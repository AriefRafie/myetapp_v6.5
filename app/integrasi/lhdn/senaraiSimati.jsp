...
function Xpapar(idPermohonanSimati,idPermohonan,idStatus) {
	...
	// Start Digunakan oleh pengguna Internal
	...
	function paparSimati(idPermohonanSimati,idPermohonan,idStatus,idStatusLHDN) {
		if(idStatusLHDN == "0"){
			alert('Maklumat Cukai masih belum disemak.');
			return;
		}
		document.${formName}.actionPerintah.value = "papar";
		document.${formName}.mode.value = "view";
	...
	//End Digunakan oleh pengguna Internal
</script>
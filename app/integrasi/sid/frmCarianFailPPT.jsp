    ...
    <td><fieldset>
      ...
      <table width="100%" align="center" border="0">
        ...
        <tr>
          ...
          <td width="70%"><input name="txtNoHakmilik" id="txtNoHakmilik" type="text" value="$!noHakmilik" size="50" maxlength="50" style="text-transform:uppercase;" >
          </td>
        </tr>
        <tr>
          <td width="30%" height="24" scope="row" align="right">No Lot : </td>
          <td width="70%"><input name="txtNoLot" id="txtNoLot" type="text" value="$!noLot" size="50" maxlength="50" style="text-transform:uppercase;" >
          </td>
        </tr>
        <tr>
          <td scope="row"></td>

...
<fieldset>
  <div class="success">Permohonan mendapatkan nilaian sewaan tanah persekutuan telah berjaya dihapuskan.</div>
</fieldset>
<br />
#end
#if ($returnMaklumat == 'true')
<fieldset>
  <div class="success">Permohonan mendapatkan nilaian sewaan tanah persekutuan telah berjaya dikembalikan ke JKPTG.</div>
</fieldset>
<br />
#end
...
<script>
  ...
  function searchMaklumat() {
	  ...
	  document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmJPPHViewNilaianSewaan&action2=search";
	  document.${formName}.method = "POST";
	  document.${formName}.submit();
  }
  function emptyMaklumat() {
	  document.${formName}.action2.value = "";
	  document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmJPPHViewNilaianSewaan&action2=";
      document.${formName}.method = "POST";
	  document.${formName}.submit();
  }
</script>
...
<fieldset>
<legend><strong>SENARAI MAKLUMAT CHARTING</strong></legend>
<!-- <input class="stylobutton100" value="Tambah" type="button" onClick="javascript:tambahPermohonan()">
 -->
#parse("app/utils/record_paging.jsp")
<table width="100%" border="0">
  <tr class="table_header">
    <td width="4%" align="center"><strong>Bil.</strong></td>
    <td width="18%"><strong>No. Fail</strong></td>
    <td width="30%"><strong>Kegunaan Tanah</strong></td>
    <td width="10%"><strong>No.Hakmilik/ Warta</strong></td>
    <td width="10%"><strong>No. Lot/ PT</strong></td>
    <td width="10%"><strong>Negeri</strong></td>
    <td width="8%" align="center"><strong>Tarikh Daftar</strong></td>
  ...
  #foreach ( $senarai in $SenaraiFail )
                ...
                #set( $i = $velocityCount )
                    ...
                    #set( $row = "row1" )
                #end
        #set($params ="nofail="+$!senarai.noFail+"&kod="+$!senarai.getStatusGIS()+"&upi="+$!senarai.getUPI())  
        #set($idGIS = "$!senarai.getIdGIS()")      
  <tr class="$row">
    <td align="center">$!senarai.getBil() .</td>
    <td > 
    	<!-- <a href="javascript:viewMaklumatPermohonan('$!senarai.id')" class="style1">$!senarai.noFail</a>
    	<a href="javascript:viewFailById('$list.idFail','$list.idPermohonan','$list.idHtpPermohonan','$list.idSuburusanStatusFail')"></a> -->
    	$!senarai.noFail
    </td>
    <td >$!senarai.kegunaan 
    	<!-- <a href="javascript:viewMaklumatPermohonan('$!senarai.id')" class="style1">$!senarai.bilTanah</a> -->
    </td>
    <td >
    	#if($!senarai.getNoWarta().equals(""))
    		senarai.getNoWarta()
    	#else
    		 $!senarai.getRujJenisHakmilik().getKodJenisHakmilik() $!senarai.getNoHakmilik()
    	#end	
    </td>
    <td >$!senarai.getRujLot().getKodLot() $!senarai.getNoLot()</td>
    <td >$!senarai.getNegeri().namaNegeri</td>
    <td align="center">$!senarai.tarikhDaftarStr</td>
    <td align="center">$!senarai.getStatusTanahGIS()
    #if ($!senarai.getLatitude().equals('TIADA') )
       	<!-- <a alt="GIS" href = "javascript:tambahGIS('$!senarai.noFail','');">
			<img border="0" src="../img/plus.gif" width="20" height="15"/>
		</a>  -->
	#else
		<!-- http://geo.fortiddns.com/viewmap.php? -->
		<a alt="GIS" href = "javascript:gisWindow('TIADA','$params');">
			<img border="0" src="../img/online/map.png" width="20" height="15"/>
		</a>
        <a alt="Hapus" href = "javascript:hapusGIS('$idGIS');"><img border="0" src="../img/online/x.gif" width="20" height="15"/></a>
	#end	
    </td>
  </tr>
  #end
...
function Hapus(){
	...
	function hapusGIS(id) {
		if ( !window.confirm("Adakah Anda Pasti?") ) return;
		var command = 'hapus';
		var hittButton = 'hapusGIS';
		doAjaxCall${formName}(command,'hittbutton='+hittButton+"&idGIS="+id);
	}

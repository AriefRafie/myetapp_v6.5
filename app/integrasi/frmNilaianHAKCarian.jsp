  ...
  <legend><strong>CARIAN MAKLUMAT SI MATI</strong>
    ...
    <tr>
      ...
      <td valign="top" scope="row">
        ...
        <input id="cmdKosongkan" name="cmdKosongkan" type="button" value="Kosongkan" onclick="emptyNilaianHTA();" $READONLY_JPPH />
#end        
      </td>
    </tr> 
    <tr>
...
function viewNilaianHAK(ID_PERMOHONAN) {	
	document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmViewNilaianHartaAlihKenderaan&action2=viewNilaianHAK&ID_PERMOHONAN=" + ID_PERMOHONAN;

...
function cetak(id){
	...
	var url = "../../servlet/ekptg.report.macgdi.RekodRingkasanMilikKementerian?txt_userLogin="+txt_userLogin+"&id="+id+"&id_tahunDari="+id_tahunDari+"&id_tahunHingga="+id_tahunHingga+"&dummmy=";	

...
function cetak(id){
	...
	var url = "../../servlet/ekptg.report.macgdi.RekodRingkasanMilikNegeri?txt_userLogin="+txt_userLogin+"&id="+id+"&id_tahunDari="+id_tahunDari+"&id_tahunHingga="+id_tahunHingga+"&dummmy=";			

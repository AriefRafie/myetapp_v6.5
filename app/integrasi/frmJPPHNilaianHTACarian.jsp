...
<fieldset>
  <legend><strong>CARIAN MAKLUMAT SI MATI</strong>
    ...
    <tr>
      <td align="right" valign="top" scope="row"><strong>NO PERMOHONAN</strong></td>
      <td align="center" valign="top" scope="row">:</td>
      <td align="left" valign="top"><input name="Carian_NoPermohonan" type="text" id="Carian_NoPermohonan" onkeyup="this.value=this.value.toUpperCase();" value="$!Carian_NoPermohonan" size="50" maxlength="255" $READONLY_JPPH /></td>
    </tr>
    <tr>
      <td width="29%" align="right" valign="top" scope="row"><strong>NAMA SIMATI</strong></td>
      <td width="1%" align="center" valign="top" scope="row">:</td>
      <td width="70%" align="left" valign="top"><input name="Carian_NamaSiMati" type="text" id="Carian_NamaSiMati" onkeyup="this.value=this.value.toUpperCase();" value="$!Carian_NamaSiMati" size="50" maxlength="255" $READONLY_JPPH /></td>
    </tr>
    <tr>
...
#foreach ($list in $ListPermohonan)
    ...
    <tr>
      ...
      <td class="$row" valign="top"><a href="javascript:viewNilaianHTA('$list.IDPermohonan', '$list.NoFail')" style="color:#0000FF">$list.NoFail</a></td>
...
<script type="text/javascript">
  function viewNilaianHTA(ID_PERMOHONAN, NO_FAIL) {	
      document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmViewNilaianHartaTakAlih&action2=viewNilaianHTA&ID_PERMOHONAN=" + ID_PERMOHONAN + "&NO_FAIL=" + NO_FAIL;
  ...
  function searchNilaianHTA() {
      ...
      document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmViewNilaianHartaTakAlih&action2=searchNilaianHTA";
      document.${formName}.method = "POST";
      document.${formName}.submit();
  }
  function emptyNilaianHTA() {
      document.${formName}.action = "?_portal_module=ekptg.view.integrasi.NilaianHartaTakAlih&action2=emptyNilaianHTA";
      document.${formName}.method = "POST";
      document.${formName}.submit();
  }
</script>
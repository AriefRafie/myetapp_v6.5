...
#foreach ($list in $ListPermohonan)
    ...
    <tr>
      ...
      <td class="$row" valign="top"><a href="javascript:viewNilaianHTA('$list.IDPermohonan')" style="color:#0000FF">$list.NoFail</a></td>
...
<script type="text/javascript">
  function viewNilaianHTA(ID_PERMOHONAN) {	
      document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmViewNilaianHartaTakAlih&action2=viewNilaianHTA&ID_PERMOHONAN=" + ID_PERMOHONAN;

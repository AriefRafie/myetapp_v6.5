...
<fieldset>
    #if ($isJPPHUser == 'true')
  <div class="success">Maklumat nilaian sewaan tanah persekutuan telah berjaya dihantar ke JKPTG.</div>    
        #set ($READONLY_FOR_JKPTG = 'true')
    #else
  <div class="success">Permohonan mendapatkan nilaian sewaan tanah persekutuan telah berjaya dihantar ke JPPH.</div>    
    #end
</fieldset>
#elseif ($saveMaklumat == 'true')
    #if ($isJPPHUser == 'true')
<fieldset>
  <div class="success">Maklumat nilaian sewaan tanah persekutuan telah berjaya disimpan.</div>    
</fieldset>
    #end
#end
...
#if ($isCompleted == 'true')
    <tr>
      <td align="right" valign="top" nowrap="nowrap"><strong>STATUS PERMOHONAN</strong></td>
      <td align="center" valign="top" nowrap="nowrap">:</td>
      <td align="left" valign="top" nowrap="nowrap"><span style="text-decoration:blink; font-weight:bold"><blink>SELESAI</blink></span></td>
    </tr>
#end
    <tr>
...
<fieldset>
  ...
  &nbsp;$MH_JENISLUASASAL</td>
    ...
    <tr>
      ...
      <td align="right" valign="top" nowrap="nowrap"><strong>LUAS TANAH DISEWA</strong></td>
      <td align="center" valign="top" nowrap="nowrap">:</td>
      <td align="left" valign="top" nowrap="nowrap"><input name="MH_LUASDISEWA" type="text" id="MH_LUASDISEWA" onkeyup="this.value=this.value.toUpperCase();" value="$!MH_LUASDISEWA" size="10" maxlength="10" $READONLY_FOR_JPPH />
  &nbsp;$MH_JENISLUASDISEWA</td>
    </tr>
    <tr>
  ...
  &nbsp;$MH_JENISPTLOT</td>
      ...
      <td align="center" valign="top" nowrap="nowrap">:</td>
      <td align="left" valign="top" nowrap="nowrap"><input name="MH_TUJUANSEWAAN" type="text" id="MH_TUJUANSEWAAN" onkeyup="this.value=this.value.toUpperCase();" value="$!MH_TUJUANSEWAAN" size="30" maxlength="255" $READONLY_FOR_JPPH /></td>
    </tr>
    <tr>
      ...
      <td align="right" valign="top" nowrap="nowrap"><strong>ALAMAT HARTA (JIKA ADA)</strong></td>
      <td align="center" valign="top" nowrap="nowrap">:</td>
      <td align="left" valign="top" nowrap="nowrap"><input name="MH_ALAMAT1HARTA" type="text" id="MH_ALAMAT1HARTA" onkeyup="this.value=this.value.toUpperCase();" value="$!MH_ALAMAT1HARTA" size="30" maxlength="255" $READONLY_FOR_JPPH /></td>
    </tr>
    <tr>
      ...
      <td align="center" valign="top" nowrap="nowrap">&nbsp;</td>
      <td align="left" valign="top" nowrap="nowrap"><input name="MH_ALAMAT2HARTA" type="text" id="MH_ALAMAT2HARTA" onkeyup="this.value=this.value.toUpperCase();" value="$!MH_ALAMAT2HARTA" size="30" maxlength="255" $READONLY_FOR_JPPH /></td>
    </tr>
    <tr>
      ...
      <td align="right" valign="top" nowrap="nowrap">&nbsp;</td>
      <td align="center" valign="top" nowrap="nowrap">&nbsp;</td>
      <td align="left" valign="top" nowrap="nowrap"><input name="MH_ALAMAT3HARTA" type="text" id="MH_ALAMAT3HARTA" onkeyup="this.value=this.value.toUpperCase();" value="$!MH_ALAMAT3HARTA" size="30" maxlength="255" $READONLY_FOR_JPPH /></td>
    </tr>
    <tr>
      ...
      <td align="right" valign="top" nowrap="nowrap">&nbsp;</td>
      <td align="center" valign="top" nowrap="nowrap">&nbsp;</td>
      <td align="left" valign="top" nowrap="nowrap"><input name="MH_ALAMAT3HARTA2" type="text" id="MH_ALAMAT3HARTA2" onkeyup="this.value=this.value.toUpperCase();" value="$!MH_ALAMAT3HARTA" size="30" maxlength="255" $READONLY_FOR_JPPH /></td>
    </tr>
    <tr>
      <td align="right" valign="top" nowrap="nowrap">&nbsp;</td>
      <td align="center" valign="top" nowrap="nowrap">&nbsp;</td>
      <td align="left" valign="top" nowrap="nowrap">&nbsp;</td>
      <td align="right" valign="top" nowrap="nowrap"><strong>NO LOT BERKAITAN (JIKA ADA)</strong></td>
      <td align="center" valign="top" nowrap="nowrap">:</td>
      <td align="left" valign="top" nowrap="nowrap"><input name="MH_NOLOTBERKAITAN" type="text" id="MH_NOLOTBERKAITAN" onkeyup="this.value=this.value.toUpperCase();" value="$!MH_NOLOTBERKAITAN" size="30" maxlength="255" $READONLY_FOR_JPPH /></td>
    </tr>
    <tr>
      <td align="right" valign="top" nowrap="nowrap">&nbsp;</td>
      <td align="center" valign="top" nowrap="nowrap">&nbsp;</td>
...
<fieldset>
  ...
  <table width="100%" cellspacing="0" cellpadding="2">
    <tr>
      <td width="30%" style="text-align:right"><strong>ALAMAT E-MEL PEGAWAI JPPH (1)</strong> : </td>
    ...
    <tr>
      <td style="text-align:right"><strong>ALAMAT E-MEL PEGAWAI JPPH (3)</strong> :</td>
...
<fieldset>
  ...
  <table width="100%" border="0" align="center">
...
#else
        <input name="JPPH_TARIKHNILAIAN" type="text" id="JPPH_TARIKHNILAIAN" value="$!JPPH_TARIKHNILAIAN" size="20" maxlength="15" $READONLY_FOR_JKPTG /><img src="../img/calendar.gif" alt="" border="0" />
#end      </td>
      <td width="15%" rowspan="6" align="right" valign="top"><strong>CATATAN</strong></td>
      <td width="1%" rowspan="6" align="center" valign="top">:</td>
      <td width="34%" rowspan="6" valign="top">
    ...
    <tr>
      <td align="right" valign="top"><strong>KADAR SEWA BULAN KE BULAN (RM)</strong></td>
      <td align="center" valign="top">:</td>
      <td valign="top"><input name="JPPH_KADARBULAN" type="text" id="JPPH_KADARBULAN" value="$!JPPH_KADARBULAN" onkeyup="this.value=this.value.toUpperCase();" size="20" maxlength="15" $READONLY_FOR_JKPTG /></td>
    </tr>
    <tr>
      <td align="right" valign="top"><strong>KADAR SEWA BULANAN DALAM TEMPOH 3 TAHUN (RM)</strong></td>
      <td align="center" valign="top">:</td>
      <td valign="top"><input name="JPPH_KADARBULAN3TAHUN" type="text" id="JPPH_KADARBULAN3TAHUN" value="$!JPPH_KADARBULAN3TAHUN" onkeyup="this.value=this.value.toUpperCase();" size="20" maxlength="15" $READONLY_FOR_JKPTG /></td>
    </tr>
    <tr>
      <td align="right" valign="top"><strong>KADAR SEWA TAHUNAN (RM)</strong></td>
      <td align="center" valign="top">:</td>
      <td valign="top"><input name="JPPH_KADARTAHUNAN" type="text" id="JPPH_KADARTAHUNAN" value="$!JPPH_KADARTAHUNAN" onkeyup="this.value=this.value.toUpperCase();" size="20" maxlength="15" $READONLY_FOR_JKPTG /></td>
    </tr>
    <tr>
...
<div style="text-align:center">
  ...
  <input type="button" id="cmdEdit" name="cmdEdit" value="Kemaskini" onclick="editMaklumat();" />&nbsp;
	#end
    #if ($isCompleted != 'true' && $hasMaklumat == 'true' && $action2 != 'edit')
...
<script type="text/javascript">
  function doChangeSOC(SOC_TYPE) {
      ...
      document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmJPPHViewNilaianSewaan&action2=edit";
  ...
  function saveMaklumat() {
      ...
      document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmJPPHViewNilaianSewaan&action2=save";
      document.${formName}.method = "POST";
      document.${formName}.submit();
  }
  function viewMaklumat() {
      document.${formName}.action2.value = "view";
      document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmJPPHViewNilaianSewaan&action2=view";
      document.${formName}.method = "POST";
      document.${formName}.submit();
  }
  function sendMaklumat() {
      ...
      document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmJPPHViewNilaianSewaan&action2=send";
      document.${formName}.method = "POST";
      document.${formName}.submit();
  }
  function cancelMaklumat() {
      ...
      document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmJPPHViewNilaianSewaan&action2=cancel";
      document.${formName}.method = "POST";
      document.${formName}.submit();
  }
  function backMaklumat() {
	...
	#else
		#if ($pageFlag == '2')
      document.${formName}.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.integrasi.FrmJPPHViewNilaianSewaan&action2=view&ID_PERMOHONAN=$ID_PERMOHONAN";
	  	#else
      document.${formName}.action = "$EkptgUtil.getTabID("Penyewaan",$portal_role)?_portal_module=ekptg.view.php2.FrmPYWJabatanTeknikalView&action2=cancel&idFail=$!idFail&idPermohonan=$!idPermohonan&idStatus=6";
		#end
	#end
      document.${formName}.method = "POST";
      document.${formName}.submit();

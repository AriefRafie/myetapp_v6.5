        ...
        <table align="center" width="100%"> 
          <tbody>
            <tr class="table_header">
              ...
              <td width="10%"align="center"><strong>History</strong></td>
            </tr>
          #set ($list = "")
          ...
          <tr>
            ...
            <td class="$row" style="text-transform:uppercase;"><a href="javascript:papar('$list.idFail')" class="style1"><font color='blue'>Lihat</font></a></td>            
            </tr>
          #end
          #else
          <tr>

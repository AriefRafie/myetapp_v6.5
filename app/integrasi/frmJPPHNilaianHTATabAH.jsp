...
<fieldset>
  ...
  <table width="100%" border="0" align="center">
    <tr>
      <td width="15%" align="right" valign="top"><strong>NEGERI</strong> <span class="mandatori">*</span></td>
    ...
    <tr>
      <td align="right" valign="top"><strong>DAERAH</strong> <span class="mandatori">*</span></td>
    ...
    <tr>
      ...
      <td align="center" valign="top">:</td>
      <td valign="top"><input name="SEKSYEN" type="text" id="SEKSYEN" value="$!SEKSYEN" size="30" maxlength="255" $READONLY_JKPTG style="text-transform:uppercase" /></td>
    </tr>
    <tr>
      <td align="right" valign="top"><strong>JENIS HAKMILIK <span class="mandatori">*</span></strong></td>
      <td align="center" valign="top">:</td>
      <td valign="top">$selectJenisHakmilik</td>
      <td rowspan="4" align="right" valign="top"><strong>SEKATAN KEPENTINGAN <span class="mandatori">*</span></strong></td>
      <td rowspan="4" align="center" valign="top">:</td>
      <td rowspan="4" align="left" valign="top"><textarea name="SEKATAN_KEPENTINGAN" cols="30" rows="3" id="SEKATAN_KEPENTINGAN" $READONLY_JKPTG style="text-transform:uppercase">$!SEKATAN_KEPENTINGAN</textarea></td>
    </tr>
    <tr>
      <td align="right" valign="top"><strong>NO HAKMILIK <span class="mandatori">*</span></strong></td>
      <td align="center" valign="top">:</td>
      <td valign="top"><input name="NO_HAKMILIK" type="text" id="NO_HAKMILIK" value="$!NO_HAKMILIK" size="20" maxlength="10" $READONLY_JKPTG style="text-transform:uppercase" /></td>
    </tr>
    <tr>
      <td align="right" valign="top"><strong>JENIS PEMBANGUNAN</strong></td>
      <td align="center" valign="top">:</td>
      <td valign="top">$selectJenisPembangunan</td>
    </tr>
    <tr>
      <td align="right" valign="top"><strong>NO PT / LOT <span class="mandatori">*</span></strong></td>
      <td align="center" valign="top">:</td>
      <td valign="top"><input name="NO_PTLOT" type="text" id="NO_PTLOT" value="$!NO_PTLOT" size="5" maxlength="20" $READONLY_JKPTG style="text-transform:uppercase" />
      &nbsp;$selectJenisPTLot</td>
    </tr>
    <tr>
      ...
      <td align="right" valign="top"><strong>LUAS TANAH <span class="mandatori">*</span></strong></td>
      <td align="center" valign="top">:</td>
      <td align="left" valign="top"><input name="LUAS_TANAH" type="text" id="LUAS_TANAH" value="$!LUAS_TANAH" size="10" maxlength="10" $READONLY_JKPTG style="text-transform:uppercase" />
      &nbsp;$selectJenisLuasTanah</td>
    </tr>
    <tr>
      <td align="right" valign="top"><strong>NO RSS</strong></td>
      <td align="center" valign="top">:</td>
#if ($isJPPHUser == 'true')
	#if ($sendNilaianHTA == 'true')
      <td valign="top"><input name="NO_RSS" type="text" id="NO_RSS" style="text-transform:uppercase" value="$!NO_RSS" size="10" maxlength="10" readonly="readonly" class="disabled" /></td>
	#else
      <td valign="top"><input name="NO_RSS" type="text" id="NO_RSS" style="text-transform:uppercase" value="$!NO_RSS" size="10" maxlength="10" /></td>
	#end      
#else      
      <td valign="top"><input name="NO_RSS" type="text" id="NO_RSS" style="text-transform:uppercase" value="$!NO_RSS" size="10" maxlength="10" $READONLY_JKPTG /></td>
#end      
      <td align="right" valign="top"><strong>LUAS PETAK (MP) <span class="mandatori">*</span></strong></td>
      <td align="center" valign="top">:</td>
      <td align="left" valign="top"><input name="LUAS_PETAK" type="text" id="LUAS_PETAK" value="$!LUAS_PETAK" size="20" maxlength="10" $READONLY_JKPTG style="text-transform:uppercase" /></td>
    </tr>
    <tr>
...
#else        
        <input name="TARIKH_LUPUT_PJKN" type="text" id="TARIKH_LUPUT_PJKN" value="$!TARIKH_LUPUT_PJKN" size="15" maxlength="10" $READONLY_PAJAKAN />
        &nbsp;<a href="javascript:displayDatePicker('TARIKH_LUPUT_PJKN',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0" /></a>
#end  </td>
      <td align="right" valign="top">&nbsp;</td>
      <td align="center" valign="top">&nbsp;</td>
...
<fieldset>
  ...
  <table width="100%" cellspacing="0" cellpadding="2">
    <tr>
      ...
      <td><input name="EMAIL_ADDR_PEGAWAI_JPPH" type="text" id="EMAIL_ADDR_PEGAWAI_JPPH" value="$!EMAIL_ADDR_PEGAWAI_JPPH" size="50" maxlength="255" $READONLY_JKPTG /></td>
    </tr>
<!--      <td width="70%">$selectEmailPegawai</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><input name="EMAIL_ADDR_PEGAWAI_JPPH" type="text" id="EMAIL_ADDR_PEGAWAI_JPPH" value="$!EMAIL_ADDR_PEGAWAI_JPPH" size="50" maxlength="255" $READONLY_JKPTG /></td>
...
-->    
    <tr>
      <td>&nbsp;</td>
      <td><input type="checkbox" id="EMAIL_SEND_JPPH" name="EMAIL_SEND_JPPH" value="1" $EMAIL_SEND_JKPTG $DISABLE_JKPTG /> Sila &radic; jika anda ingin menghantar e-mail pemberitahuan bagi permohonan ini.</td>
    </tr>
  </table>
</fieldset>
<br />
...
<fieldset>
  ...
  <table width="100%" border="0" align="center">
    ...
    <tr>
      ...
      <td align="center" valign="top">:</td>
      <td valign="top"><input name="JPPH_NILAI_TARIKH_MATI" type="text" id="JPPH_NILAI_TARIKH_MATI" value="$!JPPH_NILAI_TARIKH_MATI" size="10" maxlength="15" $READONLY_JPPH style="text-transform:uppercase" />

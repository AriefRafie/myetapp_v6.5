<fieldset>
  <legend><strong>CARIAN MAKLUMAT PEMOHON</strong>
    ...
    <tr>
      <td align="right" valign="top" scope="row">No Pemohon</td>
      <td align="center" valign="top" scope="row">:</td>
      <td align="left" valign="top"><input name="Carian_NoPemohon" type="text" id="Carian_NoPemohon" onkeyup="this.value=this.value.toUpperCase();" value="$!Carian_NoPemohon" size="50" maxlength="255" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2">&nbsp;</td>
      <td valign="top" scope="row"><input id="cmdCari" name="cmdCari" type="button" value="Cari" onclick="searchNilaianPajakan();" />
        <input id="cmdKosongkan" name="cmdKosongkan" type="button" value="Kosongkan" onclick="emptyNilaianPajakan();" /></td>
    </tr> 
    <tr>
...
#parse("app/utils/record_paging.jsp")
  <table width="100%" cellspacing="0" cellpadding="2">
    <tr class="table_header">
      ...
      <td width="15%"><strong>NO PEMOHON</strong></td>
      <td width="30%"><strong>NAMA PEMOHON</strong></td>
      <td width="30%"><strong>ALAMAT PEMOHON</strong></td>
    </tr>
#set ($list = '')
#foreach ($list in $ListPermohonan)
    ...
    <tr>
    #if ($list.No != '') 
      <td class="$row" valign="top" align="center"><a href="javascript:viewNilaianPajakan('$list.IDPermohonan')" style="color:#0000FF">$list.No</a></td>
      <td class="$row" valign="top"><a href="javascript:viewNilaianPajakan('$list.IDPermohonan')" style="color:#0000FF">$list.NoFail</a></td>
      <td class="$row" valign="top">$list.NoPemohon</td>
...
function viewNilaianPajakan(ID_PERMOHONAN) {	
	document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmViewNilaianPajakan&action2=viewNilaianPajakan&ID_PERMOHONAN-" + ID_PERMOHONAN;
	document.${formName}.method = "POST";
	document.${formName}.submit();
}
function searchNilaianPajakan() {
	document.${formName}.action = "?_portal_module=ekptg.view.integrasi.FrmViewNilaianPajakan&action2=searchNilaianPajakan";
	document.${formName}.method = "POST";
	document.${formName}.submit();
}
function emptyNilaianPajakan() {

...
<legend>Carian Integrasi <!--<input type="button" id="cmdAddIntegDalaman" name="cmdAddIntegDalaman"   
...
onkeypress="if(event.keyCode == 13) { doDivAjaxCall$formname('div_ListInteg1','showSenaraiInteg','Type=1&FlagCari=Y&carianUmum='+$jquery('#carianUmum').val()); return false; }">	
<input type="button" id="cmdCariKementerian" name="cmdCariKementerian" value="Cari" onClick="$jquery('#cetakReport').val('Y');doDivAjaxCall$formname('div_ListInteg1','showSenaraiInteg','Type=1&FlagCari=Y&carianUmum='+$jquery('#carianUmum').val());" >

...
<table width="832" border="0" cellpadding="2" cellspacing="2">
	...
	<td><div id="div_DropdownPejUrus" style="display:none">
	<select id="Form_id_jenispejabat" name="Form_id_jenispejabat">$!selectPejabat</select></div>
	</td>
	#end 
    </tr>-->
  ...
  <tr>
	...
	<td ></td>
	<td>
<input type="button" id="cmdCariPejabat1" name="cmdCariPejabat1" value="Cari" 
onClick="$jquery('#cetakReport').val('Y');doDivAjaxCall$formname('div_JKPTG','showSenaraiPejabat1','FlagCari=Y&mode=1&scrolPosition='+getPageLocation('$command')); document.getElementById('fieldJKPTG').style.display='none';document.getElementById('cmdPrint1').style.display=''; " >
<input type="button" id="cmdBatalCariPejabat" name="cmdBatalCariPejabat" value="Reset" onClick="doDivAjaxCall$formname('div_JKPTG','showSenaraiPejabat1','FlagCari=&mode=1&scrolPosition='+getPageLocation('$command'));" >
<input style="display:none" type="button" id="cmdPrint1" name="cmdPrint1"
onClick="$jquery('#cetakReport').val('Y');doDivAjaxCall$formname('SenaraiForPrint1','cetakListPejabat','FlagCetak=Y&mode=1');" value="Cetak Laporan" />
</td>
 ...
 <td></td>
 <td></td>
	<td>Statistik Unit JKPTG <!--<img src="../img/images_stat.png" alt="" width="20" height="20" onclick="doDivAjaxCall$formname('div_statsJKPTG','showStatsJKPTG','');" />-->
    <img width="20" height="20" src="../img/images_stat.png" onclick="doCetakStats('fieldJKPTG')"></td>
</tr>

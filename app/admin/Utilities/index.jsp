...
<div id="div_carian" >
#parse("app/admin/Utilities/frmCarianPejabat.jsp")
...
#parse("app/admin/Utilities/SenaraiUtama.jsp")
</div>
...
function printDiv(divName,ID_PEJABAT) {
...
alert('sini ');
    ...
    var header='<header><div align="left"  style="font-size:150%">&nbsp;&nbsp;<b>Maklumat Pejabat</b></div><br></header>'
...
function printHideDiv(divName,internalType,USER_ID) {
	...
	//var jenisPejabat = document.getElementById("jenisPejabat").value;
	//var Form_id_jenispejabat = document.getElementById("Form_id_jenispejabat").value;
	//var Form_id_negeri = document.getElementById("Form_id_negeri").value;
	//var Form_id_seksyen = document.getElementById("Form_id_seksyen").value;
	
	 var header='<header><div align="left"  style="font-size:150%">&nbsp;&nbsp;<b>Maklumat Pejabat '+internalType+'</b></div><br></header>'
		 var footer ="";
    //var originalContents = document.body.innerHTML;
    $jquery("#"+divName+" :button").hide();    
    //alert("1");
	...
	//document.getElementById("jenisPejabat").value = jenisPejabat;
	//document.getElementById("Form_id_jenispejabat").value = Form_id_jenispejabat;
	//document.getElementById("Form_id_negeri").value = Form_id_negeri;
	//document.getElementById("Form_id_seksyen").value = Form_id_seksyen;
...
function printHideDivAll(divName1,divName2) {
 //alert('test');
	...
	var printAllContent = head_style + " <table> "+
	   " <thead> "+
		  " <tr> "+
			 " <th align=\'left\' >BORANG SEMAKAN PENGGUNA DALAMAN SISTEM MYETAPP V6</th> "+
		  " </tr> "+
		  " <tr> "+
...
function printHideDivBackup(divName,internalType,USER_ID) {
...
{
	//var allkp = "";
	var allkp = document.getElementById("NOKP1_"+ID_PEJABAT).value + document.getElementById("NOKP2_"+ID_PEJABAT).value + document.getElementById("NOKP3_"+ID_PEJABAT).value;
	//alert(" allkp :"+allkp);
	document.getElementById("USER_LOGIN_"+ID_PEJABAT).value = allkp;	
	if(allkp!="")
	{
		doDivAjaxCall$formname('div_CHECK_USER_LOGIN_'+ID_PEJABAT,'checkUSER_LOGIN','internalType='+internalType+'&USER_ID='+user_id+'&USER_LOGIN='+$jquery('#USER_LOGIN_'+ID_PEJABAT).val());
	}
}
...
function valEditPejabat(ID_PEJABAT)
{
		...
		else if(document.getElementById("EMEL_"+ID_PEJABAT).value=="")
		{
		alert("Masukkan Emel Pejabat!");
		document.getElementById("EMEL_"+ID_PEJABAT).focus();
		bool_check = false;
		}
...
function hideInsPejUrus(divName,radioVal){
if(radioVal=="1"){
	document.getElementById(divName).style.display="none";
	document.getElementById('bahagianDiv').style.display="";
...
function doCheckAllRoleGroup(ID_PEJABAT,element) 
{ 
	if(element.checked==true)
	{
		var checklist_checkbox = document.getElementsByName("CHECKLIST_"+ID_PEJABAT);
		var checklist_length = document.getElementsByName("CHECKLIST_"+ID_PEJABAT).length;
...
function doCheckAllRole(ID_PEJABAT) { 
	
	var all_checklist = document.getElementById("ALL_CHECKLIST_"+ID_PEJABAT);	
	var group_length = document.getElementsByName("GROUP_CHECKLIST_"+ID_PEJABAT).length;
	var group_checkbox = document.getElementsByName("GROUP_CHECKLIST_"+ID_PEJABAT);
	if(all_checklist.checked == true)
	{
		for (i = 0; i < group_length; i++) 
		{
			group_checkbox[i].checked=true;
			var checklist_checkbox = document.getElementsByName("CHECKLIST_"+ID_PEJABAT+group_checkbox[i].value);
			var checklist_length = document.getElementsByName("CHECKLIST_"+ID_PEJABAT+group_checkbox[i].value).length;
			for (k = 0; k < checklist_length; k++) {
				checklist_checkbox[k].checked = true;
			}			
		}
...
function doCheckUpdateRole(ID_PEJABAT) { 
	var group_length = document.getElementsByName("GROUP_CHECKLIST_"+ID_PEJABAT).length;
	var group_checkbox = document.getElementsByName("GROUP_CHECKLIST_"+ID_PEJABAT);
	var all_checklist = document.getElementById("ALL_CHECKLIST_"+ID_PEJABAT);

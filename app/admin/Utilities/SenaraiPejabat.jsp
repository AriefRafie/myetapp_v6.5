<script>
if( $jquery('#div_rowPejabat').length )         // use this if you are using id to check
{
	window.scrollTo(0, $jquery('#div_rowPejabat').offset().top);
}
</script>
...
<fieldset id="div_rowPejabat">
#if($SuccessMesejDeleteUser!="")
<div class="info" id="div_rowPejabat_deletemesej">
	$SuccessMesejDeleteUser	
</div>
<script>
$jquery("#div_rowPejabat_deletemesej").show().delay(3000).fadeOut();
if( $jquery('#'+'div_rowPejabat').length )         // use this if you are using id to check
{
	window.scrollTo(0, $jquery('#'+'div_rowPejabat').offset().top);
}
...
<table width="100%" id="div_ViewJKPTG1" style="display:none">
<tr >
</tr>
</table>
...
<td>
	...
	<!--PejUrus = userHQ-->
		#foreach($PejUrus in $listPejabat)
		<tr id="div_rowPejabatUrusan$PejUrus.ID_PEJABAT">
			   ...
			   <td  align="left" valign="top" class="$PejUrus.rowCss">$PejUrus.ALAMAT1</td>
			    #if ($jenisPejabat.equals("1"))
			   <td   align="center" valign="top" class="$PejUrus.rowCss">$PejUrus.KAKI_TANGAN</td>
			   #end 
			   
               <td align="left" valign="top" class="$PejUrus.rowCss">$PejUrus.FLAG_AKTIF</td>
         
              <td align ="center" valign="top" class="$PejUrus.rowCss"><a href="javascript:doDivAjaxCall$formname('div_ViewJKPTG$PejUrus.ID_PEJABAT$mode','viewPejabatUrusan','mode=1&ID_PEJABAT=$PejUrus.ID_PEJABAT&ID_NEGERI=$PejUrus.ID_NEGERI&JENISPEJ=1');">
              <img src="../img/edit.gif" border="0"></a>
			<a href="javascript:if(confirm('Data akan dipadam. Adakah Anda Pasti?')){ doDivAjaxCall$formname('div_senaraiUtama','showSenaraiPejabat1','ID_PEJABAT=$PejUrus.ID_PEJABAT&FLAG_DELETE=Y&JENISPEJ=1');}">
			<img title="Hapus"  src="../img/delete.gif" border="0"></a>
</td>  
		</tr>
		<tr  id="div_ViewJKPTG$PejUrus.ID_PEJABAT$mode">
				<td align="left" valign="top" colspan="14">

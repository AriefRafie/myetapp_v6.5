...
<div id="div_viewPenggunaKJP$viewPengguna.USER_ID" >

</div>

<script> 
		  $jquery(document).ready(function () {
			  doDivAjaxCall$formname('div_viewPenggunaKJP$viewPengguna.USER_ID','viewPenggunaKJP','');
		  });
</script>
...
function submitRegister(userId) {
  
  alert('masuk sini');
    /*document.Dekptg_view_admin_UserProfileKJP.command.value = 'savePenggunaKJP';
    document.Dekptg_view_admin_UserProfileKJP.action = "";
    document.Dekptg_view_admin_UserProfileKJP.submit();*/
	doDivAjaxCall$formname('Dekptg_view_admin_UserProfileKJP','savePenggunaKJP','USER_ID='+userId);
}
</script>

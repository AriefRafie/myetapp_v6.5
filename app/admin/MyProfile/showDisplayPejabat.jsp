					...
					if('$viewPejabatJKPTG.ID_SEKSYEN'=='2')
					{
						$jquery(document).ready(function () {
							document.getElementById("div_displayDaerahJagaan$internalType$USER_ID").style.display="";
					  		doDivAjaxCall$formname('div_displayDaerahJagaan$internalType$USER_ID','showDisplayDaerahJagaan','ID_PEJABATJKPTG=$viewPejabatJKPTG.ID_PEJABATJKPTG&ID_JENISPEJABAT=22');			 	  

<div id="divSenaraiPenggunaLengkap" class="page-break" >
...
<br>
Senarai Pengguna bagi Bahagian ini :
<br>
...
<table width="80%" id="senaraiUser" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000" >
 ...
 <th width="5%" height="311" colspan bgcolor="#666666" "5"> </th>
  ...
  <tr> 
  #set($rowStrech = $listPengguna.length)
	...
	#foreach($PejUrus in $listPengguna)
  	<tr>
  
 	<td align="center" valign="top" >$PejUrus.BIL.</td>
	<td  align="left" valign="top">$PejUrus.USER_NAME 
    <br>$PejUrus.NO_KP
    <br> $PejUrus.NAMA_JAWATAN
    </td>

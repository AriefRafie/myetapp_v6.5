	...
	<div id="printableArea_$internalType$viewPengguna.USER_ID">
		<table width="100%" border="0">
			...
			<tr>
				...
				<td valign="top" >
				<input type="button" id="BTNEDIT$internalType$viewPengguna.USER_ID" name="BTNEDIT$internalType$viewPengguna.USER_ID"   onClick="doDivAjaxCall$formname('div_viewPengguna$internalType$viewPengguna.USER_ID','edit_PenggunaOnline','USER_ID=$viewPengguna.USER_ID&internalType=$internalType');" value="Kemaskini" > 
               ...
               <div id="printableArea2_$internalType$viewPengguna.USER_ID" style="display:none"></div>

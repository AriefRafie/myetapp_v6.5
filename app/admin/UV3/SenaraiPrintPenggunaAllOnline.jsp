<div id="divSenaraiPenggunaLengkapOnline" >
<body>
<h2>Lampiran A</h2>
...
<table width="80%" id="senaraiUser" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000" >
 ...
 <th width="5%" height="311" colspan bgcolor="#666666" "5"> </th>
  ...
  #set($rowStrech = $PrintlistPengguna.length)
    ...
    <br> Kategori : $PejUrus.KATEGORI
    <br> $PejUrus.NO_PENGENALAN
    <br> $PejUrus.NAMA_ROLE
    </td>
...
<script type="text/javascript">
	...
	printHideDiv('divSenaraiPenggunaLengkapOnline','','');
	</script>
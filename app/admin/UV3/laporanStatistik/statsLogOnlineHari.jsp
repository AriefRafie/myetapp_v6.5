...
<fieldset>
<legend>Statistik Penggunaan JKPTG Online mengikut Hari Bekerja</legend>
<div id="LogAgensi">
...
#if($statsOnlineHari.size()>0)
#foreach($list in $statsOnlineHari)
<tr id="div_rowPejabatUrusan$gred.ID_GRED">
#if (!$list.HARI.equals(""))
<td  align="left" valign="top" class="$list.rowCss">$list.HARI</td>
#else 
<td  align="left" valign="top" class="$list.rowCss">TIADA MAKLUMAT</td>
#end

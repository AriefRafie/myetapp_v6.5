...
<fieldset>
<legend>Statistik Penggunaan JKPTG Online mengikut Kategori Pengguna</legend>
<div id="LogAgensi">
...
<td   align="left" valign="top">Kategori Pengguna</td>
<td   align="center" valign="top">Jumlah Pengguna </td>
</tr>
#if($statsOnlineKategUser.size()>0)
#foreach($list in $statsOnlineKategUser)
<tr id="div_rowPejabatUrusan$gred.ID_GRED">
<td   align="center" valign="top" class="$list.rowCss">$list.BIL</td>
<td  align="left" valign="top" class="$list.rowCss">$list.KATEGORI</td>
<td  align="center" valign="top" class="$list.rowCss">$list.JUMLAHUSER</td>
</tr>

	...
	Kemasukan Maklumat Pengguna
		...
		<table width="100%" border="0">
			...
			<tr>
				...
				<td >
					<!--<select id="ID_JENISPEJABAT_$internalType$viewPengguna.USER_ID"  name="ID_JENISPEJABAT_$internalType$viewPengguna.USER_ID"  
					onChange="doDivAjaxCall$formname('showDETAILBY_JENISPEJABAT_$internalType$viewPengguna.USER_ID','selectJenisPejabatINT','ID_JENISPEJABAT='+$jquery('#ID_JENISPEJABAT_$internalType$viewPengguna.USER_ID').val()+'&USER_ID=$viewPengguna.USER_ID&internalType=$internalType');" 
					>	   
					   <option value = "" >SILA PILIH</option>
						/*#foreach ( $ruj in $list_TBLINTRUJJENISPEJABAT )		
							#set ( $selected_ruj = "" )
							#if($viewPengguna.ID_JENISPEJABAT==$ruj.ID)
               ...
               <select id="ID_JENISPEJABAT_$internalType$viewPengguna.USER_ID"  name="ID_JENISPEJABAT_$internalType$viewPengguna.USER_ID"  >	   
                        ...
                        #set ( $selected_ruj = "" )
						#if($viewPengguna.ID_JENISPEJABAT==$listPej.ID_JENISPEJABAT)
						#set ( $selected_ruj = "selected" )
						#end	
                        <option $selected_ruj value="$listPej.ID_JENISPEJABAT">
			...
			<tr>
				...
				<td >
					...
					onChange="doDivAjaxCall$formname('divListDaerah$internalType$viewPengguna.USER_ID','selectDaerahByNegeri','ID_NEGERI='+$jquery('#ID_NEGERI_$internalType$viewPengguna.USER_ID').val()+'&USER_ID=$viewPengguna.USER_ID&internalType=$internalType');" 
			...
			<tr>
				...
				<div id="divListDaerah$internalType$viewPengguna.USER_ID">
					<select id="ID_DAERAH_$internalType$viewPengguna.USER_ID"  name="ID_DAERAH_$internalType$viewPengguna.USER_ID" >	   
					   <option value = "" >SILA PILIH</option>
			...
			<tr>
				...
				<td >
				<div id="divListPejabat$internalType$viewPengguna.USER_ID">
					<select id="ID_PEJABAT_$internalType$viewPengguna.USER_ID"  
					name="ID_PEJABAT_$internalType$viewPengguna.USER_ID" 
					onChange="doDivAjaxCall$formname('div_ALAMAT_PEJABAT_$internalType$viewPengguna.USER_ID','showAlamatPejabat','ID_PEJABAT='+$jquery('#ID_PEJABAT_$internalType$viewPengguna.USER_ID').val()+'&USER_ID=$viewPengguna.USER_ID&internalType=$internalType');" 
					
					>	   
					   <option value = "" >SILA PILIH</option>
						#foreach ( $ruj in $listPejabat )		
							#set ( $selected_ruj = "" )
							#if($viewPengguna.ID_PEJABAT==$ruj.ID_PEJABAT)
							#set ( $selected_ruj = "selected" )
							#end		
					...
					<select id="ROLE_MAIN_$internalType$viewPengguna.USER_ID"  name="ROLE_MAIN_$internalType$viewPengguna.USER_ID" >	   
					   <option value = "" >SILA PILIH</option>
						#foreach ( $ruj in $listRole )		
							#set ( $selected_ruj = "" )
							#if($viewPengguna.ROLE_ID==$ruj.ID && $ruj.ID !="")
							#set ( $selected_ruj = "selected" )
							#end		
							<option $selected_ruj value="$ruj.ID" >
							#if($ruj.ID == "" && $ruj.KOD!="")
			...
			<tr>
				...
				<td valign="top" >
				<input type="button" id="BTNSAVE$internalType$viewPengguna.USER_ID" name="BTNSAVE$internalType$viewPengguna.USER_ID" onClick="if(valEditPenggunaINT('$internalType','$viewPengguna.USER_ID') == true){doDivAjaxCall$formname('div_viewPengguna$internalType$viewPengguna.USER_ID','savePenggunaINT','USER_ID=$viewPengguna.USER_ID&internalType=$internalType');}" value="Simpan" > 
	   			<input type="button" id="BTNBTL$internalType$viewPengguna.USER_ID" name="BTNBTL$internalType$viewPengguna.USER_ID" onClick="doDivAjaxCall$formname('div_viewPengguna$internalType$viewPengguna.USER_ID','edit_PenggunaINT','USER_ID=$viewPengguna.USER_ID&internalType=$internalType');" value="Batal" > 

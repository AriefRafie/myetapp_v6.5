<tr>
            <td colspan="14">
            <fieldset>
<legend>SENARAI DOKUMEN PENGGUNA </legend>
...
<table border="0" cellspacing="1" cellpadding="1" width="100%" > 
	...
	<tr >
		   ...
		   #parse("app/admin/UV3/record_paging_Doc.jsp")
		   </td>
  ...
  <tr>
  <td>
  <input size="50" id="tambahDocUser" name="tambahDocUser" onchange="uploadDoc(this,'$USER_ID','displayDoc$USER_ID');" type="file"></td>
  </tr> 

<tr>
<td>
<div id="displayDoc$USER_ID">
<table border="0" cellspacing="1" cellpadding="1" width="100%" >
...
<a href="javascript:if(confirm('Data akan dipadam. Adakah Anda Pasti?')){ doDivAjaxCall$formname('displayDoc$USER_ID','showDokumen','USER_ID=$USER_ID&internalType=$internalType&FLAG_DELETE=Y&ID_DOKUMENADMIN=$list.ID_DOKUMEN');}"><img src="../img/delete.gif" border="0"></a>

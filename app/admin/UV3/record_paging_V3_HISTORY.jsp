 ...
 <script>
 var carian = $jquery('#carianTerperinciHISTORY_$internalType$USER_ID').val(); 
 ...
 <input type="hidden" name="scrolPosition$command" id="scrolPosition$command" >
           ...
           <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td  align="right">
                        ...
                        onChange="doDivAjaxCall$formname('$div','$command','action=doChangeItemPerPage&carianTerperinciHISTORY='+$jquery('#carianTerperinciHISTORY_$internalType$USER_ID').val()+'&scrolPosition='+getPageLocation('$command')+'&TARIKH_MULA_HISTORY='+$jquery('#TARIKH_MULA_HISTORY_$internalType$USER_ID').val()+'&TARIKH_AKHIR_HISTORY='+$jquery('#TARIKH_AKHIR_HISTORY_$internalType$USER_ID').val()+'&USER_ID=$USER_ID&internalType=$internalType');"
                        >
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<td width="70%" align="left" valign="middle">
		   ...
		   onClick="doDivAjaxCall$formname('$div','$command','action=getPage&value=1&carianTerperinciHISTORY='+$jquery('#carianTerperinciHISTORY_$internalType$USER_ID').val()+'&scrolPosition='+getPageLocation('$command')+'&TARIKH_MULA_HISTORY='+$jquery('#TARIKH_MULA_HISTORY_$internalType$USER_ID').val()+'&TARIKH_AKHIR_HISTORY='+$jquery('#TARIKH_AKHIR_HISTORY_$internalType$USER_ID').val()+'&USER_ID=$USER_ID&internalType=$internalType');"
		   src="../img/paging/page-first.gif">
		   #if ($page > 10)
		   	<img title="Previous 10" style="vertical-align=bottom;cursor:hand;cursor:pointer;" 
		   	onClick="doDivAjaxCall$formname('$div','$command','action=getPrevious&page=$previous10&carianTerperinciHISTORY='+$jquery('#carianTerperinciHISTORY_$internalType$USER_ID').val()+'&scrolPosition='+getPageLocation('$command')+'&TARIKH_MULA_HISTORY='+$jquery('#TARIKH_MULA_HISTORY_$internalType$USER_ID').val()+'&TARIKH_AKHIR_HISTORY='+$jquery('#TARIKH_AKHIR_HISTORY_$internalType$USER_ID').val()+'&USER_ID=$USER_ID&internalType=$internalType');"
		...
		&nbsp;
			...
			#foreach ( $i in [$page_mula..$totalPages] )
					...
					#else
					<a 
					href="javascript:doDivAjaxCall$formname('$div','$command','action=getPage&value=$i&carianTerperinciHISTORY='+$jquery('#carianTerperinciHISTORY_$internalType$USER_ID').val()+'&scrolPosition='+getPageLocation('$command')+'&TARIKH_MULA_HISTORY='+$jquery('#TARIKH_MULA_HISTORY_$internalType$USER_ID').val()+'&TARIKH_AKHIR_HISTORY='+$jquery('#TARIKH_AKHIR_HISTORY_$internalType$USER_ID').val()+'&USER_ID=$USER_ID&internalType=$internalType');"
		    		>[$i]</a>
					#end
				#end
			#end
		...
		&nbsp;
		    ...
		    onClick="doDivAjaxCall$formname('$div','$command','action=getNext&page=$next10&carianTerperinciHISTORY='+$jquery('#carianTerperinciHISTORY_$internalType$USER_ID').val()+'&scrolPosition='+getPageLocation('$command')+'&TARIKH_MULA_HISTORY='+$jquery('#TARIKH_MULA_HISTORY_$internalType$USER_ID').val()+'&TARIKH_AKHIR_HISTORY='+$jquery('#TARIKH_AKHIR_HISTORY_$internalType$USER_ID').val()+'&USER_ID=$USER_ID&internalType=$internalType');"
		    
		    src="../img/paging/page-next.gif">
		    <img title="Last page:$totalPages" style="vertical-align=bottom;cursor:hand;cursor:pointer;" 
		    onClick="doDivAjaxCall$formname('$div','$command','action=getPage&value=$totalPages&carianTerperinciHISTORY='+$jquery('#carianTerperinciHISTORY_$internalType$USER_ID').val()+'&scrolPosition='+getPageLocation('$command')+'&TARIKH_MULA_HISTORY='+$jquery('#TARIKH_MULA_HISTORY_$internalType$USER_ID').val()+'&TARIKH_AKHIR_HISTORY='+$jquery('#TARIKH_AKHIR_HISTORY_$internalType$USER_ID').val()+'&USER_ID=$USER_ID&internalType=$internalType');"

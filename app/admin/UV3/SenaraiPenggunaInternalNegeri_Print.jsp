...
<!-- close ct -->
	...
	<div id="div_LaporanPenggunaforPrint_Negeri" style="display:none" >
	...
	<td valign="top" style="font-size: 100%;">
	<span id="display_CT_ID_SEKSYEN_Negeri"></span>
	<script>
	$jquery(document).ready(function () {
	returnDropDownSelectedText('CT_ID_SEKSYEN_Negeri','display_CT_ID_SEKSYEN_Negeri');
	});
	</script>
	</td>
	</tr>
	...
	<td valign="top" style="font-size: 100%;">
	<span id="display_CT_ID_NEGERI_Negeri"></span>
	<script>
	$jquery(document).ready(function () {
	returnDropDownSelectedText('CT_ID_NEGERI_Negeri','display_CT_ID_NEGERI_Negeri');
	});
	</script>
	</td>
	</tr>
	...
	<td valign="top" style="font-size: 100%;">
	<span id="display_CT_ID_PEJABATJKPTG_Negeri"></span>
	<script>
	$jquery(document).ready(function () {
	returnDropDownSelectedText('CT_ID_PEJABATJKPTG_Negeri','display_CT_ID_PEJABATJKPTG_Negeri');
	});
	</script>
	</td>
	</tr>
	...
	<td valign="top" style="font-size: 100%;">
	<span id="display_CT_ROLE_MAIN_Negeri"></span>
	<script>
	$jquery(document).ready(function () {
	returnDropDownSelectedText('CT_ROLE_MAIN_Negeri','display_CT_ROLE_MAIN_Negeri');
	});
	</script>
	</td>
	</tr>
	...
	<td valign="top" style="font-size: 100%;">
	<span id="display_CT_FLAG_AKTIF_Negeri"></span>
	<script>
	$jquery(document).ready(function () {
	returnDropDownSelectedText('CT_FLAG_AKTIF_Negeri','display_CT_FLAG_AKTIF_Negeri');
	});
	</script>
	</td>
	</tr>
	...
	<td valign="top" style="font-size: 100%;">
	<span id="display_CT_ID_JAWATAN_Negeri"></span>
	<script>
	$jquery(document).ready(function () {
	returnDropDownSelectedText('CT_ID_JAWATAN_Negeri','display_CT_ID_JAWATAN_Negeri');
	});
	</script>
	</td>
	</tr>
	...
	<td valign="top" style="font-size: 100%;">
	<span id="display_CT_STATUS_LOG_Negeri"></span>
	<script>
	$jquery(document).ready(function () {
	returnDropDownSelectedText('CT_STATUS_LOG_Negeri','display_CT_STATUS_LOG_Negeri');
	});
	</script>
	</td>
	</tr>
	...
	<tr   >
		...
		#foreach($Pengguna_Negeri in $PrintlistPenggunaInternalNegeri)
		<tr class="page-break" >
		   <td width="2%" style="border: 1px solid black;font-size:75%;"   align="center" valign="top" >$Pengguna_Negeri.BIL </td>
		   <td style="border: 1px solid black;font-size:75%;"  align="left" valign="top">
		   $Pengguna_Negeri.FULLNAME 
		   <br>
		   [$Pengguna_Negeri.USER_LOGIN]
		   </td>
		   #if($CT_ID_SEKSYEN == "")
		   <td style="border: 1px solid black;font-size:75%;"  align="left" valign="top">$Pengguna_Negeri.BAHAGIAN</td>
		   #end
		   #if($CT_ID_NEGERI == "")
		   <td style="border: 1px solid black;font-size:75%;"  align="left" valign="top">$Pengguna_Negeri.NEGERI_PEJABAT</td>
		   #end
		   #if($CT_ID_PEJABATJKPTG == "")
		   <td style="border: 1px solid black;font-size:75%;"  align="left" valign="top">$Pengguna_Negeri.NAMA_PEJABAT</td>
		   #end
		   #if($CT_ROLE_MAIN == "")
		   <td style="border: 1px solid black;font-size:75%;"  align="left" valign="top">$Pengguna_Negeri.ROLE_UTAMA</td>
		   #end
		   #if($CT_FLAG_AKTIF == "")
		   <td style="border: 1px solid black;font-size:75%;"  align="left" valign="top">$Pengguna_Negeri.KEAKTIFAN</td>
		   #end
		   #if($CT_ID_JAWATAN == "")
		   <td style="border: 1px solid black;font-size:75%;"  align="left" valign="top">$Pengguna_Negeri.JAWATAN</td>
		   #end
		   #if($CT_LOGMASUK_MULA == "" && $CT_LOGMASUK_AKHIR == "")
		   <td style="border: 1px solid black;font-size:75%;"  align="left" valign="top">$Pengguna_Negeri.WAKTU_AKHIR_LOGIN</td>
		   #end
		   #if($CT_STATUS_LOG == "")
		   <td style="border: 1px solid black;font-size:75%;"  align="left" valign="top">$Pengguna_Negeri.DISPLAY_NOTE</td>
		   #end
	...
	printHideDiv('div_LaporanPenggunaforPrint_Negeri','Negeri','');
	</script>
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmCRBMaklumatSuratPenghargaan.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
    ...
    <td><fieldset>
      ...
      <table align="center" width="100%">
        ...
        <tr class="table_header">
          ...
          <td width="39%"><strong>JKPTG / PTD</strong></td>
          <td width="10%" align="center"><strong>Tarikh Hantar</strong></td>
          <td width="10%"><strong>Status</strong></td>
          <td width="5%"><strong></strong></td>
        </tr>
        #set ($list = "")
        #if ($SenaraiSuratPenghargaan.size() > 0)
        #foreach ($list in $SenaraiSuratPenghargaan)
        #if ($list.bil == '')
        #set( $row = "row1" )
        #elseif (($list.bil % 2) != 0)
        #set( $row = "row1" )
        ...
        <tr>
          ...
          <td class="$row"><a href="javascript:paparMaklumatSuratPenghargaan('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a></td>
          #else
          <td class="$row"><a href="javascript:paparMaklumatSuratPenghargaan('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;(ULANGAN $list.bilUlangan)</td>
          #end
          <td class="$row">  
          	#if($list.flagKJP == 'PTD')
       ...
       #if ($list.bilUlangan == '' || $list.bilUlangan == '0')
          <td class="$row" align="center"><a href="#" class="style2" onClick="javascript:cetakCRBSuratPenghargaan('$idFail','$list.idUlasanTeknikal')"><img border="0" src="../img/print.gif"/></a></td>
          #else

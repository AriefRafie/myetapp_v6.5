              ...
              <tr>
                <td width="50%" valign="top"><table width="100%" >
                    <tr>
                      ...
                      <td width="85%"><table width="100%">
                          <tr>
                            <td><b>Senarai Mesyuarat</b> </td>
                          </tr>
                          <tr>
                            <td><a href="javascript:gotoSenaraiMesyuaratAPB()" class="help" title="Fail Tugasan"> <font color="blue">
                              <li> #if($!check_notifikasi_tugasan > 0)
                                ...
                                &nbsp;
                                #end                                
                                Urusan Akta Pelantar Benua (APB)
                              </li></font> 
                            </a></td>
                          </tr>
                          <tr>
                            <td><a href="javascript:gotoSenaraiMesyuaratCRB()" class="help" title="Fail Tugasan"> <font color="blue">
                              <li> #if($!check_notifikasi_tugasan > 0)
                                <label style="background-color:blue"  align="center" valign="top" > <b><font color="WHITE"><blink>$!check_notifikasi_tugasan</blink></font></b> </label>
                                &nbsp;
                                #end                                
                          ...
                          <tr>
                            <td><a href="javascript:gotoSenaraiMesyuaratPYW()" class="help" title="Fail Tugasan"> <font color="blue">
                              <li> #if($!check_notifikasi_tugasan > 0)
                                <label style="background-color:blue"  align="center" valign="top" > <b><font color="WHITE"><blink>$!check_notifikasi_tugasan</blink></font></b> </label>
                                &nbsp;
                                #end                                
                          ...
                          <tr>
                            <td><a href="javascript:gotoSenaraiMesyuaratPLP()" class="help" title="Fail Tugasan"> <font color="blue">
                              <li> #if($!check_notifikasi_tugasan > 0)
                                <label style="background-color:blue"  align="center" valign="top" > <b><font color="WHITE"><blink>$!check_notifikasi_tugasan</blink></font></b> </label>
                                &nbsp;
                                #end                                
                          ...
                          <tr>
                            <td><a href="javascript:gotoSenaraiMesyuaratPNW()" class="help" title="Fail Tugasan"> <font color="blue">
                              <li> #if($!check_notifikasi_tugasan > 0)
                                <label style="background-color:blue"  align="center" valign="top" > <b><font color="WHITE"><blink>$!check_notifikasi_tugasan</blink></font></b> </label>
                                &nbsp;
                                #end                                
                          ...
                          <tr>
                            <td><a href="javascript:gotoSenaraiMesyuaratTKR()" class="help" title="Fail Tugasan"> <font color="blue">
                              <li> #if($!check_notifikasi_tugasan > 0)
                                <label style="background-color:blue"  align="center" valign="top" > <b><font color="WHITE"><blink>$!check_notifikasi_tugasan</blink></font></b> </label>
                                &nbsp;
                                #end                                
                ...
                <td width="50%" valign="top"><table width="100%" >
                    <tr>
                      ...
                      <td width="85%"><table width="100%">
                          ...
                          <tr>
                            <td><a href="javascript:gotoKutipanPYW()" class="help" title="Kutipan Data Penyewaan"> <font color="blue">
                ...
                <td width="50%" valign="top"><table width="100%" >
                    <tr>
                      ...
                      <td width="85%"><table width="100%">
                          ...
                          #end
                          <tr>
                            <td><a href="javascript:gotoSenaraiFailHQ()" class="help" title="Senarai Fail HQ"> <font color="blue">
                              <li>&nbsp;Senarai Fail HQ</li>
                              </font> </a> </td>
                          </tr>
                        </table></td>
                    </tr>
                      ...
                      <td width="85%" ><table width="100%">
                          ...
                          <tr>
                            <td valign="top" width="49%"><font color="blue">
                              <li>Fail Penyewaan</li>
                              </font></td>
                            <td  valign="top" width="1%"> :</td>
                            <td  valign="top" width="50%"><b>$!failPenyewaan</b></td>
                          </tr>
                          <tr>
                            ...
                            <td valign="top"> :</td>
                            <td  valign="top"><b>$!perjanjianAktif</b></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
...
<script>
function gotoSemakanStatus(){
	document.${formName}.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.php2.FrmPYWSemakanStatusPermohonanView";

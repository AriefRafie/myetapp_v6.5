<table width="100%" border="0" cellspacing="2" cellpadding="2">
  #if ($flagPopup == 'openJP')
  <tr>
    <td> #parse("app/php2/frmAPBMaklumatJP.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td><fieldset>
      ...
      <table align="center" width="100%">
        <tr>
          <td colspan="9" scope="row"><input name="cmdTambah" type="button" value="Tambah" onclick="javascript:doDaftarMaklumatJP()"/></td>
        </tr>
        ...
        <tr>
          ...
          <td class="$row"><a href="javascript:paparMaklumatJP('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;<font class="blink" ><span class="style1">$!list.statusHari</span></font></td>
          #else
          <td class="$row"><a href="javascript:paparMaklumatJP('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;(ULANGAN $list.bilUlangan)&nbsp;&nbsp;<font class="blink" ><span class="style1">$!list.statusHari</span></font></td>
          #end
          ...
          #else
          <td class="$row" align="center"><a href="#" class="style2" onClick="javascript:cetakAPBUlanganSuratMintaUlasanDOF('$idFail','$list.idUlasanTeknikal','$list.bilUlangan')"><img border="0" src="../img/print.gif"/></a></td>
          #end </tr>
        #end
        #else
        <tr>
...
function paparMaklumatJP(idUlasanTeknikal){
...
function doSimpanMaklumatJP(){
	...
	document.${formName}.flagPopup.value = "openJP";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanMaklumatJP";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
function doSimpanMaklumatUlanganJP(){
	if(document.${formName}.txtTarikhHantar.value == ""){
		alert('Sila masukkan Tarikh Hantar.');
  		document.${formName}.txtTarikhHantar.focus(); 
		return; 
	...
	document.${formName}.flagPopup.value = "openJP";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanMaklumatUlanganJP";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
function doBatalMaklumatJP(){
...
function doKemaskiniMaklumatJP(){
	document.${formName}.flagPopup.value = "openJP";
...
function doBatalKemaskiniMaklumatJP(){
	document.${formName}.flagPopup.value = "openJP";
	document.${formName}.modePopup.value = "view";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
...
function doSimpanKemaskiniMaklumatJP(){
	...
	document.${formName}.flagPopup.value = "openJP";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanKemaskiniMaklumatJP";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
...
function simpanDokumenJP(idUlasanTeknikal,idPermohonan) {
	
	if(document.${formName}.fileuploadJP.value == ""){
		alert('Sila pilih Fail yang Ingin Dimuatnaik.');
  		document.${formName}.fileuploadJP.focus(); 
		return; 
	}
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView&hitButton=simpanDokumenKJT&selectedTabUpper=3&idPermohonan="+idPermohonan+"&idUlasanTeknikal="+idUlasanTeknikal+"&flagPopup=openJP&modePopup=view"+dopost;
	document.${formName}.method="post";
...
function cetakAPBUlanganSuratMintaUlasanDOF(idFail,idUlasanTeknikal) {
	var url = "../x/${securityToken}/ekptg.view.php2.FrmAPBPopupCetakLaporanView?idFail="+idFail+"&report=ulanganSuratMintaUlasanDOF&idUlasanTeknikal="+idUlasanTeknikal;

...
function daftarBaru() {
	...
	if(document.${formName}.noFail.value == "JKPTG/SPHP/" || document.${formName}.noFail.value == ''){
...
function checkingExistNoFail() {
	url = "../servlet/ekptg.view.php2.FrmPYWServlet?command=checkingExistNoFail";
...
function popupMsg(){
	...
	document.${formName}.noFail.value = "JKPTG/SPHP/";
}

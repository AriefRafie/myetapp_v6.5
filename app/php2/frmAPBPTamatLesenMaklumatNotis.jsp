<table width="100%" border="0" cellspacing="2" cellpadding="2">
  #if ($flagPopup == 'openMaklumatNotis')
  <tr>
    <td> #parse("app/php2/frmAPBPTamatLesenMaklumatNotisDetail.jsp") </td>
  </tr>
  #end
  <tr>
    <td><fieldset>
      ...
      <table align="center" width="100%">
        <tr>
          <td colspan="9" scope="row"><input name="cmdTambah" type="button" value="Tambah" onClick="javascript:doDaftarMaklumatNotis()"/></td>
        </tr>

    ...
    <td ><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          ...
          #if ($modePopup == 'new')
          <td width="70%"><input name="txtNamaImej" type="text" id="txtNamaImej" value="" size="43" maxlength="100"></td>
          #else
          <td width="70%"><input name="txtNamaImej" type="text" id="txtNamaImej" value="$beanMaklumatImejan.namaImej" size="43" maxlength="100"></td>
          #end
        </tr>
        <tr>
          <td>&nbsp;</td>
          ...
          <td valign="top">:</td>
          #if ($modePopup == 'new')
          <td valign="top"><textarea name="txtCatatanImej" cols="50" rows="5" id="txtCatatanImej"></textarea></td>
          #else
          <td width="70%"><input name="txtCatatanImej" type="text" id="txtCatatanImej" value="$beanMaklumatImejan.catatanImej" size="43" maxlength="100"></td>
          #end

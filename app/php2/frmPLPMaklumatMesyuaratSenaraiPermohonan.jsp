        ...
        <div class="TabbedPanelsContentGroup">
          ...
          <div class="TabbedPanelsContent">
          	...
          	<table width="100%" border="0" cellspacing="2" cellpadding="2">
					  ...
					  <tr>
					    <td> #parse("app/php2/frmPYWMinitMesyuaratDetailSenaraiPermohonan.jsp") </td>
					  </tr>
					  <tr>
					    <td>&nbsp;</td>
					  </tr>
...
function doChangeTab(tabId) {
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmPLPSenaraiMesyuaratView";
...
function pilihSenaraiPermohonanBaru() {
	var url = "../x/${securityToken}/ekptg.view.php2.FrmPLPPopupSenaraiPermohonanView";

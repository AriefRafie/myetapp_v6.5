    ...
    <td colspan="4"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td width="1%">:</td>
          <td width="70%"><input name="txtPeganganHakmilik" type="text" class="$inputTextClassPopup"id="txtPeganganHakmilik" onBlur="this.value=this.value.toUpperCase();" value="$beanMaklumatHakmilik.peganganHakmilik" maxlength="30" $readonlyPopup /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>No. Hakmilik</td>
          <td>:</td>
          <td><input name="txtNoHakmilik" type="text" class="$inputTextClassPopup" id="txtNoHakmilik" onBlur="this.value=this.value.toUpperCase();" value="$beanMaklumatHakmilik.noHakmilik" maxlength="21" $readonlyPopup/></td>
        </tr>
        <tr>
          <td><span class="style1">*</span></td>
          <td>Jenis Lot</td>
        ...
        <tr>
          ...
          <td>No. Lot</td>
          <td>:</td>
          <td><input name="txtNoLot" type="text" class="$inputTextClassPopup" id="txtNoLot" onBlur="this.value=this.value.toUpperCase();" value="$beanMaklumatHakmilik.noLot" maxlength="20" $readonlyPopup/></td>
        </tr>
        <tr>
          <td><span class="style1">*</span></td>
...
#set ($counter = $counter+1)
        ...
        <tr>
          ...
          <td>#if ($idLuas == '0' || $idLuas == '1' || $idLuas == '2' || $idLuas == '3' || $idLuas == '5' || $idLuas == '6' || $idLuas == '9')
            <input type="text" name="txtLuas1" id="txtLuas1" value="$beanMaklumatHakmilik.luas1" onkeyup="validateNumber(this,this.value);" onBlur="this.value=this.value.replace(/,/g,'');kiraLuas('$idLuas')" size="6" $readonlyPopup class="$inputTextClassPopup"/ >
            #elseif ($idLuas == '7')
            <input type="text" name="txtLuas1" id="txtLuas1" value="$beanMaklumatHakmilik.luas1" onkeyup="validateNumber(this,this.value);" size="4" $readonlyPopup class="$inputTextClassPopup" onBlur="kiraLuas('$idLuas')"/>
            <input type="text" name="txtLuas2" id="txtLuas2" value="$beanMaklumatHakmilik.luas2" style="text-align:right" onkeyup="validateNumber(this,this.value);" onBlur="this.value=this.value.replace(/,/g,'');kiraLuas('$idLuas')" size="6"/ $readonlyPopup class="$inputTextClassPopup">
            #elseif ($idLuas == '8' || $idLuas == '4')
            <input type="text" name="txtLuas1" id="txtLuas1" value="$beanMaklumatHakmilik.luas1" onkeyup="validateNumber(this,this.value);" size="4" $readonlyPopup class="$inputTextClassPopup" onBlur="kiraLuas('$idLuas')"/>
            <input type="text" name="txtLuas2" id="txtLuas2" value="$beanMaklumatHakmilik.luas2" onkeyup="validateNumber(this,this.value);" size="4" $readonlyPopup class="$inputTextClassPopup" onBlur="kiraLuas('$idLuas')"/>
            <input type="text" name="txtLuas3" id="txtLuas3" value="$beanMaklumatHakmilik.luas3" onKeyUp="validateNumber(this,this.value);" onBlur="this.value=this.value.replace(/,/g,'');kiraLuas('$idLuas')" size="6" $readonlypopup class="$inputTextClassPopup"/></td>
        </tr>
        #end
        <tr>
          <td>&nbsp;</td>
          ...
          <td>:</td>
          <td><input type="text" name="txtLuasBersamaan" id="txtLuasBersamaan" value="$beanMaklumatHakmilik.luasBersamaan" readonly="readonly" class="disabled"/>
            HEKTAR</td>
        </tr>
        <tr>
          <td><span class="style1">*</span></td>
        ...
        <tr>
          ...
          <td valign="top">:</td>
          <td valign="top"><textarea name="txtSyarat" id="txtSyarat" rows="5" cols="50" $readonlyPopup class="$inputTextClassPopup" onblur="this.value=this.value.toUpperCase();">$beanMaklumatHakmilik.syarat</textarea></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td valign="top">Sekatan Kepentingan</td>
          <td valign="top">:</td>
          <td valign="top"><textarea name="txtSekatan" id="txtSekatan" rows="5" cols="50" $readonlyPopup class="$inputTextClassPopup"  onblur="this.value=this.value.toUpperCase();">$beanMaklumatHakmilik.sekatan</textarea></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td valign="top">Kegunaan Tanah</td>
          <td valign="top">:</td>
          <td valign="top"><textarea name="txtKegunaanTanah" id="txtKegunaanTanah" rows="5" cols="50" $readonlyPopup class="$inputTextClassPopup" onblur="this.value=this.value.toUpperCase();">$beanMaklumatHakmilik.kegunaanTanah</textarea></td>
        </tr>
        <tr>
          <td><span class="style1">*</span></td>
          <td>Kementerian</td>
  ...
  <tr>
    ...
    <td width="28%">&nbsp;</td>
    <td width="1%">&nbsp;</td>
    <td width="70%"><input name="cmdSimpan" type="button" value="Simpan" onClick="doSimpanHakMilik()" />
...
function doSimpanHakMilik(){
	...
	document.${formName}.hitButton.value = "doSimpanHakMilik";
	document.${formName}.submit();
}
</script>

<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmAPBMaklumatJLM.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td><fieldset>
      ...
      <table align="center" width="100%">
        <tr>
          <td colspan="9" scope="row"><input name="cmdTambah" type="button" value="Tambah" onclick="javascript:doDaftarMaklumatJLM()"/></td>
        </tr>
        ...
        <tr>
          ...
          <td class="$row"><a href="javascript:paparMaklumatJLM('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;<font class="blink" ><span class="style1">$!list.statusHari</span></font></td>
          #else
          <td class="$row"><a href="javascript:paparMaklumatJLM('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;(ULANGAN $list.bilUlangan)&nbsp;&nbsp;<font class="blink" ><span class="style1">$!list.statusHari</span></font></td>
          #end
          ...
          #else
          <td class="$row" align="center"><a href="#" class="style2" onClick="javascript:cetakAPBUlanganSuratMintaUlasanJLM('$idFail','$list.idUlasanTeknikal','$list.bilUlangan')"><img border="0" src="../img/print.gif"/></a></td>
          #end </tr>
        #end
        #else
        <tr>
...
function doDaftarNotifikasi(){
	document.${formName}.flagPopup.value = "openJLM";
...
function paparMaklumatJLM(idUlasanTeknikal){
	document.${formName}.flagPopup.value = "openJLM";
	document.${formName}.modePopup.value = "view";
...
function doSimpanMaklumatJLM(){
	...
	document.${formName}.flagPopup.value = "openJLM";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanMaklumatJLM";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
function doSimpanMaklumatUlanganJLM(){	
	if(document.${formName}.txtTarikhHantar.value == ""){
		alert('Sila masukkan Tarikh Hantar.');
  		document.${formName}.txtTarikhHantar.focus(); 
		return; 
	...
	document.${formName}.flagPopup.value = "openJLM";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanMaklumatUlanganJLM";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
function doBatalMaklumatJLM(){
...
function doKemaskiniMaklumatJLM(){
	document.${formName}.flagPopup.value = "openJLM";
...
function doBatalKemaskiniMaklumatJLM(){
	document.${formName}.flagPopup.value = "openJLM";
	document.${formName}.modePopup.value = "view";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
...
function doSimpanKemaskiniMaklumatJLM(){
	...
	document.${formName}.flagPopup.value = "openJLM";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanKemaskiniMaklumatJLM";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
...
function simpanDokumenJLM(idUlasanTeknikal,idPermohonan) {
	
	if(document.${formName}.fileuploadJLM.value == ""){
		alert('Sila pilih Fail yang Ingin Dimuatnaik.');
  		document.${formName}.fileuploadJLM.focus(); 
		return; 
	}
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView&hitButton=simpanDokumenKJT&selectedTabUpper=4&idPermohonan="+idPermohonan+"&idUlasanTeknikal="+idUlasanTeknikal+"&flagPopup=openJLM&modePopup=view"+dopost;
	document.${formName}.method="post";
...
function cetakAPBUlanganSuratMintaUlasanJLM(idFail,idUlasanTeknikal) {
	var url = "../x/${securityToken}/ekptg.view.php2.FrmAPBPopupCetakLaporanView?idFail="+idFail+"&report=ulanganSuratMintaUlasanJLM&idUlasanTeknikal="+idUlasanTeknikal;

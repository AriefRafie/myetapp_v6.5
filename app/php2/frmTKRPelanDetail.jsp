...
<!--   <input name="idDokumen" type="hidden" id="idDokumen"/>  -->
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td> #if ($modePopup == 'new')
            ...
            <input name="cmdHapus" type="button" value="Hapus" onClick="hapusDokumenP('$idDokumen')" >
            #end
            #if ($modePopup == 'update')
            <input name="cmdSimpanKemaskini" type="button" value="Simpan" onClick="simpanKemaskiniDokumenP()" />

...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmPLPMaklumatJPPH.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
    ...
    <td><fieldset>
      ...
      <table align="center" width="100%">
        ...
        <tr>
          ...
          <td class="$row"><a href="javascript:paparMaklumatJPPH('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;<font class="blink" ><span class="style3">$!list.statusHari</td>
          #else
          ...
          <td class="$row">$list.status</td>
              ...
              #end
          #else
          <td class="$row" align="center"><a href="#" class="style2" onClick="javascript:cetakPLPSuratUlanganJPPH('$idFail','$list.idUlasanTeknikal')"><img border="0" src="../img/print.gif"/></a></td>
          #end          
        </tr>
        #end
        #else

    ...
    <td><fieldset>
      ...
      <table align="center" width="100%">
        ...
        <tr class="table_header">
          ...
          <td width="35%"><strong>Nama Pemohon</strong></td>
        ...
        <tr>
          <td class="$row" align="center">$list.bil</td>
          	...
          	<td class="$row">
          			<a href="javascript:papar('$list.idFail','$list.idStatus')" class="style1">$list.noFail</a>&nbsp;(SAMBUNGAN)
          	</td>
          #else
          	<td class="$row">
...
function papar(idFail,idStatus) {
	...
	document.${formName}.flagFrom.value = "failNegeri";	

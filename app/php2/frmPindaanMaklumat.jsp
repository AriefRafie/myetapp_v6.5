...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td><fieldset>    
      <legend>PINDAAN MAKLUMAT</legend>
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>
          <input type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onClick="doPindaanMaklumat()"/>
...
function doPindaanMaklumat(){
	...
	document.${formName}.hitButton.value = "doPindaanMaklumat";

<table width="100%" border="0" cellspacing="2" cellpadding="2">
    ...
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td width="28%">Nama</td>
          <td width="1%">:</td>
          <td width="70%"><input name="txtNamaProjek" type="text" class="$inputTextClass" id="txtNamaProjek" value="$beanMaklumatProjek.namaProjek" size="43" maxlength="80" $readonly />
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td width="70%"> #if ($mode == 'newProjek')
      ...
      <input type="button" name="cmdBatalProjek" id="cmdBatalProjek" value="Batal" onClick="batalProjek()"/>
      #end
      #if ($mode == 'viewProjek')

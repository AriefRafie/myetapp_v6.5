...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmTKRMesyuaratDetail.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
function cetakTKRSuratPanggilMesyuarat(idFail,idMesyuarat) {
	var url = "../x/${securityToken}/ekptg.view.php2.FrmPLPPopupCetakLaporanView?idFail="+idFail+"&idMesyuarat="+idMesyuarat+"&report=TKRSuratPanggilMesyuarat";
...
function simpanDokumenMM(idMesyuarat,idPermohonan) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmTKRMesyuaratView&hitButton=simpanDokumenMM&idPermohonan="+idPermohonan+"&idMesyuarat="+idMesyuarat+"&flagPopup=openMesyuarat&modePopup=view"+dopost;

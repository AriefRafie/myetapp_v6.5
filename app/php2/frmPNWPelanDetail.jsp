    ...
    <td ><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td> #if ($modePopup == 'new')
            <input name="cmdSimpan" type="button" value="Simpan" onClick="simpanPelan('$idPermohonan')" />
            ...
            <input name="cmdHapus" type="button" value="Hapus" onClick="hapusPelan('$idDokumen')" >
            #end
            #if ($modePopup == 'update')

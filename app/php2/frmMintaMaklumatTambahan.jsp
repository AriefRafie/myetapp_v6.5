...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td><fieldset>
      <legend>MINTA MAKLUMAT TAMBAHAN</legend>
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>
          <input type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onClick="doMintaMaklumatTambahan()"/>
...
<script>
function doMintaMaklumatTambahan(){
	...
	document.${formName}.hitButton.value = "doMintaMaklumatTambahan";

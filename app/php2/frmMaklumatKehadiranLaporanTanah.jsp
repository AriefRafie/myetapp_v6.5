<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmMaklumatKehadiranDetail.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
      ...
      <table align="center" width="100%">
        ...
        #set ($senaraiKehadiran = "")
        	...
        	<tr>
          		...
          		<td class="$row">
          			<a href="javascript:paparKehadiran($senaraiKehadiran.idPegawaiLaporanTanah)" style="color:#0000FF">$senaraiKehadiran.namaPegawai</a>
          		</td>

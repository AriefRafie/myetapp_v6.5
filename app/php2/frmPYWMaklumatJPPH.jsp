      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td width="70%">$beanMaklumatPejabat.namaPejabat
            <input type="hidden" name="idPejabatJPPH" id="idPejabatJPPH" value="$beanMaklumatPejabat.idPejabat"/></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>Alamat</td>
        ...
        <tr>
          <td colspan="4"><fieldset>
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
                <td>&nbsp;</td>
                <td>Kadar Sewa Bulan ke Bulan (RM)</td>
                <td>:</td>
                <td><input name="txtKadarSewaBulan" type="text" value="$beanMaklumatJPPH.kadarSewaBulan" $readonlyPopup class="$inputTextClassPopup" onblur="validateCurrency(this,this.value,'$beanMaklumatJPPH.kadarSewaBulan')" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Kadar Sewa Bagi 3 Tahun (RM)</td>
                <td>:</td>
                <td><input name="txtKadarSewaTahun" type="text" value="$beanMaklumatJPPH.kadarSewaTahun" $readonlyPopup class="$inputTextClassPopup" onblur="validateCurrency(this,this.value,'$beanMaklumatJPPH.kadarSewaTahun')" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>

...
#foreach($list in $list_KPI_MENUNGGU_APB_A)
...
#foreach($list in $list_KPI_MENUNGGU_APB_B)
...
#foreach($list in $list_KPI_MENUNGGU_APB_C)
#if($list.HARI_TUNGGU <= $SX5 && $list.HARI_TUNGGU > 0)
#set($O1 = $O1 + 1)
#end
#if($list.HARI_TUNGGU <= $SX6 && $list.HARI_TUNGGU >= $SST5 && $list.HARI_TUNGGU > 0)
#set($O2 = $O2 + 1)
#end
#if($list.HARI_TUNGGU >= $SST6)
#set($O3 = $O3 + 1)
#end
#end


#foreach($list in $list_KPI_MENUNGGU_APB_D)
#if($list.HARI_TUNGGU <= $SX7 && $list.HARI_TUNGGU > 0)
#set($P1 = $P1 + 1)
#end
#if($list.HARI_TUNGGU <= $SX8 && $list.HARI_TUNGGU >= $SST7 && $list.HARI_TUNGGU > 0)
#set($P2 = $P2 + 1)
#end
#if($list.HARI_TUNGGU >= $SST8)
#set($P3 = $P3 + 1)
#end
#end

#foreach($list in $list_KPI_MENUNGGU_APB_E)
#if($list.HARI_TUNGGU <= $SX9 && $list.HARI_TUNGGU > 0)
#set($Q1 = $Q1 + 1)
#end
#if($list.HARI_TUNGGU <= $SX10 && $list.HARI_TUNGGU >= $SST9 && $list.HARI_TUNGGU > 0)
#set($Q2 = $Q2 + 1)
#end
#if($list.HARI_TUNGGU >= $SST10)
#set($Q3 = $Q3 + 1)
#end
#end


#foreach($list in $list_KPI_MENUNGGU_APB_F)
#if($list.HARI_TUNGGU <= $SX11 && $list.HARI_TUNGGU > 0)
#set($R1 = $R1 + 1)
#end
#if($list.HARI_TUNGGU <= $SX12 && $list.HARI_TUNGGU >= $SST11 && $list.HARI_TUNGGU > 0)
#set($R2 = $R2 + 1)
#end
#if($list.HARI_TUNGGU >= $SST12)
#set($R3 = $R3 + 1)
#end
#end
...
#foreach($list in $listMaklumatKPIAPB)
#set($B1 = $list.B1)
#set($B2 = $list.B2)
#set($B3 = $list.B3)
#set($B4 = $list.B4)
...
#set($LOT_DISELESAI = $list.LOT_DISELESAI)
  ...
  <a href="javascript:javascript:setP()"><font color="blue">Maklumat Penetapan Sasaran KPI</font> #if($portal_role == "(PHP)AdminPHP")
...
<tr>
  ...
  <tr>
      <td width="100%" colspan="4"><div align="center"><strong>URUSAN : PERMOHONAN LESEN PASIR DIBAWAH AKTA PELANTAR BENUA (APB) 1966</strong></div></td>
      </tr>
  ...
  <tr>
    <td valign="top">a)</td>
    <td valign="top" >Bermula Pendaftaran <strong>SEHINGGA</strong> hantar surat meminta Ulasan dari KJT dan JUPEM</td>
  ...
  <tr>
    <td valign="top">b)</td>
    <td >Terima Ulasan-ulasan KJT dan JUPEM <strong>SEHINGGA</strong> selesai menyediakan kertas kerja untuk mesyuarat Jawatankuasa (J/K) One Stop Centre</td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td valign="top">c)</td>
    <td >Terima keputusan mesyuarat J/K One Stop Centre <strong>SEHINGGA</strong> menghantar Kertas Ringkasan Permohonan kepada Menteri NRE</td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td valign="top">d)</td>
    <td ><p>Terima keputusan Dasar dari Menteri NRE <strong>SEHINGGA</strong>  menghantar surat mendapatkan maklumat/kelulusan EIA dan Hidrografi </p></td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td>e)</td>
    <td >Terima kelulusan EIA dan Hidrographi <strong>SEHINGGA</strong> hantar surat kepada Pemohon untuk membuat bayaran sebelum pengeluaran Lesen </td>
  ...
  <tr>
    <td>f)</td>
    <td >Terima pengesahan Pemohon telah membuat bayaran serta memenohi syarat <strong>SEHINGGA</strong> Penyediaan Lesen dan Memo kepada Menteri NRE</td>
    <td><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td>g)</td>
    <td >Terima kelulusan dari Menteri NRE <strong>SEHINGGA</strong> dihantar kepada pemohon serta salinan kepada pihak berkuasa yang wajib.</td>
    <td><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
   ...
   <tr>
    <td >a)</td>
    <td >
   Menunggu ulasan dari Jabatan Teknikal (JT)</td>
  ...
  <tr>
    <td>b)</td>
    <td>Menunggu keputusan mesyuarat J/K Penyewaan</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
  ...
  <tr>
    <td>c)</td>
    <td>Menunggu respon tawaran serta sewa pertama/wang premium</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
  ...
  <tr>
    <td>d)</td>
    <td>Menunggu Peguam Kanan Persekutuan perakui Deraf Perjanjian </td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
  ...
  <tr>
    <td>e)</td>
    <td>Menunggu Pemohon menanda tangani Perjanjian</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
  ...
  <tr>
    <td>f)</td>
    <td>Menunggu Pemohon matikan setem Perjanjian</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
...
<tr>
      ...
      <tr>
      <td width="100%"><div align="center"><strong>URUSAN : PERMOHONAN LESEN PASIR DIBAWAH AKTA PELANTAR BENUA (APB) 1966</strong></div></td>
      </tr>
      <tr>
...
<table width="100%">
  ...
  <tr class="table_headerkpi">
   ...
   <tr >
    <td class="row2"><p>Bermula Pendaftaran <strong>SEHINGGA</strong> hantar surat meminta Ulasan dari KJT dan JUPEM</p></td>
  <td class="row2">
    ...
    <table width="100%" class="table_headerkpi">
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Laporan KJT dan JUPEM </td>
       </tr>
     </table>        </td>
     </tr>
     <tr>
     <td width="60%"><div align="right">&lt; $SX1 hari
      ...
      <td bgcolor="#33FF99" width="40%" >
        ...
        <div align="center">
         ...
         <a style="cursor:pointer" onClick="popup('13','$SX1','0','A','Menunggu Laporan KJT dan JUPEM < $SX1 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M1</font></strong></a>    
     ...
     $SST1 - $SX2 hari
      ...
      <td bgcolor="yellow" >
       ...
       <a style="cursor:pointer" onClick="popup('13','$SST1','$SX2','B','Menunggu Laporan KJT dan JUPEM $SST1 - $SX2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST2 hari
      ...
      <td  bgcolor="red"> <div align="center">
        <a style="cursor:pointer" onClick="popup('13','$SST2','0','C','Menunggu Laporan KJT dan JUPEM > $SST2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M3</font></strong></a> 
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Keputusan Mesyuarat J/K One Stop Centre</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX3
      ...
      <td  bgcolor="#33FF99" width="40%" > <div align="center">
          ...
          <a style="cursor:pointer" onClick="popup('14','$SX3','0','A','Menunggu Keputusan Mesyuarat J/K One Stop Centre < $SX3 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N1</font></strong></a>
     ...
     <td><div align="right">$SST3 - $SX4 hari
      ...
      <div align="center">
       ...
       <a style="cursor:pointer" onClick="popup('14','$SST3','$SX4','B','Menunggu Keputusan Mesyuarat J/K One Stop Centre $SST3 - $SX4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST4 hari
      ...
      <td bgcolor="red" >
      <div align="center">
       <a style="cursor:pointer" onClick="popup('14','$SST4','0','C','Menunggu Keputusan Mesyuarat J/K One Stop Centre > $SST4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Keputusan Dasar dari Menteri NRE</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt;       $SX5 hari</div></td>
      <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
        <a style="cursor:pointer" onClick="popup('15','$SX5','0','A','Menunggu Keputusan Dasar dari Menteri NRE < $SX5 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O1</font></strong></a>
     ...
     <td><div align="right"> $SST5 - $SX6 hari
      ...
      <td bgcolor="yellow" >
       <div align="center">
          <a style="cursor:pointer" onClick="popup('15','$SST5','$SX6','B','Menunggu Keputusan Dasar dari Menteri NRE $SST5 - $SX6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST6  hari
      ...
      <td bgcolor="red" >
       ...
       <div align="center">
        <a style="cursor:pointer" onClick="popup('15','$SST6','0','C','Menunggu Keputusan Dasar dari Menteri NRE > $SST6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Maklumat/Keputusan EIA dan Hidgrografi</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX7       hari</div></td>
       <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
       <a style="cursor:pointer" onClick="popup('16','$SX7','0','A','Menunggu Maklumat/Keputusan EIA dan Hidgrografi < $SX7 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$P1</font></strong></a>
     ...
     <td><div align="right"> $SST7 - $SX8 hari
      ...
      <td bgcolor="yellow" >
       <div align="center">
        <a style="cursor:pointer" onClick="popup('16','$SST7','$SX8','B','Menunggu Maklumat/Keputusan EIA dan Hidgrografi $SST7 - $SX8 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$P2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST8  hari
      ...
      <td bgcolor="red" >
       ...
       <div align="center">
         <a style="cursor:pointer" onClick="popup('16','$SST8','0','C','Menunggu Maklumat/Keputusan EIA dan Hidgrografi > $SST8 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$P3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Pemohon Membuat Bayaran </td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX9       hari</div></td>
       <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
         <a style="cursor:pointer" onClick="popup('17','$SX9','0','A','Menunggu Pemohon Membuat Bayaran < $SX9 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$Q1</font></strong></a>
     ...
     <td><div align="right"> $SST9 - $SX10 hari
      ...
      <td bgcolor="yellow" >
       <div align="center">
        <a style="cursor:pointer" onClick="popup('17','$SST9','$SX10','B','Menunggu Pemohon Membuat Bayaran $SST9 - $SX10 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$Q2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST10  hari
      ...
      <td bgcolor="red" >
       ...
       <div align="center">
        <a style="cursor:pointer" onClick="popup('17','$SST10','0','C','Menunggu Pemohon Membuat Bayaran > $SST10 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$Q3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Memo dan Kelulusan Lesen dari Menteri NRE</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX11       hari</div></td>
       <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
         <a style="cursor:pointer" onClick="popup('18','$SX11','0','A','Menunggu Memo dan Kelulusan Lesen dari Menteri NRE < $SX11 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$R1</font></strong></a>
     ...
     <td><div align="right"> $SST11 - $SX12 hari
      ...
      <td bgcolor="yellow" >
       <div align="center">
         <a style="cursor:pointer" onClick="popup('18','$SST11','$SX12','B','Menunggu Memo dan Kelulusan Lesen dari Menteri NRE $SST11 - $SX12 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$R2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST12  hari
      ...
      <td bgcolor="red" >
       ...
       <div align="center">
        <a style="cursor:pointer" onClick="popup('18','$SST12','0','C','Menunggu Memo dan Kelulusan Lesen dari Menteri NRE > $SST12 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$R3</font></strong></a>
 ...
 <tr>
      <td colspan="6" >Menunggu Laporan KJT dan JUPEM </td>
  </tr>
  
  <tr>
    <td class="row2">Terima Ulasan-ulasan KJT dan JUPEM <strong>SEHINGGA</strong> selesai menyediakan kertas kerja untuk mesyuarat Jawatankuasa (J/K) One Stop Centre</td>
    <td class="row2"><div align="center">
      <strong>$SS2</strong>
  ...
  <tr>
      ...
      Menunggu keputusan mesyuarat J/K One Stop Centre</td>
  </tr>
  
   <tr>
    <td class="row2"><p>Terima keputusan mesyuarat J/K One Stop Centre <strong>SEHINGGA</strong> menghantar Kertas Ringkasan Permohonan kepada Menteri NRE</p></td>
    <td class="row2"><div align="center">
      <strong>$SS3</strong>
   ...
   <tr>
      <td colspan="6">Menunggu Keputusan Dasar dari Menteri NRE</td>
  </tr>
   
  
   <tr>
    <td class="row2"><p>Terima keputusan Dasar dari Menteri NRE <strong>SEHINGGA</strong>  menghantar surat mendapatkan maklumat/kelulusan EIA dan Hidrografi </p></td>
    <td class="row2"><div align="center">
      <strong>$SS4</strong>
  ...
  <tr>
      <td colspan="6">Menunggu Maklumat/Keputusan EIA dan Hidrografi</td>
  </tr>
  <tr>
    <td class="row2">Terima kelulusan EIA dan Hidrographi <strong>SEHINGGA</strong> hantar surat kepada Pemohon untuk membuat bayaran sebelum pengeluaran Lesen </td>
    <td class="row2"><div align="center">
      <strong>$SS5</strong>
    ...
    <div align="center" id="E5">     </div></td>
    <td class="row2">
     <input name="F5T" type="hidden" id="F5T" size="5" maxlength="5" >
    <div align="center" id="F5">     </div></td>
  </tr>
  
    <tr>
      <td colspan="6">Menunggu Pemohon membuat Bayaran </td>
  </tr>
  
  <tr>
    <td class="row2">Terima pengesahan Pemohon telah membuat bayaran serta memenohi syarat <strong>SEHINGGA</strong> Penyediaan Lesen dan Memo kepada Menteri NRE</td>
     <td class="row2"><div align="center">
      <strong>$SS6</strong>
    ...
    <div align="center" id="E6">     </div></td>
    <td class="row2">
    
    <input name="F6T" type="hidden" id="F6T" size="5" maxlength="5" >
    <div align="center" id="F6">     </div></td>
    </tr>
    
     <tr>
      <td colspan="6">Menunggu Memo dan Kelulusan Lesen Dari Menteri NRE </td>
  </tr>
    
    <tr>
    <td class="row2">Terima kelulusan dari Menteri NRE <strong>SEHINGGA</strong> dihantar kepada pemohon serta salinan kepada pihak berkuasa yang wajib.</td>
    <td class="row2"><div align="center">
      <strong>$SS7</strong>
    ...
    <div align="center" id="E7">     </div></td>
    <td class="row2">
     <input name="F7T" type="hidden" id="F7T" size="5" maxlength="5" >
    <div align="center" id="F7">     </div></td>
    </tr>

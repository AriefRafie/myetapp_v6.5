  ...
  <tr>
    <td><fieldset>
      ...
      <table width="100%">
        ...
        <tr >
          <td class="row2">Mendaftar Permohonan <strong>SEHINGGA</strong> hantar surat kepada Jabatan Teknikal untuk mendapat ulasan.</td>
          ...
          <td  rowspan="7" colspan="2" valign="top"><table width="100%" class="table_headerkpi">
              <tr class="row2">
                <td width="60%"><table width="100%">
                    <tr>
                      ...
                      <td width="85%">Bil. Permohonan baru diterima</td>
                    </tr>
                  </table></td>
              ...
              <tr class="row2">
                <td colspan="2"><table width="100%">
                    <tr>
                      <td width="10%" height="21"  valign="top">3.</td>
                    ...
                    <tr>
                      <td colspan="2"><table width="100%">
                          <tr>
                            ...
                            <td width="85%">Menunggu respon dari KJP berminat.</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2"><table width="100%">
                          <tr>
                            ...
                            <td width="85%">Menunggu Keputusan Mesyuarat.</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
        ...
        <tr>
          <td class="row2">Terima respon dari KJP <strong>SEHINGGA</strong> selesai menyediakan Kertas Cadangan serta hantar ke mesyuarat.</td>
        ...
        <tr>
          <td colspan="6">Menunggu Keputusan Mesyuarat.</td>
        </tr>
        <tr>
          <td class="row2">Terima keputusan Mesyuarat <strong>SEHINGGA</strong> surat Tawaran dihantar ke KJP.</td>

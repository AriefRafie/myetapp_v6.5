...
#foreach($list in $list_KPI_MENUNGGU_PELEPASAN_A)
...
#foreach($list in $list_KPI_MENUNGGU_PELEPASAN_B)
...
#foreach($list in $list_KPI_MENUNGGU_PELEPASAN_C)
...
#foreach($list in $list_KPI_MENUNGGU_PELEPASAN_D)
...
#foreach($list in $listMaklumatKPIPelepasan)
#set($B1 = $list.B1)
#set($B2 = $list.B2)
#set($B3 = $list.B3)
#set($B4 = $list.B4)
...
<tr>
  ...
  <tr>
      <td width="100%" colspan="4"><div align="center"><strong>URUSAN : PELEPASAN</strong></div></td>
      </tr>
  ...
  <tr>
    <td valign="top">a)</td>
    <td >Mendaftar Permohonan <strong>SEHINGGA</strong> menghantar serentak surat meminta Ulasan dari KJP &amp; KJT, Laporan Tanah JKPTG(N) dan Nilaian JPPH</td>
  ...
  <tr>
    <td valign="top">b)</td>
    <td >Terima lengkap Ulasan KJP &amp; KJT, Laporan Tanah JKPTG(N) dan Nilaian JPPH <strong>SEHINGGA</strong> menghantar Kertas Cadangan kepada Menteri Kewangan</td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td valign="top">c)</td>
    <td >Terima Keputusan Menteri Kewangan <strong>SEHINGGA</strong> Minit Ceraian dihantar ke KSU </td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td valign="top">d)</td>
    <td ><p>Terima Kelulusan Menteri NRE <strong>SEHINGGA</strong> Borang 12A/12B dihantar kpd Pemohon</p></td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td>e)</td>
    <td >Terima surat pengesahan bayaran Pampasan <strong>SEHINGGA</strong> surat Keputusan dihantar kepada Pemohon.  TAMAT</td>
  ...
  <tr>
   ...
   <tr>
    ...
    <div>Menunggu Ulasan KJP</div>
   
    <div>Menunggu Ulasan KJT</div> <div>Menunggu Laporan Lawatan Tapak (Laporan Tanah) dari JKPTG(N)</div><div>Menunggu Nilaian JPPH</div>
  ...
  <tr>
    <td>d)</td>
    <td>Menunggu Pemohon Buat Bayaran Pampasan</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
...
<tr>
      ...
      <tr>
      <td width="100%"><div align="center"><strong>URUSAN : PELEPASAN</strong></div></td>
      </tr>
      <tr>
...
<table width="100%">
  ...
  <tr class="table_headerkpi">
   ...
   <tr >
    <td class="row2"><p>Mendaftar Permohonan <strong>SEHINGGA</strong> menghantar serentak surat meminta Ulasan dari KJP &amp; KJT, Laporan Tanah JKPTG(N) dan Nilaian JPPH</p></td>
  <td class="row2">
    ...
    <table width="100%" class="table_headerkpi">
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">
         Menunggu Ulasan KJP / KJT / Nilaian JPPH / Laporan Lawatan Tapak
         </td>
       </tr>
     </table>        </td>
     </tr>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Pemohon Buat Bayaran Pampasan</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     ...
     <td><div align="right">&gt; $SST8  hari
      ...
      <td colspan="6"><div>Menunggu Ulasan KJP</div><div>Menunggu Ulasan KJT</div> <div>Menunggu Laporan Lawatan Tapak (Laporan Tanah) dari JKPTG(N)</div><div>Menunggu Nilaian JPPH</div></td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td class="row2"><p>Terima Keputusan Menteri Kewangan <strong>SEHINGGA</strong> Minit Ceraian dihantar ke KSU </p></td>
    <td class="row2"><div align="center">
      <strong>$SS3</strong>
   ...
   <tr>
    <td class="row2"><p>Terima Kelulusan Menteri NRE <strong>SEHINGGA</strong> Borang 12A/12B dihantar kpd Pemohon</p></td>
    <td class="row2"><div align="center">
      <strong>$SS4</strong>
  ...
  <tr>
   <td colspan="6">Menunggu Pemohon Buat Bayaran Pampasan</td>
  </tr>
  <tr>
    <td class="row2">Terima surat pengesahan bayaran Pampasan <strong>SEHINGGA</strong> surat Keputusan dihantar kepada Pemohon.  TAMAT</td>
    <td class="row2"><div align="center">
      <strong>$SS5</strong>

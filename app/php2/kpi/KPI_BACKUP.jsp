...
#foreach($list in $list_KPI_MENUNGGU_PENYEWAAN_A)
...
#foreach($list in $list_KPI_MENUNGGU_PENYEWAAN_B)
...
#foreach($list in $list_KPI_MENUNGGU_PENYEWAAN_C)
...
#foreach($list in $list_KPI_MENUNGGU_PENYEWAAN_D)
...
#foreach($list in $list_KPI_MENUNGGU_PENYEWAAN_E)
...
#foreach($list in $list_KPI_MENUNGGU_PENYEWAAN_F)
...
#foreach($list in $listMaklumatKPIPenyewaan)
#set($B1 = $list.B1)
#set($B2 = $list.B2)
#set($B3 = $list.B3)
#set($B4 = $list.B4)
...
<tr>
  ...
  <tr>
      <td width="100%" colspan="4"><div align="center"><strong>URUSAN : PENYEWAAN (Tanah / Bangunan / Hasil) </strong></div></td>
      </tr>
  ...
  <tr>
    <td valign="top">a)</td>
    <td valign="top" >Mendaftar Permohonan <strong>SEHINGGA</strong> meminta ulasan dari Jabatan Teknikal (JT)</td>
  ...
  <tr>
    <td valign="top">b)</td>
    <td >Terima ulasan JT <strong>SEHINGGA</strong> selesai penyediaan Laporan Tanah (selepas lawatan </td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td valign="top">c)</td>
    <td >Penyediaan Kertas Ringkas <strong>SEHINGGA</strong> menghantar untuk mesyuarat J/K Penyewaan</td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td valign="top">d)</td>
    <td ><p>Terima keputusan mesyuarat J/K Penyewaan <strong>SEHINGGA</strong> surat Tawaran Perjanjian dihantar kepada Pemohon</p></td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td>e)</td>
    <td >Terima 4 salinan Perjanjian telah dimatikan setem dari Pemohon <strong>SEHINGGA</strong> salinan dihantar &amp; sah diterima edaran ke JKPTG(N), PTP, PT Hasil. TAMAT</td>
...
<tr>
      ...
      <tr>
      <td width="100%"><div align="center"><strong>URUSAN : PENYEWAAN (Tanah / Bangunan / Hasil) </strong></div></td>
      </tr>
      <tr>
...
<table width="100%">
  ...
  <tr class="table_headerkpi">
   ...
   <tr >
    <td class="row2"><p>Mendaftar Permohonan <strong>SEHINGGA</strong> meminta ulasan dari Jabatan Teknikal (JT)</p></td>
  <td class="row2">
    ...
    <table width="100%" class="table_headerkpi">
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu ulasan dari Jabatan Teknikal (JT) </td>
       </tr>
     </table>        </td>
     </tr>
     <tr>
     <td width="60%"><div align="right">&lt; $SX1 hari
      ...
      <td bgcolor="#33FF99" width="40%" >
        ...
        <div align="center">
         ...
         <a style="cursor:pointer" onClick="popup('4','$SX1','0','A','Menunggu Ulasan KJP / KJT / Nilaian JPPH / Laporan Lawatan Tapak < $SX1 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M1</font></strong></a>    
     ...
     $SST1 - $SX2 hari
      ...
      <td bgcolor="yellow" >
       ...
       <a style="cursor:pointer" onClick="popup('4','$SST1','$SX2','B','Menunggu Ulasan KJP / KJT / Nilaian JPPH / Laporan Lawatan Tapak $SST1 - $SX2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST2 hari
      ...
      <td  bgcolor="red"> <div align="center">
        <a style="cursor:pointer" onClick="popup('4','$SST2','0','C','Menunggu Ulasan KJP / KJT / Nilaian JPPH / Laporan Lawatan Tapak > $SST2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M3</font></strong></a> 
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu keputusan mesyuarat J/K Penyewaan</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX3
      ...
      <td  bgcolor="#33FF99" width="40%" > <div align="center">
          ...
          <a style="cursor:pointer" onClick="popup('5','$SX3','0','A','Menunggu Keputusan dari Menteri Kewangan < $SX3 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N1</font></strong></a>
     ...
     <td><div align="right">$SST3 - $SX4 hari
      ...
      <div align="center">
       ...
       <a style="cursor:pointer" onClick="popup('5','$SST3','$SX4','B','Menunggu Keputusan dari Menteri Kewangan $SST3 - $SX4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST4 hari
      ...
      <td bgcolor="red" >
      <div align="center">
       <a style="cursor:pointer" onClick="popup('5','$SST4','0','C','Menunggu Keputusan dari Menteri Kewangan > $SST4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu respon tawaran serta bayaran Sewa Bulan Pertama/Wang Premium dari Pemohon</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt;       $SX5 hari</div></td>
      <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
        <a style="cursor:pointer" onClick="popup('6','$SX5','0','A','Menunggu Perakuan KSU seterusnya Kelulusan Menteri NRE < $SX5 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O1</font></strong></a>
     ...
     <td><div align="right"> $SST5 - $SX6 hari
      ...
      <td bgcolor="yellow" >
       <div align="center">
          <a style="cursor:pointer" onClick="popup('6','$SST5','$SX6','B','Menunggu Perakuan KSU seterusnya Kelulusan Menteri NRE $SST5 - $SX6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST6  hari
      ...
      <td bgcolor="red" >
       ...
       <div align="center">
        <a style="cursor:pointer" onClick="popup('6','$SST6','0','C','Menunggu Perakuan KSU seterusnya Kelulusan Menteri NRE > $SST6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Pemohon menandatangani dan memulangkan kembali Perjanjian </td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX7       hari</div></td>
       <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
       <a style="cursor:pointer" onClick="popup('7','$SX7','0','A','Menunggu Pemohon Buat Bayaran Pampasan < $SX7 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$P1</font></strong></a>
     ...
     <td><div align="right"> $SST7 - $SX8 hari
      ...
      <td bgcolor="yellow" >
       <div align="center">
        <a style="cursor:pointer" onClick="popup('7','$SST7','$SX8','B','Menunggu Pemohon Buat Bayaran Pampasan $SST7 - $SX8 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$P2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST8  hari
      ...
      <td bgcolor="red" >
       ...
       <div align="center">
         <a style="cursor:pointer" onClick="popup('7','$SST8','0','C','Menunggu Pemohon Buat Bayaran Pampasan > $SST8 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$P3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Pemohon matikan setem Perjanjian</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
 ...
 <tr>
      ...
      Menunggu ulasan dari Jabatan Teknikal (JT)
       
      </td>
  </tr>
  
  <tr>
    <td class="row2">Terima ulasan JT <strong>SEHINGGA</strong> selesai penyediaan Laporan Tanah (selepas lawatan tapak)</td>
    <td class="row2"><div align="center">
      <strong>$SS2</strong>
   ...
   <tr>
    <td class="row2"><p>Penyediaan Kertas Ringkas <strong>SEHINGGA</strong> menghantar untuk mesyuarat J/K Penyewaan</p></td>
    <td class="row2"><div align="center">
      <strong>$SS3</strong>
   ...
   <tr>
      <td colspan="6">Menunggu keputusan mesyuarat J/K Penyewaan</td>
  </tr>
   
  
   <tr>
    <td class="row2"><p>Terima keputusan mesyuarat J/K Penyewaan <strong>SEHINGGA</strong> surat Tawaran Perjanjian dihantar kepada Pemohon</p></td>
    <td class="row2"><div align="center">
      <strong>$SS4</strong>
  ...
  <tr>
      <td colspan="6">Menunggu respon tawaran serta bayaran Sewa Bulan Pertama/Wang Premium dari Pemohon</td>
  </tr>
  <tr>
    <td class="row2">Terima pengesahan Tawaran dari Pemohon <strong>SEHINGGA</strong> Deraf Perjanjian di hantar kepada Peguam Kanan Persekutuan</td>
    <td class="row2"><div align="center">
      <strong>$SS5</strong>
    ...
    <tr>
      <td colspan="6">Menunggu Peguam Kanan Persekutuan (LA) Perakui Deraf Perjanjian</td>
  </tr>
  
  <tr>
    <td class="row2">Terima Perjanjian telah diperakui <strong>SEHINGGA</strong> dihantar kepada Pemohon</td>
     <td class="row2"><div align="center">
      <strong>$SS6</strong>
    ...
    <div align="center" id="F6">     </div></td>
     ...
     <tr>
      <td colspan="6">Menunggu Pemohon menandatangani dan memulangkan kembali Perjanjian </td>
  </tr>
    
    <tr>
    <td class="row2">Terima Perjanjian ditandatangani Pemohon &amp; PTP <strong>SEHINGGA</strong> hantar ke Pemohon  matikan Setem</td>
    <td class="row2"><div align="center">
      <strong>$SS7</strong>
    ...
    <tr>
      <td colspan="6">Menunggu Pemohon matikan setem Perjanjian</td>
  </tr>
    
    
    <tr>
    <td class="row2">Terima 4 salinan Perjanjian telah dimatikan setem dari Pemohon <strong>SEHINGGA</strong> salinan dihantar &amp; sah diterima edaran ke JKPTG(N), PTP, PT Hasil. TAMAT</td>
    <td class="row2"><div align="center">
      <strong>$SS8</strong>
      <input name="B8" type="hidden" id="B8" size="5" maxlength="5" value="$SS8" style="text-align:center" onKeyUp="A8()">
    </div></td>
    <td class="row2"><div align="center">
        <strong>$C8</strong>
    ...
    <td class="row2">
      <input name="E8T" type="hidden" id="E8T" size="5" maxlength="5" >
    <div align="center" id="E8">     </div></td>
    <td class="row2">
     <input name="F8T" type="hidden" id="F8T" size="5" maxlength="5" >
    <div align="center" id="F8">     </div></td>
    </tr>

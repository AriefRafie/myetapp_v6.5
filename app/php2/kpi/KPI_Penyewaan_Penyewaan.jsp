...
<tr>
  ...
  <tr>
      <td width="100%" colspan="4"><div align="center"><strong>URUSAN : PENYEWAAN 
  ...
  <tr>
    ...
    <div>Menunggu respon tawaran serta bayaran Sewa Bulan Pertama/Wang Premium dari Pemohon</div>
      <div>Menunggu Peguam Kanan Persekutuan (LA) Perakui Deraf Perjanjian</div>
      <div>Menunggu Pemohon menandatangani dan memulangkan kembali Perjanjian</div>
      <div>Menunggu Pemohon matikan setem Perjanjian</div>
...
<tr>
      ...
      <tr>
      <td width="100%"><div align="center"><strong>URUSAN : PENYEWAAN 
        #if($!socSuburusan == "36")
      (TANAH)
      #elseif($!socSuburusan == "35")
      (BANGGUNAN)
    ...
    <table width="100%" class="table_headerkpi">
     ...
     <td width="60%"><div align="right">&lt; $SX1 hari
      ...
      <td bgcolor="#33FF99" width="40%" >
        ...
        <div align="center">
         ...
         <a style="cursor:pointer" onClick="popup('10','$SX1','0','A','Menunggu ulasan dari Jabatan Teknikal (JT) < $SX1 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M1</font></strong></a>    
     ...
     $SST1 - $SX2 hari
      ...
      <td bgcolor="yellow" >
       ...
       <a style="cursor:pointer" onClick="popup('10','$SST1','$SX2','B','Menunggu ulasan dari Jabatan Teknikal (JT) $SST1 - $SX2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST2 hari
      ...
      <td  bgcolor="red"> <div align="center">
        <a style="cursor:pointer" onClick="popup('10','$SST2','0','C','Menunggu ulasan dari Jabatan Teknikal (JT) > $SST2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M3</font></strong></a> 
     ...
     <td width="60%"><div align="right">&lt; $SX3
      ...
      <td  bgcolor="#33FF99" width="40%" > <div align="center">
          ...
          <a style="cursor:pointer" onClick="popup('11','$SX3','0','A','Menunggu keputusan mesyuarat J/K Penyewaan < $SX3 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N1</font></strong></a>
     ...
     <td><div align="right">$SST3 - $SX4 hari
      ...
      <div align="center">
       ...
       <a style="cursor:pointer" onClick="popup('11','$SST3','$SX4','B','Menunggu keputusan mesyuarat J/K Penyewaan $SST3 - $SX4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST4 hari
      ...
      <td bgcolor="red" >
      <div align="center">
       <a style="cursor:pointer" onClick="popup('11','$SST4','0','C','Menunggu keputusan mesyuarat J/K Penyewaan > $SST4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
      ...
      Menunggu respon tawaran serta bayaran Sewa Bulan Pertama/Wang Premium dari Pemohon, Menunggu Peguam Kanan Persekutuan (LA) Perakui Deraf Perjanjian, Menunggu Pemohon menandatangani dan memulangkan kembali Perjanjian & Menunggu Pemohon matikan setem Perjanjian</div>
     ...
     <td width="60%"><div align="right">&lt;       $SX5 hari</div></td>
      <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
        <a style="cursor:pointer" onClick="popup('12','$SX5','0','A','Menunggu respon tawaran, Deraf Perjanjian, Pemohon menandatangani dan memulangkan kembali Perjanjian & Pemohon matikan setem < $SX5 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O1</font></strong></a>
     ...
     <td><div align="right"> $SST5 - $SX6 hari
      ...
      <td bgcolor="yellow" >
       <div align="center">
          <a style="cursor:pointer" onClick="popup('12','$SST5','$SX6','B','Menunggu respon tawaran, Deraf Perjanjian, Pemohon menandatangani dan memulangkan kembali Perjanjian & Pemohon matikan setem $SST5 - $SX6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST6  hari
      ...
      <td bgcolor="red" >
       ...
       <div align="center">
        <a style="cursor:pointer" onClick="popup('12','$SST6','0','C','Menunggu respon tawaran, Deraf Perjanjian, Pemohon menandatangani dan memulangkan kembali Perjanjian & Pemohon matikan setem > $SST6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O3</font></strong></a>

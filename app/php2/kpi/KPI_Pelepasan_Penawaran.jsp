...
#foreach($list in $list_KPI_MENUNGGU_PENAWARAN_A)
...
#foreach($list in $list_KPI_MENUNGGU_PENAWARAN_B)
...
#foreach($list in $list_KPI_MENUNGGU_PENAWARAN_C)
...
#foreach($list in $listMaklumatKPIPenawaran)
#set($B1 = $list.B1)
#set($B2 = $list.B2)
#set($B3 = $list.B3)
#set($B4 = $list.B4)
...
<tr>
  ...
  <tr>
    <td valign="top">d)</td>
    <td ><p>Terima keputusan Mesyuarat J/K Khas <strong>SEHINGGA</strong> surat Tawaran dihantar ke KJP </p></td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td>b)</td>
    <td>Menunggu respon dari KJP yang berminat</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
...
<tr>
      ...
      <tr>
      <td width="100%"><div align="center"><strong>URUSAN : PENAWARAN</strong></div></td>
      </tr>
      <tr>
...
<table width="100%">
    ...
    <table width="100%" class="table_headerkpi">
     ...
     <td width="60%"><div align="right">&lt; $SX1 hari
      ...
      <td bgcolor="#33FF99" width="40%" >
        ...
        <div align="center">
         ...
         <a style="cursor:pointer" onClick="popup('1','$SX1','0','A','Menunggu Ulasan Jabatan Teknikal < $SX1 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M1</font></strong></a>    
     ...
     $SST1 - $SX2 hari
      ...
      <td bgcolor="yellow" >
       ...
       <a style="cursor:pointer" onClick="popup('1','$SST1','$SX2','B','Menunggu Ulasan Jabatan Teknikal $SST1 - $SX2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST2 hari
      ...
      <td  bgcolor="red"> <div align="center">
        <a style="cursor:pointer" onClick="popup('1','$SST2','0','C','Menunggu Ulasan Jabatan Teknikal > $SST2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M3</font></strong></a> 
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu respon dari KJP yang berminat</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX3
      ...
      <td  bgcolor="#33FF99" width="40%" > <div align="center">
          ...
          <a style="cursor:pointer" onClick="popup('2','$SX3','0','A','Menunggu respon dari KJP yang berminat < $SX3 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N1</font></strong></a>
     ...
     <td><div align="right">$SST3 - $SX4 hari
      ...
      <div align="center">
       ...
       <a style="cursor:pointer" onClick="popup('2','$SST3','$SX4','B','Menunggu respon dari KJP yang berminat $SST3 - $SX4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST4 hari
      ...
      <td bgcolor="red" >
      <div align="center">
       <a style="cursor:pointer" onClick="popup('2','$SST4','0','C','Menunggu respon dari KJP yang berminat > $SST4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N3</font></strong></a>
     ...
     <td width="60%"><div align="right">&lt;       $SX5 hari</div></td>
      <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
        <a style="cursor:pointer" onClick="popup('3','$SX5','0','A','Menunggu Keputusan Mesyuarat J/K Khas EPU < $SX5 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O1</font></strong></a>
     ...
     <td><div align="right"> $SST5 - $SX6 hari
      ...
      <td bgcolor="yellow" >
       <div align="center">
          <a style="cursor:pointer" onClick="popup('3','$SST5','$SX6','B','Menunggu Keputusan Mesyuarat J/K Khas EPU $SST5 - $SX6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST6  hari
      ...
      <td bgcolor="red" >
       ...
       <div align="center">
        <a style="cursor:pointer" onClick="popup('3','$SST6','0','C','Menunggu Keputusan Mesyuarat J/K Khas EPU > $SST6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O3</font></strong></a>
  ...
  <tr>
     <td colspan="6">Menunggu respon dari KJP yang berminat</td>
  </tr>
   <tr>
   ...
   <tr>
    <td class="row2"><p>Terima keputusan Mesyuarat J/K Khas <strong>SEHINGGA</strong> surat Tawaran dihantar ke KJP </p></td>
    <td class="row2"><div align="center">
      <strong>$SS4</strong>

...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmPYWLampiranDetail.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
function simpanLampiran(idPermohonan) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmPYWMaklumatPermohonanView&hitButton=simpanLampiran&namaLampiran="+namaLampiran+"&catatanLampiran="+catatanLampiran+"&idPermohonan="+idPermohonan+"&selectedTabUpper=5"+dopost+"&mode=view&flagPopup=openPopupLampiran&modePopup=new";

<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td width="1%">:</td>
    <td width="70%"><input type="text" name="txtNama" id="txtNama" value="$beanMaklumatKehadiran.namaPegawai" size="40" $readonlyPopup class="$inputTextClassPopup" onblur="this.value=this.value.toUpperCase();"/>
    </td>
  </tr>
  #end
  <tr>

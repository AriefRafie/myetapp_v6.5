          ...
          <td colspan="4"><fieldset>
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td width="1%">:</td>
                <td width="70%">
                <select name="socSyor" id="socSyor" style="width:200px;" $readonlyPopup class="$inputTextClassPopup" $inputTextClassPopup>
              ...
              <tr>
                ...
                <td valign="top">:</td>
                <td valign="top"><textarea name="txtCatatanMesyuarat" id="txtCatatanMesyuarat" rows="5" cols="50" $readonlyPopup class="$inputTextClassPopup" >$beanMaklumatMesyuarat.catatan</textarea></td>
              </tr>
            </table>
            </fieldset></td>
        </tr>

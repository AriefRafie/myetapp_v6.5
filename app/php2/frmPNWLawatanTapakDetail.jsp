<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td width="1%" valign="top">:</td>
    <td valign="top"><textarea name="txtLaporanAtasTanah" id="txtLaporanAtasTanah" rows="5" cols="50" $readonly class="$inputTextClass">$beanMaklumatLaporanTanah.laporanAtasTanah</textarea>    </td>
  </tr>
  #if ($mode != 'view') #end
  <tr>
    <td valign="top">&nbsp;</td>
    ...
    <td valign="top">:</td>
    <td valign="top"><textarea name="txtIsuUlasan" id="txtIsuUlasan" rows="5" cols="50" $readonly class="$inputTextClass" >$beanMaklumatLaporanTanah.ulasan</textarea>    </td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top">Catatan</td>
    <td valign="top">:</td>
    <td valign="top"><textarea name="txtCatatan" id="txtCatatan" rows="5" cols="50" $readonly class="$inputTextClass">$beanMaklumatLaporanTanah.catatan</textarea>    </td>
  </tr>
  #if ($mode != 'view') #end
  <tr>

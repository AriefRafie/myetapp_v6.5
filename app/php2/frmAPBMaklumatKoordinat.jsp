              ...
              <tr>
                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                      ...
                      <td width="70%">:
                        <input type="text" name="txtLabelTitik" id="txtLabelTitik" size="3" maxlength="3" $readonly class="$inputTextClass"  value="$beanMaklumatKoordinat.labelTitik"></td>
                    </tr>
                    <tr>
...
&Prime;</td>
  ...
  <tr>
    ...
    <td width="70%"> #if ($mode == 'newKoordinat')
      ...
      <input type="button" name="cmdBatalKoordinat" id="cmdBatalKoordinat" value="Batal" onClick="batalKoordinat()"/>
      #end

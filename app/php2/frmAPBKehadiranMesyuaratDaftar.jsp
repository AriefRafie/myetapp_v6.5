<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td class="$row"><input name="txtNama" type="text" id="txtNama" size="30" />
    </td>
    <td class="$row"><input name="txtAgensi" type="text" id="txtAgensi" size="60" /></td>
    <td class="$row"><input name="txtJawatan" type="text" id="txtJawatan" size="30" /></td>

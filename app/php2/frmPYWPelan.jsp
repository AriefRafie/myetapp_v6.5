...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmPYWPelanDetail.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
function simpanPelan(idLaporanTanah,idPermohonan) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmPYWLawatanTapakView&hitButton=simpanPelan&namaPelan="+namaPelan+"&catatanPelan="+catatanPelan+"&idLaporanTanah="+idLaporanTanah+"&selectedTabUpper=6"+dopost+"&mode=view&flagPopup=openPopupPelan&modePopup=new&idPermohonan="+idPermohonan;
	document.${formName}.method="post";

        ...
        <tr>
          <td valign="top" align="left"><table cellpadding="2" cellspacing="1" border="0" width="100%" class="dashboard_sub" align="left">
              <tr>
                <td width="50%" valign="top"><table width="100%" >
                    <tr>
                      ...
                      <td width="85%"><table width="100%">
                          ...
                          <tr>
                            <td><a href="javascript:gotoSenaraiAkaunSewa()" class="help" title="Senarai Akaun Sewa"> <font color="blue">
                              <li>&nbsp;Senarai Akaun Sewa</li>
                              </font> </a> </td>
                          </tr>
                          <tr>
                ...
                <td width="50%" valign="top"><table width="100%" >
                    <tr>
                      <td width="15%" height="71" align="center" valign="top"><img width="30" height="30" src="../img/applyonline.png" align="center"/></td>
                      <td width="85%"><table width="100%">
                          <tr>
                            <td><b>Tunggakan Sewa</b> </td>
                          </tr>
                          <tr>
                            <td><a href="javascript:gotoSenaraiAkaunSewa()" class="help" title="Tunggakan Sewa"> <font color="blue">
                          ...
                          <td>
                           ...
                           <tr>
                            <td><b>Status Perjanjian</b> </td>
                          </tr>
                          <tr>
                            <td><a href="javascript:gotoSenaraiAkaunSewa()" class="help" title="Perjanjian Aktif"> <font color="blue">
                  ...
                  <!--<table width="100%" border="0">
                    <tr>
                      ...
                      <td width="85%"><table>
                        ...
                        <tr>
                          <td><!--<a href="javascript:alert('dddd')" target="_blank" style="color:#0000FF">Maklumat GIS</a>
                          </td>
                        </tr>
                      </table></td>
                    </tr>
                      ...
                      <td width="85%" ><table width="100%">
                          ...
                          <tr>
                            <td valign="top" width="49%"><font color="blue">
                              <li>Perjanjian Aktif</li>
                              </font></td>
                            <td valign="top" width="1%"> :</td>
                            <td  valign="top" width="50%"><b>$!perjanjianAktif</b></td>
                          </tr>
                          <tr>
                            <td valign="top" width="49%"><font color="blue">
                              <li>Perjanjian Hampir Tamat</li>
                              </font></td>
                            <td valign="top" width="1%"> :</td>
                            <td  valign="top" width="50%"><b>$!perjanjianHampirTamat</b></td>
                          </tr>
                          <tr>
                            <td valign="top" width="49%"><font color="blue">
                              <li>Perjanjian Tamat</li>
                              </font></td>
                            <td valign="top" width="1%"> :</td>
                            <td  valign="top" width="50%"><b>$!perjanjianTamat</b></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
                        ...
                        <div style="height:250" id="div_stat">
                          <table width="100%" >
                            <tr>
                              ...
                              <td width="88%" valign="top"><table width="100%">
                                  <tr>
                                    <td   valign="top" ><b>Carta Status Kutipan Sewa (RM)</b> </td>
                                  </tr>
                                  <tr>
...
function gotoTerimaanCek() {
	document.${formName}.action = "$EkptgUtil.getTabID("Hasil",$portal_role)?_portal_module=ekptg.view.php2.FrmREVBorangTerimaanCekView";
	document.${formName}.submit();
}
function gotoSenaraiAkaunPasir() {
	document.${formName}.action = "$EkptgUtil.getTabID("Hasil",$portal_role)?_portal_module=ekptg.view.php2.FrmREVMemantauBayaranAPBView";
	document.${formName}.submit();
}
function gotoSenaraiPampasanPLP() {
	document.${formName}.action = "$EkptgUtil.getTabID("Hasil",$portal_role)?_portal_module=ekptg.view.php2.FrmREVPampasanPelepasanView";
	document.${formName}.submit();
}
function gotoFLMS() {

...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td width="1%">:</td>
    <td width="70%"><input name="txtNama" type="text" class="$inputTextClassPopup" id="txtNama" value="$beanMaklumatKehadiran.nama" size="50" $readonlyPopup onBlur="this.value=this.value.toUpperCase();"/>    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>

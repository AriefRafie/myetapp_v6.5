      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          ...
          <td width="70%"><select name="idKategori" id="idKategori" onChange="javascript:doChangeKategori()">
              ...
              <option value="4" #if($!idKategori == '4') selected #end >TEMPOH</option>
            </select></td>
        </tr>
        #if($!idKategori == '1')
        <tr>
          <td align="right"><span class="style1">*</span> Tarikh : </td>
          <td><input type="text" name="tarikhHingga" id="tarikhHingga" value="$!tarikhHingga" onblur="check_date(this);" size="9"/>
            <a href="javascript:displayDatePicker('tarikhHingga',false,'dmy');"><img border="0" src="../img/calendar.gif"/></a></td>
        </tr>
        #end
        #if($!idKategori == '2')
        <tr>
...
function janaLaporan() {
	...
	if (idKategori == '1') {
		...
		var url = "../servlet/ekptg.report.php2.REVLaporanPerjanjianSewaHampirTamatHarian?TARIKH_HINGGA="+tarikhHingga;
		...
		var url = "../servlet/ekptg.report.php2.REVLaporanPerjanjianSewaHampirTamatBulanan?BULAN="+bulan+"&TAHUN="+tahun;
		...
		var url = "../servlet/ekptg.report.php2.REVLaporanPerjanjianSewaHampirTamatTahunan?TAHUN="+tahun;
		...
		var url = "../servlet/ekptg.report.php2.REVLaporanPerjanjianSewaHampirTamatJulatTempoh?TARIKH_MULA="+tarikhMula+"&TARIKH_HINGGA="+tarikhHingga;
	}	

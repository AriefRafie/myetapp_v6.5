...
function janaLaporan(){	
	...
	cetakPYWIktKementerianUrusan();
}

function cetakPYWIktKementerianUrusan() {
	var url = "../servlet/ekptg.report.php2.PYWLaporanPermohonanMengikutKementerianTanahDanUrusan?TAHUN="+document.${formName}.txtTahun.value;

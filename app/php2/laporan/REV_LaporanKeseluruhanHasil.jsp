...
function janaLaporan() {
	...
	if (idKategori == '1') {
		...
		var url = "../servlet/ekptg.report.php2.REVLaporanKeseluruhanHasilHarian?TARIKH_MULA="+tarikhMula+"&TARIKH_HINGGA="+tarikhHingga;
		...
		var url = "../servlet/ekptg.report.php2.REVLaporanKeseluruhanHasilBulanan?BULAN="+bulan+"&TAHUN="+tahun+"&BULANSE="+bulanSE+"&TAHUNSE="+tahunSE+"'&BULANTAHUN='"+bulantahun+"'&BULANTAHUNSE='"+bulantahunSE+"'";
		...
		var url = "../servlet/ekptg.report.php2.REVLaporanKeseluruhanHasilTahunan?TAHUN="+tahun+"&TAHUNSE="+tahunSE;
	}	

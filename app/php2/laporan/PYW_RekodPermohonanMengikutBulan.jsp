...
function janaLaporan(){	
	...
	cetakPYWMohonIktBulan();
}

function cetakPYWMohonIktBulan() {
	var url = "../servlet/ekptg.report.php2.PYWRekodPermohonanMengikutBulan?TAHUN="+document.${formName}.txtTahun.value;

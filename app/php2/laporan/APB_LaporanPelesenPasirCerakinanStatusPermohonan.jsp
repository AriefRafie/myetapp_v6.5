...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
         <tr>
          <td width="30%" align="right"><span class="style1">*</span> Status Permohonan</td>
          <td>
          <select name="socStatus" id="socStatus" style="width:120px;" onChange="onChangeValue1(this)" >
                ...
                <option value="4"> RAYUAN </option>
                <option value="5"> LANJUTAN </option>
                
        	#elseif($flagStatus == '2')
        		<option value="0">SILA PILIH</option>
                <option value="1"> KESELURUHAN </option>
                <option value="2" selected="selected"> LULUS </option>
                <option value="3"> TOLAK </option>
                <option value="4"> RAYUAN </option>
                <option value="5"> LANJUTAN </option>
            #elseif($flagStatus == '3')
                ...
                <option value="1"> KESELURUHAN</option>
                <option value="2" > LULUS </option>
                <option value="3" selected="selected"> TOLAK </option>
                <option value="4"> RAYUAN </option>
                <option value="5"> LANJUTAN </option>
            #elseif($flagStatus == '4')
        		<option value="0">SILA PILIH</option>
                ...
                <option value="2" > LULUS </option>
                <option value="3"> TOLAK </option>
                <option value="4" selected="selected"> RAYUAN </option>
                <option value="5"> LANJUTAN </option>
            #elseif($flagStatus == '5')
        		<option value="0">SILA PILIH</option>
                <option value="1"> KESELURUHAN</option>
                ...
                <option value="3"> TOLAK </option>
                <option value="4"> RAYUAN </option>
                <option value="5" selected="selected"> LANJUTAN </option>
            #else
...
function cetakLaporan() {
	...
	var url = "../servlet/ekptg.report.php2.APBLaporanPelesenPasirCerakinanStatusPermohonan?STATUS="+document.${formName}.flagStatus.value+"&TAHUN="+tahun;

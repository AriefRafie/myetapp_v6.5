...
function cetakLaporan() {
	var url = "../servlet/ekptg.report.php2.PLPLaporanTukarGunaTanahMilikPersekutuan?JENIS="+document.${formName}.flagJenis.value+"&TAHUN="+document.${formName}.txtTahun.value;

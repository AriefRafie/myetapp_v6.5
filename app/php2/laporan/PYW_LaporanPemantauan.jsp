...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td><fieldset>
      <legend>CARIAN LAPORAN</legend>
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
      	<tr>
          <td width="30%" align="right"><span class="style1">*</span>Status Penyewaan</td>
          <td>
...
function kosongkan(){
 ...
 document.${formName}.socJenis.value = "0";
 document.${formName}.flagJenis.value = "0";
...
function janaLaporan(){	
	...
	if(document.${formName}.socJenis.value == "0"){
...
function cetakLaporan() {
	...
	var url = "../servlet/ekptg.report.php2.CRBLaporanPenguatkuasaan?JENIS="+document.${formName}.flagJenis.value+"&STATUS="+document.${formName}.flagStatus.value+"&TAHUN="+tahun;

  ...
  <tr>
    <td><fieldset>
      ...
      <tr>
          ...
          <td>
          <!-- <select name="socJenis" id="socJenis" style="width:120px;" onChange="onChangeValue(this)"  $readonly class="$disabled" $disabled> -->
...
function cetakLaporan() {
	var url = "../servlet/ekptg.report.php2.PLPLaporanPenawaranTanahRizabPersekutuan?JENIS="+document.${formName}.flagJenis.value+"&TAHUN="+document.${formName}.txtTahun.value;

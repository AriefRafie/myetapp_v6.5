<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
  	<td>#parse("app/php2/frmREVBayaranDepositAPB.jsp")</td>
  </tr>
  <tr>
  	<td>&nbsp; </td>
  </tr>
  ...
  <tr>
    <td><fieldset>
      <legend><strong>MAKLUMAT DEPOSIT PASIR A</strong></legend>
      <table align="center" width="100%">
        #if ($mode == 'view')
        <tr >
        ...
        <tr>
          ...
          <td class="$row" align="center"><a href="javascript:paparBayaranD('$list.idAkaun')" class="style2">$list.tarikh</a></td>
          #else

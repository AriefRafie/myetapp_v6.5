                      ...
                      <td width="85%" ><table width="100%">
                          ...
                          <tr>
                            <td valign="top" width="49%"><font color="blue">
                              <li>Fail Akta Pelantar Benua</li>
                              </font></td>
                            <td  valign="top" width="1%"> :</td>
                            <td  valign="top" width="50%"><b>$!getFailAPB</b></td>
                          </tr>
                          <tr>
                            <td valign="top" width="49%"><font color="blue">
                              <li>Pelesen Aktif</li>
                            ...
                            <td  valign="top" width="1%"> :</td>
                            <td  valign="top" width="50%"><b>$!pelesenAktif</b></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
...
function gotoOnline() {
	document.${formName}.action = "$EkptgUtil.getTabID("My Info",$portal_role)?_portal_module=ekptg.view.php2.FrmAPBSenaraiFailOnlineView";
	document.${formName}.submit();
}
function gotoAPB() {
...
function gotoKutipanAPB() {
	document.${formName}.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.php2.FrmAPBKutipanDataView";
	document.${formName}.submit();
}
function gotoSenaraiPelesen() {
	document.${formName}.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.php2.FrmSenaraiPelesenView";
	document.${formName}.submit();
}
function gotoFLMS() {

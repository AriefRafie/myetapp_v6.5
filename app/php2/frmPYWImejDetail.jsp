  ...
  <tr>
    <td ><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        #if ($modePopup != 'new')
        #if ($beanMaklumatImejan.jenisMime == 'image') 
        <tr>
          <td width="1%">&nbsp;</td>
          <td width="28%">&nbsp;</td>
          <td width="1%">&nbsp;</td>
          <td width="70%"><img src="../servlet/ekptg.view.php2.FrmDisplayImage?id=$idDokumen" alt="Imej Imej" border="1" width="250" height="250" onclick="cetakImej($idDokumen)"/></td>
        </tr>
        <tr>
          <td width="1%">&nbsp;</td>
          <td width="28%">&nbsp;</td>
        ...
        <tr>
          ...
          <td width="1%">:</td>
          <td width="70%"><a href="javascript:cetakImej($idDokumen)" class="style2"><b>MUAT TURUN IMEJ</b></a></td>
        </tr>
        #end
        #end
        <tr>

<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmPYWPerjanjianTambahanMesyuaratDetail.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td align="center">
    #if ($idStatusPerjanjianTambahan == '1610201')
      <input type="button" name="cmdSeterusnya" id="cmdSeterusnya" value="Seterusnya" onclick="seterusnyaMS()"/>
    #end
    #if ($mode == 'view')

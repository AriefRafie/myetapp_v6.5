<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  #set($idNegeriPemohon=$beanHeader.idNegeriPemohon)
  #set($idKementerianPemohon=$beanHeader.idKementerianPemohon)
  <tr>
    <td width="50%" valign="top"><fieldset>
      <legend><strong>MAKLUMAT PENAWARAN</strong></legend>
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
    ...
    <td width="50%" valign="top"><fieldset>
<!--       <legend><strong>MAKLUMAT PENERIMA TAWARAN</strong></legend> -->
		<legend><strong>KJP Penawar</strong></legend>
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr valign="top">
          <td width="37%" align="right" valign="top">Nama Penawar :</td>

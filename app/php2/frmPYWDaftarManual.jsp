    ...
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td>:</td>
          <td><input name="txtNoFailNegeri" type="text" class="$inputTextClass" id="txtNoFailNegeri" value="$beanMaklumatPermohonan.noFailNegeri" $readonly onblur="this.value=this.value.toUpperCase();" size="50" maxlength="50"/></td>
        </tr>
        <tr>
    ...
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td width="1%">:</td>
          <td width="70%"><select name="socStatusTanah" id="socStatusTanah" onchange="doChangeStatusTanah()" $inputTextClass class="$inputTextClass">
              <option $selected value="0">SILA PILIH</option>
        ...
        <tr>
          <td width="30%">&nbsp;</td>
          <td width="70%"> #if ($mode == 'new')
            <input type="button" name="cmdTolakRingkas" id="cmdTolakRingkas" value="Tolak Ringkas" onclick="doTolakRingkas()"/>
            <input type="button" name="cetak" id="cetak" value="Jana Surat" onclick="cetak()"/>
            #end </td>
        </tr>
        #end
        #end
...
function janaTajuk() {
	...
	if(document.${formName}.socUrusan.value == "12"){
		...
		if(document.${formName}.socSuburusan.value == "30"){
	...
	if(document.${formName}.socUrusan.value == "7"){
		var tujuanBangunan = document.${formName}.txtTujuan.value;
	}
	...
	if(document.${formName}.socUrusan.value == "7"){
		...
		strTajuk = "PERJANJIAN PENYEWAAN RUANG BANGUNAN " + str1 +", " + milikOrRizab +", " + str3 + ", "+ str4 + ", " + str5  + " OLEH " + namaPemohon + " UNTUK TUJUAN " + tujuanBangunan ;
		}else {
		 strTajuk = "PERMOHONAN PENYEWAAN TANAH PERSEKUTUAN " + str1 +", " + milikOrRizab +", " + str3 + ", "+ str4 + ", " + str5  + " OLEH " + namaPemohon + " UNTUK TUJUAN " + tujuanBangunan ;
		}
		...
		strTajuk = "PERMOHONAN MENGELUARKAN " + strTujuan + " DI " +  str1 +", " + milikOrRizab +", " + str3 + ", "+ str4 + ", " + str5  + " OLEH " + namaPemohon ;
	 } else{
		strTajuk;
	 }

    ...
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td width="28%">Nama</td>
          <td width="1%">:</td>
          <td width="70%"><input name="txtNamaPembeliPasir" type="text" class="$inputTextClass" id="txtNamaPembeliPasir" value="$beanMaklumatPembeliPasir.nama" size="43" maxlength="80" $readonly />
          </td>
        </tr>
        <tr>
          ...
          <td>Alamat</td>
          <td>:</td>
          <td><input name="txtAlamat1PembeliPasir" type="text" class="$inputTextClass" id="txtAlamat1PembeliPasir"  value="$beanMaklumatPembeliPasir.alamat1" size="43" maxlength="80" $readonly/></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>:</td>
          <td><input name="txtAlamat2PembeliPasir" type="text" class="$inputTextClass" id="txtAlamat2PembeliPasir"  value="$beanMaklumatPembeliPasir.alamat2" size="43" maxlength="80" $readonly/></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>:</td>
          <td><input name="txtAlamat3PembeliPasir" type="text" class="$inputTextClass" id="txtAlamat3PembeliPasir"  value="$beanMaklumatPembeliPasir.alamat3" size="43" maxlength="80" $readonly/></td>
        </tr>
        <tr>
          <td>#if ($mode == 'newPembeliPasir' ||  $mode == 'updatePembeliPasir')<span class="style1">*</span>#end</td>
          <td>Poskod</td>

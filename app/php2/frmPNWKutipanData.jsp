    ...
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td>:</td>
          <td><input name="txtNoRujukanSurat" type="text" class="$inputTextClass" id="txtNoRujukanSurat" onblur="this.value=this.value.toUpperCase();" value="$beanMaklumatPermohonan.noRujukanSurat" size="50" maxlength="50" $readonly/></td>
        </tr>
        <tr>
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
                ...
                <td width="70%"> #if ($mode == 'new')
                  ...
                  <input type="button" name="cmdPilih" id="cmdPilih" value="Pilih Borang K" onclick="pilihBorangK('$idKategoriPemohon','$idAgensi')"/>
                  #else
...
function checkingExistNoFail() {
	url = "../servlet/ekptg.view.php2.FrmPLPServlet?command=checkingExistNoFail&idSuburusan=32";

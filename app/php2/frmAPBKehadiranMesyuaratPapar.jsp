...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td width="1%">:</td>
    <td width="70%"><input name="txtNama" type="text" class="$inputTextClassPopup" id="txtNama" value="$beanMaklumatKehadiran.nama" size="50" $readonlyPopup />
    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    ...
    <td>:</td>
    <td><input name="txtAgensi" type="text" class="$inputTextClassPopup" id="txtAgensi" value="$beanMaklumatKehadiran.agensi" size="50" $readonlyPopup /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>No Telefon</td>
  ...
  <tr>
    ...
    <td>Jawatan</td>
    <td>:</td>
    <td><input name="txtJawatan" type="text" class="$inputTextClassPopup" id="txtJawatan" value="$beanMaklumatKehadiran.jawatan" size="50" $readonlyPopup /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Pengerusi</td>

<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmPYWMaklumatKJP.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
    ...
    <td><fieldset>
      ...
      <table align="center" width="100%">
        ...
        <tr>
          ...
          #else
          <td class="$row"><a href="javascript:paparMaklumatKJP('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;(ULANGAN $list.bilUlangan)</td>
          #end
          ...
          #else
          <td class="$row" align="center"><a href="#" class="style2" onClick="javascript:cetakPYWSuratUlanganKJP('$idFail','$list.idUlasanTeknikal','$list.bilUlangan')"><img border="0" src="../img/print.gif"/></a></td>
          #end </tr>
        #end
        #else
        <tr>

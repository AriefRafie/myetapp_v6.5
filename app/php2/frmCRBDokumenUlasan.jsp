<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmCRBMaklumatDokumen.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
    ...
    <td><fieldset>
      ...
      <table align="center" width="100%">
        ...
        <tr class="table_header">
          ...
          <td width="29%"><strong>Agensi / Pejabat Negeri</strong></td>
        ...
        <tr>
          ...
          #end
          <td class="$row"> #if($list.idDokumen == 1)
            #if($list.flagKJP == 'PTG' || $list.flagKJP == 'PTD')
          ...
          #if($list.idDokumen == '1')
          #if ($list.bilUlangan == '' || $list.bilUlangan == '0')
          <td class="$row" align="center"><a href="#" class="style2" onClick="javascript:cetakCRBSMUKJP('$idFail','$list.idUlasanTeknikal')"><img border="0" src="../img/print.gif"/></a></td>
          #else
          <td class="$row" align="center"><a href="#" class="style2" onClick="javascript:cetakCRBSuratUlanganKJP('$idFail','$list.idUlasanTeknikal','$list.bilUlangan')"><img border="0" src="../img/print.gif"/></a></td>
          #end
          ...
          #else
          <td class="$row" align="center"><a href="#" class="style2" onClick="javascript:cetakCRBSuratUlanganLT('$idFail','$list.idUlasanTeknikal','$list.bilUlangan')"><img border="0" src="../img/print.gif"/></a></td>
          #end
          #end </tr>
        #end
        #else
...
function doSimpanMaklumatKJT(){
	...
	if(document.${formName}.socDokumen.value == "1") {
		...
		if(document.${formName}.idSuratKe.value == "KJT"){
		...
		} else if((document.${formName}.idSuratKe.value == "PTG") || (document.${formName}.idSuratKe.value == "PTD") || (document.${formName}.idSuratKe.value == "JKPTG")){

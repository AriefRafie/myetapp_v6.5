<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmAPBMaklumatJPS.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td><fieldset>
      ...
      <table align="center" width="100%">
        <tr>
          <td colspan="9" scope="row"><input name="cmdTambah" type="button" value="Tambah" onclick="javascript:doDaftarMaklumatJPS()"/></td>
        </tr>
        ...
        <tr>
          ...
          <td class="$row"><a href="javascript:paparMaklumatJPS('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;<font class="blink" ><span class="style1">$!list.statusHari</span></font></td>
          #else
          <td class="$row"><a href="javascript:paparMaklumatJPS('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;(ULANGAN $list.bilUlangan)&nbsp;&nbsp;<font class="blink" ><span class="style1">$!list.statusHari</span></font></td>
          #end
          ...
          #else
          <td class="$row" align="center"><a href="#" class="style2" onClick="javascript:cetakAPBUlanganSuratMintaUlasanJPS('$idFail','$list.idUlasanTeknikal','$list.bilUlangan')"><img border="0" src="../img/print.gif"/></a></td>
          #end </tr>
        #end
        #else
        <tr>
...
function doDaftarNotifikasi(){
	document.${formName}.flagPopup.value = "openJPS";
...
function paparMaklumatJPS(idUlasanTeknikal){
	document.${formName}.flagPopup.value = "openJPS";
	document.${formName}.modePopup.value = "view";
...
function doSimpanMaklumatJPS(){
	...
	document.${formName}.flagPopup.value = "openJPS";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanMaklumatJPS";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
function doSimpanMaklumatUlanganJPS(){	
	if(document.${formName}.txtTarikhHantar.value == ""){
		alert('Sila masukkan Tarikh Hantar.');
  		document.${formName}.txtTarikhHantar.focus(); 
		return; 
	...
	document.${formName}.flagPopup.value = "openJPS";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanMaklumatUlanganJPS";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
...
function doBatalKemaskiniMaklumatJPS(){
	document.${formName}.flagPopup.value = "openJPS";
	document.${formName}.modePopup.value = "view";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
...
function doSimpanKemaskiniMaklumatJPS(){
	...
	document.${formName}.flagPopup.value = "openJPS";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanKemaskiniMaklumatJPS";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
...
function simpanDokumenJPS(idUlasanTeknikal,idPermohonan) {
	
	if(document.${formName}.fileuploadJPS.value == ""){
		alert('Sila pilih Fail yang Ingin Dimuatnaik.');
  		document.${formName}.fileuploadJPS.focus(); 
		return; 
	}
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView&hitButton=simpanDokumenKJT&selectedTabUpper=6&idPermohonan="+idPermohonan+"&idUlasanTeknikal="+idUlasanTeknikal+"&flagPopup=openJPS&modePopup=view"+dopost;
	document.${formName}.method="post";
...
function cetakAPBUlanganSuratMintaUlasanJPS(idFail,idUlasanTeknikal) {
	var url = "../x/${securityToken}/ekptg.view.php2.FrmAPBPopupCetakLaporanView?idFail="+idFail+"&report=ulanganSuratMintaUlasanJPS&idUlasanTeknikal="+idUlasanTeknikal;

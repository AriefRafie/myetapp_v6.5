    ...
    <td><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td valign="top">:
          	<textarea name="txtkegunaanTanah" id="txtkegunaanTanah" rows="5" cols="50" onBlur="this.value=this.value.toUpperCase();" onKeyUp="textCounter(this.form.txtkegunaanTanah,this.form.remLen,$!saizTxtkegunaanTanah);" onKeyDown="textCounter(this.form.txtkegunaanTanah,this.form.remLen,$!saizTxtkegunaanTanah);" >$!txtkegunaanTanah</textarea>
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
    ...
    <td><fieldset>
      ...
      <table align="center" width="100%">
        ...
        <tr>
          ...
          <td class="$row">&nbsp;</td>
          #end
          <td class="$row">$list.kegunaanTanah</td> 
        </tr>
        #end
        #else
        <tr>
...
function kosongkan() {
	...
	if (document.${formName}.socJenisTanah.value == '0'){
		...
		document.${formName}.txtkegunaanTanah.value = "";
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmPopupSemakanMaklumatTanahView";

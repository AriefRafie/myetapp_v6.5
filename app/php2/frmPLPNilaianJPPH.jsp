    ...
    <td><fieldset>
      ...
      <table align="center" width="100%">
        ...
        <tr>
          ...
          <td class="$row">$list.daerah</td>
          <td class="$row">$list.negeri</td>
          <td class="$row" align="center"><input id="txtNilaiTanahGanti" name="txtNilaiTanahGanti" type="text" value="$list.nilaian" style="text-align:right" $readonly class="$inputTextClass" onblur="total1()">
          ...
          <input name="idTanahGanti" type="hidden" value="$list.idTanahGanti"></td>
        </tr>
        #end
        #else
        <tr>

...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
    ...
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td width="1%" >:</td>
          <td width="70%"><strong>$beanMaklumatPermohonan.noFail</strong>&nbsp;(RAYUAN)
        ...
        <tr>
          ...
          <td valign="top">:</td>
          <td><textarea name="txtPerkara" id="txtPerkara" rows="5" cols="50" $readonly class="$inputTextClass" onblur="this.value=this.value.toUpperCase();" onKeyUp="textCounter(this.form.txtPerkara,this.form.remLen1,$!saizTxtPerkara);" onKeyDown="textCounter(this.form.txtPerkara,this.form.remLen1,$!saizTxtPerkara);" >$beanMaklumatPermohonan.perkara</textarea></td>
        </tr>
        #if ($mode != 'view')
        <tr>
          <td valign="top">&nbsp;</td>
    ...
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <input type="hidden" name="idHakmilikAgensi" id="idHakmilikAgensi" value="$beanMaklumatTanah.idHakmilikAgensi"/></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>No. Lot</td>
  ...
  <tr>
    ...
    <td width="70%"> #if ($mode == 'new')
      ...
      <input type="button" name="cmdBatal" id="cmdBatal" value="Batal" onclick="batalRayuan()"/>
      #end
      #if ($mode == 'view')
...
function daftarBaru() {
	...
	document.${formName}.hitButton.value = "daftarRayuan";
	doAjaxCall${formName}("");
}
function kembali() {	
	document.${formName}.action = "$EkptgUtil.getTabID("Tukar Guna",$portal_role)?_portal_module=ekptg.view.php2.FrmTKRSenaraiFailView";
	document.${formName}.submit();
}
function batalRayuan() {

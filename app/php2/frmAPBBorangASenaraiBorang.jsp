      ...
      <table width="100%" align="center" border="0">
        ...
        <tr>
          ...
          <td><input name="cmdCari" id="cmdCari" value="Cari" type="button" onclick="javascript:carian()" />
            <input name="cmdKosongkan" id="cmdKosongkan" value="Kosongkan" type="reset" onclick="javascript:kosongkan1()" /></td>
        </tr>
        <tr>
          <td scope="row">&nbsp;</td>
          <td>&nbsp;</td>
  ...
  <tr>
    <td><fieldset>
      ...
      <table align="center" width="100%">
        <tr>
          <td colspan="5" scope="row"><input name="cmdDaftar" type="button" value="Tambah" onClick="javascript:daftarMaklumatPasir()"/></td>
        </tr>
        ...
        #set ($listBorangA = "")
        #if ($SenaraiBorangA.size() > 0)
        #foreach ($listBorangA in $SenaraiBorangA)
        #if ($listBorangA.bil == '')
        #set( $row = "row1" )
        ...
        <tr>
          ...
          <td class="$row"><a href="javascript:paparMaklumatPasir('$listBorangA.idBorangA')" class="style1">$listBorangA.bulan</a></td>
...
function paparMaklumatPasir(idBorangA) {

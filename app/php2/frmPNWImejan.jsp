...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmPNWImejDetail.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
function simpanDokumen(idLaporanTanah,idHakmilikPermohonan) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmPNWLawatanTapakView&hitButton=simpanDokumen&namaImej="+namaImej+"&catatanImej="+catatanImej+"&idLaporanTanah="+idLaporanTanah+"&selectedTabUpper=5"+dopost+"&mode=view&flagPopup=openPopupDokumen&modePopup=new&idHakmilikPermohonan="+idHakmilikPermohonan;
	document.${formName}.method="post";

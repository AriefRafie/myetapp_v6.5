      ...
      <table width="100%" align="center" border="0">
        <tr>
          ...
          <td width="70%"><input name="txtNoFail" id="txtNoFail" type="text" value="$txtNoFail" size="50" maxlength="50" style="text-transform:uppercase;" >
            ...
            <input type="hidden" name="actionTukarguna" />
        ...
        <tr>
		  ...
		  <td width="70%"><select name="socTanah" id="socTanah" onchange="onChangeValue(this)">
  ...
  <tr>
    <td><fieldset>
      ...
      <table align="center" width="100%">
        <tr>
          <td colspan="7" scope="row"><input name="cmdDaftar" type="button" value="Daftar Permohonan Baru" onclick="javascript:daftarBaru()"/>
            &nbsp;
        ...
        <tr>
          ...
          #if ($list.noRayuan != '' && $list.noRayuan != '0')
          <td class="$row"><a href="javascript:papar('$list.idFail','$list.idStatus')" class="style1">$list.noFail</a>&nbsp;(RAYUAN)
          &nbsp;&nbsp;

...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td>Bil. Mesyuarat</td>
    <td>:</td>
    <td><input name="txtBilMesyuarat" type="text" class="$inputTextClass" id="txtBilMesyuarat" value="$beanMaklumatMesyuarat.bilMesyuarat" size="9" maxlength="12" $readonly />
    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td valign="top">:</td>
    <td valign="top"><textarea name="txtTujuanMesyuarat" id="txtTujuanMesyuarat" rows="5" cols="50" $readonly class="$inputTextClass" >$beanMaklumatMesyuarat.tujuanMesyuarat</textarea>
    </td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    ...
    <td valign="top">:</td>
    <td><textarea name="txtCatatanMesyuarat" id="txtCatatanMesyuarat" rows="5" cols="50" $readonly class="$inputTextClass" >$beanMaklumatMesyuarat.catatanMesyuarat</textarea></td>
  </tr>
  #if ($mode != 'view')
  <tr>

    ...
    <td><fieldset>
      ...
      <table width="100%" align="center" border="0">
        <tr>
          ...
          <td width="70%"><input name="txtCarianTajukMesyuarat" id="txtCarianTajukMesyuarat" type="text" value="" size="50" maxlength="50" style="text-transform:uppercase;" >
        ...
        <tr>
          ...
          <td width="70%"><input name="txtCarianBilMesyuarat" id="txtCarianBilMesyuarat" type="text" value="" size="50" maxlength="50" style="text-transform:uppercase;" ></td>
        </tr>
        <tr>
          <td width="30%" height="24" scope="row" align="right">Tarikh Mesyuarat : </td>
          <td width="70%"><input type="text" name="txtCarianTarikhMesyuarat" id="txtCarianTarikhMesyuarat" value="" onblur="check_date(this)" size="9"/>
            <a href="javascript:displayDatePicker('txtCarianTarikhMesyuarat',false,'dmy');"><img border="0" src="../img/calendar.gif"/></td>
        </tr>
        <tr>
          <td scope="row"></td>
          <td>
...
function kosongkan() {
	...
	document.${formName}.txtCarianTajukMesyuarat.value = "";
	document.${formName}.txtCarianBilMesyuarat.value = "";
	document.${formName}.txtCarianTarikhMesyuarat.value = "";
	doAjaxCall${formName}("");
}
...
function paparLaporanMesyuarat(idMesyuarat) {
	var url = "../servlet/ekptg.report.php2.CRBRingkasanKeputusanMesyuarat?idMesyuarat="+idMesyuarat;

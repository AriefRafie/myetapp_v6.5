...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <!-- FlagJenisFail = $!beanHeader.flagJenisFail -->
  <tr>
    <td width="50%" valign="top"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          <td align="right">Tarikh Surat / Borang</td>
          <td>:</td>
        ...
        <tr>
          ...
          <td width="1%">:</td>
          <td width="63%"><font color="blue">$beanHeader.noRujSurat</font></td>
        </tr>
        <tr>
    ...
    <td width="50%" valign="top"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          <td align="right" valign="top"><em>MyID </em>/<em> MyCoid</em> :</td>
          <td><font color="blue" valign="top">$beanHeader.noPengenalan</font></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><font color="blue">$beanHeader.emel</font></td>
        </tr>
      </table>
      </fieldset></td>
  </tr>
  ...
  <tr>
    <td><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        #foreach($beanHeader in $BeanHeader)
        <tr>
          <td width="19%">Tarikh Batal</td>
          <td width="1%">:</td>
          <td width="80%"><font color="blue">$beanHeader.tarikhBatal</font></td>
        </tr>
        <tr>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td><fieldset>
      <legend>CATATAN MAKLUMAT TAMBAHAN</legend>
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        #foreach($beanHeader in $BeanHeader)
        <tr>
          <td width="19%">Catatan</td>
          <td width="1%">:</td>
          <td width="80%"><font color="blue">$beanHeader.catatanMT</font></td>
        </tr>
        #end
      </table>
      </fieldset></td>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td><fieldset>
      <legend>CATATAN PINDAAN</legend>
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        #foreach($beanHeader in $BeanHeader)
        <tr>
          <td width="19%">Catatan</td>
          <td width="1%">:</td>
          <td width="80%"><font color="blue">$beanHeader.catatanPindaan</font></td>
        </tr>
        #end
      </table>
      </fieldset></td>

<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td width="70%" valign="top"><textarea name="txtTindakan" id="txtTindakan" rows="9" cols="65" $readonly class="$inputTextClass" onBlur="this.value=this.value.toUpperCase();" onChange="trimTindakan(this.form.txtTindakan)">$beanMaklumatMesyuarat.tindakanMesyuarat</textarea></td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top">Ulasan</td>
    <td valign="top">:</td>
    <td valign="top"><textarea name="txtUlasanMesyuarat" id="txtUlasanMesyuarat" rows="9" cols="65" $readonly class="$inputTextClass" onBlur="this.value=this.value.toUpperCase();" onChange="trimUlasan(this.form.txtUlasanMesyuarat)">$beanMaklumatMesyuarat.ulasanMesyuarat</textarea></td>
  </tr>
  #if ($mode != 'view')
  <tr>

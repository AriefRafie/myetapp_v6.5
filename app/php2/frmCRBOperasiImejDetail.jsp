    ...
    <td ><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td width="1%">:</td>
          <td width="70%"><input name="txtNamaImej" type="text" id="txtNamaImej" value="$beanMaklumatImejan.namaImej" size="43" maxlength="100" $readonlyPopup class="$inputTextClassPopup"></td>
        </tr>
        <tr>
          <td>&nbsp;</td>

...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td><fieldset>
      <legend><strong>CARIAN BORANG K</strong></legend>
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
    ...
    <td><fieldset>
      ...
      <table align="center" width="100%">
        ...
        <tr>
          ...
          <td class="$row"><a href="javascript:papar('$list.idPHPBorangK')" class="style1">$list.peganganHakmilik</a></td>
          <td class="$row">$list.noLot</td>
...
function kosongkan(idNegeriPemohon) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmCRBPopupSenaraiBorangKView";
	document.${formName}.submit();
}
function papar(idPHPBorangK) {	

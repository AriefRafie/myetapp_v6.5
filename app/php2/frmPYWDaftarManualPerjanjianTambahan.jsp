...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td width="70%"> #if ($mode == 'new')
      <input type="button" name="cmdDaftarBaru" id="cmdDaftarBaru" value="Daftar" onclick="daftarBaru('$flagJenisPerjanjian','$idLuas')"/>
...
function daftarBaru(flagJenisPerjanjian,idLuas) {
	//CHECK DATE   

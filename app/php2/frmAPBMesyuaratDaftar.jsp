    ...
    <td><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">        
        ...
        <tr>
          ...
          <td valign="top">:</td>
          <td valign="top"><textarea name="txtTujuanMesyuarat" id="txtTujuanMesyuarat" rows="2" cols="50" class="$inputTextClass" >Mesyuarat Jawatankuasa One Stop Centre (OSC) Permohonan Lesen Bagi Aktiviti Di kawasan Pelantar Benua Di bawah Akta Pelantar Benua 1966 Bil.</textarea>
          </td>
        </tr>
        <tr>
          ...
          <td>Bil. Mesyuarat</td>
          <td>:</td>
          <td><input name="txtBilMesyuarat" type="text" class="$inputTextClass" id="txtBilMesyuarat" size="9" maxlength="12" />
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td valign="top">:</td>
          <td><textarea name="txtCatatanMesyuarat" id="txtCatatanMesyuarat" rows="5" cols="50" class="$inputTextClass" ></textarea></td>
        </tr>
        <tr>

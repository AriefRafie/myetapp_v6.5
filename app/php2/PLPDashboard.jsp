                      ...
                      <td width="85%" ><table width="100%">
                          ...
                          <tr>
                            <td valign="top" width="49%"><font color="blue">
                              <li>Fail Pelepasan</li>
                              </font></td>
                            <td  valign="top" width="1%"> :</td>
                            <td  valign="top" width="50%"><b>$!failPelepasan</b></td>
                          </tr>
                          <tr>
                            <td valign="top"><font color="blue">
                              <li>Fail Penawaran</li>
                              </font></td>
                            <td valign="top"> :</td>
                            <td  valign="top"><b>$!failPenawaran</b></td>
                          </tr>
                          <tr>
                            <td valign="top"><font color="blue">
                              <li>Fail Tukarguna</li>
                              </font></td>
                            <td valign="top"> :</td>
                            <td  valign="top"><b>$!failTukarguna</b></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
                ...
                <td><div id="TabbedPanels1" class="TabbedPanels">
                    ...
                    <div class="TabbedPanelsContentGroup"> #if($list_memo_aktif.size()>0)
                      ...
                      <div class="TabbedPanelsContent" id="Carta_Main" >
                        <div style="height:250;overflow:auto" id="div_stat">
                          <table width="100%">
                            <tr>
                              <td width="12%" align="center" valign="top"><img width="30" height="30" src="../img/images_stat.png" align="center"/> </td>
                              <td width="88%" valign="top"><table width="100%">
                                  <tr>
                                    <td   valign="top" ><b>Carta Status Permohonan Keseluruhan</b> </td>
                                  </tr>
                                  <tr>
                          ...
                          <table width="100%" >
                            <tr>
                              ...
                              <td width="88%" valign="top"><table width="100%">
                                  <tr>
                                    <td   valign="top" ><b>Carta Status Permohonan Pelepasan</b> </td>
                                  </tr>
                                  <tr>
                                    <td   valign="top" ><canvas id="cvsPelepasan" width="300" height="100" >[No canvas support]</canvas>
                                    </td>
                                  </tr>
                                </table></td>
                            </tr>
                          ...
                          <table width="100%" >
                            <tr>
                              ...
                              <td width="88%" valign="top"><table width="100%">
                                  <tr>
                                    <td   valign="top" ><b>Carta Status Permohonan Penawaran</b> </td>
                                  </tr>
                                  <tr>
                                    <td   valign="top" ><canvas id="cvsPenawaran" width="300" height="100" >[No canvas support]</canvas>
                                    </td>
                                  </tr>
                                </table></td>
                            </tr>
                          ...
                          <table width="100%" >
                            <tr>
                              ...
                              <td width="88%" valign="top"><table width="100%">
                                  <tr>
                                    <td   valign="top" ><b>Carta Status Permohonan Tukarguna</b> </td>
                                  </tr>
                                  <tr>
                                    <td   valign="top" ><canvas id="cvsTukarguna" width="300" height="100" >[No canvas support]</canvas>
                                    </td>
                                  </tr>
                                </table></td>
                            </tr>
...
function gotoSenaraiTugasan() {
	document.${formName}.action = "$EkptgUtil.getTabID("My Info",$portal_role)?_portal_module=ekptg.view.php2.FrmSenaraiTugasanPLPView";
	document.${formName}.submit();
}
function gotoOnline() {
...
function gotoPenawaran() {
	document.${formName}.action = "$EkptgUtil.getTabID("Penawaran",$portal_role)?_portal_module=ekptg.view.php2.FrmPNWSenaraiFailView&actionPenawaran=daftarBaru";
	document.${formName}.submit();
}
function gotoTukarguna() {
	document.${formName}.action = "$EkptgUtil.getTabID("Tukarguna",$portal_role)?_portal_module=ekptg.view.php2.FrmTKRSenaraiFailView&actionTukarguna=daftarBaru";
	document.${formName}.submit();
}
function gotoKutipanPLP() {
	document.${formName}.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.php2.FrmPLPKutipanDataView";
	document.${formName}.submit();
}
function gotoKutipanPNW() {
	document.${formName}.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.php2.FrmPNWKutipanDataView";
	document.${formName}.submit();
}
function gotoKutipanTKR() {
	document.${formName}.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.php2.FrmTKRKutipanDataView";
	document.${formName}.submit();
}

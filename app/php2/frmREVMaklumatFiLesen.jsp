<table width="100%" border="0" cellspacing="2" cellpadding="2">
  #if ($mode == 'newBayaranFiLesen' || $mode == 'viewBayaranFiLesen' || $mode == 'updateBayaranFiLesen')
  <tr>
  	<td>#parse("app/php2/frmREVBayaranFiLesen.jsp")</td>
  </tr>
  <tr>
  	<td>&nbsp; </td>
  </tr>
  ...
  <tr>
    <td><fieldset>
      ...
      <table align="center" width="100%">
        <tr>
          <td><a href="#" class="style2" onclick="javascript:janaPenyataAkaunFiLesen('$idJadualPertama')"> Penyata Akaun </a></td>
        </tr>
      </table>
      </fieldset></td>
  </tr>
  <tr>
    <td><fieldset>
      ...
      <table align="center" width="100%">
        #if ($mode == 'view')
        <tr >
          <td colspan="10"><input name="cmdBayaran" type="button" value="Pembayaran" onClick="pemBayaranFiLesen()">
          </td>
        </tr>
        #end
        ...
        #foreach ($list in $SenaraiFiLesen)
        #if ($list.bil == '')
        #set( $row = "row1" )
        #elseif (($list.bil % 2) != 0)
        #set( $row = "row1" )

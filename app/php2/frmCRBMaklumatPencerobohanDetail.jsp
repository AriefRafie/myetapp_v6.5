<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td width="28%">Nama</td>
    <td width="1%">:</td>
    <td width="70%"><input type="text" name="txtNamaPenceroboh" id="txtNamaPenceroboh" value="$beanMaklumatPenceroboh.namaPenceroboh" size="30" $readonlyPopup class="$inputTextClassPopup" onblur="this.value=this.value.toUpperCase();"/>
    </td>
  </tr>
  <tr>
    <td></td>
  ...
  <tr>
    ...
    <td>Negeri</td>
    <td>:</td>
    <td>$selectNegeriPenceroboh</td>
  </tr>
  <tr>
    <td></td>
    <td>Bandar</td>
    <td>:</td>
    <td>$selectBandarPenceroboh</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>E-mel</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>Jenis Pencerobohan</td>
    <td>:</td>
    <td><input name="txtJenisPencerobohan" type="text" id="txtJenisPencerobohan" value="$beanMaklumatPenceroboh.jenisPencerobohan" size="43" $readonlyPopup class="$inputTextClassPopup" onblur="this.value=this.value.toUpperCase();" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td> #if ($modePopup == 'new')
      ...
      <input name="cmdBatalPenceroboh" type="button" value="Kembali" onClick="batalPenceroboh()" />
      #end
      #if ($modePopup == 'update')

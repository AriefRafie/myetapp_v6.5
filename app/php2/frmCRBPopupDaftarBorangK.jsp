...
#set ($counter = $counter+1)
        ...
        <tr>
          ...
          <td>No. Syit</td>
          <td>:</td>
          <td><input name="txtNoSyit" type="text" class="$inputTextClassPopup" id="txtNoSyit" onBlur="this.value=this.value.toUpperCase();" value="$beanMaklumatBorangK.noSyit" maxlength="20" $readonlyPopup/></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>No. Pelan</td>
          <td>:</td>
          <td><input name="txtNoPelan" type="text" class="$inputTextClassPopup" id="txtNoPelan" onBlur="this.value=this.value.toUpperCase();" value="$beanMaklumatBorangK.noPelan" maxlength="20" $readonlyPopup/></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>Kategori</td>

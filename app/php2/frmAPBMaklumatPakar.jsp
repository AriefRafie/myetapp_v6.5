    ...
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td width="28%">Nama</td>
          <td width="1%">:</td>
          <td width="70%"><input name="txtNamaPakar" type="text" class="$inputTextClass" id="txtNamaPakar" value="$beanMaklumatPakar.nama" size="43" maxlength="80" $readonly />
          </td>
        </tr>
        <tr>
          ...
          <td width="1%" valign="top">:</td>
          <td width="70%" valign="top"><textarea name="txtKelayakan" rows="5" cols="43" class="$inputTextClass" id="txtKelayakan"  $readonly="$readonly">$beanMaklumatPakar.kelayakan</textarea>
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>

...
<p>
  ...
  <input name="actionAPB" type="hidden" id="actionAPB" value="$actionAPB"/>
  ...
  <tr>
    <td><div id="TabbedPanels" class="TabbedPanels">
        ...
        <div class="TabbedPanelsContentGroup">
          <div class="TabbedPanelsContent"> #parse("app/php2/frmAPBMaklumatMesyuarat.jsp") </div>
          <div class="TabbedPanelsContent"> #parse("app/php2/frmAPBSenaraiKehadiran.jsp") </div>
          <div class="TabbedPanelsContent"> #parse("app/php2/frmAPBKeputusanMesyuarat.jsp") </div>
          <div class="TabbedPanelsContent"> #parse("app/php2/frmAPBSenaraiMinitMesyuarat.jsp") </div>
        </div>
      </div></td>
  </tr>
</table>
...
function batalMesyuarat(){
	document.${formName}.actionAPB.value = "";
...
function cetakSPM(idFail,idMesyuarat) {
	var url = "../x/${securityToken}/ekptg.view.php2.FrmAPBPopupCetakLaporanView?idFail="+idFail+"&idMesyuarat="+idMesyuarat+"&report=cetakSuratPanggilMesy";
...
function cetakSenaraiEdaran(idFail) {
	var url = "../servlet/ekptg.report.php2.APBSenaraiEdaran?ID_FAIL="+idFail;
    var hWnd = window.open(url,'printuser','width=900,height=300, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
       hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();

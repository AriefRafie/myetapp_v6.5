    ...
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td>Nama Pegawai</td>
          <td>:</td>
          <td><input name="txtNamaPengadu" type="text" id="txtNamaPengadu" value="$beanMaklumatPemohon.namaPengadu" size="43" $readonly class="$inputTextClass"></td>
        </tr>
        #end
        #end
...
function daftarBaru() {
	...
	if(document.${formName}.noFail.value == "JKPTG/BPHP/"){
...
function checkingExistNoFail() {
	url = "../servlet/ekptg.view.php2.FrmCRBServlet?command=checkingExistNoFail";
...
function popupMsg(){
	...
	document.${formName}.noFail.value = "JKPTG/BPHP/";
	document.${formName}.noFail.focus(); 
}
function seterusnya(){

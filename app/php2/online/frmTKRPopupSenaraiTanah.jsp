    ...
    <td><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td>:
            $selectNegeri
            <input type="hidden" name="idNegeriJKPTG" value="$idNegeriJKPTG"/></td>
        </tr>
        <tr>
          <td>Daerah</td>
          <td>:
        ...
        <tr>
          ...
          <td><input type="button" name="cmdCari" id="cmdCari" value="Cari" onclick="doCarian()"/>
            <input type="button" name="cmdKosong" id="cmdKosong" value="Kosongkan" onclick="kosongkan('$idNegeriJKPTG','$idKategoriPemohon')"/></td>
        </tr>
      </table>
      </fieldset></td>
  </tr>
...
function kosongkan(idNegeriJKPTG,idKategoriPemohon) {
	...
	if(idKategoriPemohon == '8'){
		document.${formName}.socNegeri.value = idNegeriJKPTG;
	} else {

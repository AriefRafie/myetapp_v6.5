  ...
  <tr>
    ...
    #foreach ($beanMaklumatLampiran in $BeanMaklumatLampiran)
        ...
        <tr>
          ...
          <td width="1%">:</td>
          <td width="70%"><input name="txtNamaLampiran" type="text" id="txtNamaLampiran" value="$beanMaklumatLampiran.namaLampiran" size="43" maxlength="100" $readonlyPopup class="$inputTextClassPopup" onblur="this.value=this.value.toUpperCase();">
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>

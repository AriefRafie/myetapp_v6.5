  ...
  <tr>
    <td><fieldset>
        ...
        <table width="100%" align="center" border="0">
          ...
          <tr>
            <td width="30%" height="24" scope="row" align="right">Penawaran : </td>
            <td width="70%"><input name="findPenawaran" id="findPenawaran" type="text" value="$!findPenawaran" size="50" maxlength="50" style="text-transform:uppercase;" ></td>
          </tr>
          <tr>

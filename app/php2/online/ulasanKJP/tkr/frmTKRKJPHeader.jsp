<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr> #foreach($beanMaklumatPermohonan in $BeanMaklumatPermohonan)
    ...
    <td width="50%" valign="top" ><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
      	<tr>
          <td width="19%">Jenis Permohonan </td>
          <td width="1%">:</td>
          <td><font color="blue"></font></td>
        </tr>
        <tr>
          <td width="19%" >No Permohonan </td>
          <td width="1%">:</td>
          <td><font color="blue">$noRujukanOnline</font></td>
        </tr>
        <tr>
          <td width="19%">No Fail </td>
          <td width="1%">:</td>
          <td><font color="blue">$!noFail</font></td>
        </tr>
        <tr>
          <td width="19%">Tarikh Permohonan </td>
          <td width="1%">:</td>
          <td><font color="blue">$tarikhTerima</font></td>
        </tr>
        <tr>
          <td width="19%">Status Permohonan </td>
          <td width="1%">:</td>

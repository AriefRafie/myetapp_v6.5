...
#set ($counter = $counter+1)
  ...
  <tr>
   ...
   <tr>
    ...
    <td>Nilaian Tanah</td>
    <td>:</td>
    <td><input type="text" name="txtNilaianTnh" id="txtNilaianTnh" value="$beanMaklumatTanahGanti.nilaianTanah" $readonlyPopup class="$inputTextClassPopup" onBlur="validateCurrency(this,this.value,'$beanMaklumatTanahGanti.nilaianTanah');" style="text-align:right" size="10"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>No. Syit</td>

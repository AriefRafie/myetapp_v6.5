...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td colspan="2"> #parse("app/php2/online/frmPNWImejDetail.jsp") </td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
...
function simpanDokumen(idPermohonan,idFail,idStatus) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.online.FrmPNWOnlineSenaraiFailView&hitButton=simpanDokumen&namaImej="+namaImej+"&catatanImej="+catatanImej+"&idPermohonan="+idPermohonan+"&selectedTabUpper=2"+dopost+"&actionOnline=seterusnya&mode=view&flagPopup=openPopupDokumen&modePopup=new&idFail="+idFail+"&idStatus="+idStatus;

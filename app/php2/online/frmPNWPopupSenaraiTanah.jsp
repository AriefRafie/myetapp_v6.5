      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          ...
          <td width="70%">:
            ...
            <input type="hidden" name="idAgensi" value="$idAgensi"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          #foreach ($beanMaklumatAgensi in $BeanMaklumatAgensi)
          <td>:
            $beanMaklumatAgensi.kementerian</td>
          #end
        </tr>
        <tr>
          <td>Agensi</td>
...
function kosongkan(idKategoriPemohon) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.online.FrmPNWPopupSenaraiTanahOnlineView";

    ...
    <td><fieldset>
      ...
      <table align="center" width="100%">
        ...
        <tr>
          ...
          <td class="$row"><a href="javascript:papar('$list.idFail','$list.idStatus','$list.idKementerian','$list.idAgensi')" class="style1">$list.noFail</a>&nbsp;(SAMBUNGAN)
          &nbsp;&nbsp;
          #if($list.flagBuka == 'T')
          #if($list.flagMT == 'Y')
          ...
          #else
          <td class="$row"><a href="javascript:papar('$list.idFail','$list.idStatus','$list.idKementerian','$list.idAgensi')" class="style1">$list.noFail</a>
          &nbsp;&nbsp;
          #if($list.flagBuka == 'T')
          #if($list.flagMT == 'Y')
          <span class="style1"><blink><strong>MAKLUMAT TAMBAHAN</strong></blink></span>
...
function papar(idFail,idStatus,idKementerian,idAgensi)
{
	var url = "../x/${securityToken}/ekptg.view.php2.online.FrmPYWOnlineMaklumat?&idFail="+idFail+"&idStatus="+idStatus+"&idKementerian="+idKementerian+"&idAgensi="+idAgensi;

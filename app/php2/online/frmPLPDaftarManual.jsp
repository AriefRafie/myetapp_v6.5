        ...
        <tr>
          ...
          <td width="70%"> #if ($mode == 'new')
           ...
           <!-- <input type="text" name="txtPeganganHakmilik" id="txtPeganganHakmilik" value="$beanMaklumatTanah.peganganHakmilik" onBlur="doChangePeganganHakmilik();" />
            <input type="button" name="cmdPilih" id="cmdPilih" value="Pilih Tanah" onClick="pilihTanah('$idSuburusan1','$idNegeriPemohon','','')" />-->
            ...
            <i><font color='blue'>Contoh : 160140GRN00000576</font></i>
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>

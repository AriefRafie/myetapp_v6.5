      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td width="70%"> #if ($mode == 'new')
            ...
            <!--input type="button" name="cmdPilih" id="cmdPilih" value="Pilih Tanah" onclick="pilihTanah('3','$idAgensiPmhn' , '99999')"/-->
            #else
            ...
            <span class="style1"><i><font color="#ff0000">Contoh</font> : </i><span class="style5">160140GRN00000576</span></span>
             </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
...
function seterusnya() {
	//document.${formName}.idSuburusanPmhn.value = idSuburusan1;	
	document.${formName}.actionOnline.value = "seterusnya";
	document.${formName}.submit();
}
</script>

  ...
  <tr>
    <td><div id="TabbedPanels1" class="TabbedPanels">
        <ul class="TabbedPanelsTabGroup">
          ...
          <li onClick="doChangeTabUpper(1);" class="TabbedPanelsTab" tabindex="0">MAKLUMAT PELEPASAN</li>
          <li onClick="doChangeTabUpper(2);" class="TabbedPanelsTab" tabindex="0">TANAH GANTI</li>
        </ul>
        <div class="TabbedPanelsContentGroup">
          ...
          <div class="TabbedPanelsContent">
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
                <td> #parse("app/php2/online/frmPLPMaklumatTanahGanti.jsp") </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
              ...
              <tr>
                <td><fieldset>
                  ...
                  <table align="center" width="100%">
                    ...
                    #if ($flagPopup == '')
                    <tr>
                      <td colspan="7" align="center"> #if ($idStatus == '')
...
function pilihTanah(idNegeriPemohon) {
	var url = "../x/${securityToken}/ekptg.view.php2.online.FrmPLPPopupSenaraiTanahOnlineView?idNegeriPemohon="+idNegeriPemohon;
...
function doChangeLuasGuna() {
	document.${formName}.mode.value = "update";
	doAjaxCall${formName}("");
}
function doChangeJenisLuasGuna() {
	document.${formName}.mode.value = "update";
	doAjaxCall${formName}("");
}
...
function doSimpanTanahGanti(){
	...
	if(document.${formName}.txtNilaianTnh.value == ""){
		alert('Sila masukkan Nilaian Tanah.');
  		document.${formName}.txtNilaianTnh.focus(); 
		return; 
	}
...
function cetakPengesahanPermohonan(idPermohonan) {
	var url = "../servlet/ekptg.report.php2.online.PLPPengesahanPermohonanOnline?ID_PERMOHONAN="+idPermohonan;

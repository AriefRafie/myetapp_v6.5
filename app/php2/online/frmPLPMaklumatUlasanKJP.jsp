  ...
  <tr>
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          <td width="1%">&nbsp;</td>
          <td width="28%">Tarikh Hantar 1</td>
          <td width="1%">:</td>
          <td width="70%"><input name="txtTarikhHantar" type="text"  class="$inputTextClassPopup" id="txtTarikhHantar" onBlur="check_date(this);calcDate()" value="$beanMaklumatKJP.tarikhHantar" size="9" maxlength="10">
        ...
        <tr>
          <td width="1%">&nbsp;</td>
          <td width="28%">Tarikh Hantar 2</td>
          <td width="1%">:</td>
          ...
          <td colspan="4"><fieldset>
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
                ...
                <td valign="top">:</td>
                <!-- <td valign="top"><textarea name="fileupload" id="fileupload" rows="5" cols="50" $readonlyPopup class="$inputTextClassPopup">$beanMaklumatKJP.ulasan</textarea></td> -->
                <td><input id="fileupload" name="fileupload" type=file size=40 $readonlyPopup class="$inputTextClassPopup" /></td>
              </tr>
            </table>
            </fieldset></td>
        </tr>

    ...
    <td colspan="2"><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td>Nama</td>
          <td>:</td>
          <td><input name="txtNamaPengarah" type="text" class="$inputTextClass" id="txtNamaPengarah" value="$beanMaklumatPengarah.nama" size="43" maxlength="80" $readonly  onBlur="this.value=this.value.toUpperCase();"/>          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>

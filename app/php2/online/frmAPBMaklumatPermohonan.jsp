  					...
  					<fieldset>
						...
						<table width="100%" border="0">
							...
							<tr>
							    ...
							    #elseif ($idStatus != '')
							        <input type="checkbox" name="pengesahan" id="pengesahan" checked disabled>
							    #end
							    </td>
							    <td>
							    	Kami $!pemohon.get("namaPemohon"), MyCOID $!pemohon.get("noPengenalan") dengan ini maklumat yang diberikan dalam borang ini adalah benar, betul dan lengkap.
							    </td>
							</tr>
							<tr>
								<td>&nbsp;</td>

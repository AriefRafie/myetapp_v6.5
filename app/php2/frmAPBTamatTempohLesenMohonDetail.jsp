  ...
  <tr>
    <td><div id="TabbedPanels1" class="TabbedPanels">
        <ul class="TabbedPanelsTabGroup">
          <li onClick="doChangeTab(0);" class="TabbedPanelsTab" tabindex="0">LAPORAN PENGUKURAN POST-DREDGE</li>
          <li onClick="doChangeTab(1);" class="TabbedPanelsTab" tabindex="0">ARAHAN PULANG LESEN</li>
          <li onClick="doChangeTab(2);" class="TabbedPanelsTab" tabindex="0">TUNTUTAN WANG CAGARAN</li>
        </ul>
        <div class="TabbedPanelsContentGroup">
          <div class="TabbedPanelsContent"> <br>
            #parse("app/php2/frmAPBPTamatTempohLesenPengukuranPD.jsp") </div>
          <div class="TabbedPanelsContent"> <br>
            #parse("app/php2/frmAPBPTamatTempohLesenPulangLesen.jsp") </div>
          <div class="TabbedPanelsContent"> <br>
            #parse("app/php2/frmAPBPTamatTempohLesenTuntutWang.jsp") </div>           
        </div>
      </div></td>
  </tr>
</table>
...
function doChangeTab(tabId) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBTamatTempohLesenView";

...
function daftarBaru() {
	...
	if(document.${formName}.noFail.value == "JKPTG(S)/SPHP/8-2 SK"){
...
function janaTajuk(){	
	...
	var strTajuk = "Permohonan Untuk Mendapatkan Lesen Bagi Mengeluarkan Pasir Dasar Laut Di Bawah Seksyen 4, Akta Pelantar Benua 1966 P.U 2009 di Kawasan";
...
function checkingExistNoFail() {
	url = "../servlet/ekptg.view.php2.FrmAPBServlet?command=checkingExistNoFail";
...
function popupMsg(){
	...
	document.${formName}.noFail.value = "JKPTG(S)/SPHP/8-2 SK";
}
function seterusnya(){

<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td> #parse("app/php2/frmAPBMaklumatPHM.jsp") </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td><fieldset>
      ...
      <table align="center" width="100%">
        <tr>
          <td colspan="9" scope="row"><input name="cmdTambah" type="button" value="Tambah" onclick="javascript:doDaftarMaklumatPHM()"/></td>
        </tr>
        ...
        #set ($list = "")
        #if ($SenaraiPHM.size() > 0)
        #foreach ($list in $SenaraiPHM)
        #if ($list.bil == '')
        #set( $row = "row1" )
        #elseif (($list.bil % 2) != 0)
        #set( $row = "row1" )
        ...
        <tr>
          ...
          <td class="$row"><a href="javascript:paparMaklumatPHM('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;<font class="blink" ><span class="style1">$!list.statusHari</span></font></td>
          #else
          <td class="$row"><a href="javascript:paparMaklumatPHM('$list.idUlasanTeknikal')" class="style2">$list.namaDokumen</a>&nbsp;&nbsp;(ULANGAN $list.bilUlangan)&nbsp;&nbsp;<font class="blink" ><span class="style1">$!list.statusHari</span></font></td>
          #end
          ...
          #else
          <td class="$row" align="center"><a href="#" class="style2" onClick="javascript:cetakAPBUlanganSuratMintaUlasanPHN('$idFail','$list.idUlasanTeknikal','$list.bilUlangan')"><img border="0" src="../img/print.gif"/></a></td>
          #end </tr>
        #end
        #else
        <tr>
...
function doDaftarNotifikasi(){
	document.${formName}.flagPopup.value = "openPHM";
...
function paparMaklumatPHM(idUlasanTeknikal){
	document.${formName}.flagPopup.value = "openPHM";
	document.${formName}.modePopup.value = "view";
...
function doSimpanMaklumatPHM(){
	...
	document.${formName}.flagPopup.value = "openPHM";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanMaklumatPHM";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
function doSimpanMaklumatUlanganPHM(){	
	if(document.${formName}.txtTarikhHantar.value == ""){
		alert('Sila masukkan Tarikh Hantar.');
  		document.${formName}.txtTarikhHantar.focus(); 
		return; 
	...
	document.${formName}.flagPopup.value = "openPHM";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanMaklumatUlanganPHM";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
function doBatalMaklumatPHM(){
...
function doKemaskiniMaklumatPHM(){
	document.${formName}.flagPopup.value = "openPHM";
...
function doBatalKemaskiniMaklumatPHM(){
	document.${formName}.flagPopup.value = "openPHM";
	document.${formName}.modePopup.value = "view";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
...
function doSimpanKemaskiniMaklumatPHM(){
	...
	document.${formName}.flagPopup.value = "openPHM";
	document.${formName}.modePopup.value = "view";
	document.${formName}.hitButton.value = "simpanKemaskiniMaklumatPHM";
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView";
	document.${formName}.method="POST";
	document.${formName}.submit();
}
...
function simpanDokumenPHM(idUlasanTeknikal,idPermohonan) {
	
	if(document.${formName}.fileuploadPHM.value == ""){
		alert('Sila pilih Fail yang Ingin Dimuatnaik.');
  		document.${formName}.fileuploadPHM.focus(); 
		return; 
	}
	...
	document.${formName}.action = "?_portal_module=ekptg.view.php2.FrmAPBJabatanTeknikalView&hitButton=simpanDokumenKJT&selectedTabUpper=5&idPermohonan="+idPermohonan+"&idUlasanTeknikal="+idUlasanTeknikal+"&flagPopup=openPHM&modePopup=view"+dopost;
	document.${formName}.method="post";
...
function cetakAPBUlanganSuratMintaUlasanPHN(idFail,idUlasanTeknikal) {
	var url = "../x/${securityToken}/ekptg.view.php2.FrmAPBPopupCetakLaporanView?idFail="+idFail+"&report=ulanganSuratMintaUlasanPHN&idUlasanTeknikal="+idUlasanTeknikal;

...
//autoExpand(event,'maklumbalas_teknikal');
</script>
#else
<script>
check_length1_tech(document.${formName}.maklumbalas_teknikal,'4000','maklumbalas_teknikal_check','maklumbalas_teknikal_num','normal','yes','keterangan maklumbalas teknikal');
//autoExpand_temp_tech(event,'maklumbalas_teknikal');


function autoExpand_temp_tech(event,field_id){
...
function check_length1_tech(my_form,maxLen,alert_field,text_num,jenis_field,mandatory,value_field)
{

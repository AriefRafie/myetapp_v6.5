...
&nbsp;
  ...
  <table width="100%">
    <tr>
      ...
      <td width="70%"><label>
        <input type="text" name="txtNoEnakmen" id="txtNoEnakmen" />
      </label></td>
    </tr>
    <tr>
      ...
      <td scope="row">:</td>
      <td><label>
        <input type="text" name="txtNamaEnakmen" id="txtNamaEnakmen" />
      </label></td>
    </tr>
    <tr>
      ...
      <td scope="row">:</td>
      <td><label>
        <input type="text" name="txtTarikhKuatkuasa" id="txtTarikhKuatkuasa" />
      </label>
  ...
  <table width="100%" cellspacing="0" cellpadding="2">
   ...
   <table width="100%" border="0" cellpadding="2">
  	<tr>
    <td align="right"><strong>CL-08-12</strong></td>
  	</tr>
  </table>
</form>

...
<table border="0" cellspacing="0" cellpadding="1" width="100%" >  
	   ...
	   <td align="center">
		   ...
		   <td width="50%" valign="top">
			   ...
			   <td width="6%" valign="top" style="cursor: pointer;" align="right" onClick="doDivAjaxCall$formname('div_liststat_modul_$ps.ID_MAINMODUL','show_listitemby_modul','ID_MAINMODUL=$ps.ID_MAINMODUL&MAINMODUL=$ps.MAINMODUL&flagStat=JUMLAH_PENAMBAHBAIKAN&countItem=$ps.JUMLAH_PENAMBAHBAIKAN&CURRENTDATE=$ps.CURRENTDATE&ID_PROJEK='+$jquery('#ID_PROJEK').val());">
			  $ps.JUMLAH_PENAMBAHBAIKAN
			   ...
			   <td valign="top" style="cursor: pointer;" align="right" onClick="doDivAjaxCall$formname('div_liststat_modul_$ps.ID_MAINMODUL','show_listitemby_modul','ID_MAINMODUL=$ps.ID_MAINMODUL&MAINMODUL=$ps.MAINMODUL&flagStat=JUMLAH_SELESAI_CODING&countItem=$ps.JUMLAH_SELESAI_CODING&CURRENTDATE=$ps.CURRENTDATE&ID_PROJEK='+$jquery('#ID_PROJEK').val());">
			   ...
			   <td  class="$style_blink_delay" style="$style_delay cursor: pointer"  valign="top"  align="right" onClick="doDivAjaxCall$formname('div_liststat_modul_$ps.ID_MAINMODUL','show_listitemby_modul','ID_MAINMODUL=$ps.ID_MAINMODUL&MAINMODUL=$ps.MAINMODUL&flagStat=JUMLAH_DELAY&countItem=$ps.JUMLAH_DELAY&CURRENTDATE=$ps.CURRENTDATE&ID_PROJEK='+$jquery('#ID_PROJEK').val());">
			   ...
			   <td   valign="top" style="cursor: pointer;" align="right" onClick="doDivAjaxCall$formname('div_liststat_modul_$ps.ID_MAINMODUL','show_listitemby_modul','ID_MAINMODUL=$ps.ID_MAINMODUL&MAINMODUL=$ps.MAINMODUL&flagStat=JUMLAH_PATUT_SELESAI&countItem=$ps.JUMLAH_PATUT_SELESAI&CURRENTDATE=$ps.CURRENTDATE&ID_PROJEK='+$jquery('#ID_PROJEK').val());">
			   ...
			   <td   valign="top" style="cursor: pointer;" align="right" onClick="doDivAjaxCall$formname('div_liststat_modul_$ps.ID_MAINMODUL','show_listitemby_modul','ID_MAINMODUL=$ps.ID_MAINMODUL&MAINMODUL=$ps.MAINMODUL&flagStat=JUMLAH_KIV&countItem=$ps.JUMLAH_KIV&CURRENTDATE=$ps.CURRENTDATE&ID_PROJEK='+$jquery('#ID_PROJEK').val());">
	   ...
	   <tr class="underline_td_item_content" id="div_liststat_modul_$ps.ID_MAINMODUL">
	   <td >
	   </td>
	   <td>
	   </td>
...
<input type="button" id="BTNPRINTSTATMODUL" name="BTNPRINTSTATMODUL" onclick="printDiv('printableAreaStatModul','modul','1')" value="Cetak" />
#if($current_role=="Admin_Eprogress")
<input type="button" id="BTN_HANTAREMELMODUL" name="BTN_HANTAREMELMODUL" onClick="hantarEmel('printableAreaStatModul','modul','1')" value="Hantar Progress Emel" >
<input type="hidden" id="textAreaStatModul" name="textAreaStatModul" value="">
#end

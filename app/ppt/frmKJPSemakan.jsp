...
<center>
#set($id = $PermohonanListSPT.id_permohonan)
<fieldset>
  <legend><strong>Carian</strong></legend>
	<table width="100%" cellspacing="2" cellpadding="0" border="0">
    	 ...
    	 <tr>
            ...
            <td width="58%">:&nbsp;<input type="text" name="no_permohonan" value="$carianPermohonan" style="text-transform:uppercase;" id="no_permohonan" size="27" onkeyup="this.value=this.value.toUpperCase();" /></td>
        </tr>
...
function edit_item(id_permohonan) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmPermohonanSPT";

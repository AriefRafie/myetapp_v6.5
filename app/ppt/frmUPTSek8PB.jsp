...
#parse("app/ppt/infoblink_biru.jsp")</font>     </td>
        <td valign="top">:</td>
        <td>
...
$txtKeteranganPB                                
 ...
 No. Pengenalan PB</td>
    ...
    <option value="$ln.ID_WARGANEGARA">$ln.KOD_WARGA - $ln.KETERANGAN</option>
         ...
         #if($countX > 0 || $list_kehadiran.size() > 0 )  
       ...
       <div id="getSyer_div" ></div>  
         ...
         $!txtSyorAtas / $!txtSyorBawah
           ...
           &nbsp;<b>/</b>&nbsp;<input type="text" name="txtSyorBawah" id="txtSyorBawah" value="$!txtSyorBawah" size="20" maxlength="20" onblur="validateSyer('$!checkSizeBahagianPB_size')" onkeyup="validateNumber(this,this.value)">
            ...
            <input type="hidden" name="txtSyorBawah_temp" id="txtSyorBawah_temp" value="$!txtSyorBawah_temp" >
...
$txtCatatan
         ...
         <textarea name="txtCatatan" id="txtCatatan" cols="50"   rows="6" style=""         
        ...
        >$txtCatatan</textarea> 
         ...
         #if($readmode == "edit")           
         <div><span id="txtCatatan_num" style="color:blue;" ></span><span> Baki Aksara</span>         </div>
         #else
         <input name="txtCatatan_num" id="txtCatatan_num" size="3" value="4000"  style=" display:none" > 
         #end
         <div id="txtCatatan_check" class="alert_msg" ></div>     
  ...
  <tr>
    <td colspan="2">
    <div align="center" >
      <input type="button" name="cmdJIM" value ="Semakan Maklumat Kebangkrapan" onClick="javascript:semakanJIM('$!id_pb', '$!id_permohonan')"><br />
    #if($readmode == "view")
      <label>
    ...
    #if($readmode == "edit")  
      <label>
      <input type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan"  onClick="simpanPB('$id_hakmilik','$id_hakmilikpb','$id_kehadiran','$id_pb','$checkSizeBahagianPB_size')">
      </label>
      <label>
...
<!-- <input type="button" name="cmdCetak" id="cmdCetak" value="Cetak" onclick="javascript:setTable('tableReport1')" /> -->  
  ...
  <tr class="table_header">
    ...
    <td width="18%"><div align="center">Bahagian / Syer </div>
    <div align="center"> & </div>
    <div align="center">Berkongsi Bahagian (Jika Ada)</div>
    </td>
   
      #if($list_kehadiran.size() > 0)
    <td  width="8%"> 
      <div align="center">Borang
      </div>
      <div align="center">C & D
      </div>
      <div align="center">
  ...
  <tr class="table_header">
    ...
    <td width="23%"><div align="left">Jenis Pihak Berkepentingan</div></td>
...
doUpdateCheckAllBorangG('$list_kehadiran.size()');
doUpdateCheckAllBorangE('$list_kehadiran.size()');
doUpdateCheckAllBorangK('$list_kehadiran.size()');
}
...
function semakanJIM(ID_PIHAKBERKEPENTINGAN, ID_PERMOHONAN) {
	document.${formName}.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.integrasi.FrmViewMaklumatKebangkrapan&action2=viewMaklumatKebangkrapan&ID_PB=" + ID_PIHAKBERKEPENTINGAN + "&ID_PERMOHONAN=" + ID_PERMOHONAN;
	document.${formName}.submit();
}

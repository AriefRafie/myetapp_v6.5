...
<table width="100%">
  ...
  <tr>
    ...
    <td><input type="submit" name="cmdCari" id="cmdCari" value="Cari" onclick="cari()" />
        <input type="submit" name="cmdKosongkan" id="cmdCari" value="Kosongkan" onclick="kosongka()"/>
    </td>
  </tr>
</table>
</fieldset>
...
function cari() {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SementaraPerundingan&action=";
	document.${formName}.submit();

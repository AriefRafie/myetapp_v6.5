...
<fieldset>
	<legend><strong>Senarai Permohonan</strong></legend>
     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
   		...
   		<tr>
     		<td colspan="2" scope="row"><input type="button" name="cmdDaftar" value ="Daftar Baru" onClick="javascript:pendaftaran();"></td>
    	</tr>
        ...
        <tr class="table_header">
        	...
        	<td><b>Status Fail</b></td>
         	...
         	#set($flagStatusOnline="")
            	 ...
            	 #set($flagStatusOnline="<br/><font style='font-size:10px'><b><i>(TELAH DIKEMBALIKAN)</i></b></font>")
            #else
            	 #set($flagStatusOnline="")
            #end	

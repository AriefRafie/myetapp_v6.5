    ...
    <table width="100%" border="0">
		<tr align="center">
			<td>
				...
				<input type="button" name="cmdSimpan" value ="Simpan" onClick="javascript:updateSemakan('$!id_permohonan','$!id_mmk','$!modeSemak')">
				#end
					...
					#else
					<input type="button" name="cmdUpdate" value ="Simpan" onClick="javascript:updateSemakan('$!id_permohonan','$!id_mmk','$!modeSemak')">
    	...
    	<table width="100%" border="0">
    		...
    		<td width="49%" valign="top"><table width="100%" border="0">
    			...
    			<tr>
    				...
    				<td width="1%">:</td>
    				<td width="56%"><input type="text" name="txtNoPerserahan" id="txtNoPerserahan" maxlength="50" size="20" value=""   /></td>
    			</tr>
    			<tr>
    				<td>&nbsp;</td>
...
<legend><strong>SENARAI LAPORAN</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
      ...
      <tr>  
      	 <td><a href="#" onClick="javascript:cetakMMK('$!id_permohonan','$!id_fail','$!negeriMMK','$!no_fail','$!nama_pengarah')"><font color="blue">Kertas Kerja MMK</font></a></td>
      </tr> 
      #if($negeriMMK=="10")
      <tr>  
...
function mmkItem(){
	...
	if('$negeriMMK'=="2"){
		...
		textarea_KESIMPULAN_MAIN('tambahtolak','umum','');
	}else if('$negeriMMK'=="6"){
		//pahang
		...
		//perlis
		textarea_TUJUAN_MAIN('tambahtolak','umum',''),textarea_LATARBELAKANG_MAIN('tambahtolak','umum',''),textarea_PERIHALTANAH_MAIN('tambahtolak','umum',''),
		textarea_LAPORANTEKNIKAL_MAIN('tambahtolak','umum',''),textarea_KEPUTUSAN_MAIN('tambahtolak','umum',''),textarea_ULASANPENGARAH_MAIN('tambahtolak','umum',''),
		textarea_SYOR_MAIN('tambahtolak','umum',''),textarea_PERAKUANPT_MAIN('tambahtolak','umum','');
		...
		textarea_HALLAIN_MAIN('tambahtolak','umum','');
	}else if('$negeriMMK'=="14"){
		//kl
...
function cetakMMK(idpermohonan,idfail,negeriMMK,nofail,namaPentadbir) {
	...
	if(negeriMMK=="2"){
		...
		var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_permohonan="+idpermohonan+"&report=MMKSek8NSembilan&flagReport=S";
	}else if(negeriMMK=="6"){
		...
		var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_permohonan="+idpermohonan+"&report=SementaraMMKSelangor&flagReport=S";
	}else if(negeriMMK=="11"){
		...
		var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_permohonan="+idpermohonan+"&report=SementaraMMKKL&flagReport=S";
	}else{
...
function cetakMBSS8(idpermohonan,negeriMMK) {
...
function updateSemakan(idpermohonan,idmmk,mode) {
...
function cetakBorangC(idfail,totalHM) {
...
function cetakBorangD(idpermohonan,idfail,totalHM,namaPengarah,mukim,negeri) {

	if(negeri=="2" || negeri=="5"){
		var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_permohonan="+idpermohonan+"&report=BorangDBI&flagReport=S";
		//var url = "../servlet/ekptg.report.ppt.BorangDBI?id_fail="+idfail+"&nama_pengarah="+namaPengarah+"&nama_mukim="+mukim; 
	}else{
		if(totalHM > 1){
			var url = "../servlet/ekptg.report.ppt.BorangDLebih?id_Fail="+idfail+"&namaPegawai="+namaPengarah;   	
		}else{
			var url = "../servlet/ekptg.report.ppt.BorangD?id_Fail="+idfail+"&namaPegawai="+namaPengarah;   	
		}
	}

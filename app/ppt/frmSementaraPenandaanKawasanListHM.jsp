...
<br/>
	...
	<legend><strong>Senarai Maklumat Hakmilik</strong></legend>
     <table width="100%"   border="0">   
            <tr><td  align="left">
            <a href="javascript:popupCarianHakmilik('$id_permohonan','penandaan_sementara')"><font color="blue">>> SKRIN CAPAIAN HAKMILIK</font></a>
            </td>
            </tr>
            </table>
		<!--	
    		...
    		<table width="100%" border="0"> 
               ...
               <tr>
                  	<td class="$row" align="center">$!listTanah.bil</td>
                   	<td class="$row"><a href="javascript:penandaanKawasan('$!listTanah.id_hakmilik')"><font color="blue">$!listTanah.no_hakmilik</font></a></td>
...
function penandaanKawasan(id_hakmilik) {

...
<table width="100%">
  ...
  <tr>
    ...
    <td class="$row"><a href="javascript:tambah('$fail.id_fail','$fail.id_permohonan')"><font color="blue">$fail.no_rujukan_ptg</font></a></td>
    <td class="$row"><a href="javascript:tambah('$fail.id_fail','$fail.id_permohonan')"><font color="blue">$fail.no_rujukan_ptd</font></a></td>
    <td class="$row"><a href="javascript:tambah('$fail.id_fail','$fail.id_permohonan')"><font color="blue">$fail.no_rujukan_upt</font></a></td>
    #else
...
function cari() {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SementaraBorangM&action=";
	document.${formName}.submit();

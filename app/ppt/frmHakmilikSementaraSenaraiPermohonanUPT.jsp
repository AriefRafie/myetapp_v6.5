...
<table width="100%">
  <tr>
    ...
    <td width="1%">:</td>
    <td width="70%"><label>
      <input name="txtNoFail" type="text" id="txtNoFail" value="$carianPermohonan" size="40" />
    </label></td>
  </tr>
  <tr>
...
function baru() {
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SementaraUPT&action=baru";
...
function cari() {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SementaraUPT&action=";
	document.${formName}.submit();

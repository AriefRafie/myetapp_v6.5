	...
	<legend><strong>Maklumat Asas Permohonan</strong></legend>
    	...
    	<table width="100%"  cellpadding="0" border="0">
            ...
            <tr>
            	...
            	<td>:</td>
                <td><input type="text" name="txtNoRujukanPTG" id="txtNoRujukanPTG" value="$!txtNoRujukanPTG" maxlength="30" size="37" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();doCheckExistNoFail('ptg',this.value)" ></td>
            </tr>
            ...
            <tr>
            	...
            	<td>:</td>
                <td><input type="text" name="txtNoRujukanPTD" value="$!txtNoRujukanPTD" maxlength="30" size="37" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();doCheckExistNoFail('ptd',this.value)" ></td>
            </tr>
           	...
           	<tr>
            	...
            	<td>:</td>
                <td><input type="text" name="txtNoRujukanUPT" value="$!txtNoRujukanUPT" maxlength="30" size="37" style="text-transform:uppercase;"  onblur="this.value=this.value.toUpperCase();doCheckExistNoFail('upt',this.value)" ></td>
            </tr>
	...
	<legend><strong>Maklumat Asas Permohonan</strong></legend>
    	...
    	<table width="100%"  cellpadding="0" border="0">
            ...
            <tr>
            	...
            	<td>No. Rujukan PTG</td>
            	<td>:</td>
                <td><input type="text" $disability $disabilityx name="txtNoRujukanPTG" id="txtNoRujukanPTG" value="$!txtNoRujukanPTG" maxlength="30" size="37" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();doCheckExistNoFailUpdate('ptg',this.value)" ></td>
            </tr>
            ...
            <tr>
            	...
            	<td>No. Rujukan PTD</td>
            	<td>:</td>
                <td><input type="text" $disability $disabilityx name="txtNoRujukanPTD" value="$!txtNoRujukanPTD" maxlength="30" size="37" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();doCheckExistNoFailUpdate('ptd',this.value)" ></td>
            </tr>
           	...
           	<tr>
            	...
            	<td>No. Rujukan UPT</td>
            	<td>:</td>
                <td><input type="text" $disability $disabilityx name="txtNoRujukanUPT" value="$!txtNoRujukanUPT" maxlength="30" size="37" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();doCheckExistNoFailUpdate('upt',this.value)" ></td>
            </tr>
   ...
   <legend><strong>Maklumat Lengkap Projek</strong></legend>
	...
	<div id="TabbedPanels1" class="TabbedPanels">
      ...
      <ul class="TabbedPanelsTabGroup">
        ...
        <li class="TabbedPanelsTab" onClick="javascript:setSelected(2);" tabindex="1">Senarai Semakan AISHAH</li>
      </ul>

...
<legend>SENARAI RUNDINGAN</legend>
...
<table width="100%" >
  <tr class="table_header">
    ...
    <td width="14%">No. Rundingan</td>
    <td width="10%"><div align="center">Bil Rundingan</div></td>
    <td  width="20%"><div align="center">Tarikh/Masa Rundingan</div></td>
    <td  width="25%">Tempat Rundingan</td>
...
<td width="1%"></td>
<td colspan="3">
 <div align="left"><a href="javascript:papar('$list.ID_SIASATAN','$list.ID_HAKMILIK')" title="Memaparkan secara lengkap maklumat set siasatan"><font color="blue">MAKLUMAT PERUNDINGAN</font></a></div>
</td>
</tr>
...
<td width="1%"></td>
<td colspan="3">
 <div align="left"><a href="javascript:maklumatsiasatan('$list.ID_SIASATAN')" title="Memaparkan secara lengkap maklumat siasatan"><font color="blue">NOTA PERUNDINGAN </font></a></div>
</td>
</tr>
<tr>
    <td width="1%"></td>

...
<fieldset id="top">
<legend><strong>Maklumat Penampalan Notis Awam</strong></legend>
    	 ...
    	 <table width="100%" border="0">  
        	...
        	<!-- <tr>
              ...
              <td width="1%">:</td>
              <td width="73%"><input type="text" $hideNoItem $hideNoItemx name="txtNotis" id="txtNotis" value="" size="30" maxlength="100" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();" /></td>
          	</tr> -->
        	
<!--            <tr>
            	<td width="1%">#if($hide=="0")<font color="red">*</font>#end</td>
            	<td width="25%">Tarikh Dikeluarkan / Endorsan</td>
            	<td width="1%">:</td>
                <td width="73%"><input $hideNoItem $hideNoItemx name="txdTarikhKeluar" id="txdTarikhKeluar" size="11" type="text" value="$!txdTarikhKeluar" onkeyup="validateTarikh(this,this.value)" onblur="check_date(this)" >
        ...
        #foreach($data in $dataNotis)
    	 ...
    	 <table width="100%" border="0">  
        	...
        	<!-- <tr>
              ...
              <td width="25%">Notis</td>
              <td width="1%">:</td>
              <td width="73%"><input $disability $disabilityx type="text" name="txtNotis" id="txtNotis" value="$!txtNotis" size="30" maxlength="100" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();" /></td>
          	</tr> -->
...
<!--            <tr>
            	...
            	<td width="25%">Tarikh Dikeluarkan / Endorsan</td>
            	<td width="1%">:</td>
                <td width="73%"><input $disability $disabilityx name="txdTarikhKeluar" id="txdTarikhKeluar" size="11" type="text" value="$!txdTarikhKeluar" onkeyup="validateTarikh(this,this.value)" onblur="check_date(this)" >
...
<br/>
	...
	<fieldset id="bottom">
	<legend><strong>Maklumat Notis Awam Yang Terlibat</strong></legend>
		...
		<table width="100%" border="0"> 
               ...
               <tr>
                   ...
                   <td class="$row"><a href="javascript:viewNotis('$!list.id_notisawam')"><font color="blue">
                   #if($!list.jenis_tempat != "")
                   $!list.jenis_tempat
                   #else
                   -
                   #end
                   ...
                   <td class="$row">$!list.jenis_tempat</td>
...
/*	else if(dat3.value!="" && (dateTampal < currentDate)){
...
*/	else
	...
	if(document.${formName}.txtTempat.value == ""){
		...
		if ( !window.confirm("Adakah Anda Pasti?")) return;	
		//var notis = document.${formName}.txtNotis.value ;
		//var TK = document.${formName}.txdTarikhKeluar.value ;
		//var TT = document.${formName}.txdTarikhTerima.value ;
		var dopost = document.${formName}.form_token.value ;

		var item = "";
		if(mode=="new"){
			item = "&command=tambahNotis&command2=simpanNotis&id_hakmilik="+idHakmilik+"&form_token="+dopost;
		}else{
			item = "&command=viewNotis&command2=kemaskiniNotis&command3=updateNotis&id_notisawam="+idNotisAwam+"&id_hakmilik="+idHakmilik+"&form_token="+dopost;
		}
		
		//document.${formName}.enctype = "multipart/form-data";
		//document.${formName}.encoding = "multipart/form-data";
		document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmSementaraNotisAwam"+item;
		document.${formName}.submit();		
	}
}

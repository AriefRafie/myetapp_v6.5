<input type="button" name="button2" id="button2" value="Jana PB" onClick = "janaPB('$id_hakmilik')" />
...
<script>
function janaPB(id_hm){
	var url = "../servlet/ekptg.report.ppt.BorangJPN?id_hm="+id_hm;

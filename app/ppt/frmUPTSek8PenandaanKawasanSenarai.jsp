        ...
        <!-- <tr>
       	...
       	<tr>
      		...
      		<td>:&nbsp;<select name="carianStatus" style="width:150px">
      			...
      			#if($carianStatus=="38")
      			<option value="38">TANDA KAWASAN</option>				
				<option value="58">PENYAMPAIAN NOTIS</option>
				<option value="">SILA PILIH</option>
      			#elseif($carianStatus=="58")
      			<option value="58">PENYAMPAIAN NOTIS</option>
				<option value="38">TANDA KAWASAN</option>	
				<option value="">SILA PILIH</option>			
      			#else
     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
        ...
        <tr class="table_header">
        	...
        	<tr>
        		...
        		<td class="$row"><a href="javascript:penandaanKawasan('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td> 
        		<td class="$row"><a href="javascript:penandaanKawasan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptg</font></a></td> 
        		<td class="$row"><a href="javascript:penandaanKawasan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptd</font></a></td> 
        		<td class="$row"><a href="javascript:penandaanKawasan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_upt</font></a></td> 
...
<script>
function penandaanKawasan(id_permohonan) {

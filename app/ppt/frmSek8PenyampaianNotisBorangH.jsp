...
<br/>
	...
	#if($mode=="new")
	<fieldset id="top">
	<legend><strong>Penyampaian Notis Borang H</strong></legend>
	<table width="100%" border="0">
		<tr>
			<td width="1%"><font color="red">*</font></td>
			<td width="20%">Nama Penghantar</td>
			<td width="1%">:</td>
			<td width="78%"><input type="text" name="txtNamaHantar" id="txtNamaHantar" value="$!txtNamaHantar" size="47" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
	...
	<table width="100%" border="0">
		...
		<tr>
			...
			<td>No. PB</td>
			<td>:</td>
			<td><input readonly class="disabled" type="text" name="txtNoPB" id="txtNoPB" value="$!txtNoPB" size="20" maxlength="20" onblur="this.value=this.value.toUpperCase()" style="text-transform:uppercase;" ></td>
		</tr>	
		...
		<tr>
			...
			<td>Nama Penerima</td>
			<td>:</td>
			<td><input type="text" name="txtNamaTerima" id="txtNamaTerima" value="$!txtNamaTerima" size="47" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<td>:</td>
			<td><input type="text" name="txtNoKP" id="txtNoKP" value="$!txtNoKP" size="20" maxlength="20" onblur="this.value=this.value.toUpperCase()" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>Hubungan Dengan PB</td>
			<td>:</td>
			<td><input type="text" name="txtHubungan" id="txtHubungan" value="$!txtHubungan" size="20" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		#else
			<tr>
			<td><font color="red">*</font></td>
			<td>Tempat Tampal</td>
			<td>:</td>
			<td><input type="text" name="txtTempatTampal" id="txtTempatTampal" value="$!txtTempatTampal" size="47" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		#end
	...
	<table width="100%" border="0">
		<tr>
			...
			<td width="20%">Nama Penghantar</td>
			<td width="1%">:</td>
			<td width="78%"><input $disability $disabilityx type="text" name="txtNamaHantar" id="txtNamaHantar" value="$!txtNamaHantar" size="47" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
	...
	<table width="100%" border="0">
		...
		<tr>
			...
			<td>No. PB</td>
			<td>:</td>
			<td><input type="text" name="txtNoPB" readonly class="disabled" id="txtNoPB" value="$!txtNoPB" size="20" maxlength="20" onblur="this.value=this.value.toUpperCase()" style="text-transform:uppercase;" ></td>
		</tr>
		...
		<tr>
			...
			<td>Nama Penerima</td>
			<td>:</td>
			<td><input type="text" $disability $disabilityx name="txtNamaTerima" id="txtNamaTerima" value="$!txtNamaTerima" size="47" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>Kod No. Kad Pengenalan</td>
		...
		<tr>
			...
			<td>No. Kad Pengenalan</td>
			<td>:</td>
			<td><input type="text" $disability $disabilityx name="txtNoKP" id="txtNoKP" value="$!txtNoKP" size="20" maxlength="20" onblur="this.value=this.value.toUpperCase()" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>Hubungan Dengan PB</td>
			<td>:</td>
			<td><input type="text" $disability $disabilityx name="txtHubungan" id="txtHubungan" value="$!txtHubungan" size="20" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>		
		#else
			<tr>
			<td>#if($isEdit=="yes")<font color="red">*</font>#end</td>
			<td>Tempat Tampal</td>
			<td>:</td>
			<td><input type="text" $disability $disabilityx name="txtTempatTampal" id="txtTempatTampal" value="$!txtTempatTampal" size="47" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		#end
	...
	<fieldset id="bottom">
	<legend><strong>Senarai Penerima Notis Borang H</strong></legend>
...
function onChangeStatusUpdate(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmSek8PenyampaianNotisBorangH";

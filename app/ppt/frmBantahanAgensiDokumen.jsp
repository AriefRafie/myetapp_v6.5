...
<table width="100%">
  ...
  <tr>
    ...
    <td valign="top">:</td>
  	...
  	<input id="fileupload" accept=".pdf" name="fileupload" type=file size=50 value="$!txtdokumensokongan" onmouseout="checking_validation(this,'fileupload_check','yes','dokumen sokongan','file');"  onkeyup="checking_validation(this,'fileupload_check','yes','dokumen sokongan','file');"  onblur="checking_validation(this,'fileupload_check','yes','dokumen sokongan','file');" />
  	<br/>

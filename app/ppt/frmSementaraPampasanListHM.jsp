    ...
    <a href="javascript:popupCarianHakmilik('$id_permohonan','senarai_pampasan_sementara')"><font color="blue">>> SKRIN CAPAIAN HAKMILIK</font></a>
    		...
    		<table width="100%" border="0"> 
               ...
               <tr>
                   ...
                   <td class="$row"><a href="javascript:viewSenaraiPampasanPB('$!listTanah.id_hakmilik')"><font color="blue">$!listTanah.no_hakmilik</font></a></td>
...
function viewSenaraiPampasanPB(id_hakmilik){

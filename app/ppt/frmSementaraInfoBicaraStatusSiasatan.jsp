...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <tr>
    ...
    #end      
    #end
    <option value="">SILA PILIH PEGAWAI PERUNDINGAN</option> 
    ...
    <option value="">SILA PILIH STATUS PERUNDINGAN</option>
    #elseif($socStatusSiasatan == "2")
    <option value="2">DITUNDA SEBELUM SIASATAN</option> 
    <option value="3">DIBATALKAN</option> 
    <option value="4">SIASATAN ULANGAN</option>
    ...
    <option value="6">SELESAI</option>       
     ...
     <span id="socStatusSiasatan_check" class="alert_msg" ></span>
      ...
      <tr>
        <td width="1%" valign="top">&nbsp;</td>
        <td width="28%" valign="top">Ulasan Perundingan</td>
        <td width="1%" valign="top">:</td>
        <td width="70%">
  ...
  <div id="txtUlasanSiasatan_check" class="alert_msg" ></div> 
      ...
      <tr id="id_tangguh" >
        <td width="1%" valign="top">&nbsp;</td>
        <td width="28%" valign="top">Ulasan Tangguh Perundingan</td>
        <td width="1%" valign="top">:</td>
        <td width="70%">
...
<td colspan="4">
  ...
  <legend>MAKLUMAT PERUNDINGAN ULANGAN</legend>
  <table width="100%">
  <tr>
    <td width="1%">&nbsp;</td>

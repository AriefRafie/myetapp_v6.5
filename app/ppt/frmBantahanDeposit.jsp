...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="1" onclick="setSelectedTab(1);deposit()">Deposit
...
<font color="red" class="blink"  style="font-size:10px">*TIADA MAKLUMAT PENERIMAAN PEMBAYARAN PAMPASAN DIDAFTARKAN.SILA RUJUK PADA MAKLUMAT PENERIMAAN PEMBAYARAN PAMPASAN PADA PAGING 17 SEKSYEN(8).</font>
        ...
        <tr>
            ...
            <td width="20%">No Cek</td>
          	...
          	<td width="1%">:</td>
       	  <td width="32%"><input type="text" name="txtNamaBankPampasan" id="txtNamaBankPampasan" value="$!txtNamaBankPampasan" size="35" tabindex="7" class="disabled" readonly /></td>
        </tr>   
        <tr>
            <td width="1%"></td>
            <td width="20%">No Akaun</td>
          	<td width="1%">:</td>
          	<td width="28%"><input type="text" name="txtNoAkaunPampasan" id="txtNoAkaunPampasan" value="$!txtNoAkaunPampasan" size="15" tabindex="7" class="disabled" readonly /></td>
          	<td width="1%">&nbsp;</td>
          	<td width="17%">&nbsp;</td>
          	<td width="1%">&nbsp;</td>
       	    <td width="32%">&nbsp;</td>
...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
       ...
       <tr>
        <td><a href="#" class="style2" onClick="javascript:cetakSuratMintaDepositDalam30Hari('$id_fail','$id_bantahan','$id_hakmilikpb','$id_permohonan')"><font color="blue"> Surat Makluman Kemukakan Bukti Bayaran - Makluman kepada PB supaya kemukakan bukti bayaran deposit </font></a></td>
      </tr>           
    </table>
</fieldset>
...
function cetakSuratMintaDepositDalam30Hari(id_fail,id_bantahan,id_hakmilikpb,id_permohonan) {

	var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_fail="+id_fail+"&id_bantahan="+id_bantahan+"&id_hakmilikpb="+id_hakmilikpb+"&id_permohonan="+id_permohonan+"&report=SuratMintaDepositDalam30Hari&flagReport=S";
	var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();

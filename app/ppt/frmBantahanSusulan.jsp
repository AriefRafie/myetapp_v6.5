...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="4" onclick="setSelectedTab(4);susulanBantahan()">Perintah
	...
	<table width="100%" border="0">
    	...
    	<tr>
         <td ></td>
            <td valign="top">Kos Pengapit Hakim&nbsp;(RM)</td>
   	  	  <td valign="top">:</td>
       	  <td ><fieldset><legend>JPPH</legend>
            <table width="100%">
            	<tr>
                	<td width="20%">Kos                    </td>
                    <td width="1%">:                    </td>
    	...
    	<tr>
         <td ></td>
          <td valign="top"></td>
       	  <td  valign="top"></td>
       	  <td colspan="6"><input type="text" readonly class="disabled" name="remLentxtKeteranganPampasan" size="3" maxlength="3" value="400"> Baki Aksara</td>
  	    </tr>                                                               
    </table>
</fieldset>
...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
       <tr>
        <td><a href="#" class="style2" onClick="javascript:cetaksuratKepadaAPSupayaMembayarPampasanTambahan('$id_fail','$id_bantahan','$id_permohonan')"><font color="blue"> Surat Iringan Kepada Agensi Pemohon </font></a></td>
      </tr>           
    </table>
...
input_box = confirm("Adakah anda pasti?");
	...
	var id_bantahan = document.${formName}.id_bantahan.value ;
	var id_permohonan = document.${formName}.id_permohonan.value ;		
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmBantahanSenaraiCarian&command=hapusDokumenMasterPerintah&id_bantahan="+id_bantahan+"&id_permohonan="+id_permohonan+"&location=senarai_dokumen&point=senarai_dokumen&readmode="+r;	
	document.${formName}.submit();
	}
}

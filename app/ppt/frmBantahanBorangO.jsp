...
#foreach ( $senarai in $getMaklumatBantahan )
	...
	#set ($txtNamaPembantah=$senarai.nama_pb)
	...
	#foreach ( $senarai in $getDataBorangO )
    	#set ($id_borango_check=$senarai.id_borango)
	...
	<table width="100%" border="0">
    	...
    	<tr>
            ...
            <td width="22%">Nama Pihak Membantah</td>
          	<td width="1%">:</td>
          	<td><input type="text" name="txtNamaPembantah" id="txtNamaPembantah" value="$!txtNamaPembantah" size="50" class="disabled" readonly /></td>
   	    </tr>
    	...
    	<tr>
    	  ...
    	  <td>Alamat</td>
    	  <td>:</td>
    	  <td><input type="text" name="txtAlamatMahkamah1" id="txtAlamatMahkamah1" value="$!txtAlamatMahkamah1" size="50" class="disabled" readonly /></td>
  	  </tr>
    	<tr>
          <td width="1%"></td>
    	  <td>&nbsp;</td>
    	  <td>&nbsp;</td>
    	  <td><input type="text" name="txtAlamatMahkamah2" id="txtAlamatMahkamah2" value="$!txtAlamatMahkamah2" size="50" class="disabled" readonly  /></td>
  	  </tr>
    	<tr>
          <td width="1%"></td>
    	  <td>&nbsp;</td>
    	  <td>&nbsp;</td>
    	  <td><input type="text" name="txtAlamatMahkamah3" id="txtAlamatMahkamah3" value="$!txtAlamatMahkamah3" size="50" class="disabled" readonly /></td>
  	  </tr>
    	<tr>
          <td width="1%"></td>
    	  <td>Poskod</td>
...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
      ...
      <tr>
        <td>
        <a href="#" class="style2" onClick="javascript:cetakCoveringBantahanRT('$id_hakmilikpb')"><font color="blue"> Covering Bantahan RT</font></a>
        </td>
      </tr>
    #end
...
<input type="hidden" name="id_negeriMahkamah" id="id_negeriMahkamah" value="$id_negeriMahkamah" />
...
function cetakCoveringBantahanRT(id_hakmilikpb) {
	var url = "../servlet/ekptg.report.ppt.CoveringBantahanRT?idHakmilikpb="+id_hakmilikpb;
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();	
...
function cetakSuratIringanBorangO(id_fail,id_bantahan,id_hakmilikpb,id_permohonan) {
	//var url = "../servlet/ekptg.report.ppt.SuratIringanBorangO?idFail="+id_fail+"&id_bantahan="+id_bantahan+"&id_hakmilikpb="+id_hakmilikpb;

	var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?idFail="+id_fail+"&id_bantahan="+id_bantahan+"&id_hakmilikpb="+id_hakmilikpb+"&id_permohonan="+id_permohonan+"&report=SuratIringanBorangO&flagReport=S";	
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();	
...
function cetakBorangE(id_hakmilik,id_borange) {
    var url = "../servlet/ekptg.report.ppt.BorangE?id_hakmilik="+id_hakmilik+"&id_borange="+id_borange;
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function cetakBorangD(id_fail,totalHM,nama_pengarah) {

	if(totalHM > 1){
		var url = "../servlet/ekptg.report.ppt.BorangDLebih?id_Fail="+id_fail+"&namaPegawai="+nama_pengarah;   	
	}else{
		var url = "../servlet/ekptg.report.ppt.BorangD?id_Fail="+id_fail+"&namaPegawai="+nama_pengarah;   	
	}

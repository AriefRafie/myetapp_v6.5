  ...
  <legend><strong>Carian</strong></legend>
	<table width="100%" cellspacing="2" cellpadding="0" border="0">
    	 ...
    	 <tr>
            ...
            <td width="55%">:&nbsp;<input type="text" name="nofail" value="$!nofail" style="text-transform:uppercase;" id="nofail" size="27" onkeyup="this.value=this.value.toUpperCase();" /></td>
        </tr>
        ...
        <tr>
      		<td>&nbsp;</td>
      		<td>Status &nbsp; </td>
      		<td>:&nbsp;<select name="carianStatus" style="width:170px">
      		
      			#if($carianStatus=="58")
      			<option value="58">PENYAMPAIAN NOTIS</option>	
      			<option value="59">PENGAMBILAN SEGERA</option>	
      			<option value="">SILA PILIH</option>
      			#elseif($carianStatus=="59")
      			<option value="59">PENGAMBILAN SEGERA</option>	
      			<option value="58">PENYAMPAIAN NOTIS</option>	
      			<option value="">SILA PILIH</option>
      			#else
     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
        ...
        <tr class="table_header">
        	...
        	<tr>
        		...
        		<td class="$row"><a href="javascript:viewSegera('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td> 
        		<td class="$row"><a href="javascript:viewSegera('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptg</font></a></td> 
        		<td class="$row"><a href="javascript:viewSegera('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptd</font></a></td> 
        		<td class="$row"><a href="javascript:viewSegera('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_upt</font></a></td> 

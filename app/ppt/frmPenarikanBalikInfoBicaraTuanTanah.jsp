...
<td>#parse("app/ppt/header_ppt.jsp") </td>
  ...
  <tr>
<td>#parse("app/ppt/header_penarikanbalik_siasatan.jsp")
...
#set($txdTukarSyarat = $list_siasatan.TARIKH_TUKAR_SYARAT)
   ...
   <td width="1%">&nbsp;</td>
      ...
      <tr>
        ...
        <span id="txtCaraMilikTanah_check" class = "alert_msg"></span> </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
  ...
  <span id="txtHargaTanah_check" class = "alert_msg" ></span>   </td>
      ...
      <tr>
        ...
        <td>
        <!--
        <textarea name="txtKeteranganTuanTanah" id="txtKeteranganTuanTanah" cols="50"  rows="6" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();checking_validation(this,'txtKeteranganTuanTanah_check','yes','keterangan tuan tanah','normal')"  onKeyUp="checking_validation(this,'txtKeteranganTuanTanah_check','yes','keterangan tuan tanah','normal');this.value=this.value.toUpperCase();" $readonlymode class = "$disabledmode" >$txtKeteranganTuanTanah</textarea>     
         <div id="txtKeteranganTuanTanah_check" class = "alert_msg" > </div> -->
         
         
       <textarea name="txtKeteranganTuanTanah" id="txtKeteranganTuanTanah" cols="60"   rows="6" 
         onBlur="check_length(this,'400','txtKeteranganTuanTanah_check','txtKeteranganTuanTanah_num','normal','no','keterangan tuan tanah');"  
         onKeyup="check_length(this,'400','txtKeteranganTuanTanah_check','txtKeteranganTuanTanah_num','normal','no','keterangan tuan tanah');" 
         onKeydown="check_length(this,'400','txtKeteranganTuanTanah_check','txtKeteranganTuanTanah_num','normal','no','keterangan tuan tanah');"                    
        ...
        <div><span id="txtKeteranganTuanTanah_num" style="color:blue;" ></span><span> Baki Aksara</span>         </div>
         #else
         <input name="txtKeteranganTuanTanah_num" id="txtKeteranganTuanTanah_num" size="3" value="400"  style=" display:none" > 
         #end
  <div id="txtKeteranganTuanTanah_check" class="alert_msg" ></div>               </td>
      ...
      <tr>
        ...
        <td>  
              ...
              #set($PecahSempadan = "DIBUAT")            
              #elseif($sorPecahSempadan == "2")
              #set($PecahSempadan = "TIDAK DIBUAT")                                     
              #else
              #set($PecahSempadan = "")
              #end
              ...
              #end 
<input type="radio" name="sorPecahSempadan" id="sorPecahSempadan" value="1" $check1 onClick="checking_validation(this,'sorPecahSempadan_check','no','status pecah sempadan','radio');">
Dibuat</td>
<td width="75%">
 <input type="radio" name="sorPecahSempadan" id="sorPecahSempadan" value="2" $check2 onClick="checking_validation(this,'sorPecahSempadan_check','no','status pecah sempadan','radio');">
Tidak Dibuat   &nbsp; &nbsp;    <span id="sorPecahSempadan_check" class = "alert_msg"></span> </td>  
                </tr>
                </table>
          #end                   </td>
  </tr>
      ...
      <tr>
        ...
        <td>
  ...
  #if($readmode == "view" )       
              #if($sorTukarSyarat == "1")
              #set($TukarSyarat = "DIBUAT")            
              #elseif($sorTukarSyarat == "2")
              #set($TukarSyarat = "TIDAK DIBUAT")                                     
              #else
              #set($TukarSyarat = "")
              #end
              ...
              #end 
<input type="radio" name="sorTukarSyarat" id="sorTukarSyarat" value="1" $check1 onClick="checking_validation(this,'sorTukarSyarat_check','no','status tukar syarat','radio');">
Dibuat</td>
<td width="75%">
 <input type="radio" name="sorTukarSyarat" id="sorTukarSyarat" value="2" $check2 onClick="checking_validation(this,'sorTukarSyarat_check','no','status tukar syarat','radio');">
Tidak Dibuat  &nbsp; &nbsp;   <span id="sorTukarSyarat_check" class = "alert_msg" ></span> </td>  
                </tr>
                </table>
          #end   </td>
  </tr>
...
check_length(document.${formName}.txtKeteranganTuanTanah,'400','txtKeteranganTuanTanah_check','txtKeteranganTuanTanah_num','normal','no','keterangan tuan tanah');

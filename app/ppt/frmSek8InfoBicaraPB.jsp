...
<td><div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    <li class="TabbedPanelsTab" tabindex="0"  onClick="screen5('$id_permohonan')">
    Kembali
    </li>
...
$txtKeteranganPB                                
  ...
  Nama PB           </td>
    ...
    #if($id_hakmilikpb == "")
    <a href="javascript:popupCarianPB_salinNama('$id_hakmilik','skrin_salin_pb_siasatan')"><font color="blue">>> SALIN PB (Nama)</font></a>
    #end
 ...
 No. Pengenalan PB</td>
    ...
    #if($id_hakmilikpb == "")
    <a href="javascript:popupCarianPB_salinNoKP('$id_hakmilik','skrin_salin_pb_siasatan')"><font color="blue">>> SALIN PB (MyId)</font></a>
    #end	
    ...
    <option value="$ln.ID_WARGANEGARA">$ln.KOD_WARGA - $ln.KETERANGAN</option>
         ...
         #if($countX > 0 || $senarai_pihak_penting_bahagian.size() > 0)  
...
$txtCatatan
  ...
  <tr>
    ...
    #if($readmode == "edit")  
      <label>
      <input type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan"  onClick="simpanPB('$id_siasatan','$id_hakmilikpb','$id_kehadiran','$id_pb','$checkSizeBahagianPB_size')">
      </label>
      <label>
...
function getSyer(id_hakmilikpb,id_pembatalan)
{
  /*  document.${formName}.command.value = "Siasatan";
	document.${formName}.sub_command.value = "PB";
...
function simpanPB(id_siasatan,id_hakmilikpb,id_kehadiran,id_pb,sizeBahagian)
{
var c = 0;

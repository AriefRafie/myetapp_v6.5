	...
	<fieldset>	
		<table width="100%" border="0">
            ...
            <tr>
            	...
            	<td>No. LOT</td>
            	<td>:</td>
                <td><input type="text" name="txtNoLot" id="txtNoLot" value="$!txtNoLot" size="12" maxlength="20" onclick="defaultLOT()"   ></td>
			</tr>
	...
	<fieldset>	
		<table width="100%" border="0">
            ...
            <tr>
            	...
            	<td>No. LOT</td>
            	<td>:</td>
                <td><input $disability $disabilityx type="text" name="txtNoLot" id="txtNoLot" value="$!txtNoLot" size="12" maxlength="20" onclick="defaultLOT()"   ></td>
			</tr>
    		...
    		<legend><strong>Senarai Pihak Berkepentingan</strong></legend>	
    			...
    			<table width="100%" border="0">	
    				<tr class="table_header">
    					...
    					<td width="30%">&nbsp;<b>Nama PB</b></td>
    					<td width="20%">&nbsp;<b>No. PB</b></td>
    					<td width="16%">&nbsp;<b>Jenis PB</b></td>
                    ...
                    #set( $i = $velocityCount )
               		...
               		<tr>
              			...
              			<td class="$row">&nbsp;$!listPB.jenis_pb</td>
                   		#if($listPB.syer_atas != "")
	...
	<legend><strong>Senarai Maklumat Hakmilik</strong></legend>
    		...
    		<table width="100%" border="0"> 
               ...
               <tr>
                	...
                	#if($flag_subjaket=="1")
                		#if($id_negeriProjek=="10" || $id_negeriProjek=="4")

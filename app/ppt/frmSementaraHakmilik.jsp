...
#set($frmtdate = "&nbsp;<i><font color='blue' style='font-size:10px'>dd/mm/yyyy</font></i>")
	...
	<fieldset>	
		<table width="100%" border="0">
            ...
            <tr>
            	...
            	<td>&nbsp;</td>
            	<td>&nbsp;</td>
                <td><input type="text" name="txtNoPT" id="txtNoPT" value="$!txtNoPT" size="12" maxlength="20" onblur="this.value=removeSpaces(this.value)"  ></td>
			</tr>
            ...
            <tr>
                ...
                <td><input type="text" name="txtNoLot" id="txtNoLot" value="$!txtNoLot" size="12" maxlength="20"  onblur="this.value=removeSpaces(this.value)"  >
                   ...
                   <a href="javascript:popupCarianHakmilikSalin('$id_permohonan','skrin_salin_hakmilik_sementara','$id_daerah')"><font color="blue">>> SALIN MAKLUMAT HAKMILIK/LOT</font></a>
	...
	<fieldset>	
		<table width="100%" border="0">
            ...
            <tr>
            	...
            	<td>&nbsp;</td>
            	<td>&nbsp;</td>
                <td><input $disability $disabilityx type="text" name="txtNoPT" id="txtNoPT" value="$!txtNoPT" size="12" maxlength="20" onblur="this.value=removeSpaces(this.value)"  ></td>
			</tr>
            ...
            <tr>
            	...
            	<td>No. LOT</td>
            	<td>:</td>
                <td><input $disability $disabilityx type="text" name="txtNoLot" id="txtNoLot" value="$!txtNoLot" size="12" maxlength="20" onclick="defaultLOT()" onblur="this.value=removeSpaces(this.value)"  >
	...
	<table width="100%" border="0">
		<tr align="center">
			<td>
				#if($mode=="new")
				<input type="button" name="cmdSimpan" value ="Simpan" onClick="javascript:simpanHM('$!id_permohonan','$!id_hakmilik','$!flag_subjaket','$!mode')">
				#end
...
<div id="TabbedPanels1" class="TabbedPanels">
  	...
  	<div class="TabbedPanelsContentGroup">
    	...
    	<div class="TabbedPanelsContent">
    		<fieldset>
    		<legend><strong>Senarai Pihak Berkepentingan</strong> <input type="button" name="cmdTambahPB" value="Tambah" onClick="javascript:tambahPB('$!id_hakmilik')"></legend>	
...
<!--
    			<table width="100%" border="0">
    				<tr>
    					<td width="30%" align="left"><input type="button" name="cmdTambahPB" value="Tambah" onClick="javascript:tambahPB('$!id_hakmilik')"></td>

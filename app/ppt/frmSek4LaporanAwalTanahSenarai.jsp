     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
        ...
        <tr class="table_header">
        	...
        	<tr>
        		...
        		#if($list.id_status=="148")
        		<td class="$row"><a href="javascript:tambahLaporan('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td> 
        		<td class="$row"><a href="javascript:tambahLaporan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptg</font></a></td> 
        		<td class="$row"><a href="javascript:tambahLaporan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptd</font></a></td> 
        		<td class="$row"><a href="javascript:tambahLaporan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_upt</font></a></td> 
        		#else
        		<td class="$row"><a href="javascript:semakLaporan('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td> 
        		<td class="$row"><a href="javascript:semakLaporan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptg</font></a></td> 
        		<td class="$row"><a href="javascript:semakLaporan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptd</font></a></td> 
        		<td class="$row"><a href="javascript:semakLaporan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_upt</font></a></td> 
        		#end

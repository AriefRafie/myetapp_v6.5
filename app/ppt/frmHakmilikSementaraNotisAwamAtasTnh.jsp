...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0">Tempat Lain Di Atas/Berhampiran Tanah</li>
  </ul>
  ...
  <tr>
    ...
    <br>
    <fieldset>
        <legend><strong>Senarai Notis Tempat Lain Di Atas/Berhampiran Tanah</strong></legend>
        <table width="100%">
          <tr>
            <td colspan="3"><label>
           #if($mode != 'newAtsTanah' )
          ...
          <tr>
            <td class="row">$fail.bil</td>
             #if ($fail.bil != '')
            <td class="row"><a href="javascript:viewNotisAtsTanah('$fail.id_notisawam')"><font color="blue">$fail.tempat</font></a></td>
            #else
                        <td class="row">$fail.tempat</td>

            #end
            <td width="19%" class="row">$fail.tarikh</td>
          </tr> 
           #end
        </table>
      </fieldset>
...
function simpan(id_permohonan){
	...
	document.${formName}.id_permohonan.value = id_permohonan;
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SementaraNotisAwam&action=addAtasTanah";
	document.${formName}.submit();
}
function batal(){
...
function viewNotisAtsTanah(id_NotisAwam){
	
	document.${formName}.id_NotisAwam.value = id_NotisAwam;
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SementaraNotisAwam&action=viewNotisAtsTanah";
	document.${formName}.submit();
}
function tambah(){
...
function kemaskini(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SementaraNotisAwam&action=updateNotisAtsTanah";
	document.${formName}.submit();
}
function simpan_update(id_NotisAwam){
	...
	if ( !window.confirm("Adakah Anda Pasti?") ) return;
	document.${formName}.id_NotisAwam.value = id_NotisAwam;
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SementaraNotisAwam&action=simpanUpdateAtsTanah";
	document.${formName}.submit();
}
...
function hapus(){
	...
	if ( !window.confirm("Adakah Anda Pasti?") ) return;
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SementaraNotisAwam&action=hapusNotisAtsTanah";
	document.${formName}.submit();
}

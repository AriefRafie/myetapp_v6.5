     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
        ...
        <tr class="table_header">
        	...
        	<tr>
        		...
        		<td class="$row"><a href="javascript:listSurat('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td> 
...
<script>
function listSurat(id_permohonan) {

	document.${formName}.ScreenLocation.value = "top";
	document.${formName}.id_permohonan.value = id_permohonan;
	document.${formName}.command.value = "listSurat";

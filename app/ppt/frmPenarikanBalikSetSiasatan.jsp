...
<legend>SENARAI LOT PENARIKAN BALIK</legend>
             ...
             <table width="100%">
              ...
              <td align="left" width="59%" valign="top">&nbsp;</td>
                ...
                <tr  >
                  ...
                  <table width="100%">
                   ...
                   <!--   <td width="15%">Luas Lot</td> -->
                      <td width="15%" style="display:none">Lebih Kurang Luas yang Hendak Diambil</td>
 ...
 <table width="100%"   > 
  ...
  -->
                 ...
                 <!--     <td >$list.LUAS_LOT</td> -->
                      <td style="display:none" >$list.LUAS_AMBIL</td>
                        <td > 
                          $list.LUAS_LOT_TARIK 
                             </td>
...
<td colspan="3">
 <div align="left"><a href="javascript:maklumatsiasatan('$id_siasatan_tak')" title="Memaparkan secara lengkap nota siasatan"><font color="blue">NOTA SIASATAN </font></a></div></td>
           ...
           <div align="left"><a href="javascript:UrusanSiasatan('$id_hakmilik_tak','$!id_pembatalan')" title="Memaparkan secara lengkap maklumat siasatan"><font color="blue">&nbsp;MAKLUMAT SIASATAN</font></a></div>

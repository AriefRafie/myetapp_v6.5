...
<fieldset>
    ...
    <fieldset>
      ...
      <td class="$row"><a href="javascript:view('$senarai.id_fail','$senarai.id_permohonan','$senarai.id_status','$senarai.id_suburusan')">$senarai.no_fail</a></td>
...
function view(id_fail,id_permohonan,id_status,id_suburusan) {

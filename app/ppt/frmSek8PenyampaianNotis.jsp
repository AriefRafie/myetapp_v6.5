...
<br/>
  ...
  <table width="100%" border="0">
	...
	<table width="100%" border="0">
		...
		<tr>
			...
			<td>Nama Penerima</td>
			<td>:</td>
			<td><input type="text" name="txtNamaTerima" id="txtNamaTerima" value="$!txtNamaTerima" size="80" maxlength="80"   ></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
	...
	<table width="100%" border="0">
		...
		#if($hideItem=="no")
		<tr>
			<td>#if($isEdit=="yes" && $showAst=="yes")<font color="red">*</font>#end</td>
			<td>Nama Penerima</td>
			<td>:</td>
	...
	#end -->
    #if($!id_buktipenyampaian != "") 
     <fieldset id="bottom">
	<legend><strong>&nbsp;MUATNAIK BORANG SABPN <input type="button" name="button" id="button" value="Cetak SABPN" onClick="javascript:cetakSABPN('$id_buktipenyampaian','$id_permohonan','sabpn_notis_borange')" /></strong></legend>
                
               
    <table width="100%" border="0"> 
    <tr >
    <td align="left">
     <a href="javascript:popupCarianDokumen('$id_buktipenyampaian','notis_borange')"><font color="blue">>> SKRIN SENARAI DOKUMEN</font></a>
    </td>
    </tr>
    </table>
	...
	<table width="100%" border="0">
		<tr align="center">
			<td>
			#if($mode=="new")
			<input type="button" name="cmdSimpan" value ="Simpan" onClick="javascript:simpanPenyampaianNotis('$!id_permohonan','$!id_buktipenyampaian','$!mode','$!hideItem','$!showAst')">
			#end
				...
				#else
				<input type="button" name="cmdUpdate" value ="Simpan" onClick="javascript:simpanPenyampaianNotis('$!id_permohonan','$!id_buktipenyampaian','$!mode','$!hideItem','$!showAst')">
	...
	<fieldset id="bottom">
	<legend><strong>Senarai Penerima Notis Borang E</strong>
    
    #if($mode=="view")
		<input type="button" name="cmdTambah" value="Tambah" onClick="javascript:viewListPenyampaianNotis('$!id_permohonan');">
		#end
    <input type="button" name="cmdMasukNotis" value ="KEMASUKAN MAKLUMAT PENYAMPAIAN NOTIS SECARA PUKAL" onClick="javascript:popupCarianPB_HantarPukal('$id_hakmilik','skrin_kemasukan_notis_secara_pukal')">
    </legend>
  ...
  <font class="blink" color="blue" >MAKLUMAT PENYAMPAIAN <B>NOTIS BORANG E</B> TELAH BERJAYA DISIMPAN SECARA PUKAL</font><BR />  
  #end
   <a href="javascript:popupCarianPB('$id_hakmilik','skrin_pb_notis')"><font color="blue">>> SKRIN CAPAIAN PIHAK BERKEPENTINGAN (PENERIMA BORANG E)</font></a>	
    </td>
    </tr>
    </table>
...
<script>
alert("Sila Klik 'Paging' No.16 Untuk Siasatan dan Perintah Sekiranya Tiada Tambahan Bukti Penyampaian");
</script>
#end

#if($showAlertPagingSegera=="yes")
<script>
alert("Sila Klik 'Paging' No.22 Untuk Proses Pengambilan Segera Sekiranya Tiada Tambahan Bukti Penyampaian");
</script>
#end		
...
function cetakSABPN(id_buktipenyampaian,id_permohonan,jenis_report) {
	var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_buktipenyampaian="+id_buktipenyampaian+"&id_permohonan="+id_permohonan+"&report="+jenis_report+"&selectNoFail=yes";	
...
function popupCarianDokumen(id_buktipenyampaian,flag_skrin)
{
	
	var url = "../x/${securityToken}/ekptg.view.ppt.SkrinPopupUploadDokumen?&id_buktipenyampaian="+id_buktipenyampaian+"&flag_skrin="+flag_skrin;
...
function popupCarianPB_HantarPukal(id_hakmilik,flag_skrin)
{
	...
	var url = "../x/${securityToken}/ekptg.view.ppt.SkrinPopupNotisSecaraPukal?&id_hakmilik="+id_hakmilik+"&flag_skrin="+flag_skrin+"&txtNamaHantar="+txtNamaHantar+"&socJenisSerah="+socJenisSerah+"&socStatusSerah="+socStatusSerah+"&txdTarikhSerah="+txdTarikhSerah;
...
function viewHM_displaySelesai(id_hakmilik) {
	document.${formName}.ScreenLocation.value = "top";
	document.${formName}.id_hakmilik.value = id_hakmilik;
	document.${formName}.command.value = "viewListPenyampaianNotis_displaySelesai";
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmSek8PenyampaianNotis";
...
function popupCarianPB(id_hakmilik,flag_skrin)
{
	...
	var url = "../x/${securityToken}/ekptg.view.ppt.SkrinPopupCarianPBNotis?&id_hakmilik="+id_hakmilik+"&flag_skrin="+flag_skrin;
	var hWnd = window.open(url,'printuser','width=1200,height=800, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
       hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function simpanPenyampaianNotis(idpermohonan,idBuktiPenyampaian,mode,valHide,showAst){

  ...
  <tr>
    <td  valign="top"><table width="100%">
      <tr>
        ...
        <td width="28%" valign="top">Pegawai Perundingan</td>
    ...
    <option value="$ln.ID_PEGAWAI">$ln.NAMA_PEGAWAI</option>
     ...
     $!PegawaiSiasatan  
      ...
      <tr style="display:none">
        <td width="1%" valign="top">#parse("app/ppt/mandatory_pembatalan.jsp")</td>
        <td width="28%" valign="top">Status Perundingan</td>
        <td width="1%" valign="top">:</td>
        <td width="70%">
        #if($readmode == "view" ) 
    ...
    <option value="6">SELESAI</option>       
     ...
     <span id="socStatusSiasatan_check" class="alert_msg" ></span>
      ...
      <tr>
        <td width="1%" valign="top">&nbsp;</td>
        <td width="28%" valign="top">Ulasan Keseluruhan Perintah Perundingan</td>
        <td width="1%" valign="top">:</td>
        <td width="70%">
        <!--
       ...
       #if($readmode == "edit")           
        <div><span id="txtUlasanPerintah_num" style="color:blue;" ></span><span> Baki Aksara</span>        
         </div>
         #else
         <input name="txtUlasanPerintah_num" id="txtUlasanSiasatan_num" size="3" value="4000"  style=" display:none" > 
         #end
  <div id="txtUlasanPerintah_check" class="alert_msg" ></div> 
    ...
    <div align="left">Berkongsi Bahagian (Jika Ada)</div></td>
             ...
             #set( $i = $velocityCount )
                    ...
                    <tr >
                      ...
                      <td class="$row">
                      <a href="javascript:open_award('$list.ID_HAKMILIKPB','$!id_siasatan','$list.ID_AWARD')" title="Maklumat Pampasan"><font color="blue">$list.NAMA_PB</font></a>  
...
<legend><strong>SENARAI LAPORAN</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
      ...
      <!-- <td><a href="#" onClick="javascript:cetakBorangQ('$id_fail','$id_hakmilik')"><font color="blue"> Borang Q - Pemberitahu Menduduki Atau Menggunakan Tanah Bagi Sementara          
 </font></a></td>  -->
        
      
     <tr>  
      	 <td><a href="#" onClick="javascript:cetakNotaRundingan('$id_siasatan')"><font color="blue">Nota Rundingan</font></a></td>
      </tr> 
    <!-- 
      <tr>
      ...
      <!-- PPT-43 (i) -->
      <tr>  
      	 <td><a href="#" onClick="javascript:cetakSuratMohonBayaranAgensi('$id_siasatan','$!id_fail','$!id_hakmilik','$!id_permohonan')"><font color="blue">Surat Mohon Bayaran Agensi</font></a></td>
      </tr> 
      <!-- PPT-43 (iv) -->
      <tr>  
...
ttprosiding = ttprosiding + parseInt(tambahtolak);
  ...
  if(ttprosiding==1)
  {
	...
	"checking_validation(this,'txtUlasanprosidingAward_check','no','amaun pampasan banggunan','normal');textarea_kerosakan1()\" "+
	     ...
	     if(ttprosiding>1) {      
	     codes += "<span >"+
	"<input type='button' name='cmdBatalKK' id='cmdBatalKK' value='-' onClick=\"textarea_prosiding(-1,'tolak','');textarea_kerosakan1()\" title='Mengurangkan maklumat pampasan banggunan' > "+
	"</span> ";
	}
	codes +="#end";		 
	codes+=" </td>"+	
...
//PPT-43(i)
function cetakSuratMohonBayaranAgensi(id_siasatan,id_fail,id_hakmilik,id_permohonan) {
	...
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();*/
	var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?idFail="+id_fail+"&id_hakmilik="+id_hakmilik+"&id_permohonan="+id_permohonan+"&report=SuratMohonBayaranAgensi&flagReport=S";	
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function cetakSuratKpdAPRundingan(id_fail,id_hakmilik,id_permohonan) {

	var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?idFail="+id_fail+"&id_hakmilik="+id_hakmilik+"&id_permohonan="+id_permohonan+"&report=SuratKpdAPRundingan&flagReport=S";	
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();	
...
function cetakSuratKepadaJPPHSupayaMenghadiriPerundingan(id_fail,id_permohonan) {

	var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?idFail="+id_fail+"&id_permohonan="+id_permohonan+"&report=SuratKepadaJPPHSupayaMenghadiriPerundingan&flagReport=S";	
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();	

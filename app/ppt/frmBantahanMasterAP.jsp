 ...
 <!--           <option value="1">01-Pihak Berkepentingan</option>   -->                 
        ...
        <tr>
         ...
         Tarikh Terima
          ...
          #else
		  <input type="text" name="txdTkhTerimaBrgN" id="txdTkhTerimaBrgN" value="$!txdTkhTerimaBrgN" size="10" onblur="check_date(this);" onkeyup="validateNumber(this,this.value);" tabindex="3" />
          ...
          <td>#if ($mode=="disabled")<font color="red">*</font>#end</td>
          <td>Tarikh Terima          </td>
        ...
        <tr>
          ...
          #else
          <input type="text" name="txdBrgN" id="txdBrgN" value="$!txdBrgN" size="10" onblur="check_date(this);" onkeyup="validateNumber(this,this.value);" tabindex="4" />
          ...
          #else
          <input type="text" name="txdTkhAward" id="txdTkhAward" value="$!txdTkhAward" size="10" onblur="check_date(this);" onkeyup="validateNumber(this,this.value);" tabindex="10" />
...
<fieldset>
    ...
    <table width="100%" border="0"> 
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td colspan="5">                  	
          	<i><font color="#FF0000" style="font-size:10px"> PAMPASAN PIHAK BERKEPENTINGAN INI KURANG ATAU SAMA DENGAN RM15000.00 </font></i>          </td>
        </tr>
       #end       
        ...
        <tr>
          ...
          #else
          <textarea name="txtMaklumatBantahanTamat" id="txtMaklumatBantahanTamat" cols="50" rows="6" tabindex="22" >$!txtMaklumatBantahanTamat</textarea>
          #end          </td>
        </tr>
...
<!--       <tr>
      ...
      <tr>
         <td><a href="#" class="style2" onClick="javascript:cetakSuratMintaDepositDalam30HariAP('$id_siasatan','$id_permohonan','$id_hakmilik')"><font color="blue"> Surat Makluman Kemukakan Bukti Bayaran - Makluman kepada PB supaya kemukakan bukti bayaran deposit </font></a></td>
      </tr>            
    </table>
</fieldset>
...
function cetakSuratMintaDepositDalam30HariAP(id_siasatan,id_permohonan,id_hakmilik) {
	var url = "../servlet/ekptg.report.ppt.SuratMintaDepositDalam30HariAP?idSiasatan="+id_siasatan+"&idPermohonan="+id_permohonan+"&idHakmilik="+id_hakmilik;
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();	
...
input_box = confirm("Adakah anda pasti?");
	...
	var id_bantahan = document.${formName}.id_bantahan.value ;
	var id_permohonan = document.${formName}.id_permohonan.value ;		
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmBantahanAgensiPemohonSenaraiCarian&command=hapusDokumenMaster&id_bantahan="+id_bantahan+"&id_permohonan="+id_permohonan+"&location=senarai_dokumen&point=senarai_dokumen&readmode="+r;	
	document.${formName}.submit();
	}
}

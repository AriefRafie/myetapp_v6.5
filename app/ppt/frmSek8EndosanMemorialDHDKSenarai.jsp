        ...
        <!--  <tr>
       	...
       	<tr>
      		...
      		<td>:&nbsp;<select name="carianStatus" style="width:150px">
      			...
      			#if($carianStatus=="31")
      			<option value="31">PEWARTAAN</option>				
				<option value="35">MEMORIAL/ENDORSAN DHDK</option>
				<option value="">SILA PILIH</option>
      			#elseif($carianStatus=="35")
      			<option value="35">MEMORIAL/ENDORSAN DHDK</option>
				<option value="31">PEWARTAAN</option>			
				<option value="">SILA PILIH</option>	
      			#else
     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
        ...
        <tr class="table_header">
        	...
        	<tr>
        		...
        		<td class="$row"><a href="javascript:viewEndosan('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td> 
        		<td class="$row"><a href="javascript:viewEndosan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptg</font></a></td> 
        		<td class="$row"><a href="javascript:viewEndosan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptd</font></a></td> 
        		<td class="$row"><a href="javascript:viewEndosan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_upt</font></a></td> 

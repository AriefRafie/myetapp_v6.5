...
#foreach($dataK in $dataHeader)
	#set($projek_daerah = $dataK.projek_daerah)
		...
		<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%" border="0">
						...
						<tr>
 							<td>&nbsp;</td>
 							<td>2.1</td>
 							<td>Pentadbir Tanah $!projek_daerah telah menerima satu permohonan daripada :</td>
						</tr>
						<tr><td colspan="3">&nbsp;</td></tr>
						<tr>
							<td width="2%">&nbsp;</td>
							<td width="3%">&nbsp;</td>
						    <td width="95%">Ketua Pengarah Tanah dan Galian Persekutuan</td>
						</tr>
						<tr>
							<td colspan="2">&nbsp;</td>
							<td>Jabatan Ketua Pengarah Tanah dan Galian</td>
						</tr>
						<tr>
							<td colspan="2">&nbsp;</td>
							<td>(Seksyen Pengambilan Tanah)</td>
						</tr>
						<tr>
							<td colspan="2">&nbsp;</td>
				...
				<tr><td><b>6. PERAKUAN PANGARAH TANAH DAN GALIAN PAHANG :</b></td></tr>
				<tr>
					<td>
					<table width="100%" border="0">

<table width="100%" border="0">
	...
	<!-- PENDAPAT DAN SOKONGAN  -->
	<tr><td><b>3. PENDAPAT DAN SOKONGAN :</b></td></tr>
	...
	<tr>	
		...
		#if($senarai_submmk.size()!=0)
    		#foreach($list in $senarai_submmk)   
    		#if($list.FLAG_JENIS_MMK == "PENDAPAT" && $list.FLAG_JENIS_SUBMMK == "MAIN" )         
    		<input type="hidden" name="PENDAPAT_MAIN_temp1"  id="PENDAPAT_MAIN_temp1" value="$list.KETERANGAN_SUBMMK" >  
    		#end
    		#end
    	#end 
    	
    	
    	<span id="PENDAPAT_MAIN"></span>           
   		<div id="PENDAPAT_MAIN_temp"></div>	
...
//PENDAPAT
function textarea_PENDAPAT_MAIN(tambahtolak,jenis,index_tolak){
	
	var PENDAPAT_MAIN_temp1_length=0;

	if(document.${formName}.PENDAPAT_MAIN_temp1 != null){

		if(document.${formName}.PENDAPAT_MAIN_temp1.length>0){
			PENDAPAT_MAIN_temp1_length = document.${formName}.PENDAPAT_MAIN_temp1.length;
		}else{
			PENDAPAT_MAIN_temp1_length = 1;
		}
	}

	var code_temp1 = "";
	
	if(document.${formName}.txtUlasanPENDAPAT_MAIN!=null){

		if(document.${formName}.txtUlasanPENDAPAT_MAIN.length > 1){
 			for (i = 0; i < document.${formName}.txtUlasanPENDAPAT_MAIN.length; i++){
 				code_temp1 += "<tr><td><input type='hidden' id='PENDAPAT_MAIN_tempX1' name='PENDAPAT_MAIN_tempX1' value= '"+document.${formName}.txtUlasanPENDAPAT_MAIN[i].value+"'></td></tr>";
 			} 
 		}else{
			code_temp1 += "<tr><td><input type='hidden' id='PENDAPAT_MAIN_tempX1' name='PENDAPAT_MAIN_tempX1' value= '"+document.${formName}.txtUlasanPENDAPAT_MAIN.value+"'></td></tr>";
		}
	}


	$jquery("#PENDAPAT_MAIN_temp").html(""+code_temp1); 

	var codes1 = "";

	if(jenis == "umum"){
		if(PENDAPAT_MAIN_temp1_length>0){
			ttPENDAPAT_MAIN = PENDAPAT_MAIN_temp1_length;
		}else{
			ttPENDAPAT_MAIN = 1;
		}
	}
	...
	if(jenis == "tambah"){
		ttPENDAPAT_MAIN = ttPENDAPAT_MAIN + parseInt(tambahtolak);
	}
	...
	if(jenis == "tolak"){
  	...
  	for (i = 0; i < ttPENDAPAT_MAIN; i++){	

  		if(ttPENDAPAT_MAIN==1){
			...
			if(i==0 && jenis == "tolak"){	
				if(parseInt(index_tolak)==0){
					temp_value = document.${formName}.PENDAPAT_MAIN_tempX1[1].value
				}

			    if(parseInt(index_tolak)==1){
					temp_value = document.${formName}.PENDAPAT_MAIN_tempX1[0].value
				} 	
			}		
   			...
   			codes1 += "<table width='100%' border='0'> 																									"+
					  ...
					  "			#if($view=='no') 																										"+
					  "			<td width='95%'> 																										"+
	     			  "		 		<textarea name=\"txtUlasanPENDAPAT_MAIN\" id=\"txtUlasanPENDAPAT_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		
         	          "				onKeyup=\"check_length(this,'30000','txtUlasanPENDAPAT_MAIN_check','txtUlasanPENDAPAT_MAIN_num','normal','no','');textarea_kerosakan1()\"	"+
         			  " 			onKeydown=\"check_length(this,'30000','txtUlasanPENDAPAT_MAIN_check','txtUlasanPENDAPAT_MAIN_num','normal','no','');textarea_kerosakan1()\">"+temp_value+"</textarea>	"+                 			   		
         			  " 			<div ><span id=\"txtUlasanPENDAPAT_MAIN_num\" style=\"color:blue;\" ></span><span>&nbsp;Baki Aksara</span></div>					"+
         			  "				<div id=\"txtUlasanPENDAPAT_MAIN_check\" class=\"alert_msg\" ></div> 													"+
 		 			  "			</td> 																													"+		
 					  "			#end   																													"+		
					  "			#if($view=='yes') 																										"+
					  "			<td width='95%'> 																										"+
	     			  "		 		<textarea $disabilityP name=\"txtUlasanPENDAPAT_MAIN\" id=\"txtUlasanPENDAPAT_MAIN\" cols=\"90\"  rows=\"10\"			"+                  		
         	          "				onKeyup=\"check_length(this,'30000','txtUlasanPENDAPAT_MAIN_check','txtUlasanPENDAPAT_MAIN_num','normal','no','');textarea_kerosakan1()\"	"+
         			  " 			onKeydown=\"check_length(this,'30000','txtUlasanPENDAPAT_MAIN_check','txtUlasanPENDAPAT_MAIN_num','normal','no','');textarea_kerosakan1()\">"+temp_value+"</textarea>	"+                 			   		
         			  " 			<div ><span id=\"txtUlasanPENDAPAT_MAIN_num\" style=\"color:blue;\" ></span><span>&nbsp;Baki Aksara</span></div>			"+
         			  "				<div id=\"txtUlasanPENDAPAT_MAIN_check\" class=\"alert_msg\" ></div> 													"+
					  ...
					  "			<td align='left' valign='top' > 																						"+	 	
					  " 			<input type='button' name='cmdPlus' id='cmdPlus' value='+' 															"+		
					  "				onClick=\"textarea_PENDAPAT_MAIN(1,'tambah','');textarea_kerosakan1()\" > 											";
	      		

		   	if(ttPENDAPAT_MAIN>1) {      
	     	codes1 += "				<input type='button' name='cmdMinus' id='cmdMinus' value='-' 								    					"+
		     	      " 			onClick=\"textarea_PENDAPAT_MAIN(-1,'tolak','');textarea_kerosakan1()\" >												";
			}
			...
			if(ttPENDAPAT_MAIN==2 && i==0 && jenis == "tambah"){	

				temp_value = document.${formName}.PENDAPAT_MAIN_tempX1.value

			}else if(ttPENDAPAT_MAIN>2 && i!=(ttPENDAPAT_MAIN-1) && jenis == "tambah"){	

				temp_value = document.${formName}.PENDAPAT_MAIN_tempX1[i].value

			}else if(ttPENDAPAT_MAIN>1 && i!=(ttPENDAPAT_MAIN+1) && jenis == "tolak"){	

   				if(i==parseInt(index_tolak)){
					temp_value = document.${formName}.PENDAPAT_MAIN_tempX1[parseInt(index_tolak)+1].value
				}
   				...
   				if(i>parseInt(index_tolak)){
    				temp_value = document.${formName}.PENDAPAT_MAIN_tempX1[i+1].value	
				}	

			}else if(ttPENDAPAT_MAIN==1 && i==1 && jenis == "tolak"){
			...
			codes1 += 	"<table width='100%' border='0'> 																								"+
				 		" 	<tr> 																														"+
				  		...
				  		"		<td width='95%'> 																										"+
		     			"		 	<textarea name=\"txtUlasanPENDAPAT_MAIN\" id=\"txtUlasanPENDAPAT_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		
	         	        "			onKeyup=\"check_length(this,'30000','txtUlasanPENDAPAT_MAIN_check"+i+"','txtUlasanPENDAPAT_MAIN_num"+i+"','normal','no','');textarea_kerosakan1()\"	"+
	         			" 			onKeydown=\"check_length(this,'30000','txtUlasanPENDAPAT_MAIN_check"+i+"','txtUlasanPENDAPAT_MAIN_num"+i+"','normal','no','');textarea_kerosakan1()\">"+temp_value+"</textarea>	"+                 			   		
	         			" 			<div ><span id=\"txtUlasanPENDAPAT_MAIN_num"+i+"\" style=\"color:blue;\" ></span><span>&nbsp;Baki Aksara</span></div>		"+
	         			"			<div id=\"txtUlasanPENDAPAT_MAIN_check"+i+"\" class=\"alert_msg\" ></div> 											"+
	 		 			"		</td> 																													"+			
	 		 			"		#end   																													"+	
	 		 			"		#if($!view=='yes') 																										"+
	 		 			"		<td width='95%'> 																										"+
        	...
        	if(ttPENDAPAT_MAIN>1 && ttPENDAPAT_MAIN==(i+1)){  	
			codes1 += 	" 			<input type='button' name='cmdPlus' id='cmdPlus' value='+' 															"+
						"			onClick=\"textarea_PENDAPAT_MAIN(1,'tambah','');textarea_kerosakan1()\" > 											";
			}
			...
			if(ttPENDAPAT_MAIN>1){      
			codes1 += 	"			<input type='button' name='cmdMinus' id='cmdMinus' value='-' 													 	"+
						"			onClick=\"textarea_PENDAPAT_MAIN(-1,'tolak','"+i+"');textarea_kerosakan1()\"> 										";
			}
	...
	$jquery("#PENDAPAT_MAIN").html(codes1);

	
	if(jenis == "tambah" || jenis == "umum" ){
		
		if(PENDAPAT_MAIN_temp1_length > 1 && document.${formName}.txtUlasanPENDAPAT_MAIN.length > 1 ){

		for (t = 0; t < PENDAPAT_MAIN_temp1_length; t++){	
    		document.${formName}.txtUlasanPENDAPAT_MAIN[t].value = document.${formName}.PENDAPAT_MAIN_temp1[t].value;
		}

		}else if(PENDAPAT_MAIN_temp1_length > 1 && document.${formName}.txtUlasanPENDAPAT_MAIN.length < 1 ){
		
			for (t = 0; t < PENDAPAT_MAIN_temp1_length; t++){	
    			document.${formName}.txtUlasanPENDAPAT_MAIN.value = document.${formName}.PENDAPAT_MAIN_temp1[0].value;
			}
		}
		
		else if(PENDAPAT_MAIN_temp1_length == 1){
			document.${formName}.txtUlasanPENDAPAT_MAIN.value = document.${formName}.PENDAPAT_MAIN_temp1.value;
		}
	...
	if(jenis == "tolak"){	
		...
		if(PENDAPAT_MAIN_temp1_length > 1){

			for (t = 0; t < PENDAPAT_MAIN_temp1_length; t++){	 

				if(index_tolak==t){
			  		document.${formName}.PENDAPAT_MAIN_temp1[index_tolak].value = "";	
					var element = document.${formName}.PENDAPAT_MAIN_temp1[index_tolak];
    				element.parentNode.removeChild(element);	
				}
    		}	
	 		...
	 		document.${formName}.PENDAPAT_MAIN_temp1.value = "";			
	 		var element = document.${formName}.PENDAPAT_MAIN_temp1;
     		element.parentNode.removeChild(element); 	 
		}
	...
	if(jenis == "tolak" || jenis == "tambah" || jenis == "umum"){	
		...
		for (i = 0; i < ttPENDAPAT_MAIN; i++){		
		    ...
		    if(ttPENDAPAT_MAIN==1){
		 check_length(document.${formName}.txtUlasanPENDAPAT_MAIN,'30000','txtUlasanPENDAPAT_MAIN_check','txtUlasanPENDAPAT_MAIN_num','normal','no','');	
      
				}else{	
				check_length(document.${formName}.txtUlasanPENDAPAT_MAIN[i],'30000','txtUlasanPENDAPAT_MAIN_check'+i,'txtUlasanPENDAPAT_MAIN_num'+i,'normal','no','');	
			}		 
		}	
	}
...
function textarea_kerosakan1()
{
    ...
    if(PENDAPAT_MAIN_temp1_length > 1 && document.${formName}.txtUlasanPENDAPAT_MAIN.length > 1 ){
		for (t = 0; t < PENDAPAT_MAIN_temp1_length; t++){	
    		document.${formName}.PENDAPAT_MAIN_temp1[t].value = document.${formName}.txtUlasanPENDAPAT_MAIN[t].value;
		}
	}else if(PENDAPAT_MAIN_temp1_length > 1 && document.${formName}.txtUlasanPENDAPAT_MAIN.length < 1 ){
		for (t = 0; t < PENDAPAT_MAIN_temp1_length; t++){	
    		document.${formName}.PENDAPAT_MAIN_temp1[0].value = document.${formName}.txtUlasanPENDAPAT_MAIN.value;
    	}
	}else if(PENDAPAT_MAIN_temp1_length == 1){
		document.${formName}.PENDAPAT_MAIN_temp1.value = document.${formName}.txtUlasanPENDAPAT_MAIN.value;
	}

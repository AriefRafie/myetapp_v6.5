...
#foreach($dataK in $dataHeader)
	...
	#set($projek_daerah = $dataK.projek_daerah)
		...
		<table width="100%" border="0">
				...
				<tr><td><b>4. PERIHAL TANAH-TANAH TERLIBAT :</b></td></tr>
				...
				<tr>
					...
					<table width="100%" border="0">
						...
						<tr>
 							...
 							<td>:</td>
 							<td><input type="text" name="txtJenisPenggunaan" id="txtJenisPenggunaan" maxlength="400" size="50" value="" /></td>
						</tr>
						<tr>
 							<td>&nbsp;</td>
 							<td>4.5</td>
 							<td>Lokasi Tanah</td>
 							<td>:</td>
 							<td><input type="text" name="txtLokasi" id="txtLokasi" maxlength="400" size="50" value="" /></td>
						</tr>
						<tr>
 							<td>&nbsp;</td>
 							<td>4.6</td>
 							...
 							<td>:</td>
 							<td><input type="text" name="txtKedudukan" id="txtKedudukan" maxlength="400" size="50" value="" /></td>
						</tr>
						<tr>
 							<td>&nbsp;</td>
 							...
 							<td valign="top">:</td>
 							<!-- <td><input type="text" name="txtKeadaan" id="txtKeadaan" maxlength="600" size="60" value="" /></td> -->
						...
						<tr>
 							...
 							<td>Jenis Penggunaan Tanah</td>
 							<td>:</td>
 							<td><input type="text" $disabilityP name="txtJenisPenggunaan" id="txtJenisPenggunaan" maxlength="400" size="50" value="$!txtJenisPenggunaan" /></td>
						</tr>
						<tr>
 							<td>&nbsp;</td>
 							<td>4.5</td>
 							<td>Lokasi Tanah</td>
 							<td>:</td>
 							<td><input type="text" $disabilityP name="txtLokasi" id="txtLokasi" maxlength="400" size="50" value="$!txtLokasi" /></td>
						</tr>
						<tr>
 							<td>&nbsp;</td>
 							<td>4.6</td>
 							<td>kedudukan Tanah</td>
 							<td>:</td>
 							<td><input type="text" $disabilityP name="txtKedudukan" id="txtKedudukan" maxlength="400" size="50" value="$!txtKedudukan" /></td>
						</tr>
						<tr>
 							<td>&nbsp;</td>
 							<td valign="top">4.7</td>
 							<td valign="top">Keadaan Tanah</td>
 							<td valign="top">:</td>
 							<!-- <td><input type="text" $disabilityP name="txtKeadaan" id="txtKeadaan" maxlength="600" size="60" value="$!txtKeadaan" /></td> -->
							<td><textarea cols="47%" $disabilityP rows="4" name="txtKeadaan" id="txtKeadaan">$!txtKeadaan</textarea></td>
						</tr>
						#end
				...
				<tr><td><b>5. PENGESYORAN PENTADBIR TANAH JAJAHAN :</b></td></tr>
				...
				<tr><td><b>6. ULASAN PENGARAH TANAH DAN GALIAN KELANTAN :</b></td></tr>
  		...
  		if(ttPERIHALAP_MAIN==1){
			...
			if(i==0 && jenis == "tolak"){	
   			...
   			codes1 += "<table width='100%' border='0'> 																									"+
					  ...
					  "			#if($view=='yes') 																										"+
					  "			<td width='95%'> 																										"+
	     			  "		 		<textarea $disabilityP name=\"txtUlasanPERIHALAP_MAIN\" id=\"txtUlasanPERIHALAP_MAIN\" cols=\"90\"  rows=\"10\"			"+                  		
         	          "				onKeyup=\"check_length(this,'30000','txtUlasanPERIHALAP_MAIN_check','txtUlasanPERIHALAP_MAIN_num','normal','no','');textarea_kerosakan1()\"	"+
         			  " 			onKeydown=\"check_length(this,'30000','txtUlasanPERIHALAP_MAIN_check','txtUlasanPERIHALAP_MAIN_num','normal','no','');textarea_kerosakan1()\">"+temp_value+"</textarea>	"+                 			   		
         			  " 			<div ><span id=\"txtUlasanPERIHALAP_MAIN_num\" style=\"color:blue;\" ></span><span>&nbsp;Baki Aksara</span></div>			"+
         			  "				<div id=\"txtUlasanPERIHALAP_MAIN_check\" class=\"alert_msg\" ></div> 													"+
  		...
  		if(ttPERIHALTANAH_MAIN==1){
			...
			codes1 += 	"<table width='100%' border='0'> 																								"+
				 		" 	<tr> 																														"+
				  		"		<td width='2%'>&nbsp;</td> 																								"+
				  		"		<td width='3%' valign='top'>&nbsp;</td> "+
				  		"		<td width='3%' valign='top'> 4.1."+(i+1)+"  </td> 																		"+
				  		"		#if($!view=='no') 																										"+														
				  		"		<td width='92%'> 																										"+
		     			"		 	<textarea name=\"txtUlasanPERIHALTANAH_MAIN\" id=\"txtUlasanPERIHALTANAH_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		
  		...
  		if(ttULASANPENGARAH_MAIN==1){
			...
			if(i==0 && jenis == "tolak"){	
   			...
   			codes1 += "<table width='100%' border='0'> 																									"+
					  ...
					  "			#if($view=='yes') 																										"+
					  "			<td width='95%'> 																										"+
	     			  "		 		<textarea $disabilityP name=\"txtUlasanULASANPENGARAH_MAIN\" id=\"txtUlasanULASANPENGARAH_MAIN\" cols=\"90\"  rows=\"10\"			"+                  		
         	          "				onKeyup=\"check_length(this,'30000','txtUlasanULASANPENGARAH_MAIN_check','txtUlasanULASANPENGARAH_MAIN_num','normal','no','');textarea_kerosakan1()\"	"+
         			  " 			onKeydown=\"check_length(this,'30000','txtUlasanULASANPENGARAH_MAIN_check','txtUlasanULASANPENGARAH_MAIN_num','normal','no','');textarea_kerosakan1()\">"+temp_value+"</textarea>	"+                 			   		
         			  " 			<div ><span id=\"txtUlasanULASANPENGARAH_MAIN_num\" style=\"color:blue;\" ></span><span>&nbsp;Baki Aksara</span></div>			"+
         			  "				<div id=\"txtUlasanULASANPENGARAH_MAIN_check\" class=\"alert_msg\" ></div> 													"+

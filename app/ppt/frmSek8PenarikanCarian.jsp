...
<table width="100%">
  ...
  <tr>
    ...
    <td>
      <label>
        <input name="txtNoRujJkptgNegeri" type="text" id="txtNoRujJkptgNegeri" size="70" maxlength="100" value="$!txtNoRujJkptgNegeri" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase()" >
        </label>    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>

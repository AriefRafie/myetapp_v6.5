...
<br/>
	...
	#if($mode=="new")
	<fieldset id="top">
	<legend><strong>Penyampaian Notis Borang K</strong></legend>
	...
	<table width="100%" border="0">
     ...
     <fieldset id="bottom">
	<legend><strong>&nbsp;MUATNAIK BORANG SABPN <input type="button" name="button" id="button" value="Cetak SABPN" onClick="javascript:cetakSABPN('$id_buktipenyampaian','$id_permohonan','sabpn_notis_borangk')" /></strong></legend>
                
               
    <table width="100%" border="0"> 
    <tr >
    <td align="left">
     <a href="javascript:popupCarianDokumen('$id_buktipenyampaian','notis_borangk')"><font color="blue">>> SKRIN SENARAI DOKUMEN</font></a>
    </td>
    </tr>
    </table>
	...
	<fieldset id="bottom">
	<legend><strong>Senarai Penerima Notis Borang K</strong>
    
    #if($mode=="view")
		<input type="button" name="cmdTambah" value="Tambah" onClick="javascript:viewListPenyampaianNotis('$!id_permohonan');">
           
		#end
    <input type="button" name="cmdMasukNotis" value ="KEMASUKAN MAKLUMAT PENYAMPAIAN NOTIS SECARA PUKAL" onClick="javascript:popupCarianPB_HantarPukal('$id_hakmilik','skrin_kemasukan_notisK_secara_pukal')">
    </legend>
  ...
  <font class="blink" color="blue" >MAKLUMAT PENYAMPAIAN <B>NOTIS BORANG K</B> TELAH BERJAYA DISIMPAN SECARA PUKAL</font><BR />  
  #end
   <a href="javascript:popupCarianPB('$id_hakmilik','skrin_pb_notis_borangK')"><font color="blue">>> SKRIN CAPAIAN PIHAK BERKEPENTINGAN (PENERIMA BORANG K)</font></a>	
    </td>
    </tr>
    </table>
	<!--
...
<script>
alert("Sila Klik 'Paging' No.23 Untuk Proses Permintaan Ukur Sekiranya Tiada Tambahan Bukti Penyampaian");
</script>
#end
...
function onChangeStatusUpdate(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmSek8PenyampaianNotisBorangK";
...
function viewListPenyampaianNotis_displaySelesai(id_hakmilik) {

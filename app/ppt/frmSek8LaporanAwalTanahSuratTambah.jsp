		...
		<table width="100%" border="0">
			...
			<td width="53%" valign="top"><table width="100%" border="0">
				<tr>
					...
					<td width="1%">:</td>
					<td width="67%"><input type="text" name="txtBilSurat" maxlength="2" id="txtBilSurat" value=""   size="4" onkeyup="validateNumber(this,this.value)" /></td>
				</tr>
				<tr>
					<td>Tarikh Surat</td>
					<td>:</td>
				...
				<tr>
					<td>Tempoh (Minggu)</td>
					<td>:</td>
					<td><input type="text" name="txtTempoh" maxlength="2" id="txtTempoh" value=""   size="4" onkeyup="validateNumber(this,this.value)" /></td>
				</tr>
			</table></td>	
		...
		<table width="100%" border="0">
			...
			<td width="53%" valign="top"><table width="100%" border="0">
				<!-- <tr>
					<td>No. Rujukan</td>
					<td width="1%">:</td>
					<td width="67%"><input type="text" name="txtBilSuratJT" maxlength="2" id="txtBilSuratJT" value=""   size="4" onkeyup="validateNumber(this,this.value)" /></td>
				</tr> -->
				<tr>
				...
				<tr>
					...
					<td>:</td>
					<td><input type="text" name="txtNoRujukan" maxlength="50" id="txtNoRujukan" value=""   size="20"   /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>Tarikh Terima</td>
		...
		<table width="100%" border="0">
			...
			<td width="53%" valign="top"><table width="100%" border="0">
				<tr>
					<td width="32%">No. Rujukan</td>
					<td width="1%">:</td>
					<td width="67%"><input $disability $disabilityx type="text" name="txtBilSurat" maxlength="2" id="txtBilSurat" value="$!txtBilSurat"   size="4" onkeyup="validateNumber(this,this.value)" /></td>
				</tr>
				<tr>
					<td>Tarikh Surat</td>
					<td>:</td>
				...
				<tr>
					<td>Tempoh (Minggu)</td>
					<td>:</td>
					<td><input $disability $disabilityx type="text" name="txtTempoh" maxlength="2" id="txtTempoh" value="$!txtTempoh"   size="4" onkeyup="validateNumber(this,this.value)" /></td>
				</tr>
			</table></td>	
		...
		<table width="100%" border="0">
			...
			<td width="53%" valign="top"><table width="100%" border="0">
				...
				<!-- <tr>
					...
					<td width="1%">:</td>
					<td width="67%"><input $disability $disabilityx type="text" name="txtBilSuratJT" maxlength="2" id="txtBilSuratJT" value="$!txtBilSuratJT"   size="4" onkeyup="validateNumber(this,this.value)" /></td>
				</tr> -->
				<tr>
				...
				<tr>
					...
					<td>No. Rujukan Surat</td>
					<td>:</td>
					<td><input $disability $disabilityx type="text" name="txtNoRujukan" maxlength="50" id="txtNoRujukan" value="$!txtNoRujukan"   size="20"   /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>Tarikh Terima</td>
	...
	<legend><strong>Senarai Jabatan Teknikal</strong></legend>
			...
			<table width="100%" border="0">   
                	<tr>
    					...
    					#end
    					<td width="70%" align="right">Carian Nama Pejabat :&nbsp;<input type="text" name="carianPejabat2" value="$!carianPejabat2" maxlength="70" size="20"   ><a href="javascript:cariPejabat('$!id_permohonan','$!id_ulasanteknikal','$!mode')">&nbsp;<u>CARI</u></a>&nbsp;<a href="javascript:kosongkanPejabat('$!id_permohonan','$!id_ulasanteknikal','$!mode')">&nbsp;<u>KOSONGKAN</u></a></td>
    				</tr>
    		</table>
    		...
    		<table width="100%" border="0"> 
               ...
               <tr>
                   ...
                   <td class="$row">$!listJT.ulasanjt</td>
               <tr>
                    #end
               #else
                    <tr>
...
function cariPejabat(idpermohonan,id_ulasanteknikal,mode) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmSek8JabatanTeknikal";

...
<br/>
	...
	<table width="100%" border="0">
		<tr>
  			...
  			<td width="30%"><b>No. Fail/Rujukan Permintaan Ukur</b></td>
  			<td width="1%">:</td>
...
<br/>
	...
	<table width="100%" border="0">
  		<tr>
  			<td width="1%"><font color="red">$M</font></td>
  			<td width="28%">Luas PA</td>
  			<td width="2%"><b>A</b></td>
  			<td width="1%">:</td>
  			<td width="68%"><input $!disability $!disabilityx type="text" name="txtKeluasanPU" id="txtKeluasanPU" value="$!txtKeluasanPU" size="10" style="text-align:right" maxlength="11" onblur="validateLuas(this,this.value,'$!txtKeluasanPU');kiraBezaLuas()" onkeydown="kiraBezaLuas()" onkeyup="validateNilai(this,this.value);kiraBezaLuas()" >&nbsp;<b>Hektar</b></td>
  		</tr>
  		<tr>
  			<td>&nbsp;</td>
  			<td>Luas Asal</td>
  			<td><b>B</b></td>
  			<td>:</td>
  			<td><input $!disability $!disabilityx type="text" name="lblLuasAsal" id="lblLuasAsal" value="$!lblLuasAsal" size="10" style="text-align:right" maxlength="8" onblur="validateLuas(this,this.value,'$!lblLuasAsal');kiraBezaLuas()" onkeydown="kiraBezaLuas()" onkeyup="validateNilai(this,this.value);kiraBezaLuas()" >&nbsp;<b>Hektar</b></td>
  		</tr>
  		<tr>
  			<td>&nbsp;</td>
  			<td>Luas Borang K</td>
  			<td><b>C</b></td>
  			<td>:</td>
  			<td><input $!disability $!disabilityx type="text" name="lblLuasAmbil" id="lblLuasAmbil" value="$!lblLuasAmbil" size="10" style="text-align:right" maxlength="8" onblur="validateLuas(this,this.value,'$!lblLuasAmbil');kiraBezaLuas()" onkeydown="kiraBezaLuas()" onkeyup="validateNilai(this,this.value);kiraBezaLuas()" >&nbsp;<b>Hektar</b></td>
  		</tr>
  		<tr>
  			<td>&nbsp;</td>
  			...
  			<td>:</td>
  			<td>
  				<input type="text" readonly class="disabled" name="countBakiLuas" id="countBakiLuas" value="$!countBakiLuas" size="10" style="text-align:right" maxlength="8" onblur="validateLuas(this,this.value,'$!countBakiLuas')" onkeyup="validateNilai(this,this.value)" >&nbsp;<b>Hektar</b>
  				<input type="hidden" name="HDcountBakiLuas" id="HDcountBakiLuas" value="$!countBakiLuas">
  			</td>
  		</tr>
  		<tr>
  			<td>&nbsp;</td>
  			...
  			<td>:</td>
  			<td>
  				<input type="text" readonly class="disabled" name="countBezaLuas" id="countBezaLuas" value="$!countBezaLuas" size="10" style="text-align:right" maxlength="8" onblur="validateLuas(this,this.value,'$!countBezaLuas')" onkeyup="validateNilai(this,this.value)" >&nbsp;<b>Hektar</b>
  				<input type="hidden" name="HDcountBezaLuas" id="HDcountBezaLuas" value="$!countBezaLuas">
  			</td>
  		</tr>
  		<tr>
  			<td>&nbsp;</td>
  			...
  			<td><select disabled class="disabled" name="sorJenisPelarasan" style="width:200px">
	      			<option value="" #if($sorJenisPelarasan=="") selected=selected #end >SILA PILIH</option>
	      			<option value="1" #if($sorJenisPelarasan=="1") selected=selected #end >PAMPASAN TAMBAHAN</option>
	      			<option value="2" #if($sorJenisPelarasan=="2") selected=selected #end >PENGURANGAN PAMPASAN</option>
	      			<option value="3" #if($sorJenisPelarasan=="3") selected=selected #end >KEKAL</option>
      			</select>
      			<input type="hidden" name="HDsorJenisPelarasan" id="HDsorJenisPelarasan" value="$!sorJenisPelarasan">
      		</td>		
  		</tr>
  	</table>
...
function kiraBezaLuasNew(saiz_pb) {
	...
	$jquery("#div_total_bhg_per_caj_all").html("<b>"+formatCurrency(fin_total_caj)+"</b>");

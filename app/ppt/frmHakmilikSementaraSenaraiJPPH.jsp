...
<table width="100%">
  <tr>
    ...
    <td width="1%">:</td>
    <td width="70%"><label>
      <input name="txtNoFail" type="text" id="txtNoFail" onkeyup="this.value=this.value.toUpperCase();" value="$CarianFail" size="40" />
    </label></td>
  </tr>
  <tr>
    ...
    <td>:</td>
    <td><label>
      <input name="txdTarikh" type="text" id="txdTarikh" value="$tarikhPermohonan" size="10" onkeyup="validateTarikh(this,this.value)" onblur="check_date(this)" />

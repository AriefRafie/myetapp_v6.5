...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="6" onclick="setSelectedTab(6);tarikBalikBantahan()">Tarik Balik Bantahan
    </li>
...
<!--        <table width="100%"  cellpadding="1" cellspacing="1" border="0">
        	...
        	<i>
            <font color="#FF0000" style="font-size:10px">PERHATIAN</font>
            <font style="font-size:10px">: PERMOHONAN TARIK BALIK BANTAHAN TIDAK DIBENARKAN KERANA MAHKAMAH TELAH MEMBATALKAN PERMOHONAN.</font>&nbsp;
            </i>
      		</td>
      		</td>
            </tr>

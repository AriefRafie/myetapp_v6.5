...
#set($jeniswaktu = "")
#set($id_siasatan = "")
#set($_siasatan = $list_siasatan.size()+1)
...
Tidak Hadir &nbsp; &nbsp;<span id="txtPBhadir_check" class = "alert_msg" >        </span>  
 ...
 Alamat PB
   ...
   <input name="txtAlamat2PB" type="text" id="txtAlamat2PB" value="$txtAlamat2PB" size="50" onBlur="" onKeyUp=""  $readonlymode class = "$disabledmode">
    ...
    #else    
    <select name="socNegeri" class="autoselect" id="socNegeri"  onchange="checking_validation(this,'socNegeri_check','no','negeri','normal');getBandar('$!id_hakmilikpb','$!id_siasatan')"  onblur="checking_validation(this,'socNegeri_check','no','negeri','normal');getBandar('$!id_hakmilikpb','$!id_siasatan')" >  
    #if($socNegeri != "")
...
<legend>SENARAI KEHADIRAN</legend>
  ...
  <table width="100%" >
              <tr>
    <td width="7%">Bil. Siasatan</td>
    <td width="93%" >:
      <select id="bil_siasatan" name="bil_siasatan"  value="$bil_siasatan" onchange="onchangeSiasatan(this.value,'bilsiasatan');">
        <option value = "$bil_siasatan" >Sila Pilih</option>
        
#foreach ( $bil in $senarai_siasatan)

#set ( $selected_siasatan = "" )
#if($bil_siasatan==$bil.BIL_SIASATAN)
#set ( $selected_siasatan = "selected" )
#end


        <option $selected_siasatan value="$bil.ID_SIASATAN" > $bil.BIL_SIASATAN </option>
...
function onchangeSiasatan(id_siasatan) {
	//alert(id_siasatan);

...
<table width="100%" >
   ...
   <div id="TUJUAN_MAIN_temp"></div>   </td>
         ...
         <tr>
              ...
              <td valign="top"><strong>LATARBELAKANG :</strong></td>
              <td valign="top">:</td>
   ...
   <div id="LATARBELAKANG_MAIN_temp"></div>        </td>
              ...
              <td valign="top"><strong>PENGESYORAN :</strong></td>
              <td valign="top">:</td>
               
            
              <td width="60%"><p>Berdasarkan&nbsp; kenyataan di atas, maka Pentadbir Tanah  $nama_daerah1 dengan persetujuan Pengarah Tanah dan Galian,
               Terengganu mengesyorkan  seperti berikut :-</p>               </td>
                 <td width="15%">&nbsp;</td>
  </tr>
  ...
  <tr>
        ...
        <td width="75%" colspan="2"></td>
              ...
              <td valign="top"><strong>TAKSIRAN HARGA TANAH</strong></td>
              <td valign="top">:</td>
               
             
              <td width="75%" colspan="2"> #if($senarai_submmk.size() > 0)
    #foreach($list in $senarai_submmk)   
  ...
  <tr style="display:none">
   ...
   <div id="KESIMPULAN_MAIN_temp"></div> </td>
            ...
            <tr style="display:none">
              ...
              <td valign="top"><strong>HAL-HAL LAIN</strong></td>
              <td valign="top">:</td>
              
            
              <td width="75%" valign="top" colspan="2">  #if($senarai_submmk.size() > 0)
    #foreach($list in $senarai_submmk)   
   ...
   <div id="SYOR_MAIN_temp"></div>  </td>
            ...
            <tr style="display:none">
              ...
              <td width="75%" valign="top" colspan="2">             </td>
         </tr>
</table>

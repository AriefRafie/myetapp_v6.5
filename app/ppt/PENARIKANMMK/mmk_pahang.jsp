...
#set($txtSidang= $view.KETERANGAN_SIDANG)
#set($txtTempatSidang= $view.TEMPAT_SIDANG)
#set($txtTarikhSidang= $view.TARIKH_SIDANG)
#set($txtMasaSidang= $view.WAKTU_SIDANG)
...
<tr   >
    ...
    <td width="18%" valign="top"> <strong>YANG KE</strong></td>
...
<tr   >
              <td  valign="top">&nbsp;</td>
    <td  valign="top"> <strong>KERTAS BIL</strong></td>
    <td valign="top">:</td>
     
    <td  valign="top"></td>
<td valign="top">
        
        <input name="txtMasaSidang" type="text" id="txtMasaSidang" value="$!txtMasaSidang"  size="4" maxlength="4"   $readonlymode class = "$disabledmode"  onKeyUp="validateTarikh(this,this.value);" onBlur="validateTarikh(this,this.value);" /> 
                                  </td>
</tr>
...
<table width="100%" >
   ...
   <div id="LATARBELAKANG_MAIN_temp"></div>        </td>
        ...
        <td width="75%"></td>
              ...
              <td valign="top"><strong>KEDUDUKAN DAN LAPORAN ATAS TANAH</strong></td>
              <td valign="top">:</td>
  ...
  <tr>
        ...
        <td width="75%"></td>
              ...
              <td valign="top"><strong>PENGESAHAN WANG PERUNTUKAN</strong></td>
              <td valign="top">:</td>
  ...
  <tr>
    <td valign="top"><strong>6.</strong></td>
              <td valign="top"><strong>PERAKUAN PENGARAH TANAH DAN GALIAN</strong></td>
              <td valign="top">:</td>
   ...
   <div id="KESIMPULAN_MAIN_temp"></div> </td>
        ...
        <td width="75%"></td>
            ...
            <tr>
              ...
              <td valign="top"><strong>PENUTUP</strong></td>
              <td valign="top">:</td>
...
window.onload = submitForm,check_length(document.${formName}.txtTajuk,'30000','txtTajuk_check','txtTajuk_num','normal','no','ulasan'),

textarea_TUJUAN_MAIN('tambahtolak','umum',''),
textarea_LATARBELAKANG_MAIN('tambahtolak','umum',''),
textarea_SYOR_MAIN('tambahtolak','umum',''),
textarea_ASASPERTIMBANGAN_MAIN('tambahtolak','umum',''),
textarea_IMPLIKASI_MAIN('tambahtolak','umum',''),
textarea_KESIMPULAN_MAIN('tambahtolak','umum',''),
textarea_LAPORANTEKNIKAL_MAIN('tambahtolak','umum',''),
check_length(document.${formName}.txtTempatSidang,'4000','txtTempatSidang_check','txtTempatSidang_num','normal','no','ulasan'),
check_length(document.${formName}.txtSidang,'4000','txtSidang_check','txtSidang_num','normal','no','ulasan'),
checking_validation(document.${formName}.txtTarikhSidang,'txtTarikhSidang_check','yes','persidangan','tarikh');

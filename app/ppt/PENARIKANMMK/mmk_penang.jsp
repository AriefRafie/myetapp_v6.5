...
<table width="100%" >
   ...
   <div id="TUJUAN_MAIN_temp"></div>   </td>
        ...
        <td width="75%"></td>
         ...
         <tr>
              ...
              <td valign="top"><strong>PERIHAL TANAH</strong></td>
              <td valign="top">:</td>
   ...
   <div id="LATARBELAKANG_MAIN_temp"></div>        </td>
        ...
        <td width="75%"></td>
              ...
              <td valign="top"><strong>PERIHAL PERMOHONAN</strong></td>
              <td valign="top">:</td>
  ...
  <tr>
        ...
        <td width="75%"></td>
              ...
              <td valign="top"><strong>ANGGARAN KASAR KOS PENGAMBILAN</strong></td>
              <td valign="top">:</td>
  ...
  <tr>
    <td valign="top"><strong>6.</strong></td>
              <td valign="top"><strong>ULASAN PENTADBIR TANAH DAERAH</strong></td>
    <td valign="top">:</td>
   ...
   <div id="KESIMPULAN_MAIN_temp"></div> </td>
        ...
        <td width="75%"></td>
            ...
            <tr>
              ...
              <td valign="top"><strong>PERAKUAN PENTADBIR TANAH DAERAH</strong></td>
              <td valign="top">:</td>
   ...
   <div id="SYOR_MAIN_temp"></div>  </td>
        ...
        <td width="75%" valign="top">             </td>
         ...
         <tr>
              ...
              <td valign="top"><strong>JAWATANKUASA TANAH NEGERI</strong></td>
           <td valign="top">:</td>
   ...
   <div id="PERAKUAN_MAIN_temp"></div> </td>
        ...
        <td width="75%" valign="top">             </td>
         ...
         <tr>
              ...
              <td valign="top"><strong>KEPUTUSAN MAJLIS</strong></td>
           <td valign="top">:</td>
        ...
        <td width="75%" valign="top">
         ...
         #if($senarai_submmk.size() > 0)
    #foreach($list in $senarai_submmk)   
    #if($list.FLAG_JENIS_MMK == "KEPUTUSANMAJLIS" && $list.FLAG_JENIS_SUBMMK == "MAIN" )         
    <input type="hidden" name="KEPUTUSANMAJLIS_MAIN_temp1"  id="KEPUTUSANMAJLIS_MAIN_temp1" value="$list.KETERANGAN_SUBMMK" >  
    #end
    #end
    #end    
   ...
   <span id="KEPUTUSANMAJLIS_MAIN"></span>           
   <div id="KEPUTUSANMAJLIS_MAIN_temp"></div>
...
window.onload = submitForm,textarea_TUJUAN_MAIN('tambahtolak','umum',''),check_length(document.${formName}.txtTajuk,'30000','txtTajuk_check','txtTajuk_num','normal','no','ulasan'),textarea_LATARBELAKANG_MAIN('tambahtolak','umum',''),textarea_PERIHALTANAH_MAIN('tambahtolak','umum',''),textarea_LAPORANTEKNIKAL_MAIN('tambahtolak','umum',''),textarea_SYOR_MAIN('tambahtolak','umum',''),textarea_KESIMPULAN_MAIN('tambahtolak','umum',''),textarea_PERAKUAN_MAIN('tambahtolak','umum',''),textarea_PERAKUAN_MAIN('tambahtolak','umum',''),textarea_KEPUTUSANMAJLIS_MAIN('tambahtolak','umum',''),textarea_KEPUTUSAN_MAIN('tambahtolak','umum','');


/*
window.onload = submitForm,textarea_TUJUAN_MAIN('tambahtolak','umum',''),textarea_LATARBELAKANG_MAIN('tambahtolak','umum',''),textarea_SYOR_MAIN('tambahtolak','umum',''),check_length(document.${formName}.txtTajuk,'30000','txtTajuk_check','txtTajuk_num','normal','no','ulasan'),textarea_PERIHALTANAH_MAIN('tambahtolak','umum',''),textarea_KEPUTUSAN_MAIN('tambahtolak','umum',''),textarea_KESIMPULAN_MAIN('tambahtolak','umum',''),textarea_LAPORANTEKNIKAL_MAIN('tambahtolak','umum',''),textarea_PERAKUAN_MAIN('tambahtolak','umum',''),textarea_KEPUTUSANMAJLIS_MAIN('tambahtolak','umum','');*/
...
function textarea_KEPUTUSANMAJLIS_MAIN(tambahtolak,jenis,index_tolak)
{

var KEPUTUSANMAJLIS_MAIN_temp1_length=0;

if(document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1 != null)
{

if(document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1.length>0)
{
KEPUTUSANMAJLIS_MAIN_temp1_length = document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1.length;
}
else
{
KEPUTUSANMAJLIS_MAIN_temp1_length = 1;
}
}

var code_temp1 = "";
if(document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN!=null)
{

if(document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN.length > 1)
{
 for (i = 0; i < document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN.length; i++)
 {
 code_temp1 += "<tr><td><input type='hidden' id='KEPUTUSANMAJLIS_MAIN_tempX1' name='KEPUTUSANMAJLIS_MAIN_tempX1' value= '"+document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN[i].value+"'></td></tr>";
 
 } 
}
else
{
code_temp1 += "<tr><td><input type='hidden' id='KEPUTUSANMAJLIS_MAIN_tempX1' name='KEPUTUSANMAJLIS_MAIN_tempX1' value= '"+document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN.value+"'></td></tr>";
...
$jquery("#KEPUTUSANMAJLIS_MAIN_temp").html(""+code_temp1); 
var codes1 = "";

if(jenis == "umum")
{
if(KEPUTUSANMAJLIS_MAIN_temp1_length>0)
{
ttKEPUTUSANMAJLIS_MAIN = KEPUTUSANMAJLIS_MAIN_temp1_length;
}
else
{
ttKEPUTUSANMAJLIS_MAIN = 1;
}
}
if(jenis == "tambah")
{
ttKEPUTUSANMAJLIS_MAIN = ttKEPUTUSANMAJLIS_MAIN + parseInt(tambahtolak);
}
if(jenis == "tolak")
{
ttKEPUTUSANMAJLIS_MAIN = ttKEPUTUSANMAJLIS_MAIN + parseInt(tambahtolak);
  ...
  for (i = 0; i < ttKEPUTUSANMAJLIS_MAIN; i++)
  {	
  if(ttKEPUTUSANMAJLIS_MAIN==1)
  {
	...
	if(parseInt(index_tolak)==0)
    {
	temp_value = document.${formName}.KEPUTUSANMAJLIS_MAIN_tempX1[1].value
	
    }
    if(parseInt(index_tolak)==1)
    {
	temp_value = document.${formName}.KEPUTUSANMAJLIS_MAIN_tempX1[0].value
	...
	codes1 += "<table width='100%'><tr> <td width='5%' valign='top'>  </td>"+
	"<td  > "+
	     " <textarea name=\"txtUlasanKEPUTUSANMAJLIS_MAIN\" id=\"txtUlasanKEPUTUSANMAJLIS_MAIN\" cols=\"80\"   rows=\"9\""+          
         "onBlur=\"check_length(this,'30000','txtUlasanKEPUTUSANMAJLIS_MAIN_check','txtUlasanKEPUTUSANMAJLIS_MAIN_num','normal','no','ulasan kos-kos akibat KEPUTUSANMAJLIS_MAIN');textarea_kerosakan1()\" "+  
         "onKeyup=\"check_length(this,30000,'txtUlasanKEPUTUSANMAJLIS_MAIN_check','txtUlasanKEPUTUSANMAJLIS_MAIN_num','normal','no','ulasan kos-kos akibat KEPUTUSANMAJLIS_MAIN');textarea_kerosakan1()\" "+
         "onKeydown=\"check_length(this,'30000','txtUlasanKEPUTUSANMAJLIS_MAIN_check','txtUlasanKEPUTUSANMAJLIS_MAIN_num','normal','no','ulasan kos-kos akibat KEPUTUSANMAJLIS_MAIN');textarea_kerosakan1()\" "+        
         " $readonlymode class = \"$disabledmode\" >"+temp_value+"</textarea> "+	 		
		 "#if($readmode == 'edit' ) "+           
         "<div ><span id=\"txtUlasanKEPUTUSANMAJLIS_MAIN_num\" style=\"color:blue;\" ></span><span> Baki Aksara</span> "+       
         "</div>"+
         "#else"+
         "<span name=\"txtUlasanKEPUTUSANMAJLIS_MAIN_num\" id=\"txtUlasanKEPUTUSANMAJLIS_MAIN_num\" size=\"3\" value=\"400\"  style=\"display:none\" ></span> "+
         "#end"+
         "<div id=\"txtUlasanKEPUTUSANMAJLIS_MAIN_check\" class=\"alert_msg\" ></div> "+
	" </td>"+
		
	"</tr><tr> <td width='5%' valign='top'>  </td>"+	
	"<td align='left' valign='top' > ";	 	
		 codes1 +=  "#if($readmode == 'edit' ) ";
	     codes1 += " <span ><input type='button' name='cmdBatalNN' id='cmdBatalNN' value='+' onkeypress=\"textarea_KEPUTUSANMAJLIS_MAIN(1,'tambah','');textarea_kerosakan1()\"  onClick=\"textarea_KEPUTUSANMAJLIS_MAIN(1,'tambah','');textarea_kerosakan1()\" title='Menambah maklumat pampasan kos-kos akibat KEPUTUSANMAJLIS_MAIN'> "+
	      " </span>"; 	
	     if(ttKEPUTUSANMAJLIS_MAIN>1) {      
	     codes1 += "<span >"+
	"<input type='button' name='cmdBatalKK' id='cmdBatalKK' value='-' onkeypress=\"textarea_KEPUTUSANMAJLIS_MAIN(-1,'tolak','');textarea_kerosakan1()\" onClick=\"textarea_KEPUTUSANMAJLIS_MAIN(-1,'tolak','');textarea_kerosakan1()\" title='Mengurangkan maklumat pampasan kos-kos akibat KEPUTUSANMAJLIS_MAIN' > "+
	"</span> ";
	}
	codes1 +=" #end";		 
	codes1 +=" </td>"+	
	...
	var temp_value = "";
	var temp_amaunt = "";	
	if(ttKEPUTUSANMAJLIS_MAIN==2 && i==0 && jenis == "tambah")
	{	
	temp_value = document.${formName}.KEPUTUSANMAJLIS_MAIN_tempX1.value
	
	}	
	else if(ttKEPUTUSANMAJLIS_MAIN>2 && i!=(ttKEPUTUSANMAJLIS_MAIN-1) && jenis == "tambah")
	{	
	temp_value = document.${formName}.KEPUTUSANMAJLIS_MAIN_tempX1[i].value
	
	}	
	else if(ttKEPUTUSANMAJLIS_MAIN>1 && i!=(ttKEPUTUSANMAJLIS_MAIN+1) && jenis == "tolak")
	{	
   if(i==parseInt(index_tolak))
   {
	temp_value = document.${formName}.KEPUTUSANMAJLIS_MAIN_tempX1[parseInt(index_tolak)+1].value
   ...
   if(i>parseInt(index_tolak))
   {
    temp_value = document.${formName}.KEPUTUSANMAJLIS_MAIN_tempX1[i+1].value	
	
   }	

	}
	else if(ttKEPUTUSANMAJLIS_MAIN==1 && i==1 && jenis == "tolak")
	{	
   if(parseInt(index_tolak)==0)
   {
	temp_value = document.${formName}.KEPUTUSANMAJLIS_MAIN_tempX1[1].value;	
   ...
   if(parseInt(index_tolak)==1)
   {
	...
	"<td >"+
	     "<textarea name=\"txtUlasanKEPUTUSANMAJLIS_MAIN\" id=\"txtUlasanKEPUTUSANMAJLIS_MAIN\" cols=\"80\"   rows=\"9\""+          
         "onBlur=\"check_length(this,'30000','txtUlasanKEPUTUSANMAJLIS_MAIN_check"+i+"','txtUlasanKEPUTUSANMAJLIS_MAIN_num"+i+"','normal','no','ulasan kos-kos akibat KEPUTUSANMAJLIS_MAIN');textarea_kerosakan1()\" "+  
         "onKeyup=\"check_length(this,30000,'txtUlasanKEPUTUSANMAJLIS_MAIN_check"+i+"','txtUlasanKEPUTUSANMAJLIS_MAIN_num"+i+"','normal','no','ulasan kos-kos akibat KEPUTUSANMAJLIS_MAIN');textarea_kerosakan1()\" "+
         "onKeydown=\"check_length(this,'30000','txtUlasanKEPUTUSANMAJLIS_MAIN_check"+i+"','txtUlasanKEPUTUSANMAJLIS_MAIN_num"+i+"','normal','no','ulasan kos-kos akibat KEPUTUSANMAJLIS_MAIN');textarea_kerosakan1()\" "+         " $readonlymode class = \"$disabledmode\" >"+temp_value+"</textarea> "+	
		 "#if($readmode == 'edit' ) "+           
         "<div ><span id=\"txtUlasanKEPUTUSANMAJLIS_MAIN_num"+i+"\" style=\"color:blue;\" ></span><span> Baki Aksara</span> "+       
         "</div>"+
         "#else"+
         "<span name=\"txtUlasanKEPUTUSANMAJLIS_MAIN_num"+i+"\" id=\"txtUlasanKEPUTUSANMAJLIS_MAIN_num"+i+"\" size=\"3\" value=\"400\"  style=\"display:none\"  ></span> "+
         "#end"+
         "<div id=\"txtUlasanKEPUTUSANMAJLIS_MAIN_check"+i+"\" class=\"alert_msg\" ></div> "+		  
	"</td>"+
	"</tr><tr>"+
		
	"<td width='5%' valign='top'>  </td><td align='left' valign='top' > ";	     	
    codes1 +=  "#if($readmode == 'edit' ) ";		 
    if(ttKEPUTUSANMAJLIS_MAIN>1 && ttKEPUTUSANMAJLIS_MAIN==(i+1)) {  	
	codes1 += " <span ><input type='button' name='cmdBatalNN' id='cmdBatalNN' value='+' onkeypress=\"textarea_KEPUTUSANMAJLIS_MAIN(1,'tambah','');textarea_kerosakan1()\"  onClick=\"textarea_KEPUTUSANMAJLIS_MAIN(1,'tambah','');textarea_kerosakan1()\" title='Menambah maklumat pampasan kos-kos akibat KEPUTUSANMAJLIS_MAIN'> "+
	" </span>"; 
	}
	if(ttKEPUTUSANMAJLIS_MAIN>1) {      
	codes1 += "<span >"+
	"<input type='button' name='cmdBatalKK' id='cmdBatalKK' value='-' onkeypress=\"textarea_KEPUTUSANMAJLIS_MAIN(-1,'tolak','"+i+"');textarea_kerosakan1()\" onClick=\"textarea_KEPUTUSANMAJLIS_MAIN(-1,'tolak','"+i+"');textarea_kerosakan1()\" title='Mengurangkan maklumat pampasan kos-kos akibat KEPUTUSANMAJLIS_MAIN' > "+
	"</span> ";
	}
	codes1 +="#end";		 
	codes1 +=" </td>"+	
	...
	$jquery("#KEPUTUSANMAJLIS_MAIN").html(codes1);

	
	if(jenis == "tambah" || jenis == "umum" )
	{
	if(KEPUTUSANMAJLIS_MAIN_temp1_length > 1 && document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN.length > 1 )
	{
	for (t = 0; t < KEPUTUSANMAJLIS_MAIN_temp1_length; t++)
    {	
    document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN[t].value = document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1[t].value;
	
    }
	}
	else if(KEPUTUSANMAJLIS_MAIN_temp1_length > 1 && document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN.length < 1 )
	{
	for (t = 0; t < KEPUTUSANMAJLIS_MAIN_temp1_length; t++)
    {	
    document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN.value = document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1[0].value;
	}
	}
	else if(KEPUTUSANMAJLIS_MAIN_temp1_length == 1)
	{
	document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN.value = document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1.value;
	}
	}
	...
	if(jenis == "tolak")
	{	
	if(KEPUTUSANMAJLIS_MAIN_temp1_length > 1)
	{
	for (t = 0; t < KEPUTUSANMAJLIS_MAIN_temp1_length; t++)
    {	 
	if(index_tolak==t)
	{  
	document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1[index_tolak].value = "";	
	var element = document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1[index_tolak];
    element.parentNode.removeChild(element);	
	}
    }	
	}
	...
	{	
	 document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1.value = "";			
	 var element = document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1;
     element.parentNode.removeChild(element); 	 
	}
	}			
    ...
    if(ttKEPUTUSANMAJLIS_MAIN==1)
    {	
	check_length(document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN,'30000','txtUlasanKEPUTUSANMAJLIS_MAIN_check','txtUlasanKEPUTUSANMAJLIS_MAIN_num','normal','no','ulasan kos-kos akibat posiding');	
	}
	else
	{	
	check_length(document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN[i],'30000','txtUlasanKEPUTUSANMAJLIS_MAIN_check'+i,'txtUlasanKEPUTUSANMAJLIS_MAIN_num'+i,'normal','no','ulasan kos-kos akibat posiding');	
	}		 
	}	
	}
...
function textarea_kerosakan1()
{
	...
	for (t = 0; t < KEPUTUSANMAJLIS_MAIN_temp1_length; t++)
    {	
    document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1[t].value = document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN[t].value;
	}
	}
	else if(KEPUTUSANMAJLIS_MAIN_temp1_length > 1 && document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN.length < 1 )
	{
	for (t = 0; t < KEPUTUSANMAJLIS_MAIN_temp1_length; t++)
    {	
    document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1[0].value = document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN.value;
    }
	}
	else if(KEPUTUSANMAJLIS_MAIN_temp1_length == 1)
	{
	document.${formName}.KEPUTUSANMAJLIS_MAIN_temp1.value = document.${formName}.txtUlasanKEPUTUSANMAJLIS_MAIN.value;

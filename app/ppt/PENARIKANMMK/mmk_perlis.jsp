...
<table width="100%" >
  ...
  <tr>
        ...
        <td width="75%"></td>
              ...
              <td valign="top"><strong>ULASAN JABATAN TEKNIKAL DAN YANG BERHORMAT AHLI DEWAN UNDANGAN NEGERI</strong></td>
              <td valign="top">:</td>
  ...
  <tr>
        ...
        <td width="75%"></td>
              ...
              <td valign="top"><strong>KEPUTUSAN MESYUARAT JAWATANKUASA TEKNIKAL TANAH</strong></td>
              <td valign="top">:</td>
  ...
  <tr>
    <td valign="top"><strong>6.</strong></td>
              <td valign="top"><strong>ULASAN PENGARAH TANAH DAN GALIAN</strong></td>
              <td valign="top">:</td>
   ...
   <div id="KESIMPULAN_MAIN_temp"></div> </td>
        ...
        <td width="75%"></td>
            ...
            <tr>
              ...
              <td valign="top"><strong>SYOR</strong></td>
              <td valign="top">:</td>
...
window.onload = submitForm,check_length(document.${formName}.txtTajuk,'30000','txtTajuk_check','txtTajuk_num','normal','no','ulasan'),textarea_TUJUAN_MAIN('tambahtolak','umum',''),textarea_KEPUTUSAN_MAIN('tambahtolak','umum',''),textarea_LATARBELAKANG_MAIN('tambahtolak','umum',''),textarea_SYOR_MAIN('tambahtolak','umum',''),textarea_PERIHALTANAH_MAIN('tambahtolak','umum',''),textarea_KESIMPULAN_MAIN('tambahtolak','umum',''),textarea_LAPORANTEKNIKAL_MAIN('tambahtolak','umum',''),textarea_PERAKUAN_MAIN('tambahtolak','umum','');
...
ttKEPUTUSAN_MAIN = ttKEPUTUSAN_MAIN + parseInt(tambahtolak);
  ...
  if(ttKEPUTUSAN_MAIN==1)
  {
	...
	codes1 += "<table width='100%'><tr> <td width='5%' valign='top'>6.1 </td>"+
	"<td  > "+
	     " <textarea name=\"txtUlasanKEPUTUSAN_MAIN\" id=\"txtUlasanKEPUTUSAN_MAIN\" cols=\"80\"   rows=\"9\""+          
         "onBlur=\"check_length(this,'30000','txtUlasanKEPUTUSAN_MAIN_check','txtUlasanKEPUTUSAN_MAIN_num','normal','no','ulasan kos-kos akibat KEPUTUSAN_MAIN');textarea_kerosakan1()\" "+  
         "onKeyup=\"check_length(this,30000,'txtUlasanKEPUTUSAN_MAIN_check','txtUlasanKEPUTUSAN_MAIN_num','normal','no','ulasan kos-kos akibat KEPUTUSAN_MAIN');textarea_kerosakan1()\" "+

...
<table width="100%" >
   ...
   <div id="SEBABPENARIKAN_MAIN_temp"></div>        </td>
        ...
        <td width="75%" valign="top">Pentadbir Tanah $nama_daerah1 mengesyorkan supaya:</td>
         </tr>
  ...
  <tr>
              <td valign="top">5.</td>
              <td valign="top"><strong>ULASAN PENGARAH NEGERI</strong></td>
              <td valign="top">:</td>
    ...
    #if($senarai_submmk.size() > 0)
    #foreach($list in $senarai_submmk)   
    #if($list.FLAG_JENIS_MMK == "ULASAN_PENGARAH" && $list.FLAG_JENIS_SUBMMK == "MAIN" )         
    <input type="hidden" name="ULASAN_PENGARAH_MAIN_temp1"  id="ULASAN_PENGARAH_MAIN_temp1" value="$list.KETERANGAN_SUBMMK" >  
    #end
    #end
    #end    
   ...
   <span id="ULASAN_PENGARAH_MAIN"></span>           
   <div id="ULASAN_PENGARAH_MAIN_temp"></div>        </td>
  </tr>
...
ttTUJUAN_MAIN = ttTUJUAN_MAIN + parseInt(tambahtolak);
  ...
  if(ttTUJUAN_MAIN==1)
  {
	...
	codes1 += "<table width='100%'><tr> <td width='5%' valign='top'>1.1   </td>"+
	"<td  > "+

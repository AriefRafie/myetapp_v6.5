...
<legend>SENARAI LOT PERMOHONAN </legend>
 <table width="100%" border="0"> 
    <tr >
    <td align="left">
    <a href="javascript:popupCarianHakmilik('$id_permohonan','senarai_siasatan_sementara')"><font color="blue">>> SKRIN CAPAIAN HAKMILIK</font></a>
    </td>
    </tr>
    </table>
             ...
             <table width="100%" style="display:none">
              ...
              <td align="left" width="56%" valign="top">&nbsp;</td>
                ...
                <tr  >
                  ...
                  <table width="100%">
                   ...
                   <!--   <td width="15%">Luas Lot</td> -->
                      <td width="15%">Luas Keseluruhan Lot</td>
                       <td width="15%">Lebih Kurang Luas yang Hendak Diambil</td>
                      <td width="15%"><div align="center">Siasatan</div></td>
                    </tr>
    ...
    <td>
        #set($count = 0) 
                 ...
                 <!--     <td >$list.LUAS_LOT</td> -->
                      ...
                      <td >
             <!--         <div align="center"><a href="javascript:UrusanSiasatan('$list.ID_HAKMILIK','$!id_pembatalan')"><font color="blue">MAKLUMAT SIASATAN</font></a></div>-->
  #set($ada_tak = "")
...
<tr>
<td colspan="3">
 <div align="left"><a href="javascript:papar('$id_siasatan_tak','$id_hakmilik_tak')" title="Memaparkan secara lengkap maklumat siasatan"><font color="blue">MAKLUMAT PERUNDINGAN </font></a></div></td>
</tr>
...
<tr>
<td colspan="3">
 <div align="left"><a href="javascript:maklumatsiasatan('$id_siasatan_tak')" title="Memaparkan secara lengkap nota siasatan"><font color="blue">NOTA PERUNDINGAN</font></a></div></td>
</tr>
</table> 
               #else      
                     
           
           <div align="left"><a href="javascript:UrusanSiasatan('$id_hakmilik_tak','$!id_pembatalan')" title="Memaparkan secara lengkap maklumat siasatan"><font color="blue">&nbsp;MAKLUMAT PERUNDINGAN</font></a></div>
...
function UrusanSiasatan(id_hakmilik,id_pembatalan)
{

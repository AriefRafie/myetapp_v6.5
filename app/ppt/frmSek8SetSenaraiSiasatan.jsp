...
#foreach($list_siasatan in $list_siasatan)
...
<td>
  ...
  <tr>
    ...
    <td width="1%">:</td>
    <td width="70%"><input name="txtNoKes" type="text" id="txtNoKes" value="$txtNoKes" size="25" maxlength="25"  onBlur="checking_validation(this,'txtNoKes_check','yes','no kes','normal')" style="" onKeyUp="checking_validation(this,'txtNoKes_check','yes','no kes','normal')"  $readonlymode class = "$disabledmode">
  ...
  <tr>
    ...
    <td>No. Siasatan</td>
    <td>:</td>
    <td><input name="txtNoSiasatan" type="text" id="txtNoSiasatan" value="$txtNoSiasatan" size="25" maxlength="25"  onBlur="checking_validation(this,'txtNoSiasatan_check','yes','no siasatan','normal')" style="" onKeyUp="checking_validation(this,'txtNoSiasatan_check','yes','no siasatan','normal')"  $readonlymode class = "$disabledmode">
  ...
  <tr>
    ...
    <td>:</td>
    <td><input name="txtTempatSiasatan" type="text" id="txtTempatSiasatan" value="$txtTempatSiasatan" size="50" onBlur="checking_validation(this,'txtTempatSiasatan_check','yes','tempat siasatan','normal')" style="" onKeyUp="checking_validation(this,'txtTempatSiasatan_check','yes','tempat siasatan','normal')"  $readonlymode class = "$disabledmode">
  ...
  <tr>
    ...
    <td>Alamat</td>
    <td>:</td>
    <td><input name="txtAlamat1" type="text" id="txtAlamat1" value="$txtAlamat1" size="50" onBlur="checking_validation(this,'txtAlamat1_check','yes','alamat','normal')" style="" onKeyUp="checking_validation(this,'txtAlamat1_check','yes','alamat','normal')"  $readonlymode class = "$disabledmode">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>:</td>
    <td><input name="txtAlamat2" type="text" id="txtAlamat2" value="$txtAlamat2" size="50" onBlur="" style=""  $readonlymode class = "$disabledmode"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>:</td>
    <td><input name="txtAlamat3" type="text" id="txtAlamat3" value="$txtAlamat3" size="50" onBlur="" style=""  $readonlymode class = "$disabledmode"></td>
  </tr>
  <tr>
    <td>#parse("app/ppt/mandatory_pembatalan.jsp")</td>
    <td>Poskod</td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td>
     ...
     <input name="bil_siasatanx" type="text" id="bil_siasatanx" size="10" maxlength="10"   value="$!bil_siasatan" readonly class='disabled' />   
      <input name="bil_siasatan" type="hidden" id="bil_siasatan" value="$!bil_siasatan" />
     </td>
  </tr>
  <tr>
    <td>#parse("app/ppt/mandatory_pembatalan.jsp")</td>
  ...
  <tr>
    ...
    <!-- <textarea name="txtAlasan" id="txtAlasan" cols="50" rows="6"  onBlur="checking_validation(this,'txtAlasan_check','yes','alasan tangguh / batal','normal')"  onKeyUp="checking_validation(this,'txtAlasan_check','yes','lokasi tanah','normal')"  $readonlymode class = "$disabledmode">$txtAlasan</textarea>
      ...
      -->
       ...
       <textarea name="txtAlasan" id="txtAlasan" cols="60"   rows="6"        
        ...
        <div><span id="txtAlasan_num" style="color:blue;" ></span><span> Baki Aksara</span>         </div>
         ...
         #end
  <div id="txtAlasan_check" class="alert_msg" ></div>       </td>
  </tr>
...
<input type="button" value="Kembali Skrin Hakmilik" onClick="popupCarianHakmilik('$id_permohonan','senarai_siasatan')">   
	...
	<!-- syarat dlm hm ada pb yang TDK. -->
	#if($countTDK>0)
	<input name="" type="button" value="Siasatan tidak diteruskan" onClick="popupCatatanSiasatan('$!id_hakmilik','$!id_permohonan','$!id_fail','$!id_suburusanstatusfailppt')">
	#end
#else
...
#end <!-- close if($flag_stop_siasatan!="Y") -->
...
function cetakNotaSiasatan(id_siasatan,id_hakmilik){	
	var url = "../servlet/ekptg.report.ppt.NotaSiasatanKosong?id_siasatan="+id_siasatan+"&idHakmilik="+id_hakmilik; 
...
function popupCatatanSiasatan(id_hakmilik,id_permohonan,id_fail,id_suburusanstatusfailppt){	

	var w = "350";
	var h = "200";
	var left = (screen.width/2)-(w/2);
	var top = (screen.height/2)-(h/2);
	var url = "../x/${securityToken}/ekptg.view.ppt.FrmPopupStopSiasatan?id_hakmilik="+id_hakmilik+"&id_permohonan="+id_permohonan+"&id_fail="+id_fail+"&id_suburusanstatusfailppt="+id_suburusanstatusfailppt;
	
	var hWnd = window.open(url, "Siasatan tidak diteruskan", 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
	if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();

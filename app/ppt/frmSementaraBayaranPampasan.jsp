...
<!--					<tr>
					...
					<tr>
						...
						<td>Nama Bank</td>
						<td>:</td>
						<td><input type="text" name="txtNamaBank" id="txtNamaBank" value="" size="40" maxlength="50" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					...
					<tr>
						...
						<td>Tempat Ambil</td>
						<td>:</td>
						<td><input type="text" name="txtTempatAmbil" id="txtTempatAmbil" value="" size="40" maxlength="100" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
					</tr>
				...
				<table width="100%" border="0">
					...
					<tr>
						...
						<td>Nama Bank</td>
						<td>:</td>
						<td><input $disability $disabilityx type="text" name="txtNamaBank" id="txtNamaBank" value="$!txtNamaBank" size="40" maxlength="50" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td>Tarikh Ambil Cek</td>
					...
					<tr>
						...
						<td>Tempat Ambil</td>
						<td>:</td>
						<td><input $disability $disabilityx type="text" name="txtTempatAmbil" id="txtTempatAmbil" value="$!txtTempatAmbil" size="40" maxlength="100" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
					</tr>
					<tr><td colspan="4">&nbsp;</td></tr>
				</table>
				#end
  	  		...
  	  		<fieldset>
  	  			<table width="100%" border="0">
  					...
  					<tr>
  						...
  						<td>No. PB</td>
  						<td>:</td>
  						<td><input readonly class="disabled" type="text" name="txtNoPB" id="txtNoPB" value="$!lblNoPB" size="20" maxlength="20" onblur="this.value=this.value.toUpperCase()" style="text-transform:uppercase;" ></td>
  					</tr>
  	  			</table>
  	  		</fieldset>
  	  		...
  	  		<fieldset>
  	  			...
  	  			<table width="100%" border="0">
  	  				<tr>
  	  					...
  	  					<td width="1%">:</td>
  	  					<td width="73%"><input type="text" name="txtNoRujSuratEft" id="txtNoRujSuratEft" value="$!txtNoRujSuratEft" size="40" maxlength="50" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
  	  				</tr>
  	  				<tr>
  	  					<td>&nbsp;</td>
  	  					<td>No. EFT</td>
  	  					<td>:</td>
  	  					<td><input type="text" name="txtNoEft" id="txtNoEft" value="$!txtNoEft" size="40" maxlength="100" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
  	  				</tr>
  	  				<tr>
  	  					<td>&nbsp;</td>
  	  					<td>Amaun</td>
...
<!--  	  				<tr>
  	  				...
  	  				<tr>
  	  					...
  	  					<td>No. Baucer</td>
  	  					<td>:</td>
  	  					<td><input type="text" name="txtNoBaucer" id="txtNoBaucer" value="$!txtNoBaucer" size="20" maxlength="20" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
  	  				</tr>
  	  				<tr>
  	  					<td>&nbsp;</td>
				...
				<fieldset>
  	  			...
  	  			<table width="100%" border="0">
  	  				<tr>
  	  					...
  	  					<td width="25%">No. Rujukan Surat EFT</td>
  	  					<td width="1%">:</td>
  	  					<td width="73%"><input $disability $disabilityx type="text" name="txtNoRujSuratEft" id="txtNoRujSuratEft" value="$!txtNoRujSuratEft" size="40" maxlength="50" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
  	  				</tr>
  	  				<tr>
  	  					<td>&nbsp;</td>
  	  					<td>No. EFT</td>

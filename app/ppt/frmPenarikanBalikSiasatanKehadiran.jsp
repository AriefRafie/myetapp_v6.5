...
<div> 
  ...
  <tr>
   ...
   <tr  class="$row" >
    ...
    <td id="$list.NO_PB">
    <div align="left"><a href="javascript:paparpb('$list.ID_HAKMILIKPB');" title="Klik untuk maklumat lengkap turut hadir"><font color="blue">$list.NAMA_PB</font></a>

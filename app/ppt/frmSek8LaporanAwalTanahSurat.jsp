	...
	<legend><strong>Senarai Jabatan Teknikal</strong></legend>
			...
			<table width="100%" border="0">   
                	<tr>
    					...
    					<td width="70%" align="right">Carian Nama Pejabat :&nbsp;<input type="text" name="carianPejabat" value="$!carianPejabat" maxlength="70" size="20"   ><a href="javascript:cariPejabat('$!id_permohonan')">&nbsp;<u>CARI</u></a>&nbsp;<a href="javascript:kosongkanPejabat('$!id_permohonan')">&nbsp;<u>KOSONGKAN</u></a></td>
    				</tr>
    		</table>
    		...
    		<table width="100%" border="0"> 
        		...
        		<tr class="table_header">
            		...
            		<td><b>Ulasan Jabatan Teknikal</b></td> 

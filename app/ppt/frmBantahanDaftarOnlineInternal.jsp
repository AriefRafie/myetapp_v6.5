...
<legend>Maklumat Bantahan</legend>
    <table width="100%" border="0">
        ...
        <tr>
          ...
          #else
           <input type="text" name="txtNoHakmilik" id="txtNoHakmilik" value="$!txtNoHakmilik" />
          #end          </td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
            ...
            #else
            <input type="text" name="txtNoLot" id="txtNoLot" value="$!txtNoLot" />
            #end            </td>
            <td>&nbsp;</td>
            <td>&nbsp;&nbsp;&nbsp;</td>
           	<td>&nbsp;</td>
...
<fieldset>
    ...
    <table width="100%" border="0">
        <tr>
            <td width="25%"><font color="red">*</font>&nbsp;Nama Pembantah</td>
            <td width="1%">:</td>
            <td colspan="5">
            ...
            #else
            <input type="text" name="txtNamaPembantah" id="txtNamaPembantah" value="$!txtNamaPembantah" size="60" tabindex="12" />
            #end
        ...
        <tr>
            ...
            #else
            <input type="text" name="txtAlamat1" id="txtAlamat1" value="$!txtAlamat1" size="60" />
            #end
        ...
        <tr>
            ...
            #else
            <input type="text" name="txtAlamat2" id="txtAlamat2" value="$!txtAlamat2" size="60" tabindex="13" />
            #end                   
        ...
        <tr>
            ...
            #else
            <input type="text" name="txtAlamat3" id="txtAlamat3" value="$!txtAlamat3" size="60" tabindex="14" />
            #end
        ...
        <tr>
          ...
          #else
          <input type="text" name="txtPoskod" id="txtPoskod" value="$!txtPoskod" maxlength="5" size="5" onkeyup="validateNumber(this,this.value);" tabindex="15" />
          #end        
...
<div align="center">
          ...
          #if ($flagOnline=="2")
          <input type="button" name="cmdSah" id="cmdSah" value="Sahkan Permohonan" onclick="javascript:Kaunter_sahkanPermohonan()" /> 
          #end
...
function Kaunter_sahkanPermohonan(){
	if ( !window.confirm("Adakah Anda Pasti?") ) return;
	document.${formName}.command.value = "Kaunter_sahkanPermohonan";	

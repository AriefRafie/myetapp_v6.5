	...
	<legend><strong>Senarai Maklumat Hakmilik</strong></legend>
    		...
    		<table width="100%" border="0"> 
               ...
               <tr>
                   ...
                   <td class="$row">
                   <a href="javascript:screenBorangN('$!id_fail','$!id_permohonan','$!id_status','$!listTanah.id_hakmilik','$!listTanah.flag_bantahan')"><font color="blue">$!listTanah.no_hakmilik</font></a>
				   </td>
...
<input type="hidden" name="flag_bantahan" />
...
function screenBorangN(id_fail,id_permohonan,id_status,id_hakmilik,flag_bantahan) {
...
/*
function viewBorangN_Bantahan(id_fail,id_permohonan,id_status,id_hakmilik) {

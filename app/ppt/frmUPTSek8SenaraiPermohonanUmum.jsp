...
<fieldset>
  <legend><strong>Carian.</strong></legend>
	<table width="100%" cellspacing="2" cellpadding="0" border="0">
    	 ...
    	 <tr>
    		<td width="1%">&nbsp;</td>
        	<td width="28%">No.Fail Permohonan / PTG / PTD / UPT</td>
            <td width="1%">:</td>
            <td  width="70%">
            <input type="text" name="nofail" value="$!nofail" style="text-transform:uppercase;" id="nofail" size="35" onkeyup="this.value=this.value.toUpperCase();" /></td>
        ...
        <tr>
            ...
            <td>:</td>
      		<td><select name="carianStatus" class="autoselect">
      			...
      			#if($carianStatus=="127")
      			<option value="127">DISAHKAN PENGARAH</option>
				<option value="16">MAKLUMAT HAKMILIK</option>
				<option value="">SILA PILIH</option>
      			#elseif($carianStatus=="16")
      			<option value="16">MAKLUMAT HAKMILIK</option>
				<option value="127">DISAHKAN PENGARAH</option>
				<option value="">SILA PILIH</option>
				#else
     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
        ...
        <tr class="table_header">
        	...
        	<tr>
        		...
        		<td class="$row"><a href="javascript:semakHM('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td> 
        		<td class="$row"><a href="javascript:semakHM('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptg</font></a></td> 
        		<td class="$row"><a href="javascript:semakHM('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptd</font></a></td> 
        		<td class="$row"><a href="javascript:semakHM('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_upt</font></a></td> 

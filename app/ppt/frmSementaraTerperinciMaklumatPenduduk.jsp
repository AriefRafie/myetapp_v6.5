...
#foreach($data in $dataBangunan)
	...
	#set($txtJenisBangunan=$data.jenis_bangunan)
	...
	<table width="100%" border="0">
		<tr>
    		...
    		<td width="1%">:</td>
    		<td width="73%"><input type="text" $disOtherId $disOtherIdx name="txtNoUnit" value="$!txtNoUnit" id="txtNoUnit" size="10" maxlength="10" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
    	</tr>
    	#if($txtKadarSewa=="")
           #set($kadar="")
        #else
		...
		<tr>
    		...
    		<td>
              ...
              <input type="text" $disOtherId $disOtherIdx name="txtSaizBangunan" id="txtSaizBangunan" value="$!txtSaizBangunan" size="10" maxlength="10" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" >
    ...
    <table width="100%" border="0">	
    	...
    	<tr>
    		...
    		<td>Nama</td>
    		<td>:</td>
    		<td><input $disOtherId $disOtherIdx type="text" name="txtNama" id="txtNama" value="$!txtNama" size="50" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
    	</tr>
    	<tr>
			<td>&nbsp;</td>
			<td>Kod No. PB</td>
		...
		<tr>
			...
			<td>No. PB</td>
			<td>:</td>
			<td><input $disOtherId $disOtherIdx type="text" name="txtNoPB" id="txtNoPB" value="$!txtNoPB" size="20" maxlength="20" onblur="this.value=this.value.toUpperCase();checkExistPB()" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>Perihal Jenis PB (lain-lain)</td>
			<td>:</td>
			<td><input $disOtherId $disOtherIdx type="text" name="txtJenisPB" id="txtJenisPB" value="$!txtJenisPB" size="20" maxlength="100" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>		
		<tr>
			<td>&nbsp;</td>
			<td>Bangsa</td>
		...
		<tr>
			...
			<td>Alamat</td>
			<td>:</td>
			<td><input $disOtherId $disOtherIdx type="text" name="txtAlamat1" id="txtAlamat1" value="$!txtAlamat1" size="50" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
			<td><input $disOtherId $disOtherIdx type="text" name="txtAlamat2" id="txtAlamat2" value="$!txtAlamat2" size="50" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
			<td><input $disOtherId $disOtherIdx type="text" name="txtAlamat3" id="txtAlamat3" value="$!txtAlamat3" size="50" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>Poskod</td>
	...
	<table width="100%" border="0">
		<tr>
    		...
    		<td width="25%">No. Unit</td>
    		<td width="1%">:</td>
    		<td width="73%"><input $disability $disabilityx type="text" name="txtNoUnit" value="$!txtNoUnit" id="txtNoUnit" size="10" maxlength="10" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
    	</tr>
    	<tr>
			<td>&nbsp;</td>
			<td>Kadar Sewaan (RM)</td>
		...
		<tr>
    		...
    		<td>:</td>
    		<td>
              <input type="text" $disability $disabilityx name="txtSaizBangunan" id="txtSaizBangunan" value="$!txtSaizBangunan" size="10" maxlength="10" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" >
    ...
    <table width="100%" border="0">	
    	...
    	<tr>
    		...
    		<td>Nama</td>
    		<td>:</td>
    		<td><input $disability $disabilityx type="text" name="txtNama" id="txtNama" value="$!txtNama" size="50" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
    	</tr>
    	<tr>
			<td>&nbsp;</td>
			<td>Kod No. PB</td>
		...
		<tr>
			...
			<td>No. PB</td>
			<td>:</td>
			<td><input type="text" $disability $disabilityx name="txtNoPB" id="txtNoPB" value="$!txtNoPB" size="20" maxlength="20" onblur="this.value=this.value.toUpperCase()" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>Perihal Jenis PB (lain-lain)</td>
			<td>:</td>
			<td><input type="text" $disability $disabilityx name="txtJenisPB" id="txtJenisPB" value="$!txtJenisPB" size="20" maxlength="100" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>		
		<tr>
			<td>&nbsp;</td>
			<td>Bangsa</td>
		...
		<tr>
			...
			<td>Alamat</td>
			<td>:</td>
			<td><input type="text" $disability $disabilityx name="txtAlamat1" id="txtAlamat1" value="$!txtAlamat1" size="50" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
			<td><input type="text" $disability $disabilityx name="txtAlamat2" id="txtAlamat2" value="$!txtAlamat2" size="50" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
			<td><input type="text" $disability $disabilityx name="txtAlamat3" id="txtAlamat3" value="$!txtAlamat3" size="50" maxlength="80" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>Poskod</td>
...
<br/>    
    ...
    <fieldset>
    <legend>Senarai Maklumat Pemilik/Penyewa/Pembeli/Lain-lain
    ...
    <tr >
    <td align="left">
    <a href="javascript:popupCarianBangunan('$id_permohonan','$!id_hakmilik','skrin_pb_bangunan_sementara','$!id_bangunan')"><font color="blue">>> SKRIN CAPAIAN BANGUNAN</font></a>
    </td>
    </tr>
    </table>
    <!--

...
<table width="100%">
  ...
  <tr>
    <td width="50%" valign="top"><table width="100%">
      ...
      <tr>
        <td width="1%">&nbsp;</td>
        <td width="28%">No. Pembatalan</td>
        <td width="1%">:</td>
        <td width="70%">
          <label>
         
          <input name="txtNoPembatalan" type="text" id="txtNoPembatalan" size="50" maxlength="50" value="$txtNoPembatalan" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" readonly class = "disabled"   >
          </label>        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>Tarikh Pembatalan</td>
        <td>:</td>
        <td>
      
        <input name="txdTarikhPembatalan" type="text" id="txdTarikhPembatalan" size="10" maxlength="10"  value="$txdTarikhPembatalan" onblur="validateTarikh(this,this.value);check_date(this)" onKeyUp="validateTarikh(this,this.value);" readonly class = "disabled" />
    <!--
      #if($readmode == "edit")
      ...
      #end
       <span id="txdTarikhSurat_check" style="color:red" ></span>
      ...
      <a href="javascript:displayDatePicker('txdTarikhTerimaSurat',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/></a>
       <span style="font-size:9px;color:blue;font-style:italic">dd/mm/yyyy</span>
      #end
      <span id="txdTarikhTerimaSurat_check" style="color:red" ></span>
      </td>
      </tr>
      <tr>
        <td>#parse("app/ppt/mandatory_pembatalan.jsp")</td>
        <td>No. Ruj Surat</td>
        <td>:</td>
        <td><input name="txtNoRujSurat" type="text" id="txtNoRujSurat" size="50" maxlength="50" value="$txtNoRujSurat" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();checking_validation(this,'txtNoRujSurat_check','yes','no rujukan surat','normal')" $readonlymode class = "$disabledmode" onkeyup="this.value=this.value.toUpperCase();checking_validation(this,'txtNoRujSurat_check','yes','no rujukan surat','normal')" >
        <div id="txtNoRujSurat_check" style="color:red" ></div>
        </td>
      </tr>
      <tr>
        <td width="1%">#parse("app/ppt/mandatory_pembatalan.jsp")</td>
        <td width="28%">Pilihan Pembatalan</td>
        <td width="1%">:</td>
        <td width="70%">
          <label></label>
        #if($readmode == "view" )
     ...
     <input type="radio" name="sorJenisPembatalanD" id="sorJenisPembatalanD" value="keseluruhan" $check2 disabled onclick="return false;" >
           ...
           #end
          <div id="sorJenisPembatalan_check" style="color:red;width:60%"></div>
          </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td valign="top">Sebab Pembatalan</td>
        <td valign="top">:</td>
        <td>
        <textarea name="txtSebabPembatalan" id="txtSebabPembatalan" cols="40"  rows="5" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" $readonlymode class = "$disabledmode" >$txtSebabPembatalan</textarea>        </td>
      </tr>
    </table></td>
  ...
  <tr>
    <td width="100%" colspan="2" valign="top"><table width="100%">
     #if($id_pembatalan != "")
      <tr>
        <td width="1%">&nbsp;</td>
        <td width="28%">No. Pembatalan</td>
   ...
   <!--   #if($readmode == "edit")
      ...
      <tr style="display:none">
        ...
        <td width="1%">:</td>
        <td width="70%">
        <input name="txdTarikhSurat" type="text" id="txdTarikhSurat" size="10" maxlength="10"   value="$txdTarikhSurat" onblur="validateTarikh(this,this.value);checking_validation(this,'txdTarikhSurat_check','no','surat pembatalan','tarikh')" onKeyUp="validateTarikh(this,this.value);" $readonlymode class = "$disabledmode" />
      #if($readmode == "edit")  
      <a href="javascript:displayDatePicker('txdTarikhSurat',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/></a>
       <span style="font-size:9px;color:blue;font-style:italic">dd/mm/yyyy</span>
      #end
      ...
      <tr style="display:none">
        ...
        <td>:</td>
        <td>
        <input name="txdTarikhTerimaSurat" type="text" id="txdTarikhTerimaSurat" size="10" maxlength="10" value="$txdTarikhTerimaSurat" onblur="validateTarikh(this,this.value);checking_validation(this,'txdTarikhTerimaSurat_check','no','terima surat','tarikh')" onKeyUp="validateTarikh(this,this.value);" $readonlymode class = "$disabledmode" />
      #if($readmode == "edit")
      <a href="javascript:displayDatePicker('txdTarikhTerimaSurat',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/></a>
       <span style="font-size:9px;color:blue;font-style:italic">dd/mm/yyyy</span>
      #end
      ...
      <tr>
        ...
        <td width="1%">#parse("app/ppt/mandatory_pembatalan.jsp")</td>
        <td width="28%">No. Ruj Surat</td>
        <td width="1%">:</td>
        <td width="70%"><input name="txtNoRujSurat" type="text" id="txtNoRujSurat" size="50" maxlength="50" value="$txtNoRujSurat" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();checking_validation(this,'txtNoRujSurat_check','yes','no rujukan surat','normal')"  onkeyup="this.value=this.value.toUpperCase();checking_validation(this,'txtNoRujSurat_check','yes','no rujukan surat','normal')" $readonlymode class = "$disabledmode" >
        <div id="txtNoRujSurat_check" style="color:red" ></div>
        </td>
      </tr>
...
checking_validation(txtNoRujSurat,'txtNoRujSurat_check','yes','no rujukan surat','normal');
...
function doCheckAll(jumlah_lot,belumbatal,sudahbatal){ 
	...
	if(valid == "no")
	{
	   ...
	   document.${formName}.alert_message.value  = "Sila pastikan pilihan pembatalan adalah sebahagian atau keseluruhan";	  
	   url = "../servlet/ekptg.view.ppt.PenarikanBalikCheck";
	   actionName = "checking_validation";
	   target = "sorJenisPembatalan_check";
	   doAjaxUpdater(document.${formName}, url, target, actionName);	
...
function check_lot_tarik()
{
	  ...
	  else if((parseFloat(document.${formName}.lot_tarik[i].value) > parseFloat(document.${formName}.lot_ambil[i].value)) && document.${formName}.ids[i].checked == false)
	  {	 
...
//alert("LALAL"+document.${formName}.id_lot_tarik.length);
	if (document.${formName}.lot_tarik.value == "" && document.${formName}.ids.checked == false)
	  ...
	  else if((parseFloat(document.${formName}.lot_tarik.value) > parseFloat(document.${formName}.lot_ambil.value)) && document.${formName}.ids.checked == false)
	  {	 
	       document.${formName}.alert_message.value  = "Sila pastikan luas lot kurang daripada luas ambil";
		   url = "../servlet/ekptg.view.ppt.PenarikanBalikCheck";
		   actionName = "checking_validation";

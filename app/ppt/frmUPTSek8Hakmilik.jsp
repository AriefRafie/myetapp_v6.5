	...
	<fieldset>	
		<table width="100%" border="0">
            ...
            <tr>
            	...
            	<td>No. LOT</td>
            	<td>:</td>
                <td><input $disability $disabilityx type="text" name="txtNoLot" id="txtNoLot" value="$!txtNoLot" size="12" maxlength="20" onclick="defaultLOT()" onblur="checkExistLot('$!mode','$!isEdit')">
                &nbsp;<label id="checkLot" style="color:red" ></label></td>
			</tr>
...
<table width="100%" border="0"><tr><td>&nbsp;</td></tr></table>  
	...
	<fieldset id="bottom">
	<legend><strong>Senarai Maklumat Lot</strong></legend>

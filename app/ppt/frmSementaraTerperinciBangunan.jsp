...
<br/>
	...
	<fieldset id="middle">
	<legend>Laporan Tanah Terperinci Penggunaan/Pendudukan Sementara - Bangunan</legend>
    	...
    	<table width="100%" border="0">
    		<tr>
    			...
    			<td width="1%">:</td>
    			<td width="73%"><input type="text" $disOtherId $disOtherIdx name="txtNoBangunan" value="$!txtNoBangunan" id="txtNoBangunan" size="5" maxlength="3" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;" ></td>
    		</tr>
    		<tr>
    			<td>&nbsp;</td>
    		...
    		<tr>
    			...
    			<td>Saiz Bangunan</td>
    			<td>:</td>
    			<td><input type="text" $disOtherId $disOtherIdx name="txtSaizBangunan" id="txtSaizBangunan" value="$!txtSaizBangunan" size="10" maxlength="10"  >
    	...
    	<table width="100%" border="0">
    		<tr>
    			...
    			<td width="25%">No. Bangunan</td>
    			<td width="1%">:</td>
    			<td width="73%"><input $disability $disabilityx type="text" name="txtNoBangunan" value="$!txtNoBangunan" id="txtNoBangunan" size="5" maxlength="3" ></td>
    		</tr>
    		<tr>
    			<td>&nbsp;</td>
    			<td>Jenis Bangunan</td>
    		...
    		<tr>
    			...
    			<td>Saiz Bangunan</td>
    			<td>:</td>
    			<td><input $disability $disabilityx type="text" name="txtSaizBangunan" id="txtSaizBangunan" value="$!txtSaizBangunan" size="10" maxlength="10" >
    		...
    		<tr>
    			...
    			<td>Poskod</td>
    			<td>:</td>
    			<td><input $disability $disabilityx type="text" name="txtPoskod" id="txtPoskod" value="$!txtPoskod" size="5" maxlength="5" ></td>
    		</tr>
    		<tr>
    			<td>&nbsp;</td>
    			<td>Negeri</td>
...
<br/>    
    ...
    <tr >
    <td align="left">
    <a href="javascript:popupCarianBangunan('$id_permohonan','$!id_hakmilik','skrin_list_bangunan_sementara')"><font color="blue">>> SKRIN CAPAIAN BANGUNAN</font></a>
    </td>
    </tr>
    </table>
    <!--
    	...
    	<table width="100%" border="0">   
        	<tr>
               	<td><input type="button" name="cmdTambah" value="Tambah" onClick="javascript:viewInfoTanah('$!id_hakmilik')"></td>
    		</tr>
    	</table>
    	#end
...
function onchangeJenisBangunan(idJenisBangunan){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmSementaraTerperinciBangunan&idJenisBangunan="+idJenisBangunan;
	document.${formName}.submit();
}
//penambahan yati

...
<table width="100%">
  ...
  <tr>
    ...
    <!--
      ...
      #end
       <div id="txdTarikhSurat_check" style="color:red" ></div>      </td>
      </tr>
      <tr>
      ...
      #end
      <div id="txdTarikhTerimaSurat_check" style="color:red" ></div>      </td>
      </tr>
      <tr>
        <td>#parse("app/ppt/mandatory_pembatalan.jsp")</td>
                ...
                <tr>
                  ...
                  <table width="100%">
                    <tr class="table_header">
                      ...
                      <div align="center">
                        <input type="checkbox" name="all" id="all" onClick="doCheckAll('$hakmilikoverall','$hakmilik_belumbatal','$hakmilik_sudahbatal')" title="Semak untuk pilih semua" $disabledmode />
                      </div>                      </td>
                      #end
                       #end                    </tr>
        ...
        #set($count = 0) 
                    ...
                    <tr id="$list.BIL_DUM"   class="$row"    >
                      ...
                      <td >
                        <div align="center">
                        <label>
                          <input type="checkbox" name="ids" id="ids" onClick="doUpdateCheckAll('$hakmilikoverall','$hakmilik_belumbatal','$hakmilik_sudahbatal')" value="$list.ID_HAKMILIK" $disabledmode >
                        </label>
                        </div>                      </td>
                        #end                    </tr>
              #end
...
if(jenis_permohonan == "3")
{
checking_validation(txdTarikhSurat,'txdTarikhSurat_check','yes','surat pembatalan','tarikh');
checking_validation(txdTarikhTerimaSurat,'txdTarikhTerimaSurat_check','yes','terima surat','tarikh');
}
if(jenis_permohonan == "1")
{
checking_validation(txdTarikhSurat,'txdTarikhSurat_check','no','surat pembatalan','tarikh');
checking_validation(txdTarikhTerimaSurat,'txdTarikhTerimaSurat_check','no','terima surat','tarikh');
}
checking_validation(txtNoRujSurat,'txtNoRujSurat_check','yes','no rujukan surat','normal');
checking_validation(txtSebabPembatalan,'txtSebabPembatalan_check','yes','alasan penarikan balik','normal');
...
function kemaskini()
{
	...
	document.${formName}.point.value = "txtNoPembatalan";
	document.${formName}.submit();

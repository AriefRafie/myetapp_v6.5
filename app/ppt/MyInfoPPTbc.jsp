        ...
        <table width="100%" align="center" border="0">
          <tbody>
            ...
            <tr>
              ...
              <td width="70%"><input name="no_fail" id="no_fail" type="text" value="$no_fail" size="50" maxlength="50" style="text-transform:uppercase;" > 
            ...
            <tr>
              ...
              <td width="70%"><input type="text" name="tarikh_permohonan" id="tarikh_permohonan" onblur="check_date(this)" value="$tarikh_permohonan" size="9"/>
   ...
   <option value="">SILA PILIH KEMENTERIAN</option>    
    ...
    <option value="$ln.ID_KEMENTERIAN">$ln.KOD_KEMENTERIAN - $ln.NAMA_KEMENTERIAN</option>   
            ...
            <tr>
              ...
              <td width="70%"><input name="nama_pb" id="nama_pb" type="text" value="$nama_pb" size="50" maxlength="300" style="text-transform:uppercase;" ></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="70%">$!selectJenisHakmilik
   ...
   <option value="">SILA PILIH JENIS HAKMILIK</option>    
    ...
    <option value="$ln.ID_JENISHAKMILIK">$ln.KOD_JENIS_HAKMILIK - $ln.KETERANGAN</option>   
		    ...
		    <tr>
		      ...
		      <td><input name="no_lot_pt" id="no_lot_pt" type="text" value="$no_lot_pt" size="50" maxlength="50" style="text-transform:uppercase;" /></td>
	      </tr>
          
	      <tr>
		  <td width="30%" height="24" scope="row" align="right">No. Perbicaraan/Siasatan : </td>
		  <td width="70%"><input name="no_siasatan" id="no_siasatan" type="text" value="$!no_siasatan" size="50" maxlength="50" style="text-transform:uppercase;" ></td>
            </tr>
		  ...
		  <td width="70%"><input name="no_kes" id="no_kes" type="text" value="$!no_kes" size="50" maxlength="50" style="text-transform:uppercase;" ></td>
            </tr>
            
             <tr>
      <td width="30%" height="24" scope="row" align="right">No. Ruj. Prosiding Tanah : </td>
<td width="70%"><input name="no_prosiding" id="no_prosiding" type="text" value="$!no_prosiding" size="50" maxlength="50" style="text-transform:uppercase;" ></td>
            </tr>
...
//alert("ID_STATUS : "+ID_STATUS);
	...
	//status : Maklumat Jabatan Teknikal dan status2 mmk
	...
	//|| ID_STATUS == '22' 
	|| ID_STATUS == '132' || ID_STATUS == '133' || ID_STATUS == '134'){

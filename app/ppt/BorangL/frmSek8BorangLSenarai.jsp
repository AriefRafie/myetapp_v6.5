    	 ...
    	 <tr>
       	...
       	<tr>
      		...
      		<td>:&nbsp;<select name="carianStatus" style="width:170px">
      			...
      			<option value="" #if($carianStatus=="") selected=selected #end >SILA PILIH</option>
      			<option value="72" #if($carianStatus=="72") selected=selected #end >BAYARAN PAMPASAN</option>
      			<option value="59" #if($carianStatus=="59") selected=selected #end >PENGAMBILAN SEGERA</option>
      			<option value="76" #if($carianStatus=="76") selected=selected #end>BORANG K</option>	

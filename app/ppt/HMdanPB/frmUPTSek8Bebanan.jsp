...
<br/>
	...
	<table width="100%" border="0">
		<tr>
			...
			<td width="1%">:</td>
			<td width="74%"><input type="text" name="txtPerserahan" id="txtPerserahan" value="$!txtPerserahan" size="50" maxlength="100"   ></td>
		</tr>
		<tr>
			<td>Jenis Bebanan</td>
			<td>:</td>
	...
	<table width="100%" border="0">
     ...
     Keterangan Bebanan   </td>
        <td valign="top">:</td>
        <td>     
  
         <textarea name="keterangan_bebanan" id="keterangan_bebanan" cols="50"   rows="6" style=""         
        
        >$keterangan_bebanan</textarea> 
	...
	#foreach($data in $dataBebanan)
        ...
        #set($keterangan_bebanan = $data.keterangan_bebanan)
	#end
#end
	...
	<legend><strong>Maklumat Bebanan</strong></legend>
		<table width="100%" border="0">
			<tr>
				...
				<td width="1%">:</td>
				<td width="74%"><input $disability $disabilityx type="text" name="txtPerserahan" id="txtPerserahan" value="$!txtPerserahan" size="50" maxlength="100"   ></td>
			</tr>
			<tr>
				<td>Jenis Bebanan</td>
				<td>:</td>
	...
	<fieldset>
     ...
     Keterangan Bebanan   </td>
        ...
        <td>     
         ...
         <textarea $disability $disabilityx name="keterangan_bebanan" id="keterangan_bebanan" cols="50"   rows="6" style=""         

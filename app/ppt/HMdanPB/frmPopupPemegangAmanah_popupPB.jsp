...
<center>
	...
	<table width="100%" border="0">
		<tr align="center">
			<td>
				<input type="button" name="cmdSimpan" value ="Simpan" onClick="javascript:updatePA('$!id_hakmilik','$!id_hakmilikpb','$flag_skrin')">
				<input type="button" name="cmdKembali" value ="Kembali" onClick="javascript:kembaliScreenUtama('$!id_hakmilik','$flag_skrin')">
			</td>
		</tr>
	</table>
...
<script>
function kembaliScreenUtama(id_hakmilik,flag_skrin) {
		try {			
		window.opener.refresh_Popup(id_hakmilik,flag_skrin);
		}
		catch (err) {}
		window.close();
		return false;
...
function updatePA(id_hakmilik,id_hakmilikpb,flag_skrin) {
...
else
{
	...
	c++;
	  ...
	  else
	  {
		...
		//call_refreshpopup(id_hakmilik,flag_skrin);  
		...
		document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmPopupPemegangAmanah_PopupPB";

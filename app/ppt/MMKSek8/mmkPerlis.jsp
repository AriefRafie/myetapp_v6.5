...
<br />
<font color="blue">* Terdapat Perubahan pada skrin & cetakan Format kertas MMK Perlis didalam sistem MyEtapp. Untuk cetakan kertas MMK melalui MyEtapp, sila kemaskini maklumat diskrin ini.  </font>
...
<legend><strong>Penyediaan Kertas MMK/MB/KM/LC</strong></legend>
    	<table width="100%" border="0">
    			...
    			<!-- TUJUAN -->	
				<tr><td colspan="3"><b>1. TUJUAN :</b></td></tr>
				<tr><td colspan="3">&nbsp;</td></tr>
				
				<tr>
					<td width="2%">&nbsp;</td>
					<td width="2%" valign="top">1.1</td>
					<td width="96%">Kertas ini bertujuan untuk mendapat pertimbangan dan kelulusan Majlis Mesyuarat Kerajaan Negeri (MMKN) Perlis mengenai :-</td>
				</tr>
				<tr><td colspan="3">&nbsp;</td></tr>
				...
				<tr><td colspan="3"><b>2. LATAR BELAKANG :</b></td></tr>
				<tr>
					<td colspan="3">
                ...
                <!-- BUTIRAN TANAH-->	
				<tr><td colspan="3"><b>3. BUTIR-BUTIR TANAH	:</b></td></tr>
				...
				<tr>
				  <td colspan="3"><b>4. ULASAN DARI JABATAN TEKNIKAL :</b></td></tr>
        		...
        		<!-- ULASAN PENGARAH TANAH DAN GALIAN NEGERI PERLIS-->	
				<tr>
				  <td colspan="3"><b>5. ULASAN DARI PENGARAH PENGARAH TANAH DAN GALIAN :</b></td></tr>
				<tr>
					<td colspan="3">
        		...
        		<!-- SYOR -->	
				<tr>
				  <td colspan="3"><b>6. SYOR :</b></td></tr>
				<tr><td colspan="3">&nbsp;</td></tr>
				
				<tr>
					<td>&nbsp;</td>
					<td valign="top">6.1</td>
					<td>MMKN adalah dipohon menimbang dan meluluskan mengenai :-</td>
				</tr>
				<tr><td colspan="3">&nbsp;</td></tr>
        		...
        		<!-- KEPUTUSAN -->	
				<tr>
				  <td colspan="3"><b>7. KEPUTUSAN :</b></td></tr>
				<tr>
					<td colspan="3">
  	...
  	for (i = 0; i < ttTUJUAN_MAIN; i++){	
  		...
  		if(ttTUJUAN_MAIN==1){
			...
			codes1 += 	"<table width='100%' border='0'> 																								"+
						" 	<tr> 																														"+
				  		"		<td width='2%'>&nbsp;</td> 																								"+
				  		"		<td width='2%' valign='top'> 1.1."+(i+1)+"  </td> 																		"+
				  		"		#if($!mode=='new') 																										"+														
				  		"		<td width='96%'> 																										"+
		     			"		 	<textarea name=\"txtUlasanTUJUAN_MAIN\" id=\"txtUlasanTUJUAN_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		
  	...
  	for (i = 0; i < ttLATARBELAKANG_MAIN; i++){	
  		...
  		if(ttLATARBELAKANG_MAIN==1){
			...
			codes1 += 	"<table width='100%' border='0'> 																								"+
				 		" 	<tr> 																														"+
				  		"		<td width='2%'>&nbsp;</td> 																								"+
				  		"		<td width='2%' valign='top'> 2."+(i+1)+"  </td> 																		"+
				  		"		#if($!mode=='new') 																										"+														
				  		"		<td width='96%'> 																										"+
		     			"		 	<textarea name=\"txtUlasanLATARBELAKANG_MAIN\" id=\"txtUlasanLATARBELAKANG_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		
  	...
  	for (i = 0; i < ttPERIHALTANAH_MAIN; i++){	
  		...
  		if(ttPERIHALTANAH_MAIN==1){
			...
			codes1 += 	"<table width='100%' border='0'> 																								"+
						" 	<tr> 																														"+
				  		"		<td width='2%'>&nbsp;</td> 																								"+
				  		"		<td width='2%' valign='top'> 3."+(i+1)+"  </td> 																		"+
				  		"		#if($!mode=='new') 																										"+														
				  		"		<td width='96%'> 																										"+
		     			"		 	<textarea name=\"txtUlasanPERIHALTANAH_MAIN\" id=\"txtUlasanPERIHALTANAH_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		
  	...
  	for (i = 0; i < ttLAPORANTEKNIKAL_MAIN; i++){	
  		...
  		if(ttLAPORANTEKNIKAL_MAIN==1){
			...
			codes1 += 	"<table width='100%' border='0'> 																								"+
				 		" 	<tr> 																														"+
				  		"		<td width='2%'>&nbsp;</td> 																								"+
				  		"		<td width='2%' valign='top'> 4."+(i+1)+"  </td> 																		"+
				  		"		#if($!mode=='new') 																										"+														
				  		"		<td width='96%'> 																										"+
		     			"		 	<textarea name=\"txtUlasanLAPORANTEKNIKAL_MAIN\" id=\"txtUlasanLAPORANTEKNIKAL_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		
  	...
  	for (i = 0; i < ttULASANPENGARAH_MAIN; i++){	
  		...
  		if(ttULASANPENGARAH_MAIN==1){
			...
			codes1 += 	"<table width='100%' border='0'> 																								"+
				 		" 	<tr> 																														"+
				  		"		<td width='2%'>&nbsp;</td> 																								"+
				  		"		<td width='2%' valign='top'> 5."+(i+1)+"  </td> 																		"+
				  		"		#if($!mode=='new') 																										"+														
				  		"		<td width='96%'> 																										"+
		     			"		 	<textarea name=\"txtUlasanULASANPENGARAH_MAIN\" id=\"txtUlasanULASANPENGARAH_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		
  	...
  	for (i = 0; i < ttSYOR_MAIN; i++){	
  		...
  		if(ttSYOR_MAIN==1){
			...
			codes1 += 	"<table width='100%' border='0'> 																								"+
				 		" 	<tr> 																														"+
				  		"		<td width='2%'>&nbsp;</td> 																								"+
				  		"		<td width='2%' valign='top'> 6.1."+(i+1)+"  </td> 																		"+
				  		"		#if($!mode=='new') 																										"+														
				  		"		<td width='96%'> 																										"+
		     			"		 	<textarea name=\"txtUlasanSYOR_MAIN\" id=\"txtUlasanSYOR_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		
  	...
  	for (i = 0; i < ttPERAKUANPT_MAIN; i++){	
  		...
  		if(ttPERAKUANPT_MAIN==1){
			...
			codes1 += 	"<table width='100%' border='0'> 																								"+
				 		" 	<tr> 																														"+
				  		"		<td width='2%'>&nbsp;</td> 																								"+
				  		"		<td width='2%' valign='top'> 7."+(i+1)+"  </td> 																		"+
				  		"		#if($!mode=='new') 																										"+														
				  		"		<td width='96%'> 																										"+
		     			"		 	<textarea name=\"txtUlasanPERAKUANPT_MAIN\" id=\"txtUlasanPERAKUANPT_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		

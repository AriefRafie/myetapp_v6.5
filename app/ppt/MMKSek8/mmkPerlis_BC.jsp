...
<legend><strong>Penyediaan Kertas MMK/MB/KM/LC</strong></legend>
    	<table width="100%" border="0">
				...
				<tr>
					...
					<td width="96%">Tujuan kertas ini adalah untuk mendapatkan pertimbangan <br/> 
					dan kelulusan Majlis Mesyuarat Kerajaan Negeri Perlis <br/>
					mengenai:-</td>
				</tr>
				<tr><td colspan="3">&nbsp;</td></tr>
				...
				<tr><td colspan="3"><b>3. ULASAN JABATAN TEKNIKAL :</b></td></tr>
				...
				<tr><td colspan="3"><b>4. ULASAN PENGARAH TANAH DAN GALIAN NEGERI PERLIS :</b></td></tr>
				<tr>
					<td colspan="3">
        		...
        		<!-- SYOR -->	
				<tr><td colspan="3"><b>5. SYOR :</b></td></tr>
				<tr><td colspan="3">&nbsp;</td></tr>
				
				<tr>
					<td>&nbsp;</td>
					<td valign="top">5.1</td>
					<td>Majlis Mesyuarat Kerajaan Negeri adalah dipohon menimbang dan meluluskan<br/> 
					mengenai cadangan pengambilan tanah di bawah Seksyen 8 Akta Pengambilan<br/> 	
					Tanah 1960 untuk $!tujuanPermohonan<br/> 
					Jika dipersetujui adalah disyorkan supaya :-</td>
				</tr>
				<tr><td colspan="3">&nbsp;</td></tr>
        		...
        		<!-- KEPUTUSAN -->	
				<tr><td colspan="3"><b>6. KEPUTUSAN :</b></td></tr>
				<tr>
					<td colspan="3">
  	...
  	for (i = 0; i < ttSYOR_MAIN; i++){	
  		...
  		if(ttSYOR_MAIN==1){
			...
			codes1 += 	"<table width='100%' border='0'> 																								"+
				 		" 	<tr> 																														"+
				  		"		<td width='4%'>&nbsp;</td> 																								"+
				  		"		<td width='2%' valign='top'> 5.1."+(i+1)+"  </td> 																		"+
				  		"		#if($!mode=='new') 																										"+														
				  		"		<td width='94%'> 																										"+
		     			"		 	<textarea name=\"txtUlasanSYOR_MAIN\" id=\"txtUlasanSYOR_MAIN\" cols=\"90\"  rows=\"10\"						"+                  		

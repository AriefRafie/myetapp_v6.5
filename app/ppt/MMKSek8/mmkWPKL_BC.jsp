...
<legend><strong>Penyediaan Kertas MMK/MB/KM/LC</strong></legend>
	...
	<tr>
		...
		#if($senarai_submmk.size()!=0)
    		#foreach($list in $senarai_submmk)   
    		#if($list.FLAG_JENIS_MMK == "KEADAANTANAH" && $list.FLAG_JENIS_SUBMMK == "MAIN" )         
    		<input type="hidden" name="KEADAANTANAH_MAIN_temp1"  id="KEADAANTANAH_MAIN_temp1" value="$list.KETERANGAN_SUBMMK" >  
    		#end
    		#end
    	#end 
    	
    	
    	<span id="KEADAANTANAH_MAIN"></span>           
   		<div id="KEADAANTANAH_MAIN_temp"></div>
	...
	<!-- BUTIR - BUTIR TANAH-->	
	<tr><td><b>6. BUTIR - BUTIR TANAH :</b></td></tr>
	<tr>
		<td>
	...
	<!-- KEMUDAHAN ASAS-->	
	<tr><td><b>7. KEMUDAHAN ASAS :</b></td></tr>
	<tr>
		<td>
	...
	<tr><td><b>8. ANGGARAN NILAIAN TANAH :</b></td></tr>
	<tr>
		<td>
	...
	<tr><td><b>9. PENGESAHAN PERUNTUKAN :</b></td></tr>
	<tr>
		<td>
	...
	<tr><td><b>10. ULASAN PENTADBIR TANAH WILAYAH PERSEKUTUAN KUALA LUMPUR :</b></td></tr>
	<tr>
		<td>
	...
	<tr><td><b>11. PERAKUAN PENTADBIR TANAH WILAYAH PERSEKUTUAN KUALA LUMPUR :</b></td></tr>
	<tr>
		<td>
	...
	<!-- KEPUTUSAN DIPOHON -->	
	<tr><td><b>12. KEPUTUSAN DIPOHON :</b></td></tr>
	<tr>
		<td>

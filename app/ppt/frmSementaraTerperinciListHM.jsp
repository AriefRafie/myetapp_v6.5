...
<br/>
	...
	<legend><strong>Senarai Maklumat Hakmilik</strong></legend>
     <table width="100%"   border="0">   
            <tr><td  align="left">
            <a href="javascript:popupCarianHakmilik('$id_permohonan','laporan_bangunan_sementara')"><font color="blue">>> SKRIN CAPAIAN HAKMILIK</font></a>
            </td>
            </tr>
            </table>
    		...
    		<table width="100%" border="0"> 
               ...
               <tr>
                    ...
                    <td class="$row"><a href="javascript:viewInfoTanah('$!listTanah.id_hakmilik')"><font color="blue">$!listTanah.no_hakmilik</font></a></td>

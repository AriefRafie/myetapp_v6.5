         ...
         <tr class="table_header">
            ...
            <td><b>Status</b></td> 
         	...
         	<tr>
        		...
        		<td class="$row"><a href="javascript:screenAgihan('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td>
        		<td class="$row"><a href="javascript:screenAgihan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptg</font></a></td> 
        		<td class="$row"><a href="javascript:screenAgihan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptd</font></a></td>  
        		<td class="$row"><a href="javascript:screenAgihan('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_upt</font></a></td>

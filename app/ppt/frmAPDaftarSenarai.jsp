  ...
  <legend><strong>Carian</strong></legend>
	<table width="100%" cellspacing="2" cellpadding="0" border="0">
        ...
        <tr><td>&nbsp;</td></tr>
    	 ...
    	 <tr>
    		<td width="25%">&nbsp;</td>
        	<td width="17%">No. Permohonan &nbsp; </td>
            <td width="58%">:&nbsp;<input type="text" name="no_permohonan" value="$carianPermohonan" id="no_permohonan" size="27" onkeyup="this.value=this.value.toUpperCase();" /></td>
        </tr>
        ...
        <tr>
        	...
        	<!-- <td>:&nbsp;<select name="id_status" class="autoselect">
				<option value="">SILA PILIH</option>
				<option value="113">DAFTAR</option>
				<option value="5">PERMOHONAN HQ</option>
				</select></td> -->
...
<fieldset>
	<legend><strong>Senarai Permohonan</strong></legend>
     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
      ...
      #if($list_size!=0)
           #foreach($list in $PermohonanList)
                   	 #set( $i = $velocityCount )
         		#if ( ($i % 2) != 1 )
              		 #set( $row = "row2" )
         		#else
...
<script language="JavaScript"> document.forms[0].no_permohonan.focus(); </script>
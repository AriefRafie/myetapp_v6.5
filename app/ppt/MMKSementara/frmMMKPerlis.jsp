...
<table width="100%">
  ...
  <tr>
    ...
    <td valign="top">:</td>
      ...
      <script>	
		    var area4 = new FCKeditor('txtButirTanah');
  ...
  <tr>
    <td valign="top">4.</td>
    <td valign="top">Ulasan dari Jabatan Teknikal</td>
    <td valign="top">:</td>
  ...
  <tr>
    <td valign="top">5.</td>
    <td valign="top">Ulasan dari Pengarah PTG</td>
    <td valign="top">:</td>
  ...
  <tr>
    <td valign="top">6.</td>
    <td valign="top">Syor Pengarah PTG</td>
    <td valign="top">:</td>
  ...
  <tr>
    <td valign="top">7.</td>
    <td valign="top">Perakuan Setiausaha Kerajaan Negeri</td>
    <td valign="top">:</td>
    #if($readonly != 'readonly')<td><textarea name="txtPerakuanSetiausaha" id="txtPerakuanSetiausaha"  cols="80"  rows="6"  $readonlymode class = "$disabledmode" >$!PERAKUAN_SETIAUSAHA</textarea>
        <div><span id="txtPerakuanSetiausaha_num" style="color:blue;" ></span></div>
      <script>	
		    var area8 = new FCKeditor('txtPerakuanSetiausaha');
	      	area8.BasePath = '/${appname}/library/fck/' ;
	      	area8.Height = 200;
	      	area8.Width = '100%';
	      	area8.ReplaceTextarea(); 
		</script>    </td>#else
    <td valign="top" bgcolor="#ECE5B6">$!PERAKUAN_SETIAUSAHA</td>#end
  </tr>
</table>
</fieldset>
...
check_length_txtPerakuanSetiausaha('onload');
}
...
function FCKeditor_OnComplete(editorInstance){
	...
	else if (editorInstance.Name == "txtPerakuanSetiausaha" ) {	
		editorInstance.Events.AttachEvent('OnSelectionChange',check_length_txtPerakuanSetiausaha);				
	}	
...
var jenis_field = 'normal';
var mandatory = 'yes';
var value_field = 'ulasan dari jabatan teknikal';
...
var jenis_field = 'normal';
var mandatory = 'yes';
var value_field = 'ulasan dari pengarah PTG';
...
var jenis_field = 'normal';
var mandatory = 'yes';
var value_field = 'syor pengarah PTG';
...
function check_length_txtPerakuanSetiausaha(type)
{


var editorInstance = FCKeditorAPI.GetInstance('txtPerakuanSetiausaha');
var count = 0;
if(type == 'onload')
{count =  document.getElementById('txtPerakuanSetiausaha').value.length;}
else
{count = editorInstance.GetHTML(true).length;}


var my_form = 'txtPerakuanSetiausaha';
var maxLen = 3800;
var charlimit = maxLen-1 ;
var alert_field = 'txtPerakuanSetiausaha_check';
var text_num = 'txtPerakuanSetiausaha_num';
var jenis_field = 'normal';
var mandatory = 'yes';
var value_field = 'perakuan setiausaha kerajaan negeri';

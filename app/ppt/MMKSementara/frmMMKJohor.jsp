...
<table width="100%">
  ...
  <tr>
    ...
    <td valign="top">:</td>
    #if($readonly != 'readonly')<td><textarea name="txtAsasPertimbangan" id="txtAsasPertimbangan"  cols="80"  rows="6"  $readonlymode class = "$disabledmode" >$!ASAS_PERTIMBANGAN</textarea>
  ...
  <tr>
    ...
    <td valign="top">:</td>
    #if($readonly != 'readonly')<td><textarea name="txtImplikasi" id="txtImplikasi"  cols="80"  rows="6"  $readonlymode class = "$disabledmode" >$!IMPLIKASI</textarea>
  ...
  <tr>
    ...
    <td valign="top">:</td>
    #if($readonly != 'readonly')<td><textarea name="txtKesimpulan" id="txtKesimpulan"  cols="80"  rows="6"  $readonlymode class = "$disabledmode" >$!KESIMPULAN</textarea>

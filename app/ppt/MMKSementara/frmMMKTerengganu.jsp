...
<table width="100%">
  ...
  <tr>
    <td valign="top">3.</td>
    <td valign="top">Perihal Tanah</td>
    <td valign="top">:</td>
  ...
  <tr>
    <td valign="top">4.</td>
    <td valign="top">Pandangan Jabatan Teknikal</td>
    <td valign="top">:</td>
  ...
  <tr>
    <td valign="top">5.</td>
    <td valign="top">Taksiran Harga Tanah</td>
    <td valign="top">:</td>
        ...
        <div><span id="txtTaksiranHargaTanah_num" style="color:blue;" ></span></div>
      <script>	
		    var area6 = new FCKeditor('txtTaksiranHargaTanah');
  ...
  <tr>
    <td valign="top">7.</td>
    <td valign="top">Hal - Hal Lain</td>
    <td valign="top">:</td>
    #if($readonly != 'readonly')<td><textarea name="txtHalLain" id="txtHalLain"  cols="80"  rows="6"  $readonlymode class = "$disabledmode" >$!HAL_LAIN</textarea>
      <div><span id="txtHalLain_num" style="color:blue;" ></span></div>
      <script>	
		    var area6 = new FCKeditor('txtHalLain');
	      	area6.BasePath = '/${appname}/library/fck/' ;
	      	area6.Height = 200;
	      	area6.Width = '100%';
	      	area6.ReplaceTextarea(); 
		</script>    </td>#else
    <td valign="top" bgcolor="#ECE5B6">$!HAL_LAIN</td>#end
  </tr>
</table>
</fieldset>
...
check_length_txtTaksiranHargaTanah('onload');
check_length_txtPengecualianUpahUkur('onload');
check_length_txtSyor('onload');
check_length_txtHalLain('onload');
...
function FCKeditor_OnComplete(editorInstance){
	...
	else if (editorInstance.Name == "txtTaksiranHargaTanah" ) {	
		editorInstance.Events.AttachEvent('OnSelectionChange',check_length_txtTaksiranHargaTanah);				
	}	
	else if (editorInstance.Name == "txtPengecualianUpahUkur" ) {	
		editorInstance.Events.AttachEvent('OnSelectionChange',check_length_txtPengecualianUpahUkur);				
	}	
	else if (editorInstance.Name == "txtSyor" ) {	
		editorInstance.Events.AttachEvent('OnSelectionChange',check_length_txtSyor);				
	}	
	else if (editorInstance.Name == "txtHalLain" ) {	
		editorInstance.Events.AttachEvent('OnSelectionChange',check_length_txtHalLain);				
	}	
...
var count = 0;
if(type == 'onload')
{count =  document.getElementById('txtKelulusan').value.length;}
else
{count = editorInstance.GetHTML(true).length;}
...
var jenis_field = 'normal';
var mandatory = 'yes';
var value_field = 'kelulusan jawatankuasa tanah';
...
function check_length_txtTaksiranHargaTanah(type)
{


var editorInstance = FCKeditorAPI.GetInstance('txtTaksiranHargaTanah');
var count = 0;
if(type == 'onload')
{count =  document.getElementById('txtTaksiranHargaTanah').value.length;}
else
{count = editorInstance.GetHTML(true).length;}


var my_form = 'txtTaksiranHargaTanah';
var maxLen = 3800;
var charlimit = maxLen-1 ;
var alert_field = 'txtTaksiranHargaTanah_check';
var text_num = 'txtTaksiranHargaTanah_num';
var jenis_field = 'normal';
var mandatory = 'yes';
var value_field = 'taksiran harga tanah';
...
function check_length_txtPengecualianUpahUkur(type)
{


var editorInstance = FCKeditorAPI.GetInstance('txtPengecualianUpahUkur');
var count = 0;
if(type == 'onload')
{count =  document.getElementById('txtPengecualianUpahUkur').value.length;}
else
{count = editorInstance.GetHTML(true).length;}


var my_form = 'txtPengecualianUpahUkur';
var maxLen = 3800;
var charlimit = maxLen-1 ;
var alert_field = 'txtPengecualianUpahUkur_check';
var text_num = 'txtPengecualianUpahUkur_num';
var jenis_field = 'normal';
var mandatory = 'yes';
var value_field = 'pengecualian upah ukur';
...
function check_length_txtHalLain(type)
{


var editorInstance = FCKeditorAPI.GetInstance('txtHalLain');
var count = 0;
if(type == 'onload')
{count =  document.getElementById('txtHalLain').value.length;}
else
{count = editorInstance.GetHTML(true).length;}


var my_form = 'txtHalLain';
var maxLen = 3800;
var charlimit = maxLen-1 ;
var alert_field = 'txtHalLain_check';
var text_num = 'txtHalLain_num';
var jenis_field = 'normal';
var mandatory = 'yes';
var value_field = 'hal - hal lain';

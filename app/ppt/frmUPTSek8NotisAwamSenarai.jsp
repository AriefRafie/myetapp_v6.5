	...
	<table width="100%" cellspacing="2" cellpadding="0" border="0">
        ...
        <tr>
      		...
      		<td>:&nbsp;<select name="carianStatus" style="width:150px">
      			...
      			#if($carianStatus=="54")
      			<option value="54">BORANG F</option>	
				<option value="52">NOTIS AWAM</option>	
      			<option value="">SILA PILIH</option>
      			#elseif($carianStatus=="52")
      			<option value="52">NOTIS AWAM</option>	
				<option value="54">BORANG F</option>	
      			<option value="">SILA PILIH</option>	
      			#else
     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
        ...
        <tr class="table_header">
        	...
        	<tr>
        		...
        		<td class="$row"><a href="javascript:viewListNotis('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td>
        		<td class="$row"><a href="javascript:viewListNotis('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptg</font></a></td>
        		<td class="$row"><a href="javascript:viewListNotis('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptd</font></a></td> 
        		<td class="$row"><a href="javascript:viewListNotis('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_upt</font></a></td> 

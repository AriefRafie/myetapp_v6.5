...
<legend>Maklumat Bantahan</legend>
    <table width="100%" border="0">
        <tr> 
            <td width="1%">#if($mode!="disabled")<font color="red">*</font>#end</td>
            <td width="24%">&nbsp;Tarikh Permohonan</td>
            <td width="1%">:</td>
            <td width="25%">
        ...
        <tr>
          ...
          #else
           <input type="text" name="txtNoHakmilik" id="txtNoHakmilik" value="$!txtNoHakmilik" class="disabled" />
          #end          </td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
            ...
            #if ($mode=="disabled") 
            <input type="text" name="txtNoLot" id="txtNoLot" value="$!txtNoLot" class="disabled" readonly />
            #else
            <input type="text" name="txtNoLot" id="txtNoLot" value="$!txtNoLot" class="disabled" />
            #end            </td>
            <td>&nbsp;</td>
            <td>&nbsp;&nbsp;&nbsp;</td>
           	<td>&nbsp;</td>
    ...
    <table width="100%" border="0">
        <tr>
          ...
          <td width="1%">:</td>
            ...
            #else
            <input type="text" name="txtNamaPembantah" id="txtNamaPembantah" value="$!txtNamaPembantah" size="60" tabindex="12" class="disabled" />
            #end
        ...
        <tr>
            ...
            #else
            <input type="text" name="txtAlamat1" id="txtAlamat1" value="$!txtAlamat1" size="60" class="disabled" />
            #end
        ...
        <tr>
            ...
            #else
            <input type="text" name="txtAlamat2" id="txtAlamat2" value="$!txtAlamat2" size="60" tabindex="13" class="disabled" />
            #end                   
        ...
        <tr>
            ...
            #else
            <input type="text" name="txtAlamat3" id="txtAlamat3" value="$!txtAlamat3" size="60" tabindex="14" class="disabled" />
            #end
        ...
        <tr>
          ...
          #else
          <input type="text" name="txtPoskod" id="txtPoskod" value="$!txtPoskod" maxlength="5" size="5" onkeyup="validateNumber(this,this.value);" tabindex="15" class="disabled" />
          #end        
...
<div align="center">
          ...
          <input type="button" name="cmdBatal" id="cmdBatal" value="Batal" onclick="javascript:batal_bantahan('$!id_fail','$!id_permohonan','$!id_status','$!id_hakmilik','$!id_hakmilikpb')" /> 
          #end  
          ...
          #if ($flag_online=="1" && $button!="edit")
          <input type="button" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onclick="javascript:kemaskiniBantahan()" /> 
          <input type="button" name="cmdSah" id="cmdSah" value="Sahkan Permohonan" onclick="javascript:sahkan_permohonan()" /> 
...
<script>
function batal_bantahan(id_fail,id_permohonan,id_status,id_hakmilik,id_hakmilikpb) {

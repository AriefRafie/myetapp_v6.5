...
<fieldset><legend><b>
 <label style="background-color:blue"  align="center" valign="top" > 
                            <b><font color="WHITE"><span class="blink">Baru</span></font></b>
                             </label>&nbsp;
Status Bayaran Pampasan</b></legend>
        ...
        <table align="center" width="100%"> 
          <tbody>
            ...
            <tr class="table_header">
              ...
              <td width="40%">KEMENTERIAN DAN NAMA PROJEK</td>
          ...
          <tr>
            ...
            $i
          	...
          	#set($status_fail = "$list.STATUS.toUpperCase()")
            	...
            	#set($status_fail = "<b><i><blink>TELAH DISAHKAN</span></i></b>")
            	...
            	#set($status_fail = "<b><i><blink>TELAH DIAGIHKAN</span></i></b>")	
           ...
           <font color="blue">TIADA NO FAIL JKPTG 
            ...
            <td valign="top">
            <input type="button" name="cmdCetak" id="cmdCetak" value="Cetak" onClick="cetakLaporan('$list.ID_FAIL')">
            </td>
...
function cetakLaporan(id_fail) {
	 var url = "../servlet/ekptg.report.ppt.StatusPampasan?id_fail="+id_fail;

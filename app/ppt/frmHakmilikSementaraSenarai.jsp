...
<table width="100%">
  ...
  <!--<tr>
    ...
    <td>:</td>
    <td><label>
      <input name="txtNoRujJKPTGNegeri" type="text" id="txtNoRujJKPTGNegeri" value="$CarianNoJKPTG" />
    </label></td>
  </tr>-->
  <tr>
    ...
    <td><label>
      ...
      <a href="javascript:displayDatePicker('txdTarikh',false,'dmy');"><img border="0" src="../img/calendar.gif"/></a>
    </label></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <input type="submit" name="cmdKosongkan" id="cmdCari" value="Kosongkan" onclick = "kosongkan()"/>    </td>
  </tr>
</table>
</fieldset>
<p>
...
function cari() {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SementaraHakmilikPB&action=";
	document.${formName}.submit();

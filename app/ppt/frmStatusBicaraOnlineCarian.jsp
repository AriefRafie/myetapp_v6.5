  ...
  <tr>
    <td><fieldset>
        ...
        <table width="100%" align="center" border="0">
          ...
          <tr>
            <td width="30%" height="24" scope="row" align="right">No Siasatan : </td>
            <td width="70%"><input name="findNoSiasatan" id="findNoSiasatan" type="text" value="$!findNoSiasatan" size="50" maxlength="50" style="text-transform:uppercase;" ></td>
          </tr>     
          <tr>
          	<td>&nbsp</td>
        	<td>

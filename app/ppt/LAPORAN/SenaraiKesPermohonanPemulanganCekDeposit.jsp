...
function cetak(){
	...
	if(document.${formName}.socNegeri.value == ""){
		...
		var url = "../servlet/ekptg.report.ppt.SenaraiKesPermohonanPemulanganCekDeposit?id_negeri="+document.${formName}.socNegeri.value+"&tahun="+document.${formName}.socTahun.value+"&id_mukim="+document.${formName}.socMukim.value+"&id_daerah="+document.${formName}.socDaerah.value; 

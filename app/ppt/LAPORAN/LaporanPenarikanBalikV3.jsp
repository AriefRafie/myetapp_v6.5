...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2"> 
      <tr>
        <td>  
        <a href="javascript:cetakPrestasi()" class="style2" ><font color="blue">Prestasi Penyelesaian Penarikan Balik</font></a></td>
      </tr>      
      <tr>
        <td>  
      
        <a href="javascript:cetakLaporan()" class="style2" ><font color="blue">Laporan Penarikan Balik</font></a></td>
      </tr>       
...
function cetakPrestasi(){
	...
	if(document.${formName}.socPejabat.value == ""){
		...
		var item = "ID_NEGERI="+id_negeri+"&MULA_TAHUN="+mula_tahun+"&AKHIR_TAHUN="+akhir_tahun;		
	 	//alert("item :"+item);
			var url = "../servlet/ekptg.report.ppt.LaporanPrestasiPenarikanBalik?"+item 
...
function cetakLaporan(){
	...
	if(document.${formName}.socPejabat.value == ""){
		...
		var item = "ID_NEGERI="+id_negeri+"&MULA_TAHUN="+mula_tahun+"&AKHIR_TAHUN="+akhir_tahun;		
			...
			var url = "../servlet/ekptg.report.ppt.LaporanFormatPenarikanBalik?"+item 
		    var hWnd = window.open(url,'Cetak','full=yes, resizable=yes,scrollbars=yes');
		    if ((document.window != null) && (!hWnd.opener))
		    hWnd.opener = document.window;
		    if (hWnd.focus != null) hWnd.focus();

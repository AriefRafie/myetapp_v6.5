...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2"> 
      <tr>
        <td>  
        <a href="javascript:CetakLaporanPerbandinganAward()" class="style2" ><font color="blue">Laporan Perbandingan Award</font></a></td>
      </tr> 
      <!--     
      <tr>
        <td>  
      
        <a href="javascript:cetakBorangKNegeri()" class="style2" ><font color="blue">Senarai Projek Yang Dikeluarkan Borang K Mengikut Negeri</font></a></td>
      </tr>       
      -->
    </table>
</fieldset>
...
function CetakLaporanPerbandinganAward(){
	...
	if(document.${formName}.socPejabat.value == ""){
		...
		var item = "ID_NEGERI="+id_negeri+"&MULA_TAHUN="+mula_tahun+"&AKHIR_TAHUN="+akhir_tahun;		
	 	//alert("item :"+item);
			var url = "../servlet/ekptg.report.ppt.LaporanPerbandinganAward_PT_JPPH?"+item 

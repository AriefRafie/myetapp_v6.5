...
function doChange() {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.LaporanPrestasiPermohonanBantahan";
...
function cetak(jenisTempoh){
	...
	//julat
	    ...
	    var url = "../servlet/ekptg.report.ppt.LaporanPrestasiPermohonanBantahan?"+item 

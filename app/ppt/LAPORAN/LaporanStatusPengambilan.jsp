...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2"> 
      <tr>
        <td>  
        <a href="javascript:cetak('$!jenisTempoh','1')" class="style2" ><font color="blue">Laporan Status Pengambilan Tanah Mengikut Negeri</font></a></td>
      </tr>      
      <tr>
        <td>  
      
        <a href="javascript:cetak('$!jenisTempoh','2')" class="style2" ><font color="blue">Laporan Status Pengambilan Tanah Mengikut Daerah
 </font></a></td>
      </tr>       
...
<!-- Hidden -->
<input type="text" name="id_pejabat" value="$!id_pejabat">
...
function doChange() {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.LaporanStatusPengambilan";
...
function cetak(jenisTempoh,jenisLaporan){
	...
	//julat
		...
		if(jenisLaporan=="1"){
			var url = "../servlet/ekptg.report.ppt.LaporanStatusPengambilanNegeri?"+item 
		    var hWnd = window.open(url,'Cetak','full=yes, resizable=yes,scrollbars=yes');
		    if ((document.window != null) && (!hWnd.opener))
		    hWnd.opener = document.window;
		    if (hWnd.focus != null) hWnd.focus();
		}else if(jenisLaporan=="2"){
			var url = "../servlet/ekptg.report.ppt.LaporanStatusPengambilanDaerah?"+item 
		    var hWnd = window.open(url,'Cetak','full=yes, resizable=yes,scrollbars=yes');
		    if ((document.window != null) && (!hWnd.opener))
		   	hWnd.opener = document.window;
		    if (hWnd.focus != null) hWnd.focus();

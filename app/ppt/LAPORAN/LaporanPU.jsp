...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2"> 
      <tr>
        <td>  
        <a href="javascript:cetak('$!jenisTempoh','1')" class="style2" ><font color="blue">Laporan Bulanan PU</font></a></td>
      </tr>      
      <tr>
        <td>  
      
        <a href="javascript:cetak('$!jenisTempoh','2')" class="style2" ><font color="blue">Laporan Bulanan Pelarasan PU
 </font></a></td>
      </tr>       
       <tr>
        <td>  
      
        <a href="javascript:cetak('$!jenisTempoh','3')" class="style2" ><font color="blue">Laporan Bulanan Hakmilik Sambungan PU
 </font></a></td>
      </tr>     
    </table>
</fieldset>
...
function doChange() {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.LaporanPU";

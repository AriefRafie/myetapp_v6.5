...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2"> 
      <tr>
        <td>  
        <a href="javascript:cetakPampasan()" class="style2" ><font color="blue">Laporan Jumlah Pampasan</font></a></td>
      </tr>      
...
function cetakPampasan(){
	...
	if(document.${formName}.socTahun.value == ""){
		...
		var item = "ID_NEGERI="+id_negeri+"&TAHUN_MULA="+mula_tahun+"&TAHUN_AKHIR="+akhir_tahun;		
	 	//alert("item :"+item);
			var url = "../servlet/ekptg.report.ppt.LaporanJumlahPampasan?"+item 

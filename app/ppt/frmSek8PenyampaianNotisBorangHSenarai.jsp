  ...
  <legend><strong>Carian</strong></legend>
	<table width="100%" cellspacing="2" cellpadding="0" border="0">
    	 ...
    	 <tr>
            ...
            <td width="60%">:&nbsp;<input type="text" name="nofail" value="$!nofail" style="text-transform:uppercase;" id="nofail" size="27" onkeyup="this.value=this.value.toUpperCase();" /></td>
        </tr>
     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
        ...
        <tr class="table_header">
        	...
        	<tr>
        		...
        		<td class="$row"><a href="javascript:viewListPenyampaianNotis('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td> 

     ...
     <table width="100%" cellspacing="2" cellpadding="2" border="0">  
        ...
        <tr class="table_header">
        	...
        	<tr>
        		...
        		<td class="$row"><a href="javascript:viewSenaraiWarta('$!list.id_permohonan')"><font color="blue">$!list.no_fail</font></a></td>
        		<td class="$row"><a href="javascript:viewSenaraiWarta('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptg</font></a></td>
        		<td class="$row"><a href="javascript:viewSenaraiWarta('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_ptd</font></a></td> 
        		<td class="$row"><a href="javascript:viewSenaraiWarta('$!list.id_permohonan')"><font color="blue">$!list.no_rujukan_upt</font></a></td> 

...
<td><div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div id="txtUlasanPerintah_check" class="alert_msg" ></div>               </td>
    ...
    #else    
    <select name="socUnit" class="autoselect" id="socUnit"  onchange="checking_validation(this,'socUnit_check','yes','unit','normal');" >  
    ...
    <tr>
        <td width="1%" valign="top">&nbsp;</td>
        <td width="28%" valign="top">Catatan PB</td>
        <td width="1%" valign="top">:</td>
        <td width="70%">
...
<textarea name="txtUlasanTidakHadir" id="txtUlasanTidakHadir" cols="70"   rows="5"          
  ...
  <tr  class="row2">
    <td width="1%">&nbsp;</td>
    <td  width="28%" valign="top">Tanah</td>
    ...
    <tr  >
             ...
             #set( $i = $velocityCount )
                    ...
                    <tr >
                      ...
                      <td class="$row">
                      <a href="javascript:open_award('$list.ID_HAKMILIKPB','$!id_siasatan','$list.ID_AWARD')" title="Maklumat Pampasan"><font color="blue">$list.NAMA_PB</font></a>                      </td>
...
//txtUlasanPerintah
window.onload = submitForm,textarea_kerosakan('tambahtolak','umum',''),textarea_pecahpisah('tambahtolak','umum',''),textarea_prosiding('tambahtolak','umum',''),textarea_Lain('tambahtolak','umum',''),textarea_penjejasan('tambahtolak','umum',''),textarea_kenaikan('tambahtolak','umum',''),textarea_lainpampasan('tambahtolak','umum','');
...
function cetakNotaSiasatan(id_siasatan,idpermohonan) {
	...
	var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_permohonan="+idpermohonan+"&id_siasatan="+id_siasatan+"&report=NotaSiasatanSek8&flagReport=S";
	var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
    
    /*var url = "../servlet/ekptg.report.ppt.NotaSiasatanSek8?id_siasatan="+id_siasatan+"&namaPengarah="+namaPengarah;
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();*/

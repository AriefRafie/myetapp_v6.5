...
#set($txtNaikNilaiJPPH = $list_siasatan.NAIK_NILAI_JPPH)
  ...
  <td>
   <fieldset>
    ...
    <table width="100%">
      ...
      <tr>
        <td width="1%">&nbsp;</td>
        <td width="28%">Harga Seunit (RM)</td>
        <td width="1%">:</td>
        <td width="70%">
  ...
  <span id="txtHargaSeunitJPPH_check" style="color:red" ></span>  </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>Unit Harga</td>
        ...
        <td>
              ...
              #set($UnitHargaJPPH = "")
              #end
              <input name="UnitHargaJPPH" type="text" class = "disabled" id="UnitHargaJPPH" value="$UnitHargaJPPH" size="15"  readonly $check1>              
              #else
              <table width="100%">
              <tr>
              <td width="30%" >                    
              ...
              #set($check2 = "")
              #end 
<input type="radio" name="txtUnitHargaJPPH" id="txtUnitHargaJPPH" value="1" $check1 onClick="checking_validation(this,'txtUnitHargaJPPH_check','no','unit harga','radio');">
Meter Persegi</td>
              <td width="70%">
 <input type="radio" name="txtUnitHargaJPPH" id="txtUnitHargaJPPH" value="2" $check2 onClick="checking_validation(this,'txtUnitHargaJPPH_check','no','unit harga','radio');">
 Kaki Persegi  </td>                 
                </tr>
                </table>
          #end
         
          <span id="txtUnitHargaJPPH_check" style="color:red" ></span> 
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
  ...
  <span id="txtPecahPisahJPPH_check" style="color:red" ></span> </td>
       ...
       <tr>
        <td width="1%">&nbsp;</td>
        <td width="28%">Kenaikan Nilai  (RM)</td>
        <td width="1%">:</td>
        <td width="70%">

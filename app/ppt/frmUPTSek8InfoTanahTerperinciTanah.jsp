...
#foreach($data in $dataMaklumatTanahTerperinci)
	...
	#set($txtStrukturBangunanSO=$data.struktur_bangunan_so)
	<!-- JPPH -->
	...
	#set($txtStrukturBangunan=$data.struktur_bangunan)
	<!-- TAB 5 -->
...
<br/>
	...
	<fieldset id="middle">
	<legend>Laporan Tanah Terperinci Seksyen 8 - Tanah</legend>
	...
	<div id="TabbedPanels1" class="TabbedPanels">
  		...
  		<ul class="TabbedPanelsTabGroup">
            ...
            #if($id_tanah != "")
   	 		<li class="TabbedPanelsTab" onClick="javascript:setSelected(5);maklumatTanah('$!id_hakmilik')" tabindex="1">Dokumen/Imejan</li>
            #end
  		</ul>
   ...
   <br/> 		
    		...
    		<td width="53%" valign="top"><table width="100%" border="0">
    			...
    			<tr>
    				...
    				<td>No.Hakmilik</td>
    				<td>:</td>
    				<td><input $disOtherId $disOtherIdx type="text" name="txtNoHakmilik" id="txtNoHakmilik" value="$!txtNoHakmilik" size="12" maxlength="50"   ></td>
    			</tr>
    			<tr>
    				<td><font color="red">#if($editable=="yes")*#end</font></td>
    				<td>No.Syit</td>
    				<td>:</td>
    				<td><input $disOtherId $disOtherIdx type="text" name="txtNoSyit" id="txtNoSyit" value="$!txtNoSyit" size="12" maxlength="40"   ></td>
    			</tr>
    			<tr>
    				<td><font color="red">#if($editable=="yes")*#end</font></td>
    				<td>Kategori</td>
   ...
   <br/> 		
    		...
    		<table width="100%" border="0">
    			...
    			<tr>
    				...
    				<td valign="top">:</td>
    				<td><textarea $disOtherId $disOtherIdx name="txtJalanUtama" id="txtJalanUtama" cols="47%" rows="3" onKeyUp="textCounter(this.form.txtJalanUtama,this.form.remLenJU,4000);" onKeyDown="textCounter(this.form.txtJalanUtama,this.form.remLenJU,4000);" >$!txtJalanUtama</textarea></td>
    			</tr>
    			...
    			<tr>
    				...
    				<td valign="top">:</td>
    				<td><textarea $disOtherId $disOtherIdx name="txtJalanMasuk" id="txtJalanMasuk" cols="47%" rows="3" onKeyUp="textCounter(this.form.txtJalanMasuk,this.form.remLenJM,4000);" onKeyDown="textCounter(this.form.txtJalanMasuk,this.form.remLenJM,4000);" >$!txtJalanMasuk</textarea></td>
    			</tr>
    			...
    			<tr>
    				...
    				<td>:</td>
    				<td><input $disOtherId $disOtherIdx type="text" name="txtNamaPBT" id="txtNamaPBT" value="$!txtNamaPBT" size="40" maxlength="80"   ></td>
    			</tr>
    		...
    		<table width="100%" border="0">
    			...
    			<tr>
    				...
    				<td><textarea $disability $disabilityx name="txtJalanUtama" id="txtJalanUtama" cols="47%" rows="3" onKeyUp="textCounter(this.form.txtJalanUtama,this.form.remLenJU,4000);" onKeyDown="textCounter(this.form.txtJalanUtama,this.form.remLenJU,4000);" >$!txtJalanUtama</textarea></td>
    			</tr>
    			...
    			<tr>
    				...
    				<td><textarea $disability $disabilityx name="txtJalanMasuk" id="txtJalanMasuk" cols="47%" rows="3" onKeyUp="textCounter(this.form.txtJalanMasuk,this.form.remLenJM,4000);" onKeyDown="textCounter(this.form.txtJalanMasuk,this.form.remLenJM,4000);" >$!txtJalanMasuk</textarea></td>
    			</tr>
    			...
    			<tr>
    				...
    				<td>Nama PBT (Sekiranya Ya)</td>
    				<td>:</td>
    				<td><input $disability $disabilityx type="text" name="txtNamaPBT" id="txtNamaPBT" value="$!txtNamaPBT" size="40" maxlength="80"   ></td>
    			</tr>
    ...
    <br/> 		
    		...
    		<table width="100%" border="0">   		
    			<tr>
    				...
    				<td width="1%">:</td>
    				<td width="78%">
    					<input type="checkbox" $disOtherId1 $checkA name="flagBukit" id="flagBukit" value="1">&nbsp;Berbukit
    					<input type="checkbox" $disOtherId1 $checkB name="flagLandai" id="flagLandai" value="1">&nbsp;Landai
    					<input type="checkbox" $disOtherId1 $checkC name="flagRata" id="flagRata" value="1">&nbsp;Rata
    					<input type="checkbox" $disOtherId1 $checkD name="flagRendah" id="flagRendah" value="1">&nbsp;Rendah
    					<input type="checkbox" $disOtherId1 $checkE name="flagBerpaya" id="flagBerpaya" value="1">&nbsp;Berpaya
    					<input type="checkbox" $disOtherId1 $checkF name="flagLurah" id="flagLurah" value="1">&nbsp;Lurah
    					<input type="checkbox" $disOtherId1 $checkG name="flagLembah" id="flagLembah" value="1">&nbsp;Lembah
    				</td>   				
    			</tr>
    			...
    			<tr>	
            		...
            		<td valign="top">Perihal Lain</td>
            		<td valign="top">:</td>
            		<td><textarea $disOtherId $disOtherIdx name="txtPerihalRupabumi" id="txtPerihalRupabumi" cols="50%" rows="4" onKeyUp="textCounter(this.form.txtPerihalRupabumi,this.form.remLen1,400);" onKeyDown="textCounter(this.form.txtPerihalRupabumi,this.form.remLen1,400);" >$!txtPerihalRupabumi</textarea></td>
            	</tr>
    ...
    <br/> 		
    		...
    		<table width="100%" border="0">  
    			...
    			<tr>	
            		...
            		<td valign="top">Perihal Lain</td>
            		<td valign="top">:</td>
            		<td valign="top" width="78%"><textarea $disOtherId $disOtherIdx name="txtPerihalKeadaan" id="txtPerihalKeadaan" cols="50%" rows="4" onKeyUp="textCounter(this.form.txtPerihalKeadaan,this.form.remLen2,400);" onKeyDown="textCounter(this.form.txtPerihalKeadaan,this.form.remLen2,400);" >$!txtPerihalKeadaan</textarea></td>
            	</tr>
            	...
            	<tr>
           		...
           		<tr>	
            		...
            		<td valign="top">:</td>
            		<td valign="top"><textarea $disOtherId $disOtherIdx name="txtHalangan" id="txtHalangan" cols="50%" rows="4" onKeyUp="textCounter(this.form.txtHalangan,this.form.remLen3,400);" onKeyDown="textCounter(this.form.txtHalangan,this.form.remLen3,400);" >$!txtHalangan</textarea></td>
            	</tr>
            	...
            	<tr>
           		...
           		<tr>	
            		...
            		<td valign="top">:</td>
            		<td valign="top"><textarea $disOtherId $disOtherIdx name="txtTanaman" id="txtTanaman" cols="50%" rows="4" onKeyUp="textCounter(this.form.txtTanaman,this.form.remLen4,400);" onKeyDown="textCounter(this.form.txtTanaman,this.form.remLen4,400);" >$!txtTanaman</textarea></td>
            	</tr>
...
<!-- START TAB 3 -->
    		...
    		<table width="100%" border="0">
    			...
    			<tr>
    				...
    				<td width="1%">:</td>
    				<td width="73%"><input $disOtherId1 $check1s type="radio" name="sorSaliran" id="sorBaik" value="1" >Baik
     				&nbsp;&nbsp;<input $disOtherId1 $check2s type="radio" name="sorSaliran" id="sorTidak" value="2" >Tidak</td>
    			</tr>
    			...
    			<tr>	
            		...
            		<td valign="top">:</td>
            		<td valign="top" width="78%"><textarea $disOtherId $disOtherIdx name="txtKemudahan" id="txtKemudahan" cols="50%" rows="4" onKeyUp="textCounter(this.form.txtKemudahan,this.form.remLen5,400);" onKeyDown="textCounter(this.form.txtKemudahan,this.form.remLen5,400);" >$!txtKemudahan</textarea></td>
            	</tr>
            	...
            	<tr>
           		...
           		<tr>	
            		...
            		<td valign="top">:</td>
            		<td valign="top" width="78%"><textarea $disOtherId $disOtherIdx name="txtSempadanUtara" id="txtSempadanUtara" cols="50%" rows="4" onKeyUp="textCounter(this.form.txtSempadanUtara,this.form.remLen6,400);" onKeyDown="textCounter(this.form.txtSempadanUtara,this.form.remLen6,400);" >$!txtSempadanUtara</textarea></td>
            	</tr>
            	...
            	<tr>
           		...
           		<tr>	
            		...
            		<td valign="top">:</td>
            		<td valign="top" width="78%"><textarea $disOtherId $disOtherIdx name="txtSempadanSelatan" id="txtSempadanSelatan" cols="50%" rows="4" onKeyUp="textCounter(this.form.txtSempadanSelatan,this.form.remLen7,400);" onKeyDown="textCounter(this.form.txtSempadanSelatan,this.form.remLen7,400);" >$!txtSempadanSelatan</textarea></td>
            	</tr>
            	...
            	<tr>
           		...
           		<tr>	
            		...
            		<td valign="top">:</td>
            		<td valign="top" width="78%"><textarea $disOtherId $disOtherIdx name="txtSempadanTimur" id="txtSempadanTimur" cols="50%" rows="4" onKeyUp="textCounter(this.form.txtSempadanTimur,this.form.remLen8,400);" onKeyDown="textCounter(this.form.txtSempadanTimur,this.form.remLen8,400);" >$!txtSempadanTimur</textarea></td>
            	</tr>
            	...
            	<tr>
           		...
           		<tr>	
            		...
            		<td valign="top">:</td>
            		<td valign="top" width="78%"><textarea $disOtherId $disOtherIdx name="txtSempadanBarat" id="txtSempadanBarat" cols="50%" rows="4" onKeyUp="textCounter(this.form.txtSempadanBarat,this.form.remLen9,400);" onKeyDown="textCounter(this.form.txtSempadanBarat,this.form.remLen9,400);" >$!txtSempadanBarat</textarea></td>
            	</tr>
...
<!-- START TAB 4 -->
    		...
    		<td width="50%" valign="top">
    			...
    			<tr>
    				...
    				<td width="60%"><select $disOtherId1 $disOtherIdx name="socUnitHargaSO" style="width:150px">
      					...
      					<option value="4">KAKI PERSEGI</option>
      					<option value="">SILA PILIH</option>   	
      					#elseif($socUnitHargaSO=="3")
      					<option value="3">EKAR</option>	
      					<option value="1">HEKTAR</option>
      					<option value="2">METER PERSEGI</option>
      					<option value="4">KAKI PERSEGI</option>
      					<option value="">SILA PILIH</option> 
      					#elseif($socUnitHargaSO=="4")	
      					<option value="4">KAKI PERSEGI</option>	   
      					<option value="1">HEKTAR</option>
      					<option value="2">METER PERSEGI</option>
      					<option value="3">EKAR</option>
    			...
    			#if($txtHargaSeunitSO=="" || $txtHargaSeunitSO=="0")
           			#set($HSeunitSO="")
        		#else
    			...
    			#if($txtPenjejasanSO=="" || $txtPenjejasanSO=="0")
           			#set($HPenjejasanSO="")
        		#else
    			...
    			#if($txtKenaikanSO=="" || $txtKenaikanSO=="0")
           			#set($HKenaikanSO="")
        		#else
    			...
    			#if($txtStrukturBangunanSO=="" || $txtStrukturBangunanSO=="0")
           			#set($HStrukturBangunanSO="")
        		#else
           			#set($HStrukturBangunanSO=$txtStrukturBangunanSO)
       			#end
    			<tr>
    				<td>&nbsp;</td>
    				<td>Struktur Bangunan</td>
    				<td>:</td>
    				<td><input type="text" $disOtherId $disOtherIdx name="txtStrukturBangunanSO" id="txtStrukturBangunanSO" value="$!HStrukturBangunanSO" size="10" maxlength="11" style="text-align:right" onkeyup="validateNilai(this,this.value)" onblur="validateModal(this,this.value,'$!HStrukturBangunanSO')"></td>
    			</tr>
    		...
    		<td width="50%" valign="top">
    			...
    			<tr>
    				<td width="1%">&nbsp;</td>
    				<td width="30%">Unit Harga</td>
    				<td width="1%">:</td>
    				<td width="68%"><select $disOtherId1 $disOtherIdx name="socUnitHargaJP" style="width:150px">
      					...
      					<option value="4">KAKI PERSEGI</option>
      					<option value="">SILA PILIH</option>   	
      					#elseif($socUnitHargaJP=="3")
      					<option value="3">EKAR</option>	
      					<option value="1">HEKTAR</option>
      					<option value="2">METER PERSEGI</option>
      					<option value="4">KAKI PERSEGI</option>
      					<option value="">SILA PILIH</option> 
      					#elseif($socUnitHargaJP=="4")	
      					<option value="4">KAKI PERSEGI</option>	   
      					<option value="1">HEKTAR</option>
      					<option value="2">METER PERSEGI</option>
      					<option value="3">EKAR</option>
    			...
    			#if($txtHargaSeunitJP=="" || $txtHargaSeunitJP=="0")
           			#set($HSeunitJP="")
        		#else
    			...
    			#if($txtPenjejasanJP=="" || $txtPenjejasanJP=="0")
           			#set($HPenjejasanJP="")
        		#else
    			...
    			#if($txtKenaikanJP=="" || $txtKenaikanJP=="0")
           			#set($HKenaikanJP="")
        		#else
    			...
    			#if($txtStrukturBangunan=="" || $txtStrukturBangunan=="0")
           			#set($HStrukturBangunan="")
        		#else
           			#set($HStrukturBangunan=$txtStrukturBangunan)
       			#end
    			<tr>
    				<td>&nbsp;</td>
    				<td valign="top">Struktur Bangunan</td>
    				<td valign="top">:</td>
    				<td>
                    
                    <div id="getSenaraiBanggunan"></div>
                    <table width="100%" border="0">   
        		<tr >
        			<td align="center" width="5%"></td>
        			<td width="65%" align="right">Jumlah Keseluruhan :</td>
        			
        			<td width="30%"><input type="text"  $disOtherId $disOtherIdx name="txtStrukturBangunan" id="txtStrukturBangunan" value="$!HStrukturBangunan" size="12" maxlength="11" style="text-align:right" onkeyup="validateNilai(this,this.value)" onblur="validateModal(this,this.value,'$!HStrukturBangunan')" /></td>
        		</tr>
                </table>
    		...
    		<td width="50%" valign="top">
    			...
    			<tr>
    				...
    				<td>:</td>
    				#if($isEdit=="no")
    				<td><input type="text" $disability $disabilityx name="txtStrukturBangunanSO" id="txtStrukturBangunanSO" value="$!Utils.format2Decimal($txtStrukturBangunanSO)" size="10" maxlength="11" style="text-align:right" ></td>
    				#else
    				<td><input type="text" $disability $disabilityx name="txtStrukturBangunanSO" id="txtStrukturBangunanSO" value="$!txtStrukturBangunanSO" size="10" maxlength="11" style="text-align:right" onkeyup="validateNilai(this,this.value)" onblur="validateModal(this,this.value,'$!txtStrukturBangunanSO')"></td>
    				#end
    			</tr>
    		...
    		<td width="50%" valign="top">
    			...
    			<tr>
    				<td width="1%">&nbsp;</td>
    				<td width="28%">Unit Harga</td>
    				<td width="1%">:</td>
    				<td width="70%"><select name="socUnitHargaJP" $disability1 $disabilityx style="width:150px">
    			...
    			<tr>
    				...
    				#else
    				<td width="12%"><input type="text" $disability $disabilityx name="txtHargaSeunitJP" id="txtHargaSeunitJP" value="$!txtHargaSeunitJP" size="10" maxlength="11" style="text-align:right" onkeyup="validateNilai(this,this.value)" onblur="validateModal(this,this.value,'$!txtHargaSeunitJP')"></td>
    				#end
    			</tr>
        		...
        		<tr >
        			...
        			<td width="30%">
                    #if($isEdit=="no")
    				<input type="text" $disability $disabilityx name="txtStrukturBangunan" id="txtStrukturBangunan" value="$!Utils.format2Decimal($txtStrukturBangunan)" size="12" maxlength="11" style="text-align:right" >
    				#else
                    <input type="text" $disability $disabilityx name="txtStrukturBangunan" id="txtStrukturBangunan" value="$!txtStrukturBangunan" size="12" maxlength="11" style="text-align:right" onkeyup="validateNilai(this,this.value)" onblur="validateModal(this,this.value,'$!txtStrukturBangunan')">
                    #end
                    </td>
        		</tr>
                </table>
    		...
    		<legend><strong>Pecah Pisah</strong></legend>
    			...
    			<table width="100%" border="0">
    				<tr>
    					...
    					<td width="1%" valign="top">:</td>
    					<td width="80%"><textarea $disOtherId $disOtherIdx name="txtJenisPisah" id="txtJenisPisah" cols="40%" rows="3" onKeyUp="textCounter(this.form.txtJenisPisah,this.form.remLenPP,1500);" onKeyDown="textCounter(this.form.txtJenisPisah,this.form.remLenPP,1500);" >$!txtJenisPisah</textarea></td>
    				</tr>
    			</table>
    			#end
			...
			<td>
				#if($mode=="new" && $editable=="yes")
				<input type="button" name="cmdSimpan" value ="Simpan" onClick="javascript:sum_nilai();simpanNilaian();simpanTab4('$!id_hakmilik','$!id_tanah','$!mode')">
				#end
				...
				<input type="button" name="cmdKemaskini" value ="Kemaskini" onClick="javascript:kemaskiniTanahTerperinci('$!id_tanah')">
				#else
				<input type="button" name="cmdUpdate" value ="Simpan" onClick="javascript:sum_nilai();simpanNilaian();simpanTab4('$!id_hakmilik','$!id_tanah','$!mode')">
				<input type="button" name="cmdBatal" value ="Batal" onClick="javascript:batalKemaskini('$!id_hakmilik')">
				#end
				#end
...
<!-- START TAB 5 -->
    		...
    		<table width="100%" border="0">
    			...
    			<tr>	
            		...
            		<td width="1%" valign="top">:</td>
            		<td width="73%" valign="top"><textarea $disOtherId $disOtherIdx name="txtUlasanPegawai" id="txtUlasanPegawai" cols="50%" rows="6" onKeyUp="textCounter(this.form.txtUlasanPegawai,this.form.remLen10,1500);" onKeyDown="textCounter(this.form.txtUlasanPegawai,this.form.remLen10,1500);" >$!txtUlasanPegawai</textarea></td>
            	</tr>
    		...
    		<table width="100%" border="0">
    			...
    			<tr>
    				...
    				<td width="1%">:</td>
    				<td width="73%">$!selectPegawai</td>
    				<!-- <td width="73%"><input type="text" readonly class="disabled" name="txtPelapor" id="txtPelapor" value="$!{session.getAttribute('_portal_username')}" size="40" maxlength="80"   ></td> -->
    			</tr>
    		...
    		<table width="100%" border="0">
    			...
    			<tr>	
            		...
            		<td width="25%" valign="top">Pandangan dan Syor</td>
            		<td width="1%" valign="top">:</td>
            		<td width="73%" valign="top" ><textarea $disability $disabilityx name="txtUlasanPegawai" id="txtUlasanPegawai" cols="50%" rows="6" onKeyUp="textCounter(this.form.txtUlasanPegawai,this.form.remLen10,1500);" onKeyDown="textCounter(this.form.txtUlasanPegawai,this.form.remLen10,1500);" >$!txtUlasanPegawai</textarea></td>
            	</tr>
    		...
    		<table width="100%" border="0">
    			...
    			<tr>
    				...
    				<td width="73%">$!selectPegawai</td>
    				<!-- #if($isEdit=="no")
    				<td width="73%"><input type="text" readonly class="disabled" name="txtPelapor" id="txtPelapor" value="$!txtPelapor" size="40" maxlength="80"   ></td>
    				#else
    				<td width="73%"><input type="text" readonly class="disabled" name="txtPelapor" id="txtPelapor" value="$!{session.getAttribute('_portal_username')}" size="40" maxlength="80"   ></td>
    				#end -->
    			</tr>
...
<!-- START TAB 6 -->  		
    ...
    <fieldset >
	<legend><strong>&nbsp;MUATNAIK DOKUMEN BEKAITAN</strong></legend>

    <table width="100%" border="0"> 
    <tr >
    <td align="left">
     <a href="javascript:popupCarianDokumen('$id_tanah','LaporanTanahTerperinci','$id_permohonan')"><font color="blue">>> SKRIN SENARAI DOKUMEN BERKAITAN</font></a>
    </td>
    </tr>
    </table>
    ...
    <br />
    <fieldset >
	<legend><strong>&nbsp;MUATNAIK IMEJAN BEKAITAN</strong></legend>

    <table width="100%" border="0"> 
    <tr >
    <td align="left">
     <a href="javascript:popupCarianDokumenImej('$id_hakmilik','LaporanTanahTerperinciImej','$id_permohonan')"><font color="blue">>> SKRIN SENARAI IMEJAN BERKAITAN</font></a>
    </td>
    </tr>
    </table>
    ...
    <!--
    		...
    		<table width="100%" border="0">
    			<tr>
    				...
    				<td width="1%">:</td>
    				<td width="78%"><input $disOtherId $disOtherIdx type="text" name="txtTajuk" id="txtTajuk" value="" size="43" maxlength="80"   ></td>
    			</tr>
    			<tr>
    				<td>&nbsp;</td>
    			...
    			<tr>
            		<td valign="top"><font color="red">#if($editable=="yes")*#end</font></td>
...
<legend><strong>SENARAI LAPORAN</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
      <tr>  
      	 <td><a href="#" onClick="javascript:cetakLaporanTanah('$!id_permohonan','$!id_hakmilik')"><font color="blue">Laporan Penolong Pegawai Tanah</font></a></td>
      </tr>  
       <tr>  
      	 <td><a href="#" onClick="javascript:cetakLaporanTanah_imej('$!id_permohonan','$!id_hakmilik')"><font color="blue">Laporan Penolong Pegawai Tanah - Lampiran Gambarajah Tapak</font></a></td>
      </tr>  
    </table>
</fieldset>

<input type="hidden" id="check_edit" name="check_edit" value="$isEdit"  />
...
$jquery(document).ready(function () {
	doDivAjaxCall$formname('getSenaraiBanggunan','getSenaraiBanggunan','');	
	
});

function popupCarianDokumen(id_tanah,flag_skrin,id_permohonan)
{
	
	var url = "../x/${securityToken}/ekptg.view.ppt.SkrinPopupUploadDokumen?&id_tanah="+id_tanah+"&id_permohonan="+id_permohonan+"&flag_skrin="+flag_skrin;
...
function popupCarianDokumenImej(id_hakmilik,flag_skrin,id_permohonan)
{
	
	var url = "../x/${securityToken}/ekptg.view.ppt.SkrinPopupUploadDokumen?&id_hakmilik="+id_hakmilik+"&id_permohonan="+id_permohonan+"&flag_skrin="+flag_skrin;
	var hWnd = window.open(url,'printuser','width=1200,height=800, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
       hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
{
	doDivAjaxCall$formname('getSenaraiBanggunan','simpanNilaianJpph','');
}
...
function sum_nilai()
{
	...
	if(parseInt('$saiz_bangunan')>0)
	{
		var loop = parseInt('$saiz_bangunan') + 1;
		var total = 0;
		for(var i=1; i<loop; i++)
		{
				  var field = document.getElementById('nilai_jpph_bg'+i);
		...
		//alert("total :"+total);	
		document.getElementById('txtStrukturBangunan').value = total.toFixed(2);
	}
	else
	{
...
function onchangeUnitAmbilUpdate() {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmUPTSek8InfoTanahTerperinciTanah";
...
function hapusDokumen(idpermohonan,idHakmilik,idTanah,iddokumen) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmUPTSek8InfoTanahTerperinciTanah"+actionItem;
	document.${formName}.submit();
...
function simpanTab6(idpermohonan,idHakmilik,idTanah,mode) {
	...
	if(document.${formName}.fileupload.value == ""){
		...
		document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmUPTSek8InfoTanahTerperinciTanah"+actionItem+"&tabId=5";
		document.${formName}.submit();
		
	}
}
function cetakLaporanTanah(idpermohonan,idHakmilik) {

	var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_permohonan="+idpermohonan+"&id_hakmilik="+idHakmilik+"&report=LaporanTerperinciTanah&selectNoFail=yes";
...
function cetakLaporanTanah_imej(idpermohonan,idHakmilik) {

	//var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_permohonan="+idpermohonan+"&id_hakmilik="+idHakmilik+"&report=LaporanTerperinciTanah&selectNoFail=yes";
    var url = "../servlet/ekptg.report.ppt.laporanTanahSS8_imej?id_permohonan="+idpermohonan+"&idHakmilik="+idHakmilik;
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();

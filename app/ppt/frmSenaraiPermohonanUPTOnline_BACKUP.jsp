         ...
         #foreach($list in $listPermohonan)
            #set( $i = $velocityCount )
         	...
         	#set($flagStatusOnline="")
            	 ...
            	 #set($flagStatusOnline="<br/><font style='font-size:9px'><b><i>(PERMOHONAN TELAH DIKEMBALIKAN)</i></b></font>")
            #else
            	 #set($flagStatusOnline="")
            #end	
         	
         	#if($list.flag_jenispermohonan=="1")
         		#set($noOnline=$list.no_permohonan_online)
         	#else
         		#set($noOnline="TIADA")
         	#end	
			<!-- $!notifikasi -->
													        	...
													        	<tr>
													        		<td class="$row" align="center">$countList.</td>
													            	...
													            	<td class="$row">$list.status</td>
													            	<td class="$row">$list.catatan_status_online</td>
													        	</tr>
											        		#end
											        	#elseif($!jawatan == '4')
											      			#if($!list.flag_semakan_online == '2')
											      				#set( $countList = $countList + 1 )         		
													        	<tr>
													        		<td class="$row" align="center">$countList.</td>
													        		<td class="$row"><a href="javascript:semakPendaftaran('$!list.id_permohonan')"><font color="blue">$!noOnline $flagStatusOnline</font></a></td> 

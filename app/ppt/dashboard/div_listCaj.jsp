   ...
   <style>
	...
	<div id="boxListCaj" >
		...
		<input type="hidden" id="div_getListCaj_open" name="div_getListCaj_open" value="Y">
		<table border="0" width="100%" > 
			<tr>
				...
				<td align="right" valign="top">
					<a href="javascript:getListCajClose()" id="trigger">
		...
		<table border="0" width="100%"  class="nav" style=""> 
			<tr>
				<td valign="top" >
				SENARAI PERMOHONAN (Tarikh ambilan cek melebihi 90 hari dari serahan Borang H)
				</td>
			</tr>
		</table>
	
		<div id="scroll_boxListCaj">
			...
			<table border="0" width="100%" > 
				...
				#if($list.no_fail == '')
				<a href="javascript:paparCaj('$list.id_permohonan','76','$list.id_fail','$list.tarikh_permohonan','$list.flag_jenispermohonan','$list.id_suburusan','$!list.flag_segera','$!{session.getAttribute('myrole')}')" class="style1">TIADA NO Hakmilik JKPTG </a>
				#else
				<a href="javascript:paparCaj('$list.id_permohonan','76','$list.id_fail','$list.tarikh_permohonan','$list.flag_jenispermohonan','$list.id_suburusan','$!list.flag_segera','$!{session.getAttribute('myrole')}')" class="style1">$list.no_fail</a>
				#end
   ...
   <script type="text/javascript">
      ...
      $jquery(document).ready(function(e) {
		    ...
		    //width  = 600;	
			width = document.getElementById("div_listCaj").offsetWidth;		
		    left = width+e.pageX;
			top  = height+e.pageY;			
			height = 300;
			$jquery("#boxListCaj").css('width', width).css('height', height).css('top', top).css('left', left);
			$jquery("#scroll_boxListCaj").css('width', width).css('height', height-55).css('top', top).css('left', left).css('overflow-y','scroll');
		...
		var boxListCaj = $jquery("#boxListCaj")
		boxListCaj.offset({
			left: left,
			top: top
		});		
		...
		$jquery(document).mousemove(function(e) {
			...
			if (drag.state) {
				...
				drag.x = e.pageX;
				drag.y = e.pageY;
				$jquery("div#boxListCaj").css('top', e.pageY).css('left', e.pageX);
			}
		});

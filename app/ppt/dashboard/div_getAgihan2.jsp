...
<input type="hidden" id="div_getAgihan2_open" name="div_getAgihan2_open" value="Y">
...
<td align="right" valign="top"><a href="javascript:gotoAgihan2()" id="trigger">
...
<tr  >
<td valign="top" >
SENARAI FAIL (TUNGGU PENGESAHAN)
 </td>
</tr>
</table>

<div id="scroll_boxAgihan2" >
<table border="0" width="100%" > 
   ...
   <tr class="table_header">
           ...
           #if($list.ID_STATUS=="11" && $list.FLAG_SEMAK=="1" && ($list.ID_SUBURUSAN=="52" || $list.ID_SUBURUSAN=="53"))
   ...
   <script type="text/javascript">
      ...
      $jquery(document).ready(function(e) {
		   $jquery('#boxAgihan2').show();
		    width  = 500;			
		    left = width+e.pageX;
            top  = height+e.pageY;	
			
			if(document.getElementById('boxAgihan2').clientHeight>250)
			{
		    height = 250;
			//$jquery("#boxAgihan2").css('width', width).css('height', height).css('overflow-y','scroll').css('top', top).css('left', left);
			$jquery("#boxAgihan2").css('width', width).css('height', height).css('top', top).css('left', left);	
			$jquery("#scroll_boxAgihan2").css('width', width).css('height', height-55).css('top', top).css('left', left).css('overflow-y','scroll');	
			}
			else
			{
			height = document.getElementById('boxAgihan2').clientHeight;	
			$jquery("#boxAgihan2").css('width', width).css('height', height).css('top', top).css('left', left);	
			}
		...
		/*
		 $jquery("div#boxAgihan2").mousemove(function(e) {
			 $jquery("div#boxAgihan2").css('top', e.pageY).css('left', e.pageX);
			});
		*/	
		
		
		var boxAgihan2 = $jquery("#boxAgihan2")
		boxAgihan2.offset({
			left: left,
			top: top
		});		

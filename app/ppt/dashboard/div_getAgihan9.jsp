...
<input type="hidden" id="div_getAgihan9_open" name="div_getAgihan9_open" value="Y">
...
<td align="right" valign="top"><a href="javascript:gotoAgihan9()" id="trigger">
...
<tr  >
<td valign="top" >
SENARAI FAIL (TELAH DISEMAK PENARIKAN)
 </td>
</tr>
</table>
<div id="scroll_boxAgihan9" >
<table border="0" width="100%" > 
   ...
   <tr class="table_header">
           ...
           #foreach($list in $listAgihan)
             ...
             #if($list.ID_STATUS=="74" && $list.FLAG_MMK_PENARIKAN=="2" && $list.STATUS_KEPUTUSAN == "" ) 
   ...
   <script type="text/javascript">
      ...
      $jquery(document).ready(function(e) {
		$jquery('#boxAgihan9').show();
		    width  = 500;			
		    left = width+e.pageX;
            top  = height+e.pageY;	
			
			if(document.getElementById('boxAgihan9').clientHeight>250)
			{
		    height = 250;
			//$jquery("#boxAgihan9").css('width', width).css('height', height).css('overflow-y','scroll').css('top', top).css('left', left);
			$jquery("#boxAgihan9").css('width', width).css('height', height).css('top', top).css('left', left);	
			$jquery("#scroll_boxAgihan9").css('width', width).css('height', height-55).css('top', top).css('left', left).css('overflow-y','scroll');	
			}
			else
			{
			height = document.getElementById('boxAgihan9').clientHeight;	
			$jquery("#boxAgihan9").css('width', width).css('height', height).css('top', top).css('left', left);	
			}	
		...
		/*
		 $jquery("div#boxAgihan9").mousemove(function(e) {
			 $jquery("div#boxAgihan9").css('top', e.pageY).css('left', e.pageX);
			});
		*/	
		
		
		var boxAgihan9 = $jquery("#boxAgihan9")
		boxAgihan9.offset({
			left: left,
			top: top
		});		

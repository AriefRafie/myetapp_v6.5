...
#if($!div_getOnlineBantahanAG_open == "Y")




<div id="log"  style="display:none"></div>
<div id="boxOnlineBantahanAG" >
...
<input type="hidden" id="div_getOnlineBantahanAG_open" name="div_getOnlineBantahanAG_open" value="Y">
...
<td align="right" valign="top"><a href="javascript:gotoSekBantahanAG()" id="trigger">
...
<tr  >
<td valign="top" >
PERMOHONAN ONLINE BANTAHAN (AGENSI)
 </td>
</tr>
</table>

<div id="scroll_boxOnlineBantahanAG">
<table border="0" width="100%" > 
 ...
 function carian()
 {
	doDivAjaxCall$formname('div_getOnlineBantahanAG','getOnlineBantahanAG_carian','');	 
 }
 </script>
   ...
   <script type="text/javascript">
      ...
      $jquery(document).ready(function(e) {
		  $jquery('#boxOnlineBantahanAG').show();
		    width  = 500;			
		    left = width+e.pageX;
            top  = height+e.pageY;				
			if(document.getElementById('boxOnlineBantahanAG').clientHeight>250)
			{
		    height = 250;
			//$jquery("#boxOnlineBantahanAG").css('width', width).css('height', height).css('overflow-y','scroll').css('top', top).css('left', left);
			$jquery("#boxOnlineBantahanAG").css('width', width).css('height', height).css('top', top).css('left', left);	
			$jquery("#scroll_boxOnlineBantahanAG").css('width', width).css('height', height-55).css('top', top).css('left', left).css('overflow-y','scroll');	
			}
			else
			{
			height = document.getElementById('boxOnlineBantahanAG').clientHeight;	
			$jquery("#boxOnlineBantahanAG").css('width', width).css('height', height).css('top', top).css('left', left);	
			}
		...
		/*
		 $jquery("div#boxOnlineBantahanAG").mousemove(function(e) {
			 $jquery("div#boxOnlineBantahanAG").css('top', e.pageY).css('left', e.pageX);
			});
		*/	
		
		
		var boxOnlineBantahanAG = $jquery("#boxOnlineBantahanAG")
		boxOnlineBantahanAG.offset({
			left: left,
			top: top
		});		
		var drag = {

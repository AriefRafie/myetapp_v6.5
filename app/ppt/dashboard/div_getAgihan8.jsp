...
<input type="hidden" id="div_getAgihan8_open" name="div_getAgihan8_open" value="Y">
...
<td align="right" valign="top"><a href="javascript:gotoAgihan8()" id="trigger">
...
<tr  >
<td valign="top" >
SENARAI FAIL (TUNGGU SEMAKAN MMK PENARIKAN)
 </td>
</tr>
</table>
<div id="scroll_boxAgihan8">
<table border="0" width="100%" > 
   ...
   <tr class="table_header">
          ...
          #if($list.ID_STATUS=="74" && $list.FLAG_MMK_PENARIKAN=="1" )
   ...
   <script type="text/javascript">
      ...
      $jquery(document).ready(function(e) {
		 $jquery('#boxAgihan8').show();
		    width  = 500;			
		    left = width+e.pageX;
            top  = height+e.pageY;	
			
			if(document.getElementById('boxAgihan8').clientHeight>250)
			{
		    height = 250;
			//$jquery("#boxAgihan8").css('width', width).css('height', height).css('overflow-y','scroll').css('top', top).css('left', left);
			$jquery("#boxAgihan8").css('width', width).css('height', height).css('top', top).css('left', left);	
			$jquery("#scroll_boxAgihan8").css('width', width).css('height', height-55).css('top', top).css('left', left).css('overflow-y','scroll');	
			}
			else
			{
			height = document.getElementById('boxAgihan8').clientHeight;	
			$jquery("#boxAgihan8").css('width', width).css('height', height).css('top', top).css('left', left);	
			}	
		...
		/*
		 $jquery("div#boxAgihan8").mousemove(function(e) {
			 $jquery("div#boxAgihan8").css('top', e.pageY).css('left', e.pageX);
			});
		*/	
		
		
		var boxAgihan8 = $jquery("#boxAgihan8")
		boxAgihan8.offset({
			left: left,
			top: top
		});		

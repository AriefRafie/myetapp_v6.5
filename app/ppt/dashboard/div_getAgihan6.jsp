...
<input type="hidden" id="div_getAgihan6_open" name="div_getAgihan6_open" value="Y">
...
<td align="right" valign="top"><a href="javascript:gotoAgihan6()" id="trigger">
...
<tr  >
<td valign="top" >
SENARAI FAIL (TUNGGU SEMAKAN MMK)
 </td>
</tr>
</table>

<div id="scroll_boxAgihan6">
<table border="0" width="100%" > 
   ...
   <tr class="table_header">
           ...
           #if(($list.ID_STATUS=="132" && $list.FLAG_SEMAKAN_PENGARAH=="1") || ($list.ID_STATUS=="26" && $list.FLAG_SEMAKAN_PENGARAH=="1"))
   ...
   <script type="text/javascript">
      ...
      $jquery(document).ready(function(e) {
		 	$jquery('#boxAgihan6').show();
		    width  = 500;			
		    left = width+e.pageX;
            top  = height+e.pageY;	
			
			if(document.getElementById('boxAgihan6').clientHeight>250)
			{
		    height = 250;
			//$jquery("#boxAgihan6").css('width', width).css('height', height).css('overflow-y','scroll').css('top', top).css('left', left);	
			$jquery("#boxAgihan6").css('width', width).css('height', height).css('top', top).css('left', left);	
			$jquery("#scroll_boxAgihan6").css('width', width).css('height', height-55).css('top', top).css('left', left).css('overflow-y','scroll');
			}
			else
			{
			height = document.getElementById('boxAgihan6').clientHeight;	
			$jquery("#boxAgihan6").css('width', width).css('height', height).css('top', top).css('left', left);	
			}	
		...
		/*
		 $jquery("div#boxAgihan6").mousemove(function(e) {
			 $jquery("div#boxAgihan6").css('top', e.pageY).css('left', e.pageX);
			});
		*/	
		
		
		var boxAgihan6 = $jquery("#boxAgihan6")
		boxAgihan6.offset({
			left: left,
			top: top
		});		

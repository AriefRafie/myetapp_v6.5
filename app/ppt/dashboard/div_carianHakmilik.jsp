...
<input type="hidden" id="val_count_carianHakmilik" name="val_count_carianHakmilik" value="$!count_carianHakmilik" />
						...
						<font color="blue"><li>
                            ...
                            <b><font color="WHITE"><span class="blink">$!count_carianHakmilik</span></font></b>
                             </label>&nbsp;
                                                      
                            <a href="javascript:getListHakmilik()" class="help" title="Senarai Hakmilik"><font color="blue">Hakmilik</font></a>
                            </li></font>						
				 #end 

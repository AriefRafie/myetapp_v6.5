...
#if($!div_getListHakmilikSiasatan_open == "Y")

<div id="log"  style="display:none"></div>
<div id="boxListHakmilikSiasatan" >
...
<input type="hidden" id="div_getListHakmilikSiasatan_open" name="div_getListHakmilikSiasatan_open" value="Y">
...
<td align="right" valign="top"><a href="javascript:getListHakmilikSiasatan()" id="trigger">
...
<tr  >
<td valign="top" >
SENARAI HAKMILIK SIASATAN
 </td>
</tr>
</table>

<div id="scroll_boxListHakmilikSiasatan">
<table border="0" width="100%" > 
 
   <tr class="table_header">
          
              <td scope="row" width="5%" align="center">BIL</td>
              <td width="30%">NO SIASATAN</td> 
   ...
   #if($listHakmilikSiasatan.size()>0)
 			       #set( $i = 0 )   

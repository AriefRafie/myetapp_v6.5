...
<input type="hidden" id="div_getAgihan7_open" name="div_getAgihan7_open" value="Y">
...
<td align="right" valign="top"><a href="javascript:gotoAgihan7()" id="trigger">
...
<tr  >
<td valign="top" >
SENARAI FAIL (TELAH DISEMAK)
 </td>
</tr>
</table>

<div id="scroll_boxAgihan7">
<table border="0" width="100%" > 
   ...
   <tr class="table_header">
           ...
           #foreach($list in $listAgihan)
             ...
             #if(($list.ID_STATUS=="133" && $list.FLAG_SEMAKAN_PENGARAH=="2") || ($list.ID_STATUS=="26" && $list.FLAG_SEMAKAN_PENGARAH=="2"))
   ...
   <script type="text/javascript">
      ...
      $jquery(document).ready(function(e) {
		  ...
		  $jquery('#boxAgihan7').show();
		    width  = 500;			
		    left = width+e.pageX;
            top  = height+e.pageY;	
			
			if(document.getElementById('boxAgihan7').clientHeight>250)
			{
		    height = 250;
			//$jquery("#boxAgihan7").css('width', width).css('height', height).css('overflow-y','scroll').css('top', top).css('left', left);	
			$jquery("#boxAgihan7").css('width', width).css('height', height).css('top', top).css('left', left);	
			$jquery("#scroll_boxAgihan7").css('width', width).css('height', height-55).css('top', top).css('left', left).css('overflow-y','scroll');	
			
			}
			else
			{
			height = document.getElementById('boxAgihan7').clientHeight;	
			$jquery("#boxAgihan7").css('width', width).css('height', height).css('top', top).css('left', left);	
			}	  
		...
		/*
		 $jquery("div#boxAgihan7").mousemove(function(e) {
			 $jquery("div#boxAgihan7").css('top', e.pageY).css('left', e.pageX);
			});
		*/	
		
		
		var boxAgihan7 = $jquery("#boxAgihan7")
		boxAgihan7.offset({
			left: left,
			top: top
		});		

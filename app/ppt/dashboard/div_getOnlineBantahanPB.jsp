...
#if($!div_getOnlineBantahanPB_open == "Y")




<div id="log"  style="display:none"></div>
<div id="boxOnlineBantahanPB" >
...
<input type="hidden" id="div_getOnlineBantahanPB_open" name="div_getOnlineBantahanPB_open" value="Y">
...
<td align="right" valign="top"><a href="javascript:gotoSekBantahanPB()" id="trigger">
...
<tr  >
<td valign="top" >
PERMOHONAN ONLINE BANTAHAN (PIHAK BERKEPENTINGAN)
 </td>
</tr>
</table>

<div id="scroll_boxOnlineBantahanPB">
<table border="0" width="100%" > 
 ...
 function carian()
 {
	doDivAjaxCall$formname('div_getOnlineBantahanPB','getOnlineBantahanPB_carian','');	 
 }
 </script>
   ...
   <script type="text/javascript">
      ...
      $jquery(document).ready(function(e) {
		  $jquery('#boxOnlineBantahanPB').show();
		   width  = 500;			
		    left = width+e.pageX;
            top  = height+e.pageY;				
			if(document.getElementById('boxOnlineBantahanPB').clientHeight>250)
			{
		    height = 250;
			//$jquery("#boxOnlineBantahanPB").css('width', width).css('height', height).css('overflow-y','scroll').css('top', top).css('left', left);
			$jquery("#boxOnlineBantahanPB").css('width', width).css('height', height).css('top', top).css('left', left);	
			$jquery("#scroll_boxOnlineBantahanPB").css('width', width).css('height', height-55).css('top', top).css('left', left).css('overflow-y','scroll');	
				
			}
			else
			{
			height = document.getElementById('boxOnlineBantahanPB').clientHeight;	
			$jquery("#boxOnlineBantahanPB").css('width', width).css('height', height).css('top', top).css('left', left);	
			}     
        });	
		
		/*
		 $jquery("div#boxOnlineBantahanPB").mousemove(function(e) {
			 $jquery("div#boxOnlineBantahanPB").css('top', e.pageY).css('left', e.pageX);
			});
		*/	
		
		
		var boxOnlineBantahanPB = $jquery("#boxOnlineBantahanPB")
		boxOnlineBantahanPB.offset({
			left: left,
			top: top
		});		
		var drag = {

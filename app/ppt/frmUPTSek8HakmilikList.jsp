	...
	<table width="100%" border="0">
		<tr align="center">
			<td>
					...
					<input type="button" name="cmdHantar" value="Hantar Untuk Tindakan Pengarah" onClick="javascript:hantar();">
				#end
...
<legend><strong>SENARAI LAPORAN</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
		<tr>
		 <td><a href="#" onClick="javascript:cetakBorangC('$!id_fail','$!total_tanah','$!id_negeriProjek')"><font color="blue">Borang C</font></a></td>
	  	</tr>
 	</table>
</fieldset>	

...
#if($list.HARI_TUNGGU_MMK <= $SS5 && $list.HARI_TUNGGU_MMK > 0)
#set($M1 = $M1 + 1)
#end
#if($list.HARI_TUNGGU_MMK <= $SS6 && $list.HARI_TUNGGU_MMK >= $SST1 && $list.HARI_TUNGGU_MMK > 0)
#set($M2 = $M2 + 1)
#end
#if($list.HARI_TUNGGU_MMK >= $SST2)
#set($M3 = $M3 + 1)
#end
#end
...
#foreach($list in $list_KPI_Penarikan)
#set($B1 = $list.B1)
#set($B2 = $list.B2)
#set($B3 = $list.B3)
#set($B4 = $list.B4)
...
<tr>
  ...
  <tr>
    ...
    <td>PENARIKAN BALIK PENGAMBILAN TANAH</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td valign="top">a)</td>
    <td valign="top">Terima Permohonan dari AP<strong> SEHINGGA</strong> Selesai Laporan Lawatan Tapak yang terlibat dengan Penarikan Balik</td>
  ...
  <tr>
    <td valign="top">b)</td>
    <td valign="top" >Bermula dari Pesediaan Kertas MMK/MB/KM/LC <strong>SEHINGGA</strong> dihantar ke PTG (eTanah)</td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td valign="top">c)</td>
    <td valign="top">Bermula dari Terima Keputusan MMK/MB/KM/LC beserta Warta telah sedia dicetak <strong>SEHINGGA</strong> keluarkan arahan buat siasatan.</td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td valign="top">d)</td>
    <td valign="top" >Siasatan bermula <strong>SEHINGGA</strong> keputusan (Perintah) pampasan dikeluarkan kepada AP</td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
   ...
   <tr>
    <td>a)</td>
    <td>Menunggu keputusan MMK/MB/KM/LC</td>
  ...
  <tr>
    <td>b)</td>
    <td>Menunggu Bayaran Pampasan oleh AP</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
    ...
    <td width="25%">
     ...
     <td width="20%">
       <div align="center">
         <input name="SS7" type="text" id="SS7" size="4" maxlength="5" value="$SS7"  style="text-align:center"   onblur="validateTarikh(this,this.value);tetap();" onkeyup="validateTarikh(this,this.value);tetap();" $readonlymode class = "$disabledmode">    
       </div></td>
     <td width="55%"><strong>
     hari    </strong></td  >
    </tr>    
  ...
  <tr>
    ...
    <td width="25%">
      ...
      <div align="center"><span id="SX3"> </span>
        -
      </div></td>
     <td width="20%">
       <div align="center">
         <input name="SS8" type="text" id="SS8" size="4" maxlength="5" value="$SS8"  style="text-align:center" onblur="validateTarikh(this,this.value);tetap();" onkeyup="validateTarikh(this,this.value);tetap();"  $readonlymode class = "$disabledmode">
          </div></td>
     <td width="55%">
   ...
   <tr>
    ...
    <td width="25%">
     ...
     <td width="20%" align="center">
       <div align="center"><span id="SX4"  > </span> </div></td>
     <td width="55%"><strong>
     hari    </strong></td  >
    </tr>    
    </table>  
...
<tr>
      ...
      <tr>
      <td width="100%"><div align="center"><strong>URUSAN : PENARIKAN BALIK PENGAMBILAN TANAH</strong></div></td>
...
<table width="100%">
  ...
  <tr class="table_headerkpi">
   ...
   <tr >
    <td class="row2">Terima Permohonan dari AP<strong> SEHINGGA</strong> Selesai Laporan Lawatan Tapak yang terlibat dengan Penarikan Balik</td>
    <td class="row2">
    ...
    <td  rowspan="7" colspan="2" valign="top">
     ...
     <td width="60%"><table width="100%">
       <tr>
         ...
         <td width="85%">Bil. Permohonan Penarikan Balik</td>
       </tr>
     </table></td>
     ...
     <td width="60%"><table width="100%">
       <tr>
         ...
         <td width="85%">Bil. Lot Penarikan Balik </td>
       </tr>
     </table></td>
      <td width="40%" > <div align="center"><strong>
      $!LOT_DITERIMA
     ...
     <table width="100%">
       <tr>
         ...
         <td width="85%">Bil. Permohonan Penarikan Balik diselesaikan</td>
       </tr>
     </table>     </td>
     ...
     <table width="100%">
       <tr>
         ...
         <td width="85%">Bil. Lot Penarikan Balik Permohonan diselesaikan</td>
       </tr>
     </table>     </td>
      <td > <div align="center"><strong>
       $!LOT_DISELESAI
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu keputusan MMK/MB/KM/LC</td>
       </tr>
     </table>        </td>
     </tr>
     <tr>
     <td width="60%"><div align="right">&lt; $SS5 hari
      ...
      <td bgcolor="#33FF99" width="40%" >
        ...
        <div align="center">
        <a style="cursor:pointer" onClick="popup('1','$SS5','0','A','Menunggu keputusan MMK/MB/KM/LC < $SS5 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M1</font></strong></a>           
     ...
     $SST1 - $SS6 hari
      ...
      <td bgcolor="yellow" >
       <div align="center">
         <a style="cursor:pointer" onClick="popup('1','$SST1','$SS6','B','Menunggu keputusan MMK/MB/KM/LC $SST1 - $SS6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M2</font></strong></a>      
     ...
     <td><div align="right">&gt; $SST2 hari
      ...
      <td  bgcolor="red"> <div align="center">
         <a style="cursor:pointer" onClick="popup('1','$SST2','0','C','Menunggu keputusan MMK/MB/KM/LC > $SST2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M3</font></strong></a> 
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Bayaran Pampasan oleh AP</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SS7
       
       hari</div></td>
      <td  bgcolor="#33FF99" width="40%" > <div align="center">
       <a style="cursor:pointer" onClick="popup('2','$SS7','0','A','Menunggu Bayaran Pampasan oleh AP < $SS7 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N1</font></strong></a> 
       
        <input name="N1" type="hidden" id="N1" size="5" maxlength="5" value="$N1" >
        </div>  </td>
     </tr>
      <tr>
     <td><div align="right">$SST3 - $SS8 hari
       
     </div></td>
      <td bgcolor="yellow" >
      <div align="center">
         <a style="cursor:pointer" onClick="popup('2','$SST3','$SS8','B','Menunggu Bayaran Pampasan oleh AP $SST3 - $SS8 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST4 hari
      ...
      <td bgcolor="red" >
      <div align="center">
      <a style="cursor:pointer" onClick="popup('2','$SST4','0','C','Menunggu Bayaran Pampasan oleh AP > $SST4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N3</font></strong></a> 
   ...
   <tr>
    <td class="row2">Bermula dari Pesediaan Kertas MMK/MB/KM/LC <strong>SEHINGGA</strong> dihantar ke PTG (eTanah)</td>
    <td class="row2"><div align="center">
      <strong>$SS2</strong>
   ...
   <tr>
    <td colspan="6">Menunggu Keputusan MMK/MB/KM/LC</td>
  </tr>
   <tr>
    <td class="row2">Bermula dari Terima Keputusan MMK/MB/KM/LC beserta Warta telah sedia dicetak <strong>SEHINGGA</strong> keluarkan arahan buat siasatan.</td>
    <td class="row2"><div align="center">
      <strong>$SS3</strong>
    ...
    <td class="row2">
    <input name="E3T" type="hidden" id="E3T" >
    <div align="center" id="E3">
         
     </div></td>
    <td class="row2">
    <input name="F3T" type="hidden" id="F3T" >
    <div align="center" id="F3">
          
     </div></td>
  </tr>
   <tr>
    <td class="row2">Siasatan bermula <strong>SEHINGGA</strong> keputusan (Perintah) pampasan dikeluarkan kepada AP</td>
    <td class="row2"><div align="center">
      <strong>$SS4</strong>
    ...
    <td class="row2">
    <input name="E4T" type="hidden" id="E4T" >
    <div align="center" id="E4">
        
     </div></td>
    <td class="row2">
    <input name="F4T" type="hidden" id="F4T" >
    <div align="center" id="F4">
         
     </div></td>
  </tr> <tr>
    <td colspan="6">Menunggu Bayaran Pampasan oleh AP</td>

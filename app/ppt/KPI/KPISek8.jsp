...
#if($list.HARI_TUNGGU_JPPH <= $SX1 && $list.HARI_TUNGGU_JPPH > 0)
#set($M1 = $M1 + 1)
#end
#if($list.HARI_TUNGGU_JPPH <= $SX2 && $list.HARI_TUNGGU_JPPH >= $SST1 && $list.HARI_TUNGGU_JPPH > 0)
#set($M2 = $M2 + 1)
#end
#if($list.HARI_TUNGGU_JPPH >= $SST2)
#set($M3 = $M3 + 1)
#end
#end
...
#if($list.HARI_TUNGGU_JT <= $SX3 && $list.HARI_TUNGGU_JT > 0)
#set($N1 = $N1 + 1)
#end
#if($list.HARI_TUNGGU_JT <= $SX4 && $list.HARI_TUNGGU_JT >= $SST3 && $list.HARI_TUNGGU_JT > 0)
#set($N2 = $N2 + 1)
#end
#if($list.HARI_TUNGGU_JT >= $SST4)
#set($N3 = $N3 + 1)
#end
#end
...
#if($list.HARI_TUNGGU_PBN <= $SX5 && $list.HARI_TUNGGU_PBN > 0)
#set($O1 = $O1 + 1)
#end
#if($list.HARI_TUNGGU_PBN <= $SX6 && $list.HARI_TUNGGU_PBN >= $SST5 && $list.HARI_TUNGGU_PBN > 0)
#set($O2 = $O2 + 1)
#end
#if($list.HARI_TUNGGU_PBN >= $SST6)
#set($O3 = $O3 + 1)
#end
#end
...
#if($list.HARI_TUNGGU_DHDK <= $SX7 && $list.HARI_TUNGGU_DHDK > 0)
#set($P1 = $P1 + 1)
#end
#if($list.HARI_TUNGGU_DHDK <= $SX8 && $list.HARI_TUNGGU_DHDK >= $SST7 && $list.HARI_TUNGGU_DHDK > 0)
#set($P2 = $P2 + 1)
#end
#if($list.HARI_TUNGGU_DHDK >= $SST8)
#set($P3 = $P3 + 1)
#end
#end
...
#if($list.HARI_TUNGGU_BAYARAN <= $SX9 && $list.HARI_TUNGGU_BAYARAN > 0)
#set($Q1 = $Q1 + 1)
#end
#if($list.HARI_TUNGGU_BAYARAN <= $SX10 && $list.HARI_TUNGGU_BAYARAN >= $SST9 && $list.HARI_TUNGGU_BAYARAN > 0)
#set($Q2 = $Q2 + 1)
#end
#if($list.HARI_TUNGGU_BAYARAN >= $SST10)
#set($Q3 = $Q3 + 1)
#end
#end
...
#if($list.HARI_TUNGGU_BORANGK <= $SX11 && $list.HARI_TUNGGU_BORANGK > 0)
#set($R1 = $R1 + 1)
#end
#if($list.HARI_TUNGGU_BORANGK <= $SX12 && $list.HARI_TUNGGU_BORANGK >= $SST11 && $list.HARI_TUNGGU_BORANGK > 0)
#set($R2 = $R2 + 1)
#end
#if($list.HARI_TUNGGU_BORANGK >= $SST12)
#set($R3 = $R3 + 1)
#end
#end
...
#foreach($list in $list_KPI_Seksyen8)
#set($B1 = $list.B1)
#set($B2 = $list.B2)
#set($B3 = $list.B3)
#set($B4 = $list.B4)
...
<tr>
  ...
  <tr>
    ...
    <td>PENGAMBILAN TANAH SEKSYEN 8</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td valign="top">a)</td>
    <td >Bermula  dari UPT daftar permohonan <strong>SEHINGGA</strong> selesai Laporan Awal Tanah serta selesai menyediakan surat memohon  laporan/ulasan dari JPPH dan JPBD.</td>
  ...
  <tr>
    <td valign="top">b)</td>
    <td >Bermula  dari penyediaan Laporan Terperinci Tanah dan Bangunan <strong>SEHINGGA</strong> selesai Laporan Terperinci Tanah &amp; Bangunan serta  lengkap menyediakan surat memohon laporan/ulasan Jabatan Teknikal (pilihan).</td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td valign="top">c)</td>
    <td >Bermula  dari penyediaan Kertas MMK <strong>SEHINGGA</strong> selesai dan bersedia untuk dihantar ke PTG.</td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td valign="top">d)</td>
    <td ><p>Bermula dari terima Keputusan Rasmi PBN <strong>SEHINGGA</strong> lengkap dengan Penwartaan dan selesai menyediakan  permohonan endosan DHDK dari PTG/PTD.</p></td>
    <td valign="top"><div align="center"><strong>:</strong></div></td>
  ...
  <tr>
    <td>e)</td>
    <td >Bermula  dari siasatan <strong>SEHINGGA </strong>selesai Perintah  Pampasan dikeluarkan.</td>
    <td><div align="center"><strong>:</strong></div></td>
    <td valign="top"><input name="SS5" type="text" id="SS5" size="5" maxlength="5" value="$SS5"  style="text-align:center" onBlur="validateTarikh(this,this.value);" onKeyUp="validateTarikh(this,this.value);"  $readonlymode class = "$disabledmode" ></td>
  </tr>
  
  <tr>
    <td>f)</td>
    <td ><p>Bermula dari terima Perintah Pampasan <strong>SEHINGGA</strong> selesai penyediaan Borang G dan H</p></td>
    <td><div align="center"><strong>:</strong></div></td>
   <td valign="top"><input name="SS6" type="text" id="SS6" size="5" maxlength="5" value="$SS6"  style="text-align:center" onBlur="validateTarikh(this,this.value);" onKeyUp="validateTarikh(this,this.value);"  $readonlymode class = "$disabledmode" ></td>
  </tr>
  
  <tr>
    <td>g)</td>
    <td ><p>Bermula dari penyediaan Borang K dan L <strong>SEHINGGA</strong> bersedia untuk dihantar buat Endosan.</p></td>
    <td><div align="center"><strong>:</strong></div></td>
      <td valign="top"><input name="SS7" type="text" id="SS7" size="5" maxlength="5" value="$SS7"  style="text-align:center" onBlur="validateTarikh(this,this.value);" onKeyUp="validateTarikh(this,this.value);"  $readonlymode class = "$disabledmode" ></td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td>a)</td>
    <td>Menunggu Laporan JPPH dan JPBD</td>
  ...
  <tr>
    <td>b)</td>
    <td>Menunggu Laporan/Ulasan Jabatan Teknikal (pilihan)</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
  ...
  <tr>
    ...
    <td width="25%">
     ...
     <td width="20%">
       <div align="center">
         <input name="SX5" type="text" id="SX5" size="4" maxlength="5" value="$SX5"  style="text-align:center"  onblur="validateTarikh(this,this.value);tetap();" onKeyUp="validateTarikh(this,this.value);tetap();" $readonlymode class = "$disabledmode"  >    
       </div></td>
     <td width="55%"><strong>
     hari    </strong></td  >
    </tr>    
  ...
  <tr>
    ...
    <td width="25%">
      ...
      <div align="center"><span id="SST5"> </span>
        -      </div></td>
     <td width="20%">
       <div align="center">
         <input name="SX6" type="text" id="SX6" size="4" maxlength="5" value="$SX6"  style="text-align:center"  onblur="validateTarikh(this,this.value);tetap();" onKeyUp="validateTarikh(this,this.value);tetap();" $readonlymode class = "$disabledmode" >    
       </div></td>
     <td width="55%"><strong>
     hari
     </strong></td  >
   ...
   <tr>
    ...
    <td width="25%">
     ...
     <td width="20%">
       <div align="center"><span id="SST6"  > </span> </div></td>
     <td width="55%"><strong>
     hari    </strong></td  >
    </tr>    
    </table>     </td>
  ...
  <tr>
    <td>d)</td>
    <td>Menunggu Endorsan DHDK PTG/PTD dan Menunggu selesai  penandaan PTG/PTD</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
    ...
    <td width="25%">
     ...
     <td width="20%">
       <div align="center">
         <input name="SX7" type="text" id="SX7" size="4" maxlength="5" value="$SX7"  style="text-align:center"  onblur="validateTarikh(this,this.value);tetap();" onKeyUp="validateTarikh(this,this.value);tetap();" $readonlymode class = "$disabledmode"  >    
       </div></td>
     <td width="55%"><strong>
     hari    </strong></td  >
    </tr>    
  ...
  <tr>
    ...
    <td width="25%">
      ...
      <div align="center"><span id="SST7"> </span>
        -      </div></td>
     <td width="20%">
       <div align="center">
         <input name="SX8" type="text" id="SX8" size="4" maxlength="5" value="$SX8"  style="text-align:center"  onblur="validateTarikh(this,this.value);tetap();" onKeyUp="validateTarikh(this,this.value);tetap();" $readonlymode class = "$disabledmode" >    
       </div></td>
     <td width="55%"><strong>
     hari
     </strong></td  >
   ...
   <tr>
    ...
    <td width="25%">
     ...
     <td width="20%">
       <div align="center"><span id="SST8"  > </span> </div></td>
     <td width="55%"><strong>
     hari    </strong></td  >
    </tr>    
    </table>     </td>
  ...
  <tr>
    <td>e)</td>
    <td>Menunggu bayaran  pampasan daripada AP</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
    ...
    <td width="25%">
     ...
     <td width="20%">
       <div align="center">
         <input name="SX9" type="text" id="SX9" size="4" maxlength="5" value="$SX9"  style="text-align:center"  onblur="validateTarikh(this,this.value);tetap();" onKeyUp="validateTarikh(this,this.value);tetap();" $readonlymode class = "$disabledmode"  >    
       </div></td>
     <td width="55%"><strong>
     hari    </strong></td  >
    </tr>    
  ...
  <tr>
    ...
    <td width="25%">
      ...
      <div align="center"><span id="SST9"> </span>
        -      </div></td>
     <td width="20%">
       <div align="center">
         <input name="SX10" type="text" id="SX10" size="4" maxlength="5" value="$SX10"  style="text-align:center"  onblur="validateTarikh(this,this.value);tetap();" onKeyUp="validateTarikh(this,this.value);tetap();" $readonlymode class = "$disabledmode" >    
       </div></td>
     <td width="55%"><strong>
     hari
     </strong></td  >
   ...
   <tr>
    ...
    <td width="25%">
     ...
     <td width="20%">
       <div align="center"><span id="SST10"  > </span> </div></td>
     <td width="55%"><strong>
     hari    </strong></td  >
    </tr>    
    </table>     </td>
  ...
  <tr>
    <td>f)</td>
    <td>Menunggu Endorsan Borang K</td>
    <td bgcolor="#33FF99"><div align="center"><strong>:</strong></div></td>
    <td >  
    ...
    <td width="25%">
     ...
     <td width="20%">
       <div align="center">
         <input name="SX11" type="text" id="SX11" size="4" maxlength="5" value="$SX11"  style="text-align:center"  onblur="validateTarikh(this,this.value);tetap();" onKeyUp="validateTarikh(this,this.value);tetap();" $readonlymode class = "$disabledmode"  >    
       </div></td>
     <td width="55%"><strong>
     hari    </strong></td  >
    </tr>    
  ...
  <tr>
    ...
    <td width="25%">
      ...
      <div align="center"><span id="SST11"> </span>
        -      </div></td>
     <td width="20%">
       <div align="center">
         <input name="SX12" type="text" id="SX12" size="4" maxlength="5" value="$SX12"  style="text-align:center"  onblur="validateTarikh(this,this.value);tetap();" onKeyUp="validateTarikh(this,this.value);tetap();" $readonlymode class = "$disabledmode" >    
       </div></td>
     <td width="55%"><strong>
     hari
     </strong></td  >
   ...
   <tr>
    ...
    <td width="25%">
     ...
     <td width="20%">
       <div align="center"><span id="SST12"  > </span> </div></td>
     <td width="55%"><strong>
     hari    </strong></td  >
    </tr>    
    </table>     </td>
...
<tr>
      ...
      <tr>
      <td width="100%"><div align="center"><strong>URUSAN : PENGAMBILAN TANAH SEKSYEN 8</strong></div></td>
...
<table width="100%">
  ...
  <tr class="table_headerkpi">
   ...
   <tr >
    <td class="row2"><p>Bermula dari UPT daftar permohonan <strong>SEHINGGA</strong> selesai Laporan Awal Tanah  serta selesai menyediakan surat memohon laporan/ulasan dari JPPH dan JPBD.</p></td>
  <td class="row2">
    ...
    <table width="100%" class="table_headerkpi">
     ...
     <td width="60%"><table width="100%">
       <tr>
         ...
         <td width="85%">Bil. Lot </td>
       </tr>
     </table></td>
      <td width="40%" > <div align="center"><strong>
      $!LOT_DITERIMA
            <input name="LOT_DITERIMA" type="hidden" id="LOT_DITERIMA" size="5" maxlength="5" value="$LOT_DITERIMA">
        </strong></div></td>
     </tr>
     <tr class="row2">
     <td>
     ...
     <table width="100%">
       <tr>
         ...
         <td width="85%">Bil. Lot  diselesaikan</td>
       </tr>
     </table>     </td>
      <td > <div align="center"><strong>
       $!LOT_DISELESAI
             <input name="LOT_DISELESAI" type="hidden" id="LOT_DISELESAI" size="5" maxlength="5" value="$LOT_DISELESAI">
      </strong></div>   </td>
     </tr>
     <tr class="row2">
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Laporan JPPH dan JPBD</td>
       </tr>
     </table>        </td>
     </tr>
     <tr>
     <td width="60%"><div align="right">&lt; $SX1 hari
      ...
      <td bgcolor="#33FF99" width="40%" >
        ...
        <div align="center">
         ...
         <a style="cursor:pointer" onClick="popup('4','$SX1','0','A','Menunggu Laporan JPPH dan JPBD < $SX1 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M1</font></strong></a>    
     ...
     $SST1 - $SX2 hari
      ...
      <td bgcolor="yellow" >
       ...
       <a style="cursor:pointer" onClick="popup('4','$SST1','$SX2','B','Menunggu Laporan JPPH dan JPBD $SST1 - $SX2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST2 hari
      ...
      <td  bgcolor="red"> <div align="center">
        <a style="cursor:pointer" onClick="popup('4','$SST2','0','C','Menunggu Laporan JPPH dan JPBD > $SST2 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$M3</font></strong></a> 
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Laporan/Ulasan Jabatan Teknikal (pilihan)</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX3
      ...
      <td  bgcolor="#33FF99" width="40%" > <div align="center">
          ...
          <a style="cursor:pointer" onClick="popup('5','$SX3','0','A','Menunggu Laporan/Ulasan Jabatan Teknikal (pilihan) < $SX3 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N1</font></strong></a>
     ...
     <td><div align="right">$SST3 - $SX4 hari
      ...
      <div align="center">
       ...
       <a style="cursor:pointer" onClick="popup('5','$SST3','$SX4','B','Menunggu Laporan/Ulasan Jabatan Teknikal (pilihan) $SST3 - $SX4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N2</font></strong></a> 
     ...
     <td><div align="right">&gt; $SST4 hari
      ...
      <td bgcolor="red" >
      <div align="center">
       <a style="cursor:pointer" onClick="popup('5','$SST4','0','C','Menunggu Laporan/Ulasan Jabatan Teknikal (pilihan) > $SST4 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$N3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Keputusan PBN</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt;       $SX5 hari</div></td>
      <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
        <a style="cursor:pointer" onClick="popup('6','$SX5','0','A','Menunggu Keputusan PBN < $SX5 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O1</font></strong></a>
        <input name="O1" type="hidden" id="O1" size="5" maxlength="5" value="$O1" >
        </div>      </td>
     </tr>
      <tr>
     <td><div align="right"> $SST5 - $SX6 hari
       
     </div></td>
      <td bgcolor="yellow" >
       <div align="center">
          <a style="cursor:pointer" onClick="popup('6','$SST5','$SX6','B','Menunggu Keputusan PBN $SST5 - $SX6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O2</font></strong></a> 
        <input name="O2" type="hidden" id="O2" size="5" maxlength="5" value="$O2" >
        </div>      </td>
     </tr>
      <tr>
     <td><div align="right">&gt; $SST6  hari
       
     </div></td>
      <td bgcolor="red" >
      
       <div align="center">
        <a style="cursor:pointer" onClick="popup('6','$SST6','0','C','Menunggu Keputusan PBN > $SST6 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$O3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Endorsan DHDK PTG</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX7       hari</div></td>
       <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
       <a style="cursor:pointer" onClick="popup('7','$SX7','0','A','Menunggu Endorsan DHDK PTG/PTD dan Menunggu selesai  penandaan PTG/PTD < $SX7 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$P1</font></strong></a>
        <input name="P1" type="hidden" id="P1" size="5" maxlength="5" value="$P1" >
        </div>      </td>
     </tr>
      <tr>
     <td><div align="right"> $SST7 - $SX8 hari
       
     </div></td>
      <td bgcolor="yellow" >
       <div align="center">
        <a style="cursor:pointer" onClick="popup('7','$SST7','$SX8','B','Menunggu Endorsan DHDK PTG/PTD dan Menunggu selesai  penandaan PTG/PTD $SST7 - $SX8 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$P2</font></strong></a> 
        <input name="P2" type="hidden" id="P2" size="5" maxlength="5" value="$P2" >
        </div>      </td>
     </tr>
      <tr>
     <td><div align="right">&gt; $SST8  hari
       
     </div></td>
      <td bgcolor="red" >
      
       <div align="center">
         <a style="cursor:pointer" onClick="popup('7','$SST8','0','C','Menunggu Endorsan DHDK PTG/PTD dan Menunggu selesai  penandaan PTG/PTD > $SST8 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$P3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu bayaran  pampasan daripada AP </td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX9       hari</div></td>
       <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
         <a style="cursor:pointer" onClick="popup('8','$SX9','0','A','Menunggu bayaran  pampasan daripada AP < $SX9 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$Q1</font></strong></a>
        <input name="Q1" type="hidden" id="Q1" size="5" maxlength="5" value="$Q1" >
        </div>      </td>
     </tr>
      <tr>
     <td><div align="right"> $SST9 - $SX10 hari
       
     </div></td>
      <td bgcolor="yellow" >
       <div align="center">
        <a style="cursor:pointer" onClick="popup('8','$SST9','$SX10','B','Menunggu bayaran  pampasan daripada AP $SST9 - $SX10 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$Q2</font></strong></a> 
        <input name="Q2" type="hidden" id="Q2" size="5" maxlength="5" value="$Q2" >
        </div>      </td>
     </tr>
      <tr>
     <td><div align="right">&gt; $SST10  hari
       
     </div></td>
      <td bgcolor="red" >
      
       <div align="center">
        <a style="cursor:pointer" onClick="popup('8','$SST10','0','C','Menunggu bayaran  pampasan daripada AP > $SST10 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$Q3</font></strong></a>
     ...
     <td colspan="2"><table width="100%">
       <tr>
         ...
         <td width="85%">Menunggu Endorsan Borang K</td>
       </tr>
     </table>       </td>
     </tr>
      <tr>
     <td width="60%"><div align="right">&lt; $SX11       hari</div></td>
       <td  bgcolor="#33FF99" width="40%" >
      <div align="center">
         <a style="cursor:pointer" onClick="popup('9','$SX11','0','A','Menunggu Endorsan Borang K < $SX11 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$R1</font></strong></a>
        <input name="R1" type="hidden" id="R1" size="5" maxlength="5" value="$R1" >
        </div>      </td>
     </tr>
      <tr>
     <td><div align="right"> $SST11 - $SX12 hari
       
     </div></td>
      <td bgcolor="yellow" >
       <div align="center">
         <a style="cursor:pointer" onClick="popup('9','$SST11','$SX12','B','Menunggu Endorsan Borang K $SST11 - $SX12 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$R2</font></strong></a> 
        <input name="R2" type="hidden" id="R2" size="5" maxlength="5" value="$R2" >
        </div>      </td>
     </tr>
      <tr>
     <td><div align="right">&gt; $SST12  hari
       
     </div></td>
      <td bgcolor="red" >
      
       <div align="center">
        <a style="cursor:pointer" onClick="popup('9','$SST12','0','C','Menunggu Endorsan Borang K > $SST12 hari');" title="Klik untuk paparan NO FAIL"> <strong ><font color="#000000">$R3</font></strong></a>
 ...
 <tr>
      <td colspan="6">Menunggu Laporan JPPH dan JPBD</td>
  </tr>
  
  <tr>
    <td class="row2">Bermula  dari penyediaan Laporan Terperinci Tanah dan Bangunan <strong>SEHINGGA</strong> selesai Laporan Terperinci Tanah &amp; Bangunan serta  lengkap menyediakan surat memohon laporan/ulasan Jabatan Teknikal (pilihan).</td>
    <td class="row2"><div align="center">
      <strong>$SS2</strong>
  ...
  <tr>
     <td colspan="6">Menunggu Laporan/Ulasan Jabatan Teknikal (pilihan)</td>
  </tr>
   <tr>
    <td class="row2"><p>Bermula dari penyediaan Kertas MMK <strong>SEHINGGA</strong> selesai dan bersedia untuk  dihantar ke PTG.</p></td>
    <td class="row2"><div align="center">
      <strong>$SS3</strong>
  ...
  <tr> 
   <td colspan="6">Menunggu Keputusan PBN</td>
  </tr>
  
   <tr>
    <td class="row2"><p>Bermula dari terima Keputusan Rasmi PBN <strong>SEHINGGA</strong> lengkap dengan Penwartaan dan selesai menyediakan  permohonan endosan DHDK dari PTG/PTD.</p></td>
    <td class="row2"><div align="center">
      <strong>$SS4</strong>
  ...
  <tr>
     <td colspan="6">Menunggu Endorsan DHDK PTG</td>
  </tr>
    <tr>
    <td class="row2">Bermula  dari siasatan <strong>SEHINGGA </strong>selesai Perintah  Pampasan dikeluarkan.</td>
    <td class="row2"><div align="center">
      <strong>$SS5</strong>
      <input name="B5" type="hidden" id="B5" size="5" maxlength="5" value="$SS5" style="text-align:center" onKeyUp="A5()">
    </div></td>
    <td class="row2"><div align="center">
        <strong>$C5</strong>
    ...
    <input name="E5T" type="hidden" id="E5T" size="5" maxlength="5" >
    <div align="center" id="E5">
     
        
     </div></td>
    <td class="row2">
     <input name="F5T" type="hidden" id="F5T" size="5" maxlength="5" >
    <div align="center" id="F5">
         
     </div></td>
    </tr>
    
    <tr>
    <td class="row2">Bermula  dari terima Perintah Pampasan <strong>SEHINGGA</strong> selesai penyediaan Borang G dan H</td>
     <td class="row2"><div align="center">
      <strong>$SS6</strong>
      <input name="B6" type="hidden" id="B6" size="5" maxlength="5" value="$SS6" style="text-align:center" onKeyUp="A6()">
    </div></td>
    <td class="row2"><div align="center">
        <strong>$C6</strong>
    ...
    <td class="row2">
    <input name="E6T" type="hidden" id="E6T" size="5" maxlength="5" >
    <div align="center" id="E6">
        
     </div></td>
    <td class="row2">
    
    <input name="F6T" type="hidden" id="F6T" size="5" maxlength="5" >
    <div align="center" id="F6">
         
     </div></td>
    </tr>
  
  <tr>  
    <td colspan="6">Menunggu bayaran pampasan daripada AP</td>
  </tr>
    <tr>
    <td class="row2">Bermula  dari penyediaan Borang K dan L <strong>SEHINGGA</strong> bersedia untuk dihantar buat Endosan.</td>
    <td class="row2"><div align="center">
      <strong>$SS7</strong>
      <input name="B7" type="hidden" id="B7" size="5" maxlength="5" value="$SS7" style="text-align:center" onKeyUp="A7()">
    </div></td>
    <td class="row2"><div align="center">
        <strong>$C7</strong>
    ...
    <td class="row2">
      <input name="E7T" type="hidden" id="E7T" size="5" maxlength="5" >
    <div align="center" id="E7">
        
     </div></td>
    <td class="row2">
     <input name="F7T" type="hidden" id="F7T" size="5" maxlength="5" >
    <div align="center" id="F7">
         
     </div></td>
    </tr>
    <tr>
    <td colspan="6">Menunggu Endorsan Borang K</td>
  </tr>

...
#foreach($list in $list_KPI_Bantahan_byNegeri)
...
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <=  $Perlis2 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "9")
#set($C1 = $C1 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Perlis4 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Perlis7 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "9")
#set($D1 = $D1 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Perlis8 && $list.ID_NEGERI == "9")
#set($E1 = $E1 + 1)
#end
#end
...
#foreach($list in $list_KPI_Menunggu_Bantahan_Perintah)
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Kedah2 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "2")
#set($C2 = $C2 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Kedah4 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Kedah7 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "2")
#set($D2 = $D2 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Kedah8 && $list.ID_NEGERI == "2")
#set($E2 = $E2 + 1)
#end
#end
...
#foreach($list in $list_KPI_Menunggu_Bantahan_Perintah)
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Penang2 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "7")
#set($C3 = $C3 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Penang4 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Penang7 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "7")
#set($D3 = $D3 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Penang8 && $list.ID_NEGERI == "7")
#set($E3 = $E3 + 1)
#end
#end
...
#foreach($list in $list_KPI_Menunggu_Bantahan_Perintah)
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Perak2 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "8")
#set($C4 = $C4 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Perak3 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Perak7 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "8")
#set($D4 = $D4 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Perak8 && $list.ID_NEGERI == "8")
#set($E4 = $E4 + 1)
#end
#end
...
#foreach($list in $list_KPI_Menunggu_Bantahan_Perintah)
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Kelantan2 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "3")
#set($C5 = $C5 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Kelantan4 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Kelantan7 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "3")
#set($D5 = $D5 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Kelantan8 && $list.ID_NEGERI == "3")
#set($E5 = $E5 + 1)
#end
#end
...
#foreach($list in $list_KPI_Menunggu_Bantahan_Perintah)
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Ganu2 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "11")
#set($C6 = $C6 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Ganu4 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Ganu7 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "11")
#set($D6 = $D6 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Ganu8 && $list.ID_NEGERI == "11")
#set($E6 = $E6 + 1)
#end
#end
...
#foreach($list in $list_KPI_Menunggu_Bantahan_Perintah)
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Pahang2 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "6")
#set($C7 = $C7 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Pahang4 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Pahang7 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "6")
#set($D7 = $D7 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Pahang8 && $list.ID_NEGERI == "6")
#set($E7 = $E7 + 1)
#end
#end
...
#foreach($list in $list_KPI_Menunggu_Bantahan_Perintah)
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Selangor2 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "10")
#set($C8 = $C8 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Selangor4 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Selangor7 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "10")
#set($D8 = $D8 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Selangor8 && $list.ID_NEGERI == "10")
#set($E8 = $E8 + 1)
#end
#end
...
#foreach($list in $list_KPI_Menunggu_Bantahan_Perintah)
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $KL2 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "14")
#set($C9 = $C9 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $KL4 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $KL7 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "14")
#set($D9 = $D9 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $KL8 && $list.ID_NEGERI == "14")
#set($E9 = $E9 + 1)
#end
#end
...
#foreach($list in $list_KPI_Menunggu_Bantahan_Perintah)
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $N92 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "5")
#set($C10 = $C10 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $N94 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $N97 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "5")
#set($D10 = $D10 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $N98 && $list.ID_NEGERI == "5")
#set($E10 = $E10 + 1)
#end
#end
...
#foreach($list in $list_KPI_Menunggu_Bantahan_Perintah)
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Melaka2 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "4")
#set($C11 = $C11 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH <= $Melaka4 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Melaka7 && $list.HARI_TUNGGU_BANTAHAN_PERINTAH > 0 && $list.ID_NEGERI == "4")
#set($D11 = $D11 + 1)
#end
#if($list.HARI_TUNGGU_BANTAHAN_PERINTAH >= $Melaka8 && $list.ID_NEGERI == "4")
#set($E11 = $E11 + 1)
#end
#end
...
<table width="100%" id="table_kpi">
      <tr>
        <td valign="top" width="100%" ><div align="center"><strong>URUSAN 03.05 : RINGKASAN DI PERINGKAT NEGERI BANTAHAN KE MAHKAMAH</strong></div></td>
      </tr>
      <tr>
...
<tr >
    ...
    <td valign="top" width="10%" rowspan="3" colspan="2" class="row2"><div align="center"><strong>Jumlah bil. Permohonan Bantahan diterima</strong></div></td>
    ...
    <td valign="top" colspan="6" rowspan="3"  class="row2" width="30%"><div align="center"><strong>Menunggu Sokongan Agensi Luar</strong></div></td>
       <td valign="top"  colspan="5" class="row2" width="40%"><div align="center"><strong>Jumlah Permohonan Bantahan Telah Di Selesaikan</strong></div></td>
  </tr>
<tr >
      
    
    
    <td valign="top"  width="10%" colspan="2" rowspan="2" class="row2"><div align="center"><strong>Bilangan</strong></div></td>
  ...
  <tr class="row1">
    ...
    <div align="center" class="style2">
     ...
     <div align="center" class="style2" style="display:none" >
        <strong>$B1</strong>
  ...
  #set($Perlis10 = $list.F8+1)  
    ...
    <table width="100%"  >
      <tr>
        <td valign="top"><table width="100%" class="table_headerkpi" >
          <tr>
            <td valign="top" colspan="2" class="row1" ><div align="center" class="style2"><strong>Menunggu Mahkamah Mengeluarkan Perintah</strong></div></td>
          </tr>
          <tr>
    ...
    <td valign="top" colspan="2"  ><div align="center" class="style2">
        <strong>$I1</strong>
        <input name="I1" type="hidden" id="I1" size="5" maxlength="5" value="$I1" >
      </div> <div align="center" class="style2" style="display:none">
        <strong>$J1</strong>
  ...
  <tr class="row2">
    ...
    <td valign="top" colspan="2">
    <div align="center" id="A12" class="style2" >     </div>    <div align="center" id="B12" class="style2" style="display:none" >      
     </div></td>
  ...
  <td colspan="6" >
     ...
     <div align="center" id="H12" class="style2" style="display:none" >      
      ...
      <td valign="top" colspan="2"><div align="center" id="I12" class="style2" >      
     </div><div align="center" id="J12" class="style2"  style="display:none" >      
     </div>
     </td>
     <td valign="top">
     <div align="center" id="X12" class="style2" >      
     </div></td>

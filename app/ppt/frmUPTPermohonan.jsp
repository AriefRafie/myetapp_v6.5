...
#foreach ($senarai in $PermohonanListView )
    ...
    #set($nama_negeri_agensi=$senarai.nama_negeri) 
   ...
   <input name="id_senaraisemak" type="hidden" value="$id_senaraisemak" />  
     ...
     <table width="100%" border="0">
                      <tr>
                        ...
                        <td width="98%">
                        #if($semak1 == '1')
                        <input type="checkbox" name="semak1" value="1" checked disabled>
                        #else
                        <input type="checkbox" name="semak1"  value="1" disabled>
                        #end
                      ...
                      <tr>
                        ...
                        <td>
                        #if($semak2 == '1')
                          <input type="checkbox" name="semak2" value="1" checked disabled>
                        #else
                        <input type="checkbox" name="semak2"  value="1" disabled>
                        #end
                      ...
                      <tr>
                        ...
                        <td>
                        #if($semak3 == '1')
                        <input type="checkbox" name="semak3" value="1" checked disabled>
                        #else
                        <input type="checkbox" name="semak3"  value="1" disabled>
                        #end
                      ...
                      <tr>
                        ...
                        <td>
                        #if($semak4 == '1')
                        <input type="checkbox" name="semak4" value="1" checked disabled>
                        #else
                        <input type="checkbox" name="semak5"  value="1" disabled>
                        #end
                      ...
                      <tr>
                        ...
                        <td>
                        #if($semak5 == '1')
                        <input type="checkbox" name="semak5" value="1" checked disabled>
                        #else
                        <input type="checkbox" name="semak5"  value="1" disabled>
                        #end
                      ...
                      <tr>
                        ...
                        <td>
                        #if($semak6 == '1')
                        <input type="checkbox" name="semak6" value="1" checked disabled>
                        #else
                        <input type="checkbox" name="semak6"  value="1" disabled>
                        #end
                      ...
                      <tr>
                        ...
                        <td>
                        #if($semak7 == '1')
                        <input type="checkbox" name="semak7" value="1" checked disabled>
                        #else
                        <input type="checkbox" name="semak7"  value="1" disabled>
                        #end
  	...
  	<table width="100%" cellpadding="0" cellspacing="0" border="0">
   		<tr>
    		...
    		#if($semak1 == '1')
    		<input type="checkbox" value="1" name="semak10" checked disabled>
      		#else
      		<input type="checkbox" value="1" name="semak10" disabled>
      		#end
      		</td>
      		<td width="3%">1.</td>
  		...
  		<tr>
    		...
    		<td>
    		#if($semak2 == '1')
    		<input type="checkbox" name="semak20" value="1" checked disabled >
      		#else
      		<input type="checkbox" name="semak20" value="1" disabled >
      		#end
      		</td>
      		<td>2.</td>
...
<br/>
          ...
          <legend><strong>Senarai Semakan</strong></legend>   
             <p>         
               ...
               <table width="100%" border="0">
                  ...
                  <tr>
                    ...
                    <input type="checkbox" name="semak4" value="1" checked disabled>
                    #else
                    <input type="checkbox" name="semak4"  value="1" disabled>
                    #end
                      4. Ulasan dari Jabatan Alam Sekitar.</td>
                  </tr>
                  <tr>
   		...
   		<tr>
    		...
    		<td align="justify" width="4%">
    		#if($semak1 == '1')
    		<input type="checkbox" value="1" name="semak1" checked disabled>
      		#else
      		<input type="checkbox" value="1" name="semak1" disabled>
      		#end
      		</td>
      		<td width="3%">1.</td>
      		<td width="80%">Pelan Pengambilan Tanah yang lengkap.</td>
  		...
  		<tr>
    		...
    		<td>
    		#if($semak2 == '1')
    		<input type="checkbox" value="1" name="semak2" checked disabled>
    		#else
    		<input type="checkbox" value="1" name="semak2" disabled>
    		#end
    		</td>
    		<td>2.</td>
      		<td>Pengesahan peruntukan yang mencukupi untuk membiayai kos pampasan 
...
function batal(id_fail,id_permohonan){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.FrmUPTPermohonanSenarai";

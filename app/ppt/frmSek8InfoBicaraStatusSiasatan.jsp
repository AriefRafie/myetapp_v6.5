...
<td colspan="4">
  ...
  <tr>
    ...
    <td width="1%">:</td>
    <td width="70%"><input name="txtNoKes" type="text" id="txtNoKes" value="$txtNoKesX" size="25" maxlength="25"  onBlur="this.value=this.value.toUpperCase();checking_validation(this,'txtNoKes_check','no','no kes','normal')" onKeyUp="this.value=this.value.toUpperCase();checking_validation(this,'txtNoKes_check','no','no kes','normal')"  $readonlymode class = "$disabledmode">
  ...
  <tr>
    ...
    <td>No. Siasatan</td>
    <td>:</td>
    <td><input name="txtNoSiasatan" type="text" id="txtNoSiasatan" value="$txtNoSiasatanX" size="25" maxlength="25"  onBlur="this.value=this.value.toUpperCase();checking_validation(this,'txtNoSiasatan_check','no','no siasatan','normal')" onKeyUp="this.value=this.value.toUpperCase();checking_validation(this,'txtNoSiasatan_check','no','no siasatan','normal')"  $readonlymode class = "$disabledmode">
  ...
  <tr>
    ...
    <td>:</td>
    <td><input name="txtTempatSiasatan" type="text" id="txtTempatSiasatan" value="$txtTempatSiasatanX" size="50" onBlur="this.value=this.value.toUpperCase();checking_validation(this,'txtTempatSiasatan_check','no','tempat siasatan','normal')" onKeyUp="this.value=this.value.toUpperCase();checking_validation(this,'txtTempatSiasatan_check','no','tempat siasatan','normal')"  $readonlymode class = "$disabledmode">
  ...
  <tr>
    ...
    <td>Alamat</td>
    <td>:</td>
    <td><input name="txtAlamat1" type="text" id="txtAlamat1" value="$txtAlamat1X" size="50" onBlur="this.value=this.value.toUpperCase();checking_validation(this,'txtAlamat1_check','no','alamat','normal')" onKeyUp="this.value=this.value.toUpperCase();checking_validation(this,'txtAlamat1_check','no','alamat','normal')"  $readonlymode class = "$disabledmode">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>:</td>
    <td><input name="txtAlamat2" type="text" id="txtAlamat2" value="$txtAlamat2X" size="50" onBlur="this.value=this.value.toUpperCase();" onKeyUp="this.value=this.value.toUpperCase();"  $readonlymode class = "$disabledmode"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>:</td>
    <td><input name="txtAlamat3" type="text" id="txtAlamat3" value="$txtAlamat3X" size="50" onBlur="this.value=this.value.toUpperCase();" onKeyUp="this.value=this.value.toUpperCase();"  $readonlymode class = "$disabledmode"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Poskod</td>
    <td>:</td>
    <td><input name="txtPoskod" type="text" id="txtPoskod" onBlur="this.value=this.value.toUpperCase();checking_validation(this,'txtPoskod_check','no','','poskod');validateTarikh(this,this.value)" onKeyUp="this.value=this.value.toUpperCase();checking_validation(this,'txtPoskod_check','no','','poskod');validateTarikh(this,this.value)" value="$txtPoskodX" size="6" maxlength="5"  $readonlymode class = "$disabledmode">
  ...
  <tr>
   ...
   <tr>
    ...
    <td>
     ...
     <input name="bil_siasatanx" type="text" id="bil_siasatanx" size="10" maxlength="10"   value="$!bil_siasatanX" readonly class='disabled'  />   
     <input name="bil_siasatan" type="hidden" id="bil_siasatan" value="$!bil_siasatanX" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <div align="center" >
      ...
      #if($socStatusSiasatan=="4" || $socStatusSiasatan=="5" || $socStatusSiasatan=="7")
      <label>
...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
      ...
      <tr>
        <td><a href="#" onClick="javascript:cetakSiasatanAPPBUlang('$!id_permohonan','$!id_siasatan','$!id_hakmilik')"><font color="blue">Surat Kepada AP Supaya Hadir Untuk Ulang Siasatan</font></a></td>
      </tr>  
      <tr>
        <td><a href="#" onClick="javascript:cetakSiasatanPBUlang('$!id_permohonan','$!id_siasatan','$!id_hakmilik')"><font color="blue">Surat Kepada PB Supaya Hadir Untuk Ulang Siasatan</font></a></td>
      </tr> 
...
<script type="text/javascript">
 function cetakSiasatanPBUlang(idpermohonan,id_siasatan,id_hakmilik) {

	var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_permohonan="+idpermohonan+"&id_hakmilik="+id_hakmilik+"&report=SuratKpdPBUlangSiasatan&selectNoFail=yes";
...
function cetakSiasatanAPPBUlang(idpermohonan,id_siasatan,id_hakmilik) {

	document.${formName}.command.value = "Siasatan";
	document.${formName}.sub_command.value = "Status_Siasatan";
	document.${formName}.subminor_command.value = "cetakUlang";	
	...
	var url = "../x/${securityToken}/ekptg.report.ppt.FrmPopupPilihPegawaiReportView?id_permohonan="+idpermohonan+"&id_hakmilik="+id_hakmilik+"&report=SuratKpdAPPBUlangSiasatan&selectNoFail=yes";
	var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();

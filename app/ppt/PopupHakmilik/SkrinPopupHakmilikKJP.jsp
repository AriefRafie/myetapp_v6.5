      ...
      ##if($listhakmilik.size()>0)<input type="button" id="salinHakmilik" name="salinHakmilik" value="SALIN MAKLUMAT HAKMILIK" onclick="transferHakmilik()"/>#end
       ...
       <table align="center" width="100%" cellspacing="1" cellpadding="0">
        ...
        <tr class="table_header">
          ...
          <td width="25%"  valign="top"><strong><font color="white">NO. HAKMILIK</font></strong></td>       
          <td width="30%" valign="top"><strong><font color="white">LOT</font></strong></td>    
          <td width="30%"  valign="top"><strong><font color="white">MUKIM</font></strong></td>
          <td width="10%"  valign="top"><strong><font color="white">SALIN HAKMILIK</font></strong></td>
                    ...
                    #set( $rowx = "row1" )
                      ...
                      <td class="$rowx" valign="top"> 
                     	<input type="button" id="salinHakmilik" name="salinHakmilik" value="SALIN HAKMILIK" onclick="transferHakmilik1('$!fail.ID_HAKMILIK')"/>
                      </td>
                      </tr>
                      #end
    ...
    <td><fieldset>
      <legend><b>SENARAI FAIL</b></legend>    
        ...
        <tr class="table_header">
          ...
          <td width="15%" align="center" valign="top"><strong><font color="white">PAPAR HAKMILIK</font></strong></td> 
...
function transferHakmilik() 
 {	
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SkrinPopupHakmilikKJP?&id_negeri="+'$id_negeri'+"&id_daerah="+'$id_daerah'+"&jenis_seksyen="+'$jenis_seksyen';
	document.${formName}.submit();			
				
 }	
 
function transferHakmilik1(id_hakmilik) 
{	
	document.${formName}.id_hakmilik.value = id_hakmilik;
	document.${formName}.command.value = "transferHakmilik";
	document.${formName}.action = "?_portal_module=ekptg.view.ppt.SkrinPopupHakmilikKJP?&id_negeri="+'$id_negeri'+"&id_daerah="+'$id_daerah'+"&jenis_seksyen="+'$jenis_seksyen';
	document.${formName}.submit();			

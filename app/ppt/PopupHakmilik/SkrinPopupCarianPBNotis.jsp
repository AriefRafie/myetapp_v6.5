    ...
    <td valign="top"><fieldset>
      <legend><b>SENARAI PIHAK BERKEPENTINGAN</b></legend>          
        ...
        <table width="100%" border="0">
    			...
    			<td  ><b><font color="white">NAMA PENERIMA</font></b></td>
    			<td  ><b><font color="white">NAMA PENGHANTAR</font></b></td>
                <td  align="center"><b><font color="white">TARIKH SERAHAN / TAMPAL</font></b></td>
                </tr>  
   		...
   		<tr >
    		<td class="$rowx"><center>$list.bil</center></td>
 			<td class="$rowx" id="$list.NO_PB">
              ...
              #if($flag_skrin == "skrin_penerima_H")
              <a href="javascript:viewPenerimaanBorangH('$!list.id_borangh','$flag_skrin');" title="Klik untuk maklumat lengkap pihak berkepentingan"><font color="blue">$list.nama_pb</font></a>
            #else
              
                <a href="javascript:viewPenyampaianNotis('$!list.id_buktipenyampaian','$flag_skrin');" title="Klik untuk maklumat lengkap pihak berkepentingan"><font color="blue">$list.nama_pb</font></a>
            #end
    		...
    		<td class="$rowx">$!list.nama_penerima</td>
            <td class="$rowx">$!list.nama_penghantar</td>
            <td class="$rowx" align="center">$!list.tarikh_hantar</td>
...
function viewPenerimaanBorangH(id_borangH,flag_skrin)
{
	try
	{
		
			window.opener.viewPenerimaanBorangH(id_borangH);
...
function viewPenyampaianNotis(id_buktipenyampaian,flag_skrin)
{
	try
	{
		
			window.opener.viewPenyampaianNotis(id_buktipenyampaian);

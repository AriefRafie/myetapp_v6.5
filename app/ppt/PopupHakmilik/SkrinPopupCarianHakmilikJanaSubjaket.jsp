	...
	<!--	#parse("app/utils/record_pagingPopup.jsp") -->
       ...
       : $flag_subjaket
        -->
            ...
            #if($SenaraiFail.size() > 0 && $flag_subjaket!="1")
                        #if($showSJ=="no")	
                        <input type="button" name="cmdJanaAuto" value="Jana Subjaket (auto)" onClick="javascript:janaSubjaket($!id_permohonan,'$flag_skrin')">
                        <input type="button" name="cmdJanaManual" value="Jana Subjaket (manual)" onClick="javascript:janaSubjaketManual($!id_permohonan,'$flag_skrin')">
                        #else
                        <input type="button" name="cmdSimpan" value="Simpan Subjaket" onClick="javascript:simpanSj('$!id_permohonan','$flag_skrin')">
                        <input type="button" name="cmdBatalJana" value="Batal" onClick="javascript:janaSubjaketManual('$!id_permohonan','$flag_skrin'))">
                        #end
            #end
                        ...
                        #if($showSJ=="no")
                        <input type="button" name="cmdJanaAuto" value="Jana Subjaket (auto)" onClick="javascript:janaSubjaket($!id_permohonan,'$flag_skrin')">
                        <input type="button" name="cmdKemaskini" value="Kemaskini Subjaket" onClick="javascript:janaSubjaketManual('$!id_permohonan','$flag_skrin');">
                        #else
                        <input type="button" name="cmdSimpan" value="Simpan Subjaket" onClick="javascript:simpanSj('$!id_permohonan','$flag_skrin')">
                        <input type="button" name="cmdBatalJana" value="Batal" onClick="javascript:janaSubjaketManual('$!id_permohonan','$flag_skrin')">
                        #end
                    ...
                    #set( $rowx = "row1" )
                      ...
                      <tr>
                       ...
                       $!listTanah.kod_jenis_hakmilik $!listTanah.no_hakmilik
                        ...
                        #if($flag_skrin == "skrin_list_hakmilik_pb_sek8" || $flag_skrin == "skrin_hakmilik_pb_sek8" || $flag_skrin == "skrin_hakmilik_sementara")
                        &nbsp;

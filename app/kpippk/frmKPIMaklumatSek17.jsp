...
<table width="100%" border="0">
  ...
  <tr>
    	<td class="row2"><b>1.</b>$!ProsesPPK1A</td>
     					...
     					<tr>
      					...
      					<tr>
     						<td width="60%" align="right">&lt; $!txtT3 $!lblHari</td>
      						<td bgcolor="#33FF99" width="40%" align="center">
      							<a style="cursor:pointer" onClick="openPopupMenunggu('$!ProsesTungguC &lt; $!txtT3 $!lblHari','$!jumlahTungguBicaraKolateralHijau','kolateral','$!txtT3','$!txtT4','hijau')" title="Klik untuk paparan No Fail"> 
      					...
      					<tr>
     						<td align="right">$!lblT3 - $!txtT4 $!lblHari</td>
      						<td bgcolor="yellow" align="center">
      							<a style="cursor:pointer" onClick="openPopupMenunggu('$!ProsesTungguC $!lblT3 - $!txtT4 $!lblHari','$!jumlahTungguBicaraKolateralKuning','kolateral','$!txtT3','$!txtT4','kuning')" title="Klik untuk paparan No Fail">
				      	...
				      	<tr>
				     		<td align="right">&gt; $!lblT4 $!lblHari</td>
				      		<td bgcolor="red" align="center">
				      			<a style="cursor:pointer" onClick="openPopupMenunggu('$!ProsesTungguC &gt; $!lblT4  $!lblHari','$!jumlahTungguBicaraKolateralMerah','kolateral','$!txtT3','$!txtT4','merah')" title="Klik untuk paparan No Fail">
     					...
     					<tr>
      					...
      					<tr>
     						<td width="60%" align="right">&lt;$!txtT5 $!lblHari</td>
      						<td  bgcolor="#33FF99" width="40%" align="center">
					        	...
					        	<input name="nnnn" type="hidden" id="nnnn" size="5" maxlength="5" value="0" >
					        </td>
    	 				</tr>
      					...
      					<tr>
     						<td align="right">$!lblT5 - $!txtT6 $!lblHari</td>
      						<td bgcolor="yellow" align="center">
      							<b><font color="#000000">0</font></b>
        						<input name="oooo" type="hidden" id="oooo" size="5" maxlength="5" value="0" >
        					</td>
     					</tr>
      					...
      					<tr>
     						<td align="right">&gt; $!lblT6  $!lblHari</td>
      						<td bgcolor="red" align="center">
      							<b><font color="#000000">0</font></b>
        						<input name="pppp" type="hidden" id="pppp" size="5" maxlength="5" value="0" >
             				</td>
     					</tr>
     					...
     					<tr>
      					...
      					<tr>
     						<td width="60%" align="right">&lt; $!txtT7 $!lblHari</td>
      						<td bgcolor="#33FF99" width="40%" align="center"> 
      							<a style="cursor:pointer" onClick="openPopupMenunggu('$!ProsesTungguE &lt; $!txtT7 $!lblHari','$!jumlahTungguMTHijau','mahkamahtinggi','$!txtT7','$!txtT8','hijau')" title="Klik untuk paparan No Fail">
      					...
      					<tr>
     						<td align="right">$!lblT7 - $!txtT8 $!lblHari</td>
      						<td bgcolor="yellow" align="center">
      							<a style="cursor:pointer" onClick="openPopupMenunggu('$!ProsesTungguE $!lblT7 - $!txtT8 $!lblHari','$!jumlahTungguMTKuning','mahkamahtinggi','$!txtT7','$!txtT8','kuning')" title="Klik untuk paparan No Fail">
				      	...
				      	<tr>
				     		<td align="right">&gt; $!lblT8 $!lblHari</td>
				      		<td bgcolor="red" align="center">
				      			<a style="cursor:pointer" onClick="openPopupMenunggu('$!ProsesTungguE &gt; $!lblT8  $!lblHari','$!jumlahTungguMTMerah','mahkamahtinggi','$!txtT7','$!txtT8','merah')" title="Klik untuk paparan No Fail">
     					...
     					<tr>
      					...
      					<tr>
     						<td width="60%" align="right">&lt; $!txtT9 $!lblHari</td>
      						<td  bgcolor="#33FF99" width="40%" align="center">
      							<a style="cursor:pointer" onClick="openPopupMenunggu('$!ProsesTungguF &lt; $!txtT9 $!lblHari','$!jumlahTungguROTSHijau','rots','$!txtT9','$!txtT10','hijau')" title="Klik untuk paparan No Fail">
      					...
      					<tr>
     						<td align="right">$!lblT9 - $!txtT10 $!lblHari</td>
      						<td bgcolor="yellow" align="center">
      							<a style="cursor:pointer" onClick="openPopupMenunggu('$!ProsesTungguF $!lblT9 - $!txtT10 $!lblHari','$!jumlahTungguROTSKuning','rots','$!txtT9','$!txtT10','kuning')" title="Klik untuk paparan No Fail">
      					...
      					<tr>
     						<td align="right">&gt; $!lblT10  $!lblHari</td>
      						<td bgcolor="red" align="center">
      							<a style="cursor:pointer" onClick="openPopupMenunggu('$!ProsesTungguF &gt; $!lblT10 $!lblHari','$!jumlahTungguROTSMerah','rots','$!txtT9','$!txtT10','merah')" title="Klik untuk paparan No Fail">
  ...
  <tr>
    	<td class="row2"><b>3.</b>$!ProsesPPK2</td>
  ...
  <tr>
    	<td class="row2"><b>4.</b>$!ProsesPPK4</td>
    	...
    	#set($efisensi_mohon_bke = ($Utils.parseDouble($!txtF3) / $!Utils.parseDouble($!purata_masa_mohon_bke))*100 )
  ...
  <tr>
    	<td class="row2"><b>5.</b>$!ProsesPPK5</td>
    	...
    	#set($efisensi_borang_q = ($Utils.parseDouble($!txtF4) / $!Utils.parseDouble($!purata_masa_borang_q))*100 )
  ...
  <!-- <tr>
    	<td class="row2"><b>6.</b>$!ProsesPPK6</td>
     	<td class="row2" align="center"><b>$!txtF5</b>
      		<input name="HtxtF5" type="hidden" id="HtxtF5" size="5" maxlength="5" value="$!txtF5">
    	</td>
    	
    	<td class="row2" align="center"><b>bb44</b>
        	<input name="bb44" type="hidden" id="bb44" size="5" maxlength="5" value="bb44">
      	</td>
  ...
  <tr>
   	 	<td class="row2"><b>6.</b>$!ProsesPPK7</td>
    	...
    	#set($efisensi_sedia_notis = ($Utils.parseDouble($!txtF6) / $!Utils.parseDouble($!purata_masa_sedia_notis))*100 )
  ...
  <tr>
   	 	<td class="row2"><b>7.</b>$!ProsesPPK8</td>
    	...
    	#set($efisensi_bicara_pertama = ($Utils.parseDouble($!txtF7) / $!Utils.parseDouble($!purata_masa_bicara_pertama))*100 )
  ...
  <tr>
   	 	<td class="row2"><b>8.</b>$!ProsesPPK9</td>
    	...
    	#set($efisensi_borang_l = ($Utils.parseDouble($!txtF8) / $!Utils.parseDouble($!purata_masa_borang_l))*100 )
  ...
  <tr>
    	<td colspan="6"><b>9.</b>$ProsesTungguC</td>
  </tr>
  
  <tr>
   	 	<td class="row2"><b>10.</b>$!ProsesPPK10</td>
    	...
    	#set($efisensi_borang_n = ($Utils.parseDouble($!txtF9) / $!Utils.parseDouble($!purata_masa_borang_n))*100 )
  ...
  <tr>
    	<td colspan="6"><b>11.</b>$ProsesTungguD</td>
  </tr>
  
  <tr>
   	 	<td class="row2"><b>12.</b>$!ProsesPPK11</td>
    	...
    	#set($efisensi_borang_j_mt = ($Utils.parseDouble($!txtF10) / $!Utils.parseDouble($!purata_masa_borang_j_mt))*100 )
  ...
  <tr>
    	<td colspan="6"><b>13.</b>$ProsesTungguE</td>
  </tr>
  
  <tr>
   	 	<td class="row2"><b>14.</b>$!ProsesPPK12</td>
    	...
    	#set($efisensi_keputusan_mt = ($Utils.parseDouble($!txtF11) / $!Utils.parseDouble($!purata_masa_keputusan_mt))*100 )
  ...
  <tr>
   	 	<td class="row2"><b>15.</b>$!ProsesPPK13</td>
    	...
    	#set($efisensi_borang_j_rots = ($Utils.parseDouble($!txtF12) / $!Utils.parseDouble($!purata_masa_borang_j_rots))*100 )
  ...
  <tr>
    	<td colspan="6"><b>16.</b>$ProsesTungguF</td>
  </tr>
  
  <tr>
   	 	<td class="row2"><b>17.</b>$!ProsesPPK14</td>
    	...
    	#set($efisensi_keputusan_rots = ($Utils.parseDouble($!txtF13) / $!Utils.parseDouble($!purata_masa_keputusan_rots))*100 )
  ...
  <tr>
   	 	<td class="row2"><b>18.</b>$!ProsesPPK15</td>
    	...
    	#set($efisensi_sedia_perintah = ($Utils.parseDouble($!txtF14) / $!Utils.parseDouble($!purata_masa_sedia_perintah))*100 )

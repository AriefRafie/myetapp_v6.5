...
<fieldset>
  ...
  <table width="100%" border="0">
    <tr>
      ...
      <td width="62%">$selectTahunDari
        <input type="hidden" name="id_tahunDari" id="id_tahunDari" value="$!id_tahunDari"></td>
    </tr>
    <tr>
      <td width="24%">&nbsp;</td>
      <td width="6%">&nbsp;</td>
...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div class="TabbedPanelsContentGroup"> 
    ...
    <div class="TabbedPanelsContent">
          ...
          <table width="100%" cellpadding="1" cellspacing="2" border="0">
            <tr class="table_header">
              ...
              <td width="17%" style="text-transform: uppercase"><div
								align="center">Jumlah Keluasan Kawasan Tanah Rizab Melayu</div></td>
            </tr>
            #set($setLuas=0)
            #set ($jumlah = 0) 
            #if($list_size!=0) 
                ...
                #foreach($senarai in $PermohonanList) 
                    ##set($setLuas=$senarai.LUAS)
                    #set ($jumlah = $jumlah + $senarai.LUAS)
                    #set( $i = $velocityCount ) 
                    #if ( ($i % 2) != 1 ) 
                    	#set( $row = "row2" ) 					  				
                    #else
                ...
                <tr valign="top">
                  ...
                  <td class="$row"><div align="center">$senarai.LUAS</div></td>
                </tr>
            	#end
      ...
      <!--<table width="100%" cellpadding="1" cellspacing="2" border="0">
				<tr>
					...
					<td width="20%"><input type="button" name="cmdCetak" id="cmdCetak" value="Cetak Laporan" onclick="cetakLaporan()" />
					</td>
				</tr>
			</table>--> 
    ...
    <div class="TabbedPanelsContent"> #if ($selectedTab=="1")
      <object width="1330" height="600" id="Column3D">
        <param name="movie" value="../FusionCharts/Column3D.swf" />
        <param name="FlashVars"
					value="&dataXML=$xml&chartWidth=1330&chartHeight=600">
        <param name="quality" value="high" />
        <embed src="../fusioncharts/Charts/Column3D.swf"
					flashVars="&dataXML=$xml&chartWidth=1330&chartHeight=600"
					quality="high" width="1330" height="600" name="Column3D"
      ...
      <!-- OPEN HAMIDAH ADD --> 
      <br />
      <input type="button" onclick="cetakChart('Column3D.swf','chart$selectedTab',1330,600);" id="printButton" value="Cetak Carta">
      <!-- CLOSE HAMIDAH ADD --> 
    ...
    <!-- PIE CHART -->
    <div class="TabbedPanelsContent"> #if ($selectedTab=="2")
      <object width="1330" height="600" id="Pie3D">
        <param name="movie" value="../FusionCharts/Doughnut2D.swf" />
        <param name="FlashVars"
					value="&dataURL=Data.xml&chartWidth=1330&chartHeight=600">
        <param name="quality" value="high" />
        <embed src="../fusioncharts/Charts/Doughnut2D.swf"
					flashVars="&dataXML=$xml&chartWidth=1330&chartHeight=600"
					quality="high" width="1330" height="600" name="Doughnut2D"
					type="application/x-shockwave-flash"
					pluginspage="http://www.macromedia.com/go/getflashplayer" />
        </embed>
      </object>
      ...
      <!-- OPEN HAMIDAH ADD --> 
      <br />
      <input type="button" onclick="cetakChart('Doughnut2D.swf','chart$selectedTab',1330,600);" id="printButton" value="Cetak Carta">
      <!-- CLOSE HAMIDAH ADD --> 
      #end 
    ...
    <!-- Line Chart -->
    <div class="TabbedPanelsContent"> #if ($selectedTab=="3")
      <object width="1330" height="600" id="Line">
        ...
        <embed src="../fusioncharts/Charts/Line.swf"
					flashVars="&dataXML=$xml&chartWidth=1330&chartHeight=600"
					quality="high" width="1330" height="600" name="Line"
					type="application/x-shockwave-flash"
					pluginspage="http://www.macromedia.com/go/getflashplayer" />
        </embed>
      </object>
      ...
      <!-- OPEN HAMIDAH ADD --> 
      <br />
      <input type="button" onclick="cetakChart('Line.swf','chart$selectedTab',1330,600);" id="printButton" value="Cetak Carta">
      <!-- CLOSE HAMIDAH ADD --> 
    ...
    <!-- END Line Chart --> 
    <!--PIE CHART2   -->
    <div class="TabbedPanelsContent"> #if ($selectedTab=="4")
      <object width="1330" height="600" id="Pie3D">
        ...
        <embed src="../fusioncharts/Charts/Pie3D.swf"
					flashVars="&dataXML=$xml&chartWidth=1330&chartHeight=600"
					quality="high" width="1330" height="600" name="Pie3D"
					type="application/x-shockwave-flash"
					pluginspage="http://www.macromedia.com/go/getflashplayer" />
        </embed>
      </object>
      ...
      <!-- OPEN HAMIDAH ADD --> 
      <br />
      <input type="button" onclick="cetakChart('Pie3D.swf','chart$selectedTab',1330,600);" id="printButton" value="Cetak Carta">
      <!-- CLOSE HAMIDAH ADD --> 
      ...
      <!--<table width="100%" cellpadding="1" cellspacing="2" border="0">
				<tr>
					...
					<input type="hidden" name="paramBulanDari">
					<input type="hidden" name="paramBulanHingga">
					<td width="40%"><input type="button" name="cmdCetak" id="cmdCetak" value="Cetak Laporan" onclick="cetakLaporan()" />
					</td>
				</tr>
			</table>--> 
    </div>
...
function cetakLaporan() {
	...
	var reportfile = "PDT_frmLaporanTRMTahunNegeri";
	...
	params[4] = "id_negeri="+document.${formName}.idNegeri.value;
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.frmLaporanTRMTahunNegeri";
	document.${formName}.submit();
}

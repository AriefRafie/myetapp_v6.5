...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div class="TabbedPanelsContentGroup">
    ...
    <fieldset>
	<legend>Laporan Tanah Permohonan Tukarguna Tanah PTP</legend>
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PHP_LaporanPermohonanTukargunaTanahPTP";
	document.${formName}.submit();
}

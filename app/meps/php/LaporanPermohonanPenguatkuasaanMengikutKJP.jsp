...
<fieldset>
	...
	<table width="100%" border="0">
		<tr>
			...
			<td width="16%">$selectTahun <input type="hidden"
				name="id_tahun" id="id_tahun" value="$!id_tahun"></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td></td>
			...
			<td>$selectBulan<input type="hidden" name="id_bulan"
				id="id_bulan" value="$!id_bulan"></td>
		</tr>
		<td>&nbsp;</td>
		<td></td>
		...
		<td><input name="txdTarikhMula" type="text" id="txdTarikhMula"
			size="10" maxlength="10" value="$!txdTarikhMula"
			onblur="validateTarikh(this,this.value);"
			onKeyUp="validateTarikh(this,this.value);" /> <a
			href="javascript:displayDatePicker('txdTarikhMula',false,'dmy');"><img
				src="../img/calendar.gif" alt="" border="0" /></a> <span
			style="font-size: 9px; color: blue; font-style: italic">dd/mm/yyyy</span>


		</td>

		<td width="4%">Hingga</td>
		<td width="1%">:</td>
		<td width="20%"><input name="txdTarikhAkhir" type="text"
			id="txdTarikhAkhir" size="10" maxlength="10" value="$!txdTarikhAkhir"
			onblur="validateTarikh(this,this.value);"
			onKeyUp="validateTarikh(this,this.value);" /> <a
		...
		<tr>
			...
			<td><div align="center"></div></td>
			<td><input type="button" name="cmdCari" id="cmdCari"
				value="Cari" onclick="search_data()" /> <input name="cmdKosongkan"
...
<div id="TabbedPanels1" class="TabbedPanels">
	...
	<div class="TabbedPanelsContentGroup">
				...
				<table width="100%" cellpadding="1" cellspacing="2" border="0">
					<tr class="table_header">
						<td width="6%" align="center" style="text-transform: uppercase"
							scope="row">Bil</td>
						<td width="37%" style="text-transform: uppercase">KJP</td>
		...
		<div class="TabbedPanelsContent">
			#if ($selectedTab=="2")
			<object width="1000" height="700" id="Pie3D">
				<param name="movie" value="../FusionCharts/Doughnut2D.swf" />
				<param name="FlashVars"
					value="&dataURL=Data.xml&chartWidth=1000&chartHeight=700">
				<param name="quality" value="high" />
				<embed src="../fusioncharts/Charts/Doughnut2D.swf"
					flashVars="&dataXML=$xml&chartWidth=1000&chartHeight=700"
					quality="high" width="1000" height="700" name="Doughnut2D"
					type="application/x-shockwave-flash"
					pluginspage="http://www.macromedia.com/go/getflashplayer" />
				</embed>
			</object>
            ...
            <!-- OPEN HAMIDAH ADD -->
            <br />
            <input type="button" onclick="cetakChart('Doughnut2D.swf','chart$selectedTab',1000,800);" id="printButton" value="Cetak Carta">
            <!-- CLOSE HAMIDAH ADD -->
			#end
		</div>
		...
		<div class="TabbedPanelsContent">
			...
			<object width="1000" height="700" id="Pie3D">
				...
				<embed src="../fusioncharts/Charts/Pie3D.swf"
					flashVars="&dataXML=$xml&chartWidth=1000&chartHeight=700"
					quality="high" width="1000" height="700" name="Pie3D"
					type="application/x-shockwave-flash"
					pluginspage="http://www.macromedia.com/go/getflashplayer" />
				</embed>
			</object>
            ...
            <!-- OPEN HAMIDAH ADD -->
            <br />
            <input type="button" onclick="cetakChart('Pie3D.swf','chart$selectedTab',1000,700);" id="printButton" value="Cetak Carta">
            <!-- CLOSE HAMIDAH ADD -->
			#end
		</div>
...
function cetakLaporan() {
	...
	var reportfile = "PHP_LaporanJumlahPermohonanPenguatkuasaanMengikutKJP";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PHP_LaporanJumlahPermohonanPenguatkuasaanMengikutKJP";
	document.${formName}.submit();
}

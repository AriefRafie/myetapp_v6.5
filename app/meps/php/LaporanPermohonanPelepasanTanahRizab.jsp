...
function cetakLaporan() {
	...
	var reportfile = "PHP_LaporanPermohonanPelepasanTanahRizab";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PHP_LaporanPermohonanPelepasanTanahRizab";
	document.${formName}.submit();
}

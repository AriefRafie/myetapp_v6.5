...
function cetakLaporan() {
	...
	var reportfile = "PHP_LaporanPermohonanPenyerahanBalikTanahMilikPersekutuan";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PHP_LaporanPermohonanPenyerahanBalikTanahMilikPersekutuan";
	document.${formName}.submit();
}

 ...
 <li class="TabbedPanelsTab" tabindex="1" onClick="javascript:setSelected(4);PieChart2()" >Pie Chart</li>
  ...
  #set ($jumlah = 0)     
       ...
       #set ($jumlah = $jumlah + $EkptgUtil.parseInt($senarai.jumlah_permohonan))
          ...
          <tr valign="top">
            ...
            <!--<a href="javascript:papar('$senarai.idNegeri')" class="style1">
            $!senarai.nama_negeri $!senarai.nama_daerah</a>--></td>
  ...
  #set ($jumlah = 0)     
       ...
       #set ($jumlah = $jumlah + $EkptgUtil.parseInt($senarai.jumlah_permohonan))
          ...
          <tr valign="top">
            <td class="$row" ><div align="center">$senarai.bil</div></td>
            <td class="$row">$senarai.nama_daerah</td>
            <td class="$row"><div align="center">$senarai.jumlah_permohonan</div></td>
          </tr>          
      #end   
      	<tr>
...
function cetakLaporan() {
	...
	var reportfile = "PHP_LaporanJumlahPermohonanPelepasan";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PHP_LaporanJumlahPermohonanPelepasan";
	document.${formName}.submit();
}

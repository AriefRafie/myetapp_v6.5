    ...
    <!-- OPEN HAMIDAH ADD -->
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="37%" style="text-transform:uppercase">Status</td>
...
function cetakLaporan() {
	...
	var reportfile = "PHP_LaporanJumlahPermohonanPenguatkuasaanMengikutStatus";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PHP_LaporanJumlahPermohonanPenguatkuasaanMengikutStatus";
	document.${formName}.submit();
}

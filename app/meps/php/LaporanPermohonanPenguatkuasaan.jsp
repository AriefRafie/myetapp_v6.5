...
function cetakLaporan() {
	...
	var reportfile = "PHP_LaporanJumlahPermohonanPenguatkuasaan";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PHP_LaporanJumlahPermohonanPenguatkuasaan";
	document.${formName}.submit();
}

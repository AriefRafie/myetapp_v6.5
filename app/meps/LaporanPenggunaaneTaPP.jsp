...
<div id="TabbedPanels1" class="TabbedPanels">
	...
	<legend>$!tajukLaporan</legend>
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="10%" style="text-transform:uppercase"><div align="center">PPT</div></td> 
          <td width="10%" style="text-transform:uppercase"><div align="center">PHP</div></td> 
          <td width="10%" style="text-transform:uppercase"><div align="center">HTP</div></td>
          <td width="10%" style="text-transform:uppercase"><div align="center">PPK</div></td>
        </tr>
  ...
  #set ($jumlahsphp = 0)
       ...
       #set ($jumlahspt = $jumlahspt + $EkptgUtil.parseInt($senarai.dari_spt))
       #set ($jumlahsppk = $jumlahsppk + $EkptgUtil.parseInt($senarai.dari_sppk))
       #set ($jumlahshtp = $jumlahshtp + $EkptgUtil.parseInt($senarai.dari_shtp))
       #set ($jumlahsphp = $jumlahsphp + $EkptgUtil.parseInt($senarai.dari_sphp))
          ...
          <tr valign="top">
            ...
            <td class="$row"><div align="center">$senarai.dari_spt</div></td>
            <td class="$row"><div align="center">$senarai.dari_sppk</div></td>
            <td class="$row"><div align="center">$senarai.dari_shtp</div></td>
            <td class="$row"><div align="center">$senarai.dari_sphp</div></td>
          </tr>          
      #end 
          ...
          <tr valign="top">
            ...
            <td class="$row"><div align="center"><strong>$jumlahspt</strong></div></td>
            <td class="$row"><div align="center"><strong>$jumlahsppk</strong></div></td>
            <td class="$row"><div align="center"><strong>$jumlahshtp</strong></div></td>
            <td class="$row"><div align="center"><strong>$jumlahsphp</strong></div></td>
          </tr>                 
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.FrmLaporanPenggunaaneTaPP";
	document.${formName}.submit();
}

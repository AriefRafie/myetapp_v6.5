...
<table width="100%" border="0" >  
 ...
 <td width="23%"></td>
  ...
  <tr>
    ...
    <td width="1%"><div align="center">:</div></td>
    <td width="62%">$selectNegeri<input type="hidden" name="idNegeri" id="idNegeri" value="$!idNegeri"></td>
  </tr>
  <tr>
    <td width="23%">&nbsp;</td>
    <td width="5%">&nbsp;</td>
...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div class="TabbedPanelsContentGroup">
    ...
    #if($linkPapar != 'viewNegeri')
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          <td width="2%" align="center" style="text-transform:uppercase" scope="row">Bil</td>
          <td width="25%" style="text-transform:uppercase">Negeri</td>
          <td width="35%" style="text-transform:uppercase"><div align="center">Jumlah BANTAHAN OLEH PIHAK BERKEPENTINGAN</div></td> 
          <td width="35%" style="text-transform:uppercase"><div align="center">JUMLAH BANTAHAN OLEH AGENSI PEMOHON</div></td> 
        </tr>
        
  #if($list_size!=0) 
  #set ($jumlahBantahanpb = 0)  
  #set ($jumlahBantahanap = 0)
      
       #foreach($senarai in $PermohonanList)
       #set ($jumlahBantahanpb = $jumlahBantahanpb + $EkptgUtil.parseInt($senarai.jumlah_permohonan_bantahanpb))
       #set ($jumlahBantahanap = $jumlahBantahanap + $EkptgUtil.parseInt($senarai.jumlah_permohonan_bantahanap))
          ...
          <tr valign="top">
            ...
            <td class="$row">$!senarai.nama_negeri $!senarai.nama_daerah
            <!--<a href="javascript:papar('$senarai.idNegeri')" class="style1">$!senarai.nama_negeri $!senarai.nama_daerah</a>-->
            </td>
            <td class="$row"><div align="center">$senarai.jumlah_permohonan_bantahanpb</div></td>
            <td class="$row"><div align="center">$senarai.jumlah_permohonan_bantahanap</div></td>
          </tr>          
      #end 
          ...
          <tr valign="top">
            ...
            <td class="$row"><div align="center"><strong>$jumlahBantahanpb</strong></div></td>
            <td class="$row"><div align="center"><strong>$jumlahBantahanap</strong></div></td>
          </tr>                 
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="37%" style="text-transform:uppercase">Daerah</td>
  ...
  #set ($jumlahBantahanap = 0)
       ...
       #set ($jumlahBantahanap = $jumlahBantahanap + $EkptgUtil.parseInt($senarai.jumlah_permohonan_bantahanap))
          ...
          <tr valign="top">
            <td class="$row" ><div align="center">$senarai.bil</div></td>
            <td class="$row">$senarai.nama_daerah</a></td>
            <td class="$row"><div align="center">$senarai.jumlah_permohonan_bantahanpb</div></td>
            <td class="$row"><div align="center">$senarai.jumlah_permohonan_bantahanap</div></td>
          </tr>          
      #end   
...
function cetakLaporan() {
	...
	var reportfile = "PPT_LaporanPrestasiBantahanMahkamah";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPT_LaporanPrestasiBantahanMahkamah";
	document.${formName}.submit();
}

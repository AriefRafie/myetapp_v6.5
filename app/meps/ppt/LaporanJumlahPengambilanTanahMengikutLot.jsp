...
<table width="100%" border="0" >  
  <tr>
    ...
    <input type="hidden" name="linkPapar" id="linkPapar" value="$linkPapar">
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td></td>
...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="1" onClick="javascript:setSelected(3);BarGraph2()" >Bar Chart2(Permohonan dan Lot)</li>
    ...
    <li class="TabbedPanelsTab" tabindex="1" onClick="javascript:setSelected(6);LineChart2()" >Line Chart2(Permohonan dan Lot)</li>
  ...
  #set ($jumlahHM = 0)
       ...
       #set ($jumlahHM = $jumlahHM + $EkptgUtil.parseInt($senarai.jumlah_hakmilik))
          ...
          <tr valign="top">
            ...
            <!--<a href="javascript:papar('$senarai.idNegeri')" class="style1">$!senarai.nama_negeri $!senarai.nama_daerah</a>--></td>
    ...
    <object width="900" height="400" id="MSColumn3D" >
      ...
      <!-- OPEN HAMIDAH ADD -->
            <br />
            <input type="button" onclick="cetakChart('MSColumn3D.swf','chart$selectedTab',1100,400);" id="printButton" value="Cetak Carta">
            <!-- CLOSE HAMIDAH ADD -->
    ...
    <div class="TabbedPanelsContent">
     ...
     <object width="900" height="400" id="Line" >
      ...
      <!-- OPEN HAMIDAH ADD -->
            <br />
            <input type="button" onclick="cetakChart('Line.swf','chart$selectedTab',400,900);" id="printButton" value="Cetak Carta">
            <!-- CLOSE HAMIDAH ADD -->
    ...
    <div class="TabbedPanelsContent">
     ...
     <object width="900" height="600" id="MSLine" >
      ...
      <!-- OPEN HAMIDAH ADD -->
            <br />
            <input type="button" onclick="cetakChart('MSLine.swf','chart$selectedTab',900,600);" id="printButton" value="Cetak Carta">
            <!-- CLOSE HAMIDAH ADD -->
...
function cetakLaporan() {
	...
	var reportfile = "PPT_LaporanJumlahPengambilanTanahMengikutLot";

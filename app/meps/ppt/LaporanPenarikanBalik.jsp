...
<tr>
    <td width="16%">&nbsp;</td>
    <td width="11%"></td>
    <td width="8%"><div align="left">Laporan</div></td>
 ...
 <td width="23%"></td>
  ...
  <tr>
    ...
    <td width="62%"><div id="socNegeri3">$selectNegeri<input type="hidden" name="idNegeri" id="idNegeri" value="$!idNegeri"></div></td>
  </tr>
<tr></tr>
  <tr>
    <td width="16%">&nbsp;</td>
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
         <td width="6%" align="center" style="text-transform:uppercase" scope="row">Bil</td>
          ...
          <td width="30%" style="text-transform:uppercase"><div align="center">Jumlah Lot Belum Selesai</div></td>
          <td width="37%" style="text-transform:uppercase"><div align="center">Jumlah Lot Telah Selesai</div></td> 
...
function cetakLaporan() {
	...
	var reportfile = "PPT_LaporanPenarikanBalik";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPT_LaporanPenarikanBalik";
	document.${formName}.submit();
}

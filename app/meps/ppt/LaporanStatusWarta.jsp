...
<tr >
    ...
    <td width="16%"> 
    <select style="width:96px;" id="jenis_laporans"  name="jenis_laporans">
    <option value = "tapak" #if($getJenisLaporans == "tapak") selected="selected" #end >TAPAK</option>
    <option value = "jajaran" #if($getJenisLaporans == "jajaran") selected="selected" #end >JAJARAN</option>
    </select><input type="hidden" name="getJenisLaporans" id="getJenisLaporans" value="$getJenisLaporans"/>
    </td>
    <td width="4%"></td>
    <td width="1%">
    <td width="45%">
...
<tr>
    <td width="21%">&nbsp;</td>
    <td width="6%"></td>
    <td width="6%"><div align="left">Mengikut</div></td>
    <td width="1%"><div align="center">:</div></td>
    ...
    </select><input type="hidden" name="getJenisLaporan" id="getJenisLaporan" value="$getJenisLaporan"/>
    </td>
    <td width="4%"></td>
    <td width="1%">
    <td width="45%">
...
style="font-size:9px;color:blue;font-style:italic">dd/mm/yyyy</span>     
    ...
    <td width="21%">&nbsp;</td>
    <td width="6%"></td>
    <td width="6%"><div align="left" id="socNegeri1">Negeri</div></td>
    <td width="1%"><div align="center" id="socNegeri2">:</div></td>
    <td><div id="socNegeri3">$selectNegeri<input type="hidden" name="idNegeri" id="idNegeri" value="$!idNegeri"></td>
  </tr>
  <tr>
    <td width="21%">&nbsp;</td>
    <td width="6%">&nbsp;</td>
...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div class="TabbedPanelsContentGroup">
    ...
    <fieldset>
     #if($getJenisLaporan==" "||$getJenisLaporan=="negeri")    
    ...
    <!-- OPEN HAMIDAH ADD -->
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="20%" align="center" style="text-transform:uppercase" scope="row">Negeri</td>
          <td width="20%" style="text-transform:uppercase"><div align="center">awal Jadual</div></td> 
          <td width="20%" style="text-transform:uppercase"><div align="center">ikut Jadual</div></td>
          <td width="20%" style="text-transform:uppercase"><div align="center">lewat Jadual</div></td> 
          <td width="20%" style="text-transform:uppercase"><div align="center">Dalam Proses</div></td> 
   ...
   #set ($jumlahAH = 0)
    #set ($jumlahOT = 0)
       ...
       #set ($jumlahHM = $jumlahHM + $EkptgUtil.parseInt($senarai.jumlah_hakmilik))
        #set ($jumlahAH = $jumlahAH + $EkptgUtil.parseInt($senarai.ahead))
         #set ($jumlahOT = $jumlahOT + $EkptgUtil.parseInt($senarai.ontime))
          ...
          <td class="$row" ><div align="center">$senarai.bil</div></td>
            <td class="$row" ><div align="left">$!senarai.nama_negeri $!senarai.nama_daerah</div></td>
              <td class="$row"><div align="center">$senarai.ahead</div></td>
            ...
            <td class="$row"><div align="center">$senarai.jumlah_hakmilik</div></td>
             <td class="$row"><div align="center">$senarai.ontime</div></td>
    	  ...
    	  <tr>
          	<td height="24" colspan="11">&nbsp;</td>
        </tr>
             <tr valign="top">
             <td class="$row" ></td>
            <td class="$row" ><div align="center"><strong>JUMLAH</strong></div></td>
              <td class="$row"><div align="center"><strong>$jumlahAH</strong></div></td>
            <td class="$row"><div align="center"><strong>$jumlah</strong></div></td>
            <td class="$row"><div align="center"><strong>$jumlahHM</strong></div></td>
              <td class="$row"><div align="center"><strong>$jumlahOT</strong></div></td>
      ...
      #elseif($getJenisLaporan=="kementerian")
      <legend>$!tajukLaporan</legend>
    
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          <td width="20%" align="center" style="text-transform:uppercase" scope="row">Kementerian</td>
          <td width="20%" style="text-transform:uppercase"><div align="center">awal Jadual</div></td> 
          <td width="20%" style="text-transform:uppercase"><div align="center">ikut Jadual</div></td>
          <td width="20%" style="text-transform:uppercase"><div align="center">lewat Jadual</div></td> 
          <td width="20%" style="text-transform:uppercase"><div align="center">Dalam Proses</div></td> 
       ...
       #set ($jumlahHM = $jumlahHM + $EkptgUtil.parseInt($senarai.jumlah_hakmilik))
        #set ($jumlahAH = $jumlahAH + $EkptgUtil.parseInt($senarai.ahead))
         #set ($jumlahOT = $jumlahOT + $EkptgUtil.parseInt($senarai.ontime))
          ...
          <tr valign="top">
            <td class="$row" ><div align="center">$senarai.nama_kementerian</div></td>
            <td class="$row"><div align="center">$senarai.ahead</div></td>
            <td class="$row"><div align="center">$senarai.jumlah_permohonan</div></td>
            <td class="$row"><div align="center">$senarai.jumlah_hakmilik</div></td>
             <td class="$row"><div align="center">$senarai.ontime</div></td>
...
<!--<table width="100%"  cellpadding="1" cellspacing="2" border="0">
    ...
    <object width="900" height="600" id="MSLine" >
      ...
      <!-- OPEN HAMIDAH ADD -->
            <br />
            <input type="button" onclick="cetakChart('MSLine.swf','chart$selectedTab',700,500);" id="printButton" value="Cetak Carta">
            <!-- CLOSE HAMIDAH ADD -->
...
function cetakLaporan() {
	...
	var reportfile = "PPT_LaporanStatusWarta";
	...
	params[1] = "tarikh_mula="+document.${formName}.txdTarikhMula.value;
	params[2] = "tarikh_akhir="+document.${formName}.txdTarikhAkhir.value;
	params[3] = "jenis_permohonan="+document.${formName}.jenis_laporans.value.toUpperCase();
	params[4] = "laporan="+document.${formName}.jenis_laporan.value.toUpperCase();
	params[5] = "id_negeri="+document.${formName}.idNegeri.value;
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPT_LaporanStatusWarta";
	document.${formName}.submit();
}

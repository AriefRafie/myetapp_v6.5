...
<div id="TabbedPanels1" class="TabbedPanels">
    ...
    <!-- OPEN HAMIDAH ADD -->
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="44%" style="text-transform:uppercase">Cawangan</td>
 ...
 <!-- REFERENCE -->
    ...
    <fieldset>
        <legend>Kod Negeri Cawangan</legend>
        
          <table width="60%"  cellpadding="1" cellspacing="2" border="0">
            <tr class="table_header">
              <td width="10%" style="text-transform:uppercase">Kod</td>
              <td width="50%" style="text-transform:uppercase"><div align="center">Nama Cawangan</div></td> 
            </tr>
           ...
           #foreach($SenaraiKod in $SenaraiKod)
              ...
              <tr valign="top">
                ...
                <td class="$row"><div align="left">$SenaraiKod.cawangan</div></td>
              </tr>          
          #end   
             <tr>
                <td colspan="11">&nbsp;</td>
...
function cetakLaporan() {
	...
	var reportfile = "PPT_LaporanPermohonanPengambilanUnit";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPT_LaporanPermohonanPengambilanUnit";
	document.${formName}.submit();
}

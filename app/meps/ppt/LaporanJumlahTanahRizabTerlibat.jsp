    ...
    <!-- OPEN HAMIDAH ADD -->
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="17%" style="text-transform:uppercase"><div align="center">Jumlah Keluasan Tanah Rizab</div></td> 
        </tr>
  ...
  #set ($jumlah = 0)
       ...
       #set ($jumlah = $jumlah + $EkptgUtil.parseInt($senarai.jumlah_permohonan))
          ...
          <tr valign="top">
            ...
            <td class="$row"><div align="center">$senarai.luas_rizab</div></td>
          </tr>          
      #end 
  ...
  #set ($jumlah = 0)
    ...
    <div class="TabbedPanelsContent">
     ...
     <object width="900" height="400" id="Line" >
      ...
      <!-- OPEN HAMIDAH ADD -->
            <br />
            <input type="button" onclick="cetakChart('Line.swf','chart$selectedTab',700,500);" id="printButton" value="Cetak Carta">
            <!-- CLOSE HAMIDAH ADD -->
    ...
    <!-- END Line Chart -->
       ...
       <div class="TabbedPanelsContent">
        ...
        <object width="550" height="300" id="Pie3D" >
         ...
         <!-- OPEN HAMIDAH ADD -->
            <br />
            <input type="button" onclick="cetakChart('Pie3D.swf','chart$selectedTab',700,500);" id="printButton" value="Cetak Carta">
            <!-- CLOSE HAMIDAH ADD -->
...
function cetakLaporan() {
	...
	var reportfile = "PPT_LaporanPampasan";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPT_LaporanPampasan";
	document.${formName}.submit();
}

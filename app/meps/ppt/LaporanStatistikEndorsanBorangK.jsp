...
<tr>
 ...
 <tr>
    <td width="16%">&nbsp;</td>
    <td width="9%"></td>
    <td width="5%"><div align="left">Laporan</div></td>
    <td width="1%"><div align="center">:</div></td>
 ...
 <td width="23%"></td>
  ...
  <tr>
    ...
    <td width="62%"><div id="socNegeri3">$selectNegeri<input type="hidden" name="idNegeri" id="idNegeri" value="$!idNegeri"></td>
  </tr>
  <tr>
    <td width="16%">&nbsp;</td>
    <td width="9%">&nbsp;</td>
...
<div id="TabbedPanels1" class="TabbedPanels">
    ...
    <!-- OPEN HAMIDAH ADD -->
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        ...
        <td width="6%" align="center" style="text-transform:uppercase" scope="row">Bil</td>
          <td width="33%" align="center" style="text-transform:uppercase" scope="row">Negeri</td>
          <td width="30%" style="text-transform:uppercase"><div align="center">telah di endos</div></td>
          <td width="37%" style="text-transform:uppercase"><div align="center">belum di endos</div></td> 
  ...
  #set ($jumlahHM = 0)
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          <td width="33%" align="center" style="text-transform:uppercase" scope="row">Kementerian</td>
          <td width="30%" style="text-transform:uppercase"><div align="center">telah di endos</div></td>
          <td width="37%" style="text-transform:uppercase"><div align="center">belum di endos</div></td> 
...
function cetakLaporan() {
	...
	var reportfile = "PPT_LaporanStatistikEndorsanBorangK";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPT_LaporanStatistikEndorsanBorangK";
	document.${formName}.submit();
}

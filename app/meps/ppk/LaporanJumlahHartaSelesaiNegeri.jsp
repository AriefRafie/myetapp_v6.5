...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="1" onClick="javascript:setSelected(1);BarGraph2()"> <i>Bar Chart</i></li> -->
    ...
    <li class="TabbedPanelsTab" tabindex="1" onClick="javascript:setSelected(2);LineChart2()" ><i>Line Chart</i></li> -->
  </ul>
  <div class="TabbedPanelsContentGroup">
    ...
    <!-- OPEN HAMIDAH ADD -->
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="22%" style="text-transform:uppercase">Tahun</td>
          <td width="15%" style="text-transform:uppercase"><div align="center">Harta Tak Alih (RM)</div></td> 
          <td width="15%" style="text-transform:uppercase"><div align="center">Harta Alih (RM)</div></td> 
          <td width="15%" style="text-transform:uppercase"><div align="center">Jumlah Harta (RM)</div></td> 
          <td width="15%" style="text-transform:uppercase"><div align="center">Selesai (RM)</div></td> 
          <td width="15%" style="text-transform:uppercase"><div align="center">Belum Selesai (RM)</div></td> 
        </tr>
	...
	#foreach($senarai in $PermohonanList)
		#set ($jumlahHA = $jumlahHA + $senarai.jumlahHA)
		#set ($jumlahHTA = $jumlahHTA + $senarai.jumlahHTA)
		#set ($jumlahHarta = $jumlahHarta + $senarai.jumlahHarta)
		#set ($jumlahHartaS = $jumlahHartaS + $senarai.jumlahHartaS)
		#set ($jumlahHartaX = $jumlahHartaX + $senarai.jumlahHartaX)
		...
		#set( $i = $velocityCount )
          ...
          <tr valign="top">
            ...
            <td class="$row"><div align="right">$!EkptgUtil_.format2Decimal($!senarai.jumlahHTA)</div></td>
            <td class="$row"><div align="right">$!EkptgUtil_.format2Decimal($!senarai.jumlahHA)</div></td>
            <td class="$row"><div align="right">$!EkptgUtil_.format2Decimal($!senarai.jumlahHarta)</div></td>
            <td class="$row"><div align="right">$!EkptgUtil_.format2Decimal($!senarai.jumlahHartaS)</div></td>
            <td class="$row"><div align="right">$!EkptgUtil_.format2Decimal($!senarai.jumlahHartaX)</div></td>
          </tr>          
   	#end   
    	  ...
    	  <tr>
            ...
            <td colspan=2><div align="right"><strong>JUMLAH (RM)</strong></div></td>
            <td ><div align="right"><strong>$!EkptgUtil_.format2Decimal($!jumlahHTA)</strong></div></td>
            <td ><div align="right"><strong>$!EkptgUtil_.format2Decimal($!jumlahHA)</strong></div></td>
            <td ><div align="right"><strong>$!EkptgUtil_.format2Decimal($!jumlahHarta)</strong></div></td>
            <td ><div align="right"><strong>$!EkptgUtil_.format2Decimal($!jumlahHartaS)</strong></div></td>
            <td ><div align="right"><strong>$!EkptgUtil_.format2Decimal($!jumlahHartaX)</strong></div></td>
          </tr>        
    	<tr>
          	<td colspan="7">&nbsp;</td>
       	</tr>
    ...
    <object width="900" height="400" id="MSColumn3D" >
      ...
      <!-- OPEN HAMIDAH ADD -->
            <br />
            <input type="button" onclick="cetakChart('MSColumn3D.swf','chart$selectedTab',700,600);" id="printButton" value="Cetak Carta">
            <!-- CLOSE HAMIDAH ADD -->
...
function cetakLaporan() {
	...
	var reportfile = "PPKLaporanJumlahHartaSelesaiNegeri";
	...
	params[4] = "id_suburusan="+document.${formName}.socSuburusan.value;

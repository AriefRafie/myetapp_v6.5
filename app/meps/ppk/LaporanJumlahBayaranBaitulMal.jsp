...
<tr>			
  ...
  <tr>
    ...
    <td width="62%">$selectTahunDari<input type="hidden" name="id_tahunDari" id="id_tahunDari" value="$!id_tahunDari">&nbsp;&nbsp;&nbsp;Hingga&nbsp;&nbsp;&nbsp;$selectTahunHingga<input type="hidden" name="id_tahunHingga" id="id_tahunHingga" value="$!id_tahunHingga"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td></td>
    ...
    <td>$selectBulanDari<input type="hidden" name="id_bulanDari" id="id_bulanDari" value="$!id_bulanDari">&nbsp;&nbsp;&nbsp;Hingga&nbsp;&nbsp;&nbsp;$selectBulanHingga<input type="hidden" name="id_bulanHingga" id="id_bulanHingga" value="$!id_bulanHingga"></td>
  </tr>
  <tr>
    <td width="24%">&nbsp;</td>
    <td width="6%">&nbsp;</td>
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
       ...
       #set ($jumlah = $jumlah + $senarai.jumlah_permohonan )
          ...
          <tr valign="top">
            ...
            <td class="$row">$!senarai.nama_negeri $!senarai.nama_pejabat</td>
 ...
 <!--<table width="100%"  cellpadding="1" cellspacing="2" border="0">
    ...
    <div class="TabbedPanelsContent">
     ...
     <object width="1100" height="400" id="Line" >
      ...
      <param name="FlashVars" value="&dataURL=Data.xml&chartWidth=1100&chartHeight=400">
      <param name="quality" value="high" />
      <embed src="../fusioncharts/Charts/Line.swf" flashVars="&dataXML=$xml&chartWidth=1100&chartHeight=400" quality="high" width="1100" height="400" name="Line" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
      </embed>
      </object>
...
function cetakLaporan() {
	...
	var reportfile = "PPK_LaporanBayaranBaitulMal";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPK_LaporanBayaranBaitulMal";
	document.${formName}.submit();
}

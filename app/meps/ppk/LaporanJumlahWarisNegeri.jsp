...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div class="TabbedPanelsContentGroup">
    ...
    <!-- CLOSE HAMIDAH ADD -->
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="65%" style="text-transform:uppercase">Tahun</td>
	...
	#foreach($senarai in $PermohonanList)
    	...
    	#set ($jumlah2 = $jumlah2 + $EkptgUtil.parseInt($senarai.jumlah2))
          ...
          <tr valign="top">
            ...
            <td class="$row"><div align="right">$EkptgUtil.formatNumberWithoutDecimal($EkptgUtil.parseInt($!senarai.jumlah2))</div></td>
          </tr>          
      #end   
    	  ...
    	  <tr>
            ...
            <td><div align="right"><strong>$EkptgUtil.formatNumberWithoutDecimal($!jumlah2)</strong></div></td>
          </tr>                  
    	<tr>
          	<td colspan="4">&nbsp;</td>
       	</tr>
...
function cetakLaporan() {
	var reportfile = "PPKLaporanPermohonanWarisNegeri";
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPKLaporanPermohonanWarisNegeri";
	document.${formName}.submit();
	}

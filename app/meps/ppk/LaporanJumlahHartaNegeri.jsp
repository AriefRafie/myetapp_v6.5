	...
	<legend>$!tajukLaporan</legend>
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="17%" style="text-transform:uppercase">Tahun</td>
          <td width="26%" style="text-transform:uppercase"><div align="center">Harta Tak Alih (RM)</div></td> 
          <td width="26%" style="text-transform:uppercase"><div align="center">Harta Alih (RM)</div></td>
          <td width="26%" style="text-transform:uppercase"><div align="center">Jumlah Harta (RM)</div></td> 
        </tr>
...
function cetakLaporan() {
	...
	var reportfile = "PPKLaporanJumlahHartaNegeri";

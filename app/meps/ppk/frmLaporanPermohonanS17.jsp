...
<div id="TabbedPanels1" class="TabbedPanels">
	...
	<div class="TabbedPanelsContentGroup">
		...
		<div class="TabbedPanelsContent">
			...
			<fieldset>
				...
				<table width="100%" cellpadding="1" cellspacing="2" border="0">
					...
					#if($list_size!=0) #set ($jumlah = 0) #foreach($senarai in
					$PermohonanList) #set ($jumlah = $jumlah +
					$EkptgUtil.parseInt($senarai.jumlah_permohonan)) #set( $i =
		...
		<div class="TabbedPanelsContent">
			#if ($selectedTab=="3")
			<object width="1200" height="400" id="Line">
				<param name="movie" value="../FusionCharts/Line.swf" />
				<param name="FlashVars"
					value="&dataURL=Data.xml&chartWidth=1200&chartHeight=400">
				<param name="quality" value="high" />
				<embed src="../fusioncharts/Charts/Line.swf"
					flashVars="&dataXML=$xml&chartWidth=1200&chartHeight=400"
					quality="high" width="1200" height="400" name="Line"
					type="application/x-shockwave-flash"
					pluginspage="http://www.macromedia.com/go/getflashplayer" />
				</embed>
			</object>
...
function cetakLaporan() {
	...
	var reportfile = "LaporanJumPermohonanS17";
	var params = new Array();
	var paramTahunDari= document.${formName}.paramTahunDari.value;
	var paramTahunHinnga= document.${formName}.paramTahunHingga.value;
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPK_FrmLaporanJumPermohonanS17";
	document.${formName}.submit();
}

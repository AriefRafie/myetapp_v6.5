...
<fieldset>
    ...
    <tr>			
		...
		<!--<tr>
			<td width="24%">&nbsp;</td>
			<td width="6%"></td>
			<td width="7%"><div align="left">Negeri</div></td>
			<td width="1%"><div align="center">:</div></td>
			<td width="62%">$selectNegeri<input type="hidden"
				name="idNegeri" id="idNegeri" value="$!idNegeri"></td>
		</tr>-->
		<tr>
			<td width="24%">&nbsp;</td>
			<td width="6%">&nbsp;</td>
			...
			<td><div align="center"></div></td>
			<td><input type="button" name="cmdCari" id="cmdCari" value="Cari"
				onclick="search_data()" /> <input name="cmdKosongkan"
				id="cmdKosongkan" value="Kosongkan" type="reset"
				onclick="javascript:kosongkan()" /></td>
		</tr>
		<tr>
			<td colspan="5"></td>
		</tr>
...
<div id="TabbedPanels1" class="TabbedPanels">
	<ul class="TabbedPanelsTabGroup">
		<li class="TabbedPanelsTab" tabindex="1"
			onClick="javascript:setSelected(0);Laporan()">Laporan</li>
		<li class="TabbedPanelsTab" tabindex="1"
			onClick="javascript:setSelected(1);BarGraph()">Bar Chart</li>
		<li class="TabbedPanelsTab" tabindex="1"
			onClick="javascript:setSelected(2);PieChart()">Doughnut Chart</li>
		<li class="TabbedPanelsTab" tabindex="1"
			onClick="javascript:setSelected(3);LineChart()">Line Chart</li>
		<li class="TabbedPanelsTab" tabindex="1"
			onClick="javascript:setSelected(4);PieChart2()">Pie Chart</li>
	</ul>
	<div class="TabbedPanelsContentGroup">
		...
		<div class="TabbedPanelsContent">
			...
			<fieldset>
				...
				<table width="100%" cellpadding="1" cellspacing="2" border="0"  >
					<tr class="table_header">
						<td width="6%" align="center" style="text-transform: uppercase"
							scope="row">Bil</td>
						<td width="37%" style="text-transform: uppercase">
						...
						<td width="17%" style="text-transform: uppercase"><div
								align="center">Jumlah Permohonan</div></td>
					</tr>
					#if($list_size!=0) 
                    #set ($jumlah = 0) 
					...
					<tr valign="top">
						...
						<td class="$row"><div align="center">$EkptgUtil.formatNumberWithoutDecimal($EkptgUtil.parseInt($senarai.jumlah_permohonan))</div></td>
					</tr>
					#end
					<tr>
						<td colspan="11">&nbsp;</td>
					...
					<tr valign="top">
						...
						<td class="$row"><div align="center">
								<strong>$EkptgUtil.formatNumberWithoutDecimal($jumlah)</strong>
							</div></td>
					</tr>
					#else
					<tr>
			...
			<table width="100%" cellpadding="1" cellspacing="2" border="0">
				<tr>
					...
					<td width="20%"><input type="button" name="cmdCetak"
						id="cmdCetak" value="Cetak Laporan" onclick="cetakLaporan()" /></td>
				</tr>
			</table>
			-->
            <!-- CLOSE HAMIDAH ADD -->
		...
		<div class="TabbedPanelsContent">
			...
			<object width="400" height="300" id="Column3D">
				...
				<param name="FlashVars"
					value="&dataXML=$xml&chartWidth=400&chartHeight=300">
				<param name="quality" value="high" />
				<embed src="../fusioncharts/Charts/Column3D.swf"
					flashVars="&dataXML=$xml&chartWidth=900&chartHeight=300"
            ...
            <table width="100%" cellpadding="1" cellspacing="2" border="0">
				<tr>
					...
					<input type="hidden" name="paramBulanDari">
					<input type="hidden" name="paramBulanHingga">
					<td width="27%"><input type="button" name="cmdCetak"
						id="cmdCetak" value="Cetak Laporan" onclick="cetakLaporan()" /></td>
				</tr>
			</table>
            -->
		...
		<div class="TabbedPanelsContent">
			...
			<object width="550" height="300" id="Pie3D">
				...
				<param name="FlashVars"
					value="&dataURL=Data.xml&chartWidth=700&chartHeight=500">
				<param name="quality" value="high" />
				<embed src="../fusioncharts/Charts/Doughnut2D.swf"
					flashVars="&dataXML=$xml&chartWidth=550&chartHeight=300"
					quality="high" width="700" height="400" name="Doughnut2D"
					type="application/x-shockwave-flash"
					pluginspage="http://www.macromedia.com/go/getflashplayer" />
				</embed>
			</object>
			...
			<table width="100%" cellpadding="1" cellspacing="2" border="0">
				<tr>
					...
					<input type="hidden" name="paramBulanDari">
					<input type="hidden" name="paramBulanHingga">
					<td width="38%"><input type="button" name="cmdCetak"
						id="cmdCetak" value="Cetak Laporan" onclick="cetakLaporan()" /></td>
				</tr>
			</table>
            -->
		...
		<div class="TabbedPanelsContent">
			#if ($selectedTab=="3")
			<object width="1100" height="400" id="Line">
				<param name="movie" value="../FusionCharts/Line.swf" />
				<param name="FlashVars"
					value="&dataURL=Data.xml&chartWidth=1100&chartHeight=400">
				<param name="quality" value="high" />
				<embed src="../fusioncharts/Charts/Line.swf"
					flashVars="&dataXML=$xml&chartWidth=1100&chartHeight=400"
					quality="high" width="1100" height="400" name="Line"
					type="application/x-shockwave-flash"
					pluginspage="http://www.macromedia.com/go/getflashplayer" />
				</embed>
			</object>
		...
		<div class="TabbedPanelsContent">
			...
			<object width="550" height="300" id="Pie3D">
				...
				<param name="FlashVars"
					value="&dataURL=Data.xml&chartWidth=550&chartHeight=300">
				<param name="quality" value="high" />
				<embed src="../fusioncharts/Charts/Pie3D.swf"
					flashVars="&dataXML=$xml&chartWidth=550&chartHeight=300"
					quality="high" width="700" height="400" name="Pie3D"
					type="application/x-shockwave-flash"
					pluginspage="http://www.macromedia.com/go/getflashplayer" />
				</embed>
			</object>
            <!-- OPEN HAMIDAH ADD -->
            <br />
            <input type="button" onclick="cetakChart('Pie3D.swf','chart$selectedTab',550,300);" id="printButton" value="Cetak Carta">
            <!-- CLOSE HAMIDAH ADD -->
			#end
            <!-- OPEN HAMIDAH ADD -->
            <!--
			<table width="100%" cellpadding="1" cellspacing="2" border="0">
				<tr>
					...
					<input type="hidden" name="paramBulanDari">
					<input type="hidden" name="paramBulanHingga">
					<td width="40%"><input type="button" name="cmdCetak"
						id="cmdCetak" value="Cetak Laporan" onclick="cetakLaporan()" /></td>
				</tr>
			</table>
            -->
	...
	<fieldset>
		...
		<table width="60%" cellpadding="1" cellspacing="2" border="0">
			<tr class="table_header">
				...
				<td width="50%" style="text-transform: uppercase"><div
						align="center">Nama Negeri</div></td>
			</tr>

			#if($listKod_size!=0) #foreach($SenaraiKod in $SenaraiKod) #set( $i =
			$velocityCount ) #if ( ($i % 2) != 1 ) #set( $row = "row2" ) #else
			#set( $row = "row1" ) #end
...
<input type="hidden" id="paramUserLogin" name="paramUserLogin"
	value='$!{session.getAttribute("_portal_login")}'>
<input type="hidden" id="rFormat" name="rFormat"
	value='$!{session.getAttribute("rFormat")}'>
...
function cetakLaporan() {
	...
	var reportfile = "PPK_FrmLaporanPrestasi";
	...
	params[6] = "ID_NEGERI="+document.${formName}.ID_NEGERI.value;
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPK_FrmLaporanPrestasi";
	document.${formName}.submit();
}

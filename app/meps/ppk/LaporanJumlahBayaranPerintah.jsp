  ...
  <div class="TabbedPanelsContentGroup">
    ...
    <div class="TabbedPanelsContent">
     ...
     <object width="1100" height="400" id="Line" >
      ...
      <param name="quality" value="high" />
      <embed src="../fusioncharts/Charts/Line.swf" flashVars="&dataXML=$xml&chartWidth=1200&chartHeight=400" quality="high" width="1100" height="400" name="Line" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
      </embed>
      </object>
...
function cetakLaporan() {
	...
	var reportfile = "PPK_LaporanBayaranPerintah";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.PPK_LaporanBayaranPerintah";
	document.${formName}.submit();
}

...
<table width="100%" border="0" > 
 <tr>
    ...
    <td width="29%"> 
    <select style="width:230px;" id="jenis_laporan"  name="jenis_laporan">
    <option value = "negeri" #if($getJenisLaporan == "negeri") selected="selected" #end >Belum Dibangunkan-Permohonan</option>
    <option value = "kementerian" #if($getJenisLaporan == "kementerian") selected="selected" #end >Belum Dibangunkan-Penyewaan</option>
    ...
    <!-- OPEN HAMIDAH ADD -->
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="17%" style="text-transform:uppercase"><div align="center">Jumlah </div></td> 
        </tr>
...
function cetakLaporan() {
	...
	var reportfile = "HTP_LaporanRingkasanTanahBelumBangunPermohonan";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.HTP_LaporanRingkasanTanahBelumBangunPermohonan";
	document.${formName}.submit();
}

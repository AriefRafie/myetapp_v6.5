...
<table width="100%" border="0" >
  ...
  <tr>
    <td width="19%">&nbsp;</td>
    <td width="6%"></td>
    <td width="8%"><div align="left">Tahun</div></td>
    <td width="1%"><div align="center">:</div></td>
    <td width="14%">$selectTahun
...
<div id="TabbedPanels1" class="TabbedPanels">
 ...
 <!--<table width="100%"  cellpadding="1" cellspacing="2" border="0">
    ...
    <div class="TabbedPanelsContent">
    #if ($selectedTab=="3")
     <object width="1000" height="400" id="Line" >
      <param name="movie" value="../FusionCharts/Line.swf" />
      <param name="FlashVars" value="&dataURL=Data.xml&chartWidth=1000&chartHeight=400">
      <param name="quality" value="high" />
      <embed src="../fusioncharts/Charts/Line.swf" flashVars="&dataXML=$xml&chartWidth=1000&chartHeight=400" quality="high" width="1000" height="400" name="Line" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
      </embed>
      </object>
...
function cetakLaporan() {
	...
	var reportfile = "HTP_LaporanPembelianTanahMengikutNegeri";
	...
	params[3] = "laporan="+document.${formName}.jenis_laporan.value;
	params[4] = "id_tahun="+document.${formName}.id_tahun.value;
	params[5] = "id_bulan="+document.${formName}.id_bulan.value;
...
function kosongkan() {
	...
	document.${formName}.jenis_laporan.value = "";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.HTP_LaporanPembelianTanahMengikutNegeri";
	document.${formName}.submit();
}

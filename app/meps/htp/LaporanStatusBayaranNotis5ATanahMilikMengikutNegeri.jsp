...
<div id="TabbedPanels1" class="TabbedPanels">
    ...
    <fieldset>
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="37%" style="text-transform:uppercase">Nama Kementerian</td>
          <td width="17%" style="text-transform:uppercase"><div align="center">Jumlah Bayaran (RM)</div></td> 
        </tr>
  ...
  #set ($jumlah = 0)
       ...
       #set ($jumlah = $jumlah + $senarai.jumlah_permohonan )
          ...
          <tr valign="top">
            ...
            <td class="$row"><div align="right">$EkptgUtil.format2Decimal($senarai.jumlah_permohonan)</div></td>
          </tr>          
      #end   
    	  ...
    	  <tr>
             ...
             <tr valign="top">
            <td class="$row" ></td>
            <td class="$row"><div align="right"><strong>JUMLAH (RM)</strong></div></td>
            <td class="$row"><div align="right"><strong>$EkptgUtil.format2Decimal($jumlah)</strong></div></td>
          </tr>                   
...
<!--<table width="100%"  cellpadding="1" cellspacing="2" border="0">
 ...
 <!-- REFERENCE -->
    ...
    <fieldset>
     ...
     #if($getJenisLaporan=="kementerian" )
      <legend>Kod Kementerian</legend>
        
          <table width="60%"  cellpadding="1" cellspacing="2" border="0">
            <tr class="table_header">
              <td width="10%" style="text-transform:uppercase">Kod</td>
...
function cetakLaporan() {
	var reportfile = "HTP_LaporanPermohonanPemberimilikanMengikutNegeri";
	...
	params[5] = "laporan="+document.${formName}.jenis_laporan.value.toUpperCase();
	params[6] = "id_negeri="+document.${formName}.idNegeri.value;
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.HTP_LaporanStatusBayaranNotis5ATanahMilikMengikutNegeri";
	document.${formName}.submit();
}

    ...
    <!-- OPEN HAMIDAH ADD -->
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="15%" style="text-transform:uppercase"><div align="center">Jumlah HakMilik</div></td> 
        </tr>
    ...
    <!-- OPEN HAMIDAH ADD -->
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="17%" style="text-transform:uppercase"><div align="center">Jumlah HakMilik</div></td> 
        </tr>
...
function cetakLaporan() {
	...
	var reportfile = "HTP_LaporanRingkasanTanahMilikPersekutuanMengikutNegeri";
	...
	params[4] = "laporan="+(document.${formName}.getJenisLaporan.value).toUpperCase();
...
// 	document.${formName}.id_bulan.value = "";
// 	document.${formName}.getJenisLaporan.value = "";
// 	document.${formName}.hitbutton.value = "kosong";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.HTP_LaporanRingkasanTanahMilikPersekutuanMengikutNegeri";
	document.${formName}.submit();
}

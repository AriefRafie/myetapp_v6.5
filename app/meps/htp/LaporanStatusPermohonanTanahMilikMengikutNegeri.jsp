...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div class="TabbedPanelsContentGroup">
    ...
    <fieldset>
	<legend>Laporan Status Permohonan Tanah Milik Mengikut Negeri</legend>
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.HTP_LaporanStatusPermohonanTanahMilikMengikutNegeri";
	document.${formName}.submit();
}

...
<tr>
    <td width="23%">&nbsp;</td>
    <td width="7%"></td>
    <td width="7%"><div align="left">Laporan</div></td>
    <td width="1%"><div align="center">:</div></td>
 
    <td width="15%"> 
    <select style="width:130px;" id="jenis_laporan"  name="jenis_laporan">
    <option value = "negeri" #if($getJenisLaporan == "negeri") selected="selected" #end >Belum Di Daftar</option>
    <option value = "kementerian" #if($getJenisLaporan == "kementerian") selected="selected" #end >Telah Di Daftar</option>
...
style="font-size:9px;color:blue;font-style:italic">dd/mm/yyyy</span>     
    ...
    <td width="1%"><div align="center">:</div></td>
    <td>$selectNegeri<input type="hidden" name="idNegeri" id="idNegeri" value="$!idNegeri"></td>
  </tr>
  <tr>
    <td width="24%">&nbsp;</td>
    <td width="6%">&nbsp;</td>
...
<!--<table width="100%"  cellpadding="1" cellspacing="2" border="0">
    ...
    <div class="TabbedPanelsContent">
     ...
     <object width="1200" height="400" id="Line" >
      ...
      <param name="FlashVars" value="&dataURL=Data.xml&chartWidth=1200&chartHeight=400">
      <param name="quality" value="high" />
      <embed src="../fusioncharts/Charts/Line.swf" flashVars="&dataXML=$xml&chartWidth=1200&chartHeight=400" quality="high" width="1200" height="400" name="Line" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
      </embed>
      </object>
      <!-- OPEN HAMIDAH ADD -->
            <br />
...
function cetakLaporan() {
	...
	var reportfile = "HTP_LaporanPermohonanYgBelumDaftarPerletakhakanTanah";
	...
	params[2] = "id_tahun="+document.${formName}.id_tahun.value;
	params[3] = "id_bulan="+document.${formName}.id_bulan.value;
	params[4] = "idNegeri="+document.${formName}.idNegeri.value;
	params[5] = "tarikh_mula="+document.${formName}.txdTarikhMula.value;
	params[6] = "tarikh_akhir="+document.${formName}.txdTarikhAkhir.value;
	params[7] = "laporan="+(document.${formName}.getJenisLaporan.value).toUpperCase();
...
function kosongkan() {
	...
	document.${formName}.idNegeri.value = "";
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.HTP_LaporanPermohonanYgBelumDaftarPerletakhakanTanah";
	document.${formName}.submit();
}

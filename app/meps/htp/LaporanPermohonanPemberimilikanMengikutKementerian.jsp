  ...
  #set ($jumlah = 0)      
    ...
    <div class="TabbedPanelsContent">
     ...
     <object width="400" height="300" id="Column3D" >
         ...
         <param name="FlashVars" value="&dataXML=$xml&chartWidth=500&chartHeight=300">
    ...
    <fieldset>
        <legend>Kod Kementerian</legend>
          ...
          <table width="60%"  cellpadding="1" cellspacing="2" border="0">
            <tr class="table_header">
              <td width="3%" style="text-transform:uppercase">Kod</td>
              <td width="57%" style="text-transform:uppercase"><div align="center">Nama Kementerian</div></td> 
            </tr>
...
<script type="text/javascript">
	...
	function search_data(){
		...
		document.${formName}.action = "?_portal_module=ekptg.view.meps.HTP_LaporanPermohonanPemberimilikanMengikutKementerian";
		document.${formName}.submit();
	}

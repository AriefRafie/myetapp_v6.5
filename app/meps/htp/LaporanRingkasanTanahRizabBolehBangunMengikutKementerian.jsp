	...
	<legend>$!tajukLaporan</legend>
      ...
      <table width="100%"  cellpadding="1" cellspacing="2" border="0">
        <tr class="table_header">
          ...
          <td width="17%" style="text-transform:uppercase"><div align="center">Jumlah Tanah Boleh DiBangunkan</div></td> 
        </tr>
...
function search_data(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.meps.HTP_LaporanRingkasanTanahRizabBolehBangunMengikutKementerian";
	document.${formName}.submit();
}

...
<td>
	...
	<!--<legend>LAPORAN</legend>-->
		...
		<table border="0" align="center" width="100%" >
		  	...
		  	<td class="row2">1.</td>
		  	<td class="row2">
		  		<a href="javascript:openLaporan('ekptg.report.htp.LaporanUtamaHTPManual','urusan=xx','urusantahun','LaporanOnlinePrestasiMengikutTahun')" class="style1" >RINGKASAN PERMOHONAN <i>ONLINE</i> (MENGIKUT URUSAN DAN TAHUN) </a>
		 	</td>
		   	</tr>	
		</table>
...
<script>
	...
	function openLaporan(urli,param,laporan,tem){
		...
		var url = "../servlet/"+urli+"?"+param+pnegeri+ptahun+ptem+pbulanmula+pbulantamat+punit+pdaerah+"&folder=mep";

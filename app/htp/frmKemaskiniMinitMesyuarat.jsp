      ...
      <td><div id="TabbedPanels1" class="TabbedPanels">
        ...
        <div class="TabbedPanelsContentGroup">
          ...
          <input name="idMinitmesyuarat" type="hidden" value="$minit.id_Minitmesyuarat" />
              <tr>
                <td width="29%"><div align="right" class="style9">Agenda Mesyuarat</div></td>
                <td width="1%"><div align="right">:</div></td>
                <td width="70%">$selectAgendaA</td>
              </tr>
              <tr>
                <td valign="top"><div align="right" class="style9">Perkara Minit</div></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <input name="idMinitmesyuaratpara" type="hidden" value="$paparPara.id_Minitmesyuaratpara" />
              ...
              <tr>
                <td><div align="right" class="style9">Perkara Minit</div></td>
                <td width="1%"><div align="right" class="style9">:</div></td>
                <td>$selectPerkaraMinitB</td>
              </tr>
              <tr>
                <td valign="top"><div align="right" class="style9">Minit</div></td>
              ...
              <tr>
                <td><div align="right" class="style9">Tindakan</div></td>
                <td width="1%"><div align="right" class="style9">:</div></td>
                <td><label>
              ...
              <tr>
                <td valign="top"><div align="right" class="style9">Maklumbalas</div></td>
                <td width="1%" valign="top"><div align="right" class="style9">:</div></td>
                <td><label>

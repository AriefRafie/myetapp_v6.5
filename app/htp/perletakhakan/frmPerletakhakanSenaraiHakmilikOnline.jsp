<!--frmPerletakhakanSenaraiHakmilikOnline.jsp--> 
                          ...
                          <tr>
                            <td colspan="2">
                            	<div align="center">
                            		...
                            		<input type="submit" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="SimpanHakmilik()">&nbsp;&nbsp;
                            		<input type="reset" name="cmdBatal" id="cmdBatal" value="Batal" onclick="BatalHakmilik()">&nbsp;&nbsp;
                            		<input type="button" name="cmdKembali" id="cmdKembali" value="Kembali" onClick="KembaliHakmilik()">
                            	</div>
                            </td>
                          </tr>
                          <tr>

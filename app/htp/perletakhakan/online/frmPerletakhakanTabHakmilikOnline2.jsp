...
<table width="100%">
				...
				<table width="100%" border="0">
				  ...
				  <tr class="$row">
				    <td  width="1%">$list.bil.</td>
				        <td><a href="javascript:paparHakmilik('$list.idHakmilikurusan')"><font color="blue">$list.negeri</font></a></td>
				        <td>$list.daerah</td>
				        <td>$list.mukim</td>				        
	...
	<tr>
		<td align="center">
      		...
      		<input class="stylobutton" type="button" name="btnAdd2" id="btnAdd2" value="Simpan" onClick="simpanHakmilik()" /> 
      		<input class="stylobutton" name="cmdBatal" type="button" value="Batal" onClick="batal()"/> 
	    #end
	    #if ($mode == 'viewHakmilik')
	    	<input class="stylobutton" type="button" name="btnUpdate2" id="btnUpdate2" value="Kemaskini" onclick="kemaskiniHakmilik()" style="display:none"/>
	    	<input class="stylobutton" name="cmdBatal" type="button" value="Kembali" onClick="kembali()"/> 
	    	<input class="stylobutton" name="cmdSeterusnya" type="button" value="Maklumat Pemilik" onClick="pemilik()" style="display:none"/> 
	    #end 
	    #if ($mode == 'updateHakmilik')
	    	<input class="stylobutton" id="cmdUpdate" name="cmdUpdate" type="button" value="Simpan" onclick="simpanUpdateHakmilik()"/>
	    	<input class="stylobutton" id="cmdBatal" name="cmdBatal" type="button" value="Batal" onclick="batalUpdateHakmilik()"/>
	    #end  
	    #if ($mode == "")

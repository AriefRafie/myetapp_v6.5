...
<legend>Senarai Pelepasan Gadaian untuk Fail $NoFail</legend>
  ...
  <input name="add" value="Tambah" type="button" onclick="javascript:TambahPermohonanLepasGadai()" />
  &nbsp;&nbsp;
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      ...
      <tr>
        ...
        <td class="$row"><a href="javascript:viewDetailPemohonPelepasan('$permohonan.idFail','$permohonan.idPermohonan')">$permohonan.nama</a></td>

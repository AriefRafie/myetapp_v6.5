                                <table border="0" cellpadding="3" cellspacing="2" width="100%">
                                        ...
                                        <tr>
                                                ...
                                                <!--<strong>PERJANJIAN JUAL BELI TANAH DAN BANGUNAN YAYASAN MELAKA DI JALAN HANG TUAH PUSAT BANDAR MELAKA SEBAGAI KAMPUS UNIVERSITI TEKNOLOGI MARA (UITM) CAWANGAN MELAKA</strong>
                                                --><strong>$permohonanInfo.tujuan</strong>
                                                </td>
                                        ...
                                        <tr>
                                                ...
                                                <td colspan="4" height="2" width="39%">
                                                        <span id="form1:outputText1">Dengan hormatnya saya merujuk kepada </span><span id="form1:outputText2">perkara diatas.</span>
                                                </td>
                                                <td height="2" width="5%">&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                                ...
                                                <td colspan="4" height="2" width="39%"><p>2.
                                                  Bersama-sama ini dikembalikan dua (2) salinan borang pindahmilik 14A, enam (6) salinan borang PDS 15, dua (2) salinan borang permohonan untuk kebenaran pindahmilik dan borang akuan FIC SA/2004 yang telah ditandatangani oleh Persuruhjaya Tanah Persekutuan untuk tindakan tuan.</p>
                                          </td>
                                                <td height="2" width="5%">&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                                ...
                                                <td colspan="4" width="39%"><p>3.
                                                  ...
                                                  Setelah pindahmilik didaftarkan, sila kemukakan hakmilik asal ke Jabatan ini dengan segera bagi urusan pembayaran cukai dan kemaskini rekod tanah.</p>
                                          </td>
                                                <td width="5%">&nbsp;</td>
                                        </tr>
                                        <tr>

	...
	<tr>
  	...
  	<tr>
    	<td>
			<fieldset>
				<legend><strong>SENARAI HAKMILIK </strong></legend>
  					<table width="100%" >
						<tr>
				        	<td width="100%">
				  				<input class="stylobutton" type="button" name="cmdTambah" id="cmdTambah" value="Tambah" onclick="skrinTambahHakmilikPemilik('$permohonanInfo.idpermohonan')">      		
					        </td>
				 		<tr>	        
				 		<tr>
				        	<td width="100%">
								        ...
								        <tr>
								         ...
								         <!-- <td class="row2" width="29%"><strong>$senaraip.noRujukan</strong></td> $senaraip.idHakmilikurusanPB  --> 
								          <td width="27%" class="row2" align="left">
								          		...
								          		<input type="button"  class="stylobutton" name="cmdTambah2" id="cmdTambah2" value="Tambah Hakmilik" onclick="tambahHakmiliktoPemilik('$permohonanInfo.idpermohonan','$senaraip.idpihakberkepentingan')"/>
			...
			<p align="center">
				<div align="center">
        			<input class="stylobutton" type="button" name="cmdKembali" id="cmdKembali" value="Kembali" onclick="skrinKemaskiniPermohonan('$permohonanInfo.idpermohonan')">
  				</div>
			</p> 

...
<input type="hidden" name="idNegeri" id="idNegeri">

<fieldset style="width:95%;margin:auto">	

	<div style="text-align:center;font-size:12px;font-weight:bold">
		LAPORAN MAKLUMAT TANAH PESURUHJAYA TANAH PERSEKUTUAN DI 
		#if($idNegeri!="0" && $idNegeri!="14" && $idNegeri!="15" && $idNegeri!="16" && $idNegeri!="17" )
			NEGERI 
		#end	
		$!namaNegeri
	</div>
	...
	#if($listDbPTPByNegeriDetail.size() > 20)
	...
	<table style="width:100%;" border="0"> 
		<tr class="table_header">
			...
			#foreach($list in $listDbPTPByNegeriDetail)
				#set( $i = $velocityCount )
         		#if ( ($i % 2) != 1 )
              		 #set( $row = "row2" )
         		#else
		...
		<table style="width:100%">
			<tr>
				<td style="text-align:center">
					<input type="button" name="cmdCetak" id="cmdCetak" value="Cetak" onclick="doCetakReportNegeriDetail('$!idNegeri')" />
					...
					<input type="button" name="cmdLaporanNegeri" id="cmdLaporanNegeri" value="Senarai Negeri" onclick="doViewReportNegeri()" />
				</td>
			</tr>
		</table>

...
<fieldset style="width:95%;margin:auto">	
	...
	<div style="text-align:center;font-size:12px;font-weight:bold">LAPORAN MAKLUMAT TANAH PESURUHJAYA TANAH PERSEKUTUAN MENGIKUT KEMENTERIAN</div>
	...
	<table style="width:100%;" border="0"> 
		<tr class="table_header">
			...
			#foreach($list in $listDbPTPByKementerian)
				#set( $i = $velocityCount )
         		#if ( ($i % 2) != 1 )
              		 #set( $row = "row2" )
         		#else
				...
				<tr>
					...
					<td class="$row">
						<a href="javascript:doViewKementerianDetail('$!list.id_kementerian')"><font color="blue">
							$!list.kementerian
						</font></a>
					</td>
					<td class="$row">
		...
		<table style="width:100%">
			<tr>
				<td style="text-align:center">
					<input type="button" name="cmdCetak" id="cmdCetak" value="Cetak" onclick="doCetakKementerian()" />

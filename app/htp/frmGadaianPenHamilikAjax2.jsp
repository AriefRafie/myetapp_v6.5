...
<table width="100%" border="0">
  <tr>
    <td width="28%"><font color="#FF0000">*</font>Tarikh Terima Hakmilik</td>
    <td width="1%">:</td>
...
<table width="100%" border="0">
  <tr>
    <td align="center">
        ...
        <input type="button" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onclick="javascript:fGPHA_Kemaskini()">&nbsp;&nbsp;<input type="button" name="cmdSeterusnya" id="cmdSeterusnya" value="Seterusnya" onclick="javascript:fGPHA_seterusnya()">

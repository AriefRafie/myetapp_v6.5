...
<fieldset >	
    ...
    <input type="button" id="cmdAddtukarpegawaiKPP" name="cmdAddtukarpegawaiKPP" value="Permohonan Tukar Pegawai" onClick="setingTrDiv('','');doDivAjaxCall$formname('view_tukarpegawaiKPP','openSkrinTukarPegawai','scrolPosition='+getPageLocation());" >
    </td>
    </tr>
    </table>
    -->
	...
	<tr class="table_header" >
		...
		<tr  >
               ...
               <!--
               #if($pr.PERBICARAAN_EXP == "Y")
               <br />
               <font color="red"><i>Luput</i></font>
               #end	 
               -->   
               </td>
			   ...
			   <a href="javascript:document.getElementById('listPermohonanTukarPegawai').style.display = 'none';document.getElementById('cmdKembaliSenaraiTukarPegawai').style.display = '';doDivAjaxCall$formname('view_tukarpegawaiKPP','openSkrinTukarPegawai','div=view_tukarpegawaiKPP&ID_PERMOHONAN=$pr.ID_PERMOHONAN&ID_TUKARPEGAWAI=$pr.ID_TUKARPEGAWAI&FIELD_PK=ID_TUKARPEGAWAI&NAMA_TABLE=TBLPPKTUKARPEGAWAI&ID_FAIL=$pr.ID_FAIL&PERBICARAAN_EXP=$pr.PERBICARAAN_EXP&ID_SIMATI=$pr.ID_SIMATI&ID_PERMOHONANSIMATI=$pr.ID_PERMOHONANSIMATI&ID_PERBICARAAN=$pr.ID_PERBICARAAN&skrinName=tukarpegawaiKPP&openFrom=list')"><img title="Kemaskini" src="../img/edit.gif" border="0"></a>	   	
                ...
                <!--
                :::::::::::::::: $pr 
                {ID_TUKARPEGAWAI=991861, TARIKH_BICARA=02/10/2017, MASA_BICARA=12.10 TENGAH HARI, USER_ID_PEGAWAIASAL=16139630, ID_PELULUS=, BIL_BICARA=1, ID_PEGAWAIBARU=314463, STATUS_TUKARPEGAWAI=1, USER_ID_PEGAWAIBARU=, ID_NEGERIPEGAWAIASAL=3, ID_PEGAWAIASAL=314444, NO_TUKARPEGAWAI=TP/2018/03/PPK/000019, NAMA_PEGAWAI_BARU= TUAN HAJI MOHD ZIN BIN DOLLAH, ID_PERMOHONAN=317564742, ID_SIMATI=317548622, ID_PERBICARAAN=317361820, rowCss=row1, NAMA_PEGAWAI_ASAL=KHAIRIAH BINTI AWANG LAH, NO_FAIL=JKPTG/PK/03/10/0125/2017, ID_FAIL=317566030, STATUS_BICARA=PROSES PERBICARAAN, NAMA_NEGERI_PEGAWAI_GANTI=KELANTAN, KETERANGAN_STATUS_TUKARPEGAWAI=PERMOHONAN BARU, ID_NEGERIPEGAWAIBARU=3, BIL=1, ID_PEMOHON=16139630, ID_PERMOHONANSIMATI=317573897} 
                -->

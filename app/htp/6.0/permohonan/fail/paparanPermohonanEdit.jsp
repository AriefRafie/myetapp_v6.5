...
<!-- 					                <td width="35%" align="left">DAERAH</td>
 -->					                <td width="35%" align="left">
			              		...
			              		<tr>
					                ...
					                <td width="1%" valign="top">:</td>
					                <td width="63%">
					                	<textarea $!disability name="txtTajuk" id="txtTajuk" cols="41" rows="5" 
        					...
        					<table width="100%" border="0">
        						<tr> 
			              		...
			              		<tr> 
					        		...
					        		<td width="1%"><div align="center">:</div></td>
					        		<td width="68%">
										<input type="text" name="txtnoFailKJP" value="$!txtnoFailKJP" size="43" maxlength="50" $!disability onblur="this.value=this.value.toUpperCase();"  />
					          		</td>
					        		<!--
				             	...
				             	<tr>
					               ...
					               <td width="30%" align="left">TARIKH SURAT KJP</td>
					                ...
					                <td width="68%" valign="center">
					                	<input type="text" name="txdTarikhSuratKJP" value="$!txdTarikhSuratKJP" size="11" maxlength="10" $!disability onblur="check_date(this)" />
					            		#if($!readOnly == "")
			              		...
			              		<tr>
					        		...
					        		<td width="1%"><div align="center">:</div></td>
					        		<td width="68%">
										<input  type="text" name="txtnoFailUPT"  value="$!txtnoFailUPT" size="43" $!disability onblur="this.value=this.value.toUpperCase();"/>
					          		</td>	
	...
	<tr>
		...
		<td align="center">
			...
			<input type="button" class="stylobutton100" name="cmdKembali" id="cmdKembali" value="Batal" onclick="kembali()"/>
		</td>
	#end		
	</tr>
#else
...
alert('simpan 1');
	...
	alert('me here vo2/fail.failedit');

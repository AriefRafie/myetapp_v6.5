...
<table width="100%" border="0">
  ...
  <tr>
	<!-- Selain Sarawak     <td width="29%"><div align="right">Daerah</div></td> -->    
	<td width="29%"><div align="right">$!labelDaerah</div></td>
    <td width="1%">:</td>
  ...
  <tr>
    ...
    <td width="1%">:</td>
    <td width="70%"><input name="txtNoPermohonanOnline" type="text" id="txtNoPermohonanOnline" size="43" value="$!txtNoPermohonanOnline"></td>
  </tr>
  <tr>
    <td width="29%"><div align="right">Tajuk Fail</div></td>
    <td width="1%">:</td>
    <td width="70%">
    	<input name="txtTajukFail" type="text" id="txtTajukFail" size="43" value="$!txtTajukCarian">
    	#if ($flagAdvSearch == '')
  ...
  <tr>
    <td width="29%"><div align="right">Tarikh Surat KJP</div></td>
    <td width="1%">:</td>
    <td width="70%">
    	<input $readOnly class="$disabled" name="txdtarikhsuratfail" type="text" onblur="check_date(this)" value="$!txdtarikhsuratfail" size="11" maxlength="10"/>
		<a href="javascript:displayDatePicker('txdtarikhsuratfail',false,'dmy');"> <img src="../img/calendar.gif" alt="" border="0"/></a>					          
    </td>
  </tr>  
  <tr>
    ...
    <tr>
    <td width="29%"><div align="right">Tarikh Hantar</div></td>
    <td width="1%">:</td>
    <td width="70%">
    	<input $readOnly class="$disabled" name="txdtarikhantarfail" type="text" onblur="check_date(this)" value="$!txdtarikhantarfail" size="11" maxlength="10"/>
		<a href="javascript:displayDatePicker('txdtarikhantarfail',false,'dmy');"> <img src="../img/calendar.gif" alt="" border="0"/></a>					          
    </td>
  </tr>
    <tr>
    <td width="29%"><div align="right">Tarikh Keputusan</div></td>
    <td width="1%">:</td>
    <td width="70%">
    	<input $readOnly class="$disabled" name="txdtarikhkeputusanfail" type="text" onblur="check_date(this)" value="$!txdtarikhkeputusanfail" size="11" maxlength="10"/>
		<a href="javascript:displayDatePicker('txdtarikhkeputusanfail',false,'dmy');"> <img src="../img/calendar.gif" alt="" border="0"/></a>					          
    </td>
  </tr>
#end  
  <tr>
...
<table width="100%" border="0">
	...
	<tr >
		   ...
		   #parse("$PAGES")
		   ##parse("app/htp/6.0/permohonan/recordPageList.jsp")
		   </td>		     
	</tr>
	#end
  <tr class="table_header">
    <td width="3%" align="center"><strong>Bil.</strong></td>
    <!-- <td width="18%"><b>No. Rujukan Online</b></td> -->
    <td width="17%"><strong>No. Fail</strong></td>
    <td width="30%"><strong>Tajuk Fail</strong></td>
    <td width="12%"><strong>Negeri</strong></td>
    <td width="7%" align="center"><strong>Tarikh Surat</strong></td>
    <td width="7%" align="center"><strong>Tarikh Daftar Fail</strong></td>
    <td width="7%" align="center"><strong>Tarikh Hantar</strong></td>
    <td width="7%" align="center"><strong>Tarikh Keputusan</strong></td>
 ...
 #foreach ( $senarai in $SenaraiFail )
  ##foreach ( $senarai in $senaraiList1 )
                ...
                #set( $i = $velocityCount )
                    ...
                    #set( $row = "row1" )
                #end
		#set($params ="nofail="+$!senarai.no+"&kod="+$!senarai.gisStatus+"&upi=TIADA")        
                
  <tr class="$row">
    <td align="center">$!senarai.bil.</td>
    <!-- <td>
    	<a href="javascript:viewMaklumatPermohonan('$!senarai.id')" class="style1">$!senarai.noP</a>
    </td> -->
    <td>
    	<a href="javascript:viewMaklumatPermohonan('$!senarai.id')" class="style1">$!senarai.no</a>
<!--     	<a href="javascript:viewFailById('$list.idFail','$list.idPermohonan','$list.idHtpPermohonan','$list.idSuburusanStatusFail')"></a> -->    
	</td>
    <td >$!senarai.tujuan     	
    	<br><a href="javascript:viewMaklumatPermohonan('$!senarai.id')" class="style1">$!senarai.bilTanah</a>
    </td>
    <td >$!senarai.negeri</td>
    <td align="center">$!senarai.tarikhSurat</td>
    <td align="center">$!senarai.tarikhDaftar</td>
    <td align="center">$!senarai.tarikhHantar</td>
    <td align="center">$!senarai.tarikhKeputusan $!senarai.keputusan</td>
    <td align="center">$!senarai.keterangan
  	#if ($senarai.gisCharting != 'N')			      				 									      				
		<br><a alt="GIS" href = "javascript:gisWindow('TIADA','$!maklumatGis');">
			<img border="0" src="../img/online/map.png" width="20" height="15"/>
		</a>
	#end  
    #if ($!gisPage == 'GIS' && $!senarai.gisHantar == 'N')
      	<br><a href = "javascript:tambahGISPermohonan('$!senarai.no','$!senarai.gisStatus');">
   ...
   <tr>
    ...
    <td class="row1" colspan="7">Tiada Rekod</td>
    <!-- <td class="row1">&nbsp;</td>
    <td class="row1" align="center">&nbsp;</td>
    <td class="row1">&nbsp;</td> -->
   </tr>
...
<script>
	...
	function tambahGISPermohonan(file,perolehan){
		tambahGIS(file,perolehan);
	}
...
function DateAdd(ItemType, DateToWorkOn, ValueToBeAdded)
{
	...
	function Xkemaskiniterimapermohonan(id){
		var mode = 'MakAsasTanah';
...
*/
	...
	function Notis5AHapus(id){
		var command = 'kemaskinipermohonan';
		var mode = 'Notis5A';
		var button = 'HapusNotis';
		var tabId = 5;
		var tabmode = 2;
		doAjaxCall${formName}(command,'&mode='+mode+'&tabId='+tabId+'&tabmode='+tabmode+'&button='+button+'&idNotis='+id);
...
function BayaranNotis(id){
	var baucer = document.getElementById("txtNoBaucer").value;
	var resit = document.getElementById("txtNoResit").value; 
	...
	if(baucer!="" || resit!=""){
		...
		alert("Tiada Maklumat Baucer/Resit Yang Boleh Disimpan");
	}
...
function Hapus(){
	...
	//2017/07/02
	function cetakJadual1(idpermohonan,idnegeri) {	
		
		if(idnegeri==12 || idnegeri==13 || idnegeri==15){
			alert('Tiada Jadual 1 bagi negeri terlibat.');
			return;
		}
	    var url = "../servlet/ekptg.report.htp.NoFailTajukFail?template=HTPermohonanJadual1_"+idnegeri+"&idpermohonan="+idpermohonan;
	    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
	    if ((document.window != null) && (!hWnd.opener))
		hWnd.opener = document.window;
	    if (hWnd.focus != null) hWnd.focus();

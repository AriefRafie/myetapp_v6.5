        ...
        <td>&nbsp;</td>
      				...
      				<tr>
				    	<td align="center" colspan="3" >
				        	<input name="cari" value="Cari" type="button" class="stylobutton100" onclick="javascript:fSFGA_search_data()">
				        	<input name="Reset" value="Kosongkan" type="reset" class="stylobutton100">
				        </td>
      				</tr>      
...
//
	...
	function cmdKembaliSenaraiHakmilik() {
		document.${formName}.namaskrin.value = "";
		doAjaxCall${formName}("");

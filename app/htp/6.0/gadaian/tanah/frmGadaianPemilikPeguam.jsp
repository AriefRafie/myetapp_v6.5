...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
			...
			<fieldset>
			 <div id="TabbedPanels1" class="TabbedPanels">
			              ...
			              <ul class="TabbedPanelsTabGroup">
			                ...
			                onclick="setSelected(0,'hakmilikview')">PEMILIK</li>
			                <!--			                
			              ...
			              <div class="TabbedPanelsContentGroup">
			                ...
			                <!-- div maklumat peminjam -->
			                	...
			                	#parse ("app/htp/gadaian/hakmilik/frmGadaianMaklumatPeminjamAjax.jsp")
			                #end
	...
	<tr>
		<td colspan="2" align="center">
         <input type="button" class="stylobutton100" name="cmdkembalipermohonan" id="cmdSimpan" value="Kembali" onclick="javascript:cmdSenaraiHakmilik('$permohonan.idPermohonan')">
		</td>
	</tr> -->

...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
    ...
    <tr>
		<td align="center">        
        	...
        	<input type="button" name="cmdSimpan" value="Simpan" class="stylobutton100" onClick="javascript:fGS2A_Simpan()" />
        	<input type="reset" name="cmdBatal" $btnName class="stylobutton100" onClick="javascript:fGS2A_Batal()" />
        	<input type="button" name="cmdKembali" value="Kembali" class="stylobutton100" onclick="javascript:fGS2A_Kembali()" />       
        #elseif ($pagemode == "view")
        	<input type="button" name="cmdKemaskini" value="Kemaskini" class="stylobutton100" onClick="jaavascript:fGS2A_Kemaskini()" />
        	<input type="button" name="cmdSeterusnya" value="Seterusnya" class="stylobutton100" onClick="javascript:fGS2A_Seterusnya()" />
        #end             
        </td>
	</tr>	
</table>

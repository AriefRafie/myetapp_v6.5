			...
			<fieldset>
			 <div id="TabbedPanels1" class="TabbedPanels">
			              ...
			              <ul class="TabbedPanelsTabGroup">
			                ...
			                onclick="setSelected(2,'selesaiview')">PENGHANTARAN/SELESAI</li> 
			              </ul>
			              ...
			              <div class="TabbedPanelsContentGroup">
			                ...
			                #if($selectedTab == '0')
			                	#parse ("app/htp/gadaian/frmGadaianPelepasanMaklumatPeminjam.jsp")
			                #end
			                ...
			                #if($selectedTab == '1')
			                	#parse ("app/htp/gadaian/frmGadaianPelepasanMaklumatPeguam.jsp")
			                #end

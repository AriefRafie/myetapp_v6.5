			  ...
			  <table border="0" width="100%">
			      ...
			      <tr>
			        <td align="center" colspan="3">
			        	<input type="button" class="stylobutton100_" name="cari" value="Cari" onclick="javascript:fGSPA_search_data();">
			        	<input type="reset" class="stylobutton100_" name="reset" value="Kosongkan" >
			        </td>
			      </tr>
			  </table>
		...
		<fieldset>
			<legend>SENARAI PERMOHONAN GADAIAN UNTUK FAIL $NoFail</legend>
  			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
        			<td>
   						<input type="button" class="stylobutton100_" name="add" value="Tambah" onclick="javascript:fGSPA_Tambah()" />
        			</td>
        		<tr>       			
		    </table>

        ...
        <td>&nbsp;</td>
      				...
      				<tr>
				    	<td align="center" colspan="3" >
				        	<input name="cari" value="Cari" type="button" class="stylobutton_" onclick="javascript:fSFGA_search_data()">
				        	<input name="Reset" value="Kosongkan" type="reset" class="stylobutton_">
				        </td>
      				</tr>      
	...
	<tr>
		<td>
			<fieldset><legend><strong>SENARAI FAIL</strong></legend>
				<input type="button" class="stylobutton_" name="add" value="Tambah"  onClick="fSFGA_Tambah()" >

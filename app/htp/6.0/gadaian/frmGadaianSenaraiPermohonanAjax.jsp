			  ...
			  <table border="0" width="100%">
			      ...
			      <tr>
			        <td align="center" colspan="3">
			        	<input type="button" class="stylobutton_" name="cari" value="Cari" onclick="javascript:fGSPA_search_data();">
			        	<input type="reset" class="stylobutton_" name="reset" value="Kosongkan" >
			        </td>
			      </tr>
			  </table>
		...
		<fieldset>
			<legend>SENARAI PERMOHONAN GADAIAN UNTUK FAIL $NoFail</legend>
  			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
        			<td>
   						<input type="button" class="stylobutton_" name="add" value="Tambah" onclick="javascript:fGSPA_Tambah()" />
						<input type="button" class="stylobutton_" name="kembali" value="Kembali"  onclick="javascript:fGSPA_Kembali()">       				
        			</td>
        		<tr>       			
		    </table>

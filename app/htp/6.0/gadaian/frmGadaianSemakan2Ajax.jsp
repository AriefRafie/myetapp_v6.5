...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
		...
		<td>
			...
			<fieldset><legend><strong>MAKLUMAT FAIL</strong></legend>
		        ...
		        <td align="center" valign="top" width="50%"><table width="100%" border="0">
		              <tr>
		                <td width="3%"><div align="right"><font color="#FF0000">*</font></div></td>
		                <td width="31%"><div align="left">No. Fail</div></td>
		                <td width="2%">:</td>
		                <td width="64%">
		                 #if ($idFail == "")
    ...
    <tr>
		<td align="center">        
        	...
        	<input type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" class="stylobutton_" onClick="javascript:fGS2A_Simpan()" />
        	<input type="reset" name="cmdBatal" id="cmdBatal" $btnName class="stylobutton_" onClick="javascript:fGS2A_Batal()" />
        	<input type="button" style="display:none" name="cmdKembali" id="cmdKembali" value="Kembali" class="stylobutton_" onclick="javascript:fGS2A_Kembali()" />       
        #elseif ($pagemode == "view")
        	<input type="button" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" class="stylobutton_" onClick="jaavascript:fGS2A_Kemaskini()" />
        	<input type="button" name="cmdSeterusnya" id="cmdSeterusnya" value="Seterusnya" class="stylobutton_" onClick="javascript:fGS2A_Seterusnya()" />
        #end             
        </td>
	</tr>	
</table>

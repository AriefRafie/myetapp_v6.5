...
#end
#if ($!idSuburusan.equals("45") || $!idSuburusan.equals("38"))
    #set ($noRujukan = "PP:")
#end
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr>
		...
		#if($pagemode == 'baru' || $pagemode == 'kemaskini')
        	<input type="button" class="stylobutton_" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="javascript:fGSA_Simpan()">
        	<input type="reset" class="stylobutton_" name="cmdBatal" id="cmdBatal" $btnName onclick="javascript:fGSA_Batal()">

        #elseif($pagemode == 'simpan')     
       		<input type="button" class="stylobutton_" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onclick="javascript:fGSA_Kemaskini()">
       		<input type="button" class="stylobutton_" name="cmdSeterusnya" id="cmdSeterusnya" value="Seterusnya" onclick="javascript:fGSA_Seterusnya()">
        
       	#else    
       	<input type="button" class="stylobutton_" name="cmdKembali" id="cmdKembali" value="Kembali" onClick="javascript:fGSA_Kembali()">
       	<input type="button" class="stylobutton_" name="cmdSeterusnya" id="cmdSeterusnya" value="Seterusnya" onclick="javascript:fGSA_Seterusnya()">

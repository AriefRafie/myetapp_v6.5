...
<fieldset><legend><strong>MAKLUMAT GERAN</strong></legend>
	...
	<p>	
	#if($pagemode == 'baru')
		<div align="center">
     		<input type="button" class="stylobutton100" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="javascript:fGTG_SimpanGeran()">
		...
		<div align="center">
        	<input type="button" class="stylobutton100" name="cmdSimpan2" id="cmdSimpan2" value="Simpan" onclick="javascript:fGTG_SimpanUpdateGeran()"/>
            
		</div>
    #elseif($pagemode == 'view')
		<div align="center">
        	<input type="button" class="stylobutton100" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onclick="javascript:fGTG_KemaskiniGeran()">

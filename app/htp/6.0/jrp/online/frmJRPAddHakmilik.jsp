...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr>
    	<td>	
							...
							<fieldset>
								...
								<table width="100%" border="0">
									...
									<tr>
										...
										<td width="1%"></td>
										<td width="58%"><input type="text" name="txtnohakmilik"
											size="30" value=""
									...
									<tr>
										...
										<td width="1%">:</td>
										<td width="68%"><span class="labeldisplay"><span
												class="labelinput">No.Bang</span>&nbsp; <input
												name="noBangunan" type="text" class="$disabled"
												id="noBangunan" value="" size="3" maxlength="3" $readonly
												onkeyup="this.value=this.value.toUpperCase();" /> <span
												class="labelinput">No.Ting</span>&nbsp; <input
												name="noTingkat" type="text" class="$disabled"
												id="noTingkat" value="" size="3" maxlength="3" $readonly
												onkeyup="this.value=this.value.toUpperCase();" /> <span
												class="labelinput">No.Petak</span>&nbsp; <input
												name="noPetak" type="text" class="$disabled" id="noPetak"
												value="" size="3" maxlength="3" $readonly
									...
									<tr>
										...
										<td width="30%"></td>
										<td width="1%"></td>
										<td width="68%"><input type="text" name="txtnolot"
											size="15" onkeyup="this.value=this.value.toUpperCase();"
											maxlength="20" /></td>
									</tr>
							...
							<fieldset>
								...
								<table width="100%" border="0">
									<tr>
										...
										<td width="1%">:</td>
										<td width="58%"><input type="text" name="txtnorujukan"
											size="30" value="$!pihakKepentigan.noRujukan"
											readonly="readonly" disabled="disabled" class="disabled"></td>
									</tr>
									<tr>
										<td width="1%"></td>
										<td width="40%">
										...
										<td width="1%">:</td>
										<td width="58%"><input type="text" name="txtnama"
											size="30" value="$!pihakKepentigan.nama" readonly
									...
									<tr>
										...
										<td width="1%">:</td>
										<td width="58%"><input type="text" name="txtalamat1"
											size="30" value="$!pihakKepentigan.alamat1" readonly
											disabled="disabled" class="disabled" /></td>
									</tr>
									<tr>
										<td width="1%">&nbsp;</td>
										...
										<td width="63%"><input type="text" name="txtalamat2"
											size="30" value="$!pihakKepentigan.alamat2" readonly
											disabled="disabled" class="disabled"></td>
									</tr>
									<tr>
										<td width="1%">&nbsp;</td>
										...
										<td width="63%"><input type="text" name="txtalamat3"
											size="30" value="$!pihakKepentigan.alamat3" readonly
											disabled="disabled" class="disabled"></td>
									</tr>
									<tr>
										<td width="1%">&nbsp;</td>
										...
										<td width="63%"><input type="text" name="txtposkod"
											maxlength="5" size="5"
											onkeyup="validatePoskod(this,this.value);"
											value="$!pihakKepentigan.poskod" readonly disabled="disabled"
											class="disabled" /></td>
									</tr>
									<tr>
										<td width="1%"></td>
									...
									<tr>
										...
										<td width="1%">:</td>
										<td width="58%"><input type="text" name="txtnotelefon"
											size="30" value="$!pihakKepentigan.noTel" readonly
											disabled="disabled" class="disabled"></td>
									</tr>

									<input type="hidden" name="idnegeri" size="30"
										value="$idnegeri" />
								</table>
							</fieldset>
						</td>
			...
			<p align="center">
				<div align="center">
					<input class="stylobutton100" type="button" name="cmdX" id="cmdX" value="Simpan" onclick="tambahMaklumatPemilik('$permohonanInfo.idpermohonan')">
					<input class="stylobutton100" type="reset" name="cmdBatal" id="cmdBatal" value="Kosongkan">
					<input class="stylobutton100" type="button" name="cmdX" id="cmdX" value="Batal" onclick="skrinSenaraiHakmilikPemilik('$permohonanInfo.idpermohonan')">
				</div>
			</p>

...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr>
    	<td>   		
			...
			<fieldset>
				<legend>SENARAI FAIL JAWATANKUASA RUANG PEJABAT (JRP)</legend>
				...
				#parse("app/utils/record_paging.jsp")
			  	<table width="100%" cellspacing="2" cellpadding="1" border="0">
				  	...
				  	<tr>
				  		...
				  		<td class="$row">
						  	<a  href="javascript:senaraiPermohonan('$senarai.id','$senarai.idPermohonan')" class="style1">
							$senarai.no </a>[<a href="javascript:tajukPermohonan('$senarai.id')" class="style1">Edit</a>]
...
function senaraiPermohonan(id,idPermohonan) {
	document.${formName}.langkah.value = '0->-1';
	document.${formName}.fail.value = id;
	doAjaxCall${formName}("pksenaraipermohonan","idpermohonan="+idPermohonan);	

}

//function senaraiPermohonanDariBatal(id) {
	function senaraiPermohonanDariBatal(id,idPermohonan) {
		//document.${formName}.langkah.value = '0->-1';
		document.${formName}.fail.value = id;
		doAjaxCall${formName}("pksenaraipermohonan","&langkah=0->-1&idpermohonan="+idPermohonan);	
...
// end of frmKJPPajakanKecilSenaraiFail.jsp 	
...
function backPreSenaraiPermohonan(id,idpermohonan) {
	...
	//Senarai Fail
	function backMain() {
		doAjaxCall${formName}("","langkah=0->0&page_=tajuk");
	}
...
function screen7(id){
	...
	function deletePemilik(idPermohonan,idPemilikPB){
		...
		doAjaxCall${formName}('deletePemilik',"id_permohonan="+idPermohonan+"&idPemilikPB="+idPemilikPB);
	}

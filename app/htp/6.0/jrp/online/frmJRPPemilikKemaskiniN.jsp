	...
	<tr>
  	...
  	<tr>
    	<td>
								              ...
								              <td width="1%">:</td>
												...
												<tr>
													...
													<td width="64%"><input type="text"
														name="txtnohakmilik" size="30" value="$!nohakmilik"
														onkeyup="this.value=this.value.toUpperCase();" /></td>
												</tr>
												<tr>
													<td width="2%"><span class="labelmandatory">
															<!--*-->
													</span></td>
													<td width="32%">
														<div align="right" class="labelinput">
													...
													<td width="2%">:</td>
													<td width="64%"><span class="labeldisplay"><span
												...
												<tr>
													...
													<td></td>
													<td></td>
													<td><input type="text" name="txtnolot" size="15"
														value="$!nolot"
														onkeyup="this.value=this.value.toUpperCase();" /></td>
												</tr>
											</table>
										...
										<fieldset>
											...
											<table width="100%" border="0">
												<tr>
													...
													<td width="1%">:</td>
													<td width="58%"><input type="checkbox" name="copy"
												...
												<tr>
													...
													<td width="63%"><input type="text" name="txtposkod"
														maxlength="5" size="5" value="$!poskod"
			...
			<p align="center">
				<div align="center">
					<input class="stylobutton100" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="tambahMaklumatPemilik('$permohonanInfo.idpermohonan')">
					<input class="stylobutton100" type="reset" name="cmdBatal" id="cmdBatal" value="Kosongkan">
					<input class="stylobutton100" type="button" name="cmdKembali" id="cmdKembali" value="Batal" onclick="skrinSenaraiHakmilikPemilik('$permohonanInfo.idpermohonan')">  				
				</div>
			</p> 

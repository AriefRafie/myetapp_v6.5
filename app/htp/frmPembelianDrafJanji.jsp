    	...
    	<td>
            <div id="TabbedPanels1" class="TabbedPanels">
              <ul class="TabbedPanelsTabGroup">
                <li class="TabbedPanelsTab" title="Kelulusan" onclick="setSelected(0);HakmilikView()"><strong><font size="1">Kelulusan</font></strong></li>
                <li class="TabbedPanelsTab" title="Draf" onclick="setSelected(1);PeguamView()"><strong><font size="1">Draf Perjanjian</font></strong></li>
              </ul>
                        ...
                        <tr>
                            <td colspan="2"><div align="left">
                              <fieldset>
                            	...
                            	<table width="100%" border="0">
  									<tr>
                            			<td width="20%"><div align="right"><font color="#FF0000">*</font>Keputusan :</div></td>
                            			<td width="80%">$selectDaerah</td>
                          			</tr>
                          			<tr>
                            			<td><div align="right"><font color="#FF0000">*</font>No. Rujukan Surat :</div></td>
                            ...
                            <td colspan="2"><div align="left">
                              <fieldset>
                            	...
                            	<table width="100%" border="0">
                          			...
                          			<tr>
                            			<td width="100%" colspan="2"><div align="left"><strong></strong>
                              				<table width="100%" border="0">
                                				<tr>
                                  					<th width="10%" scope="col">Bil</th>
                                 					<th width="20%" scope="col">Tarikh Terima Draf Perjanjian</th>
                                  					<th width="50%" scope="col">Ulasan</th>
                                  					<th width="20%" scope="col">Tarikh Hantar Pembetulan Draf</th>
                               					</tr>
                                				<tr>
                                  				  <td>&nbsp;</td>
                                                  <td>&nbsp;</td>

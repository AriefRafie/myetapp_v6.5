...
<table width="1008" border="1">
  ...
  <tr>
    <td><table width="954" border="0" align="center">
      <tr>
        <td colspan="6"><strong>Pergerakan Hakmilik</strong></td>
        </tr>
      <tr>
        <td width="160" height="26">Tarikh</td>
        <td colspan="2"><div align="center">Keterangan</div></td>
        <td width="84">Bil. Photostat</td>
        <td width="370" colspan="2"><div align="center">Status</div></td>
        </tr>
      <tr>
        <td height="23">&nbsp;</td>
        <td colspan="2">&nbsp;</td>

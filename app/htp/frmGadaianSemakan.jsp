...
#end<strong>Pendaftaran Gadaian</strong><br>
      ...
      <tr>
		<td align="center" valign="top" width="50%"><table width="100%" border="0">
              ...
              <tr>
                ...
                <td valign="top">:</td>
                <td><label>
                  <textarea name="Tajuk" id="Tajuk" cols="45" rows="3" disabled="disabled">$tajuk</textarea>
                </label>
        ...
        <td align="center" valign="top" width="50%"><table width="100%" border="0">
              <tr>
                ...
                <td width="2%">:</td>
                <td width="65%"><input type="text" name="txtNoFailSek" maxlength="400" size="40" value="$noFail" readonly="readonly"></td>
              </tr>
              <tr>
                <td><div align="right"><font color="#FF0000">*</font></div></td>
                <td><div align="left"><strong>No. Fail Lain</strong></div></td>
                <td>:</td>
                <td><input type="text" name="txtNoFailLain" id="txtNoFailLain" size="40" maxlength="50" onkeyup="this.value=this.value.toUpperCase();" value="$noRujukan" $mode /></td>
              </tr>
              <tr>
                <td><div align="right"><font color="#FF0000">*</font></div></td>

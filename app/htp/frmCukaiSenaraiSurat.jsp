...
<br>
<fieldset>
  <legend><strong>Senarai Surat Cukai</strong></legend>
   <table width="100%" cellspacing="0" cellpadding="0" border="0">
  <p></p>
  	<tr> 
		<td class="row1">1).<a class="style1" href="javascript:showWindow('ekptg.view.htp.FrmCukaiSenaraiSurat?command=memo&idpermohonan=$permohonanInfo.idpermohonan')">
		Memo Baucer Cukai</a></td>
	</tr>
	<tr> 
		<td class="row2">2).<a class="style1" href="javascript:showWindow('ekptg.view.htp.FrmCukaiSenaraiSurat?command=cukailebih&idpermohonan=$permohonanInfo.idpermohonan')">
		Surat Makluman Status Bayaran Lebihan Cukai</a>
		</td>
	</tr>
	<tr> 
		<td class="row1">3).<a href="javascript:showWindow('ekptg.view.htp.FrmCukaiSenaraiSurat?command=pegesahansenarai&idpermohonan=$permohonanInfo.idpermohonan')">
		Surat Pengesahan Senarai Cukai</a>
		</td>
	</tr>
	<tr> 
		<td>3).<a href="javascript:showWindow('ekptg.view.htp.FrmPKSuratTandatanganBL?id_kemaskini=$permohonanInfo.idpermohonan')">
		Surat Makluman Tandatangan Borang L</a></td>
	</tr> 
	<tr> 
		<td>4).<a href="javascript:showWindow('ekptg.view.htp.FrmPKSuratKembaliBL?id_kemaskini=$permohonanInfo.idpermohonan')">
		Surat Makluman Mengembalikan Borang L</a></td>
	</tr>
	<tr> 
		<td>5).<a href="javascript:showWindow('ekptg.view.htp.FrmPKMemo?id_kemaskini=$permohonanInfo.idpermohonan')">
		Memo Kepada PKP</a></td>
	</tr>
	<tr> 
		<td>6).<a href="javascript:showWindow('ekptg.view.htp.FrmCukaiSenaraiSurat?command=memopenawaran&idpermohonan=$permohonanInfo.idpermohonan')">
		Memo Penawaran</a></td>
	</tr> 	 

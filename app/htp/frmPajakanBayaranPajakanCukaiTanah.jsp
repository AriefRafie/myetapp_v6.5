 ...
 #foreach ($beanBayaran in $BeanBayaranList)  
    ...
    <table width="100%" border="0">
      ...
      <tr>
        ...
        <td>No.</td>
        <td>:</td>
        <td><input type="text" name="txtNoBayaran" id="txtNoBayaran" size="15" value="$NoBayaran" class="$classDis" $readOnly onBlur="this.value=this.value.toUpperCase();" /></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>Nama Bank</td>
        <td>:</td>
        <td><input type="text" name="txtNamaBank" id="txtNamaBank" size="20" value="$namaBank"  class="$classDis" $readOnly onBlur="this.value=this.value.toUpperCase();" /></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td align="right">&nbsp;</td>
        <td>Tarikh Cek</td>
        <td>&nbsp;</td>
        <td><input type="text" name="txdTarikhCek" id="txdTarikhCek" size="10" value="$tarikhCek"  class="$classDis" $readOnly onblur="check_date(this)" />
      ...
      <tr>
        ...
        <td width="1%">:</td>
        <td width="41%"><input type="text" name="txdTarikhTerima" id="txdTarikhTerima" size="10" value="$tarikhTerima"  class="$classDis" $readOnly onblur="check_date(this)" />
      ...
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="txtJumlahBayaran" id="txtJumlahBayaran" size="20" value="$jumlahBayaran"  class="$classDis" $readOnly onblur="validateCurrency(this,this.value,'')"  /></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td align="right">#if($mode == 'updateBayaran' || $mode == 'newBayaran')<font color="#FF0000">*</font>#end</td>
        <td>No. Resit</td>
        <td>:</td>
        <td><input type="text" name="txtNoResit" id="txtNoResit" size="15" value="$NoResit" class="$classDis" $readOnly onBlur="this.value=this.value.toUpperCase();" /></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td align="right">#if($mode == 'updateBayaran' || $mode == 'newBayaran')<font color="#FF0000">*</font>#end</td>
        <td>Tarikh Resit</td>
        <td>&nbsp;</td>
        <td><input type="text" name="txdtarikhResit" id="txdtarikhResit" size="10" value="$tarikhResit"  class="$classDis" $readOnly onblur="check_date(this)" />
      ...
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="txdtarikhHantarResit" id="txdtarikhHantarResit" size="10" value="$tarikhHantarResit"  class="$classDis" $readOnly onblur="check_date(this)" />
...
<img src="../img/calendar.gif" alt="Calendar" border="0" onclick="displayDatePicker('txdtarikhHantarResit',false,'dmy');" /> 
      ...
      <tr>
        ...
        #if ($mode == 'newBayaran')
           	  <input class="stylobutton" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="javascript:SimpanBayaran()" />
                    <input class="stylobutton" type="reset" name="cmdBatal" id="cmdBatal" value="Kosongkan"/>
              <input class="stylobutton" type="button" name="cmdBatal" id="cmdBatal" value="Batal" onclick="javascript:BatalBayaran()" />
                #elseif ($mode == 'viewBayaran')
              <input class="stylobutton" type="button" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onclick="javascript:KemaskiniBayaran()" />
              <input class="stylobutton" type="button" name="cmdHapus" id="cmdHapus" value="Hapus" onclick="javascript:HapusBayaran()" />
                    <input class="stylobutton" type="button" name="cmdBatal" id="cmdBatal" value="Kembali" onclick="javascript:BatalBayaran()" />
                    
                #elseif ($mode == 'updateBayaran')
                    <input class="stylobutton" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="javascript:SimpanUpdateBayaran()" />
                    <input class="stylobutton" type="reset" name="cmdBatal" id="cmdBatal" value="Kosongkan"/>
                    <input class="stylobutton" type="button" name="cmdBatal" id="cmdBatal" value="Batal" onclick="javascript:batalUpdateBayaran()" />
                #end 
            </td>
        </tr>
    </table>
...
#if ($idFail != '' && $idStatus != '1' && $idStatus != '6' && $idStatus != '12' && $idStatus != '63' && $idStatus != '65' && $idStatus != '69' && $idStatus != '86' && $idStatus != '87')
	<tr>
    	<td>&nbsp;</td>
	</tr>
    	...
    	<td> 
		    ...
		    <div align="left">
			      <table width="100%" border="0">
			         #if ($mode == 'view')
			        <tr>
			          <td colspan="8" scope="col"><input class="stylobutton" type="button" name="cmdDaftar" id="cmdDaftar" value="Daftar Baru" onclick="javascript:daftarBaruBayaran()" />
			          </td>
			        </tr>
			        #end
			        <tr class="table_header">
			          ...
			          <td width="15%" align="center" scope="col"><strong>Nama Bank</strong></td>
			          <td width="11%" scope="col"><strong>Tarikh Resit</strong></td>
			          <td width="12%" scope="col"><strong>Tarikh Hantar Resit</strong></td>
			          <td width="15%" scope="col" valign="middle"><p><strong>Jumlah Bayaran</strong><strong>(RM)</strong></p></td>
			          </tr>
		        #set ($count = 0)

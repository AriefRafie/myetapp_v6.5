...
<table width="1008" border="1">
  ...
  <tr>
    <td><table width="954" border="0" align="center">
      ...
      <tr>
        <td height="26" colspan="6"><strong>SENARAI TRANSAKSI TANAH</strong></td>
        </tr>
      <tr>
        <td width="160" height="26">No. Fail Seksyen</td>
        <td colspan="2"><div align="center">Pemohon</div></td>
        <td width="84">Urusan</td>
        <td width="370" colspan="2"><div align="center">Tarikh Buka Fail</div></td>
        </tr>
      <tr>
        <td height="23">&nbsp;</td>
        <td colspan="2">&nbsp;</td>

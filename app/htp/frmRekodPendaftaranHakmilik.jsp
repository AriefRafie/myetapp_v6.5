  						...
  						<tr>
                   		...
                   		<tr>
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
								<input name="txtLuas" type="text" class="disabled" id="txtLuas" onkeyup="this.value=this.value.toUpperCase();" value="$!txtLuas" size="20" readonly="readonly"/>(Hektar) 							
							</td>
                		</tr>
                   		<tr>
  							<td width="1%"  >
                ...
                <td valign="top">
               		<table width="100%">
                   		<tr>
                        	...
                        	<td width="30%">
                            	<div align="left">
                            		<span class="labelinput">Rezab</span>
                            	</div>
                        	</td>
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="pautanms1" >
                   		...
                   		<tr>
                        	...
                        	<td width="30%">
                            	<div align="left">
                            		<span class="labelinput">No Rezab</span>
                            	</div>
                        	</td>
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
                   		...
                   		<tr>
                        	...
                        	<td width="30%">
                            	<div align="left">
                            		<span class="labelinput">Tarikh Rezab</span>
                            	</div>
                        	</td>
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
                   		...
                   		<tr>
                        	...
                        	<td width="30%">
                            	<div align="left">
                            		<span class="labelinput">Jenis Rezab</span>
                            	</div>
                        	</td>
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="pautanms1" >
                		...
                		<tr>
                        	...
                        	<td width="30%">
                            	<div align="left">
                            		<span class="labelinput">Kawasan Rezab</span>
                            	</div>
                        	</td>
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
	...
	<table width="100%">
	    ...
	    <td colspan="2" ><div align="center">
	        ...
	        <p>
		      #if($statusBatal!='S' && $statusBatal!='P' && $statusBatal!='B')
		          #if ($mode == 'view')
		          <input type="button" name="btnUpdateHakmilik" id="btnUpdateHakmilik" value="Kemaskini" onclick="kemaskini_detailHakmilik($idHakmilik)" class="stylobutton" />
		            <!--<input type="button" name="Cetak" id="Cetak" value="Cetak" onclick="javascript:setTable('tableReport1')" class="stylobutton" /> -->
		            <input type="button" name="Cetak" id="Cetak" value="Cetak" onclick="javascript:cetakMaklumatHakmilik($idHakmilik);" class="stylobutton" />
		          #end
		          
		          #if ($mode == 'update')
		          	#if($socStatus=="S")
	                	<input type="button" name="btnSaveHakmilikSamb" id="btnSaveHakmilikSamb" value="Simpan" onClick="updateDetailHakmilikSamb('$idHakmilik','$socStatus')"/>
	          		#else
	          			<input type="button" name="btnSaveHakmilik" id="btnSaveHakmilik" value="Simpan" onclick="update_detailHakmilik($idHakmilik)" class="stylobutton"/>
		       		#end
		          #end
		          
	          #end
	          <input type="button" name="btnBackHakmilik" id="btnBackHakmilik" value="Kembali" onclick="kembaliHakmilik()" class="stylobutton"/>
	        </p>
	    </div></td>
	  </tr>
	</table>

...
<fieldset><legend><strong>MAKLUMAT BORANG H</strong></legend>
	...
	#foreach ($borangO in $borangOBean)  
		<tr>
				        ...
				        <td width="30%">
				      	...
				      	<td width="1%">:</td>				        
				        <td width="68%"><input name="txdTarikhTerima" type="text" id="txdTarikhTerima" onblur="check_date(this)" value="$borangO.TarikhTerima" size="10" maxlength="10" $classDis $mode /> 
        ...
        <tr>
                	  ...
                	  <td valign="top">:</td>
                	  <td><textarea name="txtKeterangan" id="txtKeterangan" cols="45" rows="3" onkeyup="this.value=this.value.toUpperCase();" $mode $classDis >$borangO.keterangan</textarea></td>
 		</tr>
	...
	#if($pagemode == 'baru')
		<div align="center">
     		<input type="button" class="stylobutton100" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="javascript:fGTG_SimpanBorangO()">
            <input type="reset" class="stylobutton100" name="cmdBatal" id="cmdBatal" $btnNamePemilik onclick="javascript:fGTG_BatalBorangO()">
		</div>
	#elseif($pagemode == "kemaskini")
		<div align="center">
        	<input type="button" class="stylobutton100" name="cmdSimpan2" id="cmdSimpan2" value="Simpan" onclick="javascript:fGTG_SimpanUpdateBorangO()"/>
            
		</div>
    #elseif($pagemode == 'view')
		<div align="center">
        	<input type="button" class="stylobutton100" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onclick="javascript:fGTG_KemaskiniBorangO()">

...
<table width="100%" border="0">
	javascript:openSuratPegawai('ekptg.report.htp.SuratUtamaHTP','idsuburusan=38&idpermohonan=1610744','urusan','&template=HTPGadaianSuratSOCPeguam')
	javascript:openSuratPegawai('ekptg.report.htp.SuratUtamaHTP','idsuburusan=38&idpermohonan=1610744','urusan','&template=HTPGadaianSuratMOCPutrajaya')
javascript:openSuratPegawai('ekptg.report.htp.SuratUtamaHTP','idsuburusan=38&idpermohonan=1610744','urusan','&template=HTPGadaianSuratMOCSarawak')
  <tr>

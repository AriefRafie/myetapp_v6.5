...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	<tr>
		...
		<fieldset><legend><strong>MAKLUMAT PERMOHONAN ONLINE</strong></legend>
	...
	<tr>
		...
		#if($pagemode == 'baru' || $pagemode == 'kemaskini')
        	<input type="button" class="stylobutton" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="javascript:fGSA_Simpan()">
        	<input type="reset" class="stylobutton" name="cmdBatal" id="cmdBatal" $btnName onclick="javascript:fGSA_Batal()">

        #elseif($pagemode == 'simpan')     
       		<input type="button" class="stylobutton" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onclick="javascript:fGSA_Kemaskini()">
       		<input type="button" class="stylobutton" name="cmdSeterusnya" id="cmdSeterusnya" value="Seterusnya" onclick="javascript:fGSA_Seterusnya()">
        
       	#else    
       	<input type="button" class="stylobutton" name="cmdKembali" id="cmdKembali" value="Kembali" onClick="javascript:fGSA_Kembali()">
       	<input type="button" class="stylobutton" name="cmdSeterusnya" id="cmdSeterusnya" value="Seterusnya" onclick="javascript:fGSA_Seterusnya()">
	...
	<input type="hidden" name="idKem" value="$idKem" />

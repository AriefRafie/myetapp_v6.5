				...
				<tr class="table_header">
				  <td width="3%"><strong>Bil.<strong></td>
			  	  ...
			  	  <!--<td width="15%"><div align="left">Status<br /> 
			   	  ...
			   	  <td width="60%"><div align="left"><strong>Nama Pemilik</strong></div></td>
			  </tr>
...
<script>
	...
	function cetakPergerakan(id){
		var url = "../servlet/ekptg.report.htp.BorangPergerakanHakmilik?template=HTPGadaianBorangPergerakan&idPergerakan="+id;
...
// lama	
function Xpergerakanhakmilik_detail(id){

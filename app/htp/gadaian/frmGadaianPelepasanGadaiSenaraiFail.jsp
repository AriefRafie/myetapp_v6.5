...
<script>
/**********************************************
script template : frmGadaianPelepasanGadaiSenaraiFail.jsp
**********************************************/
...
function viewDetailPemohonPelepasan(idFail,idPermohonan){
	doAjaxCall${formName}("Semakan", "idFail="+idFail+"&idPermohonan="+idPermohonan);
}
...
//Pautan Senarai Permohonan
function fGSPA_seterusnya(id) {
	doAjaxCall${formName}("Semakan","idPermohonan="+id);
}

//Pautan Senarai Permohonan [Tambah]

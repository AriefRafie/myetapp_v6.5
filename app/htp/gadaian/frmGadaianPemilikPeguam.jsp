			...
			<fieldset>
			 <div id="TabbedPanels1" class="TabbedPanels">
			              ...
			              <ul class="TabbedPanelsTabGroup">
			                ...
			                <li class="TabbedPanelsTab style1 style3" tabindex="0" title="Peguam" 
			                onclick="setSelected(2,'geranview')">16A</li>			                
			                <li class="TabbedPanelsTab style1 style3" tabindex="0" title="Peguam" 
			                onclick="setSelected(2,'geranview')">16N</li>				                
			              	<li class="TabbedPanelsTab style1 style3" tabindex="0" title="Peguam" 
			                onclick="setSelected(2,'geranview')">BORANG D</li>	
			                			                <li class="TabbedPanelsTab style1 style3" tabindex="0" title="Peguam" 
			                onclick="setSelected(2,'geranview')">BORANG G</li>	
			                			                <li class="TabbedPanelsTab style1 style3" tabindex="0" title="Peguam" 
			                onclick="setSelected(2,'geranview')">BORANG H</li>	
			                			                <li class="TabbedPanelsTab style1 style3" tabindex="0" title="Peguam" 
			                onclick="setSelected(2,'geranview')">BORANG O</li>	
						<!-- 

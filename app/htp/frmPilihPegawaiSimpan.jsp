...
<p>
   ...
   <input name="idsuburusan" type="hidden" id="idsuburusan" value="$permohonanInfo.idsuburusan"/>
   <input name="langkah" type="hidden" id="langkah" value="$permohonanInfo.langkah"/>
   <input name="iduser" type="hidden" id="iduser" value="$permohonanInfo.iduser"/>
    	...
    	<fieldset><legend><strong>Cetakan Surat</strong></legend>
        	<table width="100%" border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
              	  ...
              	  <td>: <input type="text" name="up" size="35" ></td>
              </tr>
              <tr>
              	  <td><span class="$style style1"></span> Maklumat Bebanan</td>
              	  <td>: <input type="text" name="beban" size="35"></td>
              </tr>
               <tr>
              	  <td colspan="2">&nbsp;</td>
              </tr>
...
function doChangePegawai(){
	...
	doAjaxCall${formName}("PilihPegawaiSimpan");
}
...
function cetakSurat(id,temp,pg,jwt,tel,email) {
	...
	var param ="&idfail=$permohonanInfo.idfail&langkah=$permohonanInfo.langkah&iduser=$permohonanInfo.iduser&idsuburusan=$permohonanInfo.idsuburusan&pegawai="+pg+"&jawatan="+jwt+"&notelefon="+tel+"&email="+email+"&beban="+document.${formName}.beban.value+"&up="+document.${formName}.up.value;

...
<legend>MAKLUMAT HAKMILIK</legend>
                   		...
                   		<tr>
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
							   ...
							   <!-- Add hidden untuk lepaskan javascript -->
							   <input type="hidden" name="txtLuas2" value="">
							   <input type="hidden" name="txtLuas3" value="">
							   <input type="hidden" name="txtLuas4" value="">
							   <input type="hidden" name="txtLuas5" value="">
							   <input type="hidden" name="txtLuas6" value="">
							   ...
							   <!-- Add hidden untuk lepaskan javascript -->
							   <input type="hidden" name="txtLuas1" value="">
							   <input type="hidden" name="txtLuas5" value="">
							   <input type="hidden" name="txtLuas6" value="">
	...
	#if($mode=='view' && ($statusBatal=='S' || $statusBatal=="B" || $socStatus=="S")  )
	    ...
	    <td colspan="2" ><div align="center">
	        ...
	        <p>
		            ...
		            <input type="button" class="stylobutton100" name="Cetak" id="Cetak" value="Cetak" onclick="javascript:cetakMaklumatHakmilik($idHakmilik);" />
		 			<input type="button" class="stylobutton100" name="btnBackRizab" value="Kembali" onclick="kembaliHakmilik();"/>
		          #end

      		...
      		<tr>
            	<td width="50%" valign="top">
                	<table width="100%" border="0">
                    	<tr>
  							<td width="1%"  >
  								<span class="labelmandatory">#if ($mode != 'doView') * #end </span>
				        	</td>				        
                        	<td width="30%">
                            	<div align="left">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
								<input name="txdTarikhDaftar" type="text" id="txdTarikhDaftar" value="$txdTarikhDaftar" size="11" maxlength="10" $readonly class="$disabled" onkeyup="validateNumber(this,this.value);" onblur="check_date(this); validateTarikhHakmilik();" />
      							#if ($mode == 'update' || $mode == 'addHakmilik') 
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
	                            ...
	                            #set ($selectedF = "")
	                         #end   
					          <select $readonly class="$disabled" name="socTaraf" id="socTaraf" style="width:200px;" >
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
									...
									<input value="$!txtLuasLama" name="txtLuas1" type="text" class="$disabled" id="txtLuas1" size="30" maxlength="15" onkeyup="validateNumber(this,this.value);" $readonly onBlur="kiraLuas('$socLuas')" />
               		...
               		<table width="100%">
            			...
            			<tr>
                        	...
                        	<td width="30%" valign="top" >
                  			...
                  			<td width="1%" class="labelinput" valign="top" >:</td>
                   			<td width="68%" class="labeldisplay" >
        						<textarea name="txtSyarat" cols="27" rows="5" id="txtSyarat" style="text-transform:uppercase;"  
...
<table width="100%" border="0" align="left">
	<tr><td colspan=2>
       ...
       #else
			<input type="button" class="stylobutton100" value="Simpan" onclick="tambah_detailHakmilik($idPermohonan)"/>
			<input type="button" class="stylobutton100" value="Batal" onclick="kembaliHakmilik()"/>
		#end

...
<table border="0" width="100%">
    <tbody>
      ...
      <tr>
       ...
       <tr >
        <td align="right" ><div align="right">Kementerian</div></td>
        <td ><div align="center">:</div></td>
        <td >$socKementerian</td>
      </tr> 
      <tr >
        <td align="right" ><div align="right">Agensi</div></td>
        <td ><div align="center">:</div></td>
        <td >$socAgensi</td>
      </tr>  
     <tr >
      ...
      <tr >
        <td align="right" ><div align="right">Tajuk Fail</div></td>
        <td ><div align="center">:</div></td>
        <td ><input name="txtTajukFail" id="txtTajukFail" type="text" value="$!txtTajukFail" size="45" maxlength="50" style="text-transform:uppercase;" > </td>
      </tr> 
      <!--<tr>
  ...
  #set( $i = $velocityCount )
   ...
   <tr class="$row">
   	<td height="20">$!senaraiHakmilik.bil.</td> 
   	  ...
   	  #elseif($senaraiHakmilik.flagTanah == '4')
    	<td> $!senaraiHakmilik.no 
    		<a href="javascript:hakmilik_detail2('$senaraiHakmilik.idpermohonan');" class="style1">Milik</a> | 
    		<a href="javascript:rizab_detail2('$senaraiHakmilik.idpermohonan');" class="style1">Rizab</a>
    	</td>
 	  #else  
    	...
    	<td>$!senaraiHakmilik.tajuk</td>
 	  #end  
    <td>#if($!senaraiHakmilik.ptg =='') TIADA MAKLUMAT #else $!senaraiHakmilik.ptg #end</td>
    <td>#if($!senaraiHakmilik.ptd =='') TIADA MAKLUMAT #else $!senaraiHakmilik.ptd #end</td>

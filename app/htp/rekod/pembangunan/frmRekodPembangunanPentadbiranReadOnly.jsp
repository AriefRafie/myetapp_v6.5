...
<table border="0" width="100%">
  ...
  <tr class="$row">
    ...
    #if($senaraiB.bil!="")    
    <td  width="10%"><div valign="left"><a href="javascript:viewDetailPerihal('$senaraiB.idHakmilikPerihal')" class="pautanms"> 
    	#if($senaraiB.jenisBangunan=="P" || $senaraiB.jenisBangunan=="2")
      PADANG
      #elseif($senaraiB.jenisBangunan=="B" || $senaraiB.jenisBangunan=="1")
      BANGUNAN
...
//END OF VALIDATAION
	...
	*/
		alert('KEMBALI');
		document.${formName}.action = "?_portal_module=ekptg.view.htp.rekod.FrmRekodSenaraiTanahPembangunan";
		document.${formName}.submit();

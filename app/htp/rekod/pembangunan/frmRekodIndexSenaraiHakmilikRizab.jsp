...
<table width="98%" border="0">
	...
	<tr>
		<td>
			#parse("app/htp/rekod/frmRekodIndexCarianSenaraiHakmilikRizab.jsp")
			<br>
				    ...
				    <td width="1%">$senarai.bil</td>
				       ...
				       <td width="18%">
				       		<!-- <a href="javascript:hakmilik_detail('$senarai.idHakmilik','$senarai.statusSah');" class="style1"> -->
				       			$senarai.noFail
				       		<a href="javascript:screen2('$senarai.idHakmilik','M');" class="style1">
				       			..
				       			</a> 
				       	</td>
...
<script>
	...
	function screen2(id,jenis){
   	//if(jenis == 'Y' || jenis == 'T'){
	if(jenis == 'M'){
		//document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmRekodPendaftaranTanah&firstAction=PendaftaranPembangunan&nextAction=paparsahajakeluasanterperinci&idHakmilik="+id;
	}else{
		//document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmRekodPendaftaranTanah&firstAction=PendaftaranHakmilik&nextAction=paparDetailRizab&idHakmilik="+id;
	}
		//document.${formName}.submit();
		doAjaxCall${formName}("","&firstAction=PendaftaranPembangunan&nextAction=paparsahajakeluasanterperinci&idHakmilik="+id);
	}

	                        	...
	                        	<td width="30%">
	                  			...
	                  			<td width="1%" class="labelinput" >:</td>
	                   			<td width="68%" class="labeldisplay" >
	      							...
	      							<input name="txtmaklumatnotanah" type="hidden" value="$!txtNoWarta LOT $!txtNoLot" />
	                        	...
	                        	<td width="30%">
	                  			...
	                  			<td width="1%" class="labelinput" >:</td>
	                   			<td width="68%" class="labeldisplay" >
								      ...
								      <input name="txtLuas1" type="text" size="30" maxlength="15" value="$!txtLuasLama" class="$disabled" id="txtLuas1" size="30" maxlength="15" $readonly onkeyup="validateNumber(this,this.value);" onBlur="kiraLuas('$socLuas')" />
								    #elseif($socLuas == '8' || $socLuas == '4')
								      <input type="text" name="txtLuas2" value="$!txtLuasLama" d="txtLuas2" class="$disabled" size="8" maxlength="8" $readonly onkeyup="validateNumber(this,this.value);"/>

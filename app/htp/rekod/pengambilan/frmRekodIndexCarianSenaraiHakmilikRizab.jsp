	...
	<!-- Carian-->
			...
			<fieldset><legend>CARIAN</legend>
				<table border="0" width="100%">
			  	<!---->	<tr>
					    <td width="29%"align="right"><div align="right">Status</div></td>
					    ...
					    <td width="70%">
					        ...
					        #end
					    	<input type="radio" name="socJenisTanahtemp" value="1" $checkedMilik  onclick="cari()"/>PERMOHONAN
					 		<input type="radio" name="socJenisTanahtemp" value="2" $checkedRizab  onclick="cari()"/>PENYEWAAN
					 		<input type="radio" name="socJenisTanahtemp" value="3" $checkedRizabMilik  onclick="cari()"/>TIADA MAKLUMAT

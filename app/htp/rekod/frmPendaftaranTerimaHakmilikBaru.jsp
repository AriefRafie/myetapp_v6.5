...
<table width="100%" border="0" align="left">
  ...
  <tr>
    ...
    <td width="28%"><select name="socTaraf" id="socTaraf" style="width:200px;" readonly class="disabled" $disabled onChange="doChangeTaraf()">
      ...
      <option value="S">S - PEGANGAN BEBAS</option>
  ...
  <tr>
    ...
    <td width="1%"><div align="center">:</div></td>
    <td width="34%"><input type="hidden" name="socStatus" value="D">
  ...
  <tr>
    ...
    <tr>
      ...
      <table border="0" width="100%">
        <tr>
          <td colspan="7">#parse("app/utils/record_paging.jsp") <br/>
            <input type="submit" name="btnTambahSambungan" id="btnTambahSambungan" value="Tambah" onClick="tambahHakmilikSambungan('$idHakmilik')">           </td>
        </tr>
        ...
        <tr class="$row">
          ...
          <td><a href="javascript:deleteHakmilikBaru('$senarai.idHakmilikAsal','$senarai.idHakmilikBaru')" class="style1"><div align="left"><img border="0" title ="Hapus Imej" src="../img/hapus.gif"/></div></a></td>
          </tr>
        #end
      </table>
      </fieldset>      </td>
    ...
    #if($modePopup=="openSambungan")
    <tr>
      <td colspan="6"><fieldset>
      <legend>PENDAFTARAN HAKMILIK SAMBUNGAN</legend>
      <table width="100%" border="0">
        <tr>
          <td><div align="right">Jenis Hakmilik Berikut</div></td>
          <td><div align="center">:</div></td>
          <td width="56%">$selectJenisHakmilikBaru</td>
        </tr>
        <tr>
          <td width="43%"><div align="right">No. Hakmilik Berikut</div></td>
          <td width="1%"><div align="center">:</div></td>
          <td><label>
            <input name="txtHakmilikBerikut" type="text" id="txtHakmilikBerikut" value="$!txtHakmilikBerikut" size="30" $readonly2 class="$disabled2"/>
          </label></td>
        </tr>
        <tr>
  ...
  #if($mode == 'simpanBaru')
  <input type="button" name="btnAddHakmilik" id="btnAddHakmilik" value="Simpan" onClick="hakmilikBaru($idHakmilik)"/>
  #end
      </div></td>
  </tr>
</table>

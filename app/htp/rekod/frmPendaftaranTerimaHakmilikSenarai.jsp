	...
	<tr>
    	<td>
			...
			<table width="100%">
				...
				<tr class="table_header">
				  <td width="3%">Bil.</td>
			  	  ...
			  	  <td width="10%"><div align="left">No. Lot/PT</div></td>
			   	  <td width="15%"><div align="left">Status Hakmilik</div></td>
			...
			#foreach ($senarai in $SenaraiTanah)
			    ...
			    #if($senarai.bil != '')
			       <td width="18%">
			        <a href="javascript:UpdateHakmilik('$senarai.idPermohonan','$senarai.idHakmilik');" class="style1">
			       $senarai.noFail
			       </a></td>
			   	#else

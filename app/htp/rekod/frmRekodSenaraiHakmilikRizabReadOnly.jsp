<!--frmRekodSenaraiHakmilikRizabReadOnly.jsp-->
<style type="text/css">
<!--
.style1 {color: #0000FF}
-->
			...
			<fieldset>
				...
				<table border="0" width="100%">
					...
					<tr>
						...
						<td><div align="center">:</div></td>
						<td>
							<input name="txtNoFailC" type="text" id="txtNoFailC" value="$txtNoFailC" size="43" />
							#if ($flagAdvSearch == '')
					...
					<tr>
						...
						<td>
							...
							<input type="button" class="stylobutton100" name="cmdKosongkan" id="cmdKosongkan" value="Kosongkan" onclick="kosongCarianRekod('$idJenisTanah')" />        
						</td>
					</tr>
			...
			<fieldset>
				...
				<table border="0" width="100%">
					...
					<tr class="table_header">
						<td width="1%">Bil.</td>
						<td width="8%"><div align="left">No. Fail</div></td>
						<td width="8%">
							<div align="left">
								#if ($idJenisTanah==1)
									No. Hakmilik
						...
						<td width="5%">
							<div align="left">Status<br /></div>
						</td>
						<td width="33%">
							<div align="left">Kegunaan Tanah</div>
						</td>
					</tr>
...
#parse("app/htp/rekod/utiliti/javaScriptRekod.jsp")    

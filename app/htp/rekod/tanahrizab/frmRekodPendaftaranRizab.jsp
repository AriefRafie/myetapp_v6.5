	                        	...
	                        	<td width="30%">
	                  			...
	                  			<td width="1%" class="labelinput" >:</td>
	                   			<td width="68%" class="labeldisplay" >
								      ...
								      <input type="text" name="txtLuas1" id="txtLuas1" value="$!txtLuasLama" class="$disabled" size="30" maxlength="15" $readonly onkeyup="validateNumber(this,this.value);" onBlur="kiraLuas('$socLuas')" />
								    #elseif($socLuas == '8' || $socLuas == '4')
								      <input type="text" name="txtLuas2" id="txtLuas2" value="$!txtLuasLama" class="$disabled" size="8" maxlength="8" $readonly onkeyup="validateNumber(this,this.value);"/>
								      <input type="text" name="txtLuas3" id="txtLuas3" value="$!txtLuasLama1" class="$disabled" size="8" maxlength="8" $readonly onkeyup="validateNumber(this,this.value);"/>
								      <input type="text" name="txtLuas4" id="txtLuas4" value="$!txtLuasLama2" class="$disabled" size="8" maxlength="8" $readonly onkeyup="validateNumber(this,this.value);" onBlur="kiraLuas('$socLuas')"/>      
								    #elseif($socLuas == '7')
								      <input type="text" name="txtLuas5" id="txtLuas5" value="$!txtLuasLama" class="$disabled" size="13" maxlength="8" $readonly onkeyup="validateNumber(this,this.value);" />
								      <input type="text" name="txtLuas6" id="txtLuas6" value="$!txtLuasLama1" class="$disabled" size="13" maxlength="8" $readonly onkeyup="validateNumber(this,this.value);" onBlur="kiraLuas('$socLuas')"/>
								    #end 
								    <!--<a href="javascript:kiraLuas('$socLuas')" title="Kira luas dalam hektar." class="style1 style3">Kira Luas</a> -->
								#elseif ($mode =="view")
								    <input type="text" name="txtLuasLama" id="txtLuasLama" size="30" value="$txtLuasLama" maxlength="15"  
			...
			<div align="center">
			  <p>
			    ##if($statusBatal!='S' && $statusBatal!='P' && $statusBatal!='B')
				  	#if ($mode == 'view')
				    	<input type="button" class="stylobutton100" name="btnUpdate" id="btnUpdate" value="Kemaskini" onclick="kemaskini_detailRizab($idHakmilik)" />
			        	<input type="button" class="stylobutton100" name="Cetak" id="Cetak" value="Cetak" onclick="javascript:cetakMaklumatRizab($idHakmilik);" />
			    		<input type="button" class="stylobutton100" name="btnBackRizab" id="btnBackRizab" value="Kembali" onclick="rizab_detail('$!idHakmilik','$!sstatus')"  />
				    #end 

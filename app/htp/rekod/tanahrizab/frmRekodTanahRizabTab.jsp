      		...
      		<div id="TabbedPanels1" class="TabbedPanels">
	        	...
	        	<ul class="TabbedPanelsTabGroup">   
			        <li class="TabbedPanelsTab " tabindex="0"  title="" 
			        	onclick="javascript:selectTabRizab(0)">MAKLUMAT RIZAB</li>
		  	        <li class="TabbedPanelsTab" title="" tabindex="1" 
		  	        	onclick="javascript:selectTabRizab(1)">URUSAN RIZAB</li>
			        <li class="TabbedPanelsTab" title="" tabindex="0" onclick="javascript:selectTab(3,'kemaskinipermohonan','LakaranPelan',0,'$idpermohonanlokasi')" style="display:none">Lakaran/Pelan Tanah</li>
	      		</ul>
      
	      		<div class="TabbedPanelsContentGroup">      
	        		<div class="TabbedPanelsContent">
	        	#if($selectedTab == '0')	        			
	        	    #parse ("app/htp/rekod/tanahrizab/frmRekodMaklumatRizab.jsp") 
	        	#end
    				</div>
	        		<div class="TabbedPanelsContent">
	        	#if($selectedTab == '1')	        			

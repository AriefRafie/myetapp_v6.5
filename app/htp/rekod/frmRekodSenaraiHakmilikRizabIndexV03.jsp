					...
					<tr class="table_header">
					  <td width="3%"><strong>Bil.</strong></td>
				  	  ...
				  	  <td width="10%"><div align="left"><strong>
				  	  	...
				  	  	No. Lot/PT
				      #end </strong></div></td>
				   	  <td width="15%"><div align="left"><strong>Status</strong><br />
				   	  </div></td>
...
<input id="isimpangis" name="isimpangis" type="hidden" value="$!notifikasiSimpan"/>
<input id="firstAction" name="firstAction" type="hidden" value="$!firstAction"/>
...
<script>
	...
	function tambahGISRekod(file,perolehan,idHakmilik){
		...
		tambahGISC("",file,perolehan,idHakmilik,"firstAction_=carianHakmilikRizab&");
	}
	...
	function doChangeState() {
		document.${formName}.firstAction.value = "carianHakmilikRizab";
	  	doAjaxCall${formName}("","firstAction_=carianHakmilikRizab&nextAction=doChangeState");
	}
	
	function doChangeDaerah() {
		document.${formName}.firstAction.value = "carianHakmilikRizab";
		doAjaxCall${formName}("","firstAction_=carianHakmilikRizab&nextAction=doChangeDaerah");
	}
	
	function doChangeMukim() {
		document.${formName}.firstAction.value = "carianHakmilikRizab";
		doAjaxCall${formName}("","firstAction_=carianHakmilikRizab&nextAction=doChangeMukim");
	}
	
	function doChangeKementerian() {
		document.${formName}.firstAction.value = "carianHakmilikRizab";
		doAjaxCall${formName}("","firstAction_=carianHakmilikRizab&nextAction=doChangeKementerian");
	}
	...
	function deleteHakmilikBaru(id,id2){
		...
		document.${formName}.firstAction.value = "deleteHakmilikBaru";
		doAjaxCall${formName}("","firstAction_=deleteHakmilikBaru&idHakmilik="+id+"&idHakmilikBaru="+id2);
	...
	function hakmilik_detail(id,status){
		...
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=paparDetailHakmilik&idHakmilik="+id+"&statusSah="+status);
	}
	
	function doChangeStateHR() {
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
	  	doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=kemaskiniDetailHakmilik&lastAction=doChangeStateHR");
	}
	
	function doChangeDaerahHR() {
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=kemaskiniDetailHakmilik&lastAction=doChangeDaerahHR");
	}
	
	function doChangeMukimHR() {
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=kemaskiniDetailHakmilik&lastAction=doChangeMukimHR");
	}
	//[Kembali]
	...
	function kemaskini_detailHakmilik(id){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=kemaskiniDetailHakmilik&idHakmilik="+id);
	}
	...
	function update_detailHakmilik(id){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=updateDetailHakmilik&idHakmilik="+id);
	...
	function hakmilikDetailSamb(id,status){
		...
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=paparDetailHakmilik&statusSah="+status);
	...
	function screen3(id){
		...
		//document.${formName}.submit();
		//2018/07 document.${formName}.firstAction.value = "PendaftaranPembangunan";		
	...
	function screen4(id){
		...
		//document.${formName}.submit();
		//2018/07 document.${formName}.firstAction.value = "PendaftaranImej";
	...
	function screen5(id){
		...
		doAjaxCall${formName}("","firstAction_=paparDetailHakmilik&idHakmilik="+id);
	}
	//END PAGING	
	...
	function selectTab(id){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=paparDetailHakmilik&tabId="+id);
	...
	function doChangeTaraf() {
		...
		if(document.${formName}.socStatusDaftar.value=='S'){
			doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=kemaskinidetailhakmiliksamb&lastAction=doChange");	
		}else{
			doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=kemaskiniDetailHakmilik&lastAction=doChange");		
		}
	...
	function updateDetailHakmilikSamb(id,status){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=updateDetailHakmilik&tabId="+id);
	...
	document.${formName}.firstAction.value = "PendaftaranPembangunan";
 	doAjaxCall${formName}("","firstAction_=PendaftaranPembangunan&nextAction=updateDetailKeluasan&idHakmilikPerihal="+id);
...
//	imej/frmRekodPembangunanImejIndex
	...
	function baru(id){
		...
		doAjaxCall${formName}("","firstAction_=PendaftaranImej&idHakmilik="+id);
	}
	...
	function viewDetailImej(id){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranImej";
		doAjaxCall${formName}("","firstAction_=PendaftaranImej&nextAction=viewDetailImej&idGambar="+id);
	}
	...
	function viewDetailInfo(id){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranImej";
		doAjaxCall${formName}("","firstAction_=PendaftaranImej&nextAction=viewDetailInfo&idGambar="+id);
	}
	...
	function kemaskininDetailImej(id){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranImej";
		doAjaxCall${formName}("","firstAction_=PendaftaranImej&nextAction=kemaskiniDetailImej&idGambar="+id);
	}
	...
	function updateDetailImej(id){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranImej";
		doAjaxCall${formName}("","firstAction_=PendaftaranImej&nextAction=updateDetailImej&idGambar="+id);
	}
	...
	function deleteDetailImej(id){	
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranImej";
		doAjaxCall${formName}("","firstAction_=PendaftaranImej&nextAction=deleteDetailImej&idGambar="+id);
	}
	...
	function doChangeJumlahLampiran(IDJadualLampiran,j,a) {
		...
		document.${formName}.firstAction.value = "PendaftaranImej";
	 	doAjaxCall${formName}("imej","firstAction_=PendaftaranImej&X="+a+"&action=changeLampiran&IDJadualLampiran="+IDJadualLampiran);
	...
	function rizab_detail(id_,status){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=paparDetailRizab&idHakmilik="+id_+"&statusSah="+status);
	}
	
	//[Tab Rizab]
	function selectTabRizab(id){
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=paparDetailRizab&tabId="+id);		
	}
	...
	function kemaskini_detailRizab(id_){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=kemaskiniDetailRizab&idHakmilik="+id_);		
	}
	...
	function update_detailRizab(id){
		...
		//document.${formName}.submit();
		document.${formName}.firstAction.value = "PendaftaranHakmilik";
		doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=updateDetailRizab&tabId="+id);
	...
	function doPengesahanHq(idHakmilikPerihal) {
		...
		document.${formName}.firstAction.value = "PendaftaranPembangunan";
		doAjaxCall${formName}("","firstAction_=PendaftaranPembangunan&nextAction=pengesahanHq");
	}
	...
	<script>
		window.onload = function () {
			...
			if(noHakmilikDashboard!="" && noHakmilikDashboard!=null){
				doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=paparDetailHakmilik&idHakmilik="+idhm+"&statusSah="+stt);
			}else{
				doAjaxCall${formName}("","firstAction_=PendaftaranHakmilik&nextAction=paparDetailRizab&idHakmilik="+idhm+"&statusSah="+stt);
			}
		}
	</script>	
#end

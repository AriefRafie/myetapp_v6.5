				...
				#foreach ($senarai in $SenaraiFail)
				  #set( $i = $velocityCount )
				    ...
				    <td width="1%">$senarai.bil</td>
				       ...
				       <td width="18%">
				       		<!----> <a href="javascript:maklumatCeroboh('$senarai.idFailCeroboh','$senarai.statusSah');" class="style1"> 
				       			$senarai.noFail
				       		<!----> </a> 
				       	</td>
...
<script>
	...
	function maklumatCeroboh(id,status){
		...
		doAjaxCall${formName}("ceroboh","idFail="+id);
	...
	function doChangeTabUpper(tabId) {
		...
		//document.${formName}.submit();
		doAjaxCall${formName}("ceroboh");
		
	}
	
	//Operasi
	function doSeterusnya(){
		doAjaxCall${formName}("operasi");

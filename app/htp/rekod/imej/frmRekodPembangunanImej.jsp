...
<input type="text" name="negeri" value="$txtNamaNegeri" />
...
<script>
	...
	var urljava = "";
		...
		document.${formName}.action = "?_portal_module="+urljava+"&firstAction=PendaftaranImej&nextAction=viewDetailInfo&idGambar="+id;
		document.${formName}.submit();
	}
	...
	var urljava = "";
		...
		document.${formName}.action = "?_portal_module="+urljava+"&firstAction=PendaftaranImej&nextAction=kemaskiniDetailImej&idGambar="+id;
		document.${formName}.submit();
	}
	...
	var urljava = "";
		...
		document.${formName}.action = "?_portal_module="+urljava+"&firstAction=PendaftaranImej&nextAction=updateDetailImej&idGambar="+id;
		document.${formName}.submit();
	}
	...
	function kembali(id){
		...
		document.${formName}.action = "?_portal_module="+urljava+"&firstAction=PendaftaranPembangunan&idHakmilik="+id;
		document.${formName}.submit();
	}
	...
	var urljava = "";
		...
		if ( !window.confirm("Adakah Anda Pasti?")) return;
		document.${formName}.command.value = "";
		document.${formName}.action = "?_portal_module="+urljava+"&firstAction=PendaftaranImej&nextAction=deleteDetailImej&idGambar="+id;
		document.${formName}.submit();
	}

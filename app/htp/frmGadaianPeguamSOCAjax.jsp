  <html>
    <head>
      ...
      <title>frmGadaianPeguamSOC</title>
</head>
                <body>
                #set ($RujKami = "")
                #set ($RujTuan = "")
                                ...
                                <table cellspacing="2" cellpadding="3"
                                       border="0" width="100%">
                                                    ...
                                                    height="14">
                                                        <table cellspacing="3"
                                                               ...
                                                               width="100%">
                                                                <tr>
                                                                        <td>
                                                                                Tindakan Dan Penghantaran Pendua MOC / Discharge Of Charge / <strong>Satisfaction Of Charge-Sabah</strong> / Wilayah Persekutuan Labuan dan Sarawak                                                                        </td>
                                                          </tr>
                                                                <tr>
                                                                        <td>
                                                                                <table cellspacing="2"
                                        ...
                                        <tr>
                                                <td width="2%" height="2">&nbsp;</td>
                                                <td width="39%" colspan="4"
                                                    height="2">2. Untuk tujuan pendaftaran pelepasan/pembatalan gadaian, sila bawa bersama resit pembayaran cukai tanah tahun semasa. Apa-apa bayaran jika dikenakan, adalah di tanggung oleh Tetuan/Tuan/Puan.</td>
                                                <td width="1%" height="2">&nbsp;</td>
                                        </tr>
                                        <tr>
                                                <td width="2%">&nbsp;</td>
                                        ...
                                        <tr>
                                                <td width="2%">&nbsp;</td>
                                                <td width="39%" colspan="4">
                                                        <strong>( NORSYIMALAILA&nbsp;BT&nbsp;MOHAMAD&nbsp;HASHIM )</strong>
                                                </td>
                                                <td width="1%">&nbsp;</td>
                                        </tr>
                                        <tr>

...
<table width="100%" id="paging">
	<tr>
		...
		onclick="javascript:hakmilik_detail2P($idPermohonan);" onMouseOver="this.style.cursor='pointer';"/><img src="../img/arrowgaris.png" alt="" border="0"/><img src="../img/3current2.png" alt="" border="0" title="Detail Hakmilik/Rizab"/>
		#end
		</div>
		</td>
	</tr>

...
<table border="0" width="100%">
  ...
  <tr>
    <td></td>
    <td>&nbsp;</td>
    <td><input type="button" name="btnCari" id="btnCari" value="Cari" onclick="cari()"/>
...
<fieldset>
<legend>SENARAI FAIL BATAL</legend>
<table border="0" width="100%">
    <tr>
...
#foreach ($senarai in $SenaraiBatal)
  #set( $i = $velocityCount )
    #if ( ($i % 2) != 1 )
       #set( $row = "row2" )
    #else
...
function hakmilik_detail(id){
	document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmRekodBatalHakmilik&firstAction=paparDetailHakmilik&idHakmilik="+id;
	document.${formName}.submit();
}
function kosongCarian(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmRekodBatalHakmilik&firstAction=";
	document.${formName}.submit();
}

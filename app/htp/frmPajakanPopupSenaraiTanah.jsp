  ...
  <tr>
    <td>
      ...
      <a href="javascript:displayDatePicker('tarikhWarta',false,'dmy');"><img border="0" src="../../img/calendar.gif"/></td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input class="stylobutton" type="button" name="cmdCari" id="cmdCari" value="Cari" onclick="doCarian()"/>
                <input class="stylobutton" type="button" name="cmdKosong" id="cmdKosong" value="Kosongkan" onclick="kosongkan()"/></td>
              </tr>
            </table>

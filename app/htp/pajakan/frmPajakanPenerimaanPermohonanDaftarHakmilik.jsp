...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td>
           <div id="TabbedPanels1" class="TabbedPanels">
              ...
              <ul class="TabbedPanelsTabGroup">              
                ...
                <li class="TabbedPanelsTab" title="Ulasan KJP" onclick="doChangeTab(1)" tabindex="0">SENARAI HAKMILIK</li>
                    ...
                    <legend><strong>SENARAI HAKMILIK</strong></legend>
                        ...
                        <table align="center" width="100%">
                            <tr>
                              ...
                              #if($idStatus == '6' || $idStatus == '1' || $idStatus == '12')
                          ...
                          <tr>
                            ...
                            <td class="$row" align="center">
                            	...
                            	</a> --> <input type="button" value="Hapus" onclick="doDeleteHakmilik('$list.idHakmilikUrusan');"/>
    ...
    <input class="stylobutton" name="cmdSeterusnya" type="button" value="Sahkan" onclick="seterusnya()"/>
    #end
                    </fieldset>
    				#end
              </div>

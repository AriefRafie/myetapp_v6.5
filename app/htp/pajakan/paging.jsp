...
<!-- -->
	...
	#if($page == "3")<img src="../img/3current.png" alt="" border="0" title="Maklumat Pemohon"/><img src="../img/arrowgaris.png" alt="" border="0"/>
	#else<img src="../img/3enable.png" alt="" border="0" title="Maklumat Pemohon" onclick="langkah3($!htpPermohonan.permohonan.getIdPermohonan(),'$!htpPermohonan.permohonan.pfdFail.getIdFail()')"onMouseOver="this.style.cursor='pointer'"/><img src="../img/arrowgaris.png" alt="" border="0"/>#end

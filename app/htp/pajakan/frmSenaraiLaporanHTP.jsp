...
<!-- 					<tr>
						<td class="row1">2.</td>
						<td class="row1">
							<a href="javascript:cetak()" class="style1" >
								LAPORAN PAJAKAN MENGIKUT KEMENTERIAN
		 					</a>
						</td>
					</tr> -->
					#end				
				#if ( $!checkB.equals("checked") )
				<tr>
					<td class="row1">1.</td>
					<td class="row1">
	...
	<!-- 			<tr>
					<td class="row1">2.</td>
					<td class="row1">
						<a href="javascript:openLaporan('ekptg.report.htp.LaporanPermohonan','!$para','negeri','$senarai.template')" class="style1" >
							LAPORAN PAJAKAN MENGIKUT NEGERI 
	 					</a>
					</td>
				</tr> -->
			#end
			#if ( $!checkC.equals("checked") )
				<tr>
					<td class="row1">1.</td>
					<td class="row1">
		...
		if(range_akhir==""){
			...
			if(laporan=="negeri"){
				if(negeri=="-1"){
					...
					ptem = '&template=HTPPajakanSenaraiMengikutNegeri';

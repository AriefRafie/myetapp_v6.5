        		...
        		<table align="center" width="100%"> 
		            <tr>
		              <td colspan="5" scope="row">
		              	<input name="cmdDaftar" type="button" value="Daftar Permohonan Baru" onclick="javascript:daftarBaru()" style="display:none"/>
		              </td>
		            </tr>
		            <tr>
		              	<td colspan="5" scope="row">
...
function paparX(idFail,idStatus){
	...
	if (idStatus == '6' || idStatus == '1' || idStatus == '12' || idStatus == '63'){
		document.${formName}.action = "$EkptgUtil.getTabID('Pajakan',$portal_role)?_portal_module=ekptg.view.online.htp.pajakan.FrmPajakanPendaftaranView2";
	...
	function papar(idFail,idStatus){
		doAjaxCall${formName}("bayaran","idFail="+idFail+"&actionPajakan=bayaran");

       ...
       <div id="TabbedPanels1" class="TabbedPanels">
              ...
              <div class="TabbedPanelsContentGroup">
                ...
                <!-- content draf perjanjian -->
					#if ($selectedTab == '0')
                		#parse ("app/htp/pajakan/perjanjian/frmPajakanTabDrafPerjanjianSenarai.jsp")
             		#end
                </div>
                ...
                <!-- content maklumat pajakan -->
                		...
                		#parse ("app/htp/pajakan/perjanjian/frmPajakanTabMaklumatPajakan.jsp")
					#end               	
              </div>
              <!-- close content maklumat pajakan -->
                ...
                <!-- content MOA -->
					#if ($selectedTab == '2')
	                	#parse ("app/htp/pajakan/perjanjian/frmPajakanTabMOA.jsp")
					#end               	
              </div>
              <!-- close content MOA -->
              ...
              <div class="TabbedPanelsContent">
                <!-- content Borang 15A -->
					#if ($selectedTab == '3')
						#parse ("app/htp/pajakan/perjanjian/frmPajakanTabBorang15A.jsp")
					#end               	
              </div>
              ...
              <div class="TabbedPanelsContent">
                <!-- content Kelulusan Jemaah Menteri -->
					#if ($selectedTab == '4')
	                	#parse ("app/htp/pajakan/perjanjian/frmPajakanTabKelulusanJemaahMenteri.jsp")
					#end               	
              </div>

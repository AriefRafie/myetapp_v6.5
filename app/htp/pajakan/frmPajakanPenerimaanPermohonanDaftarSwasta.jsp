...
<!--  <tr>
	...
	<tr>
    	...
    	<td width="70%">
    	#if ($mode == 'new')
    		<input type="button" class="stylobutton" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="simpanbySwasta()"/>
...
function simpanbySwasta() {
	...
	document.${formName}.hitButton.value = "simpanbyswasta";

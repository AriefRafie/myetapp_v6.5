            ...
            <li class="TabbedPanelsTab" title="Ulasan SPHP" onclick="doChangeTabLower(2)" tabindex="0">ULASAN BPHP</li>
              ...
              <div class="TabbedPanelsContentGroup">              
                ...
                <!-- content Ulasan KJP -->
                		...
                		#parse ("app/htp/pajakan/mjm/ulasan/frmPajakanTabUlasan.jsp")
					#end               	
              </div>
              <!-- close content Ulasan KJP -->
               ...
               <div class="TabbedPanelsContent">
                <!-- content Ulasan JPPH-->
                		...
                		#parse ("app/htp/pajakan/mjm/ulasan/frmPajakanTabUlasanJPPH.jsp")
					#end               	
              </div>
              <!-- close content Ulasan JPPH-->
                ...
                <!-- content  Ulasan JPPH -->
	                	...
	                	#parse ("app/htp/pajakan/mjm/ulasan/frmPajakanTabUlasanSPHP.jsp")
					#end               	
              </div>
              <!-- close content  Ulasan JPPH -->

...
-->
              ...
              <tr>
                ...
                #foreach ($beanUlasanSPHP in $BeanUlasanSPHP)
                  ...
                  <tr>
                    ...
                    <td valign="top">:</td>
                    <td valign="top">
                    	<textarea name="txtUlasanSPHP" cols="50" rows="5" 
						onkeyup="textCounter(this.form.txtUlasanSPHP,this.form.remtxtcatatan,1500);" 
						onkeydown="textCounter(this.form.txtUlasanSPHP,this.form.remtxtcatatan,1500);"	
                    	class="$classDis" $readOnly>$beanUlasanSPHP.ulasan</textarea>
                    </td>
	...
	<tr>
   		<td>
      		<fieldset>
    		<legend><strong>SENARAI ULASAN BPHP</strong>    </legend>
    			<table align="center" width="100%">
				    ...
				    <tr>
				    	<td colspan="6" scope="row">
				        	...
				        	<input class="stylobutton100" name="cmdcetak" type="button" value="Surat" onclick="javascript:senaraiDokumenSPHP('tablesurat');"/>
				        </td>
				   	</tr>
			  	#end
					<tr class="table_header">
					    <td width="3%" scope="row" align="center">Bil.</td>
					    <td width="15%">No. Rujukan BPHP</td>
      			...
      			#set ($list = "")
      				...
      				#foreach ($list in $SenaraiUlasanSPHP)
      					...
      					#end
				      <tr>
				        <td class="$row" align="center" ><a href="javascript:paparSPHP('$!list.idUlasanSPHP')" class="style1">$!list.bil.</a></td>
	...
	<tr>
    	<td>&nbsp;</td>
   			...
   			<fieldset id="tablesurat" style="display:none;">
				...
				<table width="100%" border="0">
				  <tr>
				    <td><a href="javascript:openSuratPegawai('ekptg.report.htp.SuratUtamaHTP','idsuburusan=7&idpermohonan=$idPermohonan','urusan','&template=HTPPajakanMemoPenawaran')" class="pautanms">MEMO PENAWARAN KEPADA BPHP</a></td>
				  </tr>
				  <tr>

  <html>
    <head>
      ...
      <title>frmGadaianPeguamDOC</title>
</head>
                <body>
                #set ($RujKami = "")
                #set ($RujTuan = "")
                                        ...
                                        <tr>
                                          ...
                                          <td width="26%" height="77">&nbsp;</td>
                                                <td width="34%" height="77"><table width="100%" border="0">
                                                  ...
                                                  <tr>
                                                    <td width="35%">Rujukan Kami </td>
                                                    <td width="5%">:</td>
                                                    <td width="60%">$RujKami</td>
                                                  </tr>
                                                  <tr>
                                                    <td>Tarikh</td>
                                                    <td>:</td>
                                                    ...
                                                    height="14">
                                                        <table cellspacing="3"
                                                               ...
                                                               width="100%">
                                                                <tr>
                                                                        <td>
                                                                               Tindakan Dan Penghantaran Pendua MOC / <strong>Discharge Of Charge</strong> / Satisfaction Of Charge-Sabah / Wilayah Persekutuan Labuan dan <strong>Sarawak</strong> 
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td>

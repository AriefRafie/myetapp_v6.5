...
#parse("app/htp/frmPendaftaranHakmilikMaklumatFail.jsp")
...
<div align="center">
  <p>
  	#if ($mode == 'view')
    <input type="button" name="btnUpdate" id="btnUpdate" value="Kemaskini" onclick="kemaskini_detailRizab($idHakmilik)"/>
    #end
    
    #if ($mode == 'update')  
    <input type="button" name="btnSaveRizab" id="btnSaveRizab" value="Simpan" onclick="update_detailRizab($idHakmilik)"/>
    <input type="reset" name="btnResetRizab" id="btnResetRizab"  value="Batal"/>
    #end
    <input type="button" name="btnBackRizab" id="btnBackRizab" value="Kembali" onclick="kembaliRizab()"/>

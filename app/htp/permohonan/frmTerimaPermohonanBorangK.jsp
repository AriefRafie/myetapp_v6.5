...
<input type="hidden" name="idHakmilikPPT" value="$!idHakmilikPPT" /> 
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
    					...
    					<table width="100%" border="0" align="left">    
					      ...
					      <tr>
					        ...
					        <td>
					          ...
					          onblur="this.value=this.value.toUpperCase();" value="$!txtnoFailKJP" size="30" />	 </td>
					      </tr>
					      <tr>
					               <td width="1%">
					        #if($!readOnly == "")
					      ...
					      <tr>
					        ...
					        <td><textarea $readOnly class="$disabled" name="txtTajuk" id="txtTajuk" cols="41" rows="5" 
					        onblur="this.value=this.value.toUpperCase();">$!txtTajuk</textarea></td>
					        <td>&nbsp;</td>
					        <td>
					         #if($!readOnly != "")
					         <p>Didaftar Oleh</p>
	...
	#else		
		<td align="center">
			<input class="stylobutton" name="cmdSimpan" type="button" id="cmdSimpan" value="Simpan" onclick="SimpanPendaftaranBorangK('Simpan')" />
			<input class="stylobutton" name="cmdKembali" type="button" id="cmdKembali" value="Kembali" onclick="kembaliSenaraiFail()"/>
		</td>
	#end
	</tr>
#else
	<tr>
		...
		#if ($showSahkanButton)
			<input class="stylobutton" type="button" onclick="javascript:sahkanPermohonan('$idPermohonan');" value="Sahkan" />
		#end
			$!sahkanresult
		</td>
	</tr>
...
//page frmTerimaPormohonanBorangK.jsp	
...
function kembaliSenaraiFail(){
	document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmTerimaPohon1";
	document.${formName}.submit();
}

function doChangesBorangK() {
	doAjaxCall${formName}("daftarBorangK","mode=doChanges");
}

function SimpanPendaftaranBorangK(i){	
	if ( document.${formName}.socNegeri.value == "" ) { 
  		alert('Sila pilih negeri terlebih dahulu.');
  		document.${formName}.socNegeri.focus(); 
  		return; 
	...
	var mode = 'MakAsasTanah';
	doAjaxCall${formName}("kemaskinipermohonanborangK","mode="+mode+"&pagemode=0&hittButton=Simpan");
	document.${formName}.cmdSimpan.value = i;

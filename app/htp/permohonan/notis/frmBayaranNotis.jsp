    		...
    		<td valign="top">
				<table width="100%" border="0">	
					...
					<tr>
						...
						<td valign="top" width="1%">:</td>
						<td width="58%">
						<input name="txTempohRayuan" onkeyup="validateNumber(this,this.value,'')" onblur="validateNumber(this,this.value,'')" type="text" id="txTempohRayuan" size="11" maxlength="10" value="$!dat.tempohRayuan" />
						</td>
					</tr>	
					<tr>
						<td valign="top" width="1%">
						...
						<td valign="top" width="1%">:</td>
						<td width="58%">
						<input name="txtTarikhRayuan" type="text" id="txtTarikhRayuan" size="11" maxlength="10" value="$!dat.tarikhRayuan" />

				     ...
				     <tr>
				        <td width="50%" valign="top">       
					        <table width="100%" border="0" cellspacing="2" cellpadding="2">
					          <tr>
					            ...
					            <td width="1%">:</td>
					            <td width="63%"><font color="blue">$!socNegeri</font></td>
					          </tr>
					          <tr>
					            <td width="36%" align="right">DAERAH</td>
					            <td width="1%">:</td>
					            <td width="63%"><font color="blue">$!socDaerah</font></td>
					          </tr>
					          <tr>
					            <td align="right">KEMENTERIAN</td>
					            <td>:</td>
					            <td><font color="blue">$!socKementerian</font></td>
					          </tr>
					          <tr>
					            <td align="right">AGENSI</td>
					            <td>:</td>
					             <td><font color="blue">$!socAgensi</font></td>
					          </tr>
					          <tr>
					            <td align="right">URUSAN</td>
					            <td>:</td>
					             <td><font color="blue">$!socUrusan</font></td>
					          </tr>
					          <tr>
					            <td align="right">SUB URUSAN</td>
					            <td>:</td>
					             <td><font color="blue">$!socSubUrusan</font></td>
					          </tr>
					   		<!--
					          <tr>
				        ...
				        <td width="50%" valign="top">
					        <table width="100%" border="0" cellspacing="2" cellpadding="2">
					          ...
					          <tr >
					            <td align="right">STATUS TANAH :</td>
					            <td><font color="blue">$!socStatustanah</font></td>
					          </tr>
					          <tr>
					            <td align="right">JENIS FAIL :</td>
					            <td><font color="blue">$!socjenisFail</font></td>
					          </tr>
					          <!--
					          <tr>

    		...
    		<table width="100%" border="0"> 
  				<tr>
  					<td colspan="9">
  						...
  						<input class="stylobutton" type="button" name="cmdSimpan" id="cmdSimpan" value="Tambah" onclick="viewBorangK()" style="display:none"/>
               ...
               <tr>
                   <td class="$row" align="center">$!listK.bil</td>

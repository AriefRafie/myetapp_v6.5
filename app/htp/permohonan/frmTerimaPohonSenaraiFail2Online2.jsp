...
<table width="100%" border="0">
  ...
  <tr class="$row">
    ...
    <td ><a href="javascript:viewMaklumatPermohonan('$senarai.id')" class="style1">$senarai.noP </a><a href="javascript:viewFailById('$list.idFail','$list.idPermohonan','$list.idHtpPermohonan','$list.idSuburusanStatusFail')"></a></td>

	         			...
	         			<td valign="top">
	         				<table width="100%" border="0">
						          <tr>
						            ...
						            <td width="1%">:</td>
						            <td width="58%">
						            	<select name="zone" style="width:70%;" $!inputStyle>
						          ...
						          <tr>
						            ...
						            <td width="1%">:</td>
						            <td width="58%"><input type="text" name="txtJDbandar" id="txtJDbandar" value="$!detail.jarak_bandar" $!inputStyle/></td>
						          </tr>
						          <tr>
						 			<td width="1%">&nbsp;</td>
						            <td width="40%">
						            ...
						            <td width="1%">:</td>
						            <td width="58%"><input type="text" name="txtJDLebuhRaya" id="txtJDLebuhRaya" value="$!detail.jarak_jalan" $!inputStyle/></td>
						          </tr>
						          <tr>
						 			<td width="1%">&nbsp;</td>
						            <td width="40%">
						            ...
						            <td width="1%">:</td>
						            <td width="58%"><input type="text" name="txtJDJalanKeretapi" id="txtJDJalanKeretapi" value="$!detail.jarak_keretapi" $!inputStyle/></td>
						          </tr>
						          <tr>
						 			<td width="1%">&nbsp;</td>
						            <td width="40%">
						            ...
						            <td width="1%">:</td>
						            <td width="58%"><input type="text" name="txtJDSungaiPantai" id="txtJDSungaiPantai" value="$!detail.jarak_sungai" $!inputStyle/></td>
						          </tr>
			          			<tr>
						 			<td width="1%">&nbsp;</td>
						            <td width="40%">
						            ...
						            <td width="1%">:</td>
						            <td width="58%"><input type="text" name="txtSempadanUtara" id="txtSempadanUtara" value="$!detail.sempadan_utara" $!inputStyle /></td>
						          </tr>
						          <tr>
						 			<td width="1%">&nbsp;</td>
						            <td width="40%">
						            ...
						            <td width="1%">:</td>
						            <td width="58%"><input type="text" name="txtSempadanSelatan" id="txtSempadanSelatan" value="$!detail.sempadan_selatan" $!inputStyle/></td>
						          </tr>
						          <tr>
						 			<td width="1%">&nbsp;</td>
						            <td width="40%">
						            ...
						            <td width="1%">:</td>
						            <td width="58%"><input type="text" name="txtSempadanTimur" id="txtSempadanTimur" value="$!detail.sempadan_timur" $!inputStyle /></td>
						          </tr>
						          <tr>
						 			<td width="1%">&nbsp;</td>
						            <td width="40%">
						            ...
						            <td width="1%">:</td>
						            <td width="58%"><input type="text" name="txtSempadanBarat" id="txtSempadanBarat" value="$!detail.sempadan_barat" $!inputStyle /></td>
						          </tr>						          
	         				</table>			
	         			</td>
	        			...
	        			<td width="50%" valign="top">
	         				<table width="100%" border="0">
						          <tr>
						            ...
						            <td width="58%"><textarea name="PerihalLokasi" id="PerihalLokasi" cols="45" rows="5" $!inputStyle onkeyup="this.value=this.value.toUpperCase();">$!detail.keterangan</textarea></td>
						          </tr>
						          <tr>
						 			<td width="1%">&nbsp;</td>
						            <td width="40%" valign="top">
						            ...
						            <td width="1%" valign="top">:</td>
						            <td width="58%"><textarea name="txtKeteranganLain" id="txtKeteranganLain" cols="45" rows="5" $!inputStyle onkeyup="this.value=this.value.toUpperCase();">$!detail.lain_lain</textarea onkeyup="this.value=this.value.toUpperCase();"></td>
						          </tr>
	         				</table>		        				
	         			</td>
					</tr>
				...
				<fieldset>
  				<table width="100%" border="0">
					...
					<tr>
						...
						<td width="1%">:</td>
						<td width="68%"><input type="text" name="JumBayaranPelan" id="JumBayaranPelan" value="$!detail.bayarproses" onBlur="validateCurrency(this,this.value,'')" $!inputStyle/></td>
					</tr>   
				   	...
				   	<tr>
						...
						<td width="58%">
		                  ...
		                  <input checked="checked" type="radio" name="RadioGroup1" value="1" $!inputStyle/>
		                  YA
		                  <input type="radio" name="RadioGroup1" value="2" $!inputStyle/>
		                  TIDAK
					...
					<tr>
						...
						<td width="1%" valign="top">:</td>
						<td width="68%"><textarea name="ulasan" id="ulasan" cols="45" rows="5" $!inputStyle onKeyUp="this.value=this.value.toUpperCase();">$!detail.ulasan</textarea></td>
					</tr>
					<!--<tr>
						<td colspan=2 align="center">

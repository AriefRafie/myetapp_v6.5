	         				...
	         				<table width="100%" border="0">
						          <tr>
						            ...
						            <td width="58%">
										...
										#if($!idNegeriNotis=="13")
											#set ($list = ["PERMOHONAN DITERIMA","PERMOHONAN DIHANTAR JTS/BDA","LAWATAN TAPAK BERSAMA","LULUS MPN/SPA","SELESAI PEMBAYARAN(PREMIUM/PAMPASAN/KOS UKUR/LAIN-LAIN)", "KELULUSAN PEMBERIMILIKAN (BORANG L&S80)", "TIDAK LULUS MPN/SPA","DITOLAK","DIBATAL","DITANGGUH","SELESAI (HAK MILIK DAFTAR PTP)"])
  							...
  							<td width="50%" valign="top">&nbsp;
								<table width="100%" >
			          				<tr>
							            ...
							            <td width="58%">
							               #if($mode == 'new')
										     <input name="txtarikhkeputusan" type="text"  size="11" maxlength="10" $!readonly class="$disabled"/>
				          			...
				          			<tr>
							            ...
							            <td width="58%">
								            #if($mode == 'new')
									            <textarea name="txtcatatan" cols="45" rows="5" $!readonly class="$disabled" 

  				...
  				<table width="100%" border="0">
					...
					<!--<tr>
						...
						<p align="center">
							<div align="center">
						    #if ($tabmode == "3" && $!style == "")
						      <input type="button" class="stylobutton"  value="Simpan" onclick="SimpanDetailLot()" style="display:none" />
						    #elseif ($tabmode == "4" && $!style == "")
						   	 
						    #
						    <input type="button" class="stylobutton"  value="Simpan" onClick="doKemaskiniDetailLot($tabmode)"  style="display:none" />
						    else
<input type="button" class="stylobutton"  value="Kemaskini" onclick="doViewForKemaskiniDetailLot($tabmode)"  style="display:none" />
						    #end 
  				...
  				<table width="100%" border="0">
					...
					<tr>
				   	...
				   	<tr>
						...
						<td width="58%">
		                  ...
		                  TIDAK
		                  #else
		                  <input type="radio" name="RadioGroup1" value="1" $style/>
		                  YA
		                  <input type="radio" name="RadioGroup1" value="2" $style />
		                  TIDAK
		                  #end
					...
					<!--<tr>
						...
						<p align="center">
							<div align="center">
						   	#if ($tabmode == "3" && $!style == "")
						      <input type="button" class="stylobutton"  value="Simpan" onclick="SimpanCharting()" />
						    #elseif ($tabmode == "4" && $!style == "")
						   	 <input type="button" class="stylobutton"  value="Simpan" onclick="doKemaskiniCharting($tabmode)" />
						    #else
						    <input type="button" class="stylobutton"  value="Kemaskini" onclick="doViewForKemaskiniCharting($tabmode)" />
						    #end 
                 			<input class="stylobutton" type="button" name="Kembali" id="Kembali" value="Kembali" onClick="KembaliAsas(0,'kemaskinipermohonan','MakAsasTanah',0)" />
							</div>
						</p>

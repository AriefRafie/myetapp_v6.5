...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
						...
						<td width="50%" align="center" valign="top">
							<table width="100%" border="0">
			              		<tr>
					                ...
					                <td width="35%"><div align="left">Negeri</div></td>
					                <td width="1%">:</td>            
					                <td width="63%">
			              		...
			              		<tr>
					                ...
					                <td width="35%"><div align="left">Daerah</div></td>
					                <td width="1%">:</td>            
					                <td width="63%">
			              		...
			              		<tr>
					                ...
					                <td width="35%" valign="top" ><div align="left">Kementerian</div></td>
			              		...
			              		<tr>
	              					<td width="1%">
					               	...
					               	<td width="35%" valign="top" ><div align="left">Agensi</div></td>
					                <td width="1%" valign="top">:</td>
			              		...
			              		<tr>
									<td width="1%">
					               	...
					               	<td width="35%"><div align="left">Urusan</div></td>
					                <td width="1%">:</td>
					                <td width="63%">
			              		...
			              		<tr>
									<td width="1%">
					               	...
					               	<td width="35%" ><div align="left">Sub Urusan</div></td>
					                <td width="1%">:</td>
					                <td width="64%">
			              		...
			              		<tr>
									<td width="1%" valign="top">
					               	...
					               	<td width="35%" valign="top"><div align="left">Tajuk</div></td>
					                <td width="1%" valign="top">:</td>
					                <td width="63%">
        				...
        				<td width="50%" align="center" valign="top">
        					<table width="100%" border="0">
				        		...
				        		<tr>
					               ...
					               <td width="30%" ><div align="left">Didaftar Oleh</div></td>
					                <td width="1%">:</td>
					                <td width="68%">
				        		...
				        		<tr>
					               ...
					               <td width="30%" ><div align="left">Didaftar Pada</div></td>
					                <td width="1%">:</td>
					                <td width="68%">
	...
	#else		
		<td align="center">
			<input class="stylobutton100" name="cmdSimpan" type="button" id="cmdSimpan" value="Simpan" onclick="Simpan('Simpan')" />

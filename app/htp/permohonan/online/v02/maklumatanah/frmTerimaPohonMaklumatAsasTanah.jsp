...
<fieldset>
	...
	<table width="100%" border="0">
	  <tr>
	    <td colspan="10" >
	    	<input class="stylobutton100" type="button" name="btnTambahAsasTanah" id="btnTambahAsasTanah" value="Tambah" onclick="TambahAsasTanah(0,1,'maklumatanah','MakAsasTanah')"/>
	  	</td>
	  </tr>
	  ...
	  #foreach ($mat in $MAT)
	  	#set ( $cnt = $cnt + 1 )
	                ...
	                #end
	  <tr>
		<td class="$row"><a href="javascript:KemaskiniAsasTanah(0,2,'maklumatanah','MakAsasTanah','$mat.idhakmilikurusan')" class="">$cnt.</a></td>
	    <td class="$row">
	    ...
	    <td class="$row">
	    	...
	    	<a href="javascript:DetailTanah(0,3,'kemaskinipermohonan','maklumatanahterperinci','DetailLot','$mat.idhakmilikurusan')" class="pautanms"><b>Seterusnya>></b></a>
	    </td>
	  </tr>
	  #end
	  	#if ($cnt == 0)

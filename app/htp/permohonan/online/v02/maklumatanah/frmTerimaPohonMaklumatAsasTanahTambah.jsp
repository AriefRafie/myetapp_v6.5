	         				...
	         				<table width="100%" border="0">
						          ...
						          <tr>
						 			<td width="1%">
						 				...
						 				##if ($tabmode == "1" && $!style == "" || $tabmode == "2" && $!style == "") 
						 					* 
						 				##end </span>
						 				</td>
						            <td width="40%">
				      ...
				      <div align="left">
				        		...
				        		Daerah
						     	...
						     	<tr>
						            ...
						            <td valign="top" width="1%">:</td>
						            <td width="58%">
						            	<textarea $style name="Lokasi" id="Lokasi" cols="40" rows="5" onkeyup="this.value=this.value.toUpperCase();">$!Lokasi</textarea>
									</td>
						          </tr>							          				          
							</table>			
	         			</td>
	         				...
	         				<table width="100%" border="0">						          
						          ...
						          <tr>
						            ...
						            <td width="58%">
									    	...
									    	<input $style type="text" name="txtLuas1" value="$!txtLuasLama" id="txtLuas1"   
									      onBlur="kiraLuas('$socLuas')" onkeyup="validateNumber(this,this.value);"/>
									    #elseif($socLuas == '8' || $socLuas == '4') 
									      	<input $style type="text" name="txtLuas2" value="$!txtLuasLama" id="txtLuas2" size="4" onkeyup="validateNumber(this,this.value);"/>
									      	<input $style type="text" name="txtLuas3" value="$!txtLuasLama1" id="txtLuas3" size="4" onkeyup="validateNumber(this,this.value);"/>
									      	<input $style type="text" name="txtLuas4" value="$!txtLuasLama2" id="txtLuas4" size="4" onBlur="kiraLuas('$socLuas')" onkeyup="validateNumber(this,this.value);"/>      
									    #elseif($socLuas == '7')
									      	<input $style type="text" name="txtLuas5" value="$!txtLuasLama" id="txtLuas5" size="8" onkeyup="validateNumber(this,this.value);"/>
									      	<input $style type="text" name="txtLuas6" value="$!txtLuasLama1" id="txtLuas6" size="8" onBlur="kiraLuas('$socLuas')" onkeyup="validateNumber(this,this.value);"/>
									    #else
									    	<input $style name="txtLuas1" value="$!txtLuas1" type="text" 
						     	...
						     	<tr>						          
          						<tr>
						            ...
						            <td width="1%">:</td>
						            <td width="58%">
						            	<input name="Luas" value="$!Luas" type="text" id="Luas" onkeyup="validateNumber(this,this.value);" disabled class="inputnumberdisabled"/>(Hektar)
						          </tr>						          
							</table>
						</td>          
					</tr>
  		...
  		<tr>
    		<td align="center">
    			...
    			<input type="button" class="stylobutton100"  value="Kemaskini" onclick="doViewForKemaskini()" />
   	 			<input type="button" class="stylobutton100"  value="Hapus" onclick="hapusMaklumatAsasTanah(0,'0','kemaskinipermohonan','MakAsasTanah')" />
    		#end 
      			<input type="button" class="stylobutton100" name="Kembali" value="Kembali" onclick="KembaliAsas(0,'maklumatanah','MakAsasTanah',0)" /></td>

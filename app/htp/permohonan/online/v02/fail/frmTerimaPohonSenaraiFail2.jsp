...
<table width="100%" border="0">
  <tr class="table_header">
    ...
    <td width="42%"><strong>Tajuk Fail</strong></td>
    <td width="14%"><strong>Negeri</strong></td>
    <td width="11%" align="center"><strong>Tarikh Buka Fail</strong></td>
...
function Hapus(){
	...
	function sahPermohonanOnline(idPermohonan) {
		//alert("ID :::" + idPermohonan);
		if ( !window.confirm("Data Permohonan akan dimasukkan ke dalam Senarai Fail! \n Adakah Anda Pasti?") ) return;
		var command = 'sahPermohonanOnline';
		/* var mode = '';
		var tabId = 0;
		var tabmode = 2;
		var button = "doSahkan"; */

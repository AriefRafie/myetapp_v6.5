...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	<tr>
    	<td>   	
			<fieldset>
			<legend><strong>MAKLUMAT PERMOHONAN</strong>&nbsp;[<a href="javascript:arkibWindow();" class="pautanms"><b>ARKIB DOKUMEN</b></a>]</legend>
			  	...
			  	<table width="100%" border="0" cellspacing="2" cellpadding="2">
				     <tr>
				        <td width="50%" valign="top">       
					        <table width="100%" border="0" cellspacing="2" cellpadding="2">
					          <tr>
					            ...
					            <!-- <td width="36%" align="right">$!labelDaerahUP</td> -->
				        ...
				        <td width="50%" valign="top">
					        <table width="100%" border="0" cellspacing="2" cellpadding="2">
					          <tr>
					            <td width="36%"  align="right">NO. FAIL SEKSYEN</td>

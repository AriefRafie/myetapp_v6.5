			    		...
			    		<td valign="top" width="50%">
				 	       	<table width="100%" border="0">
				         		...
				         		<tr>
									...
									<td width="1%">:</td>
									<td width="58%">
		         				          	<input type="text" $!inputStyleNum name="txtJumBaucer" onblur="validateCurrency(this,this.value,'')" value="$!fuu" />
									</td>
								</tr> 
					...
					#foreach ( $Bukti in $BuktiBayaranInfo )
					  ...
					  <tr>
					    ...
					    <td class="$row" align="center">
					    				<a alt="Hapus" href = "javascript:BayaranNotisHapus($!Bukti.idBayaran)">

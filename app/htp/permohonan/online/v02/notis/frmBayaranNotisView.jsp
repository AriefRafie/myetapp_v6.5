...
#parse("app/htp/permohonan/notis/frmBayaranNotis.jsp")
   ...
   <table width="100%" border="0">
     <tr>
        ...
        <tr>
          ...
          <td>Jumlah Baucer</td>
          <td>&nbsp;</td>
          <td><input type="text" $!inputStyleNum name="txtJumBaucer" onblur="validateCurrency(this,this.value,'')" value="$!fuu" /></td>
        </tr>
        <tr>
          <td></td>
          <td>&nbsp;</td>
	  ...
	  <tr>
	    <td >
	  	  ...
	  	  <tr>
	    <td align="center" >
			<input class="stylobutton100" type="button" value="Simpan Bukti Pembayaran" style="width:auto !important" onclick="BayaranNotis($idNotis)" />
	    </td>
	  </tr>
	  </table>

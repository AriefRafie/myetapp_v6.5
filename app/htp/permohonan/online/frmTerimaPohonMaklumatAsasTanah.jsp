...
<!--	<tr bgcolor="#996600">
	...
	<tr class="table_header">
	    ...
	    <td width="13%">Kod/No. Lot</td>
	    <td width="11%">No.Syit</td>
	    <td width="8%">No.Pelan</td>
	    <td width="10%">Luas</td>
	    <td width="5%">Kod Luas</td>
  ...
  <tr>
    ...
    <td class="$row"><a href="javascript:KemaskiniAsasTanah(0,2,'kemaskinipermohonan','MakAsasTanah','$mat.idhakmilikurusan')" class="pautanms">$mat.nama_daerah</a></td>
    ...
    <!-- <td class="$row"><span class="star"><a href="javascript:DetailTanah(0,3,'kemaskinipermohonan','MakAsasTanah','DetailLot','$mat.idhakmilikurusan')" class="style1">Seterusnya>></a></span></td> --> <!-- zul disable sekejap -->
  </tr>
  #end
   	#if ($cnt == 0)
		<tr> 

			...
			<table width="100%" border="0">
  	  		<!--	<tr bgcolor="#996600">
    				<td colspan="10" bgcolor="#FFFFFF">
    					<input class="stylobutton" type="button" name="btnTambahAsasTanah" id="btnTambahAsasTanah" value="Tambah" onclick="TambahAsasTanah(0,1,'kemaskinipermohonan','MakAsasTanah')"/>
  					</td> 
  				</tr>
  				<tr>	 		

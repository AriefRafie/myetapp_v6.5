...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="1%">:</td>
    <td width="70%"><input name="txtTajukFail" type="text" id="txtTajukFail" size="40" value="$txtTajuk"></td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <td width="1%">&nbsp;</td>
    <td width="70%">
    	<input class="stylobutton"  name="cmdCari" id="cmdCari" value="Cari" type="button" onclick="javascript:carianFail()" />

...
<form name="f2" method="post">
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
        ...
        <td align="center" valign="top" width="50%"><table width="100%" border="0">
              <tr>
                ...
                <td width="2%">:</td>
                <td width="68%"><input type="text" name="txtNoFailSek" size="40" value="$NoFail" readonly="readonly"></td>
              </tr>
              <tr>
                <td><div align="left"><strong>No. Fail Lain</strong></div></td>
                <td>:</td>
                <td><input type="text" name="txtNoFailLain" id="txtNoFailLain" size="40" value="$NoRujukanLain" readonly="readonly"></td>
              </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <td><table width="100%" border="0">
          <tr>
            <td width="33%"><div align="right"><strong><font color="#FF0000">*</font>Tarikh Terima Hakmilik :</strong></div></td>
            <td width="67%"><input type="text" name="txdTarikhTerima" id="txdTarikhTerima" size="15" value="$TarikhMula" readonly="readonly">
          ...
          <tr>
            ...
            <td>RM 
              <label>
              <input type="text" name="txtCukaiPertama" id="txtCukaiPertama" maxlength="9" size="17" onkeyup="validateCurrency(this,this.value);" value="$Cukai" $mode />
              </label></td>
          </tr>
          <tr>
      ...
      <td valign="top"><table width="100%" border="0">
          <tr>
            <td width="35%"><div align="right"><strong><font color="#FF0000">*</font>Tarikh Luput :</strong></div></td>
          ...
          <tr>
            ...
            <td>RM 
              <label>
              <input type="text" name="txtCukaiSemasa" id="txtCukaiSemasa" maxlength="16" size="17" onkeyup="validateCurrency(this,this.value);" value="$CukaiTerkini" $mode>
            </label></td>
          </tr>
          <tr>
            <td><div align="right"><strong><font color="#FF0000">*</font>Luas :</strong></div></td>
            <td><label>
              <input type="text" name="txtLuas" id="txtLuas" maxlength="40" onkeyup="validateCurrency(this,this.value);" value="$Luas" $mode>
            </label></td>
          </tr>
          <tr>

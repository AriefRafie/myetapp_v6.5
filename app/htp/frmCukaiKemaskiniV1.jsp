    ...
    <tbody>
		...
		<td align="center" valign="top" width="64%">
          ...
          <tr>
            ...
            <td><table width="100%" border="0">
              <tr>
                <td width="40%">
                  <input type="text" name="txtNoHakmilik" id="txtNoHakmilik" maxlength="21" onkeyup="this.value=this.value.toUpperCase();" value="$noHakmilik" readonly class="disabled"  />
                </label></td>
               </tr>
            </table></td>
          </tr>
          ...
          <tr>
            <td width="40%" valign="top"><div align="right"><strong>Kementerian</strong></div></td>
              ...
              <tr>
                ...
                <td valign="top">:</td>
                <td valign="top"><input type="text" name="txtNoFailSek" size="40" value="$noFail" readonly class="disabled"/></td>
            </tr>
              <tr>
                <td valign="top"><div align="right"><strong>No. Fail PTG</strong></div></td>
                <td valign="top">:</td>
                <td valign="top"><input type="text" name="txtNoFailPTG" size="40" value="$noFailPTG" readonly class="disabled"/></td>
          </tr>
              <tr>
                <td valign="top"><div align="right"><strong>Kegunaan Tanah</strong></div></td>
                <td valign="top">:</td>
                <td valign="top"><input type="text" name="txtKegunaanTanah" size="40" value="$kegunaanTanah" readonly class="disabled"/></td>
              </tr>
        </table></td>
        <td><table width="100%" border="0">
          <tr>
          ...
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top" width="68%"><input type="text" name="txtCaraPerolehi" size="40" value="$caraPerolehi" readonly class="disabled"/></td>
              </tr>
              <tr>
                <td valign="top"><div align="right"><strong>No. Fail PTD</strong></div></td>
                <td valign="top">:</td>
                <td valign="top"><input type="text" name="txtNoFailLain" id="txtNoFailPTD" size="40" value="$noFailPTD" readonly class="disabled""></td>
          </tr>
              <!--<tr>
                <td valign="top"><div align="right"><strong>Pembayar Cukai</strong></div></td>
                <td valign="top">:</td>
                <td valign="top"><input type="text" name="txtPembayarCukai" size="40" value="$pembayarCukai" readonly class="disabled"/></td>
              </tr>-->
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
          ...
          <tr>
            ...
            <td width="58%" valign="top"><input type="text" name="txdTarikhDaftar" id="txdTarikhDaftar" size="15" value="$tarikhDaftar" readonly class="disabled">
          ...
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top"><label>
              <input type="text" name="txtLuas" id="txtLuas" maxlength="40" onkeyup="validateCurrency(this,this.value);" value="$Luas" readonly class="disabled" >
            </label></td>
          </tr>
          <tr>
      ...
      <input type="text" name="txtCukaiTerkini" id="txtCukaiTerkini" maxlength="16" size="17" onblur="validateCurrency(this,this.value);" value="$cukaiTerkini" readonly class="disabled">
            </label></td>
          </tr>
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top">RM <label>
     			<input type="text" name="txtCukaiTaliAir" id="txtCukaiTaliAir" maxlength="16" size="17" onblur="validateCurrency(this,this.value);" value="$cukaiTaliAir" readonly class="disabled">
            </label></td>
          </tr>
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top">RM <label>
      <input type="text" name="txtCukaiParit" id="txtCukaiParit" maxlength="16" size="17" onblur="validateCurrency(this,this.value);" value="$cukaiParit" readonly class="disabled" >
            </label></td>
          </tr>
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top">RM<label>
              <input type="text" name="txtDenda" id="txtDenda" maxlength="60" onblur="validateCurrency(this,this.value);" value="$Denda" readonly class="disabled">
            </label></td>
          </tr>
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top">RM<label>
              <input type="text" name="txtBayaranLain" id="txtBayaranLain" maxlength="60" onblur="validateCurrency(this,this.value);" value="$bayaranLain" readonly class="disabled">
            </label></td>
          </tr>
        </table>
        </td>
      <td valign="top"><table width="100%" height="220" border="0">
          <tr>
            ...
            <td width="69%">
            	<table width="100%" border="0">
              	<tr>
                <td valign="top"><label>
                  <input type="text" name="txtNoLot" id="txtNoLot" maxlength="20" onkeyup="this.value=this.value.toUpperCase();" value="$NoLot" readonly class="disabled">
                </label></td>
              </tr>
            </table></td>
          </tr>
         ...
         <td valign="top">RM 
              <label>
              <input type="text" name="txtCukaiPertama" id="txtCukaiPertama" maxlength="9" size="17" onblur="validateCurrency(this,this.value);" value="$Cukai" readonly class="disabled"/>
              </label></td>    
          </tr>
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top">RM<label>
              <input type="text" name="txtPengecualian" id="txtPengecualian" maxlength="60" onblur="validateCurrency(this,this.value);" value="$pengecualian" readonly class="disabled"e>
            </label></td>
          </tr>
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top">RM<label>
              <input type="text" name="txtPengurangan" id="txtPengurangan" maxlength="60" onblur="validateCurrency(this,this.value);" value="$pengurangan" readonly class="disabled">
            </label></td>
          </tr>
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top">RM<label>
              <input type="text" name="txtTunggakkan" id="txtTunggakkan" maxlength="60" onblur="validateCurrency(this,this.value);" value="$tunggakkan" readonly class="disabled">
            </label></td>
          </tr>
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top">RM<label>
              <input type="text" name="txtLebihan" id="txtLebihan" maxlength="60" onblur="validateCurrency(this,this.value);" value="$lebihan" readonly class="disabled">
            </label></td>
          </tr>
          <!--<tr>
            ...
            <td valign="top">:</td>
            <td valign="top"><label>
              <input type="text" name="txtStatusBayaran" id="txtStatusBayaran" maxlength="60" onblur="this.value=this.value.toUpperCase();" value="$statusBayaran" readonly class="disabled">
            </label></td>
          </tr>-->
      ...
      <tr>
		<td colspan="2" align="center">
			<input class="stylobutton" type="button" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onclick="Kemaskini()">
			<input class="stylobutton" type="button" name="cmdKembali" id="cmdKembali" value="Kembali" onClick="Kembali()"></td>
      </tr>
...
<td align="center" valign="top" width="64%"><table width="100%" border="0">
          ...
          <tr>
            ...
            <td><table width="100%" border="0">
              <tr>
                <td width="40%"><label>
                  <input type="text" name="txtNoHakmilik" id="txtNoHakmilik" maxlength="21" onkeyup="this.value=this.value.toUpperCase();" value="$noHakmilik" readonly class="disabled" $mode />
                </label></td>
                </tr>
            </table></td>
          </tr>
      ...
      <tr>
          ...
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top"><label>
              <input type="text" name="txtLuas" id="txtLuas" maxlength="40" onkeyup="validateCurrency(this,this.value);" value="$Luas" readonly class="disabled" $mode>
            </label></td>
          </tr>
          <tr>
      ...
      <td valign="top"><table width="100%" height="220" border="0">
          <tr>
            ...
            <td width="69%">
            	<table width="100%" border="0">
              	<tr>
                <td valign="top"><label>
                  <input type="text" name="txtNoLot" id="txtNoLot" maxlength="20" onkeyup="this.value=this.value.toUpperCase();" value="$NoLot" readonly class="disabled" $mode>
                </label></td>
              </tr>
            </table></td>
          </tr>
         ...
         <td valign="top">RM 
          ...
          <tr>
            ...
            <td valign="top">:</td>
            <td valign="top">RM<label>
              <input type="text" name="txtPengecualian" id="txtPengecualian" maxlength="60" onblur="validateCurrency(this,this.value);" value="$pengecualian" readonly class="disabled" $mode>
            </label></td>
          </tr>
          <tr>
            <td valign="top"><div align="right"><strong>Pengurangan</strong></div></td>
            <td valign="top">:</td>
            <td valign="top">RM<label>
              <input type="text" name="txtPengurangan" id="txtPengurangan" maxlength="60" onblur="validateCurrency(this,this.value);" value="$pengurangan" readonly class="disabled" $mode>
            </label></td>
          </tr>
          <tr>
            <td valign="top"><div align="right"><strong>Tunggakkan</strong></div></td>
          ...
          <!--S(SUDAH),B(BELUM)-->
          <input type="hidden" name="txtStatusBayaran" id="txtStatusBayaran" value="S" $mode>
      ...
      <tr>
		<td colspan="2" align="center">
			<input class="stylobutton" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="Simpan()">&nbsp;
			<input class="stylobutton" type="reset" name="cmdBatal" id="cmdBatal" value="Batal" >&nbsp;
	<!--		<input class="stylobutton" type="button" name="cmdKembali" id="cmdKembali" value="Kembali" onClick="Kembali1('$idHakmilikCukai')"></td>
      --></tr>

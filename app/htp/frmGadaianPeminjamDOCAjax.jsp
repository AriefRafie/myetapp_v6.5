  <html>
    <head>
      ...
      <title>frmGadaianPeminjamDOC</title>
</head>
                <body>
                #set ($RujKami = "")
                #set ($RujTuan = "")
                ...
                #foreach ($head in $Header)
                	#set ($RujTuan = $head.noRujukanLain)
                    #set ($RujKami = $head.noFail)
                ...
                #foreach ($content in $Content)                	
                    ...
                    #set ($NoPerserahan = $content.NoPerserahan)
                                ...
                                <table cellspacing="2" cellpadding="3"
                                       border="0" width="100%">
                                        <tr>
                                          ...
                                          <td width="45%" height="77"
                                                    colspan="2">&nbsp;</td>
                                          <td width="26%" height="77">&nbsp;</td>
                                                <td width="34%" height="77"><table width="100%" border="0">
                                                  <tr>
                                                    <td width="35%">Rujukan Tuan</td>
                                                    <td width="5%">:</td>
                                                    <td width="60%">$RujTuan</td>
                                                  </tr>
                                                  <tr>
                                                    <td>Rujukan Kami</td>
                                                    <td>:</td>
                                        ...
                                        <tr>
                                                ...
                                                <td width="39%" colspan="2"
                                                    height="151"><table width="100%" border="0">
                                                  <tr>
                                                    <td>$NamaPeguam</td>
                                                  </tr>
                                                  <tr>
                                                  ...
                                                  <tr>
                                                    <td><strong><u>$NegeriA</u></strong></td>
                                                  </tr>
                                                </table>                                                </td>
                                                    ...
                                                    height="14">
                                                        <table cellspacing="3"
                                                               ...
                                                               width="100%">
                                                                <tr>
                                                                        <td>
                                                                                Tindakan Dan Penghantaran Pendua MOC / <strong>Discharge Of Charge</strong> / Satisfaction Of Charge-Sabah / Wilayah Persekutuan Labuan dan <strong>Sarawak</strong> </td>
                                                          </tr>
                                                                <tr>
                                                                        <td>
                                                                                <table cellspacing="2"
                                        ...
                                        <tr>
                                                ...
                                                <td width="39%" colspan="4"
                                                    height="2">
                                                        ...
                                                        ini disertakan
                                                        dokumen-dokumen
                                                        berkaitan untuk tindakan
                                                        oleh 
                                                        <strong>Tetuan</strong>
                                                        /tuan/puan.</td>
                                                <td width="1%" height="2">&nbsp;</td>
                                        </tr>
                                        <tr>
                                                        ...
                                                        <table cellspacing="3"
                                                               ...
                                                               width="100%">
                                                                <tr>
                                                                        ...
                                                                        <td width="5%"
                                                                            valign="top">(i)</td>
                                                                        <td width="90%">Hakmilik : 
                                                                               
                                                                        $NoHakmilik $NamaMukim $NamaDaerah</td>
                                                                </tr>
                                                                <tr>
                                                                        <td width="5%" height="29">&nbsp;</td>
                                                                  <td width="5%"
                                                                            valign="top">(ii)</td>
                                                                        <td width="90%">Gadaian Pendua No. Perserahan : 
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td width="5%"
                                                                            valign="top">(iii)</td>
                                                                        <td width="90%">Suratcara melepaskan gadaian yang telah ditandatangani oleh Pesuruhjaya Tanah Persekutuan.</td>
                                                                </tr>
                                                        </table>
                                                </td>
                                                <td width="1%" height="2">&nbsp;</td>
                                        ...
                                        <tr>
                                                <td width="1%" height="2">&nbsp;</td>
                                                <td width="39%" colspan="4"
                                                    height="2">2. Untuk tujuan pendaftaran pelepasan/pembatalan gadaian, sila bawa bersama resit pembayaran cukai tanah tahun semasa. Apa-apa bayaran jika dikenakan, adalah di tanggung oleh <strong>Tetuan</strong>/Tuan/Puan.</td>
                                          <td width="1%" height="2">&nbsp;</td>
                                        </tr>
                                        <tr>
                                                <td width="1%">&nbsp;</td>
                                                ...
                                                <td width="39%" colspan="4">
                                                        <table cellspacing="2"
                                                               ...
                                                               width="100%">
                                                                <tr>
                                                                        <td width="7%">&nbsp;</td>
                                                                        <td width="85%" colspan="2">$Jawatan</td>
                                                                        <td width="8%">&nbsp;</td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                ...
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  <td colspan="2">$Alamat3B</td>
                                                                  <td>&nbsp;</td>
                                                                </tr>
                                                                #end
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  <td colspan="2"><strong><u>$PoskodB $NegeriB</u></strong></td>
                                                                  <td>&nbsp;</td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                ...
                                                                <tr>
                                                                        <td width="7%">&nbsp;</td>
                                                                        <td width="15%" colspan="2">$skAlamat2</td>
                                                                        <td width="8%">&nbsp;</td>
                                                                </tr>
                                                                #end
                                                                #if ($skAlamat3 != "")
                                                                <tr>
                                                                        <td width="7%">&nbsp;</td>
                                                                        <td width="15%" colspan="2">$skAlamat3</td>
                                                                        <td width="8%">&nbsp;</td>
                                                                </tr>
                                                                #end
                                                                <tr>
                                                                        <td width="7%">&nbsp;</td>
                                                                        <td width="15%" colspan="2">$skPoskod  $skDaerah</td>
                                                                        <td width="8%">&nbsp;</td>
                                                                </tr>
                                                                <tr>
                                                                        <td width="7%">&nbsp;</td>

 <table border="0" cellpadding="3" cellspacing="2" width="100%">
                                        ...
                                        <tr>
                                                ...
                                                <td colspan="4" height="2" width="39%">
                                                        <span id="form1:outputText1">Dengan hormatnya saya merujuk surat tuan bertarikh </span>
                                                        <span id="form1:otTarikh">05 May 2009</span>
                                                        <span id="form1:outputText3">rujukan no. </span>
...
Bersama-sama ini dikembalikan tiga (3) salinan 'Memorandum of Sublese
(Form L)' untuk ditandatangani oleh pemilik bangunan beserta saksinya
di tempai yang telah disediakan sebagaimana contoh berkembar. Pihak
tuan juga diminte mengembalikan Form L ini dengan kadar segera supaya
Pajakan Kecil ini dapal ditandatangani oleh Pesuruhjaya Tanah
Persekutuan seterusnya didaftarkan d: Pejabat Tanah dan Survey yang
berkenaan.</td>
                                                <td height="2" width="5%">&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                                <td width="3%">&nbsp;</td>
                                                <td colspan="4" width="39%">
                                                        <strong>( NORMA&nbsp;BIN&nbsp;ABD&nbsp;RAHMAN )</strong>
                                                </td>
                                                <td width="5%">&nbsp;</td>
                                        </tr>
                                        <tr>

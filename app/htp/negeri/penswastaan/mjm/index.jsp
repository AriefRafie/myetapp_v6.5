				    	...
				    	<table width="100%" border="0">
					      <tr>
					        ...
					        <td width="70%"><input type="text" name="txdTerimaDariKSU" id="txdTerimaDariKSU" value="$!txdTerimaDariKSU" $readonly class="$inputTextClass"/>
					            ...
					            <a href="javascript:displayDatePicker('txdTerimaDariKSU',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/></a>
								#end
						</td>
					      </tr>
					      <tr>
					        ...
					        <td width="70%"><input type="text" name="txdUlasanKeKSU" id="txdUlasanKeKSU" value="$!txdUlasanKeKSU" $readonly class="$inputTextClass"/>
			        				#if (!$!jenisAkses.equals('Readonly'))
					            <a href="javascript:displayDatePicker('txdUlasanKeKSU',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/></a>
								#end
						</td>
					      </tr>
				    	</table>
			    		...
			    		<td width="50%"> 
							...
							<tr>
								<td>
			        				...
			        				#if (!$!jenisAkses.equals('Readonly'))
								            <a href="javascript:displayDatePicker('txdMystJM',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/></a>
								#end
								    	</td>
								    </tr>
								    <tr>
			        				...
			        				#if (!$!jenisAkses.equals('Readonly'))
								            <a href="javascript:displayDatePicker('txdKeputusan',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/></a>
								#end
									</td>
								    </tr>
								    <tr>

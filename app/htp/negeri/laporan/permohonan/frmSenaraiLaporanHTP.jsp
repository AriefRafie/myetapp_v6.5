		...
		<table border="0" align="center" width="100%" >
		 	...
		 	##foreach ( $senarai in $senaraiLaporan )
		  	...
		  	<td width="97%" class="row2">
		  		<a href="javascript:openLaporan('ekptg.report.htp.permohonan.LaporanPermohonan','IDSUBURUSAN=1','urusneg','HTPPermohonanTanahMengikutNegeri')" class="style1" >SENARAI PERMOHONAN MENGIKUT NEGERI</a>
		 	</td>
		   	</tr>
		  	<tr>
			  	<td width="3%" class="row1">2.</td>
			  	<td width="97%" class="row1">
			  		<a href="javascript:openLaporan('ekptg.report.htp.permohonan.LaporanPermohonan','IDSUBURUSAN=1','urusan','HTPPermohonanTanahRingkasanMengikutNegeriStatus')" class="style1" >SENARAI PERMOHONAN MENGIKUT NEGERI (RINGKASAN MENGIKUT STATUS)</a>
			 	</td>
		   	</tr>		   		
		  	<tr>
		  	...
		  	<!--
		  	<tr>
		  	<td width="3%" class="row2"></td>
		  	<td width="97%" class="row2">
		  		<a href="javascript:openLaporan('ekptg.report.htp.permohonan.LaporanPermohonan','IDSUBURUSAN=1','urusan','HTPPermohonanTanahRingkasanMengikutNegeri')" class="style1" >SENARAI PERMOHONAN MENGIKUT NEGERI (RINGKASAN)</a>
		 	</td>
		   	</tr>				
		  	...
		  	<tr>
			  	<td width="3%" class="row2">.</td>
			  	<td width="97%" class="row2">
			  		<a href="javascript:openLaporan('ekptg.report.htp.permohonan.LaporanPermohonan','IDSUBURUSAN=1','ursselangbuta','HTPPermohonanTanahMilikTanahRizabLaporanPrestasiPegawaiMengikutBulan')" class="style1" >LAPORAN PRESTASI</a>
			 	</td>
		   	</tr>	
		   	-->	

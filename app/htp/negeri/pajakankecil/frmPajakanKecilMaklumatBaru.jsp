      ...
      <tr>
        ...
        <table width="100%" border="0">
          ...
          <tr>
            ...
            <td width="1%">:</td>
            <td width="58%"><input type="text" name="txttahun" size="5" maxlength="4"  onkeyup="validateNumber(this,this.value);"/> </td>
          </tr>
          <tr>
			<td width="1%">&nbsp;</td>
            <td width="40%">           	
            ...
            <td width="1%">:</td>
            <td width="58%"><input type="text" name="txtbulan" size="5" maxlength="2"  onkeyup="validateNumber(this,this.value);"/></td>
          </tr>
          <tr>
			<td width="1%"><span class="labelmandatory">*</span></td>
            <td width="40%">
        ...
        <table width="100%" border="0">
          <tr>
            <td width="40%"><span class="labelmandatory">*</span>Alamat Lokasi/Premis</td>
            <td width="1%">:</td>
          ...
          <tr>
            <td width="40%"><span class="labelmandatory">*</span>#if ($idnegeri == '13' )
								Bahagian
							#else
								Daerah
							#end</td>

			...
			<table width="100%" >
				...
				<tr>
			    	<td class="$row" width="10">
			        	...
			        	#set ( $checked = "" )
			    	#end
			        	 <input type="checkbox" name="cbsemaks" value="$semak.id" $checked $!selectstyle>			       	
			        </td>
			        <td class="$row">
...
<!--		</td>
							...
							<td align="center">
									...
									<input class="stylobutton100" type="button" name="cmdSimpan" id="cmdSimpan" value="Kemaskini " onclick="semakanPermohonanTambah('$permohonanInfo.idpermohonan')">
   								#end	
									<input type="button" class="stylobutton100" name="cmdKembali" id="cmdKembali" value="Kembali" onclick="senaraiPermohonan('$permohonanInfo.idfail')"> 
   									<input class="stylobutton100"  type="button" name="Cetak" id="Cetak" value="Cetak" onclick="javascript:senaraiSuratSkrinSemakan('tablesuratp');" />
									<!--  <input class="stylobutton100" type="button" name="cmdSeterusnya" id="cmdsblm" value="Seterusnya" onclick="skrinSenaraiHakmilikPemilik('$permohonanInfo.idpermohonan')"> -->
								#else
									<input class="stylobutton100" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="semakanPermohonanTambah1('$permohonanInfo.idpermohonan','simpan')">	
									<input class="stylobutton100" type="button" name="cmdKembali" id="cmdKembali" value="Batal" onclick="skrinSemakanPermohonan('$permohonanInfo.idpermohonan')">
 								#end

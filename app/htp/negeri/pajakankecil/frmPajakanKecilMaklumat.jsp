...
<!-- <tr>
      ...
      <tr>
        ...
        <table width="100%" border="0">
          <tr>
            ...
            <td width="1%">:</td>
            <td width="58%">
	         <input name="txtsewa" type="text" value="$!sewa" $inputstylerep onkeyup="validateNumber(this,this.value);" onblur="this.value=this.value.toUpperCase();"  />
            </td>
          </tr>
          <tr>
			<td width="1%">&nbsp;</td>
  ...
  <tr>
    <td align="center">
    	...
    	#if($pagemode == "" )
		<input class="stylobutton100" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="tambahMaklumatsewaansimpan('$permohonanInfo.idpermohonan')" />
		#end
		...
		#elseif($pagemode == "4")
		<input  class="stylobutton100" type="button" name="cmdKemaskini" id="cmdsblm" value="Kemaskini" onclick="kemaskiniMaklumatSewaan()" />
        ...
        #else
        <input class="stylobutton100" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="updateMaklumatSewaan('$permohonanInfo.idpermohonan')" />
        <!-- Komen pada 15/06/2010
        <input  class="stylobutton"type="button" name="cmdSeterusnya" id="cmdsblm" value="Seterusnya" onclick="nexti8('$permohonanInfo.idpermohonan')" />
		<input class="stylobutton" type="button" name="cmdKembali" id="cmdKembali" value="Kembali" onclick="backPre('$permohonanInfo.idfail','$permohonanInfo.idpermohonan')" /> -->
        #end

...
<!--<fieldset><legend>FAIL CUKAI KEMASKINI SEMASA</legend> -->
				...
				<table width="100%" border="0">
				  ...
				  <tr>
					...
					<select class="autoselect" name="Form_tahun">
					   ...
					   &nbsp;
				    		<input class="stylobutton"  name="cmdtahun" value="Salin Senarai Cukai " type="button" onclick="javascript:dataCukai()" />
				  ...
				  <tr>
				    ...
				    <td width="1%">&nbsp;</td>
				    <td width="70%">
				    	<input class="stylobutton100"  name="cmdCari" id="cmdCari" value="Papar" type="button" onclick="javascript:carianHakmilik()" />
	...
	<table width="100%" border="0">
		    <tr>
			 <td colspan="14"><!--
		      	<input type="button" value="Kemasukan Manual" onclick="tambahanManual($!Tahun)" />
        	...
        	#set ($inputstyle3 = "class=disabled" )
		    	...
		    	<tr>
					...
					<td class="$row">
		    			...
		    			<input type="text" size="10" name="cukaitaliair" value="$!UTIL.format2Decimal($senarai.cukaiTaliair)" onblur="checkNumeric(this.value);kirakira(${cnt},${cntTotal});" disabled class="inputnumberdisabled" >
		    		</td>
					<td class="$row">
						<!-- <input type="text" size="10" name="cukaiparit${cnt}" id="cukaiparit${cnt}"value="$!UTIL.format2Decimal($senarai.cukaiParit)" $inputstyle2> -->
						<input type="text" size="10" name="cukaiparit" value="$!UTIL.format2Decimal($senarai.cukaiParit)" onblur="checkNumeric(this.value);kirakira(${cnt},${cntTotal});" disabled class="inputnumberdisabled" >
					</td>					
				#else
					<td class="$row">
		    			<!-- <input type="text" size="10" name="cukaitaliair${cnt}" id="cukaitaliair${cnt}" value="$!UTIL.format2Decimal($senarai.cukaiTaliair)" $inputstyle> -->
...
##if ($cnt != 0)
	<tr>
			<td align="center">
			<input type="button" class="stylobutton100" name="cmdKembali" value="Kembali" onclick="javascript:doAjaxCall${formName}();" />
		#if ($cnt != 0)
			#if ($cnt == 1)
				<input type="button" name="btncukaikemaskini" value="Kemaskini" onclick="cukaiSimpan(1)">
			#else	
				<input type="button" name="btncukaikemaskini" value="Kemaskini Semua" onclick="cukaiSimpanSemua()">	
			#end	
		#end

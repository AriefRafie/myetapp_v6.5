...
<!-- <fieldset>
  <legend>SENARAI HAKMILIK MUAT TURUN CUKAI </legend> -->
	    ...
	    <table width="50%" border="0" align="center">
	      <tr>
	       ...
	       <tr>
				    ...
				    <td width="1%">&nbsp;</td>
				    <td width="70%">
	         			<input type="button" class="stylobutton100" name="btnCariHakmilik" id="btnCariHakmilik" value="Papar" onclick="carianHakmilikManual()"/>
				      	<input type="button" class="stylobutton100"  name="cmdKosongkan" value="Kosongkan" onclick="javascript:cancel()" /></td>
	         		</td>
	       </tr>
	    </table>
	  </fieldset>
	...
	<tr>
		<td>
	  <fieldset><legend>SENARAI HAKMILIK [KEMASUKAN MANUAL] $!Tahun</legend>
	  
		<table width="100%" cellspacing="1" cellpadding="2" border="0">
		    <tr>
		      <td colspan="6">
		      	<!-- <input class="stylobutton100" type="button" value="Tambah" onclick="tambahanManual($Tahun)" /> -->

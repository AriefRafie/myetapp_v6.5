    ...
    <td>
       <div id="TabbedPanels1" class="TabbedPanels">
              ...
              <!-- -->
                ...
                <li class="TabbedPanelsTab" title="Perjanjian" onclick="doChangeTab(0)" tabindex="0">PERJANJIAN</li>
              ...
              <div class="TabbedPanelsContentGroup">
                ...
                <!-- content draf perjanjian -->
					#if ($selectedTab == '0')
                		#parse ("app/htp/negeri/pajakan/perjanjian/frmPajakanTabDrafPerjanjianSenarai.jsp")
             		#end
                </div>
                ...
                <!-- content maklumat pajakan -->
                		...
                		#parse ("app/htp/negeri/pajakan/perjanjian/frmPajakanTabMaklumatPajakan.jsp")
					#end               	
              </div>
              <!-- close content maklumat pajakan -->
                ...
                <!-- content MOA -->
					#if ($selectedTab == '2')
	                	#parse ("app/htp/negeri/pajakan/perjanjian/frmPajakanTabMOA.jsp")
					#end               	
              </div>
              <!-- close content MOA -->
              ...
              <div class="TabbedPanelsContent">
                <!-- content Borang 15A -->
					#if ($selectedTab == '3')
						#parse ("app/htp/negeri/pajakan/perjanjian/frmPajakanTabBorang15A.jsp")
					#end               	
              </div>
              ...
              <div class="TabbedPanelsContent">
                <!-- content Kelulusan Jemaah Menteri -->
					#if ($selectedTab == '4')
	                	#parse ("app/htp/negeri/pajakan/perjanjian/frmPajakanTabKelulusanJemaahMenteri.jsp")
					#end               	
              </div>
...
#if (($idFail != '' && $idStatus != '1' && $idStatus != '6' && $idStatus != '12' && $idStatus != '63' && $idStatus != '65')|| $!page == "4")

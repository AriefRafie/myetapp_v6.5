    	...
    	<legend><strong>MAKLUMAT PAJAKAN</strong></legend>
            ...
            #foreach ($beanPajakan in $BeanPajakan)
              ...
              <tr>
                ...
                <td>:</td>
                <td><input type="text" name="txdTarikhTamatPajakan" id="txdTarikhTamatPajakan" size="11" value="$beanPajakan.tarikhTamat" onblur="check_date(this)" class="$classDis" $readOnly/>

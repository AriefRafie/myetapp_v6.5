                   ...
                   <fieldset>
                    <legend><strong>MAKLUMAT PERMOHONAN</strong></legend>
                        ...
                        #foreach ($beanMaklumatPermohonan in $BeanMaklumatPermohonan)
                         ...
                         <td>:</td>
                         <td><input type="text" name="txtNoFailLain" id="txtNoFailLain" size="43" value="$beanMaklumatPermohonan.noFailLain" onkeyup="this.value=this.value.toUpperCase();" $readOnly class="$classDis"/></td>
                         </tr>
                         <tr>
                           <td>
                         <!--	#if ($mode != 'view')<span class="style1">*</span>#end --> 
                    ...
                    <legend><strong>SENARAI HAKMILIK</strong></legend>
                        ...
                        <table align="center" width="100%">
                              ...
                              <!--<td scope="row" width="5%" align="center"><strong>Bil.</strong></td>
                            	...
                            	<td width="15%"><strong>Negeri</strong></td>
                             	...
                             	<td width="8%"><strong>Luas Dipohon</strong></td>
                              	...
                              	<td width="16%">Bandar/Pekan/Mukim</td>
                              	<td width="13%">No. Hakmilik</td>
                              	<td width="13%">No. Warta</td>
                             	<td width="10%">No. Lot/PT</td>
                             	<td width="8%">Luas Pohon</td>
                              	<td width="7%">Hapus</td>
                            </tr>
                          #set ($list = "")
                          ...
                          <tr>
                            ...
                            <td class="$row"><a href="javascript:kemaskiniTanah('$!idPermohonan','$list.idHakmilikUrusan');">$!list.negeri</a></td>
                            ...
                            <td class="$row" align="center">
  							...
  							#if (!$!jenisAkses.equals('Readonly')) 
                            	<input type="button" value="Hapus" onclick="doDeleteHakmilik('$list.idHakmilikUrusan');"/>
                            #end

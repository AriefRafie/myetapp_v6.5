...
<fieldset><legend>MEMORANDUM JEMAAH MENTERI</legend>
        ...
        <td colspan="2">
            ...
            <table width="100%" border="0">
	              <tr>
	                ...
	                <td width="70%">
					#if($!readOnly.equals(''))
	                	<input type="text" name="txdTHPTP" id="txdTHPTP" size="11" value="$!tarikhHantarPTP" onBlur="check_date(this)" />
	              ...
	              <tr>
	                ...
	                <td>
					#if($!readOnly.equals(''))
	                	<input type="text" name="txdTTPTP" id="txdTTPTP" size="11" value="$!tarikhTerimaPTP" onBlur="check_date(this)" />
	              ...
	              <tr>
	                ...
	                <td>
					#if($!readOnly.equals(''))
	                	<input type="text" name="txdTHTUP" id="txdTHTUP" size="11" value="$!tarikhHantarKSU" onBlur="check_date(this)" />
	              ...
	              <tr>
	                ...
	                <td>
					#if($!readOnly.equals(''))
	                	<input type="text" name="txdTMJM" id="txdTMJM" size="11" value="$!tarikhMesyuaratMJM" onBlur="check_date(this)" />               
	              ...
	              <tr>
	                ...
	                <td>
					#if($!readOnly.equals(''))
	                	<input type="text" name="txdTTK" id="txdTTK" size="11" value="$!tarikhTerimaKeputusan" onBlur="check_date(this)" />
	              ...
	              <tr>
	                ...
	                <td>
					#if($!readOnly.equals(''))
	                	<input type="text" name="txtNoMemorandum" size="30" value="$!noMemorandum" onBlur="this.value=this.value.toUpperCase();" /></td>
	              	#else
	              		$!noMemorandum
	              	#end
	              </tr>
	              <tr>
                	...
                	#if ($!readOnly.equals(''))
	            		<select name="txtKeputusan" id="txtKeputusan" class="$classDis" $classDis style="width:200">
	              ...
	              <tr>
	                ...
	                <td valign="top">
					#if($!readOnly.equals(''))
	                	<textarea name="txtKeterangan" id="txtKeterangan" cols="50" rows="5" onkeyup="this.value=this.value.toUpperCase();" >$!tindakanLanjut</textarea>
	              	#else
	              		$!tindakanLanjut
	              	#end
	              	</td>
	              ...
	              <tr>
	                ...
	                <td valign="top">
					#if($!readOnly.equals(''))
	                	<input type="text" name="txdTMKPemohon" size="11" id="txdTMKPemohon" onblur="check_date(this)" value="$!tarikhMaklumanKeputusan" maxlength="10" />
	              ...
	              <tr>
	                ...
	                <td valign="top">:</td>
	                <td valign="top">
							<input type=text size=2 name=jumlahlampiran $readOnly onBlur="doChangeJumlahLampiran('3',this,'$!action');" 
							...
							#foreach($mo in $senaraidokumen)
								...
								<!--	<tr>
									...
									<a class="opener" href="javascript:deleteDetailImej($mo.idDokumen,$mo.idLampiran)" 
										...
										<img src="../img/delete.gif" alt="hapus" />
									</a>
							#end
							</td>
	              		</tr>
	...
	<tr>
    	<td align="center">
	            	...
	            	#end
	                <input class="stylobutton100" name="cmdcetak" type="button" value="Cetak" onclick="javascript:cetakPemajak('$!idPermohonan');"/>
	            #end  
                
                #if ($idStatus == '65')
					#if (!$!jenisAkses.equals('Readonly'))
                <input type="button" name="cmdSeterusnya" id="cmdSeterusnya" value="Selesai Memorandum" onclick="javascript:seterusnya()" />
	            	#end
                #end
            #elseif ($mode == 'update')
					#if (!$!jenisAkses.equals('Readonly'))

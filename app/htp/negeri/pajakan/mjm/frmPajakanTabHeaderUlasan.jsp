       ...
       <div id="TabbedPanels2" class="TabbedPanels">
         <ul class="TabbedPanelsTabGroup">
           ...
           <li class="TabbedPanelsTab" title="Ulasan JPPH" onclick="doChangeTabLower(1)" tabindex="0">ULASAN JPPH</li>
            <li class="TabbedPanelsTab" title="Ulasan SPHP" onclick="doChangeTabLower(2)" tabindex="0">ULASAN SPHP</li>
           </ul>
              ...
              <div class="TabbedPanelsContentGroup">              
                ...
                <!-- content Ulasan KJP -->
                		...
                		#parse ("app/htp/negeri/pajakan/mjm/ulasan/frmPajakanTabUlasan.jsp")
					#end               	
              </div>
              <!-- close content Ulasan KJP -->
               ...
               <div class="TabbedPanelsContent">
                <!-- content Ulasan JPPH-->
                		...
                		#parse ("app/htp/negeri/pajakan/mjm/ulasan/frmPajakanTabUlasanJPPH.jsp")
					#end               	
              </div>
              <!-- close content Ulasan JPPH-->
                ...
                <!-- content  Ulasan JPPH -->
	                	...
	                	#parse ("app/htp/negeri/pajakan/mjm/ulasan/frmPajakanTabUlasanSPHP.jsp")
					#end               	
              </div>
              <!-- close content  Ulasan JPPH -->

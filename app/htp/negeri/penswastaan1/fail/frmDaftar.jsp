...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
    ...
    <legend><strong>MAKLUMAT FAIL</strong></legend>
        ...
        ##foreach ($beanMaklumatPermohonan in $BeanMaklumatPermohonan)
         ...
         <tr>
            ...
            <td width="1%">:</td>
            <td width="70%">
            	<input type="text" size="30" maxlength="100" name="noFail"  id="noFail" value="$!permohonan.getPermohonan().getPfdFail().getNoFail()"  readonly="readonly" class="disabled"/>        	
            </td>
         </tr>
         ...
         <tr>
            ...
            <td>No. Fail UKAS</td>
            <td>:</td>
            <td><input type="text" size="30" maxlength="100" name="txtNoFailKJP" id="txtNoFailKJP" $readonly class="$inputTextClass" value="$!permohonan.getNoRujukanKJP()" onblur="this.value=this.value.toUpperCase();" /></td>
         </tr>
         <tr>
         	<td>#if ($mode != 'view')<span class="style1">*</span>#end</td>
            ...
            <td>:</td>
            <td><input type="text" size="11" maxlength="10" name="tarikhSuratKJP" id="tarikhSuratKJP" onblur="check_date(this)" $readonly class="$inputTextClass" value="$!permohonan.getTarikhSurat()"/>
            #if ($mode != 'view')
         ...
         <td>:</td>
         <td>
         	<input type="text" size="30" maxlength="100" name="txtNoFailLain" id="txtNoFailLain" value="$!permohonan.getNoRujukanLain()" onblur="this.value=this.value.toUpperCase();" $readonly class="$inputTextClass"/>
        	#if ($mode != 'view')
        ...
        <!-- <tr>
         ...
         <tr>
           ...
           <td valign="top">Tajuk/Projek</td>
            <td valign="top">:</td>
            <td valign="top"><textarea name="txtTajuk" id="txtTajuk" rows="5" cols="50" $readonly class="$inputTextClass" onblur="this.value=this.value.toUpperCase();">$!permohonan.getPermohonan().getTujuan()</textarea></td>
         </tr>
         ##end
        </table>
    </fieldset>    
  ...
  <tr>
    ...
    <td width="70%">
    	...
    	<input type="button" class="stylobutton100" name="cmdBatal" id="cmdBatal" value="Batal" onclick="kembali()"/>
    #end
    #if($mode == 'view')

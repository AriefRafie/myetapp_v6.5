<table width="100%" border="0" cellspacing="2" cellpadding="2">
	<tr>
		<td>
		#parse ("app/htp/frmPajakanKecilInfoOnline.jsp")			
...
## 0=
	...
	#set ($selectstyle = "disabled class=disabled" )
 	...
 	<tr>
    	<td>	
			<fieldset><legend><strong>MAKLUMAT HAKMILIK/PEMILIK ONLINE</strong></legend>
				        				...
				        				<fieldset><legend>HAKMILIK</legend>
				          				<table width="100%" border="0">
					            			<tr>
									            ...
									            <td width="1%">:</td>
					              				<td width="58%"><input name="lblnegeri" value="$infohakmilik.labelNegeri" readonly="readonly" disabled="disabled" class="disabled"></td>
					            			</tr>
					            			...
					            			<tr>
									              ...
									              <td width="1%">:</td>
					              				  <td width="58%"><input name="lblnegeri" value=" $infohakmilik.labelDaerah" readonly="readonly" disabled="disabled" class="disabled"></tr>
					            			<tr>
									        	<td width="1%"></td>
									            <td width="40%">
													<div align="right" class="labelinput">
									              ...
									              <td width="1%">:</td>
					              				  <td width="58%"><input name="lblnegeri" value="$infohakmilik.labelMukim" readonly="readonly"  class="disabled" size="30%"></td>
					            			</tr>	            			
					            			<!-- <tr>
									              <td width="1%">&nbsp;</td>
					            			...
					            			<tr>
									              ...
									              <td width="1%">:</td>
					              				  <td width="58%">
					                				<input name="lblnegeri" value="$infohakmilik.LotKeterangan$infohakmilik.NoLot" size="15"  readonly="readonly" disabled="disabled" class="disabled">
					              				  </td>
					            			</tr>
					            			<tr>
									              <td width="1%">&nbsp;</td>

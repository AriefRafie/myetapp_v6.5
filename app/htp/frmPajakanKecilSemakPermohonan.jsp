...
<tr>
	<td>	
		<fieldset><legend><strong>SENARAI SEMAKAN1</strong></legend>
			<!-- <table width="100%" >
				<tr>
				  	<td width="100%"> -->
...
<!--		</td>
							...
							<td align="center">
								#if ($pageMode == 2 )	
									<input type="button" class="stylobutton" name="cmdSimpan" id="cmdSimpan" value="Kemaskini " onclick="semakanPermohonanTambah('$permohonanInfo.idpermohonan')">
   									<input type="button" class="stylobutton" name="Cetak" id="Cetak" value="Cetak" onclick="javascript:senaraiSuratSkrinSemakan('tablesuratp');" />
									<input type="button" class="stylobutton" name="cmdSeterusnya" id="cmdsblm" value="Seterusnya" onclick="skrinSenaraiHakmilikPemilik('$permohonanInfo.idpermohonan')">
								#else
									<input type="button" class="stylobutton" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="semakanPermohonanTambah1('$permohonanInfo.idpermohonan','simpan')">	
									<input type="button" class="stylobutton" name="cmdKembali" id="cmdKembali" value="Batal" onclick="skrinSemakanPermohonan('$permohonanInfo.idpermohonan')">
 								#end

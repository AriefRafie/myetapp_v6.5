		...
		<table border="0" align="center" width="100%" >
		 	<tr>
		  	...
		  	<td width="97%" class="row2">
		  		<a href="javascript:openLaporan('ekptg.report.htp.LaporanUtamaHTP','IDSUBURUSAN=61','urusan','HTPRekodRingkasanMilikNegeri')" class="style1" >BILANGAN LOT TANAH PERSEKUTUAN (MILIK) MENGIKUT NEGERI</a>
		 	</td>
		   	</tr>
		  	<tr>
			  	<td width="3%" class="row1">2.</td>
			  	<td width="97%" class="row1">
			  		<a href="javascript:openLaporan('ekptg.report.htp.LaporanUtamaHTP','IDSUBURUSAN=61','urusan','HTPRekodRingkasanRizabKementerian')" class="style1" >BILANGAN TANAH PERSEKUTUAN (RIZAB) MENGIKUT KEMENTERIAN</a>
			 	</td>
		   	</tr>
		  	<tr>
			  	<td width="3%" class="row2">3.</td>
			  	<td width="97%" class="row2">
			  		<a href="javascript:openLaporan('ekptg.report.htp.LaporanUtamaHTP','IDSUBURUSAN=61','urusan','HTPRekodRingkasanRizabNegeri')" class="style1" >BILANGAN LOT TANAH PERSEKUTUAN (RIZAB) MENGIKUT NEGERI</a>
			 	</td>
		   	</tr>
		   	<tr>

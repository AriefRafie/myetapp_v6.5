...
<p>
   ...
   <input name="idbaucer" type="hidden" value="$!permohonanInfo.idbaucer"/>
    <input name="tahun" type="hidden" value="$!permohonanInfo.tahun"/>
...
function cetakSurat(id,temp,pg,jwt,tel,email) {
    ...
    var url = "../../servlet/ekptg.report.htp.SuratHTPCukai?idbaucer="+document.${formName}.idbaucer.value+"&bil="+document.${formName}.txtBilDokumen.value+"&idpermohonan="+id+"&template="+temp+param;

...
#end
<!-- kmie (20100820) used for next page button -->
#set ($nextPage = $page)
#set ($prevPage = $page)
<!-- end kmie -->
                ...
                <tr>
                    ...
                    <td  align="right">
                        ...
                        <select class="smallselect" name="itemsPerPage" onchange="javascript:doAjaxCall${formname}('doChanges','action=doChangeItemPerPage')">
                            ...
                            <option value="500" #if ($itemsPerPage == 500) selected #end>500</option>
                            <option value="1000" #if ($itemsPerPage == 1000) selected #end>1000</option>
                            <option value="3000" #if ($itemsPerPage == 3000) selected #end>3000</option>
                            <option value="5000" #if ($itemsPerPage == 5000) selected #end>5000</option>
                    	</select>
                    </td>
                 </tr>
            </table>
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<td width="70%">
		   ...
		   #if ($page > 10)
<!-- kmie (20100820) prev button $page value changed to take $prevPage instead of $previous10 -->
<!--        <img title="Previous 10" style="vertical-align=bottom;cursor:hand;cursor:pointer;" onclick="javascript:doAjaxCall${formname}('record_listing','action=getPrevious&page=$previous10')" src="../img/paging/page-prev.gif"> -->
		   	<img title="Previous 10" style="vertical-align=bottom;cursor:hand;cursor:pointer;" onclick="javascript:doAjaxCall${formname}('record_listing','action=getPrevious&page=$prevPage')" src="../img/paging/page-prev.gif">
<!-- end kmie -->
		   #else
		   	<img style="vertical-align=bottom;" src="../img/paging/page-prev-disabled.gif">
		   #end
...
<!-- kmie (20100820) next button page value changed to take $nextPage instead on $next10 -->
<!-- 		    <img title="Next 10" style="vertical-align=bottom;cursor:hand;cursor:pointer;"onclick="javascript:doAjaxCall${formname}('record_listing','action=getNext&page=$next10')" src="../img/paging/page-next.gif"> -->
		    <img title="Next 10" style="vertical-align=bottom;cursor:hand;cursor:pointer;"onclick="javascript:doAjaxCall${formname}('record_listing','action=getNext&page=$nextPage')" src="../img/paging/page-next.gif">
<!-- end kmie -->

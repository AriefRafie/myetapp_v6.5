			      				...
			      				<tr>
			        				<td valign="top">
				            			...
				            			<tr>
								              ...
								              <td width="1%"></td>
				              				  <td width="58%">
				                				<input type="text" name="txtnolot" size="15" value="$!nolot" onkeyup="this.value=this.value.toUpperCase();">
				              				  </td>
				            			</tr>
				            			<tr>
								              <td width="1%">&nbsp;</td>
					          				...
					          				<tr>
									        	...
									        	<td width="40%">
									              ...
									              <td width="1%" style="display:none">:</td>
					              				  <td width="58%" style="display:none"><input type="checkbox" name="copy" onclick="copyAlamat('maklumat_pemohon')" style="display:none"/>

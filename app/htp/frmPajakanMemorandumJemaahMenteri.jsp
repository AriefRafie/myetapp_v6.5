<!-- fir test -->
<script type="text/javascript" src="../library/js/jquery.uploadify.v2.1.0.min.js" ></script>
    ...
    <td>
       <div id="TabbedPanels1" class="TabbedPanels">
              ...
              <ul class="TabbedPanelsTabGroup">
                ...
                <li class="TabbedPanelsTab" title="Draf"  onclick="doChangeTab(2)" tabindex="2">DRAF PERJANJIAN I</li>
              ...
              <div class="TabbedPanelsContentGroup">
                ...
                <!-- content Ulasan KJP -->
					#if ($selectedTab == '1')
                        #parse ("app/htp/frmPajakanTabHeaderUlasan.jsp")
					#end
              	</div>
                ...
                <!-- content Draf -->
					#if ($selectedTab == '2')
	                	#parse ("app/htp/frmPajakanTabDrafMJM.jsp")
					#end
              	</div>
              	<!-- close content Draf -->
...
function SimpanUpdateJPPH(){
	...
	var StarikhTerimaJPPH = document.getElementById("txdTarikhHantarJPPH").value;
...
function SDraf(id){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmPajakanMemorandumJemaahMenteriView&mode=view&hitButton=saveDraf&idPermohonan="+id+"&txtKeteranganDraf="+document.${formName}.txtKeteranganDraf.value+"&txdTarikhTerimaDraf="+document.${formName}.txdTarikhTerimaDraf.value+"&txdTarikhHantarDraf="+document.${formName}.txdTarikhHantarDraf.value+"&idPermohonan="+document.${formName}.txtidPermohonan.value;
	document.${formName}.enctype="multipart/form-data";
	document.${formName}.encoding="multipart/form-data";
/*	document.${formName}.mode.value = "view";
...
function downloadPerjanjian(idPermohonan,idDeraf){
	var url = "../servlet/ekptg.view.htp.PajakanDisplayBlob?id="+idPermohonan+"&idderaf="+idDeraf;

			    		...
			    		<td width="50%" valign="top" >
		    				...
		    				<table width="100%" border="0">
				            	...
				            	<tr>
								    ...
								    <td width="1%"></td>
				              		<td width="58%">
				                		<input type="text" name="txtnolot" size="15" onkeyup="this.value=this.value.toUpperCase();" maxlength="20">
				              		</td>
				            	</tr>
				            	<tr>
									<td width="1%">&nbsp;</td>

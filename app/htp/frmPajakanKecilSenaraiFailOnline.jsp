...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr>
    	<td>    	
			<fieldset>
				<legend>CARIAN ONLINE</legend>
				<table width="100%" cellspacing="0" cellpadding="0" border="0">
					<tr>
					    <td width="29%"><div align="right">No Fail</div></td>
					    <td width="1%">:</td>
					    <td width="70%"><input name="nofail" type="text" id="nofail" size="40" value="$!txtNoFail"></td>
					</tr>
					<tr>
    					<td colspan=3>&nbsp;</td>
  					</tr>
  					<tr>
				    	...
				    	<td width="1%">&nbsp;</td>
				    	<td width="70%">
				    	<input class="stylobutton"  type=button name="cmdCari" id="cmdCari" value="Cari" onclick="javascript:carian()" />
				      	<input class="stylobutton"  type=button name="cmdKosongkan" id="cmdKosongkan" value="Kosongkan" onclick="javascript:cancel()" />
				      	</td>
				  	</tr>
				</table>
			</fieldset>
	...
	<tr>
    	<td>   		
			...
			<fieldset>
				<legend>SENARAI FAIL PAJAKAN KECIL TANAH/BANGUNAN ONLINE</legend>
...
function doChangeDaerah3Pemilik(){
	document.${formName}.pagemode.value = "doChangeDaerah3Pemilik";
	doAjaxCall${formName}("pkpemilikkemaskini");
}

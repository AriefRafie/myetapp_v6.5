    	...
    	<td>
			<div id="TabbedPanels1" class="TabbedPanels">          
			              <ul class="TabbedPanelsTabGroup"> 
			                   <li class="TabbedPanelsTab" title="Urusan Pindah Milik" tabindex="0" onclick="javascript:setSelected(0,'pindahMilik','ptambahanview',0)"><strong><font size="1">URUSAN PINDAH MILIK</font></strong></li>
			                   <li class="TabbedPanelsTab" title="Maklumat Pindah Milik" tabindex="0" onclick="javascript:setSelected(1,'maklumatview','maklumatview',0)"><strong><font size="1">MAKLUMAT PINDAH MILIK</font></strong></li>
			              </ul>              
				<div class="TabbedPanelsContentGroup">
			                ...
			                <div class="TabbedPanelsContent">
			          		...
			          		#if($selectedTab == '0')	                	
			                    	#parse("app/htp/penswastaan/pindahMilik.jsp")
			               	#end
			                ...
			                <div class="TabbedPanelsContent">					
			          		#if($selectedTab == '1')
			                    	#parse("app/htp/penswastaan/maklumatPindahMilik.jsp")
			               	#end

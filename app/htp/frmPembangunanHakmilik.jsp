...
<table width="1008" border="1">
  ...
  <tr>
    <td><table width="954" border="0" align="center">
      <tr>
        <td width="159">PENTADBIRAN</td>
        <td colspan="2"><strong>IMEJAN</strong></td>
        <td width="142">No. Hakmilik</td>
        <td width="9"><div align="center">:</div></td>
        <td width="303"><form id="form17" name="form13" method="post" action="">
            <label>
            <input type="text" name="txtNoHakmilik2" id="txtNoHakmilik2" />
            </label>
        </form></td>
      </tr>
      <tr>
        <td colspan="3" rowspan="2">&nbsp;</td>
        <td height="23">Direktori</td>
        <td><div align="center">:</div></td>
        <td><form id="form19" name="form14" method="post" action="">
            <label>
            <input type="file" name="txfDirektori" id="txfDirektori" />
</label>
                </form></td>
      </tr>
      <tr>
        <td>Perihal Imej</td>
        <td><div align="center">:</div></td>
        <td><form id="form21" name="form15" method="post" action="">
            <label>
            <textarea name="txtPerihalImej" id="txtPerihalImej" cols="45" rows="5"></textarea>
            </label>
                </form></td>
      </tr>
      <tr>
        <td colspan="3">Keterangan Ringkas Imej</td>
        <td colspan="2">&nbsp;</td>
        <td><input type="submit" name="btnEnlarge" id="btnEnlarge" value="Imej Penuh" /></td>
      </tr>
      <tr>
        <td colspan="3"><form id="form16" name="form16" method="post" action="">
          <label>
            <textarea name="txtPerihalRingkas" id="txtPerihalRingkas" cols="45" rows="5"></textarea>
            </label>
        </form>
        </td>
        <td colspan="2">&nbsp;</td>
        <td><input type="submit" name="btnCetakGambar" id="btnCetakGambar" value="Cetak Gambar" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>

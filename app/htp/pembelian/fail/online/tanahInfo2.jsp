				...
				<table WIDTH="100%">
                  	...
                  	<tr>
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="pautanms1" >
									...
									$!staraf
								#else							
								<select name="socTaraf" id="socTaraf" style="width:200px;" $readonly class="$disabled" $disabled $style >								             
                   		...
                   		<tr>
						    ...
						    <input type="text" name="txdTarikhTerima" id="txdTarikhTerima" size="10" value="$!urusan.getTarikhMula()" $classDis $mode  onkeyup="validateNumber(this,this.value);" onblur="check_date(this);validateTarikhSemasaIsNull(document.${formName}.txdTarikhTerima);" $style/>
		              <img src="../img/calendar.gif" border="0" onclick="displayDatePicker('txdTarikhTerima',false,'dmy');" />      						
                   		...
                   		<tr>
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
						    <input type="text" name="txdTarikhLuput" id="txdTarikhLuput" size="10" value="$!urusan.getTarikhLuput()" $classDis $mode onkeyup="validateNumber(this,this.value);" onblur="check_date(this);kiraTahun();" $style/>
		              <img src="../img/calendar.gif" border="0" onclick="displayDatePicker('txdTarikhLuput',false,'dmy');" />      						
                   		...
                   		<tr>
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
      							<input name="txtTempoh" type="text" id="txtTempoh" value="" size="4" onkeyup="validateNumber(this,this.value);" $style/>
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			...
                   			<input name="txtTarikhPermohonan" type="hidden" id="txtTarikhPermohonan" value="$!htpPermohonan.permohonan.tarikhTerima">
      							<input name="txtTempohbaki" type="text" id="txtTempohbaki" size="4" onkeyup="validateNumber(this,this.value);" $style/>
      						<span class="labelinput">Tahun</span>    			
      						</td>
                		</tr> 
<tr>
                   		...
                   		<tr>
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
							<input type="text" name="txtLuas" id="txtLuas" maxlength="40"  value="$!urusan.getLuas()" $mode $classDis $style/>
						   	</td>
                		</tr>                 		
                 	...
                 	<tr>
            			...
            			<tr>
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
                   				<input type="text" name="txtNoHakmilik" id="txtNoHakmilik" size="20" maxlength="21" value="$!urusan.getNohakmilik()"  onkeyup="this.value=this.value.toUpperCase();" $style/>
  							</td>
                		</tr>
                    	...
                    	<tr>
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
      							<span class="labelinput">No.Bang</span>&nbsp;<input name="noBangunan" type="text" class="$disabled" id="noBangunan"  value="$!urusan.getNoBangunan()" size="3" maxlength="3" $readonly onkeyup="this.value=this.value.toUpperCase();" $style/>
								<span class="labelinput">No.Ting</span>&nbsp;<input name="noTingkat" type="text" class="$disabled" id="noTingkat"  value="$!urusan.getNoTingkat()" size="3" maxlength="3" $readonly onkeyup="this.value=this.value.toUpperCase();"$style/>
								<span class="labelinput">No.Petak</span>&nbsp;<input name="noPetak" type="text" class="$disabled" id="noPetak"  value="$!urusan.getNoPetak()" size="3" maxlength="3" $readonly onkeyup="this.value=this.value.toUpperCase();"$style/>
                    	...
                    	<tr>
                        	...
                        	<td width="30%">
                  			...
                  			<td width="1%" class="labelinput" >:</td>
                   			<td width="68%" class="labeldisplay" >
      							<input type="text" name="txtNoLot" id="txtKodLot" maxlength="20" size="20" value="$!urusan.getNolot()" $mode $classDis onkeyup="this.value=this.value.toUpperCase();" $style/>
  							</td>
                		</tr> 					
                   		<tr>
  							<td width="1%"  >
                		...
                		<tr>
	                   	...
	                   	<tr>
	                        ...
	                        <td width="30%">
	                  		...
	                  		<td width="1%" class="labelinput" >:</td>
	                   		<td width="68%" class="labeldisplay" >
								<input type="text" name="txtNoPelan" id="txtNoPelan" maxlength="50" onkeyup="this.value=this.value.toUpperCase();" value="$!urusan.getNoPlan()" $mode $classDis $style/>
	        				</td>
	                	</tr>
	...
	<TABLE WIDTH="100%">
		<TR >
			<td align="center">
			#if($button == "simpan")
            	<input class="stylobutton" name="Simpan" value="Simpan" type="button" onclick="simpanMaklumatTanah();" $hide />
                <input class="stylobutton100" name="Kembali" value="Kembali" type="button" onclick="doAjaxCall${formName}('maklumatTanah','idPermohonan='+$!htpPermohonan.permohonan.getIdPermohonan())"/> 
           	#else
                <input class="stylobutton" name="Simpan" value="Kemaskini" type="button" onclick="doAjaxCall${formName}('kemaskiniMaklumatTanah')" $hide />
                <input class="stylobutton100" name="Kembali" value="Kembali" type="button" onclick="doAjaxCall${formName}('maklumatTanah','idPermohonan='+$!htpPermohonan.permohonan.getIdPermohonan())"/>
          	#end
            </td>
		</TR>

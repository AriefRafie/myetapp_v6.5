...
<fieldset> 
	<legend>CARIAN</legend>
		<table border="0" width="100%">
			<tr>
			    <td width="29%"><div align="right">No Fail <i>Online</i></div></td>
			    <td width="1%">:</td>
			    <td width="70%"><input name="noFailOnline" type="text" id="noFail" size="43" maxlength="400" value="$!carianNoFail" onkeyup="this.value=this.value.toUpperCase();"></td>
			</tr>
			<tr>
...
<tr>
  <td><table width="100%" class="header">
    ...
    <tr>
      <td colspan="7">#parse("app/utils/record_paging.jsp")</td>
       </tr>
...
function validateTarikhSemasaIsNull(inputfield) {
	...
	function cetakPengesahan(idpermohonan) {
	    ...
	    //var url = "../servlet/ekptg.report.htp.Borang14A.pdf";
	    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
	    if ((document.window != null) && (!hWnd.opener))
		hWnd.opener = document.window;
	    if (hWnd.focus != null) hWnd.focus();

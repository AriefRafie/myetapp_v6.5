...
<table width="100%">
	<tr>
	  <td colspan="2">
	    <input type="button" class="stylobutton100" name="cmdSimpan" id="cmdSimpan" value="Tambah" onclick="doAjaxCall${formName}('tambahTanah')" style="display:none">      </td>
	</tr>
    ...
    #set( $row = "row2" )
		...
		<tr >
		  ...
		  <td class="$row"><input type="button" value="Hapus" onclick="javascript:deleteTanah('$!mo.getIdhakmilikurusan()','$!htpPermohonan.permohonan.getIdPermohonan()')" $hide ></td>
    </tr>
      #end
</table>
</fieldset>

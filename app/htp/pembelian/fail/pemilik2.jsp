...
#if($mode != "0")
##else
#parse("app/htp/pembelian/fail/maklumatPemilik2.jsp") 
#end
<br />
<fieldset>
...
<table width="100%">
		<TR>
			<TD colspan="4">
				 <input type="button" name="cmdSimpan" id="cmdSimpan" value="Tambah" onclick="doAjaxCall${formName}('tambahPemilik')" style="display:none">
            </TD>
        </TR>
          <tr class="table_header">
...
<tr>
            ...
            <td scope="col"><input class="stylobutton" type="button" name="btnDelete" value="Hapus" onclick="doAjaxCall${formName}('deletePemilik')" style="display:none"><input type="hidden" name="Idpihakberkepentingan" value="$!pk.getIdpihakberkepentingan()" /></td>
          </tr>
           #end
</table>
</fieldset>

        				...
        				<td width="50%" align="center" valign="top">
        					<table width="100%" border="0">
        						<tr>
					        		...
					        		#else
					        			<input type="text" name="txtNoFailSek" size="28" value="$!htpPermohonan.permohonan.pfdFail.noFail" $inputstylereadnofail >					        		
					        		#end
                						      ...
                						      ##if($senaraiHakmilik.flagTanah == '1' || $senaraiHakmilik.flagTanah == '2' || $senaraiHakmilik.flagTanah == '5' )  
										 	  ...
										 	  <br>
										 	  <a href="javascript:CetakSenaraiHakmilikRizab('&idpermohonan=$!htpPermohonan.permohonan.idPermohonan','&template=HTPPembelianLaporanSenaraiMengikutFailKeseluruhan','ekptg.report.htp.NoFailTajukFail');" class="pautanms">Cetak Senarai Hakmilik/Rizab</a>
                						#end
					        		</td>					
			              		</tr>
			              		<tr>
...
<!--  FIX BUG!. NEVER USE MORE THAN 1 FIELD WITH SAME NAME! 

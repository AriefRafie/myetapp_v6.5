...
<tr>
  <td><table width="100%" class="header">
    ...
    <tr>
      ...
      <td class="$row">
      $!senarai.permohonan.getTujuan()
      <a href="javascript:papar('$!senarai.permohonan.getIdPermohonan()','$!senarai.getIdHtpPermohonan()')" class="style1">$!senarai.permohonan.getKeterangan()</a>
      </td>
      <td class="$row">$a</td>

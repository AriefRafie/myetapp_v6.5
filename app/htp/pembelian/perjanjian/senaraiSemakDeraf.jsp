...
<td colspan="2">
	...
	<tr>
		    	...
		    	<td align="center" colspan="2">
		    		...
		    		#if($semakMode == "update")
		    		 <input type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="doAjaxCall${formName}('senaraisemaksimpan')" />
                      <!--<input type="button" name="cmdKembali" id="cmdKembali" value="Kembali" onclick="kembaliDraft()" />-->
                      <input type="button" name="cmdKembali" id="cmdKembali" value="Kembali" onclick="setSelected(2,'senaraisemakview','senaraisemakview',0);" />
		    		#else
		    		
		    			<input type="button" name="cmdSimpan" id="cmdSimpan" value="Kemaskini" onclick="kemaskiniSemakS()" />
                   <!--<input type="button" name="cmdKembali" id="cmdKembali" value="Kembali" onclick="kembaliDraft()" />-->
                      <input type="button" name="cmdKembali" id="cmdKembali" value="Kembali" onclick="setSelected(2,'senaraisemakview','senaraisemakview',0);" />
		    		#end

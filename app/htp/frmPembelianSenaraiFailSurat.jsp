<strong> Senarai Fail Pembelian </strong>
<br><br>
...
<form name="f1" method="post">
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      ...
      <tr>
        <td height="25"  align="right">No. Fail : &nbsp;&nbsp;</td>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      ...
      <tr>
        ...
        <td class="$row"><a href="javascript:seterusnya('$fail.idPermohonan', '$fail.noFail')" class="style1 style1">$fail.noFail</a></td>

...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="1%"><div align="center">:</div></td>
    <td width="24%"><input name="txdTarikhRizab" type="text" id="txdTarikhRizab" value="$txdTarikhRizab" size="9" readonly="readonly" class="disabled" onkeyup="validateNumber(this,this.value);"/>    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="24%"><input name="txtKawasanRizab" type="text" id="txtKawasanRizab" style="text-transform:uppercase;" 
        value="$txtKawasanRizab" size="27" readonly="readonly" class="disabled"/>    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="1%"><div align="center">:</div></td>
    <td width="24%"><select name="socTaraf" id="socTaraf" style="width:200px;" readonly class="disabled" disabled>
...
Tahun</td>
  ...
  <tr>
    ...
    <td width="1%">:</td>
    <td width="24%"><input name="txtNoHakmilikAsal" type="text" id="txtNoHakmilikAsal" value="$txtNoHakmilikAsal" size="20" readonly class="disabled" /></td>
    ...
    <td colspan="6">
      ...
      <table border="0" width="100%">
        ...
        <tr class="$row">
          ...
          #if($senarai.bil!="")
          <td><a href="javascript:deleteHakmilikBaru('$senarai.idHakmilikAsal','$senarai.idHakmilikBaru')" class="style1"><div align="left" class="style2 style3">Hapus</div>
          </a></td>
          #else
          <td>&nbsp;</td>
          #end        </tr>
  ...
  <tr>
    ...
    <fieldset>
      ...
      <table width="100%" border="0">
        <tr>
          <td><div align="right">#if ($mode !='view')<i><font color="#ff0000">*</font></i> #end Jenis Hakmilik Sambungan</div></td>
          <td><div align="center">:</div></td>
          <td width="56%">$selectJenisHakmilikBaru</td>
        </tr>
        <tr>
          <td width="43%"><div align="right">#if ($mode !='view')<i><font color="#ff0000">*</font></i> #end No. Hakmilik Sambungan</div></td>
          <td width="1%"><div align="center">:</div></td>
          <td><label>
            <input name="txtHakmilikBerikut" type="text" id="txtHakmilikBerikut" size="30" $readonly2 class="$disabled2"/>
          </label></td>
        </tr>
        <tr>
          <td colspan="3"><i><font color="#ff0000">Perhatian</font> : Pastikan label bertanda <font color="#ff0000">*</font> diisi.</i></td>
        </tr>
      </table>
      </fieldset>    </td>
   </tr>
  ...
  <tr>
    <td colspan="6">
      ...
      #end  
      #if ($mode == 'update')
      <input type="button" name="btnSaveHakmilik" id="btnSaveHakmilik" value="Simpan" onClick="update_detailHakmilik('$idHakmilik','$socStatus')"/>
...
function kemaskini_detailHakmilik(id){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmRekodPendaftaranTanah&firstAction=kemaskiniDetailHakmilik&idHakmilik="+id;
	*/
	
	document.${formName}.submit();
	//doAjaxCall${formName}("kemaskiniDetailHakmilik","idHakmilik="+id);
}
function update_detailHakmilik(id,status){
  if(status == 'S'){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmRekodHakmilikSementara&firstAction=updateDetailHakmilik&idHakmilik="+id;
		...
		/* firzan edit to cater hakmilik sambungan combine with rekod hakmilik/rizab 
	document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmRekodPendaftaranTanah&firstAction=updateDetailHakmilik&idHakmilik="+id;
	*/
...
function tambahHakmilikSambungan(id){
	...
	"?_portal_module=ekptg.view.htp.FrmRekodHakmilikSementara&firstAction=addHakmilikBaru&idHakmilik="+id;
	
	
		/* firzan edit to cater hakmilik sambungan combine with rekod hakmilik/rizab 
	document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmRekodPendaftaranTanah&firstAction=addHakmilikBaru&idHakmilik="+id;
	*/
...
function hakmilikBaru(id){
	...
	/* firzan edit to cater hakmilik sambungan combine with rekod hakmilik/rizab 
	document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmRekodPendaftaranTanah&firstAction=daftarHakmilik&idHakmilik="+id;
	*/
...
function kembaliHakmilik(){
	...
	/* firzan edit to cater hakmilik sambungan combine with rekod hakmilik/rizab 
	document.${formName}.action = "?_portal_module=ekptg.view.htp.FrmRekodPendaftaranTanah&firstAction=&idHakmilik="+id;
	*/
	
	document.${formName}.submit();
}
function doChangeTaraf() {
	doAjaxCall${formName}("","firstAction=kemaskiniDetailHakmilik");
}
</script>

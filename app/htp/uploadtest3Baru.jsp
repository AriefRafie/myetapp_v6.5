...
function Upload(){
	...
	if ( document.f1.lblNegeri.value == "" ) { 
  		alert('Sila pilih negeri terlebih dahulu.');
  		document.f1.lblNegeri.focus(); return; 
	}
	document.f1.enctype="multipart/form-data";
	if ( !window.confirm("Adakah Anda Pasti?")) return;
	document.f1.action = "?command=uploadFile&extension="+ext+"&nama_dokumen="+nama_dokumen+"&fileupload11="+fileupload11+"&keterangan="+keterangan+"&lblNegeri="+lblNegeri+"&lblDaerah="+lblDaerah;
	document.f1.submit();

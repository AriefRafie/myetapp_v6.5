   <table border="0" cellpadding="3" cellspacing="2" width="100%">
                                        ...
                                        <tr>
                                                ...
                                                <b>PERJANJIAN PAJAKAN KECIL DI</b></td>
                                        ...
                                        <tr>
                                                <td height="2" width="3%">&nbsp;</td>
                                                <td colspan="4" height="2" width="39%">
                                                        <span id="form1:outputText1">Dengan hormatnya saya merujuk kepada </span>
...
Bersama-sama ini dikemukakan enam (6) salinan "Memorandum Of Sublease"
yang telah ditandatangani oleh Pesuruhjaya Tanah Persekutuan bagi pihak
Kerajaan Persekutuan.</td>
                                                <td height="2" width="5%">&nbsp;</td>
                                        </tr>
                                        <tr>
                                                <td width="3%">&nbsp;</td>
...
Sila endoskan Perjanjian tersebut di Pejabat Duti Setem dan kemukakan
sesalinan perjanjian yang telah disetemkan ke Jabatan ini untuk rekod
dan simpanan.</td>
                                                <td width="5%">&nbsp;</td>
                                        </tr>
                                        <tr>

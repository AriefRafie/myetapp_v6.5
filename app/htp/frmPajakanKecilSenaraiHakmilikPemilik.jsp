...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td>
		...
		<fieldset><legend><strong>SENARAI HAKMILIK </strong></legend>
  		<table width="100%" >
			<tr>
        		<td width="100%">
 			...
 			<tr>
        		<td width="100%">
  					<table width="100%" >
						  ...
						  <td class="$row">
						  	<input type="button" name="cmdTambah2" id="cmdTambah2" value="[+]" onclick="tambahHakmilik2('$permohonanInfo.idpermohonan','$senarai.idhakmilikurusan')"/>
						  </td>
        	...
        	<td width="100%">
			  ...
			  <td class="$row" width="43%">
				...
				$senarai.nama
			  	...
			  	<td class="$row">
			  		<input type="button" name="cmdTambah2" id="cmdTambah2" value="[+]" onclick="tambahHakmiliktoPemilik('$permohonanInfo.idpermohonan','$senarai.idpihakberkepentingan')"/>
			  	</td>
			  </tr>
  			#end
				#if ($cnts == 0)

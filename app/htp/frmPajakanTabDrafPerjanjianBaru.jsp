...
<table width="100%" border="0">
  <tr>
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="1%">:</td>
        <td width="50%"><input type="text" name="txdTarikhHantarDraf" id="txdTarikhHantarDraf" size="10" value="$tarikhHantarDraf" />
          <img src="../img/calendar.gif" alt="Calendar" border="0" style="display:$Style2" onClick="displayDatePicker('txdTarikhHantarDraf',false,'dmy');"></td>
        <td width="20%">&nbsp;</td>
      </tr>
      <tr>
        <td align="right">&nbsp;</td>
  ...
  <tr align="center">
    <td><input type="button" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onclick="" />
&nbsp;&nbsp;

<fieldset>
	...
	<div id="TabbedPanels3" class="TabbedPanels">
	  	<ul class="TabbedPanelsTabGroup">
		    ...
		    <li class="TabbedPanelsTab" tabindex="1" onClick="selectTab3('1','kemaskinipermohonan','Pembayaran','KeputusanPermohonan','')" style="display:none">KEPUTUSAN PERMOHONAN</li>
	  	</ul>
	         			...
	         			<td valign="top">
	         				<table width="100%" border="0">
						          <tr>
						            ...
						            <td width="1%">:</td>
						            <td width="58%">
						            	<input name="txtTarikhSuratKePTD" type="text" id="txtTarikhSuratKePTD" value="$!pembayaran.tarikhterima" size="11" maxlength="10" $style/>
									    #if($visible == 1)
						          ...
						          <tr>
						            ...
						            <td width="1%">:</td>
						            <td width="58%">
						            	<input name="txtTarikhBaucerCek" type="text" id="txtTarikhBaucerCek" value="$!pembayaran.tarikhbaucer" size="11" maxlength="10" $style/>
									    #if($visible == 1)
	        			...
	        			<td width="50%" valign="top">
	         				<table width="100%" border="0">
						          <tr>
						            ...
						            <td width="1%">:</td>
						            <td width="58%">
						            	<input name="txtTarikhResit" type="text" id="txtTarikhResit" value="$!pembayaran.tarikhresit" size="11" maxlength="10" $style/>
									    #if($visible == 1)
    ...
    onKeyUp="this.value=this.value.toUpperCase();" $style></td>
					...
					<!--<tr>
						...
						<p align="center">
							<div align="center">
						    #if ($tabmode == "3" && $!style == "")
						    	<input type="button" class="stylobutton"  value="Simpan" onclick="TambahPembayaran()" />
						    #elseif ($tabmode == "4" && $!style == "")
						   		<input type="button" class="stylobutton"  value="Simpan" onclick="doKemaskiniBuktiBayaran($tabmode)" />
						    #else
						    	<input type="button" class="stylobutton"  value="Kemaskini" onclick="doViewForKemaskiniBuktiBayaran($tabmode)" />
						    #end 
  				...
  				<table width="100%" border="0">
					...
					<!--<tr>
						...
						<p align="center">
							<div align="center">
						    #if ($tabmode == "3" && $!style == "")
						      <input type="button" class="stylobutton"  value="Simpan" onclick="TambahKeputusan()" />
						    #elseif ($tabmode == "4" && $!style == "")
						   	 <input type="button" class="stylobutton"  value="Simpan" onclick="doKemaskiniKeputusan($tabmode)" />
						    #else
						    <input type="button" class="stylobutton"  value="Kemaskini" onclick="doViewForKemaskiniKeputusan($tabmode)" />
						    #end 
							</div>
						</p>
    		</div>

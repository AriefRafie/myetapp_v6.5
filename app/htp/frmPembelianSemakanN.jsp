      ...
      <tr>
        ...
        <td align="center" valign="top" width="45%"><table width="100%" border="0">
              ...
              <tr>
                ...
                <td>:</td>
                <td><input type="text" name="txtNoFailKJP" id="txtNoFailKJP" onkeyup="this.value=this.value.toUpperCase();" size="28" maxlength="50" value="$tSurat" $mode /></td>
              </tr>
              <tr style="display:none">
                <td><div align="right"><font color="#FF0000">*</font></div></td>
...
function doChangeKementerian() {
	...
	document.${formName}.mode.value = "pilihkementerian";

    ...
    <tbody>
      <tr>
		<td align="center" valign="top"><table width="100%" border="0">
              <tr>
                <td><div align="right"><strong><strong><font color="#FF0000">*</font>Negeri :</strong></div></td>
                <td>$socNegeri</td>
              </tr>
              <tr>
                <td><div align="right"><strong><strong><font color="#FF0000">*</font>Kementerian :</strong></div></td>
              ...
              <tr>
                <td><div align="right"><strong><strong><font color="#FF0000">*</font>Urusan :</strong></div></td>
                <td>$socUrusan</td>
              </tr>
           	<!--<tr>
               ...
               <tr>
                <td valign="top"><div align="right"><strong><strong><font color="#FF0000">*</font>Tajuk :</strong></div></td>
                <td><label>
        ...
        <td align="center" valign="top"><table width="100%" border="0">
              ...
              <tr>
                <td><div align="right"><strong><strong><font color="#FF0000">*</font>Tarikh Buka Fail :</strong></div></td>
      ...
      <tr>
		...
		<input class="button" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick= "simpanFail()">
		&nbsp;&nbsp;<input class="button" type="reset" name="cmdBatal" id="cmdBatal" value="Batal" onclick="cancel">
		&nbsp;&nbsp;<input class="button" type="button" name="cmdKembali" id="cmdKembali" value="Kembali" onclick="backMain()">
</td>
      </tr>
    </tbody>
  </table>  

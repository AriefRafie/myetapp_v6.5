...
<td>
	...
	<!--<legend>LAPORAN</legend>-->
		...
		<table border="0" align="center" width="100%" >
		  	...
		  	<td class="row2">1.</td>
		  	<td class="row2">
		  		<a href="javascript:openLaporan('ekptg.report.htp.LaporanUtamaHTPManual','urusan=xx','urusantahun','LaporanHTPPrestasiMengikutTahun')" class="style1" >LAPORAN PRESTASI KESELURUHAN</a>
		 	</td>
		   	</tr>	
		</table>

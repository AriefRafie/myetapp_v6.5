...
<tr>
    <td>
		<fieldset><legend>MAKLUMAT PERMOHONAN ONLINE</legend>
  			<table width="100%">
      		<tr>
				...
				<td width="50%" align="center" valign="top">	
					<table width="100%" border="0">
						<tr>
			               <td width="35%" style="text-transform:uppercase;"><div align="right">No. Fail Online</div></td>
			                <td width="1%">:</td>
			                <td width="64%">
			                	<div align="left" class="stylelabel">$labelNoP</div>               	
							</td>		
			            </tr> 
			    		<tr>
...
<!--		</td>
							...
							<td align="center">
								#if ($pageMode == 2 )	
									<input class="stylobutton" type="button" name="cmdSimpan" id="cmdSimpan" value="Kemaskini " onclick="semakanPermohonanTambah('$permohonanInfo.idpermohonan')">
   									<input type="button" name="Cetak" id="Cetak" value="Cetak" 
		            					onclick="javascript:senaraiSuratSkrinSemakan('tablesuratp');" class="stylobutton" />
									<input class="stylobutton" type="button" name="cmdSeterusnya" id="cmdsblm" value="Seterusnya" onclick="skrinSenaraiHakmilikPemilik('$permohonanInfo.idpermohonan')">
								#else
									<input class="stylobutton" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="semakanPermohonanTambah1('$permohonanInfo.idpermohonan','simpan')">	
									<input class="stylobutton" type="button" name="cmdKembali" id="cmdKembali" value="Batal" onclick="skrinSemakanPermohonan('$permohonanInfo.idpermohonan')">
 								#end
...
<table width="100%" border="0">
  <tr>
    <td><a href="javascript:openSuratPegawai('ekptg.report.htp.SuratUtamaHTP','idsuburusan=38&idpermohonan=$permohonanInfo.idpermohonan','urusan','&template=HTPPajakanKecilSenaraiSemak')" class="pautanms">SENARAI SEMAKAN</a></td>
  </tr>
  <tr>

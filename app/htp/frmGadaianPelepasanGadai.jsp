<fieldset>
<legend style="font-variant:small-caps">Pelepasan Gadaian 711</legend>
<br/>
...
<fieldset>
<legend style="font-variant:small-caps">Senarai Fail</legend>

	<input name="add" value="Tambah" type="button" onClick="TambahPelepasan()">
  ...
  <table border="0" cellpadding="2" cellspacing="1" width="100%">
    <tbody>
      ...
      <tr>
        ...
        <td class="$row"><a href="javascript:fSFGA_seterusnya('$fail.id', '$fail.no')">$fail.no</a></td>
...
function viewDetails(idFail, idPermohonan){
	doAjaxCall${formName}("PelepasanGadaiDetails","idFail="+idFail+"&idPermohonan="+idPermohonan);
}
...
function viewDetailPemohonPelepasan(idFail,idPermohonan){
	doAjaxCall${formName}("PelepasanGadaiDetails", "idFail="+idFail+"&idPermohonan="+idPermohonan);
}

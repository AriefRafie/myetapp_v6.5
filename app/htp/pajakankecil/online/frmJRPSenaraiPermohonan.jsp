...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr>
    	<td> 
			<fieldset><legend>SENARAI PERMOHONAN JAWATANKUASA RUANG PEJABAT (JRP)</legend>
			#if (!$!jenisAkses.equals('Readonly'))

				#if ($!lanjutan.equals('ya'))
				<input type="button" class="stylobutton100" name="add" value="Tambah" onclick="tambahPermohonan2('$idFail')">
   				#end
   				<input type="button" class="stylobutton100" name="cmdKembali" value="Kembali" onclick="carianFailDariPermohonan('$!nomborFail')">    		
			#end

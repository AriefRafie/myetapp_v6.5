...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr>
		...
		#if($pagemode == "2" )
			<input class="stylobutton" type="button" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onclick="semakanPTPKemaskini('$permohonanInfo.idpermohonan')">
		#end
			    
		#if($pagemode == "0" || $pagemode == "3")
			<input class="stylobutton" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick="semakanPTPSimpan('$permohonanInfo.idpermohonan')">
			#if($pagemode == "0")			
			<input class="stylobutton" type="reset" name="cmdKosong" id="cmdKosong" value="Kosongkan">
			#end
		#end
	#end
			<!-- 

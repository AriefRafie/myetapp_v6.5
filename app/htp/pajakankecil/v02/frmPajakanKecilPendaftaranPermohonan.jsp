...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr>
		...
		#if ($pageMode == 2 )	
			<input  class="stylobutton100" type="button" name="cmdSimpan" id="cmdSimpan" value="Kemaskini" onclick= "simpanPermohonan($!fail_id)">
		#end
		#if ($pageMode == 0 || $pageMode == 4)	
			<input  class="stylobutton100" type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onclick= "simpanPermohonan($!fail_id)">
		...
		#end
		<input class="stylobutton100" type="button" name="cmdKembali" id="cmdKembali" value="Batal" onclick="senaraiPermohonanDariBatal('$!fail_id','$!idPermohonan')">			
		</td>
	</tr>

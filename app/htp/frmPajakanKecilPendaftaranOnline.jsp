...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr>
    	<td> 
			...
			<fieldset><legend>PENDAFTARAN FAIL ONLINE</legend>
						...
						<td width="50%" align="center" valign="top">	
							...
							<table width="100%" border="0">
			              		...
			              		<tr>
					        		...
					        		<td width="68%">
										<textarea name="txttajuk" cols="41" rows="5" onkeyup="this.value=this.value.toUpperCase();"  $classDis>$tajuk</textarea>					        		
					        		</td>					
			              		</tr>			              			        		
		              		</table>
			        	...
			        	<td width="50%" align="center" valign="top">
			        		<table width="100%" border="0">
			              		<tr>
					        		...
					        		<td width="1%"><div align="center">:</div></td>
					        		<td width="68%"><input type="text" name="txtNoFailSek" size="30" value="$nofailseksyen"  $inputstylerep onkeyup="this.value=this.value.toUpperCase();" ></td>							              			
		              			</tr>		
			              		<tr>
						      		<!-- <td width="1%"><span class="labelmandatory">*</span></td> -->
						      		<td width="1%"></td>
					        		...
					        		<td width="1%"><div align="center">:</div></td>
					        		<td width="68%"><input type="text" name="txtNoFailLain" size="30" value="$nofaillain" id="txtNoFailLain" onkeyup="this.value=this.value.toUpperCase();" $classDis></td>							              			
		              			</tr>			              			        			
			              		<tr>
						      		<!-- <td width="1%"><span class="labelmandatory">*</span></td> -->
						      		<td width="1%"></td>
					        		...
					        		<td width="1%"><div align="center">:</div></td>
					        		<td width="68%">
					        			<input type="text" name="txdTarikhSuratKJP" value="$tarikhsurat" id="txdTarikhSurKJP" size="15" onkeyup="validateNumber(this,this.value);" onblur="check_date(this);checkDate();" $classDis>
					        			#if ($pageMode != 2 )	
			              		...
			              		<tr>
					        		...
					        		<td width="1%"><div align="center">:</div></td>
					        		<td width="68%"><input type="text" name="txdTarikhBukaFail" value="$tarikhdaftar" id="txdTarikhBukaFail" size="15"  readonly $inputstyledate></td>							              			
		              			</tr>		
		              		</table>						
						</td>
			    	</tr>				    						
	...
	<tr>		
		<td align=center>
		#if ($pageMode == 2 )	
			<input  class="stylobutton" type="button" name="cmdSimpan" id="cmdSimpan" value="Kemaskini" onclick= "simpanFail()">
			<input type="button" class="stylobutton" onclick="javascript:cetakKulitFail('$idPermohonan');" value="Cetak Kulit Fail" />

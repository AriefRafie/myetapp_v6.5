...
function cetakMasuk(DariTarikh,HinggaTarikh,Flag_dokumen,ekptg_user_id) {
  ...
  if(DariTarikh != "" && HinggaTarikh != "")
  {
	...
	var url = "../servlet/ekptg.report.pfd.DaftarSuratKPTG?reportType=PDF&DariTarikh="+DariTarikh+"&HinggaTarikh="+HinggaTarikh+"&Flag_dokumen="+Flag_dokumen+"&user_id="+ekptg_user_id;

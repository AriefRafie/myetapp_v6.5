...
#parse("app/utils/record_paging.jsp")
  <table width="100%" >
    <tr>
      <td colspan="4"><input id="cmdBaru" name="cmdBaru" type="button" value="Tambah" onclick="newMesyuarat();" /><!--&nbsp;<input id="cmdCetakSenarai" name="cmdCetakSenarai" type="button" value="Cetak Senarai" onclick="printList();" />--></td>
    </tr>
...
#foreach ($fail in $ListMesyuarat)
    ...
    <tr>
      ...
      <td class="$row" valign="top" align="center">$fail.ListStatus</td>
    #else
...
function searchMesyuarat() {
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.FrmViewMesyuarat&actionx=carianMesyuarat";
	document.${formName}.submit();
}
...
function newMesyuarat() {
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.FrmViewMesyuarat&actionx=daftarMesyuarat&ID_MESYUARAT=";
	document.${formName}.submit();
}
function printList() {

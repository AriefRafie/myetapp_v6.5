...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0" >LOG DOKUMEN KELUAR</li>
...
<fieldset>
  ...
  <tr>
    ...
    <td width="70%"><select name="socJenisDokumen" id="socJenisDokumen" $readOnly $disabled>
        ...
        <option value="3">E-MAIL</option>
        <option value="4">DOKUMEN TERPERINGKAT</option>
        <option value="5" selected="selected">LAIN-LAIN</option>
...
CD</td>
  ...
  <tr>
    ...
    <tr>
    	...
    	<td align="left" valign="top" scope="row">:</td>
    	<td>
    	#foreach($paparLampiranLogDokumenKeluarPapar in $SenaraiListLampiranLogDokumenKeluarPapar)
	      <table width="100%" border="0">
	        <tr>
 ...
 <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <textarea name="tajuk_Dokumen" cols="70" rows="6" id="tajuk_Dokumen" onblur="this.value=this.value.toUpperCase();" onkeyup="this.value=this.value.toUpperCase();" $readOnly $disabled>$!tajuk_Dokumen</textarea>
       <script> 
								              	var area2 = new FCKeditor("tajuk_Dokumen");
												area2.ToolbarSet = 'PFD';
  ...
  <tr>
    ...
    <td align="left" valign="top" scope="row">:</td>
    <td><select name="socJenisPenghantaran" id="socJenisPenghantaran" $readonlych $disabledch>
      ...
      <option value="6" >SIMPANAN FAIL</option>
      ...
      <option value="3" >POS BERDAFTAR</option>
      <option value="4" >FAX</option>
      <option value="5" selected="selected">E-MAIL</option>
      <option value="6" >SIMPANAN FAIL</option>
      
       #elseif ($jenis_Penghantaran == '6')
      ...
      <option value="4" >FAX</option>
      <option value="5" >E-MAIL</option>
      <option value="6"  selected="selected">SIMPANAN FAIL</option>
  ...
  <tr>
    ...
    <td align="left" valign="top" scope="row">:</td>
    <td><input name="tarikh_Dokumen_Dihantar" type="text" id="tarikh_Dokumen_Dihantar" value="$!tarikh_Dokumen_Dihantar" size="10" $readOnlyTH  $disabledTH/>
...
function simpanLogDokumen(){
	...
	if (document.${formName}.socJenisPenghantaran.value == ""){
	...
	else if (document.${formName}.tarikh_Dokumen_Dihantar.value == ""){
		...
		document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumen&action1=simpanLogDokumenKeluar";
		document.${formName}.submit();
	}
}
function updateLogDokumen(){
	...
	function papar_Lampiran(id) {
		//Kemaskini pada 04/02/2014 oleh Mohamad Rosli, Error!! No Data 

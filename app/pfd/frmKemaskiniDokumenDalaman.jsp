...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0">DOKUMEN DALAMAN</li>
  </ul>
 ...
 <fieldset>
       <legend>MAKLUMAT DOKUMEN DALAMAN</legend>
   <table width="100%">
  <tr>
...
CD</label></td></td>
 ...
 <tr>
  ...
  <tr>
    <td colspan="4" scope="row"><span class="style5 style47 style69 style6"><span class="style40">Perhatian </span>: Pastikan label berwarna <span class="style40">*</span> wajib diisi.</span></td>
  </tr>
  <tr>
    <td colspan="4" align="center" scope="row">
      ...
      <input type="button" name="cmdKembali1" id="cmdKembali1" value="Kembali" onClick="kembaliTabDalaman()"/>
	#end
    #if($mode == 'New')
...
<input type="button" name="cmdKembali3" id="cmdKembali3" value="Kembali" onClick="kembaliTabDalaman()"/>
#end
        #if($mode == 'PaparUpdate')
<input type="button" name="cmdKembali4" id="cmdKembali4" value="Kembali" onClick="kembaliTabDalaman()"/>
#end</td>
  </tr>
</table>
 </fieldset>
...
<p><span class="style5 style47 style69 style6"><span class="style40">Perhatian </span>:</span><span class="style5 style47 style69 style6">Dokumen berwarna <span class="style40">merah</span> - DOKUMEN MASUK, </span><span class="style5 style47 style69 style6">Dokumen berwarna hitam - DOKUMEN KELUAR dan </span><span class="style5 style47 style69 style6">Dokumen berwarna <span class="style45">hijau</span> - DOKUMEN DALAMAN</span></p>
<table width="100%" >
  ...
  <tr>
    ...
    <td class="$row"><a href="javascript:papar_dokumen('$fail.id_Dokumen')" class="style1">$fail.no_Rujukan_Dokumen</a></td>
    #else
        <td class="$row style45">$fail.no_Rujukan_Dokumen</td>
	#end
    <td class="$row style45">$fail.jenis_Dokumen</td>
    <td class="$row style45">$fail.tajuk_Dokumen</td>
    <td class="$row style45">$fail.nama_Pengirim</td>
    <td class="$row style45">$fail.nama_Penerima</td>
	 #if($fail.id_Lampiran != '')
    <td class="$row style40"><span class="$row"><img src="../img/paper_clip.png" align="right" style="vertical-align=bottom;" /></span></td>
    #else
    <td class="$row style40"><span class="$row"></span></td>
...
//	}
	...
	if ( !window.confirm("Anda Pasti?") ) return;
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.PendaftaranDokumen&action1=updateDokumenDalaman";
	document.${formName}.submit();	
}
...
function kemaskini(id){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.PendaftaranDokumen&action1=kemaskiniDokumenDalaman&idDokumen"+id;
	document.${formName}.submit();
}
...
function hapus(id){	
	if ( !window.confirm("Anda Pasti Untuk Hapus?"))return;
		document.${formName}.action = "?_portal_module=ekptg.view.pfd.PendaftaranDokumen&action1=hapusDokumenDalaman&idDokumen"+id;
		document.${formName}.submit();
}

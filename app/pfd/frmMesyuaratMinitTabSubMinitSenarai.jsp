...
<fieldset>
  ...
  <table width="100%" border="0" align="center">
    <tr>
      ...
      <td valign="top">$!SubMinit_Tajuk</td>
    </tr>
    <tr>
      <td align="right" valign="top"><div align="left">Sub-Minit</div></td>
      <td align="center" valign="top">:</td>
      <td valign="top">$!SubMinit_SubMinit</td>
    </tr>
    <tr>
      <td align="right" valign="top"><div align="left">Tindakan/Makluman</div></td>
      <td align="center" valign="top">:</td>
      <td valign="top">$!SubMinit_Tindakan<br />
   </td>
    </tr>
    <tr>
      <td align="right" valign="top"><div align="left">Maklumbalas</div></td>
      <td align="center" valign="top">:</td>
      <td valign="top"><textarea id="SubMinit_Maklumbalas" name="SubMinit_Maklumbalas" cols="80" rows="8" $readonlyMakluman>$!SubMinit_Maklumbalas</textarea>
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <input type="button" id="cmdSimpan" name="cmdSimpan" value="Simpan" onclick="simpanMesyuaratSubMinitEdit();" />
#end        </td>
    </tr>
    <tr>

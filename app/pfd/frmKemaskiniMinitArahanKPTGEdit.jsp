...
<table width="100%">
  ...
  <tr>
    ...
    <td scope="row">:</td>
    <td>
    <input type="button" name="cmdSimpan2" id="cmdSimpan2" value="1 Penerima" onclick = "tambahMinit1()" />
    <input type="button" name="cmdSimpan3" id="cmdSimpan3" value="2 Penerima" onclick = "tambahMinit2()" />
    <input type="button" name="cmdSimpan4" id="cmdSimpan4" value="3 Penerima" onclick = "tambahMinit3()" /></td>
  </tr>
</table>
</fieldset>
#if($modeSeksyen == '1')
...
#elseif($mode== 'KemaskiniSeksyen1' && $action == 'kemaskiniSeksyen1')
&nbsp;
<fieldset>
<legend>ARAHAN KE SEKSYEN LAIN</legend>
<input name="action" type="hidden" value="$action" />
...
<table width="100%">
  <tr>
    ...
    <td width="28%" align="left" scope="row"><strong>Penerima/Seksyen Pertama :</strong></td>
  ...
  <tr>
    <td align="left" scope="row"><span class="style1"></span></td>
    <td align="left" scope="row"><strong>Penerima/Seksyen Ke-Dua</strong></td>
    <td scope="row">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
    <tr>
...
#elseif($mode== 'KemaskiniSeksyen2' && $action == 'kemaskiniSeksyen2')
<fieldset>
<legend>ARAHAN KE SEKSYEN LAIN</legend>
<input name="action" type="hidden" value="$action" />
<input name="command1" type="hidden" />
...
<table width="100%">
  ...
  <tr>
    ...
    <tr>
      <td align="left" scope="row"><span class="style1"></span></td>
    <td align="left" scope="row"><strong>Penerima/Seksyen Ke-Tiga</strong></td>
    <td scope="row">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
    <tr>
...
#elseif($mode== 'KemaskiniSeksyen3' && $action == 'kemaskiniSeksyen3')
<fieldset>
<legend>ARAHAN KE SEKSYEN LAIN</legend>
<input name="action" type="hidden" value="$action" />
<input name="command1" type="hidden" />
...
<table width="100%">
  <tr>
    <td align="left" scope="row">&nbsp;</td>
    <td align="left" scope="row"><strong>Penerima/Seksyen Pertama :</strong></td>
    <td scope="row">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<table width="100%">
  <tr>
    ...
    <td align="left" scope="row" width="28%"><strong>Penerima/Seksyen Pertama :</strong></td>
...
function kembali(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=papar&pagemode=1";
	document.${formName}.submit();
}

function doChangeSeksyenPAR1() {
	document.${formName}.action.value = "tambahSeksyen1";
 	doAjaxCall${formName}("doChangeSeksyenPAR1","action=tambahSeksyen1");
}
function doChangeKemaskiniSeksyenPAR1() {
	document.${formName}.action.value = "kemaskiniSeksyen1";
 	doAjaxCall${formName}("doChangeKemaskiniSeksyenPAR1","action=kemaskiniSeksyen1");
}
function doChangeSeksyenPAR2() {
	document.${formName}.action.value = "tambahSeksyen2";
 	doAjaxCall${formName}("doChangeSeksyenPAR2","action=tambahSeksyen2");
}
function doChangeKemaskiniSeksyenPAR2() {
	document.${formName}.action.value = "kemaskiniSeksyen2";
 	doAjaxCall${formName}("doChangeKemaskiniSeksyenPAR2","action=kemaskiniSeksyen2");
}
function doChangeSeksyenPAR3() {
	document.${formName}.action.value = "tambahSeksyen3";
 	doAjaxCall${formName}("doChangeSeksyenPAR3","action=tambahSeksyen3");
}
function doChangeKemaskiniSeksyenPAR3() {
	document.${formName}.action.value = "kemaskiniSeksyen3";
 	doAjaxCall${formName}("doChangeKemaskiniSeksyenPAR3","action=kemaskiniSeksyen3");
}
...
function tambahMinit1(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=tambahSeksyen1&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value+"&minit_Arahan="+document.${formName}.minit_Arahan.value;
	document.${formName}.submit();
}
function tambahMinit2(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=tambahSeksyen2&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value+"&minit_Arahan="+document.${formName}.minit_Arahan.value;
	document.${formName}.submit();
}
function tambahMinit3(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=tambahSeksyen3&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value+"&minit_Arahan="+document.${formName}.minit_Arahan.value;
	document.${formName}.submit();
}
function simpanSeksyen1(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=simpanSeksyen1&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value+"&minit_Arahan="+document.${formName}.minit_Arahan.value;
	document.${formName}.submit();
}
function kemaskiniSeksyen1(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=kemaskiniSeksyen1&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value;
	document.${formName}.submit();
}
function batalKemaskiniSeksyen1(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=batalKemaskiniSeksyen1&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value;
	document.${formName}.submit();
}
function simpanKemaskiniSeksyen1(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=simpanKemaskiniSeksyen1&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value;
	document.${formName}.submit();
}
function simpanSeksyen2(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=simpanSeksyen2&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value+"&minit_Arahan="+document.${formName}.minit_Arahan.value;
	document.${formName}.submit();
}
function kemaskiniSeksyen2(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=kemaskiniSeksyen2&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value;
	document.${formName}.submit();
}
function batalKemaskiniSeksyen2(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=batalKemaskiniSeksyen2&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value;
	document.${formName}.submit();
}
function simpanKemaskiniSeksyen2(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=simpanKemaskiniSeksyen2&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value;
	document.${formName}.submit();
}

function simpanSeksyen3(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=simpanSeksyen3&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value+"&minit_Arahan="+document.${formName}.minit_Arahan.value;
	document.${formName}.submit();
}
function kemaskiniSeksyen3(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=kemaskiniSeksyen3&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value;
	document.${formName}.submit();
}
function batalKemaskiniSeksyen3(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=batalKemaskiniSeksyen3&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value;
	document.${formName}.submit();
}
function simpanKemaskiniSeksyen3(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.LogDokumenTKPK&action=simpanKemaskiniSeksyen3&idLogDokumenKPTG="+document.${formName}.idLogDokumenKPTG.value;
	document.${formName}.submit();
}
</script>
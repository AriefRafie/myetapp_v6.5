...
<fieldset>
  ...
  <table width="100%" border="0" align="center">
    ...
    <tr>
      ...
      <td align="center" valign="top" nowrap="nowrap">:</td>
      <td align="left" valign="top" nowrap="nowrap"><input name="Ahli_NoTelefon" type="text" id="Ahli_NoTelefon" value="$!Ahli_NoTelefon" size="50" maxlength="14" /></td>
    </tr>
    <tr>
      <td align="right" valign="top" nowrap="nowrap"><div align="left">No Faks</div></td>
      <td align="center" valign="top" nowrap="nowrap">:</td>
      <td align="left" valign="top" nowrap="nowrap"><input name="Ahli_NoFaks" type="text" id="Ahli_NoFaks" value="$!Ahli_NoFaks" size="50" maxlength="14" /></td>
    </tr>
    <tr>
...
<fieldset>
  ...
  <input type="button" id="cmdKosongkanAhli" name="cmdKosongkanAhli" value="Tambah Ahli" onclick="kosongkanAhli();" />
    ...
    </tr>#if($List_CarianAhliMesyuarat.size()>0)    
#set ($fail = '')
...
#else
    <tr>
      <td height="21" colspan="5" nowrap="nowrap">Tiada Rekod</td>
    </tr>
    #end
  </table>
</fieldset>
...
<script type="text/javascript">
  ...
  function kosongkanAhli() {
	...
	document.${formName}.Ahli_Email.value = "";
	document.${formName}.Ahli_NoTelefon.value = "";
	document.${formName}.Ahli_NoFaks.value = "";
	document.${formName}.Ahli_Jawatan.value = "";

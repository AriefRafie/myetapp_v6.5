...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    <li class="TabbedPanelsTab" tabindex="0" onclick="tabFailNegeriLama()">FAIL LAMA</li>
 ...
 <div class="TabbedPanelsContentGroup">
     ...
     <fieldset>
        ...
        <tr>
          ...
          <td width="70%"><label>#if($mode == 'baru' || $mode == 'kemaskini')
          <textarea name="txtTajukFailB" cols="41" id="txtTajukFailB" onblur="this.value=this.value.toUpperCase();" style="text-transform:uppercase;"  $disabledTajukFail $readonlyTajukFail>$tajukFailB</textarea>
           <script> 
                ...
                <tr>
          <td valign="top" class="style2" scope="row"><div align="center" class="style3 style1"><span class="style1">*</span></div></td>
          <td valign="top" scope="row"><span class="style43">Negeri</span></td>
          <td width="1%" align="left" valign="top" scope="row"><div align="right">:</div></td>
          <td>
              <label>$selectNegeriB</label></td>
        </tr>
                <tr>
                  <td class="style40" scope="row"><div align="center" class="style1"></div></td>
                  <td scope="row"><span class="style43">Daerah</span></td>
                  <td align="left" valign="top" scope="row">:</td>
                  <td>$selectDaerahB </td>
                </tr>
                <tr>
...
function update1(idFail){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.PendaftaranFail&action1=updateFailNegeriBaru";
	document.${formName}.idFail.value = idFail;
	document.${formName}.submit();
...
function kemaskini(idFail){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.PendaftaranFail&action1=kemaskiniFailNegeriBaru";
	document.${formName}.idFail.value = idFail;
	document.${formName}.submit();
...
//		}  	
	...
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.PendaftaranFail&action1=simpanFailNegeriBaru";
	document.${formName}.submit();
}
function tabFailNegeriLama(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.PendaftaranFail&action1=tabFailNegeriLama&modeAktiviti=";
	document.${formName}.submit();
}
...
function aktivitiTiada(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.PendaftaranFail&action1=tabFailNegeriBaru&modeAktiviti=tiada&socNegeriB="+document.${formName}.socNegeriB.value+"&socDaerahB="+document.${formName}.socDaerahB.value;
	document.${formName}.submit();

}
function aktivitiAda(){
	document.${formName}.action = "?_portal_module=ekptg.view.pfd.PendaftaranFail&action1=tabFailNegeriBaru&modeAktiviti=ada&socNegeriB="+document.${formName}.socNegeriB.value+"&socDaerahB="+document.${formName}.socDaerahB.value;
	document.${formName}.submit();

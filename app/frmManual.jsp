...
<script>
	...
	function menuUtama(){
		//document.${formName}.action = "$EkptgUtil.getTabID('<i>Dashboard</i>',$myrole)?_portal_module=$modul_";
		document.${formName}.action = "$EkptgUtil.getTabID('Dashboard',$myrole)?_portal_module=$modul_";

...
<fieldset id="headerppk" name="headerppk">
	...
	<p>
        ...
        <input type="hidden" name="idTblrujstatusstrata" id="idTblrujstatusstrata" value="$!idTblrujstatusstrata">
						...
						<tbody>
							<tr>
                               ...
                               <tr>
									...
									<td width="2%" scope="row">:</td>
									<td style="text-transform:uppercase;">$!bilPetak</td>
						  		</tr>
                                <tr>
...
<table width="100%" border="0">
	<tbody>
		<tr align="center">
			<th scope="col">
				<input type="button" id="cmdKemaskini" name="cmdKemaskini"  value="Kemaskini" onclick="javascript:kemaskini('$mode','$idTblrujstatusstrata')" />
				<input type="button" id="cmdBatal" name="cmdBatal" value="Kembali" onclick="javascript:kembali()"/>
				<!--<input type="button" id="cmdBatal" name="cmdBatal" value="Cetak" onclick="javascript:viewCetak()"/>-->
			</th>
		</tr>
	</tbody>
...
function kemaskini(mode,idTblrujstatusstrata){
	
	document.${formName}.mode.value = mode;
	document.${formName}.idTblrujstatusstrata.value = idTblrujstatusstrata;
...
function hideShow(value) {
	if(value == 'T'){
		...
		document.getElementById('trTarikhNoKelulusanKhas').style.display = 'none';

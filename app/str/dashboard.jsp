...
<table cellpadding="2" cellspacing="1" border="0" width="100%" class="nav" align="center">
  <tr>
    ...
    <td width="59%" valign="top"><!-- class="dashboard_sub_kiri" -->
                ...
                <td width="50%" valign="top"><table width="100%">
                    <tr>
                      ...
                      <td width="85%"><table>
                          ...
                          <tr>
                            <td> #set ( $tab = $EkptgUtil.getTabID("My Info",$portal_role) ) <a href="$tab?_portal_module=lebah.planner.CalendarModule" class="help" title="MyCalendar"> <font color="blue">
                          ...
                          <tr>
                            <td><a href="javascript:gotoInbox()" class="help" title="My Inbox"> <font color="blue">
                              <li>#if($!check_notifikasi_inbox > 0)
                                ...
                                &nbsp; #end Ruang Perbincangan Formal </li>
                              </font> </a></td>
                          </tr>
                        </table></td>
                    </tr>
...
/*
	function papar(ID_FAIL,ID_URUSAN,ID_SUBURUSAN,ID_STATUS,ID_PERMOHONAN,NO_FAIL) {

		
	
	if (ID_SUBURUSAN == '59'){	
		document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 8",$portal_role)?_portal_module=FrmPrmhnnSek8Internal&command=Kemaskini";
		...
		document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 17",$portal_role)?_portal_module=FrmPrmhnnSek17Senarai&command=Kemaskini";
		document.${formName}.ID_FAIL.value = ID_FAIL;
		document.${formName}.ID_PERMOHONAN.value = ID_PERMOHONAN;

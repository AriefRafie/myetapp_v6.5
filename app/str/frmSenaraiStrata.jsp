...
<fieldset>
<legend>
<strong>Maklumat Strata</strong></legend>
<table width="100%">
	<tr>
		<td>
...
//	var orderBy = document.${formName}.paramOrderBy.value;
	...
	var url = "../../servlet/ekptg.report.strata.senaraiStrata?idNegeri="+idNegeri+"&idDaerah="+idDaerah+"&noLot="+noLot+"&noCf="+noCf+"&pemaju="+pemaju+"&skim="+skim+"&txt_userLogin="+txt_userLogin+"&id_tahunDari="+id_tahunDari+"&id_tahunHingga="+id_tahunHingga+"&dummmy=";		

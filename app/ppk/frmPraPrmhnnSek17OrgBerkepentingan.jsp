    ...
    <div class="TabbedPanelsContentGroup">
                                    ...
                                    <tr>
                                     ...
                                     #set($pastcheck = "checked")   
                                      ...
                                      <td width="5%"><label>
                                        ...
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $nowcheck value="now" onclick="setSelected(0,3,0,0);PentingView()"  />
                                        </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "now") <span class="style42">Senarai Orang Berkepentingan Tambahan </span>#else
                                      Senarai Orang Berkepentingan Tambahan
                                      #end                                      </div></td>
                                    
                                    </tr>
                                       <td width="5%"><label>
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $pastcheck value="past" onclick="setSelected(0,3,0,0);PentingViewDulu()" />
                                         </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "past") <span class="style42">Senarai Orang Berkepentingan Terdahulu</span>                                      #else
                                      Senarai Orang Bekerpentingan Terdahulu
                                      #end                                      </div></td>
     ...
     <tr>
                                         <td>
                                          ...
                                          #end
                                           #if($nowpast == "past")
                                          MAKLUMAT ORANG BERKEPENTINGAN TERDAHULU
                                          #end</legend>
                                        <table width="100%" border="0">
                              <tr>
...
<select name="jenis_pemohon"  class="autoselect" $readmode id="jenis_pemohon" style="text-transform:uppercase;" onBlur="uppercase()" onChange="pilih_taraf()" >        
                                  ...
                                  </label>#if($!skrin_online != "yes" && $!skrin_online_17 != "yes")
...
<select name="jenis_pemohon"  class="autoselect" $readmode id="jenis_pemohon" style="text-transform:uppercase;" onBlur="uppercase()" onChange="pilih_taraf()" >        
                              ...
                              #set($readmodekp="disabled")
                                  ...
                                  <tr id="kp_lain">
                                    <td><div align="center"><span class="style40"></span></div></td>
                                    <td class="style38"><div align="left" class="style41 style38"><span class="style38">No. MyID Lain</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><span class="style36">
...
<span id="bandarsurat_b" >
 <input name="txtBandarWarisSurat_D" size="45" style="text-transform:uppercase;" readonly class="disabled" />
                                        ...
                                        <tr>
                                          ...
                                          <td valign="top"><div align="right" class="style38">:</div></td>
                                          <td><textarea name="txtCatatanPenting" cols="31"  rows="3"  $readmodeR class="$readmode"  >$txtCatatanPenting</textarea></td>
                                      </tr>
                                       <tr id="tr_flag_daftar"  style="display:none">
                                          <td valign="top"></td>
                                          <td  valign="top">Urusan Kemasukkan Maklumat OB
                   ...
                   <!--    <input type="button" name="hapuspenting" id="hapuspenting" value="Hapus"  onclick="setSelected(0,3,0,0);hapus_penting()" /> -->
                       ...
                       <input type="button" name="hapuspenting" id="hapuspenting" value="Hapus"  onclick="setSelected(0,3,0,0);hapus_penting()" />
                                  ...
                                  <input type="button" name="tambahpenting" id="tambahpenting2" value="Simpan" onclick="setSelected(0,3,0,0);tambah_simpan_penting()"/>	
                                    ...
                                    #if($boleh_kemaskini == "yes")<input type="button" name="hapuspenting" id="hapuspenting" value="Hapus"  onclick="setSelected(0,3,0,0);hapus_penting()" /> #end	
...
<!--
                  ...
                  <input type="hidden" name="idOb" value="" />
                            ...
                            <fieldset>
                              <legend>SENARAI ORANG BERKEPENTINGAN TERDAHULU</legend>
...
function PentingViewDulu() {
	document.f1.action = "";
	document.f1.mode.value = "Pentingviewdulu";
	document.f1.command.value = "Penting";
...
{
//alert(document.f1.socTarafKepentinganPentingU.value)

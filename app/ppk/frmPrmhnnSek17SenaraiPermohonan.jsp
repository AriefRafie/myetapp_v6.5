...
<fieldset>
<legend><b>Senarai Fail Pusaka Kecil Seksyen 17</b></legend>
...
<table align="center" width="100%"> 
  ...
  <tr>
    		...
    		<td colspan="6" scope="row" align="right">
    ...
    <tr class="table_header">
      ...
      <td width="25%">Nama Simati</td>
      <td width="15%">Tarikh Mohon</td>
      <td width="15%">Status Fail</td>
      <td width="20%"><div align="center">Maklumat Permohonan</div></td>
    </tr>
   #set ($noFail = "")
   #set ($tarikhDaftar = "")
   #set ($tarikh_Mohon = "")
    ...
    #set ($cnt = 0)
	       ...
	       #foreach($fail in $Senaraifail1)
	           ...
	           #set ($i = $velocityCount)
				   ...
				   #set ($namasimati = $fail.namasimati)
                    #set ($no_subjaket = $fail.no_subjaket)
					   ...
					   <tr >
				          <td class="$row">$bil</td>
				         <td class="$row"><a href="javascript:edit_item('$fail.id_Permohonan','$fail.id_simati','$flagno','$idFlag','$SimpanStatus','$no_subjaket')" class="style1">$noFail
				          </a></td>
				          <td class="$row">$namasimati.toUpperCase()</td>
				          <td class="$row">$tarikh_Mohon</td>
				          <td class="$row">$keterangan</td>
                          <td class="$row"><div align="center"><a href="javascript:tab('$fail.id_Permohonan','$fail.id_simati','$fail.id_Pemohon','$no_subjaket')" class="style1">Seterusnya</a></div></td>
    </tr>
   		...
   		#set ($cnt2 = 0)
	         ...
	         #set ($i = $velocityCount)
                   ...
                   #set ($no_subjaket = $fail1.no_subjaket)
        ...
        <tr >
          <td class="$row">$bil</td>
       <td class="$row"><a href="javascript:edit_item('$fail1.id_Permohonan','$fail1.id_simati','$flagno','$idFlag','$SimpanStatus','$no_subjaket')" class="style1">$noFail
           </a></td>            
           
          <td class="$row">$namasimati.toUpperCase()</td>
          <td class="$row">$tarikh_Mohon</td>
          <td class="$row">$keterangan</td>
           <td class="$row"><div align="center"><a href="javascript:tab('$fail1.id_Permohonan','$fail1.id_simati','$fail1.id_Pemohon','$no_subjaket')" class="style1">Seterusnya</a></div></td>
    </tr>
    #end
...
<input type="hidden" name="idSimati" />
    ...
    <input type="hidden" name="flagno" />
      <input type="hidden" name="no_subjaket" />

</form>
<script>
function tab(id,id2,id3,ns)
{
...
function search_data(){
	...
	if (document.f1.txtNoFail.value == "" && document.f1.txtPemohon.value == "" && document.f1.txtSimati.value == "" && document.f1.txtIcSimati.value == "" && document.f1.jenisIc.value == "0"){
		alert("Sila masukkan maklumat yang ingin dicari.");
		document.f1.txtNoFail.focus();
	}
	else if(document.f1.jenisIc.value != "0" &&  document.f1.txtIcSimati.value == "")
	{
		alert("Sila masukkan no kad pengenalan simati.");
		document.f1.txtIcSimati.focus();
	
	}
	else if(document.f1.jenisIc.value == "0" &&  document.f1.txtIcSimati.value != "")
	{
		alert("Sila pilih jenis kad pengenalan simati.");
		document.f1.jenisIc.focus();
...
function edit_item(id,id2,x,y,z,ns){

  ...
  <div id="TabbedPanels1" class="TabbedPanels">
      ...
      <div class="TabbedPanelsContent"> <br/>
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td width="1%">:&nbsp;</td>
              <td width="73%"><input type="radio" $serahA $disableZERO1  name="sorJenisSerah" $check1 value="1" onClick="disablePOS();enableT()" >
                    Serahan Tangan</td>
            </tr>
                <tr>
              <td>&nbsp;</td>
          ...
          <div style="width:100%;height:252;overflow:auto"> #end
            ...
            #if($data.jenis_serah=="2")
            	#set($noSurat=$data.no_surat_daftar)
            #elseif($data.jenis_serah=="4")
            	#set ($daftarPos_2=$data.no_surat_daftar)
            #end

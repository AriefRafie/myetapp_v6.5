...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0" onclick="setSelected(3);maklumatSerahan('$id_permohonan','$id_status')">MAKLUMAT SERAHAN BORANG K3</li>
  </ul>
	...
	<table width="100%"  cellpadding="1" cellspacing="2" border="0">
		...
		<input type="button" name="cmdSimpan" value="Simpan" onClick="simpanMaklumatPP()" />
			...
			<!-- #if($id_status!="164" && $id_status!="165" && $id_status!="169" && $id_status!="166" && $id_status!="167" && $id_status!="180")#end -->
				...
				#else
					<input type="button" name="cmdKembali" id="button" value="Kembali" onClick="javascript:history.back();" />
				#end
...
<legend><strong>SENARAI LAPORAN</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
      <tr>
        <td ><a href="#" class="style2" onClick="javascript:cetakBorangK1('$noFail','$idnegerirayuan','$id_perbicaraan')"><font color="blue">Borang K1</font></a></td>
      </tr> 
    </table>      
</fieldset> 
...
<!-- Tab 2 START [Maklumat rayuan] --> 
    ...
    <table width="95%"  cellpadding="1" cellspacing="2" border="0">
    	...
    	<tr>
    		<td>&nbsp;</td>
    		<td colspan="3"><textarea name="txtPerkaraRayu" $Cmode3 $mode3 $mode2 cols="85%" rows="12" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();" onKeyUp="textCounter(this.form.txtPerkaraRayu,this.form.remLen1,2000);" onKeyDown="textCounter(this.form.txtPerkaraRayu,this.form.remLen1,2000);">$!perkara</textarea></td>
    	</tr>
...
<legend>MAKLUMAT REKOD RAYUAN</legend>	
	 ...
	 <table width="95%"  cellpadding="1" cellspacing="1" border="0">
	 	...
	 	<!-- <tr>
	 		<td>&nbsp;</td>
	 		<td colspan="2"><input type="button" value="Papar" onclick="displayHTML(this.form.txtAsasKeputusan)">&nbsp;#if($editform=="yes")Baki Aksara :&nbsp;<input type="text" readonly class="disabled" name="remLen3" size="3" maxlength="3" value="2000">#end</td>
        </tr>  -->
...
<fieldset>
<legend>MAKLUMAT SERAHAN BORANG K3</legend>
    ...
    <table width="95%"  cellpadding="1" cellspacing="2" border="0">
    	...
    	<tr>
    		...
    		<td width="69%">:&nbsp;RM&nbsp;<input $Cmode3 $mode3 type="text" style="text-align:right" name="txtBayaranRekod" id="txtBayaranRekod" value="$!n3" maxlength="10" size="8" onkeyup="javascript:validateIC(event,this,this.value,'txtBayaranRekod')" onblur="validateModal(this,this.value,'$n3')"></td><!-- &nbsp;($!totalWord patah perkataan) -->
    	</tr>
    	<tr>
    		<td valign="top">#if($editable=="yes")<font color="red">*</font>#else&nbsp;#end</td>
    		<td>Tarikh Borang K3</td>
...
<table width="95%"  cellpadding="1" cellspacing="2" border="0">
    	...
    	<tr>
    		...
    		<td width="30%">Bayaran Penyediaan Rekod Rayuan</td>
    		#if($editformK3=="no")
    		<td width="69%">:&nbsp;RM&nbsp;<input $Cmode4 $mode4 type="text" style="text-align:right" name="txtBayaranRekod" id="txtBayaranRekod" value="$!Util.formatDecimal($bayaranR)" maxlength="10" size="8" onkeyup="javascript:validateIC(event,this,this.value,'txtBayaranRekod')" onblur="validateModal(this,this.value,'$bayaranR')"></td><!-- &nbsp;($!totalWord patah perkataan) -->
    		#else
    		<td width="69%">:&nbsp;RM&nbsp;<input $Cmode4 $mode4 type="text" style="text-align:right" name="txtBayaranRekod" id="txtBayaranRekod" value="$!bayaranNB" maxlength="10" size="8" onkeyup="javascript:validateIC(event,this,this.value,'txtBayaranRekod')" onblur="validateModal(this,this.value,'$bayaranR')"></td><!-- &nbsp;($!totalWord patah perkataan) -->
    		#end
    	</tr>
    	<tr>
...
<legend><strong>SENARAI LAPORAN</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
	<tr>
        <td ><a href="#" class="style2" onClick="javascript:cetakBorangK3('$noFail','$idnegerirayuan','$id_perbicaraan')"><font color="blue">Borang K3</font></a></td>
      </tr> 
      <tr>
...
function seterusnya(id_permohonan,id_status) 
{
	...
	document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 17",$portal_role)?_portal_module=ekptg.view.ppk.FrmRynSemakPenerimaanSek17&command=semakKeputusanRayuan&tabId=0";
...
/* 	
	if(document.${formName}.txtAsasKeputusan.value == ""){
		alert("Sila masukkan \"Asas-asas keputusan\" terlebih dahulu.");
		document.${formName}.txtAsasKeputusan.focus(); 
		return;
	}
...
/*	
	...
	if(document.${formName}.txtNotaBicara.value == ""){
		alert("Sila masukkan \"Nota Bicara\" terlebih dahulu.");
		document.${formName}.txtNotaBicara.focus(); 
		return;
	}

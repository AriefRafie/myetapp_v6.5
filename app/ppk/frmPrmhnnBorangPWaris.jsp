  ...
  <tr>
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <table width="100%">
          ...
          <tr>
            ...
            <td class="style36"><select name="socJenisKPLainWaris" id="socJenisKPLainWaris" $readmode style="text-transform:uppercase; width: 128px;" onBlur="text-transform:uppercase;" >
              ...
              <option value="4" style="text-transform:uppercase;" onBlur="uppercase()">Pasport</option>
	                               #end
            </select>&nbsp;<input name="txtNoKPLainWaris" type="text" id="txtNoKPLainWaris"  style="text-transform:uppercase;" onBlur="uppercase()" value="$!nokplain" size="12" maxlength="12" $readmode />
              </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="style36"><input name="txtWaktuKematianWaris" type="text" id="txtWaktuKematianWaris" onKeyUp="javascript:validatePoskod(this,this.value)" value="$!waktumati" size="4" maxlength="4" onBlur="validTarikhMati()" $readmode/>
              <span class="style44"><i>format : 24 jam (HHMM)</i></span></td>
          </tr>
          #end
          <tr>
	   ...
	   <tr>
		 <td colspan="2" height="50px" valign="bottom"><table>
                    <tr>
                    <td width="3%"><i>*</i></td>
          ...
          <div align="center">
            ...
            <input type="button" name="cmdKembali8" id="cmdKembali8" value="Kembali"  onclick="WarisView('0','2','0','0')"/>
                        ...
                        <table width="100%" border="0">
								  ...
								  <tr>
								  <td colspan="2" height="50px" valign="bottom"><br><br>
								  <table>
                    <tr>
                    <td width="3%"><i>*</i></td>
                    <td width="97%"><i>Sila pastikan salah satu No Pengenalan diisi.</i></td>
                    ...
                    <td><i>Sila pastikan maklumat pada tab SIMATI, PEMOHON 
                      dan seterusnya membuat pengesahan 
                      penghantaran pada tab PENGESAHAN PERMOHONAN.$idstatus</i></td>
                    </tr>
                    </table></td>
								  </tr>
                              </table>
        ...
        <tr>
          ...
          <input type="hidden" name="idparentlapiss" value="$idparentlapis" />
            ...
            <tr>
              <td><div align="right"><span class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;Tarikh Mati</span></div></td>
              <td class="style36" width="1%"><div align="right"><span class="style38">:</span></div></td>
              <td class="style36"><input name="txdTarikhMatiWaris" id="txdTarikhMatiWaris" type="text" value="$tarikhmati" size="10" $readmode onBlur="trans_date1(this.value)"/>&nbsp;
...
<tr>
  ...
  <table width="100%" border="0">
       ...
       #set($idwarisup=$lwu.idwaris)
        ...
        <tr>
          ...
          <td width="70%" class="style36">
           ...
           <input name="txtNoKPBaru1Waris" id="txtNoKPBaru1Waris" style="width: 50px;" type="text" value="$lwu.nokpbaru1" $readmode size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2Waris')" onBlur="getAgeByIC(this,this.value,'txtUmurWaris')"/>-<input name="txtNoKPBaru2Waris" id="txtNoKPBaru2Waris" style="width: 20px;" type="text" value="$lwu.nokpbaru2" $readmode size="1" maxlength="2" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris')"/>-<input name="txtNoKPBaru3Waris" id="txtNoKPBaru3Waris"  style="width: 40px;" type="text" value="$lwu.nokpbaru3" $readmode size="5" maxlength="4" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris')"/>         </td>
        </tr>
        <tr>
          <td ><div align="right"><span class="style38">No KP Lama</span></div></td>
           <td class="style36" width="1%"><div align="right"><span class="style38">:</span></div></td>
        ...
        <tr>
          ...
          <td class="style36"><select name="socJenisKPLainWaris" id="socJenisKPLainWaris" $readmode style="text-transform:uppercase;width: 146px;" onBlur="uppercase()">
            ...
            <option value="4" style="text-transform:uppercase;" onBlur="uppercase()">Pasport</option>
	                               #end
          </select>&nbsp;<input name="txtNoKPLainWaris" type="text" id="txtNoKPLainWaris4"  style="text-transform:uppercase;" onBlur="uppercase()" value="$lwu.nokplain" size="9" maxlength="9" $readmode />
           </td>
        </tr>
      <tr>
          <td><div align="right"><span class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;Nama Waris</span></div></td>
		...
		<tr>
		  <td class="style38" ><div align="right"></div></td>
		  <td><div align="right"><span class="style38">:</span></div></td>
		  <td><font class="style38"><input type="checkbox" value="1" name="chkAddWarisWaris1" onClick="javascript:getDuplicateAddressWaris1();">&nbsp;<i>Sekiranya alamat tetap dan alamat surat menyurat adalah sama</i></font></td>
		</tr>
		<tr>
          <td class="style38" width="29%" ><div align="right" class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;Alamat Surat Menyurat</div></td>
           <td class="style36" width="1%"><div align="right"><span class="style38">:</span></div></td>
        ...
        <tr>
          <td class="style38"><div align="right" class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;Poskod</div></td>
           <td class="style36" width="1%"><div align="right"><span class="style38">:</span></div></td>
          <td><label>
            <input name="txtPoskodWarisSurat" type="text" id="txtPoskodWarisSurat" style="text-transform:uppercase;" onBlur="validLength()" onKeyUp="javascript:validatePoskod(this,this.value)" value="$!lwu.poskodsurat" size="5" maxlength="5" $readmode/>
          </label></td>
        </tr>
	...
	<td colspan="2" height="50px" valign="bottom"><br><br>
                    ...
                    <tr>
                    <td><i>*</i></td>
                    <td><i>Sila pastikan label berwarna <font color="#ff0000">merah</font> 
                      diisi.</i></td>
                    </tr>
                    <tr>
                    <td><i>*</i></td>
...
function getDuplicateAddressWaris1(){
		if (document.${formName}.chkAddWarisWaris1.checked == true) {
				document.${formName}.method="POST";
		...
		else if (document.${formName}.chkAddWarisWaris1.checked == false) {
				document.${formName}.method="POST";

      ...
      <tr>
        <td width="50%" valign="top"><table width="100%">
            <tr>
              ...
              <td width="50%"><label>
                <input name="txtNamaFirmaPeguam" type="text" id="txtNamaFirmaPeguam" size="34" value="$!namafirma" style="text-transform:uppercase;" $readmode />
              </label></td>
            </tr>
            <tr>
              ...
              <td><label>
                <input name="txtNoRujukanFirma" type="text" id="txtNoRujukanFirma" size="34" value="$!rujukfirma" style="text-transform:uppercase;" $readmode />
              </label></td>
            </tr>
            <tr>
              ...
              <td><div align="center" class="style38">:</div></td>
              <td><label>
                <input name="txtAlamat1Peguam" type="text" id="txtAlamat1Peguam" size="34" value="$!add1" style="text-transform:uppercase;" $readmode />
              </label></td>
            </tr>
            <tr>
              ...
              <td><div align="center" class="style38">:</div></td>
              <td><label>
                <input name="txtAlamat2Peguam" type="text" id="txtAlamat2Peguam" size="34" value="$!add2" style="text-transform:uppercase;" $readmode />
              </label></td>
            </tr>
            <tr>
              <td class="style38"><div align="right"><span class="style3"></span></div></td>
              <td><div align="center" class="style38">:</div></td>
              <td><input name="txtAlamat3Peguam" type="text" id="txtAlamat3Peguam" size="34" value="$!add3" style="text-transform:uppercase;" $readmode /></td>
            </tr>
        </table></td>
        <td width="50%"><table width="100%">
            <tr>
              <td width="35%"><div align="right" class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;Poskod</div></td>
              <td width="1%"><div align="center" class="style38">:</div></td>
              <td width="64%"><label>
            ...
            <tr>
              <td><div align="right" class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;Bandar</div></td>
              <td><div align="center" class="style38">:</div></td>
              <td>$selectBandarTetap</td>
            </tr>
            <tr>
              <td><div align="right" class="style38">No Telefon:</div></td>
              <td><div align="center" class="style38">:</div></td>
              <td><label>
                <input name="txtNomborTelefonPeguam" type="text" id="txtNomborTelefonPeguam" size="12" maxlength="12" value="$!notel" onKeyUp="javascript:validatePoskod(this,this.value)" $readmode /> &nbsp;<span class="style52"><i>format : 031234567</i></span>
              </label></td>
            </tr>
            <tr>
              ...
              <td><div align="center" class="style38">:</div></td>
              <td><label>
                <input name="txtNomborFaksPeguam" type="text" id="txtNomborFaksPeguam" size="12" maxlength="12" value="$!faxno" onKeyUp="javascript:validatePoskod(this,this.value)" $readmode /> &nbsp;<span class="style52"><i>format : 031234567</i></span>
              </label></td>
            </tr>
            <tr>
    ...
    <td align="center">
     <table width="100%" border="0" align="center">
      ...
      #set($peno=0)
	      ...
	      <td class="$row" width="20%" style="text-transform:uppercase;"><a href="javascript:edit_item('$list.idPeguam')"><span class="style40">$!list.noRujukanFirma</span></a></td>
          <td class="$row" width="70%" style="text-transform:uppercase;">$!list.namaPeguam</td>
	      </tr>
	      #end
      #else
      <tr bgcolor="#FFFFFF">

...
<span id="bandarsurat_b" >
 ...
 <input name="txtBandarWarisSurat_D" size="45" style="text-transform:uppercase;" readonly class="disabled" value="" />
                                        ...
                                        <tr>
                                          ...
                                          <td><textarea name="txtCatatanPentingU" cols="31"  rows="3" $readmodeR class="$readmode" id="txtCatatanPentingU" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" >$txtCatatanPentingU</textarea>
 ...
 <tr>
  <td><span class="style5"><span class="style2 style44 style40">Perhatian</span><span class="style44"> : Sila masukkan salah satu nombor kad pengenalan (kecuali pada taraf kepentingan adalah Amanah Raya Berhad dan Baitumal) dan pastikan label bertanda <span class="style40">*</span> diisi</span>.</span></td>
...
<select name="jenis_pemohon"  class="autoselect" $readmode id="jenis_pemohon" style="text-transform:uppercase;" onBlur="uppercase()" onChange="pilih_taraf()" >        
                                  ...
                                  <tr id="kp_baru">
                                    <td width="1%" ><div align="center"><span class="style40"></span></div></td>
                                  <td width="28%" class="style38" ><div align="left" class="style41 style38"><span class="style38">No KP Baru</span></div></td>
                                  <td width="1%" class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td width="70%" class="style36"><label>
                                   
                                     <input name="txtNoKPBaru1Penting" id="txtNoKPBaru1Penting" style="width: 50px;" type="text" $readmode size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2Penting')" onBlur="getAgeByIC(this,this.value,'txtUmurPenting');getStatusByIC(this,this.value,'socStatusOB');getDOB(this.value)" value="$txtNoKPBaru1Penting" />
                                     - 
                                ...
                                <tr id="kp_lama">
                                  ...
                                  <td class="style38" ><div align="left" class="style41 style38"><span class="style38">No KP Lama</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                ...
                                <tr id="kp_jenis">
                                  <td ><div align="center"><span class="style40"></span></div></td>
                                  <td class="style38" ><div align="left" class="style41 style38"><span class="style38">Lain-lain KP</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"> 
                              ...
                              #set($readmodekp="disabled")
                                  ...
                                  <tr id="kp_lain">
                                    <td><div align="center"><span class="style40"></span></div></td>
                                    <td class="style38"><div align="left" class="style41 style38"><span class="style38"> No KP Lain</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><span class="style36">
                          ...
                          <tr>
                            <td>  <table width="100%" border="0" align="center">
                              ...
                              <input type="button" name="batalpenting" id="cmdSimpan3" value="Batal" onclick="setSelected(0,3,0,0);cancelwaris()"/>                                 
                                  #else #if($id_Status != "169" && $id_Status != "21" && $id_Status != "64" && $id_Status != "163" && $id_Status != "164" && $id_Status != "165")
                                  ...
                                  <input type="button" name="tambahpenting" id="tambahpenting3" value="$buttonpenting" onclick="setSelected(0,3,0,0);tambah_penting()"/>
                                    ...
                                    <input type="button" name="batalpentingupdate" id="cmdSimpan3" value="Batal" onclick="setSelected(0,3,0,0);batalpenting()"/>
                                      ...
                                      #if($buttonpenting == "Kemaskini" )#if($id_Status != "169" && $id_Status != "21" && $id_Status != "64" && $id_Status != "163" && $id_Status != "164" && $id_Status != "165")
...
var tt = dob_code.charAt(4)+""+dob_code.charAt(5)+"/"+dob_code.charAt(2)+""+dob_code.charAt(3)+"/"+dum+dob_code.charAt(0)+""+dob_code.charAt(1);	
	...
	else if (document.f1.txtNamaOBPenting.value=="")
 {
	...
	{
		alert("Sila lengkapkan No KP Lama orang bekepentingan");
...
else if(document.f1.socTarafKepentinganPentingU.value == '4')
{
//alert(document.f1.jenis_pemohon.value)
		document.getElementById("amanah").style.display="none";	
		document.getElementById('baitulmal').style.display="none";
...
{
if((document.f1.socTarafKepentinganPentingU.value == "6" || document.f1.socTarafKepentinganPentingU.value == "8") && document.f1.txtNamaOBPentingU!= null){
...
if(document.f1.jenis_pej.value != "" && document.f1.read_mode.value != "disabled"  && document.f1.txtNamaOBPentingU != null && (document.f1.socTarafKepentinganPentingU.value == "6" || document.f1.socTarafKepentinganPentingU.value == "8") )
{

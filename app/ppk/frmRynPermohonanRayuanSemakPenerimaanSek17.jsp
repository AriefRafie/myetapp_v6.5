...
<fieldset>
	...
	<table width="100%"  cellpadding="1" cellspacing="1" border="0">
		...
		<tr>
  		...
  		<tr>
  			<td>&nbsp;</td>
			<td>&nbsp;</td>
    		<td align="justify"><input type="radio" value="122" $offCb1 $checkCb1 name="radiosemaks" id="radiosemaks1" onClick="checkitParent()">Tempoh 14 hari daripada tarikh keputusan dibuat oleh Pentadbir.</td>
  		</tr>
  		<tr>
  			<td>&nbsp;</td>
			<td>&nbsp;</td>
    		<td align="justify"><input type="radio" value="123"  $offCb2 $checkCb2 name="radiosemaks" id="radiosemaks2" onClick="checkitParent()">Atau tempoh masa yang dibenarkan oleh Mahkamah Tinggi.</td>
  		</tr>
  		<tr>
  			<td valign="top"><font color="red">*</font></td>
  	...
  	<table width="100%"  cellpadding="1" cellspacing="1" border="0">
		<tr>
  		...
  		<tr>
    		...
    		<td>:&nbsp;<input type="text" name="txdTarikhByrnFee" id="txdTarikhByrnFee" size="11" maxlength="10" value="" onkeyup="checkitB()" onblur="check_date(this);validateTarikh(this,this.value);checkitB()" >
  	...
  	<table width="100%"  cellpadding="1" cellspacing="1" border="0">
		<tr>
  		...
  		<tr>
			...
			<td>&nbsp;</td>
    		<td align="justify">Tarikh Bayaran</td>
    		<td>:&nbsp;<input type="text" name="txdTarikhByrnDeposit" size="11" maxlength="10" id="txdTarikhByrnDeposit" value="" onkeyup="checkitE()" onblur="check_date(this);validateTarikh(this,this.value);checkitE()">
    ...
    <table width="100%"  cellpadding="1" cellspacing="1" border="0">
  		<tr>
			<td width="1%">&nbsp;</td>
			<td width="6%" valign="top" align="right"><font color="red">*</font>&nbsp;</td>
    		<td align="justify" width="23%">Tarikh Terima Rayuan</td>
    		<td width="70%">:&nbsp;<input type="text" name="txdTarikhTerimaRayuan" size="11" maxlength="10" id="txdTarikhTerimaRayuan" value="" onblur="check_date(this);validateTarikh(this,this.value)">
	...
	<table width="100%"  cellpadding="1" cellspacing="1" border="0">
		...
		<tr>
  		...
  		<tr>
  			<td>&nbsp;</td>
			<td>&nbsp;</td>
    		<td align="justify"><input type="radio" value="122" $offCb1x name="Eradiosemaks" id="Eradiosemaks1" $check2 $mode  onClick="EcheckitParent()"/>Tempoh 14 hari daripada tarikh keputusan dibuat oleh Pentadbir</td>
  		</tr>
  		<tr>
  			<td>&nbsp;</td>
			<td>&nbsp;</td>
    		<td align="justify"><input type="radio" value="123" $offCb2x name="Eradiosemaks" id="Eradiosemaks2" $check3 $mode  onClick="EcheckitParent()"/>Atau tempoh masa yang dibenarkan oleh Mahkamah Tinggi.</td>
  		</tr>
  		<tr>
  			<td valign="top">#if($editForm=="yes")<font color="red">*</font>#else&nbsp;#end</td>
	...
	<table width="100%"  cellpadding="1" cellspacing="1" border="0">
  	...
  	<table width="100%"  cellpadding="1" cellspacing="1" border="0">
		<tr>
    		...
    		<td align="justify" width="23%">Jumlah Bayaran Deposit</td>
    		#if($editForm=="no")
    		<td width="71%">:&nbsp;RM&nbsp;<input name="EtxtJumDeposit" $mclass $mode1 style="text-align:right" type="text" id="EtxtJumDeposit" value="$!Util.formatDecimal($jumlahD)"  size="8" maxlength="10" onkeyup="javascript:validateIC(event,this,this.value,'EtxtJumDeposit');EcheckitC()" onblur="validateModal(this,this.value,'$jumlahD');" /></td>
            #else
            <td width="71%">:&nbsp;RM&nbsp;<input name="EtxtJumDeposit" $mclass $mode1 style="text-align:right" type="text" id="EtxtJumDeposit" value="$!jumlahD"  size="8" maxlength="10" onkeyup="javascript:validateIC(event,this,this.value,'EtxtJumDeposit');EcheckitC()" onblur="validateModal(this,this.value,'$jumlahD');EcheckBayaran()" /></td>
            #end
    	</tr>
  		<tr>
			<td>&nbsp;</td>
  	...
  	<table width="100%"  cellpadding="1" cellspacing="1" border="0">
		<tr>
			<td width="1%" valign="top">#if($editFormxx=="yes")<font color="white">*</font>#else&nbsp;#end</td>
  	...
  	<table width="100%"  cellpadding="1" cellspacing="1" border="0">
  		<tr>
			<td width="6%" valign="top" align="right">#if($editForm=="yes")<font color="red">*</font>&nbsp;#else&nbsp;#end</td>
    		<td align="justify" width="23%">Tarikh Terima Rayuan</td>
    		<td width="70%">:&nbsp;<input type="text" name="EtxdTarikhTerimaRayuan" $mclass $mode1 size="11" maxlength="10" id="EtxdTarikhTerimaRayuan" value="$!tarikh_rayuan" onblur="check_date(this);validateTarikh(this,this.value)">
...
function seterusnya(id_permohonan,id_status) 
{
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppk.FrmRynSemakPenerimaanSek17&command=semakKeputusanRayuan&tabId=0";
...
function kembaliList(){
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppk.FrmRynPermohonanRayuanSek17";
	document.${formName}.submit();
}
...
var deposit = parseInt("1500");
	...
	{
		alert("Borang K2 perlu dilengkapkan terlebih dahulu");
		Echeckbox1.focus(); 
		return;
	}

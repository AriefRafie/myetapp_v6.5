...
function papar(idpermohonan,id2,id_status) {
	...
	//notis
		if (id_status == '18'){
			...
			document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 17",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanBicaraanSek17";
			//doAjaxCall${formName}("papar_notis");	
	...
	//selesai	
		if (id_status == '41'){
			...
			document.${formName}.id_status.value = id_status;
			document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 17",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanBicaraanSek17";
			//doAjaxCall${formName}("papar_selesai");	
	...
	//tangguh
		if (id_status == '44' ){
			...
			document.${formName}.id_status.value = id_status;
			document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 17",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanBicaraanSek17";
			//doAjaxCall${formName}("papar_tangguh");	
	...
	//batal	
		if (id_status == '47' ){
			...
			document.${formName}.id_status.value = id_status;
			document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 17",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanBicaraanSek17";
			//doAjaxCall${formName}("papar_batal");	
		...
		if (id_status == '172' || id_status == '173' ){
			...
			document.${formName}.id_status.value = id_status;
			document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 17",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanBicaraanSek17";
			//doAjaxCall${formName}("papar_selesai_kolateral");	
		...
		if (id_status == '174' || id_status == '175' ){
			...
			document.${formName}.id_status.value = id_status;
			document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 17",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanBicaraanSek17";
			//doAjaxCall${formName}("papar_selesai_rujukanMT");	
		...
		if (id_status == '176' || id_status == '177' ){
			...
			document.${formName}.id_status.value = id_status;
			document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 17",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanBicaraanSek17";
			//doAjaxCall${formName}("papar_selesai_rujukanROTS");	

...
<tr id="$display_ob" style="display:none" class="$row_color">
                                  ...
                                  <!--    
                                     ...
                                     -->
                                      ...
                                      <b>$xx.NAMA_OB</b>
                                      #set($id_obdtl = "id_obdtl"+ $listam.idhta + $xx.ID_OB) 
                                      ...
                                      $xx.BA / $xx.BB
                                       #set($bahagian_waris_atas = "bahagian_waris_atas"+ $listam.idhta + $xx.ID_OB) 
                                       <input type="hidden" name="$bahagian_waris_atas" id="$bahagian_waris_atas"  value="$xx.BA" />
                                       
                                       #set($bahagian_waris_bawah = "bahagian_waris_bawah"+ $listam.idhta + $xx.ID_OB) 
                                       <input type="hidden" name="$bahagian_waris_bawah" id="$bahagian_waris_bawah"  value="$xx.BB" />
                                       
                                       #set($id_waris_batal = "id_waris_batal"+ $listam.idhta + $xx.ID_OB) 
                                      ...
                                      #set($id_pilihanhta_temp = "")
                                          ...
                                          #set($tr_display = "tr_display"+ $listam.idhta + $xx.ID_OB)
                                          ...
                                          #if($lo.id_pilihanhta == $id_pilihanhta_temp  && $lo.id_ob == $xx.ID_OB && $lo.id_permohonansimati == $id_permohonansimati)
                                          #set($p_c_ob = 1)
                                          #end                                         
                                          #end                                          
                                          #if($p_c_ob == 1)
                    				  ...
                    				  <input type="checkbox" name="$main_ob" id="$main_ob" $pil_cek_ob  value="$xx.ID_OB"  onclick="setPilihanOB('$listam.idhta');setPilihanOB_KS_all('ob','$listam.idhta','$xx.ID_OB');" />
                                      ...
                                      #set($status_tb = "status_tb"+ $listam.idhta + $xx.ID_OB)
                                      ...
                                      <table width="100%" border="0">
                                         ...
                                         <td colspan="5">
                                          #set($flag_daftar_ob = "flag_daftar_ob"+ $listam.idhta + $xx.ID_OB)
                                  ...
                                  <!--  :::::::::: $status_tb
                                    ...
                                    $xx.STATUS_TADBIR-->
                                      ...
                                      #set($check_ob = "check_ob"+$xx.ID_HTA+$xx.ID_OB)
                                      <input type="checkbox" name="$check_ob" id="$check_ob" $pil_cek_ob_sub  value="$xx.ID_PA1" onclick="setPilihanOB_minor('$listam.idhta','$xx.ID_OB','$xx.ID_PA1')" />
                                     ...
                                     <!-- doUpdateCheck_OBMain_sub('$xx.ID_OB','$listam.idhta','$xx.ID_PA1','$xx.STATUS_TADBIR') -->
                                      ...
                                      #set($check_ob = "check_ob"+$xx.ID_HTA+$xx.ID_OB)
                                      <input type="checkbox" name="$check_ob" id="$check_ob" $pil_cek_ob_sub  value="$xx.ID_PA2" onclick="setPilihanOB_minor('$listam.idhta','$xx.ID_OB','$xx.ID_PA2')" />
                                      ...
                                      #set($p_c_ob_sub = "")
                                          ...
                                          #end  
                                      #set($check_ob = "check_ob"+$xx.ID_HTA+$xx.ID_OB)
                                      <input type="checkbox" name="$check_ob" id="$check_ob" $pil_cek_ob_sub  value="$xx.ID_PA3" onclick="setPilihanOB_minor('$listam.idhta','$xx.ID_OB','$xx.ID_PA3')" />
                                     ...
                                     <!--  doUpdateCheck_OBMain_sub('$xx.ID_OB','$listam.idhta','$xx.ID_PA3','$xx.STATUS_TADBIR') -->
                                      ...
                                      <td width="20%">
                                       #set($p_c_ob_sub = "")
                                          ...
                                          #end 
                                      #set($check_ob = "check_ob"+$xx.ID_HTA+$xx.ID_OB)
                                      <input type="checkbox" name="$check_ob" id="$check_ob" $pil_cek_ob_sub  value="$xx.ID_PA4" onclick="setPilihanOB_minor('$listam.idhta','$xx.ID_OB','$xx.ID_PA4')" />

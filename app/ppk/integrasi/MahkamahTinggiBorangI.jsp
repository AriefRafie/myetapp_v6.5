		...
		<fieldset><legend><font style="font-family:Verdana; font-size:8pt;	font-weight:bold;">BUTIRAN TERPERINCI PERMOHONAN</font></legend>
			<table border="0" cellpadding="1" cellspacing="1" align="center">
				...
				<tr>
					...
					<td>:</td>
					<td colspan="2"><input type="text" name="alamat1Pemohon" value="$!alamat1Pemohon" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
				</tr>
				<tr>
					<td align="right"></td>
					<td>:</td>
					<td colspan="2"><input type="text" name="alamat2Pemohon" value="$!alamat2Pemohon" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
				</tr>
				<tr>
					<td align="right"></td>
					<td>:</td>
					<td colspan="2"><input type="text" name="alamat3Pemohon" value="$!alamat3Pemohon" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
				</tr>
				<tr>
					<td align="right">Poskod</td>
					<td>:</td>
					<td colspan="2"><input type="text" name="poskodPemohon" value="$!poskodPemohon" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
				</tr>
				<tr>
					<td align="right">Bandar</td>
					<td>:</td>
					<td colspan="2"><input type="text" name="bandarPemohon" value="$!bandarPemohon" size="40" style="text-transform:uppercase;" readonly="readonly" />
					<input type="hidden" name="idbandarPemohon" value="$!idbandarPemohon" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
				
				</tr>
				<tr>
					<td align="right">Negeri</td>
					<td>:</td>
					<td colspan="2"><input type="text" name="negeriPemohon" value="$!negeriPemohon" size="40" style="text-transform:uppercase;" readonly="readonly" />
					<input type="hidden" name="idnegeriPemohon" value="$!idnegeriPemohon" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="umurPemohon" value="$!umurPemohon" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="jantinaPemohon" value="$!jantinaPemohon" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					
					<input type="hidden" name="nosijilmati" value="$!nosijilmati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="newtarikhmati" value="$!newtarikhmati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="alamat1simati" value="$!alamat1simati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="alamat2simati" value="$!alamat2simati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="alamat3simati" value="$!alamat3simati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="bandarsimati" value="$!bandarsimati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="idbandarsimati" value="$!idbandarsimati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="poskodsimati" value="$!poskodsimati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="idnegerisimati" value="$!idnegerisimati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="jantinasimati" value="$!jantinasimati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="umursimati" value="$!umursimati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
					<input type="hidden" name="bandarSimati" value="$!bandarSimati" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
				...
				<tr>
					...
					<td colspan="2"><input type="text" name="namaMahkamah" value="$!nama_pejabat" size="40" style="text-transform:uppercase;" readonly="readonly" />
				
				<input type="hidden" name="idcourtLocation" value="$!courtLocation" size="40" style="text-transform:uppercase;" readonly="readonly" /></td>
		...
		<table border="0" cellpadding="1" cellspacing="1" width="100%">
			...
			<tr>
				...
				<input type="button" name="tutup" id="tutup" value="Tutup" align="center" onClick="tutupTetingkap()" />
					...
					-->
					#set($applicatiType = "")
					#if ($!sendI == 'ada'  && $!Errormsg != 'Error1') <!-- && $!semakPermohonan == 'tiada' -->
						<input type="button" name="hantar2" id="hantar2" value="Hantar" align="left" onClick="javascript:hantarPermohonanBorangI()" />
		      			#set($applicatiType = "I")
...
<script>
function hantarPermohonanBorangI() {
	...
	//} 
		...
		if (input_box == true) {
			...
			document.f1.action="ekptg.view.ppk.FrmIntegrasiMT?command=hantarPermohonanBorangI";

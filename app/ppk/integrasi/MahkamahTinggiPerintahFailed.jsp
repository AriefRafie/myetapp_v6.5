...
<div id ="div_PrintMT">
	<table width="95%" border="0" cellspacing="2" cellpadding="2" align="center" bgcolor="#aad198">
		...
		<tr border="1" bgcolor=#ffbaba>
	   		<td colspan="3" class="error">
		   		<p><span>Permohonan semakan TIDAK BERJAYA DIHANTAR.</span></p>
		   		
		   		<p><span>RALAT : $!details</span></p>
	    	...
	    	<td class="success_detail">
	    		<table>
		    		...
		    		<tr>
			    		...
			    		<td>:</td>
			    		<td>$!tarikhPerintah</td>
		    		</tr>
		    		<tr>
			    		<td align="right">Waris yang dapat pembahagian</td>
			    		<td>:</td>
			    		<td>$!namaOBHAPerintah ($!jenisPerintah)</td>
		    		</tr>
	    		</table>
		   	</td>
	   	</tr>

...
<script type="text/javascript">
	...
	function sendToDigitalSign() {
		...
		if (input_box == true) {
			...
			document.f1.action="ekptg.view.ppk.FrmIntegrasiDGCertPerintahSek17?command=sahTandatangan";
			document.f1.submit();			
		}
...
<script type="text/javascript">
	...
	function simpan() {
		...
		document.f1.method="post";
		document.f1.action="ekptg.view.ppk.FrmIntegrasiDGCertPerintahSek17?command=simpanTemp";

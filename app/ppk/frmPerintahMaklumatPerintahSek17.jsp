...
<p>
  <!--
flagAdaHTA ::: $flagAdaHTA <br>
mode ::: $mode <br>
flagPopup ::: $flagPopup <br>
flagSelesaiHTA ::: $flagSelesaiHTA <br>
SenaraiHTAPopup ::: $SenaraiHTAPopup <br>
flagAdaHTAPKTTerdahulu ::: $flagAdaHTAPKTTerdahulu
-->
  ...
  #set($id_permohonansimati = $idPermohonanSimati)
...
document.getElementById("header_lama").style.display="block";
  ...
  <!-- END HEADER --> 
  #if (($hartaTertinggal == 'Y' || $flagAdaHTAPKTTerdahulu == 'T') && ($flagPopup == '' || $flagPopup == 'openHTA' || $flagPopup == 'openHTATH' || $flagPopup == 'openHA') && ($flagPopup != 'openHTAPT' || $flagPopup != 'openHAPT' || $flagPopup != 'openHTAPKT' || $flagPopup != 'openHAPKT' || $flagPopup != 'openHTAPL' || $flagPopup != 'openHAPL' || $flagPopup != 'openHTAPF' || $flagPopup != 'openHAPF' || $flagPopup == 'openHTAPA1958' || $flagPopup == 'openHAPA1958'))
  <tr>
    <td>&nbsp;</td>
  </tr>
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        ...
                        <td valign="top" width="1%">:</td>
                        <td><table align="left" width="70%" cellspacing="2" cellpadding="2">
                            <tr class="table_header">
                              <td width="4%" align="center">BIL</td>
                              <td width="95%">KETERANGAN HAKMILIK</td>
                              #if ($listSizeHTAPopup != '0')
                      ...
                      <tr>
                        ...
                        <td valign="top" width="1%">:</td>
                        <td width="70%"><textarea name="txtCatatanHTA" cols="45" rows="5" id="txtCatatanHTA" $readonly class="$inputTextClass" >$maklumatHTA.catatan</textarea></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <fieldset>
                      ...
                      <table width="100%" border="0" cellspacing="2" cellpadding="2">
                        ...
                        <tr>
                          ...
                          #else
                          <td class="$row"><a href="javascript:paparHTATH($listHTATH.idPerintahHTAOBMST)"><font color="#0000FF">$listHTATH.keteranganHakmilik</font></a></td>
                          #end
...
<tr>
                    ...
                    #set($No_Kp_Penerima = $kp1 + "-" + $kp2 + "-" + $kp3)
                      ...
                      #set ($readonly = $chkmode)
                      	...
                      	#set ($readonly = 1)
                     	   ...
                     	   #set ($catatanSerahan = "")
                      #else
                           #set ($catatanSerahan = $catatanSerahan)
                      #end
                      #if ($readonly == "1")
                      <textarea rows="4" cols="50" name="txtCatatanSerahan" disabled>$!catatanSerahan</textarea>
                      #else
                      <textarea rows="4" cols="50" name="txtCatatanSerahan">$!catatanSerahan</textarea>
                      #end
                      </td>
                      <td>
                      </td>
  ...
  #end
  #if(($hartaTertinggal == 'Y' || $flagAdaHTAPKTTerdahulu == 'T') && ($flagPopup == '' || $flagPopup == 'openHTAPT' || $flagPopup == 'openHAPT'  || $flagPopup == 'openHTAPKT' || $flagPopup == 'openHAPKT'|| $flagPopup == 'openHTAPL' || $flagPopup == 'openHAPL'  || $flagPopup == 'openHTAPF' || $flagPopup == 'openHAPF'|| $flagPopup == 'openHTAPA1958' || $flagPopup == 'openHAPA1958'))
  <tr>
    <td>&nbsp;</td>
  </tr>
            ...
            <div class="TabbedPanelsContent">
              <table width="100%" border="0" cellspacing="2" cellpadding="2">
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                      #set ($headerDetail = "")
                      #set ($headerDetail_flagBatal = "")
                      #foreach($headerDetail in $BeanHeaderDetail)
                      <tr>
                        <td width="30%" align="right">KETERANGAN HAKMILIK :</td>
                        <td width="70%" align="left"><font color="blue">$headerDetail.keteranganHakmilik</font> #set ($headerDetail_flagBatal = $headerDetail.flagBatal) 
                          <!--
                            $headerDetail.flagBatal
                            $headerDetail.ba_waris
                            $headerDetail.bb_waris
                            $headerDetail.id_waris
                            $headerDetail.nama_ob--></td>
                      </tr>
                      <tr>
                      ...
                      #if($headerDetail.ba_waris!="" && $headerDetail.bb_waris != "")
                      <tr>
                        <td width="30%" align="right">BAHAGIAN WARIS :</td>
                        <td width="70%" align="left"><font color="blue"> $headerDetail.ba_waris / $headerDetail.bb_waris </font></td>
                      </tr>
                      #end
                      <tr>
                          ...
                          <div style="width:100%;height:225;overflow:auto"> #set($sizeUp="100%")
                            ...
                            <table width="$sizeUp" border="0" cellspacing="2" cellpadding="2" align="$alignUp">
                              ...
                              <tr>
                                ...
                                #end
                                #else
                                <td><a href="javascript:updatePAPTHTAPT('$listHTAPTDTL.idOB','$idPermohonanSimati','$idSimati','$listHTAPTDTL.status','$idPerintah','$mode','$idHTA','$flag_kemaskini_selesai')"><font color="#0000FF">$listHTAPTDTL.namaWaris</font></a></td>
                                #end
                                <td>$listHTAPTDTL.status</td>
                                <td align="center"><input name="txtBA" type="text" size="14" maxlength="14" style="text-align:center" value="$listHTAPTDTL.BA" onBlur="validateBahagianWaris(this,this.value,$listHTAPTDTL.BA);calculateTotal();checkPembahagianGSA($cnt);" $readonly class="$inputTextClass">
                                  /
                                  <input name="txtBB" type="text" size="14" maxlength="14" style="text-align:center" value="$listHTAPTDTL.BB" onBlur="validateBahagianWaris(this,this.value,$listHTAPTDTL.BB);calculateTotal();" $readonly class="$inputTextClass"></td>
                              </tr>
                              #end
                            </table>
                          ...
                          -->
                            ...
                            <tr>
                              ...
                              <td align="center"> #if ($mode == 'update')
                                <input type="button" name="cmdSamakanPembawah2" id="cmdSamakanPembawah2" value="Samakan Pembawah" onClick="javascript:samakanPembawah()"/>
                                #if($flag_kemaskini_selesai != "yes" ) 
                                <script>
                                        document.getElementById('cmdSamakanPembawah2').style.display = "none";
                                        </script> 
                                #end
                                #end </td>
                            </tr>
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                      #set ($headerDetail = "")
                      #foreach($headerDetail in $BeanHeaderDetail)
                      #set ($headerDetail_flagBatal = $headerDetail.flagBatal)
                      <tr>
                        <td width="30%" align="right">JENIS HARTA ALIH :</td>
                        <td width="70%" align="left"><font color="blue">$headerDetail.jenisHA
                          ...
                          <div style="width:100%;height:225;overflow:auto"> #set($sizeUp="100%")
                            ...
                            <table width="$sizeUp" border="0" cellspacing="2" cellpadding="2" align="$alignUp">
                              ...
                              <tr>
                                ...
                                #end
                                #else
                                <td><a href="javascript:updatePAPTHAPT('$listHAPTDTL.idOB','$idPermohonanSimati','$idSimati','$listHAPTDTL.status','$idPerintah','$mode','$idHA','$flag_kemaskini_selesai')"><font color="#0000FF">$listHAPTDTL.namaWaris</font></a></td>
                                #end
                                <td>$listHAPTDTL.status</td>
                                <td align="center"><input name="txtBA" type="text" size="14" maxlength="14" style="text-align:center" value="$listHAPTDTL.BA" onBlur="validateBahagianWaris(this,this.value,$listHAPTDTL.BA);calculateTotal();" $readonly class="$inputTextClass">
                                  /
                      ...
                      <div style="width:100%;height:190;overflow:auto"> #end
                        <table align="center" width="100%">
                          ...
                          <tr>
                            ...
                            #else
                            <td class="$row"><a href="javascript:paparHAPT('$listHAPT.idPerintahHAOBMST')"><font color="#0000FF">$listHAPT.jenisHA.toUpperCase()</font></a></td>
                          ...
                          <div style="width:100%;height:225;overflow:auto"> #set($sizeUp="100%")
                            ...
                            <table width="$sizeUp" border="0" cellspacing="2" cellpadding="2" align="$alignUp">
                              ...
                              <tr>
                                ...
                                #end
                                <td align="center"><input name="txtBA" type="text" size="14" maxlength="14" style="text-align:center" value="$listPembahagianHTAPKTDTL.BA" onBlur="validateBahagianWaris(this,this.value,$listPembahagianHTAPKTDTL.BA);calculateTotal();" $readonly class="$inputTextClass">
                                  /
                                  <input name="txtBB" type="text" size="14" maxlength="14" style="text-align:center" value="$listPembahagianHTAPKTDTL.BB" onBlur="validateBahagianWaris(this,this.value,$listPembahagianHTAPKTDTL.BB);calculateTotal();" $readonly class="$inputTextClass"></td>
                              </tr>
                              #end
                            </table>
                  ...
                  <td><fieldset>
                      ...
                      <table align="center" width="100%">
                        ...
                        <tr>
                          ...
                          #else
                          <td class="$row"><a href="javascript:paparHAPKT('$listHAPKT.idPerintahHAOBMST')"><font color="#0000FF">$listHAPKT.jenisHA</font></a></td>
                  ...
                  <td><fieldset>
                      ...
                      <table align="center" width="100%">
                        ...
                        <tr>
                          ...
                          #else
                          <td class="$row"><a href="javascript:paparHAPL('$listHAPL.idPerintahHAOBMST')"><font color="#0000FF">$listHAPL.jenisHA</font></a></td>
                      ...
                      <div style="width:100%;height:190;overflow:auto"> #end
                        <table align="center" width="100%">
                          ...
                          <tr>
                            ...
                            #else
                            <td class="$row"><a href="javascript:paparHAPF('$listHAPF.idPerintahHAOBMST')"><font color="#0000FF">$listHAPF.jenisHA.toUpperCase()</font></a></td>
  ...
  <tr>
    <td><fieldset>
        <legend>BATAL/LANTIK PENTADBIR ATAU PEMEGANG AMANAH</legend>
        <div id="TabbedPanels3" class="TabbedPanels">
          ...
          <div class="TabbedPanelsContentGroup"> 
              ...
              <table width="100%">
                <tr>
                  <td  width="100%"><fieldset>
                      <legend><strong>SENARAI HARTA TAK ALIH</strong> </legend>
                      <table width="100%">
                        <tr>
                          <td align="left"><div align="left"> #if($listHTAduluPerintah.size()!=0 )
                              <input type="button" name="simpan_pilihan" id="simpan_pilihan" value="Simpan Pilihan" onClick="simpanHTA()" />
                              <blink> <font  color="blue"  onMouseOver="this.style.cursor='help'" onClick="open_new_window('1','');" ><img src="../img/info.png"  align="center" /></font> </blink> #if($flag_kemaskini_selesai != "yes") 
                              <script>
                                        document.getElementById('simpan_pilihan').style.display = "none";
                                        </script> 
                              #end
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          <td colspan="10"><font color="blue"><b>HARTA TAK ALIH (ADA HAKMILIK)</b></font></td>
                        </tr>
                        #set($plko=0)     
                        #set($bil1=0)                                   
                        #foreach($listam in $listHTAduluPerintah)                             
                        
                        
                        #if($listam.JENIS_HTA == "Y") 
                        #set($plko=$plko+1)
                        #set($bil1=$bil1+1)  
                        #if($plko%2!=0)                                      
                        #set($row_color = "row2")
                        ...
                        <tr bgcolor="white" class="$row_color">
                          <td ><div align="center" style="text-transform:uppercase;" onblur="uppercase()">$bil1</div></td>
                          ...
                          #end
                          <td ><div align="left" style="text-transform:uppercase;" onblur="uppercase()"> 
                              <!--<a href="javascript:get_htaam($listam.idhta)" class="style42">--> 
                              $listam.NAMA_NEGERI / $listam.NAMA_DAERAH / $listam.NAMA_MUKIM - $Z $listam.nopt 
                              <!--</a>--> 
                            </div></td>
                          ...
                          <td ><label>
                            <div align="center"> #set($p_c = 0)
                              ...
                              #set($jenis_hta = "jenis_harta" + $listam.idhta)
                              <input type="hidden" name="$jenis_hta" id="$jenis_hta"  value="$listam.JENIS_HTA" />
                              #set($harta_obmst = "harta_obmst" + $listam.idhta)
                              <input type="hidden" name="$harta_obmst" id="$harta_obmst"  value="$listam.ID_PERINTAHHTAOBMST" />
                        ...
                        #parse("app/ppk/frmHTAOBpilihan.jsp") 
                        #if($!pil_cek == "checked") 
                        <script>
                       ...
                       document.getElementById('$display_ob').style.display="none";
                        ...
                        <tr>
                          <td colspan="10"><br>
                            <font color="blue"><b>HARTA TAK ALIH (TIADA HAKMILIK)</b></font></td>
                        </tr>
                        #set($plko=0) 
                        #set($bil2=0)                                      
                        #foreach($listam in $listHTAduluPerintah) 
                        ...
                        #end
                        <tr bgcolor="white" class="$row_color">
                          <td ><div align="center" style="text-transform:uppercase;" onblur="uppercase()">$bil2</div></td>
                          #if($listam.noHakmilik != "" && $listam.kod_hakmilik != "" && $listam.kod_hakmilik != "00")    
                          #set($Z =  "$listam.kod_hakmilik${listam.noHakmilik}")    
                          #else
                          #set($Z =  $listam.noHakmilik)
                          ...
                          <td ><div align="left" style="text-transform:uppercase;" onblur="uppercase()"> 
                              <!--<a href="javascript:get_htaam($listam.idhta)" class="style42">--> 
                              $listam.NAMA_NEGERI / $listam.NAMA_DAERAH / $listam.NAMA_MUKIM - 
                              <!--</a>--> 
                              #if($listam.FLAG_KATEGORI_HTA == "1")
                              PERJANJIAN JUAL BELI   
                              #elseif($listam.FLAG_KATEGORI_HTA == "2") 
                              PEGANGAN DIBAWAH AKTA TANAH
                              #elseif($listam.FLAG_KATEGORI_HTA == "3")  
            ...
            <!-- END CONTENT HTA --> 
            <!-- START CONTENT HA -->
            <div class="TabbedPanelsContent"> #if($selectedTabPA == "1")
              <table width="100%" border="0">
                <tr>
                  <td><fieldset>
                      <legend><strong>SENARAI HARTA ALIH</strong></legend>
                      <table width="100%">
                        <tr>
                          <td align="left"><div align="left"> #if($listHadulu.size()!=0 )
                              <input type="button" name="simpan_pilihan" id="simpan_pilihan" value="Simpan Pilihan" onClick="simpanHA()" />
                              <blink> <font  color="blue"  onMouseOver="this.style.cursor='help'" onClick="open_new_window('1','');" ><img src="../img/info.png"  align="center" /></font> </blink> #if($flag_kemaskini_selesai != "yes") 
                              <script>
                                        document.getElementById('simpan_pilihan').style.display = "none";
                                        </script> 
                      ...
                      <table width="100%" >
                        <tr class="table_header">
                          ...
                          <td width="30%">JENIS HARTA ALIH</td>
                          <td width="40%">NO. RUJUKAN UPT / NO. DAFTAR / NO. AKAUN / NO. AHLI </td>
                          <td width="20%">JENIS PERINTAH ASAL</td>
                          <td width="5%"> #if($listHadulu.size()!=0 )
                            <div align="center">
                              <input type="checkbox" name="all" id="all" onClick="pilihan_CheckAll();setPilihanOB_KS_all('all','','');"  title="Semak untuk pilih semua" />
                            </div>
                            #end </td>
                        ...
                        <tr bgcolor="white" class="$row_color">
                          ...
                          <td ><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:edit_hartaalih('$id3')" class="style4">$list.Keterangan <span class="style10">$cat</span></a></div></td>
                          <td ><div align="left" style="text-transform:uppercase;" onblur="uppercase()">$list.noDaftar</div></td>
                          <td ><div align="left" style="text-transform:uppercase;" onblur="uppercase()">$list.JENIS_PERINTAH</div></td>
                          <td ><label>
                            <div align="center"> #set($p_c = 0)
                              #foreach($lo in $check_pilihan_ha)     
                              #if($lo.id_ha == $id3 && $lo.id_permohonansimati == $idPermohonanSimati)
                              #set($p_c = 1)
                              #end     
                              #end
                              ...
                              #set($pil_cek = "" )
                              #end
                              <input type="checkbox" name="ids" id="ids" onClick="setPilihanHarta('$id3');setPilihanOB_KS_all('harta','$id3','');" $!pil_cek value="$id3" />
                              #set($jenis_perintah_harta = "jenis_perintah_harta" + $id3)
                              <input type="hidden" name="$jenis_perintah_harta" id="$jenis_perintah_harta"  value="$list.ID_JENISPERINTAH" />
                              <input type="checkbox" name="ids_check" id="ids_check" checked value="$id3" style="display:none" />
                              #set($jenis_hta = "jenis_harta" + $listam.idhta)
                              <input type="hidden" name="$jenis_hta" id="$jenis_hta"  value="" />
                              #set($harta_obmst = "harta_obmst" + $listam.idhta)
                              <input type="hidden" name="$harta_obmst" id="$harta_obmst"  value="$listam.ID_PERINTAHHAOBMST" />
                            </div>
                            </label></td>
                        </tr>
                        #set($display_ob = "display_ob" + $list.id_Ha)  
                        #parse("app/ppk/frmHAOBpilihan.jsp") 
                        #if($!pil_cek == "checked") 
                        <script>
	   document.getElementById('$display_ob').style.display="";
       </script> 
...
<!-- arief add TANDATANGAN DIGITAL bagi PERINTAH CLOSE -->
  ...
  <tr>
    <td align="center"> #if ($flagPopup == '')
      ...
      #if ($flagSelesaiPembahagian == 'Y')
      	#if($!headerppk.CAPAIAN_FAIL_UNIT_LUAR == "N")
      		<input type="button" name="cmdJanaPerintah" id="cmdJanaPerintah" value="Intergrasi Sistem eTanah" onClick="javascript:janaPerintah('$idFail')"/>
      	#end
      #end
...
#parse("app/ppk/pilihan_script_perintah.jsp") 
...
function cetakBorangH(idFail) {
	//var url = "../servlet/ekptg.report.ppk.BorangH_Perintah?idfail="+idFail;//+"&idobminor="+idobminor; //ubah pada 27122017 en peje
	var url = "../servlet/ekptg.report.ppk.BorangH?idfail="+idFail;//+"&idobminor="+idobminor;
...
function updatePAPTHTAPT(idOB,idPermohonanSimati,idSimati,statusWaris,idPerintah,mode,idPerintahHTAOBMST,flag_kemaskini_selesai) {
...
function pembahagianSepara() {
	...
	if (idJenisTanah == 3){
		alert("Pembahagian Tanah Jenis GSA dihadkan kepada 2 waris sahaja.");
		return;
	}
...
function simpanHTA() {
	if ( !window.confirm("Adakah Anda Pasti?") ) return;
		//document.${formName}.actionPerintah.value = "";		
	document.${formName}.selectedTabPA.value = "0";
	document.${formName}.hitButt.value = "simpanHTA";
	document.${formName}.anchor.value = "tabPA";
	SaveScrollXY(); 
	document.${formName}.submit();
...
function simpanHA() {
	if ( !window.confirm("Adakah Anda Pasti?") ) return;
		//document.${formName}.actionPerintah.value = "";		
	document.${formName}.selectedTabPA.value = "1";
	document.${formName}.hitButt.value = "simpanHA";
	document.${formName}.anchor.value = "tabPA";
	SaveScrollXY(); 
	document.${formName}.submit();
...
new_window.document.write("<b><font color='blue'>Makluman</font></b><br>");

new_window.document.write("<br><font color='blue'><b>'Simpan Pilihan'</b> adalah satu fungsi baru bagi menyimpan maklumat-maklumat pembatalan <b>Pemegang Amanah</b> dan <b>Pentadbir</b>. Setelah maklumat disimpan, pengguna boleh meneruskan proses perintah seperti biasa diruangan <b>PEMBAHAGIAN HARTA</b>.</font><br>");


new_window.document.write("<br><b><font color='red'><blink>Peringatan!</blink></font></b><br>");

new_window.document.write("<br><font color='blue'>Sila pastikan maklumat pilihan adalah tepat dan lengkap sebelum menekan butang <b>'Simpan Pilihan'</b>. </font><br>");

new_window.document.write("<br><font color='blue'>Bagi fail yang telah dimasukkan maklumat <b>perintah pembahagian dan perlantikan</b>, jika anda ingin membuat pengemaskinian maklumat pilihan, <b>maklumat perintah pembahagian dan perlantikan (Pemegang Amanah dan Pentadbir) perlu dimasukkan semula</b> selepas maklumat pilihan disimpan.</font><br>");

new_window.document.write("<br><font color='blue'>Bagi fail yang berstatus <b>'Permohonan Selesai'</b> dan <b>'Selesai'</b>, status fail akan bertukar ke <b>'Selesai Perbicaraan'</b> setelah maklumat pilihan dikemaskini semula.</font></b><br>");

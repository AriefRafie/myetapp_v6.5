					                                          	...
					                                          	<tr>
					                                           	...
					                                           	<tr>
					                                                ...
					                                                <td><label>
					                                                  ...
					                                                  <input name="txtAlamat2Htaam" type="text" id="txtAlamat2Htaam" style="text-transform:uppercase;
					                                               " onblur="this.value=this.value.toUpperCase()" value="" size="50" maxlength="50"  class="$readmode"    />
					                                                  </label>
					                                                  #if($readmode != "disabled") <span id="checklot" style="color:red" ></span> #end </td>
					                                           	</tr>
	...
	#foreach($listamid in $listHTAid)
                          				...
                          				<table width="85%" align="center">
				                        	<tr>
				                              <td width="40%"><span class="style36">
				                                <input name="radioJenisHTA_update" id="radioJenisHTA_update" type="radio" value="1" 
				                                	onclick="setSelected(1,0,0,1);check_jenis_hta1();" $radioJenisHTA_update_checked1/>
				                                <font color="BLUE" ><b>HARTA TAK ALIH (ADA HAKMILIK)</b></font> </span> </td>
				                              <td  width="60%"><span class="style36">
				                                <input name="radioJenisHTA_update" id="radioJenisHTA_update" type="radio" value="2"
				                                	onclick="setSelected(1,0,0,1);check_jenis_hta2();tukarjenis_HtaamX();" $radioJenisHTA_update_checked2 />
                          ...
                          <script>
							 ...
							 function check_jenis_hta3(){
								if(document.f1.radioHtaamViewX_update[0].checked == true 
										|| document.f1.radioHtaamViewX_update[1].checked == true 
										|| document.f1.radioHtaamViewX_update[2].checked == true){	
								 	document.f1.radioJenisHTA_update[0].checked = false;							
            	...
            	#set($meterhektar = "")
					                              	...
					                              	<tr>
					                                    ...
					                                    <td><label> #if($readmode == "disabled")
					                                      ...
					                                      <input name="txtNilaiTarikhMohonHt" type="text" value="$!listamid.nilai_Hta_memohon" size="15"  onkeyup="javascript:validateIC(event,this,this.value,'txtNilaiTarikhMohonHt')" $readmodeR class="$readmode" />
					                                      #else
					                              	...
					                              	<tr>
					                                    ...
					                                    <td><label> #if($readmode == "disabled")
					                                      ...
					                                      <input name="txtNilaiTarikhMatiHtaamUpd" onkeyup="javascript:validateIC(event,this,this.value,'txtNilaiTarikhMatiHtaamUpd')" type="text" id="txtNilaiTarikhMatiHtaam2" value="$!listamid.nilai_Hta_mati" size="15" $readmodeR class="$readmode" />
					                                      #else
                                      ...
                                      <input name="jt" value="" size="15" style="text-transform:uppercase;" $readmodeR class="$readmode" />
					                                	...
					                                	<select name="socJenisTanahHtaamUpd" class="autoselect" $readmode id="socJenisTanahHtaam2" style="text-transform:uppercase;" onblur="uppercase()">
						                              	...
						                              	<tr id="tr_flag_daftar"  style="display:none">
						                                    ...
						                                    <td valign="top">:</td>
						                                    <td valign="top"> 
                                    #set($FLAG_DAFTAR = $listamid.FLAG_DAFTAR)
			...
			#set( $i = $velocityCount )
				...
				#set( $row = "row1" )
                            				...
                            				<tr bgcolor="white" class="$!row">
                                            	<td ><div align="center" style="text-transform:uppercase;" onblur="uppercase()">$!i</div></td>
				                              	<td ><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_htaam($listam.idhta)" class="style42">$!listam.namaNegeri</a></div></td>
                        		...
                        		<td>
                        			<fieldset>
                          			...
                          			<table width="100%">
                            			<tr>
                              				<td align="left"><div align="left"> #if($tambahharta == "yes") #end
                                  #if($kembaliharta == "yes")
                                  <!--
                                            <input type="submit" name="cmdKembali2" id="cmdKembali2" value="Kembali"  onclick="kembali_simati()" />
                                  -->
			...
			<!--  
     		...
     		-->
          	...
          	<script>
            	...
            	#end
 		<!-- set ob -->
       	<!-- #foreach($listam in $listHTAdulu) #end -->

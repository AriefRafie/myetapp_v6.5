                             ...
                             #set($meterhektar = "")
                                ...
                                <option value="1">TANAH RIZAB</option>
                                        ...
                                        <option value="3">TANAH GSA</option>
                                                ...
                                                #end 
                                                #if($!skrin_online == "yes") 
                                                <font style="cursor:help" align="left" class="font2" title="info" onMouseOut="close_window()"  onMouseOver="open_new_window_online('1','');this.style.cursor='help'" >#parse("app/ppk/infoblink_ppkonline.jsp")</font></td>
                                            	#end
                                            </tr>
                                            <tr>
                              ...
                              <table width="100%">
                                ...
                                <input type="hidden" name="idhtaamXid" id="idhtaamXid" value="$idhtaam" />
                                      ...
                                      <tr>
                                        ...
                                        #if($show_kemaskini_htaam == "yes")
                                       <!-- button integrasi -->                                        
                                          <input type="button" name="cmdJPPH" value ="Nilaian JPPH" onClick="javascript:intNilaianJPPH('$id', '$idhta')">&nbsp;                                          <input type="button" name="cmdETanahHM" value="Semakan Status Hakmilik" onclick="checkWSHM('$idhta');" />&nbsp;

...
<script type="text/javascript">
	//window.location="?_portal_module=ekptg.view.ppk.FrmPrmhnnSek8SenaraiSemakInternal";	
	alert("Minta maaf. No Fail telah wujud.")
</script>
#end
...
<script type="text/javascript">
	//window.location="?_portal_module=ekptg.view.ppk.FrmPrmhnnSek8SenaraiSemakInternal";	
	alert("Minta maaf. No Fail dan No KP Simati telah wujud.")
</script>
#end
...
<body onLoad="submitForm();calcDate();check_kp();check_kp_lama();check_kp_lain();check_pengenalan_simati_1_onload();check_pengenalan_simati_2_onload();check_pengenalan_simati_3_onload();check_nofail_onload();pilih_taraf();check_kp_pemohon_onload();selectPelbagaiNegara('$negeri','div_mesejpelbagagainegara','tr_pelbagainegara','nama_pelbagainegara');">
...
<table width="100%" border="0" id="main_table">
      ...
      <tr>
        <td valign="top"><fieldset>
          ...
          <table width="100%" border="0">
            <tr>
              <td width="1%">#if($setmode != "disabled") <span class="style1">*</span> #end</td>
              ...
              <input name="txtNoFail" type="text" id="txtNoFail" onBlur="this.value=this.value.toUpperCase();check_nofail()" style="width: 195px; text-transform:uppercase;" value="$noFail" maxlength="25"  $setmodeR class="$setmode" />
              <span id="check_nofail" style="color:red" ></span>
              </td>
            </tr><tr>
              ...
              <td>:</td>
               ...
               #set($setmode2R = "readonly")
                <input name="socDaerah" id="socDaerah" value="$nd" type="text" $setmode2R class="$setmode" style="width: 195px;"  />
               #else
               #set($setmode2R = "")
               #end
               ...
               <input name="socDaerahinput" id="socDaerahinput" value="$idDaerahx" type="hidden"  />
                #if($setmode != "disabled") 
               <select name="socDaerah" style="width: 195px;" $setmode />
 ...
 <input name="tdaftar" id="tdaftar"  type="hidden" value="$tarikhmohonx" />
...
#end
            #if ($EventStatus == "0") <a href="javascript:displayDatePicker('txdTarikhMohon',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/></a> 
            
            #if ($setmode != "disabled" )
              		
                    <em><span class="style3 style4 style2">dd/mm/yyyy</span></em>#end 
          ...
          <table width="100%" border="0">
            ...
            <tr>
              <td width="1%">&nbsp;</td>
               ...
               #set($setmodeR = "")
               #end
              <td width="30%">No KP Baru</td>
              <td width="1%">:</td>
              <td width="64%"> #if ($idAlert == "1" || $idAlert == "2") 
                
                <input name="txtNoKPBaruSimati1" id="txtNoKPBaruSimati1" style="width: 50px;" type="text" value="$nokpbaru1x" size="7" maxlength="6" readonly   class="disabled"  onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati2')"  onblur="qryHowOld();check_kp();check_pengenalan_simati_1()" />
                -
  <input name="txtNoKPBaruSimati2" id="txtNoKPBaruSimati2" style="width: 20px;" type="text" value="$nokpbaru2x" size="3" maxlength="2" readonly   class="disabled"  onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')"  onBlur="check_kp();check_pengenalan_simati_1()"  />
                -
  <input name="txtNoKPBaruSimati3" id="txtNoKPBaruSimati3"  style="width: 40px;" type="text" value="$nokpbaru3x" readonly   class="disabled"  size="5" maxlength="4"  onblur="jantinaic();check_kp();check_pengenalan_simati_1();kp_baru_pemohon()" />
 
                #else
                
                <input name="txtNoKPBaruSimati1" id="txtNoKPBaruSimati1" style="width: 50px;" type="text" value="$noKpBaru1" size="7" maxlength="6" readonly   class="disabled"  onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati2')" onBlur="qryHowOld();check_kp();check_pengenalan_simati_1()"  />
  ...
  <input name="txtNoKPBaruSimati2" id="txtNoKPBaruSimati2" style="width: 20px;" type="text" value="$noKpBaru2" size="3" maxlength="2" readonly   class="disabled" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')" onBlur="check_kp();check_pengenalan_simati_1()" />
                -
  <input name="txtNoKPBaruSimati3" id="txtNoKPBaruSimati3"  style="width: 40px;" type="text" value="$noKpBaru3" readonly   class="disabled"  size="5" maxlength="4" onBlur="jantinaic();check_kp();check_pengenalan_simati_1();kp_baru_pemohon()" />
    ...
    #if ($setmode != "disabled" )
   <a href="http://www.jpn.gov.my"target="_blank" class="style51 style3 style2"><em> www.jpn.gov.my</em></a>
  #end  </td>
 ...
 <input name="check_no_kp_lain_pemohon" id="check_no_kp_lain_pemohon" type="hidden"  />  
            ...
            <tr>
              ...
              <td> #if ($idAlert == "1" || $idAlert == "2") 
                ...
                #else
                <input name="txtNoKPLamaSimati" id="txtNoKPLamaSimati" type="text" value="$noKpLama"  onblur="this.value=this.value.toUpperCase();check_kp_lama();check_pengenalan_simati_2();kp_lama_pemohon()" readonly   class="disabled"  maxlength="15" size="15" style="width: 120px; text-transform:uppercase;"/>
            ...
            <tr>
              ...
              <td>
               ...
               <input  name="socJenisKPLainSimatiX" id="socJenisKPLainSimatiX"  value="$jkpm" size="12" readonly class="disabled"  />
                <input  name="socJenisKPLainSimati" id="socJenisKPLainSimati"  type="hidden" value="$jenisKpMati"  readonly class="disabled"  />
  ...
  <input name="txtNoKPBaruSimati2" id="txtNoKPBaruSimati2" style="width: 20px;" type="text" value="$nokpbaru2x" size="3" maxlength="2" $setmodeR class="$setmode" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')"  onBlur="check_kp();check_pengenalan_simati_1()"  />
                -
  <input name="txtNoKPBaruSimati3" id="txtNoKPBaruSimati3"  style="width: 40px;" type="text" value="$nokpbaru3x" $setmodeR class="$setmode" size="5" maxlength="4"  onblur="jantinaic();check_kp();check_pengenalan_simati_1();kp_baru_pemohon()" />
  ...
  <input name="txtNoKPBaruSimati2" id="txtNoKPBaruSimati2" style="width: 20px;" type="text" value="$noKpBaru2" size="3" maxlength="2" $setmodeR class="$setmode" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')" onBlur="check_kp();check_pengenalan_simati_1()" />
                -
  <input name="txtNoKPBaruSimati3" id="txtNoKPBaruSimati3"  style="width: 40px;" type="text" value="$noKpBaru3" $setmodeR class="$setmode" size="5" maxlength="4" onBlur="jantinaic();check_kp();check_pengenalan_simati_1();kp_baru_pemohon()" />
  <span id="check_kp_1" style="color:red" ></span>
 ...
 <input name="check_no_kp_lain_pemohon" id="check_no_kp_lain_pemohon" type="hidden"  />  
            ...
            #set($setmodR = "")
            	...
            	<input name="txtNoKPLainSimati" type="text" class="$setmod" id="txtNoKPLainSimati" style="width: 97px; text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();check_kp_lain();check_pengenalan_simati_3();kp_lain_pemohon()" value="$noKpLainx" size="25" maxlength="9" $setmodR />
       ...
       <input name="txtNoKPLainSimati" type="text" class="$setmod" id="txtNoKPLainSimati" style="width: 97px; text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();check_kp_lain();check_pengenalan_simati_3();kp_lain_pemohon()" value="$noKpLain" size="25"  maxlength="9" $setmodR />
       <span id="check_kp_3" style="color:red" ></span>
            ...
            <tr>
              <td valign="top" >#if($setmode != "disabled")
                <span class="style1">*</span>              #end</td>
              <td>#if($setmode == "disabled")
             Nama Simati
              #else <span class="style5">Nama Simati</span> #end </td>
              <td>:</td>
              <td> #if ($idAlert == "1" || $idAlert == "2")
...
<select name="jenis_pemohon"  class="autoselect" $readmode id="jenis_pemohon" style="text-transform:uppercase;" onBlur="uppercase()" onChange="pilih_taraf()" >        
  ...
  <div id="check_kp_p1" style="color:red" ></div>
        ...
        <tr  id="kp2">
          ...
          <td> #if ($idAlert == "1" || $idAlert == "2")
            ...
            <input name="txtNoKPLamaPemohon"  onblur="this.value=this.value.toUpperCase();kp_lama_pemohon()" id="txtNoKPLamaPemohon" style="width: 120px; text-transform:uppercase;" type="text" value="$noKpLamaPemohonx" $setmodeR class="$setmode" maxlength="9" size="10"/>
            <div id="check_kp_p2" style="color:red" ></div>
            #else
            
            <input name="txtNoKPLamaPemohon"  onblur="this.value=this.value.toUpperCase();kp_lama_pemohon()" id="txtNoKPLamaPemohon" style="width: 120px; text-transform:uppercase;" type="text" value="$noKpLamaPemohon" $setmodeR class="$setmode" maxlength="9" size="10"/>
            <div id="check_kp_p2" style="color:red" ></div>
            #end </td>
        </tr>
        <!--
  ...
  <option value="$Listkp.id">$Listkp.keterangan </option>
            ...
            <input name="txtNoKPLainPemohon" type="text" class="$setmod1" id="txtNoKPLainPemohon" style="width: 90px; text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();kp_lain_pemohon()" value="$noKpLainPemohonx" size="9" maxlength="25" $setmod1R/>
           ...
           <input name="txtNoKPLainPemohon" type="text" class="$setmod1" id="txtNoKPLainPemohon" style="width: 90px; text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();kp_lain_pemohon()" value="$noKpLainPemohon" size="9" maxlength="25" $setmod1R/>
           <div id="check_kp_p3" style="color:red" ></div>
            #end </td>
        </tr>
...
<table>
 ...
 <tr>
    <td><span class="style3 style44 style1"><em>Perhatian</em></span><span class="style3 style50"><em> : Sila pastikan label bertanda <span class="style1">*</span> diisi.</em></span></td>
  </tr>
</table>
#end
<table width="100%" border="0">
   ...
   #parse("app/ppk/SuratMintaMaklumat.jsp")   
      ...
      #set($NoFail = $noFail)
       ...
       <tr>
        ...
        <td ><a href="#" class="style2 " onClick="cetakBorangB('$NoFail','$idFail','$flagFromSenaraiFailSek8','$flagForView')">Borang B (Cetakan Secara Portrait)</a></td>
      </tr>
      
        <tr>
     
        <td ><a href="#" class="style2 " onClick="cetakBorangB2('$NoFail','$idFail','$flagFromSenaraiFailSek8','$flagForView')">Borang B (Cetakan Secara Landskap)</a></td>
      </tr>
...
function Simpan() {
    ...
    var dt=document.f1.txtTarikhMati
	 var tm=document.f1.txdTarikhMohon
   ...
   //alert("DATE ::"+date1);
	...
	else if (document.f1.socDaerah.value=="0") {
	...
	*/
		...
		alert("Sila masukkan No KP Baru Simati dengan lengkapnya");
		document.f1.txtNoKPBaruSimati1.focus();
	}
		...
		alert("Sila pilih jenis No KP Lain Simati");
	}
	...
	/* 
		...
		alert("Sila masukkan salah satu No KP Pemohon.");
	}
	*/
		...
		alert("Sila masukkan No KP Baru Pemohon dengan lengkapnya");
		document.f1.txtNoKPBaruPemohon1.focus();
	}
		...
		alert("Sila lengkapkan No KP Pemohon.");
		document.f1.txtNoKPBaruPemohon2.focus();
	}
	else if (document.f1.txtNoKPBaruPemohon1.value!="" && document.f1.txtNoKPBaruPemohon2.value!="" && document.f1.txtNoKPBaruPemohon3.value=="" ) {
		alert("Sila lengkapkan No KP Pemohon.");
	...
	else if (document.f1.socJenisKPLainPemohon.value!="0" && document.f1.txtNoKPLainPemohon.value=="") {
		alert("Sila masukkan No KP Lain Simati");
		document.f1.txtNoKPLainPemohon.focus();
	}
	else if (document.f1.txtNoKPLainPemohon.value!="" && document.f1.socJenisKPLainPemohon.value=="0") {
		alert("Sila pilih jenis No KP Lain Simati");
		document.f1.socJenisKPLainPemohon.focus();
	}
	
		/*
	else if (document.f1.taraf_penting.value == "6"  && document.f1.jenis_pej.value == "" && (document.f1.txtNamaPemohon[1] != 'null' && document.f1.txtNamaPemohon[1].value=="")) {	
	alert("Sila pilih Amanah Raya");		
	...
	*/
	...
	{
		alert("Sila lengkapkan No KP Lama Pemohon");
		document.f1.txtNoKPLamaPemohon.focus();	
	}
	...
	/*
	else if (document.f1.txtNamaPemohon[1].value=="") {
		alert("Sila masukkan nama pemohon.");
		document.f1.txtNamaPemohon[1].focus();
	} 
	...
	*/
	...
	else if (document.f1.txtTarikhMati.value != "" && isDate(dt.value)==false){
		dt.focus()
		return false
	}
	...
	else if (document.f1.txdTarikhMohon.value != "" && (isDate(tm.value)==false)){
		tm.focus()
		return false
	}
	else if (document.f1.txdTarikhMohon.value != "" && (date2 > currentTime)){
   ...
   else if( document.f1.txtTarikhMati.value != "" && (date2 < date1))
   {
...
{
/*	   
alert("id_negeri : "+document.f1.socNegeri.value);
...
{
	url = "../servlet/ekptg.view.ppk.PendaftaranCheck";
	actionName = "check_nofail";
	target = "check_nofail";
	doAjaxUpdater(document.f1, url, target, actionName);
}

function check_nofail_onload()
{
	url = "../servlet/ekptg.view.ppk.PendaftaranCheck";
	actionName = "check_nofail_onload";
	target = "check_nofail";
	doAjaxUpdater(document.f1, url, target, actionName);
}
...
function semakMTPermohonan() {
    var url = "../x/${securityToken}/ekptg.view.ppk.FrmIntegrasiMT?idFail=$idFail&command=borangPermohonan&frmFrom=frmPrmhnnSek8DaftarSek8";

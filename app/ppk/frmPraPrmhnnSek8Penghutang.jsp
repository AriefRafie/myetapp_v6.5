...
#parse("app/ppk/maklumat_sek8.jsp") 
    ...
    <div class="TabbedPanelsContentGroup">
        ...
        <div id="TabbedPanels2" class="TabbedPanelsContentVisible">
          <ul class="TabbedPanelsTabGroup">
            ...
            <li class="TabbedPanelsTab style1 style3" tabindex="0" onclick="setSelected(0,6,0,0);PenghutangView()" id="maklumat_pemohon" >PENGHUTANG</li>
          </ul>
     ...
     <tr>
                              ...
                              <tr>
                               <td width="50%" valign="top"><table width="100%">
                                  ...
                                  <tr>
                                    <td valign="top" ><span class="style43">#if($readmode != "disabled")*#end</span></td>
                                    <td width="28%" ><div align="left" class="style46">#if($readmode != "disabled")Jenis Penghutang#else Jenis Penghutang #end</div></td>
                                  ...
                                  <tr id="kp1">
                                    <td >&nbsp;</td>
                                  <td width="29%" ><div align="left" class="style46">No KP Baru</div></td>
                                  <td width="1%" class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td width="70%" class="style36"><label>
                                  
                                     #if($readmode == "disabled")
                                   <input name="txtNoKPBaru1PentingU" id="txtNoKPBaru1PentingU" style="width: 50px;" type="text"  size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2PentingU')" onBlur="getAgeByIC(this,this.value,'txtUmurPentingU');getDOB(this.value)" value="$txtNoKPBaru1PentingU" $readmodeR class="$readmode" />
                                     - 
                                     ...
                                     <input name="txtNoKPBaru1PentingU" type="text" id="txtNoKPBaru1PentingU" style="width: 50px;" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2PentingU')" value="$txtNoKPBaru1PentingU" size="7" maxlength="6" $readmodekp onBlur="getAgeByIC(this,this.value,'txtUmurPentingU');getDOBU(this.value)" />
                                     - 
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style45" >  www.jpn.gov.my</a>
                                ...
                                <tr id="kp2">
                                  <td >&nbsp;</td>
                                  <td ><div align="left" class="style46">No Pendaftaran</div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                   #if($readmode == "disabled")
                                    <input name="txtNoKPLamaPentingU" type="text" id="textfield4" value="$txtNoKPLamaPentingU" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" size="15" maxlength="9" $readmodeR class="$readmode" />
                                    
                                    #else
                                    <input name="txtNoKPLamaPentingU" type="text" id="textfield4" value="$txtNoKPLamaPentingU" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" size="15" maxlength="9"  $readmodesy />
                                ...
                                <tr  id="kp3"   >
                                  <td >&nbsp;</td>
                                  <td ><div align="left" class="style46">Lain-lain KP</div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"> 
                              ...
                              #set($readmodekp="disabled")
                                  ...
                                  <tr id="kp4">
                                    <td>&nbsp;</td>
                                    <td><div align="left" class="style46"> No KP Lain</div></td>
                                  ...
                                  <tr>
                                    <td valign="top" ><span class="style43">#if($readmode != "disabled")*#end</span></td>
                                    <td><div align="left" class="style46"> #if($readmode != "disabled") Nama Penghutang #else
                                      Nama Penghutang
                                    #end </div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                                 ...
                                 <tr id="agama">
                                   <td>&nbsp;</td>
                                  <td><div align="left" class="style46">Agama</div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label> 
                                      #if($readmode=="disabled")
                                    ...
                                    <select name="socAgamaPentingU" id="select3" class="mediumselect" $readmode style="text-transform:uppercase;" onblur="uppercase()">
                                      ...
                                      <option value="2" style="text-transform:uppercase;" onblur="uppercase()">Bukan Islam</option>
                                         ...
                                         <tr id="warga">
                                           <td>&nbsp;</td>
                                  <td><div align="left" class="style46">Warganegara</div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                    #if($readmode=="disabled")
                                ...
                                <tr>
                                  ...
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                      <input name="txdTarikhLahirPentingU" type="text" style="text-transform:uppercase;"  id="txdTarikhLahirPentingU" size="10" maxlength="10" $readmode value="$txdTarikhLahirPentingU" onblur="trans_date1(this.value)"/>
                                      #if($readmode != "disabled") 
                                    <a href="javascript:displayDatePicker('txdTarikhLahirPentingU',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/> </a></label>
                                    #end                                    </td>
                                </tr> 
                                <tr>
                                  ...
                                  <td><div align="right"><span class="style38">:</span></div></td>
                                  <td><span class="style36">
                                    <input name="txtUmurPentingU" type="text" id="txtUmurPentingU"  value="$txtUmurPentingU" size="3" maxlength="3" $readmode style="text-transform:uppercase;" onblur="CheckumurU()"  onkeyup="javascript:validateIC(event,this,this.value,'txtUmurPentingU')"/>
                                  </span></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                                      <input name="txtNoSuratBeranakPentingU" type="text" id="txtNoSuratBeranakPentingU" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" value="$txtNoSuratBeranakPentingU" size="15" maxlength="10" $readmode />
                                    </label></td>
                                  </tr>
                                -->
                                <tr>
                                  <td valign="top" ><span class="style43">#if($readmode != "disabled")*#end</span></td>
                                  <td><div align="left" class="style46">#if($readmode != "disabled")Nilai Hutang (RM)#else Nilai Hutang #end</div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><div align="left" class="style46">No Akaun</div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                ...
                                <td width="50%" valign="top"><table width="100%" border="0">
                                  ...
                                  <tr>
                                     <td valign="top" ><span class="style43">#if($readmode != "disabled")*#end</span></td>
                                    <td class="style38" width="28%"><div align="right" class="style38 style41">
                                  ...
                                  <tr>
                                    <td class="style43">&nbsp;</td>
                                    <td class="style38"><div align="left"><span class="style41"><span class="style41"></span></span></div></td>
                                  ...
                                  <tr>
                                    <td valign="top" ><span class="style43">#if($readmode != "disabled")*#end</span></td>
                                    <td class="style38"><div align="right" class="style38 style41">
...
<select name="socBandarPentingU" id="socBandarPentingU" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarTetapU()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                  ...
                                  #end
                                  <tr>
                                    <td width="29%" class="style38" ><div align="right" class="style38"><span class="style41">#if($readmode != "disabled")</span> <span class="style40">Alamat Surat Menyurat</span> #else <span class="style72">Alamat Surat Menyurat </span>#end</div></td>
                                    <td width="1%"><div align="right"><span class="style38">:</span></div></td>
                                    <td width="70%"><label>
                                      <input name="txtAlamatTerakhir1WarisSurat" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" type="text" id="txtAlamatTerakhir1WarisSurat" value="$txtAlamatTerakhir1WarisSurat" size="34"  $readmode/>
                                    </label></td>
                                  </tr>
                                  <tr>
                                    <td class="style38"><div align="right"><span class="style38"></span></div></td>
                                    <td>&nbsp;</td>
                                    <td><label>
                                  ...
                                  <tr>
                                    <td class="style38"><div align="right" class="style38"><span class="style41">#if($readmode != "disabled")</span> <span class="style40">Poskod</span> #else <span class="style72">Poskod</span> #end</div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                                  ...
                                  <tr>
                                    <td class="style38"><div align="right" class="style38"><span class="style41">#if($readmode != "disabled")</span> <span class="style40">Negeri</span> #else <span class="style72">Negeri</span> #end</div></td>
...
<select name="socNegeriWarisSurat" class="autoselect" onchange="getBandarSuratU('socBandarWarisSurat')" $readmode >
  ...
  <option value="$listneg.id_Negeri" style="text-transform:uppercase;" onblur="uppercase()">$listneg.kod_Negeri - $listneg.nama_Negeri</option>
                                  ...
                                  <tr>
                                    <td class="style38"><div align="right" class="style38"><span class="style41">#if($readmode != "disabled")</span><span class="style40"> Bandar</span> #else <span class="style72">Bandar</span> #end</div></td>
                                   
                                    
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>#if($socBandarWarisSurat == "" || $socBandarWarisSurat=="0")
                #set($kodbx="")
...
<select name="socBandarWarisSurat" id="socBandarWarisSurat" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSuratU()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                        ...
                                        <tr>
                                          ...
                                          <td >:</td>
                                          <td><input name="txtNoTeleponPentingU" type="text" id="txtNoTeleponPentingU" style="text-transform:uppercase;" onblur="uppercase()" onkeyup="javascript:validateIC(event,this,this.value,'txtNoTeleponPentingU')" value="$txtNoTeleponPentingU" size="14" maxlength="12" $readmode /></td>
                                        </tr>
                                         -->
                                        #if($readmode != "disabled")
                                        #end
                                        <tr>
                                          ...
                                          <td class="style38" valign="top"><div align="right" class="style38 style41">
                                            <div align="left">Catatan</div>
                                          </div></td>
                                          <td valign="top"><div align="right" class="style38">:</div></td>
                                          <td><textarea name="txtButiranHutangPentingU" cols="31"  rows="3"  $readmodeR class="$readmode" id="txtButiranHutangPentingU" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" >$txtButiranHutangPentingU</textarea></td>
                                      </tr>
                                </table></td>
                              </tr>
                            </table>
 ...
 <tr>
  <td><span class="style5"><span class="style2 style44 style40">Perhatian</span><span class="style44"> : Sila masukkan salah satu nombor kad pengenalan atau no syarikat penghutang dan pastikan label bertanda <span class="style40">*</span> diisi</span>.</span></td>
                            ...
                            <table width="100%" border="0">
                              <tr>
                               ...
                               <input type="hidden" name="txtIdSimatiPenting" value="$id_Simati" >        
                                  <tr>
                                    <td valign="top" ><span class="style43">*</span></td>
                                    <td width="29%" ><div align="right" class="style41">
                                      <div align="left"><span class="style38">Jenis Penghutang</span></div>
                                    </div></td>
                                     <td width="1%" class="style36">:</td>
                                     <td width="70%" class="style36">
                                     
                                      <select name="socJenisHutangPenting"  class="autoselect" $readmode id="socJenisHutangPenting" style="text-transform:uppercase;" onblur="uppercase()" onchange="jenis_hutang(this.value);pilih_taraf()">
                                  ...
                                  <td width="29%" ><div align="left" class="style41"><span class="style38">No KP Baru</span></div></td>
                                  <td width="1%" class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td width="70%" class="style36"><label>
                                   
                                     <input name="txtNoKPBaru1Penting" id="txtNoKPBaru1Penting" style="width: 50px;" type="text" $readmode size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2Penting')" onBlur="getAgeByIC(this,this.value,'txtUmurPenting');getDOB(this.value)" value="$txtNoKPBaru1Penting" $readmodekp />
                                     - 
                                     ...
                                     <a href="http://www.jpn.gov.my" target="_blank" class="style45" > www.jpn.gov.my</a> </label></td>
                                </tr>
                                <tr id="kp2">
                                  <td >&nbsp;</td>
                                  <td ><div align="left" class="style41"><span class="style38">No Pendaftaran</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                    <input name="txtNoKPLamaPenting" type="text" id="textfield4" size="15" maxlength="9" $readmodesy style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" value="$txtNoKPLamaPenting"/>
                                  </label></td>
                                </tr>
                                <tr id="kp3">
                                  <td >&nbsp;</td>
                                  <td ><div align="left" class="style41"><span class="style38">Lain-lain KP</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"> 
                              ...
                              #set($txtNoKPLainPenting="")
                                  ...
                                  <tr id="kp4">
                                    <td>&nbsp;</td>
                                    <td><div align="left" class="style41"><span class="style38"> No KP Lain</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><span class="style36">
                                  ...
                                  <tr>
                                    <td valign="top" ><span class="style43">*</span></td>
                                    <td><div align="left" class="style41"><span class="style38">Nama Penghutang</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                     ...
                     <input type="hidden" name="socTarafKepentinganPenting" id="socTarafKepentinganPenting" value="2" />
                                ...
                                <tr>
                                  ...
                                  <td><div align="right"><span class="style38">:</span></div></td>
                                  <td>
                                  <input name="txdTarikhLahirPenting" type="text" id="txdTarikhLahirPenting" size="10" maxlength="10" $readmode  onblur="trans_date(this.value)" value="$txdTarikhLahirPenting" />
                                   <a href="javascript:displayDatePicker('txdTarikhLahirPenting',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/> </td>
                                </tr>
                                <tr>
                                  <td><div align="right"><span class="style38">Umur</span></div></td>
                                  <td><div align="right"><span class="style38">:</span></div></td>
                                ...
                                <tr>
                                  <td valign="top" ><span class="style43">*</span></td>
                                  <td><div align="left" class="style41"><span class="style38">Nilai Hutang (RM)</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36">
                                    <label>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><div align="left" class="style41"><span class="style38">No Akaun</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
...
<select name="txtBandarPenting" id="txtBandarPenting" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarTetap()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                  ...
                                  <tr>
                                    <td width="29%" class="style38" ><div align="right" class="style38"><span class="style40">Alamat Surat Menyurat</span></div></td>
                                    <td width="1%"><div align="right"><span class="style38">:</span></div></td>
                                    <td width="70%"><label>
                                  ...
                                  <tr>
                                    <td class="style38"><div align="right"><span class="style38"><span class="style38"></span></span></div></td>
                                    <td>&nbsp;</td>
                                    <td><label>
                                  ...
                                  <tr>
                                    <td class="style38"><div align="right" class="style38"><span class="style40">Poskod</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                                  ...
                                  <tr>
                                    <td class="style38"><div align="right" class="style38"><span class="style40">Negeri</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td>
...
<select name="socNegeriWarisSurat" class="autoselect" onchange="getBandarSurat('txtBandarWarisSurat')">
  ...
  <option value="$listneg.id_Negeri" style="text-transform:uppercase;" onblur="uppercase()">$listneg.kod_Negeri - $listneg.nama_Negeri</option>
                                  ...
                                  <tr>
                                    <td class="style38"><div align="right" class="style38"><span class="style40"> Bandar</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
...
<select name="txtBandarWarisSurat" id="txtBandarWarisSurat" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSurat()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                        ...
                                        <tr>
                                          ...
                                          <td valign="top"><div align="right" class="style38">:</div></td>
                                          <td><textarea name="txtButiranHutangPenting" cols="31"  rows="3"  $readmode style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" >$txtButiranHutangPenting</textarea></td>
                                      </tr>
                                </table></td>
                              </tr>
                            ...
                            <td>  <table width="100%" border="0" align="center">
                              ...
                              <input type="button" name="batalpenting" id="cmdSimpan3" value="Batal" onclick="setSelected(0,3,0,0);cancelwaris()"/>                                 
                                   ...
                                   <input type="button" name="hapuspenting" id="hapuspenting" value="Hapus"  onclick="setSelected(0,3,0,0);hapus_penting()" />
                                    ...
                                    <input type="submit" name="cmdKembali3" id="cmdKembali3" value="Kembali"  onclick="setSelected(0,3,0,0);PenghutangView()" />
                              ...
                              <table width="100%" >
                                <tr>
                                  <td width="100%">
                                   ...
                                   #if($tambah_ob_button == "yes") #if($id_Status != "169" && $id_Status != "21" && $id_Status != "64" && $id_Status != "163" && $id_Status != "164" && $id_Status != "165")
                                ...
                                <tr>
                                  ...
                                  <table width="100%">
                                    <tr  class="table_header">
                                      ...
                                      <td width="23%"><div align="left">NAMA PENGHUTANG</div></td>
                                      ...
                                      <td width="20%"><div align="left">BUTIRAN HUTANG</div></td>
                                    </tr>
                                    #set($peno=0)
                                    ...
                                    <td class="row1"><div align="center" class="style41">$peno</div></td>
                                      ...
                                      #if($ll!="")
                                      <td class="row1" style="text-transform:uppercase;"><div align="right" >$Util.formatDecimal($ll)</div></td>
                                      #end
                                       #if($ll=="")
                                   ...
                                   <td class="row2"><div align="center" class="style41">$peno</div></td>
                                      ...
                                      #if($lll!="")
                                      <td class="row2" style="text-transform:uppercase;"><div align="right" >$Util.formatDecimal($lll)</div></td>
                                      #end
                                       #if($lll=="")
...
if (document.f1.socJenisHutangPenting.value=="" || document.f1.socJenisHutangPenting.value=="0")
 {
		alert("Sila pilih jenis penghutang");
...
else if (document.f1.txtNamaOBPenting.value=="")
 {
	...
	*/
	...
	else if (document.f1.txtNoKPBaru1Penting.value=="" && document.f1.txtNoKPBaru2Penting.value=="" && document.f1.txtNoKPBaru3Penting.value=="" && document.f1.txtNoKPLamaPenting.value=="" && (document.f1.socJenisKPLainPenting.value=="" || document.f1.socJenisKPLainPenting.value=="0" )&& document.f1.txtNoKPLainPenting.value=="") {
	
	    if(document.f1.socJenisHutangPenting.value == '1')
		{
		alert("Sila masukkan no syarikat penghutang ");
		document.f1.txtNoKPLamaPenting.focus();
		return;
		}
		else
		{
		alert("Sila masukkan salah satu nombor kad pengenalan penghutang");
	 ...
	 else if ((document.f1.txtNoKPBaru1Penting.value!="" || document.f1.txtNoKPBaru2Penting.value!="" || document.f1.txtNoKPBaru3Penting.value!="") && (document.f1.txtNoKPBaru1Penting.value==""))
	 {
		...
		alert("Sila masukkan nombor kad pengenalan penghutang sepenuhnya");
		document.f1.txtNoKPBaru1Penting.focus();
		return; 
	}
...
*/
	...
	{
	alert("Sila lengkapkan alamat tetap penghutang");
	document.f1.txtAlamatTerakhir1Penting.focus()
	return;
	}
	
/*	
	 else if ((document.f1.txtAlamatTerakhir1WarisSurat.value == "" || document.f1.txtPoskodWarisSurat.value == "" || document.f1.txtBandarWarisSurat.value == "0"  || document.f1.txtBandarWarisSurat.value == "" || document.f1.socNegeriWarisSurat.value == "" || document.f1.socNegeriWarisSurat.value == "0"  ))
	{
	alert("Sila lengkapkan alamat surat menyurat penghutang");
   ...
   {
      alert("Sila pastikan tarikh lahir penghutang tidak melebihi dari tarikh mohon.");
...
alert("Sila pilih jenis penghutang");
...
else if (document.f1.txtNamaOBPentingU.value=="")
 {
	...
	else if (document.f1.txtNoKPBaru1PentingU.value=="" && document.f1.txtNoKPBaru2PentingU.value=="" && document.f1.txtNoKPBaru3PentingU.value=="" && document.f1.txtNoKPLamaPentingU.value=="" && (document.f1.socJenisKPLainPentingU.value=="" || document.f1.socJenisKPLainPentingU.value=="0") && document.f1.txtNoKPLainPentingU.value=="") {
...
/*
   ...
   {
      alert("Sila pastikan tarikh lahir penghutangtidak melebihi dari tarikh mohon.");	 
      document.f1.txdTarikhLahirPentingU.focus();
   } 
...
*/
	...
	/*
	 else if ((document.f1.txtAlamatTerakhir1WarisSurat.value == "" || document.f1.txtPoskodWarisSurat.value == "" || document.f1.socBandarWarisSurat.value == "" || document.f1.socBandarWarisSurat.value == "0" || document.f1.socNegeriWarisSurat.value == "" || document.f1.socNegeriWarisSurat.value == "0"))
	{
...
function CheckumurU() 
{
	if (document.f1.txtUmurPentingU.value != "" && document.f1.txtUmurPentingU.value>100) {
		alert("Adakah anda pasti penghutang berumur "+document.f1.txtUmurPentingU.value+" tahun?");
...
function Checkumur() 
{
	if (document.f1.txtUmurPenting.value != "" && document.f1.txtUmurPenting.value>100) {
		alert("Adakah anda pasti penghutang berumur "+document.f1.txtUmurPenting.value+" tahun?");

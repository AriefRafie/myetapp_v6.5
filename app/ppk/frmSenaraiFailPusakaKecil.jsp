...
<table align="center" width="100%"> 
  <tbody>
  	<tr>
     		<td colspan="2" scope="row"><input name="cmdTambah" id="cmdTambah" value="Tambah" type="button"  onclick="Tambah()"></td>
					   ...
					   <tr >
				         ...
				         <td class="$row"><a href="javascript:edit_item('$fail.id_Permohonan','$fail.id_simati','$flagno','$idFlag','$SimpanStatus')" class="style1">$noFail
				          ...
				          <td class="$row">$tarikh_Mohon</td>
							<td class="$row">$keteranganb
								
								
							</td>
                          <td class="$row"><div align="center"><a href="javascript:tab('$fail.id_Permohonan','$fail.id_simati','$fail.id_Pemohon',)" class="style1">Seterusnya</a></div></td>
    </tr>
    #else
    <tr >
       ...
       <td class="$row"><a href="javascript:edit_item('$fail1.id_Permohonan','$fail1.id_simati','$flagno','$idFlag','$SimpanStatus')" class="style1">$noFail
          ...
          <td class="$row">$namasimati.toUpperCase()</td>
          <td class="$row">$tarikh_Mohon</td>
			<td class="$row">$keterangan
				
				
			</td>
           <td class="$row"><div align="center"><a href="javascript:tab('$fail1.id_Permohonan','$fail1.id_simati','$fail1.id_Pemohon')" class="style1">Seterusnya</a></div></td>
    </tr>
    #end
...
function muatTurunBorangC(x) {
    var url = "http://ettap.kehakiman.gov.my/BKM/bkm_frmSearchProbatePublic.aspx?SecurityCode=" + x;

        ...
        <div id="TabbedPanels2" class="TabbedPanelsContentVisible">
          ...
          <div class="TabbedPanelsContentGroup">
            ...
            <div class="TabbedPanelsContent">
              ...
              #if($!skrin_online != "yes")
              <fieldset>
                <legend><strong>JKSM</strong></legend>
                <input type="button" id="cmdJKSM" name="cmdJKSM" onclick="viewBorangJ($id);" value="Papar Borang J" />
              </fieldset>
              <br />
              <!-- end kmie -->
              #end
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                     ...
                                     <tr>
                                       <td class="style38" >&nbsp;</td>
                                        ...
                                        <tr>
                                          <td class="style38"><span class="style44">*</span> </td>
...
document.getElementById('no_fax').style.display="none";
              ...
              <script type="text/javascript">
                function viewBorangJ() {
                  document.f1.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.integrasi.FrmViewBorangJ&action2=viewBorangJ&ID_PERMOHONAN=" + $id;
                  document.f1.method = "POST";
                  document.f1.submit();
                }              
              </script>

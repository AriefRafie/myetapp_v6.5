...
<p>
  ...
  <input name="adaKIV" type="hidden" id="adaKIV" value="$adaKIV"/>
...
document.getElementById("header_lama").style.display="block";
  ...
  <!-- END HEADER --> 
  #if (($flagPopup == '' || $flagPopup == 'openHTA' || $flagPopup == 'openHTATH' || $flagPopup == 'openHA') && ($flagPopup != 'openHTAPT' || $flagPopup != 'openHAPT' || $flagPopup != 'openHTAPKT' || $flagPopup != 'openHAPKT' || $flagPopup != 'openHTAPL' || $flagPopup != 'openHAPL' || $flagPopup != 'openHTAPF' || $flagPopup != 'openHAPF' || $flagPopup != 'openHTAPA1958' || $flagPopup != 'openHAPA1958'))
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<!-- arief add -->
<!-- START FUNCTION PERINTAH PEMBAHAGIAN AKTA 1958 -->

<!-- START FUNCTION HTA -->
function paparHTAPA1958(id) {
document.${formName}.actionPerintah.value = "papar";
document.${formName}.idHTA.value = id;
document.${formName}.flagPopup.value = "openHTAPA1958";
document.${formName}.anchor.value = "tabLower";
document.${formName}.action = "?_portal_module=ekptg.view.ppk.FrmPerintahSek8";
document.${formName}.method="POST";
document.${formName}.submit();
}
function batalHTAPA1958() {
document.${formName}.actionPerintah.value = "papar";
document.${formName}.flagPopup.value = "";
document.${formName}.modePopup.value = "";
document.${formName}.anchor.value = "tabLower";
...
function simpanKemaskiniHTAPA1958() {
if ( !window.confirm("Adakah Anda Pasti ?") ){
	document.${formName}.actionPerintah.value = "papar";
	return;
}
...
document.${formName}.flagPopup.value = "openHTAPA1958";
document.${formName}.modePopup.value = "update";
document.${formName}.hitButt.value = "simpanKemaskiniHTAPA1958";
document.${formName}.anchor.value = "tabLower";
document.${formName}.submit();
}
function updatePAPTHTAPA1958(idOB,idPermohonanSimati,idSimati,statusWaris,idPerintah,mode,idPerintahHTAOBMST,flag_kemaskini_selesai) {
...
<!-- START FUNCTION HA -->
function paparHAPA1958(id) {
document.${formName}.actionPerintah.value = "papar";
document.${formName}.idHA.value = id;
document.${formName}.flagPopup.value = "openHAPA1958";
document.${formName}.anchor.value = "tabLower";
document.${formName}.action = "?_portal_module=ekptg.view.ppk.FrmPerintahSek8";
document.${formName}.method="POST";
document.${formName}.submit();
}
function batalHAPA1958() {
document.${formName}.actionPerintah.value = "papar";
document.${formName}.flagPopup.value = "";
document.${formName}.modePopup.value = "";
document.${formName}.anchor.value = "tabLower";
...
function simpanKemaskiniHAPA1958() {
if ( !window.confirm("Adakah Anda Pasti ?") ){
	document.${formName}.actionPerintah.value = "papar";
	return;
}
...
document.${formName}.flagPopup.value = "openHAPA1958";
document.${formName}.modePopup.value = "update";
document.${formName}.hitButt.value = "simpanKemaskiniHAPA1958";
document.${formName}.anchor.value = "tabLower";
document.${formName}.submit();
}
function updatePAPTHAPA1958(idOB,idPermohonanSimati,idSimati,statusWaris,idPerintah,mode,idPerintahHAOBMST,flag_kemaskini_selesai) {
...
<!-- END FUNCTION PERINTAH PEMBAHAGIAN AKTA 1958 -->
<!-- arief add -->
</script> 

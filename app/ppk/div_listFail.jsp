	...
	<table border="0" width="100%" > 
	   ...
	   <tr class="table_header">
	          ...
	          <tr>
				...
				<span id="$span1">  
	            ...
	            #if($list.NO_FAIL == '')
	            	<a href="javascript:papar('$list.id_permohonan','$list.idStatus','$list.id_fail','$list.idSimati','$list.idpermohonansimati','$list.tarikhMohon','$list.jenisfail','$list.seksyen')" class="style1">TIADA NO FAIL JKPTG</a>
	            #else
	             ...
	             <td class="$row" valign="top">
					...
					<span id="$span1">
		            	#if($list.idStatus =='18') 
		            		$list.STATUS.toUpperCase() #if($list.tarikhBicara!='') (Tarikh bicara : $!list.tarikhBicara) #end
		            	#elseif($list.idStatus =='21')
		            		$list.STATUS.toUpperCase() #if($list.tarikhSelesai!='') (Tarikh selesai : $!list.tarikhSelesai) #end
		            	#else
	            ...
	            <td class="$row" valign="top">
		            #set($span1 = "span1"+$i)
					<span id="$span1">
		            	$list.nama_pejabat, $list.daerah_pejabat
		            </span>
	            </td>

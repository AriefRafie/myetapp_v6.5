...
<script type="text/javascript">
	...
	input_box = confirm("Maaf. Permohonan Seksyen 17 masih lagi dalam proses.");
...
<input name="IdAlert" type="hidden" value="$IdAlert">
<input name="SorWaris" type="hidden" value="$SorWaris">
  ...
  <table width="100%" align="center" border="0">
    <tbody>
      <tr> 
        ...
        <td width="30%"><input name="sorWaris" type="radio" id="sorWaris" onClick="getOne('sorWaris');" value="1" $setmode $checked3>Waris</td>
      ...
      <tr> 
        <td scope="row"></td>
        <td ><input type="radio" name="sorWaris" value="2" id="sorWaris2" $setmode $checked4 onClick="getOne('sorWaris');">
        Orang Berkepentingan</td>
        <td><select name="socOB" $setmode $waris2 style="width:350px;">	 
		 #if ($socOb=="" || $socOb=="0")
		  	  <option value="0" onClick="hiddendisplay()" >SILA PILIH</option>
		      #foreach ($listob in $ListOB) 
			  <option value="$listob.idtarafkptg" onClick="hiddendisplay()">$!listob.keterangan</option>
			  #end
		 #else
		      #foreach ($listob in $ListOB) 
			  		#if ($listob.idtarafkptg == $socOb)
			  <option value="$listob.idtarafkptg" selected onClick="hiddendisplay()">$!listob.keterangan</option>
			  		#end
			  #end
		 	  <option value="0">SILA PILIH</option>
		      #foreach ($listob in $ListOB) 
...
<table border="0" align="center" width="100%">
    <tbody>
    #if($SorWaris == "1" || $SorWaris == "" || $SorWaris == "0")
      <tr id="nokpbaru"> 
        <td width="20%" height="24" scope="row" align="right">&nbsp;MyID Baru XXXX</td>

        <td width="80%"> : <input name="txtNoKPBaru1" id="txtNoKPBaru1" style="width: 50px;" type="text" value="$!noKpBaru1" size="7" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2')" maxlength="6" $setmode/>-<input name="txtNoKPBaru2" id="txtNoKPBaru2" style="width: 20px;" type="text" value="$!noKpBaru2" size="3" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3')" maxlength="2" $setmode/>-<input name="txtNoKPBaru3" id="txtNoKPBaru3"  style="width: 40px;" type="text" value="$!noKpBaru3" $setmode size="5" maxlength="4"/></td>

      </tr>
      <tr id="nokplama"> 
        <td scope="row" align="right">&nbsp;MyID Lama</td>
        <td > : <input name="txtNoKPLama" type="textbox" id="txtNoKPLama" maxlength="8" size="10" value="$!noKpLama" style="width: 120px; text-transform:uppercase;" $setmode>&nbsp;&nbsp;<span class="style1"><i>(Sila kosongkan ruangan ini jika tidak berkaitan)</i></span></td>
      </tr>
      <tr id="nokplain"> 
        ...
        <td > : <select name="socJenisKPLain" style="width:120px;" $setmode>
            ...
            #set ($selected = "")
            	...
            	#end
          </select> <input name="txtNoKPLain" id="txtNoKPLain" style="width:97px; text-transform:uppercase;" type="text" value="$noKpLain" maxlength="9" $setmode />&nbsp;&nbsp;<span class="style1"><i>(Sila kosongkan ruangan ini jika tidak berkaitan)</i></span></td>
      </tr>
      <tr id="namapemohon"> 
      ...
      #if($SorWaris == "0")
	  <tr id="arb">
	    <td height="25" valign="bottom" align="right"><span class="style2">*</span>Amanah Raya</td>
        <td height="25" valign="bottom">: 
          <label>
          <select name="socARB" id="socARB" style="width:350px";>
           #if ($socARB=="" || $socARB=="0")
		  	  <option value="0" >SILA PILIH</option>
		      #foreach ($listOBARB in $listARB) 
			  <option value="$listOBARB.id_Pejabat">$!listOBARB.nama_pejabat $!listOBARB.namabandar</option>
			  #end
		 #else
		      #foreach ($listOBARB in $listARB) 
			  		#if ($listOBARB.id_Pejabat == $socARB)
			  <option value="$listOBARB.id_Pejabat" selected>$!listOBARB.nama_pejabat $!listOBARB.namabandar</option>
			  		#end
			  #end
		 	  <option value="0">SILA PILIH</option>
		      #foreach ($listOBARB in $listARB) 
	  ...
	  <tr id="baitulmal">
	    <td height="25" valign="bottom" align="right"><span class="style2">*</span>Baitulmal</td>
	    <td height="25" valign="bottom">: 
	      <label>
	      <select name="socBaitulmal" id="socBaitulmal" style="width:350px">
           #if ($socBaitulmal=="" || $socBaitulmal=="0")
		  	  <option value="0" >SILA PILIH</option>
		      #foreach ($listOBBaitulmal in $listBaitulmal) 
			  <option value="$listOBBaitulmal.id_Pejabat">$!listOBBaitulmal.nama_pejabat $!listOBBaitulmal.namabandar</option>
			  #end
		 #else
		      #foreach ($listOBBaitulmal in $listBaitulmal) 
			  		#if ($listOBBaitulmal.id_Pejabat == $socBaitulmal)
			  <option value="$listOBBaitulmal.id_Pejabat" selected>$!listOBBaitulmal.nama_pejabat $!listOBBaitulmal.namabandar</option>
			  		#end
			  #end
		 	  <option value="0">SILA PILIH</option>
		      #foreach ($listOBBaitulmal in $listBaitulmal) 
      ...
      #end
	  <tr>
	  <td colspan="2" height="50px" valign="bottom"><p><i>
                        <font color=red style=font-size:10px>Perhatian</font>
                        <font style=font-size:10px>: Sila pastikan label bertanda</font>&nbsp;
                        <font color=red style=font-size:10px>*</font>&nbsp;
                        ...
                        <br>
                        <i>
                         <font style=font-size:10px>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sila pastikan salah satu MyID diisi.</font>&nbsp;                         </i></p></td>
	  </tr>
      </tbody>
      </table>
</fieldset>
...
<table border="0" align="center" width="100%">
    <tbody>
      <tr> 
        <td width="20%" height="24" scope="row" align="right">&nbsp;MyID Baru</td>
      ...
      <tr> 
        <td scope="row" align="right">MyID Lama</td>
        <td > : <input name="txtNoKPLamaSimati" type="textbox" id="txtNoKPLamaSimati" maxlength="8" size="10" value="$!noKpLamaSimati" style="width: 120px; text-transform:uppercase;" $setmode>&nbsp;&nbsp;<span class="style1"><i>(Sila kosongkan ruangan ini jika tidak berkaitan)</i></span></td>
      </tr>
      <tr> 
        <td scope="row" align="right">&nbsp;Lain-lain MyID</td>
            ...
            #set ($selected = "")
            	...
            	#set ($id = $Listkp.id)
           		#set ($keterangan = $Listkp.keterangan)
	            	<option value="$id"/>$keterangan.toUpperCase()</option>
            	#end
          </select> <input name="txtNoKPLainSimati" id="txtNoKPLainSimati" style="width:97px; text-transform:uppercase;" type="text" value="$!noKpLainSimati" maxlength="9" $setmode/>&nbsp;&nbsp;<span class="style1"><i>(Sila kosongkan ruangan ini jika tidak berkaitan)</i></span></td>
      </tr>
	  <tr> 
        <td scope="row" align="right"><font color="#ff0000">*</font>&nbsp;Nama</td>
	...
	<tr>
     ...
     <tr>
        ...
        <div align="center">
         ...
         <input type="button" name="cmdBatal" id="cmdBatal" value="Batal" onClick="getSemula('txtNoKPBaru1')">
...
#foreach ($detailPemohon in $DetailPemohon)
	...
	#set ($noKpBaru = $detailPemohon.noKpBaru)
    ...
    #set ($tarikhMohon = $detailPemohon.tarikhMohon)
...
MAKLUMAT ASAS PERMOHONAN TELAH BERJAYA DIDAFTAR.</b></td>
</tr>
<tr>
...
<!-- <input type="button" name="cmdCetak" id="cmdCetak" value="Cetak" onClick="javascript:cetakSlip('$noPemohon')"> -->
<font color="red"><b>PERHATIAN :<br/>Sila lengkapkan maklumat permohonan Tuan/Puan dengan menekan butang [Borang A] di sebelah.<br/>
Sila gunakan MyID atau No. Rujukan Online untuk mengemaskini permohonan anda.
</b></font></div>
<div align="right"><input type="button" name="cmdSeterusnya" value="Borang A" onClick="getSeterusnya()"></div>
</td>
    ...
    <input name="nopermohonan" type="hidden" value="$!noPemohon.toUpperCase()">
...
function kembali(){
	...
	//alert("no");document.${formName}.method="post";
	document.${formName}.hartaYa.value = "Tidak";
	document.${formName}.action="";
	document.${formName}.submit();
...
alert("test3");	
	...
	var maxYear = 2100;
		...
		if (document.${formName}.sorWaris[0].checked == true){
			...
			if (document.${formName}.txtNoKPBaru1.value == "" && document.${formName}.txtNoKPBaru2.value == "" && document.${formName}.txtNoKPBaru3.value == "" && document.${formName}.txtNoKPLama.value == "" && document.${formName}.txtNoKPLain.value == ""){
		...
		else if (document.${formName}.sorWaris[1].checked == true ){
		
			
			if (document.${formName}.socOB.value == "6"){
				
				
				if (document.${formName}.socARB.value == ""){
			alert("Sila pilih Amanah Raya Berhad");
			document.${formName}.socARB.focus();
		...
		input_box = confirm("Adakah anda pasti?");
			...
			else if (document.${formName}.socOB.value == "8"){
				
				
				if (document.${formName}.socBaitulmal.value == ""){
			alert("Sila pilih Baitulmal");
			document.${formName}.socBaitulmal.focus();
...
function hiddendisplay() {
	...
	if (document.${formName}.socOB.value == "6"){
	document.getElementById("nokpbaru").style.display="none";
	document.getElementById("nokplama").style.display="none";
	document.getElementById("nokplain").style.display="none";
	document.getElementById("namapemohon").style.display="none";
	document.getElementById("arb").style.display="";
	...
	document.getElementById("nokpbaru").style.display="";
	document.getElementById("nokplama").style.display="";
	document.getElementById("nokplain").style.display="";
	document.getElementById("namapemohon").style.display="";
	document.getElementById("arb").style.display="none";
	document.getElementById("baitulmal").style.display="none";	
	}
...
function hiddendisplay2(){

	if (document.${formName}.socWaris.checked == true){
	document.getElementById("nokpbaru").style.display="";
	document.getElementById("nokplama").style.display="";
	document.getElementById("nokplain").style.display="";
	document.getElementById("namapemohon").style.display="";

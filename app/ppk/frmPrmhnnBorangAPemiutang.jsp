  ...
  <tr>
    ...
    <div class="TabbedPanelsContentGroup">
           ...
           <div class="TabbedPanelsContent"></div>
            ...
            <table width="99%">
	                                 ...
	                                 #set ($checkedDropMenu="")
                                       ...
                                       #set ($jpemiutang = $listob.pemiutang)
     ...
     <tr>							   #set $jenishutang = $listob.pemiutang
                              ...
                              <tr>
                               ...
                               <tr id="adaftar">
                                ...
                                <tr id="kps">
                                  ...
                                  <tr id="aname">
                                    <td><div align="right"><span class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;Nama Agensi</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                                  ...
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36">
                                  <input name="txtNilaiHutangPenting" type="text" id="txtNilaiHutangPenting" style="text-transform:uppercase; text-align: right;" value="$!value" size="20" maxlength="10"  $readmode onKeyUp="javascript:validatePoskod(this,this.value)" onBlur="validateModal(this,this.value,this.value);"/>                                  </td>
                                </tr>     
                                 <tr>
                                ...
                                <tr>
                                  ...
                                  <td><!--<label>
                                    <input name="txtBandarPenting" type="text" id="txtBandarPenting" value="$listob.bandar" size="34" $readmode style="text-transform:uppercase;"/>
                                        ...
                                        <tr>
                                          <td class="style38" valign="top" colspan="3"><i>
                              ...
                              <tr>
                                ...
                                <tr  id="kps">
                                  ...
                                  <td class="style36" style="text-transform:uppercase;"> <select name="socJenisKPLainPenting"  style="width: 146px;" $checkedDropMenu $readmode >
                                      ...
                                      <option value="3">PASPORT</option>
	                               #end
                                    </select>&nbsp;<input name="txtNoKPLainPenting" type="text" id="textfield5" value="$!nolain" size="9" maxlength="9" style="text-transform:uppercase;" $jenishutang1 $readmode/>									 </td>
                                </tr>
                                <tr id="adaftar">
                                  <td ><div align="right"><span class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;No Pendaftaran</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  ...
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36">
                                  <input name="txtNilaiHutangPenting" type="text" id="txtNilaiHutangPenting" value="$!hutangrm" style="text-transform:uppercase;text-align: right;" size="20" maxlength="10"  $readmode  onKeyUp="javascript:validateIC(this,this.value,'txtNilaiHutangPenting')" onBlur="validateModal(this,this.value,this.value);"/>                                  </td>
                                </tr>
                                <tr>
                                  <td><div align="right"><span class="style38">No Akaun</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                          ...
                          <tr>
                            <td>  <table width="100%" border="0" align="center">
                              ...
                              <input type="reset" name="cmdBatal" id="cmdBatal" value="Batal" onClick="setSelected(0,4,0,0);cancelwaris()"/>    
                                     #else
          					  <input type="button" name="tambahpenting" id="tambahpenting3" value="$buttonpenting" onKeyPress="setSelected(0,4,0,0);tambah_penting()" onClick="setSelected(0,4,0,0);tambah_penting(); hiddendisplayupdate('$jpemiutang');"/>
                                ...
                                <tr>
                                  ...
                                  <table width="100%">
                                    <tr  class="table_header">
                                      ...
                                      <td width="13%"><div align="center">NO KP</div></td>                                      
                                    ...
                                    <td class="row1"><div align="center" class="style41">$peno</div></td>
                                      <td class="row1" style="text-transform:uppercase;">
                                       ...
                                       <div class="style42">$listpenting.nama_Ob</div>   
                                        <input type="hidden" name="idob" value="$listpenting.idOb" /></a></td>
                                      ...
                                      <td class="row1"><div align="right" >$Util.formatDecimal($listpenting.nilaihutang)</div></td>
                                   ...
                                   <td class="row2"><div align="center" class="style41">$peno</div></td>
                                      ...
                                      <td class="row2"><div align="right" >$Util.formatDecimal($listpenting.nilaihutang)</div></td>
            ...
            <!--<div class="TabbedPanelsContentVisible">try tst
             </div>
           <div class="TabbedPanelsContentVisible">try test
            </div>
            <div class="TabbedPanelsContentVisible">try test</div>-->
          </div>
        </div>
      </div>
	...
	if (document.${formName}.socJenisHutangPentingU[0].checked==false && document.${formName}.socJenisHutangPentingU[1].checked == false){
		...
		if (document.${formName}.socJenisHutangPentingU[1].checked==true){
			...
			if (document.${formName}.txtNoKPLamaPenting1.value == ""){
				alert('Sila masukkan " No Syarikat" terlebih dahulu.');

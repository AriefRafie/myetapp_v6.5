...
<div id="div_negeri_list" > 
<script>  
$jquery(document).ready(function (){  
	doDivAjaxCall$formname('div_negeri_list','showSenaraiNegeri','&div=div_negeri_list&namaList=negeri_list&skrinName=negeri');  
}); 
</script>
</div >

<div id="div_daerah_list" > 
<script>  
$jquery(document).ready(function (){  
	doDivAjaxCall$formname('div_daerah_list','showSenaraiDaerah','&div=div_daerah_list&namaList=daerah_list&skrinName=daerah');  
}); 
</script>
</div >

  ...
  <tr>
    ...
    <fieldset><legend><b>Carian</b></legend>
        <table width="100%" align="center" border="0">
         ...
         <input name="noFail3" type="hidden" id="noFail3">
         <input name="kemaskini" type="hidden" id="kemaskini" value="0">
    ...
    <td><fieldset>
        ...
        <table align="center" width="100%"> 
          ...
          <tr>
            ...
            #else
            <td class="$row"><a href="javascript:papar('$list.idPermohonanSimati','$list.idPermohonan','$list.idStatus','$list.noFail')" class="style1">$list.noFail</a></td>
            #end
...
function papar(idPermohonanSimati,idPermohonan,idStatus,noFail) {
	...
	document.${formName}.noFail3.value = noFail;
	document.${formName}.kemaskini.value = "0";
	document.${formName}.submit();
}
</script>
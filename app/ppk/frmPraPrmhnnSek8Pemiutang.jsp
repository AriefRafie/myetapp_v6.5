...
#set($md=$listtarikhMohon)
     ...
     <tr>
                              ...
                              <tr>
                               <td width="50%" valign="top"><table width="100%">
                                  ...
                                  <td width="29%" ><div align="left" class="style41 style38"><span class="style38">No KP Baru</span></div></td>
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style45" >  www.jpn.gov.my</a>
                                ...
                                <tr id="kp3">
                                  <td class="style38" ><span class="style40"></span></td>
                                  <td ><div align="left" class="style41 style38"><span class="style38">Lain-lain KP</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"> 
                              ...
                              #set($readmodekp="disabled")
                                  ...
                                  <tr id="kp4">
                                    <td class="style38"><span class="style40"></span></td>
                                    <td><div align="left" class="style41 style38"><span class="style38"> No KP Lain</span></div></td>
                                ...
                                <tr id="dob">
                                  ...
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                      <input name="txdTarikhLahirPentingU" type="text" style="text-transform:uppercase;"  id="txdTarikhLahirPentingU" size="10" maxlength="10" $readmodeR class="$readmode" value="$txdTarikhLahirPentingU" onblur="trans_date1(this.value)"/>
                                      #if($readmode != "disabled") 
...
<select name="socBandarWarisSurat" id="socBandarWarisSurat" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSuratU()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                        ...
                                        <tr>
                                          ...
                                          <td><textarea name="txtButiranHutangPentingU" cols="31"  rows="3" $readmodeR class="$readmode" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" >$txtButiranHutangPentingU</textarea></td>
                                      </tr>
                                </table>
                                </td>
                              </tr>
 ...
 <tr>
  <td><span class="style5"><span class="style2 style44 style40">Perhatian</span><span class="style44"> : Sila masukkan salah satu nombor kad pengenalan atau no syarikat pemiutang dan pastikan label bertanda <span class="style40">*</span> diisi</span>.</span></td>
                            ...
                            <table width="100%" border="0">
                              <tr>
                               ...
                               <input type="hidden" name="txtIdSimatiPenting" value="$id_Simati" >        
                                  ...
                                  <tr id="kp1">
                                    <td class="style38" ><span class="style40"></span></td>
                                    <td width="29%" ><div align="left" class="style51">No KP Baru</div></td>
                                    #if($readmode!="disabled")
                                ...
                                <tr id="kp3">
                                  <td class="style38" ><span class="style40"></span></td>
                                  <td ><div align="left" class="style51">Lain-lain KP</div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"> 
                              ...
                              #set($txtNoKPLainPenting="")
                                  ...
                                  <tr  id="kp4">
                                    <td class="style38"><span class="style40"></span></td>
                                    <td><div align="left" class="style51"> No KP Lain</div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><span class="style36">
...
if (document.f1.socJenisHutangPenting.value=="" || document.f1.socJenisHutangPenting.value=="0")
...
else if (document.f1.txtNamaOBPenting.value=="")
 {
	...
	*/
		...
		{
		alert("Sila masukkan salah satu nombor kad pengenalan pemiutang");
	 ...
	 else if ((document.f1.txtNoKPBaru1Penting.value!="" || document.f1.txtNoKPBaru2Penting.value!="" || document.f1.txtNoKPBaru3Penting.value!="") && (document.f1.txtNoKPBaru1Penting.value==""))
	 {
		...
		alert("Sila masukkan nombor kad pengenalan pemiutang sepenuhnya");
		document.f1.txtNoKPBaru1Penting.focus();
		return; 
	}

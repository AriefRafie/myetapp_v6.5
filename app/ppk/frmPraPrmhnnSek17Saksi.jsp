 ...
 #set($md=$listtarikhMohon)
                                    ...
                                    <tr>
                                     ...
                                     #set($pastcheck = "checked")   
                                      ...
                                      <td width="5%"><label>
                                        ...
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $nowcheck value="now" onclick="setSelected(0,4,0,0);SaksiView()"  />
                                        </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "now") <span class="style42">Senarai Saksi Tambahan</span>#else
                                      Senarai Saksi Tambahan
                                      #end                                      </div></td>
                                    
                                    </tr>
                                       <td width="5%"><label>
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $pastcheck value="past" onclick="setSelected(0,4,0,0);SaksiViewDulu()" />
                                         </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "past") <span class="style42">Senarai Saksi Terdahulu</span>                                      #else
                                      Senarai Saksi Terdahulu
                                      #end                                      </div></td>
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style45" >  www.jpn.gov.my</a>
                              ...
                              #set($readmodekp="disabled")
                                  ...
                                  <tr>
                                    <td valign="top" class="style38"> #if($readmode != "disabled") <span class="style40">*</span>#end</td>
                               ...
                               <tr>
                                ...
                                <table width="100%"  border="0" >
                                <tr>
                                  <td width="1%" valign="top" class="style38"> #if($readmode != "disabled") <span class="style40">*</span>#end</td>
...
<select name="socBandarWarisSurat" id="socBandarWarisSurat" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSuratU()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                        ...
                                        <tr>
                                          ...
                                          <td><textarea name="txtCatatanPentingU" cols="31"  rows="3" $readmodeR class="$readmode" id="txtCatatanPentingU"  >$txtCatatanPentingU</textarea></td>
                                      </tr>
                                      
                                       <tr id="tr_flag_daftar"  style="display:none">
                                          <td valign="top"></td>
                                          <td  valign="top">Urusan Kemasukkan Maklumat Saksi
                                          </td>
                                          <td valign="top">:</td>
                                          <td valign="top">
 ...
 <tr>
  <td><span class="style5"><span class="style2 style44 style40">Perhatian</span><span class="style44"> : Sila masukkan salah satu nombor MyID saksi dan pastikan label bertanda <span class="style40">*</span> diisi</span>.</span></td>
 ...
 <tr>
  <td><span class="style5"><span class="style2 style44 style40">Perhatian</span><span class="style44"> : Sila masukkan salah satu nombor MyID  saksi dan pastikan label bertanda <span class="style40">*</span> diisi</span>.</span> </td>
                  ...
                  <input type="hidden" name="idOb" value="" />
                            ...
                            <fieldset>
                              <legend>SENARAI SAKSI TERDAHULU</legend>
                              ...
                              <table width="100%" >
                                ...
                                <tr>
                                  ...
                                  #if($listPentingdulu.size()!=0 && $saksic!=0)
                                  <table width="100%">
                                    <tr  class="table_header">
                                      <td width="5%"><div align="center">NO</div></td>
                                      <td width="70%"><div align="left">NAMA SAKSI</div></td>
...
if (document.f1.txtNamaOBPenting.value=="")
 {
		...
		alert("Sila masukkan salah satu nombor MyID saksi");
	...
	{
		alert("Sila lengkapkan MyID Lama Saksi");
	 ...
	 else if ((document.f1.txtNoKPBaru1Penting.value!="" || document.f1.txtNoKPBaru2Penting.value!="" || document.f1.txtNoKPBaru3Penting.value!="") && (document.f1.txtNoKPBaru1Penting.value==""))
	 {
		...
		alert("Sila masukkan nombor MyID saksi sepenuhnya");
		document.f1.txtNoKPBaru1Penting.focus();
		return; 
	}
...
function SaksiViewDulu() {
	document.f1.action = "";
	document.f1.mode.value = "Saksiviewdulu";
	document.f1.command.value = "Saksi";

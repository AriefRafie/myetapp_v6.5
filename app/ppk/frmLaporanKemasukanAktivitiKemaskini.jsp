...
<input name="idCalendar" type="hidden" value="$idCalendar" />
<fieldset>
  ...
  <fieldset>
    <table border="0" align="center" width="80%" >
      ...
      <tr>
        ...
        <td>:&nbsp;</td>
        <td width="81%"><textarea name="eventText" cols="90%" rows="4" id="eventText" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();" onKeyDown="textCounter(this.form.eventText,this.form.remLen4,250);" onKeyUp="textCounter(this.form.eventText,this.form.remLen4,250);" >$txtAktiviti</textarea></td>
      </tr>
      <tr>
        <td valign="top">&nbsp;</td>
        <td valign="top">&nbsp;</td>
      ...
      <tr>
        ...
        <input name="btndelete" type="button" value="Hapus" onclick="doDelete()">
...
function doDelete(id) {
	...
	document.${formName}.idlaporanbilfail.value = document.${formName}.idCalendar.value;
...
function tambah() {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.ppk.FrmLaporanKemasukanAktiviti&action=simpanKemaskini";

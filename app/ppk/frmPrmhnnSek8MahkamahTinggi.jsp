...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
       <tr>
        <td><a href="#" class="style2" onClick="javascript:cetakSuratPindahMTII('$noFail')"><font color="blue"> Surat Pindah Mahkamah Tinggi</font></a></td>
      </tr>    
       <tr>
...
function Simpan(idpermohonan){
	...
	//doAjaxCall${formName}("getSimpanMahkamah");
...
function simpan_editMT(idpermohonan,id_perbicaraan,id_perintah){
	...
	document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 8",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanPerbicaraan";
	//doAjaxCall${formName}("simpan_editMT");
...
function kembali_skrin2TangguhEdit(idpermohonan,id_perbicaraan) {
	...
	document.${formName}.id_perbicaraan.value = id_perbicaraan;
	document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 8",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanPerbicaraan";
	//doAjaxCall${formName}("kembali_skrin2TangguhEdit");
...
function kembali_skrin2Tangguh(idpermohonan,id_perbicaraan) {
	...
	document.${formName}.id_perbicaraan.value = id_perbicaraan;
	document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 8",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanPerbicaraan";
	//doAjaxCall${formName}("kembali_skrin2Tangguh");
...
function kembali_skrin2TangguhAdd(idpermohonan,id_perbicaraan) {
	...
	document.${formName}.id_perbicaraan.value = id_perbicaraan;
	document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 8",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanPerbicaraan";
	//doAjaxCall${formName}("kembali_skrin2TangguhAdd");
	document.${formName}.command.value = "kembali_skrin2TangguhAdd";
	document.${formName}.submit();
}
function getDaerah(){
	document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 8",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanPerbicaraan";
	//doAjaxCall${formName}("getMahkamah");
	document.${formName}.command.value = "getMahkamah";
	document.${formName}.submit();
}
function getAddress(){
	document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 8",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanPerbicaraan";
	//doAjaxCall${formName}("getMahkamahAddress");
...
function skrin_kemaskiniMT(idpermohonan,id_perbicaraan,id_perintah){
	...
	document.${formName}.id_perintah.value = id_perintah;
	document.${formName}.action = "$EkptgUtil.getTabID("Seksyen 8",$portal_role)?_portal_module=ekptg.view.ppk.FrmSenaraiFailKeputusanPerbicaraan";
	//doAjaxCall${formName}("skrin_kemaskiniMT");

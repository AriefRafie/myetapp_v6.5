   ...
   <style>
...
#if($!div_getListFailBelumKemaskiniSek8_open == "Y")

	<div id="log"  style="display:none"></div>
	<div id="boxListFailBelumKemaskiniSek8" >
	...
	<input type="hidden" id="div_getListFailBelumKemaskiniSek8_open" name="div_getListFailBelumKemaskiniSek8_open" value="Y">
	...
	<td align="right" valign="top"><a href="javascript:doGetListFailBelumKemaskiniSek8()" id="trigger">
	...
	<tr  >
	<td valign="top" >
	SENARAI FAIL (BELUM KEMASKINI)
	 </td>
	</tr>
	</table>
	
	<div id="scroll_boxListFailBelumKemaskiniSek8" >
	<table border="0" width="100%" > 
	   ...
	   <tr class="table_header">
	             ...
	             <td scope="row" width="5%" align="center">BIL</td>
	              ...
	              <td width="30%">TARIKH BICARA</td>
	                           
	     
	            </tr>
	   #if($listFailBelumKemaskiniSek8.size()>0)
	 			       #set( $i = 0 )   
	           #foreach($list in $listFailBelumKemaskiniSek8)
	          ...
	          <tr>
				...
				<span id="$span1">  
	            ...
	            #if($list.NO_FAIL == '')
	            	<a href="javascript:papar('$list.id_permohonan','$list.idStatus','$list.idFail','$list.idSimati','$list.idpermohonansimati','$list.tarikhMohon','$list.jenisfail','$list.seksyen')" class="style1">TIADA NO FAIL JKPTG</a>
	            #else
	            	...
	            	#end
<!-- 	            	<a href="javascript:papar1('$list.ID_FAIL','$list.ID_URUSAN','$list.ID_SUBURUSAN','$list.ID_STATUS','$list.ID_PERMOHONAN','$list.ID_KEPUTUSANPERMOHONAN','$list.TARIKH_BICARA','$list.NO_FAIL')" style="color: blue">$list.NO_FAIL.toUpperCase() </a> -->
	            #end
	            ...
	            <td class="$row">
					...
					<span id="$span2">
		            	...
		            	$list.TARIKH_BICARA.toUpperCase()
   ...
   <script type="text/javascript">
      ...
      $jquery(document).ready(function(e) {
            ...
            top  = height+e.pageY;			
			height = 300;
			$jquery("#boxListFailBelumKemaskiniSek8").css('width', width).css('height', height).css('top', top).css('left', left);	
			$jquery("#scroll_boxListFailBelumKemaskiniSek8").css('width', width).css('height', height-55).css('top', top).css('left', left).css('overflow-y','scroll');
		...
		*/	
		...
		var boxListFailBelumKemaskiniSek8 = $jquery("#boxListFailBelumKemaskiniSek8")
		boxListFailBelumKemaskiniSek8.offset({
			left: left,
			top: top
		});		
		var drag = {
		...
		$jquery(document).mousemove(function(e) {
			...
			if (drag.state) {
				...
				//$jquery("div#boxListFailBelumKemaskiniSek8").css('top', e.pageY).css('left', e.pageX);
...
if('$!search' != "")
{
	...
	highlightEndTag = "</font>";
	  ...
	  for (x = 0; x < parseInt('$listFailBelumKemaskiniSek8.size()'); x++)
	  {
	  var span1 = "span1"+(x+1);
	  var span2 = "span2"+(x+1);	  

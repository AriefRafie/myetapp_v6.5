...
<br/>
    ...
    <br/>
     ...
     <tr class="table_header">
       ...
       <td width="8%" style="text-transform:uppercase">Seksyen</td>
     </tr>
     ...
     <tr>
       ...
       <td class="$row">
       #if ( $list.seksyen == 8 )
       <a href="javascript:paparTunggu('$list.id_fail','$list.id_permohonan','$list.id_status','$list.id_suburusan')"><font color="blue">$list.no_fail</font></a></td>
       #end
       
       #if ( $list.seksyen == 17 )
       <a href="javascript:paparTunggu17('$list.id_fail','$list.id_permohonan','$list.id_status','$list.id_suburusan')"><font color="blue">$list.no_fail</font></a></td>
       #end       
       ...
       <td class="$row"><div align="center">$list.seksyen</div></td>
     </tr>	
           #end
        #else   	
    		<tr>
...
function paparTunggu17(id_fail,id_permohonan,id_suburusan) {
	document.f1.id_fail.value = id_fail;
	document.f1.id_permohonan.value = id_permohonan;
	document.f1.id_suburusan.value = id_suburusan;
	document.f1.command.value = "paparTunggu17";
	document.f1.action = "";
	document.f1.submit();
}

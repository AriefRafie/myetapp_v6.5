...
<input type="hidden" name="txtSeksyen" value="$listseksyen" readonly="true"/>
                                    ...
                                    <tr>
                                     ...
                                     #set($pastcheck = "checked")   
                                      ...
                                      <td width="5%"><label>
                                        ...
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $nowcheck value="now" onclick="setSelected(0,6,0,0);PenghutangView()"  />
                                        </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "now") <span class="style42">Senarai Penghutang Tambahan </span>#else
                                      Senarai Penghutang Tambahan
                                      #end                                      </div></td>
                                    
                                    </tr>
                                       <td width="5%" ><label>
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $pastcheck value="past" onclick="setSelected(0,6,0,0);PenghutangViewDulu()" />
                                         </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "past") <span class="style42">Senarai Penghutang Terdahulu</span>                                      #else
                                      Senarai Penghutang Terdahulu
                                      #end                                      </div></td>
                              ...
                              <tr>
                               <td width="50%" valign="top"><table width="100%">
                                  ...
                                  <tr>
                                    ...
                                    <td width="28%" ><div align="left" class="style46 style38">#if($readmode != "disabled")Jenis Penghutang#else Jenis Penghutang #end</div></td>
                                    <td class="style36">:</td>
                                    <td class="style36">
                                  ...
                                  <tr  id="kp1">
                                    ...
                                    <td width="29%" ><div align="left" class="style46 style38">MyID Baru</div></td>
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style45" >  www.jpn.gov.my</a>
                                ...
                                <tr id="kp2">
                                  <td ><span class="style38"></span></td>
                                  <td ><div align="left" class="style46 style38">No Pendaftaran</div></td>
                                ...
                                <tr id="kp3">
                                  <td ><span class="style38"></span></td>
                                  <td ><div align="left" class="style46 style38">MyID Lain</div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"> 
                              ...
                              #set($readmodekp="disabled")
                                  ...
                                  <tr id="kp4">
                                    <td><span class="style38"></span></td>
                                    <td><div align="left" class="style46 style38"> No. MyID Lain</div></td>
                                  ...
                                  <tr>
                                    <td valign="top" ><span class="style43">#if($readmode != "disabled")*#end</span></td>
                                    <td><div align="left" class="style46 style38"> #if($readmode != "disabled") Nama Penghutang #else
                                      Nama Penghutang
                                      #end </div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                                 ...
                                 <tr id="agama">
                                   <td><span class="style38"></span></td>
                                   <td><div align="left" class="style46 style38">Agama</div></td>
                                   <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label> 
                                      #if($readmode=="disabled")
                                    ...
                                    <select name="socAgamaPentingU" id="select3" class="mediumselect" $readmode style="text-transform:uppercase;" onblur="uppercase()">
                                      ...
                                      <option value="2" style="text-transform:uppercase;" onblur="uppercase()">Bukan Islam</option>
                                         ...
                                         <tr id="warga">
                                           <td><span class="style38"></span></td>
                                           <td><div align="left" class="style46 style38">Warganegara</div></td>
                                           <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                    #if($readmode=="disabled")
                                ...
                                <tr>
                                  <td valign="top" ><span class="style43">#if($readmode != "disabled")*#end</span></td>
                                  <td><div align="left" class="style46 style38">#if($readmode != "disabled")Nilai Hutang (RM)#else Nilai Hutang #end</div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                ...
                                <tr>
                                  <td><span class="style38"></span></td>
                                  <td><div align="left" class="style46 style38">No Akaun</div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
...
<select name="socBandarWarisSurat" id="socBandarWarisSurat" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSuratU()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                        ...
                                        <tr>
                                          ...
                                          <td><textarea name="txtButiranHutangPentingU" cols="31"  rows="3"  $readmodeR class="$readmode" id="txtButiranHutangPentingU"  >$txtButiranHutangPentingU</textarea></td>
                                      </tr>
                                </table></td>
                              </tr>
                            </table>
 ...
 <tr>
  <td><span class="style5"><span class="style2 style44 style40">Perhatian</span><span class="style44"> : Sila masukkan salah satu nombor MyID atau no syarikat penghutang dan pastikan label bertanda <span class="style40">*</span> diisi</span>.</span></td>
                            ...
                            <table width="100%" border="0">
                              <tr>
                               ...
                               <input type="hidden" name="txtIdSimatiPenting" value="$id_Simati" >        
                                  ...
                                  <tr id="kp1">
                                    <td >&nbsp;</td>
                                    <td width="29%" ><div align="left" class="style41"><span class="style38">MyID Baru</span></div></td>
                                    #if($readmode!="disabled")
                              ...
                              #set($txtNoKPLainPenting="")
                                  ...
                                  <tr id="kp4">
                                    <td>&nbsp;</td>
                                    <td><div align="left" class="style41"><span class="style38"> No. MyID Lain</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><span class="style36">
...
<select name="txtBandarWarisSurat" id="txtBandarWarisSurat" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSurat()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                        ...
                                        <tr>
                                          ...
                                          <td valign="top"><div align="right" class="style38">:</div></td>
                                          <td><textarea name="txtButiranHutangPenting" cols="31"  rows="3" $readmodeR class="$readmode"  >$txtButiranHutangPenting</textarea></td>
                                      </tr>
                                </table></td>
                              </tr>
                          ...
                          <tr>
                            <td>  <table width="100%" border="0" align="center">
                              ...
                              <input type="button" name="batalpenting" id="cmdSimpan3" value="Batal" onclick="setSelected(0,3,0,0);cancelwaris()"/>                                 
                                  #else
                       #if($id_Status != "169" && $id_Status != "21" && $id_Status != "64" && $id_Status != "163" && $id_Status != "164" && $id_Status != "165")                     <!-- <input type="button" name="tambahpenting" id="tambahpenting3" value="$buttonpenting" onclick="setSelected(0,3,0,0);tambah_penting()"/>-->
                                            #end
                   ...
                   <!--    <input type="button" name="hapuspenting" id="hapuspenting" value="Hapus"  onclick="setSelected(0,3,0,0);hapus_penting()" /> -->
                       ...
                       <input type="button" name="hapuspenting" id="hapuspenting" value="Hapus"  onclick="setSelected(0,3,0,0);hapus_penting()" /> 
                                ...
                                document.getElementById('hapuspenting').style.display = "none";
                                      ...
                                      <input type="submit" name="cmdKembali3" id="cmdKembali3" value="Kembali"  onclick="setSelected(0,3,0,0);PentingViewDulu()" />
...
<!--
                  ...
                  <input type="hidden" name="idOb" value="" />
                            ...
                            <fieldset>
                            <legend>SENARAI PENGHUTANG TERDAHULU</legend>
                              ...
                              <table width="100%" >
                                ...
                                <tr>
                                  ...
                                  <table width="100%">
                                    ...
                                    #set($peno=0)
                                      #foreach($listpenting in $listPentingdulu)
...
if (document.f1.socJenisHutangPenting.value=="" || document.f1.socJenisHutangPenting.value=="0")
...
else if (document.f1.txtNamaOBPenting.value=="")
 {
	...
	*/
		...
		{
		alert("Sila masukkan salah satu nombor MyID penghutang");
	 ...
	 else if ((document.f1.txtNoKPBaru1Penting.value!="" || document.f1.txtNoKPBaru2Penting.value!="" || document.f1.txtNoKPBaru3Penting.value!="") && (document.f1.txtNoKPBaru1Penting.value==""))
	 {
		...
		alert("Sila masukkan nombor MyID penghutang sepenuhnya");
		document.f1.txtNoKPBaru1Penting.focus();
		return; 
	}
...
function PenghutangViewDulu() {
	document.f1.action = "";
	document.f1.mode.value = "Penghutangviewdulu";
	document.f1.command.value = "Penghutang";

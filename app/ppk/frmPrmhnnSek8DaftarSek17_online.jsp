...
#set($pesanan_skrin_daftar = "")

#if($ViewBaru != "")
#set($pesanan_skrin_daftar = "<blink>*</blink> <font color='black'>Sila Klik Pada Butang (3)</font> untuk Pengemaskinian dan Penambahan Maklumat Borang P.<br><blink>*</blink> Bagi Tujuan Pengemaskinian Senarai Semak, <font color='black'>Sila Klik Pada Butang (1)</font>.<br><blink>*</blink> Maklumat Asas Permohonan Telah Berjaya Disimpan, Permohonan ini telah Disimpan Diruang<br>&nbsp;&nbsp;&nbsp;<font color='black'>Deraf Permohonan PPK</font>.<br>")
#else
#set($pesanan_skrin_daftar = "<blink>*</blink> Sila Lengkapkan Ruangan Maklumat Pemohon untuk Meneruskan Permohonan.<br><blink>*</blink> Jika Pengguna adalah Pemohon atau Pihak Berkepentingan pada Permohonan Sebelum, <br>&nbsp;&nbsp;&nbsp;Sila Pilih <font color='black'>[Pemohon / Orang Berkepentingan Terdahulu]</font>.<br><blink>*</blink> Jika Pengguna adalah Pemohon Baru, Sila Pilih <font color='black'>[Pemohon Baru]</font>.")

#end

<div id="info_daftar"></div>
<script>
parent.document.getElementById("info_daftar").innerHTML="<div class=\"warning_online_ppk\"><b>$!pesanan_skrin_daftar</b></div>";
</script>
        ...
        <!-- 
         ...
         <table width="100%" border="0">
              <tr  style="display:none">
                <td width="1%">&nbsp;</td>
                <td width="29%">No Rujukan Online</td>
                <td width="1%">:</td>
                <td width="70%">
                #if($ViewBaru.size() > 0)
                #if($noFailBaru=="")
           ...
           <input name="txtNoFailBaru" id="txtNoFailBaru" type="hidden" value="$noFailBaru" style="width: 210px;" /></td>
              ...
              <tr>
                <td width="1%">&nbsp;</td>
                <td width="29%">No Fail Terdahulu</td>
                <td width="1%">:</td>
                <td width="70%">
...
<option value="$idDaerah" >$kodDaerah - $namaDaerah</option>
            ...
            <input name="txdTarikhMohon" id="txdTarikhMohon" style="width: 80px;" type="text" value="$t" size="11" maxlength="10" onBlur="trans_date(this.value)" />            <a href="javascript:displayDatePicker('txdTarikhMohon',false,'dmy');">#parse("app/ppk/ppk_calender.jsp")</a>  <span class="style7">dd/mm/yyyy </span></td>
              </tr>
...
#end
            #if ($EventStatus == "0") <a href="javascript:displayDatePicker('txdTarikhMohon',false,'dmy');">#parse("app/ppk/ppk_calender.jsp")</a>  <span class="style7">dd/mm/yyyy </span>#end 
       ...
       pemohonSimati :: $pemohonSimati
        ...
        -->  
           ...
           <input name="idpemohonsimati" type="hidden" id="idpemohonsimati" value="$!idpemohonsimati" >
            ...
            <tr>
              <td>&nbsp;</td>
              <td colspan="4"> <span class="style9">

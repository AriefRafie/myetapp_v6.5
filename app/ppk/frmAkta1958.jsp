    ...
    <tr>
      ...
      <table width="100%" border="0">
        <tr class="table_header">
           ...
           <td width="15%"><div align="center">BAHAGIAN</div></td>
           #if ($lapisan == 1) 
           <td width="15%"><div align="center">BAHAGIAN ASAL</div></td>
           #end
        </tr>
       #set ( $cnt = 0 )
	  ...
	  #set( $i = $velocityCount )
        ...
        <tr>
           ...
           <td align="center" width="15%" class="$row">$waris.getBahagian()</td>
           #if ($lapisan == 1) 
           <td align="center" width="15%" class="$row">$!waris.getBahagianTashieh()</td>
           #end
        </tr>
        #end 
      </table>

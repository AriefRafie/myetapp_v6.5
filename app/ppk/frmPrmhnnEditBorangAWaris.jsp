        ...
        <div class="TabbedPanelsContentGroup">
          ...
          <div class="TabbedPanelsContent">
            <div id="TabbedPanels3" class="TabbedPanels">
              <ul class="TabbedPanelsTabGroup">
                <li class="TabbedPanelsTab" tabindex="0">PEMOHON</li>
                <li class="TabbedPanelsTab" tabindex="0">PEGUAM</li>
              </ul>
              <div class="TabbedPanelsContentGroup">
                <div class="TabbedPanelsContent"></div>
                <div class="TabbedPanelsContent"></div>
...
<input name="chkAddPemohonWaris" type="checkbox" id="chkAddPemohonWaris" value="1" onClick="getDuplicateAddressPemohonWarisLapis()" $check4 $readmode>
              Alamat waris adalah alamat pemohon</i></span></td>
          </tr>
            <tr>
                <td class="style38" width="29%" ><div align="right" class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;Alamat Tetap</div></td>
              ...
              <tr>
				...
				<tr>
				  ...
				  &nbsp;<i>Sekiranya alamat tetap dan alamat surat menyurat adalah sama xx</i></font></td>
				</tr>
				<tr>
                <td class="style38" width="29%" ><div align="right" class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;Alamat Surat Menyurat</div></td>
                <td class="style36" width="1%"><div align="right"><span class="style38">:</span></div></td>
...
<input name="chkAddPemohonWaris" type="checkbox" id="chkAddPemohonWaris" value="1" onClick="getDuplicateAddressPemohonWarisLapis()" $check4 $readmode>
		...
		<tr>
		  <td class="style38" ><div align="right"></div></td>
		  <td><div align="right"><span class="style38">:</span></div></td>
		  <td><font class="style38"><input type="checkbox" value="1" name="chkAddWarisWaris1" onClick="javascript:getDuplicateAddressWaris1();" $readmode>&nbsp;<i>Sekiranya alamat tetap dan alamat surat menyurat adalah sama</i></font></td>
		</tr>
		<tr>
          <td class="style38" width="29%" ><div align="right" class="style38"><font class="mandatory" color="#FF0000">*</font>&nbsp;Alamat Surat Menyurat</div></td>
           <td class="style36" width="1%"><div align="right"><span class="style38">:</span></div></td>
      ...
      <div align="center">
        <table width="100%">
          <tr class="table_header">
           <td width="5%"><div align="center">NO</div></td>
           <td width="20%"><div align="center">NAMA WARIS</div></td>
            <td width="10%"><div align="center">MyID BARU</div></td>
            <td width="15%"><div align="center">TALIAN PERSAUDARAAN</div></td>

...
<input name="idPeguam" type="hidden"  />
#end
            ...
            <div class="TabbedPanelsContent">
              <div id="TabbedPanels3" class="TabbedPanelsContentVisible">
                <ul class="TabbedPanelsTabGroup">
                  ...
                  <li class="TabbedPanelsTab style1 style3" tabindex="0" onclick="setSelected(0,1,1,0);PeguamView()" id="tab_Peguam">PEGUAM</li>
      ...
      <tr>
        <td width="50%" valign="top"><table width="100%">
            <tr>
              ...
              <td width="28%"><div align="right" class="style38 style52">
            ...
            <tr>
              <td width="1%" valign="top"><span class="style44">*</span></td>
              <td class="style38"><div align="right" class="style38 style52">
                <div align="right"> 
            ...
            <tr>
              ...
              <td class="style38"><div align="left"><span class="style3"><span class="style52"><span class="style52"></span></span></span></div></td>
              <td><div align="center" class="style38">:</div></td>
              <td><label>
    ...
    <tr>
      <td width="50%" valign="top"><table width="100%">
          ...
          <tr>
            ...
            <div align="right" class="style51 style52">
        ...
        <tr>
          <td align="center"> 
            ...
            <input type="button" name="cmdKemaskin" id="cmdKemaskin" value="Simpan" onclick="setSelected(0,1,1,0);tambah_peguam()"/>
              ...
              #else
              <input type="button" name="SimpanOnline" id="cmdKemaskin" value="Simpan" onclick="setSelected(0,1,1,0);tambah_peguam()"/>              
              #end
...
<!--
            ...
            #end
            #if($!skrin_online != "yes" && $!skrin_online_17 != "yes")
            <input type="button" name="cmdKemaskini5" id="cmdKemaskini5" value="Kemaskini"  onclick="setSelected(0,1,1,0);kemaskini_peguam()"/>
            <input type="button" name="cmdHapus1" id="cmdHapus1" value="Hapus" onclick="setSelected(0,1,1,0);hapus_peguam()" />
              #if($flag_kemaskini_selesai != "yes")
                                <script>
                                document.getElementById('cmdHapus1').style.display = "none";
								document.getElementById('cmdKemaskini5').style.display = "none";
                                </script>
                                #end 
           
            #else
            <input type="button" name="SimpanOnline" id="cmdKemaskin" value="Simpan" onclick="setSelected(0,1,1,0);simpan_peguam()"/>
            <input type="button" name="button" id="button" value="Hapus" onclick="setSelected(0,1,1,0);hapus_peguam()" />
            #end
            ...
            <input type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan 4"  onclick="setSelected(0,1,1,0);simpan_peguam()"/>
            #end
...
<!--
                  <label>
                    ...
                    #if($open_button_online == "yes") 
                    <input type="button" name="cmdTambah1" id="cmdTambah1" value="Tambah" onclick="setSelected(0,1,1,0);tambah_peguam_baru()"/>
                    #if($flag_kemaskini_selesai != "yes")
                                <script>
...
function simpan_peguam() {
    ...
    if(document.f1.idPeguam.value == ""){
		alert('Sila masukkan nama firma peguam terlebih dahulu.');
  		document.f1.idPeguam.focus(); 
		return; 
	}
	...
	/*
	else if(document.f1.txtBandarPeguam.value == ""){
		alert('Sila masukkan bandar firma peguam terlebih dahulu.');
  		document.f1.txtBandarPeguam.focus(); 
		return; 
	}*/
...
if(document.f1.txtNamaFirmaPeguam2.value == ""){
	...
	/*
	else if(document.f1.txtBandarPeguam2.value == ""){
		alert('Sila masukkan bandar firma peguam terlebih dahulu.');
  		document.f1.txtBandarPeguam2.focus(); 
		return; 
	}*/
...
{
window.location.hash='tab_Peguam';
//goTo('tab_Peguam');
var nextFieldID = 'tab_Peguam';
   document.getElementById(nextFieldID).focus();
}

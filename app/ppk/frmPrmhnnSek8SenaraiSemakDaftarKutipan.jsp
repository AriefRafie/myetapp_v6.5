...
<tr>
<td >
<div align="right"><img src="../img/1current.png" alt="" border="0" title="Senarai Semak" /><img src="../img/arrowgaris.png" alt="" border="0"/>#if ($daftar== "yes")<a href="javascript:Seterusnya()" class="style6"  ><img src="../img/2enable.png" alt="" border="0" title="Pendaftaran Permohonan" /></a>#else<img src="../img/2disable.png" alt="" border="0" title="Pendaftaran Permohonan" />#end<img src="../img/arrowgaris.png" alt="" border="0"/>#if ($nofail== "yes")<a href="javascript:tab()" class="style6"  ><img src="../img/3enable2.png" alt="" border="0" title="Maklumat Permohonan" /></a>#else<img src="../img/3disable.png" alt="" border="0" title="Maklumat Permohonan" />#end</div>

<!--
<div align="right"><img src="../img/senarai_semak_current.png" alt="" border="0" title="Senarai Semak"/><img src="../img/arrow_pendaftaran.png" alt="" border="0"/>#if($daftar== "yes")<a href="javascript:Seterusnya()" class="style6"  ><img src="../img/pendaftaran_per_available.png" alt="" border="0" title="Pendaftaran Permohonan" /></a>#else<img src="../img/pendaftaran_per_disable.png" alt="" border="0" title="Pendaftaran Permohonan" />#end<img src="../img/arrow_pendaftaran.png" alt="" border="0"/>#if ($nofail== "yes")<a href="javascript:tab()" class="style6"  ><img src="../img/maklumat_permohonan_available.png" alt="" border="0" title="Maklumat Permohonan"/></a>#else<img src="../img/maklumat_permohonan_disable.png" alt="" border="0" title="Maklumat Permohonan" />#end</div>
-->
</td>
</tr>
</table>
...
<p>#foreach($ls in $ListSemakanSimati)
...
<!--
<p> #if($chkmode != "disabled") </p>
<table width="100%">
  <tr>
    <td class="style5 style3"><em><span class="style2">Perhatian</span> : Sila  pastikan label bertanda <span class="style2">*</span> diisi. Bayaran permohonan adalah <span class="style2">wajib</span> jika pemohonan telah dibuat sebelum 01/09/2009.</em></td>
  </tr>
</table>
#end
-->
...
*/
	 if (document.f1.cbsemakradio[0].checked == true && document.f1.txtNomborSijil.value == ""){
	...
	/*
	else if (document.f1.lepassatusept.value == "no" && document.f1.cbsemaks[8].checked == false ){
	...
	else if (document.f1.cbsemaks[8].checked == true  && dm.value != "" && isDate(dm.value)==false){
		dm.focus()
		return false
	}
	...
	*/
	else if (document.f1.cbsemaks[8].checked == true  && ( date1 > currentTime )){

...
<body onload="submitForm();check_umur_saksi()" >
...
<input type="hidden" name="socJenisHutangPentingU" id="socJenisHutangPentingU" value="2"/>
<input type="hidden" name="socJenisHutangPenting" id="socJenisHutangPenting" value="2"/>
...
#set($md=$listtarikhMohon)
    ...
    <div class="TabbedPanelsContentGroup">
        ...
        <div id="TabbedPanels2" class="TabbedPanelsContentVisible">
          <ul class="TabbedPanelsTabGroup">
            ...
            <li class="TabbedPanelsTab style1 style3" tabindex="0" onclick="setSelected(0,4,0,0);SaksiView()" id="maklumat_pemohon"  >SAKSI</li>
                              ...
                              <tr>
                               <td width="50%" valign="top"><table width="100%">
                                  ...
                                  <td width="70%" class="style36"><label>
                                     ...
                                     <input name="txtNoKPBaru1PentingU" type="text" id="txtNoKPBaru1PentingU" style="width: 50px;" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2PentingU')" value="$txtNoKPBaru1PentingU" size="7" maxlength="6" $readmodeR class="$readmode" onBlur="getAgeByIC(this,this.value,'txtUmurPentingU');getDOBU(this.value);" />
                                     - 
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style45" >  www.jpn.gov.my</a>
                                ...
                                <tr>
                                  <td class="style38" >&nbsp;</td>
                                  <td ><div align="left" class="style41"><span class="style38">No KP Lama</span></div></td>
                              ...
                              #set($readmodekp="disabled")
                                  ...
                                  <tr>
                                    <td valign="top" class="style38"> #if($readmode != "disabled")
                                    <span class="style40">*</span>#end</td>
                                    <td><div align="left" class="style41"><span class="style38"> #if($readmode != "disabled") Nama Saksi #else
                                      Nama Saksi
                                    #end </span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                                 ...
                                 <input type="hidden" name="socTarafKepentinganPenting" id="socTarafKepentinganPenting" value="$socTarafKepentinganPentingU" />
                                   <!--
                                   <tr>
                               ...
                               <tr>
                                 <td class="style38">&nbsp;</td>
                                  ...
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                      <input name="txdTarikhLahirPentingU" type="text" style="text-transform:uppercase;"  id="txdTarikhLahirPentingU" size="10" maxlength="10" $readmodeR class="$readmode" value="$txdTarikhLahirPentingU" onblur="trans_date1(this.value);getAgebyDob(this,this.value,'txtUmurPentingU');check_umur_saksi()"/>
                                      #if($readmode != "disabled") 
                               ...
                               <tr>
                                 <td valign="top" class="style38"> #if($readmode != "disabled")
                                  ...
                                  <td><span class="style36">
                                    ...
                                    <input name="txtUmurPentingU" type="text" id="txtUmurPentingU"  value="$txtUmurPentingU" size="3" maxlength="3" $readmodeR class="$readmode" style="text-transform:uppercase;" onblur="CheckumurU();check_umur_saksi()"  onkeyup="javascript:validateIC(event,this,this.value,'txtUmurPentingU')"/>
                                    
                                  </span>
                                   <span id="umur_saksi" style="color:red" ></span>
                               ...
                               -->
                                ...
                                <input name="txtNoSuratBeranakPentingU" type="hidden" id="txtNoSuratBeranakPentingU" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" value="$txtNoSuratBeranakPentingU" size="15" maxlength="10" $readmodeR class="$readmode" />
                                  
                                </table></td>
                                <td width="50%" valign="top">
                                <table width="100%"  border="0" >
                                <tr>
                                 <td width="1%" valign="top" class="style38"> #if($readmode != "disabled")
                                    <span class="style40">*</span>#end</td>
...
<select name="socNegeriPentingU" id="socNegeriPentingU" class="autoselect" $readmode style="text-transform:uppercase;" onblur="uppercase()" onchange="getBandarTetapU('socBandarPentingU')">
  ...
  <option value="$listnegpomo.id_Negeri" style="text-transform:uppercase;" onblur="uppercase()">$listnegpomo.kod_Negeri - $listnegpomo.nama_Negeri</option>
                                  ...
                                  <tr>
                                   <td valign="top" class="style38"> #if($readmode != "disabled")#end</td>
                                    <td class="style38"><div align="right" class="style51">
                                  ...
                                  <tr>
                                   <td valign="top" class="style38"> #if($readmode != "disabled")
                                    ...
                                    <td width="29%" class="style38" ><div align="right" class="style51">
                                      <div align="left">#if($readmode != "disabled") Alamat Surat Menyurat #else <span class="style72">Alamat Surat Menyurat </span>#end</div>
                                    </div></td>
...
<select name="socBandarWarisSurat" id="socBandarWarisSurat" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSuratU()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                        ...
                                        <tr>
                                          ...
                                          <td><textarea name="txtCatatanPentingU" cols="31"  rows="3" $readmodeR class="$readmode" id="txtCatatanPentingU" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" >$txtCatatanPentingU</textarea></td>
                                      </tr>
                                </table>
 ...
 <tr>
  <td><span class="style5"><span class="style2 style44 style40">Perhatian</span><span class="style44"> : Sila masukkan salah satu nombor kad pengenalan saksi dan pastikan label bertanda <span class="style40">*</span> diisi</span>.</span></td>
                            ...
                            <table width="100%" border="0">
                              <tr>
                               ...
                               <input type="hidden" name="txtIdSimatiPenting" value="$id_Simati" >        
                                  <tr>
                                    <td width="1%" class="style38 style40" >&nbsp;</td>
                                  <td width="28%" ><div align="right" class="style41">
                                    <div align="left"><span class="style38">No KP Baru</span></div>
                                  </div></td>
                                  <td width="1%" class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td width="70%" class="style36"><label>
                                   
                                     <input name="txtNoKPBaru1Penting" id="txtNoKPBaru1Penting" style="width: 50px;" type="text" $readmode size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2Penting')" onBlur="getAgeByIC(this,this.value,'txtUmurPenting');getDOB(this.value);check_umur_saksi()" value="$txtNoKPBaru1Penting" />
                                     - 
                                ...
                                <tr>
                                  ...
                                  <td ><div align="right" class="style41">
                                    <div align="left"><span class="style38">No KP Lama</span></div>
                                  </div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                    <input name="txtNoKPLamaPenting" type="text" id="textfield4" size="15" maxlength="9" $readmode style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" value="$txtNoKPLamaPenting"/>
                                  </label></td>
                                </tr>
                                <tr>
                                  <td class="style38 style40" >&nbsp;</td>
                              ...
                              #set($readmodekp="disabled")
                                  ...
                                  <tr>
                                    ...
                                    <td><div align="right" class="style41">
                                      <div align="left"><span class="style38">Nama Saksi</span></div>
                                    </div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                     ...
                     <input type="hidden" name="socTarafKepentinganPenting" id="socTarafKepentinganPenting" value="14" />
                                ...
                                <tr>
                                  ...
                                  <td><div align="right"><span class="style38">:</span></div></td>
                                  <td>
                                  <input name="txdTarikhLahirPenting" type="text" id="txdTarikhLahirPenting" size="10" maxlength="10" $readmode  onblur="trans_date(this.value);getAgebyDob(this,this.value,'txtUmurPenting');check_umur_saksi()" value="$txdTarikhLahirPenting" />
                                ...
                                <tr>
                                  ...
                                  <td><div align="right" class="style41">
                                    <div align="left"><span class="style38">Umur</span></div>
                                  </div></td>
                                  <td><div align="right"><span class="style38">:</span></div></td>
                                  <td><span class="style36">
                                    <input name="txtUmurPenting" type="text" id="txtUmurPenting"  size="3" maxlength="3" $readmode style="text-transform:uppercase;" onblur="Checkumur();check_umur_saksi()" onKeyUp="javascript:validateIC(event,this,this.value,'txtUmurPenting')"  value="$txtUmurPenting"/>
                                  </span>
                                   <span id="umur_saksi" style="color:red" ></span>
                                  </td>
                                </tr>
                                ...
                                -->
                                 <input name="txtNoSuratBeranakPenting" type="hidden" id="txtNoSuratBeranakPenting" size="15" maxlength="10" $readmode style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" value="$txtNoSuratBeranakPenting" />
                                  
                                </table></td>
                                <td width="50%" valign="top"><table width="100%" border="0">
                                  <tr>
                                    <td width="1%" valign="top" class="style38"><span class="style40">*</span></td>
                                  ...
                                  <tr>
                                    <td class="style38">&nbsp;</td>
                                    <td class="style38"><div align="left"><span class="style7"><span class="style41"></span></span></div></td>
                                    <td><div align="right" class="style38">:</div></td>
                                    <td><label>
                                ...
                                <select name="socNegeriPenting" class="autoselect" $readmode style="text-transform:uppercase;" onblur="uppercase()" onchange="getBandarTetap('txtBandarPenting')">
                                  ...
                                  #foreach($listnegpomo in $listnegeri)
                                    ...
                                    #end </tr>
                                  <tr>
                                    <td valign="top" class="style38">&nbsp;</td>
                                    <td class="style38"><div align="right" class="style51">
...
<select name="txtBandarWarisSurat" id="txtBandarWarisSurat" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSurat()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                        ...
                                        <tr>
                                          ...
                                          <td valign="top"><div align="right" class="style38">:</div></td>
                                          <td><textarea name="txtCatatanPenting" cols="31"  rows="3"  $readmode style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" >$txtCatatanPenting</textarea></td>
                                      </tr>
                                </table></td>
                              </tr>
                            ...
                            <td>  <table width="100%" border="0" align="center">
                              ...
                              <input type="button" name="batalpenting" id="cmdSimpan3" value="Batal" onclick="setSelected(0,3,0,0);cancelwaris()"/>                                 
                                  ...
                                  <input type="button" name="hapuspenting" id="hapuspenting" value="Hapus"  onclick="setSelected(0,3,0,0);hapus_penting()" />
                                    ...
                                    <input type="submit" name="cmdKembali3" id="cmdKembali3" value="Kembali"  onclick="setSelected(0,3,0,0);SaksiView()" />
                                ...
                                <tr>
                                  ...
                                  <table width="100%">
                                    <tr  class="table_header">
                                      ...
                                      <td width="70%"><div align="left">NAMA SAKSI</div></td>
                                  ...
                                  <table width="100%">
                                    <tr  class="table_header">
                                      <td width="5%"><div align="center">NO</div></td>
                                      <td width="70%"><div align="center">NAMA OB</div></td>
                                      <td width="25%"><div align="center">NO KP BARU</div></td>
                                    </tr>
                                   </table> 
...
if (document.f1.txtNamaOBPenting.value=="")
 {
		alert("Sila masukkan nama saksi");
		...
		alert("Sila masukkan salah satu nombor kad pengenalan saksi");
		document.f1.txtNoKPBaru1Penting.focus();
		
		}
		
		else if(document.f1.txtNoKPLamaPenting.value != "" && document.f1.txtNoKPLamaPenting.value.length<7)
	{
		alert("Sila lengkapkan No KP Lama Saksi");
	 ...
	 else if ((document.f1.txtNoKPBaru1Penting.value!="" || document.f1.txtNoKPBaru2Penting.value!="" || document.f1.txtNoKPBaru3Penting.value!="") && (document.f1.txtNoKPBaru1Penting.value==""))
	 {
		...
		alert("Sila masukkan nombor kad pengenalan saksi sepenuhnya");
		document.f1.txtNoKPBaru1Penting.focus();
		return; 
	}
...
/*
	...
	*/
	...
	{
	alert("Sila lengkapkan alamat tetap saksi");
	...
	{
	alert("Sila lengkapkan alamat surat menyurat saksi");
   ...
   {
      alert("Sila pastikan tarikh lahir saksi tidak melebihi dari tarikh mohon.");
	 
      document.f1.txdTarikhLahirPenting.focus();
   } 
   
   else if(document.f1.txtUmurPenting.value == "" )
   {
      alert("Sila pastikan umur saksi diisi.");
	 
      document.f1.txtUmurPenting.focus();
   } 
   
    else if(document.f1.txtUmurPenting.value != "" && document.f1.txtUmurPenting.value < 18 )
   {
      alert("Sila pastikan umur saksi adalah 18 tahun dan keatas.");	 
      document.f1.txtUmurPenting.focus();
   } 
...
if (document.f1.txtNamaOBPentingU.value=="")
 {
		...
		else if(document.f1.txtNoKPLamaPentingU.value != "" && document.f1.txtNoKPLamaPentingU.value.length<7)
	{
		alert("Sila lengkapkan No KP Lama Saksi");
...
/*
   ...
   {
      alert("Sila pastikan tarikh lahir saksitidak melebihi dari tarikh mohon.");	 
      document.f1.txdTarikhLahirPentingU.focus();
   } 
	...
	else if(document.f1.txtUmurPentingU.value == "" )
   {
      alert("Sila pastikan umur saksi diisi.");
	 
      document.f1.txtUmurPentingU.focus();
   } 
   
    else if(document.f1.txtUmurPentingU.value != "" && document.f1.txtUmurPentingU.value < 18 )
   {
      alert("Sila pastikan umur saksi adalah 18 tahun dan keatas.");	 
      document.f1.txtUmurPentingU.focus();
   } 
...
function CheckumurU() 
{
	if (document.f1.txtUmurPentingU.value != "" && document.f1.txtUmurPentingU.value>100) {
		alert("Adakah anda pasti saksi berumur "+document.f1.txtUmurPentingU.value+" tahun?");
...
function Checkumur() 
{
	if (document.f1.txtUmurPenting.value != "" && document.f1.txtUmurPenting.value>100) {
		alert("Adakah anda pasti saksi berumur "+document.f1.txtUmurPenting.value+" tahun?");
...
function check_umur_saksi()
{


url = "../servlet/ekptg.view.ppk.PendaftaranCheck";
	actionName = "check_umur_saksi";
	target = "umur_saksi";

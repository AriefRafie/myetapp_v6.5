...
<input name="idtemp" type="hidden"  value="$id"/>
  ...
  <tr>
    ...
    <ul class="TabbedPanelsTabGroup">
	  ...
	  #else	  
	  <li class="TabbedPanelsTab" onClick="goalert('0','0','0','0')" tabindex="0">HARTA TAK ALIH</li>
      <li class="TabbedPanelsTab" onClick="goalert('0','0','0','0')" tabindex="0" >HARTA ALIH</li>
	  #end
	      #set ($hidden = "")
	      #if ($hidden == "0")
    ...
    <div class="TabbedPanelsContentGroup">
        ...
        <div id="TabbedPanels2" class="TabbedPanelsContentVisible">
          <ul class="TabbedPanelsTabGroup">
            ...
            #else          	
            <li class="TabbedPanelsTab" onClick="goalert('0','0','0','0')" tabindex="0">WARIS</li>
            <li class="TabbedPanelsTab" onClick="goalert('0','0','0','0')" tabindex="0">ORANG BERKEPENTINGAN</li>
      		  #if ($hidden == "0")

	      		<li class="TabbedPanelsTab" onClick="SaksiView('0','4','0','0')" tabindex="0">SAKSI</li>
              #end                
              <li class="TabbedPanelsTab" onClick="goalert('0','0','0','0')" tabindex="0">PEMIUTANG</li>
            <li class="TabbedPanelsTab" onClick="goalert('0','0','0','0')" tabindex="0">PENGHUTANG</li>
          #end
          </ul>
          <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                ...
                <tr>
                            ...
                            <table width="100%" border="0">
                              ...
                              <tr>
                                ...
                                <td><input name="txdTarikhMati" type="text" id="txdTarikhMati" value="$!tarikhmati" size="10" maxlength="10" $setmode onBlur="javascript:trans_date(this.value);" onFocus="qryHowOld();" onKeyUp="qryHowOld(); javascript:validatePoskod(this,this.value);" onKeyDown="javascript:validatePoskod(this,this.value);" $readonly/>
								  ...
								  #end
								   <span class="style52 style2"><em>format : dd/mm/yyyy</em></span>                                   </td>
                              </tr>
                               <tr>
                              ...
                              <tr>
                                ...
                                <td ><input name="socWaktuKematianSimati" type="text" id="textfield" value="$!waktumati" size="4" maxlength="4" onKeyUp="javascript:validatePoskod(this,this.value)" $setmode onBlur="validTarikhMati()" $readonly/> <span class="style52 style2"><em>format : 24 jam (HHMM)</em></span>                                </td>
                              </tr>
                          </table></td>
                        <td valign="top">
                        <table width="100%">
                  ...
                  <option value="0" >SILA PILIH</option>
                   ...
                   <option value="$listBandar.idbandarnegeri"> $!listBandar.nama</option>
                    ...
                    <tr>
                    <td width="3%"><i>*</i></td>
                    <td width="97%"><i>Sila pastikan salah satu MyID diisi.</i></td>
                    </tr>
                    <tr>
                    <td><i>*</i></td>
                    ...
                    <!--<tr>
                    <td><i>*</i></td>
                    <td><i>Sila pastikan maklumat SIMATI, PEMOHON 
                 ...
                 <tr>
                    ...
                    <td align="center"> #if ($idstatus == "150" || $idstatus == "171") 
                    	#if ($SimpanStatus == 1) 
...
<!-- SIMATI -->
function kemaskini_simati(tabIdatas,tabIdtengah,tabIdbawah,tabIdtepi){
	document.${formName}.method="post";
...
function BatalSimati(tabIdatas,tabIdtengah,tabIdbawah,tabIdtepi) {
input_box = confirm("Adakah anda pasti?");
	if (input_box == true) {
		document.${formName}.method="post";
...
function getBandar(tabIdatas,tabIdtengah,tabIdbawah,tabIdtepi) {
		document.${formName}.method="post";

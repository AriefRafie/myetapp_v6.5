...
<input type="text" id="hiddenModulBIL$lg.BIL" name="hiddenModulBIL$lg.BIL" value="$lg.BIL">
<input type="text" id="hiddenModulMODULE_GROUP$lg.BIL" name="hiddenModulMODULE_GROUP$lg.BIL" value="$lg.MODULE_GROUP">
<input type="text" id="hiddenModulMODULE_GROUP_ASAL$lg.BIL" name="hiddenModulMODULE_GROUP_ASAL$lg.BIL" value="$lg.MODULE_GROUP_ASAL">

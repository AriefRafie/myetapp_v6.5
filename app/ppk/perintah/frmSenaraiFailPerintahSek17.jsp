    ...
    <td><fieldset>
		...
		#set ( $bil1 = 0 )			
          ...
          <tr>
            ...
            #else
            <td class="$row"><a href="javascript:papar('$list.idPermohonanSimati','$list.idPermohonan','$list.idStatus','$list.idFail')" class="style1">$list.noFail</a></td>
            #end
...
function test() {
	...
	function papar(idPermohonanSimati,idPermohonan,idStatus,idFail) {
	...
	function cetakBorangE(idFail) {
		var url = "../servlet/ekptg.report.ppk.BorangT1Integrasi?idfail="+idFail;

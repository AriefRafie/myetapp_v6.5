...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td align="right">
			Papar
			<select class="smallselect" name="itemsPerPage" onchange="javascript:doAjaxCall${formname}('carianUtama','action=doChangeItemPerPage')">
		   		...
		   		<tr>
			   		<td>
						...
						#foreach ( $i in [$paging..$totalPages] )
							...
							#end
							#if ( $x <= 11 )
								<td><a href="javascript:doAjaxCall${formname}('carianUtama','action=getPage&value=$i')"><div class=$visited>$i</div></a></td>
							#end
						#end
					#end	
					<td>

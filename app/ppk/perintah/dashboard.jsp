...
<a href="javascript:gotoFLMS()" class="help" title="MAKLUMBALAS LOG (STATUS ADUAN, KOMEN-KOMEN ADUAN, TINDAKAN)">
                            <font color="blue">
                            <li>          
...
function gotoProfile() {
	document.${formName}.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.admin.UserProfileInternal";
	document.${formName}.submit();
}

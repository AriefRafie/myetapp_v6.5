    ...
    <td><fieldset>
        ...
        <table align="center" width="100%"> 
          ...
          <tr>
            ...
            #else
            <td class="$row"><a href="javascript:papar('$list.idPermohonanSimati','$list.idPermohonan','$list.idStatus','$list.idFail','$list.noFail','$list.idSimati')" class="style1">$list.noFail</a></td>
            #end
...
//function papar(idPermohonanSimati,idPermohonan,idStatus) {
	function papar(idPermohonanSimati,idPermohonan,idStatus,idFail,noFail,idSimati) {
	...
	//var idFail = 0;
		cetakBorangE(idFail,noFail,idSimati);			
	
	}

function cetakBorangE(idFail,noFail,idSimati) {
	var url = "../servlet/ekptg.report.ppk.BorangEIntegrasi?ID_FAIL="+idFail+"&noFail="+noFail+"&idSimati="+idSimati;
	//var url = "../reports/ppk/BorangE2_Test.pdf";

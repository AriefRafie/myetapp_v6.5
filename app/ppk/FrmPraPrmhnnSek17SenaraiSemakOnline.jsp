...
<div align="right"><img src="../img/1current.png" alt="" border="0" title="Senarai Semak"/><img src="../img/arrowgaris.png" alt="" border="0"/>#if($daftar=="yes")<a href="javascript:Seterusnya()" class="style3" ><img src="../img/2enable.png" alt="" border="0" title="Pendaftaran Permohonan"/></a>#else<img src="../img/2disable.png" alt="" border="0" title="Pendaftaran Permohonan"/>#end<img src="../img/arrowgaris.png" alt="" border="0"/>#if($dah_daftar_ke == "sudah")<a href="javascript:tab()" class="style3"><img src="../img/3enable2.png" alt="" border="0" title="Maklumat Permohonan" /></a>#else<img src="../img/3disable.png" alt="" border="0" title="Maklumat Permohonan" />#end</div>
...
<td width="70%">
  ...
  Bil Fail Keseluruhan : <span class="style3">$!nofaildunia</span></div></td>
</tr>
</table>
  ...
  <tr>
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="59%"><span class="style5">$no_online</span></td>
      </tr>
    </table></td>
  </tr>
</table>
...
<form name="f1" method="post" action="" >
 ...
 #foreach($View in $ViewLamaSub)
        #set ($no_subjaket = $View.no_subjaket)
         #set ($idpermohonandulu = $View.idPermohonanLama)
...
<input name="no_subjaket" type="hidden" value="$no_subjaket" />
 ...
 <input type="hidden" name="form_token" value='$!{session.getAttribute("form_token")}'>
  ...
  #set($idpermohonan_baru = $List1.idPermohonan)
  #set($IdPermohonan = $List1.idPermohonan)
 ...
 <input name="idtempTerdahulu" type="hidden" value="$idpermohonandulu" />
...
<input name="lt" type="hidden" value="$lt" />
  ...
  #foreach($List1 in $listb)
  #set($lepassatusept = $List1.lepassatusept )
  #set($idpermohonan_baru = $List1.id_permohonan)
...
#if ($SimpanStatus != "2") <a href="javascript:displayDatePicker('txdTarikhByrn',false,'dmy');" ><img border="0" src="../img/calendar.gif"/></a> <span class="style7">dd/mm/yyyy</span>#end </label></td>
            </tr>
...
function DoTheCheck() {
	...
	*/
	...
	else if (document.f1.cbsemaks[9].checked == false && document.f1.cbsemaks[11].checked == false && document.f1.cbsemaks[12].checked == false && document.f1.cbsemaks[14].checked == false && document.f1.cbsemaks[15].checked == false && document.f1.cbsemaks[16].checked == false ) {
...
function Kembali(){
	...
	document.f1.action = "?_portal_module=FrmPrmhnnSek8Online17";
	document.f1.submit();
}

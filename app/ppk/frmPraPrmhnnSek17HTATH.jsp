...
<legend><strong>Senarai Laporan</strong></legend>
  ...
  <tr bgcolor="white">
    ...
    #end
    <td class="row1"><div align="left" class="style54" style="text-transform:uppercase;" onblur="uppercase()">$nama_daerah</div></td>
    #if($listam.mukim=="")
    ...
    #end
    <td class="row1"><div align="left" class="style54" style="text-transform:uppercase;" onblur="uppercase()">$nama_mukim</div></td>
    <!--

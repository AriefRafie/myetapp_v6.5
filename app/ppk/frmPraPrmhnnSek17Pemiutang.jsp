...
#set($md=$listtarikhMohon)
                                    ...
                                    <tr>
                                     ...
                                     #set($pastcheck = "checked")   
                                      ...
                                      <td width="5%"><label>
                                        ...
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $nowcheck value="now" onclick="setSelected(0,5,0,0);PemiutangView()"  />
                                        </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "now") <span class="style42">Senarai Pemiutang Tambahan </span>#else
                                      Senarai Pemiutang Tambahan
                                      #end                                      </div></td>
                                    
                                    </tr>
                                       <td width="5%" ><label>
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $pastcheck value="past" onclick="setSelected(0,5,0,0);PemiutangViewDulu()" />
                                         </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "past") <span class="style42">Senarai Pemiutang Terdahulu</span>                                      #else
                                      Senarai Pemiutang Terdahulu
                                      #end                                      </div></td>
     ...
     <tr>
                              ...
                              <tr>
                               <td width="50%" valign="top"><table width="100%">
                                  ...
                                  <tr>
                                    <td valign="top" class="style38" width="1%"  ><span class="style40">#if($readmode != "disabled")*</span>#end</td>
                                  ...
                                  <tr id="kp1">
                                    ...
                                    <td width="29%" ><div align="left" class="style41 style38"><span class="style38">MyID Baru</span></div></td>
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style45" >  www.jpn.gov.my</a>
                              ...
                              #set($readmodekp="disabled")
                                  ...
                                  <tr id="kp4">
                                    <td class="style38"><span class="style40"></span></td>
                                    <td><div align="left" class="style41 style38"><span class="style38"> No. MyID Lain</span></div></td>
...
<select name="socBandarWarisSurat" id="socBandarWarisSurat" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSuratU()" >
  ...
  <td><span class="style5"><span class="style2 style44 style40">Perhatian</span><span class="style44"> : Sila masukkan salah satu nombor MyID atau no syarikat pemiutang dan pastikan label bertanda <span class="style40">*</span> diisi</span>.</span></td>
                            ...
                            <table width="100%" border="0">
 ...
 #if($!skrin_online != "yes" && $!skrin_online_17 != "yes")
                                     <a href="http://www.jpn.gov.my" target="_blank" class="style45" > www.jpn.gov.my</a> #end</label></td>
                                </tr>
                                <tr id="kp2">
                                  <td class="style38" ><span class="style40"></span></td>
                              ...
                              #set($txtNoKPLainPenting="")
                                  ...
                                  <tr id="kp4">
                                    <td class="style38"><span class="style40"></span></td>
                                    <td><div align="left" class="style51"> No. MyID Lain</div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><span class="style36">
                       ...
                       <input type="button" name="hapuspenting" id="hapuspenting" value="Hapus"  onclick="setSelected(0,3,0,0);hapus_penting()" /> 
                                ...
                                document.getElementById('hapuspenting').style.display = "none";
                                  ...
                                  <input type="button" name="tambahpenting" id="tambahpenting2" value="Simpan" onclick="setSelected(0,3,0,0);tambah_simpan_penting()"/>	
                                   ...
                                   #if($boleh_kemaskini == "yes")<input type="button" name="tambahpenting" id="tambahpenting3" value="Simpan" onclick="setSelected(0,3,0,0);tambah_penting()"/>
                                   #end  
...
<!--
                            ...
                            #if($nowpast == "past")
                            <fieldset>
                            <legend>SENARAI PEMIUTANG TERDAHULU</legend>
...
function PemiutangViewDulu() {
	document.f1.action = "";
	document.f1.mode.value = "Pemiutangviewdulu";
	document.f1.command.value = "Pemiutang";

...
.style6 {font-size: 10px; color: #FF0000; }
...
#set($setMode = "") 
  ...
  <tr>
    ...
    <table width="100%" border="0">
      ...
      <td valign="top" colspan="2"  align="justify"><div id="alert_field"></div></td>
...
<input type="hidden" name="checkJ1" id="checkJ1" value="$checkJ1"  />
        ...
        <td width="1%">&nbsp;</td>
        <td width="4%" ><label   >
          <div align="right" id="kv1" style="display:none">
  ...
  <tr>
    ...
    <table width="100%">
      <tr>
        <td width="1%"  valign="top" class="style6 style5 style3" >#if($setMode != "disabled")*#end</td>
        <td width="28%"><div align="right" class="style8 style5 style8">
      ...
      <tr>
        <td width="1%"  valign="top" class="style6 style5 style3" >#if($setMode != "disabled")*#end</td>
        <td><div align="right" class="style8 style5 style8">
  ...
  #set($socNegeriWarisSurat = "")
      ...
      <tr>
                                   <td valign="top" class="style38 style6 style5"> #if($setMode != "disabled")
                                    ...
                                    <td class="style38"><div align="right" class="style51 style6 style8">
...
#else
<select name="socNegeriWarisSurat" class="autoselect" onChange="setTableA_JENISB_NEG('tableReportA',2,'txtNilaianHTA','tempatmohonawal')" $readmode >
  ...
  <option value="$listneg.id_Negeri" style="text-transform:uppercase;" onBlur="uppercase()">$listneg.kod_Negeri - $listneg.nama_Negeri</option>
      ...
      <tr>
        <td width="1%"  valign="top" class="style6 style5 style3" >#if($setMode != "disabled")*#end</td>
        <td><div align="right" class="style8 style5 style8">
            <div align="left">#if($setMode != "disabled") Tempat Permohonan Awal #else
  ...
  <tr>
    ...
    <table width="100%" id="bukan_alamatkaveat" style="display:">
      <tr>
        ...
        <td width="29%"><div align="right" class="style6 style5 style8">
      ...
      <tr>
        ...
        <td><div align="left"><span class="style6"><span class="style5"><span class="style8"></span></span></span></div></td>
        <td>:</td>
      ...
      <tr>
       ...
       $al_tel
        ...
        <td><span class="style5"></span></td>
        <td><div align="right" class="style6 style5 style8">
            <div align="left">Salinan Arahan/Akuan telah diterima</div>
        </div></td>
        <td>:</td>
  ...
  <table width="100%">
             <tr>
  <td width="1%" valign="top" class="style6" ><span>#if($setMode != "disabled")* #end</span></td>
                <td width="28%"><div align="right" class="style53 style6 style6 style8">
            ...
            <tr>
               <td width="1%" valign="top" class="style6" ><span >#if($setMode != "disabled")* #end</span></td>
              <td><div align="right" class="style53 style6 style6 style8">
                <div align="left">No. Kaveat</div>
              </div></td>
              <td><div align="center" class="style38">:</div></td>
              <td><label>
                <input name="txtNoKaveat" type="text" id="txtNoKaveat" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase()" size="34" $setModeR class="$setMode" value="$txtNoKaveat" maxlength="14" />
              </label></td>
            </tr>
            <tr>
              <td width="1%" valign="top" class="style6" ><span >#if($setMode != "disabled")* #end</span></td>
            ...
            <tr>
                <td width="1%" valign="top" class="style6" ><span >#if($setMode != "disabled")* #end</span></td>
              <td class="style38"><div align="right" class="style53 style6 style6 style8">
            ...
            <tr>
                <td width="1%" valign="top" class="style6">&nbsp;</td>
              <td class="style38"><div align="left"><span class="style3"><span class="style52"><span class="style6"><span class="style6"><span class="style8"></span></span></span></span></span></div></td>
              <td><div align="center" class="style38">:</div></td>
              <td><label>
            ...
            <tr>
              <td width="1%" valign="top" class="style6" ><span>#if($setMode != "disabled")* #end</span></td>
            <td width="28%" class="style38"><div align="right" class="style51 style52 style6 style8">
          ...
          <tr>
             <td width="1%" valign="top" class="style6" >&nbsp;</td>
            <td class="style38"><div align="right" class="style51 style52 style6 style8">
            ...
            <tr>
               <td width="1%" valign="top" class="style6">&nbsp;</td>
              <td><div align="right" class="style51 style52 style6 style6 style8">
        ...
        <input type="hidden" name="jenis_pej_id" id="jenis_pej_id" value="$jenis_pej_id" />        
	...
	//	alert("sjkshjdshjsdjhsdhjshjhjhjssd")
      ...
      <tr>
        <td scope="row">&nbsp;</td>
        <td scope="row">&nbsp;</td>
        <td colspan="2"><input type="radio" name="sorPenentuanBidangKuasa" id="sorPenentuanBidangKuasa" value="56" $check99 $setMode99 onClick="selectRadio99();setTablePindah('tableReportPindah')" />
...
<table width="100%">
  <tbody>
    <tr>
      <td valign="top"><span class="style6">#if($setMode != "disabled")*#end</span></td>
      <td width="29%"><div align="left" class="style7">
      ...
      <select name="socNegeriPindah" id="socNegeriPindah"  $setMode onChange="getDaerahPindah(this.value,'sorKeputusanBorangC','socDaerah')" style="text-transform:uppercase;" >
        ...
        <option value="$list.idNegeri" $selected>$list.namaNegeri</option>
          ...
          #foreach ($list in $ListNegeriPindah) 
		      ...
		      #if ($list.idNegeri != $negerimahkamahXPindah && $list.idNegeri != 17)	     
    ...
    <tr>
      ...
      <td>
        ...
        #else
                              <select name="socDaerahPindah" id="socDaerahPindah" onChange="getAddressPindah('sorKeputusanBorangC','socDaerah')" $setMode style="text-transform:uppercase;" onFocus="check_negeriPindah()">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><div align="left"><span class="style5"><span class="style8"></span></span></div></td>
      <td>:</td>
      <td><span class="style2" style="text-transform:uppercase;">
       #if( $alamat2pejabat != "")
     $alamat2pejabat
  ...
  <tr>
    <td>    
        <span class="style5 style3">
        </tbody>
        </span>
        <div align="left" class="style5 style3"></div>
    </table>
</fieldset>    </td>
  </tr>
</table>
      ...
      <tr>
        <td scope="row">&nbsp;</td>
        <td scope="row">&nbsp;</td>
        <td colspan="2"><input type="radio" name="sorPenentuanBidangKuasa" id="sorPenentuanBidangKuasa" value="50" $check4 $setMode5 onClick="selectRadio5();setTableB('tableReportA','tableReportX')"/>
         
        <input name="setMode5" id="setMode5" type="hidden" value="$setMode5" >
Pindah ke Mahkamah Tinggi <!-- (Jumlah Harta &gt; RM 2 juta ) --></td>
      </tr>
      <tr>
        <td scope="row">&nbsp;</td>
        <td scope="row">&nbsp;</td>
...
document.f1.action="?_portal_module=FrmSenaraiFailKeputusanPermohonanInternal";
	...
	function getSimpan() {
		...
		var check_batal = document.f1.sorPenentuanBidangKuasa[4].checked;
...
else
{
	...
	//alert('1');
		...
		document.f1.sorPenentuanBidangKuasa[2].checked = false;
		document.f1.sorPenentuanBidangKuasa[3].checked = false;
		document.f1.sorPenentuanBidangKuasa[4].checked = true;
		document.f1.sorPenentuanBidangKuasa[0].disabled = true;
		document.f1.sorPenentuanBidangKuasaTeruskan[0].disabled = true;
		document.f1.sorPenentuanBidangKuasaTeruskan[1].disabled = true;
		document.f1.sorPenentuanBidangKuasa[1].disabled = true;		
...
function setTableA123(id,loc,tab){
//ubah keputusan
//alert("1"+document.f1.sorPenentuanBidangKuasaTeruskan[0].checked)
//alert("2"+document.f1.sorPenentuanBidangKuasaTeruskan[1].checked)
//alert("3"+document.f1.sorKeputusanBorangC[1].checked+""+id)
...
document.f1.v_tab.value = tab;
		...
		document.f1.command.value = "get_jenisPejabatLama_neg";
		document.f1.action="?_portal_module=FrmSenaraiFailKeputusanPermohonanInternal";
	//document.f1.idPermohonan.value = id;
...
document.f1.v_tab.value = tab;
	...
	//	alert("asjsahja")
		...
		document.f1.command.value = "get_Bandarlama";
		document.f1.action="?_portal_module=FrmSenaraiFailKeputusanPermohonanInternal";
//	document.f1.idPermohonan.value = id;
	   document.f1.submit();

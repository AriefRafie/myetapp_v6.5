     ...
     <input name="socJenisHartaAlih" type="hidden" id="socJenisHartaAlih" value="$idJenisHa" />
      #set($xR = "readonly")
       ...
       <td width="68%">
        ...
        #if (!$negeriARB.equals(""))
         <input name="socJenisHartaAlih" value="98" disabled  size="1" class="disabled">&nbsp;
         <input name="socJenisHartaAlihNegeri" value="HARTA ALIH YANG DISELESAIKAN OLEH AMANAH RAYA BERHAD" disabled  size="58" class="disabled">
	        ...
	        #foreach($listJenis in $ViewJenisHa)
             ...
             #set($pbt = "(Pengambilan Balik Tanah)")
                ...
                <tr>
                  ...
                  <td> 
                  #if (!$negeriARB.equals(""))
                  <input type="text" name="socNegeriHtaam2" value="$kodnegeriARB" size="1" class="disabled" />&nbsp;
                  <input name="socNegeriHtaamnegeriARB" value="$negeriARB" disabled  size="45" class="disabled" />
                  <input type="button" name="button2" onclick="getCancel3()" value="Check Daerah" />
                  #else
...
<tr align="center">
<td align="center">
<input type="button" id="butonkeHartaAlih" value="Ke skrin Harta Alih" onClick="javascript:jumptoKeputusan('$jenis_permohonan','$idPermohonan','$idPemohon','$idSimati','$idpermohonan_simati','$al_negeri')"/>
</td>
</tr>
</table>
...
function intNilaianJPPH_lama(NO_FAIL, ID_HAK) {
	// kmie, 20100721
	// to cater for integration
	document.f1.action = "$EkptgUtil.getTabID("Utiliti",$portal_role)?_portal_module=ekptg.view.integrasi.FrmViewNilaianHartaAlihKenderaan&action2=viewNilaianHAK&NO_FAIL=" + NO_FAIL + "&ID_HAK=" + ID_HAK;
	document.f1.method = "POST";
	document.f1.submit();
}

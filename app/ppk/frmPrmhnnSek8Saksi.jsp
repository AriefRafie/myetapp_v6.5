                            ...
                            <table width="100%" border="0">
                              <tr>
                               ...
                               <input type="hidden" name="txtIdSimatiPenting" value="$id_Simati" >        
                                  <tr>
                                    <td width="1%" class="style38 style40"> #if($readmode != "disabled")
                                    <span class="style40">*</span>#end</td>
                                  ...
                                  <td width="70%" class="style36"><label>
                                     ...
                                     <input name="txtNoKPBaru1Penting" id="txtNoKPBaru1Penting" style="width: 50px;" type="text" $readmode size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2Penting')" value="$txtNoKPBaru1Penting" onBlur="calculateTarikhLahirOB();"/> <!--onBlur="getAgeByIC(this,this.value,'txtUmurPenting');getDOB(this.value);check_umur_saksi()"  /-->
                                     - 
...
<!--
                            ...
                            <tr>
                <td>
                <p align="right">#if($!skrin_online != "yes")CL - 01 - 73#end</p>
                </td>
                </tr>
                    </table>

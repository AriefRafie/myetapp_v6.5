...
<body onload="submitForm();CheckAll()" >
  ...
  <div id="TabbedPanels1" class="TabbedPanels">
    ...
    <div class="TabbedPanelsContentGroup">
      ...
      #parse("app/ppk/info_berjaya_disimpan.jsp")
       ...
       #if(($bkp == "Y" || $lp == "Y" || $bpa == "Y" || $lpa == "Y" || $lt == "Y") && $listHadulu.size()>0)
      <br /> 
       <!--
        #if($!skrin_online == "yes" || $!skrin_online_17 == "yes")
                                    ...
                                    <tr>
                                     ...
                                     #set($pastcheck = "checked")   
                                      ...
                                      <td width="5%"><label>
                                        ...
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $nowcheck value="now" onclick="setSelected(2,0,0,0);HAview()"  />
                                        </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "now") <span class="style42 style4">Senarai Harta Alih Tambahan </span>#else
                                      Senarai Harta Alih Tambahan
                                      #end                                      </div></td>
                                    
                                    </tr>
                                       <td width="5%" ><label>
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $pastcheck value="past" onclick="setSelected(2,0,0,0);HAviewdulu()" />
                                         </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">
                                      #if($nowpast == "past") <span class="style42 style4">Senarai Harta Alih Terdahulu</span>                                      #else
                                      Senarai Harta Alih Terdahulu
                                      #end                                      </div></td>
    ...
    <p>
      ...
      #set ($negeri = $Data.negeri)  
       #set ($butiran = $Data.butiran)   
         ...
         #if($!skrin_online_17 == "yes" && $disabled == "" && $disabledR == "")
...
#end
#if($nowpast == "past")
<input type="submit" name="cmdKembali3" id="cmdKembali3" value="Kembali"  onclick="setSelected(2,0,0,0);HAviewdulu()" />
#end</div>
...
#if($boleh_kemaskini == "yes")
#end
<!--<input type="button" name="cmdSimpanxxx" value="Simpan" onClick="setSelected(2,0,0,0);getUpdate()">-->
<input type="button" name="cmdSimpan" value="Simpan" onClick="setSelected(2,0,0,0);getSimpan_online('update')">
<input type="button" name="cmdHapus2" id="cmdHapus2" value="Hapus" onClick="setSelected(2,0,0,0);getHapus()">
#if($flag_kemaskini_selesai != "yes")
                                <script>
...
<!--<input type="button" name="cmdSimpanxxxx" value="Simpan" onClick="setSelected(2,0,0,0);getUpdate()">-->
<input type="button" name="cmdSimpan" value="Simpan" onClick="setSelected(2,0,0,0);getSimpan_online('update')">
#if($nowpast == "now")
<input type="submit" name="cmdKembali3" id="cmdKembali3" value="Kembali"  onclick="setSelected(2,0,0,0);HAview()" />
#end
...
<!--<input type="button" name="cmdSimpanxxx" value="Simpan" onClick="setSelected(2,0,0,0);getSimpan()">-->
...
#if($ht == "Y")
<input type="button" name="cmdTambah1" id="cmdTambah1" value="Tambah" onClick="setSelected(2,0,0,0);getFormHaBaru()" >
#if($flag_kemaskini_selesai != "yes")
                                <script>
...
<legend>SENARAI HARTA ALIH TERDAHULU</legend>
<table width="100%" bordercolor="#333333">
...
<tr class="table_header">
<td width="10%"><div align="center">Bil</div></td>
<td width="35%">Jenis Harta Alih</td>
<td width="30%">No Rujukan UPT / No Daftar / No Akaun / No Ahli</td>
  #if($listHadulu.size()!=0 ) 
    
   
   <td width="20%">Jenis Perintah Terdahulu</td>
...
<td ><div align="left" style="text-transform:uppercase;" onblur="uppercase()">$list.JENIS_PERINTAH</div></td>
    ...
    <label>
      ...
      #if($lo.id_ha == $id3 && $lo.id_permohonansimati == $id_permohonansimati)
       #set($p_c = 1)
      #end
...
function HAviewdulu() {
	document.f1.method="post";
	document.f1.mode.value = "view_harta_alih_dulu";
	document.f1.command.value = "harta_alih";
...
var jum=units*nilaiseunit;

if(document.f1.txtBilUnit.value != "" && document.f1.txtNilaiSeunit.value != "" )
{
document.f1.txtNilaiTarikhMati.value=jum;
document.f1.txtNilaiTarikhMohon.value=jum;
}
else
{
...
var mod = mode;
	...
	if (document.f1.socJenisHartaAlih.value=="0"){
		...
		else*/ if (document.f1.nama_saham.value=="")

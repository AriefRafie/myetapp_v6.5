...
<fieldset>
<legend>
<b  >Carian</b> <strong>Rekod Pembahagian Pusaka</strong></legend>
...
<table align="center" width="100%"> 
 ...
 <td colspan="5" scope="row" align="right">
    ...
    <tr class="table_header">
      ...
      <td width="20%"><div align="center">Cetak Maklumat </div></td>
    </tr>
   #set ($noFail = "")
   #set ($tarikhDaftar = "")
   #set ($tarikh_Mohon = "")
				   ...
				   #set ($namasimati = $fail.namasimati)
					   ...
					   <tr >
				         ...
				         <td class="$row">$noFail 
                          ...
                          <input name="cetak" type="button" value="Cetak" onclick="RPP('$id_Fail')" />
                          <input name="cetak" type="button" value="Laporan Penyelenggaraan Notis" onclick="RPP_notis('$id_Fail')" />
                        <!--
                          <a href="javascript:RPP('$noFail')" class="style1">Cetak</a>
                          -->
...
function RPP_notis(noFail) 
{
   // var url = "../servlet/ekptg.report.ppk.RPP?nofail="+noFail;
   
    var url = "../servlet/ekptg.report.ppk.LaporanPenyelenggaraanNotis?idFail="+noFail;
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();

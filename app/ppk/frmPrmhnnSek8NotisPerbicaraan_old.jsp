          ...
          <div style="width:100%;height:187;overflow:auto"> #end
              ...
              <tr class="table_header">
					...
					<td class="$row" align="center"><input type="radio" name="radioJenisSerah$ob.id_ob" id="radioJenisSerah$ob.id_ob" value="3" onClick="doCheckAllOBserahTgn($ob.bil,'3')" ></td>
					 ...
					 <td class="$row" >&nbsp;</td>
					#end
					<td class="$row" align="center"><input type="radio" name="radioJenisSerah$ob.id_ob" id="radioJenisSerah$ob.id_ob" value="5" onClick="doCheckAllOBserahTgn($ob.bil,'5')" ></td>
                  	#end
...
<!--                     <td width="15%"><b>Status</b></td> -->
              ...
              #end
              <tr>
                    <td class="$row" align="center" width="4%">$ohutang.bil</td>
              ...
              <tr>
                    ...
                    <td class="$row">$ob.keterangan</td>
	                    ...
	                    <td colspan =3  class="$row">&nbsp;</td>
		                 ...
		                 #if ($listPenerimaNotis.size() >0)
		                 #set($jenis_serah = "")
			                    #set($id_ob_notis = "")
			                #foreach($listTN in $listPenerimaNotis)
				       			...
				       			#if($jenis_serah=='5' && $id_ob_notis==$id_ob) checked #end	> 
				       			</td>
...
<!--                 <tr>
          ...
          <tr align="center">
                <td>
	              ...
	              <input type="button" name="cmdKemaskini1" class="disabled" disabled="disabled" id="cmdKemaskini1" value="Kemaskini" onClick="kemaskini()" />
	              <!-- #if($!id_perbicaraan!="")
		              <span id="span_PNB" >
	                    ...
	                    <td colspan =3  class="$row">&nbsp;</td>
		                 ...
		                 #set($jenis_serah = "")
			                ...
			                #foreach($listTN in $listPenerimaNotis)
				       			...
				       			<td class="$row" align="center">
				       			<input type="radio" name="radioJenisSerah$ob.id_ob" id="radioJenisSerah$ob.id_ob" value="1" onClick="doCheckAllOBserahTgn()" 
				       			#if($jenis_serah=='1' && $id_ob_notis==$id_ob) checked #end	 #if($edit=='no') disabled #end >
				       			</td>
				       			
				       			<td class="$row" align="center">
				       			#if($ob.emel!='')
				       			<input type="radio" name="radioJenisSerah$ob.id_ob" id="radioJenisSerah$ob.id_ob" value="3" onClick="doCheckAllOBserahTgn()" 
				       			#if($jenis_serah=='3' && $id_ob_notis==$id_ob) checked #end	#if($edit=='no') disabled #end>
				       			#end
				       			</td>
				       			
				       			<td class="$row" align="center">
				       			<input type="radio" name="radioJenisSerah$ob.id_ob" id="radioJenisSerah$ob.id_ob" value="5" onClick="doCheckAllOBserahTgn()" 
				       			#if($jenis_serah=='5' && $id_ob_notis==$id_ob) checked #end	#if($edit=='no') disabled #end> 
				       			</td>
...
function simpanNotisTambah() {
		...
		else if(date1 < trMOHON)
	{
		...
		return;
	   	...
	   	alert("Sila pastikan tarikh notis tidak kurang dari tarikh hari ini2.");
		document.${formName}.txdTarikhNotis.focus();
		return;
	}
	else if(date2 > dateHidden){

                    ...
                    #foreach($listob in $listPentingbyIDOB)
                    	...
                    	#set ($nilaihutang = $listob.nilaihutang)
                             <tr>
                                         <td>
                                          <fieldset>
                                   <input name="jenisHutang" type="hidden" value="$listob.jenishutang">
                              ...
                              <input type="hidden" name="txtIdOb" value="$listob.idOb" >
                               <input type="hidden" name="jenisHutangPentingU" value="$listob.jenishutang">       
                                   <tr>
                                     ...
                                     <td class="style36">:</td>
                                     <td class="style36"><input type="radio" name="socJenisHutangPentingU" id="socJenisHutangPentingU2" value="2" disabled $checked2a onClick="jenis_hutangU(this.value)"/>                                       &nbsp;<span class="style38">INDIVIDU</span>&nbsp;&nbsp;
                                     <input type="radio" name="socJenisHutangPentingU" id="socJenisHutangPentingU" value="1" $checked1a onClick="jenis_hutangU(this.value)" disabled/>                                       &nbsp;<span class="style38">INSTITUSI</span></td>
                                 </tr>
                               #if($jenishutang == "2")
                                  ...
                                  <td width="70%" class="style36">
                                     <input name="txtNoKPBaru1PentingU" type="text" id="txtNoKPBaru1PentingU" style="width: 50px;" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2PentingU')" value="$listob.nokpbaru1" size="6" maxlength="6" $readmode1/>-<input name="txtNoKPBaru2PentingU" type="text" id="txtNoKPBaru2PentingU" style="width: 20px;" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3PentingU')" value="$listob.nokpbaru2" size="2" maxlength="2" $readmode1/>-<input name="txtNoKPBaru3PentingU" type="text" id="txtNoKPBaru3PentingU"  style="width: 40px;" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3PentingU')" value="$listob.nokpbaru3" size="4" maxlength="4" $readmode1/>                                  </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td class="style36"> 
                                      ...
                                      <option value="4">Pasport</option>
	                               #end
                                    </select>&nbsp;<input name="txtNoKPLainPentingU" type="text" id="textfield5" value="$listob.nokplain" size="9" maxlength="12" $chkkplain $readmode1  style="text-transform:uppercase;"  />									 </td>
                                </tr>
                                #end
                                #if($jenishutang == "1")
                           <tr>
                                  <td ><div align="right"><span class="style38"><font color="#ff0000">*</font>&nbsp;No Pendaftaran n</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                              ...
                              <tr>
                                <td width="80%" valign="top"><table width="100%">
                                   ...
                                   <tr>
                                     ...
                                     <td class="style36">:</td>
                                     <td class="style36"><input type="radio" name="socJenisHutangPenting" id="socJenisHutangPenting" value="2" $checkradio2 onClick="hiddendisplay();"/>&nbsp;<span class="style38">INDIVIDU</span>&nbsp;&nbsp;
                                     <input type="radio" name="socJenisHutangPenting" id="socJenisHutangPenting" value="1" $checkradio1 onClick="hiddendisplay();"/>                                       &nbsp;<span class="style38">INSTITUSI</span></td>
                                   </tr>
                                  <tr>
                                  <tr id="kpb">
                                  <td width="29%" ><div align="right"><span class="style38">MyID Baru</span></div></td>
                                  ...
                                  <td width="70%" class="style36"><label>
                                    <input name="txtNoKPBaru1PentingU" type="text" id="txtNoKPBaru1PentingU" style="width: 50px;" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2PentingU')" value="$!nokpbaru1" size="6" maxlength="6" />
                                    -<input name="txtNoKPBaru2PentingU" type="text" id="txtNoKPBaru2PentingU" style="width: 20px;" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3PentingU')" value="$!nokpbaru2" size="2" maxlength="2" />-<input name="txtNoKPBaru3PentingU" type="text" id="txtNoKPBaru3PentingU"  style="width: 40px;" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3PentingU')" value="$!nokpbaru3" size="4" maxlength="4" />
                                  </label></td>
                                </tr>
                                <tr id="kpl">
                                  <td width="29%" ><div align="right"><span class="style38">&nbsp;MyID Lama</span></div></td>
                                ...
                                <tr id="nop">
                                  ...
                                  <tr id="namai">
                                    ...
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                                      <input name="txtNamaSyktPenting" type="text" id="txtNamaSyktPenting" style="text-transform:uppercase;" value="$!namaOB" size="34"/>
                                    </label></td>
                                  </tr>
                                  <tr>
                                     <td><div align="right"><span class="style38">No Akaun</span></div></td>
                       ...
                       <input name="txtPoskodPenting" type="text" id="txtPoskodPenting" onKeyUp="javascript:validatePoskod(this,this.value)" style="text-transform:uppercase;" size="5" maxlength="5" $readmode onBlur="validLength()" $checked3a value="$!poskod"/>
                                ...
                                <tr>
                                  ...
                                  <td class="style36" valign="top"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36">
                                    <textarea name="txtButiranHutangPenting" cols="34"  rows="3"  $readmode style="text-transform:uppercase;" id="txtButiranHutangPenting"  $checked3a >$!butiran</textarea>                                  </td>
                                </tr>
                                <tr>
                                  <td valign="top">&nbsp;</td>
                                  <td class="style36" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <table width="100%">
                                    ...
                                    <td class="row1"><div align="center" class="style41">$!peno</div></td>
                                      ...
                                      #if($ll!="")
                                      <td class="row1" style="text-transform:uppercase;"><div align="right" >$Util.formatDecimal($listpenting.nilaihutang)</div></td>
                                      #end
                                       #if($ll=="")
...
function hiddendisplayUpdate() {


	if (document.${formName}.jenisHutang.value == "2"){
	document.getElementById("nop").style.display="none";
	document.getElementById("namai").style.display="none";
	document.getElementById("kpb").style.display="";
	document.getElementById("kpl").style.display="";
	...
	else if (document.${formName}.jenisHutang.value == "1"){
	document.getElementById("nop").style.display="";
	document.getElementById("namai").style.display="";
	document.getElementById("kpb").style.display="none";
	document.getElementById("kpl").style.display="none";

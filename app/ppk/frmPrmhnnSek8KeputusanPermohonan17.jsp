...
.style5 {color: #FF0000}
.style6 {font-size: 9px; font-style: italic; color: #0000FF; }
.style13 {font-size: 10px}
.style14 {color: #FF0000; font-size: 10px; }
.style24 {font-size: 10px; color: #000000;}
.style25 {font-size: 10px; color: #0000FF;}
...
<br>
 <fieldset>
<fieldset id="header_lama" style="display:none" ><legend>MAKLUMAT PERMOHONAN</legend>
<table width="100%">
  <tr>
...
<table width="100%" border="0">
  <tr>
    ...
    <table width="100%" border="0">
     ...
     <!-- #if($setMode != "disabled")
         <font color="red">*</font>
         #end --></td>
        <td width="40%"><strong>Hantar Nilaian</strong></td>
        <td width="58%"><input name="txdTarikhHantarNilaian" type="text" class="$setMode" id="txdTarikhHantarNilaian"  value="$tarikh_Hantar_Nilaian" size="11" maxlength="10" $setModeR  onBlur="trans_date3(this.value);checkDateKP()"   onKeyPress="checkDateKP()"  onFocus="checkDateKP()" />
          &nbsp;
          #if ($EventStatus != 1)
          <a href="javascript:displayDatePicker('txdTarikhHantarNilaian',false,'dmy');"/><img border="0" src="../img/calendar.gif"/></a><span class="style6"> dd/mm/yyyy</span></td>
          #end      </tr>
      <tr>
      <td  valign="top">&nbsp;</td>
        <td ><strong>Terima Nilaian</strong></td>
        <td><input name="txdTarikhTerimaNilaian" type="text" class="$setMode" id="txdTarikhTerimaNilaian"  value="$tarikh_Terima_Nilaian" size="11" maxlength="10" $setModeR  onBlur="trans_date4(this.value)" />
         &nbsp;
		#if ($EventStatus != 1)
		<a href="javascript:displayDatePicker('txdTarikhTerimaNilaian',false,'dmy');"/><img border="0" src="../img/calendar.gif"/></a><span class="style6"> dd/mm/yyyy</span></td>
      	#end      </tr>
      <tr >
      <td></td>
      <td valign="top" colspan="2"><div id="alert_field" style="display:none"></div></td>
  ...
  <tr>
    ...
    #end
    <fieldset>
    <legend id="sorKeputusanBorangCX" >PENENTUAN BIDANG KUASA</legend>
    <table width="100%" border="0">
      <tr>
        <td width="15%" ></td>
        <td width="1%">&nbsp;</td>
   ...
   <tr>
    ...
    <!--   ------ lebih -->
      ...
      <input type="radio" name="tujuanPindah" id="tujuanPindah" $selectedTujuan1 $setModeTujuan1 value="1"   />     
        Harta Melebihi #if($check5juta=='T')RM5 juta #else RM2 juta #end
...
<table width="100%">
  <tbody>
    <tr>
      <td valign="top" class="style14 style13 style5">#if($setMode != "disabled") * #end</td>
      <td width="29%"><div align="right" class="style24">
          <div align="left">#if($setMode != "disabled") Negeri #else
            Negeri
            #end</div>
      </div></td>
      ...
      <td width="70%">
        ...
        #else 
      <select name="socNegeri" $setMode onChange="getDaerah(this.value,'sorKeputusanBorangCX','socDaerah')" style="text-transform:uppercase;" >
    ...
    <tr>
      <td valign="top" ><span class="style14"> #if($setMode != "disabled") * #end</span></td>
      <td><div align="right" class="style24">
          <div align="left">#if($setMode != "disabled") Daerah #else
            Daerah
            #end </div>
      </div></td>
      ...
      <select name="socDaerah" id="socDaerah" onChange="getAddress('sorKeputusanBorangCX','socDaerah')" $setMode style="text-transform:uppercase;" onFocus="check_negeri()">
        #if($daerahmahkamahX != "" && $daerahmahkamahX != "0")
    ...
    <tr>
      ...
      <td><div align="right" class="style25">
          <div align="left" class="style26">No Fax</div>
      </div></td>
      <td>:</td>
      <td><span class="style2" style="text-transform:uppercase;">
      #if($nofax != "")

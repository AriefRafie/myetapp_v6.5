    ...
    <tr>
      <td><div id="TabbedPanels1" class="TabbedPanels">
        <ul class="TabbedPanelsTabGroup">
          ...
          <li class="TabbedPanelsTab style1 style3" tabindex="0" onClick="KptgView('2','0','0','0')">KEPUTUSAN KPTG/PTG</li>
          #end
          </ul>
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
     ...
     <tr>
      ...
      <tr>
       ...
       <tr>
        <td ><a href="#" class="style2" onClick="javascript:cetakBorangR('$nofail','$idfail')"><span class="style40">Borang R</span></a></td>
      </tr>
      <tr>
        <td ><a href="#" class="style2" onClick="javascript:cetakBorangQ('$nofail','$idfail')"><span class="style40">Borang Q</span></a></td>
      </tr>
	  #end

...
#set ($idOb = "")
   ...
   #end
#end
                            <fieldset><legend>MAKLUMAT ORANG KEPENTINGAN INDIVIDU</legend>
                            <table width="100%" border="0">
                              <tr>
                                <td width="80%"><table width="100%">
                                   <input type="hidden" name="txtIdSimatiPenting" value="$id_Simati" > 
                                   <input type="hidden" name="jenisPB" value="1" > 
...
#set ($idOb = "") 
	...
	#set ($bandar = $listdata.bandar)
	#set ($negeri = $listdata.idnegeri)
	#set ($notel = $listdata.notel)
	#set ($nofaks = $listdata.nohp)
	#end
#end
                           <!-- ini agensi punya -->
                            <fieldset><legend>MAKLUMAT ORANG KEPENTINGAN AGENSI</legend>
                            
                            <table width="100%" border="0">
                              <tr>
                                <td width="80%"><table width="100%">
                                   <input type="hidden" name="txtIdSimatiPenting" value="$id_Simati" >        
                                   <input type="hidden" name="jenisPB" value="2" >
                                   <input type="hidden" name="txtIdOb" value="$idOb">        
                                  <tr>
                                    <td><div align="right"><span class="style40">*</span><span class="style38">&nbsp;No Daftar Syarikat</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                                      <input name="txtNoKPLamaPenting" type="text" id="txtNoKPLamaPenting" size="8" maxlength="8" value="$nokplama" $readmode style="text-transform:uppercase;" />
                                    </label></td>
                                  </tr>                               
                               <tr>
                                  <td ><div align="right"><span class="style40">*</span><span class="style38">&nbsp;Pemohon</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                    <input name="txtNamaOBPenting" type="text" id="txtNamaOBPenting" value="$namaob" size="34" maxlength="50" $readmode style="text-transform:uppercase;"  />
                                  </label></td>
                                </tr>
                                  <tr>
                                  <td class="style38" width="29%"><div align="right" class="style38">Alamat</div></td>
                                  ...
                                  <td width="70%"><label>
                                    ...
                                    <input name="txtAlamatTerakhir1Penting" type="text" id="txtAlamatTerakhir1Penting" value="$alamat1"  size="34" maxlength="50"  $readmode style="text-transform:uppercase;" />
                                  </label></td>
                                </tr>
                                <tr>
                                  <td class="style38"><div align="right"><span class="style7"><span class="style38"></span></span></div></td>
                                  <td><div align="right" class="style38">:</div></td>
                                  <td><label>
                                    <input name="txtAlamatTerakhir2Penting" type="text" id="txtAlamatTerakhir2Penting" value="$alamat2" size="34" maxlength="50" $readmode style="text-transform:uppercase;" />
                                  </label></td>
                                </tr>
                                <tr>
                                  <td class="style38"><div align="right"><span class="style7"><span class="style38"></span></span></div></td>
                                  <td><div align="right" class="style38">:</div></td>
                                  <td><input name="txtAlamatTerakhir3Penting" type="text" id="txtAlamatTerakhir3Penting" value="$alamat3" size="34" maxlength="50" $readmode style="text-transform:uppercase;" /></td>
                                </tr>
                                <tr>
                                  <td class="style38"><div align="right" class="style38">Poskod</div></td>
                                  <td><div align="right" class="style38">:</div></td>
                                  <td><label>
                                    <input name="txtPoskodPenting" type="text" id="txtPoskodPenting" value="$poskod" style="text-transform:uppercase;" size="5" maxlength="5" $readmode onBlur="validLength()"/>
                                  </label></td>
                                </tr>
                                  ...
                                  -->
	                               ...
	                               <!--
	                              #if($negeri!="")
                                  <select name="socNegeriPenting" style="width: 225px;" $readmode>
                                  ...
                                  <td><div align="right"><span class="style38">:</span></div></td>
                                  <td><!--<label>
                                    <input name="txtBandarPenting" type="text" id="txtBandarPenting" value="$bandar" size="34" $readmode style="text-transform:uppercase;" />
                                  </label>-->$selectBandarTetap</td>
                                </tr>
                                  <td class="style38"><div align="right" class="style38">No Telefon</div></td>
                                  <td><div align="right" class="style38">:</div></td>
                                  <td><label>
                                    <input name="txtNoTelefon" type="text" id="txtNoTelefon" value="$notel" style="text-transform:uppercase;" size="14" maxlength="14" $readmode />
                                  </label></td>
                                </tr>
                                <tr>
                                  <td class="style38"><div align="right" class="style38">No Faks</div></td>
                                  <td><div align="right" class="style38">:</div></td>
                                  <td><label>
                                    <input name="txtFaks" type="text" id="txtFaks" value="$nofaks" style="text-transform:uppercase;" size="14" maxlength="14" $readmode />
                                  </label></td>
                                </tr>
                                </table></td>
                                <td width="10%" valign="top"></td>
				...
				#if ($idhub != "31")
				<fieldset><legend>SENARAI ORANG KEPENTINGAN $jenisPb</legend>
                              <table width="100%" >
                                <tr>
                                  <td>
...
function tambah_penting(){
	...
	var dob_code = document.${formName}.txtNoKPBaru1Penting.value;
	 ...
	 var date_dob = new Date(yr_dob, mon_dob, dt_dob);
		...
		if (document.${formName}.jenisPB.value == "1") {
		...
		if (document.${formName}.jenisPB.value == "2") {
			if (document.${formName}.txtNoKPLamaPenting.value == "") {
				alert("Sila masukkan No Daftar");
				txtNoKPLamaPenting.focus();
			}
			else if (document.${formName}.txtNamaOBPenting.value == "") {

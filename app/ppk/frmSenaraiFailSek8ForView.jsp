...
Semakan Permohonan</b></legend>
		...
		<table width="100%" align="center" border="0">
    		...
    		<tr>
      			<td scope="row" align="right">MyID Pemohon : </td>
     			<td width="70%"><input name="txtIcPemohon" id="txtIcPemohon" type="text" value="$txtIcPemohon" size="30" maxlength="50" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();" />
              
                </td>
    		</tr>
    		<tr>
      			<td scope="row" align="right">Nama Simati : </td>
     			<td width="70%"><input name="txtNamaSimati" id="txtNamaSimati" type="text" value="$txtNamaSimati" size="30" maxlength="50" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();" />
              
                </td>
    		</tr>
    		<tr>
      			<td scope="row" align="right">Nama Pemohon : </td>
     			<td width="70%"><input name="txtNamaPemohon" id="txtNamaPemohon" type="text" value="$txtNamaPemohon" size="30" maxlength="50" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();" />
...
<tr >
                ...
                <td class="table_header" width="10%"><b>LOKASI PERMOHONAN</b></td>
...
#if($!latest_idstatus == "21" || $!latest_idstatus == "47" || $!latest_idstatus == "70" || $!latest_idstatus == "169" || $!latest_idstatus == "50" || $!latest_idstatus == "999")
#if($!role == "adminppk")

...
.style9 {font-size: 9px; color: #0000FF; font-style: italic; }
.style10 {color: #0000FF; font-size: 9px; }
-->
</style>
...
<div align="right"><a href="javascript:kembalix()" class="style3"  ><img src="../img/1enable.png" alt="" border="0" title="Senarai Semak"/></a><img src="../img/arrowgaris.png" alt="" border="0"/><img src="../img/2current.png" alt="" border="0" title="Pendaftaran Permohonan"/><img src="../img/arrowgaris.png" alt="" border="0"/>#if($noFail != "")<a href="javascript:seterusnya_tab()" class="style3" ><img src="../img/3enable2.png" alt="" border="0" title="Maklumat Permohonan"/></a>#else<img src="../img/3disable.png" alt="" border="0" title="Maklumat Permohonan"/>#end</span></div></td>
</tr>
</table>
...
#set ($id_Suburusanstatusfail = $listFail.id_Suburusanstatusfail)
#set ($id_Suburusanstatus = $listFail.id_Suburusanstatus)
#end
...
<table width="100%" border="0" id="main_table">
        ...
        <td valign="top"><fieldset>
          ...
          <table width="100%" border="0">
            <tr>
              ...
              <td width="1%">:</td>
              <td width="68%"><input name="txtNoFail" id="txtNoFail" type="text" value="$noFail" style="width: 195px;" class="disabled" readonly="readonly" /></td>
            </tr>
            
            <tr>
              <td valign="top" >#if($setmode2 != "disabled") <span class="style1 style2">*</span> #end</td>
            ...
            #end</td>
            <tr>
              <td valign="top">#if($setmode != "disabled")<span class="style2">*</span>#end</td>
              <td>#if($setmode != "disabled")Tarikh Mohon#else Tarikh Mohon #end</td>
              <td>:</td>
              <td>
            #if ($idAlert == "1" || $idAlert == "2") 
            #if($setmode == "disabled") #set($setmodeR = "readonly") 
            #else #set($setmodeR = "") 
            #end
        ...
        <td><fieldset>
          ...
          <table width="100%" border="0">
            <tr>
              ...
              <td width="1%">:</td>
              <td width="68%"> #if ($idAlert == "1" || $idAlert == "2") 
  ...
  <input name="txtNoKPBaruSimati2" id="txtNoKPBaruSimati2" style="width: 20px;" type="text" value="$nokpbaru2x" size="3" maxlength="2" $setmodeR class="$setmode" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')" onBlur="check_kp();check_pengenalan_simati_1()"  />
                -
  <input name="txtNoKPBaruSimati3" id="txtNoKPBaruSimati3"  style="width: 40px;" type="text" value="$nokpbaru3x" $setmodeR class="$setmode" size="5" maxlength="4"  onblur="jantinaic();check_kp();check_pengenalan_simati_1();kp_baru_pemohon()" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')"  />
 ...
 <input name="check_no_kp_lain_pemohon" id="check_no_kp_lain_pemohon" type="hidden"  />            
  <!--
    ...
    -->
    #if ($setmode != "disabled" )
<a href="http://www.jpn.gov.my" class="style10" > www.jpn.gov.my</a>
            ...
            <tr>
              ...
              <td> #if ($idAlert == "1" || $idAlert == "2") 
                ...
                <input name="txtNoKPLamaSimati" id="txtNoKPLamaSimati" type="text" value="$noKpLamax"  onblur="this.value=this.value.toUpperCase();check_kp_lama();check_pengenalan_simati_2();kp_lama_pemohon()" $setmodeR class="$setmode" maxlength="25" size="15" style="width: 120px; text-transform:uppercase;"/>
                 <span id="check_kp_2" style="color:red" ><input name='no_kp2' type='hidden' value='' /></span>
                #else
                <input name="txtNoKPLamaSimati" id="txtNoKPLamaSimati" type="text" value="$noKpLama"  onblur="this.value=this.value.toUpperCase();check_kp_lama();check_pengenalan_simati_2();kp_lama_pemohon()" $setmodeR class="$setmode" maxlength="25" size="15" style="width: 120px; text-transform:uppercase;"/>
                 <span id="check_kp_2" style="color:red" ><input name='no_kp2' type='hidden' value='' /></span>
                #end </td>
            </tr>
            <!--
            ...
            #set($setmodR = "")
            	...
            	<input name="txtNoKPLainSimati" id="txtNoKPLainSimati" onBlur="this.value=this.value.toUpperCase();check_kp_lain();check_pengenalan_simati_3();kp_lain_pemohon()" style="width: 97px; text-transform:uppercase;" type="text" value="$noKpLainx" $setmodR class="$setmod" maxlength="25" />
       ...
       <input name="txtNoKPLainSimati" type="text" class="$setmod" id="txtNoKPLainSimati" style="width: 97px; text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();check_kp_lain();check_pengenalan_simati_3();kp_lain_pemohon()" value="$noKpLain"  maxlength="25" $setmodR />
        <span id="check_kp_3" style="color:red" ><input name='no_kp3' type='hidden' value='' /></span>
            ...
            <tr>
              <td valign="top">#if($setmode != "disabled")
                <span class="style2">*</span>#end</td>
              <td >#if($setmode == "disabled")
                Nama Simati#else Nama Simati#end </td>
              <td>:</td>
              <td> #if ($idAlert == "1" || $idAlert == "2")
            ...
            <tr>
              <td valign="top">#if($setmode!="disabled") <span class="style1 style2">*</span> #end</td>
              ...
              <input name="txtTarikhMati" id="txtTarikhMati" type="text" style="width: 80px;" value="$tarikhMati" size="11" maxlength="10" $setmodeR class="$setmode"  onfocus="qryHowOld()" onBlur="trans_date(this.value);qryHowOld()" />
                    ...
                    <span class="style9" >dd/mm/yyyy</span>#end               </td>
            </tr>
            #if ($SimpanStatus != "2")
          #end
          </table>
    ...
    <fieldset>
     ...
     <input name="baca" id="baca" type="hidden" value="$setmode" />
      ...
      <input nama="tp" id="tp" type="hidden" value="$taraf_penting" />
            <td valign="top"><span class="style2">#if($setmode != "disabled") * #end</span></td>
           ...
           <tr id="hubungan" >
                                          <td  valign="top">#if($setmode != "disabled")<font color="red">*</font> #end</td>
...
<select name="jenis_pemohon"  class="autoselect" $readmode id="jenis_pemohon" style="text-transform:uppercase;" onBlur="uppercase()" onChange="pilih_taraf()" >        
  ...
  <option value="$Listkp.id">$Listkp.keterangan </option>
        ...
        #if($EventStatus!=3)
        <tr>
          <td valign="top" class="style38 style2" >#if($setmode != "disabled") <span class="style1">*</span> #end</td>
...
<select name="socNegeri" class="autoselect" $setmode  onchange="getBandar('socBandar');get_bandar_simati()" style="text-transform:uppercase;" onBlur="uppercase()">
        ...
        <tr>
          <td valign="top" class="style38 style2" >#if($setmode != "disabled")#end</td>
...
<table width="100%" border="0">
 ...
 <tr>
  <td><span class="style5"><span class="style2">Perhatian</span> : Sila masukkan salah satu nombor kad pengenalan dan pastikan label bertanda <span class="style2">*</span> diisi.</span></td>
  ...
  <tr align="center">
    ...
    -->
     ...
     <input type="button" name="cdmCetak" id="cdmCetak" value="Cetak" onClick="javascript:setTable('tableReport')"/>
     <!--
      <input type="button" name="cdmKembali" id="cdmKembali8" value="Kembali " onClick="kembalix()"/>
      -->
      #end
    #end   </th>
  </tr>
...
<legend><strong>Senarai Laporan</strong></legend>
    ...
    <tr>
        <td><a href="#" class="style2 style3" onClick="javascript:cetakDokumen('$IdPermohonan','PPKSemakanSek8')"> Senarai Semak </a></td>
	  </tr>
      <tr>
        <td ><a href="#" class="style2 style3" onClick="javascript:cetak('$noFail','$idFail')">Kulit Fail</a></td>
      </tr>
      <tr>
        <td > <a href="#" class="style2 style3" onClick="javascript:cetakSuratAkuanTerima('$noFail')">Surat Akuan Terima</a></td>
      </tr>
      <tr>
        <td ><a href="#" class="style2 style3" onClick="javascript:cetakSuratIringanBorangB('$noFail')">Surat Iringan Borang B</a></td>
      </tr>
       <tr>
       <td >
      ...
      <!-- 
       <tr>
        <td ><a href="#" class="style2 style3" onClick="cetakBorangB('$NoFail','$idFail')">Borang B (Cetakan Secara Portrait)</a></td>
      </tr>
       -->
       <tr>
        <td ><a href="#" class="style2 style3" onClick="cetakBorangB2('$NoFail','$idFail')">Borang B (Cetakan Secara Landskap)</a></td>
      </tr>
    </table>
</fieldset> 
<p align="right">CL - 01 - 28</p>
</fieldset>
...
<input name="idPemohon" type="hidden" value="$IdPemohon"/>
<input name="id_Suburusanstatusfail" type="hidden" value="$id_Suburusanstatusfail"/>
<input name="id_Suburusanstatus" type="hidden" value="$id_Suburusanstatus"/>
...
function Simpan() {
   ...
   var date2 = new Date(yr2, mon2, dt2);
	...
	else if (document.f1.socJenisKPLainSimati.value!="0" && document.f1.txtNoKPLainSimati.value=="") {
...
function cetakBorangB2(noFail,idfail,flag) {

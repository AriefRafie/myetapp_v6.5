...
<form id="form1" name="f1" method="post" action=""> 
        				...
        				<td valign="top" >        				                
          					<table class="table100" >          
            					...
            					<table>
						            ...
						            #if ($EventStatus == "0") <a href="javascript:displayDatePicker('txdTarikhMohon',false,'dmy');">
						            	#parse("app/ppk/ppk_calender.jsp")</a> 
		...
		<tr>
			<td>
	        	...
	        	#foreach($listsau in $listsaudara)
	    			...
	    			#else
	                     	<select name="socSaudaraWaris" id="socSaudaraWaris" class="largeselect" $!readmode style="text-transform:uppercase;">
					...
					<tr>
				    	...
				    	<td>
				            ...
				            <input name="txtNamaPemohon" type="text" class="$setmode" id="txtNamaPemohon" style=" text-transform:uppercase;"  onblur="this.value=this.value.toUpperCase()" value="$namaPemohonx" size="50" maxlength="200" $setmodeR />
				          	...
				          	<input name="txtNamaPemohon" type="text" class="disabled" id="txtNamaPemohon2" style="text-transform:uppercase;"  onblur="this.value=this.value.toUpperCase()" value="$namaPemohonx" size="50" maxlength="200" readonly />
				            </span>
						#else
				         	...
				         	<input name="txtNamaPemohon" type="text" class="disabled" id="txtNamaPemohon2" style="text-transform:uppercase;"  onblur="this.value=this.value.toUpperCase()" value="$namaPemohon" size="50"  maxlength="200" readonly />
				       		</span>          
						#end 
			          ...
			          <td> #if ($idAlert == "1" || $idAlert == "2")
			            ...
			            <input name="txtAlamat1" type="text" class="disabled" id="txtAlamat12" style="text-transform:uppercase;"  onblur="this.value=this.value.toUpperCase()" value="$alamat1x" size="50"  maxlength="100" readonly />
			            </span>
			            #else
			            ...
			            <input name="txtAlamat1" type="text" class="disabled" id="txtAlamat12" style="text-transform:uppercase;"  onblur="this.value=this.value.toUpperCase()" value="$alamat1" size="50" maxlength="100" readonly />
			            </span>
			            #end </td>
			        </tr>
			        ...
			        <tr>
			          ...
			          <td> #if ($idAlert == "1" || $idAlert == "2")
			            ...
			            <input name="txtAlamat2" type="text" class="disabled" id="txtAlamat22" style=" text-transform:uppercase;"  onblur="this.value=this.value.toUpperCase()" value="$alamat2x" size="50" maxlength="100" readonly />
			            </span>           
			            ...
			            <input name="txtAlamat2" type="text" class="disabled" id="txtAlamat22" style="text-transform:uppercase;"  onblur="this.value=this.value.toUpperCase()" value="$alamat2" size="50" maxlength="100" readonly />
			            </span>
			        ...
			        <tr>
			          ...
			          <td> #if ($idAlert == "1" || $idAlert == "2")
			            ...
			            <input name="txtAlamat3" type="text" class="disabled" id="txtAlamat32" style="text-transform:uppercase;"  onblur="this.value=this.value.toUpperCase()" value="$alamat3x" size="50" maxlength="100" readonly />
			            </span>
			            ...
			            <span id="txtAlamat3_2b" >
			             <input name="txtAlamat3" type="text" class="disabled" id="txtAlamat32" style="text-transform:uppercase;"  onblur="this.value=this.value.toUpperCase()" value="$alamat3" size="50" maxlength="100" readonly />
			            </span>
			        ...
			        <tr>
			            ...
			            Poskod
			          	...
			          	<td> 
			            	...
			            	<input name="txtPoskod" id="txtPoskod2" type="text" style="width: 45px;" value="$poskodx" readonly class="disabled" maxlength="5" size="6" onKeyUp="javascript:validatePoskod(this,this.value)" onBlur="javascript:validatePoskod(this,this.value)"/>
			            	</span>
			            #else			            
			            	...
			            	<input name="txtPoskod" id="txtPoskod2" type="text" style="width: 45px;" value="$poskod" readonly class="disabled" maxlength="5" size="6" />
			            	</span>
			            #end 
			            </td>
			        </tr>        		      		
			        	...
			        	<td class="style38" valign="top" >&nbsp;</td>
			          	...
			          	<td>
			        		...
			        		<input name="no_tel" type="text" id="no_tel" style="text-transform:uppercase;" onBlur="uppercase()" value="$no_tel" size="14" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoTelefonPemohon')" maxlength="14" $setmodeR class="$setmode" />     
			       			...
			       			<span id="no_tel_1b">
			         		<input name="no_tel" type="text" id="no_tel2" style="text-transform:uppercase;" onBlur="uppercase()" value="$no_tel" size="14" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoTelefonPemohon')" maxlength="14" readonly class="disabled" />  
			        		</span>
			       		</td>
			        </tr>
			        ...
			        <tr id="tr_hp">
			        	<td class="style38" valign="top" >#if($setmode != "disabled") <span class="style1">*</span> #end</td>
			          	...
			          	<td>
			        		...
			        		<span id="no_hp_1b">
			         			<input name="no_hp" type="text" id="no_hp2" style="text-transform:uppercase;" onBlur="uppercase()" value="$no_hp" size="14" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoTelefonPemohon')" maxlength="14" readonly class="disabled" />  
			        		</span>			       
			          	</td>
			      	</tr>
			       	<tr>
 				...
 				parent.document.getElementById("info_skrin_daftar_sek8_simati").innerHTML="<div class=\"warning_online_ppk\"><b><blink>*</blink> Sila daftarkan maklumat Simati sebelum ke skrin seterusnya.</b></div>";
          		...
          		<table class="table100">
            		...
            		<tr>
						...
						<td width="1%">:</td> 
						<td width="9%">
							<input id="fileupload" name="uploadmyid" type="file" size="40">
						</td>
					</tr>             
 					<tr>
						<td valign="top" width="2%">
						...
						<td width="1%">:</td> 
						<td width="9%">
							<input id="fileupload2" name="uploadsijil" type="file" size="40">
						</td>
      				</tr>               	
          		</table>
			  	</fieldset>
	...
	<table>	
		<tr>
	    	<td>
		    	<span class="perhatian style1 style3"><em>Perhatian</em></span><span class="style3 style50"><em> : Sila masukkan salah satu nombor MyID dan pastikan label bertanda <span class="style1">*</span> diisi.</em></span>    
		    </td>
		  </tr>
	</table>	
#end
	...
	<!-- hidden field -->
	<input type="hidden" name="buktimati" value="$!buktimati"/>
	<input type="hidden" name="command"/>
 	<input type="hidden" name="flagForView" id="flagForView" value="$!flagForView"/>
	<input type="hidden" name="idPermohonan" value="$!IdPermohonan"/>
	<input type="hidden" name="id_Suburusanstatus" value="$!id_S"/>
	<input type="hidden" name="id_Suburusanstatusfail" value="$!id_SF"/>	
	<input type="hidden" name="mode"/>
  	<input type="hidden" name="sijilmati" value="$!sijilmati"/>
	<!-- Alamat -->
	<input type="hidden" name="socBandar" id="socBandar2" value="$daerah" maxlength="70"  />
	
	<!-- Maklumat Simati-->
	<input type="hidden" name="flag_dup_p1" id="flag_dup_p1"/>
	<input type="hidden" name="flag_dup_p2" id="flag_dup_p2"/>
	<input type="hidden" name="flag_dup_p3" id="flag_dup_p3"/>
				 
	<input type="hidden" name="check_no_kp_baru_pemohon" id="check_no_kp_baru_pemohon"/>   
	<input type="hidden" name="check_no_kp_lama_pemohon" id="check_no_kp_lama_pemohon"/>  
	<input type="hidden" name="check_no_kp_lain_pemohon" id="check_no_kp_lain_pemohon"/>  
	
	<input type="hidden" name="check_no_kp_baru_simati" id="check_no_kp_baru_simati"/>   
	<input type="hidden" name="check_no_kp_lama_simati" id="check_no_kp_lama_simati"/>  
	<input type="hidden" name="check_no_kp_lain_simati" id="check_no_kp_lain_simati"/>  

	<input type="hidden" name="jenis_pej" id="jenis_pej" value="$!jenis_pej" /> 
	
	<input type="hidden" name="socJantinaSimati" id="socJantinaSimati" value="$!jantinasimati" /> 
	<input type="hidden" name="txdTarikhLahirSimati" id="txdTarikhLahirSimati" value=""  />                 
	<input type="hidden" name="txtUmurSimati" id="txtUmurSimati" value="$!umursimati"  /> 
	
	<input type="hidden" name="socJantinaPemohon" id="socJantinaPemohon" value="$!jantinapemohon" /> 				     
	<input type="hidden" name="txtUmurPemohon" id="txtUmurPemohon" value="$!umurpemohon"  />
	...
	*/
		 ...
		 else if(document.f1.txtNoKPLainSimati != null && document.f1.txtNoKPLainSimati.value == 'yes')
		{
			...
			if (input_box == true) {
				...
				//document.f1.action = "?_portal_module=ekptg.view.ppk.FrmPrmhnnBorangAMaklumatPemohon&"+comm;
				document.f1.action = "";
				document.f1.submit();
...
return;
	...
	function check_kp() {		
		//alert("checkForm:form=${formName}");
		//var s = document.${formName}.txtNoKPBaruSimati1.value + document.${formName}.txtNoKPBaruSimati2.value + document.${formName}.txtNoKPBaruSimati3.value;
		//document.${formName}.check_no_kp_baru_simati.value = s;
...
url = "../servlet/ekptg.view.ppk.PendaftaranCheck";
	...
	function pilih_taraf(){
		...
		if(document.f1.taraf_penting.value != "6" 
			&& document.f1.taraf_penting.value != "8" 
			&& document.f1.taraf_penting.value != "2" 
			&& document.f1.taraf_penting.value != "4"){
		...
		}else if(document.f1.taraf_penting.value == "2" 
		|| document.f1.taraf_penting.value == "4"){
...
url = "../servlet/ekptg.view.ppk.PendaftaranCheck";
	...
	function kp_baru_pemohon(){
		...
		//alert("kp_baru_pemohon:$!skrin_online_popup")
		if('$!skrin_online_popup' == "yes"){
			url = "../../servlet/ekptg.view.ppk.PendaftaranCheck";
		}else{
			url = "../servlet/ekptg.view.ppk.PendaftaranCheck";
...
function ForView(noFail) {
	...
	function sorok_fieldset(IdFail){
		//alert("sorok_fieldset:IdFail="+IdFail);
		if(IdFail!="" && IdFail != 0){

...
<body  onload="submitForm();jeniswaktu2()" >
...
#foreach($list in $View)
 ...
 :::::      <input name="idSimati" type="input"  value="$idSimati"/>
...
#set($md=$listtarikhMohon)
                        ...
                        <td width="50%">
                            ...
                            <table width="100%" border="0">
                              <tr>
                                ...
                                <td width="28%"><div align="left" class="style38">No KP Baru</div></td>
  ...
  <div id="checkkp_result"> </div></td>
                              ...
                              <tr>
                                ...
                                <td ><div align="left" class="style38">No KP Lama</div></td>
                                <td class="style36" >:</td>
                              ...
                              <tr>
                                <td><span class="style38"></span></td>
                                <td><div align="left" class="style38">No KP Lain</div></td>
                                <td class="style36" >:</td>
                                <td class="style36" >
                                #if($readmode == "disabled")
                              ...
                              <tr>
                                ...
                                #else
                                  <input name="txtNoSijilMatiSimati" onBlur="this.value=this.value.toUpperCase()" type="text" id="txtNoSijilMatiSimati" style="text-transform:uppercase;" value="$listmati.noSijilMati" size="10" maxlength="25" $readmodesy />
                                #end
                                </label></td>
                              </tr>
                              ...
                              <tr>
                                <td valign="top" ><span class="style38">#if($readmode != "disabled") <span class="style49">*</span> #end</span></td>
                                <td ><div align="left" class="style38">#if($readmode == "disabled") Tarikh Mati                               #else
                                ...
                                <td> #if($readmode=="disabled")
                                  ...
                                  <a href="javascript:displayDatePicker('txdTarikhMatiSimati',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/> #end 
                        ...
                        <td valign="top"><table width="100%">
                            ...
                            <tr>
                              <td class="style38" valign="top" >#if($readmode != "disabled")
                                 <span class="style49">*</span>#end </td>
        ...
        <tr id="tr_pelbagainegara">
                  ...
                  <option value="$bandartetap">$listDaerahbyNegeriK - $listDaerahbyNegeriN</option>
                    ...
                    <table width="100%">
  <tr>
    <td><span class="style44">Perhatian</span><span class="style50"> : Sila masukkan salah satu nombor kad pengenalan  dan pastikan label bertanda <span class="style49">*</span> diisi.</span></td>
  </tr>
</table>
#end

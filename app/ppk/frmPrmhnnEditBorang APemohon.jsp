...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0">HARTA TAK ALIH</li>
    <li class="TabbedPanelsTab" tabindex="0">HARTA ALIH</li>
    <li class="TabbedPanelsTab" tabindex="0">PENGESAHAN PERMOHONAN</li>
  </ul>
    ...
    <div class="TabbedPanelsContent">
      <div id="TabbedPanels2" class="TabbedPanels">
        <ul class="TabbedPanelsTabGroup">
          ...
          <li class="TabbedPanelsTab" tabindex="0" onclick="javascript:PemohonView()">WARIS</li>
          <li class="TabbedPanelsTab" tabindex="0" onclick="javascript:PemohonView()">PEMIUTANG</li>
          <li class="TabbedPanelsTab" tabindex="0" onclick="javascript:PemohonView()">PENGHUTANG</li>
        </ul>
        <div class="TabbedPanelsContentGroup">
                              ...
                              <tr>
                                <td width="50%" valign="top">
                                    ...
                                    #set ($selectHub = "")
                                      ...
                                      <tr>
                                        ...
                                        <td class="style36"><input type="radio" name="sorPeguam" value="Y" $setmode3 $check1> Ya&nbsp;&nbsp;&nbsp;<input type="radio" name="sorPeguam" value="T" $setmode3 $check2> Tidak</td>
                                      </tr>
									  <tr>
                                ...
                                <td><table width="100%">
                                   ...
                                   <td class="style38"><div align="right" class="style38"><font class="mandatory" color="#FF0000">*&nbsp;</font>Poskod
                                      ...
                                      <tr> 
                                        <td class="style38" ><div align="right" class="style38">Catatan :</div></td>

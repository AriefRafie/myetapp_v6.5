...
#if($skrinName == "tukarpegawaiKPP2")
<fieldset>
#end


#if($SuccessMesej!="")   
<div class="info" id="success_viewTukarPegawai2" align="left">
    #if($SuccessMesej=="PermohonTukarPegawai2")	    
    Permohonan Tukar Pegawai Berjaya Didaftarkan  
    #elseif($SuccessMesej=="KelulusanTukarPegawai2")	    
    Kelulusan Permohonan Tukar Pegawai Berjaya Didaftarkan  
    #end
    <script >
	$jquery("#success_viewTukarPegawai2").show().delay(3000).fadeOut();
	</script>
</div>
#end
...
#if($command == "openSkrinTukarPegawai2" || $command == "openSkrinTukarPegawai2")
 <script>
 //alert('$div'); 
...
#elseif($command == "resetTukarPegawai2") 
  <script>
 	checkTPCheckBox('');
 </script>  
#end
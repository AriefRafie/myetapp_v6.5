...
#if ($idFlag == "2" && $ViewLama!="")

    #foreach($View in $ViewLama)
    #set ($socSaudaraWaris = $View.socSaudaraWaris)
       ...
       #set($noFailBaru  = "")
        ...
        #set ($idDaerahx = $View.idDaerah)
         ...
         #set ($id_Suburusanstatusfail = $View.id_Suburusanstatusfail)
          #set ($id_Suburusanstatus = $View.id_Suburusanstatus)
...
#if ($idFlag == "2" && $ViewBaru!="")

 #foreach($ViewL in $ViewBaruNoFailLama)
 #set($noFail = $ViewL.noFail)
    ...
    #foreach($View in $ViewBaru)
        ...
        #set ($tarikhMohon = $View.tarikhMohon)
        #set ($tarikhmohondaftar = $View.tarikhMohon)
        #set ($noKpBaru1 = $View.noKpBaru1)
        #set ($noKpBaru2 = $View.noKpBaru2)
        #set ($noKpBaru3 = $View.noKpBaru3)
        #set ($noKpLama = $View.noKpLama)
...
#if ($msg_permohonansebelum == "yes")
<script type="text/javascript">
	//window.location="?_portal_module=ekptg.view.ppk.FrmPrmhnnSek8SenaraiSemakInternal";	
	alert("Pendaftaran utk permohonan baru tidak bejaya! \nPermohonan terdahulu '$noFail' telah digunakan. \nSila ke menu senarai fail tugasan untuk semakan lanjut.")
	
	
</script>
#end

<body onLoad="submitForm();calcDate();pilih_taraf();check_kp_pemohon_onload();selectPelbagaiNegara('$negeri','div_mesejpelbagagainegara','tr_pelbagainegara','nama_pelbagainegara');">
...
<input name="t_status" type="hidden"/>


 <input name="id_Suburusanstatusfail" type="hidden"  value="$listFail.id_Suburusanstatusfail"/>
<input name="id_Permohonanterdahulu" type="hidden"  value="$listFail.id_Permohonan" />
#end


<input name="id_Permohonan_terdahulu" type="hidden"  value="$id_Permohonan_terdahulu" />
<input name="idtempTerdahulu" type="hidden"  value="$id_Permohonan_terdahulu" />
<input name="txtNomborResitH" type="hidden" value="$txtNomborResitH" />
<input name="txdTarikhByrnH" type="hidden" value="$txdTarikhByrnH" />
...
#if($pendaftaran == "")
<div align="right"> 
#if ($flagFromSenaraiFailSek8 == '' && $flagFromSenaraiPermohonanSek8 == '' && $flagForView  == '' && $pendaftaran == "")<a href="javascript:javascript:Kembali()" class="style1" ><img src="../img/1enable.png" alt="" border="0" title="Senarai Permohonan"/></a><img src="../img/arrowgaris.png" alt="" border="0"/>#end#if($flagFromSenaraiFailSek8 == 'yes')<a href="javascript:javascript:kembaliSenaraiFail('$nfb')" class="style1" ><img src="../img/1enable.png" alt="" border="0" title="Senarai Permohonan"/></a><img src="../img/arrowgaris.png" alt="" border="0"/>#end#if($flagFromSenaraiPermohonanSek8 == 'yes')<a href="javascript:kembaliSenaraiPermohonan('$nfb')" class="style1" ><img src="../img/1enable.png" alt="" border="0" title="Senarai Permohonan" /></a><img src="../img/arrowgaris.png" alt="" border="0"/>#end#if($flagForView  == 'yes')<a href="javascript:ForView('$noFail')" class="style1"><img src="../img/1enable.png" alt="" border="0" title="Senarai Permohonan"/></a><img src="../img/arrowgaris.png" alt="" border="0"/>#end#if($pendaftaran == "yes")<a href="javascript:kembalidaftar()" class="style1" ><img src="../img/2enable.png" alt="" border="0" title="Senarai Semak" /></a>#else<a href="javascript:kembalix()" class="style1"  ><img src="../img/2enable.png" alt="" border="0" title="Senarai Semak"/></a>#end<img src="../img/arrowgaris.png" alt="" border="0"/><img src="../img/3current.png" alt="" border="0" title="Pendaftaran Permohonan"/><img src="../img/arrowgaris.png" alt="" border="0"/>#if ($noFailBaru != "")<a href="javascript:seterusnya_tab()" class="style1" ><img src="../img/4enable2.png" alt="" border="0" title="Maklumat Permohonan"/></a>#else<img src="../img/4disable.png" alt="" border="0" title="Maklumat Permohonan" />#end
</span></div>
#else
<div align="right"> 
#if($pendaftaran == "yes")<a href="javascript:kembalidaftar()" class="style1" ><img src="../img/1enable.png" alt="" border="0" title="Senarai Semak" /></a>#else<a href="javascript:kembalix()" class="style1"  ><img src="../img/1enable.png" alt="" border="0" title="Senarai Semak"/></a>#end<img src="../img/arrowgaris.png" alt="" border="0"/><img src="../img/2current.png" alt="" border="0" title="Pendaftaran Permohonan"/><img src="../img/arrowgaris.png" alt="" border="0"/>#if ($noFailBaru != "")<a href="javascript:seterusnya_tab()" class="style1" ><img src="../img/3enable2.png" alt="" border="0" title="Maklumat Permohonan"/></a>#else<img src="../img/3disable.png" alt="" border="0" title="Maklumat Permohonan" />#end
</span></div>
#end
...
<table width="100%" border="0" id="main_table">
  ...
  <span class="style4">$nfb</span>
   
            
                
           <input name="txtNoFailBaru" id="txtNoFailBaru" type="hidden" value="$noFailBaru" style="width: 210px;" />
              ...
              <tr>
                ...
                #end
                <span class="style1">$noFail</span>
               <input name="txtNoFail" id="txtNoFail" type="hidden" value="$noFail" style="width: 195px;" class="disabled" readonly />                </td>
              </tr>
...
<input type="hidden" name="socDaerah" value="$idDaerahx" />
              <!--
              <tr>
                <td>Daerah   </td>
                <td>:</td>
                <td><span style="width: 195px; text-transform:uppercase;">
...
<option value="$idDaerah" >$kodDaerah - $namaDaerah</option>
              ...
              <tr>
                <td valign="top">#if($setmode != "disabled")<span class="style5">*</span>#end</td>
                <td>#if($setmode != "disabled")Tarikh Mohon #else Tarikh Mohon #end</td>
                <td>:</td>
                <td>
         
            #set($t=$tarikhmohonXX)
           
            <input name="txdTarikhMohon" id="txdTarikhMohon" style="width: 80px;" type="text" value="$t" size="11" maxlength="10" onBlur="trans_date(this.value)" />            <a href="javascript:displayDatePicker('txdTarikhMohon',false,'dmy');"><img border="0" src="../img/calendar.gif"/></a>  <span class="style7">dd/mm/yyyy </span></td>
              </tr>
 ...
 <input name="tdaftar" id="tdaftar"  type="hidden" value="$tarikhmohonx" />
            ...
            #set($t=$tarikhmohon)
            #end 
            <input name="txdTarikhMohon" id="txdTarikhMohon" style="width: 80px;" type="text" $setmodeR class="$setmode"value="$t" size="11" maxlength="10" onBlur="trans_date(this.value)" />
            
             <input name="tdaftar" id="tdaftar"  type="hidden" value="$t" />
            
#end
            #if ($EventStatus == "0") <a href="javascript:displayDatePicker('txdTarikhMohon',false,'dmy');"><img border="0" src="../img/calendar.gif"/></a>  <span class="style7">dd/mm/yyyy </span>#end 
          ...
          <tr>
            ...
            <fieldset><legend>MAKLUMAT SIMATI</legend>
            
            <table width="100%" border="0">
              <tr>
                <td width="1%">&nbsp;</td>
                <td width="29%">MyID Baru</td>
                <td width="1%">:</td>
                <td width="70%">#if ($idAlert == "1" || $idAlert == "2") 
                  <span class="style1">
                  #if($nokpbaru1x == "" && $nokpbaru2x == "" && $nokpbaru3x == "")
                  -
                  #else
                  $nokpbaru1x - $nokpbaru2x - $nokpbaru3x
                  #end                  </span>
                  <input name="txtNoKPBaruSimati1" id="txtNoKPBaruSimati1" style="width: 50px;" type="hidden" value="$nokpbaru1x" size="7" maxlength="6" $setmode onKeyUp="javascript:validateIC(this,this.value,'txtNoKPBaruSimati2')"  onBlur="getAgeByIC(this,this.value,'txtUmurSimati')" />
                  <input name="txtNoKPBaruSimati2" id="txtNoKPBaruSimati2" style="width: 20px;" type="hidden" value="$nokpbaru2x" size="3" maxlength="2" $setmode onKeyUp="javascript:validateIC(this,this.value,'txtNoKPBaruSimati3')"/>
                  <input name="txtNoKPBaruSimati3" id="txtNoKPBaruSimati3"  style="width: 40px;" type="hidden" value="$nokpbaru3x" $setmode size="5" maxlength="4"  onblur="jantinaic()" />
#else 
               <span class="style1">
               #if($noKpBaru1=="" && $noKpBaru2=="" && $noKpBaru3=="")
               -
               #else
               $noKpBaru1 - $noKpBaru2 - $noKpBaru3
               #end               </span>
<input name="txtNoKPBaruSimati1" id="txtNoKPBaruSimati1" style="width: 50px;" type="hidden" value="$noKpBaru1" size="7" maxlength="6" $setmode onKeyUp="javascript:validateIC(this,this.value,'txtNoKPBaruSimati2')" onBlur="getAgeByIC(this,this.value,'txtUmurSimati')"  />
<input name="txtNoKPBaruSimati2" id="txtNoKPBaruSimati2" style="width: 20px;" type="hidden" value="$noKpBaru2" size="3" maxlength="2" $setmode onKeyUp="javascript:validateIC(this,this.value,'txtNoKPBaruSimati3')"/>
<input name="txtNoKPBaruSimati3" id="txtNoKPBaruSimati3"  style="width: 40px;" type="hidden" value="$noKpBaru3" $setmode size="5" maxlength="4" onBlur="jantinaic()" />
#end
...
<input name="socJantinaPemohon" type="hidden" value="$!jantinapemohon" />
 ...
 #set($kpbs = "$noKpBaru1${noKpBaru2}${noKpBaru3}")
 <input name="check_no_kp_baru_simati" id="check_no_kp_baru_simati" type="hidden" value="$!kpbs"  />   
              ...
              <tr>
                ...
                #else
                <span class="style1" style="width: 120px; text-transform:uppercase;" >$noKpLamax</span>
                #end
              
                  <input name="txtNoKPLamaSimati" id="txtNoKPLamaSimati" type="hidden" value="$noKpLamax" $setmode maxlength="15" size="10" style="width: 120px; text-transform:uppercase;"/>
                   <input name="check_no_kp_lama_simati" id="check_no_kp_lama_simati" type="hidden"  value="$noKpLamax" />  
#else
                ...
                <span class="style1">-</span>
                #else
                <span class="style1" style="width: 120px; text-transform:uppercase;"  >$noKpLama</span>
                #end
              
<input name="txtNoKPLamaSimati" id="txtNoKPLamaSimati" type="hidden" value="$noKpLama" $setmode maxlength="15" size="10" style="width: 120px; text-transform:uppercase;"/>
    <input name="check_no_kp_lama_simati" id="check_no_kp_lama_simati" type="hidden"  value="$noKpLama"/>
#end </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
               ...
               <!-- <select name="socJenisKPLainSimati" id="socJenisKPLainSimati" $setmode style="width: 100px; text-transform:uppercase;" onchange="kplain(this.value)"/> -->
               ...
               <!--         <option value="$Listkp.id" $selected/>   -->                      
                      #set($kkp =  $Listkp.keterangan )
                      #set($kkp_id =  $jenisKpMati)
                     <!--   </option> -->
#end
...
<!-- </option> -->
#end
 <span class="style1" style="width: 200px; text-transform:uppercase;" >
                    #if($kkp_id == "" || $kkp_id == "0")
                    -                    
                    #else
                    $kkp -
                    #end                    </span>
                     <input name="socJenisKPLainSimati" id="socJenisKPLainSimati" type="hidden" value="$kkp_id" />
            #else
                #if ($idFlag == "2")
                    ...
                    #foreach($Listkp in $listkp)
                    		...
                    		#set ($selected = "selected")
                         <!--   <option value="$Listkp.id" $selected/>  -->                          
                           #set($kk = $Listkp.keterangan)
                           #set($kk_id = $jenisKpMati)
...
-->
                    ...
                    $kk -
                    #end                    </span>
                    <input name="socJenisKPLainSimati" id="socJenisKPLainSimati" type="hidden" value="$kk_id" />
...
-->
  <span class="style1">-</span>
  <input name="socJenisKPLainSimati" id="socJenisKPLainSimati" type="hidden" value="0" />
                #end
            #end
<!-- </select> -->
#if ($idAlert == "1" || $idAlert == "2") 
             ...
             <span class="style1">$noKpLainx</span>
             <input name="txtNoKPLainSimati" id="txtNoKPLainSimati" style="width: 97px; text-transform:uppercase;" type="hidden" value="$noKpLainx" $setmod maxlength="9" />
             <input name="check_no_kp_lain_simati" id="check_no_kp_lain_simati" type="hidden"  value="$noKpLainx" /> 
#else
             ...
             <span class="style1">$noKpLain</span>
             <input name="txtNoKPLainSimati" id="txtNoKPLainSimati" style="width: 97px; text-transform:uppercase;" type="hidden" value="$noKpLain" $setmod maxlength="9" />
              <input name="check_no_kp_lain_simati" id="check_no_kp_lain_simati" type="hidden"  value="$noKpLain" /> 
#end</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td>#if ($idAlert == "1" || $idAlert == "2")
                  ...
                  <span class="style1" style="width: 200px; text-transform:uppercase;" >$namaSimatix</span>
                  <input name="txtNamaSimati" id="txtNamaSimati" style="width: 200px; text-transform:uppercase;" type="hidden" value="$namaSimatix" $setmode maxlength="200"/>
#else
<span class="style1" style="width: 200px; text-transform:uppercase;" >$namaSimati</span>
              	<input name="txtNamaSimati" id="txtNamaSimati" style="width: 200px; text-transform:uppercase;" type="hidden" value="$namaSimati" $setmode maxlength="200"/>
#end</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td>:</td>
                <td>#if ($idAlert == "1" || $idAlert == "2")
              		<span class="style1">$tarikhMatix</span>
                  <input name="txtTarikhMati" id="txtTarikhMati" type="hidden" style="width: 80px;" value="$tarikhMatix" size="11" maxlength="10" $setmode readonly/>
#else
<span class="style1">$tarikhMati</span>
<input name="txtTarikhMati" id="txtTarikhMati" type="hidden" style="width: 80px;" value="$tarikhMati" size="11" maxlength="10" $setmode readonly/>
#end
              #if ($flag_no != 3 ) 
              <!--
              <a href="javascript:displayDatePicker('txtTarikhMati',false,'dmy');"/><img src="../img/calendar.gif" alt="" border="0"/>
              </a> 
              -->
              #end</td>
              </tr>
        ...
        <fieldset><legend>MAKLUMAT PEMOHON</legend>
         ...
         <table width="100%" border="0">
          ...
          #if($show_pemohonsimati == "yes")
          
          #if($pemohonbaru == "yes")
          #set($checkedP1 = "checked")
          #set($checkedP2 = "")
          #end
          
          #if($kosongkan_pemohon == "yes")
            #set($noKpBaruPemohon1 = "")
            #set($noKpBaruPemohon2 = "")
            #set($noKpBaruPemohon3 = "")
            #set($noKpLamaPemohon = "")
...
#set ($jenis_pemohon = "2")
        ...
        <tr>
          <td colspan="5">
            ...
            <tr>
              <td width="3%">&nbsp;</td>
              <td width="3%"><label>
                <input type="radio" name="radioP" id="radioB" $checkedP1 value="B" onClick="getPemohon('radioB')">
              </label></td>
              <td width="40%">Pemohon Baru</td>
              <td width="3%"><label>
                <input type="radio" name="radioP" id="radioL" $checkedP2 value="L" onClick="getPemohon('radioL')">
              </label></td>
              <td width="51%">Pemohon / OB Terdahulu</td>
              </tr>
              
      <!--     
       pemohonSimati :: $pemohonSimati
        pemohonlama :: $pemohonlama  
        -->  
            #if($pemohonlama == "yes")
            #if($pemohonSimati != "")
       <!--     :: $listPemohonD17 -->
    
            #foreach($LX in $listPemohonD17)            
            #set($noKpBaruPemohon1 = "$LX.noKpBaru1")
            #set($noKpBaruPemohon2 = "$LX.noKpBaru2")
            #set($noKpBaruPemohon3 = "$LX.noKpBaru3")
            #set($noKpLamaPemohon = "$LX.noKpLama")
            #set($jenisKpPemohon = "$LX.jenisKp")
            #set($noKpLainPemohon = "$LX.noKpLain")
            #set($namaPemohon = "$LX.namaPemohon")
            #set($alamat1 = "$LX.alamat1")
            #set($alamat2 = "$LX.alamat2")
            #set($alamat3 = "$LX.alamat3")
            #set($poskod = "$LX.poskod")
            #set($negeri = "$LX.idnegeri")
            #set($daerah = "$LX.bandartetap")
            #set($pemohonSimati = "$LX.idob")            
            #set ($taraf_penting = "$LX.idTarafkptg")
            #set ($no_tel = "$LX.noTel")
            #set ($nama_pelbagainegara = "$LX.nama_pelbagainegara")
            #set ($no_hp = "$LX.noHp")
            #set ($jenis_pej = "$LX.jenis_pej")
            ...
            <tr>
              ...
              <td>
                ...
                <select name="pemohonSimati" id="pemohonSimati" style="text-transform:uppercase;" class="autoselect" onChange="getPemohon('radioL')">
                
                #if($pemohonSimati == "")
                <option value="" >SILA PILIH PEMOHON</option>
                #foreach($lsp in $listSenaraiPemohonSimati)               
                <option value="$lsp.id_pemohon" >$lsp.nama_pemohon</option>                
                #end
                #else
                #foreach($lsp in $listSenaraiPemohonSimati)
                #if($pemohonSimati == $lsp.id_pemohon)
                #set($namaP = $lsp.nama_pemohon)
                #end
                
                #end
                <option value="$pemohonSimati" >$namaP</option>
           ...
           <input name="idpemohonsimati" type="hidden" id="idpemohonsimati" value="$!idpemohonsimati" >
            

            #end
            </table>
             <span class="style9">
             Perhatian</span><span class="style10"> : Sila pilih salah satu jenis pemohon.     
                  </span>
         ...
         <input type="hidden" name="radioP" id="radioB" value="B" >
          <input type="hidden" name="radioP" id="radioL"  value="L" >
           <input name="pemohonSimati" type="hidden" id="pemohonSimati" value="XX" >
           </label>
    #end
      ...
      <input nama="tp" id="tp" type="hidden" value="$taraf_penting" />
            ...
            <td valign="top"><span class="style5">#if($setmode != "disabled") * #end</span></td>
        ...
        <tr id="pentadbir_tanah" >
    
        
          <td >&nbsp;</td>
          <td >Pentadbir Tanah</td>
          <td >:</td>
          <td >      
          ...
          <option value="">SILA PILIH </option>   
           ...
           #else
           #foreach($listJ in $listMaklumatPentadbirTanah)
           #if( $listJ.id_Pejabat == $jenis_pej )              
           #set($listJid_Pejabat = $listJ.id_Pejabat)
           #set($listJnama_pejabat=$listJ.nama_pejabat)
           #set($listJdaerah = $listJ.daerah)  
           ...
           #end        
                                  #foreach($listJ in $listMaklumatPentadbirTanah)
                                  #if($jenis_pej != $listJ.id_Pejabat && $listJ.jenispejabat == '2' )
	                              <option value="$listJ.id_Pejabat">$listJ.nama_pejabat , $listJ.namabandar </option>
                                  #end 
                                  #end 
...
<select name="jenis_pemohon"  class="autoselect" $readmode id="jenis_pemohon" style="text-transform:uppercase;" onBlur="uppercase()" onChange="pilih_taraf()" >        
  ...
  <option value="$Listkp.id">$Listkp.keterangan </option>
           ...
           <input name="txtNoKPLainPemohon" id="txtNoKPLainPemohon" onBlur="this.value=this.value.toUpperCase();kp_lain_pemohon()" style="width: 90px; text-transform:uppercase;" type="text" value="$noKpLainPemohon" $setmod1R class="$setmod1" maxlength="25" size="9"/>
           <div id="check_kp_p3" style="color:red" ></div>
            #end </td>
        </tr>
        ...
        #if($EventStatus!=3)
        <tr>
          <td valign="top" class="style38 style5" >#if($setmode != "disabled") <span class="style5">*</span> #end</td>
...
<select name="socNegeri" class="autoselect" $setmode  onchange="getBandar('socBandar');get_bandar_simati()" style="text-transform:uppercase;" onBlur="uppercase()">
 ...
 <tr>
  <td><span class="style9">Perhatian</span><span class="style10"> : Sila masukkan salah satu nombor MyID dan pastikan label bertanda <span class="style5">*</span> diisi.</span></td>
    ...
    <input type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onClick="Simpan()"/>
     <input type="button" name="cdmBatal" id="cdmBatal" value="Batal" onClick="Batal()"/>
      ...
      <input type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onClick="Simpan()"/>
        ...
        #end
        #if($ViewFail.size()==0)      
        <input type="button" name="cdmBatal" id="cdmBatal" value="Batal" onClick="Batal1()"/>
        #end
        
        #if($dah_daftar_ke=="belum")
      <!--
...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
		<tr>
        	<td ><a href="#" class="style1" onClick="javascript:cetakDokumen('$IdPermohonan','PPKSemakanSek17')"> Senarai Semak </a></td>
      	</tr>
    <!---->
	      <tr>
	        <td ><a href="#" class="style2  style1" onClick="javascript:cetak('$noFailBaru','$IdFail')"> Kulit Fail </a></td>
	      </tr>     
	      <tr>
	        <td > <a href="#" class="style2  style1" onClick="javascript:cetakSuratAkuanTerima('$noFailBaru')">Surat Akuan Terima</a></td>
	      </tr>
	      <!---->
	      <tr>     
	        <td ><a href="#" class="style2  style1" onClick="javascript:cetakSuratIringanBorangB('$noFailBaru')">Surat Iringan Borang B</a></td>      
	      </tr>
       
       <tr>
         <td >
         #set ($flagSeksyen17 = "yes") 
      ...
      <!---->
      	#set($NoFail = $noFail)
      <tr>
        <td ><a href="#" class="style2 style1" onClick="javascript:cetakSuratPeringatanMaklumatTambahan('$NoFail')">Surat Peringatan</a></td>
      </tr> 
       	<tr>
       		<td ><a href="#" class="style2  style1" onClick="cetakBorangB('$NoFail','$IdFail')">Borang B</a></td>
      	</tr>      
       	<!-- Edited by Salnizam SDS 10.2.3.1.6 A
       	<tr>
        	<td ><a href="#" class="style2 style1" onClick="javascript:cetakBorangB2('$NoFail','$idFail','$flagFromSenaraiFailSek8','$flagForView')">Borang B (Cetakan Secara Landskap)</a></td>
      	</tr>  -->
       	<tr>
        	<td ><a href="#" class="style2 style1" onClick="javascript:cetakDokumen('$IdPermohonan','RPF')">Rekod Pendaftaran Fail</a></td>
    	</tr>
    </table>
</fieldset> 
...
<input name="id_Permohonansimati" type="hidden" value="$id_Permohonansimati"/>
...
//alert(document.f1.jenis_pemohon.value)
  var dt=document.f1.txtTarikhMati
   ...
   var date2 = new Date(yr2, mon2, dt2);
 	...
 	if(document.f1.radioP[1].checked == true && document.f1.pemohonSimati.value == "" )
	{
		alert("Sila pilih pemohon terdahulu");
		document.f1.pemohonSimati.focus();
	}
	...
	else if (document.f1.taraf_penting.value == "0" || document.f1.taraf_penting.value == "") {
...
function Simpan() {
  ...
  var dt=document.f1.txtTarikhMati
   ...
   var date2 = new Date(yr2, mon2, dt2);
	...
	else if (isNaN(document.f1.txtNoKPBaruPemohon1.value)) {
		alert("Sila masukkan nombor sahaja");
		document.f1.txtNoKPBaruPemohon1.focus();
	}
	else if (isNaN(document.f1.txtNoKPBaruPemohon2.value)) {
		alert("Sila masukkan nombor sahaja");
		document.f1.txtNoKPBaruPemohon2.focus();
	}
	else if (isNaN(document.f1.txtNoKPBaruPemohon3.value)) {
		alert("Sila masukkan nombor sahaja");
		document.f1.txtNoKPBaruPemohon3.focus();
	}
	else if (document.f1.txtNoKPBaruPemohon1.value !="" && document.f1.txtNoKPBaruPemohon1.value.length<6) {
		alert("Sila masukkan MyID Baru Pemohon dengan lengkapnya");
		document.f1.txtNoKPBaruPemohon1.focus();
	}
	else if (document.f1.txtNoKPBaruPemohon2.value !="" && document.f1.txtNoKPBaruPemohon2.value.length<2) {
		alert("Sila masukkan MyID Baru Pemohon dengan lengkapnya");
		document.f1.txtNoKPBaruPemohon2.focus();
	}
	else if (document.f1.txtNoKPBaruPemohon3.value !="" && document.f1.txtNoKPBaruPemohon3.value.length<4) {
		alert("Sila masukkan MyID Baru Pemohon dengan lengkapnya");
		document.f1.txtNoKPBaruPemohon3.focus();
	}
	else if (document.f1.txtNoKPBaruPemohon1.value=="" && document.f1.txtNoKPBaruPemohon2.value=="" && document.f1.txtNoKPBaruPemohon3.value=="" && document.f1.txtNoKPLamaPemohon.value=="" && document.f1.socJenisKPLainPemohon.value=="0" && document.f1.txtNoKPLainPemohon.value=="") {
		alert("Sila masukkan salah satu MyID Pemohon.");
		document.f1.txtNoKPBaruPemohon1.focus();
	}
	else if (document.f1.txtNoKPBaruPemohon1.value!="" && document.f1.txtNoKPBaruPemohon2.value=="" && document.f1.txtNoKPBaruPemohon3.value=="" ) {
		alert("Sila lengkapkan MyID Pemohon.");
		document.f1.txtNoKPBaruPemohon2.focus();
	}
	else if (document.f1.txtNoKPBaruPemohon1.value!="" && document.f1.txtNoKPBaruPemohon2.value!="" && document.f1.txtNoKPBaruPemohon3.value=="" ) {
	...
	else if (document.f1.txtNoKPBaruPemohon2.value!="" && document.f1.txtNoKPBaruPemohon1.value=="" && document.f1.txtNoKPBaruPemohon3.value!="" ) {
		alert("Sila lengkapkan MyID Pemohon.");
		document.f1.txtNoKPBaruPemohon1.focus();
	}
	else if (document.f1.txtNoKPBaruPemohon2.value!="" && document.f1.txtNoKPBaruPemohon1.value=="" && document.f1.txtNoKPBaruPemohon3.value=="" ) {
	...
	else if (document.f1.txtNoKPBaruPemohon3.value!="" && document.f1.txtNoKPBaruPemohon1.value=="" && document.f1.txtNoKPBaruPemohon2.value=="" ) {
		alert("Sila lengkapkan MyID Pemohon.");
		document.f1.txtNoKPBaruPemohon1.focus();
	}
	
	else if (document.f1.txtNamaPemohon.value=="") {
		alert("Sila masukkan nama pemohon.");
		document.f1.txtNamaPemohon.focus();
	} 
	...
	else if (document.f1.txtAlamat1.value == "" || document.f1.socNegeri.value == "" || document.f1.socNegeri.value == "0" || document.f1.txtPoskod.value == "" || document.f1.socBandar.value == "0" || document.f1.socBandar.value == "") {
		alert("Sila masukkan alamat tetap pemohon dengan lengkap");
	...
	else if (document.f1.txtNoKPBaruPemohon1.value != "" && isIc(tt1)==false){
		document.f1.txtNoKPBaruPemohon1.focus()
		return false
	}
	
	else if (document.f1.txtNoKPBaruPemohon2.value != "" &&(negeri_code1!="01" && negeri_code1!="21" && negeri_code1!="22" && negeri_code1!="23" && negeri_code1!="24" && negeri_code1!="02" && negeri_code1!="25" && negeri_code1!="26" && negeri_code1!="27" && negeri_code1!="03" && negeri_code1!="28" && negeri_code1!="29" && negeri_code1!="04" && negeri_code1!="30" && negeri_code1!="05" && negeri_code1!="31" && negeri_code1!="59" && negeri_code1!="06" && negeri_code1!="32" && negeri_code1!="33" && negeri_code1!="07" && negeri_code1!="34" && negeri_code1!="35" && negeri_code1!="08" && negeri_code1!="36" && negeri_code1!="37" && negeri_code1!="38" && negeri_code1!="39"  && negeri_code1!="09" && negeri_code1!="40" && negeri_code1!="10" && negeri_code1!="41" && negeri_code1!="42" && negeri_code1!="43" && negeri_code1!="44" && negeri_code1!="11" && negeri_code1!="45" && negeri_code1!="46" && 
		negeri_code1!="12" && negeri_code1!="47" && negeri_code1!="48" && negeri_code1!="49" &&
		 negeri_code1!="13" && negeri_code1!="50" && negeri_code1!="51" && negeri_code1!="52" && negeri_code1!="53" && 
		 negeri_code1!="14" && negeri_code1!="54" && negeri_code1!="55" && negeri_code1!="56" && negeri_code1!="57" &&
		  negeri_code1!="15" && negeri_code1!="58" &&
...
function getPemohon(v_t)
{

        document.f1.method = "POST";
		document.f1.command.value="getPemohon";
		document.f1.eventStatus.value="1";
		document.f1.action = "";
		document.f1.v_tab.value = v_t;
		document.f1.submit();
...
function cetakSuratAkuanTerima(noFail) {
	var url = "../x/${securityToken}/ekptg.report.ppk.FrmPopupPilihPegawaiReportView?noFail="+noFail+"&report=suratAkuanTerimaP&flagReport=S";
...
function cetakBorangB(noFail,idfail) {
    ...
    if (hWnd.focus != null) hWnd.focus();
		...
		document.f1.t_status.value="yes";
...
if(document.f1.taraf_penting.value != "6" && document.f1.taraf_penting.value != "8" && document.f1.taraf_penting.value != "20" && document.f1.taraf_penting.value != "2" && document.f1.taraf_penting.value != "4")
{
...
if(document.f1.taraf_penting.value != "1")
		...
		document.getElementById('amanah').style.display="none";
		document.getElementById('baitulmal').style.display="none";
		document.getElementById('pentadbir_tanah').style.display="none";
...
else if(document.f1.taraf_penting.value == "20") //Pentadbir Tanah
{
...
document.getElementById('amanah').style.display="none";
document.getElementById('baitulmal').style.display="none";
document.getElementById('pentadbir_tanah').style.display="";
}
		document.getElementById("kp1").style.display="none";	
		document.getElementById("kp2").style.display="none";	
		document.getElementById("kp3").style.display="none";		
...
if(document.f1.taraf_penting.value == "6" || document.f1.taraf_penting.value == "8" || document.f1.taraf_penting.value == "20"){

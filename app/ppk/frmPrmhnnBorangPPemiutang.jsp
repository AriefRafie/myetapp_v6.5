            ...
            <table width="99%">
	                                 ...
	                                 #set ($checkedDropMenu="")
                                       ...
                                       #foreach($listob in $listPentingbyIDOB)
			                                ...
			                                #set ($checkedDropMenu="readonly class=disabled")
			                                #set ($jenishutang1="readonly")
	                                 		#set ($jenishutang2="")
     ...
     <tr>							
                              ...
                              <tr>
                               <td width="80%" valign="top"><table width="100%">
                                ...
                                <tr>
                                  ...
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"> 
 									 <select name="socJenisKPLainPenting" $checkedDropMenu $readmode id="socJenisKPLainPenting" style="text-transform:uppercase;width: 146px">
								   #if($listob.jeniskp=="1")
                                ...
                                <tr>
                                  ...
                                  <td class="style36" style="text-transform:uppercase;"> 
 									 <select name="socJenisKPLainPenting"  style="width: 146px;" $checkedDropMenu $readmode id="socJenisKPLainPenting" style="text-transform:uppercase;">
								   #if($listob.jeniskp=="1")
									   <option value="1">Tentera</option>
                                      <option value="2">Polis</option>
                                      <option value="3">Pasport</option>
                                  ...
                                  #else
                                   <tr>
                                    <td><div align="right"><span class="style38">Nama Pemiutang</span></div></td>
                                    <td><div align="right"><span class="style38">:</span></div></td>
                                    <td><label>
                                      <input name="txtNamaOBPenting" type="text" id="txtNamaOBPenting" value="$nama" size="34" $jenishutang1 style="text-transform:uppercase;"  $readmode/>
                                    </label></td>
                                  ...
                                  <td><!--<label>
                                    <input name="txtBandarPenting" type="text" id="txtBandarPenting" value="$listob.bandar" size="34" $readmode style="text-transform:uppercase;"/>
                                        ...
                                        <tr>
                                          ...
                                          <td><textarea name="txtButiranHutangPenting" cols="34"  rows="3"  $readmode id="txtButiranHutangPenting" style="text-transform:uppercase;" >$listob.butiranhutang</textarea></td>
                                      </tr> 
                                </table></td>
                              </tr>
                            </table>
                            ...
                            <table width="100%" border="0">
                              <tr>
                                ...
                                <tr>
                                  <td ><div align="right">No Syarikat</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36"><label>
                                ...
                                <tr>
                                  <td><div align="right"><span class="style38">Lain-lain KP</span></div></td>
                                  <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  <td class="style36" style="text-transform:uppercase;"> <select name="socJenisKPLainPenting"  style="width: 146px;" $checkedDropMenu $readmode style="text-transform:uppercase;">
								   #if($jenisKp=="1")
                                      <option value="1">TENTERA</option>
                                      <option value="2">POLIS</option>
                                      <option value="3">PASPORT</option>
...
<tr>
                                ...
                                <tr>
                                  ...
                                  <td class="style36" style="text-transform:uppercase;"> <select name="socJenisKPLainPenting"  style="width: 146px;" $checkedDropMenu $readmode style="text-transform:uppercase;">
                                      ...
                                      <option value="3">PASPORT</option>
	                               #end
                                    </select>&nbsp;<input name="txtNoKPLainPenting" type="text" id="textfield5" value="$!nolain" size="9" maxlength="9" $readmode style="text-transform:uppercase;" $jenishutang1/>
									 </td>
                                </tr>                             #end   
                                 #if ($socJenisHutang=="2")       
                                  <tr>
...
<tr>
                                ...
                                <tr>
                                  ...
                                  <td><div align="right"><span class="style38">:</span></div></td>
                                  <td><select name="socDaerah" id="socDaerah" style="width: 225px;" $setmode2>
                                ...
                                <tr>
                                  ...
                                  <table width="100%">
                                    <tr  class="table_header">
                                      ...
                                      <td width="12%"><div align="center">NO SYARIKAT</div></td>
                                    ...
                                    #set($peno=0)
                                      #foreach($listpenting in $listPenting)
                                        ...
                                        #set($peno=$peno+1)
         							 #if($peno%2!=0)
                                      #if ($idpermohonansimati == $listpenting.idpermohonansimati)
								       		#set ($i = $velocityCount)
										        #if (($i % 2) == 0)
										       		#set ($row = "row4")
										        #else
                                    ...
                                    <td class="$row"><div align="center" class="style41">$!peno</div></td>
                                      <td class="$row" style="text-transform:uppercase;">
                                      ...
                                      <td class="$row" style="text-transform:uppercase;">$!listpenting.noakaun</td>
                                      <td class="$row"><div align="right" >$!Util.formatDecimal($listpenting.nilaihutang)</div></td>
                                      <td class="$row" style="text-transform:uppercase;">$!listpenting.butiranhutang</td>
                                   ...
                                   <td class="$row"><div align="center" class="style41">$!peno</div></td>
                                      ...
                                      <td class="$row" style="text-transform:uppercase;"><div align="center">$!listpenting.nokpbaru</div></td>
                                      <td class="$row" style="text-transform:uppercase;">
                                      #if ($listpenting.pemiutang=="1")
                                      	$listpenting.nokplama
                                      #end

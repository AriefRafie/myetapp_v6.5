      ...
      <div class="TabbedPanelsContentVisible">
        <div id="TabbedPanels4" class="TabbedPanels">
          ...
          <tr>
                                  ...
                                  #if($mukim!=$listmukim.id)        <option value="$listmukim.id">$listmukim.kod - $listmukim.nama</option>
                                  #end    
	                               #end
                                                </select>
                                                #else
...
<select name="txtBandarHartaHtaamX" id="txtBandarHartaHtaamX" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSurat()" >
  ...
  <!-- Refer kat sini untuk frmPermhnnSek8HTAAH-->
...
<select name="txtBandarPemaju1HtaamX" id="txtBandarPemaju1HtaamX" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarTetap()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>                                 
                            ...
                            #elseif($kategori == "1" || $kategori == "3" || $kategori == "4" || $kategori == "5" || $kategori == "6" || $kategori == "7"|| $kategori == "8")
                            ...
                            <input type="hidden" name="flag_tukar_jenis_hta" id="flag_tukar_jenis_hta" value="">
							 ...
							 function check_jenis_hta2()
							 {
								 ...
								 document.f1.radioJenisHTA_update[0].checked = false;
                                  ...
                                  <fieldset>
                                  <legend>HARTA TAK ALIH (TIADA HAKMILIK) </legend>
                                  <table width="100%">
                                        <tr>
...
/
  <input name="txtBahagianSimati2X" type="text" id="txtBahagianSimati6" onkeyup="javascript:validateIC(event,this,this.value,'txtBahagianSimati2X')" value="$listam.bbsimati" size="14" maxlength="14" $readmodeR class="$readmode" style="text-align:left;text-transform:uppercase;" onblur="bahagiansimati()" /></td>
                            ...
                            || $listam.kategori == "7" || $listam.kategori == "8")
                             #set($meterhektar = "Meter Persegi")
  ...
  <option value="$listpemilik.id">$listpemilik.kod - $listpemilik.keterangan</option>
		      ...
		      <table width="100%" border="0" cellspacing="2" cellpadding="2">
		   		...
		   		<tr>
			          <td width="1%">&nbsp;</td>
			          <td width="28%">&nbsp;</td>
			          <td width="1%">&nbsp; <input type="hidden" id="idDokumen" name="idDokumen" value="$listam.idDokumen" /> </td>
			          <td width="70%"><img src="../servlet/ekptg.view.ppk.FrmDisplayImage?id=$listam.idDokumen" alt="Imej Pelan" border="1" width="250" height="250" onclick="cetakImej($listam.idDokumen)"/></td>
		        </tr>
		        <tr>
			          ...
			          <td width="1%">:</td>
			          <td width="70%">
			          	<input name="txtNamaPelan" type="text" id="txtNamaPelan2" value="$listam.namaPelan" size="43" maxlength="100" $readmodeR class="$readmode" >
...
<!-- end button integrasi -->                                        #end
          ...
          <tr>
   					...
   					<input type="button" name="tambahpenghutang3" id="tambahpenghutang3" $readmode value="Simpan"  onclick="setSelected(1,0,0,1);add_HtaamX('$id','$paramOnline')"/>
                                      #end
...
<legend><strong>Senarai Laporan</strong></legend>
  ...
  <tr bgcolor="white">
   	<td class="row1"><input type="checkbox" name="selectHTATH" id="selectHTATH" value="$listam.idhta" /></td> 
  ...
  <td class="row1"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_htaam('$id_PermohonanSimati','$listam.idhta','$listam.idDokumen')" class="style42">$nama_negeri</a></div></td>
    #if($listam.daerah=="")
    ...
    <div align="center" style="text-transform:uppercase;" onblur="uppercase()">$listam.basimati / $listam.bbsimati</div>
        ...
        <td class="row1">  </td>
                                      ...
                                      #else
  <tr class="table_header">
  	<td class="row2"><input type="checkbox" name="selectHTATH" id="selectHTATH" value="$listam.idhta" /></td> 
   ...
   <td class="row2"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_htaam('$id_PermohonanSimati','$listam.idhta','$listam.idDokumen')" class="style42">$nama_negeri</a></div></td>
    #if($listam.daerah=="")
...
// alert(document.f1.upload.value);

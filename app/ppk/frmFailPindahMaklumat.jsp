 ...
 <fieldset>
  <legend>MAKLUMAT FAIL PINDAH YANG DITERIMA DARIPADA LUAR</legend>         
     <table width="100%"  cellspacing="3" cellpadding="1" border="0" >
       ...
       <tr>
         <td align="right" style="text-transform:uppercase"><font color="red">*</font>&nbsp;Tarikh Terima Fail</td>
         <td>&nbsp;:</td>
       ...
       <tr>
         ...
         <td>&nbsp;:</td>
         <td><input name="txtNamaPemohon" type="text" id="txtNamaPemohon" value="$!txtNamaPemohon" size="50" style="text-transform:uppercase;" readonly class="disabled" /></td>
       </tr>
       <tr>
         <td width="36%" align="right" style="text-transform:uppercase">&nbsp;Negeri Asal</td>
         <td width="1%">&nbsp;:</td>
         <td width="63%"><input name="txtNegeriPindah" type="text" id="txtNegeriPindah" value="$!txtNegeriAsal" size="50" style="text-transform:uppercase;" readonly class="disabled" /></td>
       </tr>
       <tr>
         <td align="right" style="text-transform:uppercase">&nbsp;Daerah Asal</td>
         <td>&nbsp;:</td>
         <td><input name="txtDaerahPindah" type="text" id="txtDaerahPindah" value="$!txtDaerahAsal" size="50" style="text-transform:uppercase;" readonly class="disabled" /></td>
       </tr>
       <tr>
         <td align="right" style="text-transform:uppercase">&nbsp;Negeri Pindah</td>
         <td>&nbsp;:</td>
         <td><input name="txtNegeriPindah" type="text" id="txtNegeriPindah" value="$!txtNegeriPindah" size="50" style="text-transform:uppercase;" readonly
          class="disabled" /><input name="id_negeri" type="hidden" id="id_negeri" value="$id_negeri"/>
       ...
       <tr>
         ...
         <td>&nbsp;:</td>
         <td><input name="txtDaerahPindah" type="text" id="txtDaerahPindah" value="$!txtDaerahPindah" size="50" style="text-transform:uppercase;" readonly class="disabled" /><input name="id_daerah" type="hidden" id="id_daerah" value="$id_daerah"/>
  ...
  <p></p>
      <div align="center">           
      <input type="button" name="Simpan" id="Simpan" value="Pindah Maklumat" onclick="javascript:Simpan_PindahFail('$id_fail','$id_permohonan');" />
  ...
  <legend>MAKLUMAT FAIL LAMA</legend>         
     <table width="100%"  cellspacing="3" cellpadding="1" border="0" >
       ...
       <tr>
         <td align="right" style="text-transform:uppercase">&nbsp;Nama SiMati</td>
         <td>&nbsp;:</td>
         <td><input name="txtNamaSimati" type="text" id="txtNamaSimati" value="$!txtNamaSimati" size="50" style="text-transform:uppercase;" readonly class="disabled" /></td>
       </tr>
       <tr>
         <td align="right" style="text-transform:uppercase">&nbsp;Nama Pemohon</td>
         <td>&nbsp;:</td>
  ...
  <legend>MAKLUMAT FAIL YANG BARU DITERIMA</legend>
     ...
     <table width="100%"  cellspacing="3" cellpadding="1" border="0" >
       <tr>
         ...
         <td width="1%">&nbsp;:</td>
         <td width="63%"><input type="text" name="txdTarikhPindah" value="$!txdTarikhPindah" size="15" id="txdTarikhPindah" onkeyup="validateNumber(this,this.value);" readonly class="disabled" />
       ...
       <tr>
         ...
         <td><input type="text" name="txtNoFail"  id="txtNoFail" value="$!no_file_baru" size="50" style="text-transform:uppercase;" readonly="true" class="disabled" />
           <input name="id_file_baru" type="hidden" id="id_file_baru" value="$id_file_baru"/>     	 
         </td>
       </tr>
       <tr>
         <td align="right" style="text-transform:uppercase">&nbsp;Nama SiMati</td>
      ...
      <!--  <input type="button" name="cmdPendaftaran" value="Seterusnya" onClick="goPendaftaran('$id_permohonan','$idSimati','$seksyen','$id_status')" />
        ...
        id_simati_baru ::: $id_simati_baru
        seksyen_baru ::: $seksyen_baru
        id_status_baru ::: $id_status_baru 
        -->
  ...
  <legend>MAKLUMAT FAIL YANG BARU DITERIMA</legend>
     ...
     <table width="100%"  cellspacing="3" cellpadding="1" border="0" >
       <tr>
         <td width="36%" align="right" style="text-transform:uppercase">&nbsp;Tarikh Pindah</td>
         <td width="1%">&nbsp;:</td>
         <td width="63%"><input type="text" name="txdTarikhPindah" value="$!tarikh_mohon" size="15" id="txdTarikhPindah" onkeyup="validateNumber(this,this.value);" readonly class="disabled" /></td>
       </tr>
       <tr>
         <td align="right" style="text-transform:uppercase">&nbsp;No Fail Baru</td>
         <td>&nbsp;:</td>
         <td><input type="text" name="no_file_baru"  id="no_file_baru" value="$!no_file_baru" size="50" style="text-transform:uppercase;" readonly class="disabled" /><input name="id_file_baru" type="hidden" id="id_file_baru" value="$id_file_baru"/> 
     	 </td>
       </tr>
       <tr>
         <td align="right" style="text-transform:uppercase">&nbsp;Nama SiMati</td>
...
<input type="hidden" name="idsuburusanstatusfail" id="idsuburusanstatusfail" value="$idsuburusanstatusfail" />
<input type="hidden" name="ekptg_user_id" size="5" value="${session.getAttribute("_ekptg_user_id")}" /> 
...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
       <tr>
        <td><a href="#" class="style2" onClick="javascript:cetakSuratTerimaFail('$no_file_baru','$id_file_baru')"><font color="blue"> Surat Terima Fail </font></a></td>
      </tr>           
    </table>
</fieldset>
...
function setTable(id_file_baru){
	if(document.getElementById(id_file_baru).style.display=="none"){
		document.getElementById(id_file_baru).style.display="block";
	}
	else if(document.getElementById(id_file_baru).style.display=="block"){
		document.getElementById(id_file_baru).style.display="none";
	}
}

function cetakSuratTerimaFail(no_file_baru,id_file_baru) {
 	var url = "../x/${securityToken}/ekptg.report.ppk.FrmPopupPilihPegawaiReportView?noFail="+no_file_baru+"&idfail="+id_file_baru+"&report=SuratTerimaFail&flagReport=S";
...
function Simpan_PindahFail(id_fail,id_permohonan) {
	...
	if(document.f1.txdTarikhPindah.value == ""){
		alert("Sila pilih \" Tarikh Terima Fail \" terlebih dahulu.");
	...
	document.f1.id_fail.value = id_fail;
	document.f1.id_permohonan.value = id_permohonan;
	document.f1.command.value = "Simpan_PindahFail";
	document.f1.action = "";
	document.f1.submit();
	}
}

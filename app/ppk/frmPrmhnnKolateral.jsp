		...
		<table width="100%">
		  ...
		  <td width="50%">
			<table width="100%"  cellpadding="1" cellspacing="1" border="0">
						<tr>
							<td width="38%" style="text-transform:uppercase"><div align="right">Status Fail</div></td>
						    <td width="2%">:</td>
						...
						<tr>
							<td><div align="right" style="text-transform:uppercase">Nama Simati</div></td>
							<td>:</td>
							<td><font color="blue">$namaSimati.toUpperCase()</font></td>
						</tr>
						<tr>
							<td><div align="right"><span style="text-transform:uppercase">Nama Pemohon</span></div></td>
							<td>:</td>
...
#foreach($data in $dataPerbicaraan)
    #set ($id_permohonan = $data.idPermohonan)
...
#if ( $addMode == "yes" )
 <fieldset>
  <legend>PERTELINGKAHAN KOLATERAL</legend>    
  
  <div id="TabbedPanels1" class="TabbedPanels">
    <ul class="TabbedPanelsTabGroup"> 
      <li class="TabbedPanelsTab" tabindex="0" onclick="setSelected(0);permohonan()">PERMOHONAN</li>
      #if ($tab=="keputusan")
      <li class="TabbedPanelsTab" tabindex="0" onclick="setSelected(1);keputusan()">KEPUTUSAN</li>
      #end
    </ul>
    ...
    <div class="TabbedPanelsContentGroup"> 
    	...
    	<div class="TabbedPanelsContent">
                <table width="100%"  cellspacing="1" cellpadding="1" border="0">
                   <tr>
                     <td colspan="3"><input type="button" name="cmdTangguhKolateral" id="cmdTangguhKolateral" value="Senarai Tangguh Kolateral" onclick="SenaraiBicaraKolateral('$idpermohonan')" /></td>
                   </tr>
                   <tr>
                     <td><font color="red">*</font>&nbsp;Tarikh Perakuan Kolateral</td>
                     <td>:</td>
                     <td><input name="txdTarikhPerakuanAdd" value="$!txdTarikhPerakuanAdd" size="11" id="txdTarikhPerakuanAdd" type="text" onblur="check_date(this);getTarikhBicara()" onkeyup="validateNumber(this,this.value);" />
                         <img src="../img/calendar.gif" alt="" onclick="displayDatePicker('txdTarikhPerakuanAdd',false,'dmy');" /></td>
                   </tr>
                   
                   <tr>
                     <td width="25%"><font color="red">*</font>&nbsp;Tarikh Bicara</td>
                     <td width="1%">:</td>
            		 <td width="74%"><input type="text" name="txdTarikhBicara" id="txdTarikhBicara" value="$!tarikhBicara" size="11"  onblur="check_date(this);" onkeyup="validateNumber(this,this.value);" />
                         <img src="../img/calendar.gif" onclick="displayDatePicker('txdTarikhBicara',false,'dmy');" /></td>
                   </tr>
                   <tr>
                     <td><font color="red">*</font>&nbsp;Masa Bicara</td>
                     <td>:</td>
                     <td><input type="text" name="txtMasaBicara" id="txtMasaBicara" value="$!txtMasaBicara" onblur="validateNumber(this,this.value);" onkeyup="validateNumber(this,this.value);" maxlength="4" size="4" />
                       &nbsp;<font color="blue"><em>format 24 jam (HHMM)</em></font></td>
                   </tr>
                   <tr>
                     <td><font color="red">*</font>&nbsp;Tempat Bicara</td>
                     <td>:</td>
                     <td>$selectBicara<input name="id_pejabatjkptg" id="id_pejabatjkptg" type="hidden" value="$id_pejabatjkptg" /></td>
                   </tr>
                   <tr>
                     <td>&nbsp;&nbsp;&nbsp;Alamat</td>
                     <td>:</td>
                     <td><input type="text" size="52" name="txtAlamatBicara1" id="txtAlamatBicara1" value="$!alamat1" maxlength="80"  style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();" readonly class="disabled" /></td>
                   </tr>
                   <tr>
                     <td>&nbsp;</td>
                     <td>&nbsp;</td>
                     <td><input type="text" size="52" name="txtAlamatBicara2" id="txtAlamatBicara2" value="$!alamat2" maxlength="80"  style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();" readonly class="disabled" /></td>
                   </tr>
                   <tr>
                     <td>&nbsp;</td>
                     <td>&nbsp;</td>
                     <td><input type="text" size="52" name="txtAlamatBicara3" id="txtAlamatBicara3" value="$!alamat3" maxlength="80"  style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();" readonly class="disabled" /></td>
                   </tr>
                   <tr>
                     <td>&nbsp;&nbsp;&nbsp;Poskod</td>
                     <td>:</td>
                     <td><input type="text" name="txtPoskod" id="txtPoskod" onblur="validateNumber(this,this.value);" onkeyup="validateNumber(this,this.value);" maxlength="5" size="5" value="$!poskod" readonly class="disabled" /></td>
                   </tr>
                   <tr>
                      <td>&nbsp;&nbsp;&nbsp;Negeri</td>
                      <td>:</td>
                      <td>$selectNegeri<input name="id_negeri" id="id_negeri" type="hidden" value="$id_negeri" /></td>
                   </tr>       
                   <tr>
                   ...
                   <tr>
                     ...
                     <td width="74%" valign="top"><textarea name="txtCatatanAdd" cols="80%" rows="8" id="txtCatatanAdd" >$!txtCatatanAdd</textarea></td>
                   </tr>
                   <tr>
		      ...
		      <script> 
				...
				area.ReplaceTextarea();             	
                  ...
                  <p></p>
                  <fieldset>
                  <legend><strong>PIHAK YANG MENENTANG (PLANTIF)</strong></legend>
                       <p></p>
                     <table width="100%" border="0" cellspacing="2">
                        <tr class="table_header">
                          ...
                          <td width="32%" style="text-transform:uppercase">Talian dengan SiMati</td>
                       </tr> 
                        ...
                        <tr>
                           <td class="$row"><input type="checkbox" name="cbsemaksP"  value="$senarai.id_ob" onClick="checkit1()"></td>
                  ...
                  <p></p>
                  <fieldset>
                  <legend><strong>PIHAK YANG DITENTANG (DEFENDEN)</strong></legend>
                       <p></p>
                     <table width="100%" border="0" cellspacing="2">
                        <tr class="table_header">
                        	<td width="3%" style="text-transform:uppercase"></td>
                        ...
                        <tr>
                            <td class="$row"><input type="checkbox" name="cbsemaksD"  value="$senarai.id_ob" onClick="checkit2()"></td>
                           <!-- <td class="$row">$senarai.bil</td>-->
                            <td class="$row">$senarai.nama_ob.toUpperCase()</td>
                            <td class="$row">$senarai.no_kp_baru</td>
                            <td class="$row">$senarai.keterangan</td>
                  ...
                  <table width="100%">
                    <tr>
                        <td><div align="center">
                          <input type="button" name="Simpan" id="Simpan" value="Simpan" onclick="javascript:Simpan_AddKolateral();" />        	  			  
                          #if ($idstatus=="18")
                          <input name="cmdKembali" type="button" value="Kembali" onclick="javascript: kembali_skrin2TangguhKolAdd('$idpermohonan','$id_perbicaraan');" />  
                          #end
                          #if ($idstatus=="44" || $idstatus=="172" || $idstatus=="173" || $idstatus=="174" || $idstatus=="175" || $idstatus=="176" || $idstatus=="177" )       	  
                          <input name="cmdKembali" type="button" value="Kembali" onclick="javascript: kembali_skrin2TangguhKolEdit('$idpermohonan','$id_perbicaraan');" />
                          #end
                      </div></td>
                    </tr>
                  </table>
        	...
        	<fieldset>
                 ...
                 <table width="100%"  cellspacing="1" cellpadding="1" border="0"> 
                    ...
                    <tr>
                      ...
                      <td valign="top">:</td>
                      <td><textarea name="txtKeputusanAdd" cols="80%" rows="8" id="txtKeputusanAdd"></textarea></td>
                    </tr>
                    <tr>
                      <td colspan="3" valign="top">&nbsp;</td>
                   </tr>
				   ...
				   <script> 
                    ...
                    <tr>
                      ...
                      <td valign="top">:</td>
                      <td><textarea name="txtCatatanAdd" cols="73%" rows="7" id="txtCatatanAdd" onblur="this.value=this.value.toUpperCase();" readonly class="disabled"></textarea></td>
                    </tr>
                    <tr>
                      <td colspan="3" valign="top">&nbsp;</td>
                   </tr>  
 ...
 #end	<!-- close for add mode -->  

#if ( $viewMode == "yes" )

#if ( $flag == "onChange" )    
    #foreach($info in $dataPerintahKolateral)
        ##set ($id_permohonan = $info.id_permohonan)
        ##set ($id_perbicaraan = $info.id_perbicaraan)
        ##set ($id_perintah = $info.id_perintah)
        ##set ($id_keputusanpermohonan = $info.id_keputusanpermohonan)
  ...
  <legend>PERMOHONAN</legend>         
     <table width="100%"  cellspacing="1" cellpadding="1" border="0">
       ...
       <tr>
         ...
         <td>:</td>
         <td><input name="txdTarikhPerakuanAdd" value="$!tarikh_perakuan" size="11" id="txdTarikhPerakuan" type="text" readonly class="disabled" /></td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td width="1%">:</td>
         <td width="75%"><input type="text" name="txdTarikhBicara" id="txdTarikhBicara" value="$!tarikh_perintah" size="11" readonly class="disabled" /></td>
       </tr>
       <tr>
         <td>Masa Bicara</td>
         <td>:</td>
         <td><input type="text" name="txtMasaBicara" value="$!masa_bicara" onblur="validateNumber(this,this.value);" onkeyup="validateNumber(this,this.value);" maxlength="4" size="4" readonly class="disabled" />
       ...
       <tr>
         ...
         <td>:</td>
         <td>$selectViewBicara
          <input name="id_pejabatjkptg" id="id_pejabatjkptg" type="hidden" value="$id_pejabatmahkamah" /></td>
       </tr>
       <tr>
         <td>Alamat</td>
         <td>:</td>
       ...
       <tr>
         <td valign="top">Catatan</td>
         <td valign="top">:</td>
         <td valign="top"><textarea name="txtCatatanAdd" cols="80%" rows="8" id="txtCatatanAdd">$!sebab_pertelingkahan</textarea></td>
       </tr>
       <tr>
         <td colspan="3" valign="top">&nbsp;</td>
       </tr>
...
#foreach($infoPlanitif in $dataWarisPlanitif)
    ...
    #set ($jenis_ob = $infoPlanitif.jenis_ob)
      ...
      <p></p>
                 <table width="100%" border="0" cellspacing="2">
                    <tr class="table_header">
                      <td width="8%" style="text-transform:uppercase"><div align="center">No.</div></td>
                      <td width="31%" style="text-transform:uppercase">Nama</td>
                      <td width="31%" style="text-transform:uppercase">No KP Baru</td>
                      <td width="30%" style="text-transform:uppercase">Talian dengan SiMati</td>
                   </tr> 
                    #foreach ( $infoPlanitif in $dataWarisPlanitif )
    ...
    #set ($jenis_ob = $infoDefendan.jenis_ob)
      ...
      <legend><strong>PIHAK YANG DITENTANG (DEFENDEN)</strong></legend>
           <p></p>
                 <table width="100%" border="0" cellspacing="2">
                    <tr class="table_header">
                      <td width="7%" style="text-transform:uppercase"><div align="center">No.</div></td>
      ...
      <table width="100%">
      	<tr>
        	<td><div align="center">
        	  <input type="button" name="Kemaskini" id="Kemaskini" value="Kemaskini" onclick="javascript:Skrin_EditKolateral('$idpermohonan','$id_perbicaraan');" />        	  
        	  <input name="cmdBatal" type="button" value="Kembali" onclick="javascript: kembali_skrin2TangguhKolEdit('$idpermohonan','$id_perbicaraan');" />        	  
        	  <input type="button" name="button" id="button" value="Cetak" onClick="javascript:setTable('tableReport1')" />        	  
      	  </div></td>
        </tr>
      </table>
            
#end	<!-- close for view mode -->
   
 </div>  <!-- close for 1st div class="TabbedPanelsContent" -->
...
#foreach($infoKeputusanBayaran in $dataKeputusanBayaran)
 	...
 	<div class="TabbedPanelsContent">
        	...
        	<legend>KEPUTUSAN</legend>
             <table width="100%"  cellspacing="1" cellpadding="1" border="0"> 
                <tr>
                  ...
                  <td width="1%">:</td>
                  <td colspan="2">RM &nbsp;<input type="text" size="11" name="txtBayaranPerintahKol" id="txtBayaranPerintahKol" value="30.00" maxlength="12" readonly class="disabled" onblur="validateNumber(this,this.value);validateModal(this,this.value,$txtBayaranPerintahKol)" onkeyup="validateNumber(this,this.value);" /></td>
                </tr>
                <tr>
                  <td>No Resit</td>
                  <td>:</td>
                  <td colspan="2"><span style="text-transform:uppercase;">
                    <input type="text" size="15" name="txtNomborResitPerintahKol" onblur="this.value=this.value.toUpperCase();" id="txtNomborResitPerintahKol" value="$!noResitKptsan" readonly class="disabled" style="text-transform:uppercase;" maxlength="20" />
                  </span></td>
                </tr>
                <tr>
                  <td valign="top">Catatan</td>
                  <td valign="top">:</td>
                  <td colspan="2"><textarea name="txtCatatanKeputusan" cols="80%" rows="8" id="txtCatatanKeputusan">$!catatanKeputusan</textarea></td>
                </tr>
                <tr>
        ...
        <p></p>
               <table width="100%">
                <tr>
                    <td><div align="center">
                      <input type="button" name="Kemaskini" id="Kemaskini" value="Kemaskini" onclick="javascript:Skrin_EditKeputusanKolateral('$idpermohonan','$id_perbicaraan');" />                                                         	  
                      <input name="cmdKembali" type="button" value="Kembali" onclick="javascript: kembali_skrin2TangguhKolEdit('$idpermohonan','$id_perbicaraan');" />        	  
                      <input type="button" name="button" id="button" value="Cetak" onClick="javascript:setTable('tableReport1')" />
                      #if ( $idstatus == "173" )
 ...
 </div> <!-- close for 2nd div class="TabbedPanelsContent" -->
#end	<!-- close for tab=keputusan -->

</div> <!-- close for master tab -->
  ...
  <legend>PERMOHONAN</legend>         
     <table width="100%"  cellspacing="1" cellpadding="1" border="0">
       ...
       <tr>
         <td><font color="red">*</font>&nbsp;Tarikh Perakuan Kolateral</td>
         <td>:</td>
         <td><input name="txdTarikhPerakuanAdd" value="$!tarikh_bicara" size="11" id="txdTarikhPerakuan" type="text" readonly class="disabled" />
         <img src="../img/calendar.gif" alt="" onclick="displayDatePicker('txdTarikhPerakuanAdd',false,'dmy');" /></td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td width="1%">:</td>
         <td width="75%"><input type="text" name="txdTarikhBicara" id="txdTarikhBicara" value="$!tarikh_perintah" size="11" readonly class="disabled" />
         <img src="../img/calendar.gif" alt="" onclick="displayDatePicker('txdTarikhBicara',false,'dmy');" /></td>
       </tr>
       <tr>
         <td><font color="red">*</font>&nbsp;Masa Bicara</td>
         <td>:</td>
         <td><input type="text" name="txtMasaBicara" value="$!masa_bicara" onblur="validateNumber(this,this.value);" onkeyup="validateNumber(this,this.value);" maxlength="4" size="4" />
           &nbsp;<em>&nbsp;<font color="blue">format 24 jam (HHMM)</font></em></td>
       </tr>
       <tr>
         <td><font color="red">*</font>&nbsp;Tempat Bicara</td>
    ...
    #set ($jenis_ob = $infoUpdate.jenis_ob)
      ...
      <p></p>
                 <table width="100%" border="0" cellspacing="2">
                    ...
                    <tr>
                    	<td class="$row"><input type="checkbox" name="cbsemaksP"  value="$infoUpdate.id_ob" onClick="checkit1()">
                        <input type="hidden" value="$infoUpdate.id_ob" size="5" /></td>
...
#foreach($infoUpdate in $dataWarisUpdate)
    ...
    #set ($jenis_ob = $infoUpdate.jenis_ob)
      ...
      <legend><strong>PIHAK YANG DITENTANG (DEFENDEN)</strong></legend>
           <p></p>
                 <table width="100%" border="0" cellspacing="2">
                    ...
                    <tr>
                    	<td class="$row"><input type="checkbox" name="cbsemaksD" value="$infoUpdate.id_ob" onClick="checkit1()"></td>
                        <td class="$row">$infoUpdate.bil</td>
                        <td class="$row">$infoUpdate.nama_ob.toUpperCase()</td>
                        <td class="$row">$infoUpdate.no_kp_baru</td>
                        <td class="$row">$infoUpdate.keterangan</td>
      ...
      <table width="100%">
      	<tr>
        	<td><div align="center">
        	  <input type="button" name="Simpan" id="Simpan" value="Simpan" onclick="javascript:Skrin_EditKolateral('$idpermohonan','$id_perbicaraan');" />        	  
        	  <input name="cmdBatal" type="button" value="Kembali" onclick="javascript: kembali_skrin2TangguhKolEdit('$idpermohonan','$id_perbicaraan');" />        	  
        	  <input type="button" name="button" id="button" value="Cetak" onClick="javascript:setTable('tableReport1')" />
...
#foreach($infoKeputusanBayaran in $dataKeputusanBayaran)
 	...
 	<fieldset>
        	<legend>KEPUTUSAN</legend>
              <table width="100%"  cellspacing="1" cellpadding="1" border="0"> 
                <tr>
                  <td>Keputusan</td>
                  <td>:</td>
                  <td><input name="txdTarikhHantarAdd" value="$!tarikh_hantar_borang" size="11" id="txdTarikhHantarAdd" type="text" readonly class="disabled" />
		</td>
                </tr>
                <tr>
                  <td>Bayaran Perintah</td>
                  <td>:</td>
                  <td><input name="txdTarikhTerimaAdd" value="$!tarikh_terima_borang" size="11" id="txdTarikhTerimaAdd" type="text" readonly class="disabled" /></td>
                </tr>
                <tr>
                  <td width="31%" valign="top">Catatan</td>
                  <td width="1%" valign="top">:</td>
                  <td width="68%"><textarea name="txtCatatanAdd" cols="73%" rows="7" id="txtCatatanAdd" onblur="this.value=this.value.toUpperCase();" readonly class="disabled">$catatan5</textarea></td>
               </tr>  
             </table>	
  	...
  	</div> <!-- close for 2nd tab -->
</div>	<!-- close master tab -->
</div>
#end   <!-- close vieweditmode -->
  ...
  <legend>PERTELINGKAHAN KOLATERAL</legend>         
     <table width="100%"  cellspacing="1" cellpadding="1" border="0">
       <tr>
         <td><font color="red">*</font>&nbsp;Tarikh Perakuan Kolateral</td>
         <td>:</td>
         <td><input name="txdTarikhPerakuanAdd" value="$!tarikh_perakuan" size="11" id="txdTarikhPerakuanAdd" type="text" readonly class="disabled" />
         <img src="../img/calendar.gif" alt="" onclick="displayDatePicker('txdTarikhPerakuanAdd',false,'dmy');" /></td>
       </tr>
       <tr>
         <td><font color="red">*</font>&nbsp;Pegawai Pengendali</td>
       ...
       <tr>
         <td width="25%"><font color="red">*</font>&nbsp;Tarikh Bicara</td>
         <td width="1%">:</td>
         <td width="74%"><input type="text" name="txdTarikhBicara" id="txdTarikhBicara" value="$!tarikh_perintah" size="11" readonly class="disabled" />
         <img src="../img/calendar.gif" alt="" onclick="displayDatePicker('txdTarikhBicara',false,'dmy');" /></td>
       </tr>
       <tr>
         <td><font color="red">*</font>&nbsp;Masa Bicara</td>
       ...
       <tr>
         ...
         <textarea name="txtCatatanAdd" cols="80%" rows="8" id="txtCatatanAdd">$!sebab_pertelingkahan</textarea>
         </td>
       </tr>
       <tr>
         <td colspan="3" valign="top"><div  class="disabled" id="word_count"></div></td>
...
<tr></tr>
              ...
              <legend><strong>SENARAI WARIS</strong></legend>
                 ...
                 <table width="100%" border="0" cellspacing="2">
                   ...
                   <tr>
                    ...
                    <td class="$row"><input type="checkbox" name="cbsemaksP" $checked  value="$senarai.id_ob" onClick="checkit1edit()"></td>
                    <!--<td class="$row">$senarai.bil</td>-->
                    <td class="$row">$senarai.nama_ob.toUpperCase()</td>
                    <td class="$row">$senarai.no_kp_baru</td>
                    <td class="$row">$senarai.keterangan</td>
      ...
      <legend><strong>PIHAK YANG DITENTANG (DEFENDEN)</strong></legend>
           <p></p>
              <legend><strong>SENARAI WARIS</strong></legend>
                 ...
                 <table width="100%" border="0" cellspacing="2">
                    ...
                    <tr>
                    	...
                    	<td class="$row"><input type="checkbox" name="cbsemaksD" $checked  value="$senarai.id_ob" onClick="checkit2edit()"></td>
                        <!--<td class="$row">$senarai.bil</td>-->
                        <td class="$row">$senarai.nama_ob.toUpperCase()</td>
                        <td class="$row">$senarai.no_kp_baru</td>
                        <td class="$row">$senarai.keterangan</td>
              ...
              <p></p>
              <div align="center">           
              <input type="button" name="cmdSimpan" id="Simpan" value="Simpan" onclick="javascript:simpan_editkolateral('$idpermohonan','$id_perbicaraan');" />
              <input name="cmdKembali" type="button" value="Kembali" onclick="javascript: kembali_skrin2TangguhKolEdit('$idpermohonan','$id_perbicaraan');" />
              </div> 
     </div>
        	...
        	<legend>KEPUTUSAN</legend>
             <table width="100%"  cellspacing="1" cellpadding="1" border="0"> 
                <tr>
                  ...
                  <td>:</td>
                  <td colspan="2">RM&nbsp;<input type="text" size="6" name="txtBayaranPerintahKol" id="txtBayaranPerintahKol" value="30.00" maxlength="12" readonly class="disabled" onblur="validateNumber(this,this.value);validateModal(this,this.value,$txtBayaranPerintahKol)" onkeyup="validateNumber(this,this.value);" /></td>
                </tr>
                <tr>
                  <td>No Resit</td>
                  <td>:</td>
                  <td colspan="2"><span style="text-transform:uppercase;">
                    <input type="text" size="15" name="txtNomborResitPerintahKol" onblur="this.value=this.value.toUpperCase();" id="txtNomborResitPerintahKol" value="$!noResitKptsan" style="text-transform:uppercase;" maxlength="20" />
                  </span></td>
                </tr>
                <tr>
                  <td>Tarikh Bayaran</td>
                  <td>:</td>
                  <td colspan="2"><input name="txdTarikhBayaranPerintahKol" value="$!tarikhBayaranKptsan" size="11" id="txdTarikhBayaranPerintahKol" type="text" onblur="check_date(this);" onkeyup="validateNumber(this,this.value);" />
                  <img src="../img/calendar.gif" alt="" onclick="displayDatePicker('txdTarikhBayaranPerintahKol',false,'dmy');" /></td>
                </tr>
                <tr>
                  <td width="22%" valign="top">Keputusan</td>
                  <td width="1%" valign="top">:</td>
                  <td colspan="2">
                  <textarea name="txtCatatanKeputusan" cols="80%" rows="8" id="txtCatatanKeputusan">$!catatanKeputusan</textarea>
                 </td>
               </tr>
               <tr>
                 <td colspan="3" valign="top"><div class="disabled" id="word_count"></div></td>
             ...
             <p></p>
               <table width="100%">
                <tr>
                    <td><div align="center">
                    #if($idstatus == "172")
                    	<input type="button" name="Simpan" id="Simpan" value="Simpan" onclick="javascript:simpanKeputusanKolateral('$idpermohonan','$id_perbicaraan');" /> 
                    #end
                    #if($idstatus == "173")
                    	<input type="button" name="Simpan" id="Simpan" value="Simpan" onclick="javascript:simpanEditKeputusanKolateral('$idpermohonan','$id_perbicaraan');" /> 
                    #end                                                                              	
                      <input name="cmdKembali" type="button" value="Kembali" onclick="javascript: kembali_skrin2TangguhKolEdit('$idpermohonan','$id_perbicaraan');" />
                  </div></td>
                </tr>
...
<legend><strong>Senarai Laporan</strong></legend>
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
       <tr>
        <td ><a href="#" class="style2" onClick="javascript:cetakBorangL('$nofail','$idFail','$id_perbicaraan')"><font color="blue">Borang L</font></a></td>
      </tr>
       <tr>
        <td ><a href="#" class="style2" onClick="javascript:cetakBorangM('$nofail','$idFail','$id_perbicaraan')"><font color="blue">Borang M</font></a></td>
      </tr>  
       <tr>
        <td ><a href="#" class="style2" onClick="javascript:cetakBorangN('$nofail','$idFail','$id_perbicaraan')"><font color="blue">Borang N</font></a></td>
      </tr>           
    </table>
</fieldset> 

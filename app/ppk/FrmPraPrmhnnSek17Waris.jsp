...
.style38 {}
.style41 {color: #FF0000; font-style:italic}
...
#set($id_Orangberkepentingan = "")
            ...
            <br  />
              ...
              #if($listWarisDulu.size() != 0 || $listWarisLapisanIdMatiDulu.size() != 0 )
                                    ...
                                    <tr>
                                     ...
                                     #set($pastcheck = "checked")   
                                      ...
                                      <td width="5%"><label>
                                        ...
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $nowcheck value="now" onclick="setSelected(0,2,0,0);WarisView()"  />
                                        </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "now") <span class="style42">Senarai Waris Tambahan </span>#else
                                      Senarai Waris Tambahan
                                      #end                                      </div></td>
                                    
                                    </tr>
                                       <td width="5%"><label>
                                        <div align="right">
                                          <input type="radio" name="radiox" id="radiox"  $pastcheck value="past" onclick="setSelected(0,2,0,0);WarisViewDulu()" />
                                         </div>
                                      </label></td>
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "past") <span class="style42">Senarai Waris Terdahulu</span>                                      #else
                                      Senarai Waris Terdahulu
                                      #end                                      </div></td>
    ...
    <table width="100%" border="0">
                                  <tr>
                                    ...
                                    <table width="100%">
                                     ...
                                     #if($id_Pemohon != "" && $nowpast == "now" && $boleh_kemaskini_parent == "yes")                                     
                                    <tr>
    ...
    <td class="style36" width="70%">
                                             ...
                                             <font color="blue"> $nama_ob_getListOBUpdate</font>
                                            #else
                                ...
                                <select name="id_ob_list_getListOBUpdate" id="id_ob_list_getListOBUpdate" class="autoselect" $readmode style="text-transform:uppercase;" onblur="uppercase()" >
                                      ...
                                      <font  color="blue"  onMouseOver="this.style.cursor='help'" onClick="open_new_window();" ><img src="../img/info.png"  align="center" /></font>
                                            #else
                                      <select name="id_ob_list_getListOBUpdate" id="id_ob_list_getListOBUpdate" class="autoselect" $readmode style="text-transform:uppercase;" onblur="uppercase()" >
                                        <option value="" style="text-transform:uppercase;" onblur="uppercase()">Sila Pilih Waris</option>
                                           #foreach($ls in $list_getListOBUpdate)
                                      ...
                                      <font  color="blue"  onMouseOver="this.style.cursor='help'" onClick="open_new_window();" ><img src="../img/info.png"  align="center" /></font>                                  
                                       ...
                                       <input type="hidden" name="txtIdSimatiWaris" value="$idSimati" />
                                        <tr>
                                          <td width="1%">&nbsp;</td>
                                          <td width="28%"><div align="left" class="style75 style38"><span class="style38">MyID Baru</span></div></td>
                                          ...
                                          <input name="txtNoKPBaru1Waris" id="txtNoKPBaru1Waris" style="width: 50px;" type="text" value="$txtNoKPBaru1Waris" $readmodeR class="$readmode" size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2Waris');check_kp();check_pengenalan_simati_1()" onBlur="getAgeByIC(this,this.value,'txtUmurWaris');getStatusByIC(this,this.value,'socStatusOBWaris');getDOB(this.value)"/> 
                                          - 
                                          ...
                                          - 
                                          <input name="txtNoKPBaru3Waris" id="txtNoKPBaru3Waris"  style="width: 40px;" type="text" value="$txtNoKPBaru3Waris" $readmodeR class="$readmode" size="5" maxlength="4" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris');check_kp();check_pengenalan_simati_1()" onblur="jantinaic2();setSelected(0,2,0,0);tarikh_waris_saudara('txtNoKPLamaWaris','up')" />
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style51 style74 style42">  www.jpn.gov.my</a>  
                                        ...
                                        <tr>
                                          <td >&nbsp;</td>
                                          <td ><div align="left" class="style75 style38"><span class="style38">MyID Lama</span></div></td>
                                        ...
                                        <tr>
                                          <td >&nbsp;</td>
                                          <td ><div align="left" class="style75 style38"><span class="style38">MyID Lain</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36">
                                          #if($readmode=="disabled")
                              ...
                              #set($txtNoKPLainWaris = "")
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><div align="left" class="style75 style38"><span class="style38">No MyID Lain</span></div></td>
                                          <td>:</td>
                                          ...
                                          <input name="txtNoKPLainWaris" type="text" id="txtNoKPLainWaris2"  style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" onkeyup="check_kp_lain();check_pengenalan_simati_3()" value="$txtNoKPLainWaris" size="15" maxlength="25" $readmodekp />
                                            ...
                                            <span id="check_kp_3" style="color:red" ></span>                                          </td>
                                        </tr>
                                        <tr>
                                          <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
                                          <td><div align="left" class="style75 style38"><span class="style38"><span class="style38 ">#if($readmode != "disabled")</span> Nama Waris #else Nama Waris #end</span></div></td>
                                        ...
                                        <tr>
                                          <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
                                          <td><div align="left" class="style75 style38"><span class="style38"><span class="style38 ">#if($readmode != "disabled")</span> Jantina #else Jantina #end</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><label>
                                           #if($readmode=="disabled")
                                          ...
                                          #else
                                            <select name="socJantinaWaris" id="socJantinaWaris" onchange="setSelected(0,2,0,0);tarikh_waris_saudara('socAgamaWaris','up')" class="mediumselect" $readmode style="text-transform:uppercase;" onblur="text-transform:uppercase;">
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><div align="left" class="style75 style38"><span class="style38">Agama</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><label>
                                          #if($readmode=="disabled")
                                        ...
                                        <tr>
                                          <td valign="top">&nbsp;</td>
                                          <td valign="top"><div align="left" class="style75 style38"><span class="style38">Warganegara</span></div></td>
                                        ...
                                        <td width="1%" class="style36"><div align="right"><span class="style38">:</span></div></td>
                                        <td class="style36">
                                        <input type = 'text' id = 'nama_warga' name = 'nama_warga' size='30' maxlength='200' $readmodeR class="$readmode"  list = 'datalist'  value="$nama_warga"    />
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><div align="left" class="style75 style38"><span class="style38">Tarikh Lahir</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><input name="txdTarikhLahirWaris" type="text" id="txdTarikhLahirWaris" value="$txdTarikhLahirWaris" size="10" maxlength="10" $readmodeR class="$readmode"  onblur="trans_date(this.value);getAgebyDob(this,this.value,'txtUmurWaris')"/>
                                                #if($readmode != "disabled")  
                                               
                                               <a href="javascript:displayDatePicker('txdTarikhLahirWaris',false,'dmy');">#parse("app/ppk/ppk_calender.jsp")</a><span class="style73"> dd/mm/yyyy</span>
                                                #end                                               </td>
                                      </tr>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><div align="left" class="style75 style38"><span class="style38">No Surat Beranak</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                        ...
                                        <tr>
                                          <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
                                          <td><div align="left" class="style75 style38"><span class="style38"><span class="style38 ">#if($readmode != "disabled")</span> Umur #else Umur #end</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                        ...
                                        <tr>
                                        <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
                                          <td><div align="left" class="style75 style38"><span class="style38">Status Waris</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36">
                                          #if($readmode == "disabled")
                      ...
                      <option value="" style="text-transform:uppercase;" onblur="text-transform:uppercase;">Sila Pilih Status</option>                       
                        ...
                        <option value="" style="text-transform:uppercase;" onblur="text-transform:uppercase;">Sila Pilih Status</option>                     
                                        ...
                                        <tr>
                                          <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
                                          <td><div align="left" class="style75 style38"><span class="style38"><span class="style38 ">#if($readmode != "disabled")</span> Talian Persaudaraan</span> #else Talian Persaudaraan #end</div></td>
                                          <td><div align="right"><span class="style38">:</span></div></td>
                                          <td>
                                          #if($readmode == "disabled")
                                  ...
                                  #foreach($listsau in $listsaudara)
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><div align="left" class="style75 style38"><span class="style38">Sudah Meninggal Dunia</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><label>
                                      ...
                                      <tr>
                                        <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
                                        <td><div align="right" class="style38 style72 style38">
                     ...
                     <a href="javascript:displayDatePicker('txdTarikhMatiWaris',false,'dmy');">#parse("app/ppk/ppk_calender.jsp")</a><span class="style73"> dd/mm/yyyy</span>
                     #end                     </td>
                                      </tr>
                                      <tr>
                                        <td  valign="top"><span class="style44">#if($readmode != "disabled")  #end</span></td>
                                        <td><div align="left" class="style75"><span class="style38"><span class="style38 ">#if($readmode != "disabled")</span> Waktu Kematian</span> #else <span class="style38">Waktu Kematian</span> #end</div></td>
                                        <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                  ...
                                  <option value="4" id="op_malam" >MALAM</option>            
                                        ...
                                        #if($readmode != "disabled") 
                                        <span class="style73">format 12 jam (HHMM)</span>
                                        #end                                        </td>
                                      </tr>
                                      #end
                                    </table></td>
                                  <td width="50%" valign="top"><table width="100%" border="0">
                                    ...
                                    <tr>
                                      ...
                                      <td class="style38" width="28%" ><div align="right" class="style75">
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                                    ...
                                    <tr>
                                 	 ...
                                 	 <!-- arief add open -->
                                        ...
                                        <tr id="tr_flag_daftar"  style="display:none">
                                          <td valign="top"></td>
                                          <td  valign="top">Urusan Kemasukkan Maklumat Waris
                                          </td>
                                          <td valign="top">:</td>
                                          <td valign="top">
   ...
   <tr>
    <td>
                              <table width="100%">
                                <tr>
                                  <td><span class="style5 style47 style69"><span class="style41">Perhatian </span>: Sila masukkan salah satu nombor MyID dan pastikan label bertanda <span class="style41">*</span> diisi. Sila masukkan salah satu nombor telefon.</span></td>
                                </tr>
</table> </td>
  </tr>
#end
      ...
      <tr>
       ...
       <!--     <input type="button" name="tambahwaris" id="tambahwaris" value="$buttonwaris" onclick="setSelected(0,2,0,0);tambah_waris()"/> -->
          ...
          <input type="button" name="tambahwaris" id="tambahwaris" value="$buttonwaris" onclick="setSelected(0,2,0,0);tambah_waris()"/> 
            ...
            #if(($chq=="checked" ) && ($buttonwaris=="Simpan" || $buttonwaris=="Kemaskini"))
            <input type="button" name="lapisanberikut" id="lapisanberikut" value="Lapisan Berikut"  onclick="setSelected(0,2,0,0);lapisan_waris()"/>
            #end
            ...
            #end
            #if($nowpast == "past")
            <input type="submit" name="cmdKembali8" id="cmdKembali8" value="Kembali"  onclick="setSelected(0,2,0,0);WarisViewDulu()"/>
            #end
          </div>
                                    ...
                                    <table width="100%">
                                       <input type="hidden" name="txtIdSimatiWaris" value="$idSimati" />
                                        <tr>
                                          ...
                                          <input name="txtNoKPBaru1Waris" id="txtNoKPBaru1Waris" style="width: 50px;" type="text" value="$txtNoKPBaru1Waris" $readmode size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2Waris');check_kp();check_pengenalan_simati_1()" onBlur="getAgeByIC(this,this.value,'txtUmurWaris');getStatusByIC(this,this.value,'socStatusOBWaris');getDOB(this.value)"/>
                                          - 
                                          <input name="txtNoKPBaru2Waris" id="txtNoKPBaru2Waris" style="width: 20px;" type="text" value="$txtNoKPBaru2Waris" $readmode size="3" maxlength="2" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris');check_kp();check_pengenalan_simati_1()" onblur=""/> 
                                          -
                                          <input name="txtNoKPBaru3Waris" id="txtNoKPBaru3Waris"  style="width: 40px;" type="text" value="$txtNoKPBaru3Waris" $readmode size="5" maxlength="4" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris');check_kp();check_pengenalan_simati_1()" onblur="suma_kp_baru();jantinaic2()"            />
                                          <span id="check_kp_1" style="color:red" ></span>
                                          
                                        #if($!skrin_online != "yes" && $!skrin_online_17 != "yes")
  
  <a href="http://www.jpn.gov.my" target="_blank" class="style51 style74 style42">  
  www.jpn.gov.my</a>                        
  #end
                    </td>
                                        </tr>
                                        <tr>
                                          ...
                                          <span id="check_kp_2" style="color:red" ></span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td >&nbsp;</td>
                          ...
                          <option value="7" style="text-transform:uppercase;" >Lain-lain</option>                   
                              ...
                              #set($txtNoKPLainWaris = "")
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><div align="left" class="style72"><span class="style38">No MyID Lain</span></div></td>
                                          <td>:</td>
                                          <td><span class="style36">
                                          ...
                                          <span id="check_kp_3" style="color:red" ></span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
                                        ...
                                        <td width="1%" class="style36"><div align="right"><span class="style38">:</span></div></td>
                                        <td >
<input type="text" id="nama_warga" name="nama_warga" size="30" maxlength="200" $readmode  list="datalist"  value="$nama_warga"    />
                                        <datalist id = 'datalist'>#foreach($ja in $kenegaraan)<option label='$!ja.NAMA_WARGA' value = '$!ja.NAMA_WARGA'></option>#end
                                        </datalist>   
                                       </td>
                                      </tr>
                                        <tr>
                                          ...
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><input name="txdTarikhLahirWaris" type="text" id="txdTarikhLahirWaris" value="$txdTarikhLahirWaris" size="10" maxlength="10" $readmode  onblur="trans_date(this.value);getAgebyDob(this,this.value,'txtUmurWaris')"/>
                            ...
                            <tr>
                              <td><table width="100%" border="0" align="center">
                                  ...
                                  <div align="center">
                                    ...
                                    <input type="button" name="tambahwarisSimpan1" id="tambahwarisSimpan1" value="$buttonwarisSimpan"  onclick="setSelected(0,2,0,0);tambah_waris_Simpan()"/>
                                       #if($flag_kemaskini_selesai != "yes")
                                                    <script>
                                                    document.getElementById('tambahwarisSimpan1').style.display = "none";
                                                    </script>
                                                    #end 
                                    #end 
                                     #if($buttonwarisSimpan=="")
                                    ...
                                    #if($nowpast == "now")
                                      <input type="submit" name="cmdKembali8" id="cmdKembali8" value="Kembali"  onclick="setSelected(0,2,0,0);WarisView()"/>                                   #end
                                       #if($nowpast == "past")
                                      <input type="submit" name="cmdKembali8" id="cmdKembali8" value="Kembali"  onclick="setSelected(0,2,0,0);WarisViewDulu()"/>                                   #end
                                  </div>
                                  #end
                                  </label> </td>
                                  </tr>
                ...
                <table width="100%">
                 ...
                 #set($nowa=$nowa+1)
                  ...
                  <tr >
                    ...
                    <td width="20%" class="row1"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_waris('$listwaris.idwaris','now')" class="style42"> $listwaris.nama_Ob</a></div></td>
                   ...
                   <tr class="table_header">
                    ...
                    <td width="20%" class="row2"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_waris('$listwaris.idwaris','now')" class="style43"> $listwaris.nama_Ob</a></div></td>
                 ...
                 #set($nowa=$nowa+1)
                  ...
                  <tr >
                    ...
                    <td width="20%" class="row1"><div align="center" style="text-transform:uppercase;" onblur="uppercase()">
                      <div align="left"><a href="javascript:get_waris('$listwaris.idwaris','past')" class="style42"> $listwaris.nama_Ob</a></div>
                    </div></td>
                    <td width="15%" class="row1"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwaris.nokpbaru</div></td>
                    <td width="5%" class="row1"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwaris.umur</div></td>
                    ...
                    #end
                    #end
                    <td width="20%" class="row1"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">
                   ...
                   <tr class="table_header">
                    ...
                    <td width="20%" class="row2"><div align="center" style="text-transform:uppercase;" onblur="uppercase()">
                      <div align="left"><a href="javascript:get_waris('$listwaris.idwaris','past')" class="style43"> $listwaris.nama_Ob</a></div>
                    </div></td>
                    <td width="15%" class="row2"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwaris.nokpbaru</div></td>
                    <td width="5%" class="row2"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwaris.umur</div></td>
                    #foreach($listsaudaralist in $listsaudara)
                    ...
                    #end    
                    #end
                    <td width="20%" class="row2"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">
                      <div align="left">$warissaudaraketerangan</div>
                    </div></td>
                    #if($listwaris.statushidup=="0")
                    #set($hidup="Masih Hidup")
      ...
      <table width="100%">
        #set($idwww=$idparent)
          ...
          <div align="center">
            ...
            <td width="20%" class="row1"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_waris_lapisan_X('$listwarislapisan.idwaris','$listwarislapisan.idparent','now')" class="style42"> $listwarislapisan.nama_Ob</a></div></td>
            ...
            <td width="20%" class="row2"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_waris_lapisan_X('$listwarislapisan.idwaris','$listwarislapisan.idparent','now')" class="style42"> $listwarislapisan.nama_Ob</a></div></td>
...
<legend>SENARAI WARIS LAPISAN BERIKUT TERDAHULU</legend>
        ...
        <input type="hidden" name="idparentlapisXDulu" value="" />
          ...
          <div align="center">
            ...
            #set($nowar=0)
              ...
              <tr >
              <td width="5%" class="row1"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$nowar</div></td>
            <td width="20%" class="row1"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_waris_lapisan_X('$listwarislapisan.idwaris','$listwarislapisan.idparent','past')" class="style42"> $listwarislapisan.nama_Ob</a></div></td>
                <td width="15%" class="row1"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwarislapisan.nokpbaru</div></td>
                <td width="5%" class="row1"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwarislapisan.umur</div></td>
                #foreach($listsaudaralist in $listsaudara)
                ...
                <td width="20%" class="row1"><div align="left" class="style72" style="text-transform:uppercase;" onblur="uppercase()">               
                $listwarislapisan.nama_parent</div></td>
               ...
               <tr class="table_header">
              <td width="5%" class="row2"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$nowar</div></td>
            <td width="20%" class="row2"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_waris_lapisan_X('$listwarislapisan.idwaris','$listwarislapisan.idparent','past')" class="style42"> $listwarislapisan.nama_Ob</a></div></td>
                <td width="15%" class="row2"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwarislapisan.nokpbaru</div></td>
                <td width="5%" class="row2"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwarislapisan.umur</div></td>
                #foreach($listsaudaralist in $listsaudara)
                ...
                <td width="20%" class="row2"><div align="left" class="style72" style="text-transform:uppercase;" onblur="uppercase()">
               $listwarislapisan.nama_parent</div></td>
    ...
    <td>
        ...
        <legend>
         #if($nowpast == "now")
                                          MAKLUMAT WARIS LAPISAN BERIKUT
                                          #end
                                           #if($nowpast == "past")
                                          MAKLUMAT WARIS LAPISAN BERIKUT TERDAHULU
                                          #end
    ...
    <td class="style36" width="70%"><span class="style42" style="text-transform:uppercase;" onblur="uppercase()">$listWarisParentlist.nama_Ob</span>
      ...
      <input name="txtLapisParent" type="hidden"  id="textfield31" size="15" value="$listWarisParentlist.lapis" maxlength="2"  $readmode/>    </td>
                                      ...
                                      <tr>
                                          ...
                                          <input name="txtNoKPBaru1Waris" id="txtNoKPBaru1Waris" style="width: 50px;" type="text" value="$txtNoKPBaru1Waris" $readmode size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2Waris');check_kp();check_pengenalan_simati_1()" onBlur="getAgeByIC(this,this.value,'txtUmurWaris');getStatusByIC(this,this.value,'socStatusOBWaris');getDOB(this.value)"/> 
                                          - 
                                          <input name="txtNoKPBaru2Waris" id="txtNoKPBaru2Waris" style="width: 20px;" type="text" value="$txtNoKPBaru2Waris" $readmode size="3" maxlength="2" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris');check_kp();check_pengenalan_simati_1()" /> 
                                          - 
                                          <input name="txtNoKPBaru3Waris" id="txtNoKPBaru3Waris"  style="width: 40px;" type="text" value="$txtNoKPBaru3Waris" $readmode size="5" maxlength="4" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris');check_kp();check_pengenalan_simati_1()" onblur="suma_kp_baru_lap()" />
                                           <span id="check_kp_1" style="color:red" ></span>
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style51 style74 style42">  www.jpn.gov.my</a>     
                                        ...
                                        <tr>
                                          ...
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><label>
                                            <input name="txtNoKPLamaWaris" id="txtNoKPLamaWaris" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();suma_kp_lama_lap()" type="text"  value="$txtNoKPLamaWaris" size="15" maxlength="9" $readmode onkeyup="check_kp_lama();check_pengenalan_simati_2()"/>
...
<tr>
  ...
  <table width="100%" border="0">
                                  <tr>
                                    ...
                                    <table width="100%">
                                       ...
                                       <tr id="tr_waris" >
                                          <td class="style36" width="1%">&nbsp;</td>
                                          <td><div align="right" class="style75 style38">
	...
	document.getElementById('tr_waris').style.display="";
                                      ...
                                      <tr>
                                          <td width="1%" class="style36">&nbsp;</td>
                                  <td width="29%"><div align="right" class="style75 style38">
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style51 style74 style42">  www.jpn.gov.my</a>
                                        ...
                                        <tr>
                                          ...
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><label>
                                            <input name="txtNoKPLamaWaris" id="txtNoKPLamaWaris" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" type="text"  value="$txtNoKPLamaWaris" size="15" maxlength="9" $readmodeR class="$readmode" onkeyup="check_kp_lama();check_pengenalan_simati_2()" />
                                          </label>
                                           <span id="check_kp_2" style="color:red" ></span>                                          </td>
                                        </tr>
                                        <tr>
                            ...
                            <option value="7" style="text-transform:uppercase;" >Lain-lain</option>                 
                              ...
                              #set($txtNoKPLainWaris = "")
                                        ...
                                        <tr>
                                          <td valign="top" class="style36">&nbsp;</td>
                                          <td valign="top" ><div align="right" class="style75 style38">
...
<!--
        ...
        <input type="button" name="tambahwarisSimpan1" id="tambahwarisSimpan1" value="$buttonwarislapisanSimpan"  onclick="setSelected(0,2,0,0);tambah_waris_lapisan_Simpan()"/> 
         #if($flag_kemaskini_selesai != "yes")
                                                    <script>
                                                    document.getElementById('tambahwarisSimpan1').style.display = "none";
                                                    </script>
      ...
      <!--  <input type="button" name="tambahwarislapisan" id="tambahwaris4" value="$buttonwarislapisan" onclick="setSelected(0,2,0,0);tambah_waris_lapisan()"/>-->
              #end
              #if($boleh_kemaskini == "yes") 
              <input type="button" name="tambahwarislapisan" id="tambahwaris4" value="Simpan" onclick="setSelected(0,2,0,0);tambah_waris_lapisan()"/> #end
     ...
     <!--  <input type="button" name="tambahwarishapuslapisan" id="tambahwarishapuslapisan" value="Hapus" onclick="setSelected(0,2,0,0);hapus_waris_lapisan()"/>-->
         ...
         -->
            ...
            <input type="submit" name="cmdKembali9" id="cmdKembali11" value="Kembali" onclick="setSelected(0,2,0,0);WarisView()"/>    
               ...
               #if($nowpast == "past")
            <input type="submit" name="cmdKembali9" id="cmdKembali11" value="Kembali" onclick="setSelected(0,2,0,0);WarisViewDulu()"/>    
            #end
  ...
  <tr>
    ...
    #foreach($lis_wariss in $listWarisLapisan)
    ...
    <fieldset><legend>SENARAI WARIS LAPISAN BERIKUT</legend>
  ...
  <tr>
      ...
      #if($nk_tambah_lapisan=="yes")#if($id_Status != "169" && $id_Status != "21" && $id_Status != "64" && $id_Status != "163" && $id_Status != "164" && $id_Status != "165")
<!--
     ...
     -->
      ...
      #end
      #if($nowpast == "past")
      <input type="submit" name="cmdKembali" id="cmdKembali" value="Kembali" onclick="setSelected(0,2,0,0);WarisViewDulu()"/>
      #end
      -->
      #end
        ...
        <tr class="table_header">
         ...
         #set($bu=0)
          ...
          <td width="5%" class="row1"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$bu</div></td>
            <td width="20%" class="row1"><div align="left"  style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_waris_lapisan('$listwarislapisan.idwaris','$listwarislapisan.idparent','$nowpast')" class="style42"> $listwarislapisan.nama_Ob</a></div></td>
            <td width="15%" class="row1"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwarislapisan.nokpbaru</div></td>
            <td width="5%" class="row1"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwarislapisan.umur</div></td>
            #foreach($listsaudaralist in $listsaudara)
          ...
          <td width="5%" class="row2"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$bu</div></td>
            <td width="20%" class="row2"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_waris_lapisan('$listwarislapisan.idwaris','$listwarislapisan.idparent','$nowpast')" class="style42"> $listwarislapisan.nama_Ob</a></div></td>
            <td width="15%" class="row2"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwarislapisan.nokpbaru</div></td>
            <td width="5%" class="row2"><div align="center" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$listwarislapisan.umur</div></td>
            #foreach($listsaudaralist in $listsaudara)
...
<!--
      ...
      #if($boleh_kemaskini == "yes")  <input type="button" name="naktambahlapisan" id="naktambahlapisan" value="Tambah"  onclick="setSelected(0,2,0,0);tambah_lapisan_berikut()"/> #end
...
function WarisViewDulu() {
	document.f1.action = "";
	document.f1.mode.value = "Warisviewdulu";
	document.f1.command.value = "Waris";
...
function get_waris(idw,np) {
	document.f1.action = "";
	document.f1.mode.value = "Getwaris";
	document.f1.command.value = "Waris";
	document.f1.nowpast.value = np;
...
function get_waris_lapisan(idw,idp,np) {
	document.f1.action = "";
...
function get_waris_lapisan_X(idw,idp,np) {
	document.f1.action = "";
...
/*
   ...
   */
	...
	{	
	alert("No MyID lain waris telah wujud!");
	document.f1.txtNoKPLainWaris.focus()
	return;	
	}
...
var tt = dob_code.charAt(4)+""+dob_code.charAt(5)+"/"+dob_code.charAt(2)+""+dob_code.charAt(3)+"/"+dum+dob_code.charAt(0)+""+dob_code.charAt(1);	
 ...
 var ch="";	
	...
	if( document.f1.tambahwarisSimpan.value == "Simpan" ) 
	{
		...
		else if (document.f1.txtNoKPBaru1Waris.value=="" && document.f1.txtNoKPBaru2Waris.value=="" && document.f1.txtNoKPBaru3Waris.value=="" && document.f1.txtNoSuratBeranakWaris.value==""
 && document.f1.txtNoKPLamaWaris.value=="" && (document.f1.socJenisKPLainWaris.value=="" || document.f1.socJenisKPLainWaris.value=="0" )  && document.f1.txtNoKPLainWaris.value=="")
		 {
		alert("Sila masukkan salah satu nombor MyID atau nombor surat beranak waris");
		document.f1.txtNoKPBaru1Waris.focus();
...
*/   
   else if(ch=="yes" && date3 < date1 )
   {
	...
	return;
	 ...
	 else if (document.f1.checkHidupWaris.checked == false && (document.f1.txtAlamatTerakhir1WarisSurat.value == "" || (document.f1.socWarganegaraWaris.value != "2" && (document.f1.txtPoskodWarisSurat.value == "" || document.f1.txtBandarWarisSurat.value == "" || document.f1.socNegeriWarisSurat.value == "" || document.f1.socNegeriWarisSurat.value == "0"))))
	{
	alert("Sila lengkapkan alamat surat menyurat waris");
	document.f1.txtAlamatTerakhir1WarisSurat.focus()
	return;

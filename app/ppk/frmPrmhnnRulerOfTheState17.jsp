...
<table width="100%"  cellspacing="1" cellpadding="1" border="0">
               ...
               <tr>
                 ...
                 <td width="1%">:</td>
                 <td width="69%">
                 <input name="jenis_rujukan" id="jenis_rujukan"type="radio" value="1" $tempcheckedmahkamahtinggi 
                 onclick="openMT();" />   
                 Mahkamah Tinggi                 
                 </td>
               </tr>
               <tr>
                 <td>&nbsp;</td>
                 <td>&nbsp;</td>
                 <td><input name="jenis_rujukan" id="jenis_rujukan" type="radio" value="2" $tempcheckedrots 
                 onclick="openFlagRujukan();" />
...
<table border="0" width="100%">
             ...
             <table width="100%"  cellspacing="1" cellpadding="1" border="0">
              <tr>
                ...
                <td width="1%">&nbsp;</td>
                <td width="4%">&nbsp;</td>
                <td width="20%"><input name="flag_rujukan" id="flag_rujukan" type="radio" value="1" disabled $tempcheckedms onclick="openROTS();" />
                  Mahkamah Syariah</td>
                <td width="45%"><input name="flag_rujukan" id="flag_rujukan" type="radio" value="2" disabled $tempcheckedpejmufti onclick="openPejMufti();" />
                  Pejabat Mufti</td>
              </tr>
              <tr>
                <td><font color="red">*</font>&nbsp;Negeri</td>
              ...
              <tr>
                <td><font color="red">*</font>&nbsp;Alamat</td>
                <td>:</td>
                <td colspan="3">&nbsp;<input type="text" name="txtAlamat4" id="txtAlamat4" value="$!alamat1" maxlength="50" size="50" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();" readonly class="disabled" /></td>
              </tr>
              <tr>
                <td></td>
                <td>:</td>
                <td colspan="3">&nbsp;<input type="text" name="txtAlamat4" id="txtAlamat5" value="$!alamat2" maxlength="50" size="50" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();" readonly class="disabled" /></td>
              </tr>
              <tr>
                <td></td>
                <td>:</td>
                <td colspan="3">&nbsp;<input type="text" name="txtAlamat4" id="txtAlamat6" value="$!alamat3" maxlength="50" size="50" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase();" readonly class="disabled" /></td>
              </tr>
              <tr>
                <td><font color="red">*</font>&nbsp;Poskod</td>
                <td>:</td>
              ...
              <tr>
               ...
               <tr>
                <td valign="top">&nbsp;&nbsp;&nbsp;Fakta Guaman</td>
                <td valign="top">:</td>
                <td colspan="3" valign="top"><textarea name="txtFaktaGuamanAdd" id="txtFaktaGuamanAdd" cols="80%" rows="8">$!catatan1</textarea></td>
              </tr>
              <tr>
              ...
              <tr>
                <td valign="top">&nbsp;&nbsp;&nbsp;Pendapat / Keputusan / Arahan</td>
                <td valign="top">:</td>
                <td colspan="3" valign="top"><textarea name="txtPendapatAdd" id="txtPendapatAdd"  cols="80%" rows="8" >$!keputusan_mahkamah</textarea></td>
              </tr>
              <tr>
                <td colspan="5" valign="top">&nbsp;</td>
...
Pejabat Mufti</td>
        ...
        <div class="TabbedPanelsContent">
        	<fieldset>
             ...
             <table width="100%"  cellspacing="1" cellpadding="1" border="0"> 
                <tr>
                  <td>Tarikh Hantar Borang J</td>
                  <td>:</td>
                  <td><input name="txdTarikhHantarAdd" value="" size="11" id="txdTarikhHantarAdd" type="text" readonly class="disabled" />
</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td valign="top">:</td>
                  <td>
                  <textarea name="txtKeputusanAdd" cols="80%" rows="8" id="txtKeputusanAdd"></textarea>
                  </td>
                </tr>
              ...
              <script> 			  
                ...
                <tr>
                  ...
                  <td width="1%" valign="top">:</td>
                  <td width="68%">
                  <textarea name="txtCatatanAdd" cols="80%" rows="8" id="txtCatatanAdd"></textarea>
                  </td>
               </tr> 
         ...
         <legend>SENARAI FAIL</legend>    	
            <table width="100%" border="0" cellspacing="0">
              ...
              <tr>
                ...
                <a href="javascript: hapusFail('$lampiran.id_lampiran','$lampiran.id_dokumen');"><img src="../img/hapus.gif" alt="Hapus" border="0" width="18" height="18" /></a></div>
                </td>
              </tr>
            #end
            </table>
     ...
     <table width="100%"  cellspacing="1" cellpadding="1" border="0">          
            ...
            <fieldset>
              <legend><strong>SENARAI WARIS</strong></legend>
                 ...
                 <table width="100%" border="0" cellspacing="2">
                     <tr>
                     	<td colspan="5"><input type="button" name="cmdTambahWaris" id="cmdTambahWaris" value="Tambah" onclick="javascript:pilihWaris('$id_perbicaraan')" /></td>
                    </tr>
                    <tr class="table_header">
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td width="3%">&nbsp;</td>
              <td width="21%"><input name="flag_rujukan" id="flag_rujukan" type="radio" value="1" disabled="disabled" $tempcheckedms onclick="openROTS();" />
Mahkamah Syariah</td>
              <td width="46%"><input name="flag_rujukan" id="flag_rujukan" type="radio" value="2" disabled="disabled" $tempcheckedpejmufti onclick="openPejMufti();" />
Pejabat Mufti</td>
            </tr>
            <tr>
               <td width="30%"><font color="red">*</font>&nbsp;Tarikh Rujukan</td>
            ...
            <tr>
              <td><font color="red">*</font>&nbsp;Alamat SYARIAH</td>
              <td>:</td>
             ...
             <table width="100%"  cellspacing="1" cellpadding="1" border="0"> 
              ...
              <script> 
                ...
                <tr>
                  ...
                  <td width="1%" valign="top">:</td>
                  <td><input type="button" name="cmdUpload" id="cmdUpload" value="Upload Fail" onclick="OpenUploadFile('$idpermohonan','$idFail')" /></td>
               </tr>      
             </table>
         ...
         <legend>SENARAI FAIL</legend>    	
            <table width="100%" border="0" cellpadding="1" cellspacing="2">
              <tr class="table_header">
                <td width="8%" align="center" style="text-transform:uppercase" scope="row">Bil</td>
      			<td width="33%" style="text-transform:uppercase">Nama</td>
      			<td width="31%" style="text-transform:uppercase">Tajuk</td>
                <td width="14%" style="text-transform:uppercase">Hapus</td>
              </tr>
              #set ($counter = 0)
              #foreach($lampiran in $SenaraiLampiran)
              ...
              <tr>
                ...
                <td width="14%" class="$row"><div align="center">
                <!--<input type="button" name="cmdHapus" id="cmdHapus" value="Hapus" onclick="javascript: hapusFail('$lampiran.id_lampiran','$lampiran.id_dokumen');" >-->
...
<table width="100%"  cellspacing="1" cellpadding="1" border="0">           
        ...
        <table border="0" width="100%">
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td width="2%">&nbsp;</td>
              <td width="20%"><input name="flag_rujukan" id="flag_rujukan" type="radio" value="1" disabled $tempcheckedms />
Mahkamah Syariah</td>
              <td width="47%"><input name="flag_rujukan" id="flag_rujukan" type="radio" value="2" disabled $tempcheckedpejmufti />
Pejabat Mufti</td>
            </tr>
            <tr>
              <td><font color="red">*</font>&nbsp;Negeri</td>
       ...
       <table width="100%">
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td width="3%">&nbsp;</td>
              <td width="21%"><input name="flag_rujukan" id="flag_rujukan3" type="radio" value="1" disabled="disabled" $tempcheckedms />
Mahkamah Syariah</td>
              <td width="45%"><input name="flag_rujukan" id="flag_rujukan4" type="radio" value="2" disabled="disabled" $tempcheckedpejmufti />
Pejabat Mufti</td>
          </tr>
            <tr>
               <td width="30%"><font color="red">*</font>&nbsp;Tarikh Rujukan</td>
            ...
            <tr>
              <td><font color="red">*</font>&nbsp;Alamat MUFTI</td>
              <td>:</td>
              ...
              <table width="100%">
                    ...
                    <tr>
                      <td>
                        ...
                        #if ( $idstatus == "44" || $idstatus == "172" || $idstatus == "173" || $idstatus == "174" || $idstatus == "175" || $idstatus == "176" || $idstatus == "177" )
                        <input name="cmdKembali" type="button" value="Kembali" 
                        onclick="javascript: kembali_skrinROTSedit('$idpermohonan','$id_perbicaraan');" />
                        #end                      
                      </div>
                      </td>
                	</tr>            
        	...
        	<fieldset>
             ...
             <table width="100%"  cellspacing="1" cellpadding="1" border="0"> 
                <tr>
                  <td>Tarikh Hantar Borang J</td>
                  <td>:</td>
                  <td><input name="txdTarikhHantarAdd" value="$!tarikh_hantar_borangj" size="11px" id="txdTarikhHantarAdd" type="text" readonly class="disabled" /></td>
                </tr>
                <tr>
                  <td>Tarikh Terima Keputusan</td>
                  <td>:</td>
                  <td><input name="txdTarikhTerimaAdd" value="$!tarikh_terima_borangj" size="11px" id="txdTarikhTerimaAdd" type="text" readonly class="disabled" /></td>
                </tr>
                <tr>
                  <td valign="top">Keputusan</td>
                  <td valign="top">:</td>
...
function OpenUploadFile(idpermohonan,idFail,command2) {
//	var url = "../x/${securityToken}/ekptg.view.ppk.FrmUploadFail17?idPermohonan="+idPermohonan+"&idFail="+idFail+"&command2="+command2;
...
//function kembali_skrinROTS(idpermohonan,id_perbicaraan) {
//	document.${formName}.idpermohonan.value = idpermohonan;
//	document.${formName}.id_perbicaraan.value = id_perbicaraan;
//	document.${formName}.command.value = "kembali_skrinROTS";
...
//function Simpan_Keputusan(){
//	if(document.${formName}.txdTarikhHantarAdd.value == 0){
//		alert("Sila masukkan \"Tarikh Hantar Borang J\" terlebih dahulu.");
//  		document.${formName}.txdTarikhHantarAdd.focus(); 
//		return;
//	}
//	if(document.${formName}.txdTarikhTerimaAdd.value == 0){
//		alert("Sila masukkan \"Tarikh Terima Keputusan\" terlebih dahulu.");
//  		document.${formName}.txdTarikhTerimaAdd.focus(); 
//		return;
//	}else{
//	if ( !window.confirm("Adakah Anda Pasti?")) return;
//	document.${formName}.command.value="Simpan_Keputusan";
//	//document.${formName}.action="";
//	//document.${formName}.action = "?command=uploadFile&idpermohonan="+idpermohonan;
//	document.${formName}.submit();
//	}
//}
...
//	if(document.${formName}.socBandar.value == 0){
...
function TambahMuftiIDP(idpermohonan,id_perbicaraan,id_perintah) {
	var url = "../x/${securityToken}/ekptg.view.ppk.PopupTambahMufti17?idpermohonan="+idpermohonan+"&id_perbicaraan="+id_perbicaraan+"&id_perintah="+id_perintah;
    var hWnd = window.open(url,'printuser','width=1000,height=350, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
       hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function pilihWaris(id_perbicaraan) {
	var url = "../x/${securityToken}/ekptg.view.ppk.PopupTambahWaris17?id_perbicaraan="+id_perbicaraan;
    var hWnd = window.open(url,'printuser','width=1000,height=350, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
       hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();

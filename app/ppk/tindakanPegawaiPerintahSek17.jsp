          ...
          <input type="hidden" name="enabledPegawai" id="enabledPegawai" value="$enabledPegawai">
            ...
            <tr>
             ...
             <td colspan=3 align=justify>
              		...
              		<input type="button" name="cmdHPNB1" id="cmdHPNB1" value="Pengesahan Tandatangan" onClick="sendDGCertPerintahSek17('$!NO_FAIL','$!id_perintah','$!id_fail','$id_permohonan','$idpermohonansimati','$idperintah')" />
              	#end
              #end
              </td></tr>
              #end

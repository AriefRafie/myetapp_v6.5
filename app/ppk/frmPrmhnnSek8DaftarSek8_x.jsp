...
<body onLoad="submitForm();calcDate();check_kp();">
...
<table width="100%" border="0">
...
#end
            #if ($EventStatus == "0") <a href="javascript:displayDatePicker('txdTarikhMohon',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/>
  ...
  <input name="txtNoKPBaruSimati2" id="txtNoKPBaruSimati2" style="width: 20px;" type="text" value="$nokpbaru2x" size="3" maxlength="2" readonly class="disabled" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')" onBlur="check_kp();check_pengenalan_simati_1()"  />
                -
  <input name="txtNoKPBaruSimati3" id="txtNoKPBaruSimati3"  style="width: 40px;" type="text" value="$nokpbaru3x" readonly class="disabled" size="5" maxlength="4"  onblur="jantinaic();check_kp();check_pengenalan_simati_1();kp_baru_pemohon()" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')"  />
  ...
  <input name="txtNoKPBaruSimati2" id="txtNoKPBaruSimati2" style="width: 20px;" type="text" value="$noKpBaru2" size="3" maxlength="2" readonly class="disabled" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')"  onBlur="check_kp();check_pengenalan_simati_1()"  />
                -
  <input name="txtNoKPBaruSimati3" id="txtNoKPBaruSimati3"  style="width: 40px;" type="text" value="$noKpBaru3" readonly class="disabled" size="5" maxlength="4" onBlur="jantinaic();check_kp();check_pengenalan_simati_1();kp_baru_pemohon()" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')"  />
...
<input name="flag_dup_p3" id="flag_dup_p3"  type="hidden" />
  ...
  <input name="txtNoKPBaruSimati2" id="txtNoKPBaruSimati2" style="width: 20px;" type="text" value="$noKpBaru2" size="3" maxlength="2" $setmodeR class="$setmode" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')"  onBlur="check_kp();check_pengenalan_simati_1()"  />
                -
  <input name="txtNoKPBaruSimati3" id="txtNoKPBaruSimati3"  style="width: 40px;" type="text" value="$noKpBaru3" $setmodeR class="$setmode" size="5" maxlength="4" onBlur="jantinaic();check_kp();check_pengenalan_simati_1();kp_baru_pemohon()" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaruSimati3')"  /><span id="check_kp_1" style="color:red" ></span>
...
<input name="flag_dup_p3" id="flag_dup_p3"  type="hidden" />
  ...
  <span class="style36"> <a href="http://www.jpn.gov.my" target="_blank" class="style51"> www.jpn.gov.my</a></span>
            ...
            #set($setmodR = "")
            	...
            	<input name="txtNoKPLainSimati" id="txtNoKPLainSimati" onBlur="this.value=this.value.toUpperCase();check_kp_lain();check_pengenalan_simati_3();kp_lain_pemohon()" style="width: 97px; text-transform:uppercase;" type="text" value="$noKpLainx" $setmodR class="$setmod" maxlength="9" />
       ...
       <input name="txtNoKPLainSimati" onBlur="this.value=this.value.toUpperCase();check_kp_lain();check_pengenalan_simati_3();kp_lain_pemohon()" id="txtNoKPLainSimati" style="width: 97px; text-transform:uppercase;" type="text" value="$noKpLain" $setmodR class="$setmod"  maxlength="9" />
            <span id="check_kp_3" style="color:red" ></span> 

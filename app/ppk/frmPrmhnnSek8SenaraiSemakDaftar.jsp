...
#set ($chkmode = "")
	...
	#foreach($List in $ListSemakan)
		...
		<!-- arief commend -->
			...
			#set ($txtchecked6d = $List.tarikh_pelbagai)
		#end
          ...
          <tr>
            ...
            <td>Tarikh Bayaran
              <label>
                ...
                #if ($SimpanStatus != "2") <a href="javascript:displayDatePicker('txdTarikhByrn',false,'dmy');"><img src="../img/calendar.gif" alt="" border="0"/></a> <span class="style3 style6"><em>dd/mm/yyyy</em></span>#end </label></td>
          </tr>
          #if($chkmode != "disabled")
          #if ($SimpanStatus != "2")
          #end
...
<!--             <td width="10%" >&nbsp;</td> -->
<!--             <td width="1%" >&nbsp;</td> -->
<!--             <td width="89%" ><input name="cbsemaks" $chkmode type="checkbox" id="cbsemaks20" $checked25 value="25" /> -->
...
<!-- 		          #set($chkmodeR = "" ) -->
<!-- 		          #end -->
<!--         		<textarea name="txtLainLainTujuan" id="txtLainLainTujuan" $chkmodeR class="$chkmode" cols="35" rows="5" style="text-transform:uppercase;" onKeyUp="checkitD()" onBlur="this.value=this.value.toUpperCase()" >$txtchecked24</textarea> -->
<!--         	</td> -->
<!--           </tr> -->
<!--         </table> -->
<!--         </td> -->
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            ...
            <input name="cbsemaks" type="checkbox" id="cbsemaks7" $chkmode value="11" $checked11 onClick="ReadOnlyCheckBox(this);checkit10()" />      
       ...
       <tr>
        <td><table width="100%" border="0">
          <tr>
            <td width="10%" >&nbsp;</td>
            <td width="1%" >&nbsp;</td>
            <td width="89%" ><input name="cbsemaks" $chkmode type="checkbox" id="cbsemaks20" $checked25 value="16171000000" />
              Lain - lain Catatan</td>
          </tr>
        </table>
...
<table width="100%">
  <tr>
    <td class="style5 style3"><em><span class="style2">Perhatian</span> : Sila  pastikan label bertanda <span class="style2">*</span> diisi.</em></td>
  </tr>
</table>
#end
<p align="center">
...
function checkitD()
{
 ...
 if (document.f1.txtLainLain.value != "")
	{	
	document.f1.cbsemaks[16].checked = true;
	document.f1.cbsemaks[22].checked = true;
	}	
...
function DoTheCheck() {
	...
	else if (document.f1.cbsemakradio[1].checked == true && document.f1.txtNoKesMahkamah.value == ""){
		alert("Sila masukkan No. Kes Mahkamah");
	}

  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style51" >  www.jpn.gov.my</a>
                                      ...
                                      <tr id="individu_kp2">
                                        ...
                                        <td class="style36"><label>
                                          <input name="txtNoKPLamaPemohon" type="text" id="txtNoKPLamaPemohon"  value="$listpemohon.noKpLama" size="12" maxlength="9" $readmodeR class="$readmode" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" />
                                        </label></td>
                                      </tr>
                              ...
                              #set($readmodekp="disabled")
                                      ...
                                      <tr id="individu_kp4">
                                        ...
                                        #if($readmode == "disabled")
                                          <input name="txtNoKPLainPemohon" type="text" id="textfield5" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()"  value="$listpemohon.noKpLain" size="12" maxlength="25"  $readmodeR class="$readmode"  />
                                        #else
                                       
                                      <input name="txtNoKPLainPemohon" type="text" id="textfield5" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()"  value="$listpemohon.noKpLain" size="12" maxlength="25" $readmodekp />
                                        #end                                        </td>
                                      </tr>
                                      </span>
...
<select name="txtBandarPemohonSurat" id="txtBandarPemohonSurat" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarSurat()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                              ...
                              <table width="100%">
                                <tr>
                                  <td><span class="style5 style47"><span class="style44">Perhatian </span>: Sila masukkan salah satu nombor kad pengenalan  dan pastikan label bertanda <span class="style44">*</span> diisi.</span></td>
                                </tr>
...
if (document.f1.txtNamaPemohonPemohon.value=="") {
		...
		alert("Sila masukkan salah satu nombor kad pengenalan pemohon ");
	 ...
	 {
	 	alert("Sila masukkan nombor kad pengenalan lain pemohon ");
		document.f1.txtNoKPLainPemohon.focus();
		return; 
	 }
	 else if ((document.f1.status_pemohon.value == "2" && (document.f1.socJenisKPLainPemohon.value!="0" && document.f1.socJenisKPLainPemohon.value!="") && (document.f1.txtNoKPLainPemohon.value=="")))
	 {
	 	alert("Sila pilih jenis kad pengenalan lain pemohon ");
	 ...
	 else if (document.f1.status_pemohon.value == "2" && (document.f1.txtnoKpBaru1Pemohon.value!="" || document.f1.txtnoKpBaru2Pemohon.value!="" || document.f1.txtnoKpBaru3Pemohon.value!="") && (document.f1.txtnoKpBaru1Pemohon.value==""))
	 {
		...
		alert("Sila masukkan nombor kad pengenalan pemohon sepenuhnya");
		document.f1.txtnoKpBaru1Pemohon.focus();
		return; 
	}
	...
	else if(document.f1.txtNoKPLamaPemohon.value != "" && document.f1.txtNoKPLamaPemohon.value.length<7)
	{
		...
		else if (document.f1.txtPoskodPemohon.value != "" && document.f1.txtPoskodPemohon.value.length < 5) {
...
/*
	...
	*/
	...
	else if (document.f1.socWarganegaraPemohon.value != "2" && (document.f1.txtAlamatTerakhir1Pemohon.value == "" || document.f1.txtPoskodPemohon.value == ""  || document.f1.socNegeriPemohon.value == "" || document.f1.socNegeriPemohon.value == "0"))
	{
	...
	else if (document.f1.socWarganegaraPemohon.value != "2" && (document.f1.txtAlamatTerakhir1PemohonSurat.value == "" || document.f1.txtPoskodPemohonSurat.value == "" || document.f1.socNegeriPemohonSurat.value == "" || document.f1.socNegeriPemohonSurat.value == "0"))
	{

  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style51 style74 style42">  www.jpn.gov.my</a>  
                                        ...
                                        <tr>
                                          ...
                                          <td class="style36"><label>
                                            <input name="txtNoKPLamaWaris" id="txtNoKPLamaWaris" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" onkeyup="check_kp_lama();check_pengenalan_simati_2()" type="text"  value="$txtNoKPLamaWaris" size="15" maxlength="9" $readmodeR class="$readmode" />
                              ...
                              #set($txtNoKPLainWaris = "")
                                        ...
                                        <tr>
                                          ...
                                          <td class="style36"><input name="txtNoSuratBeranakWaris" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()"  onkeyup="check_pengenalan_simati_4()" type="text" id="txtNoSuratBeranakWaris" value="$txtNoSuratBeranakWaris" size="15" maxlength="10" $readmodeR class="$readmode" />
                                            <span id="check_kp_4" style="color:red" ></span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
   ...
   <tr>
    <td>
                              <table width="100%">
                                <tr>
                                  <td><span class="style5 style47 style69"><span class="style41">Perhatian </span>: Sila masukkan salah satu nombor kad pengenalan dan pastikan label bertanda <span class="style41">*</span> diisi.</span></td>
                                </tr>
</table>
 </td>
  </tr>
        ...
        <td>
          <div align="center">
           ...
           <!-- <input type="button" name="tambahwaris" id="tambahwaris" value="$buttonwaris"  onclick="setSelected(0,2,0,0);tambah_waris()"/> -->
            ...
            #if($boleh_kemaskini == "yes")<input type="button" name="tambahwaris" id="tambahwaris" value="$buttonwaris"  onclick="setSelected(0,2,0,0);tambah_waris()"/>#end
               ...
               <!-- <input type="button" name="tambahwarishapus" id="tambahwarishapus" value="Hapus" onclick="setSelected(0,2,0,0);hapus_waris()"/> -->
                ...
                #if($boleh_kemaskini == "yes")<input type="button" name="tambahwarishapus" id="tambahwarishapus" value="Hapus" onclick="setSelected(0,2,0,0);hapus_waris()"/>#end
                                    ...
                                    <table width="100%">
                                       <input type="hidden" name="txtIdSimatiWaris" value="$idSimati" />
                                        <tr>
                                          ...
                                          <input name="txtNoKPBaru1Waris" id="txtNoKPBaru1Waris" style="width: 50px;" type="text" value="$txtNoKPBaru1Waris" $readmode size="7" maxlength="6" 
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style51 style74 style42">  www.jpn.gov.my</a>                                          </td>
                                        ...
                                        <tr>
                                          ...
                                          <td class="style36"><label>
                                            ...
                                            <input name="txtNoKPLamaWaris" id="txtNoKPLamaWaris" style="text-transform:uppercase;" onkeyup="check_kp_lama();check_pengenalan_simati_2()"  onblur="this.value=this.value.toUpperCase();suma_kp_lama()" type="text"  value="$txtNoKPLamaWaris" size="15" maxlength="9" $readmode/>
...
<legend>SENARAI WARIS LAPISAN PERTAMA</legend>
    ...
    <table width="100%">
     ...
     <!--   <input type="button" name="naktambah" id="naktambah" value="Tambah" onclick="setSelected(0,2,0,0);new_waris()"/> -->
        ...
        #if($boleh_kemaskini == "yes")<input type="button" name="naktambah" id="naktambah" value="Tambah" onclick="setSelected(0,2,0,0);new_waris()"/>#end
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
   ...
   <tr>
    <td>
                              <table width="100%">
                                <tr>
                                  <td><span class="style5 style47 style69"><span class="style41">Perhatian </span>: Sila masukkan salah satu nombor pengenalan dan pastikan label bertanda <span class="style41">*</span> diisi.</span></td>
                                </tr>
</table>
 </td>
  </tr>
  ...
  <tr>
    ...
    <td><table width="100%" border="0" align="center">
      ...
      <!--   <input type="button" name="tambahwarislapisanSimpan" id="tambahwarisSimpan" value="$buttonwarislapisanSimpan"  onclick="setSelected(0,2,0,0);tambah_waris_lapisan_Simpan()"/> -->
       ...
       #if($boleh_kemaskini == "yes")<input type="button" name="tambahwarislapisanSimpan" id="tambahwarisSimpan" value="$buttonwarislapisanSimpan"  onclick="setSelected(0,2,0,0);tambah_waris_lapisan_Simpan()"/>#end
...
var tt = dob_code.charAt(4)+""+dob_code.charAt(5)+"/"+dob_code.charAt(2)+""+dob_code.charAt(3)+"/"+dum+dob_code.charAt(0)+""+dob_code.charAt(1);	
	...
	if(document.f1.txtNamaOBWaris.value == ""){
		 ...
		 {
		alert("Sila masukkan salah satu nombor kad pengenalan atau nombor surat beranak waris");
		document.f1.txtNoKPBaru1Waris.focus();
	...
	{
		alert("Sila lengkapkan No KP Lama Waris");
...
/*
   ...
   */
   else if(ch=="yes" && date3 < date1 )
   {
	...
	else if (document.f1.checkHidupWaris.checked == false && (document.f1.txtAlamatTerakhir1Waris.value == "" || document.f1.txtPoskodWaris.value == ""  || document.f1.socNegeriWaris.value == "" || document.f1.socNegeriWaris.value == "0"))
	{
	...
	return;
	 ...
	 else if (document.f1.checkHidupWaris.checked == false && (document.f1.txtAlamatTerakhir1WarisSurat.value == "" || document.f1.txtPoskodWarisSurat.value == "" || document.f1.socNegeriWarisSurat.value == "" || document.f1.socNegeriWarisSurat.value == "0"))
	{
   ...
   */
	...
	{	
	alert("No kad pengenalan baru waris telah wujud!");
	document.f1.txtNoKPBaru1Waris.focus()
	return;	
	}
	else if (document.f1.flag_dup_2.value == 'yes' )
	{	
	alert("No kad pengenalan lama waris telah wujud!");
	document.f1.txtNoKPLamaWaris.focus()
	return;	
	}
	else if (document.f1.flag_dup_3.value == 'yes' )
	{	
	alert("No kad pengenalan lain waris telah wujud!");
	document.f1.txtNoKPLainWaris.focus()
	return;	
	}

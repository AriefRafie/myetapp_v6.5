...
<table border="0" align="center" width="100%" >
  	...
  	<td>
  		<a href="javascript:PrintLaporanBaitulmal1()" class="style1" >LAPORAN HARTA DISERAHKAN KEPADA BAITULMAL (MENGIKUT DAERAH)</a>
 	</td>
   	</tr>	
   	  	<tr>
  	<td>2.</td>
  	...
  	<td>
  		<a href="javascript:PrintLaporanBaitulmal2()" class="style1" >LAPORAN HARTA DISERAHKAN KEPADA BAITULMAL (MENGIKUT DAERAH & TAHUN)</a>
 	</td>
   	</tr>
   	   	  	<tr bgcolor="#8BE75A">
  	<td>3.</td>
  	...
  	<td>
  		<a href="javascript:PrintLaporanBaitulmal3()" class="style1" >LAPORAN HARTA DISERAHKAN KEPADA BAITULMAL (MENGIKUT DAERAH & SELANG MASA)</a>
 	</td>
   	</tr>
   	   	  	<tr >
  	<td>4.</td>
  	...
  	<td>
  		<a href="javascript:PrintLaporanBaitulmal4()" class="style1" >LAPORAN HARTA DISERAHKAN KEPADA BAITULMAL (MENGIKUT DAERAH & BULAN)</a>
 	</td>
   	</tr>
   	<tr >
  	<td></td>
	...
	<tr bgcolor="#8BE75A">
  	...
  	<td>
  		<a href="javascript:PrintLaporanPBN1()" class="style1" >LAPORAN HARTA DISERAHKAN KEPADA PBN (MENGIKUT DAERAH)</a>
 	</td>
   	</tr>	
   	  	<tr>
  	<td>2.</td>
  	...
  	<td>
  		<a href="javascript:PrintLaporanPBN2()" class="style1" >LAPORAN HARTA DISERAHKAN KEPADA PBN (MENGIKUT DAERAH & TAHUN)</a>
 	</td>
   	</tr>
   	   	  	<tr bgcolor="#8BE75A">
  	<td>3.</td>
  	...
  	<td>
  		<a href="javascript:PrintLaporanPBN3()" class="style1" >LAPORAN HARTA DISERAHKAN KEPADA PBN (MENGIKUT DAERAH & SELANG MASA)</a>
 	</td>
   	</tr>
   	   	  	<tr >
  	<td>4.</td>
  	...
  	<td>
  		<a href="javascript:PrintLaporanPBN4()" class="style1" >LAPORAN HARTA DISERAHKAN KEPADA PBN (MENGIKUT DAERAH & BULAN)</a>
 	</td>
   	</tr>
</table>
</fieldset>	
...
function PrintLaporanBaitulmal1()
{
		...
		var url = "../x/${securityToken}/ekptg.view.ppk.PaparanLaporanSerahanBaitulmalPBN?mula_hari="+mula_hari+"&mula_bulan="+mula_bulan+"&mula_tahun="+mula_tahun+"&akhir_hari="+akhir_hari+"&akhir_bulan="+akhir_bulan+"&akhir_tahun="+akhir_tahun+"&jenis_laporan=Baitulmaldaerah&daerah="+daerah;
...
function PrintLaporanBaitulmal2()
{
	...
	//}
		...
		var akhir = Date.parse(akhirtemp);
		var tarikhsemasa = new Date();
		var url = "../x/${securityToken}/ekptg.view.ppk.PaparanLaporanSerahanBaitulmalPBN?mula_hari="+mula_hari+"&mula_bulan="+mula_bulan+"&mula_tahun="+mula_tahun+"&akhir_hari="+akhir_hari+"&akhir_bulan="+akhir_bulan+"&akhir_tahun="+akhir_tahun+"&jenis_laporan=Baitulmaldaerahtahun";
		var hWnd = window.open(url,'printuser','width=900,height=500, resizable=yes,scrollbars=yes');
  		if ((document.window != null) && (!hWnd.opener))
  	     hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function PrintLaporanBaitulmal3()
{
	if (document.${formName}.txdMula.value==""){
		alert("Sila masukkan Tarikh Mula Laporan");
		txdMula.focus();
		...
		var akhir = Date.parse(akhirtemp);
		var tarikhsemasa = new Date();
		var url = "../x/${securityToken}/ekptg.view.ppk.PaparanLaporanSerahanBaitulmalPBN?mula_hari="+mula_hari+"&mula_bulan="+mula_bulan+"&mula_tahun="+mula_tahun+"&akhir_hari="+akhir_hari+"&akhir_bulan="+akhir_bulan+"&akhir_tahun="+akhir_tahun+"&jenis_laporan=Baitulmalselangmasa";
		var hWnd = window.open(url,'printuser','width=900,height=500, resizable=yes,scrollbars=yes');
  		if ((document.window != null) && (!hWnd.opener))
  	     hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function PrintLaporanBaitulmal4()
{
	if (document.${formName}.txdMula.value==""){
		alert("Sila masukkan Tarikh Mula Laporan");
		txdMula.focus();
		...
		var akhir = Date.parse(akhirtemp);
		var tarikhsemasa = new Date();
		var url = "../x/${securityToken}/ekptg.view.ppk.PaparanLaporanSerahanBaitulmalPBN?mula_hari="+mula_hari+"&mula_bulan="+mula_bulan+"&mula_tahun="+mula_tahun+"&akhir_hari="+akhir_hari+"&akhir_bulan="+akhir_bulan+"&akhir_tahun="+akhir_tahun+"&jenis_laporan=Baitulmaldaerahbulan";
		var hWnd = window.open(url,'printuser','width=900,height=500, resizable=yes,scrollbars=yes');
  		if ((document.window != null) && (!hWnd.opener))
  	     hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function PrintLaporanPBN1()
{
	if (document.${formName}.txdMula.value==""){
		...
		var akhir = Date.parse(akhirtemp);
		var tarikhsemasa = new Date();
		var url = "../x/${securityToken}/ekptg.view.ppk.PaparanLaporanSerahanBaitulmalPBN?mula_hari="+mula_hari+"&mula_bulan="+mula_bulan+"&mula_tahun="+mula_tahun+"&akhir_hari="+akhir_hari+"&akhir_bulan="+akhir_bulan+"&akhir_tahun="+akhir_tahun+"&jenis_laporan=PBNdaerah";
		var hWnd = window.open(url,'printuser','width=900,height=500, resizable=yes,scrollbars=yes');
  		if ((document.window != null) && (!hWnd.opener))
  	     hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function PrintLaporanPBN2()
{
	if (document.${formName}.txdMula.value==""){
		...
		var akhir = Date.parse(akhirtemp);
		var tarikhsemasa = new Date();
		var url = "../x/${securityToken}/ekptg.view.ppk.PaparanLaporanSerahanBaitulmalPBN?mula_hari="+mula_hari+"&mula_bulan="+mula_bulan+"&mula_tahun="+mula_tahun+"&akhir_hari="+akhir_hari+"&akhir_bulan="+akhir_bulan+"&akhir_tahun="+akhir_tahun+"&PBN=1";
		var hWnd = window.open(url,'printuser','width=900,height=500, resizable=yes,scrollbars=yes');
  		if ((document.window != null) && (!hWnd.opener))
  	     hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function PrintLaporanPBN3()
{
	if (document.${formName}.txdMula.value==""){
		...
		var akhir = Date.parse(akhirtemp);
		var tarikhsemasa = new Date();
		var url = "../x/${securityToken}/ekptg.view.ppk.PaparanLaporanSerahanBaitulmalPBN?mula_hari="+mula_hari+"&mula_bulan="+mula_bulan+"&mula_tahun="+mula_tahun+"&akhir_hari="+akhir_hari+"&akhir_bulan="+akhir_bulan+"&akhir_tahun="+akhir_tahun+"&jenis_laporan=PBNselangmasa";
		var hWnd = window.open(url,'printuser','width=900,height=500, resizable=yes,scrollbars=yes');
  		if ((document.window != null) && (!hWnd.opener))
  	     hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();

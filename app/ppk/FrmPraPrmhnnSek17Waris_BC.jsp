...
#set($id_Status = $list.id_Status)
  ...
  <div align="right">No Fail Semasa : <span class="style40 style42">$!nofaildunia</span></div>
 </p>
...
#parse("app/ppk/maklumat_sek8.jsp")
            ...
            <table width="100%" border="0">
                                    <tr>
                                     ...
                                     #set($pastcheck = "checked")   
                                      ...
                                      <td width="1%">:</td>
                                      <td width="94%">
                                        <div align="left">#if($nowpast == "now") <span class="style42">Senarai Waris Terkini </span>#else
                                      Senarai Waris Terkini
                                      #end                                      </div></td>
                                  ...
                                  <tr>
                                    ...
                                    <table width="100%">
                                       <input type="hidden" name="txtIdSimatiWaris" value="$idSimati" />
                                        <tr>
                                          <td width="1%">&nbsp;</td>
                                          <td width="28%"><div align="left" class="style75"><span class="style38">No KP Baru</span></div></td>
                                          <td width="1%" class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td width="70%" class="style36">
                                      
                                          <input name="txtNoKPBaru1Waris" id="txtNoKPBaru1Waris" style="width: 50px;" type="text" value="$txtNoKPBaru1Waris" $readmodeR class="$readmode" size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2Waris')" onBlur="getAgeByIC(this,this.value,'txtUmurWaris');getStatusByIC(this,this.value,'socStatusOBWaris');getDOB(this.value)"/> 
                                          - 
                                          <input name="txtNoKPBaru2Waris" id="txtNoKPBaru2Waris" style="width: 20px;" type="text" value="$txtNoKPBaru2Waris" $readmodeR class="$readmode" size="3" maxlength="2" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris')"/> 
                                          - 
                                          <input name="txtNoKPBaru3Waris" id="txtNoKPBaru3Waris"  style="width: 40px;" type="text" value="$txtNoKPBaru3Waris" $readmodeR class="$readmode" size="5" maxlength="4" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris')" onblur="jantinaic2();setSelected(0,2,0,0);tarikh_waris_saudara('txtNoKPLamaWaris','up')" />
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style51 style74 style42">  www.jpn.gov.my</a>  
                                        ...
                                        <tr>
                                          <td >&nbsp;</td>
                                          <td ><div align="left" class="style75"><span class="style38">No KP Lama</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><label>
                                            <input name="txtNoKPLamaWaris" id="txtNoKPLamaWaris" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" type="text"  value="$txtNoKPLamaWaris" size="15" maxlength="8" $readmodeR class="$readmode" />
                                          </label></td>
                                        </tr>
                                        <tr>
                                          <td >&nbsp;</td>
                                          <td ><div align="left" class="style75"><span class="style38">Lain-lain KP</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36">
                                          #if($readmode=="disabled")
                              ...
                              #set($txtNoKPLainWaris = "")
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><div align="left" class="style75"><span class="style38">No Lain-lain KP</span></div></td>
                                          <td>:</td>
                                          <td><span class="style36">
                                          #if($readmode == "disabled")
                                          <input name="txtNoKPLainWaris" type="text" id="txtNoKPLainWaris2"  style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" value="$txtNoKPLainWaris" size="15" maxlength="12" $readmodeR class="$readmode" />
                                          #else
                                          
                                            <input name="txtNoKPLainWaris" type="text" id="txtNoKPLainWaris2"  style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" value="$txtNoKPLainWaris" size="15" maxlength="12" $readmodekp />
                                            #end
                                          </span></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><div align="left" class="style75"><span class="style38">Warganegara</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><label>
                                          #if($readmode=="disabled")
                                          ...
                                          <input name="socWarganegaraPe" type="text" id="textfield"  style="text-transform:uppercase;" onblur="uppercase()" size="25" $readmodeR class="$readmode" value="$wrp" />
                                            ...
                                            <select name="socWarganegaraWaris" id="socWarganegaraWaris" class="autoselect" $readmode style="text-transform:uppercase;" onblur="text-transform:uppercase;">
                                        ...
                                        <tr>
                                          ...
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><input name="txdTarikhLahirWaris" type="text" id="txdTarikhLahirWaris" value="$txdTarikhLahirWaris" size="10" maxlength="10" $readmodeR class="$readmode"  onblur="trans_date(this.value)"/>
                                                #if($readmode != "disabled")  
                                               
                                               <a href="javascript:displayDatePicker('txdTarikhLahirWaris',false,'dmy');"><img border="0" src="../img/calendar.gif"/><span class="style73"> dd/mm/yyyy</span>
                                                #end                                               </td>
                                      </tr>
                                        <tr>
                                          <td>&nbsp;</td>
                                          ...
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><input name="txtNoSuratBeranakWaris" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" type="text" id="txtNoSuratBeranakWaris" value="$txtNoSuratBeranakWaris" size="15" maxlength="10" $readmodeR class="$readmode" /></td>
                                        </tr>
                                        <tr>
                                          <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
                                        ...
                                        <tr>
                                          ...
                                          #else
                                          <select name="socStatusOBWaris"  style="text-transform:uppercase;" onblur="text-transform:uppercase;" class="autoselect" $readmode id="socStatusOBWaris">
                                            ...
                                            <option value="1" style="text-transform:uppercase;" onblur="text-transform:uppercase;">01 - Dewasa/Waras</option>
                                              ...
                                              <option value="3" style="text-transform:uppercase;" onblur="text-transform:uppercase;">03 - Hilang</option>
                    ...
                    <option value="" style="text-transform:uppercase;" onblur="text-transform:uppercase;">Sila Pilih Status</option>                                            
                     ...
                     <a href="javascript:displayDatePicker('txdTarikhMatiWaris',false,'dmy');"><img border="0" src="../img/calendar.gif"/><span class="style73"> dd/mm/yyyy</span>
                     #end                     </td>
                                      </tr>
                                      <tr>
                                        <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
                                        ...
                                        <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                        <td class="style36"><input name="txtWaktuKematianWaris" type="text" id="txtWaktuKematianWaris9" style="text-transform:uppercase;" onblur="text-transform:uppercase;" value="$txtWaktuKematianWaris" size="4" maxlength="4" $readmodeR class="$readmode" onkeyup="javascript:validateIC(event,this,this.value,'txtWaktuKematianWaris9')"/>
                                        #if($readmode != "disabled") 
                                        <span class="style73">format 24 jam (HHMM)</span>
                                        #end                                        </td>
                                      </tr>
                                      #end
                                    </table></td>
...
<select name="txtBandarWaris" id="txtBandarWaris" class="autoselect" $readmode   style="text-transform:uppercase;" onblur="uppercase()" onclick="CheckBandarTetap()" >
  ...
  <option value="$listDaerah.id">$listDaerah.kod - $listDaerah.nama</option>
                      ...
                      <option value="$txtBandarWarisSurat">$listDaerahbyNegeriK - $listDaerahbyNegeriN</option>
                                  ...
                                  #foreach($listDaerah in $listBandarSuratbyNegeri)
                                        ...
                                        <tr>
                                          ...
                                          <td><textarea name="txtCatatanWaris" cols="31"  rows="3"  $readmodeR class="$readmode" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()">$txtCatatanWaris</textarea></td>
                                        </tr>
                                    </table></td>
                                  </tr>
                              </table>
   ...
   <tr>
    <td>
                              <table width="100%">
                                <tr>
                                  <td><span class="style5 style47 style69"><span class="style41">Perhatian </span>: Sila masukkan salah satu nombor kad pengenalan dan pastikan label bertanda <span class="style41">*</span> diisi. <em>Sila masukkan salah satu nombor telefon.</em></span></td>
                                </tr>
</table> </td>
  </tr>
#end
                                  ...
                                  <tr>
                                    ...
                                    <table width="100%">
                                       <input type="hidden" name="txtIdSimatiWaris" value="$idSimati" />
                                        <tr>
                                          <td width="1%">&nbsp;</td>
                                          <td width="28%"><div align="left" class="style72"><span class="style38">No KP Baru</span></div></td>
                                          <td width="1%" class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td width="70%" class="style36">
                                        
                                          <input name="txtNoKPBaru1Waris" id="txtNoKPBaru1Waris" style="width: 50px;" type="text" value="$txtNoKPBaru1Waris" $readmode size="7" maxlength="6" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru2Waris')" onBlur="getAgeByIC(this,this.value,'txtUmurWaris');getStatusByIC(this,this.value,'socStatusOBWaris');getDOB(this.value)"/>
                                          - 
                                          <input name="txtNoKPBaru2Waris" id="txtNoKPBaru2Waris" style="width: 20px;" type="text" value="$txtNoKPBaru2Waris" $readmode size="3" maxlength="2" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris')"/> 
                                          -
                                          <input name="txtNoKPBaru3Waris" id="txtNoKPBaru3Waris"  style="width: 40px;" type="text" value="$txtNoKPBaru3Waris" $readmode size="5" maxlength="4" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris')" onblur="jantinaic2();setSelected(0,2,0,0);tarikh_waris_saudara('txtNoKPLamaWaris','in')" />
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style51 style74 style42">  www.jpn.gov.my</a>                                          </td>
                                        ...
                                        <tr>
                                          <td >&nbsp;</td>
                                          <td ><div align="left" class="style72"><span class="style38">No KP Lama</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><label>
                                            <input name="txtNoKPLamaWaris" id="txtNoKPLamaWaris" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" type="text"  value="$txtNoKPLamaWaris" size="15" maxlength="8" $readmode/>
                                          </label></td>
                                        </tr>
                                        <tr>
                                          <td >&nbsp;</td>
                                          <td ><div align="left" class="style72"><span class="style38">Lain-lain KP</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                              ...
                              #set($txtNoKPLainWaris = "")
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><div align="left" class="style72"><span class="style38">No Lain-lain KP</span></div></td>
                                          <td>:</td>
                                          <td><span class="style36">
                                            <input name="txtNoKPLainWaris" type="text" id="txtNoKPLainWaris2"  style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" value="$txtNoKPLainWaris" size="15" maxlength="12" $readmodekp />
                                          </span></td>
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><div align="left" class="style72"><span class="style38">Warganegara</span></div></td>
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><label>
                                            <select name="socWarganegaraWaris" id="socWarganegaraWaris" class="autoselect" $readmode style="text-transform:uppercase;" onblur="text-transform:uppercase;">
                                        ...
                                        <tr>
                                          ...
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><input name="txdTarikhLahirWaris" type="text" id="txdTarikhLahirWaris" value="$txdTarikhLahirWaris" size="10" maxlength="10" $readmode  onblur="trans_date(this.value)"/>
                                        ...
                                        <tr>
                                          ...
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><input name="txtNoSuratBeranakWaris" style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()" type="text" id="txtNoSuratBeranakWaris" value="$txtNoSuratBeranakWaris" size="15" maxlength="10" $readmode/></td>
                                        </tr>
                                        <tr>
                                          <td  valign="top"><span class="style44">#if($readmode != "disabled") * #end</span></td>
                                        ...
                                        <tr>
                                          ...
                                          <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td class="style36"><select name="socStatusOBWaris"  style="text-transform:uppercase;" onblur="text-transform:uppercase;" class="mediumselect" $readmode id="socStatusOBWaris">
                  ...
                  <option value="" style="text-transform:uppercase;" onblur="text-transform:uppercase;">Sila Pilih Status</option>                                              
                     ...
                     <a href="javascript:displayDatePicker('txdTarikhMatiWaris',false,'dmy');"><img border="0" src="../img/calendar.gif"/><span class="style73"> dd/mm/yyyy</span></td>
                                      ...
                                      <tr>
                                        ...
                                        <td class="style36"><div align="right"><span class="style38">:</span></div></td>
                                        <td class="style36"><input name="txtWaktuKematianWaris" type="text" id="txtWaktuKematianWaris9" style="text-transform:uppercase;" onblur="text-transform:uppercase;" value="$txtWaktuKematianWaris" size="4" maxlength="4" $readmode onkeyup="javascript:validateIC(event,this,this.value,'txtWaktuKematianWaris9')"/>
                      ...
                      <option value="$txtBandarWarisSurat">$listDaerahbyNegeriK - $listDaerahbyNegeriN</option>
                                  ...
                                  #foreach($listDaerah in $listBandarSuratbyNegeri)
                                        ...
                                        <tr>
                                          ...
                                          <td valign="top"><div align="right"><span class="style38">:</span></div></td>
                                          <td><textarea name="txtCatatanWaris" cols="31"  rows="3"  $readmode style="text-transform:uppercase;" onblur="this.value=this.value.toUpperCase()">$txtCatatanWaris</textarea></td>
                                        </tr>
                                    </table></td>
                                  </tr>
                              </table>
        ...
        #set($idwww=$idparent)
          ...
          <div align="center">
            ...
            <td width="20%" class="row1"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_waris_lapisan_X('$listwarislapisan.idwaris','$listwarislapisan.idparent','now')" class="style42"> $listwarislapisan.nama_Ob</a></div></td>
                ...
                #end
                 #end
                <td width="20%" class="row1"><div align="left" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$idpar</div></td>
            ...
            <td width="20%" class="row2"><div align="left" style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_waris_lapisan_X('$listwarislapisan.idwaris','$listwarislapisan.idparent','now')" class="style42"> $listwarislapisan.nama_Ob</a></div></td>
                ...
                #end
                 #end
                <td width="20%" class="row2"><div align="left" class="style72" style="text-transform:uppercase;" onblur="uppercase()">$idpar</div></td>
    ...
    <td class="style36" width="70%"><span class="style42" style="text-transform:uppercase;" onblur="uppercase()">$listWarisParentlist.nama_Ob</span>
      ...
      <input name="txtLapisParent" type="hidden"  id="textfield31" size="15" value="$listWarisParentlist.lapis" maxlength="2"  $readmode/>    </td>
                                        ...
                                        <tr>
                                          ...
                                          <td width="29%"><div align="left" class="style72"><span class="style38">No KP Baru</span></div></td>
                                          <td width="1%" class="style36"><div align="right"><span class="style38">:</span></div></td>
                                          <td width="70%" class="style36">
                                          ...
                                          <input name="txtNoKPBaru2Waris" id="txtNoKPBaru2Waris" style="width: 20px;" type="text" value="$txtNoKPBaru2Waris" $readmode size="3" maxlength="2" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris')"/> 
                                          - 
                                          <input name="txtNoKPBaru3Waris" id="txtNoKPBaru3Waris"  style="width: 40px;" type="text" value="$txtNoKPBaru3Waris" $readmode size="5" maxlength="4" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris')" onblur="jantinaic2();setSelected(0,2,0,0);tarikh_waris_saudara('txtNoKPLamaWaris','in_lap')" />
                                    ...
                                    <table width="100%">
                                       <input type="hidden" name="txtIdSimatiWaris" value="$idSimati" />
                                        ...
                                        <tr>
                                          ...
                                          <input name="txtNoKPBaru2Waris" id="txtNoKPBaru2Waris" style="width: 20px;" type="text" value="$txtNoKPBaru2Waris" $readmodeR class="$readmode" size="3" maxlength="2" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris')"/> 
                                          - 
                                          <input name="txtNoKPBaru3Waris" id="txtNoKPBaru3Waris"  style="width: 40px;" type="text" value="$txtNoKPBaru3Waris" $readmodeR class="$readmode" size="5" maxlength="4" onKeyUp="javascript:validateIC(event,this,this.value,'txtNoKPBaru3Waris')" onblur="jantinaic2();setSelected(0,2,0,0);tarikh_waris_saudara('txtNoKPLamaWaris','up_lap')" />
  ...
  <a href="http://www.jpn.gov.my" target="_blank" class="style51 style74 style42">  www.jpn.gov.my</a>  
                              ...
                              #set($txtNoKPLainWaris = "")
                                        ...
                                        <tr>
                                          <td></td>
                                          <td><div align="right" class="style75">
                                              <div align="left"><span class="style38">No Lain-lain KP</span></div>
                                          </div></td>
                                          <td>:</td>
                                          <td><span class="style36">
                                          #if($readmode == "disabled")
    ...
    <td><table width="100%" border="0" align="center">
        ...
        <input type="button" name="tambahwarislapisanSimpan" id="tambahwarisSimpan" value="$buttonwarislapisanSimpan"  onclick="setSelected(0,2,0,0);tambah_waris_lapisan_Simpan()"/>
         ...
         <input type="button" name="tambahwarislapisan" id="tambahwaris4" value="$buttonwarislapisan" onclick="setSelected(0,2,0,0);tambah_waris_lapisan()"/>
              #end#if($buttonwarislapisan=="Simpan" || $buttonwarislapisan=="Kemaskini" )              
...
var tt = dob_code.charAt(4)+""+dob_code.charAt(5)+"/"+dob_code.charAt(2)+""+dob_code.charAt(3)+"/"+dum+dob_code.charAt(0)+""+dob_code.charAt(1);	
   ...
   */
   else if(ch=="yes" && date3 < date1 )
   {
	...
	else if (document.f1.checkHidupWaris.checked == false && (document.f1.txtAlamatTerakhir1Waris.value == "" || document.f1.txtPoskodWaris.value == "" || document.f1.txtBandarWaris.value == "" ||  document.f1.txtBandarWaris.value == "0" || document.f1.socNegeriWaris.value == "" || document.f1.socNegeriWaris.value == "0"))
	{
	...
	return;
	 ...
	 else if (document.f1.checkHidupWaris.checked == false && (document.f1.txtAlamatTerakhir1WarisSurat.value == "" || document.f1.txtPoskodWarisSurat.value == "" || document.f1.txtBandarWarisSurat.value == "" || document.f1.txtBandarWarisSurat.value == "0" || document.f1.socNegeriWarisSurat.value == "" || document.f1.socNegeriWarisSurat.value == "0"))
	{

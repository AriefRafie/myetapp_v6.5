<!--frmPrmhnnSek17NotisPerbicaraan-->
...
#else
	#set($tajuk="LAPORAN PENGHANTAR NOTIS")
#end
    <center>
  #if($!headerppk.size()>0)
...
document.getElementById("header_lama").style.display="block";
  ...
  <div id="TabbedPanels1" class="TabbedPanels">
      ...
      #end
      <li class="TabbedPanelsTab" tabindex="0" onclick="setSelected(1);Laporan()">LAPORAN PENGHANTAR NOTIS</li>
    </ul>
      ...
      <div class="TabbedPanelsContent"> <br/>
          ...
          <div style="width:100%;height:187;overflow:auto"> #end
              ...
              <tr>
                    ...
                    #else
                    #if ($listOB_size != '0')
                    <td><input type="checkbox" value="$ob.id_ob" name="idsOB" onClick="doUpdateCheckAllOB()"/></td>
                    #end
          ...
          <tr align="center">
                ...
                <input type="button" name="cmdSimpan" id="cmdSimpan" value="Simpan" onClick="simpan('$param')" />
                #end
      ...
      <div class="TabbedPanelsContent"> <br/>
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td>Tarikh Notis</td>
              <td>:&nbsp;
                    <input type="text" size="11" name="editTarikhNotis" maxlength="10" id="editTarikhNotis" value="$!tarikhNotis" $disabilityCSS $disability  onblur="validateTarikh(this,this.value);check_date(this);checkCutiAm(this.value);" />
              ...
              <td>:&nbsp;
                    ...
                    Cawangan JKPTG
                    &nbsp;&nbsp;
                    <input type="radio" $checkP2 $disabilityCSS $disability1 id="pTanah" name="editjenisPejabat" value="2" onclick="onchangeJenisPejabatUpdate()" >
                    Pejabat Tanah
                    &nbsp;&nbsp;
                    <input type="radio" $checkP3 $disabilityCSS $disability1 id="pLain" name="editjenisPejabat" value="0" onclick="onchangeJenisPejabatUpdate()" >
                    Lain - lain tempat</td>
            </tr>
                <tr>
          ...
          <div style="width:100%;height:187;overflow:auto"> #end
              ...
              <tr>
                    ...
                    #else
                    #if ($listOB_size != '0')
                    <td><input type="checkbox" value="$ob.id_ob" name="idsOB" onClick="doUpdateCheckAllOB()" $obDisabled $obChecked/></td>
                    #end
                    <td class="$row">$ob.nama_ob.toUpperCase()</td>
                    #end
                    <td class="$row">$ob.age</td>
          ...
          <tr align="center">
               <td> 
	              ...
	              <input type="button" name="cmdKemaskini1" id="cmdKemaskini1" value="Kemaskini" onClick="kemaskini()" />
	              		...
	              		<script>document.getElementById('cmdKemaskini1').style.display = "none";</script> 
	              #end 
                  
              #if($!id_perbicaraan!="")    
              <span id="span_PNB" >
            <!--   <input type="button" name="cmdHPNB1" id="cmdHPNB1" value="Hantar PNB (Borang S)" onClick="cetakBorangS('$!id_perbicaraan','$!id_fail','$!id_simati','$!id_pemohonSek8')" /> -->
              </span>
              #end
      ...
      <div class="TabbedPanelsContent"> <br/>
            ...
            #if($id_status!="151" && $id_status!="53" && $id_status!="44" && $id_status!="173" && $id_status!="175" && $id_status!="177" && $id_status!="21" && $id_status!="25" && $id_status!="64" && $id_status!="163" && $id_status!="164" && $id_status!="165" && $id_status!="169" && $id_status!="166" && $id_status!="167" && $id_status!="180")
            #set($check1="")
            #set($check="")
            #set($checkClass="")
            #set($sta="sta18")
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td width="25%">Jenis Serahan1</td>
              <td width="1%">:&nbsp;</td>
              <td width="73%"><input type="radio" $serahA $disableZERO1  name="sorJenisSerah" $check1 value="1" onClick="setSerahTangan();disablePOS();enableT()" >
                    Serahan Tangan</td>
            </tr>
                <tr>
              <td>&nbsp;</td>
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td><input type="radio" name="sorJenisSerah" $serahB $disableZERO1  value="2" $check1 onClick="setPOS();disableSERAH();enableT();hideAsterik()">
                    Pos Berdaftar</td>
            </tr>
                <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td>&nbsp;&nbsp;&nbsp; &nbsp;
                    ...
                    Diterima &nbsp; &nbsp; No.Surat Daftar&nbsp;:&nbsp;
                    <input type="text" #if($txtDis_2=="yes")disabled #end $classZero name="txtNoDaftarPos_2" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();" id="txtNoDaftarPos_2" value="$daftarPos_2" maxlength="20" $checkClass size="20"></td>
            </tr>
                <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td width="1%">:&nbsp;</td>
              <td width="73%"><select $disableZERO1 $classZero $check1 $checkClass name="txtNamaPenghantarNotis" style="width:320">
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
            ...
            #if($selectedOB_size==0 || ($id_status=="21" || $id_status=="25" || $id_status=="64" || $id_status=="163" || $id_status=="164" || $id_status=="165" || $id_status=="169" || $id_status=="166" || $id_status=="167" || $id_status=="180"))
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td><input type="radio" name="EDITsorJenisSerah" value="2"  onClick="disableSERAH();enableTUpdate();hideAsterik()" $disabledNotis1 $jenisPos >
                    Pos Berdaftar</td>
            </tr>
                <tr>
              <td>&nbsp;</td>
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td width="25%">Nama Penghantar Notis</td>
              <td width="1%">:&nbsp;</td>
              <td width="73%"><select $disabledNotis1 $dClass name="EDITtxtNamaPenghantarNotis" style="width:320">
          ...
          <tr align="center">
              ...
              #if($id_status!="44" && $id_status!="173" && $id_status!="175" && $id_status!="177" && $id_status!="21" && $id_status!="25" && $id_status!="64" && $id_status!="163" && $id_status!="164" && $id_status!="165" && $id_status!="169" && $id_status!="166" && $id_status!="167" && $id_status!="180")
...
function refreshPageView(idp) {
	document.${formName}.action = "?_portal_module=ekptg.view.ppk.FrmSenaraiNotisSek17&command=semakWithData&id_permohonan="+idp+"&tabId=0";
	//document.${formName}.command.value = "refreshTambahMufti";
	document.${formName}.submit();
}
...
function SenaraiBicara(id_permohonan,flag) {
	var url = "../x/${securityToken}/ekptg.view.ppk.FrmPrmhnnSek17SenaraiBicara?id_permohonan="+id_permohonan+"&flag="+flag;
...
function simpan() {
	...
	var dt1x   = parseInt(str1.substring(0,2),10)-14;
	...
	return;
		...
		alert("Sila pastikan tarikh notis tidak boleh dalam lingkungan 14 hari sebelum tarikh bicara.");
	 	document.${formName}.txdTarikhNotis.focus();
	 	return;
	}
...
*/
    	...
    	else if ( document.${formName}.jenisPejabat[2].checked == true && (document.${formName}.txtAlamatBicara1.value == "" && document.${formName}.txtAlamatBicara2.value == "" && document.${formName}.txtAlamatBicara3.value == "") ) {	    
	    alert("Sila masukkan \"Alamat Bicara\" terlebih dahulu.");
	    document.${formName}.txtAlamatBicara1.focus(); 
	    return;
...
function simpanNotisTambah(param) {
...
*/
    	...
    	else if (document.${formName}.jenisPejabat[2].checked == true && (document.${formName}.TGAlamatBicara1.value == "" && document.${formName}.TGAlamatBicara2.value == "" && document.${formName}.TGAlamatBicara3.value == "") ){
	    alert("Sila masukkan \"Alamat Bicara\" terlebih dahulu.");
	    document.${formName}.TGAlamatBicara1.focus(); 
	    return;      
    	}	
...
*/	
    	...
    	else if (document.${formName}.editjenisPejabat[2].checked == true  
	    && (document.${formName}.editAlamatBicara1.value == "" && document.${formName}.editAlamatBicara2.value == "" && document.${formName}.editAlamatBicara3.value == "")) {
	    alert("Sila masukkan \"Alamat Bicara\" terlebih dahulu.");
	    document.${formName}.editAlamatBicara1.focus(); 
		return;     
    	}	
...
//	var negeri_code = document.${formName}.txtNoKPBaru2.value;
	...
	else if(document.${formName}.txtNamaPenghantarNotis.value == "")
		{
...
function cetakBuktiPenyampaian(NO_FAIL,tarikhnotis,idfail,idperbicaraan) {
	var url = "../servlet/ekptg.report.ppk.BuktiPenyampaian17?nofail="+NO_FAIL+"&idperbicaraan="+idperbicaraan+"&idfail="+idfail+"&tarikhnotis="+tarikhnotis;
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function cetakNotaPerbicaraan(NO_FAIL,id_perbicaraan,idfail,idsimati) {
    ...
    var url = "../servlet/ekptg.report.ppk.NotaPerbicaraan17?nofail="+NO_FAIL+"&flag="+flag+"&idfail="+idfail+"&idsimati="+idsimati+"&idperbicaraan="+id_perbicaraan+"&tajuk="+tajuk;
    var hWnd = window.open(url,'Cetak','width=800,height=500, resizable=yes,scrollbars=yes');
    if ((document.window != null) && (!hWnd.opener))
	hWnd.opener = document.window;
    if (hWnd.focus != null) hWnd.focus();
...
function kembaliKeputusanPermohonan(idpermohonan,idpermohonansimati,tarikhmohon) {
	document.${formName}.action = "?_portal_module=FrmSenaraiFailKeputusanPermohonanInternal17&command=paparKeputusan";
	document.${formName}.method="POST";

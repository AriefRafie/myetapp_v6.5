...
<input name="idpeguam" type="hidden"  /><br />
...
#set($readmode = "")
          ...
          <tr>
            ...
            <td width="1%"><div align="center" class="style38">:</div></td>
            <td width="70%">
<input name="idPeguam" type="hidden" id="idPeguam" value="$listpeguam.idPeguam" />
            <label>
...
<!--
            ...
            <input type="button" name="button" id="cmdHapus1" value="Hapus" onclick="setSelected(0,1,1,0);hapus_peguam()" />
            #if($flag_kemaskini_selesai != "yes")
                                <script>
...
<!--
                  <label>                  
                    ...
                    <input type="button" name="cmdTambahPeguam" id="cmdTambahPeguam" value="Tambah" onclick="setSelected(0,1,1,0);tambah_peguam_baru()"/>
                    #if($flag_kemaskini_selesai != "yes")
                                <script>
                                document.getElementById('cmdTambahPeguam').style.display = "none";
                                </script>
                                #end  
                    #end
                    </label>

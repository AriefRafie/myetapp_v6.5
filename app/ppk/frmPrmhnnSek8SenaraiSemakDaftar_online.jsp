...
#if ($SimpanStatus == "2")
	<input type="button" name="cmdKemaskini" id="cmdKemaskini" value="Ada Harta" onClick="Kemaskini()"/>
    <!--   
...
#else
<!--
	<input name="cmdSimpan" type="button" id="cmdSimpan"  value="Ada Harta" onClick="DoTheCheck()"/>
	<input name="cmdBatal" type="button"  id="cmdBatal" value="Tiada Harta (Batal)" onClick="hartaTiada()"/>
    -->
#end 
</label>
...
<legend>Senarai Semakan <span class="style2">CUBAAN ONLINE</span></legend>
<br>

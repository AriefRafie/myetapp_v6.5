                                  ...
                                  #foreach($listmukim in $listMukimbyDaerah)
                                          ...
                                          <tr>
                                           ...
                                           <td><div align="right">:</div></td>
                                            ...
                                            <tr>
                                              <td ><div align="right" class="style44">Luas</div></td>
...
<tr>
                                            ...
                                            <td><div align="right">:</div></td>
                                              <td><input name="txtNilaiTarikhMohonHtaaX" type="text" id="txtNilaiTarikhMohonHtaa3" maxlength="7" size="10" style="text-align: right;" $readmode value="$nilai_Hta_memohon" onKeyUp="javascript:validatePoskod(this,this.value)"  onblur="validateModal(this,this.value,$nilai_Hta_memohon);" /></td>
</tr>                                             
...
<select name="socNegeriPemajuHtaamX" $readmode id="socNegeriPemajuHtaamX" style="text-transform:uppercase; width: 225px;" onBlur="uppercase()" >
  ...
  <option value="$listnegpomo.id_Negeri">$!listnegpomo.kod_Negeri - $!listnegpomo.nama_Negeri</option>
                                          ...
                                          #end
                                          #if($listam.jenisluas!="")
                                          <input name="readmodedaerah" type="hidden" value="$readmodedaerah" >
                                          <input name="txtLuasAsalHtaamX" type="text" id="txtLuasAsalHtaamUp3" value="$listam.luasasal" size="15" maxlength="15" $readmode style="text-transform:uppercase;" onBlur="uppercase()" onKeyUp="javascript:validateIC(this,this.value,'txtLuasAsalHtaamX')" >&nbsp;<select name="socJenisLuasHtaamX" $readmode  id="socJenisLuasHtaamX" style="text-transform:uppercase;width: 225px;" onBlur="uppercase()" >
                                            <option value="0">Sila Pilih</option>
...
<select name="socJenisLuasHtaamX" $readmode id="socJenisLuasHtaamUp2" style="text-transform:uppercase;width: 225px;" onBlur="uppercase()">
  <option value="0">Sila Pilih</option>
  ...
  <option value="$listluashta.id">$!listluashta.kod - $!listluashta.nama</option>
                                     ...
                                     <!--
                                              ...
                                              <td><div align="right" class="style43">Anggaran Nilai Harta (RM)</div></td>
                                            <td><div align="right">:</div></td>
                                              <td><input name="txtNilaiTarikhMohonHtaaX" type="text" id="txtNilaiTarikhMohonHtaa3" maxlength="7" size="10" style="text-align: right;" $readmode value="$nilaihutang" onKeyUp="javascript:validatePoskod(this,this.value)"  onblur="validateModal(this,this.value,$nilai_Hta_memohon);" /></td>
                                            </tr>
											-->
                                             <tr>
                                              <td width="29%"><div align="right" class="style43">Bahagian Simati</div></td>
...
<tr>
          ...
          <tr>
                                    <td align="center"> #if($show_simpan_add_htaam=="yes")
                                      ...
                                      <input type="reset" name="cmdSimpan6" id="cmdSimpan6" value="Batal" onClick="HtaamViewX('1','0','0','0')"/>
                                    #end
  ...
  <tr bgcolor="white">
    ...
    <td class="row1"><div style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_htaam($listam.idhta)" class="style42 style2">$listam.namanegeri</a></div></td>
  ...
  <tr class="table_header">
    ...
    <td class="row2"><div style="text-transform:uppercase;" onblur="uppercase()"><a href="javascript:get_htaam($listam.idhta)" class="style42 style2">$listam.namanegeri</a></div></td>
...
function onChangeBandarTetaphtaam(){
	document.${formName}.mode.value="onChangeBandarTetaphtaam";
	document.${formName}.tabIdatas.value="0";
    document.${formName}.tabIdtengah.value="1";
    document.${formName}.tabIdbawah.value="0";	
	document.${formName}.tabIdtepi.value="0";

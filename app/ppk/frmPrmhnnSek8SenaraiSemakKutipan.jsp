      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            ...
            <td width="85%"> #if($chkmode != "disabled")Bukti kematian #else
              Bukti kematian
              #end </td>
          </tr>
        </table>
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            ...
            <td width="86%">Bayaran Permohonan
              </td>
          </tr>
        </table></td>
      </tr>
...
<table width="100%">
  <tr>
    <td><span class="style5 style4"><span class="style2">Perhatian</span> : Sila  pastikan label bertanda <span class="style2">*</span> diisi. <em> Bayaran permohonan adalah <span class="style2">wajib</span> jika pemohonan telah dibuat sebelum 01/09/2009.</em></span></td>
  </tr>
</table>
#end
-->
...
<!--	<input type="button" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onClick="Kemaskini()"/>    -->
    ...
    #if($boleh_kemaskini == "yes" && $!headerppk.CAPAIAN_FAIL_UNIT_LUAR == "N")
    <input type="button" name="cmdKemaskini" id="cmdKemaskini" value="Kemaskini" onClick="Kemaskini()"/> 
    #end
...
function DoTheCheck() {
	...
	*/
	...
	else if (document.f1.lepassatusept.value == "yes" && document.f1.cbsemaks[8].checked == true && isDate(dm.value)==false){
		dm.focus()
		return false
	}
	/*

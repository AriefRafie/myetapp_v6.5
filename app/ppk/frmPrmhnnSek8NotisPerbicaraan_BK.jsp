  ...
  <div id="TabbedPanels1" class="TabbedPanels">
      ...
      <div class="TabbedPanelsContent"> <br/>
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td width="79%">:&nbsp;
                    <input type="text" name="txdTarikhBicara" id="txdTarikhBicara" maxlength="10" value="$txdTarikhBicara" size="11"  onblur="check_date(this);getTarikhNotis();validateTarikh(this,this.value)"  />
      ...
      <div class="TabbedPanelsContent"> <br/>
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td>Tarikh Bicara</td>
              <td>:&nbsp;
                    <input type="text" name="txdTarikhBicara" id="txdTarikhBicara" value="$txdTarikhBicara" size="11" maxlength="10" onblur="check_date(this);getTarikhNotis();validateTarikh(this,this.value)"  />
                    <img src="../img/calendar.gif" onclick="displayDatePicker('txdTarikhBicara',false,'dmy');">&nbsp;<i><font color="blue" style="font-size:10px">dd/mm/yyyy</font></i></td>
            </tr>
                <tr>
              <td valign="top"><font color="red">*</font></td>
      ...
      <div class="TabbedPanelsContent"> <br/>
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td>Tarikh Bicara</td>
              <td>:&nbsp;
                    <input type="text" name="editTarikhBicara" id="editTarikhBicara" maxlength="10" value="$!tarikhBicara" size="11" $disabilityCSS $disability  onblur="check_date(this);getTarikhNotisUPDATE();validateTarikh(this,this.value)" />
      ...
      <div class="TabbedPanelsContent"> <br/>
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td><input type="radio" name="sorJenisSerah" $serahB $disableZERO1  value="2" $check1 onClick="disableSERAH();enableT();hideAsterik()">
                    Pos Berdaftar</td>
            </tr>
                <tr>
              <td>&nbsp;</td>
          ...
          <table width="100%"  cellpadding="1" cellspacing="1" border="0">
              ...
              <td>#if($sta=="sta18") #if($disableZERO!="readonly")
                  ...
                  <option value="$listOB.id_ob">$listOB.nama_ob.toUpperCase()</option>
                    ...
                    &nbsp;#end #end
                    <input type="text" id="namaPenerima" $check $disableZERO $classZero $checkClass name="txtNamaPenerima" value="$namaPenerima" maxlength="80" size="50" style="text-transform:uppercase;" onBlur="this.value=this.value.toUpperCase();" />
               </td>
            </tr>
                <tr>
              <td>&nbsp;</td>
...
function simpanNotisTambah() {
	...
	else if (document.${formName}.TGPoskod.value != "" && document.${formName}.TGPoskod.value.length < 5) {
		alert("Sila masukkan nombor poskod dengan selengkapnya");

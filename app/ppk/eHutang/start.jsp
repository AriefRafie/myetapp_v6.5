...
<div id="divMainForm">
  ...
  #elseif ($!command == 'daftarHutang'  || $!command == 'doChangeInsuransHutang2')
  		#parse("app/ppk/eHutang/daftarHutang.jsp")	
  #elseif ($!command == 'paparHutang' || $!command == 'simpanHutang' || $!command == 'kemaskiniHutang' || $!command == 'refreshUpload' || $!command == 'muatNaikDokumen' || $!command == 'kemaskiniHutang2' || $!command == 'doChangeStatusHutang' || $!command == 'doChangeInsuransHutang')

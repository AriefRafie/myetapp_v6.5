...
<link rel="stylesheet" type="text/css" href="../css/eTapp.css" />
<style type="text/css">
<!--
.style1 {
...
#set ($jenishakmilik = "")
  ...
  <select name="socMukimHtaam" style="width: 225px;" $readmodemukim>
    ...
    <option value="$listmukim.id">$!listmukim.nama</option>
                                            ...
                                            <tr>
                                              ...
                                              <option value="$jenishakmilik">$!listjenishakmiliN</option>
  ...
  <select name="socJenisHakmilikHtaam" style="width: 225px;" $readmode id="socJenisHakmilikHtaam">
    ...
    <option value="$listjenishakmilik.id">$!listjenishakmilik.keterangan</option>
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <td><label>
                              <input name="txtNilaiTarikhMohonHtaa" type="text" value="$nilai_Hta_memohon" style="text-align: right;" size="15" maxlength="8" onKeyUp="javascript:validatePoskod(this,this.value)"  onblur="validateModal(this,this.value,this.value);" $readmode /><input name="nilai_Hta_memohon" type="hidden" value="$nilai_Hta_memohon">
                            </label></td>
                          </tr>
											<tr>
										...
										<tr>
										<td colspan="2" valign="bottom" height="50px"><table>
                    <tr>
                    <td><i>*</i></td>
                    <td><i>Sila pastikan label bertanda <font color="#ff0000">*</font> diisi.</i></td>
                    </tr>
                    <tr>
                    <td><i>*</i></td>
                          ...
                          <tr>
                            ...
                            <td><label>
                              ...
                              <input name="txtNilaiTarikhMohonHt" type="text" value="$Util.formatDecimal($nilai_Hta_memohon)" style="text-align: right;" size="15" maxlength="8" onKeyUp="javascript:validatePoskod(this,this.value)"  onblur="validateModal(this,this.value,this.value);" $readmode />
                              	#else
                              <input name="txtNilaiTarikhMohonHt" type="text" value="" style="text-align: right;" size="15" maxlength="8" onKeyUp="javascript:validatePoskod(this,this.value)"  onblur="validateModal(this,this.value,this.value);" $readmode />								#end
                             #else
  ...
  <tr bgcolor="white">
    ...
    <td class="row1"><a href="javascript:get_htaam($listam.idhta)" class="style42">$listam.namanegeri</a></td>
	<td class="row1">$listam.namadaerah</td>
    <td class="row1">$listam.namamukim</td>
    <td class="row1">$listam.noHakmilik</td>
  ...
  <tr class="table_header">
    ...
    <td class="row2"><a href="javascript:get_htaam($listam.idhta)" class="style42">$listam.namanegeri</a></td>
    <td class="row2">$listam.namadaerah</td>
    <td class="row2">$listam.namamukim</td>
    <td class="row2">$listam.noHakmilik</td>

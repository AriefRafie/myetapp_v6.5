...
#parse("app/ppk/BantuUnit/BUSenaraiUtama.jsp")
</div>
...
function valEditBU(ID_PERMOHONANBANTUUNIT)
{
	  ...
	  // alert('xxx'+document.getElementById("BU_CATATAN_PELULUS_"+ID_PERMOHONANBANTUUNIT).value);
	   ...
	   */	   
	   ...
	   else if(ID_PERMOHONANBANTUUNIT!="")
	   {
			   ...
			   var ID_UNIT = document.getElementById("BU_ID_UNIT_"+ID_PERMOHONANBANTUUNIT).value;
			   var USER_UNIT = document.getElementById("USER_UNIT").value;
			   var jawatanKpp = document.getElementById("jawatanKpp").value;
			   ...
			   if(jawatanKpp=="true"){
				   ...
				   if(stats=='1')
				   {
					   ...
					   bool_check = false;
				   }else if(document.getElementById("BU_CATATAN_PELULUS_"+ID_PERMOHONANBANTUUNIT).value==""){
					   alert("Masukkan catatan kelulusan!");
					   document.getElementById("BU_CATATAN_PELULUS_"+ID_PERMOHONANBANTUUNIT).focus();
					   bool_check = false;
				   }
			   }
		  
	   }else if(document.getElementById("BU_CATATAN_PEMOHON_"+ID_PERMOHONANBANTUUNIT).value==""){
		   alert("Masukkan catatan!");
		   document.getElementById("BU_CATATAN_PEMOHON_"+ID_PERMOHONANBANTUUNIT).focus();
		   bool_check = false;
	   }
	   return bool_check;   
}

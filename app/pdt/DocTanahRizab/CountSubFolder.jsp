		...
		<span onClick="doDivAjaxCall$formname('divSubFolder$ID_DOCTRM','showAllFolder','FLAG_SUB_OPENCLOSE='+$jquery('#HID_OPENCLOSE_SUB_$ID_DOCTRM').val()+'&TAJUK=&FLAG_OPENCLOSE=&ID_DOCTRMUTAMA=$ID_DOCTRMUTAMA&ID_REFER=$ID_DOCTRM&ID_DOCTRM=$ID_DOCTRM&LAYER=$LAYER&AUTOLOAD=N&carianTerperinci='+$jquery('#carianTerperinci').val()+'&carianTerperinciLampiran='+$jquery('#carianTerperinciLampiran').val()+'&JUMLAH_SUB=$TOTAL_SUB');" >

        ...
        <table width="100%" border="0">
          <tr>
            ...
            <td width="70%" valign="top">
              <input type="text" name="txtPenggal" id="txtPenggal" value="$!JadualSubPara_Jadual" size="50" $RO_General />            </td>
          </tr>
          <tr>
            <td width="29%" align="right" valign="top">Nama Jadual</td>
            <td align="center" valign="top">:</td>
            <td valign="top">
              <input type="text" name="txtTajukPenggal" id="txtTajukPenggal" value="$!JadualSubPara_NamaJadual" size="50" $RO_General />            </td>
          </tr>  
          <tr>
          ...
          <tr>
            ...
            <td align="center" valign="top">:</td>
            <td valign="top"><textarea name="txtSubPara" cols="50" rows="5" id="txtSubPara" $RO_General>$!JadualSubPara_SubPara</textarea>            </td>
          </tr>  
          <tr>
            <td align="right">&nbsp;</td>
            <td>&nbsp;</td>

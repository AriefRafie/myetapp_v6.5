        ...
        <table width="100%" border="0">
          ...
          <tr>
            ...
            <td align="center" valign="top">:</td>
            <td valign="top">
              <input type="text" name="txtSubSeksyen" id="txtSubSeksyen" value="$!SubSeksyen_SubSeksyen" size="50" $RO_General />
            </td>
          </tr>  
          <tr>
        ...
        <fieldset>
          <legend>SENARAI SUB SEKSYEN
            ...
            <tr class="table_header">
              ...
              <td width="25%"><strong>Seksyen</strong></td>
              <td width="38%"><strong>Sub Seksyen</strong></td>
              <td width="29%">&nbsp;</td>
            </tr>
#set ($fail = '')

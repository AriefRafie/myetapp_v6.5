        ...
        <fieldset>
          <legend>SENARAI SEKSYEN
            ...
            <tr class="table_header">
              ...
              <td width="21%"><strong>Seksyen</strong></td>
              <td width="57%"><strong>Proviso</strong></td>
              <td width="16%">&nbsp;</td>
            </tr>
#set ($fail = '')
#foreach ($fail in $List_CarianSeksyen)
	    ...
	    #set ($row = 'row2')
            ...
            <tr>
              <td class="$row">
              <a href="javascript:viewSeksyen('$fail.IDSeksyen')" style="color:#0000FF">$fail.No</a></td>
              <td class="$row">$fail.Seksyen</td>
              <td class="$row">$fail.Proviso</td>

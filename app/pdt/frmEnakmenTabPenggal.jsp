        ...
        <table width="100%" border="0">
          <tr>
            ...
            <td width="70%" valign="top">
              <input type="text" name="txtNoPenggal" id="txtNoPenggal" value="$!Penggal_NoPenggal" size="50"/> 
            </td>
          </tr>
          <tr>
            <td width="29%" align="right" valign="top">Tajuk Penggal</td>
            <td align="center" valign="top">:</td>
            <td valign="top">
              <input type="text" name="txtTajukPenggal" id="txtTajukPenggal" value="$!Penggal_TajukPenggal" size="50"/>
            </td>
          </tr>  
          <tr>
            <td align="right">&nbsp;</td>

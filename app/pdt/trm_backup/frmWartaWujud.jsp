<p>
	...
	<input type="hidden" name="idTnhRzbMlyWujud" value="$!idTnhRzbMlyWujud">
</p>
<table width="100%">
	<tr>
		...
		#end #if ($mode != 'view')
		<td id="idNegeri" onchange="">$selectNegeri</td>
		#end
	</tr>
	<tr>
		...
		#end #if ($mode != 'view')
		<td id="idDaerah">$selectDaerah</td>
		#end
	</tr>
	<tr>
	...
	<tr>
		...
		#if ($mode == 'view')
		<td>
			$tarikhWarta<a href="javascript:displayDatePicker('tarikhWarta',false,'dmy');"></a>
		</td>
		#end #if ($mode != 'view')
		<td>
			<input name="tarikhWarta" type="text" id="tarikhWarta" value="$!tarikhWarta" size="10" />
			<a href="javascript:displayDatePicker('tarikhWarta',false,'dmy');"><img border="0" src="../img/calendar.gif" /></a>
		</td>
		#end
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			#if ($mode == 'view')
			<input type="button" name="cmdKemaskini" id="cmdKemaskini" style="float: center;" value="Kemaskini"
				onclick="kemaskini()" />
			#end #if ($mode != 'view')
...
function uploadImej(step){
	document.${formName}.uploadMethod.value="uploadWujud";
...
function simpan(){
	...
	document.${formName}.hitButton.value="saveWartaPewujudan";
	document.${formName}.submit();
}

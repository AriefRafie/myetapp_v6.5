...
<table width="100%" border="0">
  <tr>
    ...
    <td width="79%">
    <select name="sbcTahun" style="width:auto">
	#foreach ( $item in [$currentYear..2009] )
    ...
    <!--
    <select name="sbcTahun1" id="sbcTahun1" style="width:auto">
      ...
      <select name="sbcTahun3" id="sbcTahun3" style="width:auto">
        ...
        <option value="9" $selectedthn39 >9</option>      </select>
        -->
        </td>
  </tr>
  <tr>
    <td><div align="left">#if ($view=='error') <span class="mandatory">*</span>#end Dari Bulan</div></td><td> : </td>
    ...
    <tr>
    <td> <div align="left">#if ($view=='error') <span class="mandatory">*</span>#end Hingga Bulan</div></td><td> : </td>
  ...
  <tr><td></td>
    <td>&nbsp;</td>
  <td><div align="left">
    <input name="cmdCetak" type="button" value="Jana Laporan" onClick="jana()">
  </div></td>
  </tr>
</table>
<br/>
<br/>
#if ($view=='error')
<table width="100%" class="warning" align="center">
...
#if ($view == 'view')
<br /><!--table><tr>
<td bgcolor="#CC6600"><div align="center"><a href="javascript:jana_test('$ahli.id_Ahli','papar')" class="style1 style1 style1">sample</a></div></td>
</tr></table-->
<fieldset>
<table border="0">
...
<div align="left">
<strong>
LAPORAN DARI $BulanDariNama HINGGA $BulanHinggaNama, $tahun
</strong>

</div>
</td></tr>
    <tr><td>
    <a href="javascript:janaAkta()">
    LAPORAN AKTA</a></td></tr>
    <tr><td>
    <a href="javascript:janaPekeliling()">
    LAPORAN PEKELILING </a></td>    
    </tr>
    <tr>
    <td><a href="javascript:janaEnakmen()">
    LAPORAN ENAKMEN</a></td>
    </tr>
</table> 
</fieldset>
#end
...
function jana(){
			...
			*/
			if (document.${formName}.socDariBulan.value == "00"){
				alert('Sila pilih " Dari Bulan " terlebih dahulu.');
				document.${formName}.socDariBulan.focus();
				return;
			}
			if (document.${formName}.socKeBulan.value == "00"){

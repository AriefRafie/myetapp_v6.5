...
<tr>
	<td width="5"></td>
	<td align="left"> <strong>PEKELILING</strong></td>
</tr>
</table>
...
<input name="idPekeliling" type="hidden" value="" />
  ...
  <td><label>
        <textarea name="txtTajukPekeliling" cols="41" rows="3" id="txtTajukPekeliling" onblur="this.value=this.value.toUpperCase();">$tajukPekeliling</textarea>
      </label></td>
    </tr>
    <tr>
  ...
  <p>
    ...
    </label></p>#parse("app/utils/record_paging.jsp") 
  <table width="100%" >
    <tr class="table_header">
      <td width="1%" scope="row"><strong>Bil.</strong></td>
      <td width="6%"><strong>Bil Pekeliling</strong></td>
    ...
    <tr>
      ...
      #if ($pekeliling.bil != '')
      <td class="$row">
      <a href = "javascript:view_lampiran('$pekeliling.id_Pekeliling')">
      <img border="0" src="../img/pdf-small.png" /></a>
      
	<a alt="Hapus Pekeliling" href = "javascript:deletePekeliling('$pekeliling.id_Pekeliling')">
...
<script>
	...
	function carian(){
		...
		document.${formName}.action = "?_portal_module=ekptg.view.pdt.PendaftaranPekeliling";
		document.${formName}.submit();
	}
...
function deletePekeliling(idPekeliling) {
    if ( !window.confirm("Pekeliling akan dihapuskan.\nAdakah Anda Pasti?") ) return;	
    document.${formName}.idPekeliling.value = idPekeliling;
    doAjaxCall${formName}("Delete","action=Delete&idPekeliling="+idPekeliling);
}

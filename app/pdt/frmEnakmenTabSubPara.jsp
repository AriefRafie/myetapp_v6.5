...
<input type="button" value="Simpan" onclick="doKemaskiniSubPara('$SubPara_IDSubPara')"/>
...
#foreach ($fail in $List_CarianSubPara)
	    ...
	    #set ($row = 'row2')
            ...
            <td class="$row">
    #if ($fail.No != '') 
              <a href="javascript:viewSubPara('$fail.IDSubPara')" style="color:#0000FF">$fail.NoEnakmen</a>
    #else
              $fail.NoEnakmen
    #end    </td>
              ...
              <td class="$row">
              <input type="hidden" id="SubPara_IDSubPara" name="SubPara_IDSubPara" value="$fail.IDSubPara" />
              <input type="button" value="Hapus" onclick="doHapusSubPara('$fail.IDSubPara');" /></td>
            </tr>
#end
          </table>
</fieldset>

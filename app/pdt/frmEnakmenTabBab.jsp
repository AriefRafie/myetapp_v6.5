...
<input type="button" value="Simpan" onclick="doKemaskiniBab();"/>
...
#foreach ($fail in $List_CarianBab)
    ...
    #end
            <tr>
            <td class="$row"> <input type="hidden" id="Bab_IDBab" name="Bab_IDBab" value="$fail.IDBab" /> 
              <a href="javascript:viewBab('$fail.IDBab')" style="color:#0000FF">
              $fail.NoBab
              </a></td>

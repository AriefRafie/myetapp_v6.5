...
<fieldset>
  <legend>MAKLUMAT  ENAKMENNNNNNN</legend>
...
#if ($selectedTab == '0')
    #parse ("app/pdt/view/frmEnakmenTabEnakmen.jsp")
#end
      </div>
      <div class="TabbedPanelsContent">
#if ($selectedTab == '1')
    #parse ("app/pdt/view/frmEnakmenTabPenggal.jsp")
#end
      </div>
      <div class="TabbedPanelsContent">
#if ($selectedTab == '2')
    #parse ("app/pdt/view/frmEnakmenTabBahagian.jsp")
#end
      </div>
      <div class="TabbedPanelsContent">
#if ($selectedTab == '3')
    #parse ("app/pdt/view/frmEnakmenTabBab.jsp")
#end
      </div>
      <div class="TabbedPanelsContent">
#if ($selectedTab == '4')
    #parse ("app/pdt/view/frmEnakmenTabSeksyen.jsp")
#end
      </div>
      <div class="TabbedPanelsContent">
#if ($selectedTab == '5')
    #parse ("app/pdt/view/frmEnakmenTabSubSeksyen.jsp")
#end
      </div>
      <div class="TabbedPanelsContent">
#if ($selectedTab == '6')
    #parse ("app/pdt/view/frmEnakmenTabPara.jsp")
#end
      </div>
      <div class="TabbedPanelsContent">
#if ($selectedTab == '7')
    #parse ("app/pdt/view/frmEnakmenTabSubPara.jsp")
#end
      </div>
      <div class="TabbedPanelsContent">
#if ($selectedTab == '8')
    #parse ("app/pdt/view/frmEnakmenTabJadualPara.jsp")
#end
      </div>
      <div class="TabbedPanelsContent">
#if ($selectedTab == '9')
    #parse ("app/pdt/view/frmEnakmenTabJadualLampiran.jsp")
#end      </div>
      <div class="TabbedPanelsContent">
#if ($selectedTab == '10')
    #parse ("app/pdt/view/frmEnakmenTabJadualSubSubPara.jsp")
#end
      </div>
    </div>
  </div>

...
#foreach ($fail in $List_CarianBahagian)
	    ...
	    #set ($row = 'row2')
            ...
            <td class="$row">
              ...
              <td class="$row"><input type="hidden" id="Para_IDPara" name="Para_IDPara" value="$fail.IDBahagian" />
              <input type="button" value="Hapus" onclick="doHapusBahagian('$fail.IDBahagian');" /></td>
            </tr>
#end
          </table>
</fieldset>

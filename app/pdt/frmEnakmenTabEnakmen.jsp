...
<div id="mydiv">
        ...
        <table width="100%" border="0">      
          <tr>
            ...
            <td width="70%" valign="top">
              <input name="txtNoEnakmen" type="text" id="txtNoEnakmen" 
               onblur="this.value=this.value.toUpperCase()" value="$!Enakmen_NoEnakmen" size="25" $RO_General/>
            </td>
          </tr>
          <tr>
            ...
            <td valign="top">
              <input name="txtNamaEnakmen" type="text" id="txtNamaEnakmen" onblur="this.value=this.value.toUpperCase()" value="$!Enakmen_NamaEnakmen" size="50" $RO_General/>
            </td>
          </tr>
          <tr>
            ...
            <td align="center" valign="top">:</td>
            <td valign="top">
              <input type="text" name="txdTarikhKuatkuasa" id="txdTarikhKuatkuasa" value="$!Enakmen_TarikhKuatkuasa" size="10" $RO_General/>
              #if($action == 'doUpdate') 
          ...
          <tr>
            ...
            <td align="center" valign="top">:</td>
            <td valign="top">
              <input type="text" name="txdTarikhMansuh" id="txdTarikhMansuh" value="$!Enakmen_TarikhMansuh" size="10" $RO_General/>
               #if($action == 'doUpdate') 
          ...
          <tr>
            ...
            <td valign="top">
              ...
              name="txtNoWarta" type="text" id="txtNoWarta" onblur="this.value=this.value.toUpperCase()" value="$!Enakmen_NoWarta" size="25" $RO_General/>
            </td>
          </tr> 
          <tr>
            ...
            <td align="center" valign="top">:</td>
            <td valign="top">
              <input type="text" name="txdTarikhWarta" id="txdTarikhWarta" value="$!Enakmen_TarikhWarta" onblur="this.value=this.value.toUpperCase()" size="10" $RO_General/>
               #if($action == 'doUpdate') 
          ...
          <tr>
            ...
            <td align="center" valign="top">:</td>
            <td valign="top">$socSeksyen</td>
            <!--<td valign="top">
              <input name="txtSeksyen" type="text" id="txtSeksyen" value="$!Enakmen_IDSeksyen" size="25" $RO_General />
            </td>-->
          </tr>  
          <tr>
            ...
            <td align="center" valign="top">:</td>
            <td valign="top">
              <input name="txtNoFail" type="text" id="txtNoFail" value="$!Enakmen_NoFail" size="50" $RO_General/>
            </td>
          </tr> 
          <tr>
            ...
            <td valign="top">
	    		...
	    		$!Enakmen_Catatan
                                ...
                                <textarea name="txtCatatan_" cols="70" rows="10" onblur="this.value=this.value.toUpperCase()">$!Enakmen_Catatan</textarea>
          ...
          <tr>
            ...
            <td valign="top">
	    		...
	    		$!Enakmen_JenisMime
	    	#else
            <input id="txfMuatNaikDokumen" name="txfMuatNaikDokumen" type="file" size="40" /> <a href = "javascript:viewEnakmenBlob($Enakmen_IDEnakmen)"><font color ="blue">$!Enakmen_JenisMime</font></a>
            #end
            </td>
          </tr>
       	  <tr>
          ...
          <tr>
            ...
            <td align="center" valign="top">:</td>
            <td valign="top">
              <input type="text" name="txdTarikhDaftar" id="txdTarikhDaftar" value="$!Enakmen_TarikhDaftar" size="10"/>
 ...
 $jquery(document).ready(function () {
        ...
        <br />
        <fieldset>
          <legend>SENARAI PEGAWAI YANG BOLEH MENGAKSES ENAKMEN SULIT</legend>

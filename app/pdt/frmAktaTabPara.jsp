        ...
        <table width="100%" border="0">
          ...
          <tr>
            ...
            <td align="center" valign="top">:</td>
            <td valign="top"><textarea name="txtPara" cols="50" rows="5" id="txtPara" $RO_General="$RO_General">$!Para_Para</textarea>
            </td>
          </tr>  
          <!--
          <tr>
...
#foreach ($fail in $List_CarianPara)
	    ...
	    #set ($row = 'row2')
            ...
            <td class="$row">
    #if ($fail.No != '') 
              <a href="javascript:viewPara('$fail.IDPara')" style="color:#0000FF">$fail.NoAkta</a>
    #else
              $fail.NoAkta
    #end    </td>
              ...
              <td class="$row"><input type="button" value="Hapus" onclick="doHapusPara('$fail.IDPara');" /></td>
            </tr>
#end
          </table>
</fieldset>

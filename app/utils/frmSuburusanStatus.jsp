...
<!-- Senarai -->
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<td nowrap>
		#if( $isFirstPage )			
		    <input class="stylobutton100"  type="button"  value="<< Previous" disabled>
		#else
		    <input class="stylobutton100"  type="button"  value="<< Previous" onclick="javascript:doAjaxCall${formname}('record_listing','action=getPrevious')">
		#end
		#if( $isLastPage )
		    <input class="stylobutton100"  type="button"  value="Next >>" disabled>
		#else
		    <input class="stylobutton100"  type="button"  value="Next >>" onclick="javascript:doAjaxCall${formname}('record_listing','action=getNext')">
		#end
		</td>
		<td width="90%">
		&nbsp;
...
#foreach ( $list in $lists )
	...
	<tr class="$row" onMouseOver="this.className='highlight'" onMouseOut="this.className='$row'">
		...
		<td>$list.langkah</td>
		<td>$list.idsuburusanstatus</td>
		<td>$list.namasuburusan
		...
		<td align="right">
			...
			<a href="javascript:doAjaxCall${formName}('edit','id=$list.idsuburusanstatus')"><img src="../img/edit.gif" border="0"></a>
			<a href="javascript:if(confirm('Data akan dipadam. Adakah Anda Pasti?')){ doAjaxCall${formName}('delete','id=$list.idsuburusanstatus') } "><img src="../img/delete.gif" border="0"></a>
		</td>
	</tr>
	#end
...
<script>
	...
	function doChangesSubmit(command_) {
	  doAjaxCall${formName}(command_,'action=filterDaerah');
	}

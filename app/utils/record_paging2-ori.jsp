           <table width="100%" border="0" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td  align="right">
                    	#if($totalRecords != 0)
                        Papar
                        <select class="smallselect" name="itemsPerPage" onchange="javascript:doAjaxCall${formname}('carian','action=doChangeItemPerPage')">
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<td width="70%" align="left" valign="middle">
		  ...
		  <!--<input class="stylobutton"  type="button"  value="<< Previous" disabled>-->
		   ...
		   <img title="First Page" style="vertical-align=bottom;cursor:hand;cursor:pointer;" onclick="javascript:doAjaxCall${formname}('carian','action=getPage&value=1')" src="../img/paging/page-first.gif">
		   #if ($page > 10)
		   	<img title="Previous 10" style="vertical-align=bottom;cursor:hand;cursor:pointer;" onclick="javascript:doAjaxCall${formname}('carian','action=getPrevious&page=$previous10')" src="../img/paging/page-prev.gif">
		   #else
		   	<img style="vertical-align=bottom;" src="../img/paging/page-prev-disabled.gif">
		   #end
		...
		&nbsp;
			...
			#foreach ( $i in [$page..$totalPages] )
					...
					<b>[$i]</b>
					#else
					<a href="javascript:doAjaxCall${formname}('carian','action=getPage&value=$i')">[$i]</a>
					#end
				#end
			#end
		#end
		&nbsp;
		    ...
		    <img title="Next 10" style="vertical-align=bottom;cursor:hand;cursor:pointer;"onclick="javascript:doAjaxCall${formname}('carian','action=getNext&page=$next10')" src="../img/paging/page-next.gif">
		    <img title="Last page:$totalPages" style="vertical-align=bottom;cursor:hand;cursor:pointer;"onclick="javascript:doAjaxCall${formname}('carian','action=getPage&value=$totalPages')" src="../img/paging/page-last.gif">

...
<table cellpadding="2" cellspacing="1" border="0" width="100%" class="nava" align="center">
  <tr>
    ...
    #if($view_skrin == "skrinPebualan")
    #parse("app/utils/inboxSkrinPebualan.jsp")
    #end
    
    #if($view_skrin == "Add")
    #parse("app/utils/inboxAddMesej.jsp")
    #end
    
    #if($view_skrin == "List")
    #parse("app/utils/inboxListMesej.jsp")
    #end
    <br>
...
d.parentNode.removeChild( d ); 
 ...
 t.parentNode.removeChild(t);
   ...
   alert("Sila Masukkan Dokumen");  
	...
	{
	SaveScrollXY();	
	document.${formName}.action = "?_portal_module=ekptg.view.utils.FrmInboxUsers&command=simpanDokumen&id_maininbox="+id_maininbox+"&id_inboxmesej="+id_inboxmesej+"&mesej="+document.${formName}.mesej.value+"&ScrollX="+document.${formName}.ScrollX.value+"&ScrollY="+document.${formName}.ScrollY.value;
	...
	{
	SaveScrollXY();	
	document.${formName}.action = "?_portal_module=ekptg.view.utils.FrmInboxUsers&command=simpanDokumenPerbualan&id_maininbox="+id_maininbox+"&id_inboxmesej="+id_inboxmesej+"&mesej="+document.${formName}.mesej.value+"&ScrollX="+document.${formName}.ScrollX.value+"&ScrollY="+document.${formName}.ScrollY.value;
	document.${formName}.method="post";
	document.${formName}.enctype="multipart/form-data";
	document.${formName}.submit();

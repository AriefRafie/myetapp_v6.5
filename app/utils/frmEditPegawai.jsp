      ...
      <td><table width="100%" border="0" cellspacing="2" cellpadding="0">
        <tr>
          ...
          <td width="78%"><span id="sprytextfield2">
            <input name="nama_pegawai" type="text" class="inputFieldb3" id="nama_pegawai" value="$pegawaiInfo.nama_pegawai">
			...
			<input maxlength=2 name="kod_pegawai" type="text" class="inputFieldb10" id="kod_pegawai" value="$pegawaiInfo.kod_pegawai">
        ...
        <tr>
          ...
          <td align="center" valign="top">:</td>
          <td><input name="keterangan_unit" type="text" class="inputFieldb" id="keterangan_unit" value="$pegawaiInfo.keterangan"></td>
        </tr>
        <tr>
          <td>Pejabat</td>
          <td align="center" valign="top">:</td>
        ...
        <tr>
          ...
          <input name="no_tel" type="text" class="inputFieldb4" id="no_tel" value="$pegawaiInfo.no_tel">
<span class="textfieldInvalidFormatMsg">Format No. Telefon tidak sah. Sila masukkan format no. telefon yang betul!</span></span></td>
        ...
        <tr>
          ...
          <td><span id="sprytextfield3">
            <input name="no_tel_ext" type="text" class="inputFieldb8" id="no_tel_ext" value="$pegawaiInfo.no_tel_sam" size="3" maxlength="3" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td align="center" valign="top">&nbsp;</td>
          <td><input type="submit" name="button" id="button" value="Simpan" onclick="javascript:doAjaxCall${formName}('simpanKemaskini','id=$pejabatInfo.id_pejabatjkptg')">
            <input type="submit" name="button2" id="button2" value="Batal" onclick="javascript:doAjaxCall${formName}('batal2','id=$pejabatInfo.id_pejabatjkptg')"></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      ...
      <input name="id_pejabatjkptg" type="hidden" id="id_pejabatjkptg" value="$pejabatInfo.id_pejabatjkptg" />
      <input name="id_unitpsk" type="hidden" id="id_unitpsk" value="$pegawaiInfo.id_unitpsk" /></td>
    </tr>
  </table>
</fieldset>

	...
	<tr>	
		...
		<fieldset>	
				<table width="100%">
					<tr>	
						<td>&nbsp;</td>
						<td> <a href="javascript:openManualX('PanduanModulPFD')" class=style1><b>Manual Pengguna Modul Pengurusan Fail Dokumen (PFD)</b></a>	
						</td>
					</tr>
					<td>&nbsp;</td>
					<table>
...
<script>
	...
	function menuUtama(){
		document.${formName}.action = "$EkptgUtil.getTabID('<i>Dashboard</i>',$myrole)?_portal_module=ekptg.view.pfd.FrmDashboard";

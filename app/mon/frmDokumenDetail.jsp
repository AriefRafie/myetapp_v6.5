    ...
    <td ><fieldset>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          ...
          <td width="1%">:</td>
          <td width="70%"><a href="javascript:javascript:cetakImej($idDokumen)" style="color:#0000FF" >$beanMaklumatImejan.namaFail</a></td>
        </tr>
        <tr>
          <td width="1%">&nbsp;</td>
          <td width="28%">&nbsp;</td>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td> #if ($modePopup == 'new')
            <input name="cmdSimpan" type="button" value="Simpan" onClick="simpanDokumen('$idPerisian')" />

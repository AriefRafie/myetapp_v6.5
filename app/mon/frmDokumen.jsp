...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td colspan="2"> #parse("app/mon/frmDokumenDetail.jsp") </td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
...
function simpanDokumen(idPerisian) {
	...
	document.${formName}.action = "?_portal_module=ekptg.view.mon.FrmSoftwareLicenseMonitoringView&hitButton=simpanDokumen&namaImej="+namaImej+"&catatanImej="+catatanImej+"&idPerisian="+idPerisian+"&selectedTab=1"+dopost+"&actionMonitoring=papar&flagPopup=openPopupDokumen&modePopup=new";
...
function cetakImej(id){
	var url = "../servlet/ekptg.view.mon.FrmDisplayImej?id="+id;

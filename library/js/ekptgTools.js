    ...
    if (document.getElementById(jenisluas).value=="2"){
		...
		if(a==""){
			...
			if(document.getElementById(kategory).value=="2" 
				|| document.getElementById(kategory).value=="1" 
					|| document.getElementById(kategory).value=="5") {       
			...
			}else if(document.getElementById(kategory).value=="3" 
				|| document.getElementById(kategory).value=="4"  
					|| document.getElementById(kategory).value=="6"  
						|| document.getElementById(kategory).value=="7"  
							|| document.getElementById(kategory).value=="8"){
		...
		if(a==""){
			...
			}else if(document.getElementById(kategory).value=="1" 
				|| document.getElementById(kategory).value=="3" 
					|| document.getElementById(kategory).value=="4" 
						|| document.getElementById(kategory).value=="5" 
							|| document.getElementById(kategory).value=="6" 
								|| document.getElementById(kategory).value=="7" 
...
//*********************  ******************** 
/* MULA
 * Edit by zulfazdliabuas@gmail.com

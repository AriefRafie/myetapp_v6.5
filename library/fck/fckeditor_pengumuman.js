...
var FCKeditor_pengumuman = function( instanceName, width, height, toolbarSet, value )
{
	// Properties
	this.InstanceName	= instanceName ;
	this.Width			= width			|| '300%' ;
	this.Height			= height		|| '400' ;
	this.ToolbarSet		= 'Pengumuman' ;
	this.Value			= value			|| '' ;
...
FCKeditor_pengumuman.prototype.Create = function()
{
	// Check for errors
...
FCKeditor_pengumuman.prototype.ReplaceTextarea = function()
{
...
FCKeditor_pengumuman.prototype._InsertHtmlBefore = function( html, element )
{
...
FCKeditor_pengumuman.prototype._GetConfigHtml = function()
{
	var sConfig = '' ;
...
FCKeditor_pengumuman.prototype._GetIFrameHtml = function()
{
...
FCKeditor_pengumuman.prototype._IsCompatibleBrowser = function()
{
...
FCKeditor_pengumuman.prototype._ThrowError = function( errorNumber, errorDescription )
{
...
FCKeditor_pengumuman.prototype._HTMLEncode = function( text )
{

...
<%!
	...
	*/
    ...
    //private static final String RESTRICT_PATH = "C:\\CODE;E:\\"; //Win32: Case important!!
     ...
     //Azam change here
     private static final String RESTRICT_PATH = "D:\\eclipse-Version\\MyWorkspace\\eTapp_03112009";
	 ...
	 */
	private static final String[] FORBIDDEN_DRIVES = {"a:\\","c:\\","d:\\","e:\\","f:\\","g:\\"};
...
if (login == null) {
	...
	out.println("Welcome "+login+" [<a href='../../c/'>Kembali</a>]");
	permissionflag=true;
} else {
  	out.println("Sorry,not enough permission<br><input type=button value=Back onClick=history.go(-1)>");
}

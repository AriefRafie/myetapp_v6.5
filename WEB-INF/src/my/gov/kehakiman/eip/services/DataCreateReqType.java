...
public class DataCreateReqType  implements java.io.Serializable {
     ...
     *                 				31NCVC only. */
    private my.gov.kehakiman.eip.services.DeceaseInfoType deceaseInfo;

    private my.gov.kehakiman.eip.services.DocumentType[] document;
     ...
     */
    public my.gov.kehakiman.eip.services.CauseofactionType[] getCauseofaction() {
        return causeofaction;
    }
     ...
     * @param causeofaction
     */
    public void setCauseofaction(my.gov.kehakiman.eip.services.CauseofactionType[] causeofaction) {
        this.causeofaction = causeofaction;
    }

    public my.gov.kehakiman.eip.services.CauseofactionType getCauseofaction(int i) {
        return this.causeofaction[i];
    }

    public void setCauseofaction(int i, my.gov.kehakiman.eip.services.CauseofactionType _value) {
     ...
     * @return party
     */
    public my.gov.kehakiman.eip.services.PartyType[] getParty() {
        return party;
    }
     ...
     * @param party
     */
    public void setParty(my.gov.kehakiman.eip.services.PartyType[] party) {
        this.party = party;
    }

    public my.gov.kehakiman.eip.services.PartyType getParty(int i) {
        return this.party[i];
    }

    public void setParty(int i, my.gov.kehakiman.eip.services.PartyType _value) {
        this.party[i] = _value;
    }
     ...
     *                 				31NCVC only.
     */
    public my.gov.kehakiman.eip.services.DeceaseInfoType getDeceaseInfo() {
        return deceaseInfo;
    }
     ...
     * @return document
     */
    public my.gov.kehakiman.eip.services.DocumentType[] getDocument() {
        return document;
    }
     ...
     * @param document
     */
    public void setDocument(my.gov.kehakiman.eip.services.DocumentType[] document) {
        this.document = document;
    }

    public my.gov.kehakiman.eip.services.DocumentType getDocument(int i) {
        return this.document[i];
    }

    public void setDocument(int i, my.gov.kehakiman.eip.services.DocumentType _value) {

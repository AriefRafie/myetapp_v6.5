...
public class Civilregistercaserequest  implements java.io.Serializable {
    ...
    private my.gov.kehakiman.eip.services.CivilregistercaserequestEventName eventName;

    private my.gov.kehakiman.eip.services.DataCreateReqType data;
    ...
    public Civilregistercaserequest(
           ...
           my.gov.kehakiman.eip.services.CivilregistercaserequestEventName eventName,
           my.gov.kehakiman.eip.services.DataCreateReqType data) {
           this.source = source;
     ...
     */
    public my.gov.kehakiman.eip.services.CivilregistercaserequestEventName getEventName() {
        return eventName;
    }
     ...
     */
    public void setEventName(my.gov.kehakiman.eip.services.CivilregistercaserequestEventName eventName) {
        this.eventName = eventName;
    }
     ...
     * @return data
     */
    public my.gov.kehakiman.eip.services.DataCreateReqType getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(my.gov.kehakiman.eip.services.DataCreateReqType data) {
        this.data = data;
    }

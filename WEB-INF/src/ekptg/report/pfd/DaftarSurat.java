...
public class DaftarSurat extends EkptgReportServlet
{
...
//		super.setFolderName("pfd");
	...
	public void doProcessing(HttpServletRequest request, HttpServletResponse response, 
		...
		String DariTarikh =(String)parameters.get("dari_tahun");
		String HinggaTarikh =(String)parameters.get("hingga_tahun");
		...
		Integer INDariTarikh = Integer.parseInt(NDariTarikh);
		 ...
		 parameters.put("dari_tahun",DariTarikh);
		 parameters.put("hingga_tahun", HinggaTarikh);
		...
		super.setFolderName("pfd");
			...
			super.setReportName("DaftarSuratKeluar");
			super.setFolderName("pfd");
		}

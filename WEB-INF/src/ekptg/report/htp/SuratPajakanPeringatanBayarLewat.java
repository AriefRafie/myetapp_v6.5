...
public class SuratPajakanPeringatanBayarLewat extends EkptgReportServlet{
	static Logger myLog = Logger.getLogger(SuratPajakanKepadaPemohon.class);
	private IHTPSusulan iSusulan = null;

	public SuratPajakanPeringatanBayarLewat() {
		super.setReportName("HTPajakanSuratBayaranLewat");
	...
	public void doProcessing(HttpServletRequest request,HttpServletResponse response
		...
		dataAsal = getISusulan().getMaklumatSusulan(idPermohonan, "PAJAKAN_SURAT_LEWAT");
		String idSusulan = "-1";
		...
		data.put("sumber", "PAJAKAN_SURAT_LEWAT");

...
public class SuratPajakanKepadaPemohon extends EkptgReportServlet{
	static Logger myLog = Logger.getLogger(SuratPajakanKepadaPemohon.class);
	private IHTPSusulan iSusulan = null;

	public SuratPajakanKepadaPemohon() {
		//myLog.info("print SuratKepadaPemohonPajakan...");
		//super.setReportName("Jawapan Kpd Pemohon bila sudah terima permohonan");
		super.setReportName("HTPajakanJawapanPermohonan");
	...
	public void doProcessing(HttpServletRequest request,HttpServletResponse response
		...
		dataAsal = getISusulan().getMaklumatSusulan(idPermohonan, "PAJAKAN_SURAT_MOHON");
		String idSusulan = "-1";
		...
		data.put("catatan", "Surat Jawapan Kepada Pemohon");
		data.put("sumber", "PAJAKAN_SURAT_MOHON");

...
public class SuratPajakanKepadaJKPTGNegeri extends EkptgReportServlet{
	static Logger myLog = Logger.getLogger(SuratPajakanKepadaJKPTGNegeri.class);
	private IHTPSusulan iSusulan = null;

	public SuratPajakanKepadaJKPTGNegeri() {
		//myLog.info("print SuratKepadaJKPTGNegeri...");
		//super.setReportName("Surat Pemohonan Laporan Tanah kepada JKPTG Negeri");
		super.setReportName("HTPajakanSuratJKPTGNegeri");
	...
	public void doProcessing(HttpServletRequest request,
		...
		dataAsal = getISusulan().getMaklumatSusulan(idPermohonan, "PAJAKAN_SURAT_JKPTGN");
		String idSusulan = "-1";
		...
		data.put("catatan", "Surat Kepada JKPTG(N)");
		data.put("sumber", "PAJAKAN_SURAT_JKPTGN");

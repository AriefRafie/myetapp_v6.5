...
public class SuratPajakanKepadaJPPH extends EkptgReportServlet{
	static Logger myLog = Logger.getLogger(SuratPajakanKepadaJPPH.class);
	public SuratPajakanKepadaJPPH() {
		//myLog.info("print SuratKepadaKJPPajakan...");
		//super.setReportName("SURAT PERMOHONAN KEPADA JPPH");
		super.setReportName("HTPajakanSuratPenilaianJPPH");

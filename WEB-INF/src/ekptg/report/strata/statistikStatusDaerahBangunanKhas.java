...
public class statistikStatusDaerahBangunanKhas extends EkptgReportServlet{

		public statistikStatusDaerahBangunanKhas() {
			super.setReportName("strSenaraiSkimMengikutDaerahDanStatus");

 ...
 *
 */
public class PYWSuratPenolakanPermohonanSewaBukanMilikPTP extends EkptgReportServlet {

	public PYWSuratPenolakanPermohonanSewaBukanMilikPTP() {
		super.setReportName("PYWSuratPenolakanPermohonanSewaBukanMilikPTP");

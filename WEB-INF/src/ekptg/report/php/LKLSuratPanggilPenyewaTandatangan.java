 ...
 *
 */
public class LKLSuratPanggilPenyewaTandatangan extends EkptgReportServlet {

	public LKLSuratPanggilPenyewaTandatangan() {
		super.setReportName("LKLSuratPanggilPenyewaTandatangan");

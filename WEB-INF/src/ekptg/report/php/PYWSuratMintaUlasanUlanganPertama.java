...
public class PYWSuratMintaUlasanUlanganPertama extends EkptgReportServlet {

	public PYWSuratMintaUlasanUlanganPertama() {
		super.setReportName("PYWSuratMintaUlasanUlanganPertama");

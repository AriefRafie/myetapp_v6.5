...
public class CRBSuratMohonPTDKluarNotisKosongDanKuatkuasa extends EkptgReportServlet {

	public CRBSuratMohonPTDKluarNotisKosongDanKuatkuasa() {
		super.setReportName("CRBSuratMohonPTDKluarNotisKosongDanKuatkuasa");

...
public class CRBSuratAkuanPenerimaanPermohonanPencerobohan extends EkptgReportServlet {

	public CRBSuratAkuanPenerimaanPermohonanPencerobohan() {
		super.setReportName("CRBSuratAkuanPenerimaanPermohonanPencerobohan");

 ...
 *
 */
public class LKLSuratPembatalanKelulusanSewaSelepasTarikh extends EkptgReportServlet {

	public LKLSuratPembatalanKelulusanSewaSelepasTarikh() {
		super.setReportName("LKLSuratPembatalanKelulusanSewaSelepasTarikh");

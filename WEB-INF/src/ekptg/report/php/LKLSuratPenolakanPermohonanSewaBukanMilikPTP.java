 ...
 *
 */
public class LKLSuratPenolakanPermohonanSewaBukanMilikPTP extends EkptgReportServlet {

	public LKLSuratPenolakanPermohonanSewaBukanMilikPTP() {
		super.setReportName("LKLSuratPenolakanPermohonanSewaBukanMilikPTP");

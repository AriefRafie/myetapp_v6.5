...
public class APBSuratAkuanPenerimaan_Aduan extends EkptgReportServlet {

	public APBSuratAkuanPenerimaan_Aduan() {
		super.setReportName("APBSuratAkuanPenerimaan_Aduan");

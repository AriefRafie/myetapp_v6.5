 ...
 *
 */
public class SuratPenolakanPelepasan extends EkptgReportServlet {
	
	FrmPLPPopupCetakLaporanData logic = new FrmPLPPopupCetakLaporanData();
	
	public SuratPenolakanPelepasan() {
		super.setReportName("SuratPenolakanPelepasan");
	...
	public void doProcessing(HttpServletRequest request,
		...
		parameters.put("FLAG_PERENGGAN",logic.getFlagPerenggan2Keputusan((String) parameters.get("ID_FAIL")));
	}
}

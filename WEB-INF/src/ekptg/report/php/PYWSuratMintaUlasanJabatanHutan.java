 ...
 *
 */
public class PYWSuratMintaUlasanJabatanHutan extends EkptgReportServlet {

	public PYWSuratMintaUlasanJabatanHutan() {
		super.setReportName("PYWSuratMintaUlasanJabatanHutan");

...
public class PYWSuratPenolakanPermohonanSewaDBKL extends EkptgReportServlet {

	public PYWSuratPenolakanPermohonanSewaDBKL() {
		super.setReportName("PYWSuratPenolakanPermohonanSewaDBKL");

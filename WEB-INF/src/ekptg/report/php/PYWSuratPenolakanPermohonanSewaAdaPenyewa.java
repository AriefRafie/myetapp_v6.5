...
public class PYWSuratPenolakanPermohonanSewaAdaPenyewa extends EkptgReportServlet{
	
	public PYWSuratPenolakanPermohonanSewaAdaPenyewa() {
		super.setReportName("PYWSuratPenolakanPermohonanSewaAdaPenyewa");

...
public class CRBSuratKpdKJPMemohonLaporanCadanganPembangunanProjek extends EkptgReportServlet {

	public CRBSuratKpdKJPMemohonLaporanCadanganPembangunanProjek() {
		super.setReportName("CRBSuratKpdKJPMemohonLaporanCadanganPembangunanProjek");

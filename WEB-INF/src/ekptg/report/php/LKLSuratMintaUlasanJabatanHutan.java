 ...
 *
 */
public class LKLSuratMintaUlasanJabatanHutan extends EkptgReportServlet {

	public LKLSuratMintaUlasanJabatanHutan() {
		super.setReportName("LKLSuratMintaUlasanJabatanHutan");

 ...
 *
 */
public class LKLSuratPenolakanPermohonanSewaMesyuaratTolak extends EkptgReportServlet {

	public LKLSuratPenolakanPermohonanSewaMesyuaratTolak() {
		super.setReportName("LKLSuratPenolakanPermohonanSewaMesyuaratTolak");

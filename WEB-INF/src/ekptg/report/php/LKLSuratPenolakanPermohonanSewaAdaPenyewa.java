 ...
 *
 */
public class LKLSuratPenolakanPermohonanSewaAdaPenyewa extends EkptgReportServlet {

	public LKLSuratPenolakanPermohonanSewaAdaPenyewa() {
		super.setReportName("LKLSuratPenolakanPermohonanSewaAdaPenyewa");

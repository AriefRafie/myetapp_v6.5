 ...
 *
 */
public class LKLSuratMintaUlasanKJPHasratPenyewaan extends EkptgReportServlet {

	public LKLSuratMintaUlasanKJPHasratPenyewaan() {
		super.setReportName("LKLSuratMintaUlasanKJPHasratPenyewaan");

 ...
 *
 */
public class SuratMaklumanSewakKepadaKJP_Hasil_JKPTGN extends EkptgReportServlet {

	public SuratMaklumanSewakKepadaKJP_Hasil_JKPTGN() {
		super.setReportName("SuratMaklumanSewakKepadaKJP_Hasil_JKPTGN");

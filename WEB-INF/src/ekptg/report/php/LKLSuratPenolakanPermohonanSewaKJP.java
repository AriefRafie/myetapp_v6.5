 ...
 *
 */
public class LKLSuratPenolakanPermohonanSewaKJP extends EkptgReportServlet {

	public LKLSuratPenolakanPermohonanSewaKJP() {
		super.setReportName("LKLSuratPenolakanPermohonanSewaKJP");

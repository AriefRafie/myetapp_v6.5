 ...
 *
 */
public class SuratLawatanTapak extends EkptgReportServlet {

	public SuratLawatanTapak() {
		super.setReportName("SuratLawatanTapak");
	...
	public void doProcessing(HttpServletRequest request,
		...
		if (list.size() != 0){
			...
			parameters.put("EMEL",(String)h.get("emel"));
		}
	}
}

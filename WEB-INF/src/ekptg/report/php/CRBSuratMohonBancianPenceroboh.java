...
public class CRBSuratMohonBancianPenceroboh extends EkptgReportServlet {

	public CRBSuratMohonBancianPenceroboh() {
		super.setReportName("CRBSuratMohonBancianPenceroboh");

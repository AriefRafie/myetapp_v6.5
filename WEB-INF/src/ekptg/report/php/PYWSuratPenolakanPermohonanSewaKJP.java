 ...
 *
 */
public class PYWSuratPenolakanPermohonanSewaKJP extends EkptgReportServlet {

	public PYWSuratPenolakanPermohonanSewaKJP() {
		super.setReportName("PYWSuratPenolakanPermohonanSewaKJP");

...
public class APBSuratAkuanPenerimaanPermohonanPasir extends EkptgReportServlet {

	public APBSuratAkuanPenerimaanPermohonanPasir() {
		super.setReportName("APBSuratAkuanPenerimaanPermohonanPasir");

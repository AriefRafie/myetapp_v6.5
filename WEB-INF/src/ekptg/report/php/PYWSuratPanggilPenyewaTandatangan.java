 ...
 *
 */
public class PYWSuratPanggilPenyewaTandatangan extends EkptgReportServlet {

	public PYWSuratPanggilPenyewaTandatangan() {
		super.setReportName("PYWSuratPanggilPenyewaTandatangan");

 ...
 *
 */
public class LKLSuratPembatalanKelulusanSewa extends EkptgReportServlet {

	public LKLSuratPembatalanKelulusanSewa() {
		super.setReportName("LKLSuratPembatalanKelulusanSewa");

 ...
 *
 */
public class PYWSuratPenolakanPermohonanSewaMesyuarat extends EkptgReportServlet {

	public PYWSuratPenolakanPermohonanSewaMesyuarat() {
		super.setReportName("PYWSuratPenolakanPermohonanSewaMesyuarat");

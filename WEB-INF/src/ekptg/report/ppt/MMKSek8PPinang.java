...
public class MMKSek8PPinang extends EkptgReportServlet {
	
	public MMKSek8PPinang() {
		super.setReportName("MMK_PULAU_PINANG(SS 8)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_PULAU_PINANG(SS 8)",idfail,nofail,flagVersion);

...
public class MMKSek4Melaka extends EkptgReportServlet {
	
	public MMKSek4Melaka() {
		super.setReportName("MMK_MELAKA(SS 4)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_MELAKA(SS 4)",idfail,nofail,flagVersion);

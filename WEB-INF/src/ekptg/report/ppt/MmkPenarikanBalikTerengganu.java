...
public class MmkPenarikanBalikTerengganu extends EkptgReportServlet{
	static Logger myLogger = Logger.getLogger(MmkPenarikanBalikSelangor.class);
	
	
	public MmkPenarikanBalikTerengganu() {
		
		super.setReportName("MMK_TERENGGANU_PENARIKANBALIK");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_TERENGGANU_PENARIKANBALIK",idfail,nofail,flagVersion);
	}

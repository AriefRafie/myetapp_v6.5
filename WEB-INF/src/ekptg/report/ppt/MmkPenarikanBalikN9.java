...
public class MmkPenarikanBalikN9 extends EkptgReportServlet{
	static Logger myLogger = Logger.getLogger(MmkPenarikanBalikSelangor.class);
	
	
	public MmkPenarikanBalikN9() {
		
		super.setReportName("MMK_N9_PENARIKANBALIK");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_N9_PENARIKANBALIK",idfail,nofail,flagVersion);
	}

...
public class suratKepadaAPSupayaMembayarPampasanTambahan extends EkptgReportServlet{
	...
	public void doProcessing(HttpServletRequest request,
		...
		if(id_negeri.equals("5")){
			super.setReportName("suratKepadaAPSupayaMembayarPampasanTambahan_n9");
		}else if(id_negeri.equals("11")){
			super.setReportName("suratKepadaAPSupayaMembayarPampasanTambahan_Trgnu");
		}else if(id_negeri.equals("6")){
			super.setReportName("suratKepadaAPSupayaMembayarPampasanTambahan_Phg");
		}else{
			super.setReportName("suratKepadaAPSupayaMembayarPampasanTambahan");
		}

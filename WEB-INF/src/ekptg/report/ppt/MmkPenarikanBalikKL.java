...
public class MmkPenarikanBalikKL extends EkptgReportServlet{
	static Logger myLogger = Logger.getLogger(MmkPenarikanBalikSelangor.class);
	
	
	public MmkPenarikanBalikKL() {
		
		super.setReportName("MMK_KL");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_KL",idfail,nofail,flagVersion);
	}

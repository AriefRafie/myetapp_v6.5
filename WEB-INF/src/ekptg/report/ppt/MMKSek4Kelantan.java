...
public class MMKSek4Kelantan extends EkptgReportServlet {
	
	public MMKSek4Kelantan() {
		super.setReportName("MMK_KELANTAN(SS 4)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_KELANTAN(SS 4)",idfail,nofail,flagVersion);

...
public class MMKSek8Kelantan extends EkptgReportServlet {
	
	public MMKSek8Kelantan() {
		super.setReportName("MMK_KELANTAN(SS 8)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_KELANTAN(SS 8)",idfail,nofail,flagVersion);

...
public class MMKSek4WPKL extends EkptgReportServlet {
	
	public MMKSek4WPKL() {
		super.setReportName("MMK_WPKUALA_LUMPUR(SS 4)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_WPKUALA_LUMPUR(SS 4)",idfail,nofail,flagVersion);

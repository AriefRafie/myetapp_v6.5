...
public class MMKSek4Selangor extends EkptgReportServlet {
	
	public MMKSek4Selangor() {
		super.setReportName("MMK_SELANGOR(SS 4)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_SEK4_SELANGOR",idfail,nofail,flagVersion);
	}
}
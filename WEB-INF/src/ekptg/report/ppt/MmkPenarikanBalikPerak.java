...
public class MmkPenarikanBalikPerak extends EkptgReportServlet{
	static Logger myLogger = Logger.getLogger(MmkPenarikanBalikSelangor.class);
	
	
	public MmkPenarikanBalikPerak() {
		
		super.setReportName("MMK_PERAK_PENARIKANBALIK");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_PERAK_PENARIKANBALIK",idfail,nofail,flagVersion);
	}

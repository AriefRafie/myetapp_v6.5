...
public class PerancangJPPH extends EkptgReportServlet {
	...
	public void doProcessing(HttpServletRequest request,
		...
		if(id_negeri.equals("8"))
		{
			super.setReportName("SS8_surat_maklumat_perancang_jpph_PERAK");
		}		
		else
		{
			super.setReportName("SS8_surat_maklumat_perancang_jpph");
		}

...
public class MmkPenarikanBalikPahang extends EkptgReportServlet{
	static Logger myLogger = Logger.getLogger(MmkPenarikanBalikSelangor.class);
	
	
	public MmkPenarikanBalikPahang() {
		
		super.setReportName("MMK_PAHANG_PENARIKANBALIK");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_PAHANG_PENARIKANBALIK",idfail,nofail,flagVersion);
	}

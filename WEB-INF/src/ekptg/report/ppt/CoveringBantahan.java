...
public class CoveringBantahan  extends EkptgReportServlet {
	//tutup 17052020 - covering ikut negeri
	...
	public void doProcessing(HttpServletRequest request,
		...
		if(id_negeri.equals("5")){
			super.setReportName("CoveringBantahanv6.5_N9");
		}else if(id_negeri.equals("4")){
			super.setReportName("CoveringBantahanv6.5_Melaka");
		}else if(id_negeri.equals("2")){
			super.setReportName("CoveringBantahanV6.5_Kedah");
		}else if(id_negeri.equals("14")){
			super.setReportName("CoveringBantahanV6.5_KL");
		}else if(id_negeri.equals("11")){
			super.setReportName("CoveringBantahanV6.5_Trgnu");
		}else if(id_negeri.equals("6")){
			super.setReportName("CoveringBantahanv6.5");
		}else{
			 super.setReportName("CoveringBantahanPTG");
		}
		super.setFolderName("ppt");

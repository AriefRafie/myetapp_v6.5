...
public class MmkPenarikanBalikMelaka extends EkptgReportServlet{
	static Logger myLogger = Logger.getLogger(MmkPenarikanBalikSelangor.class);
	
	
	public MmkPenarikanBalikMelaka() {
		
		super.setReportName("MMK_MELAKA_PENARIKANBALIK");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_MELAKA_PENARIKANBALIK",idfail,nofail,flagVersion);
	}

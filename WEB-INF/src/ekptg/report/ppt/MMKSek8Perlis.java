...
public class MMKSek8Perlis extends EkptgReportServlet {
	
	public MMKSek8Perlis() {
		super.setReportName("MMK_PERLIS(SS 8)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_PERLIS(SS 8)",idfail,nofail,flagVersion);
	}
}
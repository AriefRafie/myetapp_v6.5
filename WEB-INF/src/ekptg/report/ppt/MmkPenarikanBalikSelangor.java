...
public class MmkPenarikanBalikSelangor extends EkptgReportServlet{
	static Logger myLogger = Logger.getLogger(MmkPenarikanBalikSelangor.class);
	
	
	public MmkPenarikanBalikSelangor() {
		
		super.setReportName("MMK_SELANGOR_PENARIKANBALIK");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_PENARIKANBALIK_SELANGOR",idfail,nofail,flagVersion);
	}

...
public class MMKSek8WPKL extends EkptgReportServlet {
	
	public MMKSek8WPKL() {
		super.setReportName("MMK_WPKUALA_LUMPUR(SS 8)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_WPKUALA_LUMPUR(SS 8)",idfail,nofail,flagVersion);

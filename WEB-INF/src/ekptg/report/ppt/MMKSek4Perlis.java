...
public class MMKSek4Perlis extends EkptgReportServlet {
	
	public MMKSek4Perlis() {
		super.setReportName("MMK_PERLIS(SS 4)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_PERLIS(SS 4)",idfail,nofail,flagVersion);

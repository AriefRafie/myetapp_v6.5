...
public class MMKSek8Terengganu extends EkptgReportServlet {
	
	public MMKSek8Terengganu() {
		super.setReportName("MMK_TERENGGANU(SS 8)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_TERENGGANU(SS 8)",idfail,nofail,flagVersion);

...
public class MMKSek4Pahang extends EkptgReportServlet {
	
	public MMKSek4Pahang() {
		super.setReportName("MMK_PAHANG(SS 4)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_PAHANG(SS 4)",idfail,nofail,flagVersion);

...
public class Perkara1JPBD extends EkptgReportServlet {
	...
	public void doProcessing(HttpServletRequest request,
		...
		{
			super.setReportName("PERKARA 1 - JPBD (MAKLUMAT PERANCANG)_PERAK");
		}		
		else
		{
			super.setReportName("PERKARA 1 - JPBD (MAKLUMAT PERANCANG)");
		}

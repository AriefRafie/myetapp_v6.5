...
public class SuratSiasatanKpdAP_Prmhn extends EkptgReportServlet {
	...
	public void doProcessing(HttpServletRequest request,
		...
		{
			super.setReportName("suratSiasatanKepadaAP_N9_Prmhn");
		}
		else
		{
			super.setReportName("suratSiasatanKepadaAP_Prmhn");
		}

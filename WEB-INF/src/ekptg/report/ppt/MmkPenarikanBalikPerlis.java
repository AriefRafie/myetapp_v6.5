...
public class MmkPenarikanBalikPerlis extends EkptgReportServlet{
	static Logger myLogger = Logger.getLogger(MmkPenarikanBalikSelangor.class);
	
	
	public MmkPenarikanBalikPerlis() {
		
		super.setReportName("MMK_PERLIS_PENARIKANBALIK");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_PERLIS_PENARIKANBALIK",idfail,nofail,flagVersion);
	}

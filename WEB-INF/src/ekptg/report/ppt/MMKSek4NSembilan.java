...
public class MMKSek4NSembilan extends EkptgReportServlet {
	
	public MMKSek4NSembilan() {
		super.setReportName("MMK_N9(SS 4)");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_N9(SS 4)",idfail,nofail,flagVersion);
	}
}
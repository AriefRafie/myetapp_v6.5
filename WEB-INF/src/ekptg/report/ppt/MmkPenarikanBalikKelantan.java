...
public class MmkPenarikanBalikKelantan extends EkptgReportServlet{
	static Logger myLogger = Logger.getLogger(MmkPenarikanBalikSelangor.class);
	
	
	public MmkPenarikanBalikKelantan() {
		
		super.setReportName("MMK_KELANTAN_PENARIKANBALIK");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_KELANTAN_PENARIKANBALIK",idfail,nofail,flagVersion);
	}

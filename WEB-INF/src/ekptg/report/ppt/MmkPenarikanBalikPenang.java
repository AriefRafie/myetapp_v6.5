...
public class MmkPenarikanBalikPenang extends EkptgReportServlet{
	static Logger myLogger = Logger.getLogger(MmkPenarikanBalikSelangor.class);
	
	
	public MmkPenarikanBalikPenang() {
		
		super.setReportName("MMK_PULAU_PINANG_PENARIKANBALIK");
	...
	public void doProcessing(HttpServletRequest request,
		...
		doVersioning("MMK_PULAU_PINANG_PENARIKANBALIK",idfail,nofail,flagVersion);
	}

...
public class RekodRingkasanMilikKementerian extends EkptgReportServlet{

	public RekodRingkasanMilikKementerian() {
		super.setReportName("HTPRekodRingkasanMilikKementerian");
	...
	//public void SimpanHistory(HttpSession session)throws Exception {
			...
			String namaLaporan = "Ringkasan Tanah Milik Persekutuan Mengikut Kementerian";
			String sql = "";

...
public class RekodRingkasanMilikNegeri extends EkptgReportServlet{

	public RekodRingkasanMilikNegeri() {
		super.setReportName("HTPRekodRingkasanMilikNegeri");
	...
	public void SimpanHistory(HttpSession session, String ids)throws Exception {
		...
		String namaLaporan = "Ringkasan Tanah Milik Persekutuan Mengikut Negeri";
		String sql = "";

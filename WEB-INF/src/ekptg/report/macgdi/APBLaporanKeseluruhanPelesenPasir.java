...
public class APBLaporanKeseluruhanPelesenPasir extends EkptgReportServlet {

	FrmREVPopupCetakLaporanData logic = new FrmREVPopupCetakLaporanData();
	
	public APBLaporanKeseluruhanPelesenPasir() {
	...
	public void doProcessing(HttpServletRequest request,
		...
		public void SimpanHistory(HttpSession session, String ids)throws Exception {
			...
			String namaLaporan = "APB Laporan Keseluruhan Pelesen Pasir";
			String sql = "";

...
public class APBLaporanPelesenPasirTamat extends EkptgReportServlet {
	
	public APBLaporanPelesenPasirTamat() {
		
		super.setFolderName("php2\\APB\\LAPORAN");
		super.setReportName("APBLaporanPelesenPasirTamat");
	...
	//public void SimpanHistory(HttpSession session)throws Exception {
			public void SimpanHistory(HttpSession session, String ids)throws Exception {
				...
				String namaLaporan = "Senarai Lesen Tamat Tempoh";
				String sql = "";

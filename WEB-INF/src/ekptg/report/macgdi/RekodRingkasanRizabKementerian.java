...
public class RekodRingkasanRizabKementerian extends EkptgReportServlet{

	public RekodRingkasanRizabKementerian() {
		super.setReportName("HTPRekodRingkasanRizabKementerian");
	...
	public void SimpanHistory(HttpSession session, String ids)throws Exception {
		...
		String namaLaporan = "Ringkasan Tanah Rizab Persekutuan Mengikut Kementerian";
		String sql = "";

 ...
 *
 */
public class SuratIringanPerintahKuasaTadbir extends EkptgReportServlet {

	FrmPopupPilihPegawaiReportData logic = new FrmPopupPilihPegawaiReportData();
	
	public SuratIringanPerintahKuasaTadbir() {
		super.setReportName("SuratIringanPerintahKuasaTadbir");

 ...
 *
 */
public class SuratIringanNotisPengeluaranGeran extends EkptgReportServlet {

	FrmPopupPilihPegawaiReportData logic = new FrmPopupPilihPegawaiReportData();
	
	public SuratIringanNotisPengeluaranGeran() {
		super.setReportName("SuratIringanNotisPengeluaranGeran");

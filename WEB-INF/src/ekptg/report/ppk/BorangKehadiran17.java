...
public class BorangKehadiran17 extends EkptgReportServlet
{
  Vector bayaran = null;
  Vector bayaranPusaka = null;
  FrmPopupPilihPegawaiReportData logic = new FrmPopupPilihPegawaiReportData();
	private static Logger myLog = Logger.getLogger(BorangKehadiran17.class);

  public BorangKehadiran17()
  {
    super.setReportName("BorangKehadiran17");

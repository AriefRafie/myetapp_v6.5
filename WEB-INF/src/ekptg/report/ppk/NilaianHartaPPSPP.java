...
public class NilaianHartaPPSPP extends EkptgReportServlet{
	FrmPopupPilihPegawaiReportData logic = new FrmPopupPilihPegawaiReportData();
	
	public NilaianHartaPPSPP (){
		super.setReportName("NilaianHartaPPSPP") ;
...
//		
//			System.out.println("namaPegawai :"+h.get("nama").toString());
//			System.out.println("jawatan :"+h.get("jawatan").toString());
//			
//			
//		}
//		System.out.println("jawatan :"+logic.getDaerahMohon(parameters.get("nofail").toString(),parameters.get("flagReport").toString()));

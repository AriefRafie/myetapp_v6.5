 ...
 *
 */
public class SuratIringanPerintahKuasaTadbirII extends EkptgReportServlet {

FrmPopupPilihPegawaiReportData logic = new FrmPopupPilihPegawaiReportData();
	
	public SuratIringanPerintahKuasaTadbirII() {
		super.setReportName("SuratIringanPerintahKuasaTadbirII");

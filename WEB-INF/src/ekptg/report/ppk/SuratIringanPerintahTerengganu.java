...
public class SuratIringanPerintahTerengganu extends EkptgReportServlet {
	
FrmPopupPilihPegawaiReportData logic = new FrmPopupPilihPegawaiReportData();
	
	public SuratIringanPerintahTerengganu() {
		super.setReportName("SuratIringanPerintahTerengganu");

...
public class PLPLaporanTukarGunaTanahRizabPersekutuan extends EkptgReportServlet {

	FrmREVPopupCetakLaporanData logic = new FrmREVPopupCetakLaporanData();
	
	public PLPLaporanTukarGunaTanahRizabPersekutuan() {
	...
	public void doProcessing(HttpServletRequest request,
		...
		if(jenis.equals("1")){
			super.setReportName("PLPLaporanTukarGunaTanahRizabPersekutuanKeseluruhan");
			System.out.println("dalam dah");
		}else if(jenis.equals("2")){
			super.setReportName("PLPLaporanTukarGunaTanahRizabPersekutuanMengikutNegeri");
		}else if(jenis.equals("3")){
			super.setReportName("PLPLaporanTukarGunaTanahRizabPersekutuanMengikutKem");
		}else{

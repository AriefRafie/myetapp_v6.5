...
public class APBUlanganSuratMintaUlasanDOF extends EkptgReportServlet {

	public APBUlanganSuratMintaUlasanDOF() {
		super.setReportName("APBUlanganSuratMintaUlasanDOF");

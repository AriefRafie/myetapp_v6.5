...
public class PYWSuratTandatanganPerjanjian extends EkptgReportServlet {

	public PYWSuratTandatanganPerjanjian() {
		super.setReportName("PYWSuratTandatanganPerjanjian");

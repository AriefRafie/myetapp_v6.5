...
public class PYWPerjanjianKayuKayuan extends EkptgReportServlet {

	public PYWPerjanjianKayuKayuan() {
	...
	public void doProcessing(HttpServletRequest request,
		...
		if (listRM.size() != 0){
			...
			parameters.put("ROYALTI",NumberToWords.convertTwoPart((String)hRM.get("royalti")));

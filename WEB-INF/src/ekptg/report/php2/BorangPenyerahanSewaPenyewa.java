...
public class BorangPenyerahanSewaPenyewa extends EkptgReportServlet {

	public BorangPenyerahanSewaPenyewa() {
		super.setReportName("BorangPenyerahanSewaPenyewa");
	...
	public void doProcessing(HttpServletRequest request,
		...
		parameters.put("ID_HASIL",(String)parameters.get("ID_HASIL"));

...
public class PLPLaporanTanahRizabPersekutuan extends EkptgReportServlet {

	FrmREVPopupCetakLaporanData logic = new FrmREVPopupCetakLaporanData();
	
	public PLPLaporanTanahRizabPersekutuan() {
	...
	public void doProcessing(HttpServletRequest request,
		...
		if(jenis.equals("1")){
			super.setReportName("PLPLaporanTanahRizabPersekutuanKeseluruhan");
			System.out.println("dalam dah");
		}else if(jenis.equals("2")){
			super.setReportName("PLPLaporanTanahRizabPersekutuanMengikutNegeri");
		}else if(jenis.equals("3")){
			super.setReportName("PLPLaporanTanahRizabPersekutuanMengikutKem");
		}else{

...
public class APBUlanganSuratMintaUlasanJLM extends EkptgReportServlet {

	public APBUlanganSuratMintaUlasanJLM() {
		super.setReportName("APBUlanganSuratMintaUlasanJLM");

...
public class APBUlanganPengesahanPelanKawasan extends EkptgReportServlet {

	public APBUlanganPengesahanPelanKawasan() {
		super.setReportName("APBUlanganPengesahanPelanKawasan");

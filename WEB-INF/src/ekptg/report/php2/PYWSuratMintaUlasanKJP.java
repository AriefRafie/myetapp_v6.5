...
public class PYWSuratMintaUlasanKJP extends EkptgReportServlet {

	public PYWSuratMintaUlasanKJP() {
		super.setReportName("PYWSuratMintaUlasanKJP");
	...
	public void doProcessing(HttpServletRequest request,
		...
		logic.setMaklumatUser(idPegawai);
		Vector list = logic.getBeanMaklumatUser();
		...
		if (list.size() != 0){
			...
			parameters.put("PEJABAT",(String)h.get("pejabat"));
		}

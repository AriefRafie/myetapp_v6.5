...
public class APBUlanganSuratMintaUlasanPHN extends EkptgReportServlet {

	public APBUlanganSuratMintaUlasanPHN() {
		super.setReportName("APBUlanganSuratMintaUlasanPHN");

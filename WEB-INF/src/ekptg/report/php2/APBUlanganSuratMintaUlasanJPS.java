...
public class APBUlanganSuratMintaUlasanJPS extends EkptgReportServlet {

	public APBUlanganSuratMintaUlasanJPS() {
		super.setReportName("APBUlanganSuratMintaUlasanJPS");

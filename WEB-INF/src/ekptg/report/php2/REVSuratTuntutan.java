...
public class REVSuratTuntutan extends EkptgReportServlet {

	FrmREVPopupCetakLaporanData logic = new FrmREVPopupCetakLaporanData();

	public REVSuratTuntutan() {
	...
	public void doProcessing(HttpServletRequest request,
		...
		if (bakiTunggakan < 0D) {
			...
			super.setReportName("REVSuratTuntutan2");
		} else {
			parameters.put("JUMLAH_DEPOSIT_DIRAMPAS", String.valueOf(jumlahTunggakan));
			super.setReportName("REVSuratTuntutan1");
		}
	}
}

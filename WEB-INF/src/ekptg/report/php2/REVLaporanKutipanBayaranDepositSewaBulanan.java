...
public class REVLaporanKutipanBayaranDepositSewaBulanan extends EkptgReportServlet {

	public REVLaporanKutipanBayaranDepositSewaBulanan () {
		super.setReportName("REVLaporanKutipanBayaranDepositSewaBulanan");

...
public class REVSuratTuntutanTunggakanSewa extends EkptgReportServlet {
	
	FrmREVPopupCetakLaporanData logic = new FrmREVPopupCetakLaporanData();

	public REVSuratTuntutanTunggakanSewa() {
	...
	public void doProcessing(HttpServletRequest request,
		...
		if (logic.getJenisSuratTuntutan(idNotis)) {
			super.setReportName("REVSuratTuntutanTunggakanSewa2");
		} else { 
			super.setReportName("REVSuratTuntutanTunggakanSewa2");
		}
	}

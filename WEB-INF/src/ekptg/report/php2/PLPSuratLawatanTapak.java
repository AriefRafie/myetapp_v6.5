...
public class PLPSuratLawatanTapak extends EkptgReportServlet {

	public PLPSuratLawatanTapak() {
		super.setReportName("PLPSuratLawatanTapak");
		super.setFolderName("php2"+File.separator+"PLP");
	}

...
public class APBMengemukakanBayaran extends EkptgReportServlet {

	public APBMengemukakanBayaran() {
		super.setReportName("APBSuratBayarFee");
	...
	public void doProcessing(HttpServletRequest request,
		...
		FrmAPBCetakSuratKeputusanData logicRM = new FrmAPBCetakSuratKeputusanData();
		...
		if (listRM.size() != 0){
			...
			parameters.put("ROYALTI",NumberToWords.convertTwoPart((String)hRM.get("txtKadarRoyaltiPasir")));
		}	
	}
}

...
public class PLPLaporanTanahMilikPersekutuan extends EkptgReportServlet {

	FrmREVPopupCetakLaporanData logic = new FrmREVPopupCetakLaporanData();
	
	public PLPLaporanTanahMilikPersekutuan() {
	...
	public void doProcessing(HttpServletRequest request,
		...
		if(jenis.equals("1")){
			super.setReportName("PLPLaporanTanahMilikPersekutuanKeseluruhan");
			System.out.println("dalam dah");
		}else if(jenis.equals("2")){
			super.setReportName("PLPLaporanTanahMilikPersekutuanMengikutNegeri");
		}else if(jenis.equals("3")){
			super.setReportName("PLPLaporanTanahMilikPersekutuanMengikutKem");
		}else{

...
public class CRBSuratTindakanPenguatkuasaan extends EkptgReportServlet{
	
	public CRBSuratTindakanPenguatkuasaan() {
		super.setReportName("CRBSuratTindakanPenguatkuasaan");

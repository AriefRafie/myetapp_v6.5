...
public class APBUlanganSuratMintaUlasanJMG extends EkptgReportServlet {

	public APBUlanganSuratMintaUlasanJMG() {
		super.setReportName("APBUlanganSuratMintaUlasanJMG");

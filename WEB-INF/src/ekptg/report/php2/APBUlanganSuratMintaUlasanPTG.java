...
public class APBUlanganSuratMintaUlasanPTG extends EkptgReportServlet {

	public APBUlanganSuratMintaUlasanPTG() {
		super.setReportName("APBUlanganSuratMintaUlasanPTG");

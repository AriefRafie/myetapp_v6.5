...
public class REVLaporanKeseluruhanHasilBulanan extends EkptgReportServlet {

	public REVLaporanKeseluruhanHasilBulanan () {
		super.setReportName("REVLaporanKeseluruhanHasilBulanan");

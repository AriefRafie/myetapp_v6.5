...
public class PYWSuratTarikbalikTawaran extends EkptgReportServlet {

	public PYWSuratTarikbalikTawaran() {
		super.setReportName("PYWSuratTarikBalikPermohonanMaklumbalasBerakhir");

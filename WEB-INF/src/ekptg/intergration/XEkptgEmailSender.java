...
public class XEkptgEmailSender {
	protected static Logger myLog = Logger.getLogger(XEkptgEmailSender.class);
	private static XEkptgEmailSender singleton;
	...
	private XEkptgEmailSender(){
		getMailProperties();
		getMailSession();
		
	}
	
	public static synchronized XEkptgEmailSender getInstance(){
		//if(singleton  == null){
			singleton = new XEkptgEmailSender();
		//}	
		return singleton;

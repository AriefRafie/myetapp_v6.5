...
public class FrmDaftarLainDokumenData {
	private static Vector list = new Vector();
	private static Logger myLogger = Logger.getLogger(FrmDaftarLainDokumenData.class);
	public void  setCarianDokumen(String noRujukanDokumen,String tajukDokumen, String tarikhDokumen, String seksyen) throws Exception{
		 Db db = null;
		 list.clear();
		 String sql = "";
	...
	public Vector getCarianDokumen(String noRujukanDokumen, String tajukDokumen
	...
	public void Delete(String idDokumen) throws Exception {
		Db db = null;
		String sql = "";
		try {
			db = new Db();

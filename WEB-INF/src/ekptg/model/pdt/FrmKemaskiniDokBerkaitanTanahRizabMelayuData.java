...
public class FrmKemaskiniDokBerkaitanTanahRizabMelayuData {
	static Logger myLog = Logger.getLogger(FrmKemaskiniLainDokumenData.class);
	 ...
	 public static void setData(int id)throws Exception {
		 ...
		 try {
		      ...
		      while (rs.next()) {
		    	  ...
		    	  h.put("tagging", Utils.isNull(rs.getString(9)));
		    	  h.put("idTagging", Utils.isNull(rs.getString(10)));
		    	  h.put("idJenisDokumen", Utils.isNull(rs.getString(11)));
		    	  list.addElement(h);
	 ...
	 public static void  setListLampiran(String id)throws Exception {
		...
		public static void hapus(int idLampiran) throws Exception {
			Db db = null;
			String sql = "";

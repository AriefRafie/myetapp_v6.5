...
public class FrmHakmilikSementaraPermohonanSPTData {
	...
	//sahkan (status change to "127")
	 ...
	 public void setListPohon(String id) throws Exception {
			...
			sql = r.getSQLSelect("Tblrujsuburusan us, Tblpfdfail f, Tblrujdaerah d, Tblrujnegeri n, Tblrujkementerian k, Tblrujstatus s, Tblpptpermohonan p, Tblrujmukim m");

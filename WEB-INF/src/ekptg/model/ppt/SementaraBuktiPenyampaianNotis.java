...
public class SementaraBuktiPenyampaianNotis {
	static Logger myLogger = Logger.getLogger(SementaraBuktiPenyampaianNotis.class);
	...
	public static Vector getListPermohonan(String flagJenisBukti, String userIdNegeri)throws Exception {
	    ...
	    try{
	    		...
	    		myLogger.info("LIST BUKTI NOTIS :: "+sql);
		...
		public void setListMaklumatTanah(String idPermohonan,String lot,String idpegawai) throws Exception{
			 ...
			 listMaklumatTanah = new Vector();
				...
				try {
						...
						sql += " Tblrujdaerah d, Tblrujpegawai e ";
						...
						myLogger.info("SQL HAKMILIK :: "+sql);
						ResultSet rs = stmt.executeQuery(sql);	
						Hashtable h;
						int bil = 1;

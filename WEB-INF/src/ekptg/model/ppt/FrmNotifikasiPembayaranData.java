...
public class FrmNotifikasiPembayaranData {
	static Logger myLogger = Logger.getLogger(FrmNotifikasiPembayaranData.class);
	private static final Log log = LogFactory.getLog(FrmNotifikasiPembayaranData.class);
	
	private static FrmNotifikasiPembayaranData instance = null;
	public static FrmNotifikasiPembayaranData getInstance()
	  {
	    if (instance == null) instance = new FrmNotifikasiPembayaranData();
	    return instance;
	  }

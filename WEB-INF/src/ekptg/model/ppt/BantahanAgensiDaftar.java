			...
			public Vector getMaklumatBantahanAP(String id_permohonan, String id_hakmilik, String id_siasatan, String id_warta) throws Exception {		 							
				...
				try{
					...
					/*	sql =  " SELECT DISTINCT I.MAKLUMAT_BANTAHAN_TAMAT_TEMPOH,I.FLAG_SEMAKAN_ONLINE, E.ID_SIASATAN,I.ID_BANTAHAN,I.NO_BANTAHAN,I.JENIS_PEMBANTAH,I.TARIKH_TERIMA,I.TARIKH_BORANGN,I.ID_PIHAKBERKEPENTINGAN, "; 
						...
						sql += " I.FLAG_UKUR_LUAS,I.FLAG_PAMPASAN,I.TARIKH_TERIMA_AWARD,E.NO_SIASATAN,I.AMAUN_TUNTUTAN, L.ID_WARTA, M.KETERANGAN AS DESC_STATUS_BANTAHAN_AP, ";
						sql += " N.NAMA_AGENSI, I.FLAG_ONLINE ";
						sql += " FROM TBLPPTPERMOHONAN A,TBLPPTHAKMILIK B,TBLPPTSIASATAN E, ";
						sql += " TBLPPTAWARD F,TBLPPTBORANGH H, ";	
						sql += " TBLPPTBANTAHAN I,TBLRUJKEMENTERIAN J,TBLRUJNEGERI K, TBLPPTWARTA L, TBLRUJSTATUS M, TBLRUJAGENSI N ";	
						sql += " WHERE A.ID_PERMOHONAN = B.ID_PERMOHONAN ";
						sql += " AND E.ID_SIASATAN = F.ID_SIASATAN(+) ";
						sql += " AND A.ID_AGENSI = N.ID_AGENSI(+) ";
						sql += " AND A.ID_PERMOHONAN = E.ID_PERMOHONAN ";
						sql += " AND B.ID_HAKMILIK = I.ID_HAKMILIK AND J.ID_KEMENTERIAN = I.ID_KEMENTERIAN AND K.ID_NEGERI = J.ID_NEGERI AND I.STATUS_BANTAHAN_AP = M.ID_STATUS ";
						sql += " AND A.ID_PERMOHONAN = '"+id_permohonan+"' AND B.ID_HAKMILIK = '"+id_hakmilik+"' ";

...
public class SementaraLaporanTerperinciTanah {
	static Logger myLogger = Logger.getLogger(SementaraLaporanTerperinciTanah.class);
	private static SimpleDateFormat Format =  new SimpleDateFormat("dd/MM/yyyy");
	
	private static Vector listcarian = null;
	
	public static Vector getListCarian(String userIdNeg){
		return listcarian;
	}
	...
	public static Vector getListPermohonan(String userIdNegeri)throws Exception {
	    ...
	    try{
	    		...
	    		sql +="AND p.id_status IN (22,26,31,132,133,134,147) ";

...
public class BantahanAgensiOnlineOperations {
	static Logger myLogger = Logger.getLogger(BantahanAgensiOnlineOperations.class);
	private static SimpleDateFormat sdf =  new SimpleDateFormat("dd/MM/yyyy");
	
	public void daftarBantahan (String txtNoBantahan, String txdTkhMasuk,
			...
			String umpuk_pampasan,String id_hakmilikpb,String txtAmaunTuntutan,String id_permohonan) throws Exception {
...
//			  r.add("flag_pulang_deposit",socStatusPulang);
	...
	public void updateBantahan(String id_bantahan,String txtNoBantahan, String txdTkhMasuk,
			...
			String terima_pampasan, String umpuk_pampasan, String txtAmaunTuntutan) throws Exception {	
...
//		myLogger.info("umpuk_pampasan :"+umpuk_pampasan+";terima_pampasan :"+terima_pampasan+";amaun_pampasan :"+amaun_pampasan+";ukuran_luas:"+ukuran_luas);
	...
	public void simpanSusulan(String usid,String idBorangO,String id_bantahan,String id_hakmilikpb,String txtNoProsiding,
			...
			String txtTempohBayaran, String unitTempohBayaran, String id_award, String txtKeteranganPampasan) throws Exception {
		...
		public static void updateSuburusanHakmilik_pembatalanOlehMT(Hashtable data,String currentSuburusanstatushakmilik,String id_suburusanstatus) throws Exception
		  {
			...
			public static void updateSuburusanStatusBantahan(Hashtable data,
					String currentSuburusanstatusfailppt,String newSuburusanStatus) throws Exception
			  {
			    ...
			    try{
			    		...
			    		//update n add tblrujsuburusanstatusbantahan
					    SQLRenderer r = new SQLRenderer();
						r.update("ID_SUBURUSANSTATUS", currentSuburusanstatusfailppt);	
						r.add("AKTIF",0);
						r.add("ID_KEMASKINI",id_user);
						r.add("TARIKH_KEMASKINI",r.unquote("sysdate"));
						sql = r.getSQLUpdate("tblrujsuburusanstatusbantahan");
						
						myLogger.info("status bantahan :: "+sql);						
						stmt.executeUpdate(sql);	 
			  ...
			  }//close tblrujsuburusanstatusbantahan	

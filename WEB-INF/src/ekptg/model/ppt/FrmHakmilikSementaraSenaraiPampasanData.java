...
public class FrmHakmilikSementaraSenaraiPampasanData {
	
	Vector list = null;
	SimpleDateFormat Format =  new SimpleDateFormat("dd/MM/yyyy");
	
	static Logger myLogger = Logger.getLogger(FrmHakmilikSementaraSenaraiPampasanData.class);
	...
	public void  setCarianFail(String noFail,String tarikh,String status, String noRujJKPTG, String userIdNegeri)throws Exception {
	    ...
	    try {
	      ...
	      sql +="AND p.id_status = s.id_status AND ( s.id_status = 38 OR s.id_status = 68 OR s.id_status = 147 OR s.id_status = 72 OR s.id_status = 1610193)  AND s.id_seksyen = 1  AND f.id_suburusan = 53";
	      ...
	      myLogger.info("SQL LIST PAMPASAN :: "+sql);

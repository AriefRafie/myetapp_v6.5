...
public class PPTHeader_lama {
	...
	public static void setDataHeader(String id_permohonan)throws Exception {
	    ...
	    getFlagLot = getFlagLot(id_permohonan);		
...
//	Hashtable getFlagLot = null;
	public static Hashtable getFlagLot(String id_permohonan)throws Exception {
	...
	public static void updateFlagLot(String id_permohonan)throws Exception
	  {
	   Db db = null;
	    String sql = "";
	    try
	...
	public static void updateLOT(String id_permohonan)throws Exception
	  { 

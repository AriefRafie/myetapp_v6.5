...
public class BantahanAgensiDaftarOperations {
	static Logger myLogger = Logger.getLogger(BantahanAgensiDaftarOperations.class);
	...
	public void add_bantahanAP (HttpSession session,String txtNoBantahan,String txdTkhMasuk,String txdTkhTerimaBrgN,String txdBrgN,String txtNoLot,String txtNoPt,
	    ...
	    {			    	  
		      ...
		      r.add("jenis_pembantah",2);						// JENIS PEMBANTAH : 1 [PIHAK BERKEPENTINGAN] & 2 [AGENSI PEMOHON]
		      r.add("tarikh_terima",r.unquote(TT) );		      
		      r.add("tarikh_borangn",r.unquote(TBN) );
		      r.add("id_kementerian",txtIdKementerian);
...
//			  myLogger.info("UPDATE Tblppthakmilik ::-> "+sql);	
			  stmt.executeUpdate(sql);	
...
//		      myLogger.info("INSERT TBLRUJSUBURUSANSTATUSBANTAHAN ::"+sql);
		      ...
		      Db db1 = null;				
				...
				at.logActivity("","1",null,session,"INS","BANTAHAN AGENSI [BIL. BANTAHAN : "+NO_BANTAHAN_temp+", AMAUN TUNTUTAN : RM "+AMAUN_TUNTUTAN_temp+"] INSERT");
	...
	public void add_deposit(String usid,String id_bantahan,String txdTkhTerimaResit, String txdTkhResit,
	    ...
	    {		
		      ...
		      r.add("status_bantahan_ap", 200);					// 200 = URUSAN DEPOSIT (AGENSI)
		      r.add("id_kemaskini",usid);
		      r.add("tarikh_kemaskini",r.unquote("sysdate"));
	 ...
	 public boolean isNoResitExist(String no_resit) {
		...
		public void updateStatusUrusanDeposit(String id_permohonan, String usid) throws Exception {
		    ...
		    {			  
			    ...
			    r.add("id_status", 200);			// 200 = URUSAN DEPOSIT (DEPOSIT)
			    r.add("id_kemaskini",usid);
				r.add("tarikh_kemaskini",r.unquote("sysdate"));
...
//			    myLogger.info("daftarBorangO = "+sql);
			    ...
			    //TBLPPTBANTAHAN
			    r.update("id_bantahan", id_bantahan);	
			    r.add("status_bantahan_ap",1610249);		// 1610249 = BORANG O (AGENSI)
			    r.add("id_kemaskini",usid);
			    r.add("tarikh_kemaskini",r.unquote("sysdate"));
			    sql = r.getSQLUpdate("Tblpptbantahan");
//			    myLogger.info("UPDATE ::-> "+sql);	
		...
		public void updateBantahan(String id_bantahan,String txtNoBantahan, String txdTkhMasuk,
		    ...
		    {		
		    	String TT = "to_date('" + txdTkhTerimaBrgN + "','dd/MM/yyyy')";
		    	String TBN = "to_date('" + txdBrgN + "','dd/MM/yyyy')";	
		    	String TAW = "to_date('" + txdTkhAward + "','dd/MM/yyyy')";	
			    ...
			    r.add("flag_pampasan",umpuk_pampasan);	
			    r.add("amaun_tuntutan",txtAmaunTuntutan);
			    r.add("tarikh_terima_award",r.unquote(TAW) );
			    r.add("id_kemaskini",usid);
				r.add("tarikh_kemaskini",r.unquote("sysdate"));
		...
		public void simpanLanjutan(String usid,String idBorangO,String id_bantahan,String txdTarikhLanjutanOB,
				String txdTarikhLanjutanPT) throws Exception {
		...
		public void simpanSusulan(String usid,String idBorangO,String id_bantahan,String txtNoProsiding,
		    ...
		    {		
			    ...
			    SQLRenderer r = new SQLRenderer();
			      ...
			      r.add("status_bantahan_ap",201);						// 201 = URUSAN MAHKAMAH (AGENSI)
			      r.add("id_kemaskini",usid);
			      r.add("tarikh_kemaskini",r.unquote("sysdate"));
			      sql = r.getSQLUpdate("Tblpptbantahan");
...
//				  stmt.executeUpdate(sql);	
		...
		public void simpanPemulanganDeposit(String usid,String idBorangO,String id_bantahan,String sorStatusPulangDep) throws Exception {
...
//			    SQLRenderer r = new SQLRenderer();
//			    r.update("id_permohonan", id_permohonan);		    
//			    r.add("id_status", 201);					// 201 = URUSAN MAHKAMAH (AGENSI)
//			    r.add("id_kemaskini",usid);
//				r.add("tarikh_kemaskini",r.unquote("sysdate"));
//			    sql = r.getSQLUpdate("Tblpptpermohonan");	
...
//		}
		...
		public void update_deposit(String usid, String id_bantahan, String idBorangO,
				...
				String socStatusPulang, String txdTkhHantar,
				String txtNamaPenghantar, String txtCatatanPlgDeposit) throws Exception {
...
//				  myLogger.info("UPDATE ::-> "+sql);	
		...
		public void simpanTarikBalik(String usid, String id_bantahan,String txdTkhTerimaSurat, String txdTkhSurat, String txtNoRujSurat) throws Exception {
		    Db db = null;
		    String sql = "";	    
		    try
		    {
			    ...
			    r.add("status_bantahan_ap",203);					// 202 = TARIK BALIK BANTAHAN (AGENSI)
			    r.add("id_kemaskini",usid);
				r.add("tarikh_kemaskini",r.unquote("sysdate"));
			    sql = r.getSQLUpdate("Tblpptbantahan");	
//			    myLogger.info("TBLPPTBANTAHAN = "+sql);
		...
		public void updateStatusTarikBalik(String id_permohonan, String usid) throws Exception {
		    ...
		    {			  
			    ...
			    SQLRenderer r = new SQLRenderer();
			    r.update("id_permohonan", id_permohonan);		    
			    r.add("id_status", 203);				// 203 = TARIK BALIK (AGENSI)
			    r.add("id_kemaskini",usid);
				r.add("tarikh_kemaskini",r.unquote("sysdate"));
			    sql = r.getSQLUpdate("Tblpptpermohonan");	
//			    myLogger.info("EDIT IDSTATUS TBLPPTPERMOHONAN = "+sql);
...
//				myLogger.info("DELETE AP :: "+sql);
		...
		public void updateStatusDalamProses(String id_permohonan, String usid) throws Exception {
		    ...
		    {			  
			    ...
			    SQLRenderer r = new SQLRenderer();
			    r.update("id_permohonan", id_permohonan);		    
			    r.add("id_status", 199);						// 199 = DALAM PROSES (AGENSI)
			    r.add("id_kemaskini",usid);
				r.add("tarikh_kemaskini",r.unquote("sysdate"));
			    sql = r.getSQLUpdate("Tblpptpermohonan");	
//			    myLogger.info("EDIT IDSTATUS TBLPPTPERMOHONAN = "+sql);
		...
		public void simpanBatalMahkamah(String usid, String id_bantahan,String txdTkhTerimaSurat, String txdTkhSurat, 
		    ...
		    try
		    {
			    ...
			    r.add("status_bantahan_ap",220);					// 220 = PEMBATALAN OLEH MT
			    r.add("id_kemaskini",usid);
				r.add("tarikh_kemaskini",r.unquote("sysdate"));
			    sql = r.getSQLUpdate("Tblpptbantahan");	
//			    myLogger.info("TBLPPTBANTAHAN = "+sql);
...
//				  myLogger.info("UPDATE TBLRUJSUBURUSANSTATUSBANTAHAN --> "+sql2);
				...
				//** INSERT TBLRUJSUBURUSANSTATUSBANTAHAN
					...
					r.add("id_hakmilik",id_hakmilik);
					r.add("id_bantahan",id_bantahan);				
					r.add("id_suburusanstatus",16102107);			// ID_SUBURUSANSTATUS URUSAN DEPOSIT = 200
					r.add("aktif",1);
...
//				  myLogger.info("UPDATE TBLRUJSUBURUSANSTATUSBANTAHAN --> "+sql2);
				...
				//** INSERT TBLRUJSUBURUSANSTATUSBANTAHAN
					...
					r.add("id_hakmilik",id_hakmilik);
					r.add("id_bantahan",id_bantahan);				
					r.add("id_suburusanstatus",16102108);			// ID_SUBURUSANSTATUS URUSAN MAHKAMAH(AGENSI) = 201
					r.add("aktif",1);
					r.add("id_fail",id_fail);
					r.add("id_masuk",usid);
					r.add("tarikh_masuk",r.unquote("sysdate"));
...
//				  myLogger.info("UPDATE TBLRUJSUBURUSANSTATUSBANTAHAN --> "+sql2);
				...
				//** INSERT TBLRUJSUBURUSANSTATUSBANTAHAN
					...
					r.add("id_hakmilik",id_hakmilik);
					r.add("id_bantahan",id_bantahan);				
					r.add("id_suburusanstatus",16102117);	// ID_SUBURUSANSTATUS TARIK BALIK BANTAHAN (AGENSI) = 203
					r.add("aktif",1);
					r.add("id_fail",id_fail);
					r.add("id_masuk",usid);
					r.add("tarikh_masuk",r.unquote("sysdate"));
...
//				  myLogger.info("UPDATE TBLRUJSUBURUSANSTATUSBANTAHAN --> "+sql2);
				...
				//** INSERT TBLRUJSUBURUSANSTATUSBANTAHAN
					...
					r.add("id_hakmilik",id_hakmilik);
					r.add("id_bantahan",id_bantahan);				
					r.add("id_suburusanstatus",16102122);	// ID_SUBURUSANSTATUS PEMBATALAN BANTAHAN OLEH MT (AGENSI) = 1610235
					r.add("aktif",1);
					r.add("id_fail",id_fail);
					r.add("id_masuk",usid);
					r.add("tarikh_masuk",r.unquote("sysdate"));
				...
				public static void updateSuburusanHakmilik_pembatalanOlehMT(Hashtable data,String currentSuburusanstatushakmilik,String id_suburusanstatus) throws Exception
				  {
					...
					public void tolakPermohonanOnline(String id_bantahan,String usid) throws Exception {
					    ...
					    {			  
						    ...
						    r.add("status_bantahan_ap","1610250"); //Status permohonan ditolak
						    r.add("id_kemaskini",usid);
							r.add("tarikh_kemaskini",r.unquote("sysdate"));
						    sql = r.getSQLUpdate("Tblpptbantahan");	
						    stmt.executeUpdate(sql);	    

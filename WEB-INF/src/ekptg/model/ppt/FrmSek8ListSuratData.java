...
public class FrmSek8ListSuratData {
	static Logger myLogger = Logger.getLogger(FrmSek8ListSuratData.class);
	...
	public static Vector getListPermohonan()throws Exception {
		    ...
		    try{
		    		...
		    		//sql +="AND p.id_status IN (22,132,133,134,26)";
	...
	@SuppressWarnings("unchecked")
	public static void setListCarian(String carianNofail, String carianTarikh, String status)throws Exception {

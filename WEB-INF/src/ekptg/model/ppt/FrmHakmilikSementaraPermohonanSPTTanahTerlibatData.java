...
public class FrmHakmilikSementaraPermohonanSPTTanahTerlibatData {
	...
	//sahkan (status change to "127")
	 ...
	 /*   //generate no Fail "JKPTG(S)881/SPT/kod_kementerian/kod_negeri-seq_fail
	      String KodFailJabatan = "JKPTG(S)881";
	      String SPT = "SPT";
	      String kod_kementerian = "";
	      String kodMampu = "";
	      ...
	      String noFail = KodFailJabatan+"/"+SPT+"/"+kod_kementerian+"/"+kodMampu+"-"+File.getSeqNoJilid(seq_number1, seq_number2, seq_number3, seq_number4);
	  */
	 ...
	 public void setListPohon(String id) throws Exception {
			...
			sql = r.getSQLSelect("Tblrujsuburusan us, Tblpptsenaraisemak smk, Tblpfdfail f, Tblrujdaerah d, Tblrujnegeri n, Tblrujkementerian k, Tblrujstatus s, Tblpptpermohonan p, Tblrujmukim m");

...
public class FrmHakmilikSementaraSenaraiAgihanTugasUPTData {
	static Logger myLogger = Logger.getLogger(FrmHakmilikSementaraSenaraiAgihanTugasUPTData.class);	
	...
	public  void setList(String carianFail, String CarianTarikhMohon, String cStatus)throws Exception {
	    ...
	    // AND c.kod_status IN ('27','32') AND c.id_seksyen = 1
	    try {
	     list = new Vector();
	      db = new Db();
	      ...
	      sql +="AND a.id_status = c.id_status(+) AND d.id_suburusan = su.id_suburusan(+) AND d.id_kementerian = k.id_kementerian(+) AND d.id_fail = a.id_fail(+) AND c.kod_status IN ('27','32') AND c.id_seksyen = 1 AND d.id_suburusan = 53";
	      ...
	      sql +="ORDER by b.tarikh_agih desc, d.no_fail desc ";
	      }

...
public class FrmKemaskiniMesyuaratData {
	...
	public static void setData(String id, String idFlag)throws Exception {
		 ...
		 try {
		      ...
		      while (rs.next()) {
		    	  ...
		    	  if (idFlag=="1"){
		    		  Integer bil = Integer.parseInt(rs.getString("bil_Mesyuarat")) + 1;
			    	  h.put("bil_Mesyuarat", bil);
		    	  }else{
...
//		    	  h.put("bil_Mesyuarat", rs.getString("bil_Mesyuarat"));
		    	  ...
		    	  h.put("waktu_Mesyuarat_Dari",rs.getString("waktu_Mesyuarat_Dari")== null?0:rs.getString("waktu_Mesyuarat_Dari"));
		    	  h.put("masa_Mesyuarat_Hingga",rs.getString("masa_Mesyuarat_Hingga")== null?"":rs.getString("masa_Mesyuarat_Hingga"));
		    	  h.put("waktu_Mesyuarat_Hingga",rs.getString("waktu_Mesyuarat_Hingga")== null?0:rs.getString("waktu_Mesyuarat_Hingga"));
	 ...
	 public static void  updateBilMesyuarat(Hashtable data) throws Exception{
		 Db db = null;
		    String sql = "";
		    try
		    {
		    	Integer idMesyuarat = Integer.parseInt((String)data.get("id_Mesyuarat"));
		    	  Integer bilMesyuarat = Integer.parseInt((String)data.get("bil_Mesyuarat"));

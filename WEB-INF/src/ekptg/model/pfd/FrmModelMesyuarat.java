...
public class FrmModelMesyuarat {
	...
	public String saveMesyuaratData(String ID_MESYUARAT, String BIL_MESYUARAT, String NO_FAIL, String TAJUK_MESYUARAT, String JENIS_MESYUARAT, String TARIKH_MESYUARAT, String MESYUARAT_DARI, String MESYUARAT_HINGGA, 
			...
			String STATUS_PROSES,HttpSession session, String user_negeri, String ID_URUSETIA) throws Exception {
		String returnValue = "";
		String sql = "";
		String TABLE_NAME = "TBLPFDMESYUARAT";
	//	Db db = new Db();
	...
	public Vector getAhliMesyuaratKehadiran(String ID_MESYUARAT) throws Exception {
		...
		try {
			...
			sql = "SELECT ID_AHLIMESYUARAT, NAMA_AHLIMESYUARAT, HADIR, NAMA_WAKIL FROM TBLPFDAHLIMESYUARAT WHERE ID_MESYUARAT = " + ID_MESYUARAT + " ORDER BY FLAG_PENGERUSI, KATEGORI_AHLI, NAMA_AHLIMESYUARAT, ID_AHLIMESYUARAT";
			rs = stmt.executeQuery(sql);
			while (rs.next()) {
				ID_AHLI = rs.getString(1) == null ? "" : rs.getString(1);
	...
	@SuppressWarnings("unchecked")
	public Vector getAgendaMesyuaratList(String ID_MESYUARAT) throws Exception {
		Vector v = new Vector();
		String sql = "";
		Db db = new Db();
	...
	@SuppressWarnings("unchecked")
	public Vector getMinitMesyuaratList(String ID_MESYUARAT) throws Exception {
		Vector v = new Vector();
		String sql = "";
		Db db = new Db();
	...
	@SuppressWarnings("unchecked")
	public Vector getSubMinitMesyuaratList(String ID_MESYUARAT) throws Exception {
		Vector v = new Vector();
		String sql = "";
		Db db = new Db();
...
//		      " ORDER BY NP, PG.USER_ID ";
	...
	@SuppressWarnings("unchecked")
	public Vector getListMesyuarat(String Mesyuarat_NoFail, String Mesyuarat_Tajuk, String Mesyuarat_Jenis, String Mesyuarat_Urusetia, String Mesyuarat_Lokasi, String Mesyuarat_Tarikh,String id_seksyen, String id_negeri, String ID_URUSETIA) throws DbException, Exception {
		String sql = "";
		Db db = new Db();
	...
	@SuppressWarnings("unchecked")
	public Vector getListMesyuaratNegeri(String Mesyuarat_NoFail, String Mesyuarat_Tajuk, String Mesyuarat_Jenis, String Mesyuarat_Urusetia, String Mesyuarat_Lokasi, String Mesyuarat_Tarikh,String id_unit, String id_negeri, String ID_URUSETIA) throws DbException, Exception {
		String sql = "";
		Db db = new Db();
		Vector listMesyuarat = new Vector();

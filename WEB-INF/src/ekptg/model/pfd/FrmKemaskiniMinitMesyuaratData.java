...
public class FrmKemaskiniMinitMesyuaratData {
	...
	private static final String idAgenda = null;
	...
	public static void setDataMesyuarat(int id)throws Exception {
	 ...
	 public static void setDataPerkaraMinit(int id)throws Exception {
		 ...
		 try {
		      ...
		      System.out.println("papar perkara--"+sql);
	...
	public static void setListAgendaMesyuarat(int id) throws Exception {
		  ...
		  Db db = null;
		    ...
		    try {
		      ...
		      r.add("id_Mesyuarat",id);
		     
		     
		
		      sql = r.getSQLSelect("Tblpfdmesyuaratagenda");
		      ResultSet rs = stmt.executeQuery(sql);
	...
	public static String addAgenda(Hashtable data) throws Exception {
		Db db = null;
	    String sql = "";
	   
	    try
	    {	 
	    	  long idMinitmesyuaratpara = DB.getNextID("TBLPFDMESYUARATAGENDA_SEQ");
		      String agendaMesyuarat = (String)data.get("agendaMesyuarat");
		      String statusAgenda = (String)data.get("status");
		      String idMesyuarat = (String)data.get("idMesyuarat");
		     ...
		     // r.add("id_Agendamesyuarat",idAgenda);
		      r.add("agenda_mesyuarat", agendaMesyuarat);
		      r.add("idMesyuarat", idMesyuarat);
		      r.add("statusAgenda", statusAgenda);
		      r.add("tarikh_Masuk",r.unquote("sysdate")); 
		      r.add("id_Masuk",idMasuk);
		      
		      sql = r.getSQLInsert("tblpfdmesyuaratagenda");  
		      stmt.executeUpdate(sql);

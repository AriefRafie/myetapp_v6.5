...
public class FrmDaftarTukarTarafKeselamatanData {
	
	private static Vector list = new Vector();
	public static void  setCarianFail(String noFail,String noFailLama,String tajukFail,String negeri,String seksyen,String status,String tarikhDaftar,String taraf, String user_id, String myrole, String user_negeri, String id_seksyen)throws Exception {
	    Db db = null;
	    list.clear();
	    String sql = "";
...
//	      		" AND A.ID_TARAFKESELAMATAN in (1)" +
	      ...
	      //TARAF KESELAMATAN
	      if (taraf != null) {
				if (!taraf.trim().equals("")) {
					if (!taraf.trim().equals("0")) {
						setLimit = false;
						sql = sql + " AND A.ID_TARAFKESELAMATAN = '" + taraf + "'";
					}
				}
			}
	      //TARIKH DAFTAR FAIL	      
...
//			}
	      ...
	      while (rs.next()) {
	    	  ...
	    	  h.put("tarafKeselamatan", rs.getString("TARAF_KESELAMATAN")== null? "":rs.getString("TARAF_KESELAMATAN"));

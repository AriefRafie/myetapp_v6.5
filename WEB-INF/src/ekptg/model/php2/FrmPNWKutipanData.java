...
public class FrmPNWKutipanData {
	...
	public String daftarBaru(String idJenisTanah, String noFail,
			...
			String perkara, String idKategoriPemohon,
	...
	public boolean checkingExistNoFail(String noFail) throws Exception {
		...
		try {
			...
			sql = "SELECT ID_FAIL FROM TBLPFDFAIL WHERE ID_SEKSYEN = '4' AND ID_URUSAN = '6' AND ID_SUBURUSAN = '32' AND UPPER(NO_FAIL) = UPPER('"
					+ noFail + "')";

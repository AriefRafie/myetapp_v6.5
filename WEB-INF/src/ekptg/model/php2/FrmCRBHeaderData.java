...
public class FrmCRBHeaderData {
	...
	public void setMaklumatPermohonan(String idFail, HttpSession session)
		...
		try {
			...
			sql = "SELECT A.ID_FAIL, A.NO_FAIL, A.TAJUK_FAIL, B.ID_PERMOHONAN, B.TARIKH_TERIMA, B.TARIKH_SURAT, C.ID_PEMOHON, C.NAMA, C.ID_NEGERITETAP, C.ID_KATEGORIPEMOHON, C.ID_PEJABAT, I.ID_NEGERI AS ID_NEGERITANAH, I.ID_KEMENTERIAN AS ID_KEMENTERIANTANAH, I.ID_AGENSI AS ID_AGENSITANAH,"

 ...
 * 
 */
public class FrmPNWSenaraiMesyuaratData {
	...
	private static final Log myLog = LogFactory.getLog(FrmPNWSenaraiMesyuaratData.class);
	...
	public void carianSenaraiMesyuarat(String tajukMesyuarat, String bilMesyuarat, String tarikhMesyuarat, 
		...
		try {
			...
			sql = "SELECT A.ID_MESYUARAT, A.TAJUK, A.BIL_MESYUARAT,A.TARIKH_MESYUARAT, B.LOKASI, A.STATUS_MESYUARAT " +
				      ...
				      "AND ID_URUSAN='6' AND ID_SUBURUSAN='32'";
...
//			}
	...
	public void sendEmailMesyuarat(String idMesyuarat,String emel, HttpSession session) throws Exception {
		...
		try {
			...
			email.SUBJECT = "NOTIS PANGGILAN MESYUARAT PERMOHONAN PENAWARAN";
			email.MESSAGE = body;
			email.sendEmail();

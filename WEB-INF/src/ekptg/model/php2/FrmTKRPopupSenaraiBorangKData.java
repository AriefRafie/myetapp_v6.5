...
public class FrmTKRPopupSenaraiBorangKData {
	...
	public String saveBorangK(String jenisHakmilik, String txtNoHakmilik,
			...
			String idKategori, String idSubKategori, String idKementerian,
			String idAgensi, String txtSyarat, String txtSekatan,
			String txtKegunaanTanah, String tarikhBorangK, String txtCatatan,
			String txtNoPerserahan, String tarikhCatatan, String tarikhTerima,
	...
	public void setMaklumatAgensi(String idAgensi) throws Exception {
		...
		try {
			...
			sql = "SELECT B.NAMA_KEMENTERIAN, A.NAMA_AGENSI FROM TBLRUJAGENSI A, TBLRUJKEMENTERIAN B WHERE A.ID_KEMENTERIAN = B.ID_KEMENTERIAN AND A.ID_AGENSI = '"
					+ idAgensi + "'";
	...
	public void carianBorangK(String peganganHakmilik, String jenisHakmilik,
			...
			String idAgensiPemohon) throws Exception {
		...
		try {
			...
			if (idAgensiPemohon != null) {
				if (!idAgensiPemohon.trim().equals("")
						&& !idAgensiPemohon.trim().equals("99999")) {
					sql = sql + " AND PPTMOHON.ID_AGENSI != '"
							+ idAgensiPemohon.trim().toUpperCase() + "'";
				}
			}
	...
	public String getIdKementerian(String idAgensi) throws Exception {
		Db db = null;
		String sql = "";

 ...
 * 
 */
public class FrmPLPSenaraiFailData {
	...
	public String daftarBaru(String idJenisTanah, String tarikhTerima,
			...
			String noFaks, String idHakmilikAgensi, String idPPTBorangK,
		...
		try {
			...
			r.add("ID_PERMOHONAN", idPermohonan);
			r.add("ID_HAKMILIKAGENSI", idHakmilikAgensi);// ID GERAN

	...
	public void setMaklumatPermohonan(String idFail, String initiateFlagBuka,HttpSession session) 
		...
		try {
			...
			sql = "SELECT FAIL.ID_FAIL, FAIL.NO_FAIL, FAIL.NO_FAIL_NEGERI, FAIL.TAJUK_FAIL, MOHON.ID_PERMOHONAN, MOHON.TARIKH_TERIMA, MOHON.TARIKH_SURAT, MOHON.NO_RUJ_SURAT,"
					...
					+ ", MOHONSEWA.ID_PHPPERMOHONANSEWA, MOHONSEWA.FLAG_SEBAB_TAMAT, MOHONSEWA.FLAG_TEMPOHSEWA, MOHON.NO_PERMOHONAN "
			...
			if (rs.next()) {
				...
				h.put("noFailOnline", rs.getString("NO_PERMOHONAN") == null ? "" : rs

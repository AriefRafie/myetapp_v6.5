...
public class FrmPYWSenaraiFailHQData {
	...
	public void carianFail(String noFail, String namaPemohon,
			...
			String noPegangan, String idStatus) throws Exception {
		...
		try {
			...
			sql = "SELECT A.ID_FAIL, B.ID_PERMOHONAN, A.NO_FAIL, B.TARIKH_TERIMA, C.NAMA, D.KETERANGAN, B.ID_STATUS, B.NO_SAMBUNGAN, A.TARIKH_DAFTAR_FAIL, G.USER_NAME"
					+ " FROM TBLPFDFAIL A, TBLPERMOHONAN B, TBLPHPPEMOHON C, TBLRUJSTATUS D, TBLPHPHAKMILIKPERMOHONAN E, TBLPHPHAKMILIK F, USERS G"
					...
					+ " AND A.ID_MASUK = G.USER_ID(+)"
					+ " AND E.FLAG_HAKMILIK = 'U' AND A.ID_NEGERI_BUKAFAIL = 16";

 ...
 * 
 */
public class FrmCRBSenaraiMesyuaratData {
	...
	private static final Log myLog = LogFactory.getLog(FrmCRBSenaraiMesyuaratData.class);
...
//			}
	...
	public void sendEmailMesyuarat(String idMesyuarat,String emel, HttpSession session) throws Exception {
		...
		try {
			...
			email.SUBJECT = "NOTIS PANGGILAN MESYUARAT PERMOHONAN PENGUATKUASA";
			email.MESSAGE = body;
			email.sendEmail();

...
public class FrmPYWPopupSenaraiTanahData {
	...
	public void carianTanah(String idJenisTanah, String peganganHakmilik,
		...
		try {
			...
			System.out.println("cek CARIAN PENYEWAAN: " + sql);
	...
	public void setMaklumatTanah(String idHakmilikAgensi,
		...
		try {
			...
			sql = sql
					...
					+ " RUJLOT.KOD_LOT, RUJLOT.KETERANGAN AS JENIS_LOT, HMS.NO_LOT, HMS.NO_WARTA, HMS.KEGUNAAN_TANAH, HMS.LUAS AS LUAS_BERSAMAAN, HMS.ID_LUAS AS ID_LUAS_BERSAMAAN, HMS.TARIKH_WARTA, RUJMUKIM.NAMA_MUKIM, RUJDAERAH.NAMA_DAERAH, RUJNEGERI.NAMA_NEGERI,"

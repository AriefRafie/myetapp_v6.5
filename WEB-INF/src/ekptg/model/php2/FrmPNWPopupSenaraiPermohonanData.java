...
public class FrmPNWPopupSenaraiPermohonanData {
	...
	public void carianFail(String noFail, String namaPemohon) throws Exception {
		...
		try {
			...
			+ " AND A.ID_FAIL IS NOT NULL AND A.ID_SEKSYEN = 4 AND A.ID_URUSAN = '6' AND A.ID_SUBURUSAN = '32' AND B.ID_STATUS = '1610201' " 

...
public class FrmCRBPopupSenaraiTanahData {
	...
	public void carianTanah(String idJenisTanah, String peganganHakmilik,
			...
			String idAgensi,String role, String id_negeri_user) throws Exception {
		...
		try {
			...
			if(role.equals("(PHP)UserPenguatkuasaanNegeri"))
			{
				if(!id_negeri_user.equals("16"))
				{
					sql += " AND A.ID_NEGERI = '"+id_negeri_user+"' ";
				}
			}
			...
			if(role.equals("(PHP)PenolongPegawaiTanahNegeri") || role.equals("(PHP)PenolongPengarahNegeri") || role.equals("(PHP)PengarahNegeri"))
			{
				if(!id_negeri_user.equals("16"))
				{
					sql += " AND A.ID_NEGERI = '"+id_negeri_user+"' ";
	...
	public void setMaklumatTanah(String idHakmilikAgensi,
		...
		try {
			...
			sql = sql + " UNION";
			sql = sql
					+ " SELECT NULL AS ID_HAKMILIKAGENSI, NULL AS ID_HAKMILIK, HMS.ID_HAKMILIKSEMENTARA, HMS.PEGANGAN_HAKMILIK, RUJJENISHM.KOD_JENIS_HAKMILIK, "
					+ " RUJJENISHM.KETERANGAN AS JENIS_HAKMILIK, HMS.NO_HAKMILIK, RUJLOT.KOD_LOT, RUJLOT.KETERANGAN AS JENIS_LOT, HMS.NO_LOT, HMS.NO_WARTA, HMS.KEGUNAAN_TANAH,"
					+ " HMS.LUAS AS LUAS_BERSAMAAN, HMS.ID_LUAS AS ID_LUAS_BERSAMAAN, HMS.TARIKH_WARTA, RUJMUKIM.NAMA_MUKIM, RUJDAERAH.NAMA_DAERAH, RUJNEGERI.NAMA_NEGERI,"
					+ " RUJSUBKATEGORI.KETERANGAN AS SUBKATEGORI, RUJKATEGORI.KETERANGAN AS KATEGORI, HMS.SYARAT, HMS.SEKATAN, RUJKEMENTERIAN.NAMA_KEMENTERIAN, +"
					+ " RUJAGENSI.NAMA_AGENSI, RUJLUAS.KOD_LUAS, RUJLUAS.KETERANGAN AS JENIS_LUAS_BERSAMAAN"

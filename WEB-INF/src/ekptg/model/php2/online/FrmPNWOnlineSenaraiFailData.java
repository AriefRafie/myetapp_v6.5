...
public class FrmPNWOnlineSenaraiFailData {
	...
	public void carianFail(String userId, String userRole, String noFail,String noPermohonan,String tarikhPermohonan, String idNegeriC,
...
//				+ " AND A.ID_MASUK = H.USER_ID(+) AND A.ID_MASUK ='" + userId + "' ";
			...
			sql = "SELECT A.ID_FAIL, B.ID_PERMOHONAN, A.NO_FAIL, B.TARIKH_TERIMA, C.NAMA, D.KETERANGAN, B.ID_STATUS, H.USER_LOGIN,B.NO_PERMOHONAN "
				...
				+ " AND C.ID_KEMENTERIAN = I.ID_KEMENTERIAN AND H.USER_ID = '" + userId + "'";				
	...
	public void setMaklumatPermohonan(String idFail) throws Exception {
		...
		try {
			...
			sql = "SELECT A.ID_FAIL, A.NO_FAIL, B.ID_PERMOHONAN, B.NO_PERMOHONAN, B.ID_PEMOHON"
	...
	public String getIdHakmilikAgensiByPeganganHakmilik(String idKementerian, String idAgensi, String peganganHakmilik ) throws Exception {
		Db db = null;
		String sql = "";
		...
		try {
			...
			Statement stmt = db.getStatement();
				...
				sql = "SELECT TBLHTPHAKMILIKAGENSI.ID_HAKMILIKAGENSI FROM TBLHTPHAKMILIK, TBLHTPHAKMILIKAGENSI WHERE TBLHTPHAKMILIK.ID_HAKMILIK = TBLHTPHAKMILIKAGENSI.ID_HAKMILIK"
					+ " AND UPPER(TBLHTPHAKMILIK.PEGANGAN_HAKMILIK) = '" + peganganHakmilik.toUpperCase() + "' AND TBLHTPHAKMILIKAGENSI.ID_KEMENTERIAN = '" + idKementerian + "'";

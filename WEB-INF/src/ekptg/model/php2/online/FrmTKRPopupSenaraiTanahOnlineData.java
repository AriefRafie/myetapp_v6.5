 ...
 *
 */
public class FrmTKRPopupSenaraiTanahOnlineData {
	...
	public void carianTanah(String idJenisTanah, String peganganHakmilik, String jenisHakmilik, String noHakmilik, String jenisLot,
			String lot, String noWarta, String tarikhWarta, String idNegeri, String idDaerah, String idMukim, String idKementerian, String idAgensi, String idAgensiPemohon) throws Exception {
		...
		try {
			...
			//idAgensiPemohon
			if (idAgensiPemohon != null) {
				if (!idAgensiPemohon.trim().equals("") && !idAgensiPemohon.trim().equals("99999")) {
					sql = sql + " AND F.ID_AGENSI != '" + idAgensiPemohon.trim().toUpperCase() + "'";
				}
			}
	...
	public void setMaklumatAgensi(String idAgensi) throws Exception {
		...
		try {
			...
			sql = "SELECT B.NAMA_KEMENTERIAN, A.NAMA_AGENSI FROM TBLRUJAGENSI A, TBLRUJKEMENTERIAN B WHERE A.ID_KEMENTERIAN = B.ID_KEMENTERIAN AND A.ID_AGENSI = '" + idAgensi + "'";

...
public class FrmCRBKutipanData {
	...
	public String daftarBaru(String idJenisTanah, String noFail, String tarikhTerima,
		...
		try {
			...
			r.add("NO_FAIL", noFail.trim());
			r.add("NO_FAIL_ROOT", noFail.trim());
	...
	public boolean checkingExistNoFail(String noFail) throws Exception {
		...
		try {
			...
			sql = "SELECT ID_FAIL FROM TBLPFDFAIL WHERE ID_SEKSYEN = '4' AND ID_URUSAN = '8' "
					+ " AND ID_SUBURUSAN = '56' AND UPPER(NO_FAIL) = UPPER('"
					+ noFail.trim() + "')";

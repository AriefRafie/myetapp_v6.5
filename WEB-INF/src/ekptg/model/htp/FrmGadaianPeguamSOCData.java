...
public class FrmGadaianPeguamSOCData {
	...
	private static Logger log = Logger.getLogger(FrmGadaianPeguamSOCData.class);
	...
	public static void setListHeader(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      log.info("FrmGadaianPeguamSOCData::setListHeader = "+sql);
	      ...
	      while (rs.next()) {
	    	...
	    	//log.info("FrmGadaianPeguamSOCData::setListHeader::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null){
	    	  db.close();
	...
	public static Vector getListHeader(){
		  log.info("FrmGadaianPeguamSOCData::getListHeader: "+ listHeader.size());
		  return listHeader;
	  }
	...
	public static void setListContent(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      ResultSet rs = stmt.executeQuery(sql);
	      log.info("FrmGadaianPeguamSOCData::setListContent = "+sql);
	      //Vector list = new Vector();
	      Hashtable h;
	      ...
	      while (rs.next()) {
	    	...
	    	log.info("FrmGadaianPeguamSOCData::setListContent::Exception = "+ex);
	    } finally {
	      if (db != null) db.close();
	    }
	}
	...
	public static Vector getListContent(){
		  log.info("FrmGadaianPeguamSOCData::getListContent:: " +listContent.size());
		  return listContent;
	  }
	...
	public static void setListHakmilik(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      ResultSet rs = stmt.executeQuery(sql);
	      log.info("FrmGadaianPeguamSOCData::setListHakmilik = "+sql);
	      //Vector list = new Vector();
	      Hashtable h;
	      ...
	      while (rs.next()) {
	    	...
	    	log.info("FrmGadaianPeguamSOCData::setListHakmilik::Exception = "+ex);
	    } finally {
	      if (db != null) db.close();
	    }
	}
	...
	public static Vector getListHakmilik(){
		  log.info("FrmGadaianPeguamSOCData::getListHakmilik:: "+listHakmilik.size());
		  return listHakmilik;
	  }
	...
	public static Vector getListFooter(){
		  log.info("FrmGadaianPeguamSOCData::getListFooter: "+ listFooter.size());
		  return listFooter;
	  }

...
public class FrmGadaianPeminjamSOCData {
	...
	private static Logger log = Logger.getLogger(FrmGadaianPeminjamSOCData.class);
	...
	public static void setListHeader(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      log.info("FrmGadaianPeminjamSOCData::setListHeader = "+sql);
	...
	public static Vector getListHeader(){
		  log.info("FrmGadaianPeminjamSOCData::getListHeader: " + listHeader.size());
		  return listHeader;
	  }
	...
	public static void setListContent(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      ResultSet rs = stmt.executeQuery(sql);
	      log.info("FrmGadaianPeminjamSOCData::setListContent = "+sql);
	      //Vector list = new Vector();
	      Hashtable h;
	      ...
	      while (rs.next()) {
	    	...
	    	//System.out.println("FrmGadaianPeminjamSOCData::setListContent::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null){
	    	  db.close();
	...
	public static Vector getListContent(){
		  log.info("FrmGadaianPeminjamSOCData::getListContent:" +listContent.size());
		  return listContent;
	  }
	...
	public static void setListHakmilik(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      ResultSet rs = stmt.executeQuery(sql);
	      log.info("FrmGadaianPeminjamSOCData::setListHakmilik = "+sql);
	      //Vector list = new Vector();
	      Hashtable h;
	      ...
	      while (rs.next()) {
	    	...
	    	//System.out.println("FrmGadaianPeminjamSOCData::setListHakmilik::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null){
	    	  db.close();
	...
	public static Vector getListHakmilik(){
		  log.info("FrmGadaianPeminjamSOCData::getLisHakmilik:" +listHakmilik.size());
		  return listHakmilik;
	  }
	...
	public static Vector getListFooter(){
		  log.info("FrmGadaianPeminjamSOCData::getListFooter:" + listFooter.size());
		  return listFooter;
	  }
}

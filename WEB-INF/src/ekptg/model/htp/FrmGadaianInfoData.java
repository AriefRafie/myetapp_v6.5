...
public class FrmGadaianInfoData {
	private static SimpleDateFormat Format =  new SimpleDateFormat("dd/MM/yyyy");
	
	public static Vector<Hashtable<String,String>> getSemak(String id)throws Exception {
	    Db db = null;
	    ...
	    try {
	      ...
	      //System.out.println("sql permohonan-- :"+sql);
	      
	      Hashtable<String,String> h;
	      while (rs.next()) {
	    	  h = new Hashtable<String,String>();
	    	  h.put("idPermohonan", String.valueOf(rs.getString("id_Permohonan")));

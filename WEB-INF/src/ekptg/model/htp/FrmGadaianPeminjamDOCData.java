...
public class FrmGadaianPeminjamDOCData {
	...
	private static Logger log = Logger.getLogger(FrmGadaianPeminjamDOCData.class);
	...
	public static void setListHeader(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      log.info("FrmGadaianPeminjamDOCData::setListHeader = "+sql);
	      ...
	      while (rs.next()) {
	    	...
	    	//System.out.println("FrmGadaianPeminjamDOCData::setListHeader::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null){
	    	  db.close();
	...
	public static Vector getListHeader(){
		  log.info("FrmGadaianPeminjamDOCData::getListHeader: " + listHeader.size());
		  return listHeader;
	  }
	...
	public static void setListContent(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      sql = r.getSQLSelect("Tblpermohonan P, Tblpfdfail f, Tblhtphakmilikurusan urus, Tblhtppihakberkepentingan pihak, Tblhtpbebanan beban, Tblrujkementerian kem, Tblrujnegeri n");
	      ResultSet rs = stmt.executeQuery(sql);
	      log.info("FrmGadaianPeminjamDOCData::setListContent = "+sql);
	      //Vector list = new Vector();
	      Hashtable h;
	      ...
	      while (rs.next()) {
	    	...
	    	//System.out.println("FrmGadaianPeminjamDOCData::setListContent::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null) {
	    	  db.close();
	...
	public static Vector getListContent(){
		  log.info("FrmGadaianPeminjamDOCData::getListContent: " + listContent.size());
		  return listContent;
	  }
	...
	public static void setListHakmilik(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      ResultSet rs = stmt.executeQuery(sql);
	      log.info("FrmGadaianPeminjamDOCData::setListHakmilik = "+sql);
	      //Vector list = new Vector();
	      Hashtable h;
	      ...
	      while (rs.next()) {
	    	...
	    	//System.out.println("FrmGadaianPeminjamDOCData::setListHakmilik::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null){
	    	  db.close();
	...
	public static Vector getListHakmilik(){
		  log.info("FrmGadaianPeminjamDOCData::getListHakmilik: " + listHakmilik.size());
		  return listHakmilik;
	  }
	...
	public static void setListFooter(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      ResultSet rs = stmt.executeQuery(sql);
	      log.info("FrmGadaianPeminjamDOCData::setListFooter = "+sql);
	      //Vector list = new Vector();
	      Hashtable h;
	      ...
	      while (rs.next()) {
	    	...
	    	//System.out.println("FrmGadaianPeminjamDOCData::setListFooter::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null) db.close();
	    }
	...
	public static Vector getListFooter(){
		  log.info("FrmGadaianPeminjamDOCData::getListFooter" + listFooter.size());
		  return listFooter;
	  }

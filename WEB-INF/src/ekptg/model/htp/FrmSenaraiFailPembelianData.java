...
public class FrmSenaraiFailPembelianData {
	private static Vector list = new Vector();
	private static Logger log = Logger.getLogger(FrmSenaraiFailPembelianData.class);
...
//	      sql = "SELECT distinct f.id_Fail, f.no_Fail, f.tajuk_Fail, s.keterangan, n.nama_Negeri, n.kod_Mampu ";
	      ...
	      r.add("f.id_Urusan","108");
	      r.add("sf.aktif","1");

	      sql = r.getSQLSelect("Tblpermohonan p, Tblpfdfail f,Tblrujsuburusanstatusfail sf,Tblrujsuburusanstatus us,Tblrujstatus s, Tblrujnegeri n");
	      */
	  ...
	  public static Vector getList(){
		  log.info("FrmSenaraiFailPembelianData: getList: " +list.size());
		  return list;
	  }
	  
		public static Vector getSenaraiFail(String carian, String noFail, Long idNegeri)throws Exception {
		    Db db = null;
		    list.clear();
		    String sql = "";
		    String Like = "";

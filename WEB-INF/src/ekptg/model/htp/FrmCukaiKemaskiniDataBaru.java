...
public class FrmCukaiKemaskiniDataBaru{
	...
	private static Logger myLog = Logger.getLogger(ekptg.model.htp.FrmCukaiKemaskiniDataBaru.class);
...
//		System.out.println("YEAR :: " +TBF);
	    ...
	    try{
	    	...
	    	myLog.info("FrmGadaianSemakanData::Insert::tblhtpcukaitemp = "+sql);
	...
	public static String SimpanDataManual(Hashtable data) throws Exception{		
	    ...
	    try{
    		...
    		rJM.add("id_mukim",idMukim2);
	  		...
	  		r.add("cukai_kena_bayar", JumBayaran);
	  		r.add("cukai_perlu_bayar", Tahunan);

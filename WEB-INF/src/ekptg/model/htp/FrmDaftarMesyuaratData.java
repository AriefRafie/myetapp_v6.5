...
public class FrmDaftarMesyuaratData {
	...
	static Logger myLog = Logger.getLogger(FrmDaftarMesyuaratData.class);
public static void  setCarianMesyuarat(String tajukMesyuarat, String tarikhMesyuarat, String seksyen, String lokasi)throws Exception {
	    ...
	    try {
	      ...
	      myLog.info("setCarianMesyuarat:sql::"+sql);
	      ...
	      while (rs.next()) {
	    	  ...
	    	  h.put("tarikh_Mesyuarat",sdf.format(rs.getDate("TARIKH_MESYUARAT")));

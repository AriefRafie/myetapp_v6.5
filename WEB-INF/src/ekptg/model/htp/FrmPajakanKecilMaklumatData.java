...
public class FrmPajakanKecilMaklumatData {
	
	static Logger log = Logger.getLogger(FrmPajakanKecilMaklumatData.class);
	  ...
	  public static void add(Tblhtphakmilikbangunan s,String tmula,String ttamat ) throws Exception {
		  ...
		  try {
		      ...
		      sql =" INSERT INTO TBLHTPHAKMILIKBANGUNAN " +
			  		...
			  		"TARIKH_MASUK, ID_KEMASKINI, " +
			  		"TARIKH_KEMASKINI, ID_DB,TAHUN,BULAN ) " +
			  		"VALUES  " +
			  		...
			  		"TO_DATE('"+strTarikhSemasa+"','yyyy-mm-dd hh24:mi:ss'), "+s.getIdMasuk()+","+s.getTahun()+","+s.getBulan()+")";

...
//		    		  lampiran = "X";
	...
	public Vector<Hashtable<String,String>> getSenaraiSemakanAttach2(String kodForm,String idPermohonan)
			throws Exception {
			//public Vector<Hashtable<String,String>> getSenaraiSemakanAttach(String kodForm) throws Exception {
			Vector<Hashtable<String,String>> list = new Vector<Hashtable<String,String>>();
//	        myLog.info("getSenaraiSemakanAttach :kodForm= " + kodForm.substring(0,3));
			    ...
			    try {
			      ...
			      while (rs.next()) {
			    	  ...
			    	  h.put("flag", rs.getString("flag"));
			    	  if(!rs.getString("jenis_dokumen").equals("0")) {
			    		  lampiran = setLampiran2(kodForm.substring(0,3),idPermohonan,rs.getString("id_semakansenarai"),rs.getString("jenis_dokumen"));
//			    		  lampiran = "X";
			    	  }else {
			    		  lampiran = "";
			    	  }
...
//			sb.append("</a>");
	...
	private String setLampiran2(String modul,String rujukan,String idSenarai,String jenisDokumen) throws Exception {
		StringBuffer sb = new StringBuffer("");
//		myLog.info("setLampiran:mode="+mode);
//		myLog.info("setLampiran:modul="+modul);
		if(modul.equals("php"))

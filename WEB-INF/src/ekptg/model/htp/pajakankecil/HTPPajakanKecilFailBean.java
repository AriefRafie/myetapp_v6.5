package ekptg.model.htp.pajakankecil;
...
public class HTPPajakanKecilFailBean implements IHTPFail{
	
 	private IHtp iHTP = null;  
	private static Logger myLog = Logger.getLogger(ekptg.model.htp.pajakankecil.HTPPajakanKecilFailBean.class);
	    ...
	    try {
	      ...
	      if (id_daerah != null && !"-1".equals(id_daerah) && !"".equals(id_daerah)) {
	    	  sql = sql + "AND P.ID_PERMOHONAN IN "+ 
	    	  	...
	    	  	" WHERE TPHUI.ID_DAERAH='"+id_daerah+"'"+
	    	  	" ) ";
	      }	      
	      if (id_mukim != null && !"-1".equals(id_mukim) && !"".equals(id_mukim)) {
	    	  sql = sql + "AND P.ID_PERMOHONAN IN "+ 
	      ...
	      myLog.info("getSenaraiFail:isSearch="+isSearch);
	      if (isSearch==true) {
	    	  sql = sql + " AND ROWNUM <= 50 ";
	      }	      
	      //sql = sql + "ORDER BY  f.id_kemaskini DESC";
	...
	@Override
	public void XkemaskiniMaklumatAsasTanah(Hashtable data) throws Exception{			
	...
	@Override
	public String XkemaskiniMaklumatTanah(Hashtable data) throws Exception{			
		Connection conn = null;
		Db db = null;
	    String sql = "";
	    String returnValue = "";
	...
	@Override
	public void XsimpanMaklumatAsasTanah(Hashtable data) throws Exception{	
		Connection conn = null;
		Db db = null;
	    String sql = "";
		ResultSet rs = null;
	...
	@Override
	public String XsimpanMaklumatTanah(Hashtable data) throws Exception{	
		Connection conn = null;
		Db db = null;
	    String sql = "";
		ResultSet rs = null;
	...
	@Override
	public Hashtable XgetMaklumatAsasTanahKemaskini(String idhakmilikurusan)throws Exception {
	...
	@Override
	public Hashtable getMaklumatPermohonan(String idFail) throws Exception {
		Db db = null;
		String sql = "";
		Hashtable h = null;
		try {
	...
	@Override
	public Vector getMaklumatPermohonans(String idFail) throws Exception {
		Db db = null;
		String sql = "";
		Hashtable h = null;
	...
	public HtpPermohonan findPermohonan(String idFail, String idPermohonan,String idHtpPermohonan) 
		...
		try {
			...
			sql = "SELECT A.ID_FAIL, A.NO_FAIL, A.TAJUK_FAIL, A.ID_URUSAN" +
					...
					",B.TARIKH_TERIMA, B.ID_PERMOHONAN,B.TARIKH_SURAT" +

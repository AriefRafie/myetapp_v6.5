...
public class FrmPajakanKecilSenaraiPermohonanData {

	static Logger myLog = Logger.getLogger(ekptg.model.htp.FrmPajakanKecilSenaraiPermohonanData.class);
	    ...
	    try {
		  ...
		  */
	      sql= "SELECT p.id_Permohonan, f.no_Fail, UPPER(p.tujuan) TUJUAN, s.keterangan,RN.NAMA_NEGERI "+
	      	...
	      	" AND f.id_Urusan =309 AND p.id_Fail ="+fail+" " +

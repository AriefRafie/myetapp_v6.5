...
public class HTPBayaranBean implements IHTPBayaran {
//	private static final String KOD_JABATAN ="JKPTG";
	private static Logger myLog = Logger.getLogger(ekptg.model.htp.HTPBayaranBean.class);
	...
	public Bayaran getPembayaranByPermohonan(String idPermohonan)throws Exception {
		...
		try{
		    ...
		    sql = " select TPB.id_bayaran,TPB.jumlah_bayaran" +
		  		" ,TPB.nama_bank,TPB.id_carabayar" +
		  		" ,(" +
		  		"	select keterangan from tblrujcarabayar where id_carabayar= TPB.id_carabayar" +
		  		"	) cara_bayar "+
		  		" ,TPB.no_baucer,TPB.tarikh_baucer,TPB.tarikh_terima" +
		  		" ,TPB.no_resit,TPB.tarikh_resit from tblhtpbayaran TPB where TPB.id_jenisbayaran = 20 " +

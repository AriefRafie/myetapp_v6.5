...
public class FrmGadaianPeguamDOCData {
	...
	private static Logger log = Logger.getLogger(FrmGadaianPeguamDOCData.class);
	...
	public static void setListHeader(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      log.info("FrmGadaianPeguamDOCData::setListHeader = "+sql);
	      ...
	      while (rs.next()) {
	    	...
	    	//System.out.println("FrmGadaianPeguamDOCData::setListHeader::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null) {
	    	  db.close();
	...
	public static Vector getListHeader(){
		  log.info("FrmGadaianPeguamDOCData::getListHeader:" + listHeader.size());
		  return listHeader;
	  }
	...
	public static void setListContent(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      ResultSet rs = stmt.executeQuery(sql);
	      log.info("FrmGadaianPeguamDOCData::setListContent = "+sql);
	      //Vector list = new Vector();
	      Hashtable h;
	      ...
	      while (rs.next()) {
	    	...
	    	//System.out.println("FrmGadaianPeguamDOCData::setListContent::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null) {
	    	  db.close();
	...
	public static Vector getListContent(){
		  log.info("FrmGadaianPeguamDOCData::getListContent: " + listContent.size());
		  return listContent;
	  }
	...
	public static void setListHakmilik(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      ResultSet rs = stmt.executeQuery(sql);
	      log.info("FrmGadaianPeguamDOCData::setListHakmilik = "+sql);
	      //Vector list = new Vector();
	      Hashtable h;
	      ...
	      while (rs.next()) {
	    	...
	    	//System.out.println("FrmGadaianPeguamDOCData::setListHakmilik::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null) {
	    	  db.close();
	...
	public static Vector getListHakmilik(){
		  log.info("FrmGadaianPeguamDOCData::getListHakmilik: " + listHakmilik.size());
		  return listHakmilik;
	  }
	...
	public static void setListFooter(int idPermohonan)throws Exception {
	    ...
	    try {
	      ...
	      ResultSet rs = stmt.executeQuery(sql);
	      System.out.println("FrmGadaianPeguamMOCData::setListFooter = "+sql);
	      //Vector list = new Vector();
	      Hashtable h;
	      ...
	      while (rs.next()) {
	    	...
	    	//System.out.println("FrmGadaianPeguamDOCData::setListFooter::Exception = "+ex);
	    	ex.printStackTrace();
	    } finally {
	      if (db != null) db.close();
	    }
	...
	public static Vector getListFooter(){
		  log.info("FrmGadaianPeguamDOCData::getListFooter: " + listFooter.size());
		  return listFooter;
	  }
}

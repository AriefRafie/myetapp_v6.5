...
public class HTPEmelBean extends EkptgCache implements IHTPEmel {
	...
	public String setEmailSign(String noFail,String tajuk,String dari){		
		...
		bff.append("<br/>");
		bff.append("<br/>");		  
		bff.append("Permohonan Tuan/Puan bagi <b>"+tajuk+"</b> telah diterima dan nombor fail adalah seperti berikut <b>"+noFail+"</b>.");
		bff.append("<br/>");
		bff.append("<br/>");
...
//		bff.append("<br/>");
//		bff.append("<br/>");		  
//		bff.append("Permohonan  bagi <b>"+tajuk+"</b> telah dihantar dan nombor rujukan adalah seperti berikut <b>"+noFail+"</b>.");
//		bff.append("<br/>");
//		bff.append("<br/>");
//		bff.append("Sila <i>login</i> ke <a href=\"http://www.etapp.gov.my\" >www.etapp.gov.my</a> untuk semakan selanjutnya.");
//		bff.append("<br/>");

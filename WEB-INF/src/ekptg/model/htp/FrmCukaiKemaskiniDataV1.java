...
public class FrmCukaiKemaskiniDataV1 {
	
	private static SimpleDateFormat Format =  new SimpleDateFormat("dd/MM/yyyy");
	static Logger mylog = Logger.getLogger(ekptg.model.htp.FrmCukaiKemaskiniDataV1.class);
	...
	public static int update(Hashtable data) throws Exception {
		...
		try{
			...
			if(idHC==0){
				int idHC_old = (Integer)data.get("idHC");
					...
					sql = r.getSQLInsert("Tblhtphakmilikcukai");
					mylog.info("FrmCukaiKemaskiniData::Insert::Tblhtphakmilikcukai = "+sql);
				    stmt.executeUpdate(sql);
				    return (int)idHakmilikCukai;
 	...
 	public static Vector getList(Long noHakmilik, Long idJenisHakmilik,
	...
	public static Hashtable getListKCukaiViewV1(String idHakmilikCukai)throws Exception {
 	    Db db = null;
 	    String sql = "";
	    ...
	    if (idMukim == 0){
 	    ...
 	    try {
 	      ...
 	      Statement stmt = db.getStatement();
 	      	...
 	      	sql +=	" tpf.no_fail,  thh.no_fail_ptg, thh.tarikh_daftar, thh.id_luas, thh.id_lot, thh.luas, ";
 	      	sql +=	" thhc.tarikh_masuk, thhc.cukai_terkini, thhc.cukai_taliair, thhc.cukai_parit,  thhc.denda,thhc.bayaran_lain, ";
 	      	sql +=	" thh.no_lot, thhc.id_hakmilikcukai, thh.id_hakmilik, thhc.STATUS_TERKINI,  NVL(thhc.cukai,0) CUKAI, ";
 	      	sql +=	" thhc.pengecualian, thhc.pengurangan, thhp.kegunaan_tanah, tru.nama_urusan, thpajak.kategori_cukai, ";
 	      	sql +=	" thhc.pengecualian, thhc.pengurangan, tru.nama_urusan "; 	      	
 	      	sql +=" FROM tblhtphakmilik thh, tblhtphakmilikcukai thhc, ";
 	      	sql +=	" tblpermohonan tp, tblpfdfail tpf, tblrujurusan tru,tblhtppajakan thpajak, ";
 	      	sql +=	" tblpermohonan tp, tblpfdfail tpf, tblrujurusan tru";

...
public class FrmPrmhnnStatusPengunaOnlineData {
	...
	/** 2017/10/03 aishahidris tambah untuk list baru deraf  */
	public static Vector<Hashtable<String,String>>  getSenaraiTugasanDraf(String search,String idMasuk,String role,String kppemohon,String kpsimati,String flag_draff)throws Exception {	
	    Db db = null;
	    String sql = "";
//	    Format formatter = new SimpleDateFormat("dd/MM/yyyy h:MM:ss a");
	    try {
	      ...
	      sql = " SELECT DISTINCT F.ID_MASUK, TO_CHAR (P.TARIKH_MOHON, 'DD/MM/YYYY') AS TARIKH_MOHON, " +
	      		...
	      		" AND P.NO_PERMOHONAN_ONLINE IS NULL "+
	      		" AND P.ID_STATUS IN ('150', '160','270') " +
	      		" AND UO.USER_ID = '"+idMasuk+"' " +
	      		" ORDER BY TARIKH_MOHON, TARIKH_MOHON_ONLINE, TARIKH_MASUK DESC ";
	      myLogger.info("SQL LIST DRAF:sql="+sql.toUpperCase());
	      ResultSet rs = stmt.executeQuery(sql);

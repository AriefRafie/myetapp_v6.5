...
//			SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
	...
	public static void setmaklumatSimati(String kpbarux, String kplamax,
		...
		try {
			...
			sql = "SELECT DISTINCT P.NO_PERMOHONAN_ONLINE, PEJ.ID_SEKSYEN,PEJ.ID_JENISPEJABAT,UR.ID_DAERAHURUS,UR.ID_PEJABATURUSAN, PEJ.ID_PEJABATJKPTG, P.ID_PERMOHONAN, " 
					+ "F.NO_FAIL" 
					+ "SM.NAMA_SIMATI, SM.NO_KP_BARU, "
	...
	public static void setmaklumatSimati_17(String kpbarux, String kplamax,
		...
		try {
			...
			sql = "SELECT DISTINCT P.NO_PERMOHONAN_ONLINE, PEJ.ID_SEKSYEN,PEJ.ID_JENISPEJABAT,UR.ID_DAERAHURUS,UR.ID_PEJABATURUSAN, PEJ.ID_PEJABATJKPTG, P.ID_PERMOHONAN,F.NO_FAIL, " 					
					+ "SM.NAMA_SIMATI, SM.NO_KP_BARU, "
					+ "SM.NO_KP_LAMA,SM.NO_KP_LAIN, SM.JENIS_KP, D.NAMA_DAERAH, N.NAMA_NEGERI, PEJ.NAMA_PEJABAT, "
			...
			if (!kpbaru.equals("") && kpbaru.length() != 0) {
				...
				sql += " AND UPPER(F.NO_FAIL) LIKE UPPER('" + no_fail + "')";
			}
	...
	public static void setmaklumatSimati_WithoutNoFail_17(String kpbarux,
		...
		try {
			...
			sql = "SELECT DISTINCT P.NO_PERMOHONAN_ONLINE,P.ID_PERMOHONAN,F.NO_FAIL,  " 				
					+ "SM.NAMA_SIMATI, SM.NO_KP_BARU, "

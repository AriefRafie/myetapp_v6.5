...
//		    	int idsimati=(Integer)data.get("idSimati");
...
//			  
//			    	int idsimati=(Integer)data.get("idSimati");
//			    	int idob=(Integer)data.get("idsaksi");
//			    	String namaob= (String)data.get("namaOB");
//			    	String notel= (String)data.get("notel");
//			    	
//			    	
...
//		  
//
//			 public static void updateNilaiHartaBaruHta(String id,String NilaiMohon, String NilaiMati, String idSimati, String idPermohonan) throws Exception {
//				    Db db = null;
//				    String sql = "";
//
//				    try
...
//				  }
//			 
//			 public static void updateNilaiHartaBaruHa(String id,String NilaiMohon, String NilaiMati, String idSimati, String idPermohonan) throws Exception {
//				    Db db = null;
//				    String sql = "";
//				    String sql2 = "";
//				    try
...
//					      r2.add("JUMLAH_HARTA_TARIKHMATI", JumlahBesarTarikhMati);
...
//				    {
//				      
//				    	int idwaris=(Integer)data.get("idwaris");
//				    	int idsimati=(Integer)data.get("idSimati");
//				    	String namaob= (String)data.get("namaOB");
//				    	
//				    	
...
//					String tarikhlahir_format = "to_date('" + tarikhlahir + "','dd/MM/yyyy')";
//			    	
//			    	int idparent=(Integer)data.get("idparent");
//				    String id_Masuk = (String)data.get("id_Masuk");
//			        String tarikh_Masuk = (String)data.get("tarikh_Masuk");
//					
//			    	
...
//				  r1.add("tarikh_Masuk",tarikh_Masuk);

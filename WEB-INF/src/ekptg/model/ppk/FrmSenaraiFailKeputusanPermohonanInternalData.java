	...
	public static void setData(String id, String uid) throws Exception {
		...
		try {
			...
			sql = "SELECT P.ID_PEJAWAL, P.NO_FAIL_AWAL, P.NAMA_PEMOHON_AWAL,F.ID_FAIL, F.NO_FAIL, D.ID_DAERAH, P.ID_PERMOHONAN, P.TARIKH_MOHON,  S.NO_KP_BARU,"
					...
					+ " PK.TARIKH_TERIMA_NILAIAN, PK.FLAG_SALINAN_ARAHAN, PK.JENIS_BORANGC, PK.KEPUTUSAN_PERMOHONAN, PK.CATATAN, pk.tarikh_suratarb, SUB.ID_SUBURUSANSTATUS, "
			...
			while (rs.next()) {
				...
				h.put("txtSuratAkuanARB",
						rs.getString("TARIKH_SURATARB") == null ? "" : sdf
								.format(rs.getDate("TARIKH_SURATARB")));

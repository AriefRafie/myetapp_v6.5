...
public class FrmPrmhnnSek8SenaraiHTATHOnlineData {
	...
	public void setDataHta(String id) throws Exception{
		...
		try {
			...
			sql = r.getSQLSelect("Tblppkpermohonan p, Tblppkhta hta, Tblrujnegeri n, Tblrujdaerah d, Tblrujmukim m, Tblppksimati sm, Tblppkpermohonansimati ms");

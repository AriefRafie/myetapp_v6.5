...
//backup from svn 02102017
//incase new header problem

public class FrmHeaderPpk_BACKUP {
	
	static Logger myLogger = Logger.getLogger(FrmHeaderPpk.class);	
	//get SUBUURSAN
	///SELECT  C.TARIKH_MASUK,E.KETERANGAN,H.ID_SIMATI, A.SEKSYEN, A.ID_PERMOHONAN, B.NO_FAIL, MAX(C.ID_SUBURUSANSTATUSFAIL) AS ID_SUBURUSANSTATUSFAIL, C.AKTIF, E.ID_STATUS,H.ID_PERMOHONANSIMATI, A.TARIKH_MOHON,B.FLAG_JENIS_FAIL  FROM TBLPPKPERMOHONAN A, TBLPFDFAIL B, TBLRUJSUBURUSANSTATUSFAIL C, TBLRUJSUBURUSANSTATUS D, TBLRUJSTATUS E, TBLRUJNEGERI F, TBLRUJDAERAH G, TBLPPKPERMOHONANSIMATI H WHERE G.ID_DAERAH IN (SELECT DISTINCT U.ID_DAERAHURUS FROM TBLRUJPEJABATURUSAN U, USERS_INTERNAL UR WHERE U.ID_PEJABATJKPTG = UR.ID_PEJABATJKPTG AND UR.USER_ID = '293') AND A.ID_STATUS NOT IN (56,999) AND B.ID_FAIL = A.ID_FAIL AND D.ID_SUBURUSANSTATUS = C.ID_SUBURUSANSTATUS AND E.ID_STATUS = D.ID_STATUS AND A.ID_PERMOHONAN = C.ID_PERMOHONAN AND A.ID_PERMOHONAN = H.ID_PERMOHONAN AND A.ID_NEGERIMHN = F.ID_NEGERI AND A.ID_DAERAHMHN = G.ID_DAERAH AND TRIM(UPPER(B.NO_FAIL)) = 'JKPTG/PK/01/06/0182/2008' GROUP BY C.TARIKH_MASUK,E.KETERANGAN,H.ID_SIMATI, A.SEKSYEN, A.ID_PERMOHONAN, B.NO_FAIL, C.AKTIF, E.ID_STATUS, H.ID_PERMOHONANSIMATI, A.TARIKH_MOHON,B.FLAG_JENIS_FAIL ORDER BY  C.TARIKH_MASUK,ID_SUBURUSANSTATUSFAIL  ASC
	 
	
	//fungsi untuk menanda permohonan yang telah dicreate history
	public static void updatePermohonan(String id_permohonan,Db db) throws Exception
	  {
	    Db db1 = null;
	    String sql = "";
	    try
	...
	public Hashtable getHeaderData(HttpSession session,String id_permohonan,String flag_permohonan,String id_fail,String flag_fail) throws Exception {
		...
		try {
			...
			String current_flag_kebenaran = getFlagKebenaran(id_permohonan,user_id,db);
			String check_expiry = "";
			if(current_flag_kebenaran.equals("1"))
			{
				check_expiry = getDurationKebKemaskini(id_permohonan,user_id,IDFAIL,db);
			...
			/*System.out.println("current_flag_kebenaran ::::::::::::"+current_flag_kebenaran);
			...
			sql1 = " SELECT PSM.ID_PERMOHONANSIMATI,PSM.ID_PERMOHONAN  FROM TBLPPKPERMOHONANSIMATI PSM   "+ 
				" WHERE "+ 
				" PSM.ID_SIMATI = (SELECT ID_SIMATI FROM TBLPPKPERMOHONANSIMATI WHERE ID_PERMOHONAN = '"+id_permohonan+"') AND "+ 
				...
				" FROM TBLPPKPERMOHONAN WHERE ID_STATUS <> '999' AND  ID_PERMOHONAN = '"+id_permohonan+"'))  ";
			...
			while (rs1.next()) {
				tot++;
				String temp_id_permohonan =	rs1.getString("ID_PERMOHONAN") == null ? "" : rs1.getString("ID_PERMOHONAN");
				myLogger.info("--------------------------------###no permohonan :"+tot+":"+temp_id_permohonan);				
			...
			/*
			sql2 = " SELECT HUP.ID_HUBUNGANOB,PSM.ID_PERMOHONANSIMATI  FROM TBLPPKHUBUNGANOB HUP,TBLPPKOB OB,TBLPPKPERMOHONANSIMATI PSM "+  
				...
				" AND ID_SIMATI = (SELECT ID_SIMATI FROM TBLPPKPERMOHONANSIMATI WHERE ID_PERMOHONAN = '"+id_permohonan+"'))";
			...
			while (rs2.next()) {
				tot1++;
				//myLogger.info("###BERAPA KALI BUAT HUBUNGAN:"+tot1);				
				String temp_ID_HUBUNGANOB =	rs2.getString("ID_HUBUNGANOB") == null ? "" : rs2.getString("ID_HUBUNGANOB");
				String temp_ID_PERMOHONANSIMATI = rs2.getString("ID_PERMOHONANSIMATI") == null ? "" : rs2.getString("ID_PERMOHONANSIMATI");
				//myLogger.info("###temp_ID_HUBUNGANOB :"+temp_ID_HUBUNGANOB);
				//myLogger.info("###temp_ID_PERMOHONANSIMATI :"+temp_ID_PERMOHONANSIMATI);				
				//myLogger.info("###recordCount(temp_id_ob,id_permohonan):"+recordCountHubungan(temp_ID_HUBUNGANOB,temp_ID_PERMOHONANSIMATI));			
				if(recordCountHubungan(temp_ID_HUBUNGANOB,temp_ID_PERMOHONANSIMATI) == 0)
				{
				//updateOBPermohonan(id_permohonan,temp_id_ob,user_id);
				updateOBHubunganPermohonan(temp_ID_PERMOHONANSIMATI,temp_ID_HUBUNGANOB,user_id);
				}		
			}*/
			...
			while (rs.next()) {					
				...
				h.put("STATUS_EDIT_USER",getStatusEdit(rs.getString("ID_FAIL") == null ? "" : rs.getString("ID_FAIL"),user_id,db));
	...
	public Hashtable getPemohonData2(HttpSession session,String id_permohonan) throws Exception {
	...
	try {
		...
		while (rs2.next()) {					
			h2.put("ID_PERMOHONANSIMATI",rs2.getString("ID_PERMOHONANSIMATI") == null ? "" : rs2.getString("ID_PERMOHONANSIMATI"));
	...
	//aishahlatip maklumat flag kebanaran Kemaskini
	 ...
	 public static void updateKebKemaskini(String id_permohonan,Db db) throws Exception
	  {
	    Db db1 = null;
	    String sql = "";
	    try
...
//=======
	...
	public String getStatusUnitLuar(String id_permohonan,String user_id,Db db) throws Exception{
		Db db1 = null;
		String sql2 = "";
		try {
			if(db == null)
	...
	public String getHantarLaporanPerintah(String id_permohonan,String user_id,Db db) throws Exception{
		Db db1 = null;
		String sql2 = "";
		try {
			if(db == null)
...
//			myLogger.info("CHECK STATUS UNIT LUAR :"+sql2);
	...
	public String getStatusKemaskini(String id_permohonan,String user_id, String IDFAIL) throws Exception{
		Db db = null;
		String sql2 = "";
		try {
			db = new Db();
	...
	public String getDurationKebKemaskini(String id_permohonan,String user_id, String IDFAIL, Db db) throws Exception{
		Db db1 = null;
		String sql2 = "";
		try {
			if(db == null)
	...
	public Hashtable getPemohonData(HttpSession session,String id_permohonan,Db db) throws Exception {
		Db db1 = null;	
		//Db db2 = null;
		String sql = "";
		String sql1 = "";
		...
		try {
			...
			while (rs.next()) {					
				...
				h.put("WARGA",rs.getString("WARGA") == null ? "" : rs.getString("WARGA"));
	...
	public Hashtable getStatusEdit(String id_fail,String user_id, Db db) throws Exception {
		...
		try {
			...
			" FROM TBLEDITAGIHAN A,USERS U WHERE A.USER_ID = U.USER_ID AND A.ID_FAIL = '"+ id_fail+"' AND A.USER_ID = '"+ user_id+"'  "
			+ " ";		
			...
			while (rs.next()) {
				/*
				int CHECK_EDIT = rs.getInt("CHECK_EDIT") == 0 ? 0 : rs.getInt("CHECK_EDIT");
				
				if(CHECK_EDIT>0)
				{				
					h.put("CHECK_EDIT", "yes");			
				}
				else
				{
					h.put("CHECK_EDIT", "no");	
...
public Hashtable getWujudLot(String id_permohonansimati,String nolot,
		String id_negeri,String id_daerah,String id_mukim,String id_jenishakmilik,String no_hakmilik,String no_lot) throws Exception {
		...
		try {
			...
			while (rs.next()) {
				...
				h.put("NO_STRATA",rs.getString("NO_STRATA") == null ? "" : rs.getString("NO_STRATA"));	
				h.put("MAKLUMAT_TANAH",rs.getString("MAKLUMAT_TANAH") == null ? "" : rs.getString("MAKLUMAT_TANAH"));	
				...
				h.put("STATUS_PEMILIKAN",rs.getString("STATUS_PEMILIKAN") == null ? "" : rs.getString("STATUS_PEMILIKAN"));
				...
				h.put("NAMA_RANCANGAN",rs.getString("NAMA_RANCANGAN") == null ? "" : rs.getString("NAMA_RANCANGAN"));	
				h.put("NO_ROH",rs.getString("NO_ROH") == null ? "" : rs.getString("NO_ROH"));	
				h.put("NO_LOT_ID",rs.getString("NO_LOT_ID") == null ? "" : rs.getString("NO_LOT_ID"));	
				h.put("FLAG_KATEGORI_HTA",rs.getString("FLAG_KATEGORI_HTA") == null ? "" : rs.getString("FLAG_KATEGORI_HTA"));
				h.put("JENIS_KEPENTINGAN",rs.getString("JENIS_KEPENTINGAN") == null ? "" : rs.getString("JENIS_KEPENTINGAN"));	
				h.put("ID_PERMOHONANSIMATI",rs.getString("ID_PERMOHONANSIMATI") == null ? "" : rs.getString("ID_PERMOHONANSIMATI"));	
				h.put("ID_BANDARPEMAJU",rs.getString("ID_BANDARPEMAJU") == null ? "" : rs.getString("ID_BANDARPEMAJU"));	
				...
				h.put("FLAG_SELESAI",rs.getString("FLAG_SELESAI") == null ? "" : rs.getString("FLAG_SELESAI"));	
				h.put("ID_PERINTAHOBMST",rs.getString("ID_PERINTAHOBMST") == null ? "" : rs.getString("ID_PERINTAHOBMST"));	
				...
				h.put("ALAMAT_PEMAJU1",rs.getString("ALAMAT_PEMAJU1") == null ? "" : rs.getString("ALAMAT_PEMAJU1"));	
				h.put("ALAMAT_PEMAJU2",rs.getString("ALAMAT_PEMAJU2") == null ? "" : rs.getString("ALAMAT_PEMAJU2"));	
				h.put("ALAMAT_PEMAJU3",rs.getString("ALAMAT_PEMAJU3") == null ? "" : rs.getString("ALAMAT_PEMAJU3"));	
				h.put("BANDAR_PEMAJU",rs.getString("BANDAR_PEMAJU") == null ? "" : rs.getString("BANDAR_PEMAJU"));	
				h.put("POSKOD_PEMAJU",rs.getString("POSKOD_PEMAJU") == null ? "" : rs.getString("POSKOD_PEMAJU"));
				h.put("ID_NEGERIPEMAJU",rs.getString("ID_NEGERIPEMAJU") == null ? "" : rs.getString("ID_NEGERIPEMAJU"));	
				...
				h.put("LUAS_HMP",rs.getString("LUAS_HMP") == null ? "" : rs.getString("LUAS_HMP"));	
				h.put("NO_CAGARAN",rs.getString("NO_CAGARAN") == null ? "" : rs.getString("NO_CAGARAN"));	
				h.put("NO_PAJAKAN",rs.getString("NO_PAJAKAN") == null ? "" : rs.getString("NO_PAJAKAN"));	
				h.put("JENIS_TNH",rs.getString("JENIS_TNH") == null ? "" : rs.getString("JENIS_TNH"));	
				h.put("ALAMAT_HTA1",rs.getString("ALAMAT_HTA1") == null ? "" : rs.getString("ALAMAT_HTA1"));	
				h.put("ALAMAT_HTA2",rs.getString("ALAMAT_HTA2") == null ? "" : rs.getString("ALAMAT_HTA2"));	
				h.put("ALAMAT_HTA3",rs.getString("ALAMAT_HTA3") == null ? "" : rs.getString("ALAMAT_HTA3"));	
				h.put("BANDAR_HTA",rs.getString("BANDAR_HTA") == null ? "" : rs.getString("BANDAR_HTA"));	
				h.put("POSKOD_HTA",rs.getString("POSKOD_HTA") == null ? "" : rs.getString("POSKOD_HTA"));	
				h.put("TARIKH_PERJANJIAN",rs.getString("TARIKH_PERJANJIAN") == null ? "" : rs.getString("TARIKH_PERJANJIAN"));	
				...
				h.put("NILAI_HTA_TARIKHMOHON",rs.getString("NILAI_HTA_TARIKHMOHON") == null ? "" : rs.getString("NILAI_HTA_TARIKHMOHON"));	
				h.put("NILAI_HTA_TARIKHMATI",rs.getString("NILAI_HTA_TARIKHMATI") == null ? "" : rs.getString("NILAI_HTA_TARIKHMATI"));	
				h.put("ID_KATEGORI",rs.getString("ID_KATEGORI") == null ? "" : rs.getString("ID_KATEGORI"));	
				h.put("ID_JENISHM",rs.getString("ID_JENISHM") == null ? "" : rs.getString("ID_JENISHM"));	
	 	...
	 	public void checkOBPermohonan(String id_permohonan,String user_id,Db db) throws Exception
	 	{ 
	 	Db db1 = null;
	    String sql = "";
	    String sql1 = "";
	    ...
	    {	
	      ...
	      Statement stmt = db1.getStatement();
			...
			" AND NVL(Y.NO_SUBJAKET,'0') <= (SELECT NVL(NO_SUBJAKET,'0') FROM TBLPPKPERMOHONAN WHERE ID_PERMOHONAN = '"+id_permohonan+"'))  ";
			...
			while (rs1.next()) {
				...
				String temp_id_ob =	rs1.getString("ID_OB") == null ? "" : rs1.getString("ID_OB");
				String temp_TARIKH_LAHIR = rs1.getString("TARIKH_LAHIR") == null ? "" : rs1.getString("TARIKH_LAHIR");
				int temp_UMUR =	rs1.getInt("UMUR") == 0 ? 0 : rs1.getInt("UMUR");
				int temp_NO_SUBJAKET=	rs1.getInt("NO_SUBJAKET") == 0 ? 0 : rs1.getInt("NO_SUBJAKET");
				int temp_NO_SUBJAKET_MAX =	rs1.getInt("NO_SUBJAKET_MAX") == 0 ? 0 : rs1.getInt("NO_SUBJAKET_MAX");
				...
				/*
				if(!temp_TARIKH_LAHIR.equals(""))
				{
					if(temp_NO_SUBJAKET == temp_NO_SUBJAKET_MAX)
					{  
						SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
						Date convertedDate = dateFormat.parse(temp_TARIKH_LAHIR); 
						int current_age = getAge(convertedDate); 
						//myLogger.info("########### ID_OB :"+temp_id_ob+"CURRENT UMUR :"+current_age);
						if(current_age != temp_UMUR)
						{
	 	...
	 	public void checkHTAPermohonan(String id_permohonan,String user_id,Db db) throws Exception
	 	{ 
	 	Db db1 = null;
	    String sql = "";
	    String sql1 = "";
	    ...
	    {	
	      ...
	      Statement stmt = db1.getStatement();
			...
			while (rs1.next()) {
				tot++;
				//myLogger.info("###BERAPA KALI BUAT:"+tot);				
				String temp_id_hta =	rs1.getString("ID_HTA") == null ? "" : rs1.getString("ID_HTA");
				int temp_NO_SUBJAKET=	rs1.getInt("NO_SUBJAKET") == 0 ? 0 : rs1.getInt("NO_SUBJAKET");
				int temp_NO_SUBJAKET_MAX =	rs1.getInt("NO_SUBJAKET_MAX") == 0 ? 0 : rs1.getInt("NO_SUBJAKET_MAX");
				//myLogger.info("###temp_id_hta :"+temp_id_hta);
				if(recordCountHTA(temp_id_hta,id_permohonan,db1) == 0)
				{
				updateHTAPermohonan(id_permohonan,temp_id_hta,user_id,db1);
				}
	 	...
	 	public void checkHAPermohonan(String id_permohonan,String user_id,Db db) throws Exception
	 	{ 
	 	Db db1 = null;
	    String sql = "";
	    String sql1 = "";
	    ...
	    {	
	      ...
	      Statement stmt = db1.getStatement();
			...
			while (rs1.next()) {
				tot++;
				//myLogger.info("###BERAPA KALI BUAT:"+tot);				
				String temp_id_HA =	rs1.getString("ID_HA") == null ? "" : rs1.getString("ID_HA");
				int temp_NO_SUBJAKET=	rs1.getInt("NO_SUBJAKET") == 0 ? 0 : rs1.getInt("NO_SUBJAKET");
				int temp_NO_SUBJAKET_MAX =	rs1.getInt("NO_SUBJAKET_MAX") == 0 ? 0 : rs1.getInt("NO_SUBJAKET_MAX");
	 	...
	 	public void checkOBHubunganPermohonan(String id_permohonan,String user_id,Db db) throws Exception
	 	{ 
	 	Db db1 = null;
	    String sql = "";
	    String sql1 = "";
	    ...
	    {	
	      ...
	      Statement stmt = db1.getStatement();
			...
			while (rs1.next()) {
				...
				String temp_id_ob =	rs1.getString("ID_OB") == null ? "" : rs1.getString("ID_OB");
				//String temp_id_permohonansimati =	rs1.getString("ID_PERMOHONANSIMATI") == null ? "" : rs1.getString("ID_PERMOHONANSIMATI");
				...
				{
				updateOBHubunganPermohonan(id_permohonan,temp_id_ob,user_id,db1);
				}		
			}
	 ...
	 public void updateOBPermohonan(String id_permohonan,String temp_id_ob,String user_id,Db db) throws Exception
	  { 
	    ...
	    {	   
	      ...
	      /*
	      sql1 = " SELECT OB.NAMA_OB,OB.ID_OB,OB.ID_PERMOHONANSIMATI FROM TBLPPKOBPERMOHONAN OB,TBLPPKPERMOHONANSIMATI PSM "+   
				" WHERE OB.ID_PERMOHONANSIMATI = PSM.ID_PERMOHONANSIMATI AND  OB.ID_OB = '"+temp_id_ob+"' "+
				...
				" (SELECT DISTINCT ID_SIMATI FROM TBLPPKPERMOHONANSIMATI WHERE ID_PERMOHONAN = '"+id_permohonan+"') "+
				" AND NVL(Y.NO_SUBJAKET,'0') = "+
				" (SELECT NVL(NO_SUBJAKET,'0') FROM TBLPPKPERMOHONAN WHERE  NVL(NO_SUBJAKET,'0') > 0 AND ID_PERMOHONAN = '"+id_permohonan+"')-1 "+
				" )  "+
				"";
			...
			while (rs1.next()) {
				tot++;
				NAMA_OB  =	rs1.getString("NAMA_OB") == null ? "" : rs1.getString("NAMA_OB");
				ID_OB  =	rs1.getString("ID_OB") == null ? "" : rs1.getString("ID_OB");	
				ID_PERMOHONANSIMATI  =	rs1.getString("ID_PERMOHONANSIMATI") == null ? "" : rs1.getString("ID_PERMOHONANSIMATI");	
			...
			*/
		    ...
		    //myLogger.info("GET 1");
			sql += ""+ 
			" SELECT  (SELECT ID_PERMOHONANSIMATI FROM TBLPPKPERMOHONANSIMATI WHERE ID_PERMOHONAN = '"+id_permohonan+"'), " +
			" T.ID_OB,  "+
			...
			" T.NO_TEL_SURAT, '"+user_id+"' ,sysdate, '"+user_id+"', sysdate, T.ID_DB,  "+
			...
			else
			{
				...
				" FROM TBLPPKOBPERMOHONAN T WHERE T.ID_OB = '"+ID_OB+"' AND T.ID_PERMOHONANSIMATI = '"+ID_PERMOHONANSIMATI+"' ";	
			}
			*/
	 ...
	 public void updateHTAPermohonan(String id_permohonan,String temp_id_hta,String user_id,Db db) throws Exception
	  { 
	 	//Connection conn = null;
	    Db db1 = null;
	    String sql = "";
	    ...
	    {	   
	      ...
	      Statement stmt = db1.getStatement();
			...
			" BANDAR_PEMAJU,POSKOD_PEMAJU,ID_NEGERIPEMAJU,CATATAN,BA_SIMATI,BB_SIMATI,NO_BANGUNAN,NO_TINGKAT," +
			" NO_PETAK,NO_STRATA,MAKLUMAT_TANAH,NO_PERJANJIAN,JENIS_HTA,STATUS_PEMILIKAN,TANGGUNGAN,NO_PERSERAHAN,NAMA_RANCANGAN," +
			" NO_ROH,NO_LOT_ID,FLAG_KATEGORI_HTA,JENIS_KEPENTINGAN,'"+user_id+"',sysdate,'"+user_id+"',sysdate," +
			" ID_DB,ID_BANDARPEMAJU,ID_BANDARHTA,FLAG_PA,FLAG_PT,FLAG_SELESAI,ID_PERINTAHOBMST,ID_HAKMILIK "+
	 ...
	 public void updateHAPermohonan(String id_permohonan,String temp_id_ha,String user_id,Db db) throws Exception
	  { 
		//Connection conn = null;
		Db db1 = null;
	    String sql = "";
	    ...
	    {	   
	      ...
	      Statement stmt = db1.getStatement();
			...
			""; 
			sql += " SELECT (SELECT ID_PERMOHONANSIMATI FROM TBLPPKPERMOHONANSIMATI WHERE ID_PERMOHONAN = '"+id_permohonan+"')," +
					" ID_HA,BIL,ID_SIMATI,ID_JENISHA,ID_NEGERI,ID_DAERAH,JENAMA,NO_DAFTAR," +
					" NO_SIJIL,BIL_UNIT,TARIKH_HARTA,ALAMAT_HA1,ALAMAT_HA2,ALAMAT_HA3,POSKOD,NILAI_HA_TARIKHMOHON,NILAI_HA_TARIKHMATI, " +
					" BA_SIMATI,BB_SIMATI,CATATAN,NILAI_SEUNIT,'"+user_id+"', sysdate,'"+user_id+"',sysdate, " +
					" ID_DB,FLAG_PA,FLAG_PT,FLAG_SELESAI,ID_PERINTAHOBMST,NAMA_SAHAM,BUTIRAN,ID_HA_LAMA " +
	 ...
	 public void updateOBHubunganPermohonan(String id_permohonan,String id_ob,String user_id,Db db) throws Exception
	  { Db db1 = null;
	    String sql = "";
	    String sql1 = "";
	    try
	    {	
	      ...
	      sql1 = " SELECT OB.ID_OB,OB.ID_PERMOHONANSIMATI " +
			...
			" WHERE OB.ID_PERMOHONANSIMATI = PSM.ID_PERMOHONANSIMATI AND  OB.ID_OB = '"+id_ob+"' "+
			" AND  PSM.ID_PERMOHONAN = "+
			" ( "+
			" SELECT X.ID_PERMOHONAN  FROM TBLPPKPERMOHONANSIMATI X,TBLPPKPERMOHONAN Y "+
			" WHERE X.ID_PERMOHONAN = Y.ID_PERMOHONAN  AND X.ID_SIMATI IN "+
		...
		//myLogger.info("ADA KA? CHECK SEBELUM ADD OB HUBUNGAN PERMOHONAN :"+tot);
	      ...
	      if(tot==0)
			{*/
	      sql1 +="SELECT HOB.ID_HUBUNGANOB,(SELECT ID_PERMOHONANSIMATI FROM TBLPPKPERMOHONANSIMATI WHERE ID_PERMOHONAN = '"+id_permohonan+"'),"+
	      " HOB.ID_OB,HOB.ID_PARENTOB,HOB.ID_SAUDARA,'"+user_id+"',sysdate,'"+user_id+"',sysdate,HOB.ID_DB "+
	      " FROM TBLPPKHUBUNGANOB HOB, TBLPPKOB OB  WHERE HOB.ID_OB = OB.ID_OB AND HOB.ID_OB = '"+id_ob+"'";
		  /*	}
	      else
	      {
	      sql1 +=" SELECT HOB.ID_HUBUNGANOB,(SELECT ID_PERMOHONANSIMATI FROM TBLPPKPERMOHONANSIMATI WHERE ID_PERMOHONAN = '"+id_permohonan+"'),"+
		  " HOB.ID_OB,HOB.ID_PARENTOB,HOB.ID_SAUDARA,'"+user_id+"',sysdate,'"+user_id+"',sysdate,HOB.ID_DB "+
		  " FROM TBLPPKHUBUNGANOBPERMOHONAN HOB WHERE  HOB.ID_OB = '"+ID_OB+"' AND HOB.ID_PERMOHONANSIMATI = '"+ID_PERMOHONANSIMATI+"'";  
	      }
	      */	      
	 ...
	 public int recordCountHTA(String temp_hta,String id_permohonan,Db db) throws Exception {		
			Db db1 = null;
			String sql2 = "";
			try {
				if(db == null)
	 ...
	 public int recordCountHA(String temp_hta,String id_permohonan,Db db) throws Exception {		
			Db db1 = null;
			String sql2 = "";
			try {
				if(db == null)
...
public int recordCount(String temp_id_ob,String id_permohonan, Db db) throws Exception {		
		Db db1 = null;
		String sql2 = "";
		try {
			if(db == null)
...
public int recordCountHubungan(String temp_id_ob,String id_permohonan,Db db) throws Exception {		
	Db db1 = null;
	String sql2 = "";
	try {
		if(db == null)
...
/*
public int recordCountHubungan(String temp_id_HUBUNGANOB,String ID_PERMOHONANSIMATI) throws Exception {		
	Db db = null;
	String sql2 = "";
	try {
		db = new Db();
		Statement stmt = db.getStatement();
		SQLRenderer r = new SQLRenderer();
		sql2 = " SELECT * FROM TBLPPKHUBUNGANOBPERMOHONAN HUP, TBLPPKPERMOHONANSIMATI SM "+
		" WHERE HUP.ID_PERMOHONANSIMATI = SM.ID_PERMOHONANSIMATI AND  HUP.ID_PERMOHONANSIMATI = '"+ID_PERMOHONANSIMATI+"' " +
...
*/
/*
public int recordCountBasedOBPermohonan(String temp_id_ob,String id_permohonan) throws Exception {		
	Db db = null;
	String sql2 = "";
	try {
		db = new Db();
...
*/	
	...
	/*							
	sql = "SELECT SUS.TARIKH_MASUK,SUS.ID_SUBURUSANSTATUSFAIL,F.NO_FAIL,S.KETERANGAN,P.ID_PERMOHONAN,S.ID_STATUS,PS.ID_PERMOHONANSIMATI,P.TARIKH_MOHON, "+
	...
	*/
	...
	public Vector<Hashtable<String,String>> carianFail(String id_permohonan,String flag_permohonan,String id_fail,String flag_fail) throws Exception {
	...
	public Vector kenegaraan(String XXXXXX) throws Exception {
		...
		sql = "SELECT KOD_WARGA,NAMA_WARGA FROM TBLRUJKENEGARAAN "+
		 "ORDER BY NAMA_WARGA  ASC ";	
					...
					while (rs.next()){						
						count++;
						h = new Hashtable();						
						h.put("KOD_WARGA", rs.getString("KOD_WARGA") == null ? "" : rs.getString("KOD_WARGA"));
						h.put("NAMA_WARGA", rs.getString("NAMA_WARGA") == null ? "" : rs.getString("NAMA_WARGA").toUpperCase());					
	...
	public Vector getListBayaranPerintah(String id_permohonan,String id_jenisbayaran) throws Exception {
		...
		try {
			...
			sql = "SELECT ID_BAYARAN,ID_PERMOHONAN,ID_JENISBAYARAN,NO_RESIT,TO_CHAR(TARIKH_BAYARAN,'DD/MM/YYYY') AS TARIKH_BAYARAN," +
					...
					"AND ID_PERMOHONAN = '"+id_permohonan+"' ORDER BY TARIKH_BAYARAN,ID_BAYARAN ASC";
			...
			while (rs.next()){
				...
				h.put("ID_BAYARAN", rs.getString("ID_BAYARAN") == null ? "" : rs
						.getString("ID_BAYARAN"));
				h.put("ID_PERMOHONAN", rs.getString("ID_PERMOHONAN") == null ? "" : rs
						.getString("ID_PERMOHONAN"));
				h.put("ID_JENISBAYARAN", rs.getString("ID_JENISBAYARAN") == null ? "" : rs
						.getString("ID_JENISBAYARAN"));
				h.put("NO_RESIT", rs.getString("NO_RESIT") == null ? "" : rs
						.getString("NO_RESIT"));
				h.put("TARIKH_BAYARAN", rs.getString("TARIKH_BAYARAN") == null ? "" : rs
						.getString("TARIKH_BAYARAN"));
				h.put("JUMLAH_BAYARAN", rs.getString("JUMLAH_BAYARAN") == null ? "" : rs
	...
	public Vector getListBayaranCukai(String id_permohonan,String id_jenisbayaran) throws Exception {
	...
	public Vector getListBayaranBaitulmal(String id_permohonan,String id_jenisbayaran) throws Exception {
		String key = "getListBayaranCukai"+id_permohonan;
	...
	public String getFlagKebenaran(String id_permohonan,String user_id,Db db) throws Exception{
		Db db1 = null;
		String sql2 = "";
		try {
			if(db == null)
			...
			//Statement stmt = db1.getStatement();
	//		SQLRenderer r = new SQLRenderer();
			sql2 = " SELECT A.ID_FAIL " +
					" FROM TBLPPKPERMOHONAN A, TBLEDITAGIHAN B " +
					" WHERE A.ID_FAIL = B.ID_FAIL " +
					" AND A.FLAG_KEBENARAN_EDIT = 1 " +
					" AND B.USER_ID = '"+user_id+"' " +
					" AND A.ID_PERMOHONAN = '"+id_permohonan+"' ";

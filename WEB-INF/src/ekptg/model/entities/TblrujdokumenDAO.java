...
public class TblrujdokumenDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(TblrujdokumenDAO.class);
	// property constants
	...
	public void save(Tblrujdokumen transientInstance) {
		log.debug("saving Tblrujdokumen instance");
		try {
	...
	public void delete(Tblrujdokumen persistentInstance) {
	...
	public Tblrujdokumen findById(java.lang.Long id) {
		log.debug("getting Tbldokumen instance with id: " + id);
		try {
			Tblrujdokumen instance = (Tblrujdokumen) getSession().get(
	...
	public List findByExample(Tblrujdokumen instance) {
		log.debug("finding Tbldokumen instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblrujdokumen").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tbldokumen instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Tblrujdokumen as model where model."
					+ propertyName + "= ?";
	...
	public List findByKodDokumen(Object namaDokumen) {
	...
	public Tblrujdokumen merge(Tblrujdokumen detachedInstance) {
		log.debug("merging Tbldokumen instance");
		try {
			Tblrujdokumen result = (Tblrujdokumen) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Tblrujdokumen instance) {

...
/**
 * AbstractTblppkborangaob entity provides the base persistence definition of
 * the Tblppkborangaob entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblppkborangaob implements java.io.Serializable {

	// Fields

	private Long idBorangaob;
	private Tblrujppkjenispb tblrujppkjenispb;
	private Tblppkborangasimati tblppkborangasimati;
	...
	private Set tblppkborangahubobs = new HashSet(0);

	// Constructors

	/** default constructor */
	public AbstractTblppkborangaob() {
	}

	/** minimal constructor */
	public AbstractTblppkborangaob(Long idBorangaob,
			Tblppkborangasimati tblppkborangasimati,
			Tblrujppktarafkptg tblrujppktarafkptg) {
		this.idBorangaob = idBorangaob;
		this.tblppkborangasimati = tblppkborangasimati;
	...
	public AbstractTblppkborangaob(Long idBorangaob,
		...
		this.idBorangaob = idBorangaob;
		this.tblrujppkjenispb = tblrujppkjenispb;
		this.tblppkborangasimati = tblppkborangasimati;
		this.tblrujppktarafkptg = tblrujppktarafkptg;
		...
		this.tblppkborangahubobs = tblppkborangahubobs;
	}

	// Property accessors

	public Long getIdBorangaob() {
		return this.idBorangaob;
	}

	public void setIdBorangaob(Long idBorangaob) {
		this.idBorangaob = idBorangaob;
	}

	public Tblrujppkjenispb getTblrujppkjenispb() {
		return this.tblrujppkjenispb;
	}

	public void setTblrujppkjenispb(Tblrujppkjenispb tblrujppkjenispb) {
		this.tblrujppkjenispb = tblrujppkjenispb;
	}

	public Tblppkborangasimati getTblppkborangasimati() {
		return this.tblppkborangasimati;
	}

	public void setTblppkborangasimati(Tblppkborangasimati tblppkborangasimati) {
		this.tblppkborangasimati = tblppkborangasimati;
	}
	...
	public Set getTblppkborangahubobs() {
		return this.tblppkborangahubobs;
	}

	public void setTblppkborangahubobs(Set tblppkborangahubobs) {
		this.tblppkborangahubobs = tblppkborangahubobs;
	}

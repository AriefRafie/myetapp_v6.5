 ...
 * Tblppkpenghutang entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblppkpenghutang
 * @author MyEclipse Persistence Tools
 */

public class TblppkpenghutangDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(TblppkpenghutangDAO.class);
	// property constants
	...
	public void save(Tblppkpenghutang transientInstance) {
		log.debug("saving Tblppkpenghutang instance");
		try {
	...
	public void delete(Tblppkpenghutang persistentInstance) {
		log.debug("deleting Tblppkpenghutang instance");
		try {
	...
	public Tblppkpenghutang findById(java.lang.Long id) {
		log.debug("getting Tblppkpenghutang instance with id: " + id);
		try {
			Tblppkpenghutang instance = (Tblppkpenghutang) getSession().get(
					"ekptg.model.entities.Tblppkpenghutang", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblppkpenghutang instance) {
		log.debug("finding Tblppkpenghutang instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblppkpenghutang").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblppkpenghutang instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblppkpenghutang as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Tblppkpenghutang instances");
		try {
			String queryString = "from Tblppkpenghutang";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblppkpenghutang merge(Tblppkpenghutang detachedInstance) {
		log.debug("merging Tblppkpenghutang instance");
		try {
			Tblppkpenghutang result = (Tblppkpenghutang) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Tblppkpenghutang instance) {
		log.debug("attaching dirty Tblppkpenghutang instance");
		try {
	...
	public void attachClean(Tblppkpenghutang instance) {
		log.debug("attaching clean Tblppkpenghutang instance");
		try {

...
/**
 * AbstractTblppkborangaha entity provides the base persistence definition of
 * the Tblppkborangaha entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblppkborangaha implements java.io.Serializable {

	// Fields

	private Long idBorangaha;
	...
	/** default constructor */
	public AbstractTblppkborangaha() {
	}

	/** minimal constructor */
	public AbstractTblppkborangaha(Long idBorangaha,
			Tblrujppkjenisha tblrujppkjenisha,
			Tblppkborangasimati tblppkborangasimati) {
		this.idBorangaha = idBorangaha;
	...
	public Long getIdBorangaha() {
		return this.idBorangaha;
	}

	public void setIdBorangaha(Long idBorangaha) {
		this.idBorangaha = idBorangaha;
	}
	...
	public String getUrusniaga() {
		return this.urusniaga;
	}

	public void setUrusniaga(String urusniaga) {
		this.urusniaga = urusniaga;
	}

...
/**
 * AbstractTblppkborangpob entity provides the base persistence definition of
 * the Tblppkborangpob entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblppkborangpob implements java.io.Serializable {

	// Fields

	private Long idBorangpob;
	...
	private Set tblppkborangphubobs = new HashSet(0);

	// Constructors

	/** default constructor */
	public AbstractTblppkborangpob() {
	}

	/** minimal constructor */
	public AbstractTblppkborangpob(Long idBorangpob,
			Tblppkborangpsimati tblppkborangpsimati) {
		this.idBorangpob = idBorangpob;
	...
	public AbstractTblppkborangpob(Long idBorangpob,
		...
		this.tblppkborangphubobs = tblppkborangphubobs;
	}

	// Property accessors

	public Long getIdBorangpob() {
		return this.idBorangpob;
	}

	public void setIdBorangpob(Long idBorangpob) {
		this.idBorangpob = idBorangpob;
	}
	...
	public Set getTblppkborangphubobs() {
		return this.tblppkborangphubobs;
	}

	public void setTblppkborangphubobs(Set tblppkborangphubobs) {
		this.tblppkborangphubobs = tblppkborangphubobs;
	}

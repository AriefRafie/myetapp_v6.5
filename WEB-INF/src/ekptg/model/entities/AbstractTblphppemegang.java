...
/**
 * AbstractTblphppemegang entity provides the base persistence definition of the
 * Tblphppemegang entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblphppemegang implements java.io.Serializable {

	// Fields

	private Long idPemegang;
	private Tblphppemeganglesenperjanjian tblphppemeganglesenperjanjian;
	private String nama;
	...
	/** default constructor */
	public AbstractTblphppemegang() {
	}

	/** minimal constructor */
	public AbstractTblphppemegang(Long idPemegang) {
		this.idPemegang = idPemegang;
	}
	...
	public AbstractTblphppemegang(Long idPemegang,
		...
		this.idPemegang = idPemegang;
		this.tblphppemeganglesenperjanjian = tblphppemeganglesenperjanjian;
		this.nama = nama;
	...
	public Long getIdPemegang() {
		return this.idPemegang;
	}

	public void setIdPemegang(Long idPemegang) {
		this.idPemegang = idPemegang;
	}

	public Tblphppemeganglesenperjanjian getTblphppemeganglesenperjanjian() {
		return this.tblphppemeganglesenperjanjian;
	}

	public void setTblphppemeganglesenperjanjian(
			Tblphppemeganglesenperjanjian tblphppemeganglesenperjanjian) {
		this.tblphppemeganglesenperjanjian = tblphppemeganglesenperjanjian;
	}

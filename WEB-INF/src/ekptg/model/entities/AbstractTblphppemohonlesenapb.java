...
/**
 * AbstractTblphppemohonlesenapb entity provides the base persistence definition
 * of the Tblphppemohonlesenapb entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblphppemohonlesenapb implements
		java.io.Serializable {

	// Fields

	private Long idPemohonlesenapb;
	...
	private Set tblphpmaklumatpakarapbs = new HashSet(0);
	private Set tblphppengarahpmhnlesenapbs = new HashSet(0);

	// Constructors

	/** default constructor */
	public AbstractTblphppemohonlesenapb() {
	}

	/** minimal constructor */
	public AbstractTblphppemohonlesenapb(Long idPemohonlesenapb) {
		this.idPemohonlesenapb = idPemohonlesenapb;
	}
	...
	public AbstractTblphppemohonlesenapb(Long idPemohonlesenapb,
		...
		this.tblphpmaklumatpakarapbs = tblphpmaklumatpakarapbs;
		this.tblphppengarahpmhnlesenapbs = tblphppengarahpmhnlesenapbs;
	}

	// Property accessors

	public Long getIdPemohonlesenapb() {
		return this.idPemohonlesenapb;
	}

	public void setIdPemohonlesenapb(Long idPemohonlesenapb) {
		this.idPemohonlesenapb = idPemohonlesenapb;
	}
	...
	public Set getTblphpmaklumatpakarapbs() {
		return this.tblphpmaklumatpakarapbs;
	}

	public void setTblphpmaklumatpakarapbs(Set tblphpmaklumatpakarapbs) {
		this.tblphpmaklumatpakarapbs = tblphpmaklumatpakarapbs;
	}

	public Set getTblphppengarahpmhnlesenapbs() {
		return this.tblphppengarahpmhnlesenapbs;
	}

	public void setTblphppengarahpmhnlesenapbs(Set tblphppengarahpmhnlesenapbs) {
		this.tblphppengarahpmhnlesenapbs = tblphppengarahpmhnlesenapbs;
	}

 ...
 * Tblppksimati entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblppksimati
 * @author MyEclipse Persistence Tools
 */

public class TblppksimatiDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(TblppksimatiDAO.class);
	// property constants
	...
	public static final String JENIS_WAKTU_MATI = "jenisWaktuMati";
	...
	public void save(Tblppksimati transientInstance) {
		log.debug("saving Tblppksimati instance");
		try {
	...
	public void delete(Tblppksimati persistentInstance) {
		log.debug("deleting Tblppksimati instance");
		try {
	...
	public Tblppksimati findById(java.lang.Long id) {
		log.debug("getting Tblppksimati instance with id: " + id);
		try {
			Tblppksimati instance = (Tblppksimati) getSession().get(
					"ekptg.model.entities.Tblppksimati", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblppksimati instance) {
		log.debug("finding Tblppksimati instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblppksimati").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblppksimati instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblppksimati as model where model."
					+ propertyName + "= ?";
	...
	public List findByJenisWaktuMati(Object jenisWaktuMati) {
		return findByProperty(JENIS_WAKTU_MATI, jenisWaktuMati);
	}
	...
	public List findAll() {
		log.debug("finding all Tblppksimati instances");
		try {
			String queryString = "from Tblppksimati";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblppksimati merge(Tblppksimati detachedInstance) {
		log.debug("merging Tblppksimati instance");
		try {
			Tblppksimati result = (Tblppksimati) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Tblppksimati instance) {
		log.debug("attaching dirty Tblppksimati instance");
		try {
	...
	public void attachClean(Tblppksimati instance) {
		log.debug("attaching clean Tblppksimati instance");
		try {

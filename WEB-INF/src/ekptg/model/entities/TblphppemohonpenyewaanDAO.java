 ...
 * Tblphppemohonpenyewaan entities. Transaction control of the save(), update()
 * and delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblphppemohonpenyewaan
 * @author MyEclipse Persistence Tools
 */

public class TblphppemohonpenyewaanDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory
			.getLog(TblphppemohonpenyewaanDAO.class);
	// property constants
	...
	public void save(Tblphppemohonpenyewaan transientInstance) {
		log.debug("saving Tblphppemohonpenyewaan instance");
		try {
	...
	public void delete(Tblphppemohonpenyewaan persistentInstance) {
		log.debug("deleting Tblphppemohonpenyewaan instance");
		try {
	...
	public Tblphppemohonpenyewaan findById(java.lang.Long id) {
		log.debug("getting Tblphppemohonpenyewaan instance with id: " + id);
		try {
			Tblphppemohonpenyewaan instance = (Tblphppemohonpenyewaan) getSession()
					.get("ekptg.model.entities.Tblphppemohonpenyewaan", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblphppemohonpenyewaan instance) {
		log.debug("finding Tblphppemohonpenyewaan instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblphppemohonpenyewaan").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblphppemohonpenyewaan instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblphppemohonpenyewaan as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Tblphppemohonpenyewaan instances");
		try {
			String queryString = "from Tblphppemohonpenyewaan";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblphppemohonpenyewaan merge(Tblphppemohonpenyewaan detachedInstance) {
		log.debug("merging Tblphppemohonpenyewaan instance");
		try {
			Tblphppemohonpenyewaan result = (Tblphppemohonpenyewaan) getSession()
	...
	public void attachDirty(Tblphppemohonpenyewaan instance) {
		log.debug("attaching dirty Tblphppemohonpenyewaan instance");
		try {
	...
	public void attachClean(Tblphppemohonpenyewaan instance) {
		log.debug("attaching clean Tblphppemohonpenyewaan instance");
		try {

...
/**
 * AbstractTblppkborangapenghutang entity provides the base persistence
 * definition of the Tblppkborangapenghutang entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblppkborangapenghutang implements
		java.io.Serializable {

	// Fields

	private Long idBorangapenghutang;
	...
	/** default constructor */
	public AbstractTblppkborangapenghutang() {
	}

	/** minimal constructor */
	public AbstractTblppkborangapenghutang(Long idBorangapenghutang,
			Tblppkborangasimati tblppkborangasimati) {
		this.idBorangapenghutang = idBorangapenghutang;
	...
	public Long getIdBorangapenghutang() {
		return this.idBorangapenghutang;
	}

	public void setIdBorangapenghutang(Long idBorangapenghutang) {
		this.idBorangapenghutang = idBorangapenghutang;
	}

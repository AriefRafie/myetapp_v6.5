...
/**
 * AbstractTblppkborangahta entity provides the base persistence definition of
 * the Tblppkborangahta entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblppkborangahta implements java.io.Serializable {

	// Fields

	private Long idBorangahta;
	...
	/** default constructor */
	public AbstractTblppkborangahta() {
	}

	/** minimal constructor */
	public AbstractTblppkborangahta(Long idBorangahta,
			Tblppkborangasimati tblppkborangasimati) {
		this.idBorangahta = idBorangahta;
		this.tblppkborangasimati = tblppkborangasimati;
	}

	/** full constructor */
	public AbstractTblppkborangahta(Long idBorangahta,
			Tblppkborangasimati tblppkborangasimati, String noHakmilik,
	...
	public Long getIdBorangahta() {
		return this.idBorangahta;
	}

	public void setIdBorangahta(Long idBorangahta) {
		this.idBorangahta = idBorangahta;
	}

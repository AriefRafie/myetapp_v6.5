...
/**
 * AbstractTblphptanahdisewa entity provides the base persistence definition of
 * the Tblphptanahdisewa entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblphptanahdisewa implements java.io.Serializable {

	// Fields

	private Long idTanahdisewa;
	...
	/** default constructor */
	public AbstractTblphptanahdisewa() {
	}

	/** minimal constructor */
	public AbstractTblphptanahdisewa(Long idTanahdisewa) {
		this.idTanahdisewa = idTanahdisewa;
	}
	...
	public Long getIdTanahdisewa() {
		return this.idTanahdisewa;
	}

	public void setIdTanahdisewa(Long idTanahdisewa) {
		this.idTanahdisewa = idTanahdisewa;
	}

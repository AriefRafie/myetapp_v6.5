...
/**
 * AbstractTblppksimati entity provides the base persistence definition of the
 * Tblppksimati entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblppksimati implements java.io.Serializable {
...
//	private Tblppkpermohonan tblppkpermohonan;
	...
	private Set tblppkpenghutangs = new HashSet(0);
	private Set tblppkhas = new HashSet(0);
	private Set tblppkobs = new HashSet(0);
	private Set tblppkhtas = new HashSet(0);

	// Constructors

	/** default constructor */
	public AbstractTblppksimati() {
	}

	/** minimal constructor */
	public AbstractTblppksimati(Long idSimati,
			String namaSimati) {
	...
	/** full constructor */
	public AbstractTblppksimati(Long idSimati, Long idPermohonan, 
			Long idBuktiMati, String namaSimati,
	...
	//	this.tblppkpermohonan = tblppkpermohonan;
		...
		this.jenisWaktuMati = jenisWaktuMati;
		...
		this.tblppkpenghutangs = tblppkpenghutangs;
		this.tblppkhas = tblppkhas;
		this.tblppkobs = tblppkobs;
		this.tblppkhtas = tblppkhtas;
	}
...
*/
	...
	public String getJenisWaktuMati() {
		return this.jenisWaktuMati;
	}

	public void setJenisWaktuMati(String jenisWaktuMati) {
		this.jenisWaktuMati = jenisWaktuMati;
	}
	...
	public Set getTblppkpenghutangs() {
		return this.tblppkpenghutangs;
	}

	public void setTblppkpenghutangs(Set tblppkpenghutangs) {
		this.tblppkpenghutangs = tblppkpenghutangs;
	}
	...
	public Set getTblppkhtas() {
		return this.tblppkhtas;
	}

	public void setTblppkhtas(Set tblppkhtas) {
		this.tblppkhtas = tblppkhtas;
	}

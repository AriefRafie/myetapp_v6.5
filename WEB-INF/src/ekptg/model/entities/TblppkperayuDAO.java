 ...
 * Tblppkperayu entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblppkperayu
 * @author MyEclipse Persistence Tools
 */

public class TblppkperayuDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(TblppkperayuDAO.class);
	// property constants
	public static final String NAMA_PERAYU = "namaPerayu";
	...
	public void save(Tblppkperayu transientInstance) {
		log.debug("saving Tblppkperayu instance");
		try {
	...
	public void delete(Tblppkperayu persistentInstance) {
		log.debug("deleting Tblppkperayu instance");
		try {
	...
	public Tblppkperayu findById(java.lang.Long id) {
		log.debug("getting Tblppkperayu instance with id: " + id);
		try {
			Tblppkperayu instance = (Tblppkperayu) getSession().get(
					"ekptg.model.entities.Tblppkperayu", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblppkperayu instance) {
		log.debug("finding Tblppkperayu instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblppkperayu").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblppkperayu instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblppkperayu as model where model."
					+ propertyName + "= ?";
	...
	public List findByNamaPerayu(Object namaPerayu) {
		return findByProperty(NAMA_PERAYU, namaPerayu);
	}
	...
	public List findAll() {
		log.debug("finding all Tblppkperayu instances");
		try {
			String queryString = "from Tblppkperayu";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblppkperayu merge(Tblppkperayu detachedInstance) {
		log.debug("merging Tblppkperayu instance");
		try {
			Tblppkperayu result = (Tblppkperayu) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Tblppkperayu instance) {
		log.debug("attaching dirty Tblppkperayu instance");
		try {
	...
	public void attachClean(Tblppkperayu instance) {
		log.debug("attaching clean Tblppkperayu instance");
		try {

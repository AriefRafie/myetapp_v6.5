 ...
 * Tblppkborangapemohon entities. Transaction control of the save(), update()
 * and delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblppkborangapemohon
 * @author MyEclipse Persistence Tools
 */

public class TblppkborangapemohonDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory
			.getLog(TblppkborangapemohonDAO.class);
	// property constants
	...
	public void save(Tblppkborangapemohon transientInstance) {
		log.debug("saving Tblppkborangapemohon instance");
		try {
	...
	public void delete(Tblppkborangapemohon persistentInstance) {
		log.debug("deleting Tblppkborangapemohon instance");
		try {
	...
	public Tblppkborangapemohon findById(java.lang.Long id) {
		log.debug("getting Tblppkborangapemohon instance with id: " + id);
		try {
			Tblppkborangapemohon instance = (Tblppkborangapemohon) getSession()
					.get("ekptg.model.entities.Tblppkborangapemohon", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblppkborangapemohon instance) {
		log.debug("finding Tblppkborangapemohon instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblppkborangapemohon").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblppkborangapemohon instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblppkborangapemohon as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Tblppkborangapemohon instances");
		try {
			String queryString = "from Tblppkborangapemohon";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblppkborangapemohon merge(Tblppkborangapemohon detachedInstance) {
		log.debug("merging Tblppkborangapemohon instance");
		try {
			Tblppkborangapemohon result = (Tblppkborangapemohon) getSession()
	...
	public void attachDirty(Tblppkborangapemohon instance) {
		log.debug("attaching dirty Tblppkborangapemohon instance");
		try {
	...
	public void attachClean(Tblppkborangapemohon instance) {
		log.debug("attaching clean Tblppkborangapemohon instance");
		try {

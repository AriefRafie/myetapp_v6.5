...
/**
 * AbstractTblppkborangapeguam entity provides the base persistence definition
 * of the Tblppkborangapeguam entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblppkborangapeguam implements
		java.io.Serializable {

	// Fields

	private Long idBorangapeguam;
	private Tblppkborangapemohon tblppkborangapemohon;
	...
	/** default constructor */
	public AbstractTblppkborangapeguam() {
	}

	/** minimal constructor */
	public AbstractTblppkborangapeguam(Long idBorangapeguam,
			Tblppkborangapemohon tblppkborangapemohon) {
		this.idBorangapeguam = idBorangapeguam;
		this.tblppkborangapemohon = tblppkborangapemohon;
	}
	...
	public Long getIdBorangapeguam() {
		return this.idBorangapeguam;
	}

	public void setIdBorangapeguam(Long idBorangapeguam) {
		this.idBorangapeguam = idBorangapeguam;
	}

	public Tblppkborangapemohon getTblppkborangapemohon() {
		return this.tblppkborangapemohon;
	}

	public void setTblppkborangapemohon(
			Tblppkborangapemohon tblppkborangapemohon) {
		this.tblppkborangapemohon = tblppkborangapemohon;
	}

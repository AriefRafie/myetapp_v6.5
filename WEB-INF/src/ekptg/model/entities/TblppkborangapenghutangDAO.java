 ...
 * Tblppkborangapenghutang entities. Transaction control of the save(), update()
 * and delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblppkborangapenghutang
 * @author MyEclipse Persistence Tools
 */

public class TblppkborangapenghutangDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory
			.getLog(TblppkborangapenghutangDAO.class);
	// property constants
	...
	public void save(Tblppkborangapenghutang transientInstance) {
		log.debug("saving Tblppkborangapenghutang instance");
		try {
	...
	public void delete(Tblppkborangapenghutang persistentInstance) {
		log.debug("deleting Tblppkborangapenghutang instance");
		try {
	...
	public Tblppkborangapenghutang findById(java.lang.Long id) {
		log.debug("getting Tblppkborangapenghutang instance with id: " + id);
		try {
			Tblppkborangapenghutang instance = (Tblppkborangapenghutang) getSession()
					.get("ekptg.model.entities.Tblppkborangapenghutang", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblppkborangapenghutang instance) {
		log.debug("finding Tblppkborangapenghutang instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblppkborangapenghutang").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblppkborangapenghutang instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblppkborangapenghutang as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Tblppkborangapenghutang instances");
		try {
			String queryString = "from Tblppkborangapenghutang";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblppkborangapenghutang merge(
			Tblppkborangapenghutang detachedInstance) {
		log.debug("merging Tblppkborangapenghutang instance");
		try {
			Tblppkborangapenghutang result = (Tblppkborangapenghutang) getSession()
	...
	public void attachDirty(Tblppkborangapenghutang instance) {
		log.debug("attaching dirty Tblppkborangapenghutang instance");
		try {
	...
	public void attachClean(Tblppkborangapenghutang instance) {
		log.debug("attaching clean Tblppkborangapenghutang instance");
		try {

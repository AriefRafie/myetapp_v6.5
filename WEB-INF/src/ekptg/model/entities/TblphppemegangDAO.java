 ...
 * Tblphppemegang entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblphppemegang
 * @author MyEclipse Persistence Tools
 */

public class TblphppemegangDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(TblphppemegangDAO.class);
	// property constants
	...
	public void save(Tblphppemegang transientInstance) {
		log.debug("saving Tblphppemegang instance");
		try {
	...
	public void delete(Tblphppemegang persistentInstance) {
		log.debug("deleting Tblphppemegang instance");
		try {
	...
	public Tblphppemegang findById(java.lang.Long id) {
		log.debug("getting Tblphppemegang instance with id: " + id);
		try {
			Tblphppemegang instance = (Tblphppemegang) getSession().get(
					"ekptg.model.entities.Tblphppemegang", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblphppemegang instance) {
		log.debug("finding Tblphppemegang instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblphppemegang").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblphppemegang instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblphppemegang as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Tblphppemegang instances");
		try {
			String queryString = "from Tblphppemegang";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblphppemegang merge(Tblphppemegang detachedInstance) {
		log.debug("merging Tblphppemegang instance");
		try {
			Tblphppemegang result = (Tblphppemegang) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Tblphppemegang instance) {
		log.debug("attaching dirty Tblphppemegang instance");
		try {
	...
	public void attachClean(Tblphppemegang instance) {
		log.debug("attaching clean Tblphppemegang instance");
		try {

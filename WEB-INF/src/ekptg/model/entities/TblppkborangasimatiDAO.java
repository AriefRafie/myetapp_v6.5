 ...
 * Tblppkborangasimati entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblppkborangasimati
 * @author MyEclipse Persistence Tools
 */

public class TblppkborangasimatiDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory
			.getLog(TblppkborangasimatiDAO.class);
	// property constants
	...
	public void save(Tblppkborangasimati transientInstance) {
		log.debug("saving Tblppkborangasimati instance");
		try {
	...
	public void delete(Tblppkborangasimati persistentInstance) {
		log.debug("deleting Tblppkborangasimati instance");
		try {
	...
	public Tblppkborangasimati findById(java.lang.Long id) {
		log.debug("getting Tblppkborangasimati instance with id: " + id);
		try {
			Tblppkborangasimati instance = (Tblppkborangasimati) getSession()
					.get("ekptg.model.entities.Tblppkborangasimati", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblppkborangasimati instance) {
		log.debug("finding Tblppkborangasimati instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblppkborangasimati").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblppkborangasimati instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblppkborangasimati as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Tblppkborangasimati instances");
		try {
			String queryString = "from Tblppkborangasimati";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblppkborangasimati merge(Tblppkborangasimati detachedInstance) {
		log.debug("merging Tblppkborangasimati instance");
		try {
			Tblppkborangasimati result = (Tblppkborangasimati) getSession()
	...
	public void attachDirty(Tblppkborangasimati instance) {
		log.debug("attaching dirty Tblppkborangasimati instance");
		try {
	...
	public void attachClean(Tblppkborangasimati instance) {
		log.debug("attaching clean Tblppkborangasimati instance");
		try {

 ...
 */
public class TblrujagensiId extends AbstractTblrujagensiId implements
		java.io.Serializable {

	// Constructors

	/** default constructor */
	public TblrujagensiId() {
	}

	/** minimal constructor */
	public TblrujagensiId(Long idAgensi, Long idNegeri) {
		super(idAgensi, idNegeri);
	}

	/** full constructor */
	public TblrujagensiId(Long idAgensi, String kodAgensi, String namaAgensi,

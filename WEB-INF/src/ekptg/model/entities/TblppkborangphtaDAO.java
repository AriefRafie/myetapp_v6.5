 ...
 * Tblppkborangphta entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblppkborangphta
 * @author MyEclipse Persistence Tools
 */

public class TblppkborangphtaDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(TblppkborangphtaDAO.class);
	// property constants
	...
	public void save(Tblppkborangphta transientInstance) {
		log.debug("saving Tblppkborangphta instance");
		try {
	...
	public void delete(Tblppkborangphta persistentInstance) {
		log.debug("deleting Tblppkborangphta instance");
		try {
	...
	public Tblppkborangphta findById(java.lang.Long id) {
		log.debug("getting Tblppkborangphta instance with id: " + id);
		try {
			Tblppkborangphta instance = (Tblppkborangphta) getSession().get(
					"ekptg.model.entities.Tblppkborangphta", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblppkborangphta instance) {
		log.debug("finding Tblppkborangphta instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblppkborangphta").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblppkborangphta instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblppkborangphta as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Tblppkborangphta instances");
		try {
			String queryString = "from Tblppkborangphta";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblppkborangphta merge(Tblppkborangphta detachedInstance) {
		log.debug("merging Tblppkborangphta instance");
		try {
			Tblppkborangphta result = (Tblppkborangphta) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Tblppkborangphta instance) {
		log.debug("attaching dirty Tblppkborangphta instance");
		try {
	...
	public void attachClean(Tblppkborangphta instance) {
		log.debug("attaching clean Tblppkborangphta instance");
		try {

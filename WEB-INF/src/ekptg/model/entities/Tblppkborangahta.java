...
/**
 * Tblppkborangahta entity.
 * 
 * @author MyEclipse Persistence Tools
 */
public class Tblppkborangahta extends AbstractTblppkborangahta implements
		java.io.Serializable {

	// Constructors

	/** default constructor */
	public Tblppkborangahta() {
	}

	/** minimal constructor */
	public Tblppkborangahta(Long idBorangahta,
			Tblppkborangasimati tblppkborangasimati) {
		super(idBorangahta, tblppkborangasimati);
	}
	...
	public Tblppkborangahta(Long idBorangahta,
		...
		super(idBorangahta, tblppkborangasimati, noHakmilik, noPt,
				nilaiHtaTarikhmohon, nilaiHtaTarikhmati, idKategori, idJenishm,
				idJenispb, idNegeri, idDaerah, idMukim, idLuas, luas, luasHmp,

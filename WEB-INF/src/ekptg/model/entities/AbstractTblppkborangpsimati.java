...
/**
 * AbstractTblppkborangpsimati entity provides the base persistence definition
 * of the Tblppkborangpsimati entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblppkborangpsimati implements
		java.io.Serializable {

	// Fields

	private Long idBorangpsimati;
	...
	private Set tblppkborangppenghutangs = new HashSet(0);
	...
	/** default constructor */
	public AbstractTblppkborangpsimati() {
	}

	/** minimal constructor */
	public AbstractTblppkborangpsimati(Long idBorangpsimati,
			Tblppkborangp tblppkborangp, String namaSimati) {
		this.idBorangpsimati = idBorangpsimati;
	...
	public AbstractTblppkborangpsimati(Long idBorangpsimati,
		...
		this.tblppkborangppenghutangs = tblppkborangppenghutangs;
	...
	public Long getIdBorangpsimati() {
		return this.idBorangpsimati;
	}

	public void setIdBorangpsimati(Long idBorangpsimati) {
		this.idBorangpsimati = idBorangpsimati;
	}
	...
	public Set getTblppkborangppenghutangs() {
		return this.tblppkborangppenghutangs;
	}

	public void setTblppkborangppenghutangs(Set tblppkborangppenghutangs) {
		this.tblppkborangppenghutangs = tblppkborangppenghutangs;
	}

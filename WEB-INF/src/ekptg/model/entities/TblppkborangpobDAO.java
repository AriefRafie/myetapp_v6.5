 ...
 * Tblppkborangpob entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblppkborangpob
 * @author MyEclipse Persistence Tools
 */

public class TblppkborangpobDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(TblppkborangpobDAO.class);
	// property constants
	...
	public void save(Tblppkborangpob transientInstance) {
		log.debug("saving Tblppkborangpob instance");
		try {
	...
	public void delete(Tblppkborangpob persistentInstance) {
		log.debug("deleting Tblppkborangpob instance");
		try {
	...
	public Tblppkborangpob findById(java.lang.Long id) {
		log.debug("getting Tblppkborangpob instance with id: " + id);
		try {
			Tblppkborangpob instance = (Tblppkborangpob) getSession().get(
					"ekptg.model.entities.Tblppkborangpob", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblppkborangpob instance) {
		log.debug("finding Tblppkborangpob instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblppkborangpob").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblppkborangpob instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblppkborangpob as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Tblppkborangpob instances");
		try {
			String queryString = "from Tblppkborangpob";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblppkborangpob merge(Tblppkborangpob detachedInstance) {
		log.debug("merging Tblppkborangpob instance");
		try {
			Tblppkborangpob result = (Tblppkborangpob) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Tblppkborangpob instance) {
		log.debug("attaching dirty Tblppkborangpob instance");
		try {
	...
	public void attachClean(Tblppkborangpob instance) {
		log.debug("attaching clean Tblppkborangpob instance");
		try {

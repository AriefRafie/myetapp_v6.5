 ...
 * Tblppkperintahhaobdtl entities. Transaction control of the save(), update()
 * and delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see ekptg.model.entities.Tblppkperintahhaobdtl
 * @author MyEclipse Persistence Tools
 */

public class TblppkperintahhaobdtlDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory
			.getLog(TblppkperintahhaobdtlDAO.class);
	// property constants
	public static final String ID_HA = "idHa";
	...
	public void save(Tblppkperintahhaobdtl transientInstance) {
		log.debug("saving Tblppkperintahhaobdtl instance");
		try {
	...
	public void delete(Tblppkperintahhaobdtl persistentInstance) {
		log.debug("deleting Tblppkperintahhaobdtl instance");
		try {
	...
	public Tblppkperintahhaobdtl findById(java.lang.Long id) {
		log.debug("getting Tblppkperintahhaobdtl instance with id: " + id);
		try {
			Tblppkperintahhaobdtl instance = (Tblppkperintahhaobdtl) getSession()
					.get("ekptg.model.entities.Tblppkperintahhaobdtl", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tblppkperintahhaobdtl instance) {
		log.debug("finding Tblppkperintahhaobdtl instance by example");
		try {
			List results = getSession().createCriteria(
					"ekptg.model.entities.Tblppkperintahhaobdtl").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Tblppkperintahhaobdtl instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Tblppkperintahhaobdtl as model where model."
					+ propertyName + "= ?";
	...
	public List findByIdHa(Object idHa) {
		return findByProperty(ID_HA, idHa);
	}
	...
	public List findAll() {
		log.debug("finding all Tblppkperintahhaobdtl instances");
		try {
			String queryString = "from Tblppkperintahhaobdtl";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Tblppkperintahhaobdtl merge(Tblppkperintahhaobdtl detachedInstance) {
		log.debug("merging Tblppkperintahhaobdtl instance");
		try {
			Tblppkperintahhaobdtl result = (Tblppkperintahhaobdtl) getSession()
	...
	public void attachDirty(Tblppkperintahhaobdtl instance) {
		log.debug("attaching dirty Tblppkperintahhaobdtl instance");
		try {
	...
	public void attachClean(Tblppkperintahhaobdtl instance) {
		log.debug("attaching clean Tblppkperintahhaobdtl instance");
		try {

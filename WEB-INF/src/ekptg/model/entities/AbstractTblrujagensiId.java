...
/**
 * AbstractTblrujagensiId entity provides the base persistence definition of the
 * TblrujagensiId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblrujagensiId implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTblrujagensiId() {
	}

	/** minimal constructor */
	public AbstractTblrujagensiId(Long idAgensi, Long idNegeri) {
		this.idAgensi = idAgensi;
		this.idNegeri = idNegeri;
	}

	/** full constructor */
	public AbstractTblrujagensiId(Long idAgensi, String kodAgensi,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AbstractTblrujagensiId))
			return false;
		AbstractTblrujagensiId castOther = (AbstractTblrujagensiId) other;

		return ((this.getIdAgensi() == castOther.getIdAgensi()) || (this
				.getIdAgensi() != null
				&& castOther.getIdAgensi() != null && this.getIdAgensi()
				.equals(castOther.getIdAgensi())))
				&& ((this.getKodAgensi() == castOther.getKodAgensi()) || (this
						.getKodAgensi() != null
						&& castOther.getKodAgensi() != null && this
						.getKodAgensi().equals(castOther.getKodAgensi())))
				&& ((this.getNamaAgensi() == castOther.getNamaAgensi()) || (this
						.getNamaAgensi() != null
						&& castOther.getNamaAgensi() != null && this
						.getNamaAgensi().equals(castOther.getNamaAgensi())))
				...
				&& ((this.getIdKementerian() == castOther.getIdKementerian()) || (this
						.getIdKementerian() != null
						&& castOther.getIdKementerian() != null && this
						.getIdKementerian()
						.equals(castOther.getIdKementerian())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getKodAgensi() == null ? 0 : this.getKodAgensi().hashCode());
		result = 37
				* result
				+ (getNamaAgensi() == null ? 0 : this.getNamaAgensi()
						.hashCode());
		result = 37 * result

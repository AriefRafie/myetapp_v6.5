...
public abstract class AbstractTblrujkementerian implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTblrujkementerian() {
	}

	/** minimal constructor */
	public AbstractTblrujkementerian(Long idKementerian) {
		this.idKementerian = idKementerian;
	}

	/** full constructor */
	public AbstractTblrujkementerian(Long idKementerian, String kodKementerian,

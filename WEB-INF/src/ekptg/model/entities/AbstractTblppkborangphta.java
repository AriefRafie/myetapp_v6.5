...
/**
 * AbstractTblppkborangphta entity provides the base persistence definition of
 * the Tblppkborangphta entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractTblppkborangphta implements java.io.Serializable {

	// Fields

	private Long idBorangphta;
	...
	/** default constructor */
	public AbstractTblppkborangphta() {
	}

	/** minimal constructor */
	public AbstractTblppkborangphta(Long idBorangphta,
			Tblppkborangpsimati tblppkborangpsimati) {
		this.idBorangphta = idBorangphta;
	...
	public Long getIdBorangphta() {
		return this.idBorangphta;
	}

	public void setIdBorangphta(Long idBorangphta) {
		this.idBorangphta = idBorangphta;
	}

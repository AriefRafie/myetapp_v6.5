...
public class FrmAgihAduanKePegawaiData {
	...
	public static void setData(int id)throws Exception {
		 ...
		 try {
		      ...
		      sql = r.getSQLSelect("Tblonlineaduan a, Tblonlinepengadu b, Tblrujjenisaduan c, Tblonlinepengaduan d, Tblrujseksyen e");
	 ...
	 public static void updateAduan(Hashtable data) throws Exception {
		 ...
		 Db db = null;
		    ...
		    try
		    {
				 ...
				 r.add("tarikh_Pengagihan_Kpdpegawai",r.unquote("sysdate")); 

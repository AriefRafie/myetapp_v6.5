...
public class EkptgCloseComplaintHandler extends ComplaintHandler implements IEkptgCloseComplaintHandler,IComplaintActivityHandler,IFileUploadUtilityProperty{
	...
	public Complaint processComplaint(Complaint temp) throws Exception {
		...
		complaint.setStatus(ComplainStatus.SELESAI.toString());

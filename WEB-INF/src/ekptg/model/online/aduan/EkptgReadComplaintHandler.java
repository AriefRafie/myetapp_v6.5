...
public class EkptgReadComplaintHandler extends ComplaintHandler implements IEkptgFakeComplaintHandler,IComplaintActivityHandler,IFileUploadUtilityProperty {
	...
	public Complaint processComplaint(Complaint temp) throws Exception {
		...
		complaint.setStatus(ComplainStatus.BACA.toString());

...
public class FrmKPIData {

	static Logger mylog = Logger.getLogger(FrmKPIData.class);

	public static Vector<Hashtable<String, Comparable>> getSenaraiKeterangan()throws Exception {
	    Db db = null;
	    String sql = "";
	    try {
	      db = new Db();
	      ...
	      r.add("id_kpiketerangan");
	      r.add("keterangan");
	      r.add("id_masuk");
	      r.add("tarikh_masuk");
	      r.add("id_kemaskini");
	      r.add("tarikh_kemaskini");
	      sql = r.getSQLSelect("tblkpiketerangan","keterangan");
	...
	public static Vector<Hashtable<String, Comparable>> getSenaraiKeterangan(String idUrusan,String idSuburusan)throws Exception {
	 ...
	 public static void add(String keterangan, int id_masuk) throws Exception {
		  Db db = null;
		  String sql = "";
		  ...
		  long Id_KPIKeterangan= DB.getNextID("TBLKPIKETERANGAN_SEQ");

		  try {
			  db = new Db();
			  Statement stmt = db.getStatement();
			  SQLRenderer r = new SQLRenderer();
			  r.add("Id_Kpiketerangan", Id_KPIKeterangan);
			  ...
			  sql = r.getSQLInsert("TBLKPIKETERANGAN");
	  ...
	  public static void update(String idKpiketerangan, String keterangan, int idKemaskini) throws Exception {
		  Db db = null;
		  String sql = "";
		  String strTarikhSemasa="";
		  lebah.util.Util u = new lebah.util.Util();
	  ...
	  public static void delete(String idKpiketerangan)throws Exception {
	    Db db = null;
	    String sql = "";
	    try {
	      db = new Db();
	      ...
	      //if (found)
	      sql = "delete from TBLKPIKETERANGAN where id_kpiketerangan = " + idKpiketerangan;
	      stmt.executeUpdate(sql);
	    }finally {
	      if (db != null) db.close();
	    }

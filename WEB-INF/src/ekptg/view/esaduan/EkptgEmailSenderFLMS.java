...
public class EkptgEmailSenderFLMS {
	
	
	protected static Logger log = Logger.getLogger(EkptgEmailSenderFLMS.class);
	private static EkptgEmailSenderFLMS singleton;
	...
	private EkptgEmailSenderFLMS(){
		getMailProperties();
		getMailSession();
	}
	
	public static synchronized EkptgEmailSenderFLMS getInstance(){
		//if(singleton  == null){
			singleton = new EkptgEmailSenderFLMS();
		//}
	...
	private Properties getMailProperties(){
	    ...
	    props.setProperty("mail.host", "smtp.nre.gov.my");
	...
	private Properties getGMailProperties(){
		...
		props.put("mail.smtp.host", "smtp.nre.gov.my");
		...
		// server
		/*
		#SMTP_HOST =smtpapp.nre.gov
		#SMTP_PORT =26
		#SMTP_FROM =etapp_webmaster@ekptg.gov.my
		
		props.put("mail.transport.protocol", "smtps");
		props.put("mail.smtps.host", "smtp.nre.gov.my");
		props.put("mail.smtps.auth", "true");
		props.put("mail.debug", "true");
		props.put("mail.smtps.port", "26");
		props.put("mail.smtp.starttls.enable","true");
		*/
		return props;
	...
	public void sendEmail(){
		try{
			...
			transport.connect();
			//transport.connect("imap.gmail.com","etapp.pla@gmail.com","etapp123");
			//transport.connect("smtp.nre.gov.my","etappsupport@kptg.gov.my","zaq!2wsx");
			//transport.connect("mail.hla-group.com","razman@hla-group.com","hla123");

...
import ekptg.model.php2.FrmPYWPopupSenaraiTanahData;
/**
 * 
 *
 */
public class PopupSenaraiTanahView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	static Logger myLog = Logger.getLogger(ekptg.view.PopupSenaraiTanahView.class);

	FrmPYWPopupSenaraiTanahData logic = new FrmPYWPopupSenaraiTanahData();
	...
	public String doTemplate2() throws Exception {	
		...
		if ("daftar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmPYWPopupMaklumatTanah.jsp";

...
public class PPT_LaporanPrestasiPermohonanPengambilan extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PPT_LaporanPrestasiPermohonanPengambilan.class);
	...
	public String doTemplate2() throws Exception{
		...
		myLogger.info("BOLEH SIMPAN :"+bolehsimpan);
				...
				vm = "app/meps/ppt/LaporanPrestasiPermohonanPengambilan.jsp";	

...
public class HTP_LaporanStatusPermohonanTanahMilikMengikutKementerian extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanStatusPermohonanTanahMilikMengikutKementerian.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanStatusPermohonanTanahMilikMengikutKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalStatusPermohonanTanahMilikMengikutKementerian(id_tahun,id_bulan);
		...
		context.put("xml", model.generateXMLKementerian("Laporan Status Permohonan Tanah Milik Mengikut Kementerian"));

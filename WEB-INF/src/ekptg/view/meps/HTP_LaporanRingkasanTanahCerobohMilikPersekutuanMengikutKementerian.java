...
public class HTP_LaporanRingkasanTanahCerobohMilikPersekutuanMengikutKementerian extends AjaxBasedModule{	
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanRingkasanTanahCerobohMilikPersekutuanMengikutKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalRingkasanTanahCerobobohMilikPersekutuanMengikutKementerian(id_tahun,id_bulan,"","");
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Ringkasan Pencerobohan Tanah Milik Persekutuan"));
		
		String tajukLaporan = "Laporan Ringkasan Pencerobohan Tanah Milik Persekutuan "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

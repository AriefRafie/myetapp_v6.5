...
public class HTP_LaporanStatusPermohonanTanahMilikMengikutNegeri extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanStatusPermohonanTanahMilikMengikutNegeri.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanStatusPermohonanTanahMilikMengikutNegeri.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalStatusPermohonanTanahMilikMengikutNegeri(id_tahun,id_bulan);
		...
		context.put("xml", model.generateXML("Laporan Status Permohonan Tanah Milik Mengikut Negeri"));

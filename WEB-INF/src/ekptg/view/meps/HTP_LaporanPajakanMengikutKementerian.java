...
public class HTP_LaporanPajakanMengikutKementerian extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanPajakanMengikutKementerian.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanPajakanMengikutKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPajakanMengikutKementerian(id_tahun,id_bulan,"","");
	...
	vm = skrinDepanSenaraiLaporan;	
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Pajakan Tanah Mengikut Kementerian"));
		
		String tajukLaporan = "Laporan Pajakan Tanah Mengikut Kementerian "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

...
public class HTP_LaporanRingkasanTanahBelumBangunPenyewaan extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanRingkasanTanahBelumBangunPenyewaan.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanRingkasanTanahBelumBangunPenyewaan.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalRingkasanTanahBelumBangunPenyewaan(id_tahun,id_bulan);
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Ringkasan Tanah Belum Bangun - Penyewaan"));
		if(getJenisLaporan.equals("")||getJenisLaporan.equals("negeri")){

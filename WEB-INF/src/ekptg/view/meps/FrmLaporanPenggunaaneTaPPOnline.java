...
public class FrmLaporanPenggunaaneTaPPOnline extends AjaxBasedModule{	
	/**
	 * 
	 */
	private static final long serialVersionUID = 8871189698082238238L;

	static Logger myLogger = Logger.getLogger(FrmLaporanPenggunaaneTaPPOnline.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/LaporanPenggunaaneTaPPOnlineUpdated.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListStatusPenggunaaneTaPPOnlineUpdated(id_tahun,id_bulan);
		...
		//context.put("xml", model.generateXML_MSColumn2D_PenggunaanOnline(id_tahun,id_bulan,""));
		
		String tajukLaporan = "Laporan Penggunaan JKPTG Online "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			
			tajukLaporan += " - "+ekptg.report.Utils.getBulan(Integer.parseInt(id_bulan));			
		}
		tajukLaporan += (id_tahun.equals("")?"":")");
		context.put("xml", model.generateXML_MSColumn2D_PenggunaanOnlineUpdated(id_tahun,id_bulan,tajukLaporan));

 ...
 *
 */
public class PPK_LaporanBayaranPerintah extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PPK_LaporanBayaranPerintah.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/ppk/LaporanJumlahBayaranPerintah.jsp";
...
//		myLogger.info("socBulanHingga :: " + id_bulanHingga);
		...
		if("BarGraph".equals(submit)){ 
    		...
    		if (ID_NEGERI != null && ID_NEGERI.length() > 0) {
				System.out.println("::BarGraphgetTotalBayaranPerintahUnit::");
				listPageDepan = model.getTotalBayaranPerintahUnit(ID_NEGERI, ID_PEJABATJKPTG, id_tahunDari, id_tahunHingga, id_bulanDari, id_bulanHingga);
				refence = "no";
			} else {
    		listPageDepan = model.getTotalBayaranPerintah(ID_NEGERI, ID_PEJABATJKPTG, id_tahunDari,id_tahunHingga,id_bulanDari,id_bulanHingga);
			}
    		...
    		//GET LIST DATA
    		if (ID_NEGERI != null && ID_NEGERI.length() > 0) {
				System.out.println("::PieChartgetTotalBayaranPerintahUnit::");
				listPageDepan = model.getTotalBayaranPerintahUnit(ID_NEGERI, ID_PEJABATJKPTG, id_tahunDari, id_tahunHingga, id_bulanDari, id_bulanHingga);
				refence = "no";
			} else {
    		listPageDepan = model.getTotalBayaranPerintah(ID_NEGERI, ID_PEJABATJKPTG, id_tahunDari,id_tahunHingga,id_bulanDari,id_bulanHingga);
    		...
    		//GET LIST DATA
    		if (ID_NEGERI != null && ID_NEGERI.length() > 0) {
				System.out.println("::LineChartgetTotalBayaranPerintahUnit::");
				listPageDepan = model.getTotalBayaranPerintahUnit(ID_NEGERI, ID_PEJABATJKPTG, id_tahunDari, id_tahunHingga, id_bulanDari, id_bulanHingga);
				refence = "no";
			} else {
    		listPageDepan = model.getTotalBayaranPerintah(ID_NEGERI, ID_PEJABATJKPTG, id_tahunDari,id_tahunHingga,id_bulanDari,id_bulanHingga);
    		...
    		//GET LIST DATA
    		if (ID_NEGERI != null && ID_NEGERI.length() > 0) {
				System.out.println("::PieChart2getTotalBayaranPerintahUnit::");
				listPageDepan = model.getTotalBayaranPerintahUnit(ID_NEGERI, ID_PEJABATJKPTG, id_tahunDari, id_tahunHingga, id_bulanDari, id_bulanHingga);
				refence = "no";
			} else {
    		listPageDepan = model.getTotalBayaranPerintah(ID_NEGERI, ID_PEJABATJKPTG, id_tahunDari,id_tahunHingga,id_bulanDari,id_bulanHingga);
			...
			this.context.put("listPejabatJKPTG",listPejabatJKPTG);
           	...
           	//GET LIST DATA
			if (ID_NEGERI != null && ID_NEGERI.length() > 0) {
				System.out.println("::ElsegetTotalBayaranPerintahUnit::");
				listPageDepan = model.getTotalBayaranPerintahUnit(ID_NEGERI, ID_PEJABATJKPTG, id_tahunDari, id_tahunHingga, id_bulanDari, id_bulanHingga);
				refence = "no";
			} else {
    		listPageDepan = model.getTotalBayaranPerintah(ID_NEGERI, ID_PEJABATJKPTG, id_tahunDari,id_tahunHingga,id_bulanDari,id_bulanHingga);
		...
		//context.put("xml", model.generateXML("Laporan Jumlah Bayaran Perintah Pusaka Kecil"));
		
		String tajukLaporan = "LAPORAN JUMLAH BAYARAN PERINTAH PUSAKA KECIL " + (id_tahunDari.equals("") && id_tahunHingga.equals("") ? "" : " (");
		...
		if(ID_NEGERI !=null && ID_NEGERI.length()>0){
		context.put("xml", model.generateXMLPUnit(tajukLaporan));
		myLogger.info("CHART LAPORAN BAYARAN PERINTAH "+model.generateXMLPUnit(tajukLaporan));
		//context.put("xml", model.generateXMLPUnit(tajukLaporan));
		} else {
			context.put("xml", model.generateXMLP(tajukLaporan));
		}

...
public class PHP_LaporanJumlahPermohonanAPB extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanJumlahPermohonanAPB.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanAPB.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalAPBAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
       		//DEFAULT
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalAPBAbbrev(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalAPBAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		//DEFAULT
    		context.put("refence", refence);
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalAPB_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		this.context.put("txdTarikhAkhir",txdTarikhAkhir);
           	//GET LIST DATA
			//listPageDepan = model.getListTotalAPB(id_tahun,id_bulan);				
    		listPageDepan = model.getListTotalAPB_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		context.put("PermohonanList", listPageDepan);
    		context.put("list_size", listPageDepan.size());  	
		...
		//context.put("xml", model.generateXML("Laporan Jumlah Permohonan Akta Pelantar Benua"));
		
		String tajukLaporan = "Laporan Jumlah Permohonan Akta Pelantar Benua "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

...
public class PPT_LaporanBulananProjek_old extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PPT_LaporanBulananProjek_old.class);
	...
	public String doTemplate2() throws Exception{
		...
		if(main_command.equals("daerah"))
		{
			...
			this.context.put("list_daerahpejabat",list_daerahpejabat);
				...
				this.context.put("socBulan", socBulan);
				...
				vm = "app/meps/ppt/LaporanBulananProjek_old.jsp";	

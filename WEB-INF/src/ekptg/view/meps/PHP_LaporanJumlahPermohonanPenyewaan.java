...
public class PHP_LaporanJumlahPermohonanPenyewaan extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanJumlahPermohonanPenyewaan.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanPenyewaan.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPenyewaanAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalPenyewaanAbbrev(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalPenyewaanAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		//DEFAULT
    		context.put("refence", refence);
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPenyewaan_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		this.context.put("txdTarikhAkhir",txdTarikhAkhir);
           	//GET LIST DATA
			//listPageDepan = model.getListTotalPenyewaan(id_tahun,id_bulan);				
    		listPageDepan = model.getListTotalPenyewaan_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		context.put("PermohonanList", listPageDepan);
    		context.put("list_size", listPageDepan.size());  	
		...
		//context.put("xml", model.generateXML("Laporan Jumlah Permohonan Penyewaan"));
		
		String tajukLaporan = "Laporan Jumlah Permohonan Penyewaan "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

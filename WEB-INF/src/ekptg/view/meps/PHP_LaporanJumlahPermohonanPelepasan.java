...
public class PHP_LaporanJumlahPermohonanPelepasan extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanJumlahPermohonanPelepasan.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanPelepasan.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalPelepasanAbbrev(id_tahun,id_bulan);
    		if(linkPapar.equals("viewNegeri")){
        		listPageDepan = model.getListDaerahByNegeri(Long.parseLong(idNegeri),id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		} else {
        		if(idNegeri!=null && idNegeri.length()>0){
    		...
    		context.put("idNegeri", idNegeri);
           	//GET LIST DATA
			//listPageDepan = model.getListTotalPelepasan(id_tahun,id_bulan);			
    		if(linkPapar.equals("viewNegeri")){
        		listPageDepan = model.getListDaerahByNegeri(Long.parseLong(idNegeri),id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		} else {
        		if(idNegeri!=null && idNegeri.length()>0){
		...
		String tajukLaporan = "Laporan Jumlah Permohonan Pelepasan "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

...
public class HTP_LaporanPermohonanPemberimilikanMengikutKementerian extends AjaxBasedModule{	
	static Logger myLog = Logger.getLogger(HTP_LaporanPermohonanPemberimilikanMengikutKementerian.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanPermohonanPemberimilikanMengikutKementerian.jsp";
	...
	vm = skrinDepanSenaraiLaporan;	
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Permohonan Pemberimilikan Mengikut Kementerian"));
		
		String tajukLaporan = "Laporan Permohonan Pemberimilikan Mengikut Kementerian "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

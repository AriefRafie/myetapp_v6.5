...
public class PPT_LaporanJumlahPampasan extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PPT_LaporanJumlahPampasan.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/ppt/LaporanJumlahPampasan.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//GET LIST DATA
    		listPageDepan = model.getListTotalJumlahPampasanAbbrev(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		//GET LIST DATA
    		//listPageDepan = model.getListTotalJumlahPampasanAbbrev(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalJumlahPampasanAbbrev(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		context.put("refence", refence);
	...
	vm = skrinDepanSenaraiLaporan;
    		...
    		//GET LIST DATA
    		//listPageDepan = model.getListTotalJumlahPampasan(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalJumlahPampasanAbbrev(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		if(linkPapar.equals("viewNegeri")){
    			listPageDepan = model.getListDaerahByNegeriTotalJumlahPampasanAbbrev(Long.parseLong(idNegeri),id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		} else {
		...
		//context.put("xml", model.generateXML("Laporan Jumlah Bayaran Pampasan Pengambilan Tanah"));
		
		String tajukLaporan = "Laporan Jumlah Bayaran Pampasan Pengambilan Tanah "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

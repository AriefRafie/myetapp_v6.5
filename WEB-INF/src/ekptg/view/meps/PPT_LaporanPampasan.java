...
public class PPT_LaporanPampasan extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PPT_LaporanPampasan.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/ppt/LaporanJumlahTanahRizabTerlibat.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		if(linkPapar.equals("viewNegeri")){
    			listPageDepan = model.getListDaerahByNegeriTanahRizab_add(idNegeri,id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		} else {
        		if(idNegeri!=null && idNegeri.length()>0){
            		listPageDepan = model.getListDaerahByNegeriTanahRizab_add(idNegeri,id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
        			refence = "no";
        		} else {
        			listPageDepan = model.getListTanahRizab_add(idNegeri,id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
        		}       
    		}
    		//listPageDepan = model.getListTanahRizab_add(idNegeri,id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		//listPageDepan = model.getListTanahRizab(id_tahun,id_bulan);
    		//listPageDepan = model.getListTanahRizab_add(idNegeri,id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		context.put("refence", refence);
			...
			//listPageDepan = model.getListTanahRizab(id_tahun,id_bulan);
//			listPageDepan = model.getListTanahRizab_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
...
//			txdTarikhAkhir = "";
		...
		//context.put("xml", model.generateXML("Laporan Jumlah Tanah Rizab Melayu Terlibat Dalam Pengambilan Tanah"));
		
		String tajukLaporan = "Laporan Jumlah Tanah Rizab Melayu Terlibat Dalam Pengambilan Tanah "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

...
public class PPT_LaporanPrestasiBayaran extends AjaxBasedModule{
	static Logger myLogger = Logger.getLogger(PPT_LaporanPrestasiBayaran.class);
	...
	public String doTemplate2() throws Exception{
		...
		myLogger.info("BOLEH SIMPAN :"+bolehsimpan);
				...
				vm = "app/meps/ppt/LaporanPrestasiBayaran.jsp";

...
public class PPT_FrmLaporanKesMahkamah extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PPT_FrmLaporanKesMahkamah.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/ppt/frmLaporanBulananKesBantahanKeMahkamah.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//GET LIST DATA
    		listPageDepan = model.getListTotalBantahanAbbrev_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		//GETLIST DATA
    		//listPageDepan = model.getListTotalBantahanAbbrev(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalBantahanAbbrev_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		context.put("refence", refence);
    		...
    		if(linkPapar.equals("viewNegeri")){
    			listPageDepan = model.getListDaerahByNegeriTotalBantahanAbbrev(Long.parseLong(idNegeri),id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		} else {
    		...
    		context.put("selectNegeri",HTMLPPT.SelectNegeri("socNegeri", Utils.parseLong(idNegeri), null, "style=width:130px"));
           	...
           	//GET LIST DATA
			listPageDepan = model.getListTotalBantahan(id_tahun,id_bulan);				
		...
		//context.put("xml", model.generateXML("Lapotan Kes Bantahan Ke Mahkamah Pengambilan Tanah"));
		
		String tajukLaporan = "Laporan Kes Bantahan Ke Mahkamah Pengambilan Tanah "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

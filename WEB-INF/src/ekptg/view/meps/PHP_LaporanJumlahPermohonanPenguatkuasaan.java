...
public class PHP_LaporanJumlahPermohonanPenguatkuasaan extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanJumlahPermohonanPenguatkuasaan.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanPenguatkuasaan.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPenguatkuasaanAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
		...
		String tajukLaporan = "Laporan Jumlah Permohonan Penguatkuasaan "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

...
public class PHP_LaporanPermohonanPelepasanTanahRizab extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanPermohonanPelepasanTanahRizab.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanPelepasanTanahRizab.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalTanahRizab(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalTanahRizabAbbrev(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalTanahRizab(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalTanahRizab(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalTanahRizab(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
		...
		//context.put("xml", model.generateXML("Laporan Permohonan Pelepasan Tanah Rizab Persekutuan"));
		
		String tajukLaporan = "Laporan Permohonan Pelepasan Tanah Rizab Persekutuan "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

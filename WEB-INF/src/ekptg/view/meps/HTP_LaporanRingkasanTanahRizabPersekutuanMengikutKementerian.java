...
public class HTP_LaporanRingkasanTanahRizabPersekutuanMengikutKementerian extends AjaxBasedModule{	
	/**
	 * 
	 */
	private static final long serialVersionUID = 5450205194170387994L;
	static Logger myLogger = Logger.getLogger(HTP_LaporanRingkasanTanahRizabPersekutuanMengikutKementerian.class);	
	// MODEL
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanRingkasanTanahRizabPersekutuanMengikutKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalRingkasanTanahRizabPersekutuanMengikutKementerian(id_tahun,id_bulan,"","");
    		...
    		id_tahun = getParam("socTahun");
    		id_bulan = getParam("socBulan");
    		getJenisLaporan=getParam("getJenisLaporan");
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Ringkasan Tanah Rizab Persekutuan Mengikut Kementerian"));

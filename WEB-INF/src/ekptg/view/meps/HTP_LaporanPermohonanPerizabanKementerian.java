...
public class HTP_LaporanPermohonanPerizabanKementerian extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanPermohonanPerizabanKementerian.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanPermohonanPerizabanKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPermohonanPerizabanMengikutKementerian(id_tahun,id_bulan);
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Permohonan Perizaban Mengikut Kementerian"));
		
		String tajukLaporan = "Laporan Permohonan Perizaban Mengikut Kementerian "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

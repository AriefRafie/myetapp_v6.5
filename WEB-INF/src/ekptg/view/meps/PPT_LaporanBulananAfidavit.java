...
public class PPT_LaporanBulananAfidavit extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PPT_LaporanBulananAfidavit.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/ppt/LaporanBulananAfidavit.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//GET LIST DATA
    		listPageDepan = model.getListTotalAfidavitAbbrev(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		if(linkPapar.equals("viewNegeri")){
    			listPageDepan = model.getListDaerahByNegeriTotalAfidavitAbbrev(Long.parseLong(idNegeri),id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		} else {
		...
		//context.put("xml", model.generateXML("Laporan Afidavit Menyimpan dan Mengeluarkan Pampasan"));
		
		String tajukLaporan = "Laporan Afidavit Menyimpan dan Mengeluarkan Pampasan "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

...
public class HTP_LaporanRingkasanTanahRizabBolehBangunMengikutKementerian extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanRingkasanTanahRizabBolehBangunMengikutKementerian.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanRingkasanTanahRizabBolehBangunMengikutKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalRingkasanRizabTanahBolehBangunMengikutKementerian(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Ringkasan Tanah Rizab Boleh Bangun Mengikut Kementerian"));
		
		String tajukLaporan = "Laporan Ringkasan Tanah Rizab Boleh Bangun Mengikut Kementerian "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

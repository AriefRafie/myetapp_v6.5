...
public class HTP_LaporanRingkasanTanahMilikPersekutuanMengikutKementerian extends AjaxBasedModule{	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2464966832743538180L;
	static Logger myLogger = Logger.getLogger(HTP_LaporanRingkasanTanahMilikPersekutuanMengikutKementerian.class);	
	// MODEL
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanRingkasanTanahMilikPersekutuanMengikutKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalRingkasanTanahMilikPersekutuanMengikutKementerian(id_tahun,id_bulan);
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Ringkasan Tanah Milik Persekutuan Mengikut Kementerian"));
		
		String tajukLaporan = "Laporan Ringkasan Tanah Milik Persekutuan Mengikut Kementerian "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

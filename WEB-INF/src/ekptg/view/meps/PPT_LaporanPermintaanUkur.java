...
public class PPT_LaporanPermintaanUkur extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PPT_LaporanPermintaanUkur.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/ppt/LaporanPermintaanUkur.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//GET LIST DATA
    		listPageDepan = model.getListTotalPUAbbrev_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		//GETLIST DATA
    		//listPageDepan = model.getListTotalPUAbbrev(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalPUAbbrev_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		context.put("refence", refence);
    		...
    		//GET LIST DATA
    		//listPageDepan = model.getListTotalPU(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalPUAbbrev_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		if(linkPapar.equals("viewNegeri")){
    			listPageDepan = model.getListDaerahByNegeriTotalPUAbbrev_add(Long.parseLong(idNegeri),id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		} else {
		...
		//context.put("xml", model.generateXML("Laporan Permintaan Ukur Pengambilan Tanah"));
		
		String tajukLaporan = "Laporan Permintaan Ukur Pengambilan Tanah "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

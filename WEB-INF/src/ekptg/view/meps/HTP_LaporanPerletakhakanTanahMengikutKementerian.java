...
public class HTP_LaporanPerletakhakanTanahMengikutKementerian extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanPerletakhakanTanahMengikutKementerian.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanPerletakhakanTanahMengikutKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPerletakhakanTanahMengikutKementerian(id_tahun,id_bulan);
	...
	vm = skrinDepanSenaraiLaporan;
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Perletakhakan Tanah Mengikut Kementerian"));
		
		String tajukLaporan = "Laporan Perletakhakan Tanah Mengikut Kementerian "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

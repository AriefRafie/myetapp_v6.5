...
public class PHP_LaporanJumlahPenawaran extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanJumlahPenawaran.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanPenawaran.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPenawaranAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalPenawaranAbbrev(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalPenawaranAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		//DEFAULT
    		context.put("refence", refence);
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalPelepasan(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		listPageDepan = model.getListTotalPenawaranAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		context.put("selectBulan",HTML.SelectBulan("socBulan", Utils.parseLong(id_bulan), null, "style=width:130px"));
           	...
           	//GET LIST DATA
			//listPageDepan = model.getListTotalPenawaran(id_tahun,id_bulan);				
    		listPageDepan = model.getListTotalPenawaranAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		context.put("PermohonanList", listPageDepan);
    		context.put("list_size", listPageDepan.size());  	
    		this.context.put("txdTarikhMula",txdTarikhMula);
		...
		//context.put("xml", model.generateXML("Laporan Jumlah Permohonan Penawaran"));
		
		String tajukLaporan = "Laporan Jumlah Permohonan Penawaran "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

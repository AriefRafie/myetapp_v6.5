...
public class HTP_LaporanRingkasanTanahBolehBangunMilikPersekutuanMengikutKementerian extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanRingkasanTanahBolehBangunMilikPersekutuanMengikutKementerian.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanRingkasanTanahBolehBangunMilikPersekutuanMengikutKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalRingkasanTanahBolehBangunMilikPersekutuanMengikutKementerian(id_tahun,id_bulan);
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Ringkasan Tanah Boleh Bangun Milik Persekutuan Mengikut Kementerian"));
		
		String tajukLaporan = "Laporan Ringkasan Tanah Boleh Bangun Milik Persekutuan Mengikut Kementerian "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

...
public class PPT_LaporanPampasanAmanahRaya extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PPT_LaporanPampasanAmanahRaya.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/ppt/LaporanPampasanAmanahRaya.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//GET LIST DATA
    		listPageDepan = model.getListJumlahPampasanAmanahRayaBerhadAbbrev_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		//GET LIST DATA
    		//listPageDepan = model.getListJumlahPampasanAmanahRayaBerhadAbbrev(id_tahun,id_bulan);
    		listPageDepan = model.getListJumlahPampasanAmanahRayaBerhadAbbrev_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		context.put("refence", refence);
    		...
    		//GET LIST DATA
    		listPageDepan = model.getListJumlahPampasanAmanahRayaBerhad_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		if(linkPapar.equals("viewNegeri")){
    			listPageDepan = model.getListDaerahByNegeriJumlahPampasanAmanahRayaBerhadAbbrev_add(Long.parseLong(idNegeri),id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		} else {
    		...
    		this.context.put("txdTarikhAkhir",txdTarikhAkhir);
           	//GET LIST DATA
			//listPageDepan = model.getListJumlahPampasanAmanahRayaBerhad(id_tahun,id_bulan);				
    		listPageDepan = model.getListJumlahPampasanAmanahRayaBerhad_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		context.put("PermohonanList", listPageDepan);
		...
		//context.put("xml", model.generateXML("Laporan Penyimpanan Pampasan di Amanah Raya Berhad Pengambilan Tanah"));
		
		String tajukLaporan = "Laporan Penyimpanan Pampasan di Amanah Raya Berhad "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

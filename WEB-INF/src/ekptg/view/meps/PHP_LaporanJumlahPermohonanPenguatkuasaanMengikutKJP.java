...
import ekptg.model.meps.PHP_modeldata;

public class PHP_LaporanJumlahPermohonanPenguatkuasaanMengikutKJP extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanJumlahPermohonanPenguatkuasaanMengikutKJP.class);
	
	// MODEL
	PHP_modeldata model = new PHP_modeldata();	
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanPenguatkuasaanMengikutKJP.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPenguatkuasaanAbbrevMengikutKJP(id_tahun,id_bulan);
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPenguatkuasaanAbbrevBaruMengikutKJP(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		//DEFAULT
    		context.put("refence", refence);
    		...
    		//DROPDOWN
    	     //listPageDepan = model.getListTotalPenguatkuasaan(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalPenguatkuasaanAbbrevBaruMengikutKJP(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		this.context.put("txdTarikhAkhir",txdTarikhAkhir);
           	//GET LIST DATA
			listPageDepan = model.getListTotalPenguatkuasaanMengikutKJP(id_tahun,id_bulan);				
		...
		//context.put("xml", model.generateXML("Laporan Jumlah Permohonan Penguatkuasaan"));
		
		String tajukLaporan = "Laporan Jumlah Permohonan Penguatkuasaan Mengikut KJP "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

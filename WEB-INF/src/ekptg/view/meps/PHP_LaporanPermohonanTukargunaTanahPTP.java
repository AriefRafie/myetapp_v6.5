...
public class PHP_LaporanPermohonanTukargunaTanahPTP extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanPermohonanTukargunaTanahPTP.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanTanahPTP.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalTukargunaTanahPTP(id_tahun,id_bulan);
		...
		context.put("xml", model.generateXML("Laporan Tanah Permohonan Tukarguna Tanah PTP"));

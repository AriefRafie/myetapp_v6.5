...
public class PHP_LaporanJumlahPermohonanPenguatkuasaanMengikutStatus extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanJumlahPermohonanPenguatkuasaanMengikutStatus.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanPenguatkuasaanMengikutStatus.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPenguatkuasaanAbbrevMengikutStatus(id_tahun,id_bulan);
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPenguatkuasaanAbbrevBaruMengikutStatus(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		//DEFAULT
    		context.put("refence", refence);
    		...
    		//DROPDOWN
    	     //listPageDepan = model.getListTotalPenguatkuasaanMengikutStatus(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalPenguatkuasaanAbbrevBaruMengikutStatus(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
		...
		String tajukLaporan = "Laporan Jumlah Permohonan Penguatkuasaan Mengikut Status "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

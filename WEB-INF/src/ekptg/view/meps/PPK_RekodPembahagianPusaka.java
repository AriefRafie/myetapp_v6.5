...
public class PPK_RekodPembahagianPusaka extends VTemplate {

	static Logger myLogger = Logger.getLogger(PPK_RekodPembahagianPusaka.class);
	...
	public Template doTemplate() throws Exception {
		...
		if ("Cari".equals(submit)) {
			...
			vm = "app/meps/ppk/frmSenaraiFailPusakaKecilRPP.jsp";
	...
	public void updateStatus(HttpSession session) throws Exception {
		...
		// faresh komen logic.updateStatus(h);

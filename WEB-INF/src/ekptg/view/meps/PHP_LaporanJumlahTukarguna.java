...
public class PHP_LaporanJumlahTukarguna extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanJumlahTukarguna.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanTukarguna.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalTukargunaAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		//DEFAULT
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalTukargunaAbbrev(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalTukargunaAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		//DEFAULT
    		context.put("refence", refence);
			vm = skrinDepanSenaraiLaporan;
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalTukarguna(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalTukargunaAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
		...
		//context.put("xml", model.generateXML("Laporan Jumlah Permohonan Tukarguna"));
		
		
		String tajukLaporan = "Laporan Jumlah Permohonan Tukarguna "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

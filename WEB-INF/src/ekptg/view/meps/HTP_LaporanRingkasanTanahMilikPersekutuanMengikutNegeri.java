...
public class HTP_LaporanRingkasanTanahMilikPersekutuanMengikutNegeri extends AjaxBasedModule{	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6515268235757949771L;
	static Logger myLogger = Logger.getLogger(HTP_LaporanRingkasanTanahMilikPersekutuanMengikutNegeri.class);	
	// MODEL
	...
	public String doTemplate2() throws Exception{		
    	...
    	String idNegeri = "";
     	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanRingkasanTanahMilikPersekutuanMengikutNegeri.jsp";
...
//		myLogger.info("socBulan :: "+id_bulan);
		...
		if("BarGraph".equals(submit)){ 		
			...
			txdTarikhAkhir = getParam("txdRTarikhAkhir");
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalRingkasanTanahMilikPersekutuanMengikutNegeriAbbrev(id_tahun,id_bulan);
    		if (getJenisLaporan.equals("negeri") || getJenisLaporan.equals("")){
    			if(idNegeri !=null && idNegeri.length()>0){
    				listPageDepan = model.getListTotalDaerahRingkasanTanahMilikPersekutuanMengikutNegeriAbbrev_baru(idNegeri,id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    				refence = "no";
    			} else {
    				listPageDepan = model.getListTotalRingkasanTanahMilikPersekutuanMengikutNegeriAbbrev_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    			}
    			
    		}else if ((getJenisLaporan.equals("kementerian"))){
    			listPageDepan = model.getListTotalRingkasanTanahMilikPersekutuanMengikutKementerian_baru(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		}
			...
			getJenisLaporan = getParam("jenis_laporan");
			txdTarikhMula = getParam("txdTarikhMula");
			txdTarikhAkhir = getParam("txdTarikhMula");
			idNegeri = getParam("socNegeri");
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalRingkasanTanahMilikPersekutuanMengikutNegeri(id_tahun,id_bulan);
		...
		//context.put("xml", model.generateXML("Laporan Ringkasan Tanah Milik Persekutuan Mengikut Negeri"));
		System.out.println("test"+getJenisLaporan);
		if (getJenisLaporan.equals("negeri")||getJenisLaporan.equals("") ){
		String tajukLaporan = "Laporan Ringkasan Tanah Milik Persekutuan Mengikut Negeri "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

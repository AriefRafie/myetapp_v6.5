...
public class PPT_LaporanPrestasiPermohonanBantahan extends AjaxBasedModule{
	static Logger myLogger = Logger.getLogger(PPT_LaporanPrestasiPermohonanBantahan.class);
	...
	public String doTemplate2() throws Exception{
		...
		if(main_command.equals("daerah"))
		{
			...
			this.context.put("list_daerahpejabat",list_daerahpejabat);
				...
				vm = "app/meps/ppt/LaporanPrestasiPermohonanBantahan.jsp";

...
public class HTP_LaporanRingkasanTanahCerobohMilikPersekutuanMengikutNegeri extends AjaxBasedModule{	
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanRingkasanTanahCerobohMilikPersekutuanMengikutNegeri.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		if(getJenisLaporan.equals("")||getJenisLaporan.equals("negeri")){
				listPageDepan = model.getListTotalRingkasanTanahCerobohMilikPersekutuanMengikutNegeriAbbrev(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
		...
		vm = skrinDepanSenaraiLaporan;
			...
			if(getJenisLaporan.equals("")||getJenisLaporan.equals("negeri")){
    			...
    			listPageDepan = model.getListTotalRingkasanTanahCerobohMilikPersekutuanMengikutDaerahAbbrev(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir,idNegeri);
        			refence = "no";
        		} else {
    				listPageDepan = model.getListTotalRingkasanTanahCerobohMilikPersekutuanMengikutNegeriAbbrev(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
        	}
		...
		if(getJenisLaporan.equals("")||getJenisLaporan.equals("negeri")){
			String tajukLaporan = "Laporan Ringkasan Pencerobohan Tanah Milik Persekutuan Mengikut Negeri "+(id_tahun.equals("")?"":" ("+id_tahun);
			if(!id_bulan.equals("")){			
			...
			this.context.put("tajukLaporan",tajukLaporan);
				...
				String tajukLaporan = "Laporan Ringkasan Pencerobohan Tanah Milik Persekutuan Mengikut Kementerian "+(id_tahun.equals("")?"":" ("+id_tahun);
				if(!id_bulan.equals("")){			
					tajukLaporan += " - "+ekptg.report.Utils.getBulan(Integer.parseInt(id_bulan));			
				}
				if (!txdTarikhMula.trim().equals("")&&!txdTarikhAkhir.trim().equals("") ) {

...
public class FrmLaporanPenggunaaneTaPP extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(FrmLaporanPenggunaaneTaPP.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/LaporanPenggunaaneTaPP.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListStatusPenggunaaneTaPP(id_tahun,id_bulan);
		...
		//context.put("xml", model.generateXML_MSColumn2D_Penggunaan(id_tahun,id_bulan,"Laporan Penggunaan eTaPP"));
		
		String tajukLaporan = "Statistik Penggunaan eTaPP "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			
			tajukLaporan += " - "+ekptg.report.Utils.getBulan(Integer.parseInt(id_bulan));			
		}
		tajukLaporan += (id_tahun.equals("")?"":")");
		context.put("xml", model.generateXML_MSColumn2D_Penggunaan(id_tahun,id_bulan,tajukLaporan));

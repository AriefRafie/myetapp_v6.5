...
public class PPKLaporanJumlahHartaNegeri extends AjaxBasedModule{	
	/**
	 * 
	 */
	private static final long serialVersionUID = -2543565142093803217L;
	static Logger myLog = Logger.getLogger(ekptg.view.meps.PPKLaporanJumlahHartaNegeri.class);
	...
	public String doTemplate2() throws Exception{		
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/ppk/LaporanJumlahHartaNegeri.jsp";
    	//TAB
    	String selectedTab = "";
...
//	 if("search_data".equals(submit)){
//		 
//		 idSubUrusan = getParam("socSuburusan").equals("")?"":getParam("socSuburusan");
//		 idNegeri = getParam("socNegeri").equals("")?"":getParam("socNegeri");
//         idTahun = getParam("socNegeri").equals("")?"":getParam("socTahun");
//         idTahunHingga = getParam("socTahunHingga").equals("")?"":getParam("socTahunHingga");
//          System.out.println("idNegeri"+idNegeri);
//          System.out.println(" idTahun "+idNegeri);
//          System.out.println(" idTahunHingga"+ idTahunHingga);
...
//     		}
// 		
//         listPageDepan = getMep().getJumlahHarta(idTahun,idTahunHingga,idNegeri,idSubUrusan);
//// 		//DROP DOWN
//	context.put("selectNegeri",HTML.SelectNegeri("socNegeri",Long.parseLong(idNegeri), "", ""));
...
//	 }else { 			
 		...
 		//DROP DOWN
 		context.put("selectNegeri",HTML.SelectNegeri("socNegeri",Long.parseLong("99999"), "", ""));
 		//context.put("selectTahun",getMepUtils().SelectTahun(this.getTahun(idNegeri),"socTahun" , idTahun, null, "style=width:130px"));
 		//context.put("selectTahunHingga",getMepUtils().SelectTahun(this.getTahun(idNegeri),"socTahunHingga", idTahunHingga, null, "style=width:130px"));
 		//GET LIST DATA 
 		ID_NEGERI = getParam("ID_NEGERI");
		...
		context.put("ID_PEJABATJKPTG", ID_PEJABATJKPTG);
 		...
 		listPageDepan = getMep().getJumlahHarta(ID_NEGERI, ID_PEJABATJKPTG, idTahun,idTahunHingga,idSubUrusan);
...
//    	}   
		...
		String tajukLaporan = "Laporan Jumlah Nilaian Harta Mengikut Tahun ";
		if(idSubUrusan != null){	
...
// METHOD --------------
	private Vector getTahun(String ID_NEGERI) throws Exception {
		...
		Vector v = new Vector();
		Hashtable h = null;
		Vector vecTahun = getMep().getJumlahHarta(ID_NEGERI, ID_PEJABATJKPTG, "","",idSubUrusan);

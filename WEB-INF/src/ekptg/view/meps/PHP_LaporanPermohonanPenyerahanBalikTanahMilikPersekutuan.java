...
public class PHP_LaporanPermohonanPenyerahanBalikTanahMilikPersekutuan extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PHP_LaporanPermohonanPenyerahanBalikTanahMilikPersekutuan.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/php/LaporanPermohonanPenyerahanBalikTanahMilikPersekutuan.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalSerahBalikTanah(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
		...
		//context.put("xml", model.generateXML("Laporan Permohonan Penyerahan Balik Tanah Milik Persekutuan"));
		
		String tajukLaporan = "Laporan Permohonan Penyerahan Balik Tanah Milik Persekutuan "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

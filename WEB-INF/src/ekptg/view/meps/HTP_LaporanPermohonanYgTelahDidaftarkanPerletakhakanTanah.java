...
public class HTP_LaporanPermohonanYgTelahDidaftarkanPerletakhakanTanah extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanPermohonanYgTelahDidaftarkanPerletakhakanTanah.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanPermohonanYgTelahDidaftarkanPerletakhakanTanah.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListPermohonanYgTelahDidaftarkanPerletakhakanTanahAbbrev(id_tahun,id_bulan);
    		...
    		//DROPDOWN
    		listPageDepan = model.getListPermohonanYgTelahDidaftarkanPerletakhakanTanah(id_tahun,id_bulan);
		...
		//context.put("xml", model.generateXML("Laporan Permohonan Yang Telah Didaftarkan Perletakhakan Tanah"));
		
		String tajukLaporan = "Laporan Permohonan Yang Telah Didaftarkan Perletakhakan Tanah "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

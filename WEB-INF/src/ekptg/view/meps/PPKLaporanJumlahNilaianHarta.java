...
public class PPKLaporanJumlahNilaianHarta extends AjaxBasedModule{	
	/**
	 * 
	 */
	...
	static Logger myLog = Logger.getLogger(PPKLaporanJumlahNilaianHarta.class);
	...
	public String doTemplate2() throws Exception{	
		...
		// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/ppk/LaporanNilaianHarta.jsp";
    	//TAB
    	String selectedTab = "";
...
//    	}   
		...
		String tajukLaporan = "Laporan Nialain Harta ";
		if(idSubUrusan != null){	

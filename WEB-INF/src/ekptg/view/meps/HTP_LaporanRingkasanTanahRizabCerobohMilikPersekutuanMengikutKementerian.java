...
public class HTP_LaporanRingkasanTanahRizabCerobohMilikPersekutuanMengikutKementerian extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanRingkasanTanahCerobohMilikPersekutuanMengikutKementerian.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanRingkasanTanahRizabCerobohMilikPersekutuanMengikutKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getTotalRingkasanTanahRizabCerobohMilikPersekutuanMengikutKementerian(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Ringkasan Tanah Rizab Ceroboh Milik Persekutuan Mengikut Kementerian"));
		
		String tajukLaporan = "Laporan Ringkasan Tanah Rizab Ceroboh Milik Persekutuan Mengikut Kementerian "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

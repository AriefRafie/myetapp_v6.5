...
public class PPT_LaporanPermohonanPengambilanUnit extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(PPT_LaporanPermohonanPengambilanUnit.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/ppt/LaporanPermohonanPengambilanUnit.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPermohonanUnitKod_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		...
    		//DROPDOWN
    		//listPageDepan = model.getListTotalPermohonanUnitKod(id_tahun,id_bulan);
    		listPageDepan = model.getListTotalPermohonanUnitKod_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
			vm = skrinDepanSenaraiLaporan;
    		...
    		//DROPDOWN
    	    listPageDepan = model.getListTotalPermohonanUnit_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		//listPageDepan = model.getListTotalPermohonanUnitKod_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
    		context.put("refence", "");
			...
			//GET LIST DATA
			//listPageDepan = model.getListTotalPermohonanUnit(id_tahun,id_bulan);
			//listPageDepan = model.getListTotalPermohonanUnitKod_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
			 listPageDepan = model.getListTotalPermohonanUnit_add(id_tahun,id_bulan,txdTarikhMula,txdTarikhAkhir);
		...
		//context.put("xml", model.generateXML("Laporan Jumlah Pengambilan Tanah Mengikut Cawangan Negeri"));
		
		String tajukLaporan = "Laporan Jumlah Pengambilan Tanah Mengikut Negeri "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

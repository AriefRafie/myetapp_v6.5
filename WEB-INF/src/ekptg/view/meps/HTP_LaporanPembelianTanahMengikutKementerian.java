...
public class HTP_LaporanPembelianTanahMengikutKementerian extends AjaxBasedModule{	
	static Logger myLogger = Logger.getLogger(HTP_LaporanPembelianTanahMengikutKementerian.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SKRIN JSP
    	String skrinDepanSenaraiLaporan = "app/meps/htp/LaporanPembelianTanahMengikutKementerian.jsp";
		...
		if("BarGraph".equals(submit)){ 
    		...
    		//DROPDOWN
    		listPageDepan = model.getListTotalPembelianTanahMengikutKementerian(id_tahun,id_bulan);
		...
		//context.put("xml", model.generateXMLKementerian("Laporan Pembelian Tanah Mengikut Kementerian"));
		
		String tajukLaporan = "Laporan Pembelian Tanah Mengikut Kementerian "+(id_tahun.equals("")?"":" ("+id_tahun);
		if(!id_bulan.equals("")){			

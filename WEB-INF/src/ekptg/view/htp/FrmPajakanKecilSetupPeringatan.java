...
public class FrmPajakanKecilSetupPeringatan extends AjaxBasedModule{
	...
	static Logger mylog = Logger.getLogger(ekptg.view.htp.FrmPajakanKecilSetupPeringatan.class);

	@SuppressWarnings("unchecked")
	public String doTemplate2()throws Exception {
		 
	    HttpSession session = this.request.getSession();
	    String template_name = "app/htp/frmPajakanKecilSetupPeringatan.jsp";
	    ...
	    mylog.info("equals("+submit+")::pageMode("+pageMode+")");
	    if (!("".equals(submit))) {

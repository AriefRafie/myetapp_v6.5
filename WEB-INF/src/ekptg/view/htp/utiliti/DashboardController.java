...
public class DashboardController extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3455784952255888227L;
	private final String PATH="app/htp/v6/utiliti/";
	...
	static Logger myLog = Logger.getLogger(ekptg.view.htp.utiliti.DashboardController.class);
	String userId = null;
	String role = null;

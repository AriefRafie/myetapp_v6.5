package ekptg.view.htp.online.ulasanKJP;
 ...
 *
 */
public class FrmPajakanKJPSenaraiFailView extends AjaxBasedModule {

	private final String PATH="app/htp/online/ulasanKJP/";
	...
	private static Logger myLog1 = Logger.getLogger(ekptg.view.htp.online.ulasanKJP.FrmPajakanKJPSenaraiFailView.class);
	...
	public String doTemplate2() throws Exception {
		...
		if (idKeputusan.equals("-1") || idKeputusan.trim().length() == 0){
			idKeputusan = "99999";
		}
		...
		if (postDB){
        	...
        	}else if (hitButton.equals("saveUpdateKJP2")){
        		saveUpdateUlasanKJP2(idUlasanKJP, session);
...
//    			myLog1.debug("** save draft **");
		...
		if (actionPajakan.equals("paparulasan")){
        	vm =PATH+"ulasan.jsp";
        ...
        // ULASAN 06/09/2020
    		...
    		if (idKeputusan.equals("") || idKeputusan.trim().length() == 0){
    			idKeputusan = "99999";
    		}

			this.context.put("sockeputusan",idKeputusan);
			list = getIHTP().getSenaraiFail(getParam("sockeputusan"), getParam("txtNoHakmilik"), getParam("txtNoRujukanKJP"),userID);
			this.context.put("SenaraiUlasanKJP", list);
        	...
        	vm = PATH+"index.jsp";
			list = getIHTP().getSenaraiFail("","","",userID);
...
//			}
		...
		private void saveUpdateUlasanKJP2(String idUlasanKJP, HttpSession session) throws Exception {
			Hashtable<String,String> hash = new Hashtable<String,String>();
			hash.put("noRujukanKJP", getParam("txtNoRujukanKJP"));
			hash.put("ulasan", getParam("txtUlasanKJP"));
			hash.put("status", getParam("socKeputusan"));
			logicmjm.updateUlasanKJP2(idUlasanKJP, hash, session);
    	...
    	try{
    		//Vector beanUlasanKJP = null;
       		if (mode.equalsIgnoreCase("newKJP")){
       			...
       			System.out.println("masuk newKJP");
       			Date today = new Date();
...
//    			this.context.put("BeanUlasanKJP", beanUlasanKJP);
            	...
            	this.context.put("classDis", "");
       			...
       			System.out.println("masuk viewKJP");
//       			beanUlasanKJP = new Vector();
...
//            	this.context.put("BeanUlasanKJP", beanUlasanKJP);
            ...
            //mode = update
       			...
       			System.out.println("masuk updateKJP");
       			ulasan = getIPMJM().getMaklumatUlasan(idUlasanKJP);
       			this.context.put("readOnly", "");
            	this.context.put("classDis", "");

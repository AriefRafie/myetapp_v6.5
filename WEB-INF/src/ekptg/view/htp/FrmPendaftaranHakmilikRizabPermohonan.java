...
public class FrmPendaftaranHakmilikRizabPermohonan extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	private final String PATH="app/htp/rekod/";
	private static Logger log = Logger.getLogger(ekptg.view.htp.FrmPendaftaranHakmilikRizabPermohonan.class);
...
//			 // VIEW MAKLUMAT RIZAB BY ID
	    	...
	    	if ("carian".equals(mode)) {
		    	...
		    	list = frmRekodUtilData.getHakmilikUrusanMengikutUrusan("1,10,");		    
		    }

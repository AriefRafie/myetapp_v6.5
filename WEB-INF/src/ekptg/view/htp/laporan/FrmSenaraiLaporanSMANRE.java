...
public class FrmSenaraiLaporanSMANRE extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4940705598365484047L;
	private final String PATH="app/htp/laporan/";
	private IHtpLaporan iLaporan = null;
	static Logger myLog = Logger.getLogger(ekptg.view.htp.laporan.FrmSenaraiLaporanSMANRE.class);
	String socNegeri = "";
	String socUnit = "";
	Vector<?> vecHash = null;
	...
	public String doTemplate2() throws Exception {
		...
		String vm = PATH+"frmSenaraiLaporanSMANRE.jsp";

...
import ekptg.model.utils.rujukan.UtilHTMLPilihanPerolehanLaporanRekod;

public class HTPRekodLaporan extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger myLog = Logger.getLogger(ekptg.view.htp.laporan.HTPRekodLaporan.class);
	
	private IHtpLaporan iLaporan = null;
	private IUtilHTMLPilihan iUrusanTanah = null;
	private final String PATH="app/htp/laporan/rekod/";
	String socNegeri = "";
	String socUnit = "";
	String socSuburusan = "";
	Vector<?> vecHash = null;
	...
	public String doTemplate2() throws Exception {
		...
		String vm = PATH+"indexLaporan.jsp";
...
//    		}
    	...
    	String sorTanah = getParam("sortanah");   	
    	String checkMilik = "";
    	String checkRizab = "";
    	String checkMR = "";
    	if(sorTanah.equals("1")){
			//checked laporan
    		checkMilik = "checked";		
		}else if(sorTanah.equals("2")){			
			//checked
			checkRizab = "checked";		
		}else if(sorTanah.equals("3")){		
			//checked
			checkMR = "checked";		
		}
		context.put("sorTanah",sorTanah);
		context.put("checkMilik",checkMilik);
		context.put("checkRizab",checkRizab);
		context.put("checkMR",checkMR);
...
//		this.context.put("txdAkhir", tarikhAkhir); 
	...
	private IUtilHTMLPilihan getUrusan(){
		if(iUrusanTanah==null){
			iUrusanTanah = new UtilHTMLPilihanPerolehanLaporanRekod();
		}
		return iUrusanTanah;

...
public class HTPRekodLaporanLain extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger myLog = Logger.getLogger(ekptg.view.htp.laporan.HTPRekodLaporanLain.class);
...
//		this.context.put("txdAkhir", tarikhAkhir); 
	...
	private IUtilHTMLPilihan getUrusan(){
		if(iUrusanTanah==null){
			iUrusanTanah = new UtilHTMLPilihanUrusanLaporanRekod();
		}
		return iUrusanTanah;

...
public class FrmSenaraiLaporanHTPPembelian extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger mylog = Logger.getLogger(ekptg.view.htp.FrmSenaraiLaporanHTPPembelian.class);
	String socNegeri = "";
	String socUnit = "";
	Vector<?> vecHash = null;
	...
	public String doTemplate2() throws Exception {
		...
		if(session == null)
			throw new Exception("[000]SESSI SUDAH TAMAT, SILA LOGIN SEMULA");
	...
	private void paparanRekod(int userLevel,String login) throws Exception{
		/*if(userLevel==1){
			...
			FrmUtilData frmUtilData = new FrmUtilData();
			vecHash = frmUtilData.getLaporanMengikutUrusan("25",null,"L");

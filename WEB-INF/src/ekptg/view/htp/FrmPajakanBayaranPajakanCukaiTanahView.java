...
public class FrmPajakanBayaranPajakanCukaiTanahView extends AjaxBasedModule{

	  private static final long serialVersionUID = 1L;
	  private static final String PATH="app/htp/pajakan/";
	  private static Logger log = Logger.getLogger(FrmPajakanBayaranPajakanCukaiTanahView.class);

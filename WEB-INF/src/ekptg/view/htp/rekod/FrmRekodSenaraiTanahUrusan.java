...
import ekptg.model.htp.rekod.FrmHakmilikRizabUrusanBean;
...
public class FrmRekodSenaraiTanahUrusan extends AjaxBasedModule {
	
	private final String PATH="app/htp/rekod/";
	private ITanah iHakmilik = null;
	private static final long serialVersionUID = 1L;
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.rekod.FrmRekodSenaraiTanahUrusan.class);
	...
	public String doTemplate2() throws Exception {
		...
		if("".equals(firstAction))	{
		   vm = PATH+"urusan/frmRekodIndexSenaraiHakmilikRizab.jsp";
...
//		//LIST HAKMILIK SAMBUNGAN
		...
		if("PendaftaranPembangunan".equals(firstAction)){
		   ...
		   } else //TAMBAH PEMBANGUNAN HAKMILIK BY ID HAKMILIK
		   ...
		   } else if("viewDetailKeluasan".equals(nextAction)){
			   this.context.put("readOnly", "readOnly");
		       this.context.put("disabled", "disabled");
		       this.context.put("mode", "view");
		   ...
		   }else if("kemaskiniDetailKeluasan".equals(nextAction)){
		       this.context.put("readOnly", "");
		       this.context.put("disabled", "");
		   ...
		   }else if("updateDetailKeluasan".equals(nextAction)){
		       this.context.put("readOnly", "");
		       this.context.put("disabled", "");
		       this.context.put("mode", "update");
		   ...
		   //DELETE REKOD IMAGE
		   } else if("deleteDetailPembangunan".equals(nextAction)){	  
		   ...
		   }else if("paparsahajakeluasanterperinci".equals(nextAction)){
	 ...
	 // VIEW MAKLUMAT FAIL BY ID (MASTER)
		...
		private ITanahCarian getIHakmilikRizab(){
			if (iHakmilikRizab == null){
				iHakmilikRizab = new FrmHakmilikRizabUrusanBean();
			}

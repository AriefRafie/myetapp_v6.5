package ekptg.view.htp.rekod.negeri;
...
public class XFrmSenaraiLaporanHTPRekodNegeri extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger myLog = Logger.getLogger(ekptg.view.htp.rekod.negeri.XFrmSenaraiLaporanHTPRekodNegeri.class);
	String socNegeri = "";
	String socUnit = "";
	Vector<?> vecHash = null;

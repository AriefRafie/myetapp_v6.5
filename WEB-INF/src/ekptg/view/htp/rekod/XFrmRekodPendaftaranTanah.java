...
public class XFrmRekodPendaftaranTanah extends AjaxBasedModule {
	...
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.rekod.XFrmRekodPendaftaranTanah.class);

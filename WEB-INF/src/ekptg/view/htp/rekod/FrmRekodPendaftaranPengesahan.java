...
import ekptg.model.htp.rekod.FrmHakmilikRizabPengesahanBean;
...
public class FrmRekodPendaftaranPengesahan extends AjaxBasedModule {
	...
	private ITanahCarian iTanahCarian = null;
 	private IHtp iHTP = null;  
 	private FrmHakmilikRizabPengesahanTanahBean iHakmilikRizabPengesahan = null;
	private IHTPSusulan iSusulan = null;
	private IHTPSusulan iSusulanPembangunan = null;
	private IHTPStatus iStatus = null;
	private static final long serialVersionUID = 1L;
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.rekod.FrmRekodPendaftaranPengesahan.class);
	...
	private String idKementerianKemasukan = "";
	...
	public String doTemplate2() throws Exception {
		...
		if (submit.equals("paparDetailHakmilik2")){	//[1.0] VIEW HAKMILIK BY ID - FUNGSI INI DIGUNA 
			FrmHakmilikRizabPengesahanTanahBean pengesahan = new FrmHakmilikRizabPengesahanTanahBean();
			
			vm = PATH+"pendaftaran/frmPendaftaranTerimaHakmilik.jsp";
			String idPermohonan = "";
			Hashtable hMaklumatFail = pengesahan.getPerolehanInfo("",idHakmilik);
			String idFail = String.valueOf(hMaklumatFail.get("idfail"));
			Permohonan permohonan = null;
			HtpPermohonan htpPermohonan = null;
			htpPermohonan = pengesahan.findPermohonan(idFail);
			myLog.info(idFail);
			myLog.info(htpPermohonan);
			if(htpPermohonan==null){
				myLog.info("null");
				//idPermohonan = htpPermohonan.getPermohonan().getIdPermohonan();
				idPermohonan = simpanPermohonan(session,"0","0",idFail);

			}else{
				myLog.info(htpPermohonan.getPermohonan().getIdPermohonan());
				idPermohonan = String.valueOf(htpPermohonan.getPermohonan().getIdPermohonan());
	
			}
			myLog.info(htpPermohonan+":idPermohonan="+idPermohonan);
			//doPaparDetailHakmilik2(list,idPermohonan);
		...
		if(firstAction.equals("")){
			...
			vm = PATH+"frmRekodSenaraiHakmilikRizabPengesahanIndex.jsp";
			if(!"".equals(skrin)){
		...
		//****************SECOND PAGE PROCESS **************************
			...
			String mode = "new";
			if (nextAction.equals("prepengesahan")){
				vm = PATH+"tanahmilik/frmPengesahanHakmilik.jsp";	
				mode = "new";
				this.context.put("mode",mode);				
				viewMaklumatFailPengesahan(idHakmilik); 					
				viewHakmilikPengambilan(idHakmilik,mode);
			...
			if (nextAction.equals("paparDetailHakmilik")){
				...
				if(isSambungan){	 
					//vm = PATH+"tanahmilik/frmRekodPendaftaranHakmilikSambunganView.jsp";	
	        	...
	        	// Kemaskini Oleh Rosli pada 20120718, Tab 
...
//		    // GET LUAS ASAL DAN BAKI TERKINI
	...
	private String viewMaklumatFailPengesahan(String idHakmilik) throws Exception {
		Vector list =null;
		FrmHakmilikRizabPengesahanTanahBean pengesahan = new FrmHakmilikRizabPengesahanTanahBean();
		...
		this.context.put("txtTajuk",(String)hMaklumatFail.get("tajukFail"));
		//this.context.put("txtNamaKementerian", (String)hMaklumatFail.get("namaKementerian"));
		this.context.put("txtNamaKementerian",UtilHTML.SelectKementerianAktif("txtIdKementerian", Utils.parseLong((String)hMaklumatFail.get("idkementerian")), null,"onChange=\"doChangeKementerianHakmilik()\" style=\"width:400px\""));
		...
		this.context.put("txtNamaMukim", (String)hMaklumatFail.get("namaMukim"));
		//this.context.put("txtNamaAgensi", (String)hMaklumatFail.get("namaAgensi"));
		this.context.put("txtNamaAgensi",HTML.SelectAgensiByKementerian("txtIdAgensi", (String)hMaklumatFail.get("idkementerian"), Utils.parseLong((String)hMaklumatFail.get("idagensi")), "", " style=\"width:400px\""));
		this.context.put("txtJenisHakmilik", (String)hMaklumatFail.get("jenisHakmilik"));
		this.context.put("txtFailKJP", (String)hMaklumatFail.get("noFailKjp"));
		this.context.put("txtNoWarta", (String)hMaklumatFail.get("noWarta"));
		this.context.put("txtNoHakmilik",(String) hMaklumatFail.get("noHakmilik"));
	...
	private String viewModeMaklumatFail(HttpSession session,String idHakmilik) throws Exception {
		...
		vector = geTanah().getPaparMaklumatFailById(idHakmilik);
...
//		}
		...
		private void viewHakmilikPengambilan(String idHakmilik,String mode) throws Exception {
			FrmHakmilikRizabPengesahanTanahBean pengesahan = new FrmHakmilikRizabPengesahanTanahBean();
...
//		}
		...
		public void doPaparDetailHakmilik2(Vector list,String idPermohonan) throws Exception {
//			myLog.debug("** doPaparDetailHakmilik2 **");
		...
		private void view_modeMaklumatFail(String idHakmilik) throws Exception {
		  ...
		  private String simpanPermohonan(HttpSession session,String idSubUrusan,String idAgensi,String idfail)throws Exception {
			  Hashtable data = null;
			  data = new Hashtable();
			  ...
			  System.out.println("simpan perhohonan id:"+idMasuk );
		      	...
		      	data.put("idSuburusan", Integer.parseInt(idSubUrusan));
		    	...
		    	return getPengesahanTanah().simpan(data);
		...
		private ITanahCarian getIHakmilikRizab(){
			if (iTanahCarian == null){
				iTanahCarian = new FrmHakmilikRizabPengesahanBean();
			}
			return iTanahCarian;
		}
	...
	private ITanahDaftar getPengesahanTanah(){
		if (iHakmilikRizabPengesahan == null){
			iHakmilikRizabPengesahan = new FrmHakmilikRizabPengesahanTanahBean();
		}

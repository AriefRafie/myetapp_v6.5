...
public class FrmRekodPendaftaranTanahReadOnly extends AjaxBasedModule {
	
	private final String PATH="app/htp/rekod/";
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(ekptg.view.htp.rekod.FrmRekodPendaftaranTanahReadOnly.class);
	String userId = "";
	...
	public String doTemplate2() throws Exception {
		...
		if("".equals(firstAction)){
		   ...
		   vm = PATH+"frmRekodSenaraiHakmilikRizabReadOnly.jsp";
		...
		if("PendaftaranHakmilik".equals(firstAction)){
			...
			if ("paparDetailHakmilik".equals(nextAction)){
			   ...
			   vm = PATH+"frmRekodPendaftaranHakmilikReadOnly.jsp";	
...
//				this.context.put("listSambungan",listSambungan);
			...
			// VIEW DETAIL RIZAB
			if ("paparDetailRizab".equals(nextAction)){
 
			   vm = PATH+"frmRekodPendaftaranRizabReadOnly.jsp";
	...
	private void uploadFiles() throws Exception {
	 ...
	 // VIEW MAKLUMAT FAIL BY ID (MASTER)
		...
		private void viewModeRizab(HttpSession session,String nextAction,String lastAction,String idNegeriHR, String idDaerahHR, String idMukimHR,String idJenisHakmilikHR, String idCaraBayar, String idJenisHakmilikBaru) throws Exception {
			log.info("viewModeRizab:nextAction="+nextAction);
			String idHakmilik = getParam("idHakmilik");
			Vector list =null;

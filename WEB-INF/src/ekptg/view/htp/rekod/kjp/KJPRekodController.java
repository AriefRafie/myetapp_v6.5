...
public class KJPRekodController extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	static Logger myLogger = Logger.getLogger(ekptg.view.htp.rekod.kjp.KJPRekodController.class);
	...
	public void getLuasPTPByNegeri(Vector listDbPTPByNegeri,FrmKjpRekodDB rekodDb) throws Exception{
    	...
    	if(listDbPTPByNegeri.size()!=0){
	    	for (int i = 0; i < listDbPTPByNegeri.size(); i++) { 
	    		...
	    		bilTanahMilik += Integer.parseInt(String.valueOf(ldb.get("bilTanahMilik")));
	    		bilTanahRizab += Integer.parseInt(String.valueOf(ldb.get("bilTanahRizab")));
	    		bilKeseluruhan += Integer.parseInt(String.valueOf(ldb.get("bilTanah")));
    	...
    	context.put("totalKeseluruhan",Utils.formatLuas(totalKeseluruhan));
       	context.put("bilTanahMilikAll",bilTanahMilik);
    	context.put("bilTanahRizabAll",bilTanahRizab);
    	context.put("bilKeseluruhan",bilKeseluruhan);
	...
	public void getDataHakmilik(Vector listDataHakmilik,FrmKjpRekodDB rekodDb,String idHakmilik) throws Exception{
		...
		context.put("jenis_tanah", no_hakmilik.equals("")?"RIZAB":"MILIK");

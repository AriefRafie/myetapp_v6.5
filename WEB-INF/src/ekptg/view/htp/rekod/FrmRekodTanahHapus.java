...
public class FrmRekodTanahHapus extends AjaxBasedModule {
	...
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.rekod.FrmRekodTanahHapus.class);
...
//				this.context.put("listSambungan",listSambungan);
               ...
               viewModeRizab(session,nextAction,lastAction,idNegeriHR,idDaerahHR,idMukimHR,idJenisHakmilikHR,idCaraBayar,idJenisHakmilikBaru);
			...
			}else if ("kemaskinidetailhakmiliksamb".equals(nextAction)){	
				 // 18/10/2010
				 vm = PATH+"frmRekodPendaftaranHakmilik.jsp";					
				 this.context.put("readonly", "");
				 this.context.put("disabled", "");	
			 ...
			 }else if ("kemaskiniDetailRizab".equals(nextAction)){	//KEMASKINI DETAIL MAKLUMAT RIZAB
	        	// Kemaskini Oleh Rosli pada 20110228, PATH 
			    //vm = "app/htp/frmRekodPendaftaranRizab.jsp";
				vm = PATH+"frmRekodPendaftaranRizab.jsp";
				...
				viewModeRizab(session,nextAction,lastAction,idNegeriHR,idDaerahHR,idMukimHR,idJenisHakmilikHR,idCaraBayar,idJenisHakmilikBaru);
			 ...
			 }else if ("updateDetailHakmilik".equals(nextAction)){	//UPDATE DETAIL MAKLUMAT HAKMILIK
				 //vm = "app/htp/frmRekodPendaftaranHakmilik.jsp";
				 vm = PATH+"frmRekodPendaftaranHakmilik.jsp";
			 	...
			 	//20/10/2010
			}else if ("papardetailhakmiliksamb".equals(nextAction)){

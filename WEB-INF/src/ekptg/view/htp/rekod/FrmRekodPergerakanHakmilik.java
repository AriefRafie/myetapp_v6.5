...
public class FrmRekodPergerakanHakmilik extends AjaxBasedModule {
	...
	public String doTemplate2() throws Exception {
		...
		if((submit.equals("doChanges")) || (submit.equals("record_listing"))){	
			...
			this.context.put("disabled", "disabled");
			this.context.put("mode", "view");
			FrmRekodPergerakanHakmilikData.hapus(idPergerakan);
			// VIEW MAKLUMAT FAIL
			viewMaklumatFailMengikutHakmilik(idHakmilik);
			// VIEW MAKLUMAT PERGERAKAN HAKMILIK BY ID
			listPergerakan = view_modeSenaraiPergerakanFail(session);
	...
	// PAPARAN HEADER, Dibuat pada 2012/09/06 (ekptg.view.htp.rekod.FrmRekodPendaftaranTanah)
	// Disalin/Kemaskini pada  2012/09/29

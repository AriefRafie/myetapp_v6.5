...
public class FrmRekodPendaftaranTanahReadOnlyAll extends AjaxBasedModule {
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(FrmRekodPendaftaranTanahReadOnlyAll.class);
	String userId = "";

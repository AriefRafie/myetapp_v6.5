...
public class FrmPendaftaranTanah extends AjaxBasedModule {
	...
	private ekptg.model.utils.IUtilHTMLPilihan iPilihanSek = null;
	...
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.rekod.FrmPendaftaranTanah.class);
	...
	public String doTemplate2() throws Exception {
		...
		//}else if (submit.equals("paparrizabterperinci")){	//[2.1]-TAMBAH RIZAB- DARI PERMOHONAN, SEKIRANYA TIADA RIZAB				
			...
			vm = PATH+"pendaftaran/frmPendaftaranTerimaRizab.jsp";
			myLog.info("submit:baru/paparrizabterperinci="+submit+",mode="+mode);
			myLog.info("submit:baru/paparrizabterperinci="+submit+",idPermohonan="+getParam("idPermohonan"));
			String idPermohonan = getParam("idPermohonan");	

			/** [2.2] JIKA MAKLUMAT RIZAB DALAM TABLE TBLHTPHAKMILIK SUDAH ADA/WUJUD */
			if(frmRekodUtilData.isHTPHakmilik(idPermohonan)){
				myLog.info("isHTPHakmilik = TRUE");
...
//				this.context.put("txtNoWarta", getParam("txtNoWarta") );
		...
		// Kemaskini pada 28/05/2013
			 ...
			 Hashtable<String,String> rizab = new Hashtable<String,String>();
			 String idPermohonan = getParam("idPermohonan");
			 String idHakmilik = getParam("idHakmilik");
...
//			 }else{
			 	 // HTP-12(b)
				 rizab.put("socSeksyen", getParam("socSeksyen"));

			 	idHakmilik = getIDaftaRizab().simpan(rizab);
			 ...
			 // Sub Urusan (1 = LAIN-LAIN RIZAB)
			 simpanKemaskiniFail("1",langkah);

		}else if (submit.equals("simpanRizab")){
			 vm = PATH+"pendaftaran/frmPendaftaranTerimaRizab.jsp";
			 //myLog.info("simpanRizab="+submit+",mode="+mode);
			 Hashtable<String,String> rizab = new Hashtable<String,String>();
			 String idPermohonan = getParam("idPermohonan");
			 String idHakmilik = getParam("idHakmilik");
			 //myLog.info("simpanRizab : idPermohonan="+idPermohonan+",idHakmilik="+idHakmilik);
			 idKementerianKemasukan = getParam("txtIdKementerian");
			 idAgensiKemasukan = getParam("txtIdAgensi");
			 rizab.put("idKementerian", idKementerianKemasukan);	//TBLHTPHAKMILIKAGENSI
			 rizab.put("idAgensi", idAgensiKemasukan);	//TBLHTPHAKMILIKAGENSI
		 ...
		 */			
			...
			String luasAsal = "";
			String idHakmilik = getParam("idHakmilik");	
			Hashtable<String,String> hRizabUpdate = new Hashtable<String,String>();
...
//			 }
			luasAsal = getTanah().getLuas(getParam("socLuas")
			 ...
			 hRizabUpdate.put("txtLuasLama",luasAsal);
			 ...
			 hRizabUpdate.put("txtNoSyit", getParam("txtNoSyit"));
			 ...
			 hRizabUpdate.put("socIdKementerian", idKementerianKemasukan);	
			 hRizabUpdate.put("socIdAgensi", idAgensiKemasukan);				 
			 ...
			 hakmilikAgensi.setLuasBersamaan(Utils.RemoveComma(getParam("txtLuas"))); //end 2017/11/16
			 hakmilikAgensi.setIdHakmilikAgensi(Long.parseLong(idAgensiKemasukan));
			 hakmilikAgensi.setIdKementerian(Long.parseLong(idKementerianKemasukan));
			 hakmilikAgensi.setIdKemaskini(Long.parseLong(userId));
			 ...
			 getIDaftaRizab().kemaskini(hRizabUpdate);
			...
			this.context.put("page3",false);
			list = new Vector();
			getIDaftar().hapus(getParam("idHakmilik"));
...
//		    			idnegeri,iddaerah,idmukim,"-1");
				...
				list = getIHTPFail().getSenaraiFailMengikutUrusans(null, "", ""
						, "", ""
						, "", "", ""
						, "1,10,2,5,4", "", ""
						,"", false);
...
//			    			idnegeri,iddaerah,idmukim,"-1");
	...
	//			myLog.info("getMaklumatRizabAwal:else idnegeri="+idnegeri+"iddaerah="+iddaerah);
			...
			this.context.put("changeLuas",submit);
			 ...
			 //e.printStackTrace();
			throw new Exception(getIHTP().getErrorHTML("[MODUL HTP REKOD] MASALAH RANGKAIAN[2] , SILA SEMAK RANGKAIAN DB METHOD getMaklumatRizabAwal(ekptg.view.htp.FrmPendaftaranHakmilikRizabRekod)"));
		}
...
//				this.context.put("selectDaerah", HTML.SelectDaerahByNegeri(idnegeri, "socDaerah", Utils.parseLong(iddaerah),""," onChange=\"doChangeDaerahRizab();\" style=\"width:300px\""));
	...
	//	 		myLog.info("getMaklumatRizabAwal:else changeTarafRizab");
			...
			throw new Exception(getIHTP().getErrorHTML("[MODUL HTP REKOD] MASALAH DATA[RIZAB 1] , HUBUNGI PENTADBIR SISTEM, " +
					"SILA SEMAK DATA BAGI PERMOHONAN "+idPermohonan+ " getMaklumatRizabMengikutPermohonan(ekptg.view.htp.FrmPendaftaranTanah)"));
		}
	...
	private void getMaklumatTanahAwal(String idPermohonan) throws Exception {	
		Hashtable<String,String> maklumatRizab = (Hashtable<String,String>)FrmRekodUtilData.getRizabUrusan(idPermohonan,null);
		myLog.info("getMaklumatTanahAwal:mode="+mode);
...
//					,String.valueOf( getParam("socjenisrizab")), " style=\"width:200px\""," "));
			...
			this.context.put("selectMukim", HTML.SelectMukimByDaerah(iddaerah, "socMukim"
					, Utils.parseLong(idmukim)," style=\"width:300px\""));

			this.context.put("selectSeksyen", getPilihanSek().Pilihan("socSeksyen", "",idmukim));

			this.context.put("selectLot", HTML.SelectLot("socLot"
					,Utils.parseLong( String.valueOf(getParam("socLot"))),"style=\"width:200px\""));
...
//				}
				...
				this.context.put("socjenisrizab"
					,getIUtilPilihan().Pilihan("socjenisrizab"
	...
	private void view_modeHakmilikRizab(HttpSession session,String submit) throws Exception {
		...
		}else if(submit.equals("updateDetailHakmilik")|| submit.equals("updateDetailRizab")||submit.equals("paparDetailHakmilik")||submit.equals("paparDetailRizab")){
			//this.context.put("selectLuas", HTML.SelectLuas("socLuas",Utils.parseLong((String)hHakmilik.get("idLuas")), "disabled"," style=\"width:200px\" class=\"disabled\""));
			this.context.put("selectLuas", HTML.SelectLuas("socLuas",Utils.parseLong((String)hHakmilik.get("idLuasLama")), "disabled"," style=\"width:200px\" class=\"disabled\""));
			this.context.put("selectKategori", HTML.SelectKategori("socKategori",Utils.parseLong((String)hHakmilik.get("idKategori")), "disabled"," style=\"width:200px\" class=\"disabled\""));
...
//					 "MASALAH RANGKAIAN[4] , SILA SEMAK RANGKAIAN DB METHOD doInitMaklumatFail(ekptg.view.htp.FrmPendaftaranTanah)"));
	...
	public void doInitMaklumatHakmilik(String mode,String idHakmilik) throws Exception {
		//myLog.info("\ndoInitMaklumatHakmilik masuk siniiiiiiiiiiiiiiiiii("+mode+","+idHakmilik+")");	
		if ("".equals(idHakmilik)) 
			idHakmilik = "-1";
		
		Hashtable<String,String> maklumatHakmilik = null;
		if (mode.equals("byIdPermohonan")) {
			//myLog.info("\nbyIdPermohonan");	
			maklumatHakmilik = (Hashtable<String,String>)frmRekodUtilData.getDetailHakmilikByIdPermohonan(idHakmilik);
		} else {
			//myLog.info("\nTidak byIdPermohonan");	
			maklumatHakmilik = (Hashtable<String,String>)frmRekodUtilData.getDetailHakmilik(idHakmilik);	
		}
		...
		//		this.context.put("txtNamaKementerian",maklumatHakmilik.get("namakementerian"));
			//}else{
			// 2013/04/10
			//System.out.println("txtIdKementerian--------"+maklumatHakmilik.get("idkementerian"));
			this.context.put("txtNamaKementerian",UtilHTML.SelectKementerian("txtIdKementerian", Utils.parseLong((String)maklumatHakmilik.get("idkementerian")), style,"onChange=\"doChangeKementerianHakmilik()\" style=\"width:400px\""));
			// 2013/07/19
	...
	public void doGetListBox() throws Exception {
		try{
			...
			if (mode.indexOf("doChange") != -1){
			 ...
			 e.printStackTrace();
			 throw new Exception(getIHTP().getErrorHTML(
					 "[MODUL HTP REKOD] MASALAH RANGKAIAN[1], SILA SEMAK RANGKAIAN DB METHOD doGetListBox("+this.className+")"));
		
		}
		
	}
	
	public void getPilihanRizab() throws Exception {
		myLog.info("getPilihanRizab:mode="+mode);
		try{
			//26/10/2010 Buka komen, diguna untuk kemaskini hakmilik(pilih negeri),param id_negeri  
			idnegeri = getParam("socNegeri");if ("".equals(idnegeri)) idnegeri = "-1";
			iddaerah = getParam("socDaerah");if ("".equals(iddaerah)) iddaerah = "-1";
			...
			//26/10/2010 Buka komen, diguna untuk kemaskini hakmilik(pilih negeri)  
			this.context.put("selectNegeri",HTML.SelectNegeri("socNegeri",Utils.parseLong(idnegeri)," onChange=\"doChangeStateRizab();\""));	
			this.context.put("selectDaerah", HTML.SelectDaerahByNegeri(idnegeri, "socDaerah", Utils.parseLong(iddaerah),"$readonly class=\"$disabled\""," onChange=\"doChangeDaerahRizab();\""));
			this.context.put("selectMukim", HTML.SelectMukimByDaerah(iddaerah, "socMukim", Utils.parseLong(idmukim),"$readonly class=\"$disabled\"","onChange=\"doChangeMukimRizab();\""));
			...
			if (mode.indexOf("doChange") != -1){
			 ...
			 e.printStackTrace();
			 throw new Exception(getIHTP().getErrorHTML(
					 "[MODUL HTP REKOD] MASALAH RANGKAIAN[1], SILA SEMAK RANGKAIAN DB METHOD getPilihanRizab("+this.className+")"));
	...
	public void doPaparDetailHakmilik2(Vector<Hashtable<String, String>> list) throws Exception {
...
//				}
			...
			//Langkah Ketiga (3)
				...
				doInitMaklumatHakmilik(null,idTanah);
				this.context.put("readOnly",readOnly);
			 	this.context.put("disabled",disabled);	
			...
			// Langkah Ketiga (4)
				...
				myLog.debug("mode= update||kemaskini");
				readOnly = "";
				disabled = "";
				style = "";
				this.context.put("page2",false);
				...
				doInitMaklumatHakmilik(mode,idTanah);
				//this.context.put("mode", "update");
			 	//mode = "update";
...
//				}
				...
				doInitMaklumatFail(String.valueOf(hakmilik.getIdPermohonan()));
				doInitMaklumatHakmilik("",idTanah);
				this.context.put("readOnly",readOnly);
			 	this.context.put("disabled",disabled);	
				//this.context.put("mode", "doView");
			 	//mode = "view";
	...
	public String doInsertDetailHakmilik2() throws Exception {
		 ...
		 try {
			 ...
			 String noTanah = getTanah().getKodJenisHakmilik(getParam("socJenisHakmilik"))+getParam("txtNoHakmilik")+ ", "+getKodLot().getKod(getParam("noLot"))+getParam("txtNoLot");
...
//				 hHakmilikUpdate.put("no_fail_ptd", getParam("txtFailPTD")); 
				 hHakmilikUpdate.put("txtNoFailPTG", getParam("txtFailPTG")); 
				 hHakmilikUpdate.put("txtNoFailPTD", getParam("txtFailPTD")); 
				 // 2018/01/29
...
//				 hHakmilikUpdate.put("id_mukim", idmukim); 
				 ...
				 hHakmilikUpdate.put("socDaerahHR", getParam("socDaerah"));
				 hHakmilikUpdate.put("socMukimHR", getParam("socMukim"));
				 //hHakmilikUpdate.put("socSeksyenHR", getParam("socSeksyen"));
//				 hHakmilikUpdate.put("id_lot", getParam("noLot")); 
//				 hHakmilikUpdate.put("no_lot", getParam("txtNoLot")); 
				 hHakmilikUpdate.put("socLot", getParam("noLot")); 
				 hHakmilikUpdate.put("txtNoLot", getParam("txtNoLot")); 
...
//				 hHakmilikUpdate.put("tarikh_daftar",getParam("txdTarikhDaftar"));	
				 ...
				 hHakmilikUpdate.put("luasBersamaan",Utils.RemoveComma(getParam("txtLuas")));	
...
//				 hHakmilikUpdate.put("peganganHakmilik", ph);
...
//				 hHakmilikUpdate.put("tarikh_daftar",getParam("txdTarikhDaftar"));	
				 hHakmilikUpdate.put("socJenisHakmilik", getParam("socJenisHakmilik")); 
...
//				 hHakmilikUpdate.put("kawasan_rizab",getParam("txtKawasanRizab"));	
				 hHakmilikUpdate.put("noRizab",	getParam("txtNoWarta"));	
				 hHakmilikUpdate.put("tarikhRizab",getParam("txdTarikhWarta"));	
				 hHakmilikUpdate.put("idRizab",getParam("socJenisRizab"));	
...
//				 hHakmilikUpdate.put("id_subkategori",FrmUtilData.getSubCategory((String)getParam("socKategori")));
				 hHakmilikUpdate.put("idKategori",getParam("socKategori"));
				 hHakmilikUpdate.put("idSubKategori",FrmUtilData.getSubCategory((String)getParam("socKategori")));
				 hHakmilikUpdate.put("sekatan",getParam("txtSekatan"));	
				 hHakmilikUpdate.put("syarat",getParam("txtSyarat"));	
				 
				 //table tblhtphakmilikperihal
				 //hHakmilikUpdate.put("kegunaan_tanah",getParam("txtKegunaanTanah"));				 
				 myLog.info("id_kementerian============"+idKementerianKemasukan);
				 myLog.info("idAgensiKemasukan============"+idAgensiKemasukan);								 
...
//	}
	...
	private ekptg.model.utils.IUtilHTMLPilihan getPilihanSek(){
		if(iPilihanSek==null){
			iPilihanSek = new UtilHTMLPilihanSeksyenUPI();
		}
		return iPilihanSek;

...
import ekptg.model.htp.FrmPenswastaanPopupSenaraiTanahData;

/**
 * 
 *
 */
public class FrmPenswastaanPopupSenaraiTanahView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmPenswastaanPopupSenaraiTanahData logic = new FrmPenswastaanPopupSenaraiTanahData();
	...
	public String doTemplate2() throws Exception {
		...
		if ("simpanHakmilik".equals(hitButton)){
			logic.saveHakmilikUrusan(idHakmilik, idPermohonan, getParam("socTindakanLanjut"), session);
		}
	    
	    if ("papar".equals(actionPopup)){
	    	
	    	//GO TO DETAIL MAKLUMAT TANAH        	
        	vm = "app/htp/frmPenswastaanPopupMaklumatTanah.jsp";
	    	...
	    	//GO TO LIST TANAH        	
        	vm = "app/htp/frmPenswastaanPopupSenaraiTanah.jsp";        	

...
public class PajakanDisplayBlob implements IServlet2{
	...
	static Logger myLogger = Logger.getLogger(PajakanDisplayBlob.class);
	...
	public void doService(HttpServletRequest request, HttpServletResponse response,
			...
			Db db = null;
			 try {
		            ...
		            PreparedStatement ps = con.prepareStatement("select content_derafperjanjian,mimetype,nama_fail from TBLHTPDERAFPERJANJIAN where id_derafperjanjian = ?");

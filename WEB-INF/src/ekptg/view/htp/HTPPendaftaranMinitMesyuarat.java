...
import ekptg.model.htp.FrmDaftarMinitMesyuaratData;
import ekptg.model.htp.FrmKemaskiniMinitMesyuaratData;

public class HTPPendaftaranMinitMesyuarat extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = -564563614531994339L;
	static Logger myLog = Logger.getLogger(ekptg.view.htp.HTPPendaftaranMinitMesyuarat.class);
	...
	public String doTemplate2() throws Exception{
        ...
        if ("tambah".equals(command)){
        	...
        	vm = "app/htp/frmKemaskiniMinitMesyuarat.jsp";
       	 ...
       	 vm = "app/htp/frmDaftarMinitMesyuarat.jsp";

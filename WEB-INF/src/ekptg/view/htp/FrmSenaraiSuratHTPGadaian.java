...
public class FrmSenaraiSuratHTPGadaian extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(ekptg.view.htp.FrmSenaraiSuratHTPGadaian.class);
	Vector<?> vecHash = null;
    String IDURUSAN = "108";
	...
	public String doTemplate2() throws Exception {
		...
		if("SenaraiPermohonan".equals(submit)){
			...
			FGA.ListPermohonan(session, idFail,"", carian);

...
public class HTPSubmodulGadaian16N extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5838716042887991776L;
	private final String PATH="app/htp/6.0/gadaian/";
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.gadaian.HTPSubmodulGadaian.class);
...
//				list = FrmGadaianSenaraiPermohonanData.getListPermohonan();
				...
				vm = PATH+"frmGadaianPemilikPeguam.jsp";
				getPermohonanInfo();
	...
	private String SimpanFailBaru(HttpSession session) throws Exception {
		...
		try{
			if(getParam("idFail") == ""){
				...
				myLog.info("GadaianProcessA::SimpanFailBaru:: h = " + h);
				idFail = FrmGadaianSemakan1Data.simpan(h);
				result = "baru";

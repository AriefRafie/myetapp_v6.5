...
public class FrmPendaftaranHakmilikRizabRekod extends AjaxBasedModule {
	...
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.FrmPendaftaranHakmilikRizabRekod.class);
	...
	String style = "";
 	String userId = "";
	String vm = PATH+"frmPendaftaranHakmilikRizabSenarai.jsp";

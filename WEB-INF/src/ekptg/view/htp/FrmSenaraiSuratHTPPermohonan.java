...
public class FrmSenaraiSuratHTPPermohonan extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger mylog = Logger.getLogger(ekptg.view.htp.FrmSenaraiSuratHTPPermohonan.class);
	String socNegeri = "";
	String socUnit = "";
	Vector<?> vecHash = null;
	Vector<?> vecRekod = null;
	String socDaerah = "";
    String idUrusan = "1,10";
	...
	public String doTemplate2() throws Exception {
    	...
    	user = PrepareUser.getUserById(userId);
 		...
 		if("surat".equals(submit)){//senarai surat
			...
			Vector list1 = FrmUtilData.getSenaraiFailMengikutUrusanDanPengguna(idUrusan, key_cari,keyNo_cari,""+idNegeri,null);

 ...
 * @author Firzan.Fir
 */
public class XFrmPajakanMemorandumJemaahMenteriView extends AjaxBasedModule {

    private static final long serialVersionUID = 1L;
    private static Logger log = Logger.getLogger(XFrmPajakanMemorandumJemaahMenteriView.class);

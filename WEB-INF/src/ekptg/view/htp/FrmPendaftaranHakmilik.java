...
public class FrmPendaftaranHakmilik extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	private final String PATH="app/htp/rekod/";
	private static Logger log = Logger.getLogger(ekptg.view.htp.FrmPendaftaranHakmilik.class);
	...
	public String doTemplate2() throws Exception {
		...
		if ("".equals(submit)){
			...
			this.context.put("SenaraiHakmilik", list); 
			 ...
			 /* AZAM 
			 String idHakmilik = FrmUtilData.insertHTPHakmilik(hHakmilikUpdate);

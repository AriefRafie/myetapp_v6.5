 ...
 *
 */
public class FrmPenswastaaan2CadanganProjekView extends AjaxBasedModule {
	
 	private IHTPFail iHTPFail = null;  
	private static final long serialVersionUID = 1L;
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.FrmPenswastaaan2CadanganProjekView.class);	

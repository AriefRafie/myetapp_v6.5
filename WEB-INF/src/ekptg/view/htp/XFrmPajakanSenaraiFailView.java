 ...
 *
 */
public class XFrmPajakanSenaraiFailView extends AjaxBasedModule {
	...
	private static Logger log = Logger.getLogger(ekptg.view.htp.XFrmPajakanSenaraiFailView.class);

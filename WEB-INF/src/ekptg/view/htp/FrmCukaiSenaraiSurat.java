...
public class FrmCukaiSenaraiSurat extends AjaxBasedModule {	
	/**
	 * 
	 */
	private static final long serialVersionUID = -6366949383289282002L;
	static Logger myLog = Logger.getLogger(FrmCukaiSenaraiSurat.class);
	...
	public String doTemplate2() throws Exception	{
	    ...
	    if("memo".equals(submit)){
    		...
    		template_name = "app/htp/frmCukaiSenaraiFailSurat.jsp";

...
public class FrmSenaraiLaporanHTPPenswastaan extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger mylog = Logger.getLogger(ekptg.view.htp.FrmSenaraiLaporanHTPPenswastaan.class);
	String socNegeri = "";
	String socUnit = "";
	Vector<?> vecHash = null;
	...
	private void paparanRekod(int userLevel,String login) throws Exception{
		if(userLevel==1){
			...
			vecHash = FrmUtilData.getLaporanMengikutUrusan("8,9,10,11",null,"L");

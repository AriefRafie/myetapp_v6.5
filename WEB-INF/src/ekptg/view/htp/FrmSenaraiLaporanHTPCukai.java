...
public class FrmSenaraiLaporanHTPCukai extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger mylog = Logger.getLogger(ekptg.view.htp.FrmSenaraiLaporanHTPCukai.class);
	String socNegeri = "";
	String socUnit = "";
	Vector<?> vecHash = null;
	...
	private void paparanRekod(int userLevel,String login) throws Exception{
		if(userLevel==1){
			...
			vecHash = FrmUtilData.getLaporanMengikutUrusan(idSubUrusan,null,"L");			
		}

...
public class PajakanDisplayBlob implements IServlet2{
	
	static Logger myLogger = Logger.getLogger(ekptg.view.htp.pajakan.PajakanDisplayBlob.class);
	...
	public void doService(HttpServletRequest request, HttpServletResponse response,
			...
			Db db = null;
			 try {
		            ...
		            PreparedStatement ps = con.prepareStatement("select content_derafperjanjian,mimetype,nama_fail from TBLHTPDERAFPERJANJIANATTACH where id_derafperjanjian = ?");
		            String id = request.getParameter("idderaf");
		            ps.setString(1,id);

...
public class FrmPajakanUtamaPeringatanKJP extends AjaxBasedModule{
	/**
	 * 
	 */
	...
	static Logger myLog = Logger.getLogger(ekptg.view.htp.pajakan.FrmPajakanUtamaPeringatanKJP.class);
	...
	public String doTemplate2()throws Exception {
	    ...
	    String template_name = PATH+"peringatan/KJPIndex.jsp";
...
// PAGE 1
	    	...
	    	senaraiFail = getIHTPP().getSenaraiPeringatan15("", "3","","","");
	    }

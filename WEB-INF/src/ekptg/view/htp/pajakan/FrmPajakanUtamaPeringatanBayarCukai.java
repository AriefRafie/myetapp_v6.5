...
public class FrmPajakanUtamaPeringatanBayarCukai extends AjaxBasedModule{
	/**
	 * 
	 */
	...
	static Logger myLog = Logger.getLogger(ekptg.view.htp.pajakan.FrmPajakanUtamaPeringatanBayarCukai.class);
	...
	public String doTemplate2()throws Exception {
	    ...
	    String template_name = PATH+"peringatan/bayarCukaiindex.jsp";

...
public class FrmPKSuratPerjanjianTLengkap extends VTemplate {

 	/**
	 * 
	 */
	private static final long serialVersionUID = 7057940530685052503L;
	static Logger mylog = Logger.getLogger(ekptg.view.htp.FrmPKSuratPerjanjianTLengkap.class);
 	@Override
	public Template doTemplate() throws Exception {
    	
    	HttpSession session = this.request.getSession();

    	String vm = "app/htp/frmPKSuratPerjanjianTLengkap.jsp";

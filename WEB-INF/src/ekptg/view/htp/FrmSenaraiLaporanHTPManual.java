...
public class FrmSenaraiLaporanHTPManual extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger myLog = Logger.getLogger(ekptg.view.htp.FrmSenaraiLaporanHTPManual.class);
	String socNegeri = "";
	String socUnit = "";
	Vector<?> vecHash = null;
	...
	public String doTemplate2() throws Exception {
		...
		String vm = "app/htp/frmSenaraiLaporanHTPManual.jsp";
	...
	private void paparanRekod(int userLevel,String login) throws Exception{
		if(userLevel==1){
			...
			vecHash = FrmUtilData.getLaporanMengikutUrusan(s,null,"L");

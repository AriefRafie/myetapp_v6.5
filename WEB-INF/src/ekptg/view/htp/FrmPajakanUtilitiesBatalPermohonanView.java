 ...
 *
 */
public class FrmPajakanUtilitiesBatalPermohonanView extends AjaxBasedModule {
	
	 private static final long serialVersionUID = 1L;
	 private static Logger log = Logger.getLogger(FrmPajakanUtilitiesBatalPermohonanView.class);

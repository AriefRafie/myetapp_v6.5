...
import ekptg.model.htp.frmSenaraiFailPenswastaanData;

public class frmSenaraiFailPenswastaan extends AjaxBasedModule {
	static Logger myLogger = Logger.getLogger(frmSenaraiFailPenswastaan.class);
	...
	throws Exception
    {
    	...
    	String vm = "app/htp/frmSenaraiFailPenswastaan.jsp";
...
//     	Vector list = null;
     	...
     	myLogger.info("frmSenaraiFailPenswastaan submit:"+submit);
...
//    		this.context.put("selectKementerian", HTML.SelectKementerian("socKementerian",Long.parseLong(""+idKementerian),""));
...
//    		this.context.put("selectStatusTanah", HTML.SelectJenisTanah("socStatusTanah"));
    		...
    		//no_fail_seksyen = id_negeri + "TEST" ;
...
//    		socNegeri = HTML.SelectNegeri("socNegeri", (idNegeri == 0) ? null : Long.parseLong(pilihanIdNegeri), null);
    		...
    		if ("papar".equals(action)){
				...
				this.context.put("readonly", "");
				this.context.put("inputTextClass", "");
	    		//this.context.put("socNegeri1", HTML.SelectNegeri("socNegeri",Long.parseLong(""+idNegeri),""));
    		...
    		} else if("nextscreen".equals(action)){
    			vm = "app/htp/frmMesyuarat.jsp";
    		
    			myLogger.info("backToList");	
    		} else if("backToList".equals(action)){
    			vm = "app/htp/frmSenaraiFailPenswastaan.jsp";
    			
    		} else if("namaPengarah".equals(action)){
    			vm = "app/htp/frmpenswastaanTambahPengarah.jsp";
    			//if (maklumatSyarikat.size() != 0){
    				//view maklumat syarikat
    				this.context.put("mode", "view");
    				this.context.put("readonly", "readonly");
    		...
    		}else if("backToMklmatSykt".equals(action)){
    			vm = "app/htp/frmMaklumatSyarikat.jsp";
...
//  		Vector list = cariFail(nofail,namafail,idNegeri);
	...
	private void simpanKemaskiniPemaju(HttpSession session) throws Exception {
		...
		frmSenaraiFailPenswastaanData.updateSimpanPemaju(h);
	...
	private void simpanpemaju(HttpSession session)throws Exception {
		...
		frmSenaraiFailPenswastaanData.addSimpanPemaju(h);

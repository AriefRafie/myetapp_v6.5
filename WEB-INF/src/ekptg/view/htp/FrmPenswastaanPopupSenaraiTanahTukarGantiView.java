...
import ekptg.model.htp.FrmPenswastaanPopupSenaraiTanahTukarGantiData;

/**
 * 
 *
 */
public class FrmPenswastaanPopupSenaraiTanahTukarGantiView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmPenswastaanPopupSenaraiTanahTukarGantiData logic = new FrmPenswastaanPopupSenaraiTanahTukarGantiData();
	...
	public String doTemplate2() throws Exception {
		...
		if ("pilihTanah".equals(hitButton)){
			logic.pilihTanah(idHakmilik, idPermohonan, session);
		}
	    
	    if ("papar".equals(actionPopup)){
	    	
	    	//GO TO DETAIL MAKLUMAT TANAH        	
        	vm = "app/htp/frmPenswastaanPopupMaklumatTanahTukarGanti.jsp";
	    	...
	    	//GO TO LIST TANAH        	
        	vm = "app/htp/frmPenswastaanPopupSenaraiTanahTukarGanti.jsp";        	

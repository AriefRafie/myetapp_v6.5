...
public class FrmPendaftaranHakmilikRizabCukai extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	private final String PATH="app/htp/rekod/";
	private static Logger log = Logger.getLogger(ekptg.view.htp.FrmPendaftaranHakmilikRizabCukai.class);
	...
	public String doTemplate2() throws Exception {
		...
		if ("".equals(submit)){
			...
			log.debug("***  submit=paparDetailRizab2,mode="+mode);
			...
			//JIKA MAKLUMAT RIZAB YANG BARU, BERSEDIA UNTUK DISIMPAN
					...
					String idDaerah = getParam("socDaerah");
				 	...
				 	if (mode.toLowerCase().indexOf("change") != -1) {
						...
						this.context.put("txtNamaKementerian",HTML.SelectKementerian("txtIdKementerian", Utils.parseLong((String)getParam("txtIdKementerian")), null,"onChange=\"doChangeKementerianRizab()\" "));
						this.context.put("txtNamaAgensi",HTML.SelectAgensiByKementerian("txtIdAgensi", (String)getParam("txtIdKementerian"), Utils.parseLong((String)getParam("txtIdAgensi")), "", ""));
			...
			viewMaklumatRizab(list,dis,submit);
				...
				log.debug("** kemaskiniMaklumatRizab **");
			    vm = PATH+"frmPendaftaranTerimaRizab.jsp";
			    String idPermohonan = getParam("idPermohonan");
			    String dis = "";
				this.context.put("readonly", "");
	    	...
	    	if ("carian".equals(mode)) {
		    	...
		    	list = frmRekodUtilData.getHakmilikUrusanMengikutUrusan("11");		    
		    }
...
//			this.context.put("txtNamaAgensi", (String)maklumatFail.get("agensi"));
			this.context.put("txtNamaKementerian",HTML.SelectKementerian("txtIdKementerian", Utils.parseLong((String)getParam("txtIdKementerian")), null,"onChange=\"doChangeKementerianRizab()\" "));
			this.context.put("txtNamaAgensi",HTML.SelectAgensiByKementerian("txtIdAgensi", (String)getParam("txtIdKementerian"), Utils.parseLong((String)getParam("idagensi")), "", ""));
...
//			this.context.put("txtIdAgensi", (String)maklumatFail.get("idagensi"));	
//			this.context.put("txtNamaAgensi", (String)maklumatFail.get("agensi"));
			this.context.put("txtNamaKementerian",HTML.SelectKementerian("txtIdKementerian", Utils.parseLong((String)maklumatFail.get("idkementerian")), null,"onChange=\"doChangeKementerianRizab()\" "));
			this.context.put("txtNamaAgensi",HTML.SelectAgensiByKementerian("txtIdAgensi", (String)maklumatFail.get("idkementerian"), Utils.parseLong((String)maklumatFail.get("idagensi")), "", ""));
...
//			this.context.put("txtNamaAgensi", (String)maklumatRizab.get("agensi"));
			log.info(maklumatRizab.get("idkementerian"));
			log.info(maklumatRizab.get("idagensi"));
			this.context.put("txtNamaKementerian",HTML.SelectKementerian("txtIdKementerian", Utils.parseLong((String)maklumatRizab.get("idKementerian")), null,"onChange=\"doChangeKementerianRizabEdit()\" "));
			this.context.put("txtNamaAgensi",HTML.SelectAgensiByKementerian("txtIdAgensi", (String)maklumatRizab.get("idKementerian"), Utils.parseLong((String)maklumatRizab.get("idAgensi")), "", ""));
			...
			this.context.put("selectDaerah", HTML.SelectDaerahByNegeri(maklumatRizab.get("idNegeri").toString(), "socDaerah", Utils.parseLong(maklumatRizab.get("idDaerah").toString()),""," onChange=\"doChangeDaerahRizabEdit();\" class=\""+dis+"\" "+dis));
		 	...
		 	if (mode.toLowerCase().indexOf("change") != -1) {
				...
				this.context.put("txtNamaKementerian",HTML.SelectKementerian("txtIdKementerian", Utils.parseLong((String)getParam("txtIdKementerian")), null,"onChange=\"doChangeKementerianRizabEdit()\" "));
				this.context.put("txtNamaAgensi",HTML.SelectAgensiByKementerian("txtIdAgensi", (String)getParam("txtIdKementerian"), Utils.parseLong((String)getParam("txtIdAgensi")), "", ""));
		 	}
		 	/*
			String idnegeri = getParam("socNegeri");
...
//			this.context.put("txtTempoh", "");
	...
	private void viewModeMaklumatFail(HttpSession session,String idHakmilik) throws Exception {
		//String idHakmilik = Integer.parseInt(idHakmilik);	
		Vector list =null;
	...
	public void doInitMaklumatFail(String idPermohonan) throws Exception {
		...
		if (maklumatFail != null) { 
			...
			this.context.put("txtNamaAgensi", (String)maklumatFail.get("agensi"));
			*/
			this.context.put("txtNamaKementerian",HTML.SelectKementerian("txtIdKementerian", Utils.parseLong((String)maklumatFail.get("idkementerian")), null,"onChange=\"doChangeKementerianHakmilik()\" "));
			this.context.put("txtNamaAgensi",HTML.SelectAgensiByKementerian("txtIdAgensi", (String)maklumatFail.get("idkementerian"), Utils.parseLong((String)maklumatFail.get("idagensi")), "", ""));
			this.context.put("txtNoFailSeksyen", (String)maklumatFail.get("fail"));
	...
	public void doInitMaklumatHakmilik(String mode,String idHakmilik) throws Exception {
		...
		log.info("doInitMaklumatHakmilik:"+mode);	
			//if(!"update".equals(mode)){
		//		this.context.put("txtNamaKementerian",maklumatHakmilik.get("namakementerian"));
			//}else{
				this.context.put("txtNamaKementerian",HTML.SelectKementerian("txtIdKementerian", Utils.parseLong((String)maklumatHakmilik.get("idkementerian")), style,"onChange=\"doChangeKementerianHakmilik()\" "));
			//}
			this.context.put("txtNamaAgensi",HTML.SelectAgensiByKementerian("txtIdAgensi", (String)maklumatHakmilik.get("idkementerian"), Utils.parseLong((String)maklumatHakmilik.get("idagensi")), style , ""));

			this.context.put("txtNamaNegeri",HTML.SelectNegeri("socNegeri",Utils.parseLong(idnegeri),style));
			...
			if ("byIdPermohonan".equals(mode)) {
				this.context.put("txtJenisHakmilik", HTML.SelectJenisHakmilik("socJenisHakmilik",Utils.parseLong("-1"),style));
			   	this.context.put("txtNoHakmilik","");
			} else {
				this.context.put("txtJenisHakmilik", HTML.SelectJenisHakmilik("socJenisHakmilik",Utils.parseLong( (String)maklumatHakmilik.get("idJenisHakmilik")),style));
		   	...
		   	this.context.put("selectLot", HTML.SelectLot("noLot",Utils.parseLong( (String)maklumatHakmilik.get("idLot")),style));
			this.context.put("txtNoLot", (String)maklumatHakmilik.get("noLot"));	
			...
			this.context.put("selectRizab", HTML.SelectRizab("socJenisRizab",Utils.parseLong( (String)maklumatHakmilik.get("id_rizab")),style));
			...
			log.info("socKategorisocKategori:"+maklumatHakmilik.get("id_kategori"));
		   	this.context.put("selectKategori", HTML.SelectKategori("socKategori",Utils.parseLong( (String)maklumatHakmilik.get("id_kategori")),style));
	...
	public void doGetListBox() throws Exception {
		...
		this.context.put("txtNamaKementerian",HTML.SelectKementerian("txtIdKementerian", Utils.parseLong(idKementerianKemasukan), null,"onChange=\"doChangeKementerianHakmilik()\" "));
		this.context.put("txtNamaAgensi",HTML.SelectAgensiByKementerian("txtIdAgensi", idKementerianKemasukan, Utils.parseLong(idAgensiKemasukan), "", ""));
	...
	public void doPaparDetailHakmilik2(Vector list) throws Exception {
		...
		try {
			...
			idnegeri = getParam("socNegeri");
		 	...
		 	idKementerianKemasukan = getParam("txtIdKementerian");
			log.debug("idKementerianKemasukan:"+idKementerianKemasukan);
...
//		 	if ("".equals(idmukim)) idmukim = "-1";
			...
			log.debug("isHTPHakmilik:"+isHTPHakmilik);
	...
	public void dokemaskiniDetailHakmilik() throws Exception {
		...
		try {
			if ("update".equals(mode)) {
				 ...
				 hHakmilikUpdate.put("luas_bersamaan",getParam("txtLuasGabung"));

 ...
 *
 */
public class FrmPenswastaan2CadanganProjekView extends AjaxBasedModule {
	
 	private IHTPFail iHTPFail = null;  
 	private IHtp iHTP = null; 
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(ekptg.view.htp.FrmPenswastaan2CadanganProjekView.class);
	...
	public String doTemplate2() throws Exception {
		...
		log.info("action : "+getParam("action"));
		// GET ID PARAM

package ekptg.view.htp.negeri.pembelian;
...
public class FrmPembelianSenaraiFail extends AjaxModule {
	
	private final String jenisAkses = "Readonly";
	private InternalUser iu = null;
	private static final String PATH="app/htp/negeri/pembelian/fail/";
	private static final String PATHONLINE="app/htp/pembelian/fail/online/";
	private String DISABILITY = " disabled class=disabled ";
	static Logger myLog = Logger.getLogger(ekptg.view.htp.negeri.pembelian.FrmPembelianSenaraiFail.class);
	...
	public String doAction() throws Exception {
		...
		if(command.equals("tambahFail")){
			...
			socKementerian = HTML.SelectKementerian("socKementerian", (idKementerian == "") ? null : Long.parseLong(idKementerian),"", " onChange=\"doChangeKementerian()\" ");
			socAgensi = HTML.SelectAgensiByKementerian("socAgensi",idKementerian,Long.parseLong("1"),"");
			...
			String carian = getParam("txtTajukFail");
			...
			socNegeri = HTML.SelectNegeri("socNegeri",Long.parseLong(idNegeri),DISABILITY, "onChange=\"doChangeDaerahManual()\" ");
		    ...
		    socKementerian = HTML.SelectKementerian("socKementerian", Utils.parseLong(idKementerian.equals("")?"0":idKementerian),"", "onChange=\"cmdChangeKementerianCarian() \" style=\"width:400\"");
			...
			context.put("txtTajukFail", carian);		
			context.put("txtTajukCarian", carian);

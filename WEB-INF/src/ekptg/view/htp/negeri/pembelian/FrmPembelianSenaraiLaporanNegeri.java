...
public class FrmPembelianSenaraiLaporanNegeri extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final String PATH="app/htp/";
	private String DISABILITY = " disabled class=disabled ";
	static Logger myLog = Logger.getLogger(ekptg.view.htp.negeri.pembelian.FrmPembelianSenaraiLaporanNegeri.class);
	String socNegeri = "";
	String socUnit = "";
	Vector<?> vecHash = null;
	...
	public String doTemplate2() throws Exception {
		...
		String vm = PATH+"frmSenaraiLaporanHTP.jsp";
...
//			paparanRekod(userLevel,userId);
	...
	private void paparanRekod(int userLevel,String login) throws Exception{
		if(userLevel==1){
			...
			vecHash =getILaporan().getLaporanMengikutUrusan("25",null,"L","neg","'HTPPembelianRingkasanMengikutNegeriDaerahTahunan'");
	...
	private void getLaporanTemplates(String jenisTanah,String template) throws Exception{
		if(!jenisTanah.equals("")){
			if(jenisTanah.equals("1")){
				templates = "neg%%"+template ;				
			}else if(jenisTanah.equals("2")){
				templates = "neg%%"+template ;
			}
			//myLog.info("jenisTanah:templates="+templates);
			vecHash = getILaporan().getLaporanMengikutUrusan("25",null,"L",templates,"'HTPPembelianRingkasanMengikutNegeriDaerahTahunan'");

		}else{
			//myLog.info("!jenisTanah:template="+template);
			if(!"".equals(getParam("socUnit"))){
				template = "kem%%"+template ;   		
    		}		
			vecHash = getILaporan().getLaporanMengikutUrusan("25",null,"L",template,"'HTPPembelianRingkasanMengikutNegeriDaerahTahunan'");

package ekptg.view.htp.negeri.pkecil;
...
public class FrmPajakanKecilNegeri extends AjaxBasedModule{
	
	private static final long serialVersionUID = 9046892655520724342L;
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.negeri.pkecil.FrmPajakanKecilNegeri.class);
	private final String PATH = "app/htp/negeri/pajakankecil/";
	private String DISABILITY = " disabled class=disabled ";
	private String jenisAkses = "write";
	...
	private String socDaerahSarawak = "";
	private String socMukim = "";
	private String idDaerah = "";
	private String idDaerahSarawak = "";
	...
	public String doTemplate2()throws Exception {
		...
		myLog.info("myRole="+portal_role);
	    //userID = "3";
	    String template_name = PATH+"/frmPajakanKecilSenaraiFail.jsp";
		...
		//idNegeri = "12";
	 	...
	 	idDaerahSarawak = getParam("socDaerahSarawak");
	    ...
	    myLog.info("idKemaskiniPaging="+idKemaskiniPaging); 
	    //if(idFail.equals(""))
	    ...
	    socKementerian = HTML.SelectKementerian("socKementerian", "onChange=\"doChangeKementerian() \" style=\"width:400\"");
	    	...
	    	if(submit.equals("pksenaraifailcari")){ //carian
	    		...
	    		noFail = getParam("txtNoFail");
			 	idDaerah = getParam("socDaerah");
			  	idMukim = getParam("socMukim");
			 	maklumatCarian();
			 	socDaerah = HTML.SelectSortDaerahByNegeri(idNegeri,"socDaerah", Utils.parseLong(idDaerah),"onChange=\"doChangeKementerianCarian()\"", null);
			 	//socDaerah = HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah",hakmilik.getIdDaerah(),"","");
...
//	    		senaraiFail = FrmSenaraiFailPajakanKecilData.getList(noFail.trim(),txtTajukCarian,idNegeri,idKementerian,idAgensi,"");      			    		
		    	...
		    	skrin = "2";		    			    	
		    	this.context.put("modeFail", "fail");	    	
...
//				    }
				    ...
				    if(pageMode.equals("4")){
				    	...
				    	myLog.info("pkpermohonankemaskini:simpan");
						String[] cbsemaks = this.request.getParameterValues("cbsemaks");
						myLog.info("cbsemaks : "+cbsemaks);
						myLog.info("cbsemaks size : "+cbsemaks.length);
					   	semakanSenarai = FrmSemakan.getSenaraiSemakan("frmSewaanSemak"+permohonan.get("idnegeri"));
			        	Hashtable hash = null;
			        	Hashtable h = new Hashtable();
			        	
			        	/*declare id permohonan*/
			        	id =  Long.parseLong((String)permohonan.get("idpermohonan"))+"";
	//						h.put("id_Fail", Long.parseLong((String)permohonan.get("idpermohonan")));
						h.put("idPermohonan", Long.parseLong((String)permohonan.get("idpermohonan")));
						h.put("idFailN", idFailN);
						h.put("id_kemaskini", 1);
	    ...
	    //tab 2
					...
					if(pageMode.equals("hapusPemilik")){
			    		//myLog.info("deletePemilik------------------------------");
			    	...
			    	}else if(pageMode.equals("hapusHakmilik")){
					...
					Vector<PihakBerkepentingan> p = getIPemilik().findPemilikByPermohonan(id_);
					if(p.size()!=0){
			    	...
			    	Hashtable<?, ?> hakmilikbangunan = null;
			    	String id_ = getParam("id_permohonan");
			    	myLog.info("deleteHakmilik------------------------id_------"+id_);
					Hashtable<?, ?> permohonan = FrmPajakanKecilSenaraiPermohonanData.getPermohonanInfo(id_);
	                ...
	                String socDaerah1 = HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah1",null,null, " onChange=\"doChangeDaerah123("+id+")\" ");
					...
					if ("doChangeNegeri1".equalsIgnoreCase(pageMode)) {
						...
						socDaerah = HTML.SelectSortDaerahByNegeri(socNegeri2,"socDaerah",null,null,null);
						this.context.put("socDaerah",socDaerah);
					}
					this.context.put("socNegeri",socNegeri);
	                ...
	                socDaerah = HTML.SelectSortDaerahByNegeri((String)permohonan1.get("idnegeri"),"socDaerah",null,null,null );
					...
					//Maklumat Hakmilik
					socNegeri = HTML.SelectNegeri("socNegeri",Long.parseLong(permohonan.get("idnegeri").toString()),disability);
	                this.context.put("socDaerah1",HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah1",null,null, " onChange=\"doChangeDaerahHakmilik("+idPermohonan+")\" "));
					...
					this.context.put("socDaerah",HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah",0L,null,null));
					...
					if (pageMode.equalsIgnoreCase("dochangedaerah")) {
						...
						if(tempIdMukim=="")
							tempIdMukim="00";
						this.context.put("socDaerah1",HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah1",Long.parseLong(socDaerah1),null, " onChange=\"doChangeDaerahHakmilik("+idPermohonan+")\" "));
	...
	//			    	template_name = "app/htp/frmPajakanKecilSenaraiHakmilikPemilik.jsp";
						socDaerah = HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah",pihak.getIdDaerah(),disability,null);				    	    
			    	    pageMode = "2";
	                ...
	                this.context.put("socDaerah1",HTML.SelectSortDaerahByNegeri((String)hakmilikinfo.get("idNegeri"),"socDaerah1",Long.parseLong(hakmilikinfo.get("idDaerah").toString()), disability,null));
	                ...
	                this.context.put("socDaerah",HTML.SelectSortDaerahByNegeri(pihak.getIdNegeri(),"socDaerah",Long.parseLong(pihak.getIdDaerah()), disability,null));
					this.context.put("noLotvalue", hakmilikinfo.get("noLot"));
		            this.context.put("noHakmilik", hakmilikinfo.get("noHakmilik"));
		            this.context.put("idPermohonan", hakmilikinfo.get("idPermohonan"));
		            this.context.put("pagemode", 0);
					...
					if ("doChangeNegeri2".equalsIgnoreCase(pageMode)) {
						...
						this.context.put("socDaerah",HTML.SelectSortDaerahByNegeri(socNegeri2,"socDaerah",null,null,null));
					...
					Hashtable<?, ?> permohonan = FrmPajakanKecilSenaraiPermohonanData.getPermohonanInfo(id);
					socDaerah = HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah",null,null,null);
			    	    ...
			    	    if("".equals(idHakmilik)){
							...
							if(FrmPajakanKecilHakmilikData.isHakmilikUrusan(idHakmilikU)){														
								...
								if(!idPihakBerkepentingan.equals("") && !idPihakBerkepentingan.equals(null)){									
									...
									intPB = simpanPB(session,0,idHakmilikUrusan);
									simpanHakMilikUrusanPB(intPB,String.valueOf(idHakmilikUrusan), session);
					...
					if(hakmilikbangunan==null){
						...
						socDaerah = HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah",Long.parseLong(hakmilikbangunan.get("iddaerah").toString()),disability,null);
						socNegeri = HTML.SelectNegeri("socNegeri",Long.parseLong(permohonan.get("idnegeri").toString()),disability);
					...
					String socDaerah = HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah",Long.parseLong(hakmilikbangunan.get("iddaerah").toString()),disability,null);
					socNegeri = HTML.SelectNegeri("socNegeri",Long.parseLong(permohonan.get("idnegeri").toString()),disability);
					String socPegawai = HTML.SelectPegawai("socPegawai",Long.parseLong(hakmilikbangunan.get("idpegawai").toString()) ,disability);
					this.context.put("socPegawai",socPegawai);
					pageMode = "3";
					...
					if(pageMode.equals("0")){
				    	...
				    	socDaerah = HTML.SelectSortDaerahByNegeri((String)hakmilikbangunan.get("idnegeri"),"socDaerah",Long.parseLong(hakmilikbangunan.get("iddaerah").toString()),disability,null);
						...
						socDaerah = HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah",Long.parseLong(hakmilikbangunan.get("iddaerah").toString()),null,null);
					    ...
					    s.put("tarikhkemaskini",new Date());
					    s.put("tahun",getParam("txttahun"));
					    s.put("bulan",getParam("txtbulan"));
					   	socKementerian = HTML.SelectKementerian("socKementerian",Long.parseLong(permohonan.get("idkementerian").toString()),disability);
				    	socAgensi = HTML.SelectAgensi("socAgensi",Long.parseLong(permohonan.get("idagensi").toString()),disability);
...
//			    	
		    		...
		    		myLog.info("addHakmilikToPemilik ::"+idPermohonan);
		    		...
		    		socNegeri = HTML.SelectNegeri("socNegeri",Long.parseLong(permohonan.get("idnegeri").toString()),disability);
		    		String socMukim = HTML.SelectMukimByNegeri((String)permohonan.get("idnegeri"), "socMukim");
		    		myLog.info("pihakKepentingan.getIdNegeri()-------------------"+permohonan.get("idnegeri").toString());
		    		myLog.info("pihakKepentingan.getIdDaerah()-------------------"+permohonan.get("iddaerah").toString());
		    		
		    		String socDaerah1 = HTML.SelectSortDaerahByNegeri(permohonan.get("idnegeri").toString(),"socDaerah1",Long.parseLong(permohonan.get("iddaerah").toString()),null,null);
		    		//String socDaerah1  = HTML.SelectSortDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah1",null,null,null);
		    		myLog.info(socDaerah1);
		    		this.context.put("socMukim", socMukim);
					this.context.put("socDaerah1", socDaerah1);
					this.context.put("socHakmilik",HTML.SelectJenisHakmilik("socHakmilik"));
					//this.context.put("socHakmilik",UtilHTML.SelectJenisHakmilikMengikutNegeri("socHakmilik",(String)permohonan.get("idnegeri")));
		    		...
		    		String socDaerah = HTML.SelectSortDaerahByNegeri(pihakKepentingan.getIdNegeri().toString(),"socDaerah", pihakKepentingan.getIdDaerah(), disability,null);//HTML.SelectDaerahByNegeri(permohonan.get("idnegeri").toString(),"socDaerah",pihakKepentingan.getIdDaerah(),disability);
...
//							getISusulan().simpanSusulanStatusFail(hInsert);
			    ...
			    if(langkah.equals("0->0")){ //carian
			    	...
			    	myLog.info("::::::::::::::::::testmasuksini ke mana nak tgk senarai");
			    	template_name = PATH+"frmPajakanKecilSenaraiFail.jsp";
			    	
			    	//senaraiFail = FrmSenaraiFailPajakanKecilData.getList("",noFail,"",idNegeri,"","",idMasuk);
			    	 senaraiFail =  getIHTPPKFail().getSenaraiFail(
			    			 userId, noFail.trim(), "","","",idNegeri,"","","309","", "", "", "", true );
					this.context.put("SenaraiFail", senaraiFail);
					setupPage(session,action,senaraiFail);
...
//					hashInfoPemilikandHakmilik.put("senaraiPemilik", vsenaraiPemilik);
		  ...
		  private void maklumatCarian() throws Exception{
			socNegeri = HTML.SelectNegeri("socNegeri",Long.parseLong(idNegeri),"disabled class='disabled'");
		   	socDaerah = HTML.SelectSortDaerahByNegeri(idNegeri, "socDaerah",Utils.parseLong(idDaerah),null, "onChange=\"doChangeKementerianCarian()\"");

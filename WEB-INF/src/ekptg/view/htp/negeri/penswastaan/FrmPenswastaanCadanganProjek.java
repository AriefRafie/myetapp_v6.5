 ...
 *
 */
public class FrmPenswastaanCadanganProjek extends AjaxBasedModule {
	
	private final String jenisAkses = "Readonly";
	private final String PATH = "app/htp/negeri/penswastaan/projek/";
	private static final long serialVersionUID = 1L;
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.negeri.penswastaan.FrmPenswastaanCadanganProjek.class);

...
public class FrmPenswastaanMemorandum extends AjaxBasedModule {
	
	private final String jenisAkses="Readonly";
	private final String PATH = "app/htp/negeri/penswastaan/mjm/";
	private static final long serialVersionUID = 1L;
	private static Logger myLog = Logger.getLogger(ekptg.view.htp.negeri.penswastaan.FrmPenswastaanMemorandum.class);

 ...
 *
 */
public class FrmPenswastaanPindahMilikTanah extends AjaxBasedModule {

	private static final String PATH="app/htp/negeri/penswastaan/";
	private static final String PATHPEM="app/htp/pembelian/perjanjian/";
	private final String jenisAkses="Readonly";
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(ekptg.view.htp.negeri.penswastaan.FrmPenswastaanPindahMilikTanah.class);
...
//			logic.setMaklumatSenaraiPemilikTanah(idHakmilikurusan);
		...
		if(submit.equals("maklumatview")){
			...
			log.info("==senaraisemakpmilikkemaskini==");
			getPermohonanInfo();
			//selectedTab="2";
			vm = PATHPEM+"senaraiSemakPindahmilik.jsp";
			getSemakanPindahMilik();
			...
			log.info("==senaraisemakpmiliksimpan==");
			getPermohonanInfo();
...
//        		this.context.put("selectDaerah", HTML.SelectDaerahByNegeri(idNegeri, "socDaerah", Long.parseLong(idDaerah), "", ""));
	...
	public void saveUpdatePemilik(String idPihakKepentingan, HttpSession session)throws Exception{
		try{
			...
			log.info("fir saveupdatePemilik ");

...
public class FrmPajakanBayaran extends AjaxBasedModule{

	private final String jenisAkses="Readonly";
	  private static final long serialVersionUID = 1L;
	  private static final String PATH="app/htp/negeri/pajakan/bayaran/";
	  private static Logger log = Logger.getLogger(ekptg.view.htp.negeri.pajakan.FrmPajakanBayaran.class);

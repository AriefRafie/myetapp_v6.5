...
/**
 * Mengurus pemohonan pemberimilikan/ perizaban daripada online
 *
 */
public class FrmPermohonanTanahOnline extends AjaxBasedModule{	
	private BorangK borangK = null;
	private final String PATHTP="app/htp/";
	private final String PATHVER = PATHTP+"v06/";
	private final String PATH = PATHVER+"permohonan/online/";
...
//			this.context.put("labelDaerah",labelDaerah)	    		
			...
			if (submit.equals("SahkanPermohonan")) {
			...
			}else if(submit.equals("sahPermohonanOnline")){

				myLog.debug("SAHKAN PERMOHONAN");
				...
				int idnegeri = get("id_Negeri");
				int iddaerah = get("id_Daerah");
				int idkementerian = get("id_Kementerian");
				int idagensi = get("id_Agensi");
				int idurusan = get("id_Urusan");
				int idsuburusan = get("id_Suburusan");
				
    			getPermohonanInfo();
    			myLog.info("sahPermohonanOnline id_permohonan :::::::::: "+ htpPermohonan.getPermohonan().getIdPermohonan());
    			String semakMode="";
    			String langkah = "";			
    			langkah = "1";
    			...
    			context.put("infoPengesahan", "Permohonan Telah Disahkan");
				...
				tanahBean.setLabelDaerah(context, String.valueOf(hashTerimaPohonInfo.get("lblIdNegeri")));
	   			...
	   			if (hittButton.equals("kemaskini")){
					...
					myLog.debug("htpPermohonan ::::: " + htpPermohonan.getIdHtpPermohonan());
	    		...
	    		this.context.put("idNegeriNotis",idnegeri);	
			...
			//CARIAN
				...
				senaraiTerimaPohon = getPR().senaraiPermohonanOnline(null,nofail,txtTajukCarian,
						id_kementerian,id_agensi,idnegeri,iddaerah,idmukim,idurusan,tarikhBukaFail);
	    		...
	    		if (hittButton.equals("simpanGIS")) {
	    			getIntegrasi().simpan(getParam("nofailgis"), 2);
	    		}
...
//	    				this.context.put("suratExt",suratExt);
	    	...
	    	// Lama - lama	   			
		    	...
		    	if(flagAdvSearch.equals("open")){
		    		...
		    		/*senaraiTerimaPohon = getPR().TerimaPohongetList(null,nofail,txtTajukCarian==""?txtTajuk:txtTajukCarian,
									id_kementerian,id_agensi,idnegeri,iddaerah,idmukim,idurusan,tarikhBukaFail);*/
		    		senaraiTerimaPohon = getPR().senaraiPermohonanOnline(null,nofail,txtTajukCarian==""?txtTajuk:txtTajukCarian,
							id_kementerian,id_agensi,idnegeri,iddaerah,idmukim,idurusan,tarikhBukaFail);
					doListing(session,action,mode,senaraiTerimaPohon);
					
		    	}else{
		    		//myLog.info("default page");
		    		//senaraiTerimaPohon = getPR().TerimaPohongetList(userId,"","","","","","","","",tarikhBukaFail);
		    		senaraiTerimaPohon = getPR().senaraiPermohonanOnline("","","","","","","","","",tarikhBukaFail); //zul remove user untuk paparkan semua list permohonan online
	    		...
	    		if(mode.equals("changeNegeri")){
	        	    ...
	        	    /*senaraiTerimaPohon = getPR().TerimaPohongetList(userId,nofail,txtTajukCarian,
						id_kementerian,id_agensi,idnegeri,iddaerah,idmukim,idurusan,tarikhBukaFail);*/
	        	    senaraiTerimaPohon = getPR().senaraiPermohonanOnline(userId,nofail,txtTajukCarian,
							id_kementerian,id_agensi,idnegeri,iddaerah,idmukim,idurusan,tarikhBukaFail);
			    	doListing(session,action,mode,senaraiTerimaPohon);
			...
			myLog.info("selectedTab == " + selectedTab + "<br/>" + "selectedTab2 == " + selectedTab2 + "<br/>" + "selectedTab3 == " + selectedTab3 + "<br/>" + "tabmode == " + tabmode + "<br />" + "button === " + button + "<br/>" + "mode == " + mode + "<br />" + "submit === " + submit);
...
//			subUrusanStatusFailN.setTarikhMasuk(date);
	...
	//start addby zul for pengesahan
	...
	private void simpanPengesahan(Tblrujsuburusanstatusfail rsusf,String langkah)throws Exception {
		myLog.debug("rsusf ::::: " + rsusf);
		myLog.debug("langkah ::::: " + langkah);
		 try {
			subUrusanStatusFail = new Tblrujsuburusanstatusfail();
			subUrusanStatusFail.setIdPermohonan(rsusf.getIdPermohonan());
			subUrusanStatusFail.setIdFail(rsusf.getIdFail());
			...
			Tblrujsuburusanstatusfail subUrusanStatusFailN = new Tblrujsuburusanstatusfail();
			long setIdSuburusanstatus = FrmUtilData.getIdSuburusanStatusByLangkah(langkah,String.valueOf(rsusf.getIdSuburusanstatusfail()),"=");
			myLog.debug("setIdSuburusanstatus ::::: " + setIdSuburusanstatus);
			subUrusanStatusFailN.setIdSuburusanstatus(setIdSuburusanstatus);
			subUrusanStatusFailN.setAktif("1");
			subUrusanStatusFailN.setUrl(Utils.isNull(rsusf.getUrl()));
			subUrusanStatusFailN.setIdMasuk(Long.parseLong(userId));

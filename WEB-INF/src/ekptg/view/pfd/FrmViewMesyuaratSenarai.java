...
import ekptg.model.pfd.FrmModelMesyuaratSenarai;
@SuppressWarnings({ "serial", "unused" })

public class FrmViewMesyuaratSenarai extends AjaxBasedModule{
...
SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
	...
	public String doTemplate2() throws Exception{
        ...
        FrmModelMesyuaratSenarai model = new FrmModelMesyuaratSenarai();
        //
        ...
        paparSeksyen = model.getDataSeksyen();
       ...
       // set_maklumat = getParam("set_maklumat");
    	...
    	if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
    		statusProses = model.getStatusProses(ID_MESYUARAT);
    		this.context.put("idNegeri", user_negeri);
    	}
        
        if ("daftarMesyuarat".equalsIgnoreCase(actionx)) {
        //	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
        	this.context.put("idNegeri", user_negeri);
        	PrevPage = "1";
 ...
 //       		if("16".equalsIgnoreCase(user_negeri)){
        			vData = model.getMesyuaratData(ID_MESYUARAT);
//        		}
//        		else{
//        			vData = model.getMesyuaratDataNegeri(ID_MESYUARAT);
//        		}
        		...
        		vData = model.getMesyuaratTemplateData(ID_TEMPLATE);
        		...
        		h.clear();
        		vData.clear();
        		Mesyuarat_Bil = model.getMesyuaratNextBilNo(Mesyuarat_Tajuk);
        	...
        	vm = "app/pfd/frmMesyuaratSenaraiPanggilan.jsp";
        	this.context.put("idNegeri", user_negeri);
        	model.deleteMesyuaratData(ID_MESYUARAT);        	
        	model.deleteMesyuaratDiCalendar(ID_MESYUARAT);   
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
        		...
        		if (!vData.isEmpty()) {
        			h = (Hashtable) vData.get(0);
        			model.email(ID_MESYUARAT,h); 
        			populateMesyuaratData(h);
        		}
        		h.clear();
        		vData.clear();
        		
        		list = model.getListMesyuaratKehadiran(ID_MESYUARAT);
        		context.put("List_AhliMesyuarat", list);
        		//list.clear();

        		vData = model.getListMesyuaratMinit(ID_MESYUARAT);
        		...
        		if (model.isNumeric(Mesyuarat_Tarikh.substring(6, 10))) {
        			eventYear = Integer.parseInt(Mesyuarat_Tarikh.substring(6, 10));
        		}
        		if (model.isNumeric(Mesyuarat_Tarikh.substring(3, 5))) {
        			eventMonth = Integer.parseInt(Mesyuarat_Tarikh.substring(3, 5));
        		}
        		if (model.isNumeric(Mesyuarat_Tarikh.substring(0, 2))) {
                ...
                // add by Rizuan
                Boolean IDMESYAUARAT_EXIST = model.checkMesyuaratDiCalendar(ID_MESYUARAT);
                ...
                model.updateStatusProses(ID_MESYUARAT, "5");
                ...
                if ("tempahMakanan".equalsIgnoreCase(submit)) {
                    ...
                    Mesyuarat_TempahMakananMakanan = getParam("Mesyuarat_TempahMakananMakanan");
                    Mesyuarat_TempahMakananMinuman = getParam("Mesyuarat_TempahMakananMinuman");
                    model.saveMesyuaratTempahanMakanan(ID_MESYUARAT, Mesyuarat_TempahMakananPemohon, Mesyuarat_TempahMakananBilAhli, Mesyuarat_TempahMakananMakanan, Mesyuarat_TempahMakananMinuman);
                }
    		}
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
        		...
        		if (!vData.isEmpty()) {
        			h = (Hashtable) vData.get(0);
        			model.emailminit(ID_MESYUARAT,h); 
        			populateMesyuaratData(h);
        		}
        		h.clear();
        		vData.clear();
...
//	        			}
        	...
        	if (canProceed) {
        		...
        		if (!"".equalsIgnoreCase(ID_TEMPLATE)) {
        			model.saveAhliMesyuaratTemplateToMesyuarat(ID_TEMPLATE, ID_MESYUARAT);
        		}
        		list = model.getAhliMesyuaratList(ID_MESYUARAT, false);
        		context.put("List_CarianAhliMesyuarat", list);
        		list = model.getAhliMesyuaratList(ID_MESYUARAT, true);
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
        		...
        		if ("1".equalsIgnoreCase(SOC_PERANAN)) {
        			if (!model.havePengerusi(ID_MESYUARAT, ID_AHLI)) {
        				doSave = true;
        			...
        			if (!model.haveSetiausaha(ID_MESYUARAT, ID_AHLI)) {
        				doSave = true;
        		...
        		// save data ahli ni
        		if(doSave==true){
    				model.saveAhliMesyuaratData(ID_MESYUARAT, ID_AHLI, Ahli_Kategori, SOC_PEGAWAI, Ahli_Nama, Ahli_Agensi, "", SOC_NEGERI, SOC_SEKSYEN, SOC_UNIT, Ahli_Jawatan, Ahli_Email, Ahli_NoTelefon, Ahli_NoFaks, SOC_PERANAN,txtAlamatAhli);
        		}
    			// kosongkan fields
        		list = model.getAhliMesyuaratList(ID_MESYUARAT, false);
        		context.put("List_CarianAhliMesyuarat", list);
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT) && !"".equalsIgnoreCase(ID_AHLI)) {
        		...
        		Vector kat = model.getMaklumatKategori(ID_AHLI);
        		if (!kat.isEmpty()) {
        		...
        		{
        		vData = model.getAhliMesyuaratData(ID_MESYUARAT, ID_AHLI);
        		if (!vData.isEmpty()) {
        			h = (Hashtable) vData.get(0);
        		...
        		getAhliMesyuaratDataUrussetia = model.getAhliMesyuaratDataUrussetia(ID_MESYUARAT, ID_AHLI);
        		if (!getAhliMesyuaratDataUrussetia.isEmpty()) {
        			...
        			if ("1".equalsIgnoreCase(jenis_kategori)) {
        				...
        				if ("16".equalsIgnoreCase(negeri_user)) {
        		        	Ahli_Pegawai = model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", id_user, SOC_SEKSYEN, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai');\"",submit,actionx);
        		        	context.put("Ahli_Pegawai", Ahli_Pegawai);
                		}		        
        		        else  {		        	
        		        	Ahli_Pegawai = model.getSOCPegawaiByNegeri(ID_MESYUARAT,"SOC_PEGAWAI", id_user, negeri_user, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai1');\"",submit,actionx);
        		        	context.put("Ahli_Pegawai", Ahli_Pegawai);
        		        }
        				...
        				Ahli_Kategori3 = "checked=\"checked\"";
        				if ("16".equalsIgnoreCase(negeri_user)) {
        		        	Ahli_Pegawai = model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", id_user, SOC_SEKSYEN, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai2');\"",submit,actionx);
        		        	context.put("Ahli_Pegawai", Ahli_Pegawai);
                		}		        
        		        else  {		        	
        		        	Ahli_Pegawai = model.getSOCPegawaiByNegeri(ID_MESYUARAT,"SOC_PEGAWAI", id_user, negeri_user, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai3');\"",submit,actionx);
        		        	context.put("Ahli_Pegawai", Ahli_Pegawai);
        		        }
        			}
        			else
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT) && !"".equalsIgnoreCase(ID_AHLI)) {
        		...
        		// delete data ahli ni
    			model.deleteAhliMesyuaratData(ID_MESYUARAT, ID_AHLI);
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
    			vm = "app/pfd/frmMesyuaratMinitSenarai.jsp";
    			this.context.put("idNegeri", user_negeri);
        		...
        		if ("0".equalsIgnoreCase(selectedTab)) {
	        		list = model.getAhliMesyuaratKehadiran(ID_MESYUARAT, user_id);
	        		context.put("List_CarianAhliMesyuarat", list);
        		...
        		model.updateStatusProses(ID_MESYUARAT, "3");
        		selectedTab = "0";  
    		}
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
        		...
        		vData = model.getAhliMesyuaratListID(ID_MESYUARAT, user_id);
        		if (!vData.isEmpty()) {
        			h = (Hashtable) vData.get(0);
            		int iDataCount = 0;
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
        		...
        		list = model.getAgendaMesyuaratList(ID_MESYUARAT, user_id);
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
    			...
    			this.context.put("agenda", "false");
    			this.context.put("minit", "");
    			this.context.put("subminit", "");
        		...
        		vData = model.getAgendaMesyuaratData(ID_AGENDA);
        		if (!vData.isEmpty()) {
        			h = (Hashtable) vData.get(0);
        ...
        else if ("viewMesyuaratAgendaEdit".equalsIgnoreCase(actionx)) {
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		this.context.put("idNegeri", user_negeri);
    		
			this.context.put("agenda", "true");
			this.context.put("minit", "");
			this.context.put("subminit", "");
			this.context.put("readonly", "readonly");
			this.context.put("disabled", "disabled");
			this.context.put("readonlyMakluman", "");
			this.context.put("readonlyDisabled", "");
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
        		...
        		model.saveAgendaMesyuaratData(ID_MESYUARAT, ID_AGENDA, Agenda_No, Agenda_Tajuk, Agenda_Agenda);
        		ID_AGENDA = "";
        		Agenda_No = "";
        		Agenda_Tajuk = "";
        		Agenda_Agenda = "";
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT) && !"".equalsIgnoreCase(ID_AGENDA)) {
        		...
        		model.deleteAgendaMesyuaratData(ID_MESYUARAT, ID_AGENDA);
        		ID_AGENDA = "";
        		Agenda_No = "";
        		Agenda_Tajuk = "";
        		Agenda_Agenda = "";
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
        		...
        		Minit_Agenda = model.getSOCAgendaMesyuarat("SOC_AGENDA", ID_AGENDA, ID_MESYUARAT, "", "");
        		
	         	listPegawai(session);
	    		listPegawai = model.getListPegawai();
	    		this.context.put("SenaraiPegawai",listPegawai);
        		
        		list = model.getMinitMesyuaratList(ID_MESYUARAT, user_id);
        		context.put("List_CarianMinit", list);
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
    			...
    			this.context.put("agenda", "");
    			this.context.put("minit", "false");
    			this.context.put("subminit", "");
        		...
        		vData = model.getMinitMesyuaratData(ID_MINIT);
        		if (!vData.isEmpty()) {
        			h = (Hashtable) vData.get(0);
	    		...
	    		Vector listPegawai = model.getDataPegawaiMinit(ID_MINIT);
	    		Hashtable x ;
        		...
        		selectedTab = "2";
        		context.put("minit", "false");
    		}
        } else if ("viewMesyuaratMinitEdit".equalsIgnoreCase(actionx)) {
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		this.context.put("idNegeri", user_negeri);
    		String idPegawaiTindakan = "";
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
        		...
        		selectedTab = "2";
        		context.put("minit", "true");
    		}
        }else if ("simpanMesyuaratMinitEdit".equalsIgnoreCase(actionx)) {
        	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
        		this.context.put("idNegeri", user_negeri);
        		...
        		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
    				...
    				model.saveMinitMesyuaratDataEdit(ID_MESYUARAT, ID_MINIT, Minit_Maklumbalas );
            		ID_MINIT = "";
            		Minit_No = "";
            		Minit_Tajuk = "";
            		Minit_Minit = "";
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
				...
				model.saveMinitMesyuaratData(ID_MESYUARAT, SOC_AGENDA, ID_MINIT, Minit_No, Minit_Tajuk, Minit_Minit, Minit_Tindakan, Minit_Makluman, Minit_Maklumbalas, idPegawaiTindakan );
        		ID_MINIT = "";
        		Minit_No = "";
        		Minit_Tajuk = "";
        		Minit_Minit = "";
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT) && !"".equalsIgnoreCase(ID_MINIT)) {
        		...
        		model.deleteMinitMesyuaratData(ID_MESYUARAT, ID_MINIT);
        		ID_MINIT = "";
        		Minit_No = "";
        		Minit_Tajuk = "";
        		Minit_Minit = "";
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
        		...
        		SubMinit_Agenda = model.getSOCAgendaMesyuarat("SOC_AGENDA", ID_AGENDA, ID_MESYUARAT, "", " onchange=\"doChangeSOC('changeAgenda')\"");
        		SubMinit_Minit = model.getSOCMinitMesyuarat("SOC_MINIT", ID_MINIT, ID_AGENDA, "", "");
        		
        		listPegawai(session);
	    		listPegawai = model.getListPegawai();
	    		this.context.put("SenaraiPegawai",listPegawai);
        		
        		list = model.getSubMinitMesyuaratList(ID_MESYUARAT, user_id);
        		context.put("List_CarianMinit", list);
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
    			...
    			this.context.put("agenda", "");
    			this.context.put("minit", "");
    			this.context.put("subminit", "false");
        		...
        		vData = model.getSubMinitMesyuaratData(ID_SUBMINIT);
        		if (!vData.isEmpty()) {
        			h = (Hashtable) vData.get(0);
	    		...
	    		Vector listPegawai = model.getDataPegawaiSubMinit(ID_SUBMINIT);
	    		Hashtable x ;
	    		if (listPegawai.size() > 0) {
        			x = (Hashtable)listPegawai.elementAt(0);
         			this.context.put("selectidorang",x.get("user_id"));
        		...
        		selectedTab = "3";
        		context.put("subminit", "false");
    		}
        }else if ("viewMesyuaratSubMinitEdit".equalsIgnoreCase(actionx)) {
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		this.context.put("idNegeri", user_negeri);
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
    			...
    			this.context.put("agenda", "");
    			this.context.put("minit", "");
    			this.context.put("subminit", "true");
    			this.context.put("readonly", "readonly");
    			this.context.put("disabled", "disabled");
    			this.context.put("readonlyMakluman", "");
    			this.context.put("readonlyDisabled", "");
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
        		...
        		String idPegawaiTindakan = getParam("socPegawai");
        		model.saveSubMinitMesyuaratData(ID_MESYUARAT, SOC_AGENDA, SOC_MINIT, ID_SUBMINIT, SubMinit_No, SubMinit_Tajuk, SubMinit_SubMinit, SubMinit_Tindakan, SubMinit_Makluman,SubMinit_Maklumbalas, idPegawaiTindakan);
        		ID_SUBMINIT = "";
        		SubMinit_No = "";
        		SubMinit_Tajuk = "";
        		SubMinit_SubMinit = "";
        ...
        else if ("simpanMesyuaratSubMinitEdit".equalsIgnoreCase(actionx)) {
        	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
        		this.context.put("idNegeri", user_negeri);
        		...
        		if (!"".equalsIgnoreCase(ID_MESYUARAT)) {
            		...
            		String idPegawaiTindakan = getParam("socPegawai");
            		model.saveSubMinitMesyuaratDataEdit(ID_MESYUARAT,ID_SUBMINIT, SubMinit_Maklumbalas);
            		ID_SUBMINIT = "";
            		SubMinit_No = "";
            		SubMinit_Tajuk = "";
            		SubMinit_SubMinit = "";
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
    		...
    		if (!"".equalsIgnoreCase(ID_MESYUARAT) && !"".equalsIgnoreCase(ID_SUBMINIT)) {
        		...
        		model.deleteSubMinitMesyuaratData(ID_MESYUARAT, ID_SUBMINIT);
        		ID_SUBMINIT = "";
        		SubMinit_No = "";
        		SubMinit_Tajuk = "";
        		SubMinit_SubMinit = "";
    	...
    	//	vm = "app/pfd/frmMesyuaratDaftarSenarai.jsp";
        	...
        	list = model.getListMesyuarat(Search_NoFail, Search_Tajuk, Search_Kategori, Search_Urusetia, Search_Lokasi, Search_Tarikh,id_seksyen, id_negeri, user_id);
        	...
        	if("16".equalsIgnoreCase(user_negeri)){
        		//list = model.getListMesyuarat("", "", "", "", "", "",id_seksyen,id_negeri,user_id);
        		list = model.getListMesyuaratMyInfo((String)session.getAttribute("_ekptg_user_id"));
            	this.context.put("ListMesyuarat", list);
        		setupPage(session, actionx, list);
        ...
        if (Page_Carian) {
	    	...
	    	if ("daftarMesyuarat".equalsIgnoreCase(actionx)) {
	    		if("16".equalsIgnoreCase(user_negeri)){
	    			context.put("Mesyuarat_Lokasi", model.getSOCLokasiMesyuarat("SOC_LOKASI", Mesyuarat_Lokasi, RO_MaklumatMesyuarat, id_seksyen,id_negeri));
	    		}
	    		else
	    		{
	    			context.put("Mesyuarat_Lokasi", model.getSOCLokasiMesyuaratNegeri("SOC_LOKASI", Mesyuarat_Lokasi, RO_MaklumatMesyuarat, Mesyuarat_Unit ,id_negeri));
	    	...
	    	if ("selesaiMesyuarat".equalsIgnoreCase(actionx) || "email".equalsIgnoreCase(actionx)) {
	    		...
	    		context.put("Mesyuarat_Status", model.getSOCStatusMesyuarat("SOC_STATUS", Mesyuarat_Status));
	    	}
	    ...
	    //	context.put("Ahli_Pegawai", model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", Ahli_Pegawai, Ahli_Seksyen, Ahli_Kategori, RO_MaklumatMesyuarat) );
	    	...
	    	{
	    	context.put("Ahli_Pegawai", model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", SOC_PEGAWAI, Ahli_Seksyen, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai');\"",submit,actionx) );
	    	}
	    	...
	    	//context.put("Ahli_Pegawai", model.getSOCMaklumatPegawai(ID_MESYUARAT,"SOC_PEGAWAI", Ahli_Pegawai, Ahli_Seksyen, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai');\"",submit) );
	    	...
	    	context.put("Ahli_Peranan", model.getSOCPerananAhliMesyuarat("SOC_PERANAN", Ahli_Peranan, Ahli_Kategori, RO_MaklumatMesyuarat));
	        ...
	        if (!"".equalsIgnoreCase(submit)) {
		        if ("changeSeksyen".equalsIgnoreCase(submit)) {
		        	...
		        	Ahli_Kategori2 = "";
		        	Ahli_Kategori3 = "";
		        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", Ahli_Peranan, "1", RO_MaklumatMesyuarat);
		        	Ahli_Pegawai = model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", "", SOC_SEKSYEN, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai');\"",submit,actionx);
		            context.put("Ahli_Pegawai",Ahli_Pegawai);
		        	...
		        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", Ahli_Peranan, "1", RO_MaklumatMesyuarat);
		        	Ahli_Pegawai = model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", SOC_PEGAWAI, SOC_SEKSYEN, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai');\"",submit,actionx);
		        	Vector getMaklumatPegawai = new Vector();
		        	getMaklumatPegawai = model.getMaklumatPegawai(getParam("SOC_PEGAWAI"));
		        	...
		        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", Ahli_Peranan, "1", RO_MaklumatMesyuarat);
		        	Ahli_Pegawai = model.getSOCPegawaiByNegeri(ID_MESYUARAT,"SOC_PEGAWAI", SOC_PEGAWAI, SOC_NEGERI, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai1');\"",submit,actionx);
		      	Vector getMaklumatPegawai = new Vector();
		        	getMaklumatPegawai = model.getMaklumatPegawai(getParam("SOC_PEGAWAI"));
	        		if (!getMaklumatPegawai.isEmpty()) {
	        			h = (Hashtable) getMaklumatPegawai.get(0);	        			
		        ...
		        //	context.put("Ahli_Negeri", HTML.SelectNegeri("SOC_NEGERI", Utils.parseLong(SOC_NEGERI), RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changeNegeri3');\""));
		        	...
		        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", Ahli_Peranan, "1", RO_MaklumatMesyuarat);
		        	Ahli_Pegawai = model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", SOC_PEGAWAI, SOC_SEKSYEN, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai2');\"",submit,actionx);
		        	Vector getMaklumatPegawai = new Vector();
		        	getMaklumatPegawai = model.getMaklumatPegawai(getParam("SOC_PEGAWAI"));
	        		if (!getMaklumatPegawai.isEmpty()) {
	        			h = (Hashtable) getMaklumatPegawai.get(0);	        			
		        	...
		        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", Ahli_Peranan, "1", RO_MaklumatMesyuarat);
		        	Ahli_Pegawai = model.getSOCPegawaiByNegeri(ID_MESYUARAT,"SOC_PEGAWAI", SOC_PEGAWAI, SOC_NEGERI, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai3');\"",submit,actionx);
		      	Vector getMaklumatPegawai = new Vector();
		        	getMaklumatPegawai = model.getMaklumatPegawai(getParam("SOC_PEGAWAI"));
	        		if (!getMaklumatPegawai.isEmpty()) {
	        			h = (Hashtable) getMaklumatPegawai.get(0);	        			
		        	...
		        	Ahli_Kategori2 = "";
		        	Ahli_Kategori3 = "";
		        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", "", "1", RO_MaklumatMesyuarat);
		        	Ahli_Pegawai = model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", "", Ahli_Seksyen, "1", RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai');\"",submit,actionx);
		        	context.put("Ahli_Negeri", HTML.SelectNegeri("SOC_NEGERI", Utils.parseLong(null), RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changeNegeri');\""));
		        	context.put("Ahli_Seksyen", HTML.SelectSeksyen("SOC_SEKSYEN", Utils.parseLong(null), RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changeSeksyen');\""));
		        ...
		        // add by rizuan
				        	...
				        	Ahli_Kategori2 = "";
				        	Ahli_Kategori3 = "checked=\"checked\"";
				        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", Ahli_Peranan, "3", RO_MaklumatMesyuarat);
				        	Ahli_Pegawai = model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", "", SOC_SEKSYEN, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai2');\"",submit,actionx);
				        	...
				        	Ahli_Kategori3 = "checked=\"checked\"";
				        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", Ahli_Peranan, "3", RO_MaklumatMesyuarat);
				        	Ahli_Pegawai = model.getSOCPegawaiByNegeri(ID_MESYUARAT,"SOC_PEGAWAI", "", SOC_NEGERI, Ahli_Kategori, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai3');\"",submit,actionx);
				        	...
				        	Ahli_Kategori2 = "";
				        	Ahli_Kategori3 = "checked=\"checked\"";
				        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", "", "3", RO_MaklumatMesyuarat);
				        	Ahli_Pegawai = model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", "", Ahli_Seksyen, "3", RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai2');\"",submit,actionx);
				        	context.put("Ahli_Seksyen3", HTML.SelectSeksyen("SOC_SEKSYEN", Utils.parseLong(null), RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changeSeksyen3');\""));
				        	context.put("Ahli_Negeri3", HTML.SelectNegeri("SOC_NEGERI", Utils.parseLong(null), RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changeNegeri3');\""));
		        ...
		        // end by rizuan
		        	...
		        	Ahli_Kategori2 = "checked=\"checked\"";
		        	Ahli_Kategori3 = "";
		        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", "", "2", RO_MaklumatMesyuarat);
		    ...
		    /*    else if ("changePegawai".equalsIgnoreCase(submit)) {
		        	...
		        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", Ahli_Peranan, "2", RO_MaklumatMesyuarat);
		     ...
		     /*   else if ("changeKategori3".equalsIgnoreCase(submit)) {
		        	...
		        	Ahli_Kategori3 = "checked=\"checked\"";
		        	Ahli_Peranan = model.getSOCPerananAhliMesyuarat("SOC_PERANAN", Ahli_Peranan, "1", RO_MaklumatMesyuarat);
		        	Ahli_Pegawai = model.getSOCPegawaiBySeksyen(ID_MESYUARAT,"SOC_PEGAWAI", SOC_PEGAWAI, Ahli_Seksyen, "3", RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changePegawai');\"",submit,actionx);
		        	...
		        	context.put("SubMinit_Agenda", model.getSOCAgendaMesyuarat("SOC_AGENDA", SOC_AGENDA, ID_MESYUARAT, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changeAgenda')\""));
		        	context.put("SubMinit_Minit", model.getSOCMinitMesyuarat("SOC_MINIT", SOC_MINIT, SOC_AGENDA, RO_MaklumatMesyuarat));
		        } else if ("clickAddButton".equalsIgnoreCase(submit)) {
		        	String addType = getParam("addType");
		        	String addId = getParam("addId");
		        	String addIdMinit = model.getIDMinit(addType, addId);
		        	String addIdAgenda = model.getIDAgenda(addType, addId);
		        	context.put("Minit_Agenda", model.getSOCAgendaMesyuarat("SOC_AGENDA", addIdAgenda, ID_MESYUARAT, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changeAgenda')\""));
		        	context.put("SubMinit_Agenda", model.getSOCAgendaMesyuarat("SOC_AGENDA", addIdAgenda, ID_MESYUARAT, RO_MaklumatMesyuarat, " onchange=\"doChangeSOC('changeAgenda')\""));
		        	context.put("SubMinit_Minit", model.getSOCMinitMesyuarat("SOC_MINIT", addIdMinit, addIdAgenda, RO_MaklumatMesyuarat));
		        }
		    	context.put("Ahli_Kategori", Ahli_Kategori);
		    	context.put("Ahli_Kategori1", Ahli_Kategori1);
		    	context.put("Ahli_Kategori2", Ahli_Kategori2);
	...
	private void listPegawai(HttpSession session) throws Exception {
		String user_id = (String)session.getAttribute("_ekptg_user_id");
		FrmModelMesyuaratSenarai.setListPegawai(user_id,(String) session.getAttribute("_ekptg_user_negeri"));
	...
	private void view_Seksyen(HttpSession session) throws Exception {
		String user_id = (String)session.getAttribute("_ekptg_user_id");
		FrmModelMesyuaratSenarai.setSeksyen(user_id);

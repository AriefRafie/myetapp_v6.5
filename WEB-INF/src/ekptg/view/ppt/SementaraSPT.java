...
import ekptg.model.ppt.FrmHakmilikSementaraPermohonanSPTData;
import ekptg.model.ppt.FrmHakmilikSementaraPermohonanSPTMaklumatTanahData;
import ekptg.model.ppt.FrmHakmilikSementaraSenaraiPermohonanSPTData;

public class SementaraSPT extends AjaxBasedModule{
	...
	public String doTemplate2() throws Exception {
        ...
        FrmHakmilikSementaraSenaraiPermohonanSPTData senaraiPrmhnnSPT = new FrmHakmilikSementaraSenaraiPermohonanSPTData();
        FrmHakmilikSementaraPermohonanSPTData prmhnnSPT = new FrmHakmilikSementaraPermohonanSPTData();
        FrmHakmilikSementaraPermohonanSPTMaklumatTanahData prmnhnnSPTMaklumatTanah = new FrmHakmilikSementaraPermohonanSPTMaklumatTanahData();
        
        Vector listPermohonanSPT = null;
        ...
        if ("baru".equals(action)){
        	 vm = "app/ppt/frmHakmilikSementaraPermohonanSPT.jsp";
        	String now = "";
        	...
        	vm = "app/ppt/frmHakmilikSementaraSenaraiPermohonanSPT.jsp";
        	
        	
        	context.put("mode", "simpan");
 	        
        	senaraiPrmhnnSPT.setListPemohon();
 	        listPermohonanSPT = senaraiPrmhnnSPT.getList();
 	        context.put("PermohonanListSPT", listPermohonanSPT);
 	        context.put("carianPermohonan", "");
 			context.put("carianTarikh", "");
 	        setupPage(session,action,listPermohonanSPT);
        ...
        else if("kemaskini".equals(action))
    	{
    		...
    		prmhnnSPT.setListPohon(id);
    		listPohon = prmhnnSPT.getListPohon();
    		
    		prmhnnSPT.setListPohon2(id);
    		listPohon2 = prmhnnSPT.getListPohon2();
    		
    		prmhnnSPT.setListMaklumatTanah(id);
    		listMaklumatTanah = prmhnnSPT.getListMaklumatTanah();
    		
    		prmhnnSPT.setListDokumen(id);
    		listDokumen = prmhnnSPT.getListDokumen();
    		...
    		context.put("SelectNegeri",HTML.SelectNegeri("negeri",Long.parseLong(h.get("idNegeri").toString()),"style=width:300px"));
    		context.put("project_negeri",HTML.SelectNegeri("projek_negeri",Long.parseLong(i.get("idProjekNegeri").toString()),null,"style=width:300px onChange=\"doChangeidProjekNegeriUpdate();\" "));
    	...
    	else if("semak".equals(action))
    	{
    		...
    		context.put("SelectNegeri",HTML.SelectNegeri("negeri",Long.parseLong(h.get("idNegeri").toString()),"style=width:300px class=disabled disabled"));
    		...
    		Hashtable i = (Hashtable) listPohon2.get(0);
    		context.put("project_negeri",HTML.SelectNegeri("projek_negeri",Long.parseLong(i.get("idProjekNegeri").toString()),"style=width:300px class=disabled disabled"));
    		context.put("idFail", i.get("id_fail"));
    	...
    	{
    		vm = "app/ppt/frmHakmilikSementaraPermohonanSPTMaklumatDokumen.jsp";
    	...
    	{
    		vm = "app/ppt/frmHakmilikSementaraPermohonanSPTMaklumatTanah.jsp";
    		...
    		String _idDaerah = i.get("idDaerah").toString();
    	...
    	else if("edit_maklumat".equals(action))
    	{
    		...
    		prmhnnSPT.setListPohon(idP);
    		listPohon = prmhnnSPT.getListPohon();
    		
    		prmhnnSPT.setListPohon2(idP);
    		listPohon2 = prmhnnSPT.getListPohon2();
    		
    		prmnhnnSPTMaklumatTanah.setMaklumatTanah(id);
    	...
    	else if("updateMaklumatTanah".equals(action))
    	{
    		...
    		prmhnnSPT.setListPohon(id_permohonan);
  			listPohon = prmhnnSPT.getListPohon();
  		
  			prmhnnSPT.setListPohon2(id_permohonan);
  			listPohon2 = prmhnnSPT.getListPohon2();
    		...
    		prmnhnnSPTMaklumatTanah.setMaklumatTanah(id_hakmilik);
    		dataMaklumatTanah = prmnhnnSPTMaklumatTanah.getMaklumatTanah();
		    ...
		    context.put("listD_size", listDokumen.size());
  			...
  			context.put("SelectNegeri",HTML.SelectNegeri("negeri",Long.parseLong(h.get("idNegeri").toString()),"class=disabled disabled"));
        	...
        	context.put("addTujuan", h.get("tujuan"));
     		...
     		context.put("idSuburusan", h.get("idSuburusan"));
  			...
  			Hashtable i = (Hashtable) listPohon2.get(0);
  			context.put("project_negeri",HTML.SelectNegeri("projek_negeri",Long.parseLong(i.get("idProjekNegeri").toString()),"class=disabled disabled"));
    	...
    	else if("lulus".equals(action))
    	{
    		...
    		context.put("PermohonanListSPT", listPermohonanSPT);
    		context.put("list_size", listPermohonanSPT.size());
    		context.put("carianPermohonan", "");
			context.put("carianTarikh", "");
			setupPage(session,action,listPermohonanSPT);
    		...
    		context.put("tarikhPohon", getParam("tarikh_permohonan"));
    		context.put("mode","baru");
    		context.put("noPermohonan","");
    		...
    		context.put("SelectNegeri",HTML.SelectNegeri("negeri",Utils.parseLong(idNegeri),"style=width:300px"));
    		...
    		alamatKementerian = prmhnnSPT.getAlamatKementerian(idKementerian);
    		...
    		alamatKementerian = prmhnnSPT.getAlamatKementerian(idEditKementerian);
    		...
    		context.put("SelectNegeri",HTML.SelectNegeri("negeri",Utils.parseLong(idNegeri),"style=width:300px"));
    		context.put("project_negeri",HTML.SelectNegeri("projek_negeri",Utils.parseLong(idProjekNegeri),null,"style=width:300px onChange=\"doChangeidProjekNegeriUpdate();\" "));
    		...
    		context.put("project_negeri",HTML.SelectNegeri("projek_negeri",Utils.parseLong(idEditProjekNegeri),null,"style=width:300px onChange=\"doChangeidNegeriUpdate();\" "));
    		...
    		context.put("SelectNegeri",HTML.SelectNegeri("negeri",Utils.parseLong(idNegeri),"style=width:300px"));
    		context.put("project_negeri",HTML.SelectNegeri("projek_negeri",Utils.parseLong(idEditProjekNegeri),null,"style=width:300px onChange=\"doChangeidProjekNegeriUpdate();\" "));
    		...
    		context.put("SelectNegeri",HTML.SelectNegeri("negeri",Utils.parseLong(idNegeri),"style=width:300px",null));
    		context.put("project_negeri",HTML.SelectNegeri("projek_negeri",Utils.parseLong(idProjekNegeri),null,"style=width:300px onChange=\"doChangeidNegeri();\" "));
    		...
    		//--Filter--//
    		context.put("SelectKementerian",HTML.SelectKementerian("kementerian",Utils.parseLong(idKementerian),null,"style=width:470px onChange=\"doChangeidKementerianUpdate();\" "));
    		context.put("SelectNegeri",HTML.SelectNegeri("negeri",Utils.parseLong(idNegeri),null,"style=width:300px onChange=\"doChangeidNegeriUpdate();\" "));
    		context.put("project_negeri",HTML.SelectNegeri("projek_negeri",Utils.parseLong(idEditProjekNegeri),null,"style=width:300px onChange=\"doChangeidProjekNegeriUpdate();\" "));
	...
	private void addSPT(HttpSession session) throws Exception{
	    Hashtable h = new Hashtable();
	    	...
	    	FrmHakmilikSementaraPermohonanSPTData.addSPT(h);
	...
	private void update(HttpSession session) throws Exception
	  {
	    ...
	    Hashtable h = new Hashtable();
	    	...
	    	FrmHakmilikSementaraPermohonanSPTData.update(h);
	 ...
	 private void sah(HttpSession session) throws Exception{
		    Hashtable h = new Hashtable();
		    h.put("id_permohonan", getParam("id_permohonan"));
		    FrmHakmilikSementaraPermohonanSPTData.sahkan(h);  
		 	}
	 ...
	 private void lulus(HttpSession session) throws Exception{
		 ...
		 FrmHakmilikSementaraPermohonanSPTData.lulus(h);
	  	}
	 private void add_maklumat_tanah(HttpSession session) throws Exception{
			...
			Hashtable h = new Hashtable();
		    	...
		    	h.put("mukim", getParam("id_existMukim"));
		    	...
		    	FrmHakmilikSementaraPermohonanSPTMaklumatTanahData.add_maklumat_tanah(h);
	 ...
	 private void updateMaklumatTanah(HttpSession session) throws Exception{
		 ...
		 String id_hakmilik = getParam("id_hakmilik");
		    ...
		    FrmHakmilikSementaraPermohonanSPTMaklumatTanahData.updateMaklumatTanah(i);
	  }
	 private void deleteMaklumatTanah(HttpSession session) throws Exception{
		    String id = getParam("id_hakmilik");	    
		    FrmHakmilikSementaraPermohonanSPTMaklumatTanahData.deleteMaklumatTanah(id);
		  }

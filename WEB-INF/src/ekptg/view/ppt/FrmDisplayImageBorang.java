...
public class FrmDisplayImageBorang implements IServlet2 {
	...
	public void doService(HttpServletRequest request,
		...
		try {
			...
			PreparedStatement ps = con
					.prepareStatement("SELECT IMEJ,JENIS_MIME FROM"
							+ " TBLPPTIMEJBORANG WHERE ID_PPTIMEJBORANG = ?");
			String id = request.getParameter("id");
			System.out.println("String id ===== " + id);
			ps.setString(1, id);
			ResultSet rs = ps.executeQuery();
			if (rs.next()) {
				Blob b = rs.getBlob("imej");

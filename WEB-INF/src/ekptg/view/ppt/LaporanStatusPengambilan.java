...
public class LaporanStatusPengambilan extends AjaxBasedModule{	
	
	static Logger myLogger = Logger.getLogger(LaporanStatusPengambilan.class);
	...
	public String doTemplate2() throws Exception{
		...
		String vm = ""; 
		String mainpage = "app/ppt/LAPORAN/LaporanStatusPengambilan.jsp";

...
public class FrmUPTSek8InfoTanahTerperinciBangunan extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	static Logger myLogger = Logger.getLogger(FrmUPTSek8InfoTanahTerperinciBangunan.class);
	...
	public String doTemplate2() throws Exception{
		...
		Vector senarai_tanah = null; //yati
		Vector senarai_bangunan = null; //yati
    	...
    	*/
    	...
    	if("viewInfoTanah".equals(submit)){
 		...
 		//data maklumat tanah
    		...
    		String txtLainBangunan = getParam("txtLainBangunan");
    		//context.put("txtLainBangunan", txtLainBangunan);
    		...
    		//dropdown
    		context.put("selectTanah",HTMLPPT.SelectTanah("socTanah", null, null, ""));
    		//context.put("selectBangunan",HTMLPPT.SelectBangunan("socBangunan", null, null, ""+mode+" onChange=\"onchangeBangunan(this.value,'socBangunan');\""));
    		  
    		//penambahan yati
    		context.put("selectBangunan",HTMLPPT.SelectBangunan("socBangunan",null,null,""+mode+" style=width:250px id=socBangunan onchange=\"onchangeJenisBangunan(this.value,'socBangunan');\""));
    		//list bangunan
        	...
        	if("onchangeNegeri".equals(submit2)){
        		...
        		if (doPost.equals("true")) {
        			...
        			/*
        			if(modelUPT.cekStatusFailDahWujud(idpermohonan,"46","52")==false)
            		{
        ...
        if("viewBangunan".equals(submit)){
			...
			String idNegeri = "";
			String idBandar = "";
			String idKategoriTanah = "";
			//String idJenisBangunan = "";
     		if(dataBangunan.size()!=0){
     			...
     			idKategoriTanah = (String)db.get("id_kategori_tanah");
     			idJenisBangunan = (String)db.get("jenis_bangunan");
     			
     				//System.out.println("ID JENIS BANGUNAN cccc: "+idJenisBangunan);
     		}
     		//dropdown
    		...
    		context.put("selectTanah",HTMLPPT.SelectTanah("socTanah",Utils.parseLong(idKategoriTanah),null,"style=width:auto disabled class=disabled"));
    		...
    		//context.put("selectBangunan",HTMLPPT.SelectBangunan("socBangunan",Utils.parseLong(idJenisBangunan),null,"style=width:auto disabled class=disabled"));
    		//System.out.println("CHECK TANAH "+idKategoriTanah);
    		//data bangunan
    		dataBangunan(session,id_bangunan);
    		context.put("idKategoriTanah",idKategoriTanah);
        	...
        	if("kemaskiniBangunan".equals(submit2)){
        		...
        		//dropdown
         		...
         		String socBangunan =getParam("socBangunan");
         		//context.put("selectBangunan",HTMLPPT.SelectBangunan("socBangunan", null, null, "style=width:auto onChange=\"onchangeBangunan(this.value,'socBangunan');\""));
         		...
         		String katTanah = getParam("socTanah");
         		
         		//String idKategoriTanah =getParam("socTanah");
         		context.put("selectTanah",HTMLPPT.SelectTanah("socTanah",Utils.parseLong(idKategoriTanah), null, ""));
            	...
            	if("onchangeJenisBangunanUpdate".equals(submit3)){
            		...
            		//idJenisBangunan = getParam("idJenisBangunan");
            		context.put("idJenisBangunan", idJenisBangunan);
            		//System.out.println("idJenisBangunan---------"+idJenisBangunan);
    	...
    	if("tambahMaklumatBangunanPB".equals(submit)){
        	...
        	if("pilihPB".equals(submit2)){
        		...
        		// yati 23/12
        		/*String socBangunan =getParam("socBangunan");
        		context.put("selectBangunan",HTMLPPT.SelectBangunan("socBangunan", Utils.parseLong(socBangunan), null, ""));
        		if(socBangunan != ""){
        			context.put("selectBangunan",HTMLPPT.SelectBangunan("socBangunan", Utils.parseLong(socBangunan), null, ""));
...
//            		}
    	...
    	if("hapusBangunanPB".equals(submit)){
    		...
    		context.put("txtSaizBangunanDua", "");
...
//--METHOD--//	
	...
	private void ListCarian(HttpSession session,String userIdNeg) throws Exception{
		...
		FrmUPTSek8InfoTanahTerperinciBangunanData.setListCarian(nofail,tarikh,status,userIdNeg);
	...
	private void getAndSetItemMB(HttpSession session,String mode) throws Exception{
		...
		String socTanah = getParam("socTanah"); // UNTUK PEGANG VALUE BILA PAGE LOAD
		
		if(mode.equals("new")){
			context.put("selectTanah",HTMLPPT.SelectTanah("socTanah", Utils.parseLong(socTanah), null, ""));
    		
			//context.put("selectNegeri",HTML.SelectNegeriMampu("socNegeri",Utils.parseLong(socTanah),null,"style=width:auto onChange=\"onchangeNegeri();\""));
		}else{
			context.put("selectTanah",HTMLPPT.SelectTanah("socTanah", Utils.parseLong(socTanah), null, ""));
    		
			//context.put("selectNegeri",HTML.SelectNegeriMampu("socNegeri",Utils.parseLong(socTanah),null,"style=width:auto onChange=\"onchangeNegeriUpdate();\""));
		}
		...
		if(mode.equals("new")){
			context.put("selectBangunan",HTMLPPT.SelectBangunan("socBangunan",Utils.parseLong(socBangunan),null,""+mode+" style=width:auto id=socBangunan onchange=\"onchangeJenisBangunan(this.value,'socBangunan');\""));
		...
		//context.put("socBangunan",getParam("socBangunan"));
		context.put("sorSaiz",getParam("sorSaiz"));
		context.put("txtNoBangunan",getParam("txtNoBangunan"));
		//context.put("socBangunan",getParam("socBangunan"));
		context.put("socTanah",getParam("socTanah"));
		context.put("txtLainBangunan",getParam("txtLainBangunan"));
		context.put("txtSaizBangunan",getParam("txtSaizBangunan"));
		context.put("txtSaizBangunanDua",getParam("txtSaizBangunanDua"));
...
//		}
	...
	private void updateSuburusanStatusFailPPT(HttpSession session,String id_permohonan,String id_fail,String id_suburusanstatusfailppt) throws Exception{
		...
		modelUPT.updateSuburusanStatusFailPPT(h,id_suburusanstatusfailppt,"1475");

...
public class SkrinPopupHakmilik extends AjaxBasedModule {
	static Logger myLogger = Logger.getLogger(SkrinPopupHakmilik.class);
	private final String PATH="app/ppt/PopupHakmilik/";
	private String vm = PATH +"SkrinPopupHakmilik.jsp";

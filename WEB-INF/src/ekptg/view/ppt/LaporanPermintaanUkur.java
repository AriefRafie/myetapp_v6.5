...
public class LaporanPermintaanUkur extends AjaxBasedModule{	
	
	static Logger myLogger = Logger.getLogger(LaporanBulananAfidavit.class);
	...
	public String doTemplate2() throws Exception{
		...
		Vector dataNegeriJKPTG = new Vector();
		dataNegeriJKPTG.clear();
		
		String vm = ""; 
		String mainpage = "app/ppt/LAPORAN/LaporanPermintaanUkur.jsp";

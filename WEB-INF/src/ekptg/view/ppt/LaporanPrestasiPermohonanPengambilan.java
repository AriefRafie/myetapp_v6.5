...
public class LaporanPrestasiPermohonanPengambilan extends AjaxBasedModule{	
	
	static Logger myLogger = Logger.getLogger(LaporanPrestasiPermohonanPengambilan.class);
	...
	public String doTemplate2() throws Exception{
		...
		String vm = ""; 
		String mainpage = "app/ppt/LAPORAN/LaporanPrestasiPermohonanPengambilan.jsp";

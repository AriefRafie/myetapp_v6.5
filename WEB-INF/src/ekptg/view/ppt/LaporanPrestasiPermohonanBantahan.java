...
public class LaporanPrestasiPermohonanBantahan extends AjaxBasedModule{	
	
	static Logger myLogger = Logger.getLogger(LaporanPrestasiPermohonanBantahan.class);
	...
	public String doTemplate2() throws Exception{
		...
		String vm = ""; 
		String mainpage = "app/ppt/LAPORAN/LaporanPrestasiPermohonanBantahan.jsp";

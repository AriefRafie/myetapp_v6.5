...
public class FrmRayuanOnline  extends AjaxBasedModule {	
	/**
	 * 
	 */
	private static final long serialVersionUID = -2134293724087904664L;
	static Logger myLogger = Logger.getLogger(FrmRayuanOnline.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	// SCREEN JSP
		String skrinListDepan = "app/ppt/frmRayuanOnline.jsp";
		String skrinDaftarBantahanMasterAP = "app/ppt/frmRayuanOnline.jsp";
		String skrinDepositAP = "app/ppt/frmRayuanOnline.jsp"; 
...
//        		context.put("getSenaraiNoLot", listE);
        		...
        		vm = "app/ppt/frmBantahanAgensiSenaraiPB.jsp"; 
               	...
               	//GET LIST DATA
        		list = modelBantahanPB.getListRayuanOnline(userIdNeg,idkementerian);		
        		...
        		context.put("selectKementerian",HTML.SelectKementerian("socKementerian",Utils.parseLong(id_Kementerian),"style=width:470px"));
        		socKementerian = HTML.SelectKementerian("socKementerian", Utils.parseLong(id_Kementerian), "disabled class=disabled","onChange=\"doChangeKementerianX()\" style=\"width:400\"");
    			...
    			context.put("txtNoFail", "");
               	...
               	//GET LIST DATA
        		listPageDepan = modelBantahanPB.getListRayuanOnline(userIdNeg,id_Kementerian );	

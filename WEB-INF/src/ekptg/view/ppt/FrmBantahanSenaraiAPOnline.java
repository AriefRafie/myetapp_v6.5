...
public class FrmBantahanSenaraiAPOnline extends AjaxBasedModule {
	...
	// MODEL
	BantahanDaftar modelBantahan = new BantahanDaftar();
	...
	public String doTemplate2() throws Exception
    {
		...
		listHeader = modelBantahan.getHeader(id_fail,id_permohonan); 
		...
		//GET MAX NO SIASATAN
		listH = modelBantahan.getNoSiasatan(id_permohonan,id_hakmilik);
		...
		Hashtable statusFail = modelBantahan.getStatusFail(id_permohonan);	
		...
		// SCREEN JSP
		String skrinListPermohonanAP = "app/ppt/frmBantahanSenaraiAPOnline.jsp";
	    String skrinDaftarOnlineInternalAP = "app/ppt/frmBantahanDaftarAPOnlineInternal.jsp";  
...
//    		
//    		if (listE.size()!=0){
//    			context.put("selectHakmilik",HTML.SelectHakmilik(id_hakmilik,id_pihakberkepentingan,"socHakmilik","style=width:auto tabindex=5 onChange=\"doChangeNoLot();\" disabled "));
//    			context.put("selectNoLot",HTML.SelectNoLotByHakmilik(id_hakmilik,"socNoLot","style=width:auto tabindex=7 disabled "));
//    			context.put("selectNamaPembantah", HTML.SelectNamaPembantahByIdPihakBerkepentingan(id_hakmilikpb, "socNamaPembantah", null, "style=width:auto tabindex=11 disabled", null));
...
//							//----SYARAT A
//							tarikh_terimaborangh = lebah.util.Util.getDateTime((Date)c.get("tarikh_terimaborangh"), "dd/MM/yyyy");
...
//								if (BGdateDiffInt < BHdateDiffInt ){ // CHECKING ANT BORANG H & BORANG G YANA MANA TAMAT DAHULU
...
//			//CHECKING SAMAADA PIHAK BERKEPENTINGAN SUDAH BUAT BANTAHAN ATAU TIDAK			
//			Hashtable getFlagBantahan =  model.getFlagBantahan(id_hakmilikp);
//			String flag_bantahan = getFlagBantahan.get("flag_bantahan").toString();
//			//END			
//				if(!flag_bantahan.equals("1")){					
...
//     		setupPagePB(session,action,listE);
    		...
    		modelAPonline.setMaklumatAgensi_DgnBantahanOnlineInternal(id_bantahan);
     		listMaklumatBantahanAgensi = modelAPonline.getMaklumatAgensi_DgnBantahanOnlineInternal();
			...
			maklumatBantahan = modelAPonline.getMaklumatBantahan(id_permohonan,id_bantahan);
    		...
    		//GETHAKMILIK
    		Hashtable getHakmilik =  modelAPonline.getHakmilikPortal(id_hakmilik);
    		...
    		vm =  skrinDaftarOnlineInternalAP;
    		
		}else if("KaunterSahkan_permohonan".equals(submit)){
        	
			// UPDATE FLAG ONLINE
			pengesahan_internal(id_bantahan,usid);
			
    		// GET LIST HAKMILIK YG DAH BUAT BANTAHAN
			modelAPonline.setMaklumatAgensi_DgnBantahanOnlineInternal(id_bantahan);
     		listMaklumatTanah = modelAPonline.getMaklumatAgensi_DgnBantahanOnlineInternal();
     		context.put("saiz_listTanah", listMaklumatTanah.size());	
			...
			if (maklumatBantahan.size()!=0 ){				
				...
				String flag_ukur_luas = (String)b.get("flag_ukur_luas");
				String flag_pampasan = (String)b.get("flag_pampasan");								
				flag_online = (String)b.get("flag_pampasan");
...
//			}
				...
				getDataBorangO = modelBantahan.getDataBorangO(idBorangO);
...
//				myLogger.info("id bantahan >>> "+id_bantahan);
				...
				listA = modelBantahan.getMaklumatSusulan(id_bantahan);
				...
				if (listA.size()!=0){					
					...
					if (!no_rujukan_tanah.equals("")){
						...
						String checkingDateTerimaPerintah =  modelBantahan.checkingDateTerimaPerintah(tarikh_terimaPerintah);							
						// CONVERT STRING TO INT
...
//				String id_bantahan = "";
				...
				if( id_bantahan.equals("") || id_bantahan.equals(null) ){	
					...
					listA = modelBantahan.getMaklumatTarikBalik(id_bantahan);
...
//				String id_bantahan = "";
				...
				if( id_bantahan.equals("") || id_bantahan.equals(null) ){	
					...
					listA = modelBantahan.getMaklumatBatalMahkamah(id_bantahan);
...
//    		setupPagePB(session,action,listE);
    		...
    		vm = "app/ppt/frmBantahanSenaraiPB.jsp"; 
           	...
           	//GET LIST DATA
    		list = modelAPonline.getListPemohonAPOnliheInternal("","");		
			...
			list = modelAPonline.getListPemohonAPOnliheInternal(txtNoFail,tarikh_permohonan);
	...
	private void pengesahan_internal(String id_bantahan, String usid) throws Exception {
		modelAPonline.pengesahan_internal(id_bantahan,usid);
	...
	private void carianBantahan(String usid, String userIdNeg) throws Exception {
		...
		modelBantahan.setCarianFailAP(usid,txtNoFail,idKementerian,userIdNeg );
...
//		String socBank = getParam("socBank");
	...
	private void updateBantahan(String usid, String id_bantahan) throws Exception {
	    ...
	    modelOperations.updateBantahan(id_bantahan,txtNoBantahan,txdTkhMasuk,txdTkhTerimaBrgN,txdBrgN,
	    		...
	    		amaun_pampasan,terima_pampasan,umpuk_pampasan,txtAmaunTuntutan,""); 
	}

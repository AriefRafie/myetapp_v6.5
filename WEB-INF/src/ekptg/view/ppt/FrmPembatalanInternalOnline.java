...
public class FrmPembatalanInternalOnline extends AjaxBasedModule{	
	...
	public String doTemplate2() throws Exception{
		...
		this.context.put("portal_module", portal_module);
		myLogger.info("portal_module :"+portal_module);
		...
		//fail pembatalan expired
    	listPembatalanExpired = modelOnline.getListPembatalanExpired(id_user);    		
...
/* Sepatutnya kat dalam internal time sahkan */
	...
	/*		maklumat_keputusan = logic.maklumat_keputusan(getParam("id_permohonan"));
		...
		/*	maklumat_keputusan = logic.maklumat_keputusan(getParam("id_permohonan"));
			...
			listdepan = logic.senarai_pembatalan_carian_online("","","","","","","","","","","",id_user,(String)session.getAttribute("_portal_role"));						
			this.context.put("listdepan",listdepan);
		...
		{	
			...
			listdepan = logic.senarai_pembatalan_carian_online(getParam("socStatus"),getParam("socJenisHakmilik"),getParam("socNegeri"),getParam("txtNoFailCarian").trim(),
		...
		System.out.println("vm last apa : "+vm);
	...
	private void updateFlag(HttpSession session,String flag) throws Exception{
	    	...
	    	FrmPembatalanInternalData.updateFlag(h,"batal");
	...
	private void uploadFiles() throws Exception {
	 ...
	 private void updatePembatalanOnline(HttpSession session) throws Exception {
			...
			h.put("id_permohonan", getParam("id_permohonan"));
			h.put("id_Masuk", (String) session.getAttribute("_ekptg_user_id"));
			logic.updatePembatalanOnline(h);
	 ...
	 private void updatePembatalanOnlineTolak(HttpSession session) throws Exception {
			...
			h.put("id_permohonan", getParam("id_permohonan"));
			h.put("id_Masuk", (String) session.getAttribute("_ekptg_user_id"));
			logic.updatePembatalanOnlineTolak(h);

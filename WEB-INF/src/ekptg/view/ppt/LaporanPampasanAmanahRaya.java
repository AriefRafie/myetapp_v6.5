...
public class LaporanPampasanAmanahRaya extends AjaxBasedModule{	
	
	static Logger myLogger = Logger.getLogger(LaporanPampasanAmanahRaya.class);
	...
	public String doTemplate2() throws Exception{
		...
		String vm = ""; 
		String mainpage = "app/ppt/LAPORAN/LaporanPampasanAmanahRaya.jsp";

...
public class LaporanPrestasiBayaran extends AjaxBasedModule{	
	
	static Logger myLogger = Logger.getLogger(LaporanPrestasiBayaran.class);
	...
	public String doTemplate2() throws Exception{
		...
		String vm = ""; 
		String mainpage = "app/ppt/LAPORAN/LaporanPrestasiBayaran.jsp";

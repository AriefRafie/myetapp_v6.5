...
public class LaporanPemantauanPU extends AjaxBasedModule{	
	
	static Logger myLogger = Logger.getLogger(LaporanPemantauanPU.class);
	...
	public String doTemplate2() throws Exception{
		...
		String vm = ""; 
		String mainpage = "app/ppt/LAPORAN/LaporanPemantauanPU.jsp";

...
public class FrmLaporanRingkasanPermohonan extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger myLog = Logger.getLogger(ekptg.view.ppt.laporan.FrmLaporanRingkasanPermohonan.class);
	String socNegeri = "";
	String socUnit = "";
	Vector<?> vecHash = null;
	...
	public String doTemplate2() throws Exception {
		...
		String vm = "app/ppt/LAPORAN/frmLaporanRingkasan.jsp";

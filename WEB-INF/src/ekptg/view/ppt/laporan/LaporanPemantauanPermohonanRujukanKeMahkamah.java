...
public class LaporanPemantauanPermohonanRujukanKeMahkamah extends AjaxBasedModule{
	
	static Logger myLogger = Logger.getLogger(LaporanPemantauanPermohonanRujukanKeMahkamah.class);
	@Override
	public String doTemplate2() throws Exception {
		...
		String mainpage = "app/ppt/LAPORAN/LaporanPemantauanPermohonanRujukanKeMahkamah.jsp";

...
public class FrmLaporanSenaraiPermohonan extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger myLog = Logger.getLogger(ekptg.view.ppt.laporan.FrmLaporanSenaraiPermohonan.class);
	String socNegeri = "";
	String socDaerah = "";
	String socUnit = "";
	Vector<?> vecHash = null;
	...
	public String doTemplate2() throws Exception {
		...
		String vm = "app/ppt/LAPORAN/frmLaporanSenaraiPermohonan.jsp";
    	...
    	if ("PilihNegeri".equals(submit)){
			...
			socDaerah =  UtilHTML.SelectDaerahByNegeri(String.valueOf(tempIdNegeri),"socDaerah");
    		Long tempIdKem = 0L;
    		if(!"".equals(getParam("socKementerian"))){
    			tempIdKem = Long.parseLong(getParam("socKementerian"));
    		}else{
    			tempIdKem = Long.parseLong(String.valueOf("0"));
    		}
   			//socKementerian = HTML.SelectKementerian("socKementerian", tempIdKem, null, "onChange=\"doChangeUnit()\" style=\"width:400\"");
   			socKementerian = UtilHTML.SelectKementerianAktif("socKementerian", tempIdKem, null, "onChange=\"doChangeUnit()\" style=\"width:400\"");
   			
   			Long tempIdAgensi= 0L;
    		if(!"".equals(getParam("socAgensi"))){
    			tempIdAgensi = Long.parseLong(getParam("socAgensi"));
    		}else{
    			tempIdAgensi = Long.parseLong(String.valueOf("0"));
    		}
    		socAgensi = HTML.SelectAgensiByKementerian("socAgensi",String.valueOf(tempIdKem),tempIdAgensi," style=\"width:400\"");
    		//socJenisTanahtemp
//    		paparanRekod(userLevel,userId);
    		...
    		if(!"".equals(getParam("socDaerah"))){
    			tempIdDaerah = Long.parseLong(getParam("socDaerah"));
    		}else{
			...
			socDaerah =  UtilHTML.SelectDaerahByNegeri(String.valueOf(tempIdNegeri), "socDaerah",tempIdDaerah, "");
   	   		Long tempIdAgensi= 0L;
    		if(!"".equals(getParam("socAgensi"))){
    			tempIdAgensi = Long.parseLong(getParam("socAgensi"));
    		}else{
    		...
    		socAgensi = HTML.SelectAgensiByKementerian("socAgensi",id_kementerian,tempIdAgensi," style=\"width:400\"");
    		if(!jenisTanah.equals("")){
    			if(jenisTanah.equals("1")){
    				templates = "Milik" ;
			...
			String tempIdDaerah = getParam("socDaerah");
      		if("".equals(getParam("socDaerah"))){
     			tempIdDaerah = "0";
    		} 
      		if(!"".equals(getParam("socKementerian"))){
      			tempIdKementerian = Long.parseLong(getParam("socKementerian"));
        		if(!jenisTanah.equals("")){
        			//vecHash = FrmUtilData.getLaporanMengikutUrusan("61",null,"L");
        			if(jenisTanah.equals("1")){
        				templates = "Milik%%Kem" ;
			...
			socDaerah =  UtilHTML.SelectDaerahByNegeri(String.valueOf(tempIdNegeri), "socDaerah",Long.parseLong(tempIdDaerah), "");
			socAgensi = HTML.SelectAgensiByKementerian("socAgensi",String.valueOf(tempIdKementerian),Long.parseLong("1")," style=\"width:400\"");
  			if(!"".equals(getParam("socNegeri")) && !"".equals(getParam("socKementerian"))){
      			tempIdKementerian = Long.parseLong(getParam("socKementerian"));
        		if(!jenisTanah.equals("")){
        			//vecHash = FrmUtilData.getLaporanMengikutUrusan("61",null,"L");
        			if(jenisTanah.equals("1")){
...
//        		}
			...
			if(userLevel==1){
    			...
    			socDaerah = UtilHTML.SelectDaerah("socDaerah",null,"style=width:340");
 				...
 				displayNegeri(0L);
    			socDaerah = UtilHTML.SelectDaerah("socDaerah",null,"");
    			//socKementerian = HTML.SelectKementerian("socKementerian", null, null, "onChange=\"doChangeUnit()\" style=\"width:400\"");
       			socKementerian = UtilHTML.SelectKementerianAktif("socKementerian", null, null, "onChange=\"doChangeUnit()\" style=\"width:400\"");
    			socAgensi = HTML.SelectAgensiByKementerian("socAgensi","0",Long.parseLong("1")," style=\"width:400\"");
	...
	public void displayNegeriUnitXNegeri(Long tempIdNegeri,Long idUnit) throws Exception{		
		socNegeri = UtilHTML.SelectNegeriXKod("socNegeri",tempIdNegeri, "", " onChange=\"doChangeNegeri()\"", null);
		//socKementerian = HTML.SelectKementerian("socKementerian",idUnit, null, "onChange=\"doChangeUnit()\" style=\"width:400\"");
		socKementerian = UtilHTML.SelectKementerianAktif("socKementerian", idUnit, null, "onChange=\"doChangeUnit()\" style=\"width:400\"");

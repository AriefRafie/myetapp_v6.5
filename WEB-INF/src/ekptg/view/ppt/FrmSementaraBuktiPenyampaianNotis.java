...
import ekptg.model.ppt.SementaraBuktiPenyampaianNotis;
/*
 * @author
 * NORZAILY BINTI JASMI
 */

public class FrmSementaraBuktiPenyampaianNotis extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	static Logger myLogger = Logger.getLogger(FrmSementaraBuktiPenyampaianNotis.class);
	...
	// MODEL SEMENTARA
	SementaraBuktiPenyampaianNotis modelSementara = new SementaraBuktiPenyampaianNotis();
...
//    	String listHMscreen = "app/ppt/frmSek8PenyampaianNotisListHM.jsp";
    	...
    	//screen jsp
    	String listdepan = "app/ppt/frmSementaraBuktiPenyampaianNotisSenarai.jsp";
    	String mainscreen = "app/ppt/frmSementaraBuktiPenyampaianNotis.jsp";
    	String listHMscreen = "app/ppt/frmSementaraPenyampaianNotisListHM.jsp";
    	...
    	//default list
    	listPageDepan = modelSementara.getListPermohonan("1",userIdNeg);
...
//--METHOD--//
	...
	private void updateSuburusanStatusFailPPT(HttpSession session,String id_permohonan,String id_fail,String id_suburusanstatusfailppt) throws Exception{
		...
		modelUPT.updateSuburusanStatusFailPPT(h,id_suburusanstatusfailppt,"1525");
	...
	private void ListCarian(HttpSession session,String userIdNeg) throws Exception{
		...
		SementaraBuktiPenyampaianNotis.setListCarian(nofail,tarikh,status,"1",userIdNeg);
	...
	@SuppressWarnings("unchecked")
	private void listPenyampaianNotis(HttpSession session,String idHakmilik) throws Exception{

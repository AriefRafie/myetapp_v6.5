...
public class SkrinPopupCarianHakmilikJanaSubjaket extends AjaxBasedModule {
	static Logger myLogger = Logger.getLogger(SkrinPopupCarianHakmilikJanaSubjaket.class);
	private static SimpleDateFormat Format =  new SimpleDateFormat("dd/MM/yyyy");
	private final String PATH="app/ppt/PopupHakmilik/";
	private String vm = PATH +"SkrinPopupCarianHakmilikJanaSubjaket.jsp";

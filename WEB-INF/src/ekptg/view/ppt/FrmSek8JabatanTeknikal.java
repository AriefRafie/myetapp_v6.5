...
public class FrmSek8JabatanTeknikal extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	static Logger myLogger = Logger.getLogger(FrmSek8JabatanTeknikal.class);
	...
	myLogger.info("userIdNeg --- "+userIdNeg);
    	String vm = "";
    	String namaPej = "";
    	...
    	//screen jsp
    	String listdepan = "app/ppt/frmSek8LaporanAwalTanahSuratSenarai.jsp";
    	String mainscreen = "app/ppt/frmSek8LaporanAwalTanahSurat.jsp";
    	String screenjabatan = "app/ppt/frmSek8LaporanAwalTanahSuratTambah.jsp";
		...
		*/
    	...
    	if("tambahJabatan".equals(submit)){
    		...
    		//dropdown
    		//context.put("selectJabatan",HTML.SelectJabatanTeknikal("socJabatan",null,"id=socJabatan style=width:auto"));
        	...
        	if("simpanJabatan".equals(submit2)){
        		...
        		if (doPost.equals("true")) {
        			...
        			/*
        			if(id_status.equals("147") || id_status.equals("43")){
        		    
        			}
        			*/
        			
        			
        			if(modelUPT.cekStatusFailDahWujud(idpermohonan,"22","52")==false)
        			{
        ...
        if("viewJabatan".equals(submit)){
    		...
    		if(dataJabatan.size()!=0){
    			...
    			id_pejabat = (String)dj.get("id_pejabat");
    		...
    		//dropdown
    		//context.put("selectJabatan",HTMLPPT.SelectJabatanTeknikalPPT("socJabatan",Utils.parseLong(idnegeri),"id=socJabatan style=width:auto disabled class=disabled"));
    		context.put("selectJabatan",HTMLPPT.SelectJabatanTeknikalPPT(userIdNeg,"socJabatan",Utils.parseLong(id_pejabat),"id=socJabatan style=width:auto disabled class=disabled",null));
    		//context.put("selectJabatan",HTMLPPT.SelectJabatanTeknikalPPT(userIdNeg,"socJabatan",null,null,"style=width:auto"));
    		String submit2 = getParam("command2");
        	myLogger.info("submit[2] : " + submit2);
        	...
        	if("kemaskiniJabatan".equals(submit2)){
            	...
            	if("updateJabatan".equals(submit3)){
            		...
            		//data Pejabat Teknikal
            		dataPejabatTeknikal(session,id_ulasanteknikal,userIdNeg);
...
//--METHOD--//	
	...
	private void updateSuburusanStatusFailPPT(HttpSession session,String id_permohonan,String id_fail,String id_suburusanstatusfailppt) throws Exception{
		...
		modelUPT.updateSuburusanStatusFailPPT(h,id_suburusanstatusfailppt,"1469");
	...
	private void ListCarian(HttpSession session,String userIdNeg) throws Exception{
		...
		FrmSek8JabatanTeknikalData.setListCarian(nofail,tarikh,status,userIdNeg);
	...
	@SuppressWarnings({ "static-access", "unchecked" })
	private void dataPejabatTeknikal(HttpSession session,String id_ulasanteknikal,String userIdNeg) throws Exception{
		...
		//dropdown
		//context.put("selectJabatan",HTMLPPT.SelectJabatanTeknikalPPT("socJabatan",Utils.parseLong(id_jabatanteknikal),"id=socJabatan style=width:auto disabled class=disabled"));
		//context.put("selectJabatan",HTMLPPT.SelectJabatanTeknikalPPT("socJabatan",Utils.parseLong(id_jabatanteknikal),"id=socJabatan style=width:auto disabled class=disabled"));
		context.put("selectJabatan",HTMLPPT.SelectJabatanTeknikalPPT(userIdNeg,"socJabatan",null,null,"style=width:auto"));
	}//close listJabatan
	...
	private void simpanJabatan(HttpSession session,String idstatus) throws Exception{
		...
		if(idstatus.equals("147") || idstatus.equals("43")){
			//FrmSek8JabatanTeknikalData.updateStatus(h,getParam("id_permohonan"));
    	}
	...
	//tambah function query jabatan teknikal - 080318
	
		public static Vector<Tblrujpejabat> getJabatanTeknikal(String idnegeri) throws Exception {
			Db db = null;
			String sql = "";
			sql = "Select id_pejabat,kod_pejabat,initcap(nama_pejabat),id_seksyen,id_jenispejabat from tblrujpejabat "+
				" where " +
				//"id_seksyen = '1' and "+
				" id_jenispejabat in  ('1', '2', '3', '4', '5', '8', '11' ,'16', '18', '19', '25', '26','82'," +
				" '141782', '161782', '1617102', '9917152', '9917164', '9917165'," +			
				" '9917184', '9917205' ,'9917206', '9918267', '9918287','9918288','9918289','9918290','9918307')"+ //1-ptg, 2-ptd, 25-pbt 26-jas 9918267-jps
				" and id_negeri in ('16','" + idnegeri + "')"+
				" ORDER BY nama_pejabat asc"+
			"";
			myLogger.info("SQL JABATAN TEKNIKAL --- "+sql);
			try {
				db = new Db();

...
public class LaporanOnlineKJP extends AjaxBasedModule{	
	...
	public String doTemplate2() throws Exception{
		...
		dataKementerian.clear();
		
		String vm = ""; 
		String mainpage = "app/ppt/LAPORAN/LaporanOnlineKJP.jsp";
    	...
    	if("doChange".equals(submit)){
			...
			id_kementerian = getParam("id_kementerian");
			...
			logic.setDataPejabatJKPTG(userIdNegeri);
	     	...
	     	if(dataPejabatJKPTG.size()!=0){
	     		...
	     		System.out.println("************ ID_PEJABATJKPTG "+id_pejabat+" apa2");
	     	}
			
	     	socStatus = getParam("socStatus"); 
    		...
    		//context.put("selectPejabat",SelectPejabatJKPTGLaporan("socPejabat",Utils.parseLong(id_pejabat),null,"id='socPejabat' style=width:auto onChange=\"doChange()\""));
	     	...
	     	context.put("selectPejabat",SelectPejabatJKPTGLaporan("socPejabat",Utils.parseLong(userIdNegeri),null,"id='socPejabat' style=width:auto onChange=\"showhidereport()\""));
	     	context.put("selectKementerian",HTML.SelectKementerian("selectKementerian",Utils.parseLong(id_kementerian),null,"id='selectKementerian' style=width:auto onChange=\"showhidereport()\""));
    		...
    		context.put("selectBulan",HTML.SelectBulan("socBulan",Utils.parseLong(bulan),null,"id='socBulan' style=width:200px onChange=\"showhidereport()\""));
    		context.put("selectTahun",HTML.SelectTahun("socTahun",tahun,null,"id='socTahun' style=width:200px onChange=\"showhidereport()\""));
    		
    		//tambahan untuk julat masa
    		context.put("selectBulanSehingga",HTML.SelectBulan("socBulanSehingga",Utils.parseLong(bulan),null,"id='socBulanSehingga' style=width:200px onChange=\"showhidereport()\""));
    		context.put("selectTahunSehingga",HTML.SelectTahun("socTahunSehingga",tahun,null,"id='socTahunSehingga' style=width:200px onChange=\"showhidereport()\""));
	...
	public static String SelectKementerian(String selectName,
		...
		try {
			...
			Vector v = getKementerianLaporan();
	...
	public static Vector getKementerianLaporan() throws Exception {
		Db db = null;

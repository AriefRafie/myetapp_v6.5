...
public class FrmLHDNSemakan extends AjaxBasedModule {
	...
	static Logger myLog = Logger.getLogger(ekptg.view.integrasi.lhdn.FrmLHDNSemakan.class);
	...
	public String doTemplate2() throws Exception {
		...
		if(submit.equals("")){
			vm = PATH+"senaraiSemakanIndex.jsp";
			list = new Vector();

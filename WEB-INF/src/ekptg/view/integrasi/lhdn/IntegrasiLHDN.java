...
import etapp.module.ppt.Util;

/**
 * 
 * @Dibuat Oleh Mohamad Rosli
 * @Dibuat Pada Oktober 2012
 *
 */
public class IntegrasiLHDN extends LebahRecordTemplateModule<PPTPermohonan> { // extends RecordTemplateModule2<PPTPermohonan> {

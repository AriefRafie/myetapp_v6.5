...
public class FrmLHDNInternal extends AjaxBasedModule {
	...
	private String DISABILITYNUM = " disabled class=\"inputnumberdisabled\" ";
  	...
  	static Logger myLog = Logger.getLogger(ekptg.view.integrasi.lhdn.FrmLHDNInternal.class);
	...
	public String doTemplate2() throws Exception {
		...
		if(submit.equals("")){
			...
			list = getIntegrasi().carianPerintah(role, getParam("txtNoFail"),getParam("txtPemohon")

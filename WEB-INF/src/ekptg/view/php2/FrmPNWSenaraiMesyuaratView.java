...
import ekptg.model.php2.FrmPNWSenaraiMesyuaratData;
 ...
 * 
 */
public class FrmPNWSenaraiMesyuaratView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	static Logger myLogger = Logger.getLogger(ekptg.view.php2.FrmPNWSenaraiMesyuaratView.class);

	FrmPNWSenaraiMesyuaratData logic = new FrmPNWSenaraiMesyuaratData();
...
//				step = "";
		...
		if ("daftarBaru".equals(actionMesyuarat)) {
			...
			vm = "app/php2/frmPNWMaklumatMesyuaratSenaraiPermohonan.jsp";
			...
			vm = "app/php2/frmPNWSenaraiFailMesyuarat.jsp";

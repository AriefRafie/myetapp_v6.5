...
import ekptg.model.php2.FrmPYWPopupSenaraiBorangKBerkaitanData;

public class FrmPYWPopupSenaraiBorangKBerkaitanView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmPYWPopupSenaraiBorangKBerkaitanData logic = new FrmPYWPopupSenaraiBorangKBerkaitanData();
	...
	public String doTemplate2() throws Exception {
		...
		if ("papar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmPYWPopupMaklumatBorangKBerkaitan.jsp";
	    	...
	    	//GO TO LIST BORANG K        	
        	vm = "app/php2/frmPYWPopupSenaraiBorangKBerkaitan.jsp";

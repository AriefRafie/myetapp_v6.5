...
public class FrmPNWPopupSenaraiTanahView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmPNWPopupSenaraiTanahData logic = new FrmPNWPopupSenaraiTanahData();
	...
	public String doTemplate2() throws Exception {
		...
		if ("daftar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmPNWPopupDaftarHakmilik.jsp";
        	...
        	vm = "app/php2/frmPNWPopupMaklumatTanah.jsp";
	    	...
	    	//GO TO LIST TANAH        	
        	vm = "app/php2/frmPNWPopupSenaraiTanah.jsp";  
        	
        	//SET DEFAULT VALUE
        	if ("3".equals(idKategoriPemohon)){
        		if ("99999".equals(idKementerian)){
        			idAgensi = idAgensiPemohon;
        			idKementerian = logic.getIdKementerianByIdAgensi(idAgensiPemohon);
        		}        		
        	}        	
			...
			System.out.println(" idAgensi : "+idAgensi);
			if(!idAgensi.equals(""))
			{
			this.context.put("selectAgensi", HTML.SelectAgensiByKementerian("socAgensi", idKementerian, Long.parseLong(idAgensi), ""));
			}

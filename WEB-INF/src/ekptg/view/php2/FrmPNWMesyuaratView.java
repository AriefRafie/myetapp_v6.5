...
import ekptg.model.php2.FrmPNWMesyuaratData;

public class FrmPNWMesyuaratView extends AjaxBasedModule{

	private static final long serialVersionUID = 1L;
	
	FrmPNWHeaderData logicHeader = new FrmPNWHeaderData();
	FrmPNWMesyuaratData logic = new FrmPNWMesyuaratData();
	...
	public String doTemplate2() throws Exception {
        ...
        vm = "app/php2/frmPNWMesyuarat.jsp";
        ...
        if (postDB) {
        	...
        	if ("simpanDokumenMM".equals(hitButton)) {
        		logic.simpanDokumen(idMesyuarat, session);

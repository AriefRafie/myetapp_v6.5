...
public class FrmAPBTamatTempohLesenView extends  AjaxBasedModule{
	static Logger myLogger = Logger.getLogger(FrmAPBTamatTempohLesenView.class);
	...
	HttpSession session = this.request.getSession();
        ...
        vm = "app/php2/frmAPBTamatTempohLesen.jsp";

...
public class FrmPHPMesyuaratDashboard extends AjaxBasedModule {
	
	private static final long serialVersionUID = 1L;
	
	static Logger myLogger = Logger.getLogger(FrmPHPMesyuaratDashboard.class);
	String userId = null;
	String role = null;
	...
	public String doTemplate2() throws Exception {
		...
		context.put("idNegeriUser", user_negeri_login);		
		...
		vm = "app/php2/PHPMesyuaratDashboard.jsp";
	...
	public Integer getFailPenyewaan() throws Exception {
	...
	public Integer getPerjanjianAktif() throws Exception {
		...
		try {
			...
			sql = "SELECT COUNT(*) AS BIL"
				...
				+ " AND E.ID_HAKMILIKPERMOHONAN = F.ID_HAKMILIKPERMOHONAN(+)"
				+ " AND B.ID_PEMOHON = C.ID_PEMOHON AND B.ID_PERMOHONAN = E.ID_PERMOHONAN AND B.FLAG_AKTIF = 'Y' AND A.NO_FAIL IS NOT NULL"
				+ " AND A.ID_MASUK = H.USER_ID(+) AND E.FLAG_HAKMILIK = 'U' AND B.ID_STATUS = 1610195";
	...
	public Integer getNotifikasiInbox(String userId) throws Exception {
	...
	public Integer getNotifikasiTugasan(String userId, String userRole, String idNegeri) throws Exception {

...
import ekptg.model.php2.FrmTKRMesyuaratData;

public class FrmTKRMesyuaratView extends AjaxBasedModule{

	private static final long serialVersionUID = 1L;
	
	FrmTKRHeaderData logicHeader = new FrmTKRHeaderData();
	FrmTKRMesyuaratData logic = new FrmTKRMesyuaratData();
	...
	public String doTemplate2() throws Exception {
        ...
        Vector beanMinitMesyuarat = null; //14092017
        ...
        vm = "app/php2/frmTKRMesyuarat.jsp";
		...
		System.out.println("value =" + getParam("txtCatatan"));

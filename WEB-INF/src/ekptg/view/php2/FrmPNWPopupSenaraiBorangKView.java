...
import ekptg.model.php2.FrmPNWPopupBorangKData;


public class FrmPNWPopupSenaraiBorangKView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmPNWPopupBorangKData logic = new FrmPNWPopupBorangKData();
	...
	public String doTemplate2() throws Exception {
		...
		//SET DEFAULT VALUE
    	if("3".equals(idKategoriPemohon) && !"99999".equals(idAgensiPemohon)) {
			idKementerian = logic.getIdKementerian(idAgensiPemohon);
			idAgensi = idAgensiPemohon;
    	} 
		...
		if ("daftar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmPNWPopupDaftarBorangK.jsp";
			...
			if("3".equals(idKategoriPemohon)){
				this.context.put("selectKementerian", HTML.SelectKementerian("socKementerian", Long.parseLong(idKementerian), "disabled", " onChange=\"doChangeKementerian();\""));
				this.context.put("selectAgensi", HTML.SelectAgensiByKementerian("socAgensi", idKementerian, Long.parseLong(idAgensi), "disabled", ""));
			} else{
        	...
        	vm = "app/php2/frmPNWPopupMaklumatBorangK.jsp";
	    	...
	    	//GO TO LIST BORANG K        	
        	vm = "app/php2/frmPNWPopupSenaraiBorangK.jsp";       	

...
public class FrmTKRPopupSenaraiTanahView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmTKRPopupSenaraiTanahData logic = new FrmTKRPopupSenaraiTanahData();
	...
	public String doTemplate2() throws Exception {
		...
		if ("daftar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmTKRPopupDaftarHakmilik.jsp";

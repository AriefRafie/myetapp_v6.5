...
import ekptg.model.php2.FrmTKRPopupSenaraiBorangKData;

public class FrmTKRPopupSenaraiBorangKView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmTKRPopupSenaraiBorangKData logic = new FrmTKRPopupSenaraiBorangKData();
	...
	public String doTemplate2() throws Exception {
	    ...
	    String idNegeriJKPTG = getParam("idNegeriJKPTG");
		...
		//SET DEFAULT VALUE
    	if("8".equals(idKategoriPemohon) && !"99999".equals(idNegeriJKPTG)) {
			this.context.put("idNegeriPemohon", idNegeriJKPTG);
			idNegeri = idNegeriJKPTG;
    	}
		...
		if ("daftar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmTKRPopupDaftarBorangK.jsp";
        	...
        	vm = "app/php2/frmTKRPopupMaklumatBorangK.jsp";
	    	...
	    	//GO TO LIST BORANG K        	
        	vm = "app/php2/frmTKRPopupSenaraiBorangK.jsp";
			...
			this.context.put("selectJenisLot", HTML.SelectLot("socJenisLot",Long.parseLong(jenisLot), ""));
			if ("8".equals(idKategoriPemohon) && !"99999".equals(idNegeriJKPTG)) {
				this.context.put("selectNegeri", HTML.SelectNegeri("socNegeri",Long.parseLong(idNegeri), "disabled", " onChange=\"doChangeNegeri();\""));
			} else {
				this.context.put("selectNegeri", HTML.SelectNegeri("socNegeri",Long.parseLong(idNegeri), "", " onChange=\"doChangeNegeri();\""));
			}			
			this.context.put("selectDaerah", HTML.SelectDaerahByNegeri(idNegeri, "socDaerah", Long.parseLong(idDaerah), "", " onChange=\"doChangeDaerah();\""));

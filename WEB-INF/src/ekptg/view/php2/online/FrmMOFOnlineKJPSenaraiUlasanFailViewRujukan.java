...
public class FrmMOFOnlineKJPSenaraiUlasanFailViewRujukan extends AjaxBasedModule {
	...
	public String doTemplate2() throws Exception {
		...
		try {
			...
			if ("refreshDokumenMuatNaik".equals(command)) {
				...
				vm = "app/php2/online/ulasanKJP/mof/maklumatUlasanRujukan.jsp";	
				...
				vm = "app/php2/online/ulasanKJP/mof/refreshDokumenMuatNaik.jsp";	
				...
				vm = "app/php2/online/ulasanKJP/mof/startRujukan.jsp";

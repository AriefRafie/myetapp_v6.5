...
public class FrmTKROnlineKJPSenaraiUlasanFailViewRujukan extends AjaxBasedModule {
//test 14/8/2020
	private static final long serialVersionUID = 1L;
	private String readonly = "disabled class = \"disabled\"";
	static Logger myLog = Logger.getLogger(FrmTKROnlineKJPSenaraiUlasanFailViewRujukan.class);
	...
	public String doTemplate2() throws Exception {
		...
		try {
			...
			if ("refreshDokumenMuatNaik".equals(submit)) {//ros guna nie
				...
				Vector listFail = logic.getSenaraiFailRujukan(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, userId);
				...
				myLog.info("bacaaaa paparFail semua");
				vm = "/paparFailRujukan.jsp";
				//TO CLEAR CONTEXT
				context.remove("BeanHeader");
				context.remove("BeanMaklumatTanah");
				context.remove("lampiran");
				...
				Vector listFail = logic.getSenaraiFailRujukan(findNoFail, findNoPermohonan, findTajukFail, findPemohon, findNoPengenalan, findTarikhTerima,

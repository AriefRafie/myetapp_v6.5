...
public class FrmPYWOnlineKJPSenaraiFailViewRujukan extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
    static Logger myLog = Logger.getLogger(FrmPYWOnlineKJPSenaraiFailViewRujukan.class);

...
import ekptg.model.php2.FrmAPBBorangAOnlineSenaraiFailData;

public class FrmAPBBorangAOnlineSenaraiFailView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	static Logger myLog = Logger.getLogger(FrmAPBBorangAOnlineSenaraiFailData.class);

	FrmAPBBorangAOnlineSenaraiFailData logic = new FrmAPBBorangAOnlineSenaraiFailData();
	...
	public String doTemplate2() throws Exception {
		...
		// PAGING SHJ
		myLog.info("paging : "+action);
		String vm = "";
		String actionLesen = getParam("actionLesen");
		myLog.info("actionLesen "+actionLesen);
		...
		if ("seterusnya".equals(actionLesen)) {
		...
		else if ("daftarBaruBorangA".equals(actionLesen)) {
		myLog.info("xx masuk sini tak?");

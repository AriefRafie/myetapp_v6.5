...
import ekptg.model.php2.online.FrmPLPPopupSenaraiTanahOnlineData;

/**
 * 
 *
 */
public class FrmPLPPopupSenaraiTanahOnlineView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmPLPPopupSenaraiTanahOnlineData logic = new FrmPLPPopupSenaraiTanahOnlineData();
	...
	public String doTemplate2() throws Exception {
	    ...
	    if ("papar".equals(actionPopup)){
        	...
        	vm = "app/php2/online/frmPLPPopupMaklumatTanah.jsp";
	    	...
	    	//GO TO LIST TANAH        	
        	vm = "app/php2/online/frmPLPPopupSenaraiTanah.jsp";  

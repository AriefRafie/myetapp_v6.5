 ...
 *
 */
public class FrmTKRPopupSenaraiTanahOnlineView extends AjaxBasedModule {
	...
	public String doTemplate2() throws Exception {
	    ...
	    if ("papar".equals(actionPopup)){
        	...
        	logic.carianTanah(idJenisTanah, getParam("txtPeganganHakmilik"), jenisHakmilik, getParam("txtNoHakmilik"), jenisLot,
        			getParam("txtNoLot"), getParam("txtNoWarta"), getParam("tarikhWarta"), idNegeri, idDaerah, idMukim, idKementerian, idAgensi, idAgensiPemohon);

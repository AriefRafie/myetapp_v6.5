...
import ekptg.model.php2.online.FrmTKRPopupSenaraiTanahGantiOnlineData;

/**
 * 
 *
 */
public class FrmTKRPopupSenaraiTanahGantiOnlineView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmTKRPopupSenaraiTanahGantiOnlineData logic = new FrmTKRPopupSenaraiTanahGantiOnlineData();
	...
	public String doTemplate2() throws Exception {
	    ...
	    if ("papar".equals(actionPopup)){
        	...
        	vm = "app/php2/online/frmTKRPopupMaklumatTanahGanti.jsp";
	    	...
	    	//GO TO LIST TANAH        	
        	vm = "app/php2/online/frmTKRPopupSenaraiTanahGanti.jsp";         	
			...
			this.context.put("selectAgensi", HTML.SelectAgensiByKementerian("socAgensi", idKementerianPemohon, Long.parseLong(idAgensi), ""));
        	...
        	logic.carianTanah(idJenisTanah, getParam("txtPeganganHakmilik"), jenisHakmilik, getParam("txtNoHakmilik"), jenisLot,
        			getParam("txtNoLot"), getParam("txtNoWarta"), getParam("tarikhWarta"), idNegeri, idDaerah, idMukim, idKementerianPemohon, idAgensi, idAgensiPemohon);

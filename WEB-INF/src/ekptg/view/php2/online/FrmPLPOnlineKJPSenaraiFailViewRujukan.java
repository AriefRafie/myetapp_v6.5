...
public class FrmPLPOnlineKJPSenaraiFailViewRujukan extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
    static Logger myLog = Logger.getLogger(FrmPLPOnlineKJPSenaraiFailViewRujukan.class);
	...
	FrmPLPOnlineKJPSenaraiFailData logic = new FrmPLPOnlineKJPSenaraiFailData();
	...
	public String doTemplate2() throws Exception {
		...
		try {
			if ("refreshDokumenMuatNaik".equals(command)) {
				...
				Vector listFail = logic.getSenaraiFailRujukan(findNoFail, findTajukFail, findPemohon, findNoPengenalan, findTarikhTerima, 
...
*/
				...
				String userId = (String) session.getAttribute("_ekptg_user_id");
				Vector listFail = logic.getSenaraiFailRujukan(null, null, null, null, null, null, null, null, null, null, null, null, null, null, userId);
				this.context.put("SenaraiFail", listFail);
				setupPage(session, action, listFail);

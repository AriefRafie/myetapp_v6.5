...
import ekptg.model.php2.FrmTKRPopupSenaraiTanahGantiData;


public class FrmTKRPopupSenaraiTanahGantiView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmTKRPopupSenaraiTanahGantiData logic = new FrmTKRPopupSenaraiTanahGantiData();
	...
	public String doTemplate2() throws Exception {
	    ...
	    if ("papar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmTKRPopupMaklumatTanahGanti.jsp";
	    	...
	    	//GO TO LIST TANAH        	
        	vm = "app/php2/frmTKRPopupSenaraiTanahGanti.jsp";   

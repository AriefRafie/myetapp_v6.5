...
public class FrmAPBDashboard extends AjaxBasedModule {
	
private static final long serialVersionUID = 1L;
	
	static Logger myLogger = Logger.getLogger(FrmAPBDashboard.class);
	String userId = null;
	String role = null;
	...
	public Integer getFailAPB() throws Exception {
		...
		try {
			...
			sql = "SELECT COUNT(*) AS BIL"
				...
				+ " WHERE A.ID_URUSAN = '9' AND A.ID_SUBURUSAN = '57' AND A.ID_FAIL = B.ID_FAIL AND B.ID_STATUS = D.ID_STATUS"
	...
	public Integer getPelesenAktif() throws Exception {
	...
	public Integer getFailSelesai() throws Exception {
		...
		try {
			...
			sql = "SELECT COUNT(*) AS BIL"
				...
				+ " WHERE A.ID_URUSAN = '9' AND A.ID_SUBURUSAN = '57' AND A.ID_FAIL = B.ID_FAIL AND B.ID_STATUS = D.ID_STATUS"
				+ " AND B.ID_PEMOHON = C.ID_PEMOHON AND B.ID_PERMOHONAN = E.ID_PERMOHONAN(+) AND A.NO_FAIL IS NOT NULL"
				+ " AND B.ID_STATUS IN (1610212,1610208,1610207,1610244)";

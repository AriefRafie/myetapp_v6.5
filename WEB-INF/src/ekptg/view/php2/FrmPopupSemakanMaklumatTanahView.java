...
import ekptg.model.php2.FrmPopupSemakanMaklumatTanahData;

public class FrmPopupSemakanMaklumatTanahView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	String idNegeriUser = null;

	FrmPopupSemakanMaklumatTanahData logic = new FrmPopupSemakanMaklumatTanahData();
	...
	public String doTemplate2() throws Exception {
		...
		if ("papar".equals(actionPopup)) {
			...
			vm = "app/php2/frmPopupSemakanMaklumatTanah.jsp";
			...
			// GO TO LIST TANAH
			vm = "app/php2/frmPopupSemakanSenaraiTanah.jsp";
			...
			logic.carianTanah(idJenisTanah, getParam("txtPeganganHakmilik"),
					...
					idKementerian, idAgensi, getParam("txtkegunaanTanah"));

...
import ekptg.model.php2.FrmPLPPopupSenaraiBorangKData;

public class FrmPLPPopupSenaraiBorangKView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmPLPPopupSenaraiBorangKData logic = new FrmPLPPopupSenaraiBorangKData();
	...
	public String doTemplate2() throws Exception {
		...
		if ("daftar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmPLPPopupMaklumatBorangK.jsp";
	    	...
	    	//GO TO LIST BORANG K        	
        	vm = "app/php2/frmPLPPopupSenaraiBorangK.jsp";  

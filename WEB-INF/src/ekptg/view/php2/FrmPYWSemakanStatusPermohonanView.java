...
import ekptg.model.php2.FrmPYWSemakanStatusPermohonanData;

public class FrmPYWSemakanStatusPermohonanView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;

	FrmPYWSemakanStatusPermohonanData logic = new FrmPYWSemakanStatusPermohonanData();
	...
	public String doTemplate2() throws Exception {
		...
		vm = "app/php2/frmPYWSemakanStatusPermohonan.jsp";
		...
		logic.carianFail(getParam("txtNoFail"), getParam("txtPemohon"), getParam("txtNoPengenalan"),
				...
				getParam("txtNoPegangan"), idStatusC, idNegeriUser);

...
import ekptg.model.php2.FrmCRBSenaraiFailKeseluruhanData;

public class FrmCRBSenaraiFailKeseluruhanView extends AjaxBasedModule {
	
	private static final long serialVersionUID = 1L;
	
	FrmCRBSenaraiFailKeseluruhanData logic = new FrmCRBSenaraiFailKeseluruhanData();
	...
	public String doTemplate2() throws Exception {
		...
		vm = "app/php2/frmCRBSenaraiFailKeseluruhan.jsp";

		logic.carianFail(getParam("txtNoFail"), getParam("txtNoFailNegeri"), 

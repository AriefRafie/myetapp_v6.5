...
import ekptg.model.php2.FrmCRBPopupSenaraiTanahData;
import ekptg.view.admin.UserListModuleV3;

public class FrmCRBPopupSenaraiTanahView extends AjaxBasedModule  {
	...
	public String doTemplate2() throws Exception {
		...
		String SESSSION_USER_ID = (String)session.getAttribute("_ekptg_user_id");
		String SESSSION_NEGERI_USER = (String)session.getAttribute("_ekptg_user_negeri");
		String CURRENT_ROLE = (String)session.getAttribute("myrole");
		
		myLogger.info("SESSSION_USER_ID : "+SESSSION_USER_ID+" SESSSION_NEGERI_USER : "+SESSSION_NEGERI_USER+" CURRENT_ROLE : "+CURRENT_ROLE);
		...
		if ("daftar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmCRBPopupDaftarHakmilik.jsp";
        	...
        	vm = "app/php2/frmCRBPopupMaklumatTanah.jsp";
			...
			logic.carianTanah(idJenisTanah, getParam("txtPeganganHakmilik"),
					...
					idKementerian, idAgensi,CURRENT_ROLE,SESSSION_NEGERI_USER);

...
import ekptg.model.php2.FrmTKRSenaraiFailData;

public class FrmTKRSenaraiFailView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;

	FrmTKRSenaraiFailData logic = new FrmTKRSenaraiFailData();
	...
	public String doTemplate2() throws Exception {
		...
		if ("papar".equals(actionTukarguna)) {
			...
			vm = "app/php2/frmTKRSenaraiFail.jsp";

...
import ekptg.model.php2.FrmPLPPopupSenaraiTanahData;

public class FrmPLPPopupSenaraiTanahView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmPLPPopupSenaraiTanahData logic = new FrmPLPPopupSenaraiTanahData();
	...
	public String doTemplate2() throws Exception {
		...
		if ("daftar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmPLPPopupMaklumatTanah.jsp";

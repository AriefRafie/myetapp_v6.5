...
import ekptg.model.php2.FrmPLPPopupSenaraiBorangKBerkaitanData;

public class FrmPLPPopupSenaraiBorangKBerkaitanView extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	
	FrmPLPPopupSenaraiBorangKBerkaitanData logic = new FrmPLPPopupSenaraiBorangKBerkaitanData();
	...
	public String doTemplate2() throws Exception {
		...
		if ("simpan".equals(hitButton)) {
			logic.simpan(idPermohonan, idPPTBorangK, idPHPBorangK, idHakmilikUrusan, session);
		...
		if ("daftar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmPLPPopupDaftarBorangK.jsp";
        	...
        	vm = "app/php2/frmPLPPopupMaklumatBorangKBerkaitan.jsp";
	    	...
	    	//GO TO LIST BORANG K        	
        	vm = "app/php2/frmPLPPopupSenaraiBorangKBerkaitan.jsp";  

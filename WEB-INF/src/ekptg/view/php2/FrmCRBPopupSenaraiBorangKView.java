...
import ekptg.model.php2.FrmCRBPopupSenaraiBorangKData;

public class FrmCRBPopupSenaraiBorangKView extends AjaxBasedModule  {
	
	private static final long serialVersionUID = 1L;

	FrmCRBPopupSenaraiBorangKData logic = new FrmCRBPopupSenaraiBorangKData();
	@Override
	public String doTemplate2() throws Exception {
		...
		if ("doSimpanBorangK".equals(hitButton)) {
			idPHPBorangK = logic.saveBorangK(jenisHakmilik, getParam("txtNoHakmilik"), jenisLot, getParam("txtNoLot"),
					...
					getParam("txtNoSyit"), getParam("txtNoPelan"),
		...
		if ("daftar".equals(actionPopup)){
        	...
        	vm = "app/php2/frmCRBPopupDaftarBorangK.jsp";
			...
			hashBorangK.put("noSyit", getParam("txtNoSyit"));
			hashBorangK.put("noPelan", getParam("txtNoPelan"));
        	...
        	vm = "app/php2/frmCRBPopupMaklumatBorangK.jsp";
        	
        	beanMaklumatBorangK = new Vector();
			logic.setMaklumatBorangK(idPHPBorangK);
	    	...
	    	//GO TO LIST BORANG K        	
        	vm = "app/php2/frmCRBPopupSenaraiBorangK.jsp";
			...
			list = new Vector();
        	logic.carianBorangK(getParam("txtPeganganHakmilik"), jenisHakmilik, getParam("txtNoHakmilik"), jenisLot,
        			getParam("txtNoLot"), idNegeri, idDaerah, idMukim, idKementerian, idAgensi);

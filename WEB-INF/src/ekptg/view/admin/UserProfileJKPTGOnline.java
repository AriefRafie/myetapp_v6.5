...
import ekptg.helpers.Paging2;
	...
	public class UserProfileJKPTGOnline extends AjaxBasedModule {
		static Logger myLogger = Logger.getLogger(UserProfileJKPTGOnline.class);
		String skrin_name = "app/admin/MyProfile/indexOnline.jsp";
		...
		public String doTemplate2() throws Exception {
			...
			this.context.put("internalType", "online");
			
			viewPengguna = viewDataPenggunaOnline(session, USER_ID_SYSTEM, "");
			this.context.put("viewPengguna", viewPengguna);
			
			//ONLINE
			
			 if(command.equals("viewPenggunaOnline"))
			{			
			 ...
			 else if(command.equals("edit_PenggunaOnline"))
			{
				...
				listRole = listTableRujukanV3(session,"ROLE","",USER_ID_SYSTEM,internalType);
			 ...
			 else if(command.equals("savePenggunaOnline"))
				{
					...
					listAdditionalRoleByUserLogin = listRoleByUserLogin_Selected(session, USER_ID_SYSTEM);
					this.context.put("listAdditionalRoleByUserLogin", listAdditionalRoleByUserLogin);
			...
			else if(command.equals("showDisplayDaerahJagaan"))
			{
				...
				{
					listDaerahJagaanByIdPejabat = listDaerahJagaanByIdPejabat(session, ID_PEJABATJKPTG);
			...
			else if(command.equals("batalPaparMyProfile"))
			{
				...
				viewPengguna = viewDataPenggunaInternal(session,USER_ID_SYSTEM,"");
				this.context.put("viewPengguna", viewPengguna);
			...
			else if(command.equals("showListBandar"))
			{
				...
				{			
					...
					skrin_name = "app/admin/MyProfile/indexOnline.jsp";
				}
	...
	//PLA
		...
		@SuppressWarnings("unchecked")
		public List listDaerahJagaanByIdPejabat(HttpSession session, String ID_PEJABATJKPTG)throws Exception {
			Db db = null;
			ResultSet rs = null;
			Statement stmt = null;
			List listDaerahJagaanByIdPejabat = null;
				...
				try {
					...
					if(!user_id.equals("") || !USER_LOGIN.equals(""))
					{
						sql = " SELECT U.FLAG_AKTIF, UI.ID_SEKSYEN, U.USER_ID, U.USER_LOGIN, UPPER(U.USER_NAME) AS USER_NAME, UI.EMEL, "+					
								...
								" UPPER(U.USER_TYPE) AS JENIS_PENGGUNA, U.USER_TYPE AS ID_JENIS_PENGGUNA "+
		...
		//INTEGRASI
			...
			public String queryUserINT_ViewEdit(HttpSession session,String USER_ID, String carianTerperinci,String USER_LOGIN) throws Exception {	
				...
				String query = "";
						...
						" TRUNC (SYSDATE - TO_DATE (MAX (WL.LOG_DATE))) AS DAYS_AFTERLASTLOGIN, "+
						" TO_CHAR(TO_DATE(U.LAST_CHANGEPASSWORD + 90),'DD/MM/YYYY') AS DATE_DAYS_AFTERCHANGEPASS, (90 - TRUNC(SYSDATE - TO_DATE(U.LAST_CHANGEPASSWORD))) AS TEMPOH_SAH,"+
						" TRUNC (SYSDATE - TO_DATE (U.LAST_CHANGEPASSWORD)) AS DAYS_AFTERCHANGEPASS, U.FLAG_AKTIF,"+
						...
						" UPPER (D.NAMA_DAERAH) AS DAERAH_UI,UIN.EMEL,UIN.ID_JENISPEJABAT,UPPER(JP.NAMA_PEJABAT) AS JENIS_PEJABAT, " +
						...
						" TBLRUJPEJABAT PEJ, TBLRUJNEGERI N,TBLRUJDAERAH D, TBLINTRUJJENISPEJABAT JP "+
						...
						" JP.NAMA_PEJABAT,UIN.JAWATAN,UIN.ID_PEJABAT, UIN.ID_DAERAH, UIN.ID_NEGERI, UIN.ID_MUKIM, UIN.ID_AGENSI ";

...
import ekptg.helpers.Paging2;
	...
	public class UserProfileIntegrasi extends AjaxBasedModule {
		static Logger myLogger = Logger.getLogger(UserProfileIntegrasi.class);
		String skrin_name = "app/admin/MyProfile/indexIntegrasi.jsp";
		...
		public String doTemplate2() throws Exception {
			...
			//internal
			if(command.equals("showDisplayDaerahJagaan"))
			{
			...
			{			
				...
				viewPengguna = viewDataPenggunaINT(session, USER_ID_SYSTEM, "");

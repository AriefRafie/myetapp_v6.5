...
public class DisplayBlobLampiranDocTRM implements IServlet2{
	
	static Logger myLogger = Logger.getLogger(DisplayBlobLampiranDocTRM.class);
			 ...
			 try {
				 myLogger.info("MASUK DOWNLOAD");
		            ...
		            PreparedStatement ps = con.prepareStatement("SELECT CONTENT,JENIS_MIME,NAMA_DOC from " +
		            		" TBLPDTDOCTRMLAMPIRAN WHERE ID_DOCTRMLAMPIRAN = ?");
		            String id = request.getParameter("ID_DOCTRMLAMPIRAN");
		            ps.setString(1,id);

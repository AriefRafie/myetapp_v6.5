...
public class FrmPajakanPemajak extends AjaxBasedModule {
	...
	private static Logger myLog = Logger.getLogger(ekptg.view.online.htp.pajakan.FrmPajakanPemajak.class);

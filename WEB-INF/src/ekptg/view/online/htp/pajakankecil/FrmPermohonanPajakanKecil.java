package ekptg.view.online.htp.pajakankecil;
...
public class FrmPermohonanPajakanKecil extends AjaxBasedModule{
	...
	static Logger mylog = Logger.getLogger(ekptg.view.htp.FrmPajakanKecilAjax.class);
	private String idUrusan = "309";
	private String idSubUrusan = "44";
	private String idFailN = null;
	//private long longIdFail = 0L;
	...
	public String doTemplate2()throws Exception {
	    ...
	    String template_name = PATH+"frmPajakanKecilSenaraiFailOnline.jsp";
      	String disability = "disabled";
      	String id_kementerian1 = "";
      	String idUser = "";
		idUser = (String)session.getAttribute("_ekptg_user_id");
		
        //ONLINE
        if (id_kementerian1 == null || id_kementerian1.trim().length() == 0){
			uk = getIPengguna().getKementerian(idUser);
			if(uk == null)
				throw new Exception("[ONLINE-HTP REKOD] KEMENTERIAN TIDAK DIJUMPAI");
			
			id_kementerian1 = String.valueOf(uk.getAgensi().getKementerian().getIdKementerian());
			System.out.println("idKementerian ==" +id_kementerian1);
		}
...
// PAGE 1
	    	if("pksenaraifailcari".equals(submit)){ //carian
	    		System.out.println("pksenaraifailcari");
	    	    mylog.info("equals("+submit+")::pksenaraifailcari");
	    		String nofail = getParam("nofail");
	    		
	    		template_name = PATH+"frmPajakanKecilSenaraiFailOnline.jsp";
	    		...
	    		senaraiFail = FrmSenaraiFailPajakanKecilData.getListOnline(nofail.trim(),(String)session.getAttribute("_ekptg_user_id"),id_kementerian1);    		
	    		...
	    		System.out.println("pksenaraipermohonan");
		    	template_name = PATH+"frmPajakanKecilSenaraiPermohonanOnline.jsp";	
	    		mylog.info("equals(submit)::pksenaraipermohonan");
	    		idFail = getParam("fail");
		    	Vector senaraiPermohonan = null;
		    	senaraiPermohonan = FrmPajakanKecilSenaraiPermohonanData.getListOnline(idFail);
		    	this.context.put("senaraiList", senaraiPermohonan);	    	
		    	this.context.put("idFail", idFail);	    	
//Tambah Pemilik Baru##########################################		    	
// PAGE 2
		    }else if("pkfailbaru".equals(submit)){
		    	System.out.println("pkfailbaru");
		    	mylog.info(" equals("+submit+")::pkfailbaru");
		    	String strOperation = "";
		    	template_name = PATH+"frmPajakanKecilPendaftaranOnline.jsp";
			    this.context.put("socSeksyen","3");
			    
			    if("0".equals(pageMode)){
			    	mylog.info("pageMode :: 0");
			    	mylog.info("pageMode::0"+pageMode);
	    		
			    	template_name = "app/htp/frmPajakanKecilPendaftaranOnline.jsp";
				    this.context.put("socSeksyen","3");
				    ...
				    socKementerian = HTML.SelectKementerian("sockementerian",Long.parseLong(id_kementerian1), "disabled", " ");
				    socAgensi = HTML.SelectAgensiByKementerian("socAgensi",id_kementerian1.toString(),null,"");
...
//					h.put("id_Fail", Long.parseLong((String)permohonan.get("idpermohonan")));
		    	...
		    	System.out.println("doChangeKementerian");
	    		...
	    		System.out.println("pkpendaftaranseterus");
	    		...
	    		System.out.println("pkpermohonantambah");
	    		...
	    		//1 //2 //3
	    		System.out.println("pkpermohonankemaskini");
		    	mylog.info("pkpermohonankemaskini:"+pageMode);

		    	template_name = "app/htp/frmPajakanKecilSemakPermohonanOnline.jsp";	
				String id = getParam("id_kemaskini");
			    ...
			    if(pageMode.equals("4")){
			    	System.out.println("pkpermohonankemaskini pagemode 4");
			    	if(id==""){
					...
					System.out.println("pkpermohonankemaskini pagemode 3");
					...
					System.out.println("pkpermohonankemaskini pagemode simpan");
					String[] cbsemaks = this.request.getParameterValues("cbsemaks");
		    		...
		    		System.out.println("pkpermohonankemaskini pagemode kemaskini");
			    ...
			    // Senarai semakan
			    //semakanSenarai = FrmSemakan.getSenaraiSemakan("frmSewaanSemakPermoh");
			    //semakanSenarai = FrmSemakan.getSenaraiSemakan("frmSewaanSemak","aktif");
		    	semakanSenarai = FrmSemakan.getSenaraiSemakan("frmSewaanSemak");
		    	...
		    	//mylog.info("pkpermohonankemaskini:id::36");
	    		...
	    		mylog.info("pksemakanseterus");
				template_name = PATH+"frmPajakanKecilSenaraiHakmilikPemilik2Online.jsp";
	    		skrin = "1";
			    disability = "disabled class=disabled";
			    ...
			    mylog.info("pkpemilikkemaskini 2"+getParam("id_kemaskini")+" "+template_name);
				template_name = PATH+"frmPajakanKecilPemilikKemaskiniN1Online.jsp";
				skrin = "1";	    		
	    		disability = "disabled class=disabled";
	    		String socDaerah = "";
//<-------------------Form pemilik baru------------------------------------->
					...
					socNegeri = HTML.SelectNegeri("socNegeri","onChange=\"doChangeDaerah3Pemilik()\"");
			    	socKementerian = HTML.SelectKementerian("socKementerian",Long.parseLong(permohonan.get("idkementerian").toString()),disability);
			    	socAgensi = HTML.SelectAgensi("socAgensi",Long.parseLong(permohonan.get("idagensi").toString()),disability);
					//rosli -ikut jsp
					//socDaerah = HTML.SelectDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerahalamat","");
					socDaerah = HTML.SelectDaerah("socDaerah");
					//Syiful
	                ...
	                if(pageMode.equals("doChangeDaerah3Pemilik")){
			    	    mylog.info("pageMode :: doChangeDaerah3Pemilik");
			    	    String idNegeri = getParam("socNegeri");
			    	    addPemilik2();
			    	    socNegeri = HTML.SelectNegeri("socNegeri", Long.parseLong(idNegeri), "", "onChange=\"doChangeDaerah3Pemilik()\"");
					  	socDaerah = HTML.SelectDaerahByNegeri(idNegeri, "socDaerah");
			 ...
			 * uuu */
		    	...
		    	mylog.info("tambahhakmilikpemilik");
				template_name = PATH+"frmPajakanKecilPemilikKemaskiniNOnline.jsp";
				...
				//Maklumat Hakmilik
				socNegeri = HTML.SelectNegeri("socNegeri",Long.parseLong(permohonan.get("idnegeri").toString()),disability);
                this.context.put("socDaerah1",HTML.SelectDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah1", " onChange=\"doChangeDaerahHakmilik("+id+")\" "));
				...
				//Maklumat Pemilik
		    	this.context.put("socNegeri1",HTML.SelectNegeri("socNegeri",null,""));
				this.context.put("socDaerah",HTML.SelectDaerah("socDaerah"));

				//Maklumat Permohonan
				this.context.put("permohonanInfo", permohonan);
				
				if ("dochangedaerah".equalsIgnoreCase(pageMode)) {
					System.out.println("dochangedaerah");
					...
					if(socNegeri1=="")
						socNegeri1="00";
	                this.context.put("socDaerah1",HTML.SelectDaerahByNegeri((String)permohonan.get("idnegeri"),"socDaerah1",Long.parseLong(getParam("socDaerah1")), " onChange=\"doChangeDaerahHakmilik("+id+")\" "));
					this.context.put("socMukim", HTML.SelectMukimByDaerah(getParam("socDaerah1"), "socMukim"));
					//pemilik
					this.context.put("socNegeri1",HTML.SelectNegeri("socNegeri1",Long.parseLong(socNegeri1),"", " onChange=\"doChangeDaerahHakmilik()\" "));
					this.context.put("socDaerah",HTML.SelectDaerahByNegeri(socNegeri1, "socDaerah"));
				}else if("simpan".equalsIgnoreCase(pageMode)){
					System.out.println("tambahhakmilikpemilik simpan");
					template_name = PATH+"frmPajakanKecilSenaraiHakmilikPemilik2Online.jsp";
					simpanHakmilik(session,0);						
					intPB = simpanPBOnline(session,0,idHakmilikUrusan);
...
//			    	template_name = "app/htp/frmPajakanKecilSenaraiHakmilikPemilik.jsp";
		    	...
		    	System.out.println("viewhakmilik");
		    	...
		    	System.out.println("kemaskinihakmilik");
				template_name = PATH+"frmPajakanKecilUpdateHakmilik.jsp";
				skrin = "1";		    	
				String id = getParam("id_permohonan");
				String idHakmilikUrusan = getParam("idHakmilik");
				...
				Hashtable hakmilikinfo = FrmPajakanKecilHakmilikData.getHakmilikDetails(id);
				//Maklumat Hakmilik
		    	socNegeri = HTML.SelectNegeri("socNegeri",Long.parseLong(pihak.getIdNegeri().toString()),"disabled class=disabled");
		    	...
		    	System.out.println("pkkemaskinipemilik");
		    	template_name = PATH+"frmPajakanKecilUpdatePihakKepentingan.jsp";
		    	skrin = "1";
		    	String id = getParam("id_permohonan");
		    	String idPihakBerkepentingan = getParam("idPihakBerkepentingan");
		    	...
		    	System.out.println("pkpemiliktambah");
				template_name = "app/htp/frmPajakanKecilSenaraiHakmilikPemilik2Online.jsp";		    	
				...
				if(pageMode.equals("0")){
		    	    ...
		    	    if("".equals(idHakmilik)){
						...
						if(FrmPajakanKecilHakmilikData.isHakmilikUrusan(idHakmilikU)){														
							intPB = simpanPBOnline(session,0,0L);
...
//							simpanHakMilikUrusanPB(String.valueOf(intPB),String.valueOf(idHakmilikUrusan), session);
						...
						//Long idHakmilikU = getParam("fail")==""?0L:Long.parseLong(getParam("fail"));
						intPB = simpanPBOnline(session,0,Long.parseLong(idHakmilik));
		    	...
		    	System.out.println("pkpemilikseterus");
		    	skrin = "2";
		    	Hashtable<?, ?> hakmilikbangunan = null;
			    //readability = "readonly";
		    	...
		    	System.out.println("KemaskiniSewaan");
				template_name = PATH+"frmPajakanKecilMaklumat.jsp";
		    	disability = "disabled class=disabled";
		    	skrin = "2";
		    	System.out.println("----------Kemaskini");
		    	String permohonanId = getParam("id_kemaskini");
		    	String hakMilikBangunanId = getParam("idHakmilikBangunan");
		    	Hashtable<?, ?> permohonan = FrmPajakanKecilSenaraiPermohonanData.getPermohonanInfo(permohonanId);
		    	Hashtable hakmilikbangunan = FrmPajakanKecilMaklumatData.getHakmilikBangunanInfo(permohonanId);
		    	...
		    	System.out.println("updateSewaanSewaan");
		    	skrin = "2";
		    	
		    	String permohonanId = getParam("id_kemaskini");
		    	String hakMilikBangunanId = getParam("idHakmilikBangunan");
		    	System.out.println("update=============="+permohonanId);
		    	Hashtable<?, ?> permohonan = FrmPajakanKecilSenaraiPermohonanData.getPermohonanInfo(permohonanId);
		    	int month = 0;
				int year = 0;
		    	...
		    	System.out.println("pkmaklumatseterus");
		    	template_name = PATH+"frmPajakanKecilSemakanPKP.jsp";	
		    	mylog.info("pkmaklumatseterus:id::"+id);
		    	disability = "disabled class=disabled";
		    	...
		    	if(pageMode.equals("simpan")){
		    		...
		    		System.out.println("kemaskini");
					//String[] cbsemaks = this.request.getParameterValues("cbsemaks");
		    	    mylog.info("semakanPKPkemaskini:id::"+id);
		        	//FrmSemakan frmSemak = new FrmSemakan();
		    	...
		    	System.out.println("pksemakanpkpseterus");
	    		...
	    		System.out.println("simpanpermohonan");
	    		...
	    		System.out.println("pkpemiliktambah2");
...
//	    		template_name ="app/htp/frmPajakanKecilSenaraiHakmilikPemilik.jsp";
	    		...
	    		template_name = PATH+"frmPajakanKecilAddHakmilikOnline.jsp";
	    		...
	    		String socDaerah = HTML.SelectDaerahByNegeri(permohonan.get("idnegeri").toString(),"socDaerah",pihakKepentingan.getIdDaerah(),disability);
	    		context.put("pihakKepentigan", pihakKepentingan);
	    		this.context.put("socDaerah",socDaerah);
	    	
	    	}else if("doChanges".equals(submit)){
	    		System.out.println("doChanges");
	    		String nofail = getParam("nofail");
...
//		    	template_name = "app/htp/frmPajakanKecilSenaraiPermohonan.jsp";	
		    	...
		    	senaraiFail = FrmSenaraiFailPajakanKecilData.getListOnline("",(String)session.getAttribute("_ekptg_user_id"),id_kementerian1);
	    		//this.context.put("senaraiList", senaraiFail);  
				this.context.put("SenaraiFail", senaraiFail);
				setupPage(session,action,senaraiFail);
	...
	private void simpanFail(HttpSession session, Long idfail) throws Exception {
		  ...
		  FrmUtilData.simpanFailOnline(h);
	  ...
	  private String simpanPermohonan(HttpSession session,int i,String idfail)throws Exception {
	      ...
	      if(i==0){
	      	...
	      	data.put("socNegeri", getParam("socNegeri"));
	      	data.put("socKementerian",getParam("sockementerian"));
	    	...
	    	return FrmUtilData.simpanPermohonanOnline(data);
	  } 
	  ...
	  private void simpanHakmilik(HttpSession session,int i) throws Exception {
		  ...
		  if(i == 0){
			  //fail baru
				...
				h.put("Sekatan", "TIADA");
				mylog.info("Hash==="+h);
				idHakmilikUrusan = FrmPajakanKecilHakmilikData.simpanOnline(h);
			}else{
				//kemaskini fail
...
//				h.put("socNegeri", getParam("socNegeri"));
      ...
      private String simpanPBOnline(HttpSession session,int i,Long l) throws Exception {
...
private String simpanPB(HttpSession session,int i,Long l) throws Exception {
	    ...
	    private void label(Hashtable permohonan){
			...
			String labelNoP = (String)permohonan.get("noP");
			...
			this.context.put("labelNoP", labelNoP);

...
public class FrmRekodPendaftaranTanahAgensi extends AjaxBasedModule {
	...
	private static Logger myLog = Logger.getLogger(ekptg.view.online.htp.rekod.FrmRekodPendaftaranTanahAgensi.class);
	...
	public String doTemplate2() throws Exception {
		...
		String idAgensi = String.valueOf(uk.getAgensi().getIdAgensi());
		...
		if("".equals(firstAction))	{
		   ...
		   this.context.put("selectKementerian",HTML.SelectKementerian("socKementerian", Long.parseLong(idKementerian), " disabled class=\"disabled\"", " onChange=\"doChangeKementerian();\" style=\"width:400\""));
		   this.context.put("selectAgensi",HTML.SelectAgensiByKementerian("socAgensi", idKementerian, Long.parseLong(idAgensi), " disabled class=\"disabled\"", " style=\"width:400\""));
		...
		if("PendaftaranHakmilik".equals(firstAction)){
			...
			if ("XpaparDetailHakmilik".equals(nextAction)){
...
//				this.context.put("listSambungan",listSambungan);
			...
			}else if ("XpaparDetailRizab".equals(nextAction)){	// VIEW DETAIL RIZAB

...
public class FrmKJPModulePembelian extends AjaxModule {
	/**
	 * 
	 */
	...
	static Logger myLog = Logger.getLogger(ekptg.view.online.htp.pembelian.FrmKJPModulePembelian.class);
	private static final Log log = LogFactory.getLog(FrmKJPModulePembelian.class);
	...
	private String vm = PATH+"frmSenaraiFailBorang14A.jsp";
...
//				    this.context.put("mode","view");					    
			...
			*/
			...
			vm = PATH+"frmSenaraiFailBorang14A.jsp";

...
import ekptg.model.online.FrmAgihAduanKePegawaiData;
import ekptg.model.online.FrmListAduanBaruData;

public class AgihanAduanOlehSeksyen extends AjaxBasedModule{
	...
	public String doTemplate2() throws Exception
    {
        ...
        if ("papar".equals(action)){
			...
			vm = "app/online/frmAgihAduanKePegawai.jsp";
			viewAduan(session);
			list = FrmAgihAduanKePegawaiData.getData();
	...
	public void viewAduan(HttpSession session)throws Exception{
		...
		FrmAgihAduanKePegawaiData.setData(id);
	}
	public void agihAduan(HttpSession session)throws Exception{
		...
		FrmAgihAduanKePegawaiData.updateAduan(h);
	}

...
public class UploadDokumenSemak extends AjaxBasedModule {
	...
	private final String PATH="app/online/upload/";
	...
	public String doTemplate2() throws Exception {		
	    ...
	    idJenisDokumen = getParam("jenisdokumen");
	    idRujukan = getParam("rujukan");
	    idSenarai = getParam("idsenarai");
	    //param += "&rujukan="+idPermohonan+"&idJenisDokumen="+idJenisDokumen+"&idSenarai="+idSenarai;

	    //VECTOR
		Vector<Hashtable<String, String>> dokumens = null;
        Vector<Tblrujdokumen> senaraiDokumen = null;      
		...
		myLog.info("idSenarai="+idSenarai);
...
//			uploadFiles(idRujukan,true);
        ...
        vm = PATH+"frmUploadDokumenSemak.jsp";
        int jumLampiran = 1;
		...
		senaraiDokumen = getDocHTP().getLampirans(idRujukan, idJenisDokumen);
			...
			dokumens = l.lampiranMengikutHarta(idRujukan, null,true);
			// end Lampiran
		...
		this.context.put("readonly",readability);		
	   	...
	   	this.context.put("idRujukan",idRujukan);
	   	this.context.put("idSenarai",idSenarai);
	   	this.context.put("jenisDokumen",idJenisDokumen);

...
public class FrmPrmhnnStatusPengunaOnline2 extends AjaxBasedModule {
	static Logger myLogger = Logger
			.getLogger(FrmPrmhnnStatusPengunaOnline2.class);
	...
	public String doTemplate2() throws Exception {
		...
		System.out.println("vm FrmPrmhnnStatusPengunaOnline >>> "+vm);

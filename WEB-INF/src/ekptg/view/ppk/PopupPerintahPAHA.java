 ...
 *
 */
public class PopupPerintahPAHA extends AjaxBasedModule {
	...
	public String doTemplate2() throws Exception {
		...
		if (logic.checkRowWarisHA(idOB, idPerintahHAOBMST)){
			...
			logic.setDataSenaraiPAHA(idOB, idPerintahHAOBMST, idPermohonanSimati,idSimati);
			senaraiPA = logic.getSenaraiPAHA();
		...
		if (hitButt.equals("simpan")){
			...
			logic.updatePAHA(idOB, idPerintahHAOBMST, idPA1, idPA2, idPA3, idPA4, session);

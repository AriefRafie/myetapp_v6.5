...
public class FrmDisplayImage implements IServlet2 {
	...
	public void doService(HttpServletRequest request,
		...
		try {
			...
			PreparedStatement ps = con
					.prepareStatement("SELECT KANDUNGAN,FORMAT,NAMA_DOKUMEN FROM"
							+ " TBLPPKDOKUMEN WHERE ID_DOKUMEN = ?");
			...
			if (rs.next()) {
				...
				String namaFail = rs.getString("NAMA_DOKUMEN");

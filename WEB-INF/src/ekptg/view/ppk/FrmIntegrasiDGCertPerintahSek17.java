...
public class FrmIntegrasiDGCertPerintahSek17 extends VTemplate {
static Logger myLogger = Logger.getLogger(FrmIntegrasiDGCertPerintahSek17.class);
	...
	if ("sendDGCertPerintahSek17".equals(submit)) {
		//System.out.println("inside sendDGCertPerintahSek17 ################");	

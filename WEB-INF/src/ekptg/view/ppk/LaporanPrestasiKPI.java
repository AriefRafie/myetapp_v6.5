...
public class LaporanPrestasiKPI extends AjaxBasedModule {
	/**
	 *  
	 */
	...
	static Logger myLog = Logger.getLogger(ekptg.view.ppk.LaporanPrestasiKPI.class); 
	public String doTemplate2() throws Exception {
	    HttpSession session = this.request.getSession();
		String vm = "app/ppk/frmSenaraiLaporanPrestasiKPI.jsp";
		String socNegeri = "";
		String socUnit = "";
    	...
    	if ("doChangeSelect".equals(submit)){
			...
			if(userLevel==1){
    			vm = PATH+"frmSenaraiLaporanPrestasiKPI.jsp?";

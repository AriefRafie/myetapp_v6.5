 ...
 *
 */
public class FrmPerintahLHDN extends AjaxBasedModule {
	...
	static Logger myLog = Logger.getLogger(ekptg.view.ppk.integrasi.FrmPerintahLHDN.class);
	String role = null;	
		...
		if (actionPerintah.equals("papar")){			
			...
			if (flagAdaHAPF.equals("1")){
				...
				this.context.put("SenaraiHAPF", listHAPF);
						...
						/**
			 * Tambahan syarat role.contains("(INTEGRASI)")
			 * Dikemaskini pada 21/02/2013
			 * Dikemaskini Oleh Mohamad Rosli
			 */
			...
			if(role.equals("userSemakanPerintah") || role.contains("(INTEGRASI)")){
				...
				if(!getParam("txtNoFail").equals("") 
					|| !getParam("txtPemohon").equals("")
					|| !getParam("txtSimati").equals("") 
					|| !getParam("socJenisKp").equals("") 
					|| !getParam("txtIcSimati").equals("")){					
			...
			if(list.size()!=0){
				...
				this.context.put("idSimati",  h.get("ID_SIMATI"));
			}

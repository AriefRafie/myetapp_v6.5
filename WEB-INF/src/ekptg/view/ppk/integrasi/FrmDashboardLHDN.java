...
public class FrmDashboardLHDN extends AjaxBasedModule {
	static Logger myLogger = Logger.getLogger(FrmDashboardLHDN.class);
	String userId = null;
	String role = null;
	...
	EtappSupportAduanData logicES = new EtappSupportAduanData();
...
*/
		...
		check_notifikasi_index_maklumbalas_aduan = logicES.getListNotifikasi_main_list(role,user_negeri_login,"","1",userId,"NO");
		context.put("check_notifikasi_index_maklumbalas_aduan",check_notifikasi_index_maklumbalas_aduan);
		
		check_notifikasi_index_maklumbalas_teknikal = logicES.getListNotifikasi_main_list(role,user_negeri_login,"","2",userId,"NO");
    	...
    	*/
		String vm = "app/ppk/perintah/dashboard.jsp";

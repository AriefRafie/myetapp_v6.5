...
public class FrmLaporanKemasukanBayaran extends AjaxBasedModule {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger mylog = Logger.getLogger(ekptg.view.ppk.FrmLaporanKemasukanBilFail.class);
	public String doTemplate2() throws Exception {
    	...
    	if ("SelectDaerah".equals(submit)){
			...
			vecHash = FrmLaporanKemasukanBilFailData.getSenarai(idPejabat,idDaerah);
           	...
           	vecSenaraiCarian = FrmLaporanKemasukanBayaranData.carianFailMengikutNoFail(noFail, session);
           	socUnit = PPKUtilHTML.SelectJenisBayaranBySeksyen("2","socJenisbayaran",null," style=width:340 "," onChange=\"javascript:doJenisBayaran('"+noFail+"')\"");
			socDaerah = PPKUtilHTML.SelectCaraBayaran("socCarabayaran",null,"style=width:340",null);  			
			vecHash = (Vector)FrmLaporanKemasukanBayaranData.getSenarai(user.getId_pejabatjkptg(),noFail);
			...
			socUnit = PPKUtilHTML.SelectJenisBayaranBySeksyen("2","socJenisbayaran",null," style=width:340 "," onChange=\"javascript:doJenisBayaran()\"");
  			socDaerah = PPKUtilHTML.SelectCaraBayaran("socCarabayaran",null,"style=width:340",null);  			
   			vecHash = FrmLaporanKemasukanBayaranData.getSenarai(user.getId_pejabatjkptg(),noFail);
			...
			if(userLevel==1){
    			...
    			socUnit = PPKUtilHTML.SelectJenisBayaranBySeksyen("2","socJenisbayaran",null," style=width:340 "," onChange=\"javascript:doJenisBayaran()\"");
    			socDaerah = PPKUtilHTML.SelectCaraBayaran("socCarabayaran",null,"style=width:340",null);  			
    			// Tidak dipaparkan semasa pertama kali/ default
    			//vecHash = (Vector)FrmLaporanKemasukanBayaranData.getSenarai(user.getId_pejabatjkptg());
    		}
    	}
		//context.put("senaraiRekod",vecHash);
		context.put("SenaraiFail",vecHash);
		setupPage(session,action,vecHash);
	...
	public void XsetupPage(HttpSession session,String action,Vector list) {
		...
		this.context.put("senaraiRekod",paging.getPage(page));

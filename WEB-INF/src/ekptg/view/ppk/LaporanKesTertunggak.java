...
public class LaporanKesTertunggak extends AjaxBasedModule {
	/**
	 * 
	 */
	...
	static Logger myLog = Logger.getLogger(ekptg.view.ppk.LaporanKesTertunggak.class);
	public String doTemplate2() throws Exception {
	    HttpSession session = this.request.getSession();
		String vm = PATH+"frmSenaraiLaporanKesTertunggak.jsp";
		String socNegeri = "";
		String socUnit = "";
    	...
    	if ("doChangeSelect".equals(submit)){
			...
			if(userLevel==1){
    			vm = PATH+"frmSenaraiLaporanKesTertunggak.jsp";
    			...
    			vm = PATH+"frmSenaraiLaporanPUnit.jsp";			   			
...
//       		vecHash = FrmUtilData.getLaporanMengikutSeksyen("","daerah","L");
    	...
    	Vector listSenarai1 = new Vector();
		listSenarai1 = null;
		Vector listSenarai2 = new Vector();
		listSenarai2 = null;
    	String negeri;
    	int i;
    	for (i=0; i<2; i++)
    	{
    		...
    		{
    			negeri = "14";
    			modelLaporan.setDataSenaraiSerahanOverall("1","1","2016","31","12","2016", negeri);
    			listSenarai1 = modelLaporan.getSenaraiLaporanSerahan();
    		}
    		if (i == 1)
    		{
    			negeri = "11";
    			modelLaporan.setDataSenaraiSerahanOverall("1","1","2016","31","12","2016", negeri);
    			listSenarai2 = modelLaporan.getSenaraiLaporanSerahan();
    		}
    	}
    	context.put("listSenarai1",listSenarai1);
    	context.put("listSenarai2",listSenarai2);

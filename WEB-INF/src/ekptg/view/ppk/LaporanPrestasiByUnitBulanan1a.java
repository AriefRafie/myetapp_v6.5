...
public class LaporanPrestasiByUnitBulanan1a extends AjaxBasedModule {
	/**
	 * 
	 */
	...
	static Logger myLog = Logger.getLogger(ekptg.view.ppk.LaporanPrestasiByUnitBulan.class);
	...
	public String doTemplate2() throws Exception {
		...
		listPrestasi = null;
		modelLaporan.setDataPrestasibyUnitBulan(BULAN,TAHUN,ID_NEGERI,ID_UNIT);

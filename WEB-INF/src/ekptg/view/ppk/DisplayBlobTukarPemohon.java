...
public class DisplayBlobTukarPemohon implements IServlet2{
	
static Logger myLogger = Logger.getLogger(DisplayBlobTukarPemohon.class);
	...
	public void doService(HttpServletRequest request, HttpServletResponse response,
			...
			Db db = null;
				 try {
			            ...
			            PreparedStatement ps = con.prepareStatement("select content,jenis_mime from (select * from tblppktukarpemohon  where id_permohonansimati = ? order by tarikh_pertukaran desc) where rownum = 1");

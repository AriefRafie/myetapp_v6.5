...
public class FrmIntegrasiDGCert17 extends VTemplate {
	static Logger myLogger = Logger.getLogger(FrmIntegrasiDGCert17.class);
...
//				context.put("checkP3", "");
			...
			vm = "app/ppk/integrasi/DGCert17.jsp";
			myLogger.info("vm ::"+vm);
...
//				context.put("checkP3", "");
		...
		//String flagSimpan = "";
			...
			//System.out.println("signedText:::::SEK17 "+signedText);
			...
			try {
				...
				//aishah add untuk pindah dr table TEMP ke table real
				modelNotis.insertPenghantaranNotisReal(idperbicaraan,idfail,session,application,request,response);

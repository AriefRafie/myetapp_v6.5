...
public class SenaraiFailLengkap extends AjaxBasedModule {
	private static final long serialVersionUID = 1L;

	FrmHeaderPpk mainheader = new FrmHeaderPpk();

	// for println output
	static Logger myLogger = Logger.getLogger(SenaraiFailLengkap.class);
	...
	public String doTemplate2() throws Exception {
		...
		System.out.println("submit12345 = " + submit);
		//System.out.println("commands kat atas =" + commands);
		//String FailLengkap = "no";
		if (submit == "Cari" || submit == "cari" || submit.equals("Cari"))
		{
			commands = "selesai";
			//System.out.println("submit == cari");
		}
...
System.out.println("flag===="+flag);
			...
			System.out.println("*******semakWithData********");
			String selectedTab = "";
...
//			String idParentOB = modelNotis.getIdParentOB(getParam("id_permohonansimati_atheader")); 
			...
			modelNotis.setListPenerimaNotis(idperbicaraan, getParam("id_permohonansimati_atheader"));
...
System.out.println("idPegawai==="+idPegawai);
	...
	private void simpanNotisTambah(HttpSession session) throws Exception {
		...
		modelNotis.addNotisTambah(session, h);
	...
	private void simpanLaporan(HttpSession session) throws Exception {
		...
		List listEmailAdd = new ArrayList<>();//code wp
		List listIdObToSendMel = new ArrayList<>();//code wp

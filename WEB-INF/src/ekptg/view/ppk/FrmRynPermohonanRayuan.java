...
public class FrmRynPermohonanRayuan extends AjaxBasedModule{

	static Logger myLogger = Logger.getLogger(FrmRynPermohonanRayuan.class);
	...
	public String doTemplate2() throws Exception{
    	...
    	//screen
    	String screensenarai = "app/ppk/frmRynSenarai.jsp";
    	String screen = "app/ppk/frmRynPermohonanRayuanSemakPenerimaan.jsp";
    	String mainscreen = "app/ppk/frmRynPermohonanRayuanMaklumatPerayu.jsp";
    	...
    	getIdSuburusanstatusfail = model2.getIdSubUrusanStatusFail(idprmhn);
		...
		model2.setListSemakWithData(idkp);
		dataNotis = model2.getListSemakWithData();
		...
		//get id perintah
		perintah = model.getPerintah(idperbicaraan);
		String id_perintah = "";
		if(perintah.size()!=0){
    	...
    	if ("semakRayuan".equals(submit)){
    		...
    		//get info pemohon
        	model2.setListSemak(id_permohonan,usid);
    		dataPemohon = model2.getListSemak();
    		...
    		if(!idStatus.equals("21") && !idStatus.equals("25")){
        		...
        		//get checkbox
        		model.setListSemakK2(id_permohonan);
        		dataSemakK2 = model.getListSemakK2();

        		//get data bayaran
        		model.setBayaranK2(id_permohonan);
        		bayaranK2 = model.getBayaranK2();
            	...
            	if ("kemaskiniSemakanK2".equals(submit3)){
            		...
            		flagRayuan = model.getFlagRayuan(id_perintah);
            		String flag_rayuan = "";
    		...
    		}else if(idStatus.equals("21") || idStatus.equals("25")){
    			
    			//dapatkan tarikh selesai dari TBLPPKPERMOHONAN
    			tarikh_selesai = model.getTarikhSelesai(id_permohonan);
    			String tarikhselesai = "";
    			if(tarikh_selesai.size()!=0){
        			Hashtable ts = (Hashtable) tarikh_selesai.get(0);
        			tarikhselesai = ts.get("tarikh_selesai").toString();
        			context.put("tarikhselesai",tarikhselesai);
        		}
            	...
            	if ("simpanSemakanK2".equals(submit2)){
            		...
            		if(dataPemohon.size()!=0){
            			...
            			idFail = ls.get("idFail").toString();
            			idPemohon = ls.get("idPemohon").toString();
            			namaSimati = ls.get("namaSimati").toString();
            			tarikhMati = ls.get("tarikhMati").toString();
            			tarikh_rayuan = ls.get("tarikh_rayuan").toString();
            		}
    		...
    		//get list firma
    		listFirmaTR = model.getListFirmaTerdahulu(id_pemohon);
    		...
    		model.setDataMaklumat(id_permohonan,id_perintah);
    		maklumatRayuan = model.getDataMaklumat();
    		context.put("maklumatRayuan_size", maklumatRayuan.size());

    		//get data ob
    		model2.setListOB(id_permohonansimatiINT,id_simati);
    		listOB = model2.getListOB();


    		//get data ob
    		model2.setListOBatas18(id_permohonansimatiINT,id_simati,"8");
    		listOBatas18 = model2.getListOBatas18();
    		...
    		listFirmaTerdahulu = model.getDropdownFirmaTerdahulu(id_pemohon,idp);
    		...
    		if ("changeGetAlamatPerayu".equals(submitx)){
        		...
        		if(idListOB!=""){
        			...
        			onchangeListOB = model.getOnchangeListOB(idListOB);
    		...
    		if(maklumatRayuan.size()!=0){
        		...
        		model.setLatestPeguam(id_perayu);
        		dataLatestPeguam = model.getLatestPeguam();
        		...
        		//get list firma
        		listFirma = model.getListFirma(id_perayu);
            	...
            	if("kemaskiniMaklumatPP".equals(submit2)){
            		...
            		otherPeguam = model.getOtherPeguam(id_peguamX);
                	...
                	if("kemaskiniX".equals(submitxx)){
                		...
                		otherPeguam = model.getOtherPeguam(id_peguamXX);
                    	...
                    	if ("changeGetAlamatPerayuUPDATETambah".equals(submitoc)){
                    		...
                    		if(onchangePP.equals("yes")){
                    			...
                    			if(idob!=""){
                        			...
                        			onchangeListOB = model.getOnchangeListOB(idob);
                            		Hashtable xy = (Hashtable) onchangeListOB.get(0);
        	...
        	if ("getDetailFirmaX".equals(submit2)){
        		...
        		if(id_socNamaFirma!=""){
        	    	detailFirma = model.getDetailFirma(id_socNamaFirma);
	    	...
	    	vm = mainscreen;
    	    	...
    	    	if(idListOBx!=""){
    	    		onchangeListOB = model.getOnchangeListOB(idListOBx);
	    	...
	    	if(socNamaFirma!=""){
	    	detailFirma = model.getDetailFirma(socNamaFirma);
    		...
    		String selectedTab = "";
    		String BRR = getParam("BRR");
    		String n4 = getParam("n4");
    		selectedTab = getParam("tabId").toString();
    		String jumlah_bayaran = getParam("txtBayaranRekodhidden");
    		myLogger.info("jumlah_bayaran1 = " + jumlah_bayaran);
    		if (selectedTab == null || "".equals(selectedTab))
            {
            	selectedTab="3";
            }
    		...
    		model2.setPenghantarNotisByJkptg(idPejabatJKPTG);
    		penghantarNotisByJkptg = model2.getPenghantarNotisByJkptg();
    		//and
    		model2.setPenghantarNotis();
    		penghantarNotis = model2.getPenghantarNotis();
    		...
    		if(maklumatRayuan.size()!=0){
        		...
        		if(id_status.equals("163") || id_status.equals("164") || id_status.equals("165") || id_status.equals("169") || id_status.equals("166") || id_status.equals("167") || id_status.equals("180")){
        			...
        			model.setDataMaklumatSerahan(id_rayuan);
            		maklumatSerahan = model.getDataMaklumatSerahan();
            		...
            		dataMstRayuan = model.getDataMstRayuan();
                	...
                	if ("kemaskiniSerahan".equals(submit2)){
    	    			...
    	    			getSelectedPenghantarNotisByJkptg = model2.getSelectedPenghantarNotisByJkptg(idPejabatJKPTG,id_penghantarnotis);
                		//and
    	    			getSelectedPenghantarNotis = model2.getSelectedPenghantarNotis(id_penghantarnotis);
                    	...
                    	if ("updateSerahan".equals(submit3)){
                    		//myLogger.info("jumlah_bayaran3 = " + jumlah_bayaran);
                    		context.put("jumlah_bayaran_semua", jumlah_bayaran);
                     		if (doPost.equals("true")) {
                			...
                			context.put("editformK3", "no");
                			context.put("onchangebandar","no");
                			myLogger.info("jumlah_bayaran2 = " + jumlah_bayaran);
                			//context.put("jumlah_bayaran_semua","jumlah_bayaran");
                    	}//update serahan
        	    			...
        	    			if(id_penghantar!=""){
            	        		...
            	        		getPenghantarNotis = model2.getDetailPenghantarNotis(id_penghantar);
            	    			...
            	    			//selected penghantar ob
            	    			getSelectedPenghantarNotisByJkptg = model2.getSelectedPenghantarNotisByJkptg(idPejabatJKPTG,id_penghantar);
                        		//and
            	    			getSelectedPenghantarNotis = model2.getSelectedPenghantarNotis(id_penghantar);
            	    			//check penghantar notis ade o xde dlm negeri
            	    			model2.setPenghantarNotisByJkptg(idPejabatJKPTG);
            	        		penghantarNotisByJkptg = model2.getPenghantarNotisByJkptg();
...
/*new form*/    else
      ...
      //  			String bandarPER = mr.get("bandar_perayu").toString();
                	...
                	if ("simpanSerahan".equals(submit2)){
                		...
                		//String jumlah_bayaran = getParam("txtBayaranRekod");
                		myLogger.info("jumlah_bayaran = " + jumlah_bayaran);
                 		if (doPost.equals("true")) {
            	    	...
            	    	if(id_penghantarnotis!=""){
        	        		...
        	        		getPenghantarNotis = model2.getDetailPenghantarNotis(id_penghantarnotis);
        	        		if(getPenghantarNotis.size()!=0){
        	        			Hashtable x = (Hashtable) getPenghantarNotis.get(0);
    		...
    		if(dataPemohon.size()!=0){
    			...
    			id_pemohon = ls.get("idPemohon").toString();
    			id_status = ls.get("id_Status").toString();
    		...
    		//get list ob atas 18
			model.setListcbOB(id_permohonansimatiINT,id_rayuan,id_perayu,id_simati);
			listOBatas18 = model.getListcbOB();
 ...
 /*   	else if("memorandumRayuan".equals(submit)){
    	...
    	}//close memorandum rayuan
  */
    	else if ("cari".equals(submit)){

    		carianRayuan(session);
    		listdepan = model.getListCarian();
 ...
 */
	...
	private void simpanSemakanK2(HttpSession session,String id_perintah) throws Exception{
	    	...
	    	if(cbsemaks!=null){
	    		for (int i = 0; i < cbsemaks.length; i++) {
        			...
        			model.simpanSemakanK2(h,cbsemaks[i], String.valueOf(id_permohonan), String.valueOf(noresit), String.valueOf(tarikhbayaran),String.valueOf(jumlahbayaran));
        			}
	...
	private void updateSemakanK2(HttpSession session) throws Exception{
	    	...
	    	if(cbsemaks!=null){
	    		for (int i = 0; i < cbsemaks.length; i++) {
        			...
        			model.updateSemakanK2(h,cbsemaks[i], String.valueOf(id_permohonan), String.valueOf(noresit), String.valueOf(tarikhbayaran),String.valueOf(jumlahbayaran),String.valueOf(deleteF));
        			}
        	}
	...
	private void simpanMaklumatPP(HttpSession session,String id_perintah) throws Exception{
	    	...
	    	String idListOB = getParam("socPerayu");
	    	Vector onchangeListOB = model.getOnchangeListOB(idListOB);
	...
	private void updateMaklumatPP(HttpSession session) throws Exception{
	    	...
	    	if(sorPeguam==1){
	    		if(id_socNamaFirma!=""){
	    			...
	    			model.deleteDataPeguam(id_peguam);
	    			model.tambahPeguamLama(h);
	    		}//else{
	...
	private void simpanSerahanK3(HttpSession session,String idperbicaraan) throws Exception{
	    	...
	    	model.simpanSerahanK3(session,h);

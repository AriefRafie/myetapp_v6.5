 ...
 *
 */
public class LaporaneHutang extends AjaxBasedModule {
	

	private static final long serialVersionUID = 1L;
    private static Logger myLog = Logger.getLogger(LaporaneHutang.class);	
	...
	public String doTemplate2() throws Exception {
		...
		String vm = "";
		String step2 = "";
		String jenisLaporan2 = "1";
		//String jenisLaporan2 = getParam("jenisLaporan2");
		System.out.println("%%%%%%%%%%%%%%%%%jenisLaporan2%%%%%%%%%%%%%%%%%%= "+jenisLaporan2);
		String check1A = "";
		String check1B = "";
		if (jenisLaporan2.equals("1"))
		{
			check1A = "checked";
			check1B = "";
		}
		else if (jenisLaporan2.equals("2"))
		{
			check1A = "";
			check1B = "checked";
		}
		...
		String sorTempoh = getParam("sorTempoh2");
		String cetak = "";
		cetak = getParam("Cetak");
		System.out.println("command="+command);
		System.out.println("sorTempoh2 :: " +sorTempoh);
		System.out.println("cetak :: " +cetak);
		context.put("command", command);
		context.put("templateDir", templateDir);
		Vector<Hashtable<String,String>> senaraiUtama = null;
		Vector<Hashtable<String,String>> LaporaneHutangAgensi = null;
		Vector<Hashtable<String,String>> LaporaneHutangAgensibyPPK = null;
		
		Vector<Hashtable<String,String>> LaporaneHutangAgensi2 = null;
		...
		//try {
			if ("hapusDokumen".equals(command)) {
				...
				Hashtable hutang = logic.simpanHutang(getParam("idHutang"), getParam("nama"), getParam("noPengenalan"), getParam("alamat1"), getParam("alamat2"), 
						...
						getParam("butiranHutang"), getParam("nilaiHutang"), getParam("bakiHutang"), getParam("tarikhTamatTempohHutang"), getParam("tarikhPerjanjian"), getParam("catatan"), getParam("insuransHutang"), getParam("catatanInsuransHutang"), session);
				context.put("hutang", hutang);
				...
				context.put("id2", id2);
				Vector maklumathutangPPK = logic.getMaklumatPenghutangPPK(id);	
				...
				vm = "/start.jsp";
			}else if ("cetakLaporaneHutangAgensi".equals(command)) {
				context.put("role", portal_role);
				context.put("buttonCetak","buttonCetak");
				context.put("cetak", cetak);
				context.put("jenisLaporan2", jenisLaporan2);
				System.out.println("***sorTempoh**** "+sorTempoh);
				context.put("sorTempoh", sorTempoh);
				String valueAgensi = getParam("namaAgensi");
				System.out.println("valueAgensi = " +valueAgensi);
				if (!(valueAgensi.equals("")))
				//if (valueAgensi != null || valueAgensi != "")
				{
					System.out.println("Check valueAgensi");
					Vector namaAgensibyIdPejabat = logic.namaAgensibyIdPejabat(valueAgensi);
					this.context.put("namaAgensibyIdPejabat", namaAgensibyIdPejabat );
				}
				step2 = "step2";
					if (sorTempoh.equals("1"))
					{
					System.out.println("cetakLaporaneHutangAgensibyBulan");
					System.out.println("jenisLaporan2 = "+jenisLaporan2);
					
					//Vector idpejabat = logic.idPejabat(USER_ID_SYSTEM);
					String bulan1 = getParam("bulan1");
					String tahun1 = getParam("tahun1");
					String bulan2 = getParam("bulan2");
					String tahun2 = getParam("tahun2");

					
					context.put("bulan1",bulan1);
					context.put("tahun1",tahun1);
					context.put("bulan2",bulan2);
					context.put("tahun2",tahun2);
					
					if (!(jenisLaporan2.equals("")))
					{
						System.out.println("########jenisLaporan2#########");
						if (jenisLaporan2.equals("1"))
						{
							System.out.println("########jenisLaporan2(1)#########");
							LaporaneHutangAgensibyPPK = logic.getLaporaneHutangAgensibyPPK(bulan1, null, tahun1, null, valueAgensi);
							this.context.put("LaporaneHutangAgensibyPPK", LaporaneHutangAgensibyPPK);
						}
					}
					else
					{
						LaporaneHutangAgensi = logic.getLaporaneHutangAgensi(bulan1, null, tahun1, null, USER_ID_SYSTEM);
						LaporaneHutangAgensi2 = logic.getLaporaneHutangAgensi2(bulan1, null, tahun1, null, USER_ID_SYSTEM);
						this.context.put("LaporaneHutangAgensi", LaporaneHutangAgensi);
						this.context.put("LaporaneHutangAgensi2", LaporaneHutangAgensi2);
					}
			        vm = "/startLaporan.jsp";
					}
					
					if (sorTempoh.equals("2"))
					{
					System.out.println("cetakLaporaneHutangAgensibyTahun");
					System.out.println("***jenisLaporan2*** = "+jenisLaporan2);
					//Vector idpejabat = logic.idPejabat(USER_ID_SYSTEM);
					...
					if (!(jenisLaporan2.equals("")))
					{
						...
						{
							System.out.println("########jenisLaporan2(1)#########");
							LaporaneHutangAgensibyPPK = logic.getLaporaneHutangAgensibyPPK(null, null, tahun1, null, valueAgensi);
							this.context.put("LaporaneHutangAgensibyPPK", LaporaneHutangAgensibyPPK);
						}
					}
					else
					...
					LaporaneHutangAgensi = logic.getLaporaneHutangAgensi(null, null, tahun1, null, USER_ID_SYSTEM);
					LaporaneHutangAgensi2 = logic.getLaporaneHutangAgensi2(null, null, tahun1, null, USER_ID_SYSTEM);
			        this.context.put("LaporaneHutangAgensi", LaporaneHutangAgensi);
			        this.context.put("LaporaneHutangAgensi2", LaporaneHutangAgensi2);
					...
					if (sorTempoh.equals("3"))
					{
					System.out.println("cetakLaporaneHutangAgensibyRange");
					//Vector idpejabat = logic.idPejabat(USER_ID_SYSTEM);
					String bulan1 = getParam("bulan1");
					String tahun1 = getParam("tahun1");
					String bulan2 = getParam("bulan2");
					...
					if (!(jenisLaporan2.equals("")))
					{
						...
						{
							System.out.println("########jenisLaporan2(1)#########");
							LaporaneHutangAgensibyPPK = logic.getLaporaneHutangAgensibyPPK(bulan1, bulan2, tahun1, tahun2, valueAgensi);
							this.context.put("LaporaneHutangAgensibyPPK", LaporaneHutangAgensibyPPK);
						}
					}
					else
					{
						LaporaneHutangAgensi = logic.getLaporaneHutangAgensi(bulan1, bulan2, tahun1, tahun2, USER_ID_SYSTEM);
						LaporaneHutangAgensi2 = logic.getLaporaneHutangAgensi2(bulan1, bulan2, tahun1, tahun2, USER_ID_SYSTEM);
						this.context.put("LaporaneHutangAgensi", LaporaneHutangAgensi);
						this.context.put("LaporaneHutangAgensi2", LaporaneHutangAgensi2);
					}
			        vm = "/startLaporan.jsp";
			...
			}else if ("cetakLaporaneHutangAgensibyPPK_step1".equals(command)) {
					context.put("buttonCetak","");
					context.put("command","cetakLaporaneHutangAgensibyPPK_step1");
					context.put("tahun1", "");
					context.put("bulan1", "");
					context.put("namaAgensibyIdPejabat", "");
					step2 = "step2";
				...
				System.out.println("Read Hereq --- else");
				Hashtable namaPejabat = logic.namaPejabat2(USER_ID_SYSTEM);
				System.out.println("Read Here1bb --- else");
				context.put("namaPejabat", namaPejabat);
				System.out.println("Read Here1aa --- else");
				context.put("buttonCetak","");
				context.put("cetak", cetak);
				//Vector idpejabat = logic.idPejabat(USER_ID_SYSTEM);
				//context.put("namaPejabat", idpejabat);
				System.out.println("Read Here2aa --- else");
		        if(portal_role.equals("adminppk")){
		        	System.out.println("Read Here3a --- else");
		        	//Vector listPenghutang = logic.getSenaraiPenghutang(null, null, USER_ID_SYSTEM);
		        	senaraiUtama = logic.getSenaraiPenghutangPPK(null, null, USER_ID_SYSTEM);
		        	this.context.put("SenaraiFail", senaraiUtama);
		        	System.out.println("Read Here3 --- else");
		        	
		        	
		        }else{
		        	System.out.println("Read Here4a --- else");
		        	//Vector listPenghutang2 = logic.getSenaraiPenghutang2(null, null);
		        	senaraiUtama = logic.getSenaraiPenghutang2(null, null, USER_ID_SYSTEM);
		        	this.context.put("SenaraiFail2", senaraiUtama);
		        	System.out.println("Read Here4 --- else");
		        	//this.context.put("idpejabat", idpejabat);
		        	
		        }
		        System.out.println("Read Here5 --- else");
				setupPage(session, action, senaraiUtama);
	        	...
	        	if ("doChangeTempoh".equals(submit2)){
	        		...
	        		if(sorTempoh.equals("1")){
	        			step2 = "step2";
	        			System.out.println("sorTempoh = 1");
	        			//checked
	        			...
	        			step2 = "step2";
	        			System.out.println("sorTempoh = 2");
	        			//checked
	        			context.put("check1","");
	        			...
	        			step2 = "step2";
	        			System.out.println("sorTempoh = 3");
	        			...
	        			step2 = "step2";
	        			System.out.println("sorTempoh = else");
	        			//checked
	        			context.put("check1","");
	        			context.put("check2","");
	        			context.put("check3","");
        			...
        			context.put("disB","");
        			context.put("disC","");
        			context.put("LaporaneHutangAgensibyPPK", "");
    			...
    			context.put("tahun1","");
    			context.put("tahun2","");
	        	this.context.put("LaporaneHutangAgensi","");
				vm = "/startLaporan.jsp";
			...
			System.out.println(" ::::command::::: "+command);
			System.out.println(" ::::check1A::::: "+check1A);
			Vector namaAgensi = logic.namaAgensi();
			this.context.put("namaAgensi",namaAgensi);
			context.put("check1A",check1A);
			context.put("check1B", check1B);

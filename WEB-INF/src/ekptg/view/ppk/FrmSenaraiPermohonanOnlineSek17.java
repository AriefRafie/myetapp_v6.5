...
public class FrmSenaraiPermohonanOnlineSek17 extends AjaxBasedModule{
	
	Vector list = null;
	public String doTemplate2() throws Exception {
		String vm = "app/ppk/frmSenaraiPermohonanOnlineSek17.jsp";
		...
		context.put("selectUnit",HTML.SelectTempatBicaraByNegeri(negeri,"socUnit",null,"style=width:340"," onChange=\"doChangeNegeir()\""));

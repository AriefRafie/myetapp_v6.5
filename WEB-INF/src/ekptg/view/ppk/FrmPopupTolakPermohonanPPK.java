...
public class FrmPopupTolakPermohonanPPK extends AjaxBasedModule {
	private static final long serialVersionUID = 1L;
	static Logger myLogger = Logger.getLogger(FrmPopupTolakPermohonanPPK.class);	
	//model
	...
	public String doTemplate2() throws Exception{		
    	...
    	//default
    	String vm = "app/ppk/frmPopupTolakPermohonan.jsp";		
    	//item
		...
		String modul = "ppk";//getParam("modul");
    	myLogger.info("modul : " + modul);
    	String modulPPK = getParam("modulPPK");
    	myLogger.info("modulPPK : " + modulPPK);
    	//NEW FORM
...
//    				susf.setTarikhKemaskini("sysdate");
					...
					myLogger.info("simpanCatatanTolak");*/
					simpanCatatanTolak(String.valueOf(hashPermohonan.get("idPermohonan")),String.valueOf(getParam("txtCatatan")),userId);
...
//--METHOD--//		
	...
	private void simpanCatatanTolak(String id_permohonan, String catatan, String userId) throws Exception{	
		
		Hashtable<String,String> h = new Hashtable<String,String>();		
		h.put("id_permohonan", id_permohonan);
		h.put("txtCatatan", catatan.toUpperCase());
		h.put("id_user",userId);	
		//modelUPT.simpanCatatanTolak(h);
		FrmPrmhnnSek8DaftarSek8OnlineData.simpanCatatanTolak(h);

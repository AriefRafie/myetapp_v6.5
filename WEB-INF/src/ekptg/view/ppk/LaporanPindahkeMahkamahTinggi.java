...
public class LaporanPindahkeMahkamahTinggi extends AjaxBasedModule {
	/**
	 * 
	 */
	...
	static Logger myLog = Logger.getLogger(ekptg.view.ppk.LaporanPindahkeMahkamahTinggi.class);
	public String doTemplate2() throws Exception {
	    HttpSession session = this.request.getSession();
		String vm = PATH+"frmSenaraiLaporanPindahKeMahkamahTinggi.jsp";
		String socNegeri = "";
		String socUnit = "";
    	...
    	if ("doChangeSelect".equals(submit)){
    		...
    		//myLog.info("userLevel="+userLevel);
			if(userLevel==1){
    			vm = PATH+"frmSenaraiLaporanPindahKeMahkamahTinggi.jsp";

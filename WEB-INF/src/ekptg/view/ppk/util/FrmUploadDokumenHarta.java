...
public class FrmUploadDokumenHarta extends AjaxBasedModule {

	private final String PATH="app/ppk/util/";
	private static final long serialVersionUID = 1L;
	private static Logger myLog = Logger.getLogger(ekptg.view.ppk.util.FrmUploadDokumenHarta.class);

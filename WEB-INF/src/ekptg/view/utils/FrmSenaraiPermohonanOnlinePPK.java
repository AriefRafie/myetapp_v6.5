...
public class FrmSenaraiPermohonanOnlinePPK extends AjaxBasedModule{
	Vector list = null;
	private static Logger myLog = Logger.getLogger(ekptg.view.utils.FrmSenaraiPermohonanOnlinePPK.class);
	
	public String doTemplate2() throws Exception {
		String vm = "app/utils/frmSenaraiPermohonanOnlinePPK.jsp";	
	...
	public void  setCarianFail(String negeri,String daerah)throws Exception{		
	    ...
	    try {
		    ...
		    sql= "SELECT A.NO_PERMOHONAN_ONLINE,B.NAMA_SIMATI,A.TARIKH_MOHON,C.NO_FAIL"+
			    ...
			    " AND A.SEKSYEN IN (8,17) " +
			    " AND (C.ID_STATUS IS NULL OR C.ID_STATUS <> '999')" +
			    "";

...
public class FrmPopupEmel extends AjaxBasedModule{
	...
	static Logger myLog = Logger.getLogger(ekptg.view.utils.emel.FrmPopupEmel.class);
	...
	public String doTemplate2() throws Exception {		
		...
		String modul = getParam("modul");	//emelperingatan
		String perkara = getParam("perkara");
		String txtKandungan = getParam("kandungan");	
//		String nama_pegawai = "";
//		String id_jawatan = "";
//		String jawatan = "";
//		String emel = "";		
		...
		if(modul.equals("htp")) {
			permohonan = getIPermohonan().findPermohonan(idPermohonan,"");
			txtKandungan = getEmelSemak().setKandungan(permohonan.getPermohonan().getPfdFail().getTajukFail()
							,permohonan.getPermohonan().getPfdFail().getNamaKementerian()
							,permohonan.getPermohonan().getNoPermohonan());
		}
//		
...
//    	txtKandungan += ec.getFooter();
		...
		//
    		hantarEmel = ec.sendTo("roslizakaria@gmail.com", perkara, txtKandungan);

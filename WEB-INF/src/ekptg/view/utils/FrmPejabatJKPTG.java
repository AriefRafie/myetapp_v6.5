 ...
 * 
 */
public class FrmPejabatJKPTG extends AjaxBasedModule {
	static Logger myLogger = Logger.getLogger(FrmPejabatJKPTG.class);
	public String doTemplate2() throws Exception {
		HttpSession session = this.request.getSession();
		String template = "app/utils/frmPejabatJKPTG.jsp";

...
public class Luas{
	...
	@Column(name="FORMULA_UNIT_ASAL")
	private String formulaUnitAsal;
	...
	public String getFormulaUnitAsal() {
		return formulaUnitAsal;
	}

	public void setFormulaUnitAsal(String formulaUnitAsal) {
		this.formulaUnitAsal = formulaUnitAsal;
	}

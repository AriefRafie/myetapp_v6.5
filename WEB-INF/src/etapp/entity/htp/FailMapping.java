...
@Entity
@Table(name = "TBLHTPFAILMAPPING")
public class FailMapping {
	@Id @Column(name="ID_HTPFAILMAPPING")
	private long id;
	@ManyToOne @JoinColumn(name="ID_FAIL")
	private Fail fail;
	@ManyToOne @JoinColumn(name="ID_FAILLAMA")
	private Fail failLama;
	
	@Temporal(TemporalType.TIMESTAMP) @Column(name="TARIKH_AGIHAN")
	...
	public Fail getFailLama() {
		return failLama;
	}
	public void setFailLama(Fail failLama) {
		this.failLama = failLama;
	}

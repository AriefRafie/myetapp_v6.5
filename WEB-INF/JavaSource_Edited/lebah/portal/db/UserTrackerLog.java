...
public class UserTrackerLog {
	...
	static Logger myLog = Logger.getLogger("lebah.portal.db.UserTrackerLog");
	...
	public static void save(HttpServletRequest req, String login, String module) {
	    ...
	    try {
	    	...
	    	myLog.info("55:"+e.getMessage());
	    }
    	//myLog.info("57:"+moduleClass);
	...
	public static void save2(HttpServletRequest req, String login, String module, String moduleClass) {
	    ...
	    String fmtDate = "TO_DATE('" + fmt(Integer.toString(month)) + "/" + fmt(Integer.toString(day)) + "/" + year + " " + hour24 + ":" + min + ":" + sec + "', 'MM/DD/YYYY HH24:MI:SS')";
		...
		try {
			...
			r.add("log_date", r.unquote(fmtDate));
			r.add("module_id", module);
			r.add("module_class", moduleClass);
			String moduleName = getModuleName(module);
			//myLog.info("103:"+moduleName +"-"+module);
	...
	static String getModuleName(String id) throws Exception {
	    if ( "".equals(id)) return "TIADA-ID";
	    String moduleName = "TIADA";
	    Db db = null;
	    try {
	        db = new Db();
	        Statement stmt = db.getStatement();
	...
	public static class CountComparator implements java.util.Comparator {

...
"nowrap>"
        ...
        out.println("<tr class=\"module_content\"><td><div id=\""+contentName+"\" >");
        try
        {
            printContent(content, svtCfg, req, res, out, portletInfo);
      ...
      //  content = null;
        ...
        out.println("</div>"+jsAllelement+"</td></tr>");
        out.println("</table>");
        out.println("</td></tr>");
        out.println("</table>");
        out.println("</td></tr>");
...
"=\"0\">"
        ...
        String contentName = (new StringBuilder("contentDIV")).append(module.replace('.', '_')).toString();
        out.println("<tr><td><div id=\""+contentName+"\" >");
...
" border=\"0\">"
    ...
    private static void printContent(Object content, ServletConfig svtCfg, HttpServletRequest req, HttpServletResponse res, PrintWriter out, PortletInfo portletInfo)
        throws Exception
    {
        if(content != null)
        {
    ...
    private static Object renderContent(VelocityEngine engine, VelocityContext context, ServletConfig svtCfg, HttpServletRequest req, HttpServletResponse res, String module, PortletInfo portletInfo)
    {
        HttpSession session = req.getSession();
        Object content = null;
        try

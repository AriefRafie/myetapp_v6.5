...
public class Tabber extends lebah.portal.velocity.VTemplate {
	...
	public Tabber(VelocityEngine engine, VelocityContext context,
	...
	public Template doTemplate() throws Exception {
		Template template = engine.getTemplate("vtl/main/tabber.vm");
		return template;
	}

	public Tab getFirstTab() {
		if (v != null && (v.size() > 0))
			return (Tab) v.elementAt(0);
		else
			return null;
	}
	...
	private void prepareEnvironment() throws Exception {
		...
		// System.out.println("in Tabber: " + usrlogin + " - " + myrole);

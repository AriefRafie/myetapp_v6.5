...
public class DesktopControllerNewVersion extends VServlet {	
	/**
	 * 
	 */
	...
	public DesktopControllerNewVersion() {
		loginIntercept = null;
		loginIntercept = null;
	}
	...
	public 
	synchronized 
	void doBodyBackupRazman(HttpServletRequest req,
		...
		*/
		...
		// System.out.println("-----------------------------------getCSS(myroletest) :"+ getCSS(myroletest).size());
		if (myroletest == null) {
		...
		if (myroletest != null && getCSS(myroletest).size() > 0) {
			...
			// System.out.print("GET CSS CSS CSS ::::::" + getCSS);
		...
		// myLogger.info(css);
		// System.out.println("CSS dari _portal_css : " +
		// session.getAttribute("_portal_css"));
		// System.out.println("CSS dari variable css : " + css);
	...
	//razman revamp desktop controller
	//solution for queue & cross session/velocity
	public void doBody(HttpServletRequest req,
		HttpServletResponse res) throws Exception {
		boolean isAccessDenied = false;
		...
		boolean isPasswordExpired = false;
		String css;
		//boolean createPortalPage = false;
		
		
		//open razman add sini 27102017		
		...
		//close razman add sini 27102017
		
		synchronized(this){
		
		//open razman comment sini 27102017		
		/*
		session = req.getSession();
		System.out.println("req masuk ::::::::: "+req);
		String pathInfo = req.getPathInfo();
		...
		res.setContentType("text/html");	
		*/	
		//close razman comment sini 27102017
		...
		// module
		module = req.getParameter("_portal_module") != null ? req.getParameter("_portal_module") : "";
		if (session.getAttribute("_portal_module") != null)
			if ((module == null) || ("".equals(module)))
			{
				//System.out.println("portal_module ::::::: "+session.getAttribute("_portal_module"));
				module = (String) session.getAttribute("_portal_module");
			}
		...
		*/
		...
		Object contentRendered = null;
		PortletInfo portletInfo;
		System.out.println("++++++++++++++++++++++++++++++ dc_portletInfo: "+session.getAttribute("_dc_portletInfo"));
		if(session.getAttribute("_dc_portletInfo")!=null)
		{
			ServletConfig svtCfg = getServletConfig();
			portletInfo = (PortletInfo)session.getAttribute("_dc_portletInfo");
			System.out.println("DC portletInfo.id : "+portletInfo.id);
			contentRendered = (Object)session.getAttribute("_dc_content");
			System.out.println("DC content : "+contentRendered);
			if(contentRendered!=null)
			{
				DisplayContentNewVersion.printContent(contentRendered, svtCfg, req, res, out, portletInfo);				
			}			 
		}
		out.println("</td></tr>");
        out.println("</table>");
	...
	private void createPortalPage(HttpServletRequest req,
			...
			if ("customize".equalsIgnoreCase(action) && "true".equals(islogin)) {
				...
				out.println("</td></tr>");
				//2016/11/15////system.out.println(":::::::::::::::::::4");
				...
				out.println("</td></tr>");
				//2016/11/15, //system.out.println(":::::::::::::::::::5");
				...
				try {
					...
					{
						//System.out.println("display_type : 1");
						DisplayContentNewVersion.showNavigationType(engine, context,
							getServletConfig(), req, res, module, out, session);
					}
					else if ("top_navigation".equals(display_type))
					{
						//System.out.println("display_type : 2");
						DisplayContentNewVersion.showTopNavigationType(engine, context,
							getServletConfig(), req, res, module, out, session);
					}
					else if ("top_navigation_with_title".equals(display_type))
					{
						//System.out.println("display_type : 3");
						DisplayContentNewVersion.showTopNavigationTitleType(engine, context,
							getServletConfig(), req, res, module, out, session);
					}
					else if ("two_columns_with_bottom".equals(display_type))
					{
						//System.out.println("display_type : 4");
						DisplayContentNewVersion.showTwoColumnsWithSingleBottom(engine,context, 
							getServletConfig(), req, res, module, out,session);
					}
					else if ("three_columns_with_top".equals(display_type))
					{
						//System.out.println("display_type : 5");
						DisplayContentNewVersion.showThreeColumnsWithSingleTop(engine,context, 
							getServletConfig(), req, res, module, out,session);
					}
					else if ("three_columns_with_bottom".equals(display_type))
					{
						//System.out.println("display_type : 6");
						DisplayContentNewVersion.showThreeColumnsWithSingleBottom(engine,context, 
							getServletConfig(), req, res, module, out,session);
					}
					else if ("narrow_wide".equals(display_type))
					{
						//System.out.println("display_type : 7");
						DisplayContentNewVersion.showNarrowWideType(engine, context,
							getServletConfig(), req, res, module, out, session);
					}
					else if ("wide_narrow".equals(display_type))
					{
						//System.out.println("display_type : 8");
						DisplayContentNewVersion.showWideNarrowType(engine, context,
							getServletConfig(), req, res, module, out, session);
					}
					else if ("two_columns".equals(display_type))
					{
						//System.out.println("display_type : 9");
						DisplayContentNewVersion.showTwoColumnsType(engine, context,
							getServletConfig(), req, res, module, out, session);
					}
					else if ("three_columns".equals(display_type))
					{
						//System.out.println("display_type : 10");
						DisplayContentNewVersion.showThreeColumnsType(engine, context,
							getServletConfig(), req, res, module, out, session);
					}
					else if ("pulldown_menu".equals(display_type))
					{
						//System.out.println("display_type : 11");
						DisplayContentNewVersion.showPullDownMenuType(engine, context,
							getServletConfig(), req, res, module, out, session);
					}
					else if ("windows".equals(display_type))
					{
						//System.out.println("display_type : 12");
						DisplayContentNewVersion.showWindowsType(engine, context,
							getServletConfig(), req, res, module, out, session);
					}
					else
					{
						//System.out.println("display_type : 13");
						DisplayContentNewVersion.showNavigationType(engine, context,
							getServletConfig(), req, res, module, out, session);
					}
					out.println("</div>");
	...
	private void createPortalPageBackupRazman(HttpServletRequest req,
		HttpServletResponse res, PrintWriter out, HttpSession session,
		String action, String module) throws Exception {
		String islogin = (String) session.getAttribute("_portal_islogin");
		String login = (String) session.getAttribute("_portal_login");

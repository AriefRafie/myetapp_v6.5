...
import my.gov.kehakiman.eip.services.EtappSOAPStub;
import my.gov.kehakiman.eip.services.NewType;
import my.gov.kehakiman.eip.services.NewTypeApplicationType;
import my.gov.kehakiman.eip.services.NewTypeCardType;
import my.gov.kehakiman.eip.services.SubmitApplicationRequest;
import my.gov.kehakiman.eip.services.SubmitApplicationRequestEventName;
import my.gov.kehakiman.eip.services.SubmitApplicationRequestSource;
import my.gov.kehakiman.eip.services.SubmitApplicationResponse;
...
//	private static String eventName = "MyeTaPPApplication";
	...
	public MTManager(String kod) throws Exception{
...
//			data.setBlueCardID("16061039");
	...
	private static SubmitApplicationResponse submitToMT(NewType data, String transactionID) 
		...
		EtappSOAPStub stub = new EtappSOAPStub(obj);

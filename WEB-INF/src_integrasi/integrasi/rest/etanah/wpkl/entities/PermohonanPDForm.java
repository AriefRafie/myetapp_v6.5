...
public class PermohonanPDForm {
	...
	private List<HakmilikPermohonanPD> BorangList = null;
	...
	public List<HakmilikPermohonanPD> getBorangList() {
		return BorangList;
	}

	public void setBorangList(List<HakmilikPermohonanPD> borangList) {

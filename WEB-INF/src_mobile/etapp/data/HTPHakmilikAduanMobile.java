...
@Entity
@Table(name = "TBLHTPHAKMILIKADUAN")
public class HTPHakmilikAduanMobile {

	@Id @Column(name="ID_HAKMILIKADUAN")
	private long id;
	...
	public String getIdEAduan() {
		return idEaduan;
	}
	public void setIdEAduan(String idEaduan) {
		this.idEaduan = idEaduan;
	}
}
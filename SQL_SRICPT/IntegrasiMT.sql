...
WHERE 
--
ID_PEJABATMAP=992060

SELECT ID_PEJABAT,NAMA_PEJABAT FROM TBLRUJPEJABAT
WHERE 
...
-- Kuala Lumpur	60
--Peguam Negara, Kuala Lumpur |Pentadbir Tanah Wilayah Persekutuan Kuala Lumpur
--local,uat
INSERT INTO TBLINTMTPEJABATMAP
(ID_PEJABATMAP, ID_PEJABATPEN, ID_PEJABATU, KOD_PEJABATPEN, KOD_PEJABATU, STATUS, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI, JAWATAN)
...
--Pejabat Penasihat Undang-Undang Negeri Terengganu|	Pentadbir Tanah Dungun
INSERT INTO TBLINTMTPEJABATMAP
(ID_PEJABATMAP, ID_PEJABATPEN, ID_PEJABATU, KOD_PEJABATPEN, KOD_PEJABATU, STATUS, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI, JAWATAN)
...
INSERT INTO TBLINTMTPEJABATMAP
(ID_PEJABATMAP, ID_PEJABATPEN, ID_PEJABATU, KOD_PEJABATPEN, KOD_PEJABATU, STATUS, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI, JAWATAN)
VALUES(992013, 0, 0, '', 'e6e1090c-0c7c-4869-a299-eac495c2dbe6', 'Y', NULL, NULL, NULL, NULL, 'Pentadbir Tanah');
...
INSERT INTO TBLINTMTPEJABATMAP
(ID_PEJABATMAP, ID_PEJABATPEN, ID_PEJABATU, KOD_PEJABATPEN, KOD_PEJABATU, STATUS, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI, JAWATAN)
VALUES(99209, 0, 0, '', 'dda63d7a-8075-46ff-b5e0-526d6e585ac1', 'Y', NULL, NULL, NULL, NULL, 'Pentadbir Tanah');
    

--local/uat Pejabat Penasihat Undang-Undang Negeri Kedah|Pentadbir Tanah Daerah Baling 
INSERT INTO TBLINTMTPEJABATMAP
(ID_PEJABATMAP, ID_PEJABATPEN, ID_PEJABATU, KOD_PEJABATPEN, KOD_PEJABATU, STATUS, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI, JAWATAN)
VALUES(992014, 20, 327, '939366a5-afa3-418f-bcfb-0eeb4605ecb3', 'aaea5021-9985-45ed-817e-44d7c20d0d67', 'Y', NULL, NULL, NULL, NULL, 'Pentadbir Tanah Daerah Baling');
...
--local/uat Pejabat Penasihat Undang-Undang Negeri Kedah|Pentadbir Tanah Daerah Langkawi 
INSERT INTO TBLINTMTPEJABATMAP
(ID_PEJABATMAP, ID_PEJABATPEN, ID_PEJABATU, KOD_PEJABATPEN, KOD_PEJABATU, STATUS, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI, JAWATAN)
VALUES(992015, 20, 327, '939366a5-afa3-418f-bcfb-0eeb4605ecb3', 'aaea5021-9985-45ed-817e-44d7c20d0d67', 'Y', NULL, NULL, NULL, NULL, 'Pentadbir Tanah Daerah Langkawi');

--local/uat Pejabat Penasihat Undang-Undang Negeri Kedah|Pentadbir Tanah Daerah Kota Setar 
INSERT INTO TBLINTMTPEJABATMAP
(ID_PEJABATMAP, ID_PEJABATPEN, ID_PEJABATU, KOD_PEJABATPEN, KOD_PEJABATU, STATUS, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI, JAWATAN)
...
DELETE FROM TBLINTMTPEJABATMAP
...
begin    if :new.ID_PEJABATMAP    is null    then SELECT (SELECT kod_negeri FROM tbllookupstate) || TO_CHAR (SYSDATE, 'YY') || TBLINTMTPEJABATMAP_SEQ.NEXTVAL into :new.ID_PEJABATMAP            from dual;    end if;    end;

CREATE SEQUENCE TBLINTMTPEJABATMAP_SEQ
  START WITH 1
  MAXVALUE 999999999
  MINVALUE 1
  NOCYCLE
...
ALTER TABLE TBLINTMTPEJABATMAP ADD (
  CONSTRAINT TBLINTMTPEJABATMAP_PK
 PRIMARY KEY
 (ID_PEJABATMAP));

CREATE TABLE TBLINTMTPEJABATMAP(
	ID_PEJABATMAP           NUMBER CONSTRAINT TBLINTMTPEJABATMAP_C01 NOT NULL,
 	ID_PEJABATPEN        NUMBER                   NOT NULL,
  	ID_PEJABATU        NUMBER                   NOT NULL,
 	KOD_PEJABATPEN        VARCHAR2(50 BYTE),
  	KOD_PEJABATU        VARCHAR2(50 BYTE),
...
AND ID_NEGERI=5
 ...
 SELECT RP.KOD_PEJABATPEN, RP.KOD_PEJABATU, RP.JAWATAN  FROM TBLINTMTPEJABATMAP RP WHERE RP.ID_PEJABATPEN = '267' 

SELECT RP.KOD_PEJABATPEN, RP.KOD_PEJABATU, RP.JAWATAN  
FROM TBLINTMTPEJABATMAP RP
WHERE RP.ID_PEJABATPEN = '267'

SELECT RP.KOD_PEJABATPEN, RP.KOD_PEJABATU, RP.JAWATAN  
FROM TBLINTMTPEJABATMAP RP,TBLRUJPEJABAT P 
WHERE RP.ID_PEJABATPEN = '267'  AND RP.ID_PEJABATPEN = P.ID_PEJABAT

SELECT RP.NAMA_PEJABAT,RPM.KOD_PEJABATPEN
,RPU.NAMA_PEJABAT,RPM.KOD_PEJABATU
FROM TBLRUJPEJABAT RP
,TBLINTMTPEJABATMAP RPM
,TBLRUJPEJABAT RPU
WHERE RP.ID_PEJABAT =RPM.ID_PEJABATPEN
AND RPU.ID_PEJABAT = RPM.ID_PEJABATU
ORDER BY 
RPM.ID_PEJABATMAP

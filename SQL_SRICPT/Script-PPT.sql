---13092020---
INSERT INTO TBLSEMAKAN (ID_SEMAKAN,ID_PARENT,KOD_SEMAK,PERIHAL,LAIN_LAIN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) VALUES (194,NULL,'bantahanpampasan','Nilai Tanah',NULL,NULL,NULL,NULL,NULL);
INSERT INTO TBLSEMAKAN (ID_SEMAKAN,ID_PARENT,KOD_SEMAK,PERIHAL,LAIN_LAIN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) VALUES (195,NULL,'bantahanpampasan','Bangunan',NULL,NULL,NULL,NULL,NULL);
INSERT INTO TBLSEMAKAN (ID_SEMAKAN,ID_PARENT,KOD_SEMAK,PERIHAL,LAIN_LAIN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) VALUES (196,NULL,'bantahanpampasan','Kecederaan',NULL,NULL,NULL,NULL,NULL);


INSERT INTO TBLSEMAKANSENARAI (ID_SEMAKANSENARAI,ID_SEMAKAN,ID_URUSAN,KOD_FORM,ATURAN,CATATAN,ID_SUBURUSAN,ID_KATEGORIPEMOHON,STATUS_DOKUMEN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) VALUES (276,194,51,'pptbantahanpampasan',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO TBLSEMAKANSENARAI (ID_SEMAKANSENARAI,ID_SEMAKAN,ID_URUSAN,KOD_FORM,ATURAN,CATATAN,ID_SUBURUSAN,ID_KATEGORIPEMOHON,STATUS_DOKUMEN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) VALUES (277,195,51,'pptbantahanpampasan',2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO TBLSEMAKANSENARAI (ID_SEMAKANSENARAI,ID_SEMAKAN,ID_URUSAN,KOD_FORM,ATURAN,CATATAN,ID_SUBURUSAN,ID_KATEGORIPEMOHON,STATUS_DOKUMEN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) VALUES (278,196,51,'pptbantahanpampasan',3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);


----12092020
ALTER TABLE TBLPPTTANAHUMUM ADD(
--PENDAHULUAN             VARCHAR2(4000 BYTE),
STATUS_TANAH            VARCHAR2(4000 BYTE),
JALAN_UTAMA             VARCHAR2(4000 BYTE),
JALAN_MASUK             VARCHAR2(4000 BYTE),
NAMA_TEMPAT             VARCHAR2(4000 BYTE),
JARAK_BANDAR            VARCHAR2(4000 BYTE),
PERUMAHAN               VARCHAR2(4000 BYTE),
INDUSTRI                VARCHAR2(4000 BYTE),
FLAG_PBT                VARCHAR2(1 BYTE),
NAMA_PBT                VARCHAR2(200 BYTE),
FLAG_REZAB_MELAYU       VARCHAR2(1 BYTE)
TARIKH_MULA_LAWAT      DATE,
TARIKH_AKHIR_LAWAT     DATE
RUPABUMI               VARCHAR2(4000 BYTE),
KEADAAN_TANAH          VARCHAR2(4000 BYTE),
HALANGAN               VARCHAR2(4000 BYTE),
TANAMAN                VARCHAR2(4000 BYTE),
FLAG_LEMBAH            VARCHAR2(1 BYTE),
FLAG_LURAH             VARCHAR2(1 BYTE),
FLAG_BUKIT             VARCHAR2(1 BYTE),
FLAG_LANDAI            VARCHAR2(1 BYTE),
FLAG_RENDAH            VARCHAR2(1 BYTE),
FLAG_RATA              VARCHAR2(1 BYTE),
FLAG_PAYA              VARCHAR2(1 BYTE),
FLAG_DIUSAHA           VARCHAR2(1 BYTE),
FLAG_LAPANG            VARCHAR2(1 BYTE),
FLAG_TERBIAR           VARCHAR2(1 BYTE),
FLAG_HUTAN             VARCHAR2(1 BYTE),
FLAG_BELUKAR           VARCHAR2(1 BYTE),
FLAG_SEMAK             VARCHAR2(1 BYTE))


----12092020
ALTER TABLE TBLPPTSIASATAN ADD KETERANGAN_PEMBELIAN VARCHAR2(400);
ALTER TABLE TBLPPTSIASATAN ADD KETERANGAN_PERLETAKHAKAN VARCHAR2(400);
ALTER TABLE TBLPPTSIASATAN ADD KETERANGAN_PUSAKA VARCHAR2(400);
ALTER TABLE TBLPPTSIASATAN ADD KETERANGAN_PEMBERIMILIKAN VARCHAR2(400);


---11092020---RUJUKAN EN FARESH SAHAJA

	UPDATE TBLPPTSIASATAN SET JENIS_TANAMAN = NULL WHERE ID_SIASATAN IN (SELECT S.ID_SIASATAN
	FROM TBLPPTSIASATAN S, TBLPPTPERMOHONAN P, TBLPFDFAIL F WHERE S.JENIS_TANAMAN IS NOT NULL 
	AND (S.JENIS_TANAMAN LIKE '%Tiada%' OR S.JENIS_TANAMAN LIKE '%tiada%' OR S.JENIS_TANAMAN LIKE '%Tiada %') AND 
	S.ID_PERMOHONAN = P.ID_PERMOHONAN AND P.ID_FAIL =F.ID_FAIL AND F.ID_SUBURUSAN = '52' )
	
		UPDATE TBLPPTSIASATAN SET JENIS_BANGUNAN = NULL WHERE ID_SIASATAN IN (SELECT S.ID_SIASATAN
	FROM TBLPPTSIASATAN S, TBLPPTPERMOHONAN P, TBLPFDFAIL F WHERE S.JENIS_TANAMAN IS NOT NULL 
	AND (S.JENIS_BANGUNAN LIKE '%Tiada%' OR S.JENIS_BANGUNAN LIKE '%tiada%' OR S.JENIS_BANGUNAN LIKE '%Tiada %') AND 
	S.ID_PERMOHONAN = P.ID_PERMOHONAN AND P.ID_FAIL =F.ID_FAIL AND F.ID_SUBURUSAN = '52' )

-----END OF RUJUKAN EN FARESH-----


--10092020--
CREATE TABLE EKPTGHQUAT.TBLRUJJENISKETERANGANTANAH (
	ID_JENIS_KETERANGANTANAH NUMBER,
	NAMA_KETERANGANTANAH VARCHAR2(100),
	KETERANGANTANAH VARCHAR2(400),
	ID_MASUK NUMBER,
	TARIKH_MASUK DATE
);
CREATE UNIQUE INDEX TBLRUJJENISKETERANGANTANAH_PK ON EKPTGHQUAT.TBLRUJJENISKETERANGANTANAH (ID_JENIS_KETERANGANTANAH);



CREATE SEQUENCE TBLRUJJENISKETERANGANTANAH_SEQ
  START WITH 1
...
INSERT INTO TBLRUJJENISKETERANGANTANAH
(ID_JENIS_KETERANGANTANAH , NAMA_KETERANGANTANAH , KETERANGANTANAH, ID_MASUK, TARIKH_MASUK)
VALUES(1, 'Pembelian', NULL, NULL, NULL);

INSERT INTO TBLRUJJENISKETERANGANTANAH
(ID_JENIS_KETERANGANTANAH , NAMA_KETERANGANTANAH , KETERANGANTANAH, ID_MASUK, TARIKH_MASUK)
VALUES(2, 'Pusaka', NULL, NULL, NULL);

INSERT INTO TBLRUJJENISKETERANGANTANAH
(ID_JENIS_KETERANGANTANAH , NAMA_KETERANGANTANAH , KETERANGANTANAH, ID_MASUK, TARIKH_MASUK)
VALUES(3,'Perletakhakan Mahkamah', NULL, NULL, NULL);

INSERT INTO TBLRUJJENISKETERANGANTANAH
(ID_JENIS_KETERANGANTANAH , NAMA_KETERANGANTANAH , KETERANGANTANAH, ID_MASUK, TARIKH_MASUK)
VALUES(4,'Pemberimilikan', NULL, NULL, NULL);

INSERT INTO TBLRUJJENISKETERANGANTANAH
(ID_JENIS_KETERANGANTANAH , NAMA_KETERANGANTANAH , KETERANGANTANAH, ID_MASUK, TARIKH_MASUK)
VALUES(5,'Lain - lain', NULL, NULL, NULL);
...
INSERT INTO EKPTGHQLIVE.TBLSEMAKANSENARAI
(ID_SEMAKANSENARAI, ID_SEMAKAN, ID_URUSAN, KOD_FORM, ATURAN, CATATAN, ID_SUBURUSAN, ID_KATEGORIPEMOHON, STATUS_DOKUMEN, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI)
VALUES(271, 193, 1, 'pptjenispemilikan', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO EKPTGHQLIVE.TBLSEMAKANSENARAI
(ID_SEMAKANSENARAI, ID_SEMAKAN, ID_URUSAN, KOD_FORM, ATURAN, CATATAN, ID_SUBURUSAN, ID_KATEGORIPEMOHON, STATUS_DOKUMEN, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI)
VALUES(272, 194, 1, 'pptjenispemilikan', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO EKPTGHQLIVE.TBLSEMAKANSENARAI
(ID_SEMAKANSENARAI, ID_SEMAKAN, ID_URUSAN, KOD_FORM, ATURAN, CATATAN, ID_SUBURUSAN, ID_KATEGORIPEMOHON, STATUS_DOKUMEN, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI)
VALUES(273, 195, 1, 'pptjenispemilikan', 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO EKPTGHQLIVE.TBLSEMAKANSENARAI
(ID_SEMAKANSENARAI, ID_SEMAKAN, ID_URUSAN, KOD_FORM, ATURAN, CATATAN, ID_SUBURUSAN, ID_KATEGORIPEMOHON, STATUS_DOKUMEN, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI)
VALUES(274, 196, 1, 'pptjenispemilikan', 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO EKPTGHQLIVE.TBLSEMAKANSENARAI
(ID_SEMAKANSENARAI, ID_SEMAKAN, ID_URUSAN, KOD_FORM, ATURAN, CATATAN, ID_SUBURUSAN, ID_KATEGORIPEMOHON, STATUS_DOKUMEN, ID_MASUK, TARIKH_MASUK, ID_KEMASKINI, TARIKH_KEMASKINI)
VALUES(275, 197, 1, 'pptjenispemilikan', 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

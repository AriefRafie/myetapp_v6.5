ALTER TABLE EKPTGHQUAT.TBLPPTBAYARAN ADD HARI_LEWAT VARCHAR2(10);
ALTER TABLE EKPTGHQUAT.TBLPPTBAYARAN ADD TARIKH_CAJLEWAT DATE;
ALTER TABLE EKPTGHQUAT.TBLPPTBAYARAN ADD TARIKH_BANTAH DATE;
ALTER TABLE EKPTGHQUAT.TBLPPTBAYARAN ADD PERATUS_BANTAH VARCHAR2(10);
ALTER TABLE EKPTGHQUAT.TBLPPTBAYARAN ADD AMAUN_BANTAH NUMBER(11,2);


--10112020
ALTER TABLE TBLPPTHAKMILIK ADD FLAG_HANTAR_KJP VARCHAR2(100);



--07112020
ALTER TABLE TBLPPTBORANGEHAKMILIK ADD CATATAN VARCHAR2(400);



---13092020---
INSERT INTO TBLSEMAKAN (ID_SEMAKAN,ID_PARENT,KOD_SEMAK,PERIHAL,LAIN_LAIN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) 
VALUES (209,NULL,'bantahanpampasan','Nilai Tanah',NULL,NULL,NULL,NULL,NULL);
INSERT INTO TBLSEMAKAN (ID_SEMAKAN,ID_PARENT,KOD_SEMAK,PERIHAL,LAIN_LAIN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) 
VALUES (210,NULL,'bantahanpampasan','Bangunan',NULL,NULL,NULL,NULL,NULL);
INSERT INTO TBLSEMAKAN (ID_SEMAKAN,ID_PARENT,KOD_SEMAK,PERIHAL,LAIN_LAIN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) 
VALUES (211,NULL,'bantahanpampasan','Kecederaan',NULL,NULL,NULL,NULL,NULL);
INSERT INTO TBLSEMAKAN (ID_SEMAKAN,ID_PARENT,KOD_SEMAK,PERIHAL,LAIN_LAIN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) 
VALUES (212,NULL,'bantahanpampasan','Kemudaratan',NULL,NULL,NULL,NULL,NULL);


INSERT INTO TBLSEMAKANSENARAI (ID_SEMAKANSENARAI,ID_SEMAKAN,ID_URUSAN,KOD_FORM,ATURAN,CATATAN,ID_SUBURUSAN,ID_KATEGORIPEMOHON,STATUS_DOKUMEN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) 
VALUES (276,209,51,'pptbantahanpampasan',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO TBLSEMAKANSENARAI (ID_SEMAKANSENARAI,ID_SEMAKAN,ID_URUSAN,KOD_FORM,ATURAN,CATATAN,ID_SUBURUSAN,ID_KATEGORIPEMOHON,STATUS_DOKUMEN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) 
VALUES (277,210,51,'pptbantahanpampasan',2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO TBLSEMAKANSENARAI (ID_SEMAKANSENARAI,ID_SEMAKAN,ID_URUSAN,KOD_FORM,ATURAN,CATATAN,ID_SUBURUSAN,ID_KATEGORIPEMOHON,STATUS_DOKUMEN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) 
VALUES (278,211,51,'pptbantahanpampasan',3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO TBLSEMAKANSENARAI (ID_SEMAKANSENARAI,ID_SEMAKAN,ID_URUSAN,KOD_FORM,ATURAN,CATATAN,ID_SUBURUSAN,ID_KATEGORIPEMOHON,STATUS_DOKUMEN,ID_MASUK,TARIKH_MASUK,ID_KEMASKINI,TARIKH_KEMASKINI) 
VALUES (279,212,51,'pptbantahanpampasan',3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

...
!function(b){
	var a=function(c,d){
		...
		this.$window=b(window).on("scroll.affix.data-api",b.proxy(this.checkPosition,this)).on("click.affix.data-api",b.proxy(function(){setTimeout(b.proxy(this.checkPosition,this),1)},this));
		this.$element=b(c);
		this.checkPosition()
		};
		a.prototype.checkPosition=function(){
			...
			if(typeof j!="object"){h=f=j}
			if(typeof f=="function"){f=j.top()}
			if(typeof h=="function"){h=j.bottom()}
				...
				return this.each(function(){
					...
					b(window).on("load",function(){
						b('[data-spy="affix"]').each(function(){
							...
							c.affix(d)})})}(window.jQuery);
							!function(c){
								var a='[data-dismiss="alert"]',b=function(d){c(d).on("click",a,this.close)};
